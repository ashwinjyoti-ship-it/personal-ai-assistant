...
export function getDashboardScript(): string {
  ...
  async function renderDashboard(container) {
    ...
    try {
      ...
      html += '<div class="dash-card dash-card-outlined" id="dashGmailCard" onclick="dashGmailClick()"><div class="dash-card-icon">&#9993;</div><div class="dash-card-value" id="dashGmailCount"><span style=\\'color:var(--text-muted);font-size:13px;\\'>...</span></div><div class="dash-card-label">Unread Gmail</div></div>';
      ...
      html += '<div class="dash-card dash-card-outlined" onclick="state.prevView=\\'dashboard\\';state.view=\\'documents\\';renderView();"><div class="dash-card-icon">&#128196;</div><div class="dash-card-value">' + (data.documents_count || 0) + '</div><div class="dash-card-label">Documents</div></div>';
      if (data.errors > 0) {
