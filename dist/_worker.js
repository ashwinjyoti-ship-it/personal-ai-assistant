var Or=Object.defineProperty;var aa=e=>{throw TypeError(e)};var Rr=(e,t,a)=>t in e?Or(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var O=(e,t,a)=>Rr(e,typeof t!="symbol"?t+"":t,a),Lt=(e,t,a)=>t.has(e)||aa("Cannot "+a);var b=(e,t,a)=>(Lt(e,t,"read from private field"),a?a.call(e):t.get(e)),U=(e,t,a)=>t.has(e)?aa("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),A=(e,t,a,r)=>(Lt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),z=(e,t,a)=>(Lt(e,t,"access private method"),a);var ra=(e,t,a,r)=>({set _(s){A(e,t,s,a)},get _(){return b(e,t,r)}});var sa=(e,t,a)=>(r,s)=>{let n=-1;return i(0);async function i(o){if(o<=n)throw new Error("next() called multiple times");n=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],r.req.routeIndex=o):d=o===e.length&&s||void 0,d)try{l=await d(r,()=>i(o+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),c=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},Nr=Symbol(),Ar=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,n=(e instanceof Ra?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Lr(e,{all:a,dot:r}):{}};async function Lr(e,t){const a=await e.formData();return a?Mr(a,t):{}}function Mr(e,t){const a=Object.create(null);return e.forEach((r,s)=>{t.all||s.endsWith("[]")?$r(a,s,r):a[s]=r}),t.dot&&Object.entries(a).forEach(([r,s])=>{r.includes(".")&&(Br(a,r,s),delete a[r])}),a}var $r=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Br=(e,t,a)=>{let r=e;const s=t.split(".");s.forEach((n,i)=>{i===s.length-1?r[n]=a:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},Sa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},jr=e=>{const{groups:t,path:a}=Pr(e),r=Sa(a);return Ur(r,t)},Pr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const s=`@${r}`;return t.push([s,a]),s}),{groups:t,path:e}},Ur=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let s=e.length-1;s>=0;s--)if(e[s].includes(r)){e[s]=e[s].replace(r,t[a][1]);break}}return e},Et={},Hr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return Et[r]||(a[2]?Et[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Et[r]=[e,a[1],!0]),Et[r]}return null},zt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Gr=e=>zt(e,decodeURI),Da=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const s=t.charCodeAt(r);if(s===37){const n=t.indexOf("?",r),i=t.indexOf("#",r),o=n===-1?i===-1?void 0:i:i===-1?n:Math.min(n,i),l=t.slice(a,o);return Gr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(s===63||s===35)break}return t.slice(a,r)},Fr=e=>{const t=Da(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ze=(e,t,...a)=>(a.length&&(t=ze(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ia=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))r+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){a.length===0&&r===""?a.push("/"):a.push(r);const n=s.replace("?","");r+="/"+n,a.push(r)}else r+="/"+s}),a.filter((s,n,i)=>i.indexOf(s)===n)},Mt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?zt(e,Oa):e):e,Ca=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return Mt(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const s={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const i=e.indexOf("&",n+1);let o=e.indexOf("=",n);o>i&&i!==-1&&(o=-1);let l=e.slice(n+1,o===-1?i===-1?void 0:i:o);if(r&&(l=Mt(l)),n=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),r&&(c=Mt(c))),a?(s[l]&&Array.isArray(s[l])||(s[l]=[]),s[l].push(c)):s[l]??(s[l]=c)}return t?s[t]:s},qr=Ca,Wr=(e,t)=>Ca(e,t,!0),Oa=decodeURIComponent,na=e=>zt(e,Oa),Ve,de,xe,Na,Aa,Ht,De,ba,Ra=(ba=class{constructor(e,t="/",a=[[]]){U(this,xe);O(this,"raw");U(this,Ve);U(this,de);O(this,"routeIndex",0);O(this,"path");O(this,"bodyCache",{});U(this,De,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const s=Object.keys(t)[0];return s?t[s].then(n=>(s==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,A(this,de,a),A(this,Ve,{})}param(e){return e?z(this,xe,Na).call(this,e):z(this,xe,Aa).call(this)}query(e){return qr(this.url,e)}queries(e){return Wr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ar(this,e))}json(){return b(this,De).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,De).call(this,"text")}arrayBuffer(){return b(this,De).call(this,"arrayBuffer")}blob(){return b(this,De).call(this,"blob")}formData(){return b(this,De).call(this,"formData")}addValidatedData(e,t){b(this,Ve)[e]=t}valid(e){return b(this,Ve)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Nr](){return b(this,de)}get matchedRoutes(){return b(this,de)[0].map(([[,e]])=>e)}get routePath(){return b(this,de)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ve=new WeakMap,de=new WeakMap,xe=new WeakSet,Na=function(e){const t=b(this,de)[0][this.routeIndex][1][e],a=z(this,xe,Ht).call(this,t);return a&&/\%/.test(a)?na(a):a},Aa=function(){const e={},t=Object.keys(b(this,de)[0][this.routeIndex][1]);for(const a of t){const r=z(this,xe,Ht).call(this,b(this,de)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?na(r):r)}return e},Ht=function(e){return b(this,de)[1]?b(this,de)[1][e]:e},De=new WeakMap,ba),zr={Stringify:1},La=async(e,t,a,r,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(s?s[0]+=e:s=[e],Promise.all(n.map(o=>o({phase:t,buffer:s,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>La(l,t,!1,r,s))).then(()=>s[0]))):Promise.resolve(e)},Kr="text/plain; charset=UTF-8",$t=(e,t)=>({"Content-Type":e,...t}),mt,ht,be,Ze,_e,oe,gt,Xe,Qe,$e,ft,yt,Ie,Ke,_a,Yr=(_a=class{constructor(e,t){U(this,Ie);U(this,mt);U(this,ht);O(this,"env",{});U(this,be);O(this,"finalized",!1);O(this,"error");U(this,Ze);U(this,_e);U(this,oe);U(this,gt);U(this,Xe);U(this,Qe);U(this,$e);U(this,ft);U(this,yt);O(this,"render",(...e)=>(b(this,Xe)??A(this,Xe,t=>this.html(t)),b(this,Xe).call(this,...e)));O(this,"setLayout",e=>A(this,gt,e));O(this,"getLayout",()=>b(this,gt));O(this,"setRenderer",e=>{A(this,Xe,e)});O(this,"header",(e,t,a)=>{this.finalized&&A(this,oe,new Response(b(this,oe).body,b(this,oe)));const r=b(this,oe)?b(this,oe).headers:b(this,$e)??A(this,$e,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});O(this,"status",e=>{A(this,Ze,e)});O(this,"set",(e,t)=>{b(this,be)??A(this,be,new Map),b(this,be).set(e,t)});O(this,"get",e=>b(this,be)?b(this,be).get(e):void 0);O(this,"newResponse",(...e)=>z(this,Ie,Ke).call(this,...e));O(this,"body",(e,t,a)=>z(this,Ie,Ke).call(this,e,t,a));O(this,"text",(e,t,a)=>!b(this,$e)&&!b(this,Ze)&&!t&&!a&&!this.finalized?new Response(e):z(this,Ie,Ke).call(this,e,t,$t(Kr,a)));O(this,"json",(e,t,a)=>z(this,Ie,Ke).call(this,JSON.stringify(e),t,$t("application/json",a)));O(this,"html",(e,t,a)=>{const r=s=>z(this,Ie,Ke).call(this,s,t,$t("text/html; charset=UTF-8",a));return typeof e=="object"?La(e,zr.Stringify,!1,{}).then(r):r(e)});O(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});O(this,"notFound",()=>(b(this,Qe)??A(this,Qe,()=>new Response),b(this,Qe).call(this,this)));A(this,mt,e),t&&(A(this,_e,t.executionCtx),this.env=t.env,A(this,Qe,t.notFoundHandler),A(this,yt,t.path),A(this,ft,t.matchResult))}get req(){return b(this,ht)??A(this,ht,new Ra(b(this,mt),b(this,yt),b(this,ft))),b(this,ht)}get event(){if(b(this,_e)&&"respondWith"in b(this,_e))return b(this,_e);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,_e))return b(this,_e);throw Error("This context has no ExecutionContext")}get res(){return b(this,oe)||A(this,oe,new Response(null,{headers:b(this,$e)??A(this,$e,new Headers)}))}set res(e){if(b(this,oe)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,oe).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,oe).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of r)e.headers.append("set-cookie",s)}else e.headers.set(t,a)}A(this,oe,e),this.finalized=!0}get var(){return b(this,be)?Object.fromEntries(b(this,be)):{}}},mt=new WeakMap,ht=new WeakMap,be=new WeakMap,Ze=new WeakMap,_e=new WeakMap,oe=new WeakMap,gt=new WeakMap,Xe=new WeakMap,Qe=new WeakMap,$e=new WeakMap,ft=new WeakMap,yt=new WeakMap,Ie=new WeakSet,Ke=function(e,t,a){const r=b(this,oe)?new Headers(b(this,oe).headers):b(this,$e)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of n)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[n,i]of Object.entries(a))if(typeof i=="string")r.set(n,i);else{r.delete(n);for(const o of i)r.append(n,o)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Ze);return new Response(e,{status:s,headers:r})},_a),ae="ALL",Jr="all",Vr=["get","post","put","delete","options","patch"],Ma="Can not add a route since the matcher is already built.",$a=class extends Error{},Zr="__COMPOSED_HANDLER",Xr=e=>e.text("404 Not Found",404),ia=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},me,re,Ba,he,Le,xt,kt,et,Qr=(et=class{constructor(t={}){U(this,re);O(this,"get");O(this,"post");O(this,"put");O(this,"delete");O(this,"options");O(this,"patch");O(this,"all");O(this,"on");O(this,"use");O(this,"router");O(this,"getPath");O(this,"_basePath","/");U(this,me,"/");O(this,"routes",[]);U(this,he,Xr);O(this,"errorHandler",ia);O(this,"onError",t=>(this.errorHandler=t,this));O(this,"notFound",t=>(A(this,he,t),this));O(this,"fetch",(t,...a)=>z(this,re,kt).call(this,t,a[1],a[0],t.method));O(this,"request",(t,a,r,s)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ze("/",t)}`,a),r,s)));O(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(z(this,re,kt).call(this,t.request,t,void 0,t.request.method))})});[...Vr,Jr].forEach(n=>{this[n]=(i,...o)=>(typeof i=="string"?A(this,me,i):z(this,re,Le).call(this,n,b(this,me),i),o.forEach(l=>{z(this,re,Le).call(this,n,b(this,me),l)}),this)}),this.on=(n,i,...o)=>{for(const l of[i].flat()){A(this,me,l);for(const c of[n].flat())o.map(d=>{z(this,re,Le).call(this,c.toUpperCase(),b(this,me),d)})}return this},this.use=(n,...i)=>(typeof n=="string"?A(this,me,n):(A(this,me,"*"),i.unshift(n)),i.forEach(o=>{z(this,re,Le).call(this,ae,b(this,me),o)}),this);const{strict:r,...s}=t;Object.assign(this,s),this.getPath=r??!0?t.getPath??Da:Fr}route(t,a){const r=this.basePath(t);return a.routes.map(s=>{var i;let n;a.errorHandler===ia?n=s.handler:(n=async(o,l)=>(await sa([],a.errorHandler)(o,()=>s.handler(o,l))).res,n[Zr]=s.handler),z(i=r,re,Le).call(i,s.method,s.path,n)}),this}basePath(t){const a=z(this,re,Ba).call(this);return a._basePath=ze(this._basePath,t),a}mount(t,a,r){let s,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?s=l=>l:s=r.replaceRequest));const i=n?l=>{const c=n(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};s||(s=(()=>{const l=ze(this._basePath,t),c=l==="/"?0:l.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const o=async(l,c)=>{const d=await a(s(l.req.raw),...i(l));if(d)return d;await c()};return z(this,re,Le).call(this,ae,ze(t,"*"),o),this}},me=new WeakMap,re=new WeakSet,Ba=function(){const t=new et({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,A(t,he,b(this,he)),t.routes=this.routes,t},he=new WeakMap,Le=function(t,a,r){t=t.toUpperCase(),a=ze(this._basePath,a);const s={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,s]),this.routes.push(s)},xt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},kt=function(t,a,r,s){if(s==="HEAD")return(async()=>new Response(null,await z(this,re,kt).call(this,t,a,r,"GET")))();const n=this.getPath(t,{env:r}),i=this.router.match(s,n),o=new Yr(t,{path:n,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,he)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await b(this,he).call(this,o)})}catch(d){return z(this,re,xt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:b(this,he).call(this,o))).catch(d=>z(this,re,xt).call(this,d,o)):c??b(this,he).call(this,o)}const l=sa(i[0],this.errorHandler,b(this,he));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return z(this,re,xt).call(this,c,o)}})()},et),ja=[];function es(e,t){const a=this.buildAllMatchers(),r=((s,n)=>{const i=a[s]||a[ae],o=i[2][n];if(o)return o;const l=n.match(i[0]);if(!l)return[[],ja];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=r,r(e,t)}var Dt="[^/]+",dt=".*",ut="(?:|/.*)",Ye=Symbol(),ts=new Set(".\\+*[^]$()");function as(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===dt||e===ut?1:t===dt||t===ut?-1:e===Dt?1:t===Dt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Be,je,ge,He,rs=(He=class{constructor(){U(this,Be);U(this,je);U(this,ge,Object.create(null))}insert(t,a,r,s,n){if(t.length===0){if(b(this,Be)!==void 0)throw Ye;if(n)return;A(this,Be,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",dt]:["","",Dt]:i==="/*"?["","",ut]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let p=l[2]||Dt;if(d&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Ye;if(c=b(this,ge)[p],!c){if(Object.keys(b(this,ge)).some(h=>h!==dt&&h!==ut))throw Ye;if(n)return;c=b(this,ge)[p]=new He,d!==""&&A(c,je,s.varIndex++)}!n&&d!==""&&r.push([d,b(c,je)])}else if(c=b(this,ge)[i],!c){if(Object.keys(b(this,ge)).some(d=>d.length>1&&d!==dt&&d!==ut))throw Ye;if(n)return;c=b(this,ge)[i]=new He}c.insert(o,a,r,s,n)}buildRegExpStr(){const a=Object.keys(b(this,ge)).sort(as).map(r=>{const s=b(this,ge)[r];return(typeof b(s,je)=="number"?`(${r})@${b(s,je)}`:ts.has(r)?`\\${r}`:r)+s.buildRegExpStr()});return typeof b(this,Be)=="number"&&a.unshift(`#${b(this,Be)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Be=new WeakMap,je=new WeakMap,ge=new WeakMap,He),Ct,vt,Ea,ss=(Ea=class{constructor(){U(this,Ct,{varIndex:0});U(this,vt,new rs)}insert(e,t,a){const r=[],s=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return s[i]=[c,l],i++,o=!0,c}),!o)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=s.length-1;i>=0;i--){const[o]=s[i];for(let l=n.length-1;l>=0;l--)if(n[l].indexOf(o)!==-1){n[l]=n[l].replace(o,s[i][1]);break}}return b(this,vt).insert(n,t,r,b(this,Ct),a),r}buildRegExp(){let e=b(this,vt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,n,i)=>n!==void 0?(a[++t]=Number(n),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},Ct=new WeakMap,vt=new WeakMap,Ea),ns=[/^$/,[],Object.create(null)],St=Object.create(null);function Pa(e){return St[e]??(St[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function is(){St=Object.create(null)}function os(e){var c;const t=new ss,a=[];if(e.length===0)return ns;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[h,v])=>d?1:h?-1:p.length-v.length),s=Object.create(null);for(let d=0,p=-1,h=r.length;d<h;d++){const[v,g,x]=r[d];v?s[g]=[x.map(([T])=>[T,Object.create(null)]),ja]:p++;let w;try{w=t.insert(g,p,v)}catch(T){throw T===Ye?new $a(g):T}v||(a[p]=x.map(([T,_])=>{const C=Object.create(null);for(_-=1;_>=0;_--){const[R,$]=w[_];C[R]=$}return[T,C]}))}const[n,i,o]=t.buildRegExp();for(let d=0,p=a.length;d<p;d++)for(let h=0,v=a[d].length;h<v;h++){const g=(c=a[d][h])==null?void 0:c[1];if(!g)continue;const x=Object.keys(g);for(let w=0,T=x.length;w<T;w++)g[x[w]]=o[g[x[w]]]}const l=[];for(const d in i)l[d]=a[i[d]];return[n,l,s]}function qe(e,t){if(e){for(const a of Object.keys(e).sort((r,s)=>s.length-r.length))if(Pa(a).test(t))return[...e[a]]}}var Ce,Oe,Ot,Ua,Ta,ls=(Ta=class{constructor(){U(this,Ot);O(this,"name","RegExpRouter");U(this,Ce);U(this,Oe);O(this,"match",es);A(this,Ce,{[ae]:Object.create(null)}),A(this,Oe,{[ae]:Object.create(null)})}add(e,t,a){var o;const r=b(this,Ce),s=b(this,Oe);if(!r||!s)throw new Error(Ma);r[e]||[r,s].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ae]).forEach(c=>{l[e][c]=[...l[ae][c]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Pa(t);e===ae?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=qe(r[c],t)||qe(r[ae],t)||[])}):(o=r[e])[t]||(o[t]=qe(r[e],t)||qe(r[ae],t)||[]),Object.keys(r).forEach(c=>{(e===ae||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,n])})}),Object.keys(s).forEach(c=>{(e===ae||e===c)&&Object.keys(s[c]).forEach(d=>l.test(d)&&s[c][d].push([a,n]))});return}const i=Ia(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(s).forEach(p=>{var h;(e===ae||e===p)&&((h=s[p])[d]||(h[d]=[...qe(r[p],d)||qe(r[ae],d)||[]]),s[p][d].push([a,n-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,Oe)).concat(Object.keys(b(this,Ce))).forEach(t=>{e[t]||(e[t]=z(this,Ot,Ua).call(this,t))}),A(this,Ce,A(this,Oe,void 0)),is(),e}},Ce=new WeakMap,Oe=new WeakMap,Ot=new WeakSet,Ua=function(e){const t=[];let a=e===ae;return[b(this,Ce),b(this,Oe)].forEach(r=>{const s=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];s.length!==0?(a||(a=!0),t.push(...s)):e!==ae&&t.push(...Object.keys(r[ae]).map(n=>[n,r[ae][n]]))}),a?os(t):null},Ta),Re,Ee,xa,cs=(xa=class{constructor(e){O(this,"name","SmartRouter");U(this,Re,[]);U(this,Ee,[]);A(this,Re,e.routers)}add(e,t,a){if(!b(this,Ee))throw new Error(Ma);b(this,Ee).push([e,t,a])}match(e,t){if(!b(this,Ee))throw new Error("Fatal error");const a=b(this,Re),r=b(this,Ee),s=a.length;let n=0,i;for(;n<s;n++){const o=a[n];try{for(let l=0,c=r.length;l<c;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof $a)continue;throw l}this.match=o.match.bind(o),A(this,Re,[o]),A(this,Ee,void 0);break}if(n===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,Ee)||b(this,Re).length!==1)throw new Error("No active router has been determined yet.");return b(this,Re)[0]}},Re=new WeakMap,Ee=new WeakMap,xa),nt=Object.create(null),Ne,ie,Pe,tt,ne,Te,Me,at,ds=(at=class{constructor(t,a,r){U(this,Te);U(this,Ne);U(this,ie);U(this,Pe);U(this,tt,0);U(this,ne,nt);if(A(this,ie,r||Object.create(null)),A(this,Ne,[]),t&&a){const s=Object.create(null);s[t]={handler:a,possibleKeys:[],score:0},A(this,Ne,[s])}A(this,Pe,[])}insert(t,a,r){A(this,tt,++ra(this,tt)._);let s=this;const n=jr(a),i=[];for(let o=0,l=n.length;o<l;o++){const c=n[o],d=n[o+1],p=Hr(c,d),h=Array.isArray(p)?p[0]:c;if(h in b(s,ie)){s=b(s,ie)[h],p&&i.push(p[1]);continue}b(s,ie)[h]=new at,p&&(b(s,Pe).push(p),i.push(p[1])),s=b(s,ie)[h]}return b(s,Ne).push({[t]:{handler:r,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:b(this,tt)}}),s}search(t,a){var l;const r=[];A(this,ne,nt);let n=[this];const i=Sa(a),o=[];for(let c=0,d=i.length;c<d;c++){const p=i[c],h=c===d-1,v=[];for(let g=0,x=n.length;g<x;g++){const w=n[g],T=b(w,ie)[p];T&&(A(T,ne,b(w,ne)),h?(b(T,ie)["*"]&&r.push(...z(this,Te,Me).call(this,b(T,ie)["*"],t,b(w,ne))),r.push(...z(this,Te,Me).call(this,T,t,b(w,ne)))):v.push(T));for(let _=0,C=b(w,Pe).length;_<C;_++){const R=b(w,Pe)[_],$=b(w,ne)===nt?{}:{...b(w,ne)};if(R==="*"){const D=b(w,ie)["*"];D&&(r.push(...z(this,Te,Me).call(this,D,t,b(w,ne))),A(D,ne,$),v.push(D));continue}const[G,F,W]=R;if(!p&&!(W instanceof RegExp))continue;const H=b(w,ie)[G],K=i.slice(c).join("/");if(W instanceof RegExp){const D=W.exec(K);if(D){if($[F]=D[0],r.push(...z(this,Te,Me).call(this,H,t,b(w,ne),$)),Object.keys(b(H,ie)).length){A(H,ne,$);const B=((l=D[0].match(/\//))==null?void 0:l.length)??0;(o[B]||(o[B]=[])).push(H)}continue}}(W===!0||W.test(p))&&($[F]=p,h?(r.push(...z(this,Te,Me).call(this,H,t,$,b(w,ne))),b(H,ie)["*"]&&r.push(...z(this,Te,Me).call(this,b(H,ie)["*"],t,$,b(w,ne)))):(A(H,ne,$),v.push(H)))}}n=v.concat(o.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},Ne=new WeakMap,ie=new WeakMap,Pe=new WeakMap,tt=new WeakMap,ne=new WeakMap,Te=new WeakSet,Me=function(t,a,r,s){const n=[];for(let i=0,o=b(t,Ne).length;i<o;i++){const l=b(t,Ne)[i],c=l[a]||l[ae],d={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),r!==nt||s&&s!==nt))for(let p=0,h=c.possibleKeys.length;p<h;p++){const v=c.possibleKeys[p],g=d[c.score];c.params[v]=s!=null&&s[v]&&!g?s[v]:r[v]??(s==null?void 0:s[v]),d[c.score]=!0}}return n},at),Ue,ka,us=(ka=class{constructor(){O(this,"name","TrieRouter");U(this,Ue);A(this,Ue,new ds)}add(e,t,a){const r=Ia(t);if(r){for(let s=0,n=r.length;s<n;s++)b(this,Ue).insert(e,r[s],a);return}b(this,Ue).insert(e,t,a)}match(e,t){return b(this,Ue).search(e,t)}},Ue=new WeakMap,ka),ke=class extends Qr{constructor(e={}){super(e),this.router=e.router??new cs({routers:[new ls,new us]})}},ps=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:i=>n===i?i:null:typeof n=="function"?n:i=>n.includes(i)?i:null)(a.origin),s=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(a.allowMethods);return async function(i,o){var d;function l(p,h){i.res.headers.set(p,h)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await s(i.req.header("origin")||"",i);p.length&&l("Access-Control-Allow-Methods",p.join(","));let h=a.allowHeaders;if(!(h!=null&&h.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(h=v.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Ha(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>qa),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const p=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!p)return;const h=await c(p.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function oa(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class za{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",s="anthropic"){O(this,"name");O(this,"apiKey");O(this,"model");O(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=s}async chat(t,a){var d,p,h,v;const r=t.find(g=>g.role==="system"),s=t.filter(g=>g.role!=="system"),n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:s.map(g=>({role:g.role,content:g.content}))};r&&(n.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(n.tools=a.tools.map(g=>({name:g.name,description:g.description,input_schema:g.parameters})));const i=await Wa(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(n)}),this.name);if(!i.ok){const g=await i.text();throw new Error(this.name+" API error "+i.status+": "+g)}const o=await i.json(),l=((d=o.content)==null?void 0:d.filter(g=>g.type==="text"))||[],c=((p=o.content)==null?void 0:p.filter(g=>g.type==="tool_use"))||[];return{content:l.map(g=>g.text).join(`
`),toolCalls:c.map(g=>({id:g.id,name:g.name,arguments:g.input})),usage:{promptTokens:((h=o.usage)==null?void 0:h.input_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(c=>c.role==="system"),s=t.filter(c=>c.role!=="system"),n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:s.map(c=>({role:c.role,content:c.content}))};r&&(n.system=r.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(n)});if(!i.ok){const c=await i.text();throw new Error(this.name+" stream error "+i.status+": "+c)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var g;const{done:d,value:p}=await o.read();if(d){c.close();return}const v=l.decode(p,{stream:!0}).split(`
`);for(const x of v)if(x.startsWith("data: ")){const w=x.slice(6);if(w==="[DONE]")continue;try{const T=JSON.parse(w);T.type==="content_block_delta"&&((g=T.delta)!=null&&g.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:T.delta.text})+`

`))}catch{}}}})}}function gs(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const s={};for(const[n,i]of Object.entries(r))i&&typeof i=="object"?s[n]=Gt(i):s[n]=i;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Gt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[s,n]of Object.entries(a))n&&typeof n=="object"?r[s]=Gt(n):r[s]=n;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Gt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ka{constructor(t,a,r,s){O(this,"name");O(this,"apiKey");O(this,"model");O(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=s}async chat(t,a){var l,c,d,p,h,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(g=>({role:g.role,content:g.content}))},s=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&s)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(g=>({type:"function",function:{name:g.name,description:g.description,parameters:gs(g.parameters||{})}})));const n=await Wa(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)}),this.name);if(!n.ok){const g=await n.text();throw new Error(this.name+" API error "+n.status+": "+g)}const i=await n.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((c=o==null?void 0:o.message)==null?void 0:c.content)||"",toolCalls:(p=(d=o==null?void 0:o.message)==null?void 0:d.tool_calls)==null?void 0:p.map(g=>({id:g.id,name:g.function.name,arguments:(()=>{try{return typeof g.function.arguments=="string"?JSON.parse(g.function.arguments||"{}"):g.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=i.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const o=await s.text();throw new Error(this.name+" stream error "+s.status+": "+o)}const n=s.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var h,v,g;const{done:l,value:c}=await n.read();if(l){o.close();return}const p=i.decode(c,{stream:!0}).split(`
`);for(const x of p)if(x.startsWith("data: ")){const w=x.slice(6);if(w==="[DONE]")continue;try{const _=(g=(v=(h=JSON.parse(w).choices)==null?void 0:h[0])==null?void 0:v.delta)==null?void 0:g.content;_&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:_})+`

`))}catch{}}}})}}function Ft(e,t,a,r){const s=pt[e];if(!s)throw new Error(`Unknown LLM provider: ${e}`);const n=r||s.defaultModel;return s.apiFormat==="anthropic"?new za(t,n,s.apiBase,a):new Ka(t,n,s.apiBase,a)}class Ya{constructor(){O(this,"errorLog",new Map);O(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(s=>{const n=this.errorLog.get(s);return n?n.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const fs=["llm_slot_1","llm_slot_2","llm_slot_3"],ys=["anthropic","openai"];async function wt(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>qa),s=new Ya,n=[];for(const p of fs){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(h)try{const v=await r(h.encrypted_value,a),g=JSON.parse(v);if(g.provider&&g.apiKey&&pt[g.provider]){const w=g.provider,T=Ft(g.provider,g.apiKey,w,g.model);n.push({name:w,provider:T})}}catch(v){console.error(`Failed to load ${p}:`,v)}}const i=new Set(n.map(p=>p.name));for(const p of ys){if(i.has(p))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(h)try{const v=await r(h.encrypted_value,a);if(pt[p]){const x=Ft(p,v,p);n.push({name:p,provider:x})}}catch{console.error(`Failed to decrypt legacy ${p} key`)}}if(n.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=n.map(p=>p.name),l=await s.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:n[0].provider,rotation:s};const c=n.find(p=>p.name===l);return{provider:vs(c.provider,n,s,e,t),rotation:s}}function vs(e,t,a,r,s){const n=i=>i.includes("401")||i.includes("403")||i.includes("authentication")||i.includes("credit balance")||i.includes("invalid")&&i.includes("key")||i.includes("properties field not found")||i.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(i,o){try{return await e.chat(i,o)}catch(l){const c=l.message||"";throw n(c)&&!c.includes("TOOLS_UNSUPPORTED")&&Bt(r,s,"all_providers_down",e.name,null,c),l}},async streamChat(i,o){return await e.streamChat(i,o)}}:{name:e.name,async chat(i,o){try{return await e.chat(i,o)}catch(l){const c=l.message||"";if(!n(c))throw l;const d=c.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${d?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,d?1:1440);const p=t.filter(h=>h.name!==e.name);for(const h of p)try{const v=await h.provider.chat(i,o);return this.name=h.name,d||Bt(r,s,"provider_switched",e.name,h.name,c),v}catch(v){const g=v.message||"";if(n(g)){await a.recordError(h.name,g,1440);continue}throw v}throw Bt(r,s,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(i,o){return await e.streamChat(i,o)}}}const Je=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:za,OpenAICompatibleProvider:Ka,ProviderRotation:Ya,createProviderFromConfig:Ft,createRotatingProvider:wt,logError:P},Symbol.toStringTag,{value:"Module"})),jt=20,ws=2e3,bs=2e3,Ja=4;function _s(e){return Math.ceil(e.length/Ja)}function la(e,t){const a=t*Ja;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class ue{constructor(t){this.db=t}async store(t,a,r,s,n=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       WHERE user_id = ? AND type = 'task' AND status = 'done' AND tier = 'working'
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>jt){const r=((a==null?void 0:a.cnt)||0)-jt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,r).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,jt).all()).results||[]}async getAll(t,a,r=50){return a?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a,r).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,r).all()).results||[]}async search(t,a,r=10){const n=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${a}%`,`%${a}%`,r).all()).results||[];if(n.length>0)return await this.touchMemories(t,n.map(d=>d.id)),n;const i=a.split(/\s+/).filter(d=>d.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const d of i){const p=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${d}%`,`%${d}%`,r*2).all();for(const h of p.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const c=[...l.values()].sort((d,p)=>(o.get(p.id)||0)-(o.get(d.id)||0)).slice(0,r);return c.length>0&&await this.touchMemories(t,c.map(d=>d.id)),c}async searchLongTerm(t,a,r=5){const n=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${a}%`,`%${a}%`,r).all()).results||[];if(n.length>0)return await this.touchMemories(t,n.map(d=>d.id)),n;const i=a.split(/\s+/).filter(d=>d.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const d of i){const p=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${d}%`,`%${d}%`,r*2).all();for(const h of p.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const c=[...l.values()].sort((d,p)=>(o.get(p.id)||0)-(o.get(d.id)||0)).slice(0,r);return c.length>0&&await this.touchMemories(t,c.map(d=>d.id)),c}async touchMemories(t,a){for(const r of a)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t).run()}async update(t,a,r){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t,a).run()}async promote(t,a){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run(),await this.enforceWorkingMemoryCap(a)}async demote(t,a){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run()}async remove(t,a){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,a).run()}async buildContext(t){const a=await this.getWorkingMemory(t);if(a.length===0)return"";const r={};for(const n of a)r[n.type]||(r[n.type]=[]),r[n.type].push(n);let s=`
## Working Memory (Active Context)
`;for(const[n,i]of Object.entries(r)){s+=`
### ${n.charAt(0).toUpperCase()+n.slice(1)}s
`;for(const o of i)s+=`- **${o.title}**: ${o.content}
`}return la(s,ws)}static truncatePersonality(t){return la(t,bs)}async getRecentConversations(t,a=20,r){return r?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r,a).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a).all()).results||[]).reverse()}async storeMessage(t,a,r,s,n="{}",i){const o=_s(s);i?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,o,i).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,o).run()}async compactHistory(t,a=30){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((r==null?void 0:r.cnt)||0)<=a*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,a).run()}}const Es=Object.freeze(Object.defineProperty({__proto__:null,MemoryService:ue},Symbol.toStringTag,{value:"Module"})),Ts="https://accounts.google.com/o/oauth2/v2/auth",Va="https://oauth2.googleapis.com/token",xs="https://www.googleapis.com/oauth2/v2/userinfo",ks=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let ye=null;async function qt(e,t,a){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!r)return null;try{const s=await Z(r.encrypted_value,a);return JSON.parse(s)}catch{return null}}async function Ss(e,t,a,r){const s=await Yt(JSON.stringify(r),a);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,s).run()}function Za(e,t,a){const r=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:ks,access_type:"offline",prompt:"consent",state:a,include_granted_scopes:"true"});return`${Ts}?${r}`}async function Xa(e,t,a,r){const s=await fetch(Va,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:a,redirect_uri:r,grant_type:"authorization_code"})}),n=await s.text();if(!s.ok)throw new Error(`Token exchange failed (${s.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function Ds(e,t,a){const r=await fetch(Va,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:a,grant_type:"refresh_token"})}),s=await r.text();if(!r.ok)throw r.status===400||r.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${r.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function Qa(e){const t=await fetch(xs,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function rt(e,t,a,r,s){if(!r||!s)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(ye&&ye.userId===t&&ye.expiresAt>Date.now()/1e3+60){const o=await qt(e,t,a);return{token:ye.token,email:(o==null?void 0:o.email)||"unknown"}}const n=await qt(e,t,a);if(!n)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const i=await Ds(n.refresh_token,r,s);return ye={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{token:i.access_token,email:n.email}}async function Jt(e,t,a){try{const r=await qt(e,t,a);return r?{connected:!0,email:r.email,connectedAt:r.connected_at}:{connected:!1}}catch{return{connected:!1}}}function er(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function tr(e,t,a,r,s,n,i){const o=await Xa(r,n,i,s);if(!o.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await Qa(o.access_token),c={refresh_token:o.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Ss(e,t,a,c),ye={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{email:l.email,name:l.name}}async function ar(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(ye==null?void 0:ye.userId)===t&&(ye=null)}const it="https://sheets.googleapis.com/v4/spreadsheets";class rr{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await rt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,a){const r=await this.authHeaders(),s=encodeURIComponent(a),n=await fetch(`${it}/${t}/values/${s}`,{headers:r});if(!n.ok){const o=await n.text();throw new Error(`Sheets read failed (${n.status}): ${o}`)}return(await n.json()).values||[]}async writeRange(t,a,r){const s=await this.authHeaders(),n=encodeURIComponent(a),i=await fetch(`${it}/${t}/values/${n}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:s,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!i.ok){const l=await i.text();throw new Error(`Sheets write failed (${i.status}): ${l}`)}return{updatedCells:(await i.json()).updatedCells||0}}async appendRows(t,a,r){var l;const s=await this.authHeaders(),n=encodeURIComponent(a),i=await fetch(`${it}/${t}/values/${n}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:s,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!i.ok){const c=await i.text();throw new Error(`Sheets append failed (${i.status}): ${c}`)}return{updatedCells:((l=(await i.json()).updates)==null?void 0:l.updatedCells)||r.length}}async createSpreadsheet(t,a){const r=await this.authHeaders(),s={properties:{title:t},sheets:a&&a.length>0?a.map(o=>({properties:{title:o}})):[{properties:{title:"Sheet1"}}]},n=await fetch(it,{method:"POST",headers:r,body:JSON.stringify(s)});if(!n.ok){const o=await n.text();throw new Error(`Sheets create failed (${n.status}): ${o}`)}const i=await n.json();return{spreadsheetId:i.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${i.spreadsheetId}/edit`}}async getMetadata(t){const a=await this.authHeaders(),r=await fetch(`${it}/${t}?fields=properties.title,sheets.properties.title`,{headers:a});if(!r.ok){const n=await r.text();throw new Error(`Sheets metadata failed (${r.status}): ${n}`)}const s=await r.json();return{title:s.properties.title,sheets:s.sheets.map(n=>n.properties.title)}}}const ot="https://www.googleapis.com/calendar/v3";class Vt{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await rt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",a={}){const r=await this.authHeaders(),s=new URLSearchParams;a.timeMin&&s.set("timeMin",a.timeMin),a.timeMax&&s.set("timeMax",a.timeMax),s.set("maxResults",String(a.maxResults||20)),s.set("singleEvents","true"),s.set("orderBy","startTime"),a.query&&s.set("q",a.query);const n=await fetch(`${ot}/calendars/${encodeURIComponent(t)}/events?${s}`,{headers:r});if(!n.ok){const o=await n.text();throw new Error(`Calendar list failed (${n.status}): ${o}`)}return(await n.json()).items||[]}async createEvent(t="primary",a){var o;const r=await this.authHeaders(),s=a.timeZone||"Asia/Kolkata",n={summary:a.summary,description:a.description||"",location:a.location||"",start:{dateTime:a.startDateTime,timeZone:s},end:{dateTime:a.endDateTime,timeZone:s}};(o=a.attendees)!=null&&o.length&&(n.attendees=a.attendees.map(l=>({email:l})));const i=await fetch(`${ot}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:r,body:JSON.stringify(n)});if(!i.ok){const l=await i.text();throw new Error(`Calendar create failed (${i.status}): ${l}`)}return await i.json()}async updateEvent(t="primary",a,r){const s=await this.authHeaders(),n=r.timeZone||"Asia/Kolkata",i={};r.summary&&(i.summary=r.summary),r.description&&(i.description=r.description),r.location&&(i.location=r.location),r.startDateTime&&(i.start={dateTime:r.startDateTime,timeZone:n}),r.endDateTime&&(i.end={dateTime:r.endDateTime,timeZone:n});const o=await fetch(`${ot}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"PATCH",headers:s,body:JSON.stringify(i)});if(!o.ok){const l=await o.text();throw new Error(`Calendar update failed (${o.status}): ${l}`)}return await o.json()}async deleteEvent(t="primary",a){const r=await this.authHeaders(),s=await fetch(`${ot}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"DELETE",headers:r});if(!s.ok&&s.status!==410){const n=await s.text();throw new Error(`Calendar delete failed (${s.status}): ${n}`)}}async listCalendars(){const t=await this.authHeaders(),a=await fetch(`${ot}/users/me/calendarList`,{headers:t});if(!a.ok){const s=await a.text();throw new Error(`Calendar list calendars failed (${a.status}): ${s}`)}return((await a.json()).items||[]).map(s=>({id:s.id,summary:s.summary,primary:s.primary||!1}))}}const Tt="https://docs.googleapis.com/v1/documents",Is="https://www.googleapis.com/drive/v3/files";class sr{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await rt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const a=await this.authHeaders(),r=await fetch(Tt,{method:"POST",headers:a,body:JSON.stringify({title:t})});if(!r.ok){const n=await r.text();throw new Error(`Docs create failed (${r.status}): ${n}`)}const s=await r.json();return{documentId:s.documentId,url:`https://docs.google.com/document/d/${s.documentId}/edit`}}async readDocument(t){var i,o;const a=await this.authHeaders(),r=await fetch(`${Tt}/${t}`,{headers:a});if(!r.ok){const l=await r.text();throw new Error(`Docs read failed (${r.status}): ${l}`)}const s=await r.json();let n="";for(const l of((i=s.body)==null?void 0:i.content)||[])if(l.paragraph)for(const c of l.paragraph.elements)(o=c.textRun)!=null&&o.content&&(n+=c.textRun.content);return{title:s.title,content:n.trim()}}async appendText(t,a){const r=await this.authHeaders(),s=await fetch(`${Tt}/${t}`,{headers:r});if(!s.ok){const l=await s.text();throw new Error(`Docs read for append failed (${s.status}): ${l}`)}const n=await s.json(),i=n.body.content[n.body.content.length-1].endIndex-1,o=await fetch(`${Tt}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{insertText:{location:{index:i},text:a}}]})});if(!o.ok){const l=await o.text();throw new Error(`Docs append failed (${o.status}): ${l}`)}}async shareDocument(t,a,r="writer"){const s=await this.authHeaders(),n=await fetch(`${Is}/${t}/permissions`,{method:"POST",headers:s,body:JSON.stringify({type:"user",role:r,emailAddress:a})});if(!n.ok){const i=await n.text();throw new Error(`Share failed (${n.status}): ${i}`)}}}class fe{constructor(t,a,r,s,n){O(this,"sheets");O(this,"calendar");O(this,"docs");O(this,"db");O(this,"userId");O(this,"pinHash");this.db=t,this.userId=a,this.pinHash=r,this.sheets=new rr(t,a,r,s,n),this.calendar=new Vt(t,a,r,s,n),this.docs=new sr(t,a,r,s,n)}async isConnected(){return Jt(this.db,this.userId,this.pinHash)}}const lt=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:Vt,GoogleDocs:sr,GoogleServices:fe,GoogleSheets:rr,completeOAuthFlow:tr,disconnectGoogle:ar,exchangeCodeForTokens:Xa,fetchUserInfo:Qa,generateAuthUrl:Za,getGoogleAuth:rt,isGoogleConnected:Jt,isOAuthClientConfigured:er},Symbol.toStringTag,{value:"Module"}));async function nr(e,t,a={}){const r={textQuery:t,languageCode:"en",pageSize:8};if(a.type&&(r.includedType=a.type),a.location){const l=a.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(r.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:a.radius||5e3}})}const s=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),n=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":s},body:JSON.stringify(r)});if(!n.ok){const l=await n.text();return{results:[],error:`Places API error (${n.status}): ${l.substring(0,200)}`}}const i=await n.json();return!i.places||i.places.length===0?{results:[]}:{results:i.places.map(l=>{var c,d,p;return{name:((c=l.displayName)==null?void 0:c.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(d=l.currentOpeningHours)==null?void 0:d.openNow,types:(p=l.types)==null?void 0:p.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function ir(e,t){var n,i,o;const a=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),r=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":a}});if(!r.ok){const l=await r.text();return{error:`Place Details API error (${r.status}): ${l.substring(0,200)}`}}const s=await r.json();return{details:{name:((n=s.displayName)==null?void 0:n.text)||"",address:s.formattedAddress||"",phone:s.internationalPhoneNumber,website:s.websiteUri,rating:s.rating,reviews:(i=s.reviews)==null?void 0:i.slice(0,3).map(l=>{var c,d,p;return{author:((c=l.authorAttribution)==null?void 0:c.displayName)||"Anonymous",rating:l.rating||0,text:((p=(d=l.text)==null?void 0:d.text)==null?void 0:p.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(o=s.currentOpeningHours)==null?void 0:o.weekdayDescriptions,location:s.location?{lat:s.location.latitude,lng:s.location.longitude}:void 0,googleMapsUri:s.googleMapsUri}}}async function or(e,t,a,r={}){var c;const s=new URLSearchParams({origin:t,destination:a,key:e,mode:r.mode||"driving"});(r.mode==="driving"||!r.mode)&&s.set("departure_time","now");const n=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${s}`);if(!n.ok)return{error:`Directions API error: ${n.status}`};const i=await n.json();if(i.status!=="OK")return{error:`Directions: ${i.status} — ${i.error_message||""}`};const o=i.routes[0],l=o.legs[0];return{route:{summary:o.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(c=l.duration_in_traffic)==null?void 0:c.text,steps:l.steps.slice(0,10).map(d=>{var p,h,v;return{instruction:((p=d.html_instructions)==null?void 0:p.replace(/<[^>]*>/g,""))||"",distance:((h=d.distance)==null?void 0:h.text)||"",duration:((v=d.duration)==null?void 0:v.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function lr(e,t,a,r){var l,c;const s={q:t,target:a,key:e,format:"text"};r&&(s.source=r);const n=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(!n.ok){const d=await n.text();return{translatedText:"",error:`Translate API error (${n.status}): ${d.substring(0,200)}`}}const o=(c=(l=(await n.json()).data)==null?void 0:l.translations)==null?void 0:c[0];return o?{translatedText:o.translatedText,detectedSourceLang:o.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function cr(e,t){const a=new URLSearchParams({address:t,key:e}),r=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${a}`);if(!r.ok)return{results:[],error:`Geocoding API error: ${r.status}`};const s=await r.json();return s.status!=="OK"&&s.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${s.status} — ${s.error_message||""}`}:{results:(s.results||[]).slice(0,5).map(n=>{var i;return{address:n.formatted_address,lat:n.geometry.location.lat,lng:n.geometry.location.lng,placeId:n.place_id,types:(i=n.types)==null?void 0:i.slice(0,3)}})}}async function dr(e,t,a={}){const r=new URLSearchParams({part:"snippet",q:t,key:e,type:a.type||"video",maxResults:String(a.maxResults||5),order:a.order||"relevance"}),s=await fetch(`https://www.googleapis.com/youtube/v3/search?${r}`);if(!s.ok){const i=await s.text();return{results:[],error:`YouTube API error (${s.status}): ${i.substring(0,200)}`}}return{results:((await s.json()).items||[]).map(i=>{var o,l,c,d,p,h,v,g;return{title:i.snippet.title,channelTitle:i.snippet.channelTitle,description:(o=i.snippet.description)==null?void 0:o.substring(0,200),videoId:((l=i.id)==null?void 0:l.videoId)||((c=i.id)==null?void 0:c.channelId)||((d=i.id)==null?void 0:d.playlistId)||"",publishedAt:i.snippet.publishedAt,url:(p=i.id)!=null&&p.videoId?`https://www.youtube.com/watch?v=${i.id.videoId}`:(h=i.id)!=null&&h.channelId?`https://www.youtube.com/channel/${i.id.channelId}`:"",thumbnailUrl:(g=(v=i.snippet.thumbnails)==null?void 0:v.medium)==null?void 0:g.url}})}}async function Nt(e,t={}){const a=Math.min(t.num||5,10),r=t.site?`site:${t.site} ${e}`:e;try{const s=new URLSearchParams({q:r}),n=await fetch(`https://html.duckduckgo.com/html/?${s}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!n.ok)return{results:[],error:`Search request failed (${n.status})`};const i=await n.text(),o=[],l=i.split(/class="result results_links/g).slice(1);for(const c of l){if(o.length>=a)break;const d=c.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),p=c.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(d){let h=d[1];const v=h.match(/uddg=([^&]+)/);v?h=decodeURIComponent(v[1]):h.startsWith("//")&&(h="https:"+h);const g=T=>T.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),x=g(d[2]),w=p?g(p[1]):"";if(x&&h.startsWith("http")){const T=h.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];o.push({title:x,link:h,snippet:w,displayLink:T})}}}return o.length===0?{results:[],error:void 0}:{results:o}}catch(s){return{results:[],error:`Web search error: ${s.message}`}}}async function ur(e,t,a,r="driving"){var l,c,d,p;const s=new URLSearchParams({origins:t,destinations:a,key:e,mode:r,departure_time:"now"}),n=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${s}`);if(!n.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${n.status}`};const i=await n.json(),o=(d=(c=(l=i.rows)==null?void 0:l[0])==null?void 0:c.elements)==null?void 0:d[0];return!o||o.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(o==null?void 0:o.status)||i.status}`}:{distance:o.distance.text,duration:o.duration.text,durationInTraffic:(p=o.duration_in_traffic)==null?void 0:p.text}}const Cs=Object.freeze(Object.defineProperty({__proto__:null,geocode:cr,getDirections:or,getDistanceMatrix:ur,getPlaceDetails:ir,searchPlaces:nr,searchYouTube:dr,translateText:lr,webSearch:Nt},Symbol.toStringTag,{value:"Module"})),ve="https://gmail.googleapis.com/gmail/v1/users/me";class we{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await rt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var o;const a=await this.authHeaders(),r=new URLSearchParams;if(r.set("maxResults",String(t.maxResults||10)),t.query&&r.set("q",t.query),(o=t.labelIds)!=null&&o.length)for(const l of t.labelIds)r.append("labelIds",l);const s=await fetch(`${ve}/messages?${r}`,{headers:a});if(!s.ok){const l=await s.text();throw new Error(`Gmail list failed (${s.status}): ${l.substring(0,200)}`)}const n=await s.json();if(!n.messages||n.messages.length===0)return[];const i=[];for(const l of n.messages.slice(0,t.maxResults||10))try{const c=await this.getMessage(l.id,a);c&&i.push(c)}catch{}return i}async getMessage(t,a){const r=a||await this.authHeaders(),s=await fetch(`${ve}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:r});if(!s.ok)return null;const n=await s.json(),i=o=>{var l,c,d;return((d=(c=(l=n.payload)==null?void 0:l.headers)==null?void 0:c.find(p=>p.name.toLowerCase()===o.toLowerCase()))==null?void 0:d.value)||""};return{id:n.id,threadId:n.threadId,snippet:n.snippet||"",subject:i("Subject")||"(no subject)",from:i("From"),to:i("To"),date:i("Date")||new Date(parseInt(n.internalDate)).toISOString(),isUnread:(n.labelIds||[]).includes("UNREAD"),labels:n.labelIds||[]}}async getMessageBody(t){const a=await this.authHeaders(),r=await fetch(`${ve}/messages/${t}?format=full`,{headers:a});if(!r.ok){const n=await r.text();throw new Error(`Gmail message body failed (${r.status}): ${n.substring(0,200)}`)}const s=await r.json();return pr(s.payload)}async search(t,a=10){return this.listMessages({query:t,maxResults:a})}async send(t,a,r,s={}){const n=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];s.cc&&i.push(`Cc: ${s.cc}`),s.bcc&&i.push(`Bcc: ${s.bcc}`),s.replyToMessageId&&(i.push(`In-Reply-To: ${s.replyToMessageId}`),i.push(`References: ${s.replyToMessageId}`)),i.push("",r);const o=i.join(`\r
`),c={raw:ca(o)};s.threadId&&(c.threadId=s.threadId);const d=await fetch(`${ve}/messages/send`,{method:"POST",headers:n,body:JSON.stringify(c)});if(!d.ok){const p=await d.text();throw new Error(`Gmail send failed (${d.status}): ${p.substring(0,200)}`)}return await d.json()}async createDraft(t,a,r,s={}){const n=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];s.cc&&i.push(`Cc: ${s.cc}`),i.push("",r);const o=i.join(`\r
`),l=ca(o),c=await fetch(`${ve}/drafts`,{method:"POST",headers:n,body:JSON.stringify({message:{raw:l}})});if(!c.ok){const d=await c.text();throw new Error(`Gmail draft failed (${c.status}): ${d.substring(0,200)}`)}return await c.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${ve}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const r=await this.authHeaders();let s={};switch(a){case"archive":s={removeLabelIds:["INBOX"]};break;case"trash":s={addLabelIds:["TRASH"]};break;case"read":s={removeLabelIds:["UNREAD"]};break;case"unread":s={addLabelIds:["UNREAD"]};break;case"star":s={addLabelIds:["STARRED"]};break;case"unstar":s={removeLabelIds:["STARRED"]};break}const n=await fetch(`${ve}/messages/${t}/modify`,{method:"POST",headers:{...r,"Content-Type":"application/json"},body:JSON.stringify(s)});if(!n.ok){const i=await n.text();throw new Error(`Failed to modify message: ${i}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${ve}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${ve}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function pr(e){var t,a,r;if(!e)return"";if((t=e.body)!=null&&t.data)return Pt(e.body.data);if(e.parts){for(const s of e.parts)if(s.mimeType==="text/plain"&&((a=s.body)!=null&&a.data))return Pt(s.body.data);for(const s of e.parts)if(s.mimeType==="text/html"&&((r=s.body)!=null&&r.data)){const n=Pt(s.body.data);return Os(n)}for(const s of e.parts)if(s.parts){const n=pr(s);if(n)return n}}return e.snippet||""}function ca(e){const t=new TextEncoder().encode(e);let a="";for(let r=0;r<t.length;r++)a+=String.fromCharCode(t[r]);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Pt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function Os(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const Rs=1e4,Ns=1e4;async function mr(e,t){try{const a=new AbortController,r=setTimeout(()=>a.abort(),Ns),s=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!s.ok)return{text:"",error:`HTTP ${s.status}`};const n=s.headers.get("content-type")||"";if(!n.includes("text/html")&&!n.includes("text/plain")&&!n.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${n.split(";")[0]}`};const i=await s.text();clearTimeout(r);const o=i.length>2e5?i.substring(0,2e5):i,l=As(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||Rs)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function As(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}const Ls=1e4;async function Ms(e,t){var s,n,i;const a=new AbortController,r=setTimeout(()=>a.abort(),Ls);try{const o=await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",signal:a.signal,headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:e}],max_tokens:2e3})});if(clearTimeout(r),!o.ok)return{report:"",sources:[],pagesRead:0,error:`Perplexity error ${o.status}`};const l=await o.json(),c=((i=(n=(s=l==null?void 0:l.choices)==null?void 0:s[0])==null?void 0:n.message)==null?void 0:i.content)||"",p=((l==null?void 0:l.citations)||[]).map(h=>({title:h,url:h,snippet:""}));return{report:c,sources:p,pagesRead:p.length}}catch(o){return clearTimeout(r),{report:"",sources:[],pagesRead:0,error:`Perplexity request failed: ${o.message}`}}}async function hr(e,t,a={}){if(a.perplexityApiKey){const h=await Ms(e,a.perplexityApiKey);if(!h.error)return h}const r=a.maxPages||(a.depth==="thorough"?5:3),s=a.maxResults||(a.depth==="thorough"?8:5),n=await Nt(e,{num:s,site:a.site});if(n.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${n.error}`};if(n.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=n.results.slice(0,r).map(async h=>{const v=await mr(h.link);return{title:h.title,url:h.link,displayLink:h.displayLink,snippet:h.snippet,content:v.text,error:v.error}}),c=(await Promise.all(o)).filter(h=>h.content.length>50);if(c.length===0){const h=n.results.map((g,x)=>`[${x+1}] ${g.title}
${g.snippet}
Source: ${g.link}`).join(`

`);return{report:await da(e,h,t,"snippets"),sources:n.results.map(g=>({title:g.title,url:g.link})),pagesRead:0}}const d=c.map((h,v)=>`--- SOURCE ${v+1}: ${h.title} (${h.displayLink}) ---
${h.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await da(e,d,t,"full"),sources:c.map(h=>({title:h.title,url:h.url})),pagesRead:c.length}}async function da(e,t,a,r){const n=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
${r}
`:"",o=ua(t,Us);return`You are ${s} — a personal AI assistant. Your name is ${s} — always refer to yourself by this name if asked.
...
- **Long content intent check**: When asked to write long-form content (essay, article, report — likely over 200 words) WITHOUT a save destination specified, do NOT start writing. Ask first: "Should I save this as a Google Doc and send you the link, or write it here in chat?" Wait for the response. If Drive/Doc, call \`create_doc\` with full content and return only the link. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**`:""}`}async function ma(e,t,a){var c;const s=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let n;((c=s.files)==null?void 0:c.length)>0?n=s.files[0].id:n=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${n}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:n,folderName:a}}function wr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function It(e,t,a,r,s,n,i,o,l,c,d,p,h){const v=Date.now();let g=!0,x="",w="";try{return w=await Gs(e,t,a,r,n,i,o,l,c,d,p,h),w}catch(T){throw g=!1,x=T.message||"Unknown error",T}finally{const T=Date.now()-v;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,s.agentType||null,s.providerName||null,e,JSON.stringify(t).substring(0,2e3),(g?w:"").substring(0,500),g?1:0,x||null,T,s.isEnforcementRetry?1:0,s.channel||"web").run()}catch{}}}function Hs(e){const t=[];let a=[],r="",s=!1,n=0;const i=e.length;for(;n<i;){const o=e[n];if(s){if(o==='"'){if(e[n+1]==='"'){r+='"',n+=2;continue}s=!1,n++;continue}r+=o,n++;continue}if(o==='"'){s=!0,n++;continue}if(o===","){a.push(r),r="",n++;continue}if(o==="\r"&&e[n+1]===`
`){a.push(r),t.push(a),a=[],r="",n+=2;continue}if(o===`
`||o==="\r"){a.push(r),t.push(a),a=[],r="",n++;continue}r+=o,n++}for((r||a.length)&&(a.push(r),t.push(a));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function Gs(e,t,a,r,s,n,i,o,l,c,d,p){var v,g,x,w,T,_,C,R,$,G,F,W,H,K,D,B;const h=new ue(a);switch(e){case"create_schedule":{const u=new Date;let y;const m=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(u.getTime()+t.minutes_from_now*60*1e3);const I=y.toLocaleString("en-US",{timeZone:m,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[L,j,N]=(I[0]||"").split("/");t.schedule_value=`${N}-${L}-${j} ${I[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const S=parseInt(t.schedule_value,10);y=new Date(u.getTime()+S*60*1e3)}else if(t.schedule_type==="daily"){const[S,I]=t.schedule_value.split(":").map(Number),L=u.toLocaleString("en-US",{timeZone:m}),j=new Date(L),N=new Date(j);N.setHours(S,I,0,0),N<=j&&N.setDate(N.getDate()+1);const M=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),q=new Date(N.toLocaleString("en-US",{timeZone:m})),Y=M.getTime()-q.getTime();y=new Date(N.getTime()+Y)}else if(t.schedule_type==="weekly"){const[S,I]=t.schedule_value.split(" "),[L,j]=(I||"00:00").split(":").map(Number),M=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Fe=>Fe.toLowerCase()===S.toLowerCase()),q=u.toLocaleString("en-US",{timeZone:m}),Y=new Date(q),J=new Date(Y);J.setHours(L,j,0,0);let te=(M-J.getDay()+7)%7;te===0&&J<=Y&&(te=7),J.setDate(J.getDate()+te);const X=new Date(J.toLocaleString("en-US",{timeZone:"UTC"})),se=new Date(J.toLocaleString("en-US",{timeZone:m})),le=X.getTime()-se.getTime();y=new Date(J.getTime()+le)}else if(t.schedule_type==="once"){const[S,I]=t.schedule_value.split(" "),[L,j,N]=S.split("-").map(Number),[M,q]=(I||"00:00").split(":").map(Number),Y=u.toLocaleString("en-US",{timeZone:m}),J=new Date(Y),te=new Date(J);te.setFullYear(L,j-1,N),te.setHours(M,q,0,0);const X=new Date(te.toLocaleString("en-US",{timeZone:"UTC"})),se=new Date(te.toLocaleString("en-US",{timeZone:m})),le=X.getTime()-se.getTime();y=new Date(te.getTime()+le);const Fe=new Date(u.getTime()+120*1e3);if(y.getTime()<u.getTime()+60*1e3){const At=y.toISOString();y=Fe;const st=` [Note: The requested time ${t.schedule_value} in ${m} resolved to ${At} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=st}}else y=new Date(u.getTime()+3600*1e3);if(await a.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(r,t.name,t.schedule_type,t.schedule_value).first()){const S=y.toLocaleString("en-US",{timeZone:m,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${S} (${m}). No duplicate created.`}await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),y.toISOString()).run();const E=t._pastTimeWarning||"",k=y.toLocaleString("en-US",{timeZone:m,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${k} (${m}). [UTC: ${y.toISOString()}]${E}. IMPORTANT: Use the exact time "${k}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const y=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return y.length===0?"No scheduled tasks found.":y.map(m=>`[ID:${m.id}] ${m.enabled?"▶":"⏸"} "${m.name}" — [${m.schedule_type}] ${m.schedule_value} — ${m.action_type} — state: ${m.state||"active"} — next: ${m.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,y=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,y,t.job_id,r).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],y=t.state;if(!u.includes(y))return`Invalid state "${y}". Valid states: ${u.join(", ")}`;const m=y==="completed"||y==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,m,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"update_schedule":{const u=t.job_id,y=c||"UTC",m=new Date,f=["updated_at = CURRENT_TIMESTAMP"],E=[];t.name&&(f.push("name = ?"),E.push(t.name)),t.description&&(f.push("description = ?"),E.push(t.description));let k=null,S=t.schedule_type,I=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){k=new Date(m.getTime()+t.minutes_from_now*60*1e3);const N=k.toLocaleString("en-US",{timeZone:y,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[M,q,Y]=(N[0]||"").split("/");I=`${Y}-${M}-${q} ${N[1]||"00:00"}`,S="once"}else if(S&&I){if(S==="interval")k=new Date(m.getTime()+parseInt(I,10)*60*1e3);else if(S==="daily"){const[j,N]=I.split(":").map(Number),M=new Date(m.toLocaleString("en-US",{timeZone:y})),q=new Date(M);q.setHours(j,N,0,0),q<=M&&q.setDate(q.getDate()+1);const Y=new Date(q.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(q.toLocaleString("en-US",{timeZone:y})).getTime();k=new Date(q.getTime()+Y)}else if(S==="weekly"){const[j,N]=I.split(" "),[M,q]=(N||"00:00").split(":").map(Number),J=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Fe=>Fe.toLowerCase()===j.toLowerCase()),te=new Date(m.toLocaleString("en-US",{timeZone:y})),X=new Date(te);X.setHours(M,q,0,0);let se=(J-X.getDay()+7)%7;se===0&&X<=te&&(se=7),X.setDate(X.getDate()+se);const le=new Date(X.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(X.toLocaleString("en-US",{timeZone:y})).getTime();k=new Date(X.getTime()+le)}else if(S==="once"){const[j,N]=I.split(" "),[M,q,Y]=j.split("-").map(Number),[J,te]=(N||"00:00").split(":").map(Number),X=new Date(m.toLocaleString("en-US",{timeZone:y})),se=new Date(X);se.setFullYear(M,q-1,Y),se.setHours(J,te,0,0);const le=new Date(se.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(se.toLocaleString("en-US",{timeZone:y})).getTime();k=new Date(se.getTime()+le),k.getTime()<m.getTime()+60*1e3&&(k=new Date(m.getTime()+120*1e3))}}if(S&&(f.push("schedule_type = ?"),E.push(S)),I&&(f.push("schedule_value = ?"),E.push(I)),k&&(f.push("next_run = ?"),E.push(k.toISOString())),f.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";E.push(u,r),await a.prepare(`UPDATE cron_jobs SET ${f.join(", ")} WHERE id = ? AND user_id = ?`).bind(...E).run();const L=k?k.toLocaleString("en-US",{timeZone:y,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${L?` New fire time: ${L} (${y}).`:""} IMPORTANT: Use this exact time "${L}" when confirming to the user.`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,y=t.type==="task"?"preference":t.type,m=u>=7?"working":"long_term";return await h.store(r,y,t.title,t.content,u,m),`Stored in ${m==="working"?"working":"long-term"} memory: [${y}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await h.search(r,t.query);return u.length===0?"No matching memories found.":u.map(y=>`[id:${y.id}] [${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
`)}case"delete_memory":return await h.remove(t.id,r),`Memory entry ${t.id} deleted.`;case"update_memory":return await h.update(t.id,r,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const u=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),y=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),m=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),f=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),E=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(E==null?void 0:E.cnt)||0}`}case"read_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||""),y=t.spreadsheet_id;let m=t.range;const f=await u.sheets.getMetadata(y),E=f.sheets;m.includes("!")||(m=`${E[0]}!${m}`);let k;try{k=await u.sheets.readRange(y,m)}catch(I){if((v=I.message)!=null&&v.includes("Unable to parse range")||(g=I.message)!=null&&g.includes("400")){const L=m.includes("!")?m.split("!")[1]:m;m=`${E[0]}!${L}`,k=await u.sheets.readRange(y,m)}else throw I}let S=`[Spreadsheet: "${f.title}" | Reading tab: "${m.split("!")[0]}" | All tabs in this spreadsheet: ${E.map(I=>`"${I}"`).join(", ")}]
`;return E.length>1&&(S+=`[To read a different tab, call read_sheet again with range like "${E[1]}!A1:Z500"]
`),k.length===0?S+"No data found in the specified range.":S+k.map(I=>I.join("	| ")).join(`
`)}catch(u){return await P(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||""),y=t.values;let m=t.range;const k=Math.max(...y.map(j=>j.length))+4,S=y.map(j=>{const N=[...j];for(;N.length<k;)N.push("");return N}),I=m.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(I){const j=I[1]||"",N=I[2],M=I[3],q=I[5],J=N.toUpperCase().charCodeAt(0)-64+k-1,te=J<=26?String.fromCharCode(64+J):"Z";m=`${j}${N}${M}:${te}${q}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,m,S)).updatedCells} cells to ${m}.`}catch(u){return await P(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!s)return"Authentication context unavailable.";try{return`Appended ${(await new fe(a,r,s,n||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await P(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let f="";if(t.folder_name)try{const{token:E}=await(await Promise.resolve().then(()=>lt)).getGoogleAuth(a,r,s,n||"",i||"");f=`
Folder: "${(await ma(E,m.spreadsheetId,t.folder_name)).folderName}"`}catch(E){f=`
(Could not move to folder "${t.folder_name}": ${E.message})`}try{await new ue(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${m.spreadsheetId} | URL: ${m.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${f}
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(u){return await P(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||""),y=t.calendar_id||"primary",m=t.days_ahead||7,f=new Date,E=new Date(f.getTime()+m*24*60*60*1e3),k=await u.calendar.listEvents(y,{timeMin:f.toISOString(),timeMax:E.toISOString(),query:t.query});return k.length===0?`No events found in the next ${m} days.`:k.map(S=>{var M;const I=S.start.dateTime||S.start.date||"TBD",L=S.end.dateTime||S.end.date||"",j=S.location?` 📍 ${S.location}`:"",N=((M=S.attendees)==null?void 0:M.map(q=>q.email).join(", "))||"";return`• ${S.summary} — ${I} to ${L}${j}${N?`
  Attendees: ${N}`:""}`}).join(`
`)}catch(u){return await P(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||""),y=t.calendar_id||"primary",m=await u.calendar.createEvent(y,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${m.summary}"
ID: ${m.id}
Start: ${m.start.dateTime||m.start.date}`}catch(u){return await P(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(m.documentId,t.content);let f="";if(t.folder_name)try{const{token:E}=await(await Promise.resolve().then(()=>lt)).getGoogleAuth(a,r,s,n||"",i||"");f=`
Folder: "${(await ma(E,m.documentId,t.folder_name)).folderName}"`}catch(E){f=`
(Could not move to folder "${t.folder_name}": ${E.message})`}try{await new ue(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${m.documentId} | URL: ${m.url}`,6,"working")}catch{}return`Document created: "${t.title}"${f}
ID: ${m.documentId}
URL: ${m.url}`}catch(u){return await P(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!s)return"Authentication context unavailable.";try{const y=await new fe(a,r,s,n||"",i||"").docs.readDocument(t.document_id);return`Document: "${y.title}"

${y.content}`}catch(u){return await P(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!s)return"Authentication context unavailable.";try{const u=new fe(a,r,s,n||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let m=t.document_id;try{m=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${m}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await P(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!s)return"Authentication context unavailable.";try{const y=await new we(a,r,s,n||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return y.length===0?"No messages found.":y.map((m,f)=>`${m.isUnread?"● ":"  "}${f+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await P(a,r,"gmail","list",u.message),(x=u.message)!=null&&x.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!s)return"Authentication context unavailable.";try{const u=new we(a,r,s,n||"",i||""),y=await u.getMessage(t.message_id);if(!y)return"Message not found.";const m=await u.getMessageBody(t.message_id);return`**${y.subject}**
From: ${y.from}
To: ${y.to}
Date: ${y.date}

${m}`}catch(u){return await P(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!s)return"Authentication context unavailable.";try{const y=await new we(a,r,s,n||"",i||"").search(t.query,t.max_results||10);return y.length===0?`No results for: ${t.query}`:y.map((m,f)=>`${m.isUnread?"● ":"  "}${f+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await P(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!s)return"Authentication context unavailable.";try{const y=await new we(a,r,s,n||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${y.id}]`}catch(u){return await P(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!s)return"Authentication context unavailable.";try{const y=await new we(a,r,s,n||"",i||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),m=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${m}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${y.id}]`}catch(u){return await P(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!s)return"Authentication context unavailable.";try{return await new we(a,r,s,n||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await P(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!s)return"Authentication context unavailable.";try{const y=await new we(a,r,s,n||"",i||"").getUnreadCount();return`You have ${y} unread email${y!==1?"s":""} in Gmail.`}catch(u){return(w=u.message)!=null&&w.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>lt)).getGoogleAuth(a,r,s,n||"",i||""),y=new URLSearchParams;y.set("pageSize",String(t.max_results||10)),y.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),y.set("orderBy","modifiedTime desc");let m="";t.folder_id?m=`'${t.folder_id}' in parents and trashed = false`:t.query?m=`${t.query} and trashed = false`:m="trashed = false",y.set("q",m);const f=await fetch(`https://www.googleapis.com/drive/v3/files?${y}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const E=await f.json();return(T=E.files)!=null&&T.length?E.files.map((k,S)=>{var N,M;const I=((N=k.mimeType)==null?void 0:N.split(".").pop())||k.mimeType,L=k.size?`${(parseInt(k.size)/1024).toFixed(1)} KB`:"",j=((M=k.modifiedTime)==null?void 0:M.split("T")[0])||"";return`${S+1}. **${k.name}** (${I})
   ${L} · Modified: ${j}
   ${k.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await P(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>lt)).getGoogleAuth(a,r,s,n||"",i||""),y=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,m=new URLSearchParams;m.set("q",y),m.set("pageSize",String(t.max_results||10)),m.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),m.set("orderBy","modifiedTime desc");const f=await fetch(`https://www.googleapis.com/drive/v3/files?${m}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const E=await f.json();return(_=E.files)!=null&&_.length?E.files.map((k,S)=>{var j,N;const I=((j=k.mimeType)==null?void 0:j.split(".").pop())||k.mimeType,L=((N=k.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${S+1}. **${k.name}** (${I}) — Modified: ${L}
   ${k.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await P(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"drive_read_file":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>lt)).getGoogleAuth(a,r,s,n||"",i||""),y=t.url_or_id.trim();let m=y;const f=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const Y of f){const J=y.match(Y);if(J){m=J[1];break}}const E=await fetch(`https://www.googleapis.com/drive/v3/files/${m}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${u}`}});if(!E.ok)throw new Error(`Drive API error (${E.status}): could not fetch file metadata`);const k=await E.json(),{name:S,mimeType:I}=k,L=t.extract_focus,j=L?`Focus specifically on extracting: ${L}`:"Extract and return all readable text content. Preserve structure where relevant.",N={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(N[I]){const Y=N[I],J=await fetch(`https://www.googleapis.com/drive/v3/files/${m}/export?mimeType=${encodeURIComponent(Y)}`,{headers:{Authorization:`Bearer ${u}`}});if(!J.ok)throw new Error(`Drive export error (${J.status})`);const te=await J.text();if(I==="application/vnd.google-apps.spreadsheet"){const X=Hs(te),se=X.length,le=((C=X[0])==null?void 0:C.length)??0;return`**${S}** (Google Sheet — ${se} rows × ${le} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(X)}`}return`**${S}**

${te.substring(0,2e4)}`}if(I==="application/pdf"||S.toLowerCase().endsWith(".pdf")){const Y=await fetch(`https://www.googleapis.com/drive/v3/files/${m}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!Y.ok)throw new Error(`Drive download error (${Y.status})`);const J=await Y.arrayBuffer(),te=Buffer.from(J).toString("base64");let X=null,se="claude-haiku-4-5-20251001";for(const st of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const ta=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,st).first();if(ta&&s){const Cr=await Z(ta.encrypted_value,s),_t=JSON.parse(Cr);if(_t.provider==="anthropic"){X=_t.apiKey,_t.model&&(se=_t.model);break}}}catch{}if(!X)return`"${S}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const le=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":X,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:se,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:te}},{type:"text",text:j}]}]})});if(!le.ok){const st=await le.text();throw new Error(`Anthropic PDF extraction error: ${st.substring(0,200)}`)}const At=(($=(R=(await le.json()).content)==null?void 0:R[0])==null?void 0:$.text)||"";return`**${S}** (PDF from Drive)

${At}`}const M=await fetch(`https://www.googleapis.com/drive/v3/files/${m}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!M.ok)throw new Error(`Drive download error (${M.status})`);const q=await M.text();return`**${S}** (${I})

${q.substring(0,2e4)}`}catch(u){return await P(a,r,"google","drive_read_file",u.message),`Drive read error: ${u.message}`}}case"web_search":try{const u=await Nt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((y,m)=>`${m+1}. **${y.title}**
   ${y.link}
   ${y.snippet}`).join(`

`)}catch(u){return await P(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:m}=await Promise.resolve().then(()=>$s),f=await m(u,y);return f.error?`Failed to read page: ${f.error}`:!f.text||f.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${f.text.length} chars):

${f.text}`}catch(u){return await P(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{let u;try{const S=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"perplexity_api_key").first();S&&s&&(u=await Z(S.encrypted_value,s))}catch{}const y=2e4,m=hr(t.query,d,{depth:t.depth||"quick",site:t.site,perplexityApiKey:u}),f=new Promise(S=>setTimeout(()=>S(null),y)),E=await Promise.race([m,f]);if(E===null){const{webSearch:S}=await Promise.resolve().then(()=>Cs),I=await S(t.query,{num:5});if(I.error||I.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let L=`Research took too long, but here are the top search results:

`;return L+=I.results.map((j,N)=>`${N+1}. **${j.title}**
   ${j.snippet}
   ${j.link}`).join(`

`),L}if(E.error)return`Research failed: ${E.error}`;let k=E.report;return E.sources.length>0&&(k+=`

---
**Sources** (`+E.pagesRead+` pages read):
`,k+=E.sources.map((S,I)=>`[${I+1}] ${S.title}
    ${S.url}`).join(`
`)),k}catch(u){return await P(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await Z(u.encrypted_value,s),m=await nr(y,t.query,{type:t.type});return m.error?`Places search failed: ${m.error}`:m.results.length===0?`No places found for "${t.query}".`:m.results.map((f,E)=>{const k=f.rating?` ★${f.rating} (${f.userRatingsTotal||0} reviews)`:"",S=f.openNow!==void 0?f.openNow?" · Open now":" · Closed":"",I=f.googleMapsUri?`
   ${f.googleMapsUri}`:"";return`${E+1}. **${f.name}**${k}${S}
   ${f.address}${I}
   [place_id: ${f.placeId}]`}).join(`

`)}catch(u){return await P(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Z(u.encrypted_value,s),m=await ir(y,t.place_id);if(m.error)return`Details lookup failed: ${m.error}`;if(!m.details)return"No details found.";const f=m.details;let E=`**${f.name}**
...
— ${k.author} (★${k.rating}, ${k.time}): "${k.text}"`}return E}catch(u){return await P(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Z(u.encrypted_value,s),m=await or(y,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const f=m.route;let E=`**${f.startAddress}** → **${f.endAddress}**
`;return E+=`📏 ${f.distance} · ⏱️ ${f.duration}`,f.durationInTraffic&&(E+=` (with traffic: ${f.durationInTraffic})`),E+=`
via ${f.summary}`,E+=`

Steps:`,f.steps.forEach((k,S)=>{E+=`
${S+1}. ${k.instruction} (${k.distance}, ${k.duration})`}),E}catch(u){return await P(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Z(u.encrypted_value,s),m=await ur(y,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let f=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(f+=` (with traffic: ${m.durationInTraffic})`),f}catch(u){return await P(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Z(u.encrypted_value,s),m=await lr(y,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(u){return await P(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Z(u.encrypted_value,s),m=await dr(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((f,E)=>{var k;return`${E+1}. **${f.title}**
   ${f.channelTitle} · ${((k=f.publishedAt)==null?void 0:k.split("T")[0])||""}
   ${f.description}
   ${f.url}`}).join(`

`)}catch(u){return await P(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Z(u.encrypted_value,s),m=await cr(y,t.address);return m.error?`Geocoding failed: ${m.error}`:m.results.length===0?`Location not found: "${t.address}"`:m.results.map((f,E)=>`${E+1}. ${f.address}
   Coordinates: ${f.lat}, ${f.lng}`).join(`
`)}catch(u){return await P(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}case"parse_document":{const u=t.file_id,y=t.extract_focus;if(!u)return"file_id is required to parse a document.";const m=await a.prepare("SELECT file_name, file_type, file_data, file_size FROM uploaded_files WHERE id = ? AND user_id = ?").bind(u,r).first();if(!m)return"File not found. The file may have expired or the file_id is incorrect.";const{file_name:f,file_type:E}=m;let{file_data:k}=m;if(k==="r2"){if(!p)return`File "${f}" is stored in R2 but no storage bucket is configured.`;const S=await p.get(u);if(!S)return`File "${f}" not found in storage. It may have been deleted.`;const I=await S.arrayBuffer();k=Buffer.from(I).toString("base64")}if(E.startsWith("text/"))try{const S=Buffer.from(k,"base64").toString("utf-8");return`Document: ${f}

${S.substring(0,2e4)}`}catch{return`Could not decode text file: ${f}`}if(E==="application/pdf"||E==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||f.toLowerCase().endsWith(".pdf")||f.toLowerCase().endsWith(".docx")){let S=null,I="claude-haiku-4-5-20251001";for(const L of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const j=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,L).first();if(j&&s){const N=await Z(j.encrypted_value,s),M=JSON.parse(N);if(M.provider==="anthropic"){S=M.apiKey,M.model&&(I=M.model);break}}}catch{}if(S)try{const L=y?`Focus specifically on extracting: ${y}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",N=E==="application/pdf"||f.toLowerCase().endsWith(".pdf")?"application/pdf":"application/vnd.openxmlformats-officedocument.wordprocessingml.document",M=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":S,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:I,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:N,data:k}},{type:"text",text:L}]}]})});if(M.ok){const Y=((F=(G=(await M.json()).content)==null?void 0:G[0])==null?void 0:F.text)||"";return`Document: ${f}

${Y}`}else{const q=await M.text();return`Could not parse ${f} via Anthropic API: ${q.substring(0,200)}`}}catch(L){return`Document parsing error for ${f}: ${L.message}`}if(f.toLowerCase().endsWith(".docx"))try{const N=Buffer.from(k,"base64").toString("utf-8").replace(/<[^>]+>/g," ").replace(/\s+/g," ").trim().substring(0,1e4);if(N.length>100)return`Document: ${f} (rough text extraction)

${N}`}catch{}return"To parse PDF/Word documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}try{const S=Buffer.from(k,"base64").toString("utf-8").substring(0,2e3);return`Document: ${f} (${E})

Content preview:
${S}`}catch{return`Cannot read file: ${f} (${E})`}}case"create_skill":{const u=(W=t.name)==null?void 0:W.trim(),y=(H=t.description)==null?void 0:H.trim(),m=(K=t.instructions)==null?void 0:K.trim();if(!u||!y||!m)return"create_skill requires name, description, and instructions.";let f=u.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");f||(f=`skill_${Date.now()}`);const E=await a.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(r,`${f}%`).all();(D=E.results)!=null&&D.some(L=>L.slug===f)&&(f=`${f}_${(((B=E.results)==null?void 0:B.length)||0)+1}`);const k=JSON.stringify(t.parameters||{}),S=JSON.stringify(t.required_tools||[]),I=JSON.stringify(t.examples||[]);return await a.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,u,f,y,m,k,S,I).run(),`Skill created: **${u}** (invoke as: "${f}")
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function br(e,t,a,r,s){if(t.length>0&&t[t.length-1].role==="user"){const n="(Previous request did not complete. Please try again.)";await e.storeMessage(a,r,"assistant",n,"{}",s),t.push({id:-1,user_id:a,channel:r,role:"assistant",content:n,metadata:"{}",token_estimate:n.length,created_at:new Date().toISOString()})}}function _r(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function ha(e,t,a,r,s,n,i){var K,D,B,u,y;const o=new ue(t),l=(K=e.metadata)==null?void 0:K.thread_id,c=Date.now(),[d,p]=await Promise.all([o.buildContext(r.id),Qt(t,r.id)]),h=await o.getRecentConversations(r.id,30,l);await br(o,h,r.id,e.channel,l);const v=vr(r,d,e.channel,p),g=yr([{role:"system",content:v},...h.map(m=>({role:m.role,content:m.content})),{role:"user",content:e.text}]);_r(g);const x=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],w=(d.match(/^- /gm)||[]).length;if(x.some(m=>m.test(e.text))||w<3)try{const m=await o.searchLongTerm(r.id,e.text,5);if(m.length>0){const f=m.map(E=>`- [${E.type}] ${E.title}: ${E.content}`).join(`
...
${f}]`})}}catch{}await o.storeMessage(r.id,e.channel,"user",e.text,"{}",l);const _=(i==null?void 0:i.maxTurns)??10,C=(i==null?void 0:i.tools)??await Xt(t,r.id);let R="",$=0;const G=[];for(let m=0;m<_;m++)try{const f=await a.chat(g,{tools:C});if(f.usage&&($+=f.usage.promptTokens+f.usage.completionTokens),f.toolCalls&&f.toolCalls.length>0){const E=f.content||`[calling: ${f.toolCalls.map(S=>S.name).join(", ")}]`;g.push({role:"assistant",content:E});for(const S of f.toolCalls)G.push(S.name);const k=await Promise.all(f.toolCalls.map(async S=>{try{const I=await It(S.name,S.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a,n==null?void 0:n.DOCUMENTS_BUCKET);return`[Tool Result for ${S.name}]: ${I}`}catch(I){return await P(t,r.id,"tool",S.name,I.message||"Tool execution failed"),`[Tool Error for ${S.name}]: ${I.message||"Execution failed"}`}}));g.push({role:"user",content:k.join(`

`)});continue}R=f.content;break}catch(f){if(s){const E=f.message||"",k=E.includes("401")||E.includes("403")||E.includes("authentication")||E.includes("credit balance"),S=E.includes("429"),I=k?1440:S?10:5;await s.recordError(a.name,E,I)}throw await P(t,r.id,"llm","provider_error",f.message||"Unknown LLM error",{provider:a.name,turn:m}),f}if(R=(R==null?void 0:R.trim())??"",!R)try{((D=g[g.length-1])==null?void 0:D.role)==="user"&&g.push({role:"assistant",content:"[gathering results]"}),g.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),R=(await a.chat(g,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me directly and I will answer from my knowledge."}catch{R="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge."}if(s&&$>0)try{await s.recordUsage(a.name,$)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",$,Date.now()-c,1,e.channel).run()}catch{}const F=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your|the)\s+(sheet|spreadsheet))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"}];for(const m of F){const f=m.claimPattern.test(R),E=m.requiredTools.some(k=>G.includes(k));if(f&&!E){try{await P(t,r.id,"llm",m.logType,"LLM claimed action without tool call",{response:R.substring(0,200)}),g.push({role:"assistant",content:R}),g.push({role:"user",content:m.enforcementMsg});const k=await a.chat(g,{tools:C.filter(S=>m.requiredTools.includes(S.name)),temperature:0});if((B=k.toolCalls)!=null&&B.length){for(const I of k.toolCalls){const L=await It(I.name,I.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a,n==null?void 0:n.DOCUMENTS_BUCKET);G.push(I.name),g.push({role:"assistant",content:null,toolCalls:k.toolCalls}),g.push({role:"user",content:L})}const S=await a.chat(g,{tools:[]});S.content&&(R=S.content)}else R="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}let W=R.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").trim();if(!W&&G.length>0){const m=[...new Set(G)].join(", ");try{((u=g[g.length-1])==null?void 0:u.role)==="user"&&g.push({role:"assistant",content:"[completed tools]"}),g.push({role:"user",content:"Please summarise what you just did and provide the result to the user."}),W=((y=(await a.chat(g,{tools:[]})).content)==null?void 0:y.trim())||`Done. I used the following tools: ${m}.`}catch{W=`Done. I used the following tools: ${m}.`}}const H=G.length>0?`[TOOLS_USED: ${[...new Set(G)].join(", ")}] `:"";await o.storeMessage(r.id,e.channel,"assistant",H+W,"{}",l),await o.compactHistory(r.id,30);try{const m=await t.prepare("SELECT COUNT(*) as c FROM conversations WHERE user_id = ? AND role = ?").bind(r.id,"assistant").first();m&&m.c%5===0&&m.c>0&&await Promise.race([Fs(t,a,r,o,g),new Promise(f=>setTimeout(f,5e3))])}catch{}return W}async function Fs(e,t,a,r,s){var d;const n=s.filter(p=>p.role!=="system").slice(-10);if(n.length<4)return;const o=[{role:"system",content:`Review this conversation and extract any information worth remembering long-term.
...
`)){const h=p.trim().split("|");if(h.length<4)continue;const[v,g,x,w]=h,T=["fact","preference","context","decision","summary","task"].find(C=>C===v.trim().toLowerCase());if(!T||!(g!=null&&g.trim())||!(x!=null&&x.trim()))continue;const _=Math.min(10,Math.max(1,parseInt(w)||5));await r.store(a.id,T,g.trim(),x.trim(),_,"long_term")}}const ga={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function qs(e){for(const[t,a]of Object.entries(ga))if(e.toLowerCase().includes(t.toLowerCase()))return a;return ga.default}function Ws(e,t,a,r){const s=qs(r),n=Math.floor(s*.75),i=[];let o=0,l=!1;const c=Ut(e);i.push({role:"system",content:e}),o+=c;const d=Ut(a);o+=d;const p=n-o,h=[];let v=0;for(let g=t.length-1;g>=0;g--){const x=t[g],w=Ut(x.content);if(v+w<=p)h.unshift({role:x.role,content:x.content}),v+=w;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:a}),o+=v,{maxTokens:s,usedTokens:o,messages:i,wasTruncated:l}}async function*zs(e,t,a,r,s,n){var R,$;const i=new ue(t),o=(R=e.metadata)==null?void 0:R.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:a.name}};const[c,d]=await Promise.all([i.buildContext(r.id),Qt(t,r.id)]),p=await i.getRecentConversations(r.id,30,o);await br(i,p,r.id,e.channel,o);const h=vr(r,c,e.channel,d),v=Ws(h,p,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const g=await Xt(t,r.id),x=10;let w="",T=0;const _=[...v.messages];_r(_);for(let G=0;G<x;G++)try{G>0&&(yield{type:"thinking",data:{threadId:o}});const F=await a.chat(_,{tools:g});if(F.usage&&(T+=F.usage.promptTokens+F.usage.completionTokens),F.toolCalls&&F.toolCalls.length>0){F.content&&(yield{type:"chunk",data:{text:F.content,threadId:o}});const H=F.content||`[calling: ${F.toolCalls.map(D=>D.name).join(", ")}]`;_.push({role:"assistant",content:H});const K=[];for(const D of F.toolCalls){yield{type:"tool_start",data:{tool:D.name,toolArgs:D.arguments,threadId:o}};try{const B=await It(D.name,D.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a,n==null?void 0:n.DOCUMENTS_BUCKET);yield{type:"tool_end",data:{tool:D.name,toolResult:B.substring(0,500)+(B.length>500?"...":""),threadId:o}},K.push(`[Tool Result for ${D.name}]: ${B}`)}catch(B){await P(t,r.id,"tool",D.name,B.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:D.name,toolResult:`Error: ${B.message||"Execution failed"}`,threadId:o}},K.push(`[Tool Error for ${D.name}]: ${B.message||"Execution failed"}`)}}_.push({role:"user",content:K.join(`

`)});continue}w=F.content,await i.storeMessage(r.id,e.channel,"assistant",w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),"{}",o);const W=50;for(let H=0;H<w.length;H+=W)yield{type:"chunk",data:{text:w.substring(H,H+W),threadId:o}},H+W<w.length&&await new Promise(D=>setTimeout(D,10));break}catch(F){if(s){const K=F.message||"",D=K.includes("401")||K.includes("403")||K.includes("authentication")||K.includes("credit balance"),B=K.includes("429"),u=D?1440:B?10:5;await s.recordError(a.name,K,u)}await P(t,r.id,"llm","provider_error",F.message||"Unknown LLM error",{provider:a.name,turn:G});const W=F.message||"An error occurred",H=W.includes("429")?"Rate limit reached — the AI provider is temporarily throttling requests. Please wait a moment and try again.":W;try{await i.storeMessage(r.id,e.channel,"assistant",`⚠️ ${H}`,"{}",o)}catch{}yield{type:"error",data:{error:H,threadId:o}};return}if(w=(w==null?void 0:w.trim())??"",!w)try{_.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),w=(await a.chat(_,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(r.id,e.channel,"assistant",w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),"{}",o);const F=50;for(let W=0;W<w.length;W+=F)yield{type:"chunk",data:{text:w.substring(W,W+F),threadId:o}},W+F<w.length&&await new Promise(H=>setTimeout(H,10))}catch{w="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(r.id,e.channel,"assistant",w,"{}",o).catch(()=>{}),yield{type:"chunk",data:{text:w,threadId:o}}}if(s&&T>0)try{await s.recordUsage(a.name,T)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",T,Date.now()-l,1,e.channel).run()}catch{}const C=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"}];for(const G of C){const F=G.claimPattern.test(w),W=G.requiredTools.some(H=>toolsCalledList.includes(H));if(F&&!W){try{await P(t,r.id,"llm",G.logType,"LLM claimed action without tool call (streaming)",{response:w.substring(0,200)}),_.push({role:"assistant",content:w}),_.push({role:"user",content:G.enforcementMsg});const H=await a.chat(_,{tools:g.filter(K=>G.requiredTools.includes(K.name)),temperature:0});if(($=H.toolCalls)!=null&&$.length){for(const D of H.toolCalls){const B=await It(D.name,D.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a,n==null?void 0:n.DOCUMENTS_BUCKET);toolsCalledList.push(D.name),_.push({role:"assistant",content:null,toolCalls:H.toolCalls}),_.push({role:"user",content:B})}const K=await a.chat(_,{tools:[]});K.content&&(w=K.content)}else w="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:T}}}async function ea(e,t,a,r,s,n){var d;const i=new ue(t),o=(d=e.metadata)==null?void 0:d.thread_id,l=await i.buildContext(r.id);if(Zt(e.text,l).agent==="conversation")return Er(e,t,a,r,l,s,o);if(e.channel==="telegram"){const p=await Xt(t,r.id);return ha(e,t,a,r,s,n,{maxTurns:10,tools:p})}return ha(e,t,a,r,s,n)}async function Er(e,t,a,r,s,n,i){const o=new ue(t),l=Date.now(),c=wr(r.timezone),d=await Qt(t,r.id),p=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${s}`:s,h=gr("conversation",r,p,r.timezone,c,e.channel),v=(await o.getRecentConversations(r.id,30,i)).filter(_=>!_.content.startsWith("[Autonomous Scheduled Task]")&&!_.content.startsWith("[Scheduled Reminder]")),g=yr([{role:"system",content:h},...v.map(_=>({role:_.role,content:_.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);let x=0,w="";try{const _=await a.chat(g,{temperature:.8});_.usage&&(x=_.usage.promptTokens+_.usage.completionTokens),w=_.content}catch(_){if(n){const C=_.message||"",R=C.includes("401")||C.includes("403")||C.includes("authentication")||C.includes("credit balance"),$=C.includes("429"),G=R?1440:$?10:5;await n.recordError(a.name,C,G)}throw await P(t,r.id,"llm","conversation_error",_.message,{provider:a.name}),_}if(n&&x>0)try{await n.recordUsage(a.name,x)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"conversation",x,Date.now()-l,1,e.channel).run()}catch{}const T=w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await o.storeMessage(r.id,e.channel,"assistant",T,"{}",i),await o.compactHistory(r.id,30),T}async function*Ks(e,t,a,r,s,n){var d;const i=new ue(t),o=(d=e.metadata)==null?void 0:d.thread_id,l=await i.buildContext(r.id),c=Zt(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:a.name}},c.agent!=="conversation"){yield*zs(e,t,a,r,s,n);return}try{const p=await Er(e,t,a,r,l,s,o),h=50;for(let v=0;v<p.length;v+=h)yield{type:"chunk",data:{text:p.substring(v,v+h),threadId:o}},v+h<p.length&&await new Promise(g=>setTimeout(g,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:0}}}const ee=new ke;async function Ys(e,t){var s;const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}ee.use("/*",Ys);ee.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),s=await e.env.DB.prepare(`SELECT t.*, 
     ...
     LIMIT ?`).bind(t.id,a?1:0,r).all();return e.json({threads:s.results||[]})});ee.post("/threads",async e=>{const t=e.get("user"),{title:a}=await e.req.json(),r=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a||"New conversation").first();return e.json({thread:r})});ee.put("/threads/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),r=await e.req.json(),s=[],n=[];return r.title!==void 0&&(s.push("title = ?"),n.push(r.title)),r.is_archived!==void 0&&(s.push("is_archived = ?"),n.push(r.is_archived?1:0)),s.push("updated_at = CURRENT_TIMESTAMP"),n.push(a,t.id),s.length<=1?e.json({error:"Nothing to update"},400):(await e.env.DB.prepare(`UPDATE threads SET ${s.join(", ")} WHERE id = ? AND user_id = ?`).bind(...n).run(),e.json({success:!0}))});ee.delete("/threads/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM conversations WHERE thread_id = ? AND user_id = ?").bind(a,t.id).run(),await e.env.DB.prepare("DELETE FROM threads WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});ee.post("/upload",async e=>{const t=e.get("user"),a=!!e.env.DOCUMENTS_BUCKET,r=a?100*1024*1024:700*1024;let s,n,i,o=null,l=null;try{if((e.req.header("Content-Type")||"").includes("multipart/form-data")){const g=(await e.req.formData()).get("file");if(!g)return e.json({error:"No file provided."},400);if(s=g.name,n=g.type||"application/octet-stream",i=g.size,i>r)return e.json({error:`File too large (max ${a?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);o=await g.arrayBuffer()}else{const v=await e.req.json();if(!v.file_name||!v.file_data)return e.json({error:"file_name and file_data are required."},400);if(s=v.file_name,n=v.file_type||"application/octet-stream",l=v.file_data,i=v.file_size||Math.round(l.length*.75),i>r)return e.json({error:`File too large (max ${a?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);if(a){const g=atob(l);o=new ArrayBuffer(g.length);const x=new Uint8Array(o);for(let w=0;w<g.length;w++)x[w]=g.charCodeAt(w)}}const d=crypto.randomUUID();let p;a&&o?(await e.env.DOCUMENTS_BUCKET.put(d,o,{httpMetadata:{contentType:n},customMetadata:{fileName:s,userId:String(t.id)}}),p="r2"):p=l||(o?Buffer.from(o).toString("base64"):""),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(d,t.id,s,n,p,i).run();let h="";if(n.startsWith("text/"))try{const v=l||(o?Buffer.from(o).toString("base64"):"");h=Buffer.from(v,"base64").toString("utf-8").substring(0,500)}catch{}return e.json({file_id:d,name:s,type:n,size:i,text_preview:h,storage:a?"r2":"d1"})}catch(c){console.error("File upload error:",c);try{const{logError:d}=await Promise.resolve().then(()=>Je);await d(e.env.DB,t.id,"upload","upload_error",c.message||"Unknown upload error")}catch{}return e.json({error:`Upload failed: ${c.message||"Unknown error"}`},500)}});ee.post("/send",async e=>{const t=e.get("user"),{message:a,channel:r="web",thread_id:s,files:n}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let i="";if(n&&Array.isArray(n)&&n.length>0){i=`
...
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=s;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await wt(e.env.DB,t.id,t.pin_hash),p=await ea(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});return!s&&o?await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run():o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),e.json({response:p,timestamp:new Date().toISOString(),channel:l.channel,provider:c.name,thread_id:o})}catch(c){console.error("Chat error:",c);const d=c.message||"";if(d.includes("No LLM provider configured"))return e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400);if(d.includes("All LLM providers failed"))return e.json({error:d,type:"no_provider",thread_id:o},400);if(d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests"))return e.json({error:"Rate limit reached — the AI provider is temporarily throttling requests. Please wait a moment and try again.",type:"rate_limit",thread_id:o},429);const p=d.includes("401")||d.includes("403")||d.includes("authentication")||d.includes("credit balance")||d.includes("invalid")&&d.includes("key");try{const{logError:h}=await Promise.resolve().then(()=>Je);await h(e.env.DB,t.id,"llm","chat_error",d)}catch{}return e.json({error:p?"API key error — your provider returned an authentication or billing error. Check Settings → Keys to verify your API keys are valid.":"Something went wrong. I'll be back in a moment.",details:d,type:p?"no_provider":void 0,thread_id:o},p?400:500)}});function fa(e){return`event: ${e.type}
data: ${JSON.stringify(e.data)}

`}ee.post("/stream",async e=>{const t=e.get("user"),{message:a,channel:r="web",thread_id:s,files:n}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let i="";if(n&&Array.isArray(n)&&n.length>0){i=`

[Attached files:
`;for(const c of n)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=s;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await wt(e.env.DB,t.id,t.pin_hash),p=new ReadableStream({async start(h){const v=new TextEncoder;try{const g=Ks(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const x of g)x.data.threadId||(x.data.threadId=o),h.enqueue(v.encode(fa(x)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),h.close()}catch(g){const x={type:"error",data:{error:g.message||"An error occurred",threadId:o}};h.enqueue(v.encode(fa(x))),h.close()}}});return new Response(p,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached — the AI provider is temporarily throttling requests. Please wait a moment and try again.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});ee.get("/threads/:id/messages",async e=>{var n;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),s=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?`).bind(t.id,a,r).all();return e.json({messages:(s.results||[]).reverse(),total:((n=s.results)==null?void 0:n.length)||0})});ee.get("/history",async e=>{var l;const t=e.get("user"),a=parseInt(e.req.query("limit")||"50"),r=parseInt(e.req.query("offset")||"0"),s=e.req.query("thread_id");let n,i;s?(n=`SELECT id, role, content, channel, thread_id, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(s).all(),i=[];for(const o of n.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(s,o.id).run();const l=o.user_timezone||"UTC";let c,d=!1,p=o.state||"active";if(o.schedule_type==="interval"){const g=parseInt(o.schedule_value,10);c=new Date(r.getTime()+g*60*1e3)}else if(o.schedule_type==="daily"){const[g,x]=o.schedule_value.split(":").map(Number),w=ya(l),T=new Date(w);T.setHours(g,x,0,0),T<=w&&T.setDate(T.getDate()+1);const _=new Date(T.toLocaleString("en-US",{timeZone:"UTC"})),C=new Date(T.toLocaleString("en-US",{timeZone:l})),R=_.getTime()-C.getTime();c=new Date(T.getTime()+R)}else if(o.schedule_type==="weekly"){const[g,x]=o.schedule_value.split(" "),[w,T]=(x||"00:00").split(":").map(Number),C=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(K=>K.toLowerCase()===g.toLowerCase()),R=ya(l),$=new Date(R);$.setHours(w,T,0,0);let G=(C-$.getDay()+7)%7;G===0&&$<=R&&(G=7),$.setDate($.getDate()+G);const F=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),W=new Date($.toLocaleString("en-US",{timeZone:l})),H=F.getTime()-W.getTime();c=new Date($.getTime()+H)}else o.schedule_type==="once"?(d=!0,p="completed",c=new Date(r.getTime()+365*24*60*60*1e3)):c=new Date(r.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,c.toISOString(),d?0:o.enabled,p,o.id).run();const v=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:v,next_run:c.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}try{const{MemoryService:o}=await Promise.resolve().then(()=>Es),l=await e.env.DB.prepare("SELECT id FROM users").all();for(const c of l.results||[])await new o(e.env.DB).cleanupDoneTasks(c.id)}catch{}return e.json({executed:i.length,results:i,timestamp:s})});Se.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);const r=parseInt(e.req.param("jobId"),10);if(!r)return e.json({error:"Invalid job ID"},400);const s=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(r).first();if(!s)return e.json({error:"Job not found"},404);const i=JSON.parse(s.action_config||"{}").description||s.description||"",o="⏰ "+(s.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=s.action_type==="reminder",p=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&s.action_type==="custom"&&p.test(i),d)c=i||s.name||"Time for your scheduled task.";else try{const x={id:s.user_id,username:s.username||"user",name:s.user_name||"User",pin_hash:s.pin_hash||"",role:s.user_role||"",personality_prompt:s.personality_prompt||"",telegram_chat_id:s.telegram_chat_id||"",timezone:s.user_timezone||"UTC",assistant_name:s.assistant_name||"Karna",created_at:"",updated_at:""},w={userId:s.user_id,username:x.username,channel:"cron",text:Zs(s.name,i,s.action_type),sessionId:"cron-"+s.id,timestamp:l},{provider:T,rotation:_}=await wt(e.env.DB,s.user_id,s.pin_hash);c=await ea(w,e.env.DB,T,x,_,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(x){const w=x.message||"unknown error",T=w.includes("rate_limit")||w.includes("429")||w.includes("quota"),_=w.includes("timeout")||w.includes("Timeout");T?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":_?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await P(e.env.DB,s.user_id,"cron_agent","execution_error",w,{job_id:s.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(s.action_type))try{const x=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(s.user_id).first();(!x||x.cnt===0)&&await P(e.env.DB,s.user_id,"cron_verification","no_tools_called",`Cron job "${s.name}" (${s.action_type}) completed without any tool calls`,{job_id:s.id,action_type:s.action_type,response_preview:c.substring(0,200)})}catch{}let v=c||i||"Time for your scheduled task.";v=v.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const g=o+`
`+v;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(s.user_id,"reminder",o,v,"cron:"+s.id).run(),d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(s.user_id,"system","assistant",g,JSON.stringify({type:"cron",job_id:s.id})).run(),s.telegram_chat_id&&await Vs(e.env.DB,s.user_id,s.telegram_chat_id,g),e.json({job_id:r,status:"completed",response_length:c.length})});async function Tr(e){var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return null;const a=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(a==null?void 0:a.user_id)||null}Se.get("/health/tools",async e=>{var a;const t=await Tr(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function Zs(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Task: "${e}"
Instructions: ${t}
You MUST call read_sheet immediately with the relevant spreadsheet.${ct}`:a==="custom"&&t?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${ct}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${ct}`}function Xs(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function Qs(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const bt=new ke,en=4e3;async function Q(e,t,a,r="Markdown",s,n){var c,d;const i=an(a,en),o=[];let l=!0;for(let p=0;p<i.length;p++){const h=i[p];let v=!1,g="";for(let x=0;x<3;x++)try{const w=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h,parse_mode:r,disable_web_page_preview:!1})});if(w.ok){v=!0;break}const T=await w.json().catch(()=>null);if(g=`HTTP ${w.status}: ${(T==null?void 0:T.description)||"Unknown error"}`,(c=T==null?void 0:T.description)!=null&&c.includes("parse")||(d=T==null?void 0:T.description)!=null&&d.includes("entities")){if((await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h})})).ok){v=!0;break}g+=" (plain-text retry also failed)"}if(w.status===429||w.status>=500){const _=Math.pow(2,x)*1e3;await new Promise(C=>setTimeout(C,_));continue}break}catch(w){if(g=`Network error: ${w.message}`,x<2){const T=Math.pow(2,x)*1e3;await new Promise(_=>setTimeout(_,T));continue}}v||(l=!1,o.push(`Chunk ${p+1}/${i.length}: ${g}`))}if(!l&&s&&n&&o.length>0)try{const{logError:p}=await Promise.resolve().then(()=>Je);await p(s,n,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function tn(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function an(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let s=r.lastIndexOf(`
`,t);s<t*.3&&(s=r.lastIndexOf(" ",t)),s<t*.3&&(s=t),a.push(r.substring(0,s)),r=r.substring(s).trimStart()}return a}async function rn(e,t,a,r,s){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(r==null?void 0:r.name)||"there",o=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
`];for(const g of o){let x="";if(g.due_date){const w=g.due_date.slice(0,10);w<c?x=" ⚠️ _overdue_":w===c?x=" 🔴 _due today_":w===p?x=" 🟡 _due tomorrow_":x=` _${new Date(g.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}h.push(`☐ ${g.title}${x}`)}h.push(`
_Say "mark [task] as done" to close a task._`);const v=await Q(a,t,h.join(`
`),"Markdown",s,r.id);v.success||console.warn(`[/tasks] Failed to send message: ${v.errors.join(" | ")}`)}catch(i){const o=await Q(a,t,"❌ Could not fetch tasks: "+i.message,"Markdown",s,r==null?void 0:r.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}bt.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},s=async()=>{var n,i,o,l,c;try{if(t.callback_query){await sn(a,t.callback_query);return}const d=t.message;if(!d)return;const p=!!d.text,h=!!d.voice,v=!!d.document,g=!!d.photo,x=!!d.caption;if(!p&&!h&&!v&&!g)return;const w=String(d.chat.id);let T=d.text||"";const _=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(w).first();let C=null;if(_){const D=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(_.id,"telegram_bot_token").first();D&&(C=await Z(D.encrypted_value,_.pin_hash))}if(!C){const D=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();D&&(C=await Z(D.encrypted_value,D.pin_hash))}if(!C||T.startsWith("/")&&await rn(T,w,C,_,a))return;if(!_){const D=await Q(C,w,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${w}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",a);D.success||console.warn(`Failed to send unlinked account message: ${D.errors.join(" | ")}`);return}if(d.voice&&C&&_)try{const D=await Q(C,w,"🎤 Processing voice note...","Markdown",a,_.id);D.success||console.warn(`[voice start] Failed to send message: ${D.errors.join(" | ")}`);const u=await(await fetch(`https://api.telegram.org/bot${C}/getFile?file_id=${d.voice.file_id}`)).json();if(u.ok&&((n=u.result)!=null&&n.file_path)){const m=await(await fetch(`https://api.telegram.org/file/bot${C}/${u.result.file_path}`)).blob();let f="",E="",k="whisper-1";const S=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(_.id).all();for(const M of S.results){const q=await Z(M.encrypted_value,_.pin_hash);if(M.service==="openai"){f="https://api.openai.com/v1/audio/transcriptions",E=q;break}else if(M.service.startsWith("llm_slot_"))try{const Y=JSON.parse(q);if(Y.provider==="openai"){f="https://api.openai.com/v1/audio/transcriptions",E=Y.apiKey;break}else if(Y.provider==="groq"){f="https://api.groq.com/openai/v1/audio/transcriptions",E=Y.apiKey,k="whisper-large-v3";break}}catch{}}if(!f){const M=await Q(C,w,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).","Markdown",a,_.id);M.success||console.warn(`[voice no stt] Failed to send message: ${M.errors.join(" | ")}`);return}const I=new FormData;I.append("file",m,"voice.ogg"),I.append("model",k),I.append("language","en");const L=await fetch(f,{method:"POST",headers:{Authorization:`Bearer ${E}`},body:I});if(!L.ok){const M=await L.text(),q=await Q(C,w,`⚠️ Transcription failed: ${L.status} ${M}`,"Markdown",a,_.id);q.success||console.warn(`[voice transcription error] Failed to send message: ${q.errors.join(" | ")}`);return}T=(await L.json()).text;const N=await Q(C,w,`🗣️ *You said:* ${T}`,"Markdown",a,_.id);N.success||console.warn(`[voice transcript echo] Failed to send message: ${N.errors.join(" | ")}`)}}catch(D){const B=await Q(C,w,`⚠️ Failed to process voice note: ${D.message}`,"Markdown",a,_==null?void 0:_.id);B.success||console.warn(`[voice processing error] Failed to send message: ${B.errors.join(" | ")}`);return}if((v||g)&&C&&_)try{let D,B="unknown",u="unknown",y=0;if(v)D=d.document.file_id,B=d.document.file_name||"document",u=d.document.mime_type||"unknown",y=d.document.file_size||0;else if(g){const m=d.photo[d.photo.length-1];D=m.file_id,B="photo.jpg",u="image/jpeg",y=m.file_size||0}if(D){const f=await(await fetch(`https://api.telegram.org/bot${C}/getFile?file_id=${D}`)).json();let E="";if(f.ok&&((i=f.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(B)||/^text\/|application\/json|application\/xml|application\/csv/i.test(u))&&y<5e4)try{E=await(await fetch(`https://api.telegram.org/file/bot${C}/${f.result.file_path}`)).text()}catch{}const k=d.caption||"",S=`[Telegram file received: "${B}" (${u}, ${Math.round(y/1024)}KB)]`;E?T=`${k?k+`
...
`:""}${S}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(D){if(x&&d.caption)T=d.caption;else{const B=await Q(C,w,`⚠️ Received your file but couldn't process it: ${D.message}`,"Markdown",a,_==null?void 0:_.id);B.success||console.warn(`[file processing error] Failed to send message: ${B.errors.join(" | ")}`);return}}if(!T)return;tn(C,w).catch(()=>{});let R=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(_.id).first();R?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(R.id).run():R={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(_.id).run()).meta.last_row_id};const $=Xs(_.id,_.username,T,w);$.metadata={thread_id:R.id};let G,F;try{const D=await wt(a,_.id,_.pin_hash);G=D.provider,F=D.rotation}catch(D){console.error("Telegram provider setup error:",D);const B=(o=D.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=D.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${D.message||"Unknown error"}`,u=await Q(C,w,B,"Markdown",a,_.id);u.success||console.warn(`[provider error] Failed to send message: ${u.errors.join(" | ")}`);return}const{classifyIntentFast:W}=await Promise.resolve().then(()=>js);if(W(T).agent==="multi"){const D=await Q(C,w,"🔍 On it…","Markdown",a,_.id);D.success||console.warn(`[ack] Failed to send: ${D.errors.join(" | ")}`)}const H=9e4;let K=!1;try{const D=await Promise.race([ea($,a,G,_,F,r),new Promise((y,m)=>setTimeout(()=>m(new Error("TELEGRAM_TIMEOUT")),H))]),B=Qs(D,"telegram"),u=await Q(C,w,B||"(empty response)","Markdown",a,_.id);if(K=u.success,!u.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${_.id}:`,u.errors);try{const{logError:y}=await Promise.resolve().then(()=>Je);await y(a,_.id,"telegram","response_send_failed",`Failed to deliver response: ${u.errors.join(" | ")}`)}catch{}}}catch(D){console.error("Telegram agent error:",D);const B=D.message==="TELEGRAM_TIMEOUT",u=B?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=D.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${G.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(D.message||"Unknown").substring(0,200)}`,y=await Q(C,w,u,"Markdown",a,_.id);K=y.success,y.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${_.id}:`,y.errors);try{const{logError:m}=await Promise.resolve().then(()=>Je);await m(a,_.id,"telegram",B?"timeout":"agent_error",D.message||"Agent error",{provider:G.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:p}=await Promise.resolve().then(()=>Je);await p(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(s()),e.json({ok:!0})});bt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Telegram bot token not configured in Settings"},400);const n=await Z(s.encrypted_value,a.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});bt.get("/webhook-status",async e=>{var n,i,o,l,c,d;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const s=await Z(r.encrypted_value,a.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((c=h.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=h.result)==null?void 0:d.last_error_date)||null})}catch(p){return e.json({configured:!0,error:p.message})}});bt.post("/detect-chat-id",async e=>{var n,i;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const s=await Z(r.encrypted_value,a.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const p=await(await fetch(`https://api.telegram.org/bot${s}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:["message"]})});const h=p.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],g=new Set;for(let w=h.length-1;w>=0;w--){const T=h[w].message;if(T&&T.chat){const _=String(T.chat.id);g.has(_)||(g.add(_),v.push({chat_id:_,name:[T.chat.first_name,T.chat.last_name].filter(Boolean).join(" ")||T.chat.title||"Unknown",username:T.chat.username||"",date:new Date((T.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const x=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(x,a.user_id).run(),e.json({found:!0,chat_id:x,name:v[0].name,all_chats:v,message:`Chat ID ${x} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function sn(e,t){var x;const{id:a,data:r,message:s,from:n}=t;if(!r||!s)return;const i=r.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const c=String(s.chat.id),d=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(c).first();if(!d)return;const p=await e.prepare(`
  ...
  `).bind(h,h,p.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(d.id).first();if(!v)return;const g=await Z(v.encrypted_value,v.pin_hash);try{const w=await fetch(`https://api.telegram.org/bot${g}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:h?"✅ Checked!":"☐ Unchecked"})});w.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${w.status}`)}catch(w){console.warn(`[callback answer] Error answering callback: ${w.message}`)}if((x=s.reply_markup)!=null&&x.inline_keyboard){const w=s.reply_markup.inline_keyboard.map(T=>T.map(_=>{var C;if((C=_.callback_data)!=null&&C.includes(o)){const R=h?"✅":"☐",$=_.text.replace(/^[☐✅]\s*/,"");return{..._,text:`${R} ${$}`}}return _}));try{await fetch(`https://api.telegram.org/bot${g}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:s.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function nn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const s=new Date(r);s.setHours(23,59,59,999);const n=r.toISOString().split("T")[0];return{start:r.toISOString(),end:s.toISOString(),dateStr:n}}async function on(e,t,a,r,s,n){try{return(await new Vt(e,t,a,r,s).listEvents("primary",{timeMin:n.start,timeMax:n.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function ln(e,t,a,r,s){try{const n=new we(e,t,a,r,s),i=await n.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await n.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const p of i){const h=p.from.split("<")[0].trim()||p.from;l[h]=(l[h]||0)+1}const c=Object.entries(l).sort(([,p],[,h])=>h-p).slice(0,5).map(([p])=>p),d=i.some(p=>p.subject.toLowerCase().includes("urgent")||p.subject.toLowerCase().includes("asap")||p.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(n){return console.error("Gmail fetch error:",n.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function cn(e,t){try{const a=await e.prepare(`
...
`)}function mn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function hn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const n=JSON.parse(a.components);r={google_calendar:n.google_calendar!==!1,gmail:n.gmail!==!1,tasks:n.tasks!==!1,news:n.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const s=a.news_topics?a.news_topics.split(",").map(n=>n.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:s}}async function xr(e,t,a){var _,C;const r=t.timezone||"Asia/Kolkata",s=nn(r),{components:n,newsTopics:i}=await hn(e,t.id),o=[],l=[];n.google_calendar&&(o.push(on(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,s)),l.push("googleEvents")),n.gmail&&(o.push(ln(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),n.tasks&&(o.push(cn(e,t.id)),l.push("tasks")),n.news&&(o.push(un(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((R,$)=>{d[R]=c[$]});const p={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:s.dateStr,calendar:{google:d.googleEvents||[],totalCount:((_=d.googleEvents)==null?void 0:_.length)||0},emails:{gmail:d.gmailSummary||p},tasks:d.tasks||h,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},g=((C=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:C.briefing_time)||"20:00";v.summary=pn(v,g);const x=mn(v),w=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:s.results||[]}}async function fn(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(i,i,r,a).run(),{checked:i===1}}async function yn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,a).all()).results||[]).map(s=>({...s,content:JSON.parse(s.content_json||"{}")}))}function vn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),s=r.getHours(),n=r.getMinutes(),[i,o]=e.split(":").map(Number),l=s*60+n,c=i*60+o;return l===c}function kr(e,t){const a=e.summary,r=[];for(const s of t.slice(0,10))r.push([{text:`☐ ${s.text.substring(0,40)}${s.text.length>40?"...":""}`,callback_data:`briefing_toggle:${s.key}`}]);return{text:a,inlineKeyboard:r}}const ce=new ke;async function wn(e,t){var s;if(e.req.path.includes("/cron/"))return t();const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),s=[],n=new Date;for(const i of r.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(vn(l,o,n))try{const c=await xr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(i.telegram_chat_id){const{text:d,inlineKeyboard:p}=kr(c.content,c.items);await Sr(e.env.DB,i,d,p,c.briefingId)}s.push({user_id:i.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:o})}catch(c){s.push({user_id:i.id,status:"error",error:c.message})}}return e.json({executed:s.length,results:s})}catch(r){return e.json({error:r.message},500)}});ce.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),s=[],n=new Date,i=new Date(n.getTime()+600*1e3).toISOString(),o=new Date(n.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await Z(c.encrypted_value,l.pin_hash),h=JSON.parse(d).access_token;if(!h)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(n.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${h}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(_=>{var R;const C=(R=_.start)==null?void 0:R.dateTime;return C?C>=n.toISOString()&&C<=i:!1});if(x.length===0){s.push({user_id:l.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!w)continue;const T=await Z(w.encrypted_value,l.pin_hash);for(const _ of x){const C=new Date(_.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),R=_.location?`
📍 ${_.location}`:"",$=`⏰ Meeting in 10 minutes!

*${_.summary||"Untitled Event"}*
🕐 ${C}${R}`;await fetch(`https://api.telegram.org/bot${T}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:$,parse_mode:"Markdown"})})}s.push({user_id:l.id,reminders_sent:x.length})}catch(c){s.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:s.length,results:s})}catch(r){return e.json({error:r.message},500)}});async function Sr(e,t,a,r,s){try{const n=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!n)return;const i=await Z(n.encrypted_value,n.pin_hash);if(!(await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(c=>c.map(d=>({...d,callback_data:`${d.callback_data}:${s}`})))}})})).json()).ok){const d=await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a.replace(/[_*[\]`]/g,""),reply_markup:{inline_keyboard:r.map(p=>p.map(h=>({...h,callback_data:`${h.callback_data}:${s}`})))}})})).json();if(!d.ok){console.error("Telegram briefing send failed:",d.description,"chat_id:",t.telegram_chat_id);return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(s).run()}catch(n){console.error("Telegram briefing error:",n.message)}}ce.post("/briefings/:id/resend",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const r=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!r)return e.json({error:"Briefing not found"},404);const s=JSON.parse(r.content||"{}"),n=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(a).all(),{text:i,inlineKeyboard:o}=kr(s,n.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(a).run(),await Sr(e.env.DB,t,i,o,a);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(a).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(r){return e.json({error:r.message},500)}});ce.delete("/briefings/:id",async e=>{const t=e.get("user"),a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});const Ge=new ke;async function bn(e,t){var s;const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}Ge.use("/*",bn);function Dr(e){return e.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"")}Ge.get("/",async e=>{const t=e.get("user"),a=await e.env.DB.prepare(`SELECT id, name, slug, description, instructions, parameters, required_tools, examples, enabled, usage_count, last_used_at, created_at, updated_at
     FROM user_skills WHERE user_id = ? ORDER BY created_at DESC`).bind(t.id).all();return e.json({skills:a.results||[]})});Ge.post("/",async e=>{var c,d,p;const t=e.get("user"),a=await e.req.json();if(!((c=a.name)!=null&&c.trim()))return e.json({error:"name is required"},400);if(!((d=a.description)!=null&&d.trim()))return e.json({error:"description is required"},400);if(!((p=a.instructions)!=null&&p.trim()))return e.json({error:"instructions is required"},400);let r=Dr(a.name);r||(r=`skill_${Date.now()}`);const s=await e.env.DB.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(t.id,`${r}%`).all();s.results&&s.results.length>0&&s.results.map(v=>v.slug).includes(r)&&(r=`${r}_${s.results.length+1}`);const n=JSON.stringify(a.parameters||{}),i=JSON.stringify(a.required_tools||[]),o=JSON.stringify(a.examples||[]),l=await e.env.DB.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).bind(t.id,a.name.trim(),r,a.description.trim(),a.instructions.trim(),n,i,o).first();return e.json({skill:l,created:!0})});Ge.get("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));if(isNaN(a))return e.json({error:"Invalid skill ID"},400);const r=await e.env.DB.prepare("SELECT * FROM user_skills WHERE id = ? AND user_id = ?").bind(a,t.id).first();return r?e.json({skill:r}):e.json({error:"Skill not found"},404)});Ge.put("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));if(isNaN(a))return e.json({error:"Invalid skill ID"},400);const r=await e.req.json(),s=[],n=[];return r.name!==void 0&&(s.push("name = ?","slug = ?"),n.push(r.name.trim(),Dr(r.name))),r.description!==void 0&&(s.push("description = ?"),n.push(r.description.trim())),r.instructions!==void 0&&(s.push("instructions = ?"),n.push(r.instructions.trim())),r.parameters!==void 0&&(s.push("parameters = ?"),n.push(JSON.stringify(r.parameters))),r.required_tools!==void 0&&(s.push("required_tools = ?"),n.push(JSON.stringify(r.required_tools))),r.examples!==void 0&&(s.push("examples = ?"),n.push(JSON.stringify(r.examples))),r.enabled!==void 0&&(s.push("enabled = ?"),n.push(r.enabled?1:0)),s.length===0?e.json({error:"Nothing to update"},400):(s.push("updated_at = CURRENT_TIMESTAMP"),n.push(a,t.id),await e.env.DB.prepare(`UPDATE user_skills SET ${s.join(", ")} WHERE id = ? AND user_id = ?`).bind(...n).run(),e.json({success:!0}))});Ge.delete("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return isNaN(a)?e.json({error:"Invalid skill ID"},400):(await e.env.DB.prepare("DELETE FROM user_skills WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0}))});const pe=new ke;pe.use("/api/*",ps());pe.route("/api/auth",Ae);pe.route("/api/chat",ee);pe.route("/api/settings",V);pe.route("/api/system",Se);pe.route("/api/telegram",bt);pe.route("/api/proactive",ce);pe.route("/api/skills",Ge);pe.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),s=t.searchParams.get("error");if(s)return e.html(We(!1,`Google denied access: ${s}`));if(!a||!r)return e.html(We(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(r)).sessionId;if(!i)return e.html(We(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(We(!1,"Session expired. Please log in again and retry."));const l=o.user_id,c=o.pin_hash,d=`${t.protocol}//${t.host}/auth/google/callback`,p=await tr(e.env.DB,l,c,a,d,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(We(!0,`Connected as ${p.email}`,p.email))}catch(n){return e.html(We(!1,`OAuth failed: ${n.message}`))}});pe.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Ha())));pe.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Ha())));function We(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function _n(e,t,a){const r="https://karna-5xs.pages.dev",n={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const o=await(await fetch(`${r}/api/system/cron/execute`,{method:"POST",headers:n})).json();if(o.results&&o.results.length>0){const c=o.results.filter(p=>p.needs_agent&&p.status==="dispatched");if(c.length>0){const p=c.map(h=>fetch(`${r}/api/system/cron/run-task/${h.job_id}`,{method:"POST",headers:n}).then(v=>v.json()).catch(v=>({job_id:h.job_id,error:v.message})));a.waitUntil(Promise.allSettled(p).then(h=>{console.log(`Cron: ${o.executed} dispatched, ${c.length} agent tasks`,JSON.stringify(h.map(v=>v.status==="fulfilled"?v.value:v.reason)))}))}const d=o.results.filter(p=>!p.needs_agent&&p.status==="dispatched");if(d.length>0){const p=d.map(h=>fetch(`${r}/api/system/cron/run-task/${h.job_id}`,{method:"POST",headers:n}).catch(()=>{}));a.waitUntil(Promise.allSettled(p))}}a.waitUntil(fetch(`${r}/api/proactive/cron/evening-briefing`,{method:"POST",headers:n}).then(c=>c.json()).then(c=>{c.executed>0&&console.log("Evening briefing result:",JSON.stringify(c))}).catch(c=>{console.error("Evening briefing error:",c.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${r}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:n}).then(c=>c.json()).then(c=>{var d;(d=c.results)!=null&&d.some(p=>p.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(c))}).catch(()=>{}))}catch(i){console.error("Scheduled cron error:",i.message||i)}}const En={fetch:pe.fetch,scheduled:_n},wa=new ke,Tn=Object.assign({"/src/index.tsx":En});let Ir=!1;for(const[,e]of Object.entries(Tn))e&&(wa.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),wa.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Ir=!0);if(!Ir)throw new Error("Can't import modules from ['/src/index.tsx']");export{wa as default};
