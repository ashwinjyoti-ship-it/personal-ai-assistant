var ta=Object.defineProperty;var zn=e=>{throw TypeError(e)};var na=(e,t,n)=>t in e?ta(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var j=(e,t,n)=>na(e,typeof t!="symbol"?t+"":t,n),cn=(e,t,n)=>t.has(e)||zn("Cannot "+n);var k=(e,t,n)=>(cn(e,t,"read from private field"),n?n.call(e):t.get(e)),J=(e,t,n)=>t.has(e)?zn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),F=(e,t,n,s)=>(cn(e,t,"write to private field"),s?s.call(e,n):t.set(e,n),n),ee=(e,t,n)=>(cn(e,t,"access private method"),n);var Kn=(e,t,n,s)=>({set _(r){F(e,t,r,n)},get _(){return k(e,t,s)}});var Yn=(e,t,n)=>(s,r)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&r||void 0,d)try{l=await d(s,()=>i(o+1))}catch(u){if(u instanceof Error&&t)s.error=u,l=await t(u,s),c=!0;else throw u}else s.finalized===!1&&n&&(l=await n(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},sa=Symbol(),ra=async(e,t=Object.create(null))=>{const{all:n=!1,dot:s=!1}=t,a=(e instanceof Cs?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?aa(e,{all:n,dot:s}):{}};async function aa(e,t){const n=await e.formData();return n?ia(n,t):{}}function ia(e,t){const n=Object.create(null);return e.forEach((s,r)=>{t.all||r.endsWith("[]")?oa(n,r,s):n[r]=s}),t.dot&&Object.entries(n).forEach(([s,r])=>{s.includes(".")&&(la(n,s,r),delete n[s])}),n}var oa=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},la=(e,t,n)=>{let s=e;const r=t.split(".");r.forEach((a,i)=>{i===r.length-1?s[a]=n:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},Rs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ca=e=>{const{groups:t,path:n}=da(e),s=Rs(n);return ua(s,t)},da=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,s)=>{const r=`@${s}`;return t.push([r,n]),r}),{groups:t,path:e}},ua=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[s]=t[n];for(let r=e.length-1;r>=0;r--)if(e[r].includes(s)){e[r]=e[r].replace(s,t[n][1]);break}}return e},Kt={},ma=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const s=`${e}#${t}`;return Kt[s]||(n[2]?Kt[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:Kt[s]=[e,n[1],!0]),Kt[s]}return null},Rn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},pa=e=>Rn(e,decodeURI),Ds=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let s=n;for(;s<t.length;s++){const r=t.charCodeAt(s);if(r===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return pa(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(n,s)},ha=e=>{const t=Ds(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ht=(e,t,...n)=>(n.length&&(t=ht(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ns=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let s="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))s+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){n.length===0&&s===""?n.push("/"):n.push(s);const a=r.replace("?","");s+="/"+a,n.push(s)}else s+="/"+r}),n.filter((r,a,i)=>i.indexOf(r)===a)},dn=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Rn(e,Is):e):e,Os=(e,t,n)=>{let s;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return dn(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const r={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(l=dn(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=dn(c))),n?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(c)):r[l]??(r[l]=c)}return t?r[t]:r},ga=Os,fa=(e,t)=>Os(e,t,!0),Is=decodeURIComponent,Jn=e=>Rn(e,Is),vt,Ee,je,As,Ls,vn,He,_s,Cs=(_s=class{constructor(e,t="/",n=[[]]){J(this,je);j(this,"raw");J(this,vt);J(this,Ee);j(this,"routeIndex",0);j(this,"path");j(this,"bodyCache",{});J(this,He,e=>{const{bodyCache:t,raw:n}=this,s=t[e];if(s)return s;const r=Object.keys(t)[0];return r?t[r].then(a=>(r==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,F(this,Ee,n),F(this,vt,{})}param(e){return e?ee(this,je,As).call(this,e):ee(this,je,Ls).call(this)}query(e){return ga(this.url,e)}queries(e){return fa(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,s)=>{t[s]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ra(this,e))}json(){return k(this,He).call(this,"text").then(e=>JSON.parse(e))}text(){return k(this,He).call(this,"text")}arrayBuffer(){return k(this,He).call(this,"arrayBuffer")}blob(){return k(this,He).call(this,"blob")}formData(){return k(this,He).call(this,"formData")}addValidatedData(e,t){k(this,vt)[e]=t}valid(e){return k(this,vt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[sa](){return k(this,Ee)}get matchedRoutes(){return k(this,Ee)[0].map(([[,e]])=>e)}get routePath(){return k(this,Ee)[0].map(([[,e]])=>e)[this.routeIndex].path}},vt=new WeakMap,Ee=new WeakMap,je=new WeakSet,As=function(e){const t=k(this,Ee)[0][this.routeIndex][1][e],n=ee(this,je,vn).call(this,t);return n&&/\%/.test(n)?Jn(n):n},Ls=function(){const e={},t=Object.keys(k(this,Ee)[0][this.routeIndex][1]);for(const n of t){const s=ee(this,je,vn).call(this,k(this,Ee)[0][this.routeIndex][1][n]);s!==void 0&&(e[n]=/\%/.test(s)?Jn(s):s)}return e},vn=function(e){return k(this,Ee)[1]?k(this,Ee)[1][e]:e},He=new WeakMap,_s),ya={Stringify:1},Ms=async(e,t,n,s,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(r?r[0]+=e:r=[e],Promise.all(a.map(o=>o({phase:t,buffer:r,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Ms(l,t,!1,s,r))).then(()=>r[0]))):Promise.resolve(e)},va="text/plain; charset=UTF-8",un=(e,t)=>({"Content-Type":e,...t}),Pt,jt,Me,wt,$e,be,Ut,bt,_t,nt,Ht,Ft,Fe,gt,Es,wa=(Es=class{constructor(e,t){J(this,Fe);J(this,Pt);J(this,jt);j(this,"env",{});J(this,Me);j(this,"finalized",!1);j(this,"error");J(this,wt);J(this,$e);J(this,be);J(this,Ut);J(this,bt);J(this,_t);J(this,nt);J(this,Ht);J(this,Ft);j(this,"render",(...e)=>(k(this,bt)??F(this,bt,t=>this.html(t)),k(this,bt).call(this,...e)));j(this,"setLayout",e=>F(this,Ut,e));j(this,"getLayout",()=>k(this,Ut));j(this,"setRenderer",e=>{F(this,bt,e)});j(this,"header",(e,t,n)=>{this.finalized&&F(this,be,new Response(k(this,be).body,k(this,be)));const s=k(this,be)?k(this,be).headers:k(this,nt)??F(this,nt,new Headers);t===void 0?s.delete(e):n!=null&&n.append?s.append(e,t):s.set(e,t)});j(this,"status",e=>{F(this,wt,e)});j(this,"set",(e,t)=>{k(this,Me)??F(this,Me,new Map),k(this,Me).set(e,t)});j(this,"get",e=>k(this,Me)?k(this,Me).get(e):void 0);j(this,"newResponse",(...e)=>ee(this,Fe,gt).call(this,...e));j(this,"body",(e,t,n)=>ee(this,Fe,gt).call(this,e,t,n));j(this,"text",(e,t,n)=>!k(this,nt)&&!k(this,wt)&&!t&&!n&&!this.finalized?new Response(e):ee(this,Fe,gt).call(this,e,t,un(va,n)));j(this,"json",(e,t,n)=>ee(this,Fe,gt).call(this,JSON.stringify(e),t,un("application/json",n)));j(this,"html",(e,t,n)=>{const s=r=>ee(this,Fe,gt).call(this,r,t,un("text/html; charset=UTF-8",n));return typeof e=="object"?Ms(e,ya.Stringify,!1,{}).then(s):s(e)});j(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});j(this,"notFound",()=>(k(this,_t)??F(this,_t,()=>new Response),k(this,_t).call(this,this)));F(this,Pt,e),t&&(F(this,$e,t.executionCtx),this.env=t.env,F(this,_t,t.notFoundHandler),F(this,Ft,t.path),F(this,Ht,t.matchResult))}get req(){return k(this,jt)??F(this,jt,new Cs(k(this,Pt),k(this,Ft),k(this,Ht))),k(this,jt)}get event(){if(k(this,$e)&&"respondWith"in k(this,$e))return k(this,$e);throw Error("This context has no FetchEvent")}get executionCtx(){if(k(this,$e))return k(this,$e);throw Error("This context has no ExecutionContext")}get res(){return k(this,be)||F(this,be,new Response(null,{headers:k(this,nt)??F(this,nt,new Headers)}))}set res(e){if(k(this,be)&&e){e=new Response(e.body,e);for(const[t,n]of k(this,be).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=k(this,be).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of s)e.headers.append("set-cookie",r)}else e.headers.set(t,n)}F(this,be,e),this.finalized=!0}get var(){return k(this,Me)?Object.fromEntries(k(this,Me)):{}}},Pt=new WeakMap,jt=new WeakMap,Me=new WeakMap,wt=new WeakMap,$e=new WeakMap,be=new WeakMap,Ut=new WeakMap,bt=new WeakMap,_t=new WeakMap,nt=new WeakMap,Ht=new WeakMap,Ft=new WeakMap,Fe=new WeakSet,gt=function(e,t,n){const s=k(this,be)?new Headers(k(this,be).headers):k(this,nt)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??k(this,wt);return new Response(e,{status:r,headers:s})},Es),de="ALL",ba="all",_a=["get","post","put","delete","options","patch"],$s="Can not add a route since the matcher is already built.",Bs=class extends Error{},Ea="__COMPOSED_HANDLER",Ta=e=>e.text("404 Not Found",404),Vn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},Se,ue,Ps,xe,et,Jt,Vt,Et,Sa=(Et=class{constructor(t={}){J(this,ue);j(this,"get");j(this,"post");j(this,"put");j(this,"delete");j(this,"options");j(this,"patch");j(this,"all");j(this,"on");j(this,"use");j(this,"router");j(this,"getPath");j(this,"_basePath","/");J(this,Se,"/");j(this,"routes",[]);J(this,xe,Ta);j(this,"errorHandler",Vn);j(this,"onError",t=>(this.errorHandler=t,this));j(this,"notFound",t=>(F(this,xe,t),this));j(this,"fetch",(t,...n)=>ee(this,ue,Vt).call(this,t,n[1],n[0],t.method));j(this,"request",(t,n,s,r)=>t instanceof Request?this.fetch(n?new Request(t,n):t,s,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ht("/",t)}`,n),s,r)));j(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(ee(this,ue,Vt).call(this,t.request,t,void 0,t.request.method))})});[..._a,ba].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?F(this,Se,i):ee(this,ue,et).call(this,a,k(this,Se),i),o.forEach(l=>{ee(this,ue,et).call(this,a,k(this,Se),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){F(this,Se,l);for(const c of[a].flat())o.map(d=>{ee(this,ue,et).call(this,c.toUpperCase(),k(this,Se),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?F(this,Se,a):(F(this,Se,"*"),i.unshift(a)),i.forEach(o=>{ee(this,ue,et).call(this,de,k(this,Se),o)}),this);const{strict:s,...r}=t;Object.assign(this,r),this.getPath=s??!0?t.getPath??Ds:ha}route(t,n){const s=this.basePath(t);return n.routes.map(r=>{var i;let a;n.errorHandler===Vn?a=r.handler:(a=async(o,l)=>(await Yn([],n.errorHandler)(o,()=>r.handler(o,l))).res,a[Ea]=r.handler),ee(i=s,ue,et).call(i,r.method,r.path,a)}),this}basePath(t){const n=ee(this,ue,Ps).call(this);return n._basePath=ht(this._basePath,t),n}mount(t,n,s){let r,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?r=l=>l:r=s.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};r||(r=(()=>{const l=ht(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(r(l.req.raw),...i(l));if(d)return d;await c()};return ee(this,ue,et).call(this,de,ht(t,"*"),o),this}},Se=new WeakMap,ue=new WeakSet,Ps=function(){const t=new Et({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,xe,k(this,xe)),t.routes=this.routes,t},xe=new WeakMap,et=function(t,n,s){t=t.toUpperCase(),n=ht(this._basePath,n);const r={basePath:this._basePath,path:n,method:t,handler:s};this.router.add(t,n,[s,r]),this.routes.push(r)},Jt=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},Vt=function(t,n,s,r){if(r==="HEAD")return(async()=>new Response(null,await ee(this,ue,Vt).call(this,t,n,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(r,a),o=new wa(t,{path:a,matchResult:i,env:s,executionCtx:n,notFoundHandler:k(this,xe)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await k(this,xe).call(this,o)})}catch(d){return ee(this,ue,Jt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:k(this,xe).call(this,o))).catch(d=>ee(this,ue,Jt).call(this,d,o)):c??k(this,xe).call(this,o)}const l=Yn(i[0],this.errorHandler,k(this,xe));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return ee(this,ue,Jt).call(this,c,o)}})()},Et),js=[];function xa(e,t){const n=this.buildAllMatchers(),s=((r,a)=>{const i=n[r]||n[de],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],js];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=s,s(e,t)}var Qt="[^/]+",It=".*",Ct="(?:|/.*)",ft=Symbol(),ka=new Set(".\\+*[^]$()");function Ra(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===It||e===Ct?1:t===It||t===Ct?-1:e===Qt?1:t===Qt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var st,rt,ke,ot,Da=(ot=class{constructor(){J(this,st);J(this,rt);J(this,ke,Object.create(null))}insert(t,n,s,r,a){if(t.length===0){if(k(this,st)!==void 0)throw ft;if(a)return;F(this,st,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",It]:["","",Qt]:i==="/*"?["","",Ct]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||Qt;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ft;if(c=k(this,ke)[u],!c){if(Object.keys(k(this,ke)).some(h=>h!==It&&h!==Ct))throw ft;if(a)return;c=k(this,ke)[u]=new ot,d!==""&&F(c,rt,r.varIndex++)}!a&&d!==""&&s.push([d,k(c,rt)])}else if(c=k(this,ke)[i],!c){if(Object.keys(k(this,ke)).some(d=>d.length>1&&d!==It&&d!==Ct))throw ft;if(a)return;c=k(this,ke)[i]=new ot}c.insert(o,n,s,r,a)}buildRegExpStr(){const n=Object.keys(k(this,ke)).sort(Ra).map(s=>{const r=k(this,ke)[s];return(typeof k(r,rt)=="number"?`(${s})@${k(r,rt)}`:ka.has(s)?`\\${s}`:s)+r.buildRegExpStr()});return typeof k(this,st)=="number"&&n.unshift(`#${k(this,st)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},st=new WeakMap,rt=new WeakMap,ke=new WeakMap,ot),en,qt,Ts,Na=(Ts=class{constructor(){J(this,en,{varIndex:0});J(this,qt,new Da)}insert(e,t,n){const s=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return r[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,r[i][1]);break}}return k(this,qt).insert(a,t,s,k(this,en),n),s}buildRegExp(){let e=k(this,qt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,s]}},en=new WeakMap,qt=new WeakMap,Ts),Oa=[/^$/,[],Object.create(null)],Zt=Object.create(null);function Us(e){return Zt[e]??(Zt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function Ia(){Zt=Object.create(null)}function Ca(e){var c;const t=new Na,n=[];if(e.length===0)return Oa;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[h,f])=>d?1:h?-1:u.length-f.length),r=Object.create(null);for(let d=0,u=-1,h=s.length;d<h;d++){const[f,g,v]=s[d];f?r[g]=[v.map(([b])=>[b,Object.create(null)]),js]:u++;let w;try{w=t.insert(g,u,f)}catch(b){throw b===ft?new Bs(g):b}f||(n[u]=v.map(([b,T])=>{const R=Object.create(null);for(T-=1;T>=0;T--){const[$,I]=w[T];R[$]=I}return[b,R]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let h=0,f=n[d].length;h<f;h++){const g=(c=n[d][h])==null?void 0:c[1];if(!g)continue;const v=Object.keys(g);for(let w=0,b=v.length;w<b;w++)g[v[w]]=o[g[v[w]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,r]}function dt(e,t){if(e){for(const n of Object.keys(e).sort((s,r)=>r.length-s.length))if(Us(n).test(t))return[...e[n]]}}var qe,Ge,tn,Hs,Ss,Aa=(Ss=class{constructor(){J(this,tn);j(this,"name","RegExpRouter");J(this,qe);J(this,Ge);j(this,"match",xa);F(this,qe,{[de]:Object.create(null)}),F(this,Ge,{[de]:Object.create(null)})}add(e,t,n){var o;const s=k(this,qe),r=k(this,Ge);if(!s||!r)throw new Error($s);s[e]||[s,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[de]).forEach(c=>{l[e][c]=[...l[de][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Us(t);e===de?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=dt(s[c],t)||dt(s[de],t)||[])}):(o=s[e])[t]||(o[t]=dt(s[e],t)||dt(s[de],t)||[]),Object.keys(s).forEach(c=>{(e===de||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([n,a])})}),Object.keys(r).forEach(c=>{(e===de||e===c)&&Object.keys(r[c]).forEach(d=>l.test(d)&&r[c][d].push([n,a]))});return}const i=Ns(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(r).forEach(u=>{var h;(e===de||e===u)&&((h=r[u])[d]||(h[d]=[...dt(s[u],d)||dt(s[de],d)||[]]),r[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(k(this,Ge)).concat(Object.keys(k(this,qe))).forEach(t=>{e[t]||(e[t]=ee(this,tn,Hs).call(this,t))}),F(this,qe,F(this,Ge,void 0)),Ia(),e}},qe=new WeakMap,Ge=new WeakMap,tn=new WeakSet,Hs=function(e){const t=[];let n=e===de;return[k(this,qe),k(this,Ge)].forEach(s=>{const r=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];r.length!==0?(n||(n=!0),t.push(...r)):e!==de&&t.push(...Object.keys(s[de]).map(a=>[a,s[de][a]]))}),n?Ca(t):null},Ss),We,Be,xs,La=(xs=class{constructor(e){j(this,"name","SmartRouter");J(this,We,[]);J(this,Be,[]);F(this,We,e.routers)}add(e,t,n){if(!k(this,Be))throw new Error($s);k(this,Be).push([e,t,n])}match(e,t){if(!k(this,Be))throw new Error("Fatal error");const n=k(this,We),s=k(this,Be),r=n.length;let a=0,i;for(;a<r;a++){const o=n[a];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof Bs)continue;throw l}this.match=o.match.bind(o),F(this,We,[o]),F(this,Be,void 0);break}if(a===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(k(this,Be)||k(this,We).length!==1)throw new Error("No active router has been determined yet.");return k(this,We)[0]}},We=new WeakMap,Be=new WeakMap,xs),Dt=Object.create(null),ze,ye,at,Tt,ge,Pe,tt,St,Ma=(St=class{constructor(t,n,s){J(this,Pe);J(this,ze);J(this,ye);J(this,at);J(this,Tt,0);J(this,ge,Dt);if(F(this,ye,s||Object.create(null)),F(this,ze,[]),t&&n){const r=Object.create(null);r[t]={handler:n,possibleKeys:[],score:0},F(this,ze,[r])}F(this,at,[])}insert(t,n,s){F(this,Tt,++Kn(this,Tt)._);let r=this;const a=ca(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=ma(c,d),h=Array.isArray(u)?u[0]:c;if(h in k(r,ye)){r=k(r,ye)[h],u&&i.push(u[1]);continue}k(r,ye)[h]=new St,u&&(k(r,at).push(u),i.push(u[1])),r=k(r,ye)[h]}return k(r,ze).push({[t]:{handler:s,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:k(this,Tt)}}),r}search(t,n){var l;const s=[];F(this,ge,Dt);let a=[this];const i=Rs(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],h=c===d-1,f=[];for(let g=0,v=a.length;g<v;g++){const w=a[g],b=k(w,ye)[u];b&&(F(b,ge,k(w,ge)),h?(k(b,ye)["*"]&&s.push(...ee(this,Pe,tt).call(this,k(b,ye)["*"],t,k(w,ge))),s.push(...ee(this,Pe,tt).call(this,b,t,k(w,ge)))):f.push(b));for(let T=0,R=k(w,at).length;T<R;T++){const $=k(w,at)[T],I=k(w,ge)===Dt?{}:{...k(w,ge)};if($==="*"){const M=k(w,ye)["*"];M&&(s.push(...ee(this,Pe,tt).call(this,M,t,k(w,ge))),F(M,ge,I),f.push(M));continue}const[U,B,Y]=$;if(!u&&!(Y instanceof RegExp))continue;const G=k(w,ye)[U],ne=i.slice(c).join("/");if(Y instanceof RegExp){const M=Y.exec(ne);if(M){if(I[B]=M[0],s.push(...ee(this,Pe,tt).call(this,G,t,k(w,ge),I)),Object.keys(k(G,ye)).length){F(G,ge,I);const W=((l=M[0].match(/\//))==null?void 0:l.length)??0;(o[W]||(o[W]=[])).push(G)}continue}}(Y===!0||Y.test(u))&&(I[B]=u,h?(s.push(...ee(this,Pe,tt).call(this,G,t,I,k(w,ge))),k(G,ye)["*"]&&s.push(...ee(this,Pe,tt).call(this,k(G,ye)["*"],t,I,k(w,ge)))):(F(G,ge,I),f.push(G)))}}a=f.concat(o.shift()??[])}return s.length>1&&s.sort((c,d)=>c.score-d.score),[s.map(({handler:c,params:d})=>[c,d])]}},ze=new WeakMap,ye=new WeakMap,at=new WeakMap,Tt=new WeakMap,ge=new WeakMap,Pe=new WeakSet,tt=function(t,n,s,r){const a=[];for(let i=0,o=k(t,ze).length;i<o;i++){const l=k(t,ze)[i],c=l[n]||l[de],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),s!==Dt||r&&r!==Dt))for(let u=0,h=c.possibleKeys.length;u<h;u++){const f=c.possibleKeys[u],g=d[c.score];c.params[f]=r!=null&&r[f]&&!g?r[f]:s[f]??(r==null?void 0:r[f]),d[c.score]=!0}}return a},St),it,ks,$a=(ks=class{constructor(){j(this,"name","TrieRouter");J(this,it);F(this,it,new Ma)}add(e,t,n){const s=Ns(t);if(s){for(let r=0,a=s.length;r<a;r++)k(this,it).insert(e,s[r],n);return}k(this,it).insert(e,t,n)}match(e,t){return k(this,it).search(e,t)}},it=new WeakMap,ks),_e=class extends Sa{constructor(e={}){super(e),this.router=e.router??new La({routers:[new Aa,new $a]})}},Ba=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),r=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,h){i.res.headers.set(u,h)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await r(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let h=n.allowHeaders;if(!(h!=null&&h.length)){const f=i.req.header("Access-Control-Request-Headers");f&&(h=f.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Pa(){return`  // === Karna v3.1 Frontend ===
...
`}function ja(){return`  // === Render Core ===
  function render() {
...
`}function Wa(){return`  // === Memory Review ===
...
`}function za(){return`  // === Document Library ===
...
</html>`}function Qa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover">
...
`))}catch{}}}})}}function ti(e){const t={},n=e||{};if(t.type=n.type||"object",t.type==="object"){const s=n.properties;if(s&&typeof s=="object"&&Object.keys(s).length>0){const r={};for(const[a,i]of Object.entries(s))i&&typeof i=="object"?r[a]=wn(i):r[a]=i;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(n.required)?t.required=n.required:t.required=[]}return n.description&&(t.description=n.description),t}function wn(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const n=t.properties;if(n&&typeof n=="object"&&Object.keys(n).length>0){const s={};for(const[r,a]of Object.entries(n))a&&typeof a=="object"?s[r]=wn(a):s[r]=a;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=wn(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ys{constructor(t,n,s,r){j(this,"name");j(this,"apiKey");j(this,"model");j(this,"apiBase");this.apiKey=t,this.model=n,this.apiBase=s.replace(/\/+$/,""),this.name=r}async chat(t,n){var l,c,d,u,h,f;const s={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,messages:t.map(g=>({role:g.role,content:g.content}))},r=this.apiBase.includes("routellm.abacus.ai");if(n!=null&&n.tools&&n.tools.length>0&&r)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");n!=null&&n.tools&&n.tools.length>0&&(s.tools=n.tools.map(g=>({type:"function",function:{name:g.name,description:g.description,parameters:ti(g.parameters||{})}})),n.toolChoice==="required"&&(s.tool_choice="required"));const a=await zs(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(s)}),this.name);if(!a.ok){const g=await a.text();throw new Error(this.name+" API error "+a.status+": "+g)}const i=await a.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((c=o==null?void 0:o.message)==null?void 0:c.content)||"",toolCalls:(u=(d=o==null?void 0:o.message)==null?void 0:d.tool_calls)==null?void 0:u.map(g=>({id:g.id,name:g.function.name,arguments:(()=>{try{return typeof g.function.arguments=="string"?JSON.parse(g.function.arguments||"{}"):g.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=i.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((f=i.usage)==null?void 0:f.completion_tokens)||0}}}async streamChat(t,n){const s={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},r=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(s)});if(!r.ok){const o=await r.text();throw new Error(this.name+" stream error "+r.status+": "+o)}const a=r.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var h,f,g;const{done:l,value:c}=await a.read();if(l){o.close();return}const u=i.decode(c,{stream:!0}).split(`
`);for(const v of u)if(v.startsWith("data: ")){const w=v.slice(6);if(w==="[DONE]")continue;try{const T=(g=(f=(h=JSON.parse(w).choices)==null?void 0:h[0])==null?void 0:f.delta)==null?void 0:g.content;T&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:T})+`

`))}catch{}}}})}}function bn(e,t,n,s){const r=At[e];if(!r)throw new Error(`Unknown LLM provider: ${e}`);const a=s||r.defaultModel;return r.apiFormat==="anthropic"?new Ks(t,a,r.apiBase,n):new Ys(t,a,r.apiBase,n)}class Js{constructor(){j(this,"errorLog",new Map);j(this,"usageLog",new Map)}async pickProvider(t){const n=Date.now(),s=t.filter(r=>{const a=this.errorLog.get(r);return a?a.cooldownUntil<=n:!0});return s.length>0?s[0]:null}async recordUsage(t,n){const s=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:s.tokens+n,requests:s.requests+1})}async recordError(t,n,s=5){this.errorLog.set(t,{error:n,cooldownUntil:Date.now()+s*60*1e3})}}const ni=["llm_slot_1","llm_slot_2","llm_slot_3"],si=["anthropic","openai"];async function Ve(e,t,n){const{decrypt:s}=await Promise.resolve().then(()=>sn),r=new Js,a=[];for(const u of ni){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(h)try{const f=await s(h.encrypted_value,n),g=JSON.parse(f);if(g.provider&&g.apiKey&&At[g.provider]){const w=g.provider,b=bn(g.provider,g.apiKey,w,g.model);a.push({name:w,provider:b})}}catch(f){console.error(`Failed to load ${u}:`,f)}}const i=new Set(a.map(u=>u.name));for(const u of si){if(i.has(u))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(h)try{const f=await s(h.encrypted_value,n);if(At[u]){const v=bn(u,f,u);a.push({name:u,provider:v})}}catch{console.error(`Failed to decrypt legacy ${u} key`)}}if(a.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=a.map(u=>u.name),l=await r.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:a[0].provider,rotation:r};const c=a.find(u=>u.name===l);return{provider:ri(c.provider,a,r,e,t),rotation:r}}function ri(e,t,n,s,r){const a=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"";throw a(d)&&!d.includes("TOOLS_UNSUPPORTED")&&mn(s,r,"all_providers_down",e.name,null,d),c}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"",u=i(d);if(!a(d)&&!u)throw c;const h=d.includes("TOOLS_UNSUPPORTED"),f=h?1:u?10:1440;console.warn(`Provider ${e.name} ${u?"rate limited":h?"tools unsupported":"auth/billing error"}, trying fallback...`),await n.recordError(e.name,d,f);const g=t.filter(v=>v.name!==e.name);for(const v of g)try{const w=await v.provider.chat(o,l);return this.name=v.name,!h&&!u&&mn(s,r,"provider_switched",e.name,v.name,d),w}catch(w){const b=w.message||"";if(a(b)||i(b)){await n.recordError(v.name,b,i(b)?10:1440);continue}throw w}throw mn(s,r,"all_providers_down",e.name,null,d),new Error(`All LLM providers failed. Primary (${e.name}): ${d.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const yt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Ks,OpenAICompatibleProvider:Ys,ProviderRotation:Js,createProviderFromConfig:bn,createRotatingProvider:Ve,logError:H},Symbol.toStringTag,{value:"Module"})),pn=20,ai=2e3,ii=2e3,Vs=4,oi=1e3;function li(e){return Math.ceil(e.length/Vs)}function _n(e,t){const n=t*Vs;return e.length<=n?e:e.slice(0,n)+`
[...truncated to fit token budget]`}async function Nn(e,t){try{const s=(await e.prepare(`SELECT title, content FROM notes
...
`).trim()}function hn(e,t){const n=`${e.subject} ${e.snippet} ${e.from}`.toLowerCase(),s=t.toLowerCase();let r=0;n.includes(s)&&(r+=10);for(const a of s.split(/\s+/))a.length>2&&n.includes(a)&&(r+=3);return/\b(order|ordered|confirmation|invoice|receipt|thank you for your order)\b/i.test(`${e.subject} ${e.snippet}`)&&(r+=6),/\b(delivered|delivery|out for delivery|shipped|dispatch|dispatched|arriving)\b/i.test(e.subject)&&(r-=4),r}function ss(e){return e.map((t,n)=>`${t.isUnread?"● ":"  "}${n+1}. **${t.subject}**
   From: ${t.from}
   Date: ${t.date}
   ${t.snippet}
   [id: ${t.id}]`).join(`

`)}function Si(e,t,n){if(e.length===0)return`No purchase-related emails found for "${t}" (query: ${n}).`;const s=[...e].sort((i,o)=>hn(o,t)-hn(i,t)),r=s[0];if(hn(r,t)>0){const i=`**Purchase email for "${t}"**
...
${ss(s.slice(1,6))}`:"";return i+o}return`No clear purchase confirmation for "${t}". Closest matches:

${ss(s.slice(0,8))}`}const xi=15e3,ki=15e3,Ri=15e3,Di=6e4;async function Cn(e,t){try{const n=new AbortController,s=setTimeout(()=>n.abort(),ki),r=await fetch(e,{signal:n.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!r.ok)return{text:"",error:`HTTP ${r.status}`};const a=r.headers.get("content-type")||"";if(!a.includes("text/html")&&!a.includes("text/plain")&&!a.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${a.split(";")[0]}`};const i=await r.text();clearTimeout(s);const o=i.length>2e5?i.substring(0,2e5):i,l=Ni(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||xi)}}catch(n){return{text:"",error:n.name==="AbortError"?"Timeout":n.message}}}function Ni(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Oi(e,t,n){const s=new AbortController,r=setTimeout(()=>s.abort(),Ri);try{const a=await fetch("https://api.tavily.com/search",{method:"POST",signal:s.signal,headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t,query:e,search_depth:n==="quick"?"basic":"advanced",include_raw_content:!0,max_results:n==="quick"?7:5})});return clearTimeout(r),a.ok?{results:(await a.json()).results||[]}:{results:[],error:`Tavily error ${a.status}`}}catch(a){clearTimeout(r);const i=a.name==="AbortError"?"Timeout":a.message;return console.warn("[searchViaTavily]",i),{results:[],error:i}}}async function Yt(e,t,n,s,r){var o,l;const a=new AbortController,i=setTimeout(()=>a.abort(),Di);try{const c=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",signal:a.signal,headers:{"x-api-key":e,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:"claude-opus-4-8",max_tokens:s,temperature:r,system:t,messages:[{role:"user",content:n}]})});if(clearTimeout(i),!c.ok)throw new Error(`Opus API error ${c.status}`);return((l=(o=(await c.json()).content)==null?void 0:o[0])==null?void 0:l.text)||""}catch(c){throw clearTimeout(i),c}}function rs(e,t){try{const n=e.match(/\[[\s\S]*\]/);if(!n)return t;const s=JSON.parse(n[0]);if(Array.isArray(s)&&s.every(r=>typeof r=="string"))return s.filter(Boolean)}catch{}return t}async function Ii(e){return e.raw_content&&e.raw_content.length>100?e.raw_content.slice(0,15e3):(await Cn(e.url,15e3)).text}async function Ci(e,t,n,s,r){const a=[];async function i(w,b,T){let R=[];return n&&(R=(await Oi(w,n,T)).results),R.length===0&&(R=(await r(w,b)).map(U=>({url:U.link,title:U.title,content:U.snippet,raw_content:null,score:0}))),(await Promise.all(R.map(async I=>({result:I,content:await Ii(I)})))).filter(I=>I.content.length>50)}if(s==="quick"){const w=await i(e,7,"quick");let b="";for(let R=0;R<w.length;R++){const $=w[R],I=`[${R+1}] ${$.result.title}
${$.result.url}

${$.content}

`;if(b.length+I.length>8e4)break;b+=I,a.push({url:$.result.url,title:$.result.title})}return{report:await Yt(t,"You are an expert research analyst. Write a clear, accurate, well-structured report answering the query based on provided sources. Cite sources as [1], [2] etc. Be precise and factual.",`Query: ${e}

Sources:
${b}`,2048,.3),sources:a,pagesRead:w.length}}const o=await Yt(t,"You are a research planning expert.",`I need to research: ${e}

Generate exactly 4-5 specific sub-queries that together cover all important angles (definition, current state, comparisons, recent developments, expert analysis). Return ONLY a JSON array of strings, nothing else.`,400,.2),l=rs(o,[e,`${e} overview`,`${e} examples`,`${e} latest`]).slice(0,5),c=await Promise.all(l.map(w=>i(w,5,"thorough"))),d=new Set,u=[];for(const w of c)for(const b of w)d.has(b.result.url)||u.length>=20||(d.add(b.result.url),u.push(b));let h="";for(let w=0;w<u.length;w++){const b=u[w],T=`[${w+1}] ${b.result.title}
${b.result.url}

${b.content}

`;if(h.length+T.length>18e4)break;h+=T,a.push({url:b.result.url,title:b.result.title})}const f=await Yt(t,"You are a research analyst identifying information gaps.",`I'm researching: ${e}

Here's what I've found so far:
${h.slice(0,6e4)}

Identify 2-3 specific information gaps or important angles not yet covered. Return ONLY a JSON array of follow-up search queries.`,300,.2),g=rs(f,[]).slice(0,3);if(g.length>0){let w=0;const b=await Promise.all(g.map(T=>i(T,4,"thorough")));for(const T of b)for(const R of T){if(w>=5||d.has(R.result.url))continue;d.add(R.result.url);const I=`[${a.length+1}] ${R.result.title}
${R.result.url}

${R.content}

`;if(h.length+I.length>18e4)break;h+=I,a.push({url:R.result.url,title:R.result.title}),u.push(R),w++}}return{report:await Yt(t,`You are an expert research analyst producing a comprehensive report. Use this exact structure:
...
Sources:
${h}`,4096,.2),sources:a,pagesRead:u.length}}async function hr(e,t,n={}){const s=n.depth||"quick",r=async(g,v)=>(await Lt(g,{num:v,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId})).results||[];if(n.anthropicKey)try{const g=await Ci(e,n.anthropicKey,n.tavilyKey||null,s,r);if(g.report.trim())return{report:g.report,sources:g.sources.map(v=>({title:v.title,url:v.url})),pagesRead:g.pagesRead}}catch(g){console.warn("[conductResearch] Opus path failed:",g.message)}const a=n.maxPages||(s==="thorough"?5:3),i=n.maxResults||(s==="thorough"?8:5),o=await Lt(e,{num:i,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId});if(o.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${o.error}`};if(o.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const c=o.results.slice(0,a).map(async g=>{const v=await Cn(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),u=(await Promise.all(c)).filter(g=>g.content.length>50);if(u.length===0){const g=o.results.map((w,b)=>`[${b+1}] ${w.title}
${w.snippet}
Source: ${w.link}`).join(`

`);return{report:await as(e,g,t,"snippets"),sources:o.results.map(w=>({title:w.title,url:w.link})),pagesRead:0}}const h=u.map((g,v)=>`--- SOURCE ${v+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await as(e,h,t,"full"),sources:u.map(g=>({title:g.title,url:g.url})),pagesRead:u.length}}async function as(e,t,n,s){const a=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Write a synthesized research report answering the query above.`;try{return(await n.chat([{role:"system",content:a},{role:"user",content:i}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(o){return`Research synthesis error: ${o.message}. Raw search results were found but could not be analyzed.`}}const Ai=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:hr,fetchPageContent:Cn},Symbol.toStringTag,{value:"Module"})),Ye="https://api.browser-use.com/api/v2",is=2e4,Tn=6e3,Li=3e5,An=12e3,gr=new Set(["finished","stopped"]);async function Mt(e,t,n=An){const s=new AbortController,r=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}finally{clearTimeout(r)}}async function Mi(e){const t=()=>fetch(`${Ye}/sessions`,{method:"POST",headers:{"X-Browser-Use-API-Key":e,"Content-Type":"application/json"},body:JSON.stringify({})});try{let n=await t();if(!n.ok){const r=await n.text().catch(()=>"");if(yr(n.status,r)){if(console.log("[createBrowserSession] concurrency limit — reaping stale sessions and retrying"),await fr(e),n=await t(),!n.ok)return console.log(`[createBrowserSession] FAILED after reap HTTP ${n.status}`),null}else return console.log(`[createBrowserSession] FAILED HTTP ${n.status}: ${r}`),null}const s=await n.json();return console.log(`[createBrowserSession] sessionId=${s.id}`),s.id??null}catch(n){return console.log(`[createBrowserSession] ERROR ${n.message}`),null}}async function rn(e,t){try{await fetch(`${Ye}/sessions/${e}`,{method:"DELETE",headers:{"X-Browser-Use-API-Key":t}}),console.log(`[closeBrowserSession] closed sessionId=${e}`)}catch{}}async function $i(e){try{const t=await Mt(`${Ye}/sessions?filterBy=active&pageSize=100`,{headers:{"X-Browser-Use-API-Key":e}});return t.ok?(await t.json()).items??[]:[]}catch{return[]}}async function fr(e,t){const n=await $i(e);let s=0;for(const r of n)!r.id||t&&r.id===t||(await rn(r.id,e),s++);return s>0&&console.log(`[reapActiveBrowserSessions] closed ${s} stale session(s)`),s}function yr(e,t){const n=(t||"").toLowerCase();return/session/.test(n)?/concurrent|too many|maximum|limit|exceeded/.test(n):!1}async function vr(e,t,n){var o;const s=(n==null?void 0:n.timeoutMs)??Li;console.log(`[runBrowserTask] starting taskLen=${e.length} timeoutMs=${s} hasSecrets=${!!(n!=null&&n.secrets)} reuseSession=${!!(n!=null&&n.sessionId)}`);let r,a;try{const l={task:e};n!=null&&n.secrets&&Object.keys(n.secrets).length>0&&(l.secrets=n.secrets),n!=null&&n.sessionId&&(l.sessionId=n.sessionId);const c=()=>fetch(`${Ye}/tasks`,{method:"POST",headers:{"X-Browser-Use-API-Key":t,"Content-Type":"application/json"},body:JSON.stringify(l)});let d=await c();if(!d.ok){const h=await d.text().catch(()=>"");if(yr(d.status,h)&&(console.log("[runBrowserTask] concurrency limit — reaping stale sessions and retrying"),await fr(t,n==null?void 0:n.sessionId),d=await c()),!d.ok){const f=await d.text().catch(()=>h);return console.log(`[runBrowserTask] CREATE_FAILED HTTP ${d.status}: ${f}`),{output:null,taskId:"",status:"failed",error:`HTTP ${d.status}: ${f}`}}}const u=await d.json();if(r=u.id,a=u.sessionId||void 0,console.log(`[runBrowserTask] CREATED taskId=${r} sessionId=${a}`),!r)return{output:null,taskId:"",status:"failed",error:"No id in create response"}}catch(l){return{output:null,taskId:"",status:"failed",error:l.message}}await new Promise(l=>setTimeout(l,is));const i=Date.now()+(s-is);for(;Date.now()<i;){try{const l=await Mt(`${Ye}/tasks/${r}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(l.ok){const c=await l.json();if(gr.has(c.status)){if(c.status==="finished"){let d=c.output??null;if(!d)try{const u=await Mt(`${Ye}/tasks/${r}`,{headers:{"X-Browser-Use-API-Key":t}},An);if(u.ok){const h=await u.json();if(d=h.output??null,!d&&((o=h.steps)!=null&&o.length)){const f=h.steps[h.steps.length-1];d=f.extracted_content??f.output??f.result??null}}}catch{}return console.log(`[runBrowserTask] COMPLETED taskId=${r} outputLen=${(d??"").length}`),{output:d,taskId:r,sessionId:a,status:"completed"}}return console.log(`[runBrowserTask] FAILED taskId=${r} status=${c.status}`),{output:c.output??null,taskId:r,status:"failed",error:c.output??"Task was stopped before completing"}}}}catch{}await new Promise(l=>setTimeout(l,Tn))}return console.log(`[runBrowserTask] TIMEOUT taskId=${r} sessionId=${a}`),{output:null,taskId:r,sessionId:a,status:"timeout"}}async function wr(e,t,n){var a;const s=(n==null?void 0:n.waitMs)??3e4,r=Date.now()+s;for(;Date.now()<r;){try{const i=await Mt(`${Ye}/tasks/${e}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(!i.ok){await new Promise(l=>setTimeout(l,Tn));continue}const o=await i.json();if(gr.has(o.status)){let l=null;const c=await Mt(`${Ye}/tasks/${e}`,{headers:{"X-Browser-Use-API-Key":t}},An);if(c.ok){const d=await c.json();if(l=d.output??null,!l&&((a=d.steps)!=null&&a.length)){const u=d.steps[d.steps.length-1];l=u.extracted_content??u.output??u.result??null}}else l=o.output??null;return{status:o.status,output:l,done:!0}}}catch{}await new Promise(i=>setTimeout(i,Tn))}return{status:"running",output:null,done:!1}}function Bi(e){return`Navigate to https://www.bluedart.com/tracking.
...
- **HARD RULE — no false confirmations**: You have ZERO tool access. You CANNOT set reminders, create schedules, send emails, read sheets, or perform any action. NEVER output phrases like "Reminder set for...", "I've scheduled...", "Done ✅", "Task created", or any language implying an action was completed. If the user wants an action, say: "I can do that — just send your message and I'll take care of it." Do NOT simulate the outcome.`;default:return""}}const Hi=Object.freeze(Object.defineProperty({__proto__:null,buildPurchaseGmailQuery:Mn,buildSubAgentPrompt:Tr,classifyIntentFast:Ln,detectDeterministicOp:$n,detectTierTwoOp:Bn,extractPurchaseProduct:Er},Symbol.toStringTag,{value:"Module"})),Fi=new Set(["create_skill","list_skills","store_memory","search_memory","delete_memory","update_memory","get_schedules","delete_schedule","create_schedule","toggle_schedule","gmail_unread_count"]),qi=3,Gi=3,Sr=5,xr=.4,kr=5;async function Rr(e,t,n,s,r,a,i=!0){try{const o=r.filter(g=>!Fi.has(g));if(o.length<qi)return;const c=[...[...new Set(o)]].sort().join(","),d=await e.prepare(`INSERT INTO skill_patterns (user_id, tool_signature, user_message_sample, tool_sequence, turn_count, succeeded)
       VALUES (?, ?, ?, ?, ?, ?)
...
`)}
`}catch{return""}}async function zi(e,t,n){var i;let s=0,r=0,a=0;try{const o=await e.prepare(`SELECT us.id, us.user_id, us.name, us.instructions, us.refinement_count,
              us.confidence_score, us.usage_count
       FROM user_skills us
       WHERE us.user_id = ? AND us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < ? AND us.usage_count >= ?`).bind(n,xr,kr).all();for(const l of o.results??[]){s++;const c=await e.prepare(`SELECT user_message_sample, tool_sequence
         FROM skill_patterns
         WHERE auto_skill_id = ? AND succeeded = 1
         ORDER BY created_at DESC LIMIT 3`).bind(l.id).all();if((c.results??[]).length<2||l.refinement_count>=Sr){await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),await e.prepare(`INSERT INTO notifications (user_id, type, title, body, source, is_read)
...
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const v=(((i=(await t.chat(h,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);v&&v[1].trim()&&(await e.prepare(`UPDATE user_skills
             ...
             WHERE id = ?`).bind(v[1].trim(),l.id).run(),r++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:s,rewritten:r,disabled:a}}async function Ki(e,t,n,s,r){var R;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
     WHERE user_id = ? AND tool_signature = ?
     ORDER BY created_at DESC LIMIT 3`).bind(n.id,s).all()).results??[]).map($=>$.user_message_sample),o=[{role:"system",content:"You are a workflow analyst. Given examples of user requests that all triggered the same multi-tool sequence, write a concise reusable skill procedure."},{role:"user",content:`These user requests all produced the same multi-tool workflow:
...
INSTRUCTIONS: <step-by-step instructions referencing exact tool names, under 200 words>`}],c=((R=(await t.chat(o,{tools:[]})).content)==null?void 0:R.trim())??"",d=c.match(/^NAME:\s*(.+)$/m),u=c.match(/^DESCRIPTION:\s*(.+)$/m),h=c.match(/^INSTRUCTIONS:\s*([\s\S]+)$/m);if(!d||!u||!h)return;const f=d[1].trim(),g=u[1].trim(),v=h[1].trim();if(!f||!g||!v)return;let w=`auto_${f.toLowerCase().replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").substring(0,40)}`;await e.prepare("SELECT id FROM user_skills WHERE user_id = ? AND slug = ?").bind(n.id,w).first()&&(w=`${w}_${Date.now().toString().slice(-4)}`);const T=await e.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, required_tools, is_auto, source)
     VALUES (?, ?, ?, ?, ?, ?, 1, 'auto')
     RETURNING id`).bind(n.id,f,w,g,v,JSON.stringify(r)).first();T!=null&&T.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE user_id = ? AND tool_signature = ?").bind(T.id,n.id,s).run()}async function Yi(e,t,n,s,r,a){var u;const i=await e.prepare("SELECT name, instructions, refinement_count FROM user_skills WHERE id = ? AND user_id = ?").bind(s,n.id).first();if(!i||i.refinement_count>=Sr)return;const o=[{role:"system",content:"You are a workflow optimizer. Given an existing skill and a new usage example, decide if the instructions should be improved."},{role:"user",content:`Existing skill "${i.name}":
${i.instructions}
...
${s}
`:"",c=fn(t,Xi),d=a!=null&&a.trim()?fn(`## Pinned Notes Reference
${a}
...
---
## Current Date & Time
${$r(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.${n==="telegram"?'\n\n## TELEGRAM CONSTRAINTS\n- **Essays / save to Drive**: When the user wants an essay, article, or report saved to Google Drive (or says "store/save to drive"), you MUST call `create_doc` with the **full** text in the `content` parameter — never truncate for Telegram. Do NOT paste the essay body in chat (reply with title + Doc link only). Write from your knowledge unless they asked for research — do NOT call web_search before a plain essay. One `create_doc` call with title + full content (+ optional `folder_name`).\n- **Research + save**: One web_search, then immediately create_doc or gmail_draft with the findings. Do NOT call read_url on multiple pages. Pattern: web_search → create_doc (or gmail_draft).\n- **Reminders**: When the user says "remind me in X" or "set a reminder", you MUST call create_schedule. For a specific time/date ("at 13:00", "tomorrow at noon", "next Friday at 5pm"), ALWAYS use `schedule_value` with the exact datetime in the user\'s local timezone — NEVER use `minutes_from_now` for clock-time requests (it causes wrong times). Only use `minutes_from_now` for pure duration requests like "in 30 minutes" or "in 2 hours".\n- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I\'ll now..." — just call the tool.\n- **Long content intent check**: When asked to write long-form content (essay, article, report) WITHOUT any save destination (no mention of Drive, Google Doc, or "save/store"), ask first: "Should I save the full piece as a Google Doc and send you the link, or give you a brief summary here in chat?" Default to Google Doc for anything over ~300 words. If they already said Drive/Doc/save/store, skip this question and call `create_doc` with the complete text immediately. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**':""}`}async function yn(e,t,n){var c;const r=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${n.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let a;((c=r.files)==null?void 0:c.length)>0?a=r.files[0].id:a=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:n,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${a}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:a,folderName:n}}function $t(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").replace(/^\[calling:[^\]]*\]\s*/i,"").trim()}function $r(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}const Qi={read_sheet:"read",search_memory:"read",list_schedules:"read",write_sheet:"write",append_sheet:"write",update_schedule:"write",delete_schedule:"write",gmail_send:"external_effect",create_calendar_event:"external_effect"};function eo(e,t){const n=Qi[e]||"read";if(n==="read")return null;const s=Br(t);return n==="write"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} requires transaction_mode=execute.`:n==="external_effect"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} can cause external side effects and needs transaction_mode=execute.`:null}const to=["ETIMEDOUT","TIMEOUT","429","503","ECONNRESET","network"],no=new Set(["write_sheet","append_sheet","gmail_send","create_calendar_event","update_schedule","delete_schedule","delete_memory"]),so={create_schedule:{required:["name","schedule_type","action_type"],enum:{schedule_type:["interval","daily","weekly","once"]}},update_schedule:{required:["job_id"]},delete_schedule:{required:["job_id"]},write_sheet:{required:["spreadsheet_id","range","values"]},append_sheet:{required:["spreadsheet_id","range","values"]},gmail_send:{required:["to","subject","body"]}};function ro(e){const t=String((e==null?void 0:e.message)||e||"Unknown tool error");return/timeout|timed out/i.test(t)?"TOOL_TIMEOUT":/unauthorized|forbidden|401|403/i.test(t)?"TOOL_AUTH":/not found|404/i.test(t)?"TOOL_NOT_FOUND":/rate limit|429/i.test(t)?"TOOL_RATE_LIMIT":/validation|invalid|required/i.test(t)?"TOOL_VALIDATION":"TOOL_EXECUTION_FAILED"}function ao(e){const t=String((e==null?void 0:e.message)||e||"").toLowerCase();return to.some(n=>t.includes(n.toLowerCase()))}function io(e){const t=e.query??e.q??e.search_query??e.search;return typeof t=="string"?t.trim():""}function oo(e,t){const n=so[e];if(n){for(const s of n.required||[])if(t[s]===void 0||t[s]===null||t[s]==="")throw new Error(`Validation failed: ${s} is required for ${e}`);for(const[s,r]of Object.entries(n.enum||{}))if(t[s]!==void 0&&!r.includes(String(t[s])))throw new Error(`Validation failed: ${s} must be one of ${r.join(", ")}`)}}function Br(e){const t=e.transaction_mode;return t==="dry_run"||t==="confirm_required"||t==="execute"?t:"execute"}function lo(e,t){if(!no.has(e))return null;const n=Br(t);return n==="dry_run"?`DRY RUN: ${e} validated. No write action was executed.`:n==="confirm_required"?`CONFIRMATION REQUIRED: ${e} is a write action. Re-run with transaction_mode=execute to proceed.`:null}const co=new Set(["gmail_send","gmail_draft","gmail_modify","append_sheet","create_sheet","write_sheet","create_doc","append_to_doc","rewrite_doc","create_calendar_event","create_schedule","create_skill"]),uo=new Set(["list_schedules","search_memory","get_system_status","read_sheet","list_calendar_events","read_doc","gmail_list","gmail_read","gmail_search","gmail_unread_count","drive_list","drive_search","drive_read_file","web_search","read_url","research","browser_task_status","vault_lookup","search_places","get_place_details","get_directions","get_travel_time","translate_text","search_youtube","geocode_address","parse_document","search_library","read_library_file","list_skills"]),mo=5;async function Bt(e,t,n,s,r,a,i,o,l,c,d,u,h,f,g){const v=Date.now();let w=!0,b="",T="";const R=r.traceId||crypto.randomUUID(),$=`${s}:${e}:${JSON.stringify(t)}`;if(co.has(e)&&!uo.has(e))try{const U=await n.prepare(`SELECT tool_result FROM tool_execution_log
           WHERE user_id = ? AND tool_name = ? AND idempotency_key = ? AND success = 1
             AND created_at >= datetime('now', '-${mo} minutes')
           ORDER BY created_at DESC
           LIMIT 1`).bind(s,e,$).first();if(U)return U.tool_result||""}catch{}try{oo(e,t);const U=eo(e,t);if(U)return T=U,T;const B=lo(e,t);if(B)return T=B,T;const Y=2;for(let G=1;G<=Y;G++)try{const ne=e==="browser_task"?31e4:e==="browser_task_status"?35e3:e==="research"?31e4:9e4;T=await Promise.race([ho(e,t,n,s,a,i,o,l,c,d,u,h,f,r.channel,g),new Promise((M,W)=>setTimeout(()=>W(new Error("Tool timed out")),ne))]);break}catch(ne){if(G<Y&&ao(ne)){await new Promise(M=>setTimeout(M,250*G));continue}throw ne}return T}catch(U){throw w=!1,b=`${ro(U)}: ${U.message||"Unknown error"}`,new Error(b)}finally{const U=Date.now()-v;try{await n.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel, idempotency_key)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,r.agentType||null,r.providerName||null,e,JSON.stringify({...t,_idempotency_key:$,_trace_id:R}).substring(0,2e3),(w?T:"").substring(0,500),w?1:0,b||null,U,r.isEnforcementRetry?1:0,r.channel||"web",$).run()}catch{}}}function Pr(e){const t=e.length;for(let n=0;n<t-1;n++){const s=e[n];if(s.role!=="user"||typeof s.content!="string")continue;const r=t-1-n,a=r<=2?12e3:r<=4?5e3:2e3;s.content.length>a&&(e[n]={...s,content:s.content.substring(0,a)+`
[...truncated in history to reduce context size]`})}}function po(e){const t=[];let n=[],s="",r=!1,a=0;const i=e.length;for(;a<i;){const o=e[a];if(r){if(o==='"'){if(e[a+1]==='"'){s+='"',a+=2;continue}r=!1,a++;continue}s+=o,a++;continue}if(o==='"'){r=!0,a++;continue}if(o===","){n.push(s),s="",a++;continue}if(o==="\r"&&e[a+1]===`
`){n.push(s),t.push(n),n=[],s="",a+=2;continue}if(o===`
`||o==="\r"){n.push(s),t.push(n),n=[],s="",a++;continue}s+=o,a++}for((s||n.length)&&(n.push(s),t.push(n));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function ho(e,t,n,s,r,a,i,o,l,c,d,u,h,f,g){var w,b,T,R,$,I,U,B,Y,G,ne,M,W,q,Z,te,ie,se,me;const v=new X(n);switch(e){case"create_schedule":{const m=new Date;let E;const p=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){E=new Date(m.getTime()+t.minutes_from_now*60*1e3);const A=E.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,C,O]=(A[0]||"").split("/");t.schedule_value=`${O}-${N}-${C} ${A[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const D=parseInt(t.schedule_value,10);E=new Date(m.getTime()+D*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const D=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(D)){const[N,C]=t.schedule_value.split(":").map(Number),O=m.toLocaleString("en-US",{timeZone:p}),L=new Date(O),P=new Date(L);P.setHours(N,C,0,0),P<=L&&P.setDate(P.getDate()+1);const z=new Date(P.toLocaleString("en-US",{timeZone:"UTC"})),Q=new Date(P.toLocaleString("en-US",{timeZone:p})),K=z.getTime()-Q.getTime();E=new Date(P.getTime()+K)}else{const[N,C]=t.schedule_value.split(":").map(Number),O=m.toLocaleString("en-US",{timeZone:p}),L=new Date(O),P=new Date(L);P.setHours(N,C,0,0),P<=L&&P.setDate(P.getDate()+1);const z=Ie=>String(Ie).padStart(2,"0"),Q=P.getFullYear(),K=z(P.getMonth()+1),oe=z(P.getDate());t.schedule_value=`${Q}-${K}-${oe} ${z(N)}:${z(C)}`,t.schedule_type="once";const ce=new Date(P.toLocaleString("en-US",{timeZone:"UTC"})),pe=new Date(P.toLocaleString("en-US",{timeZone:p})),ve=ce.getTime()-pe.getTime();E=new Date(P.getTime()+ve)}}else if(t.schedule_type==="daily"){const[D,A]=t.schedule_value.split(":").map(Number),N=m.toLocaleString("en-US",{timeZone:p}),C=new Date(N),O=new Date(C);O.setHours(D,A,0,0),O<=C&&O.setDate(O.getDate()+1);const L=new Date(O.toLocaleString("en-US",{timeZone:"UTC"})),P=new Date(O.toLocaleString("en-US",{timeZone:p})),z=L.getTime()-P.getTime();E=new Date(O.getTime()+z)}else if(t.schedule_type==="weekly"){const[D,A]=t.schedule_value.split(" "),[N,C]=(A||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ve=>ve.toLowerCase()===D.toLowerCase()),P=m.toLocaleString("en-US",{timeZone:p}),z=new Date(P),Q=new Date(z);Q.setHours(N,C,0,0);let K=(L-Q.getDay()+7)%7;K===0&&Q<=z&&(K=7),Q.setDate(Q.getDate()+K);const oe=new Date(Q.toLocaleString("en-US",{timeZone:"UTC"})),ce=new Date(Q.toLocaleString("en-US",{timeZone:p})),pe=oe.getTime()-ce.getTime();E=new Date(Q.getTime()+pe)}else if(t.schedule_type==="once"){const[D,A]=t.schedule_value.split(" "),[N,C,O]=D.split("-").map(Number),[L,P]=(A||"00:00").split(":").map(Number),z=m.toLocaleString("en-US",{timeZone:p}),Q=new Date(z),K=new Date(Q);K.setFullYear(N,C-1,O),K.setHours(L,P,0,0);const oe=new Date(K.toLocaleString("en-US",{timeZone:"UTC"})),ce=new Date(K.toLocaleString("en-US",{timeZone:p})),pe=oe.getTime()-ce.getTime();E=new Date(K.getTime()+pe);const ve=new Date(m.getTime()+120*1e3);if(E.getTime()<m.getTime()+60*1e3){const Ie=E.toISOString();E=ve;const Ue=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${Ie} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${E.toISOString()}.]`;t._pastTimeWarning=Ue}}else E=new Date(m.getTime()+3600*1e3);if((t.schedule_type==="interval"||t.schedule_type==="daily"||t.schedule_type==="weekly")&&t.action_type==="custom"){const D=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(send|forward)\b.{0,40}\b(email|mail)\b|\bemail.{0,20}\bto\b|\bgmail_send\b/.test(D)&&(t.schedule_type="once")}if(t.action_type==="custom"&&t.schedule_type==="once"){const D=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(D)||(t.action_type="reminder")}if(await n.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(s,t.name,t.schedule_type,t.schedule_value).first()){const D=E.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${D} (${p}). No duplicate created.`}await n.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
`)}case"toggle_schedule":{const m=t.enabled?1:0,E=m?"active":"paused";return await n.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(m,E,t.job_id,s).run(),`Schedule ${t.job_id} ${m?"enabled (active)":"paused"}.`}case"update_schedule_state":{const m=["created","active","reminding","paused","completed"],E=t.state;if(!m.includes(E))return`Invalid state "${E}". Valid states: ${m.join(", ")}`;const p=E==="completed"||E==="paused"?0:1;return await n.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(E,p,t.job_id,s).run(),`Schedule ${t.job_id} state updated to "${E}".`}case"update_schedule":{const m=t.job_id,E=c||"UTC",p=new Date,y=["updated_at = CURRENT_TIMESTAMP"],_=[];t.name&&(y.push("name = ?"),_.push(t.name)),t.description&&(y.push("description = ?"),_.push(t.description));let S=null,x=t.schedule_type,D=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){S=new Date(p.getTime()+t.minutes_from_now*60*1e3);const C=S.toLocaleString("en-US",{timeZone:E,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[O,L,P]=(C[0]||"").split("/");D=`${P}-${O}-${L} ${C[1]||"00:00"}`,x="once"}else if(x&&D){if(x==="interval")S=new Date(p.getTime()+parseInt(D,10)*60*1e3);else if(x==="daily"){const[N,C]=D.split(":").map(Number),O=new Date(p.toLocaleString("en-US",{timeZone:E})),L=new Date(O);L.setHours(N,C,0,0),L<=O&&L.setDate(L.getDate()+1);const P=new Date(L.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(L.toLocaleString("en-US",{timeZone:E})).getTime();S=new Date(L.getTime()+P)}else if(x==="weekly"){const[N,C]=D.split(" "),[O,L]=(C||"00:00").split(":").map(Number),z=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(pe=>pe.toLowerCase()===N.toLowerCase()),Q=new Date(p.toLocaleString("en-US",{timeZone:E})),K=new Date(Q);K.setHours(O,L,0,0);let oe=(z-K.getDay()+7)%7;oe===0&&K<=Q&&(oe=7),K.setDate(K.getDate()+oe);const ce=new Date(K.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(K.toLocaleString("en-US",{timeZone:E})).getTime();S=new Date(K.getTime()+ce)}else if(x==="once"){const[N,C]=D.split(" "),[O,L,P]=N.split("-").map(Number),[z,Q]=(C||"00:00").split(":").map(Number),K=new Date(p.toLocaleString("en-US",{timeZone:E})),oe=new Date(K);oe.setFullYear(O,L-1,P),oe.setHours(z,Q,0,0);const ce=new Date(oe.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(oe.toLocaleString("en-US",{timeZone:E})).getTime();S=new Date(oe.getTime()+ce),S.getTime()<p.getTime()+60*1e3&&(S=new Date(p.getTime()+120*1e3))}}if(x&&(y.push("schedule_type = ?"),_.push(x)),D&&(y.push("schedule_value = ?"),_.push(D)),S&&(y.push("next_run = ?"),_.push(S.toISOString())),y.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";_.push(m,s),await n.prepare(`UPDATE cron_jobs SET ${y.join(", ")} WHERE id = ? AND user_id = ?`).bind(..._).run();const A=S?S.toLocaleString("en-US",{timeZone:E,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${m} updated.${A?` New fire time: ${A} (${E}).`:""} IMPORTANT: Use this exact time "${A}" when confirming to the user.`}case"delete_schedule":return await n.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,s).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const m=t.importance||5,E=t.type==="task"?"preference":t.type,p=m>=7?"working":"long_term";return await v.store(s,E,t.title,t.content,m,p),`Stored in ${p==="working"?"working":"long-term"} memory: [${E}] ${t.title} (importance: ${m})`}case"search_memory":{const m=await v.search(s,t.query);return m.length===0?"No matching memories found.":m.map(E=>`[id:${E.id}] [${E.tier||"long_term"}] [${E.type}] **${E.title}**: ${E.content}`).join(`
...
`)}catch(m){return await H(n,s,"google","read_sheet",m.message),`Failed to read sheet: ${m.message}`}}case"write_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const C=new X(n),O=JSON.stringify(t.values);await C.store(s,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:O.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const p=t.values;let y=t.range;const x=Math.max(...p.map(C=>C.length))+4,D=p.map(C=>{const O=[...C];for(;O.length<x;)O.push("");return O}),A=y.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(A){const C=A[1]||"",O=A[2],L=A[3],P=A[5],Q=O.toUpperCase().charCodeAt(0)-64+x-1,K=Q<=26?String.fromCharCode(64+Q):"Z";y=`${C}${O}${L}:${K}${P}`}const N=await m.sheets.writeRange(t.spreadsheet_id,y,D);try{const C=new X(n),O=await C.search(s,`Pending sheet write: ${t.spreadsheet_id}`);for(const L of O)L.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await C.remove(L.id,s)}catch{}return`Written ${N.updatedCells} cells to ${y}.`}catch(m){return await H(n,s,"google","write_sheet",m.message),`Failed to write sheet: ${m.message}`}}case"append_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new X(n).store(s,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const p=await m.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const y=new X(n),_=await y.search(s,`Pending sheet append: ${t.spreadsheet_id}`);for(const S of _)S.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await y.remove(S.id,s)}catch{}return`Appended ${p.updatedCells} cells to ${t.range}.`}catch(m){return await H(n,s,"google","append_sheet",m.message),`Failed to append to sheet: ${m.message}`}}case"create_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title)try{await new X(n).store(s,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`

The spreadsheet request has been saved to temporary memory. After reconnecting, tell me "create the pending spreadsheet" and I'll complete this automatically.`:"")}const p=await m.sheets.createSpreadsheet(t.title,t.sheet_names);let y="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||"");y=`
Folder: "${(await yn(_,p.spreadsheetId,t.folder_name)).folderName}"`}catch(_){y=`
...
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(m){return await H(n,s,"google","create_sheet",m.message),`Failed to create spreadsheet: ${m.message}`}}case"list_calendar_events":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||""),E=t.calendar_id||"primary",p=t.days_ahead||7,y=new Date,_=new Date(y.getTime()+p*24*60*60*1e3),S=await m.calendar.listEvents(E,{timeMin:y.toISOString(),timeMax:_.toISOString(),query:t.query});return S.length===0?`No events found in the next ${p} days.`:S.map(x=>{var O;const D=x.start.dateTime||x.start.date||"TBD",A=x.end.dateTime||x.end.date||"",N=x.location?` 📍 ${x.location}`:"",C=((O=x.attendees)==null?void 0:O.map(L=>L.email).join(", "))||"";return`• ${x.summary} — ${D} to ${A}${N}${C?`
  Attendees: ${C}`:""}`}).join(`
...
Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" and I'll complete this automatically.`:"")}let p;try{p=await m.docs.createDocument(t.title)}catch(_){return await H(n,s,"google","create_doc",_.message),`Failed to create document: ${_.message}`}if(t.content){const _=t.content,S=async()=>{_.length>12e3?await m.docs.appendText(p.documentId,_):await m.docs.appendFormattedContent(p.documentId,_)};try{await S()}catch(x){try{await m.docs.appendText(p.documentId,_)}catch(D){return await H(n,s,"google","create_doc_append",D.message),`Document created but content could not be written (${D.message}).
ID: ${p.documentId}
URL: ${p.url}

Use append_to_doc with the document ID above to add content.`}await H(n,s,"google","create_doc_append_fallback",`Formatted append failed, used plain text: ${x.message}`)}}let y="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||"");y=`
Folder: "${(await yn(_,p.documentId,t.folder_name)).folderName}"`}catch(_){y=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new X(n).store(s,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}try{const _=t.content;await n.prepare(`INSERT OR IGNORE INTO document_library (user_id, source, drive_file_id, name, summary, extracted_text, status)
           VALUES (?, 'drive', ?, ?, ?, ?, 'parsed')`).bind(s,p.documentId,t.title,_?_.substring(0,500):null,_?_.substring(0,5e4):null).run()}catch{}try{const _=new X(n),S=await _.search(s,`Pending Google Doc save: "${t.title}"`);for(const x of S)x.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await _.remove(x.id,s)}catch{}return`Document created: "${t.title}"${y}
ID: ${p.documentId}
...
Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const y=await m.send(t.to,t.subject,t.body,{cc:t.cc});try{const _=new X(n),S=await _.search(s,`Pending email: "${t.subject}"`);for(const x of S)x.title.startsWith(`Pending email: "${t.subject}"`)&&await _.remove(x.id,s)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${y.id}]`}catch(m){return await H(n,s,"gmail","send",m.message),`Gmail send error: ${m.message}`}}case"gmail_draft":{if(!r)return"Authentication context unavailable.";try{const m=new Re(n,s,r,a||"",i||"");if(!(await new we(n,s,r,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new X(n).store(s,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const y=await m.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const S=new X(n),x=await S.search(s,`Pending draft: "${t.subject}"`);for(const D of x)D.title.startsWith(`Pending draft: "${t.subject}"`)&&await S.remove(D.id,s)}catch{}const _=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${_}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${y.id}]`}catch(m){return await H(n,s,"gmail","draft",m.message),`Gmail draft error: ${m.message}`}}case"gmail_modify":{if(!r)return"Authentication context unavailable.";try{return await new Re(n,s,r,a||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(m){return await H(n,s,"gmail","modify",m.message),`Gmail modify error: ${m.message}`}}case"gmail_unread_count":{if(!r)return"Authentication context unavailable.";try{const E=await new Re(n,s,r,a||"",i||"").getUnreadCount();return`You have ${E} unread email${E!==1?"s":""} in Gmail.`}catch(m){return(R=m.message)!=null&&R.includes("not connected")?m.message:`Gmail error: ${m.message}`}}case"drive_list":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||""),E=new URLSearchParams;E.set("pageSize",String(t.max_results||10)),E.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),E.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",E.set("q",p);const y=await fetch(`https://www.googleapis.com/drive/v3/files?${E}`,{headers:{Authorization:`Bearer ${m}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const _=await y.json();return($=_.files)!=null&&$.length?_.files.map((S,x)=>{var C,O;const D=((C=S.mimeType)==null?void 0:C.split(".").pop())||S.mimeType,A=S.size?`${(parseInt(S.size)/1024).toFixed(1)} KB`:"",N=((O=S.modifiedTime)==null?void 0:O.split("T")[0])||"";return`${x+1}. **${S.name}** (${D})
   ${A} · Modified: ${N}
   ${S.webViewLink||""}`}).join(`

`):"No files found."}catch(m){return await H(n,s,"google","drive_list",m.message),`Drive list error: ${m.message}`}}case"drive_search":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||""),E=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",E),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const y=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${m}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const _=await y.json();return(I=_.files)!=null&&I.length?_.files.map((S,x)=>{var N,C;const D=((N=S.mimeType)==null?void 0:N.split(".").pop())||S.mimeType,A=((C=S.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${x+1}. **${S.name}** (${D}) — Modified: ${A}
   ${S.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(m){return await H(n,s,"google","drive_search",m.message),`Drive search error: ${m.message}`}}case"drive_read_file":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||""),E=t.url_or_id.trim();let p=E;const y=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const P of y){const z=E.match(P);if(z){p=z[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${m}`}});if(!_.ok)throw new Error(`Drive API error (${_.status}): could not fetch file metadata`);const S=await _.json(),{name:x,mimeType:D}=S,A=t.extract_focus,N=A?`Focus specifically on extracting: ${A}`:"Extract and return all readable text content. Preserve structure where relevant.",C={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(C[D]){const P=C[D],z=await fetch(`https://www.googleapis.com/drive/v3/files/${p}/export?mimeType=${encodeURIComponent(P)}`,{headers:{Authorization:`Bearer ${m}`}});if(!z.ok)throw new Error(`Drive export error (${z.status})`);const Q=await z.text();if(D==="application/vnd.google-apps.spreadsheet"){const K=po(Q),oe=K.length,ce=((U=K[0])==null?void 0:U.length)??0;return`**${x}** (Google Sheet — ${oe} rows × ${ce} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(K)}`}return`**${x}**

${Q.substring(0,2e4)}`}if(D==="application/pdf"||x.toLowerCase().endsWith(".pdf")){const P=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!P.ok)throw new Error(`Drive download error (${P.status})`);const z=await P.arrayBuffer(),Q=Buffer.from(z).toString("base64");let K=null,oe="claude-sonnet-4-6";for(const Ie of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const Ue=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,Ie).first();if(Ue&&r){const ea=await V(Ue.encrypted_value,r),zt=JSON.parse(ea);if(zt.provider==="anthropic"){K=zt.apiKey,zt.model&&(oe=zt.model);break}}}catch{}if(!K)return`"${x}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const ce=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":K,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:oe,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:Q}},{type:"text",text:N}]}]})});if(!ce.ok){const Ie=await ce.text();throw new Error(`Anthropic PDF extraction error: ${Ie.substring(0,200)}`)}const ve=((Y=(B=(await ce.json()).content)==null?void 0:B[0])==null?void 0:Y.text)||"";return`**${x}** (PDF from Drive)

${ve}`}const O=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!O.ok)throw new Error(`Drive download error (${O.status})`);const L=await O.text();return`**${x}** (${D})

${L.substring(0,2e4)}`}catch(m){return await H(n,s,"google","drive_read_file",m.message),`Drive read error: ${m.message}`}}case"drive_delete_file":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||""),E=t.url_or_id.trim();let p=E;const y=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const D of y){const A=E.match(D);if(A){p=A[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=name`,{headers:{Authorization:`Bearer ${m}`}});if(!_.ok)throw new Error(`Drive API error (${_.status})`);const S=await _.json(),x=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!x.ok)throw new Error(`Drive API error (${x.status})`);return`"${S.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(m){return await H(n,s,"google","drive_delete_file",m.message),`Drive delete error: ${m.message}`}}case"drive_organise":{if(!r)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:m}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(n,s,r,a||"",i||""),E=t.url_or_id.trim();let p=E;const y=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const S of y){const x=E.match(S);if(x){p=x[1];break}}const _=[];if(t.new_name){const S=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!S.ok)throw new Error(`Drive rename error (${S.status})`);_.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:S}=await yn(m,p,t.folder_name);_.push(`Moved to folder "${S}"`)}return _.join(". ")+"."}catch(m){return await H(n,s,"google","drive_organise",m.message),`Drive organise error: ${m.message}`}}case"web_search":try{const m=await Lt(t.query,{num:t.num_results||5,site:t.site,googleApiKey:o||void 0,googleCseId:l||void 0});return m.error?`Web search failed: ${m.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:m.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:m.results.map((E,p)=>`${p+1}. [${E.title}](${E.link})
   ${E.snippet}`).join(`

`)}catch(m){return await H(n,s,"search","web_search",m.message),`Web search error: ${m.message}`}case"read_url":try{const m=t.url;if(!m||!m.startsWith("http://")&&!m.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const E=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>Ai),y=await p(m,E);return y.error?`Failed to read page: ${y.error}`:!y.text||y.text.length<20?`Page at ${m} returned no readable content.`:`Content from ${m} (${y.text.length} chars):

${y.text}`}catch(m){return await H(n,s,"search","read_url",m.message),`Read URL error: ${m.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{let m,E;try{for(const N of["llm_slot_1","llm_slot_2","llm_slot_3"]){const C=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,N).first();if(!C||!r)continue;const O=JSON.parse(await V(C.encrypted_value,r));if(O.provider==="anthropic"&&O.apiKey){m=O.apiKey;break}}const A=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"tavily_api_key").first();A&&r&&(E=await V(A.encrypted_value,r))}catch{}const p=t.depth||"quick",y=p==="thorough"?3e5:9e4,_=hr(t.query,d,{depth:p,site:t.site,anthropicKey:m,tavilyKey:E,googleApiKey:o||void 0,googleCseId:l||void 0}),S=new Promise(A=>setTimeout(()=>A(null),y)),x=await Promise.race([_,S]);if(x===null){const{webSearch:A}=await Promise.resolve().then(()=>wi),N=await A(t.query,{num:5,googleApiKey:o||void 0,googleCseId:l||void 0});if(N.error||N.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let C=`Research took too long, but here are the top search results:

`;return C+=N.results.map((O,L)=>`${L+1}. [${O.title}](${O.link})
   ${O.snippet}`).join(`
...
---
💡 *Say "save as note" to store this report in your notes.*`;try{const A=new X(n),N=x.report.substring(0,600);await A.store(s,"context",`Research: ${t.query.substring(0,80)}`,N,6,"long_term")}catch{}return D}catch(m){return await H(n,s,"research","research",m.message),`Research error: ${m.message}`}}case"save_note":try{const m=(t.content||"").trim();if(!m)return"Note content cannot be empty.";const E=t.source||"manual",p=["manual","research","chat"].includes(E)?E:"manual",y=await n.prepare(`INSERT INTO notes (user_id, title, content, tags, source, source_query, is_pinned)
...
${x.substring(0,2e4)}`}catch{return`Could not decode text file: ${y}`}if(_==="application/pdf"||_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||y.toLowerCase().endsWith(".pdf")||y.toLowerCase().endsWith(".docx")){if(_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||y.toLowerCase().endsWith(".docx")){try{const A=await br(Buffer.from(S,"base64"));if(A.length>50){try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(A,m,s).run();const N=A.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(N,A.substring(0,5e4),m,s).run(),h!=null&&h.ai&&(h!=null&&h.vectorize)){const C=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(C){const{indexDocumentChunks:O}=await Promise.resolve().then(()=>Ke);O({DB:n,AI:h.ai,VECTORIZE:h.vectorize},s,C.id,A).catch(()=>{})}}}catch{}return`Document: ${y}

${A.substring(0,2e4)}`}}catch{}return`Could not extract text from "${y}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let x=null,D="claude-sonnet-4-6";for(const A of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const N=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,A).first();if(N&&r){const C=await V(N.encrypted_value,r),O=JSON.parse(C);if(O.provider==="anthropic"){x=O.apiKey,O.model&&(D=O.model);break}}}catch{}if(x)try{const A=E?`Focus specifically on extracting: ${E}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",N=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":x,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:S}},{type:"text",text:A}]}]})});if(N.ok){const O=((M=(ne=(await N.json()).content)==null?void 0:ne[0])==null?void 0:M.text)||"";if(O&&O.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(O,m,s).run();const L=O.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(L,O.substring(0,5e4),m,s).run(),h!=null&&h.ai&&(h!=null&&h.vectorize)){const P=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(P){const{indexDocumentChunks:z}=await Promise.resolve().then(()=>Ke);z({DB:n,AI:h.ai,VECTORIZE:h.vectorize},s,P.id,O).catch(()=>{})}}}catch{}return`Document: ${y}

${O}`}else{const C=await N.text();return`Could not parse ${y} via Anthropic API: ${C.substring(0,200)}`}}catch(A){return`Document parsing error for ${y}: ${A.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}if(_.startsWith("image/")){let x=null,D="claude-sonnet-4-6";for(const N of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const C=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,N).first();if(C&&r){const O=await V(C.encrypted_value,r),L=JSON.parse(O);if(L.provider==="anthropic"){x=L.apiKey,L.model&&(D=L.model);break}}}catch{}if(!x)return"To extract text from images, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set.";const A=E?`Focus specifically on: ${E}`:"Extract all visible text from this image. Include any text from signs, documents, screenshots, or diagrams. If the image contains charts or tables, describe their structure and data.";try{const N=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":x,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:_,data:S}},{type:"text",text:A}]}]})});if(N.ok){const O=((q=(W=(await N.json()).content)==null?void 0:W[0])==null?void 0:q.text)||"";if(O&&O.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(O,m,s).run();const L=O.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(L,O.substring(0,5e4),m,s).run(),h!=null&&h.ai&&(h!=null&&h.vectorize)){const P=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(P){const{indexDocumentChunks:z}=await Promise.resolve().then(()=>Ke);z({DB:n,AI:h.ai,VECTORIZE:h.vectorize},s,P.id,O).catch(()=>{})}}}catch{}return`Document: ${y}

${O}`}else{const C=await N.text();return`Could not parse ${y} via Anthropic API: ${C.substring(0,200)}`}}catch(N){return`Image parsing error for ${y}: ${N.message}`}}try{const x=Buffer.from(S,"base64").toString("utf-8").substring(0,2e3);return`Document: ${y} (${_})

Content preview:
${x}`}catch{return`Cannot read file: ${y} (${_})`}}case"search_library":{const m=t.query,E=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!m)return"query is required for search_library.";if(h!=null&&h.ai&&(h!=null&&h.vectorize))try{const{semanticDocumentSearch:x}=await Promise.resolve().then(()=>Ke),D=await x({DB:n,AI:h.ai,VECTORIZE:h.vectorize},s,m,E);if(D.length>0){const A=D.map(N=>`[id:${N.document_id}] "${N.filename}" (relevance: ${(N.relevance_score*100).toFixed(1)}%)
...
Use read_library_file with the id to get the full document text.`}}catch{}const p=await n.prepare(`
      ...
      `).bind(s,`%${m}%`,`%${m}%`,`%${m}%`,E).all(),y=await n.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(s,s,`%${m}%`,s,`%${m}%`,`%${m}%`,`%${m}%`,E).all(),_=[...p.results||[],...y.results||[]].slice(0,E);if(_.length===0)return`No documents found matching "${m}" in your library.`;const S=_.map(x=>{const D=(x.summary||x.dl_extracted||"").substring(0,200);return`[id:${x.id}] "${x.name}" (source: ${x.source}, status: ${x.status})
...
${y.substring(0,2e4)}`:`Document "${p.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${p.file_id}") to extract the text first.`}case"create_skill":{const m=(Z=t.name)==null?void 0:Z.trim(),E=(te=t.description)==null?void 0:te.trim(),p=(ie=t.instructions)==null?void 0:ie.trim();if(!m||!E||!p)return"create_skill requires name, description, and instructions.";let y=m.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");y||(y=`skill_${Date.now()}`);const _=await n.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(s,`${y}%`).all();(se=_.results)!=null&&se.some(A=>A.slug===y)&&(y=`${y}_${(((me=_.results)==null?void 0:me.length)||0)+1}`);const S=JSON.stringify(t.parameters||{}),x=JSON.stringify(t.required_tools||[]),D=JSON.stringify(t.examples||[]);return await n.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,m,y,E,p,S,x,D).run(),`Skill created: **${m}** (invoke as: "${y}")

You can now ask me to run "${m}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${m} skill" to execute it.`}case"list_skills":{const E=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",y=(await n.prepare(E).bind(s).all()).results||[];if(y.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const _=y.map(S=>`• **${S.name}** (${S.slug}): ${S.description} [used ${S.usage_count} times${S.enabled?"":" — disabled"}]`).join(`
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function jr(e,t,n,s,r){if(t.length>0&&t[t.length-1].role==="user"){const a="(Previous request did not complete. Please try again.)";await e.storeMessage(n,s,"assistant",a,"{}",r),t.push({id:-1,user_id:n,channel:s,role:"assistant",content:a,metadata:"{}",token_estimate:a.length,created_at:new Date().toISOString()})}}function Ur(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const n=typeof e[t].content=="string"?e[t].content:"";n.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(n.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function ds(e,t,n,s,r,a,i){var ie,se,me,m,E;const o=new X(t),l=(ie=e.metadata)==null?void 0:ie.thread_id,c=Date.now(),[d,u,h,f]=await Promise.all([o.buildContext(s.id),Nn(t,s.id),Gn(t,s.id),Dr(t,s.id)]),g=await o.getRecentConversations(s.id,30,l);await jr(o,g,s.id,e.channel,l);const v=Mr(s,d,e.channel,h,f,u),w=Hn(g),b=Fn([{role:"system",content:v},...Un(g),{role:"user",content:e.text}]);Lr(b,w),Ur(b);const T=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],R=(d.match(/^- /gm)||[]).length;if(T.some(p=>p.test(e.text))||R<3)try{const p=await o.searchLongTerm(s.id,e.text,5);if(p.length>0){const y=p.map(_=>`- [${_.type}] ${_.title}: ${_.content}`).join(`
...
`)){const h=u.trim().split("|");if(h.length<4)continue;const[f,g,v,w]=h,b=["fact","preference","context","decision","summary","task"].find(R=>R===f.trim().toLowerCase());if(!b||!(g!=null&&g.trim())||!(v!=null&&v.trim()))continue;const T=Math.min(10,Math.max(1,parseInt(w)||5));await s.store(n.id,b,g.trim(),v.trim(),T,"long_term")}}const us={"claude-opus-4-8":1e6,"claude-sonnet-4-6":1e6,"claude-haiku-4-5":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function fo(e){for(const[t,n]of Object.entries(us))if(e.toLowerCase().includes(t.toLowerCase()))return n;return us.default}function yo(e,t,n,s){const r=fo(s),a=Math.floor(r*.75),i=[];let o=0,l=!1;const c=gn(e);i.push({role:"system",content:e}),o+=c;const d=gn(n);o+=d;const u=a-o,h=[];let f=0;for(let g=t.length-1;g>=0;g--){const v=t[g],w=gn(v.content);if(f+w<=u)h.unshift({role:v.role,content:v.content}),f+=w;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:n}),o+=f,{maxTokens:r,usedTokens:o,messages:i,wasTruncated:l}}async function*vo(e,t,n,s,r,a){var me,m,E;const i=new X(t),o=(me=e.metadata)==null?void 0:me.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:n.name}};const[c,d,u,h]=await Promise.all([i.buildContext(s.id),Nn(t,s.id),Gn(t,s.id),Dr(t,s.id)]),f=await i.getRecentConversations(s.id,30,o);await jr(i,f,s.id,e.channel,o);const g=Mr(s,c,e.channel,u,h,d),v=Hn(f),w=Fn([...Un(f)]);let b=e.text;v&&(b=`${Sn}

${e.text}`);const T=yo(g,w.map(p=>({role:p.role,content:p.content})),b,n.name);await i.storeMessage(s.id,e.channel,"user",e.text,"{}",o);const R=await qn(t,s.id),$=10;let I="",U=0;const B=[...T.messages],Y=[];let G,ne=0,M=0;const W={hasActiveTask:!1,persistSession:!1,threadId:o,channel:e.channel},q=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],Z=(c.match(/^- /gm)||[]).length;if(q.some(p=>p.test(e.text))||Z<3||v)try{const p=await i.searchLongTerm(s.id,e.text,5);if(p.length>0){const y=p.map(_=>`- [${_.type}] ${_.title}: ${_.content}`).join(`
`);B.splice(B.length-1,0,{role:"assistant",content:"I retrieved some relevant context from your long-term memory."},{role:"user",content:`[Long-term memory retrieved for this query:
${y}]`})}}catch{}Ur(B);const ie=()=>Ir(Y,G);for(let p=0;p<$;p++){ne=p+1;try{p>0&&(yield{type:"thinking",data:{threadId:o}},Pr(B));const y=await n.chat(B,{tools:R});if(y.usage&&(U+=y.usage.promptTokens+y.usage.completionTokens),y.toolCalls&&y.toolCalls.length>0){const x=((m=y.content)==null?void 0:m.trim())??"";x&&x.length<=150&&!/^\[calling:/i.test(x)&&(yield{type:"chunk",data:{text:y.content,threadId:o}});const D=y.content||"(tools executed)";B.push({role:"assistant",content:D});const A=[];for(const N of y.toolCalls){yield{type:"tool_start",data:{tool:N.name,toolArgs:N.arguments,threadId:o}},Y.push(N.name);try{const C=(Q,K)=>Bt(Q,K,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},W);let O;if(N.name==="research"&&(yield{type:"research_ack",data:{message:(N.arguments.depth||"quick")==="thorough"?"Starting deep research with Opus 4.8 — planning queries, reading sources, and identifying gaps. This takes 2-4 minutes.":"Researching with Opus 4.8... (~45 seconds)",threadId:o}}),N.name==="browser_task"||N.name==="browser_task_status"){if(N.name==="browser_task"){const pe=N.arguments.site_name;yield{type:"browser_ack",data:{message:pe?`Starting now — opening ${pe} in a browser. I'll notify you when done.`:"Starting now — running browser task. I'll notify you when done.",startedAt:new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:s.timezone||"UTC"}),threadId:o}}}const K=["Still working — browser launched, navigating to site...","Still working — page loaded, scanning for content...","Still working — reading and extracting results...","Still working — almost there, finalising output...","Taking a bit longer — site may require extra steps...","Still running — browser is working through the page...","Continuing — extracting and processing data...","Still going — complex task, nearly there...","Almost done — wrapping up the browser session...","Still running — holding on a little longer...","Browser is still active — this one is taking time...","Patience — still working through the task...","Still running — will have a result for you shortly..."],oe=C(N.name,N.arguments);let ce=0;e:for(;;){const pe=await Promise.race([oe.then(ve=>({done:!0,r:ve})),new Promise(ve=>setTimeout(()=>ve({done:!1}),15e3))]);if(pe.done){O=pe.r;break e}N.name==="browser_task"?yield{type:"browser_progress",data:{message:K[Math.min(ce,K.length-1)],elapsed_s:(ce+1)*15,threadId:o}}:yield{type:"thinking",data:{threadId:o}},ce++}if(N.name==="browser_task"){const pe=O.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(pe){yield{type:"browser_progress",data:{message:"Task still running — checking final status...",threadId:o}};const ve=C("browser_task_status",{task_id:pe[1]});e:for(;;){const Ie=await Promise.race([ve.then(Ue=>({done:!0,r:Ue})),new Promise(Ue=>setTimeout(()=>Ue({done:!1}),15e3))]);if(Ie.done){O=Ie.r;break e}yield{type:"thinking",data:{threadId:o}}}if(!O.startsWith("[still-running]")&&!O.startsWith("[NO-OUTPUT]")&&!O.startsWith("Browser"))try{await t.prepare("DELETE FROM pending_browser_tasks WHERE user_id = ? AND task_id = ? AND notified = 0").bind(s.id,pe[1]).run()}catch{}}}}else O=await C(N.name,N.arguments);let L=O;(N.name==="browser_task"||N.name==="browser_task_status")&&(/^\[BROWSER_TIMEOUT:/.test(L)?L="Task timed out — still running in background.":/^\[NO-OUTPUT\]/.test(L)?L="Browser task finished but returned no content.":/^\[still-running\]/.test(L)?L="Still running — will notify when done.":L=L.replace(/\s*\|\s*Operator hint:.*$/s,"")),yield{type:"tool_end",data:{tool:N.name,toolResult:L.substring(0,500)+(L.length>500?"...":""),threadId:o}};const P=["parse_document","drive_read_file","read_library_file"].includes(N.name)?2e4:8e3,z=O.length>P?O.substring(0,P)+`
[...result truncated to prevent token limit — full content was extracted]`:O;G=Ar(N.name,N.arguments,O,G),A.push(`[Tool Result for ${N.name}]: ${z}`)}catch(C){M++,await H(t,s.id,"tool",N.name,C.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:N.name,toolResult:`Error: ${C.message||"Execution failed"}`,threadId:o}},A.push(`[Tool Error for ${N.name}]: ${C.message||"Execution failed"}`)}}B.push({role:"user",content:A.join(`

`)});continue}I=y.content;const _=$t(I);await i.storeMessage(s.id,e.channel,"assistant",_,ie(),o);const S=50;for(let x=0;x<_.length;x+=S)yield{type:"chunk",data:{text:_.substring(x,x+S),threadId:o}},x+S<_.length&&await new Promise(A=>setTimeout(A,10));break}catch(y){if(r){const x=y.message||"",D=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),A=x.includes("429"),N=D?1440:A?10:5;await r.recordError(n.name,x,N)}await H(t,s.id,"llm","provider_error",y.message||"Unknown LLM error",{provider:n.name,turn:p});const _=y.message||"An error occurred",S=_.includes("429")||_.toLowerCase().includes("rate limit")||_.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":_;try{await i.storeMessage(s.id,e.channel,"assistant",`⚠️ ${S}`,"{}",o)}catch{}yield{type:"error",data:{error:S,threadId:o}};return}}if(I=(I==null?void 0:I.trim())??"",!I)try{B.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),I=(await n.chat(B,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const y=$t(I);await i.storeMessage(s.id,e.channel,"assistant",y,ie(),o);const _=50;for(let S=0;S<y.length;S+=_)yield{type:"chunk",data:{text:y.substring(S,S+_),threadId:o}},S+_<y.length&&await new Promise(x=>setTimeout(x,10))}catch{I="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(s.id,e.channel,"assistant",I,ie(),o).catch(()=>{}),yield{type:"chunk",data:{text:I,threadId:o}}}if(r&&U>0)try{await r.recordUsage(n.name,U)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"full",U,Date.now()-l,1,e.channel).run()}catch{}const se=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const p of se){const y=p.claimPattern.test(I),_=p.requiredTools.some(S=>Y.includes(S));if(y&&!_){try{await H(t,s.id,"llm",p.logType,"LLM claimed action without tool call (streaming)",{response:I.substring(0,200)}),B.push({role:"assistant",content:I}),B.push({role:"user",content:p.enforcementMsg});const S=await n.chat(B,{tools:R.filter(x=>p.requiredTools.includes(x.name)),temperature:0});if((E=S.toolCalls)!=null&&E.length){for(const D of S.toolCalls){const A=await Bt(D.name,D.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});Y.push(D.name),B.push({role:"assistant",content:"",toolCalls:S.toolCalls}),B.push({role:"user",content:A})}const x=await n.chat(B,{tools:[]});x.content&&(I=x.content)}else I="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}Y.length>=3&&Promise.race([Rr(t,n,s,e.text,Y,ne,M===0),new Promise(p=>setTimeout(p,6e3))]).catch(()=>{}),W.sessionId&&W.apiKey&&!W.hasActiveTask&&!W.persistSession&&rn(W.sessionId,W.apiKey).catch(()=>{}),yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:U}}}async function xn(e,t,n,s,r,a,i,o){await a.storeMessage(r.id,t.channel,"user",t.text,"{}",o);const l=await Bt(e.tool,e.args,n,r.id,{agentType:"direct",channel:t.channel},r.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,r.timezone,s,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),c=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await a.storeMessage(r.id,t.channel,"assistant",c,"{}",o),l}async function Wn(e,t,n,s,r,a){var v;const i=new X(t),o=(v=e.metadata)==null?void 0:v.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Ln(e.text,l,Cr(c));if(d.agent==="conversation")return Hr(e,t,n,s,l,r,o);const u=$n(e.text);if(u)return xn(u,e,t,n,s,i,a,o);const h=(await i.getRecentConversations(s.id,10,o)).map(w=>w.content).join(`
`),f=Bn(e.text,h);if(f)return xn(f,e,t,n,s,i,a,o);const g=d.confidence>=.85;if(e.channel==="telegram"){const w=await qn(t,s.id);return ds(e,t,n,s,r,a,{maxTurns:10,tools:w,forceToolUseOnFirstTurn:g})}return ds(e,t,n,s,r,a,{forceToolUseOnFirstTurn:g})}async function Hr(e,t,n,s,r,a,i){const o=new X(t),l=Date.now(),c=$r(s.timezone),d=await Gn(t,s.id),u=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${r}`:r,h=Tr("conversation",s,u,s.timezone,c,e.channel),f=(await o.getRecentConversations(s.id,30,i)).filter(R=>!R.content.startsWith("[Autonomous Scheduled Task]")&&!R.content.startsWith("[Scheduled Reminder]")),g=Hn(f),v=Fn([{role:"system",content:h},...Un(f),{role:"user",content:e.text}]);Lr(v,g),await o.storeMessage(s.id,e.channel,"user",e.text,"{}",i);let w=0,b="";try{const R=await n.chat(v,{temperature:.8});R.usage&&(w=R.usage.promptTokens+R.usage.completionTokens),b=R.content}catch(R){if(a){const $=R.message||"",I=$.includes("401")||$.includes("403")||$.includes("authentication")||$.includes("credit balance"),U=$.includes("429"),B=I?1440:U?10:5;await a.recordError(n.name,$,B)}throw await H(t,s.id,"llm","conversation_error",R.message,{provider:n.name}),R}if(a&&w>0)try{await a.recordUsage(n.name,w)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"conversation",w,Date.now()-l,1,e.channel).run()}catch{}const T=$t(b);return await o.storeMessage(s.id,e.channel,"assistant",T,"{}",i),T}async function*ms(e,t,n,s,r,a,i,o){yield{type:"tool_start",data:{tool:e.tool,toolArgs:e.args,threadId:o}};const l=await xn(e,t,n,s,r,a,i,o);yield{type:"tool_end",data:{tool:e.tool,toolResult:l.substring(0,500)+(l.length>500?"...":""),threadId:o}};const c=$t(l),d=50;for(let u=0;u<c.length;u+=d)yield{type:"chunk",data:{text:c.substring(u,u+d),threadId:o}},u+d<c.length&&await new Promise(h=>setTimeout(h,10));yield{type:"done",data:{threadId:o,provider:s.name,tokenCount:0}}}async function*wo(e,t,n,s,r,a){var u;const i=new X(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Ln(e.text,l,Cr(c));if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){const h=$n(e.text);if(h){yield*ms(h,e,t,n,s,i,a,o);return}const f=(await i.getRecentConversations(s.id,10,o)).map(v=>v.content).join(`
`),g=Bn(e.text,f);if(g){yield*ms(g,e,t,n,s,i,a,o);return}yield*vo(e,t,n,s,r,a);return}try{const h=await Hr(e,t,n,s,l,r,o),f=50;for(let g=0;g<h.length;g+=f)yield{type:"chunk",data:{text:h.substring(g,g+f),threadId:o}},g+f<h.length&&await new Promise(v=>setTimeout(v,10))}catch(h){yield{type:"error",data:{error:h.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const le=new _e;async function bo(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}le.use("/*",bo);le.get("/threads",async e=>{const t=e.get("user"),n=e.req.query("archived")==="1",s=parseInt(e.req.query("limit")||"30"),r=await e.env.DB.prepare(`SELECT t.*, 
...
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=r;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:s,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Ve(e.env.DB,t.id,t.pin_hash),u=new ReadableStream({async start(h){const f=new TextEncoder;try{const g=wo(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const v of g)v.data.threadId||(v.data.threadId=o),h.enqueue(f.encode(ps(v)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),h.close()}catch(g){const v={type:"error",data:{error:g.message||"An error occurred",threadId:o}};h.enqueue(f.encode(ps(v))),h.close()}}});return new Response(u,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});le.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(r).all(),i=[];for(const o of a.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(r,o.id).run();const l=o.user_timezone||"UTC";let c,d=!1,u=o.state||"active";if(o.schedule_type==="interval"){const g=parseInt(o.schedule_value,10);c=new Date(s.getTime()+g*60*1e3)}else if(o.schedule_type==="daily"){const[g,v]=o.schedule_value.split(":").map(Number),w=hs(l),b=new Date(w);b.setHours(g,v,0,0),b<=w&&b.setDate(b.getDate()+1);const T=new Date(b.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(b.toLocaleString("en-US",{timeZone:l})),$=T.getTime()-R.getTime();c=new Date(b.getTime()+$)}else if(o.schedule_type==="weekly"){const[g,v]=o.schedule_value.split(" "),[w,b]=(v||"00:00").split(":").map(Number),R=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ne=>ne.toLowerCase()===g.toLowerCase()),$=hs(l),I=new Date($);I.setHours(w,b,0,0);let U=(R-I.getDay()+7)%7;U===0&&I<=$&&(U=7),I.setDate(I.getDate()+U);const B=new Date(I.toLocaleString("en-US",{timeZone:"UTC"})),Y=new Date(I.toLocaleString("en-US",{timeZone:l})),G=B.getTime()-Y.getTime();c=new Date(I.getTime()+G)}else o.schedule_type==="once"?(d=!0,u="completed",c=new Date(s.getTime()+365*24*60*60*1e3)):c=new Date(s.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,c.toISOString(),d?0:o.enabled,u,o.id).run();const f=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:f,next_run:c.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}try{const{MemoryService:o}=await Promise.resolve().then(()=>ci),l=await e.env.DB.prepare("SELECT id FROM users").all();for(const c of l.results||[])await new o(e.env.DB).cleanupDoneTasks(c.id)}catch{}return e.json({executed:i.length,results:i,timestamp:r})});Ne.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);const s=parseInt(e.req.param("jobId"),10);if(!s)return e.json({error:"Invalid job ID"},400);const r=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(s).first();if(!r)return e.json({error:"Job not found"},404);const i=JSON.parse(r.action_config||"{}").description||r.description||"",o="⏰ "+(r.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=r.action_type==="reminder",u=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&r.action_type==="custom"&&u.test(i),d)c=i||r.name||"Time for your scheduled task.";else try{const b={id:r.user_id,username:r.username||"user",name:r.user_name||"User",pin_hash:r.pin_hash||"",personality_prompt:r.personality_prompt||"",telegram_chat_id:r.telegram_chat_id||"",timezone:r.user_timezone||"UTC",assistant_name:r.assistant_name||"Karna",created_at:"",updated_at:""},T={userId:r.user_id,username:b.username,channel:"cron",text:So(r.name,i,r.action_type,r.schedule_type),sessionId:"cron-"+r.id,timestamp:l},{provider:R,rotation:$}=await Ve(e.env.DB,r.user_id,r.pin_hash);c=await Wn(T,e.env.DB,R,b,$,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(b){const T=b.message||"unknown error",R=T.includes("rate_limit")||T.includes("429")||T.includes("quota"),$=T.includes("timeout")||T.includes("Timeout");R?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":$?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await H(e.env.DB,r.user_id,"cron_agent","execution_error",T,{job_id:r.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(r.action_type))try{const b=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(r.user_id).first();(!b||b.cnt===0)&&await H(e.env.DB,r.user_id,"cron_verification","no_tools_called",`Cron job "${r.name}" (${r.action_type}) completed without any tool calls`,{job_id:r.id,action_type:r.action_type,response_preview:c.substring(0,200)})}catch{}let f=c||i||"Time for your scheduled task.";f=f.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const g=o+`
`+f,v=await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0) RETURNING id").bind(r.user_id,"reminder",o,f,"cron:"+r.id).first();v==null||v.id,d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(r.user_id,"system","assistant",g,JSON.stringify({type:"cron",job_id:r.id})).run();const w=await e.env.DB.prepare("SELECT pin_hash FROM users WHERE id = ?").bind(r.user_id).first();return w!=null&&w.pin_hash&&await Rt(e.env.DB,r.user_id,o,f,{pinHash:w.pin_hash,priority:"default",tags:["reminder","karna"]}),e.json({job_id:s,status:"completed",response_length:c.length})});async function Fr(e){var s;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return null;const n=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(n==null?void 0:n.user_id)||null}Ne.get("/health/tools",async e=>{var n;const t=await Fr(e);if(!t)return e.json({error:"Not authenticated"},401);try{const s=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function So(e,t,n,s){return n==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:n==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
CRITICAL SAFETY RULE: This is a RECURRING scheduled task. You MUST NOT call gmail_send or gmail_draft — sending emails on every cron tick spams recipients. Report findings as text only.`:""}${Ot}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${Ot}`}Ne.post("/cron/check-browser-tasks",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);let s=0,r=0;try{const a=await e.env.DB.prepare(`SELECT pbt.id, pbt.user_id, pbt.task_id, pbt.task_description,
       ...
       LIMIT 10`).all();for(const i of a.results||[]){s++;try{const o=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'browser_use_api_key'").bind(i.user_id).first();if(!o)continue;const l=(await V(o.encrypted_value,i.pin_hash)).trim(),c=await wr(i.task_id,l,{waitMs:8e3});if(!c.done)continue;const d=i.task_description?`"${i.task_description.substring(0,80)}${i.task_description.length>80?"...":""}"`:"Your browser task";let u,h;if(c.status==="finished"&&c.output?(u="Browser task completed",h=`${d} finished.

${c.output.substring(0,500)}${c.output.length>500?"...":""}`):c.status==="finished"?(u="Browser task completed (no output)",h=`${d} finished, but the browser returned no readable content. You may want to retry.`):(u="Browser task ended",h=`${d} ended with status "${c.status}". Check the browser dashboard for details.`),i.thread_id){const f=c.status==="finished"&&c.output?c.output.substring(0,8e3):h,g=Math.ceil(f.length/4);try{await e.env.DB.prepare(`INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id)
               VALUES (?, ?, 'assistant', ?, '{}', ?, ?)`).bind(i.user_id,i.channel||"web",f,g,i.thread_id).run()}catch{}}try{await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, 'info', ?, ?, ?, 0)").bind(i.user_id,u,h,`browser_task:${i.task_id}`).run()}catch{}i.pin_hash&&await Rt(e.env.DB,i.user_id,u,h,{pinHash:i.pin_hash,tags:["browser","karna"]}),await e.env.DB.prepare("UPDATE pending_browser_tasks SET notified = 1 WHERE id = ?").bind(i.id).run(),r++,await new Promise(f=>setTimeout(f,200))}catch{}}}catch{}return e.json({checked:s,notified:r})});Ne.get("/scorecard/weekly",async e=>{var u;const t=(u=e.req.header("Authorization"))==null?void 0:u.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=n.user_id,r=new Date(Date.now()-10080*60*1e3).toISOString(),[a,i,o]=await Promise.all([e.env.DB.prepare(`SELECT COUNT(*) as total,
       ...
       FROM conversations
       WHERE user_id = ? AND role = 'assistant' AND created_at >= ? AND (content LIKE '%[S1]%' OR content LIKE '%source%')`).bind(s,r).first()]),l=Number((a==null?void 0:a.total)||0),c=Number((a==null?void 0:a.success_count)||0),d=l?c/l:0;return e.json({window:"7d",task_success_rate:Number(d.toFixed(3)),groundedness_rate_hint:Number((Number((o==null?void 0:o.cited_responses)||0)/Math.max(1,l)).toFixed(3)),avg_latency_ms:Math.round(Number((a==null?void 0:a.avg_latency)||0)),p95_latency_hint_ms:Math.round(Number((a==null?void 0:a.p95_latency_hint)||0)),fallback_frequency_hint:Number((Number((i==null?void 0:i.retry_count)||0)/Math.max(1,l)).toFixed(3)),totals:{total_tool_calls:l,successful_tool_calls:c}})});function xo(e,t,n,s){return{userId:e,username:t,channel:"telegram",text:n,sessionId:`telegram-${s}`,timestamp:new Date().toISOString()}}function ko(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const Ro=["llm_slot_1","llm_slot_2","llm_slot_3"],Do=["openai","groq"];function gs(e,t){const n=t==null?void 0:t.trim();if(!n)return null;const s=e.trim().toLowerCase();return s==="openai"?{url:"https://api.openai.com/v1/audio/transcriptions",apiKey:n,model:"whisper-1"}:s==="groq"?{url:"https://api.groq.com/openai/v1/audio/transcriptions",apiKey:n,model:"whisper-large-v3"}:null}function No(e){var t,n;return((t=e.apiKey)==null?void 0:t.trim())||((n=e.api_key)==null?void 0:n.trim())}async function Oo(e,t,n){for(const s of Ro){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await V(r.encrypted_value,n),i=JSON.parse(a),o=No(i);if(i.provider&&o){const l=gs(i.provider,o);if(l)return l}}catch(a){console.error(`[telegram stt] Failed to load ${s}:`,a)}}for(const s of Do){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await V(r.encrypted_value,n),i=gs(s,a);if(i)return i}catch(a){console.error(`[telegram stt] Failed to load legacy ${s}:`,a)}}return null}const qr=["message","callback_query"],Io=4e3,Co=1e4,Ao=3e4;async function De(e,t={}){const n=new AbortController,s=setTimeout(()=>n.abort(),Co);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function fs(e){const t=new AbortController,n=setTimeout(()=>t.abort(),Ao);try{return await fetch(e,{signal:t.signal})}finally{clearTimeout(n)}}async function re(e,t,n,s="Markdown",r,a){var c,d;const i=Mo(n,Io),o=[];let l=!0;for(let u=0;u<i.length;u++){const h=i[u];let f=!1,g="";for(let v=0;v<3;v++)try{const w=await De(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h,parse_mode:s,disable_web_page_preview:!1})});if(w.ok){f=!0;break}const b=await w.json().catch(()=>null);if(g=`HTTP ${w.status}: ${(b==null?void 0:b.description)||"Unknown error"}`,(c=b==null?void 0:b.description)!=null&&c.includes("parse")||(d=b==null?void 0:b.description)!=null&&d.includes("entities")){if((await De(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h})})).ok){f=!0;break}g+=" (plain-text retry also failed)"}if(w.status===429||w.status>=500){const T=Math.pow(2,v)*1e3;await new Promise(R=>setTimeout(R,T));continue}break}catch(w){if(g=`Network error: ${w.message}`,v<2){const b=Math.pow(2,v)*1e3;await new Promise(T=>setTimeout(T,b));continue}}f||(l=!1,o.push(`Chunk ${u+1}/${i.length}: ${g}`))}if(!l&&r&&a&&o.length>0)try{const{logError:u}=await Promise.resolve().then(()=>yt);await u(r,a,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function Lo(e,t){try{await De(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Mo(e,t){if(e.length<=t)return[e];const n=[];let s=e;for(;s.length>0;){if(s.length<=t){n.push(s);break}let r=s.lastIndexOf(`
`,t);r<t*.3&&(r=s.lastIndexOf(" ",t)),r<t*.3&&(r=t),n.push(s.substring(0,r)),s=s.substring(r).trimStart()}return n}function $o(e){const t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`}async function Bo(e,t,n){const r={reminder:"⏰",mail:"✉️",calendar:"📅",error:"⚠️",system:"⚙️"}[n.type]||"🔔",a={daily:"📅 Daily",weekly:"📅 Weekly",once:"✓ Once"},i=n.schedule_type?` · _${a[n.schedule_type]||"⏱ Repeating"}_`:"",o=n.body?`
`+n.body.substring(0,150)+(n.body.length>150?"…":""):"",l=`${r} *${n.title}*${i}
_${$o(n.created_at)}_${o}`,c=Gr(n.id);if(!(await De(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l,parse_mode:"Markdown",reply_markup:{inline_keyboard:c}})})).ok){const u=await De(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l.replace(/[_*`[\]]/g,""),reply_markup:{inline_keyboard:c}})});u.ok||console.warn("[sendNotifMessage] plain-text fallback also failed:",t,u.status)}}async function Po(e,t,n,s,r){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(s==null?void 0:s.name)||"there",o=(s==null?void 0:s.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
`),"Markdown",r,s.id);f.success||console.warn(`[/tasks] Failed to send message: ${f.errors.join(" | ")}`)}catch(i){const o=await re(n,t,"❌ Could not fetch tasks: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/notifications":case"/notif":{if(!s){const i=await re(n,t,"⚠️ Account not linked.","Markdown",r);return i.success||console.warn(`[/notifications] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await r.prepare(`
          ...
          LIMIT 5
        `).bind(s.id).all()).results||[];if(o.length===0){const c=await re(n,t,"🎉 No pending notifications. You're all caught up.","Markdown",r,s.id);return c.success||console.warn(`[/notifications] Failed to send message: ${c.errors.join(" | ")}`),!0}const l=await re(n,t,`📬 *${o.length} pending notification${o.length>1?"s":""}:*`,"Markdown",r,s.id);l.success||console.warn(`[/notifications] Failed to send header: ${l.errors.join(" | ")}`);for(const c of o)await Bo(n,t,c)}catch(i){const o=await re(n,t,"❌ Could not fetch notifications: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/notifications error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}async function jo(e,t){var r,a,i,o,l,c;const n=t.db,s=t.env;console.log(`[telegram webhook] envVars keys=${Object.keys(s).join(",")}`);try{if(e.callback_query){await qo(n,e.callback_query);return}const d=e.message;if(!d)return;const u=!!d.text,h=!!d.voice,f=!!d.document,g=!!d.photo,v=!!d.caption;if(!u&&!h&&!f&&!g)return;const w=String(d.chat.id);let b=d.text||"";const T=await n.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(w).first();let R=null;if(T){const M=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(T.id,"telegram_bot_token").first();M&&(R=await V(M.encrypted_value,T.pin_hash))}if(!R){const M=await n.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();M&&(R=await V(M.encrypted_value,M.pin_hash))}if(!R||b.startsWith("/")&&await Po(b,w,R,T,n))return;if(!T){const M=await re(R,w,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${w}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",n);M.success||console.warn(`Failed to send unlinked account message: ${M.errors.join(" | ")}`);return}if(d.voice&&R&&T)try{if((d.voice.file_size??0)>20*1024*1024){const Z=await re(R,w,"⚠️ Voice note is too large to process (max 20 MB).","Markdown",n,T.id);Z.success||console.warn(`[voice size] Failed to send message: ${Z.errors.join(" | ")}`);return}const M=await re(R,w,"🎤 Processing voice note...","Markdown",n,T.id);M.success||console.warn(`[voice start] Failed to send message: ${M.errors.join(" | ")}`);const q=await(await De(`https://api.telegram.org/bot${R}/getFile?file_id=${d.voice.file_id}`)).json();if(q.ok&&((r=q.result)!=null&&r.file_path)){const te=await(await fs(`https://api.telegram.org/file/bot${R}/${q.result.file_path}`)).blob(),ie=await Oo(n,T.id,T.pin_hash);if(!ie){const p=await re(R,w,"⚠️ To use voice notes, add an OpenAI or Groq API key in Settings → Keys (LLM slot or legacy openai/groq).","Markdown",n,T.id);p.success||console.warn(`[voice no stt] Failed to send message: ${p.errors.join(" | ")}`);return}const se=new FormData;se.append("file",te,"voice.ogg"),se.append("model",ie.model),se.append("language","en");const me=await fetch(ie.url,{method:"POST",headers:{Authorization:`Bearer ${ie.apiKey}`},body:se});if(!me.ok){const p=await me.text(),y=await re(R,w,`⚠️ Transcription failed: ${me.status} ${p}`,"Markdown",n,T.id);y.success||console.warn(`[voice transcription error] Failed to send message: ${y.errors.join(" | ")}`);return}b=(await me.json()).text;const E=await re(R,w,`🗣️ *You said:* ${b}`,"Markdown",n,T.id);E.success||console.warn(`[voice transcript echo] Failed to send message: ${E.errors.join(" | ")}`)}}catch(M){const W=await re(R,w,`⚠️ Failed to process voice note: ${M.message}`,"Markdown",n,T==null?void 0:T.id);W.success||console.warn(`[voice processing error] Failed to send message: ${W.errors.join(" | ")}`);return}if((f||g)&&R&&T)try{let M,W="unknown",q="unknown",Z=0;if(f)M=d.document.file_id,W=d.document.file_name||"document",q=d.document.mime_type||"unknown",Z=d.document.file_size||0;else if(g){const te=d.photo[d.photo.length-1];M=te.file_id,W="photo.jpg",q="image/jpeg",Z=te.file_size||0}if(M){const ie=await(await De(`https://api.telegram.org/bot${R}/getFile?file_id=${M}`)).json();let se="";if(ie.ok&&((a=ie.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(W)||/^text\/|application\/json|application\/xml|application\/csv/i.test(q))&&Z<5e4)try{se=await(await fs(`https://api.telegram.org/file/bot${R}/${ie.result.file_path}`)).text()}catch{}const me=d.caption||"",m=`[Telegram file received: "${W}" (${q}, ${Math.round(Z/1024)}KB)]`;se?b=`${me?me+`
...
`:""}${m}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(M){if(v&&d.caption)b=d.caption;else{const W=await re(R,w,`⚠️ Received your file but couldn't process it: ${M.message}`,"Markdown",n,T==null?void 0:T.id);W.success||console.warn(`[file processing error] Failed to send message: ${W.errors.join(" | ")}`);return}}if(!b)return;Lo(R,w).catch(()=>{});let $=await n.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(T.id).first();if($)await n.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind($.id).run();else{const M=await n.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(T.id).run();if(!((i=M.meta)!=null&&i.last_row_id))throw new Error("Thread creation failed — no row ID returned");$={id:M.meta.last_row_id}}const I=xo(T.id,T.username,b,w);I.metadata={thread_id:$.id},console.log(`[telegram webhook] user=${T.id} msgLen=${b.length} thread=${$.id}`);let U,B;try{const M=await Ve(n,T.id,T.pin_hash);U=M.provider,B=M.rotation}catch(M){console.error("Telegram provider setup error:",M);const W=(o=M.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=M.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${M.message||"Unknown error"}`,q=await re(R,w,W,"Markdown",n,T.id);q.success||console.warn(`[provider error] Failed to send message: ${q.errors.join(" | ")}`);return}const{classifyIntentFast:Y}=await Promise.resolve().then(()=>Hi);if(Y(b).agent==="multi"){const M=await re(R,w,"🔍 On it…","Markdown",n,T.id);M.success||console.warn(`[ack] Failed to send: ${M.errors.join(" | ")}`)}const G=6e5;let ne=!1;try{const M=await Promise.race([Wn(I,n,U,T,B,s),new Promise((Z,te)=>setTimeout(()=>te(new Error("TELEGRAM_TIMEOUT")),G))]),W=ko(M,"telegram"),q=await re(R,w,W||"(empty response)","Markdown",n,T.id);if(await n.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind($.id).run().catch(()=>{}),ne=q.success,!q.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${T.id}:`,q.errors);try{const{logError:Z}=await Promise.resolve().then(()=>yt);await Z(n,T.id,"telegram","response_send_failed",`Failed to deliver response: ${q.errors.join(" | ")}`)}catch{}}}catch(M){console.error("Telegram agent error:",M);const W=M.message==="TELEGRAM_TIMEOUT",q=W?`⏱️ This is taking too long to complete via Telegram.

If you requested a browser task, the result will arrive as a notification when ready. For other long tasks, try the web app.`:(c=M.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${U.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(M.message||"Unknown").substring(0,200)}`,Z=await re(R,w,q,"Markdown",n,T.id);ne=Z.success,Z.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${T.id}:`,Z.errors);try{const{logError:te}=await Promise.resolve().then(()=>yt);await te(n,T.id,"telegram",W?"timeout":"agent_error",M.message||"Agent error",{provider:U.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:u}=await Promise.resolve().then(()=>yt);await u(n,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}}function ys(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}function Uo(e){const t=new Date(new Date().toLocaleString("en-US",{timeZone:e})),n=new Date(t);n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const s=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),r=new Date(n.toLocaleString("en-US",{timeZone:e}));return new Date(n.getTime()+(s.getTime()-r.getTime())).toISOString()}const Gr=e=>[[{text:"✅ Seen",callback_data:`notif_seen:${e}`},{text:"⏰ Snooze",callback_data:`notif_snooze_menu:${e}`},{text:"✓ Done",callback_data:`notif_done:${e}`}]],Ho=e=>[[{text:"10 minutes",callback_data:`notif_snooze:${e}:10m`},{text:"1 hour",callback_data:`notif_snooze:${e}:1h`}],[{text:"Tomorrow 9 AM",callback_data:`notif_snooze:${e}:tomorrow`},{text:"← Back",callback_data:`notif_back:${e}`}]];async function ut(e,t,n){const s=await De(`https://api.telegram.org/bot${e}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:t,text:n})});s.ok||console.warn("[answerCallback]",t,s.status)}async function mt(e,t,n,s){const r=await De(`https://api.telegram.org/bot${e}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,message_id:n,reply_markup:s?{inline_keyboard:s}:{}})});r.ok||console.warn("[editKeyboard]",t,n,r.status)}async function Fo(e,t,n,s,r,a,i,o,l,c){const d=await e.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).first();if(!d){await ut(t,n,"Notification not found — may have already been actioned."),await mt(t,s,r,null);return}if(i==="notif_seen")await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ut(t,n,"✅ Dismissed"),await mt(t,s,r,null);else if(i==="notif_snooze_menu")await ut(t,n),await mt(t,s,r,Ho(o));else if(i==="notif_back")await ut(t,n),await mt(t,s,r,Gr(o));else if(i==="notif_snooze"){const u=ys(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run();let h,f;l==="10m"?(h=new Date(Date.now()+600*1e3).toISOString(),f="10 minutes"):l==="1h"?(h=new Date(Date.now()+3600*1e3).toISOString(),f="1 hour"):(h=Uo(c||"UTC"),f="tomorrow 9 AM"),await e.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
       VALUES (?, ?, ?, 'once', ?, 'reminder', ?, ?, 1, 'active')`).bind(a,d.title,d.body,h,JSON.stringify({description:d.body||""}),h).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ut(t,n,`⏰ Snoozed until ${f}`),await mt(t,s,r,null)}else if(i==="notif_done"){const u=ys(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ut(t,n,"✓ Done!"),await mt(t,s,r,null)}}async function qo(e,t){var w;const{id:n,data:s,message:r,from:a}=t;if(!s||!r)return;const i=s.split(":"),o=i[0],l=String(r.chat.id);if(o.startsWith("notif_")){const b=parseInt(i[1]);if(!b)return;const T=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!T)return;const R=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
       JOIN users u ON c.user_id = u.id
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(T.id).first();if(!R)return;const $=await V(R.encrypted_value,R.pin_hash),I=i[2];await Fo(e,$,n,l,r.message_id,T.id,o,b,I,T.timezone);return}if(i[0]!=="briefing_toggle"||i.length<3)return;const c=i[1],d=parseInt(i[2]);if(!d||!c)return;const u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const h=await e.prepare(`
  ...
  `).bind(f,f,h.id).run();const g=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!g)return;const v=await V(g.encrypted_value,g.pin_hash);try{const b=await De(`https://api.telegram.org/bot${v}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:n,text:f?"✅ Checked!":"☐ Unchecked"})});b.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${b.status}`)}catch(b){console.warn(`[callback answer] Error answering callback: ${b.message}`)}if((w=r.reply_markup)!=null&&w.inline_keyboard){const b=r.reply_markup.inline_keyboard.map(T=>T.map(R=>{var $;if(($=R.callback_data)!=null&&$.includes(c)){const I=f?"✅":"☐",U=R.text.replace(/^[☐✅]\s*/,"");return{...R,text:`${I} ${U}`}}return R}));try{await De(`https://api.telegram.org/bot${v}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:r.message_id,reply_markup:{inline_keyboard:b}})})}catch{}}}const Gt=new _e;function Go(e){return{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE}}Gt.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const s={db:e.env.DB,env:Go(e)};return e.executionCtx.waitUntil(jo(t,s)),e.json({ok:!0})});Gt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const{webhook_url:s}=await e.req.json(),r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Telegram bot token not configured in Settings"},400);const a=await V(r.encrypted_value,n.pin_hash);if(!s){const d=await(await fetch(`https://api.telegram.org/bot${a}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${a}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:s,allowed_updates:[...qr],drop_pending_updates:!1})})).json();return e.json(o)});Gt.get("/webhook-status",async e=>{var a,i,o,l,c,d;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({configured:!1,error:"Bot token not set"});const r=await V(s.encrypted_value,n.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((c=h.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=h.result)==null?void 0:d.last_error_date)||null})}catch(u){return e.json({configured:!0,error:u.message})}});Gt.post("/detect-chat-id",async e=>{var a,i;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Bot token not configured"},400);const r=await V(s.encrypted_value,n.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${r}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const u=await(await fetch(`https://api.telegram.org/bot${r}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${r}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:[...qr]})});const h=u.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const f=[],g=new Set;for(let w=h.length-1;w>=0;w--){const b=h[w].message;if(b&&b.chat){const T=String(b.chat.id);g.has(T)||(g.add(T),f.push({chat_id:T,name:[b.chat.first_name,b.chat.last_name].filter(Boolean).join(" ")||b.chat.title||"Unknown",username:b.chat.username||"",date:new Date((b.date||0)*1e3).toISOString()}))}}if(f.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const v=f[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(v,n.user_id).run(),e.json({found:!0,chat_id:v,name:f[0].name,all_chats:f,message:`Chat ID ${v} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});function Wo(e){const t=new Date,n=new Date(t.toLocaleString("en-US",{timeZone:e})),s=new Date(n);s.setDate(s.getDate()+1),s.setHours(0,0,0,0);const r=new Date(s);r.setHours(23,59,59,999);const a=s.toISOString().split("T")[0];return{start:s.toISOString(),end:r.toISOString(),dateStr:a}}function an(e,t=new Date){return new Intl.DateTimeFormat("en-CA",{timeZone:e||"Asia/Kolkata",year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}async function zo(e,t,n,s,r,a){try{return(await new In(e,t,n,s,r).listEvents("primary",{timeMin:a.start,timeMax:a.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Ko(e,t,n,s,r){try{const a=new Re(e,t,n,s,r),i=await a.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await a.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const u of i){const h=u.from.split("<")[0].trim()||u.from;l[h]=(l[h]||0)+1}const c=Object.entries(l).sort(([,u],[,h])=>h-u).slice(0,5).map(([u])=>u),d=i.some(u=>u.subject.toLowerCase().includes("urgent")||u.subject.toLowerCase().includes("asap")||u.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(a){return console.error("Gmail fetch error:",a.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Yo(e,t){try{const n=await e.prepare(`
...
`)}function Xo(e){const t=[];let n=0;for(const s of e.calendar.google)t.push({type:"calendar",key:s.id,text:`${s.title} - ${new Date(s.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:s},sortOrder:n++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:n++});for(const s of e.tasks.items)t.push({type:"task",key:`task-${s}`,text:s,metadata:{},sortOrder:n++});for(const s of e.news.items)t.push({type:"news",key:`news-${s.url}`,text:`📰 ${s.title}`,metadata:{url:s.url,source:s.source},sortOrder:n++});return t}async function Qo(e,t){const n=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!n)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let s;try{const a=JSON.parse(n.components);s={google_calendar:a.google_calendar!==!1,gmail:a.gmail!==!1,tasks:a.tasks!==!1,news:a.news!==!1}}catch{s={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const r=n.news_topics?n.news_topics.split(",").map(a=>a.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:s,newsTopics:r}}async function Wr(e,t,n){var R,$;const s=t.timezone||"Asia/Kolkata",r=Wo(s),{components:a,newsTopics:i}=await Qo(e,t.id),o=[],l=[];a.google_calendar&&(o.push(zo(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET,r)),l.push("googleEvents")),a.gmail&&(o.push(Ko(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),a.tasks&&(o.push(Yo(e,t.id)),l.push("tasks")),a.news&&(o.push(Vo(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((I,U)=>{d[I]=c[U]});const u={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},f={generatedAt:new Date().toISOString(),targetDate:r.dateStr,calendar:{google:d.googleEvents||[],totalCount:((R=d.googleEvents)==null?void 0:R.length)||0},emails:{gmail:d.gmailSummary||u},tasks:d.tasks||h,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},g=(($=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:$.briefing_time)||"20:00";f.summary=Zo(f,g);const v=Xo(f),w=an(s),b=await e.prepare(`
  ...
  `).bind(n).all();return{briefing:{...s,content:JSON.parse(s.content_json||"{}")},items:r.results||[]}}async function tl(e,t,n,s){if(!await e.prepare(`
  ...
  `).bind(i,i,s,n).run(),{checked:i===1}}async function nl(e,t,n=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,n).all()).results||[]).map(r=>({...r,content:JSON.parse(r.content_json||"{}")}))}function zr(e,t,n=new Date,s=5){const r=new Date(n.toLocaleString("en-US",{timeZone:t})),a=r.getHours(),i=r.getMinutes(),[o,l]=e.split(":").map(Number),c=a*60+i,d=o*60+l,u=c-d;return u>=0&&u<s}function Kr(e,t){const n=e.summary,s=[];for(const r of t.slice(0,10))s.push([{text:`☐ ${r.text.substring(0,40)}${r.text.length>40?"...":""}`,callback_data:`briefing_toggle:${r.key}`}]);return{text:n,inlineKeyboard:s}}const fe=new _e,sl=1e4;async function ws(e,t){const n=new AbortController,s=setTimeout(()=>n.abort(),sl);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function rl(e,t){var r;if(e.req.path.includes("/cron/"))return t();const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(!zr(l,o,a))continue;const c=an(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'evening' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await Wr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),{text:h}=Kr(u.content,u.items);await Rt(e.env.DB,i.id,"Evening Briefing",h,{pinHash:i.pin_hash,tags:["briefing","karna"]}),u.briefingId&&await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run(),r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});fe.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare("SELECT * FROM users").all(),r=[],a=new Date,i=new Date(a.getTime()+600*1e3).toISOString(),o=new Date(a.getTime()+900*1e3).toISOString();for(const l of s.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await V(c.encrypted_value,l.pin_hash),h=JSON.parse(d).access_token;if(!h)continue;const f=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(a.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${h}`}});if(!f.ok)continue;const v=((await f.json()).items||[]).filter(w=>{var T;const b=(T=w.start)==null?void 0:T.dateTime;return b?b>=a.toISOString()&&b<=i:!1});if(v.length===0){r.push({user_id:l.id,reminders_sent:0});continue}for(const w of v){const b=new Date(w.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),T=w.location?`
📍 ${w.location}`:"",R="Meeting in 10 minutes",$=`${w.summary||"Untitled Event"}
🕐 ${b}${T}`;await Rt(e.env.DB,l.id,R,$,{pinHash:l.pin_hash,priority:"high",tags:["calendar","karna"]})}r.push({user_id:l.id,reminders_sent:v.length})}catch(c){r.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});fe.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(!zr(l,o,a))continue;const c=an(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'morning' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await Yr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let h={telegram:!0,web:!0};try{h=JSON.parse(i.notification_channels||"{}")}catch{}if(h.web!==!1&&u.briefingId){const f=ll(u.content);await Rt(e.env.DB,i.id,"Morning Briefing",f,{pinHash:i.pin_hash,tags:["briefing","karna"]}),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run()}r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});fe.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[];for(const a of s.results||[]){let i={};try{i=JSON.parse(a.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Jr(e.env.DB,a,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{skipBrowserUse:!0}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,c=JSON.stringify(o,null,2),d=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
  ...
  `).bind(t.id,s.toISOString(),r.toISOString()).all(),i=await e.prepare(`
    ...
    LIMIT 10
  `).bind(t.id).all(),o=await Jr(e,t,n,{skipBrowserUse:!0});let l=[];try{const f=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first();if(f){const g=await V(f.encrypted_value,t.pin_hash),w=JSON.parse(g).access_token;if(w){const b=s.toISOString(),T=r.toISOString(),R=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(b)}&timeMax=${encodeURIComponent(T)}&maxResults=20`,{headers:{Authorization:`Bearer ${w}`}});R.ok&&(l=((await R.json()).items||[]).map(I=>{var U,B,Y,G;return{title:I.summary||"Untitled",startTime:((U=I.start)==null?void 0:U.dateTime)||((B=I.start)==null?void 0:B.date),endTime:((Y=I.end)==null?void 0:Y.dateTime)||((G=I.end)==null?void 0:G.date)}}))}}}catch{}const c={generatedAt:new Date().toISOString(),type:"morning",todayReminders:(a.results||[]).map(f=>({name:f.name,description:f.description,next_run:f.next_run})),pendingActions:(i.results||[]).map(f=>({title:f.title,priority:f.priority})),emailDigest:o,calendarEvents:l},d=an(t.timezone||"Asia/Kolkata"),u=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel, briefing_date)
    VALUES (?, 'morning', ?, 'all', ?)
    RETURNING id
  `).bind(t.id,JSON.stringify(c),d).first();return{briefingId:(u==null?void 0:u.id)||0,content:c}}async function Jr(e,t,n,s){const r={unreadCount:0,recent:[]},a={message:"",recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const o=new Re(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET),l=await o.getUnreadCount(),c=await o.listMessages({maxResults:10,labelIds:["INBOX"]});r.unreadCount=l,r.recent=c.map(d=>({id:d.id,subject:d.subject,from:d.from,snippet:d.snippet,isUnread:d.isUnread}))}}catch(i){r.error=i.message}if(s!=null&&s.skipBrowserUse)a.message="Outlook not fetched in automated digest (runs once daily in morning briefing).";else try{const i=await e.prepare("SELECT name, encrypted_blob FROM site_credentials WHERE user_id = ? AND (name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE) LIMIT 1").bind(t.id,"%Outlook%","%Microsoft%","%Office 365%").first();if(!i)a.message="No Outlook credentials saved in Secret Vault. Add them in Settings → Secret Vault.";else{const o=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t.id,"browser_use_api_key").first();if(!o)a.message="Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key.";else{const l=(await V(o.encrypted_value,t.pin_hash)).trim(),c=JSON.parse(await V(i.encrypted_blob,t.pin_hash)),d=await vr("Go to https://outlook.live.com or https://outlook.office.com. Log in with username {username} and password {password} if prompted. Navigate to the inbox and extract the 10 most recent emails with sender, subject, date, and snippet. Return the results as structured text.",l,{secrets:{username:c.username,password:c.password},timeoutMs:3e5});d.status==="completed"&&d.output?a.recent=d.output:d.status==="timeout"?a.message="Outlook browser task timed out.":a.message="Outlook returned no content."}}}catch(i){a.message=`Outlook error: ${i.message}`}return{gmail:r,outlook:a}}function il(e,t,n=new Date){const s=new Date(n.toLocaleString("en-US",{timeZone:t})),r=s.toLocaleDateString("en-US",{weekday:"long"}),a=s.getHours(),i=s.getMinutes(),o=e.trim().split(" "),l=o[o.length-1],c=o.slice(0,o.length-1).join(" "),[d,u]=l.split(":").map(Number),h=a*60+i,f=d*60+u;return r===c&&h===f}async function ol(e,t,n){const s=new Date,r=new Date(s.getTime()-10080*60*1e3),a=new Date(s.getTime()+10080*60*1e3),i=await e.prepare(`
    SELECT * FROM cron_jobs 
