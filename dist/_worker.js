var Qa=Object.defineProperty;var pn=e=>{throw TypeError(e)};var es=(e,t,n)=>t in e?Qa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var A=(e,t,n)=>es(e,typeof t!="symbol"?t+"":t,n),Ht=(e,t,n)=>t.has(e)||pn("Cannot "+n);var k=(e,t,n)=>(Ht(e,t,"read from private field"),n?n.call(e):t.get(e)),G=(e,t,n)=>t.has(e)?pn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),j=(e,t,n,a)=>(Ht(e,t,"write to private field"),a?a.call(e,n):t.set(e,n),n),V=(e,t,n)=>(Ht(e,t,"access private method"),n);var hn=(e,t,n,a)=>({set _(s){j(e,t,s,n)},get _(){return k(e,t,a)}});var gn=(e,t,n)=>(a,s)=>{let r=-1;return i(0);async function i(o){if(o<=r)throw new Error("next() called multiple times");r=o;let l,d=!1,c;if(e[o]?(c=e[o][0][0],a.req.routeIndex=o):c=o===e.length&&s||void 0,c)try{l=await c(a,()=>i(o+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&n&&(l=await n(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},ts=Symbol(),ns=async(e,t=Object.create(null))=>{const{all:n=!1,dot:a=!1}=t,r=(e instanceof Wn?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?as(e,{all:n,dot:a}):{}};async function as(e,t){const n=await e.formData();return n?ss(n,t):{}}function ss(e,t){const n=Object.create(null);return e.forEach((a,s)=>{t.all||s.endsWith("[]")?rs(n,s,a):n[s]=a}),t.dot&&Object.entries(n).forEach(([a,s])=>{a.includes(".")&&(is(n,a,s),delete n[a])}),n}var rs=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},is=(e,t,n)=>{let a=e;const s=t.split(".");s.forEach((r,i)=>{i===s.length-1?a[r]=n:((!a[r]||typeof a[r]!="object"||Array.isArray(a[r])||a[r]instanceof File)&&(a[r]=Object.create(null)),a=a[r])})},Pn=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},os=e=>{const{groups:t,path:n}=ls(e),a=Pn(n);return ds(a,t)},ls=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,a)=>{const s=`@${a}`;return t.push([s,n]),s}),{groups:t,path:e}},ds=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[a]=t[n];for(let s=e.length-1;s>=0;s--)if(e[s].includes(a)){e[s]=e[s].replace(a,t[n][1]);break}}return e},Ot={},cs=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const a=`${e}#${t}`;return Ot[a]||(n[2]?Ot[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:Ot[a]=[e,n[1],!0]),Ot[a]}return null},tn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},us=e=>tn(e,decodeURI),Un=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let a=n;for(;a<t.length;a++){const s=t.charCodeAt(a);if(s===37){const r=t.indexOf("?",a),i=t.indexOf("#",a),o=r===-1?i===-1?void 0:i:i===-1?r:Math.min(r,i),l=t.slice(n,o);return us(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(s===63||s===35)break}return t.slice(n,a)},ms=e=>{const t=Un(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Qe=(e,t,...n)=>(n.length&&(t=Qe(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Hn=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let a="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))a+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){n.length===0&&a===""?n.push("/"):n.push(a);const r=s.replace("?","");a+="/"+r,n.push(a)}else a+="/"+s}),n.filter((s,r,i)=>i.indexOf(s)===r)},Ft=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?tn(e,Gn):e):e,Fn=(e,t,n)=>{let a;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,d=e.indexOf("&",l);return Ft(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(a=/[%+]/.test(e),!a)return}const s={};a??(a=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const i=e.indexOf("&",r+1);let o=e.indexOf("=",r);o>i&&i!==-1&&(o=-1);let l=e.slice(r+1,o===-1?i===-1?void 0:i:o);if(a&&(l=Ft(l)),r=i,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),a&&(d=Ft(d))),n?(s[l]&&Array.isArray(s[l])||(s[l]=[]),s[l].push(d)):s[l]??(s[l]=d)}return t?s[t]:s},ps=Fn,hs=(e,t)=>Fn(e,t,!0),Gn=decodeURIComponent,fn=e=>tn(e,Gn),at,he,Re,qn,zn,Jt,Ce,An,Wn=(An=class{constructor(e,t="/",n=[[]]){G(this,Re);A(this,"raw");G(this,at);G(this,he);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});G(this,Ce,e=>{const{bodyCache:t,raw:n}=this,a=t[e];if(a)return a;const s=Object.keys(t)[0];return s?t[s].then(r=>(s==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,j(this,he,n),j(this,at,{})}param(e){return e?V(this,Re,qn).call(this,e):V(this,Re,zn).call(this)}query(e){return ps(this.url,e)}queries(e){return hs(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,a)=>{t[a]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ns(this,e))}json(){return k(this,Ce).call(this,"text").then(e=>JSON.parse(e))}text(){return k(this,Ce).call(this,"text")}arrayBuffer(){return k(this,Ce).call(this,"arrayBuffer")}blob(){return k(this,Ce).call(this,"blob")}formData(){return k(this,Ce).call(this,"formData")}addValidatedData(e,t){k(this,at)[e]=t}valid(e){return k(this,at)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ts](){return k(this,he)}get matchedRoutes(){return k(this,he)[0].map(([[,e]])=>e)}get routePath(){return k(this,he)[0].map(([[,e]])=>e)[this.routeIndex].path}},at=new WeakMap,he=new WeakMap,Re=new WeakSet,qn=function(e){const t=k(this,he)[0][this.routeIndex][1][e],n=V(this,Re,Jt).call(this,t);return n&&/\%/.test(n)?fn(n):n},zn=function(){const e={},t=Object.keys(k(this,he)[0][this.routeIndex][1]);for(const n of t){const a=V(this,Re,Jt).call(this,k(this,he)[0][this.routeIndex][1][n]);a!==void 0&&(e[n]=/\%/.test(a)?fn(a):a)}return e},Jt=function(e){return k(this,he)[1]?k(this,he)[1][e]:e},Ce=new WeakMap,An),gs={Stringify:1},Kn=async(e,t,n,a,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(s?s[0]+=e:s=[e],Promise.all(r.map(o=>o({phase:t,buffer:s,context:a}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Kn(l,t,!1,a,s))).then(()=>s[0]))):Promise.resolve(e)},fs="text/plain; charset=UTF-8",Gt=(e,t)=>({"Content-Type":e,...t}),_t,Et,Se,st,xe,ue,Tt,rt,it,Ge,St,xt,Ne,et,Ln,ys=(Ln=class{constructor(e,t){G(this,Ne);G(this,_t);G(this,Et);A(this,"env",{});G(this,Se);A(this,"finalized",!1);A(this,"error");G(this,st);G(this,xe);G(this,ue);G(this,Tt);G(this,rt);G(this,it);G(this,Ge);G(this,St);G(this,xt);A(this,"render",(...e)=>(k(this,rt)??j(this,rt,t=>this.html(t)),k(this,rt).call(this,...e)));A(this,"setLayout",e=>j(this,Tt,e));A(this,"getLayout",()=>k(this,Tt));A(this,"setRenderer",e=>{j(this,rt,e)});A(this,"header",(e,t,n)=>{this.finalized&&j(this,ue,new Response(k(this,ue).body,k(this,ue)));const a=k(this,ue)?k(this,ue).headers:k(this,Ge)??j(this,Ge,new Headers);t===void 0?a.delete(e):n!=null&&n.append?a.append(e,t):a.set(e,t)});A(this,"status",e=>{j(this,st,e)});A(this,"set",(e,t)=>{k(this,Se)??j(this,Se,new Map),k(this,Se).set(e,t)});A(this,"get",e=>k(this,Se)?k(this,Se).get(e):void 0);A(this,"newResponse",(...e)=>V(this,Ne,et).call(this,...e));A(this,"body",(e,t,n)=>V(this,Ne,et).call(this,e,t,n));A(this,"text",(e,t,n)=>!k(this,Ge)&&!k(this,st)&&!t&&!n&&!this.finalized?new Response(e):V(this,Ne,et).call(this,e,t,Gt(fs,n)));A(this,"json",(e,t,n)=>V(this,Ne,et).call(this,JSON.stringify(e),t,Gt("application/json",n)));A(this,"html",(e,t,n)=>{const a=s=>V(this,Ne,et).call(this,s,t,Gt("text/html; charset=UTF-8",n));return typeof e=="object"?Kn(e,gs.Stringify,!1,{}).then(a):a(e)});A(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});A(this,"notFound",()=>(k(this,it)??j(this,it,()=>new Response),k(this,it).call(this,this)));j(this,_t,e),t&&(j(this,xe,t.executionCtx),this.env=t.env,j(this,it,t.notFoundHandler),j(this,xt,t.path),j(this,St,t.matchResult))}get req(){return k(this,Et)??j(this,Et,new Wn(k(this,_t),k(this,xt),k(this,St))),k(this,Et)}get event(){if(k(this,xe)&&"respondWith"in k(this,xe))return k(this,xe);throw Error("This context has no FetchEvent")}get executionCtx(){if(k(this,xe))return k(this,xe);throw Error("This context has no ExecutionContext")}get res(){return k(this,ue)||j(this,ue,new Response(null,{headers:k(this,Ge)??j(this,Ge,new Headers)}))}set res(e){if(k(this,ue)&&e){e=new Response(e.body,e);for(const[t,n]of k(this,ue).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=k(this,ue).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of a)e.headers.append("set-cookie",s)}else e.headers.set(t,n)}j(this,ue,e),this.finalized=!0}get var(){return k(this,Se)?Object.fromEntries(k(this,Se)):{}}},_t=new WeakMap,Et=new WeakMap,Se=new WeakMap,st=new WeakMap,xe=new WeakMap,ue=new WeakMap,Tt=new WeakMap,rt=new WeakMap,it=new WeakMap,Ge=new WeakMap,St=new WeakMap,xt=new WeakMap,Ne=new WeakSet,et=function(e,t,n){const a=k(this,ue)?new Headers(k(this,ue).headers):k(this,Ge)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of r)i.toLowerCase()==="set-cookie"?a.append(i,o):a.set(i,o)}if(n)for(const[r,i]of Object.entries(n))if(typeof i=="string")a.set(r,i);else{a.delete(r);for(const o of i)a.append(r,o)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??k(this,st);return new Response(e,{status:s,headers:a})},Ln),ae="ALL",vs="all",ws=["get","post","put","delete","options","patch"],Yn="Can not add a route since the matcher is already built.",Jn=class extends Error{},bs="__COMPOSED_HANDLER",_s=e=>e.text("404 Not Found",404),yn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},ge,se,Vn,fe,He,Ct,Nt,ot,Es=(ot=class{constructor(t={}){G(this,se);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");G(this,ge,"/");A(this,"routes",[]);G(this,fe,_s);A(this,"errorHandler",yn);A(this,"onError",t=>(this.errorHandler=t,this));A(this,"notFound",t=>(j(this,fe,t),this));A(this,"fetch",(t,...n)=>V(this,se,Nt).call(this,t,n[1],n[0],t.method));A(this,"request",(t,n,a,s)=>t instanceof Request?this.fetch(n?new Request(t,n):t,a,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Qe("/",t)}`,n),a,s)));A(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(V(this,se,Nt).call(this,t.request,t,void 0,t.request.method))})});[...ws,vs].forEach(r=>{this[r]=(i,...o)=>(typeof i=="string"?j(this,ge,i):V(this,se,He).call(this,r,k(this,ge),i),o.forEach(l=>{V(this,se,He).call(this,r,k(this,ge),l)}),this)}),this.on=(r,i,...o)=>{for(const l of[i].flat()){j(this,ge,l);for(const d of[r].flat())o.map(c=>{V(this,se,He).call(this,d.toUpperCase(),k(this,ge),c)})}return this},this.use=(r,...i)=>(typeof r=="string"?j(this,ge,r):(j(this,ge,"*"),i.unshift(r)),i.forEach(o=>{V(this,se,He).call(this,ae,k(this,ge),o)}),this);const{strict:a,...s}=t;Object.assign(this,s),this.getPath=a??!0?t.getPath??Un:ms}route(t,n){const a=this.basePath(t);return n.routes.map(s=>{var i;let r;n.errorHandler===yn?r=s.handler:(r=async(o,l)=>(await gn([],n.errorHandler)(o,()=>s.handler(o,l))).res,r[bs]=s.handler),V(i=a,se,He).call(i,s.method,s.path,r)}),this}basePath(t){const n=V(this,se,Vn).call(this);return n._basePath=Qe(this._basePath,t),n}mount(t,n,a){let s,r;a&&(typeof a=="function"?r=a:(r=a.optionHandler,a.replaceRequest===!1?s=l=>l:s=a.replaceRequest));const i=r?l=>{const d=r(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};s||(s=(()=>{const l=Qe(this._basePath,t),d=l==="/"?0:l.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const o=async(l,d)=>{const c=await n(s(l.req.raw),...i(l));if(c)return c;await d()};return V(this,se,He).call(this,ae,Qe(t,"*"),o),this}},ge=new WeakMap,se=new WeakSet,Vn=function(){const t=new ot({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,j(t,fe,k(this,fe)),t.routes=this.routes,t},fe=new WeakMap,He=function(t,n,a){t=t.toUpperCase(),n=Qe(this._basePath,n);const s={basePath:this._basePath,path:n,method:t,handler:a};this.router.add(t,n,[a,s]),this.routes.push(s)},Ct=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},Nt=function(t,n,a,s){if(s==="HEAD")return(async()=>new Response(null,await V(this,se,Nt).call(this,t,n,a,"GET")))();const r=this.getPath(t,{env:a}),i=this.router.match(s,r),o=new ys(t,{path:r,matchResult:i,env:a,executionCtx:n,notFoundHandler:k(this,fe)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await k(this,fe).call(this,o)})}catch(c){return V(this,se,Ct).call(this,c,o)}return d instanceof Promise?d.then(c=>c||(o.finalized?o.res:k(this,fe).call(this,o))).catch(c=>V(this,se,Ct).call(this,c,o)):d??k(this,fe).call(this,o)}const l=gn(i[0],this.errorHandler,k(this,fe));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return V(this,se,Ct).call(this,d,o)}})()},ot),Zn=[];function Ts(e,t){const n=this.buildAllMatchers(),a=((s,r)=>{const i=n[s]||n[ae],o=i[2][r];if(o)return o;const l=r.match(i[0]);if(!l)return[[],Zn];const d=l.indexOf("",1);return[i[1][d],l]});return this.match=a,a(e,t)}var At="[^/]+",yt=".*",vt="(?:|/.*)",tt=Symbol(),Ss=new Set(".\\+*[^]$()");function xs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===yt||e===vt?1:t===yt||t===vt?-1:e===At?1:t===At?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var We,qe,ye,Ye,ks=(Ye=class{constructor(){G(this,We);G(this,qe);G(this,ye,Object.create(null))}insert(t,n,a,s,r){if(t.length===0){if(k(this,We)!==void 0)throw tt;if(r)return;j(this,We,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",yt]:["","",At]:i==="/*"?["","",vt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let m=l[2]||At;if(c&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw tt;if(d=k(this,ye)[m],!d){if(Object.keys(k(this,ye)).some(h=>h!==yt&&h!==vt))throw tt;if(r)return;d=k(this,ye)[m]=new Ye,c!==""&&j(d,qe,s.varIndex++)}!r&&c!==""&&a.push([c,k(d,qe)])}else if(d=k(this,ye)[i],!d){if(Object.keys(k(this,ye)).some(c=>c.length>1&&c!==yt&&c!==vt))throw tt;if(r)return;d=k(this,ye)[i]=new Ye}d.insert(o,n,a,s,r)}buildRegExpStr(){const n=Object.keys(k(this,ye)).sort(xs).map(a=>{const s=k(this,ye)[a];return(typeof k(s,qe)=="number"?`(${a})@${k(s,qe)}`:Ss.has(a)?`\\${a}`:a)+s.buildRegExpStr()});return typeof k(this,We)=="number"&&n.unshift(`#${k(this,We)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},We=new WeakMap,qe=new WeakMap,ye=new WeakMap,Ye),$t,kt,Mn,Ds=(Mn=class{constructor(){G(this,$t,{varIndex:0});G(this,kt,new ks)}insert(e,t,n){const a=[],s=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return s[i]=[d,l],i++,o=!0,d}),!o)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=s.length-1;i>=0;i--){const[o]=s[i];for(let l=r.length-1;l>=0;l--)if(r[l].indexOf(o)!==-1){r[l]=r[l].replace(o,s[i][1]);break}}return k(this,kt).insert(r,t,a,k(this,$t),n),a}buildRegExp(){let e=k(this,kt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,r,i)=>r!==void 0?(n[++t]=Number(r),"$()"):(i!==void 0&&(a[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,a]}},$t=new WeakMap,kt=new WeakMap,Mn),Rs=[/^$/,[],Object.create(null)],It=Object.create(null);function Xn(e){return It[e]??(It[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function Os(){It=Object.create(null)}function Cs(e){var d;const t=new Ds,n=[];if(e.length===0)return Rs;const a=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[h,w])=>c?1:h?-1:m.length-w.length),s=Object.create(null);for(let c=0,m=-1,h=a.length;c<h;c++){const[w,f,_]=a[c];w?s[f]=[_.map(([S])=>[S,Object.create(null)]),Zn]:m++;let y;try{y=t.insert(f,m,w)}catch(S){throw S===tt?new Jn(f):S}w||(n[m]=_.map(([S,E])=>{const R=Object.create(null);for(E-=1;E>=0;E--){const[N,M]=y[E];R[N]=M}return[S,R]}))}const[r,i,o]=t.buildRegExp();for(let c=0,m=n.length;c<m;c++)for(let h=0,w=n[c].length;h<w;h++){const f=(d=n[c][h])==null?void 0:d[1];if(!f)continue;const _=Object.keys(f);for(let y=0,S=_.length;y<S;y++)f[_[y]]=o[f[_[y]]]}const l=[];for(const c in i)l[c]=n[i[c]];return[r,l,s]}function Ze(e,t){if(e){for(const n of Object.keys(e).sort((a,s)=>s.length-a.length))if(Xn(n).test(t))return[...e[n]]}}var Ie,Ae,Bt,Qn,$n,Ns=($n=class{constructor(){G(this,Bt);A(this,"name","RegExpRouter");G(this,Ie);G(this,Ae);A(this,"match",Ts);j(this,Ie,{[ae]:Object.create(null)}),j(this,Ae,{[ae]:Object.create(null)})}add(e,t,n){var o;const a=k(this,Ie),s=k(this,Ae);if(!a||!s)throw new Error(Yn);a[e]||[a,s].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ae]).forEach(d=>{l[e][d]=[...l[ae][d]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Xn(t);e===ae?Object.keys(a).forEach(d=>{var c;(c=a[d])[t]||(c[t]=Ze(a[d],t)||Ze(a[ae],t)||[])}):(o=a[e])[t]||(o[t]=Ze(a[e],t)||Ze(a[ae],t)||[]),Object.keys(a).forEach(d=>{(e===ae||e===d)&&Object.keys(a[d]).forEach(c=>{l.test(c)&&a[d][c].push([n,r])})}),Object.keys(s).forEach(d=>{(e===ae||e===d)&&Object.keys(s[d]).forEach(c=>l.test(c)&&s[d][c].push([n,r]))});return}const i=Hn(t)||[t];for(let l=0,d=i.length;l<d;l++){const c=i[l];Object.keys(s).forEach(m=>{var h;(e===ae||e===m)&&((h=s[m])[c]||(h[c]=[...Ze(a[m],c)||Ze(a[ae],c)||[]]),s[m][c].push([n,r-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(k(this,Ae)).concat(Object.keys(k(this,Ie))).forEach(t=>{e[t]||(e[t]=V(this,Bt,Qn).call(this,t))}),j(this,Ie,j(this,Ae,void 0)),Os(),e}},Ie=new WeakMap,Ae=new WeakMap,Bt=new WeakSet,Qn=function(e){const t=[];let n=e===ae;return[k(this,Ie),k(this,Ae)].forEach(a=>{const s=a[e]?Object.keys(a[e]).map(r=>[r,a[e][r]]):[];s.length!==0?(n||(n=!0),t.push(...s)):e!==ae&&t.push(...Object.keys(a[ae]).map(r=>[r,a[ae][r]]))}),n?Cs(t):null},$n),Le,ke,Bn,Is=(Bn=class{constructor(e){A(this,"name","SmartRouter");G(this,Le,[]);G(this,ke,[]);j(this,Le,e.routers)}add(e,t,n){if(!k(this,ke))throw new Error(Yn);k(this,ke).push([e,t,n])}match(e,t){if(!k(this,ke))throw new Error("Fatal error");const n=k(this,Le),a=k(this,ke),s=n.length;let r=0,i;for(;r<s;r++){const o=n[r];try{for(let l=0,d=a.length;l<d;l++)o.add(...a[l]);i=o.match(e,t)}catch(l){if(l instanceof Jn)continue;throw l}this.match=o.match.bind(o),j(this,Le,[o]),j(this,ke,void 0);break}if(r===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(k(this,ke)||k(this,Le).length!==1)throw new Error("No active router has been determined yet.");return k(this,Le)[0]}},Le=new WeakMap,ke=new WeakMap,Bn),ht=Object.create(null),Me,le,ze,lt,ie,De,Fe,dt,As=(dt=class{constructor(t,n,a){G(this,De);G(this,Me);G(this,le);G(this,ze);G(this,lt,0);G(this,ie,ht);if(j(this,le,a||Object.create(null)),j(this,Me,[]),t&&n){const s=Object.create(null);s[t]={handler:n,possibleKeys:[],score:0},j(this,Me,[s])}j(this,ze,[])}insert(t,n,a){j(this,lt,++hn(this,lt)._);let s=this;const r=os(n),i=[];for(let o=0,l=r.length;o<l;o++){const d=r[o],c=r[o+1],m=cs(d,c),h=Array.isArray(m)?m[0]:d;if(h in k(s,le)){s=k(s,le)[h],m&&i.push(m[1]);continue}k(s,le)[h]=new dt,m&&(k(s,ze).push(m),i.push(m[1])),s=k(s,le)[h]}return k(s,Me).push({[t]:{handler:a,possibleKeys:i.filter((o,l,d)=>d.indexOf(o)===l),score:k(this,lt)}}),s}search(t,n){var l;const a=[];j(this,ie,ht);let r=[this];const i=Pn(n),o=[];for(let d=0,c=i.length;d<c;d++){const m=i[d],h=d===c-1,w=[];for(let f=0,_=r.length;f<_;f++){const y=r[f],S=k(y,le)[m];S&&(j(S,ie,k(y,ie)),h?(k(S,le)["*"]&&a.push(...V(this,De,Fe).call(this,k(S,le)["*"],t,k(y,ie))),a.push(...V(this,De,Fe).call(this,S,t,k(y,ie)))):w.push(S));for(let E=0,R=k(y,ze).length;E<R;E++){const N=k(y,ze)[E],M=k(y,ie)===ht?{}:{...k(y,ie)};if(N==="*"){const O=k(y,le)["*"];O&&(a.push(...V(this,De,Fe).call(this,O,t,k(y,ie))),j(O,ie,M),w.push(O));continue}const[W,H,$]=N;if(!m&&!($ instanceof RegExp))continue;const q=k(y,le)[W],z=i.slice(d).join("/");if($ instanceof RegExp){const O=$.exec(z);if(O){if(M[H]=O[0],a.push(...V(this,De,Fe).call(this,q,t,k(y,ie),M)),Object.keys(k(q,le)).length){j(q,ie,M);const U=((l=O[0].match(/\//))==null?void 0:l.length)??0;(o[U]||(o[U]=[])).push(q)}continue}}($===!0||$.test(m))&&(M[H]=m,h?(a.push(...V(this,De,Fe).call(this,q,t,M,k(y,ie))),k(q,le)["*"]&&a.push(...V(this,De,Fe).call(this,k(q,le)["*"],t,M,k(y,ie)))):(j(q,ie,M),w.push(q)))}}r=w.concat(o.shift()??[])}return a.length>1&&a.sort((d,c)=>d.score-c.score),[a.map(({handler:d,params:c})=>[d,c])]}},Me=new WeakMap,le=new WeakMap,ze=new WeakMap,lt=new WeakMap,ie=new WeakMap,De=new WeakSet,Fe=function(t,n,a,s){const r=[];for(let i=0,o=k(t,Me).length;i<o;i++){const l=k(t,Me)[i],d=l[n]||l[ae],c={};if(d!==void 0&&(d.params=Object.create(null),r.push(d),a!==ht||s&&s!==ht))for(let m=0,h=d.possibleKeys.length;m<h;m++){const w=d.possibleKeys[m],f=c[d.score];d.params[w]=s!=null&&s[w]&&!f?s[w]:a[w]??(s==null?void 0:s[w]),c[d.score]=!0}}return r},dt),Ke,jn,Ls=(jn=class{constructor(){A(this,"name","TrieRouter");G(this,Ke);j(this,Ke,new As)}add(e,t,n){const a=Hn(t);if(a){for(let s=0,r=a.length;s<r;s++)k(this,Ke).insert(e,a[s],n);return}k(this,Ke).insert(e,t,n)}match(e,t){return k(this,Ke).search(e,t)}},Ke=new WeakMap,jn),pe=class extends Es{constructor(e={}){super(e),this.router=e.router??new Is({routers:[new Ns,new Ls]})}},Ms=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(r=>typeof r=="string"?r==="*"?()=>r:i=>r===i?i:null:typeof r=="function"?r:i=>r.includes(i)?i:null)(n.origin),s=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(n.allowMethods);return async function(i,o){var c;function l(m,h){i.res.headers.set(m,h)}const d=await a(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),n.credentials&&l("Access-Control-Allow-Credentials","true"),(c=n.exposeHeaders)!=null&&c.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const m=await s(i.req.header("origin")||"",i);m.length&&l("Access-Control-Allow-Methods",m.join(","));let h=n.allowHeaders;if(!(h!=null&&h.length)){const w=i.req.header("Access-Control-Request-Headers");w&&(h=w.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function ea(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`))}catch{}}}})}}function js(e){const t={},n=e||{};if(t.type=n.type||"object",t.type==="object"){const a=n.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const s={};for(const[r,i]of Object.entries(a))i&&typeof i=="object"?s[r]=Vt(i):s[r]=i;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(n.required)?t.required=n.required:t.required=[]}return n.description&&(t.description=n.description),t}function Vt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const n=t.properties;if(n&&typeof n=="object"&&Object.keys(n).length>0){const a={};for(const[s,r]of Object.entries(n))r&&typeof r=="object"?a[s]=Vt(r):a[s]=r;t.properties=a}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Vt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class ra{constructor(t,n,a,s){A(this,"name");A(this,"apiKey");A(this,"model");A(this,"apiBase");this.apiKey=t,this.model=n,this.apiBase=a.replace(/\/+$/,""),this.name=s}async chat(t,n){var l,d,c,m,h,w;const a={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},s=this.apiBase.includes("routellm.abacus.ai");if(n!=null&&n.tools&&n.tools.length>0&&s)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");n!=null&&n.tools&&n.tools.length>0&&(a.tools=n.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:js(f.parameters||{})}})),n.toolChoice==="required"&&(a.tool_choice="required"));const r=await aa(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)}),this.name);if(!r.ok){const f=await r.text();throw new Error(this.name+" API error "+r.status+": "+f)}const i=await r.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((d=o==null?void 0:o.message)==null?void 0:d.content)||"",toolCalls:(m=(c=o==null?void 0:o.message)==null?void 0:c.tool_calls)==null?void 0:m.map(f=>({id:f.id,name:f.function.name,arguments:(()=>{try{return typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=i.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((w=i.usage)==null?void 0:w.completion_tokens)||0}}}async streamChat(t,n){const a={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)});if(!s.ok){const o=await s.text();throw new Error(this.name+" stream error "+s.status+": "+o)}const r=s.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var h,w,f;const{done:l,value:d}=await r.read();if(l){o.close();return}const m=i.decode(d,{stream:!0}).split(`
...
`))}catch{}}}})}}function Zt(e,t,n,a){const s=wt[e];if(!s)throw new Error(`Unknown LLM provider: ${e}`);const r=a||s.defaultModel;return s.apiFormat==="anthropic"?new sa(t,r,s.apiBase,n):new ra(t,r,s.apiBase,n)}class ia{constructor(){A(this,"errorLog",new Map);A(this,"usageLog",new Map)}async pickProvider(t){const n=Date.now(),a=t.filter(s=>{const r=this.errorLog.get(s);return r?r.cooldownUntil<=n:!0});return a.length>0?a[0]:null}async recordUsage(t,n){const a=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:a.tokens+n,requests:a.requests+1})}async recordError(t,n,a=5){this.errorLog.set(t,{error:n,cooldownUntil:Date.now()+a*60*1e3})}}const Ps=["llm_slot_1","llm_slot_2","llm_slot_3"],Us=["anthropic","openai"];async function ut(e,t,n){const{decrypt:a}=await Promise.resolve().then(()=>an),s=new ia,r=[];for(const m of Ps){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const w=await a(h.encrypted_value,n),f=JSON.parse(w);if(f.provider&&f.apiKey&&wt[f.provider]){const y=f.provider,S=Zt(f.provider,f.apiKey,y,f.model);r.push({name:y,provider:S})}}catch(w){console.error(`Failed to load ${m}:`,w)}}const i=new Set(r.map(m=>m.name));for(const m of Us){if(i.has(m))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const w=await a(h.encrypted_value,n);if(wt[m]){const _=Zt(m,w,m);r.push({name:m,provider:_})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(r.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=r.map(m=>m.name),l=await s.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:r[0].provider,rotation:s};const d=r.find(m=>m.name===l);return{provider:Hs(d.provider,r,s,e,t),rotation:s}}function Hs(e,t,n,a,s){const r=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"";throw r(c)&&!c.includes("TOOLS_UNSUPPORTED")&&Wt(a,s,"all_providers_down",e.name,null,c),d}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"",m=i(c);if(!r(c)&&!m)throw d;const h=c.includes("TOOLS_UNSUPPORTED"),w=h?1:m?10:1440;console.warn(`Provider ${e.name} ${m?"rate limited":h?"tools unsupported":"auth/billing error"}, trying fallback...`),await n.recordError(e.name,c,w);const f=t.filter(_=>_.name!==e.name);for(const _ of f)try{const y=await _.provider.chat(o,l);return this.name=_.name,!h&&!m&&Wt(a,s,"provider_switched",e.name,_.name,c),y}catch(y){const S=y.message||"";if(r(S)||i(S)){await n.recordError(_.name,S,i(S)?10:1440);continue}throw y}throw Wt(a,s,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const nt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:sa,OpenAICompatibleProvider:ra,ProviderRotation:ia,createProviderFromConfig:Zt,createRotatingProvider:ut,logError:P},Symbol.toStringTag,{value:"Module"})),qt=20,Fs=2e3,Gs=2e3,oa=4;function Ws(e){return Math.ceil(e.length/oa)}function wn(e,t){const n=t*oa;return e.length<=n?e:e.slice(0,n)+`
[...truncated to fit token budget]`}class K{constructor(t){this.db=t}async store(t,n,a,s,r=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,n,a).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,r,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,a,s,r,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       ...
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const n=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((n==null?void 0:n.cnt)||0)>qt){const a=((n==null?void 0:n.cnt)||0)-qt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,a).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,qt).all()).results||[]}async getAll(t,n,a=50){return n?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,n,a).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a).all()).results||[]}async search(t,n,a=10){const r=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${n}%`,`%${n}%`,a).all()).results||[];if(r.length>0)return await this.touchMemories(t,r.map(c=>c.id)),r;const i=n.split(/\s+/).filter(c=>c.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const c of i){const m=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${c}%`,`%${c}%`,a*2).all();for(const h of m.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const d=[...l.values()].sort((c,m)=>(o.get(m.id)||0)-(o.get(c.id)||0)).slice(0,a);return d.length>0&&await this.touchMemories(t,d.map(c=>c.id)),d}async searchLongTerm(t,n,a=5){const r=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${n}%`,`%${n}%`,a).all()).results||[];if(r.length>0)return await this.touchMemories(t,r.map(c=>c.id)),r;const i=n.split(/\s+/).filter(c=>c.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const c of i){const m=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${c}%`,`%${c}%`,a*2).all();for(const h of m.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const d=[...l.values()].sort((c,m)=>(o.get(m.id)||0)-(o.get(c.id)||0)).slice(0,a);return d.length>0&&await this.touchMemories(t,d.map(c=>c.id)),d}async touchMemories(t,n){for(const a of n)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t).run()}async update(t,n,a){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t,n).run()}async promote(t,n){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run(),await this.enforceWorkingMemoryCap(n)}async demote(t,n){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run()}async remove(t,n){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,n).run()}async buildContext(t){const n=await this.getWorkingMemory(t);if(n.length===0)return"";const a={};for(const r of n)a[r.type]||(a[r.type]=[]),a[r.type].push(r);let s=`
## Working Memory (Active Context)
`;for(const[r,i]of Object.entries(a)){s+=`
### ${r.charAt(0).toUpperCase()+r.slice(1)}s
`;for(const o of i)s+=`- **${o.title}**: ${o.content}
`}return wn(s,Fs)}static truncatePersonality(t){return wn(t,Gs)}async getRecentConversations(t,n=20,a){return a?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a,n).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,n).all()).results||[]).reverse()}async storeMessage(t,n,a,s,r="{}",i){const o=Ws(s);i?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,n,a,s,r,o,i).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,a,s,r,o).run()}async compactHistory(t,n=30){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((a==null?void 0:a.cnt)||0)<=n*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,n).run()}}const qs=Object.freeze(Object.defineProperty({__proto__:null,MemoryService:K},Symbol.toStringTag,{value:"Module"})),zs="https://accounts.google.com/o/oauth2/v2/auth",la="https://oauth2.googleapis.com/token",Ks="https://www.googleapis.com/oauth2/v2/userinfo",Ys=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let be=null;async function Xt(e,t,n){const a=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!a)return null;try{const s=await Y(a.encrypted_value,n);return JSON.parse(s)}catch{return null}}async function Js(e,t,n,a){const s=await ct(JSON.stringify(a),n);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,s).run()}function da(e,t,n){const a=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Ys,access_type:"offline",prompt:"consent",state:n,include_granted_scopes:"true"});return`${zs}?${a}`}async function ca(e,t,n,a){const s=await fetch(la,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:n,redirect_uri:a,grant_type:"authorization_code"})}),r=await s.text();if(!s.ok)throw new Error(`Token exchange failed (${s.status}): ${r.substring(0,300)}`);return JSON.parse(r)}async function Vs(e,t,n){const a=await fetch(la,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:n,grant_type:"refresh_token"})}),s=await a.text();if(!a.ok)throw a.status===400||a.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${a.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function ua(e){const t=await fetch(Ks,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function mt(e,t,n,a,s){if(!a||!s)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(be&&be.userId===t&&be.expiresAt>Date.now()/1e3+60){const o=await Xt(e,t,n);return{token:be.token,email:(o==null?void 0:o.email)||"unknown"}}const r=await Xt(e,t,n);if(!r)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const i=await Vs(r.refresh_token,a,s);return be={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{token:i.access_token,email:r.email}}async function sn(e,t,n){try{const a=await Xt(e,t,n);return a?{connected:!0,email:a.email,connectedAt:a.connected_at}:{connected:!1}}catch{return{connected:!1}}}function ma(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function pa(e,t,n,a,s,r,i){const o=await ca(a,r,i,s);if(!o.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await ua(o.access_token),d={refresh_token:o.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Js(e,t,n,d),be={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{email:l.email,name:l.name}}async function ha(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(be==null?void 0:be.userId)===t&&(be=null)}const Pe="https://sheets.googleapis.com/v4/spreadsheets";class ga{constructor(t,n,a,s,r){this.db=t,this.userId=n,this.pinHash=a,this.clientId=s,this.clientSecret=r}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,n){const a=await this.authHeaders(),s=encodeURIComponent(n),r=await fetch(`${Pe}/${t}/values/${s}`,{headers:a});if(!r.ok){const o=await r.text();throw new Error(`Sheets read failed (${r.status}): ${o}`)}return(await r.json()).values||[]}async writeRange(t,n,a){const s=await this.authHeaders(),r=encodeURIComponent(n),i=await fetch(`${Pe}/${t}/values/${r}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:s,body:JSON.stringify({range:n,majorDimension:"ROWS",values:a})});if(!i.ok){const l=await i.text();throw new Error(`Sheets write failed (${i.status}): ${l}`)}return{updatedCells:(await i.json()).updatedCells||0}}async appendRows(t,n,a){var l;const s=await this.authHeaders(),r=encodeURIComponent(n),i=await fetch(`${Pe}/${t}/values/${r}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:s,body:JSON.stringify({range:n,majorDimension:"ROWS",values:a})});if(!i.ok){const d=await i.text();throw new Error(`Sheets append failed (${i.status}): ${d}`)}return{updatedCells:((l=(await i.json()).updates)==null?void 0:l.updatedCells)||a.length}}async deleteRow(t,n,a){const s=await this.authHeaders(),r=await fetch(`${Pe}/${t}?fields=sheets.properties`,{headers:s});if(!r.ok){const m=await r.text();throw new Error(`Failed to get sheet metadata (${r.status}): ${m}`)}const i=await r.json(),o=i.sheets.find(m=>m.properties.title===n);if(!o){const m=i.sheets.map(h=>h.properties.title).join(", ");throw new Error(`Tab "${n}" not found. Available tabs: ${m}`)}const l=o.properties.sheetId,d=a-1,c=await fetch(`${Pe}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:[{deleteDimension:{range:{sheetId:l,dimension:"ROWS",startIndex:d,endIndex:d+1}}}]})});if(!c.ok){const m=await c.text();throw new Error(`Row delete failed (${c.status}): ${m}`)}}async createSpreadsheet(t,n){const a=await this.authHeaders(),s={properties:{title:t},sheets:n&&n.length>0?n.map(o=>({properties:{title:o}})):[{properties:{title:"Sheet1"}}]},r=await fetch(Pe,{method:"POST",headers:a,body:JSON.stringify(s)});if(!r.ok){const o=await r.text();throw new Error(`Sheets create failed (${r.status}): ${o}`)}const i=await r.json();return{spreadsheetId:i.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${i.spreadsheetId}/edit`}}async getMetadata(t){const n=await this.authHeaders(),a=await fetch(`${Pe}/${t}?fields=properties.title,sheets.properties.title`,{headers:n});if(!a.ok){const r=await a.text();throw new Error(`Sheets metadata failed (${a.status}): ${r}`)}const s=await a.json();return{title:s.properties.title,sheets:s.sheets.map(r=>r.properties.title)}}}const gt="https://www.googleapis.com/calendar/v3";class rn{constructor(t,n,a,s,r){this.db=t,this.userId=n,this.pinHash=a,this.clientId=s,this.clientSecret=r}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",n={}){const a=await this.authHeaders(),s=new URLSearchParams;n.timeMin&&s.set("timeMin",n.timeMin),n.timeMax&&s.set("timeMax",n.timeMax),s.set("maxResults",String(n.maxResults||20)),s.set("singleEvents","true"),s.set("orderBy","startTime"),n.query&&s.set("q",n.query);const r=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events?${s}`,{headers:a});if(!r.ok){const o=await r.text();throw new Error(`Calendar list failed (${r.status}): ${o}`)}return(await r.json()).items||[]}async createEvent(t="primary",n){var o;const a=await this.authHeaders(),s=n.timeZone||"Asia/Kolkata",r={summary:n.summary,description:n.description||"",location:n.location||"",start:{dateTime:n.startDateTime,timeZone:s},end:{dateTime:n.endDateTime,timeZone:s}};(o=n.attendees)!=null&&o.length&&(r.attendees=n.attendees.map(l=>({email:l})));const i=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:a,body:JSON.stringify(r)});if(!i.ok){const l=await i.text();throw new Error(`Calendar create failed (${i.status}): ${l}`)}return await i.json()}async updateEvent(t="primary",n,a){const s=await this.authHeaders(),r=a.timeZone||"Asia/Kolkata",i={};a.summary&&(i.summary=a.summary),a.description&&(i.description=a.description),a.location&&(i.location=a.location),a.startDateTime&&(i.start={dateTime:a.startDateTime,timeZone:r}),a.endDateTime&&(i.end={dateTime:a.endDateTime,timeZone:r});const o=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events/${n}`,{method:"PATCH",headers:s,body:JSON.stringify(i)});if(!o.ok){const l=await o.text();throw new Error(`Calendar update failed (${o.status}): ${l}`)}return await o.json()}async deleteEvent(t="primary",n){const a=await this.authHeaders(),s=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events/${n}`,{method:"DELETE",headers:a});if(!s.ok&&s.status!==410){const r=await s.text();throw new Error(`Calendar delete failed (${s.status}): ${r}`)}}async listCalendars(){const t=await this.authHeaders(),n=await fetch(`${gt}/users/me/calendarList`,{headers:t});if(!n.ok){const s=await n.text();throw new Error(`Calendar list calendars failed (${n.status}): ${s}`)}return((await n.json()).items||[]).map(s=>({id:s.id,summary:s.summary,primary:s.primary||!1}))}}const Ee="https://docs.googleapis.com/v1/documents",Zs="https://www.googleapis.com/drive/v3/files";function bn(e){const t=[];for(const n of e.split(`
`)){const a=n.trim();if(a===""||/^---+$/.test(a))continue;let s="NORMAL_TEXT",r=n;const i=a.match(/^###\s+(.+)/),o=!i&&a.match(/^##\s+(.+)/),l=!i&&!o&&a.match(/^#\s+(.+)/);i?(s="HEADING_3",r=i[1]):o?(s="HEADING_2",r=o[1]):l?(s="HEADING_1",r=l[1]):/^\s*[-*]\s/.test(n)&&(r="• "+n.replace(/^\s*[-*]\s+/,""));const{text:d,spans:c}=Xs(r);t.push({text:d,namedStyle:s,spans:c})}return t}function Xs(e){const t=[];let n="",a=0;for(;a<e.length;)if(e[a]==="*"&&e[a+1]==="*"){const s=e.indexOf("**",a+2);if(s!==-1){const r=n.length;n+=e.substring(a+2,s),t.push({start:r,end:n.length,bold:!0}),a=s+2}else n+=e[a++]}else if(e[a]==="_"&&e[a+1]==="_"){const s=e.indexOf("__",a+2);if(s!==-1){const r=n.length;n+=e.substring(a+2,s),t.push({start:r,end:n.length,bold:!0}),a=s+2}else n+=e[a++]}else if(e[a]==="*"&&e[a+1]!=="*"){const s=e.indexOf("*",a+1);if(s!==-1){const r=n.length;n+=e.substring(a+1,s),t.push({start:r,end:n.length,italic:!0}),a=s+1}else n+=e[a++]}else if(e[a]==="_"){const s=e.indexOf("_",a+1);if(s!==-1){const r=n.length;n+=e.substring(a+1,s),t.push({start:r,end:n.length,italic:!0}),a=s+1}else n+=e[a++]}else n+=e[a++];return{text:n,spans:t}}class fa{constructor(t,n,a,s,r){this.db=t,this.userId=n,this.pinHash=a,this.clientId=s,this.clientSecret=r}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const n=await this.authHeaders(),a=await fetch(Ee,{method:"POST",headers:n,body:JSON.stringify({title:t})});if(!a.ok){const r=await a.text();throw new Error(`Docs create failed (${a.status}): ${r}`)}const s=await a.json();return{documentId:s.documentId,url:`https://docs.google.com/document/d/${s.documentId}/edit`}}async readDocument(t){var i,o;const n=await this.authHeaders(),a=await fetch(`${Ee}/${t}`,{headers:n});if(!a.ok){const l=await a.text();throw new Error(`Docs read failed (${a.status}): ${l}`)}const s=await a.json();let r="";for(const l of((i=s.body)==null?void 0:i.content)||[])if(l.paragraph)for(const d of l.paragraph.elements)(o=d.textRun)!=null&&o.content&&(r+=d.textRun.content);return{title:s.title,content:r.trim()}}async rewriteDocument(t,n){var f;const a=await this.authHeaders(),s=await fetch(`${Ee}/${t}`,{headers:a});if(!s.ok){const _=await s.text();throw new Error(`Docs fetch failed (${s.status}): ${_.substring(0,200)}`)}const i=((f=(await s.json()).body)==null?void 0:f.content)||[],o=i[i.length-1],l=(o==null?void 0:o.endIndex)??2,d=bn(n),c=[];if(l>2&&c.push({deleteContentRange:{range:{startIndex:1,endIndex:l-1}}}),d.length===0){c.length>0&&await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:c})});return}let m="";const h=[];for(const _ of d){const y=m.length;m+=_.text+`
`,h.push({start:y,end:m.length,namedStyle:_.namedStyle,spans:_.spans})}c.push({insertText:{location:{index:1},text:m}});for(const _ of h){_.namedStyle!=="NORMAL_TEXT"&&c.push({updateParagraphStyle:{range:{startIndex:1+_.start,endIndex:1+_.end},paragraphStyle:{namedStyleType:_.namedStyle},fields:"namedStyleType"}});for(const y of _.spans){const S={},E=[];y.bold&&(S.bold=!0,E.push("bold")),y.italic&&(S.italic=!0,E.push("italic")),E.length>0&&c.push({updateTextStyle:{range:{startIndex:1+_.start+y.start,endIndex:1+_.start+y.end},textStyle:S,fields:E.join(",")}})}}const w=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:c})});if(!w.ok){const _=await w.text();throw new Error(`Docs rewrite failed (${w.status}): ${_.substring(0,200)}`)}}async appendFormattedContent(t,n){var f;const a=await this.authHeaders(),s=bn(n);if(s.length===0)return;const r=await fetch(`${Ee}/${t}`,{headers:a});if(!r.ok){const _=await r.text();throw new Error(`Docs fetch failed (${r.status}): ${_.substring(0,200)}`)}const o=((f=(await r.json()).body)==null?void 0:f.content)||[],l=o[o.length-1],d=Math.max(1,((l==null?void 0:l.endIndex)??2)-1);let c="";const m=[];for(const _ of s){const y=c.length;c+=_.text+`
`,m.push({start:y,end:c.length,namedStyle:_.namedStyle,spans:_.spans})}const h=[{insertText:{location:{index:d},text:c}}];for(const _ of m){_.namedStyle!=="NORMAL_TEXT"&&h.push({updateParagraphStyle:{range:{startIndex:d+_.start,endIndex:d+_.end},paragraphStyle:{namedStyleType:_.namedStyle},fields:"namedStyleType"}});for(const y of _.spans){const S={},E=[];y.bold&&(S.bold=!0,E.push("bold")),y.italic&&(S.italic=!0,E.push("italic")),E.length>0&&h.push({updateTextStyle:{range:{startIndex:d+_.start+y.start,endIndex:d+_.start+y.end},textStyle:S,fields:E.join(",")}})}}const w=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:h})});if(!w.ok){const _=await w.text();throw new Error(`Docs append failed (${w.status}): ${_.substring(0,200)}`)}}async appendText(t,n){const a=await this.authHeaders(),s=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:[{insertText:{endOfSegmentLocation:{},text:n}}]})});if(!s.ok){const r=await s.text();throw new Error(`Docs append failed (${s.status}): ${r}`)}}async deleteContent(t,n){var i,o,l;const a=await this.authHeaders(),s=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:[{replaceAllText:{containsText:{text:n,matchCase:!0},replaceText:""}}]})});if(!s.ok){const d=await s.text();throw new Error(`Docs delete content failed (${s.status}): ${d.substring(0,200)}`)}return{occurrencesRemoved:((l=(o=(i=(await s.json()).replies)==null?void 0:i[0])==null?void 0:o.replaceAllText)==null?void 0:l.occurrencesChanged)??0}}async shareDocument(t,n,a="writer"){const s=await this.authHeaders(),r=await fetch(`${Zs}/${t}/permissions`,{method:"POST",headers:s,body:JSON.stringify({type:"user",role:a,emailAddress:n})});if(!r.ok){const i=await r.text();throw new Error(`Share failed (${r.status}): ${i}`)}}}class ce{constructor(t,n,a,s,r){A(this,"sheets");A(this,"calendar");A(this,"docs");A(this,"db");A(this,"userId");A(this,"pinHash");this.db=t,this.userId=n,this.pinHash=a,this.sheets=new ga(t,n,a,s,r),this.calendar=new rn(t,n,a,s,r),this.docs=new fa(t,n,a,s,r)}async isConnected(){return sn(this.db,this.userId,this.pinHash)}}const Ue=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:rn,GoogleDocs:fa,GoogleServices:ce,GoogleSheets:ga,completeOAuthFlow:pa,disconnectGoogle:ha,exchangeCodeForTokens:ca,fetchUserInfo:ua,generateAuthUrl:da,getGoogleAuth:mt,isGoogleConnected:sn,isOAuthClientConfigured:ma},Symbol.toStringTag,{value:"Module"}));async function ya(e,t,n={}){const a={textQuery:t,languageCode:"en",pageSize:8};if(n.type&&(a.includedType=n.type),n.location){const l=n.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(a.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:n.radius||5e3}})}const s=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),r=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":s},body:JSON.stringify(a)});if(!r.ok){const l=await r.text();return{results:[],error:`Places API error (${r.status}): ${l.substring(0,200)}`}}const i=await r.json();return!i.places||i.places.length===0?{results:[]}:{results:i.places.map(l=>{var d,c,m;return{name:((d=l.displayName)==null?void 0:d.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(c=l.currentOpeningHours)==null?void 0:c.openNow,types:(m=l.types)==null?void 0:m.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function va(e,t){var r,i,o;const n=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),a=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":n}});if(!a.ok){const l=await a.text();return{error:`Place Details API error (${a.status}): ${l.substring(0,200)}`}}const s=await a.json();return{details:{name:((r=s.displayName)==null?void 0:r.text)||"",address:s.formattedAddress||"",phone:s.internationalPhoneNumber,website:s.websiteUri,rating:s.rating,reviews:(i=s.reviews)==null?void 0:i.slice(0,3).map(l=>{var d,c,m;return{author:((d=l.authorAttribution)==null?void 0:d.displayName)||"Anonymous",rating:l.rating||0,text:((m=(c=l.text)==null?void 0:c.text)==null?void 0:m.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(o=s.currentOpeningHours)==null?void 0:o.weekdayDescriptions,location:s.location?{lat:s.location.latitude,lng:s.location.longitude}:void 0,googleMapsUri:s.googleMapsUri}}}async function wa(e,t,n,a={}){var d;const s=new URLSearchParams({origin:t,destination:n,key:e,mode:a.mode||"driving"});(a.mode==="driving"||!a.mode)&&s.set("departure_time","now");const r=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${s}`);if(!r.ok)return{error:`Directions API error: ${r.status}`};const i=await r.json();if(i.status!=="OK")return{error:`Directions: ${i.status} — ${i.error_message||""}`};const o=i.routes[0],l=o.legs[0];return{route:{summary:o.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(d=l.duration_in_traffic)==null?void 0:d.text,steps:l.steps.slice(0,10).map(c=>{var m,h,w;return{instruction:((m=c.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((h=c.distance)==null?void 0:h.text)||"",duration:((w=c.duration)==null?void 0:w.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function ba(e,t,n,a){var l,d;const s={q:t,target:n,key:e,format:"text"};a&&(s.source=a);const r=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(!r.ok){const c=await r.text();return{translatedText:"",error:`Translate API error (${r.status}): ${c.substring(0,200)}`}}const o=(d=(l=(await r.json()).data)==null?void 0:l.translations)==null?void 0:d[0];return o?{translatedText:o.translatedText,detectedSourceLang:o.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function _a(e,t){const n=new URLSearchParams({address:t,key:e}),a=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${n}`);if(!a.ok)return{results:[],error:`Geocoding API error: ${a.status}`};const s=await a.json();return s.status!=="OK"&&s.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${s.status} — ${s.error_message||""}`}:{results:(s.results||[]).slice(0,5).map(r=>{var i;return{address:r.formatted_address,lat:r.geometry.location.lat,lng:r.geometry.location.lng,placeId:r.place_id,types:(i=r.types)==null?void 0:i.slice(0,3)}})}}async function Ea(e,t,n={}){const a=new URLSearchParams({part:"snippet",q:t,key:e,type:n.type||"video",maxResults:String(n.maxResults||5),order:n.order||"relevance"}),s=await fetch(`https://www.googleapis.com/youtube/v3/search?${a}`);if(!s.ok){const i=await s.text();return{results:[],error:`YouTube API error (${s.status}): ${i.substring(0,200)}`}}return{results:((await s.json()).items||[]).map(i=>{var o,l,d,c,m,h,w,f;return{title:i.snippet.title,channelTitle:i.snippet.channelTitle,description:(o=i.snippet.description)==null?void 0:o.substring(0,200),videoId:((l=i.id)==null?void 0:l.videoId)||((d=i.id)==null?void 0:d.channelId)||((c=i.id)==null?void 0:c.playlistId)||"",publishedAt:i.snippet.publishedAt,url:(m=i.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${i.id.videoId}`:(h=i.id)!=null&&h.channelId?`https://www.youtube.com/channel/${i.id.channelId}`:"",thumbnailUrl:(f=(w=i.snippet.thumbnails)==null?void 0:w.medium)==null?void 0:f.url}})}}async function Pt(e,t={}){const n=Math.min(t.num||5,10),a=t.site?`site:${t.site} ${e}`:e;try{const s=new URLSearchParams({q:a}),r=await fetch(`https://html.duckduckgo.com/html/?${s}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!r.ok)return{results:[],error:`Search request failed (${r.status})`};const i=await r.text(),o=[],l=i.split(/class="result results_links/g).slice(1);for(const d of l){if(o.length>=n)break;const c=d.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=d.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(c){let h=c[1];const w=h.match(/uddg=([^&]+)/);w?h=decodeURIComponent(w[1]):h.startsWith("//")&&(h="https:"+h);const f=S=>S.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),_=f(c[2]),y=m?f(m[1]):"";if(_&&h.startsWith("http")){const S=h.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];o.push({title:_,link:h,snippet:y,displayLink:S})}}}return o.length===0?{results:[],error:void 0}:{results:o}}catch(s){return{results:[],error:`Web search error: ${s.message}`}}}async function Ta(e,t,n,a="driving"){var l,d,c,m;const s=new URLSearchParams({origins:t,destinations:n,key:e,mode:a,departure_time:"now"}),r=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${s}`);if(!r.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${r.status}`};const i=await r.json(),o=(c=(d=(l=i.rows)==null?void 0:l[0])==null?void 0:d.elements)==null?void 0:c[0];return!o||o.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(o==null?void 0:o.status)||i.status}`}:{distance:o.distance.text,duration:o.duration.text,durationInTraffic:(m=o.duration_in_traffic)==null?void 0:m.text}}const Qs=Object.freeze(Object.defineProperty({__proto__:null,geocode:_a,getDirections:wa,getDistanceMatrix:Ta,getPlaceDetails:va,searchPlaces:ya,searchYouTube:Ea,translateText:ba,webSearch:Pt},Symbol.toStringTag,{value:"Module"})),Te="https://gmail.googleapis.com/gmail/v1/users/me";class ve{constructor(t,n,a,s,r){this.db=t,this.userId=n,this.pinHash=a,this.clientId=s,this.clientSecret=r}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var o;const n=await this.authHeaders(),a=new URLSearchParams;if(a.set("maxResults",String(t.maxResults||10)),t.query&&a.set("q",t.query),(o=t.labelIds)!=null&&o.length)for(const l of t.labelIds)a.append("labelIds",l);const s=await fetch(`${Te}/messages?${a}`,{headers:n});if(!s.ok){const l=await s.text();throw new Error(`Gmail list failed (${s.status}): ${l.substring(0,200)}`)}const r=await s.json();if(!r.messages||r.messages.length===0)return[];const i=[];for(const l of r.messages.slice(0,t.maxResults||10))try{const d=await this.getMessage(l.id,n);d&&i.push(d)}catch{}return i}async getMessage(t,n){const a=n||await this.authHeaders(),s=await fetch(`${Te}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:a});if(!s.ok)return null;const r=await s.json(),i=o=>{var l,d,c;return((c=(d=(l=r.payload)==null?void 0:l.headers)==null?void 0:d.find(m=>m.name.toLowerCase()===o.toLowerCase()))==null?void 0:c.value)||""};return{id:r.id,threadId:r.threadId,snippet:r.snippet||"",subject:i("Subject")||"(no subject)",from:i("From"),to:i("To"),date:i("Date")||new Date(parseInt(r.internalDate)).toISOString(),isUnread:(r.labelIds||[]).includes("UNREAD"),labels:r.labelIds||[]}}async getMessageBody(t){const n=await this.authHeaders(),a=await fetch(`${Te}/messages/${t}?format=full`,{headers:n});if(!a.ok){const r=await a.text();throw new Error(`Gmail message body failed (${a.status}): ${r.substring(0,200)}`)}const s=await a.json();return Sa(s.payload)}async search(t,n=10){return this.listMessages({query:t,maxResults:n})}async send(t,n,a,s={}){const r=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${n}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];s.cc&&i.push(`Cc: ${s.cc}`),s.bcc&&i.push(`Bcc: ${s.bcc}`),s.replyToMessageId&&(i.push(`In-Reply-To: ${s.replyToMessageId}`),i.push(`References: ${s.replyToMessageId}`)),i.push("",a);const o=i.join(`\r
`),d={raw:_n(o)};s.threadId&&(d.threadId=s.threadId);const c=await fetch(`${Te}/messages/send`,{method:"POST",headers:r,body:JSON.stringify(d)});if(!c.ok){const m=await c.text();throw new Error(`Gmail send failed (${c.status}): ${m.substring(0,200)}`)}return await c.json()}async createDraft(t,n,a,s={}){const r=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${n}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];s.cc&&i.push(`Cc: ${s.cc}`),i.push("",er(a));const o=i.join(`\r
`),l=_n(o),d=await fetch(`${Te}/drafts`,{method:"POST",headers:r,body:JSON.stringify({message:{raw:l}})});if(!d.ok){const c=await d.text();throw new Error(`Gmail draft failed (${d.status}): ${c.substring(0,200)}`)}return await d.json()}async markAsRead(t){const n=await this.authHeaders();await fetch(`${Te}/messages/${t}/modify`,{method:"POST",headers:n,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,n){const a=await this.authHeaders();let s={};switch(n){case"archive":s={removeLabelIds:["INBOX"]};break;case"trash":s={addLabelIds:["TRASH"]};break;case"read":s={removeLabelIds:["UNREAD"]};break;case"unread":s={addLabelIds:["UNREAD"]};break;case"star":s={addLabelIds:["STARRED"]};break;case"unstar":s={removeLabelIds:["STARRED"]};break}const r=await fetch(`${Te}/messages/${t}/modify`,{method:"POST",headers:{...a,"Content-Type":"application/json"},body:JSON.stringify(s)});if(!r.ok){const i=await r.text();throw new Error(`Failed to modify message: ${i}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),n=await fetch(`${Te}/labels/INBOX`,{headers:t});return n.ok&&(await n.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),n=await fetch(`${Te}/profile`,{headers:t});if(!n.ok)throw new Error("Failed to get Gmail profile");return await n.json()}}function Sa(e){var t,n,a;if(!e)return"";if((t=e.body)!=null&&t.data)return zt(e.body.data);if(e.parts){for(const s of e.parts)if(s.mimeType==="text/plain"&&((n=s.body)!=null&&n.data))return zt(s.body.data);for(const s of e.parts)if(s.mimeType==="text/html"&&((a=s.body)!=null&&a.data)){const r=zt(s.body.data);return tr(r)}for(const s of e.parts)if(s.parts){const r=Sa(s);if(r)return r}}return e.snippet||""}function er(e){let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return t=t.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),t=t.replace(new RegExp("(?<!\\*)\\*(?!\\*)(.+?)(?<!\\*)\\*(?!\\*)","g"),"<em>$1</em>"),`<html><body style="font-family:Arial,sans-serif;font-size:14px;line-height:1.6;color:#000000;">${t.split(/\n\n+/).map(s=>{const r=s.split(`
`);return r.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${r.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:r.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${r.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${r.join("<br>")}</p>`}).join("")}</body></html>`}function _n(e){const t=new TextEncoder().encode(e);let n="";for(let a=0;a<t.length;a++)n+=String.fromCharCode(t[a]);return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function zt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function tr(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const nr=1e4,ar=1e4;async function xa(e,t){try{const n=new AbortController,a=setTimeout(()=>n.abort(),ar),s=await fetch(e,{signal:n.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!s.ok)return{text:"",error:`HTTP ${s.status}`};const r=s.headers.get("content-type")||"";if(!r.includes("text/html")&&!r.includes("text/plain")&&!r.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${r.split(";")[0]}`};const i=await s.text();clearTimeout(a);const o=i.length>2e5?i.substring(0,2e5):i,l=sr(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||nr)}}catch(n){return{text:"",error:n.name==="AbortError"?"Timeout":n.message}}}function sr(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}const rr=1e4;async function ir(e,t){var s,r,i;const n=new AbortController,a=setTimeout(()=>n.abort(),rr);try{const o=await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",signal:n.signal,headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:e}],max_tokens:2e3})});if(clearTimeout(a),!o.ok)return{report:"",sources:[],pagesRead:0,error:`Perplexity error ${o.status}`};const l=await o.json(),d=((i=(r=(s=l==null?void 0:l.choices)==null?void 0:s[0])==null?void 0:r.message)==null?void 0:i.content)||"",m=((l==null?void 0:l.citations)||[]).map(h=>({title:h,url:h,snippet:""}));return{report:d,sources:m,pagesRead:m.length}}catch(o){return clearTimeout(a),{report:"",sources:[],pagesRead:0,error:`Perplexity request failed: ${o.message}`}}}async function ka(e,t,n={}){if(n.perplexityApiKey){const h=await ir(e,n.perplexityApiKey);if(!h.error)return h}const a=n.maxPages||(n.depth==="thorough"?5:3),s=n.maxResults||(n.depth==="thorough"?8:5),r=await Pt(e,{num:s,site:n.site});if(r.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${r.error}`};if(r.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=r.results.slice(0,a).map(async h=>{const w=await xa(h.link);return{title:h.title,url:h.link,displayLink:h.displayLink,snippet:h.snippet,content:w.text,error:w.error}}),d=(await Promise.all(o)).filter(h=>h.content.length>50);if(d.length===0){const h=r.results.map((f,_)=>`[${_+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await En(e,h,t,"snippets"),sources:r.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const c=d.map((h,w)=>`--- SOURCE ${w+1}: ${h.title} (${h.displayLink}) ---
${h.content}
--- END SOURCE ${w+1} ---`).join(`

`);return{report:await En(e,c,t,"full"),sources:d.map(h=>({title:h.title,url:h.url})),pagesRead:d.length}}async function En(e,t,n,a){const r=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
${a}
`:"",o=Sn(t,hr);return`You are ${s} — a personal AI assistant. Your name is ${s} — always refer to yourself by this name if asked.
...
- **Long content intent check**: When asked to write long-form content (essay, article, report — likely over 200 words) WITHOUT a save destination specified, do NOT start writing. Ask first: "Should I save this as a Google Doc and send you the link, or write it here in chat?" Wait for the response. If Drive/Doc, call \`create_doc\` with full content and return only the link. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**`:""}`}async function Yt(e,t,n){var d;const s=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${n.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let r;((d=s.files)==null?void 0:d.length)>0?r=s.files[0].id:r=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:n,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${r}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:r,folderName:n}}function Mt(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").trim()}function $a(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function bt(e,t,n,a,s,r,i,o,l,d,c,m,h){const w=Date.now();let f=!0,_="",y="";try{return y=await fr(e,t,n,a,r,i,o,l,d,c,m,h),y}catch(S){throw f=!1,_=S.message||"Unknown error",S}finally{const S=Date.now()-w;try{await n.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(a,s.agentType||null,s.providerName||null,e,JSON.stringify(t).substring(0,2e3),(f?y:"").substring(0,500),f?1:0,_||null,S,s.isEnforcementRetry?1:0,s.channel||"web").run()}catch{}}}function Ba(e){const t=e.length;for(let n=0;n<t-1;n++){const a=e[n];if(a.role!=="user"||typeof a.content!="string")continue;const s=t-1-n,r=s<=2?12e3:s<=4?5e3:2e3;a.content.length>r&&(e[n]={...a,content:a.content.substring(0,r)+`
[...truncated in history to reduce context size]`})}}function gr(e){const t=[];let n=[],a="",s=!1,r=0;const i=e.length;for(;r<i;){const o=e[r];if(s){if(o==='"'){if(e[r+1]==='"'){a+='"',r+=2;continue}s=!1,r++;continue}a+=o,r++;continue}if(o==='"'){s=!0,r++;continue}if(o===","){n.push(a),a="",r++;continue}if(o==="\r"&&e[r+1]===`
`){n.push(a),t.push(n),n=[],a="",r+=2;continue}if(o===`
`||o==="\r"){n.push(a),t.push(n),n=[],a="",r++;continue}a+=o,r++}for((a||n.length)&&(n.push(a),t.push(n));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function fr(e,t,n,a,s,r,i,o,l,d,c,m){var w,f,_,y,S,E,R,N,M,W,H,$,q,z,O,U;const h=new K(n);switch(e){case"create_schedule":{const u=new Date;let v;const p=d||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){v=new Date(u.getTime()+t.minutes_from_now*60*1e3);const D=v.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[I,B,C]=(D[0]||"").split("/");t.schedule_value=`${C}-${I}-${B} ${D[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);v=new Date(u.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"){const[T,D]=t.schedule_value.split(":").map(Number),I=u.toLocaleString("en-US",{timeZone:p}),B=new Date(I),C=new Date(B);C.setHours(T,D,0,0),C<=B&&C.setDate(C.getDate()+1);const L=new Date(C.toLocaleString("en-US",{timeZone:"UTC"})),F=new Date(C.toLocaleString("en-US",{timeZone:p})),J=L.getTime()-F.getTime();v=new Date(C.getTime()+J)}else if(t.schedule_type==="weekly"){const[T,D]=t.schedule_value.split(" "),[I,B]=(D||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ve=>Ve.toLowerCase()===T.toLowerCase()),F=u.toLocaleString("en-US",{timeZone:p}),J=new Date(F),X=new Date(J);X.setHours(I,B,0,0);let ee=(L-X.getDay()+7)%7;ee===0&&X<=J&&(ee=7),X.setDate(X.getDate()+ee);const Q=new Date(X.toLocaleString("en-US",{timeZone:"UTC"})),re=new Date(X.toLocaleString("en-US",{timeZone:p})),me=Q.getTime()-re.getTime();v=new Date(X.getTime()+me)}else if(t.schedule_type==="once"){const[T,D]=t.schedule_value.split(" "),[I,B,C]=T.split("-").map(Number),[L,F]=(D||"00:00").split(":").map(Number),J=u.toLocaleString("en-US",{timeZone:p}),X=new Date(J),ee=new Date(X);ee.setFullYear(I,B-1,C),ee.setHours(L,F,0,0);const Q=new Date(ee.toLocaleString("en-US",{timeZone:"UTC"})),re=new Date(ee.toLocaleString("en-US",{timeZone:p})),me=Q.getTime()-re.getTime();v=new Date(ee.getTime()+me);const Ve=new Date(u.getTime()+120*1e3);if(v.getTime()<u.getTime()+60*1e3){const Ut=v.toISOString();v=Ve;const pt=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${Ut} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${v.toISOString()}.]`;t._pastTimeWarning=pt}}else v=new Date(u.getTime()+3600*1e3);if(await n.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(a,t.name,t.schedule_type,t.schedule_value).first()){const T=v.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${T} (${p}). No duplicate created.`}await n.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
ID: ${g.id}
Start: ${g.start.dateTime||g.start.date}`}catch(u){return await P(n,a,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!s)return"Authentication context unavailable.";const u=new ce(n,a,s,r||"",i||"");if(!(await u.isConnected()).connected){if(t.title&&t.content)try{await new K(n).store(a,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title&&t.content?`
...
Use append_to_doc with the document ID above to add content.`}let g="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(n,a,s,r||"",i||"");g=`
...
ID: ${p.documentId}
URL: ${p.url}`}case"read_doc":{if(!s)return"Authentication context unavailable.";try{const v=await new ce(n,a,s,r||"",i||"").docs.readDocument(t.document_id);return`Document: "${v.title}"

${v.content}`}catch(u){return await P(n,a,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!s)return"Authentication context unavailable.";try{const u=new ce(n,a,s,r||"",i||"");if(!(await u.isConnected()).connected){if(t.document_id&&t.content)try{await new K(n).store(a,"context",`Pending append to doc: "${t.document_id}"`,JSON.stringify({tool:"append_to_doc",document_id:t.document_id,content:t.content}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.'+(t.document_id&&t.content?`
...
`));try{const T=new K(n),D=b.report.substring(0,600);await T.store(a,"context",`Research: ${t.query.substring(0,80)}`,D,6,"long_term")}catch{}return x}catch(u){return await P(n,a,"research","research",u.message),`Research error: ${u.message}`}}case"browser_task":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const v=(await Y(u.encrypted_value,s)).trim();let p,g=t.task,b,x;if(t.site_name)try{const C=await n.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(a,t.site_name).first();if(C){const L=JSON.parse(await Y(C.encrypted_blob,s));p={username:L.username,password:L.password},x=L.sessionId,b=C.id,g=`${g}

When prompted to log in, use username {username} and password {password}.`}}catch{}const T=await Ra(g,v,{secrets:p,sessionId:x}),D=async C=>{if(b)try{const L=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(b,a).first();if(!L)return;const F=JSON.parse(await Y(L.encrypted_blob,s));F.sessionId=C;const J=await ct(JSON.stringify(F),s);await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(J,b,a).run()}catch{}},I=async()=>{if(!(!b||!x))try{const C=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(b,a).first();if(!C)return;const L=JSON.parse(await Y(C.encrypted_blob,s));delete L.sessionId;const F=await ct(JSON.stringify(L),s);await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(F,b,a).run()}catch{}};if(T.status==="completed")return T.sessionId&&await D(T.sessionId),T.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again.";if(T.status==="timeout"){T.sessionId&&await D(T.sessionId);try{await new K(n).store(a,"context",`Browser task in progress: ${T.taskId}`,JSON.stringify({task_id:T.taskId,task:t.task}),9,"working")}catch{}return`[BROWSER_TIMEOUT:${T.taskId}] Browser task did not finish within the time limit. Tell the user it is still running and ask them to follow up in 2–3 minutes.`}await I();const B=[T.error,T.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${T.taskId}\`): ${B||"No details returned. Check your Browser Use dashboard at cloud.browser-use.com."}`}catch(u){return await P(n,a,"browser","browser_task",u.message),`Browser task error: ${u.message}`}}case"browser_task_status":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured.";const v=await Y(u.encrypted_value,s),p=await dr(t.task_id,v);if(p.done){try{const g=new K(n),b=await g.search(a,`Browser task in progress: ${t.task_id}`);for(const x of b)await g.remove(x.id,a)}catch{}return p.status==="finished"||p.status==="completed"?p.output?p.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${p.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${p.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working. Ask me 'what happened with the browser task?' in 2–3 minutes."`}catch(u){return await P(n,a,"browser","browser_task_status",u.message),`Browser status check error: ${u.message}`}}case"vault_lookup":try{const u=(t.site_name||"").trim();if(!u)return"No site name provided.";const p=((await n.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(a,`%${u}%`).all()).results||[]).map(g=>g.name);return p.length===0?`No vault entries found matching "${u}".`:`Vault entries matching "${u}": ${p.join(", ")}. Use site_name="${p[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const v=await Y(u.encrypted_value,s),p=await ya(v,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((g,b)=>{const x=g.rating?` ★${g.rating} (${g.userRatingsTotal||0} reviews)`:"",T=g.openNow!==void 0?g.openNow?" · Open now":" · Closed":"",D=g.googleMapsUri?`
   ${g.googleMapsUri}`:"";return`${b+1}. **${g.name}**${x}${T}
   ${g.address}${D}
   [place_id: ${g.placeId}]`}).join(`

`)}catch(u){return await P(n,a,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const v=await Y(u.encrypted_value,s),p=await va(v,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const g=p.details;let b=`**${g.name}**
...
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return b}catch(u){return await P(n,a,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const v=await Y(u.encrypted_value,s),p=await wa(v,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const g=p.route;let b=`**${g.startAddress}** → **${g.endAddress}**
`;return b+=`📏 ${g.distance} · ⏱️ ${g.duration}`,g.durationInTraffic&&(b+=` (with traffic: ${g.durationInTraffic})`),b+=`
via ${g.summary}`,b+=`

Steps:`,g.steps.forEach((x,T)=>{b+=`
${T+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),b}catch(u){return await P(n,a,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const v=await Y(u.encrypted_value,s),p=await Ta(v,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let g=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(g+=` (with traffic: ${p.durationInTraffic})`),g}catch(u){return await P(n,a,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const v=await Y(u.encrypted_value,s),p=await ba(v,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await P(n,a,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const v=await Y(u.encrypted_value,s),p=await Ea(v,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((g,b)=>{var x;return`${b+1}. **${g.title}**
   ${g.channelTitle} · ${((x=g.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${g.description}
   ${g.url}`}).join(`

`)}catch(u){return await P(n,a,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!s)return"Authentication context unavailable.";try{const u=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const v=await Y(u.encrypted_value,s),p=await _a(v,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((g,b)=>`${b+1}. ${g.address}
...
`)});continue}y=$.content;const q=Mt(y);await i.storeMessage(a.id,e.channel,"assistant",q,"{}",o);const z=50;for(let O=0;O<q.length;O+=z)yield{type:"chunk",data:{text:q.substring(O,O+z),threadId:o}},O+z<q.length&&await new Promise(u=>setTimeout(u,10));break}catch($){if(s){const O=$.message||"",U=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),u=O.includes("429"),v=U?1440:u?10:5;await s.recordError(n.name,O,v)}await P(t,a.id,"llm","provider_error",$.message||"Unknown LLM error",{provider:n.name,turn:H});const q=$.message||"An error occurred",z=q.includes("429")||q.toLowerCase().includes("rate limit")||q.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":q;try{await i.storeMessage(a.id,e.channel,"assistant",`⚠️ ${z}`,"{}",o)}catch{}yield{type:"error",data:{error:z,threadId:o}};return}if(y=(y==null?void 0:y.trim())??"",!y)try{E.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),y=(await n.chat(E,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const $=Mt(y);await i.storeMessage(a.id,e.channel,"assistant",$,"{}",o);const q=50;for(let z=0;z<$.length;z+=q)yield{type:"chunk",data:{text:$.substring(z,z+q),threadId:o}},z+q<$.length&&await new Promise(O=>setTimeout(O,10))}catch{y="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(a.id,e.channel,"assistant",y,"{}",o).catch(()=>{}),yield{type:"chunk",data:{text:y,threadId:o}}}if(s&&S>0)try{await s.recordUsage(n.name,S)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(a.id,n.name,"full",S,Date.now()-l,1,e.channel).run()}catch{}const N=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc)\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a Google Document but create_doc was never called. You MUST call create_doc NOW.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const H of N){const $=H.claimPattern.test(y),q=H.requiredTools.some(z=>R.includes(z));if($&&!q){try{await P(t,a.id,"llm",H.logType,"LLM claimed action without tool call (streaming)",{response:y.substring(0,200)}),E.push({role:"assistant",content:y}),E.push({role:"user",content:H.enforcementMsg});const z=await n.chat(E,{tools:f.filter(O=>H.requiredTools.includes(O.name)),temperature:0});if((W=z.toolCalls)!=null&&W.length){for(const U of z.toolCalls){const u=await bt(U.name,U.arguments,t,a.id,{agentType:"full",providerName:n.name,channel:e.channel},a.pin_hash,r==null?void 0:r.GOOGLE_CLIENT_ID,r==null?void 0:r.GOOGLE_CLIENT_SECRET,r==null?void 0:r.GOOGLE_API_KEY,r==null?void 0:r.GOOGLE_CSE_ID,a.timezone,n,r==null?void 0:r.DOCUMENTS_BUCKET);R.push(U.name),E.push({role:"assistant",content:"",toolCalls:z.toolCalls}),E.push({role:"user",content:u})}const O=await n.chat(E,{tools:[]});O.content&&(y=O.content)}else y="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:S}}}async function Rn(e,t,n,a,s,r,i,o){await r.storeMessage(s.id,t.channel,"user",t.text,"{}",o);const l=await bt(e.tool,e.args,n,s.id,{agentType:"direct",channel:t.channel},s.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,s.timezone,a,i==null?void 0:i.DOCUMENTS_BUCKET),d=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await r.storeMessage(s.id,t.channel,"assistant",d,"{}",o),l}async function cn(e,t,n,a,s,r){var f;const i=new K(t),o=(f=e.metadata)==null?void 0:f.thread_id,l=await i.buildContext(a.id),d=on(e.text,l);if(d.agent==="conversation")return Ua(e,t,n,a,l,s,o);const c=Ca(e.text);if(c)return Rn(c,e,t,n,a,i,r,o);const m=(await i.getRecentConversations(a.id,10,o)).map(_=>_.content).join(`
`),h=Na(e.text,m);if(h)return Rn(h,e,t,n,a,i,r,o);const w=d.confidence>=.85;if(e.channel==="telegram"){const _=await ln(t,a.id);return kn(e,t,n,a,s,r,{maxTurns:10,tools:_,forceToolUseOnFirstTurn:w})}return kn(e,t,n,a,s,r,{forceToolUseOnFirstTurn:w})}async function Ua(e,t,n,a,s,r,i){const o=new K(t),l=Date.now(),d=$a(a.timezone),c=await dn(t,a.id),m=c?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${c}

${s}`:s,h=Ia("conversation",a,m,a.timezone,d,e.channel),w=(await o.getRecentConversations(a.id,30,i)).filter(E=>!E.content.startsWith("[Autonomous Scheduled Task]")&&!E.content.startsWith("[Scheduled Reminder]")),f=La([{role:"system",content:h},...w.map(E=>({role:E.role,content:E.content})),{role:"user",content:e.text}]);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);let _=0,y="";try{const E=await n.chat(f,{temperature:.8});E.usage&&(_=E.usage.promptTokens+E.usage.completionTokens),y=E.content}catch(E){if(r){const R=E.message||"",N=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),M=R.includes("429"),W=N?1440:M?10:5;await r.recordError(n.name,R,W)}throw await P(t,a.id,"llm","conversation_error",E.message,{provider:n.name}),E}if(r&&_>0)try{await r.recordUsage(n.name,_)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(a.id,n.name,"conversation",_,Date.now()-l,1,e.channel).run()}catch{}const S=Mt(y);return await o.storeMessage(a.id,e.channel,"assistant",S,"{}",i),S}async function*_r(e,t,n,a,s,r){var c;const i=new K(t),o=(c=e.metadata)==null?void 0:c.thread_id,l=await i.buildContext(a.id),d=on(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){yield*br(e,t,n,a,s,r);return}try{const m=await Ua(e,t,n,a,l,s,o),h=50;for(let w=0;w<m.length;w+=h)yield{type:"chunk",data:{text:m.substring(w,w+h),threadId:o}},w+h<m.length&&await new Promise(f=>setTimeout(f,10))}catch(m){yield{type:"error",data:{error:m.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const ne=new pe;async function Er(e,t){var s;const n=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",n),await t()}ne.use("/*",Er);ne.get("/threads",async e=>{const t=e.get("user"),n=e.req.query("archived")==="1",a=parseInt(e.req.query("limit")||"30"),s=await e.env.DB.prepare(`SELECT t.*, 
...
`+w;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(s.user_id,"reminder",o,w,"cron:"+s.id).run(),c&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(s.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:s.id})).run(),s.telegram_chat_id&&await Sr(e.env.DB,s.user_id,s.telegram_chat_id,f),e.json({job_id:a,status:"completed",response_length:d.length})});async function Ha(e){var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return null;const n=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(n==null?void 0:n.user_id)||null}Oe.get("/health/tools",async e=>{var n;const t=await Ha(e);if(!t)return e.json({error:"Not authenticated"},401);try{const a=await e.env.DB.prepare(`SELECT tool_name,
       ...
       WHERE user_id = ? AND created_at > datetime('now', '-24 hours')
       AND tool_name = '__enforcement_trigger'
       GROUP BY agent_type, provider_name`).bind(t).all(),r=await e.env.DB.prepare(`SELECT COUNT(*) as total_retries,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function xr(e,t,n){return n==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:n==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${ft}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${ft}`}function kr(e,t,n,a){return{userId:e,username:t,channel:"telegram",text:n,sessionId:`telegram-${a}`,timestamp:new Date().toISOString()}}function Dr(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const Dt=new pe,Rr=4e3;async function te(e,t,n,a="Markdown",s,r){var d,c;const i=Cr(n,Rr),o=[];let l=!0;for(let m=0;m<i.length;m++){const h=i[m];let w=!1,f="";for(let _=0;_<3;_++)try{const y=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h,parse_mode:a,disable_web_page_preview:!1})});if(y.ok){w=!0;break}const S=await y.json().catch(()=>null);if(f=`HTTP ${y.status}: ${(S==null?void 0:S.description)||"Unknown error"}`,(d=S==null?void 0:S.description)!=null&&d.includes("parse")||(c=S==null?void 0:S.description)!=null&&c.includes("entities")){if((await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h})})).ok){w=!0;break}f+=" (plain-text retry also failed)"}if(y.status===429||y.status>=500){const E=Math.pow(2,_)*1e3;await new Promise(R=>setTimeout(R,E));continue}break}catch(y){if(f=`Network error: ${y.message}`,_<2){const S=Math.pow(2,_)*1e3;await new Promise(E=>setTimeout(E,S));continue}}w||(l=!1,o.push(`Chunk ${m+1}/${i.length}: ${f}`))}if(!l&&s&&r&&o.length>0)try{const{logError:m}=await Promise.resolve().then(()=>nt);await m(s,r,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function Or(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Cr(e,t){if(e.length<=t)return[e];const n=[];let a=e;for(;a.length>0;){if(a.length<=t){n.push(a);break}let s=a.lastIndexOf(`
`,t);s<t*.3&&(s=a.lastIndexOf(" ",t)),s<t*.3&&(s=t),n.push(a.substring(0,s)),a=a.substring(s).trimStart()}return n}async function Nr(e,t,n,a,s){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(a==null?void 0:a.name)||"there",o=(a==null?void 0:a.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`),d=await te(n,t,l,"Markdown",s,a==null?void 0:a.id);return!d.success&&d.errors.length>0&&console.warn(`[/start] Failed to send message: ${d.errors.join(" | ")}`),!0}case"/help":{const o=`🛠 *${(a==null?void 0:a.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`,l=await te(n,t,o,"Markdown",s,a==null?void 0:a.id);return!l.success&&l.errors.length>0&&console.warn(`[/help] Failed to send message: ${l.errors.join(" | ")}`),!0}case"/status":{if(!a){const i=await te(n,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app.","Markdown",s);return i.success||console.warn(`[/status] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const[i,o,l,d]=await Promise.all([s.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(a.id).first(),s.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(a.id).first(),s.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(a.id).first(),s.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(a.id).first()]),c=`📊 *System Status*
...
Status: ✅ Online`,m=await te(n,t,c,"Markdown",s,a.id);m.success||console.warn(`[/status] Failed to send message: ${m.errors.join(" | ")}`)}catch{const o=await te(n,t,"✅ Online — but had trouble fetching stats.","Markdown",s,a==null?void 0:a.id);o.success||console.warn(`[/status error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/new":{if(!a){const o=await te(n,t,"⚠️ Account not linked.","Markdown",s);return o.success||console.warn(`[/new] Failed to send message: ${o.errors.join(" | ")}`),!0}await s.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(a.id).run();const i=await te(n,t,"🆕 Starting fresh conversation. Your next message begins a new thread.","Markdown",s,a.id);return i.success||console.warn(`[/new] Failed to send message: ${i.errors.join(" | ")}`),!0}case"/tasks":case"/task":{if(!a){const i=await te(n,t,"⚠️ Account not linked.","Markdown",s);return i.success||console.warn(`[/tasks] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await s.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(a.id).all()).results||[];if(o.length===0){const f=await te(n,t,"✅ No open tasks. You're all clear.","Markdown",s,a.id);return f.success||console.warn(`[/tasks] Failed to send message: ${f.errors.join(" | ")}`),!0}const l=new Date,d=l.toISOString().slice(0,10),c=new Date(l);c.setDate(c.getDate()+1);const m=c.toISOString().slice(0,10),h=[`📋 *Open Tasks (${o.length})*
...
`:""}${T}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(O){if(_&&c.caption)S=c.caption;else{const U=await te(R,y,`⚠️ Received your file but couldn't process it: ${O.message}`,"Markdown",n,E==null?void 0:E.id);U.success||console.warn(`[file processing error] Failed to send message: ${U.errors.join(" | ")}`);return}}if(!S)return;Or(R,y).catch(()=>{});let N=await n.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(E.id).first();N?await n.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(N.id).run():N={id:(await n.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(E.id).run()).meta.last_row_id};const M=kr(E.id,E.username,S,y);M.metadata={thread_id:N.id};let W,H;try{const O=await ut(n,E.id,E.pin_hash);W=O.provider,H=O.rotation}catch(O){console.error("Telegram provider setup error:",O);const U=(o=O.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=O.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${O.message||"Unknown error"}`,u=await te(R,y,U,"Markdown",n,E.id);u.success||console.warn(`[provider error] Failed to send message: ${u.errors.join(" | ")}`);return}const{classifyIntentFast:$}=await Promise.resolve().then(()=>mr);if($(S).agent==="multi"){const O=await te(R,y,"🔍 On it…","Markdown",n,E.id);O.success||console.warn(`[ack] Failed to send: ${O.errors.join(" | ")}`)}const q=9e4;let z=!1;try{const O=await Promise.race([cn(M,n,W,E,H,a),new Promise((v,p)=>setTimeout(()=>p(new Error("TELEGRAM_TIMEOUT")),q))]),U=Dr(O,"telegram"),u=await te(R,y,U||"(empty response)","Markdown",n,E.id);if(await n.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(N.id).run().catch(()=>{}),z=u.success,!u.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${E.id}:`,u.errors);try{const{logError:v}=await Promise.resolve().then(()=>nt);await v(n,E.id,"telegram","response_send_failed",`Failed to deliver response: ${u.errors.join(" | ")}`)}catch{}}}catch(O){console.error("Telegram agent error:",O);const U=O.message==="TELEGRAM_TIMEOUT",u=U?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(d=O.message)!=null&&d.includes("API error")?`⚠️ AI provider returned an error. The provider (${W.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(O.message||"Unknown").substring(0,200)}`,v=await te(R,y,u,"Markdown",n,E.id);z=v.success,v.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${E.id}:`,v.errors);try{const{logError:p}=await Promise.resolve().then(()=>nt);await p(n,E.id,"telegram",U?"timeout":"agent_error",O.message||"Agent error",{provider:W.name})}catch{}}}catch(c){console.error("Telegram webhook error:",c);try{const{logError:m}=await Promise.resolve().then(()=>nt);await m(n,null,"telegram","webhook_error",c.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(s()),e.json({ok:!0})});Dt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const{webhook_url:a}=await e.req.json(),s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Telegram bot token not configured in Settings"},400);const r=await Y(s.encrypted_value,n.pin_hash);if(!a){const c=await(await fetch(`https://api.telegram.org/bot${r}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(c)}const o=await(await fetch(`https://api.telegram.org/bot${r}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:a,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});Dt.get("/webhook-status",async e=>{var r,i,o,l,d,c;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!a)return e.json({configured:!1,error:"Bot token not set"});const s=await Y(a.encrypted_value,n.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((d=h.result)==null?void 0:d.last_error_message)||"",last_error_date:((c=h.result)==null?void 0:c.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Dt.post("/detect-chat-id",async e=>{var r,i;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!a)return e.json({error:"Bot token not configured"},400);const s=await Y(a.encrypted_value,n.pin_hash);try{const d=((i=(await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(y=>setTimeout(y,500));const m=await(await fetch(`https://api.telegram.org/bot${s}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const h=m.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const w=[],f=new Set;for(let y=h.length-1;y>=0;y--){const S=h[y].message;if(S&&S.chat){const E=String(S.chat.id);f.has(E)||(f.add(E),w.push({chat_id:E,name:[S.chat.first_name,S.chat.last_name].filter(Boolean).join(" ")||S.chat.title||"Unknown",username:S.chat.username||"",date:new Date((S.date||0)*1e3).toISOString()}))}}if(w.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=w[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,n.user_id).run(),e.json({found:!0,chat_id:_,name:w[0].name,all_chats:w,message:`Chat ID ${_} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function Ir(e,t){var _;const{id:n,data:a,message:s,from:r}=t;if(!a||!s)return;const i=a.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const d=String(s.chat.id),c=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!c)return;const m=await e.prepare(`
  ...
  `).bind(h,h,m.id).run();const w=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(c.id).first();if(!w)return;const f=await Y(w.encrypted_value,w.pin_hash);try{const y=await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:n,text:h?"✅ Checked!":"☐ Unchecked"})});y.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${y.status}`)}catch(y){console.warn(`[callback answer] Error answering callback: ${y.message}`)}if((_=s.reply_markup)!=null&&_.inline_keyboard){const y=s.reply_markup.inline_keyboard.map(S=>S.map(E=>{var R;if((R=E.callback_data)!=null&&R.includes(o)){const N=h?"✅":"☐",M=E.text.replace(/^[☐✅]\s*/,"");return{...E,text:`${N} ${M}`}}return E}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:s.message_id,reply_markup:{inline_keyboard:y}})})}catch{}}}function Ar(e){const t=new Date,n=new Date(t.toLocaleString("en-US",{timeZone:e})),a=new Date(n);a.setDate(a.getDate()+1),a.setHours(0,0,0,0);const s=new Date(a);s.setHours(23,59,59,999);const r=a.toISOString().split("T")[0];return{start:a.toISOString(),end:s.toISOString(),dateStr:r}}async function Lr(e,t,n,a,s,r){try{return(await new rn(e,t,n,a,s).listEvents("primary",{timeMin:r.start,timeMax:r.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(c=>c.displayName||c.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Mr(e,t,n,a,s){try{const r=new ve(e,t,n,a,s),i=await r.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await r.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of i){const h=m.from.split("<")[0].trim()||m.from;l[h]=(l[h]||0)+1}const d=Object.entries(l).sort(([,m],[,h])=>h-m).slice(0,5).map(([m])=>m),c=i.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:d,hasUrgent:c}}catch(r){return console.error("Gmail fetch error:",r.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function $r(e,t){try{const n=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),a=new Date,s=new Date(a);s.setDate(s.getDate()+1),s.setHours(23,59,59,999);const r=n.results||[],i=r.map(l=>{if(l.due_date){const d=new Date(l.due_date),c=d<=a?"overdue":d<=s?"due today":d.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${l.title} [${c}]`}return l.title}),o=r.filter(l=>l.due_date?new Date(l.due_date)<=s:!1).length;return{pending:r.length,dueToday:o,items:i}}catch(n){return console.error("Tasks fetch error:",n.message),{pending:0,dueToday:0,items:[]}}}async function Br(e,t){try{const n=Math.floor((Date.now()-1728e5)/1e3),a=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${n},points>10`,s=await fetch(a,{headers:{"User-Agent":"Karna/1.0"}});return s.ok?((await s.json()).hits||[]).filter(i=>i.url&&!t.has(i.url)).slice(0,2).map(i=>({title:i.title,summary:`${i.points} pts · ${i.num_comments} comments on HN`,url:i.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const Nn=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function jr(e,t,n){const a=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],s=new Set;if(t&&n)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(n).all()).results||[]).forEach(d=>s.add(d.url))}catch{}const r=[];if(a.some(l=>Nn.some(d=>l.toLowerCase().includes(d.toLowerCase())))){const l=a.find(c=>Nn.some(m=>c.toLowerCase().includes(m.toLowerCase())))||"AI agents",d=await Br(l,s);for(const c of d)r.push(c),s.add(c.url)}for(const l of a){if(r.length>=8)break;const d=`latest ${l} news today`;try{const c=await Pt(d,{num:5});if(c.results)for(const m of c.results){if(r.length>=8)break;s.has(m.link)||(r.push({title:m.title,summary:m.snippet,url:m.link,source:m.displayLink}),s.add(m.link))}}catch(c){console.error(`News search error for "${d}":`,c.message)}}const o=r.slice(0,7);if(t&&n&&o.length>0)for(const l of o)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(n,l.url,l.title).run()}catch{}return o}function Pr(e,t){const n=[];let a="20:00";{const[i,o]=t.split(":"),l=parseInt(i,10),d=o||"00",c=l>=12?"PM":"AM";a=`${l===0?12:l>12?l-12:l}:${d} ${c}`}n.push(`🗓 Your ${a} Brief — ${e.targetDate}`),n.push("");const s=e.calendar.totalCount;if(s>0){n.push(`📅 Tomorrow: ${s} event${s===1?"":"s"}`);for(const i of e.calendar.google.slice(0,5)){const o=i.startTime?new Date(i.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";n.push(`   • ${o} ${i.title}`)}}else n.push("📅 Tomorrow: Nothing scheduled");n.push("");const r=e.emails.gmail.unreadCount;if(r>0?(n.push(`📧 Gmail: ${r} unread`),e.emails.gmail.importantCount>0&&n.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&n.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&n.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):n.push("📧 Gmail: Inbox clear"),n.push(""),e.tasks.pending>0){n.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const i of e.tasks.items)n.push(`   ☐ ${i}`)}else n.push("✅ Tasks: All clear");if(n.push(""),e.news.items.length>0){n.push("📡 Today's Signal:");for(const i of e.news.items){const o=i.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${i.source}`;n.push(`   • ${i.title.substring(0,90)}${i.title.length>90?"…":""}`),n.push(`     ${o} — ${i.summary.substring(0,80)}${i.summary.length>80?"…":""}`)}}return n.join(`
`)}function Ur(e){const t=[];let n=0;for(const a of e.calendar.google)t.push({type:"calendar",key:a.id,text:`${a.title} - ${new Date(a.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:a},sortOrder:n++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:n++});for(const a of e.tasks.items)t.push({type:"task",key:`task-${a}`,text:a,metadata:{},sortOrder:n++});for(const a of e.news.items)t.push({type:"news",key:`news-${a.url}`,text:`📰 ${a.title}`,metadata:{url:a.url,source:a.source},sortOrder:n++});return t}async function Hr(e,t){const n=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!n)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let a;try{const r=JSON.parse(n.components);a={google_calendar:r.google_calendar!==!1,gmail:r.gmail!==!1,tasks:r.tasks!==!1,news:r.news!==!1}}catch{a={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const s=n.news_topics?n.news_topics.split(",").map(r=>r.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:a,newsTopics:s}}async function Fa(e,t,n){var E,R;const a=t.timezone||"Asia/Kolkata",s=Ar(a),{components:r,newsTopics:i}=await Hr(e,t.id),o=[],l=[];r.google_calendar&&(o.push(Lr(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET,s)),l.push("googleEvents")),r.gmail&&(o.push(Mr(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),r.tasks&&(o.push($r(e,t.id)),l.push("tasks")),r.news&&(o.push(jr(i,e,t.id)),l.push("news"));const d=await Promise.all(o),c={};l.forEach((N,M)=>{c[N]=d[M]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},w={generatedAt:new Date().toISOString(),targetDate:s.dateStr,calendar:{google:c.googleEvents||[],totalCount:((E=c.googleEvents)==null?void 0:E.length)||0},emails:{gmail:c.gmailSummary||m},tasks:c.tasks||h,news:{items:c.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((R=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:R.briefing_time)||"20:00";w.summary=Pr(w,f);const _=Ur(w),y=await e.prepare(`
  ...
  `).bind(t.id,JSON.stringify(w)).first(),S=(y==null?void 0:y.id)||0;for(const N of _)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(S,N.type,N.key,N.text,JSON.stringify(N.metadata),N.sortOrder).run();return{briefingId:S,content:w,items:_}}async function Fr(e,t,n){const a=await e.prepare(`
    SELECT * FROM briefings WHERE id = ? AND user_id = ?
  `).bind(n,t).first();if(!a)return null;const s=await e.prepare(`
    SELECT * FROM briefing_items WHERE briefing_id = ? ORDER BY sort_order ASC
  `).bind(n).all();return{briefing:{...a,content:JSON.parse(a.content_json||"{}")},items:s.results||[]}}async function Gr(e,t,n,a){if(!await e.prepare(`
    SELECT id FROM briefings WHERE id = ? AND user_id = ?
  `).bind(n,t).first())return null;const r=await e.prepare(`
    SELECT checked FROM briefing_items WHERE id = ? AND briefing_id = ?
  `).bind(a,n).first();if(!r)return null;const i=r.checked?0:1;return await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ? AND briefing_id = ?
  `).bind(i,i,a,n).run(),{checked:i===1}}async function Wr(e,t,n=10){return((await e.prepare(`
    SELECT b.*, 
    ...
    LIMIT ?
  `).bind(t,n).all()).results||[]).map(s=>({...s,content:JSON.parse(s.content_json||"{}")}))}function Ga(e,t,n=new Date){const a=new Date(n.toLocaleString("en-US",{timeZone:t})),s=a.getHours(),r=a.getMinutes(),[i,o]=e.split(":").map(Number),l=s*60+r,d=i*60+o;return l===d}function Wa(e,t){const n=e.summary,a=[];for(const s of t.slice(0,10))a.push([{text:`☐ ${s.text.substring(0,40)}${s.text.length>40?"...":""}`,callback_data:`briefing_toggle:${s.key}`}]);return{text:n,inlineKeyboard:a}}const oe=new pe;async function qr(e,t){var s;if(e.req.path.includes("/cron/"))return t();const n=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",n),await t()}oe.use("/*",qr);oe.get("/briefings",async e=>{const t=e.get("user"),n=parseInt(e.req.query("limit")||"10");try{const a=await Wr(e.env.DB,t.id,n);return e.json({briefings:a})}catch(a){return e.json({error:a.message},500)}});oe.get("/briefings/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));try{const a=await Fr(e.env.DB,t.id,n);return a?e.json(a):e.json({error:"Briefing not found"},404)}catch(a){return e.json({error:a.message},500)}});oe.post("/briefings/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),a=parseInt(e.req.param("itemId"));try{const s=await Gr(e.env.DB,t.id,n,a);return s?e.json(s):e.json({error:"Item not found"},404)}catch(s){return e.json({error:s.message},500)}});oe.post("/briefings/generate",async e=>{const t=e.get("user");try{const n=await Fa(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(n)}catch(n){return e.json({error:n.message},500)}});oe.get("/morning-briefing",async e=>{const t=e.get("user");try{const n=await Ka(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(n)}catch(n){return e.json({error:n.message},500)}});oe.get("/briefing-preferences",async e=>{const t=e.get("user");try{const n=await e.env.DB.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t.id).first();if(!n){const s={briefingTime:"20:00",briefingEnabled:!0,components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0,weather:!1},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"],notificationChannels:{telegram:!0,web:!0},proactiveLevel:"moderate"};return e.json({preferences:s})}const a={briefingTime:n.briefing_time,briefingEnabled:n.briefing_enabled!==0,components:JSON.parse(n.components),newsTopics:n.news_topics.split(",").map(s=>s.trim()).filter(Boolean),notificationChannels:JSON.parse(n.notification_channels),proactiveLevel:n.proactive_level};return e.json({preferences:a})}catch(n){return e.json({error:n.message},500)}});oe.post("/briefing-preferences",async e=>{const t=e.get("user"),n=await e.req.json(),a=[];if(n.briefingTime&&(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.test(n.briefingTime)||a.push("Invalid time format. Use HH:MM (e.g., 20:00)")),n.newsTopics&&(n.newsTopics.length>5&&a.push("Maximum 5 news topics allowed"),n.newsTopics.some(s=>s.length>50)&&a.push("Each news topic must be 50 characters or less")),n.proactiveLevel&&!["conservative","moderate","aggressive"].includes(n.proactiveLevel)&&a.push("Invalid proactive level. Use conservative, moderate, or aggressive"),a.length>0)return e.json({error:a.join("; ")},400);try{const s=await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first(),r=n.components?JSON.stringify(n.components):null,i=n.notificationChannels?JSON.stringify(n.notificationChannels):null,o=n.newsTopics?n.newsTopics.join(", "):null;if(s){const l=[],d=[];n.briefingTime!==void 0&&(l.push("briefing_time = ?"),d.push(n.briefingTime)),n.briefingEnabled!==void 0&&(l.push("briefing_enabled = ?"),d.push(n.briefingEnabled?1:0)),r!==null&&(l.push("components = ?"),d.push(r)),o!==null&&(l.push("news_topics = ?"),d.push(o)),i!==null&&(l.push("notification_channels = ?"),d.push(i)),n.proactiveLevel!==void 0&&(l.push("proactive_level = ?"),d.push(n.proactiveLevel)),l.length>0&&(l.push("updated_at = CURRENT_TIMESTAMP"),d.push(t.id),await e.env.DB.prepare(`UPDATE briefing_preferences SET ${l.join(", ")} WHERE user_id = ?`).bind(...d).run())}else await e.env.DB.prepare(`
        INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(t.id,n.briefingTime||"20:00",r||'{"google_calendar":true,"gmail":true,"tasks":true,"news":true}',o||"AI, LLM, Tools, Agentic Workflows, AI Features",i||'{"telegram":true,"web":true}',n.proactiveLevel||"moderate").run();return e.json({success:!0})}catch(s){return e.json({error:s.message},500)}});oe.post("/briefing-preferences/init-defaults",async e=>{const t=e.get("user");try{return await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first()?e.json({success:!0,message:"Preferences already exist"}):(await e.env.DB.prepare(`
      INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
...
🕐 ${R}${N}`;await fetch(`https://api.telegram.org/bot${S}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:M,parse_mode:"Markdown"})})}s.push({user_id:l.id,reminders_sent:_.length})}catch(d){s.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:s.length,results:s})}catch(a){return e.json({error:a.message},500)}});oe.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),s=[],r=new Date;for(const i of a.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(Ga(l,o,r))try{const d=await Ka(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let c={telegram:!0,web:!0};try{c=JSON.parse(i.notification_channels||"{}")}catch{}if(c.telegram!==!1&&i.telegram_chat_id&&d.briefingId){const m=Yr(d.content);await za(e.env.DB,i,m),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(d.briefingId).run()}s.push({user_id:i.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:o})}catch(d){s.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:s.length,results:s})}catch(a){return e.json({error:a.message},500)}});oe.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),s=[];for(const r of a.results||[]){let i={};try{i=JSON.parse(r.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Ya(e.env.DB,r,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,d=JSON.stringify(o,null,2),c=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'email_digest', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(r.id,l,d,`email_digest_${Date.now()}`,null,null,null).first();s.push({user_id:r.id,status:"success",action_item_id:c==null?void 0:c.id,digest:o})}catch(o){s.push({user_id:r.id,status:"error",error:o.message})}}return e.json({executed:s.length,results:s})}catch(a){return e.json({error:a.message},500)}});oe.post("/cron/weekly-review",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),s=[],r=new Date;for(const i of a.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(zr(l,o,r))try{const d=await Kr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),c=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,m=JSON.stringify(d,null,2),h=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,c,m,`weekly_review_${Date.now()}`,null,null,null).first();let w={telegram:!0,web:!0};try{w=JSON.parse(i.notification_channels||"{}")}catch{}if(w.telegram!==!1&&i.telegram_chat_id){const f=Jr(d);await za(e.env.DB,i,f)}s.push({user_id:i.id,status:"success",action_item_id:h==null?void 0:h.id})}catch(d){s.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:s.length,results:s})}catch(a){return e.json({error:a.message},500)}});async function qa(e,t,n,a,s){try{const r=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!r)return;const i=await Y(r.encrypted_value,r.pin_hash);if(!(await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n,parse_mode:"Markdown",reply_markup:{inline_keyboard:a.map(d=>d.map(c=>({...c,callback_data:`${c.callback_data}:${s}`})))}})})).json()).ok){const c=await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:a.map(m=>m.map(h=>({...h,callback_data:`${h.callback_data}:${s}`})))}})})).json();if(!c.ok){console.error("Telegram briefing send failed:",c.description,"chat_id:",t.telegram_chat_id);return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(s).run()}catch(r){console.error("Telegram briefing error:",r.message)}}async function za(e,t,n){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!a)return;const s=await Y(a.encrypted_value,a.pin_hash);(await fetch(`https://api.telegram.org/bot${s}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3),parse_mode:"Markdown"})})).ok||await fetch(`https://api.telegram.org/bot${s}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3).replace(/[_*[`\]]/g,"")})})}catch(a){console.error("Telegram plain text error:",a.message)}}async function Ka(e,t,n){const a=new Date;a.setHours(0,0,0,0);const s=new Date;s.setHours(23,59,59,999);const r=await e.prepare(`
    SELECT * FROM cron_jobs 
    WHERE user_id = ? AND enabled = 1 
    AND next_run >= ? AND next_run <= ?
    ORDER BY next_run ASC
  `).bind(t.id,a.toISOString(),s.toISOString()).all(),i=await e.prepare(`
    SELECT * FROM action_items 
    WHERE user_id = ? AND status = 'pending'
    ORDER BY priority DESC, created_at DESC
    LIMIT 10
  `).bind(t.id).all(),o=await Ya(e,t,n);let l=[];try{const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first();if(h){const w=await Y(h.encrypted_value,t.pin_hash),_=JSON.parse(w).access_token;if(_){const y=a.toISOString(),S=s.toISOString(),E=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(y)}&timeMax=${encodeURIComponent(S)}&maxResults=20`,{headers:{Authorization:`Bearer ${_}`}});E.ok&&(l=((await E.json()).items||[]).map(N=>{var M,W,H,$;return{title:N.summary||"Untitled",startTime:((M=N.start)==null?void 0:M.dateTime)||((W=N.start)==null?void 0:W.date),endTime:((H=N.end)==null?void 0:H.dateTime)||(($=N.end)==null?void 0:$.date)}}))}}}catch{}const d={generatedAt:new Date().toISOString(),type:"morning",todayReminders:(r.results||[]).map(h=>({name:h.name,description:h.description,next_run:h.next_run})),pendingActions:(i.results||[]).map(h=>({title:h.title,priority:h.priority})),emailDigest:o,calendarEvents:l},c=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'morning', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(d)).first();return{briefingId:(c==null?void 0:c.id)||0,content:d}}async function Ya(e,t,n){const a={unreadCount:0,recent:[]},s={message:"",recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const i=new ve(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET),o=await i.getUnreadCount(),l=await i.listMessages({maxResults:10,labelIds:["INBOX"]});a.unreadCount=o,a.recent=l.map(d=>({id:d.id,subject:d.subject,from:d.from,snippet:d.snippet,isUnread:d.isUnread}))}}catch(r){a.error=r.message}try{const r=await e.prepare("SELECT name, encrypted_blob FROM site_credentials WHERE user_id = ? AND (name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE) LIMIT 1").bind(t.id,"%Outlook%","%Microsoft%","%Office 365%").first();if(!r)s.message="No Outlook credentials saved in Secret Vault. Add them in Settings → Secret Vault.";else{const i=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t.id,"browser_use_api_key").first();if(!i)s.message="Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key.";else{const o=(await Y(i.encrypted_value,t.pin_hash)).trim(),l=JSON.parse(await Y(r.encrypted_blob,t.pin_hash)),d=await Ra("Go to https://outlook.live.com or https://outlook.office.com. Log in with username {username} and password {password} if prompted. Navigate to the inbox and extract the 10 most recent emails with sender, subject, date, and snippet. Return the results as structured text.",o,{secrets:{username:l.username,password:l.password},timeoutMs:88e3});d.status==="completed"&&d.output?s.recent=d.output:d.status==="timeout"?s.message="Outlook browser task timed out.":s.message="Outlook returned no content."}}}catch(r){s.message=`Outlook error: ${r.message}`}return{gmail:a,outlook:s}}function zr(e,t,n=new Date){const a=new Date(n.toLocaleString("en-US",{timeZone:t})),s=a.toLocaleDateString("en-US",{weekday:"long"}),r=a.getHours(),i=a.getMinutes(),o=e.trim().split(" "),l=o[o.length-1],d=o.slice(0,o.length-1).join(" "),[c,m]=l.split(":").map(Number),h=r*60+i,w=c*60+m;return s===d&&h===w}async function Kr(e,t,n){const a=new Date,s=new Date(a.getTime()-10080*60*1e3),r=new Date(a.getTime()+10080*60*1e3),i=await e.prepare(`
    SELECT * FROM cron_jobs 
...
`)}oe.post("/briefings/:id/resend",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));try{const a=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!a)return e.json({error:"Briefing not found"},404);const s=JSON.parse(a.content||"{}"),r=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(n).all(),{text:i,inlineKeyboard:o}=Wa(s,r.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(n).run(),await qa(e.env.DB,t,i,o,n);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(n).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(a){return e.json({error:a.message},500)}});oe.delete("/briefings/:id",async e=>{const t=e.get("user"),n=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});const Je=new pe;async function Vr(e,t){var s;const n=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     ...
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",n),await t()}_e.use("/*",Qr);_e.get("/",async e=>{const t=e.get("user"),[n,a,s,r,i,o,l,d,c,m,h,w,f]=await Promise.all([e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'pending'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'running'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'failed'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'completed'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'needs_approval'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ?").bind(t.id).first(),e.env.DB.prepare("SELECT type, COUNT(*) as cnt FROM action_items WHERE user_id = ? GROUP BY type").bind(t.id).all(),e.env.DB.prepare(`SELECT * FROM action_items WHERE user_id = ? AND (status IN ('pending', 'running', 'needs_approval') OR date(due_at) = date('now'))
       ...
       ORDER BY next_run ASC LIMIT 50`).bind(t.id).all(),e.env.DB.prepare(`SELECT id, name as title, description as body, 'reminder' as type, 'pending' as status, 'high' as priority, next_run as due_at,
              'cron' as source, CAST(id as TEXT) as source_id, schedule_type, schedule_value
       FROM cron_jobs WHERE user_id = ? AND enabled = 1 AND state IN ('active', 'reminding') AND next_run < datetime('now')
       ORDER BY next_run ASC LIMIT 50`).bind(t.id).all()]),_={};for(const R of l.results||[])_[R.type]=R.cnt;const y=[...w.results||[],...f.results||[]],E=[...d.results||[]];for(const R of y)E.some(M=>M.source==="cron"&&M.source_id===String(R.id))||E.push(R);return E.sort((R,N)=>{const M=R.due_at?new Date(R.due_at).getTime():1/0,W=N.due_at?new Date(N.due_at).getTime():1/0;return M-W}),e.json({counts:{pending:((n==null?void 0:n.cnt)||0)+y.length,running:(a==null?void 0:a.cnt)||0,failed:(s==null?void 0:s.cnt)||0,completed:(r==null?void 0:r.cnt)||0,needs_approval:(i==null?void 0:i.cnt)||0,total:((o==null?void 0:o.cnt)||0)+y.length},by_type:_,today:E.slice(0,50),pending:[...c.results||[],...y.filter(R=>R.next_run&&new Date(R.next_run)>=new Date)].slice(0,50),needs_approval:m.results||[],recent_activity:h.results||[],cron_jobs_count:y.length})});_e.get("/pending",async e=>{const t=e.get("user"),n=e.req.query("type"),a=parseInt(e.req.query("limit")||"50");let s="SELECT * FROM action_items WHERE user_id = ? AND status IN ('pending', 'needs_approval')";const r=[t.id];n&&(s+=" AND type = ?",r.push(n)),s+=" ORDER BY CASE priority WHEN 'urgent' THEN 1 WHEN 'high' THEN 2 WHEN 'normal' THEN 3 ELSE 4 END, due_at ASC LIMIT ?",r.push(a);const i=await e.env.DB.prepare(s).bind(...r).all();return e.json({items:i.results||[]})});_e.post("/:id/complete",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare(`UPDATE action_items SET status = 'completed', completed_at = CURRENT_TIMESTAMP, updated_at = CURRENT_TIMESTAMP
