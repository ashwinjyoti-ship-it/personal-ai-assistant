var ur=Object.defineProperty;var Ht=e=>{throw TypeError(e)};var mr=(e,t,a)=>t in e?ur(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var D=(e,t,a)=>mr(e,typeof t!="symbol"?t+"":t,a),_t=(e,t,a)=>t.has(e)||Ht("Cannot "+a);var b=(e,t,a)=>(_t(e,t,"read from private field"),a?a.call(e):t.get(e)),A=(e,t,a)=>t.has(e)?Ht("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),R=(e,t,a,r)=>(_t(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),$=(e,t,a)=>(_t(e,t,"access private method"),a);var Gt=(e,t,a,r)=>({set _(n){R(e,t,n,a)},get _(){return b(e,t,r)}});var Ft=(e,t,a)=>(r,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],r.req.routeIndex=o):d=o===e.length&&n||void 0,d)try{l=await d(r,()=>i(o+1))}catch(m){if(m instanceof Error&&t)r.error=m,l=await t(m,r),c=!0;else throw m}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},pr=Symbol(),hr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ha?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?gr(e,{all:a,dot:r}):{}};async function gr(e,t){const a=await e.formData();return a?fr(a,t):{}}function fr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?yr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(vr(a,r,n),delete a[r])}),a}var yr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},vr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},ca=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},br=e=>{const{groups:t,path:a}=wr(e),r=ca(a);return _r(r,t)},wr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},_r=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},ct={},Er=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return ct[r]||(a[2]?ct[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ct[r]=[e,a[1],!0]),ct[r]}return null},At=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Tr=e=>At(e,decodeURI),da=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),i=t.indexOf("#",r),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return Tr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},xr=e=>{const t=da(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ae=(e,t,...a)=>(a.length&&(t=Ae(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ua=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,i)=>i.indexOf(n)===s)},Et=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?At(e,pa):e):e,ma=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return Et(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(r&&(l=Et(l)),s=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),r&&(c=Et(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},Sr=ma,kr=(e,t)=>ma(e,t,!0),pa=decodeURIComponent,Wt=e=>At(e,pa),je,X,he,ga,fa,Ot,fe,ra,ha=(ra=class{constructor(e,t="/",a=[[]]){A(this,he);D(this,"raw");A(this,je);A(this,X);D(this,"routeIndex",0);D(this,"path");D(this,"bodyCache",{});A(this,fe,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,R(this,X,a),R(this,je,{})}param(e){return e?$(this,he,ga).call(this,e):$(this,he,fa).call(this)}query(e){return Sr(this.url,e)}queries(e){return kr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await hr(this,e))}json(){return b(this,fe).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,fe).call(this,"text")}arrayBuffer(){return b(this,fe).call(this,"arrayBuffer")}blob(){return b(this,fe).call(this,"blob")}formData(){return b(this,fe).call(this,"formData")}addValidatedData(e,t){b(this,je)[e]=t}valid(e){return b(this,je)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[pr](){return b(this,X)}get matchedRoutes(){return b(this,X)[0].map(([[,e]])=>e)}get routePath(){return b(this,X)[0].map(([[,e]])=>e)[this.routeIndex].path}},je=new WeakMap,X=new WeakMap,he=new WeakSet,ga=function(e){const t=b(this,X)[0][this.routeIndex][1][e],a=$(this,he,Ot).call(this,t);return a&&/\%/.test(a)?Wt(a):a},fa=function(){const e={},t=Object.keys(b(this,X)[0][this.routeIndex][1]);for(const a of t){const r=$(this,he,Ot).call(this,b(this,X)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Wt(r):r)}return e},Ot=function(e){return b(this,X)[1]?b(this,X)[1][e]:e},fe=new WeakMap,ra),Ir={Stringify:1},ya=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>ya(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},Or="text/plain; charset=UTF-8",Tt=(e,t)=>({"Content-Type":e,...t}),Qe,et,de,Be,ue,V,tt,Pe,Ue,ke,at,rt,ye,Me,na,Dr=(na=class{constructor(e,t){A(this,ye);A(this,Qe);A(this,et);D(this,"env",{});A(this,de);D(this,"finalized",!1);D(this,"error");A(this,Be);A(this,ue);A(this,V);A(this,tt);A(this,Pe);A(this,Ue);A(this,ke);A(this,at);A(this,rt);D(this,"render",(...e)=>(b(this,Pe)??R(this,Pe,t=>this.html(t)),b(this,Pe).call(this,...e)));D(this,"setLayout",e=>R(this,tt,e));D(this,"getLayout",()=>b(this,tt));D(this,"setRenderer",e=>{R(this,Pe,e)});D(this,"header",(e,t,a)=>{this.finalized&&R(this,V,new Response(b(this,V).body,b(this,V)));const r=b(this,V)?b(this,V).headers:b(this,ke)??R(this,ke,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});D(this,"status",e=>{R(this,Be,e)});D(this,"set",(e,t)=>{b(this,de)??R(this,de,new Map),b(this,de).set(e,t)});D(this,"get",e=>b(this,de)?b(this,de).get(e):void 0);D(this,"newResponse",(...e)=>$(this,ye,Me).call(this,...e));D(this,"body",(e,t,a)=>$(this,ye,Me).call(this,e,t,a));D(this,"text",(e,t,a)=>!b(this,ke)&&!b(this,Be)&&!t&&!a&&!this.finalized?new Response(e):$(this,ye,Me).call(this,e,t,Tt(Or,a)));D(this,"json",(e,t,a)=>$(this,ye,Me).call(this,JSON.stringify(e),t,Tt("application/json",a)));D(this,"html",(e,t,a)=>{const r=n=>$(this,ye,Me).call(this,n,t,Tt("text/html; charset=UTF-8",a));return typeof e=="object"?ya(e,Ir.Stringify,!1,{}).then(r):r(e)});D(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});D(this,"notFound",()=>(b(this,Ue)??R(this,Ue,()=>new Response),b(this,Ue).call(this,this)));R(this,Qe,e),t&&(R(this,ue,t.executionCtx),this.env=t.env,R(this,Ue,t.notFoundHandler),R(this,rt,t.path),R(this,at,t.matchResult))}get req(){return b(this,et)??R(this,et,new ha(b(this,Qe),b(this,rt),b(this,at))),b(this,et)}get event(){if(b(this,ue)&&"respondWith"in b(this,ue))return b(this,ue);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ue))return b(this,ue);throw Error("This context has no ExecutionContext")}get res(){return b(this,V)||R(this,V,new Response(null,{headers:b(this,ke)??R(this,ke,new Headers)}))}set res(e){if(b(this,V)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,V).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,V).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}R(this,V,e),this.finalized=!0}get var(){return b(this,de)?Object.fromEntries(b(this,de)):{}}},Qe=new WeakMap,et=new WeakMap,de=new WeakMap,Be=new WeakMap,ue=new WeakMap,V=new WeakMap,tt=new WeakMap,Pe=new WeakMap,Ue=new WeakMap,ke=new WeakMap,at=new WeakMap,rt=new WeakMap,ye=new WeakSet,Me=function(e,t,a){const r=b(this,V)?new Headers(b(this,V).headers):b(this,ke)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")r.set(s,i);else{r.delete(s);for(const o of i)r.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Be);return new Response(e,{status:n,headers:r})},na),q="ALL",Cr="all",Rr=["get","post","put","delete","options","patch"],va="Can not add a route since the matcher is already built.",ba=class extends Error{},Nr="__COMPOSED_HANDLER",Lr=e=>e.text("404 Not Found",404),qt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,z,wa,ee,xe,mt,pt,He,Ar=(He=class{constructor(t={}){A(this,z);D(this,"get");D(this,"post");D(this,"put");D(this,"delete");D(this,"options");D(this,"patch");D(this,"all");D(this,"on");D(this,"use");D(this,"router");D(this,"getPath");D(this,"_basePath","/");A(this,Q,"/");D(this,"routes",[]);A(this,ee,Lr);D(this,"errorHandler",qt);D(this,"onError",t=>(this.errorHandler=t,this));D(this,"notFound",t=>(R(this,ee,t),this));D(this,"fetch",(t,...a)=>$(this,z,pt).call(this,t,a[1],a[0],t.method));D(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ae("/",t)}`,a),r,n)));D(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith($(this,z,pt).call(this,t.request,t,void 0,t.request.method))})});[...Rr,Cr].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?R(this,Q,i):$(this,z,xe).call(this,s,b(this,Q),i),o.forEach(l=>{$(this,z,xe).call(this,s,b(this,Q),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){R(this,Q,l);for(const c of[s].flat())o.map(d=>{$(this,z,xe).call(this,c.toUpperCase(),b(this,Q),d)})}return this},this.use=(s,...i)=>(typeof s=="string"?R(this,Q,s):(R(this,Q,"*"),i.unshift(s)),i.forEach(o=>{$(this,z,xe).call(this,q,b(this,Q),o)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??da:xr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let s;a.errorHandler===qt?s=n.handler:(s=async(o,l)=>(await Ft([],a.errorHandler)(o,()=>n.handler(o,l))).res,s[Nr]=n.handler),$(i=r,z,xe).call(i,n.method,n.path,s)}),this}basePath(t){const a=$(this,z,wa).call(this);return a._basePath=Ae(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ae(this._basePath,t),c=l==="/"?0:l.length;return d=>{const m=new URL(d.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,d)}})());const o=async(l,c)=>{const d=await a(n(l.req.raw),...i(l));if(d)return d;await c()};return $(this,z,xe).call(this,q,Ae(t,"*"),o),this}},Q=new WeakMap,z=new WeakSet,wa=function(){const t=new He({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,R(t,ee,b(this,ee)),t.routes=this.routes,t},ee=new WeakMap,xe=function(t,a,r){t=t.toUpperCase(),a=Ae(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},mt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},pt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await $(this,z,pt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),i=this.router.match(n,s),o=new Dr(t,{path:s,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,ee)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await b(this,ee).call(this,o)})}catch(d){return $(this,z,mt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:b(this,ee).call(this,o))).catch(d=>$(this,z,mt).call(this,d,o)):c??b(this,ee).call(this,o)}const l=Ft(i[0],this.errorHandler,b(this,ee));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return $(this,z,mt).call(this,c,o)}})()},He),_a=[];function Mr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const i=a[n]||a[q],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],_a];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=r,r(e,t)}var gt="[^/]+",Je=".*",Ve="(?:|/.*)",$e=Symbol(),$r=new Set(".\\+*[^]$()");function jr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Je||e===Ve?1:t===Je||t===Ve?-1:e===gt?1:t===gt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ie,Oe,te,Re,Br=(Re=class{constructor(){A(this,Ie);A(this,Oe);A(this,te,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Ie)!==void 0)throw $e;if(s)return;R(this,Ie,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Je]:["","",gt]:i==="/*"?["","",Ve]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let m=l[2]||gt;if(d&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw $e;if(c=b(this,te)[m],!c){if(Object.keys(b(this,te)).some(g=>g!==Je&&g!==Ve))throw $e;if(s)return;c=b(this,te)[m]=new Re,d!==""&&R(c,Oe,n.varIndex++)}!s&&d!==""&&r.push([d,b(c,Oe)])}else if(c=b(this,te)[i],!c){if(Object.keys(b(this,te)).some(d=>d.length>1&&d!==Je&&d!==Ve))throw $e;if(s)return;c=b(this,te)[i]=new Re}c.insert(o,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,te)).sort(jr).map(r=>{const n=b(this,te)[r];return(typeof b(n,Oe)=="number"?`(${r})@${b(n,Oe)}`:$r.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Ie)=="number"&&a.unshift(`#${b(this,Ie)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Ie=new WeakMap,Oe=new WeakMap,te=new WeakMap,Re),yt,nt,sa,Pr=(sa=class{constructor(){A(this,yt,{varIndex:0});A(this,nt,new Br)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,o=!0,c}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return b(this,nt).insert(s,t,r,b(this,yt),a),r}buildRegExp(){let e=b(this,nt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},yt=new WeakMap,nt=new WeakMap,sa),Ur=[/^$/,[],Object.create(null)],ht=Object.create(null);function Ea(e){return ht[e]??(ht[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Hr(){ht=Object.create(null)}function Gr(e){var c;const t=new Pr,a=[];if(e.length===0)return Ur;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,m],[g,v])=>d?1:g?-1:m.length-v.length),n=Object.create(null);for(let d=0,m=-1,g=r.length;d<g;d++){const[v,y,T]=r[d];v?n[y]=[T.map(([E])=>[E,Object.create(null)]),_a]:m++;let _;try{_=t.insert(y,m,v)}catch(E){throw E===$e?new ba(y):E}v||(a[m]=T.map(([E,u])=>{const h=Object.create(null);for(u-=1;u>=0;u--){const[p,f]=_[u];h[p]=f}return[E,h]}))}const[s,i,o]=t.buildRegExp();for(let d=0,m=a.length;d<m;d++)for(let g=0,v=a[d].length;g<v;g++){const y=(c=a[d][g])==null?void 0:c[1];if(!y)continue;const T=Object.keys(y);for(let _=0,E=T.length;_<E;_++)y[T[_]]=o[y[T[_]]]}const l=[];for(const d in i)l[d]=a[i[d]];return[s,l,n]}function Ne(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(Ea(a).test(t))return[...e[a]]}}var ve,be,vt,Ta,ia,Fr=(ia=class{constructor(){A(this,vt);D(this,"name","RegExpRouter");A(this,ve);A(this,be);D(this,"match",Mr);R(this,ve,{[q]:Object.create(null)}),R(this,be,{[q]:Object.create(null)})}add(e,t,a){var o;const r=b(this,ve),n=b(this,be);if(!r||!n)throw new Error(va);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[q]).forEach(c=>{l[e][c]=[...l[q][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Ea(t);e===q?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=Ne(r[c],t)||Ne(r[q],t)||[])}):(o=r[e])[t]||(o[t]=Ne(r[e],t)||Ne(r[q],t)||[]),Object.keys(r).forEach(c=>{(e===q||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,s])})}),Object.keys(n).forEach(c=>{(e===q||e===c)&&Object.keys(n[c]).forEach(d=>l.test(d)&&n[c][d].push([a,s]))});return}const i=ua(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(n).forEach(m=>{var g;(e===q||e===m)&&((g=n[m])[d]||(g[d]=[...Ne(r[m],d)||Ne(r[q],d)||[]]),n[m][d].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,be)).concat(Object.keys(b(this,ve))).forEach(t=>{e[t]||(e[t]=$(this,vt,Ta).call(this,t))}),R(this,ve,R(this,be,void 0)),Hr(),e}},ve=new WeakMap,be=new WeakMap,vt=new WeakSet,Ta=function(e){const t=[];let a=e===q;return[b(this,ve),b(this,be)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==q&&t.push(...Object.keys(r[q]).map(s=>[s,r[q][s]]))}),a?Gr(t):null},ia),we,me,oa,Wr=(oa=class{constructor(e){D(this,"name","SmartRouter");A(this,we,[]);A(this,me,[]);R(this,we,e.routers)}add(e,t,a){if(!b(this,me))throw new Error(va);b(this,me).push([e,t,a])}match(e,t){if(!b(this,me))throw new Error("Fatal error");const a=b(this,we),r=b(this,me),n=a.length;let s=0,i;for(;s<n;s++){const o=a[s];try{for(let l=0,c=r.length;l<c;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof ba)continue;throw l}this.match=o.match.bind(o),R(this,we,[o]),R(this,me,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,me)||b(this,we).length!==1)throw new Error("No active router has been determined yet.");return b(this,we)[0]}},we=new WeakMap,me=new WeakMap,oa),qe=Object.create(null),_e,J,De,Ge,Y,pe,Se,Fe,qr=(Fe=class{constructor(t,a,r){A(this,pe);A(this,_e);A(this,J);A(this,De);A(this,Ge,0);A(this,Y,qe);if(R(this,J,r||Object.create(null)),R(this,_e,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},R(this,_e,[n])}R(this,De,[])}insert(t,a,r){R(this,Ge,++Gt(this,Ge)._);let n=this;const s=br(a),i=[];for(let o=0,l=s.length;o<l;o++){const c=s[o],d=s[o+1],m=Er(c,d),g=Array.isArray(m)?m[0]:c;if(g in b(n,J)){n=b(n,J)[g],m&&i.push(m[1]);continue}b(n,J)[g]=new Fe,m&&(b(n,De).push(m),i.push(m[1])),n=b(n,J)[g]}return b(n,_e).push({[t]:{handler:r,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:b(this,Ge)}}),n}search(t,a){var l;const r=[];R(this,Y,qe);let s=[this];const i=ca(a),o=[];for(let c=0,d=i.length;c<d;c++){const m=i[c],g=c===d-1,v=[];for(let y=0,T=s.length;y<T;y++){const _=s[y],E=b(_,J)[m];E&&(R(E,Y,b(_,Y)),g?(b(E,J)["*"]&&r.push(...$(this,pe,Se).call(this,b(E,J)["*"],t,b(_,Y))),r.push(...$(this,pe,Se).call(this,E,t,b(_,Y)))):v.push(E));for(let u=0,h=b(_,De).length;u<h;u++){const p=b(_,De)[u],f=b(_,Y)===qe?{}:{...b(_,Y)};if(p==="*"){const O=b(_,J)["*"];O&&(r.push(...$(this,pe,Se).call(this,O,t,b(_,Y))),R(O,Y,f),v.push(O));continue}const[w,x,S]=p;if(!m&&!(S instanceof RegExp))continue;const I=b(_,J)[w],k=i.slice(c).join("/");if(S instanceof RegExp){const O=S.exec(k);if(O){if(f[x]=O[0],r.push(...$(this,pe,Se).call(this,I,t,b(_,Y),f)),Object.keys(b(I,J)).length){R(I,Y,f);const C=((l=O[0].match(/\//))==null?void 0:l.length)??0;(o[C]||(o[C]=[])).push(I)}continue}}(S===!0||S.test(m))&&(f[x]=m,g?(r.push(...$(this,pe,Se).call(this,I,t,f,b(_,Y))),b(I,J)["*"]&&r.push(...$(this,pe,Se).call(this,b(I,J)["*"],t,f,b(_,Y)))):(R(I,Y,f),v.push(I)))}}s=v.concat(o.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},_e=new WeakMap,J=new WeakMap,De=new WeakMap,Ge=new WeakMap,Y=new WeakMap,pe=new WeakSet,Se=function(t,a,r,n){const s=[];for(let i=0,o=b(t,_e).length;i<o;i++){const l=b(t,_e)[i],c=l[a]||l[q],d={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==qe||n&&n!==qe))for(let m=0,g=c.possibleKeys.length;m<g;m++){const v=c.possibleKeys[m],y=d[c.score];c.params[v]=n!=null&&n[v]&&!y?n[v]:r[v]??(n==null?void 0:n[v]),d[c.score]=!0}}return s},Fe),Ce,la,zr=(la=class{constructor(){D(this,"name","TrieRouter");A(this,Ce);R(this,Ce,new qr)}add(e,t,a){const r=ua(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ce).insert(e,r[n],a);return}b(this,Ce).insert(e,t,a)}match(e,t){return b(this,Ce).search(e,t)}},Ce=new WeakMap,la),Ee=class extends Ar{constructor(e={}){super(e),this.router=e.router??new Wr({routers:[new Fr,new zr]})}},Kr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var d;function l(m,g){i.res.headers.set(m,g)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await n(i.req.header("origin")||"",i);m.length&&l("Access-Control-Allow-Methods",m.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function xa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>Ia),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const g=await c(m.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${g}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function zt(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Da{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){D(this,"name");D(this,"apiKey");D(this,"model");D(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var d,m,g,v;const r=t.find(y=>y.role==="system"),n=t.filter(y=>y.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(y=>({role:y.role,content:y.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(y=>({name:y.name,description:y.description,input_schema:y.parameters})));const i=await Oa(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)}),this.name);if(!i.ok){const y=await i.text();throw new Error(this.name+" API error "+i.status+": "+y)}const o=await i.json(),l=((d=o.content)==null?void 0:d.filter(y=>y.type==="text"))||[],c=((m=o.content)==null?void 0:m.filter(y=>y.type==="tool_use"))||[];return{content:l.map(y=>y.text).join(`
`),toolCalls:c.map(y=>({id:y.id,name:y.name,arguments:y.input})),usage:{promptTokens:((g=o.usage)==null?void 0:g.input_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(c=>c.role==="system"),n=t.filter(c=>c.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(c=>({role:c.role,content:c.content}))};r&&(s.system=r.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const c=await i.text();throw new Error(this.name+" stream error "+i.status+": "+c)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var y;const{done:d,value:m}=await o.read();if(d){c.close();return}const v=l.decode(m,{stream:!0}).split(`
`);for(const T of v)if(T.startsWith("data: ")){const _=T.slice(6);if(_==="[DONE]")continue;try{const E=JSON.parse(_);E.type==="content_block_delta"&&((y=E.delta)!=null&&y.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Vr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,i]of Object.entries(r))i&&typeof i=="object"?n[s]=Dt(i):n[s]=i;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Dt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=Dt(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Dt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ca{constructor(t,a,r,n){D(this,"name");D(this,"apiKey");D(this,"model");D(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var l,c,d,m,g,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(y=>({role:y.role,content:y.content}))},n=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&n)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(y=>({type:"function",function:{name:y.name,description:y.description,parameters:Vr(y.parameters||{})}})));const s=await Oa(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)}),this.name);if(!s.ok){const y=await s.text();throw new Error(this.name+" API error "+s.status+": "+y)}const i=await s.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((c=o==null?void 0:o.message)==null?void 0:c.content)||"",toolCalls:(m=(d=o==null?void 0:o.message)==null?void 0:d.tool_calls)==null?void 0:m.map(y=>({id:y.id,name:y.function.name,arguments:(()=>{try{return typeof y.function.arguments=="string"?JSON.parse(y.function.arguments||"{}"):y.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((g=i.usage)==null?void 0:g.prompt_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const o=await n.text();throw new Error(this.name+" stream error "+n.status+": "+o)}const s=n.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var g,v,y;const{done:l,value:c}=await s.read();if(l){o.close();return}const m=i.decode(c,{stream:!0}).split(`
`);for(const T of m)if(T.startsWith("data: ")){const _=T.slice(6);if(_==="[DONE]")continue;try{const u=(y=(v=(g=JSON.parse(_).choices)==null?void 0:g[0])==null?void 0:v.delta)==null?void 0:y.content;u&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:u})+`

`))}catch{}}}})}}function Ct(e,t,a,r){const n=Ze[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new Da(t,s,n.apiBase,a):new Ca(t,s,n.apiBase,a)}class Ra{constructor(){D(this,"errorLog",new Map);D(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const Zr=["llm_slot_1","llm_slot_2","llm_slot_3"],Xr=["anthropic","openai"];async function st(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Ia),n=new Ra,s=[];for(const m of Zr){const g=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(g)try{const v=await r(g.encrypted_value,a),y=JSON.parse(v);if(y.provider&&y.apiKey&&Ze[y.provider]){const _=y.provider,E=Ct(y.provider,y.apiKey,_,y.model);s.push({name:_,provider:E})}}catch(v){console.error(`Failed to load ${m}:`,v)}}const i=new Set(s.map(m=>m.name));for(const m of Xr){if(i.has(m))continue;const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(g)try{const v=await r(g.encrypted_value,a);if(Ze[m]){const T=Ct(m,v,m);s.push({name:m,provider:T})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=s.map(m=>m.name),l=await n.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const c=s.find(m=>m.name===l);return{provider:Qr(c.provider,s,n,e,t),rotation:n}}function Qr(e,t,a,r,n){const s=i=>i.includes("401")||i.includes("403")||i.includes("authentication")||i.includes("credit balance")||i.includes("invalid")&&i.includes("key")||i.includes("properties field not found")||i.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(i,o){try{return await e.chat(i,o)}catch(l){const c=l.message||"";throw s(c)&&!c.includes("TOOLS_UNSUPPORTED")&&xt(r,n,"all_providers_down",e.name,null,c),l}},async streamChat(i,o){return await e.streamChat(i,o)}}:{name:e.name,async chat(i,o){try{return await e.chat(i,o)}catch(l){const c=l.message||"";if(!s(c))throw l;const d=c.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${d?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,d?1:1440);const m=t.filter(g=>g.name!==e.name);for(const g of m)try{const v=await g.provider.chat(i,o);return this.name=g.name,d||xt(r,n,"provider_switched",e.name,g.name,c),v}catch(v){const y=v.message||"";if(s(y)){await a.recordError(g.name,y,1440);continue}throw v}throw xt(r,n,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(i,o){return await e.streamChat(i,o)}}}const Rt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Da,OpenAICompatibleProvider:Ca,ProviderRotation:Ra,createProviderFromConfig:Ct,createRotatingProvider:st,logError:M},Symbol.toStringTag,{value:"Module"})),St=20,en=2e3,tn=2e3,Na=4;function an(e){return Math.ceil(e.length/Na)}function Kt(e,t){const a=t*Na;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class ae{constructor(t){this.db=t}async store(t,a,r,n,s=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>St){const r=((a==null?void 0:a.cnt)||0)-St;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
...
`),t.trim()}async function Za(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await wt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,r).map(async g=>{const v=await Va(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),c=(await Promise.all(o)).filter(g=>g.content.length>50);if(c.length===0){const g=s.results.map((y,T)=>`[${T+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Jt(e,g,t,"snippets"),sources:s.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const d=c.map((g,v)=>`--- SOURCE ${v+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Jt(e,d,t,"full"),sources:c.map(g=>({title:g.title,url:g.url})),pagesRead:c.length}}async function Jt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I'll now..." — just call the tool.`:""}`}async function Zt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function ar(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function ft(e,t,a,r,n,s,i,o,l,c,d,m){const g=Date.now();let v=!0,y="",T="";try{return T=await wn(e,t,a,r,s,i,o,l,c,d,m),T}catch(_){throw v=!1,y=_.message||"Unknown error",_}finally{const _=Date.now()-g;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?T:"").substring(0,500),v?1:0,y||null,_,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function wn(e,t,a,r,n,s,i,o,l,c,d){var g,v,y,T,_,E;const m=new ae(a);switch(e){case"create_schedule":{const u=new Date;let h;const p=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){h=new Date(u.getTime()+t.minutes_from_now*60*1e3);const S=h.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[I,k,O]=(S[0]||"").split("/");t.schedule_value=`${O}-${I}-${k} ${S[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const x=parseInt(t.schedule_value,10);h=new Date(u.getTime()+x*60*1e3)}else if(t.schedule_type==="daily"){const[x,S]=t.schedule_value.split(":").map(Number),I=u.toLocaleString("en-US",{timeZone:p}),k=new Date(I),O=new Date(k);O.setHours(x,S,0,0),O<=k&&O.setDate(O.getDate()+1);const C=new Date(O.toLocaleString("en-US",{timeZone:"UTC"})),N=new Date(O.toLocaleString("en-US",{timeZone:p})),L=C.getTime()-N.getTime();h=new Date(O.getTime()+L)}else if(t.schedule_type==="weekly"){const[x,S]=t.schedule_value.split(" "),[I,k]=(S||"00:00").split(":").map(Number),C=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ne=>ne.toLowerCase()===x.toLowerCase()),N=u.toLocaleString("en-US",{timeZone:p}),L=new Date(N),j=new Date(L);j.setHours(I,k,0,0);let B=(C-j.getDay()+7)%7;B===0&&j<=L&&(B=7),j.setDate(j.getDate()+B);const K=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),U=new Date(j.toLocaleString("en-US",{timeZone:p})),W=K.getTime()-U.getTime();h=new Date(j.getTime()+W)}else if(t.schedule_type==="once"){const[x,S]=t.schedule_value.split(" "),[I,k,O]=x.split("-").map(Number),[C,N]=(S||"00:00").split(":").map(Number),L=u.toLocaleString("en-US",{timeZone:p}),j=new Date(L),B=new Date(j);B.setFullYear(I,k-1,O),B.setHours(C,N,0,0);const K=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),U=new Date(B.toLocaleString("en-US",{timeZone:p})),W=K.getTime()-U.getTime();h=new Date(B.getTime()+W);const ne=new Date(u.getTime()+120*1e3);if(h.getTime()<u.getTime()+60*1e3){const oe=h.toISOString();h=ne;const ot=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${oe} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${h.toISOString()}.]`;t._pastTimeWarning=ot}}else h=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),h.toISOString()).run();const f=t._pastTimeWarning||"",w=h.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${w} (${p}). [UTC: ${h.toISOString()}]${f}. IMPORTANT: Use the exact time "${w}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const h=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return h.length===0?"No scheduled tasks found.":h.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,h=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,h,t.job_id,r).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],h=t.state;if(!u.includes(h))return`Invalid state "${h}". Valid states: ${u.join(", ")}`;const p=h==="completed"||h==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(h,p,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${h}".`}case"update_schedule":{const u=t.job_id,h=c||"UTC",p=new Date,f=["updated_at = CURRENT_TIMESTAMP"],w=[];t.name&&(f.push("name = ?"),w.push(t.name)),t.description&&(f.push("description = ?"),w.push(t.description));let x=null,S=t.schedule_type,I=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){x=new Date(p.getTime()+t.minutes_from_now*60*1e3);const C=x.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,L,j]=(C[0]||"").split("/");I=`${j}-${N}-${L} ${C[1]||"00:00"}`,S="once"}else if(S&&I){if(S==="interval")x=new Date(p.getTime()+parseInt(I,10)*60*1e3);else if(S==="daily"){const[O,C]=I.split(":").map(Number),N=new Date(p.toLocaleString("en-US",{timeZone:h})),L=new Date(N);L.setHours(O,C,0,0),L<=N&&L.setDate(L.getDate()+1);const j=new Date(L.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(L.toLocaleString("en-US",{timeZone:h})).getTime();x=new Date(L.getTime()+j)}else if(S==="weekly"){const[O,C]=I.split(" "),[N,L]=(C||"00:00").split(":").map(Number),B=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(oe=>oe.toLowerCase()===O.toLowerCase()),K=new Date(p.toLocaleString("en-US",{timeZone:h})),U=new Date(K);U.setHours(N,L,0,0);let W=(B-U.getDay()+7)%7;W===0&&U<=K&&(W=7),U.setDate(U.getDate()+W);const ne=new Date(U.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(U.toLocaleString("en-US",{timeZone:h})).getTime();x=new Date(U.getTime()+ne)}else if(S==="once"){const[O,C]=I.split(" "),[N,L,j]=O.split("-").map(Number),[B,K]=(C||"00:00").split(":").map(Number),U=new Date(p.toLocaleString("en-US",{timeZone:h})),W=new Date(U);W.setFullYear(N,L-1,j),W.setHours(B,K,0,0);const ne=new Date(W.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(W.toLocaleString("en-US",{timeZone:h})).getTime();x=new Date(W.getTime()+ne),x.getTime()<p.getTime()+60*1e3&&(x=new Date(p.getTime()+120*1e3))}}if(S&&(f.push("schedule_type = ?"),w.push(S)),I&&(f.push("schedule_value = ?"),w.push(I)),x&&(f.push("next_run = ?"),w.push(x.toISOString())),f.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";w.push(u,r),await a.prepare(`UPDATE cron_jobs SET ${f.join(", ")} WHERE id = ? AND user_id = ?`).bind(...w).run();const k=x?x.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${k?` New fire time: ${k} (${h}).`:""} IMPORTANT: Use this exact time "${k}" when confirming to the user.`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,h=t.type==="task"?"preference":t.type,p=u>=7?"working":"long_term";return await m.store(r,h,t.title,t.content,u,p),`Stored in ${p==="working"?"working":"long-term"} memory: [${h}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await m.search(r,t.query);return u.length===0?"No matching memories found.":u.map(h=>`[${h.tier||"long_term"}] [${h.type}] **${h.title}**: ${h.content}`).join(`
`)}case"get_system_status":{const u=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),f=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),w=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.spreadsheet_id;let p=t.range;const f=await u.sheets.getMetadata(h),w=f.sheets;p.includes("!")||(p=`${w[0]}!${p}`);let x;try{x=await u.sheets.readRange(h,p)}catch(I){if((g=I.message)!=null&&g.includes("Unable to parse range")||(v=I.message)!=null&&v.includes("400")){const k=p.includes("!")?p.split("!")[1]:p;p=`${w[0]}!${k}`,x=await u.sheets.readRange(h,p)}else throw I}let S=`[Spreadsheet: "${f.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${w.map(I=>`"${I}"`).join(", ")}]
`;return w.length>1&&(S+=`[To read a different tab, call read_sheet again with range like "${w[1]}!A1:Z500"]
`),x.length===0?S+"No data found in the specified range.":S+x.map(I=>I.join("	| ")).join(`
`)}catch(u){return await M(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.values;let p=t.range;const x=Math.max(...h.map(O=>O.length))+4,S=h.map(O=>{const C=[...O];for(;C.length<x;)C.push("");return C}),I=p.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(I){const O=I[1]||"",C=I[2],N=I[3],L=I[5],B=C.toUpperCase().charCodeAt(0)-64+x-1,K=B<=26?String.fromCharCode(64+B):"Z";p=`${O}${C}${N}:${K}${L}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,p,S)).updatedCells} cells to ${p}.`}catch(u){return await M(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new se(a,r,n,s||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await M(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let f="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||"");f=`
Folder: "${(await Zt(w,p.spreadsheetId,t.folder_name)).folderName}"`}catch(w){f=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ae(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${f}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(u){return await M(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.calendar_id||"primary",p=t.days_ahead||7,f=new Date,w=new Date(f.getTime()+p*24*60*60*1e3),x=await u.calendar.listEvents(h,{timeMin:f.toISOString(),timeMax:w.toISOString(),query:t.query});return x.length===0?`No events found in the next ${p} days.`:x.map(S=>{var N;const I=S.start.dateTime||S.start.date||"TBD",k=S.end.dateTime||S.end.date||"",O=S.location?` 📍 ${S.location}`:"",C=((N=S.attendees)==null?void 0:N.map(L=>L.email).join(", "))||"";return`• ${S.summary} — ${I} to ${k}${O}${C?`
  Attendees: ${C}`:""}`}).join(`
`)}catch(u){return await M(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.calendar_id||"primary",p=await u.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(u){return await M(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(p.documentId,t.content);let f="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||"");f=`
Folder: "${(await Zt(w,p.documentId,t.folder_name)).folderName}"`}catch(w){f=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ae(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${f}
ID: ${p.documentId}
URL: ${p.url}`}catch(u){return await M(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const h=await new se(a,r,n,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${h.title}"

${h.content}`}catch(u){return await M(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await M(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((p,f)=>`${p.isUnread?"● ":"  "}${f+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await M(a,r,"gmail","list",u.message),(y=u.message)!=null&&y.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const u=new ce(a,r,n,s||"",i||""),h=await u.getMessage(t.message_id);if(!h)return"Message not found.";const p=await u.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${p}`}catch(u){return await M(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((p,f)=>`${p.isUnread?"● ":"  "}${f+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await M(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(u){return await M(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),p=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${p}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(u){return await M(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ce(a,r,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await M(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(u){return(T=u.message)!=null&&T.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",h.set("q",p);const f=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const w=await f.json();return(_=w.files)!=null&&_.length?w.files.map((x,S)=>{var C,N;const I=((C=x.mimeType)==null?void 0:C.split(".").pop())||x.mimeType,k=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",O=((N=x.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${S+1}. **${x.name}** (${I})
   ${k} · Modified: ${O}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await M(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",h),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const f=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const w=await f.json();return(E=w.files)!=null&&E.length?w.files.map((x,S)=>{var O,C;const I=((O=x.mimeType)==null?void 0:O.split(".").pop())||x.mimeType,k=((C=x.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${S+1}. **${x.name}** (${I}) — Modified: ${k}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await M(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await wt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((h,p)=>`${p+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(u){return await M(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>gn),f=await p(u,h);return f.error?`Failed to read page: ${f.error}`:!f.text||f.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${f.text.length} chars):

${f.text}`}catch(u){return await M(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const h=Za(t.query,d,{depth:t.depth||"quick",site:t.site}),p=new Promise(x=>setTimeout(()=>x(null),45e3)),f=await Promise.race([h,p]);if(f===null){const{webSearch:x}=await Promise.resolve().then(()=>dn),S=await x(t.query,{num:5});if(S.error||S.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let I=`Research took too long, but here are the top search results:

`;return I+=S.results.map((k,O)=>`${O+1}. **${k.title}**
   ${k.snippet}
   ${k.link}`).join(`

`),I}if(f.error)return`Research failed: ${f.error}`;let w=f.report;return f.sources.length>0&&(w+=`

---
**Sources** (`+f.pagesRead+` pages read):
`,w+=f.sources.map((x,S)=>`[${S+1}] ${x.title}
    ${x.url}`).join(`
`)),w}catch(u){return await M(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await F(u.encrypted_value,n),p=await Ga(h,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((f,w)=>{const x=f.rating?` ★${f.rating} (${f.userRatingsTotal||0} reviews)`:"",S=f.openNow!==void 0?f.openNow?" · Open now":" · Closed":"",I=f.googleMapsUri?`
   ${f.googleMapsUri}`:"";return`${w+1}. **${f.name}**${x}${S}
   ${f.address}${I}
   [place_id: ${f.placeId}]`}).join(`

`)}catch(u){return await M(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),p=await Fa(h,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const f=p.details;let w=`**${f.name}**
📍 ${f.address}`;if(f.phone&&(w+=`
📞 ${f.phone}`),f.website&&(w+=`
🌐 ${f.website}`),f.rating&&(w+=`
★ ${f.rating}`),f.googleMapsUri&&(w+=`
📌 ${f.googleMapsUri}`),f.openingHours&&(w+=`

Opening Hours:
${f.openingHours.join(`
`)}`),f.reviews&&f.reviews.length>0){w+=`

Recent Reviews:`;for(const x of f.reviews)w+=`
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return w}catch(u){return await M(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),p=await Wa(h,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const f=p.route;let w=`**${f.startAddress}** → **${f.endAddress}**
`;return w+=`📏 ${f.distance} · ⏱️ ${f.duration}`,f.durationInTraffic&&(w+=` (with traffic: ${f.durationInTraffic})`),w+=`
via ${f.summary}`,w+=`

Steps:`,f.steps.forEach((x,S)=>{w+=`
${S+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),w}catch(u){return await M(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),p=await Ya(h,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let f=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(f+=` (with traffic: ${p.durationInTraffic})`),f}catch(u){return await M(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),p=await qa(h,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await M(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),p=await Ka(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((f,w)=>{var x;return`${w+1}. **${f.title}**
   ${f.channelTitle} · ${((x=f.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${f.description}
   ${f.url}`}).join(`

`)}catch(u){return await M(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),p=await za(h,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((f,w)=>`${w+1}. ${f.address}
   Coordinates: ${f.lat}, ${f.lng}`).join(`
`)}catch(u){return await M(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function rr(e,t,a,r,n){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(a,r,"assistant",s,"{}",n),t.push({id:-1,user_id:a,channel:r,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function nr(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function _n(e,t,a,r,n,s,i){var x,S;const o=new ae(t),l=(x=e.metadata)==null?void 0:x.thread_id,c=Date.now(),[d,m]=await Promise.all([o.buildContext(r.id),Pt(t,r.id)]),g=await o.getRecentConversations(r.id,25,l);await rr(o,g,r.id,e.channel,l);const v=tr(r,d,e.channel,m),y=er([{role:"system",content:v},...g.map(I=>({role:I.role,content:I.content})),{role:"user",content:e.text}]);nr(y),await o.storeMessage(r.id,e.channel,"user",e.text,"{}",l);const T=(i==null?void 0:i.maxTurns)??10,_=(i==null?void 0:i.tools)??Xe;let E="",u=0;const h=[];for(let I=0;I<T;I++)try{const k=await a.chat(y,{tools:_});if(k.usage&&(u+=k.usage.promptTokens+k.usage.completionTokens),k.toolCalls&&k.toolCalls.length>0){k.content&&y.push({role:"assistant",content:k.content});for(const O of k.toolCalls){h.push(O.name);try{const C=await ft(O.name,O.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);y.push({role:"user",content:`[Tool Result for ${O.name}]: ${C}`})}catch(C){await M(t,r.id,"tool",O.name,C.message||"Tool execution failed"),y.push({role:"user",content:`[Tool Error for ${O.name}]: ${C.message||"Execution failed"}`})}}continue}E=k.content;break}catch(k){if(n){const O=k.message||"",C=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),N=O.includes("429"),L=C?1440:N?10:5;await n.recordError(a.name,O,L)}throw await M(t,r.id,"llm","provider_error",k.message||"Unknown LLM error",{provider:a.name,turn:I}),k}if(!E)try{y.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),E=(await a.chat(y,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me directly and I will answer from my knowledge."}catch{E="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge."}if(n&&u>0)try{await n.recordUsage(a.name,u)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",u,Date.now()-c,1,e.channel).run()}catch{}const p=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|drafted\s+(the\s+)?email|email\s+draft\s+created)\b/i,requiredTools:["gmail_send","gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent or drafted but gmail_send/gmail_draft was never called. You MUST call the appropriate tool NOW.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your|the)\s+(sheet|spreadsheet))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"}];for(const I of p){const k=I.claimPattern.test(E),O=I.requiredTools.some(C=>h.includes(C));if(k&&!O){try{await M(t,r.id,"llm",I.logType,"LLM claimed action without tool call",{response:E.substring(0,200)}),y.push({role:"assistant",content:E}),y.push({role:"user",content:I.enforcementMsg});const C=await a.chat(y,{tools:Xe.filter(N=>I.requiredTools.includes(N.name)),temperature:0});if((S=C.toolCalls)!=null&&S.length){for(const L of C.toolCalls){const j=await ft(L.name,L.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);h.push(L.name),y.push({role:"assistant",content:null,toolCalls:C.toolCalls}),y.push({role:"user",content:j})}const N=await a.chat(y,{tools:[]});N.content&&(E=N.content)}else E="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}const f=E.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),w=h.length>0?`[TOOLS_USED: ${[...new Set(h)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",w+f,"{}",l),await o.compactHistory(r.id,30),f}const Xt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function En(e){for(const[t,a]of Object.entries(Xt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Xt.default}function Tn(e,t,a,r){const n=En(r),s=Math.floor(n*.75),i=[];let o=0,l=!1;const c=It(e);i.push({role:"system",content:e}),o+=c;const d=It(a);o+=d;const m=s-o,g=[];let v=0;for(let y=t.length-1;y>=0;y--){const T=t[y],_=It(T.content);if(v+_<=m)g.unshift({role:T.role,content:T.content}),v+=_;else{l=!0;break}}return i.push(...g),i.push({role:"user",content:a}),o+=v,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*xn(e,t,a,r,n,s){var h,p;const i=new ae(t),o=(h=e.metadata)==null?void 0:h.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:a.name}};const[c,d]=await Promise.all([i.buildContext(r.id),Pt(t,r.id)]),m=await i.getRecentConversations(r.id,20,o);await rr(i,m,r.id,e.channel,o);const g=tr(r,c,e.channel,d),v=Tn(g,m,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const y=10;let T="",_=0;const E=[...v.messages];nr(E);for(let f=0;f<y;f++)try{f>0&&(yield{type:"thinking",data:{threadId:o}});const w=await a.chat(E,{tools:Xe});if(w.usage&&(_+=w.usage.promptTokens+w.usage.completionTokens),w.toolCalls&&w.toolCalls.length>0){w.content&&(yield{type:"chunk",data:{text:w.content,threadId:o}},E.push({role:"assistant",content:w.content}));for(const S of w.toolCalls){yield{type:"tool_start",data:{tool:S.name,toolArgs:S.arguments,threadId:o}};try{const I=await ft(S.name,S.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:S.name,toolResult:I.substring(0,500)+(I.length>500?"...":""),threadId:o}},E.push({role:"user",content:`[Tool Result for ${S.name}]: ${I}`})}catch(I){await M(t,r.id,"tool",S.name,I.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:S.name,toolResult:`Error: ${I.message||"Execution failed"}`,threadId:o}},E.push({role:"user",content:`[Tool Error for ${S.name}]: ${I.message||"Execution failed"}`})}}continue}T=w.content;const x=50;for(let S=0;S<T.length;S+=x)yield{type:"chunk",data:{text:T.substring(S,S+x),threadId:o}},S+x<T.length&&await new Promise(k=>setTimeout(k,10));break}catch(w){if(n){const S=w.message||"",I=S.includes("401")||S.includes("403")||S.includes("authentication")||S.includes("credit balance"),k=S.includes("429"),O=I?1440:k?10:5;await n.recordError(a.name,S,O)}await M(t,r.id,"llm","provider_error",w.message||"Unknown LLM error",{provider:a.name,turn:f});const x=w.message||"An error occurred";try{await i.storeMessage(r.id,e.channel,"assistant",`⚠️ ${x}`,"{}",o)}catch{}yield{type:"error",data:{error:x,threadId:o}};return}if(!T)try{E.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),T=(await a.chat(E,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const w=50;for(let x=0;x<T.length;x+=w)yield{type:"chunk",data:{text:T.substring(x,x+w),threadId:o}},x+w<T.length&&await new Promise(S=>setTimeout(S,10))}catch{T="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",yield{type:"chunk",data:{text:T,threadId:o}}}if(n&&_>0)try{await n.recordUsage(a.name,_)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",_,Date.now()-l,1,e.channel).run()}catch{}const u=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|drafted\s+(the\s+)?email|email\s+draft\s+created)\b/i,requiredTools:["gmail_send","gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent or drafted but gmail_send/gmail_draft was never called. You MUST call the appropriate tool NOW.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"}];for(const f of u){const w=f.claimPattern.test(T),x=f.requiredTools.some(S=>toolsCalledList.includes(S));if(w&&!x){try{await M(t,r.id,"llm",f.logType,"LLM claimed action without tool call (streaming)",{response:T.substring(0,200)}),E.push({role:"assistant",content:T}),E.push({role:"user",content:f.enforcementMsg});const S=await a.chat(E,{tools:Xe.filter(I=>f.requiredTools.includes(I.name)),temperature:0});if((p=S.toolCalls)!=null&&p.length){for(const k of S.toolCalls){const O=await ft(k.name,k.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);toolsCalledList.push(k.name),E.push({role:"assistant",content:null,toolCalls:S.toolCalls}),E.push({role:"user",content:O})}const I=await a.chat(E,{tools:[]});I.content&&(T=I.content)}else T="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}await i.storeMessage(r.id,e.channel,"assistant",T.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),"{}",o),await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:_}}}async function Ut(e,t,a,r,n,s){var m;const i=new ae(t),o=(m=e.metadata)==null?void 0:m.thread_id,l=await i.buildContext(r.id);if(Xa(e.text,l).agent==="conversation")return sr(e,t,a,r,l,n,o);const d=e.channel==="telegram"?{maxTurns:4,tools:Xe.filter(g=>g.name!=="research")}:void 0;return _n(e,t,a,r,n,s,d)}async function sr(e,t,a,r,n,s,i){const o=new ae(t),l=Date.now(),c=ar(r.timezone),d=await Pt(t,r.id),m=d?`## Your Standing Instructions
These are explicit preferences the user has set. Follow them in every response.
${d}

${n}`:n,g=yn("conversation",r,m,r.timezone,c,e.channel),v=(await o.getRecentConversations(r.id,25,i)).filter(u=>!u.content.startsWith("[Autonomous Scheduled Task]")&&!u.content.startsWith("[Scheduled Reminder]")),y=er([{role:"system",content:g},...v.map(u=>({role:u.role,content:u.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);let T=0,_="";try{const u=await a.chat(y,{temperature:.8});u.usage&&(T=u.usage.promptTokens+u.usage.completionTokens),_=u.content}catch(u){if(s){const h=u.message||"",p=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),f=h.includes("429"),w=p?1440:f?10:5;await s.recordError(a.name,h,w)}throw await M(t,r.id,"llm","conversation_error",u.message,{provider:a.name}),u}if(s&&T>0)try{await s.recordUsage(a.name,T)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"conversation",T,Date.now()-l,1,e.channel).run()}catch{}const E=_.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await o.storeMessage(r.id,e.channel,"assistant",E,"{}",i),await o.compactHistory(r.id,30),E}async function*Sn(e,t,a,r,n,s){var d;const i=new ae(t),o=(d=e.metadata)==null?void 0:d.thread_id,l=await i.buildContext(r.id),c=Xa(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:a.name}},c.agent!=="conversation"){yield*xn(e,t,a,r,n,s);return}try{const m=await sr(e,t,a,r,l,n,o),g=50;for(let v=0;v<m.length;v+=g)yield{type:"chunk",data:{text:m.substring(v,v+g),threadId:o}},v+g<m.length&&await new Promise(y=>setTimeout(y,10))}catch(m){yield{type:"error",data:{error:m.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:0}}}const G=new Ee;async function kn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}G.use("/*",kn);G.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=n;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await st(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(g){const v=new TextEncoder;try{const y=Sn(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const T of y)T.data.threadId||(T.data.threadId=o),g.enqueue(v.encode(Qt(T)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),g.close()}catch(y){const T={type:"error",data:{error:y.message||"An error occurred",threadId:o}};g.enqueue(v.encode(Qt(T))),g.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("limit reached")?e.json({error:d,type:"cost_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});G.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(n).all(),i=[];for(const o of s.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(n,o.id).run();const l=o.user_timezone||"UTC";let c,d=!1,m=o.state||"active";if(o.schedule_type==="interval"){const y=parseInt(o.schedule_value,10);c=new Date(r.getTime()+y*60*1e3)}else if(o.schedule_type==="daily"){const[y,T]=o.schedule_value.split(":").map(Number),_=ea(l),E=new Date(_);E.setHours(y,T,0,0),E<=_&&E.setDate(E.getDate()+1);const u=new Date(E.toLocaleString("en-US",{timeZone:"UTC"})),h=new Date(E.toLocaleString("en-US",{timeZone:l})),p=u.getTime()-h.getTime();c=new Date(E.getTime()+p)}else if(o.schedule_type==="weekly"){const[y,T]=o.schedule_value.split(" "),[_,E]=(T||"00:00").split(":").map(Number),h=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(k=>k.toLowerCase()===y.toLowerCase()),p=ea(l),f=new Date(p);f.setHours(_,E,0,0);let w=(h-f.getDay()+7)%7;w===0&&f<=p&&(w=7),f.setDate(f.getDate()+w);const x=new Date(f.toLocaleString("en-US",{timeZone:"UTC"})),S=new Date(f.toLocaleString("en-US",{timeZone:l})),I=x.getTime()-S.getTime();c=new Date(f.getTime()+I)}else o.schedule_type==="once"?(d=!0,m="completed",c=new Date(r.getTime()+365*24*60*60*1e3)):c=new Date(r.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,c.toISOString(),d?0:o.enabled,m,o.id).run();const v=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:v,next_run:c.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}return e.json({executed:i.length,results:i,timestamp:n})});ge.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);const r=parseInt(e.req.param("jobId"),10);if(!r)return e.json({error:"Invalid job ID"},400);const n=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(r).first();if(!n)return e.json({error:"Job not found"},404);const i=JSON.parse(n.action_config||"{}").description||n.description||"",o="⏰ "+(n.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=n.action_type==="reminder",m=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&n.action_type==="custom"&&m.test(i),d)c=i||n.name||"Time for your scheduled task.";else try{const T={id:n.user_id,username:n.username||"user",name:n.user_name||"User",pin_hash:n.pin_hash||"",role:n.user_role||"",personality_prompt:n.personality_prompt||"",telegram_chat_id:n.telegram_chat_id||"",timezone:n.user_timezone||"UTC",assistant_name:n.assistant_name||"Karna",created_at:"",updated_at:""},_={userId:n.user_id,username:T.username,channel:"cron",text:Dn(n.name,i,n.action_type),sessionId:"cron-"+n.id,timestamp:l},{provider:E,rotation:u}=await st(e.env.DB,n.user_id,n.pin_hash);c=await Ut(_,e.env.DB,E,T,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(T){const _=T.message||"unknown error",E=_.includes("rate_limit")||_.includes("429")||_.includes("quota"),u=_.includes("timeout")||_.includes("Timeout");E?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":u?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await M(e.env.DB,n.user_id,"cron_agent","execution_error",_,{job_id:n.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(n.action_type))try{const T=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(n.user_id).first();(!T||T.cnt===0)&&await M(e.env.DB,n.user_id,"cron_verification","no_tools_called",`Cron job "${n.name}" (${n.action_type}) completed without any tool calls`,{job_id:n.id,action_type:n.action_type,response_preview:c.substring(0,200)})}catch{}let v=c||i||"Time for your scheduled task.";v=v.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const y=o+`
`+v;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(n.user_id,"reminder",o,v,"cron:"+n.id).run(),d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(n.user_id,"system","assistant",y,JSON.stringify({type:"cron",job_id:n.id})).run(),n.telegram_chat_id&&await On(e.env.DB,n.user_id,n.telegram_chat_id,y),e.json({job_id:r,status:"completed",response_length:c.length})});async function ir(e){var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return null;const a=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(a==null?void 0:a.user_id)||null}ge.get("/health/tools",async e=>{var a;const t=await ir(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function Dn(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check Gmail for new/important emails."}
You MUST call gmail_list or gmail_search immediately.${Ye}`:a==="check_calendar"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check calendar for upcoming events."}
You MUST call list_calendar_events immediately.${Ye}`:a==="check_sheet"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
You MUST call read_sheet immediately with the relevant spreadsheet.${Ye}`:a==="custom"&&t?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${Ye}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${Ye}`}function Cn(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function Rn(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const it=new Ee,Nn=4e3;async function H(e,t,a,r="Markdown"){var s,i;const n=An(a,Nn);for(const o of n)try{const l=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:o,parse_mode:r,disable_web_page_preview:!1})});if(!l.ok){const c=await l.json().catch(()=>null);((s=c==null?void 0:c.description)!=null&&s.includes("parse")||(i=c==null?void 0:c.description)!=null&&i.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:o})})}}catch{}}async function Ln(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function An(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let n=r.lastIndexOf(`
`,t);n<t*.3&&(n=r.lastIndexOf(" ",t)),n<t*.3&&(n=t),a.push(r.substring(0,n)),r=r.substring(n).trimStart()}return a}async function Mn(e,t,a,r,n){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(r==null?void 0:r.name)||"there",o=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await H(a,t,l),!0}case"/help":{const o=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await H(a,t,o),!0}case"/status":{if(!r)return await H(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[i,o,l,c]=await Promise.all([n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),d=`📊 *System Status*
...
Status: ✅ Online`;await H(a,t,d)}catch{await H(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await H(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await H(a,t,"⚠️ Account not linked."),!0);case"/tasks":case"/task":{if(!r)return await H(a,t,"⚠️ Account not linked."),!0;try{const o=(await n.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(o.length===0)return await H(a,t,"✅ No open tasks. You're all clear."),!0;const l=new Date,c=l.toISOString().slice(0,10),d=new Date(l);d.setDate(d.getDate()+1);const m=d.toISOString().slice(0,10),g=[`📋 *Open Tasks (${o.length})*
`];for(const v of o){let y="";if(v.due_date){const T=v.due_date.slice(0,10);T<c?y=" ⚠️ _overdue_":T===c?y=" 🔴 _due today_":T===m?y=" 🟡 _due tomorrow_":y=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}g.push(`☐ ${v.title}${y}`)}g.push(`
_Say "mark [task] as done" to close a task._`),await H(a,t,g.join(`
`))}catch(i){await H(a,t,"❌ Could not fetch tasks: "+i.message)}return!0}default:return!1}}it.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},n=async()=>{var s,i,o,l,c;try{if(t.callback_query){await $n(a,t.callback_query);return}const d=t.message;if(!d)return;const m=!!d.text,g=!!d.voice,v=!!d.document,y=!!d.photo,T=!!d.caption;if(!m&&!g&&!v&&!y)return;const _=String(d.chat.id);let E=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(_).first();let h=null;if(u){const k=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();k&&(h=await F(k.encrypted_value,u.pin_hash))}if(!h){const k=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();k&&(h=await F(k.encrypted_value,k.pin_hash))}if(!h||E.startsWith("/")&&await Mn(E,_,h,u,a))return;if(!u){await H(h,_,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${_}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&h&&u)try{await H(h,_,"🎤 Processing voice note...");const O=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${d.voice.file_id}`)).json();if(O.ok&&((s=O.result)!=null&&s.file_path)){const N=await(await fetch(`https://api.telegram.org/file/bot${h}/${O.result.file_path}`)).blob();let L="",j="",B="whisper-1";const K=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const oe of K.results){const ot=await F(oe.encrypted_value,u.pin_hash);if(oe.service==="openai"){L="https://api.openai.com/v1/audio/transcriptions",j=ot;break}else if(oe.service.startsWith("llm_slot_"))try{const lt=JSON.parse(ot);if(lt.provider==="openai"){L="https://api.openai.com/v1/audio/transcriptions",j=lt.apiKey;break}else if(lt.provider==="groq"){L="https://api.groq.com/openai/v1/audio/transcriptions",j=lt.apiKey,B="whisper-large-v3";break}}catch{}}if(!L){await H(h,_,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const U=new FormData;U.append("file",N,"voice.ogg"),U.append("model",B),U.append("language","en");const W=await fetch(L,{method:"POST",headers:{Authorization:`Bearer ${j}`},body:U});if(!W.ok){const oe=await W.text();await H(h,_,`⚠️ Transcription failed: ${W.status} ${oe}`);return}E=(await W.json()).text,await H(h,_,`🗣️ *You said:* ${E}`)}}catch(k){await H(h,_,`⚠️ Failed to process voice note: ${k.message}`);return}if((v||y)&&h&&u)try{let k,O="unknown",C="unknown",N=0;if(v)k=d.document.file_id,O=d.document.file_name||"document",C=d.document.mime_type||"unknown",N=d.document.file_size||0;else if(y){const L=d.photo[d.photo.length-1];k=L.file_id,O="photo.jpg",C="image/jpeg",N=L.file_size||0}if(k){const j=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${k}`)).json();let B="";if(j.ok&&((i=j.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(O)||/^text\/|application\/json|application\/xml|application\/csv/i.test(C))&&N<5e4)try{B=await(await fetch(`https://api.telegram.org/file/bot${h}/${j.result.file_path}`)).text()}catch{}const K=d.caption||"",U=`[Telegram file received: "${O}" (${C}, ${Math.round(N/1024)}KB)]`;B?E=`${K?K+`
...
`:""}${U}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(k){if(T&&d.caption)E=d.caption;else{await H(h,_,`⚠️ Received your file but couldn't process it: ${k.message}`);return}}if(!E)return;Ln(h,_).catch(()=>{});let p=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();p?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(p.id).run():p={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const f=Cn(u.id,u.username,E,_);f.metadata={thread_id:p.id};let w,x;try{const k=await st(a,u.id,u.pin_hash);w=k.provider,x=k.rotation}catch(k){console.error("Telegram provider setup error:",k);const O=(o=k.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=k.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${k.message||"Unknown error"}`;await H(h,_,O);return}/\b(write\s+(an?\s+)?(essay|article|report|document|doc|blog|post|summary|draft)|draft\s+(an?\s+)?(essay|article|report|document)|research\s+.{0,60}(save|store|drive|doc))\b/i.test(E)&&await H(h,_,"📝 Working on it— searching and saving to Drive takes about 20 seconds...");const I=25e3;try{const k=await Promise.race([Ut(f,a,w,u,x,r),new Promise((C,N)=>setTimeout(()=>N(new Error("TELEGRAM_TIMEOUT")),I))]),O=Rn(k,"telegram");await H(h,_,O||"(empty response)")}catch(k){console.error("Telegram agent error:",k);const O=k.message==="TELEGRAM_TIMEOUT",C=O?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=k.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${w.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(k.message||"Unknown").substring(0,200)}`;await H(h,_,C);try{const{logError:N}=await Promise.resolve().then(()=>Rt);await N(a,u.id,"telegram",O?"timeout":"agent_error",k.message||"Agent error",{provider:w.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:m}=await Promise.resolve().then(()=>Rt);await m(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(n()),e.json({ok:!0})});it.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await F(n.encrypted_value,a.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});it.get("/webhook-status",async e=>{var s,i,o,l,c,d;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await F(r.encrypted_value,a.pin_hash);try{const g=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=g.result)==null?void 0:i.url)||"",has_webhook:!!((o=g.result)!=null&&o.url),pending_updates:((l=g.result)==null?void 0:l.pending_update_count)||0,last_error:((c=g.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=g.result)==null?void 0:d.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});it.post("/detect-chat-id",async e=>{var s,i;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await F(r.encrypted_value,a.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(_=>setTimeout(_,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:["message"]})});const g=m.result||[];if(g.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],y=new Set;for(let _=g.length-1;_>=0;_--){const E=g[_].message;if(E&&E.chat){const u=String(E.chat.id);y.has(u)||(y.add(u),v.push({chat_id:u,name:[E.chat.first_name,E.chat.last_name].filter(Boolean).join(" ")||E.chat.title||"Unknown",username:E.chat.username||"",date:new Date((E.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const T=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(T,a.user_id).run(),e.json({found:!0,chat_id:T,name:v[0].name,all_chats:v,message:`Chat ID ${T} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function $n(e,t){var T;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const i=r.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const c=String(n.chat.id),d=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(c).first();if(!d)return;const m=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(d.id,l,o).first();if(!m)return;const g=m.checked?0:1;await e.prepare(`
  ...
  `).bind(g,g,m.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(d.id).first();if(!v)return;const y=await F(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:g?"✅ Checked!":"☐ Unchecked"})}),(T=n.reply_markup)!=null&&T.inline_keyboard){const _=n.reply_markup.inline_keyboard.map(E=>E.map(u=>{var h;if((h=u.callback_data)!=null&&h.includes(o)){const p=g?"✅":"☐",f=u.text.replace(/^[☐✅]\s*/,"");return{...u,text:`${p} ${f}`}}return u}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:n.message_id,reply_markup:{inline_keyboard:_}})})}catch{}}}function jn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function Bn(e,t,a,r,n,s){try{return(await new Bt(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Pn(e,t,a,r,n){try{const s=new ce(e,t,a,r,n),i=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of i){const g=m.from.split("<")[0].trim()||m.from;l[g]=(l[g]||0)+1}const c=Object.entries(l).sort(([,m],[,g])=>g-m).slice(0,5).map(([m])=>m),d=i.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Un(e,t){try{const a=await e.prepare(`
...
`)}function Wn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function qn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const s=JSON.parse(a.components);r={google_calendar:s.google_calendar!==!1,gmail:s.gmail!==!1,tasks:s.tasks!==!1,news:s.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function or(e,t,a){var u,h;const r=t.timezone||"Asia/Kolkata",n=jn(r),{components:s,newsTopics:i}=await qn(e,t.id),o=[],l=[];s.google_calendar&&(o.push(Bn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(o.push(Pn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(o.push(Un(e,t.id)),l.push("tasks")),s.news&&(o.push(Gn(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((p,f)=>{d[p]=c[f]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:d.googleEvents||[],totalCount:((u=d.googleEvents)==null?void 0:u.length)||0},emails:{gmail:d.gmailSummary||m},tasks:d.tasks||g,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},y=((h=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:h.briefing_time)||"20:00";v.summary=Fn(v,y);const T=Wn(v),_=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function Kn(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function Jn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[i,o]=e.split(":").map(Number),l=n*60+s,c=i*60+o;return l===c}function lr(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const Z=new Ee;async function Vn(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const i of r.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(Jn(l,o,s))try{const c=await or(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(i.telegram_chat_id){const{text:d,inlineKeyboard:m}=lr(c.content,c.items);await cr(e.env.DB,i,d,m,c.briefingId)}n.push({user_id:i.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:o})}catch(c){n.push({user_id:i.id,status:"error",error:c.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});Z.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,i=new Date(s.getTime()+600*1e3).toISOString(),o=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await F(c.encrypted_value,l.pin_hash),g=JSON.parse(d).access_token;if(!g)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${g}`}});if(!v.ok)continue;const T=((await v.json()).items||[]).filter(u=>{var p;const h=(p=u.start)==null?void 0:p.dateTime;return h?h>=s.toISOString()&&h<=i:!1});if(T.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const _=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!_)continue;const E=await F(_.encrypted_value,l.pin_hash);for(const u of T){const h=new Date(u.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=u.location?`
📍 ${u.location}`:"",f=`⏰ Meeting in 10 minutes!

*${u.summary||"Untitled Event"}*
🕐 ${h}${p}`;await fetch(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:f,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:T.length})}catch(c){n.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function cr(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const i=await F(s.encrypted_value,s.pin_hash);if(!(await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(c=>c.map(d=>({...d,callback_data:`${d.callback_data}:${n}`})))}})})).json()).ok){const d=await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a.replace(/[_*[\]`]/g,""),reply_markup:{inline_keyboard:r.map(m=>m.map(g=>({...g,callback_data:`${g.callback_data}:${n}`})))}})})).json();if(!d.ok){console.error("Telegram briefing send failed:",d.description,"chat_id:",t.telegram_chat_id);return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}Z.post("/briefings/:id/resend",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const r=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!r)return e.json({error:"Briefing not found"},404);const n=JSON.parse(r.content||"{}"),s=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(a).all(),{text:i,inlineKeyboard:o}=lr(n,s.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(a).run(),await cr(e.env.DB,t,i,o,a);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(a).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(r){return e.json({error:r.message},500)}});Z.delete("/briefings/:id",async e=>{const t=e.get("user"),a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});const re=new Ee;re.use("/api/*",Kr());re.route("/api/auth",Te);re.route("/api/chat",G);re.route("/api/settings",P);re.route("/api/system",ge);re.route("/api/telegram",it);re.route("/api/proactive",Z);re.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Le(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Le(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(r)).sessionId;if(!i)return e.html(Le(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(Le(!1,"Session expired. Please log in again and retry."));const l=o.user_id,c=o.pin_hash,d=`${t.protocol}//${t.host}/auth/google/callback`,m=await Ba(e.env.DB,l,c,a,d,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Le(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Le(!1,`OAuth failed: ${s.message}`))}});re.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(xa())));re.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(xa())));function Le(e,t,a){return`<!DOCTYPE html>
