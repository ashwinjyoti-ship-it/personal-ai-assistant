var ja=Object.defineProperty;var Rt=e=>{throw TypeError(e)};var Ba=(e,t,a)=>t in e?ja(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var T=(e,t,a)=>Ba(e,typeof t!="symbol"?t+"":t,a),pt=(e,t,a)=>t.has(e)||Rt("Cannot "+a);var b=(e,t,a)=>(pt(e,t,"read from private field"),a?a.call(e):t.get(e)),C=(e,t,a)=>t.has(e)?Rt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),I=(e,t,a,r)=>(pt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),R=(e,t,a)=>(pt(e,t,"access private method"),a);var At=(e,t,a,r)=>({set _(n){I(e,t,n,a)},get _(){return b(e,t,r)}});var Lt=(e,t,a)=>(r,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,d=!1,u;if(e[o]?(u=e[o][0][0],r.req.routeIndex=o):u=o===e.length&&n||void 0,u)try{l=await u(r,()=>i(o+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),d=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},Pa=Symbol(),Ha=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ta?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Ua(e,{all:a,dot:r}):{}};async function Ua(e,t){const a=await e.formData();return a?Ga(a,t):{}}function Ga(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?za(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(Fa(a,r,n),delete a[r])}),a}var za=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Fa=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},Vt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Wa=e=>{const{groups:t,path:a}=qa(e),r=Vt(a);return Ka(r,t)},qa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},Ka=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},at={},Ja=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return at[r]||(a[2]?at[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:at[r]=[e,a[1],!0]),at[r]}return null},Tt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Ya=e=>Tt(e,decodeURI),Xt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),i=t.indexOf("#",r),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return Ya(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},Va=e=>{const t=Xt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Oe=(e,t,...a)=>(a.length&&(t=Oe(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Zt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,i)=>i.indexOf(n)===s)},mt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Tt(e,ea):e):e,Qt=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,d=e.indexOf("&",l);return mt(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(r&&(l=mt(l)),s=i,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),r&&(d=mt(d))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Xa=Qt,Za=(e,t)=>Qt(e,t,!0),ea=decodeURIComponent,Nt=e=>Tt(e,ea),Le,q,oe,aa,ra,yt,le,Ft,ta=(Ft=class{constructor(e,t="/",a=[[]]){C(this,oe);T(this,"raw");C(this,Le);C(this,q);T(this,"routeIndex",0);T(this,"path");T(this,"bodyCache",{});C(this,le,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,I(this,q,a),I(this,Le,{})}param(e){return e?R(this,oe,aa).call(this,e):R(this,oe,ra).call(this)}query(e){return Xa(this.url,e)}queries(e){return Za(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ha(this,e))}json(){return b(this,le).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,le).call(this,"text")}arrayBuffer(){return b(this,le).call(this,"arrayBuffer")}blob(){return b(this,le).call(this,"blob")}formData(){return b(this,le).call(this,"formData")}addValidatedData(e,t){b(this,Le)[e]=t}valid(e){return b(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Pa](){return b(this,q)}get matchedRoutes(){return b(this,q)[0].map(([[,e]])=>e)}get routePath(){return b(this,q)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,q=new WeakMap,oe=new WeakSet,aa=function(e){const t=b(this,q)[0][this.routeIndex][1][e],a=R(this,oe,yt).call(this,t);return a&&/\%/.test(a)?Nt(a):a},ra=function(){const e={},t=Object.keys(b(this,q)[0][this.routeIndex][1]);for(const a of t){const r=R(this,oe,yt).call(this,b(this,q)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Nt(r):r)}return e},yt=function(e){return b(this,q)[1]?b(this,q)[1][e]:e},le=new WeakMap,Ft),Qa={Stringify:1},na=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>na(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},er="text/plain; charset=UTF-8",ht=(e,t)=>({"Content-Type":e,...t}),Je,Ye,re,Ne,ne,W,Ve,$e,Me,be,Xe,Ze,de,Re,Wt,tr=(Wt=class{constructor(e,t){C(this,de);C(this,Je);C(this,Ye);T(this,"env",{});C(this,re);T(this,"finalized",!1);T(this,"error");C(this,Ne);C(this,ne);C(this,W);C(this,Ve);C(this,$e);C(this,Me);C(this,be);C(this,Xe);C(this,Ze);T(this,"render",(...e)=>(b(this,$e)??I(this,$e,t=>this.html(t)),b(this,$e).call(this,...e)));T(this,"setLayout",e=>I(this,Ve,e));T(this,"getLayout",()=>b(this,Ve));T(this,"setRenderer",e=>{I(this,$e,e)});T(this,"header",(e,t,a)=>{this.finalized&&I(this,W,new Response(b(this,W).body,b(this,W)));const r=b(this,W)?b(this,W).headers:b(this,be)??I(this,be,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});T(this,"status",e=>{I(this,Ne,e)});T(this,"set",(e,t)=>{b(this,re)??I(this,re,new Map),b(this,re).set(e,t)});T(this,"get",e=>b(this,re)?b(this,re).get(e):void 0);T(this,"newResponse",(...e)=>R(this,de,Re).call(this,...e));T(this,"body",(e,t,a)=>R(this,de,Re).call(this,e,t,a));T(this,"text",(e,t,a)=>!b(this,be)&&!b(this,Ne)&&!t&&!a&&!this.finalized?new Response(e):R(this,de,Re).call(this,e,t,ht(er,a)));T(this,"json",(e,t,a)=>R(this,de,Re).call(this,JSON.stringify(e),t,ht("application/json",a)));T(this,"html",(e,t,a)=>{const r=n=>R(this,de,Re).call(this,n,t,ht("text/html; charset=UTF-8",a));return typeof e=="object"?na(e,Qa.Stringify,!1,{}).then(r):r(e)});T(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});T(this,"notFound",()=>(b(this,Me)??I(this,Me,()=>new Response),b(this,Me).call(this,this)));I(this,Je,e),t&&(I(this,ne,t.executionCtx),this.env=t.env,I(this,Me,t.notFoundHandler),I(this,Ze,t.path),I(this,Xe,t.matchResult))}get req(){return b(this,Ye)??I(this,Ye,new ta(b(this,Je),b(this,Ze),b(this,Xe))),b(this,Ye)}get event(){if(b(this,ne)&&"respondWith"in b(this,ne))return b(this,ne);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ne))return b(this,ne);throw Error("This context has no ExecutionContext")}get res(){return b(this,W)||I(this,W,new Response(null,{headers:b(this,be)??I(this,be,new Headers)}))}set res(e){if(b(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}I(this,W,e),this.finalized=!0}get var(){return b(this,re)?Object.fromEntries(b(this,re)):{}}},Je=new WeakMap,Ye=new WeakMap,re=new WeakMap,Ne=new WeakMap,ne=new WeakMap,W=new WeakMap,Ve=new WeakMap,$e=new WeakMap,Me=new WeakMap,be=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,de=new WeakSet,Re=function(e,t,a){const r=b(this,W)?new Headers(b(this,W).headers):b(this,be)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")r.set(s,i);else{r.delete(s);for(const o of i)r.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Ne);return new Response(e,{status:n,headers:r})},Wt),P="ALL",ar="all",rr=["get","post","put","delete","options","patch"],sa="Can not add a route since the matcher is already built.",ia=class extends Error{},nr="__COMPOSED_HANDLER",sr=e=>e.text("404 Not Found",404),$t=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},J,H,oa,Y,ve,st,it,je,ir=(je=class{constructor(t={}){C(this,H);T(this,"get");T(this,"post");T(this,"put");T(this,"delete");T(this,"options");T(this,"patch");T(this,"all");T(this,"on");T(this,"use");T(this,"router");T(this,"getPath");T(this,"_basePath","/");C(this,J,"/");T(this,"routes",[]);C(this,Y,sr);T(this,"errorHandler",$t);T(this,"onError",t=>(this.errorHandler=t,this));T(this,"notFound",t=>(I(this,Y,t),this));T(this,"fetch",(t,...a)=>R(this,H,it).call(this,t,a[1],a[0],t.method));T(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Oe("/",t)}`,a),r,n)));T(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(R(this,H,it).call(this,t.request,t,void 0,t.request.method))})});[...rr,ar].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?I(this,J,i):R(this,H,ve).call(this,s,b(this,J),i),o.forEach(l=>{R(this,H,ve).call(this,s,b(this,J),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){I(this,J,l);for(const d of[s].flat())o.map(u=>{R(this,H,ve).call(this,d.toUpperCase(),b(this,J),u)})}return this},this.use=(s,...i)=>(typeof s=="string"?I(this,J,s):(I(this,J,"*"),i.unshift(s)),i.forEach(o=>{R(this,H,ve).call(this,P,b(this,J),o)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??Xt:Va}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let s;a.errorHandler===$t?s=n.handler:(s=async(o,l)=>(await Lt([],a.errorHandler)(o,()=>n.handler(o,l))).res,s[nr]=n.handler),R(i=r,H,ve).call(i,n.method,n.path,s)}),this}basePath(t){const a=R(this,H,oa).call(this);return a._basePath=Oe(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Oe(this._basePath,t),d=l==="/"?0:l.length;return u=>{const p=new URL(u.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,u)}})());const o=async(l,d)=>{const u=await a(n(l.req.raw),...i(l));if(u)return u;await d()};return R(this,H,ve).call(this,P,Oe(t,"*"),o),this}},J=new WeakMap,H=new WeakSet,oa=function(){const t=new je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,I(t,Y,b(this,Y)),t.routes=this.routes,t},Y=new WeakMap,ve=function(t,a,r){t=t.toUpperCase(),a=Oe(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},st=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},it=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await R(this,H,it).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),i=this.router.match(n,s),o=new tr(t,{path:s,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,Y)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await b(this,Y).call(this,o)})}catch(u){return R(this,H,st).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:b(this,Y).call(this,o))).catch(u=>R(this,H,st).call(this,u,o)):d??b(this,Y).call(this,o)}const l=Lt(i[0],this.errorHandler,b(this,Y));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return R(this,H,st).call(this,d,o)}})()},je),la=[];function or(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const i=a[n]||a[P],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],la];const d=l.indexOf("",1);return[i[1][d],l]});return this.match=r,r(e,t)}var lt="[^/]+",We=".*",qe="(?:|/.*)",Ae=Symbol(),lr=new Set(".\\+*[^]$()");function dr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===lt?1:t===lt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,xe,V,Te,cr=(Te=class{constructor(){C(this,we);C(this,xe);C(this,V,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,we)!==void 0)throw Ae;if(s)return;I(this,we,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",We]:["","",lt]:i==="/*"?["","",qe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let p=l[2]||lt;if(u&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Ae;if(d=b(this,V)[p],!d){if(Object.keys(b(this,V)).some(g=>g!==We&&g!==qe))throw Ae;if(s)return;d=b(this,V)[p]=new Te,u!==""&&I(d,xe,n.varIndex++)}!s&&u!==""&&r.push([u,b(d,xe)])}else if(d=b(this,V)[i],!d){if(Object.keys(b(this,V)).some(u=>u.length>1&&u!==We&&u!==qe))throw Ae;if(s)return;d=b(this,V)[i]=new Te}d.insert(o,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,V)).sort(dr).map(r=>{const n=b(this,V)[r];return(typeof b(n,xe)=="number"?`(${r})@${b(n,xe)}`:lr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,we)=="number"&&a.unshift(`#${b(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,xe=new WeakMap,V=new WeakMap,Te),dt,Qe,qt,ur=(qt=class{constructor(){C(this,dt,{varIndex:0});C(this,Qe,new cr)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return n[i]=[d,l],i++,o=!0,d}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return b(this,Qe).insert(s,t,r,b(this,dt),a),r}buildRegExp(){let e=b(this,Qe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},dt=new WeakMap,Qe=new WeakMap,qt),pr=[/^$/,[],Object.create(null)],ot=Object.create(null);function da(e){return ot[e]??(ot[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function mr(){ot=Object.create(null)}function hr(e){var d;const t=new ur,a=[];if(e.length===0)return pr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,p],[g,y])=>u?1:g?-1:p.length-y.length),n=Object.create(null);for(let u=0,p=-1,g=r.length;u<g;u++){const[y,v,x]=r[u];y?n[v]=[x.map(([E])=>[E,Object.create(null)]),la]:p++;let w;try{w=t.insert(v,p,y)}catch(E){throw E===Ae?new ia(v):E}y||(a[p]=x.map(([E,c])=>{const f=Object.create(null);for(c-=1;c>=0;c--){const[h,m]=w[c];f[h]=m}return[E,f]}))}const[s,i,o]=t.buildRegExp();for(let u=0,p=a.length;u<p;u++)for(let g=0,y=a[u].length;g<y;g++){const v=(d=a[u][g])==null?void 0:d[1];if(!v)continue;const x=Object.keys(v);for(let w=0,E=x.length;w<E;w++)v[x[w]]=o[v[x[w]]]}const l=[];for(const u in i)l[u]=a[i[u]];return[s,l,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(da(a).test(t))return[...e[a]]}}var ce,ue,ct,ca,Kt,gr=(Kt=class{constructor(){C(this,ct);T(this,"name","RegExpRouter");C(this,ce);C(this,ue);T(this,"match",or);I(this,ce,{[P]:Object.create(null)}),I(this,ue,{[P]:Object.create(null)})}add(e,t,a){var o;const r=b(this,ce),n=b(this,ue);if(!r||!n)throw new Error(sa);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(d=>{l[e][d]=[...l[P][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=da(t);e===P?Object.keys(r).forEach(d=>{var u;(u=r[d])[t]||(u[t]=De(r[d],t)||De(r[P],t)||[])}):(o=r[e])[t]||(o[t]=De(r[e],t)||De(r[P],t)||[]),Object.keys(r).forEach(d=>{(e===P||e===d)&&Object.keys(r[d]).forEach(u=>{l.test(u)&&r[d][u].push([a,s])})}),Object.keys(n).forEach(d=>{(e===P||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([a,s]))});return}const i=Zt(t)||[t];for(let l=0,d=i.length;l<d;l++){const u=i[l];Object.keys(n).forEach(p=>{var g;(e===P||e===p)&&((g=n[p])[u]||(g[u]=[...De(r[p],u)||De(r[P],u)||[]]),n[p][u].push([a,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,ue)).concat(Object.keys(b(this,ce))).forEach(t=>{e[t]||(e[t]=R(this,ct,ca).call(this,t))}),I(this,ce,I(this,ue,void 0)),mr(),e}},ce=new WeakMap,ue=new WeakMap,ct=new WeakSet,ca=function(e){const t=[];let a=e===P;return[b(this,ce),b(this,ue)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?hr(t):null},Kt),pe,se,Jt,fr=(Jt=class{constructor(e){T(this,"name","SmartRouter");C(this,pe,[]);C(this,se,[]);I(this,pe,e.routers)}add(e,t,a){if(!b(this,se))throw new Error(sa);b(this,se).push([e,t,a])}match(e,t){if(!b(this,se))throw new Error("Fatal error");const a=b(this,pe),r=b(this,se),n=a.length;let s=0,i;for(;s<n;s++){const o=a[s];try{for(let l=0,d=r.length;l<d;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof ia)continue;throw l}this.match=o.match.bind(o),I(this,pe,[o]),I(this,se,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,se)||b(this,pe).length!==1)throw new Error("No active router has been determined yet.");return b(this,pe)[0]}},pe=new WeakMap,se=new WeakMap,Jt),Ge=Object.create(null),me,F,_e,Be,G,ie,ye,Pe,vr=(Pe=class{constructor(t,a,r){C(this,ie);C(this,me);C(this,F);C(this,_e);C(this,Be,0);C(this,G,Ge);if(I(this,F,r||Object.create(null)),I(this,me,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},I(this,me,[n])}I(this,_e,[])}insert(t,a,r){I(this,Be,++At(this,Be)._);let n=this;const s=Wa(a),i=[];for(let o=0,l=s.length;o<l;o++){const d=s[o],u=s[o+1],p=Ja(d,u),g=Array.isArray(p)?p[0]:d;if(g in b(n,F)){n=b(n,F)[g],p&&i.push(p[1]);continue}b(n,F)[g]=new Pe,p&&(b(n,_e).push(p),i.push(p[1])),n=b(n,F)[g]}return b(n,me).push({[t]:{handler:r,possibleKeys:i.filter((o,l,d)=>d.indexOf(o)===l),score:b(this,Be)}}),n}search(t,a){var l;const r=[];I(this,G,Ge);let s=[this];const i=Vt(a),o=[];for(let d=0,u=i.length;d<u;d++){const p=i[d],g=d===u-1,y=[];for(let v=0,x=s.length;v<x;v++){const w=s[v],E=b(w,F)[p];E&&(I(E,G,b(w,G)),g?(b(E,F)["*"]&&r.push(...R(this,ie,ye).call(this,b(E,F)["*"],t,b(w,G))),r.push(...R(this,ie,ye).call(this,E,t,b(w,G)))):y.push(E));for(let c=0,f=b(w,_e).length;c<f;c++){const h=b(w,_e)[c],m=b(w,G)===Ge?{}:{...b(w,G)};if(h==="*"){const A=b(w,F)["*"];A&&(r.push(...R(this,ie,ye).call(this,A,t,b(w,G))),I(A,G,m),y.push(A));continue}const[_,k,D]=h;if(!p&&!(D instanceof RegExp))continue;const S=b(w,F)[_],L=i.slice(d).join("/");if(D instanceof RegExp){const A=D.exec(L);if(A){if(m[k]=A[0],r.push(...R(this,ie,ye).call(this,S,t,b(w,G),m)),Object.keys(b(S,F)).length){I(S,G,m);const N=((l=A[0].match(/\//))==null?void 0:l.length)??0;(o[N]||(o[N]=[])).push(S)}continue}}(D===!0||D.test(p))&&(m[k]=p,g?(r.push(...R(this,ie,ye).call(this,S,t,m,b(w,G))),b(S,F)["*"]&&r.push(...R(this,ie,ye).call(this,b(S,F)["*"],t,m,b(w,G)))):(I(S,G,m),y.push(S)))}}s=y.concat(o.shift()??[])}return r.length>1&&r.sort((d,u)=>d.score-u.score),[r.map(({handler:d,params:u})=>[d,u])]}},me=new WeakMap,F=new WeakMap,_e=new WeakMap,Be=new WeakMap,G=new WeakMap,ie=new WeakSet,ye=function(t,a,r,n){const s=[];for(let i=0,o=b(t,me).length;i<o;i++){const l=b(t,me)[i],d=l[a]||l[P],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),r!==Ge||n&&n!==Ge))for(let p=0,g=d.possibleKeys.length;p<g;p++){const y=d.possibleKeys[p],v=u[d.score];d.params[y]=n!=null&&n[y]&&!v?n[y]:r[y]??(n==null?void 0:n[y]),u[d.score]=!0}}return s},Pe),Ee,Yt,yr=(Yt=class{constructor(){T(this,"name","TrieRouter");C(this,Ee);I(this,Ee,new vr)}add(e,t,a){const r=Zt(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ee).insert(e,r[n],a);return}b(this,Ee).insert(e,t,a)}match(e,t){return b(this,Ee).search(e,t)}},Ee=new WeakMap,Yt),ge=class extends ir{constructor(e={}){super(e),this.router=e.router??new fr({routers:[new gr,new yr]})}},br=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var u;function l(p,g){i.res.headers.set(p,g)}const d=await r(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await n(i.req.header("origin")||"",i);p.length&&l("Access-Control-Allow-Methods",p.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const y=i.req.header("Access-Control-Request-Headers");y&&(g=y.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function ua(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`),t.trim()}async function Ca(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await Ct(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,r).map(async g=>{const y=await Da(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:y.text,error:y.error}}),d=(await Promise.all(o)).filter(g=>g.content.length>50);if(d.length===0){const g=s.results.map((v,x)=>`[${x+1}] ${v.title}
${v.snippet}
Source: ${v.link}`).join(`
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Pt(e,t,a){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function Yr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function La(e,t,a,r,n,s,i,o,l,d,u){var g,y,v,x,w,E;const p=new he(a);switch(e){case"create_schedule":{const c=new Date;let f;const h=d||"UTC";if(t.schedule_type==="interval"){const m=parseInt(t.schedule_value,10);f=new Date(c.getTime()+m*60*1e3)}else if(t.schedule_type==="daily"){const[m,_]=t.schedule_value.split(":").map(Number),k=c.toLocaleString("en-US",{timeZone:h}),D=new Date(k),S=new Date(D);S.setHours(m,_,0,0),S<=D&&S.setDate(S.getDate()+1);const L=new Date(S.toLocaleString("en-US",{timeZone:"UTC"})),A=new Date(S.toLocaleString("en-US",{timeZone:h})),N=L.getTime()-A.getTime();f=new Date(S.getTime()+N)}else if(t.schedule_type==="weekly"){const[m,_]=t.schedule_value.split(" "),[k,D]=(_||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ie=>Ie.toLowerCase()===m.toLowerCase()),A=c.toLocaleString("en-US",{timeZone:h}),N=new Date(A),$=new Date(N);$.setHours(k,D,0,0);let U=(L-$.getDay()+7)%7;U===0&&$<=N&&(U=7),$.setDate($.getDate()+U);const ke=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),ee=new Date($.toLocaleString("en-US",{timeZone:h})),Se=ke.getTime()-ee.getTime();f=new Date($.getTime()+Se)}else if(t.schedule_type==="once"){const[m,_]=t.schedule_value.split(" "),[k,D,S]=m.split("-").map(Number),[L,A]=(_||"00:00").split(":").map(Number),N=c.toLocaleString("en-US",{timeZone:h}),$=new Date(N),U=new Date($);U.setFullYear(k,D-1,S),U.setHours(L,A,0,0);const ke=new Date(U.toLocaleString("en-US",{timeZone:"UTC"})),ee=new Date(U.toLocaleString("en-US",{timeZone:h})),Se=ke.getTime()-ee.getTime();f=new Date(U.getTime()+Se)}else f=new Date(c.getTime()+3600*1e3);return await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
`)}case"get_system_status":{const c=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),f=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),m=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),_=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||""),f=t.spreadsheet_id;let h=t.range;const m=await c.sheets.getMetadata(f),_=m.sheets;h.includes("!")||(h=`${_[0]}!${h}`);let k;try{k=await c.sheets.readRange(f,h)}catch(S){if((g=S.message)!=null&&g.includes("Unable to parse range")||(y=S.message)!=null&&y.includes("400")){const L=h.includes("!")?h.split("!")[1]:h;h=`${_[0]}!${L}`,k=await c.sheets.readRange(f,h)}else throw S}let D=`[Spreadsheet: "${m.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(S=>`"${S}"`).join(", ")}]
`;return _.length>1&&(D+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),k.length===0?D+"No data found in the specified range.":D+k.map(S=>S.join("	| ")).join(`
`)}catch(c){return await O(a,r,"google","read_sheet",c.message),`Failed to read sheet: ${c.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new Z(a,r,n,s||"",i||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await O(a,r,"google","write_sheet",c.message),`Failed to write sheet: ${c.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new Z(a,r,n,s||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await O(a,r,"google","append_sheet",c.message),`Failed to append to sheet: ${c.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const h=await c.sheets.createSpreadsheet(t.title,t.sheet_names);let m="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||"");m=`
Folder: "${(await Pt(_,h.spreadsheetId,t.folder_name)).folderName}"`}catch(_){m=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new he(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${m}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(c){return await O(a,r,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||""),f=t.calendar_id||"primary",h=t.days_ahead||7,m=new Date,_=new Date(m.getTime()+h*24*60*60*1e3),k=await c.calendar.listEvents(f,{timeMin:m.toISOString(),timeMax:_.toISOString(),query:t.query});return k.length===0?`No events found in the next ${h} days.`:k.map(D=>{var $;const S=D.start.dateTime||D.start.date||"TBD",L=D.end.dateTime||D.end.date||"",A=D.location?` 📍 ${D.location}`:"",N=(($=D.attendees)==null?void 0:$.map(U=>U.email).join(", "))||"";return`• ${D.summary} — ${S} to ${L}${A}${N?`
  Attendees: ${N}`:""}`}).join(`
...
ID: ${h.id}
Start: ${h.start.dateTime||h.start.date}`}catch(c){return await O(a,r,"google","create_event",c.message),`Failed to create event: ${c.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const h=await c.docs.createDocument(t.title);t.content&&await c.docs.appendText(h.documentId,t.content);let m="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||"");m=`
Folder: "${(await Pt(_,h.documentId,t.folder_name)).folderName}"`}catch(_){m=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new he(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}return`Document created: "${t.title}"${m}
ID: ${h.documentId}
...
`)}catch(c){return await O(a,r,"gmail","search",c.message),`Gmail search error: ${c.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${f.id}]`}catch(c){return await O(a,r,"gmail","send",c.message),`Gmail send error: ${c.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${f.id}]`}catch(c){return await O(a,r,"gmail","draft",c.message),`Gmail draft error: ${c.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ae(a,r,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(c){return await O(a,r,"gmail","modify",c.message),`Gmail modify error: ${c.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").getUnreadCount();return`You have ${f} unread email${f!==1?"s":""} in Gmail.`}catch(c){return(x=c.message)!=null&&x.includes("not connected")?c.message:`Gmail error: ${c.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||""),f=new URLSearchParams;f.set("pageSize",String(t.max_results||10)),f.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),f.set("orderBy","modifiedTime desc");let h="";t.folder_id?h=`'${t.folder_id}' in parents and trashed = false`:t.query?h=`${t.query} and trashed = false`:h="trashed = false",f.set("q",h);const m=await fetch(`https://www.googleapis.com/drive/v3/files?${f}`,{headers:{Authorization:`Bearer ${c}`}});if(!m.ok)throw new Error(`Drive API error (${m.status})`);const _=await m.json();return(w=_.files)!=null&&w.length?_.files.map((k,D)=>{var N,$;const S=((N=k.mimeType)==null?void 0:N.split(".").pop())||k.mimeType,L=k.size?`${(parseInt(k.size)/1024).toFixed(1)} KB`:"",A=(($=k.modifiedTime)==null?void 0:$.split("T")[0])||"";return`${D+1}. **${k.name}** (${S})
   ${L} · Modified: ${A}
   ${k.webViewLink||""}`}).join(`

`):"No files found."}catch(c){return await O(a,r,"google","drive_list",c.message),`Drive list error: ${c.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||""),f=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,h=new URLSearchParams;h.set("q",f),h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");const m=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${c}`}});if(!m.ok)throw new Error(`Drive API error (${m.status})`);const _=await m.json();return(E=_.files)!=null&&E.length?_.files.map((k,D)=>{var A,N;const S=((A=k.mimeType)==null?void 0:A.split(".").pop())||k.mimeType,L=((N=k.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${D+1}. **${k.name}** (${S}) — Modified: ${L}
   ${k.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(c){return await O(a,r,"google","drive_search",c.message),`Drive search error: ${c.message}`}}case"web_search":try{const c=await Ct(t.query,{num:t.num_results||5,site:t.site});return c.error?`Web search failed: ${c.error}`:c.results.length===0?`No results found for "${t.query}".`:c.results.map((f,h)=>`${h+1}. **${f.title}**
   ${f.link}
   ${f.snippet}`).join(`

`)}catch(c){return await O(a,r,"search","web_search",c.message),`Web search error: ${c.message}`}case"read_url":try{const c=t.url;if(!c||!c.startsWith("http://")&&!c.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const f=Math.min(t.max_length||8e3,15e3),{fetchPageContent:h}=await Promise.resolve().then(()=>qr),m=await h(c,f);return m.error?`Failed to read page: ${m.error}`:!m.text||m.text.length<20?`Page at ${c} returned no readable content.`:`Content from ${c} (${m.text.length} chars):

${m.text}`}catch(c){return await O(a,r,"search","read_url",c.message),`Read URL error: ${c.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const c=await Ca(t.query,u,{depth:t.depth||"quick",site:t.site});if(c.error)return`Research failed: ${c.error}`;let f=c.report;return c.sources.length>0&&(f+=`

---
**Sources** (`+c.pagesRead+` pages read):
`,f+=c.sources.map((h,m)=>`[${m+1}] ${h.title}
    ${h.url}`).join(`
`)),f}catch(c){return await O(a,r,"research","research",c.message),`Research error: ${c.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const f=await M(c.encrypted_value,n),h=await $r(f,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((m,_)=>{const k=m.rating?` ★${m.rating} (${m.userRatingsTotal||0} reviews)`:"",D=m.openNow!==void 0?m.openNow?" · Open now":" · Closed":"",S=m.googleMapsUri?`
   ${m.googleMapsUri}`:"";return`${_+1}. **${m.name}**${k}${D}
   ${m.address}${S}
   [place_id: ${m.placeId}]`}).join(`

`)}catch(c){return await O(a,r,"google_api","search_places",c.message),`Places search error: ${c.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Mr(f,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const m=h.details;let _=`**${m.name}**
...
Recent Reviews:`;for(const k of m.reviews)_+=`
— ${k.author} (★${k.rating}, ${k.time}): "${k.text}"`}return _}catch(c){return await O(a,r,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await jr(f,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const m=h.route;let _=`**${m.startAddress}** → **${m.endAddress}**
`;return _+=`📏 ${m.distance} · ⏱️ ${m.duration}`,m.durationInTraffic&&(_+=` (with traffic: ${m.durationInTraffic})`),_+=`
via ${m.summary}`,_+=`

Steps:`,m.steps.forEach((k,D)=>{_+=`
${D+1}. ${k.instruction} (${k.distance}, ${k.duration})`}),_}catch(c){return await O(a,r,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Ur(f,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let m=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(m+=` (with traffic: ${h.durationInTraffic})`),m}catch(c){return await O(a,r,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Br(f,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(c){return await O(a,r,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Hr(f,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((m,_)=>{var k;return`${_+1}. **${m.title}**
   ${m.channelTitle} · ${((k=m.publishedAt)==null?void 0:k.split("T")[0])||""}
   ${m.description}
   ${m.url}`}).join(`

`)}catch(c){return await O(a,r,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Pr(f,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((m,_)=>`${_+1}. ${m.address}
   Coordinates: ${m.lat}, ${m.lng}`).join(`
`)}catch(c){return await O(a,r,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function Ot(e,t,a,r,n,s){var x;const i=new he(t),o=(x=e.metadata)==null?void 0:x.thread_id,l=await i.buildContext(r.id),d=await i.getRecentConversations(r.id,25,o),p=[{role:"system",content:Aa(r,l)},...d.map(w=>({role:w.role,content:w.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const g=10;let y="",v=0;for(let w=0;w<g;w++)try{const E=await a.chat(p,{tools:Ra});if(E.usage&&(v+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){E.content&&p.push({role:"assistant",content:E.content});for(const c of E.toolCalls)try{const f=await La(c.name,c.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);p.push({role:"user",content:`[Tool Result for ${c.name}]: ${f}`})}catch(f){await O(t,r.id,"tool",c.name,f.message||"Tool execution failed"),p.push({role:"user",content:`[Tool Error for ${c.name}]: ${f.message||"Execution failed"}`})}continue}y=E.content;break}catch(E){if(n){const c=E.message||"",f=c.includes("401")||c.includes("403")||c.includes("authentication")||c.includes("credit balance"),h=c.includes("429"),m=f?1440:h?10:5;await n.recordError(a.name,c,m)}throw await O(t,r.id,"llm","provider_error",E.message||"Unknown LLM error",{provider:a.name,turn:w}),E}if(n&&v>0)try{await n.recordUsage(a.name,v)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",y,"{}",o),await i.compactHistory(r.id,30),y}const Ht={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Vr(e){for(const[t,a]of Object.entries(Ht))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Ht.default}function Xr(e,t,a,r){const n=Vr(r),s=Math.floor(n*.75),i=[];let o=0,l=!1;const d=vt(e);i.push({role:"system",content:e}),o+=d;const u=vt(a);o+=u;const p=s-o,g=[];let y=0;for(let v=t.length-1;v>=0;v--){const x=t[v],w=vt(x.content);if(y+w<=p)g.unshift({role:x.role,content:x.content}),y+=w;else{l=!0;break}}return i.push(...g),i.push({role:"user",content:a}),o+=y,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*Zr(e,t,a,r,n,s){var w;const i=new he(t),o=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:o,provider:a.name}};const l=await i.buildContext(r.id),d=await i.getRecentConversations(r.id,20,o),u=Aa(r,l),p=Xr(u,d,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const g=10;let y="",v=0;const x=[...p.messages];for(let E=0;E<g;E++)try{E>0&&(yield{type:"thinking",data:{threadId:o}});const c=await a.chat(x,{tools:Ra});if(c.usage&&(v+=c.usage.promptTokens+c.usage.completionTokens),c.toolCalls&&c.toolCalls.length>0){c.content&&(yield{type:"chunk",data:{text:c.content,threadId:o}},x.push({role:"assistant",content:c.content}));for(const h of c.toolCalls){yield{type:"tool_start",data:{tool:h.name,toolArgs:h.arguments,threadId:o}};try{const m=await La(h.name,h.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:h.name,toolResult:m.substring(0,500)+(m.length>500?"...":""),threadId:o}},x.push({role:"user",content:`[Tool Result for ${h.name}]: ${m}`})}catch(m){await O(t,r.id,"tool",h.name,m.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:h.name,toolResult:`Error: ${m.message||"Execution failed"}`,threadId:o}},x.push({role:"user",content:`[Tool Error for ${h.name}]: ${m.message||"Execution failed"}`})}}continue}y=c.content;const f=50;for(let h=0;h<y.length;h+=f)yield{type:"chunk",data:{text:y.substring(h,h+f),threadId:o}},h+f<y.length&&await new Promise(_=>setTimeout(_,10));break}catch(c){if(n){const f=c.message||"",h=f.includes("401")||f.includes("403")||f.includes("authentication")||f.includes("credit balance"),m=f.includes("429"),_=h?1440:m?10:5;await n.recordError(a.name,f,_)}await O(t,r.id,"llm","provider_error",c.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:c.message||"An error occurred",threadId:o}};return}if(n&&v>0)try{await n.recordUsage(a.name,v)}catch{}await i.storeMessage(r.id,e.channel,"assistant",y,"{}",o),await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:v}}}const j=new ge;async function Qr(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}j.use("/*",Qr);j.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const d of s)i+=`- ${d.name} (${d.type}, ${Math.round(d.size/1024)}KB, file_id: ${d.file_id})`,d.text_preview&&(i+=`
  Preview: ${d.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=n;if(!o){const d=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=d==null?void 0:d.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:d,rotation:u}=await et(e.env.DB,t.id,t.pin_hash),p=new ReadableStream({async start(g){const y=new TextEncoder;try{const v=Zr(l,e.env.DB,d,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of v)x.data.threadId||(x.data.threadId=o),g.enqueue(y.encode(Ut(x)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),g.close()}catch(v){const x={type:"error",data:{error:v.message||"An error occurred",threadId:o}};g.enqueue(y.encode(Ut(x))),g.close()}}});return new Response(p,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(d){console.error("Stream setup error:",d);const u=d.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:o},500)}});j.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
Status: ✅ Online`;await z(a,t,u)}catch{await z(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await z(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await z(a,t,"⚠️ Account not linked."),!0);default:return!1}}tt.post("/webhook",async e=>{var t,a,r,n,s;try{const i=await e.req.json();if(i.callback_query)return await dn(e.env.DB,i.callback_query),e.json({ok:!0});const o=i.message;if(!o)return e.json({ok:!0});const l=!!o.text,d=!!o.voice,u=!!o.document,p=!!o.photo,g=!!o.caption;if(!l&&!d&&!u&&!p)return e.json({ok:!0});const y=String(o.chat.id);let v=o.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(y).first();let w=null;if(x){const m=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();m&&(w=await M(m.encrypted_value,x.pin_hash))}if(!w){const m=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();m&&(w=await M(m.encrypted_value,m.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(v.startsWith("/")&&await ln(v,y,w,x,e.env.DB))return e.json({ok:!0});if(!x)return await z(w,y,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${y}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(o.voice&&w&&x)try{await z(w,y,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${o.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const D=await(await fetch(`https://api.telegram.org/file/bot${w}/${_.result.file_path}`)).blob();let S="",L="",A="whisper-1";const N=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const ee of N.results){const Se=await M(ee.encrypted_value,x.pin_hash);if(ee.service==="openai"){S="https://api.openai.com/v1/audio/transcriptions",L=Se;break}else if(ee.service.startsWith("llm_slot_"))try{const Ie=JSON.parse(Se);if(Ie.provider==="openai"){S="https://api.openai.com/v1/audio/transcriptions",L=Ie.apiKey;break}else if(Ie.provider==="groq"){S="https://api.groq.com/openai/v1/audio/transcriptions",L=Ie.apiKey,A="whisper-large-v3";break}}catch{}}if(!S)return await z(w,y,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const $=new FormData;$.append("file",D,"voice.ogg"),$.append("model",A);const U=await fetch(S,{method:"POST",headers:{Authorization:`Bearer ${L}`},body:$});if(!U.ok){const ee=await U.text();return await z(w,y,`⚠️ Transcription failed: ${U.status} ${ee}`),e.json({ok:!0})}v=(await U.json()).text,await z(w,y,`🗣️ *You said:* ${v}`)}}catch(m){return await z(w,y,`⚠️ Failed to process voice note: ${m.message}`),e.json({ok:!0})}if((u||p)&&w&&x)try{let m,_="unknown",k="unknown",D=0;if(u)m=o.document.file_id,_=o.document.file_name||"document",k=o.document.mime_type||"unknown",D=o.document.file_size||0;else if(p){const S=o.photo[o.photo.length-1];m=S.file_id,_="photo.jpg",k="image/jpeg",D=S.file_size||0}if(m){const L=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${m}`)).json();let A="";if(L.ok&&((a=L.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(_)||/^text\/|application\/json|application\/xml|application\/csv/i.test(k))&&D<5e4)try{A=await(await fetch(`https://api.telegram.org/file/bot${w}/${L.result.file_path}`)).text()}catch{}const N=o.caption||"",$=`[Telegram file received: "${_}" (${k}, ${Math.round(D/1024)}KB)]`;A?v=`${N?N+`
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(m){if(g&&o.caption)v=o.caption;else return await z(w,y,`⚠️ Received your file but couldn't process it: ${m.message}`),e.json({ok:!0})}if(!v)return e.json({ok:!0});await sn(w,y);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const c=an(x.id,x.username,v,y);c.metadata={thread_id:E.id};let f,h;try{const m=await et(e.env.DB,x.id,x.pin_hash);f=m.provider,h=m.rotation}catch(m){console.error("Telegram provider setup error:",m);const _=(r=m.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=m.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${m.message||"Unknown error"}`;return await z(w,y,_),e.json({ok:!0})}try{const m=await Ot(c,e.env.DB,f,x,h,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),_=rn(m,"telegram");await z(w,y,_||"(empty response)")}catch(m){console.error("Telegram agent error:",m);const _=(s=m.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${f.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(m.message||"Unknown").substring(0,200)}`;await z(w,y,_);try{const{logError:k}=await Promise.resolve().then(()=>xt);await k(e.env.DB,x.id,"telegram","agent_error",m.message||"Agent error",{provider:f.name})}catch{}}return e.json({ok:!0})}catch(i){console.error("Telegram webhook error:",i);try{const{logError:o}=await Promise.resolve().then(()=>xt);await o(e.env.DB,null,"telegram","webhook_error",i.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:i.message})}});tt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
