var Qr=Object.defineProperty;var jn=e=>{throw TypeError(e)};var ea=(e,t,n)=>t in e?Qr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var P=(e,t,n)=>ea(e,typeof t!="symbol"?t+"":t,n),an=(e,t,n)=>t.has(e)||jn("Cannot "+n);var x=(e,t,n)=>(an(e,t,"read from private field"),n?n.call(e):t.get(e)),V=(e,t,n)=>t.has(e)?jn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),F=(e,t,n,s)=>(an(e,t,"write to private field"),s?s.call(e,n):t.set(e,n),n),ne=(e,t,n)=>(an(e,t,"access private method"),n);var Un=(e,t,n,s)=>({set _(r){F(e,t,r,n)},get _(){return x(e,t,s)}});var Hn=(e,t,n)=>(s,r)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&r||void 0,d)try{l=await d(s,()=>i(o+1))}catch(u){if(u instanceof Error&&t)s.error=u,l=await t(u,s),c=!0;else throw u}else s.finalized===!1&&n&&(l=await n(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},ta=Symbol(),na=async(e,t=Object.create(null))=>{const{all:n=!1,dot:s=!1}=t,a=(e instanceof Ss?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?sa(e,{all:n,dot:s}):{}};async function sa(e,t){const n=await e.formData();return n?ra(n,t):{}}function ra(e,t){const n=Object.create(null);return e.forEach((s,r)=>{t.all||r.endsWith("[]")?aa(n,r,s):n[r]=s}),t.dot&&Object.entries(n).forEach(([s,r])=>{s.includes(".")&&(ia(n,s,r),delete n[s])}),n}var aa=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},ia=(e,t,n)=>{let s=e;const r=t.split(".");r.forEach((a,i)=>{i===r.length-1?s[a]=n:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},ws=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},oa=e=>{const{groups:t,path:n}=la(e),s=ws(n);return ca(s,t)},la=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,s)=>{const r=`@${s}`;return t.push([r,n]),r}),{groups:t,path:e}},ca=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[s]=t[n];for(let r=e.length-1;r>=0;r--)if(e[r].includes(s)){e[r]=e[r].replace(s,t[n][1]);break}}return e},qt={},da=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const s=`${e}#${t}`;return qt[s]||(n[2]?qt[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:qt[s]=[e,n[1],!0]),qt[s]}return null},Tn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},ua=e=>Tn(e,decodeURI),bs=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let s=n;for(;s<t.length;s++){const r=t.charCodeAt(s);if(r===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return ua(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(n,s)},ma=e=>{const t=bs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},mt=(e,t,...n)=>(n.length&&(t=mt(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),_s=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let s="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))s+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){n.length===0&&s===""?n.push("/"):n.push(s);const a=r.replace("?","");s+="/"+a,n.push(s)}else s+="/"+r}),n.filter((r,a,i)=>i.indexOf(r)===a)},on=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Tn(e,Ts):e):e,Es=(e,t,n)=>{let s;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return on(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const r={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(l=on(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=on(c))),n?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(c)):r[l]??(r[l]=c)}return t?r[t]:r},pa=Es,ha=(e,t)=>Es(e,t,!0),Ts=decodeURIComponent,Fn=e=>Tn(e,Ts),ft,we,$e,xs,ks,hn,Be,ps,Ss=(ps=class{constructor(e,t="/",n=[[]]){V(this,$e);P(this,"raw");V(this,ft);V(this,we);P(this,"routeIndex",0);P(this,"path");P(this,"bodyCache",{});V(this,Be,e=>{const{bodyCache:t,raw:n}=this,s=t[e];if(s)return s;const r=Object.keys(t)[0];return r?t[r].then(a=>(r==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,F(this,we,n),F(this,ft,{})}param(e){return e?ne(this,$e,xs).call(this,e):ne(this,$e,ks).call(this)}query(e){return pa(this.url,e)}queries(e){return ha(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,s)=>{t[s]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await na(this,e))}json(){return x(this,Be).call(this,"text").then(e=>JSON.parse(e))}text(){return x(this,Be).call(this,"text")}arrayBuffer(){return x(this,Be).call(this,"arrayBuffer")}blob(){return x(this,Be).call(this,"blob")}formData(){return x(this,Be).call(this,"formData")}addValidatedData(e,t){x(this,ft)[e]=t}valid(e){return x(this,ft)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ta](){return x(this,we)}get matchedRoutes(){return x(this,we)[0].map(([[,e]])=>e)}get routePath(){return x(this,we)[0].map(([[,e]])=>e)[this.routeIndex].path}},ft=new WeakMap,we=new WeakMap,$e=new WeakSet,xs=function(e){const t=x(this,we)[0][this.routeIndex][1][e],n=ne(this,$e,hn).call(this,t);return n&&/\%/.test(n)?Fn(n):n},ks=function(){const e={},t=Object.keys(x(this,we)[0][this.routeIndex][1]);for(const n of t){const s=ne(this,$e,hn).call(this,x(this,we)[0][this.routeIndex][1][n]);s!==void 0&&(e[n]=/\%/.test(s)?Fn(s):s)}return e},hn=function(e){return x(this,we)[1]?x(this,we)[1][e]:e},Be=new WeakMap,ps),ga={Stringify:1},Ds=async(e,t,n,s,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(r?r[0]+=e:r=[e],Promise.all(a.map(o=>o({phase:t,buffer:r,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Ds(l,t,!1,s,r))).then(()=>r[0]))):Promise.resolve(e)},fa="text/plain; charset=UTF-8",ln=(e,t)=>({"Content-Type":e,...t}),Mt,$t,Ce,yt,Ae,ve,Pt,vt,wt,tt,Bt,jt,je,pt,hs,ya=(hs=class{constructor(e,t){V(this,je);V(this,Mt);V(this,$t);P(this,"env",{});V(this,Ce);P(this,"finalized",!1);P(this,"error");V(this,yt);V(this,Ae);V(this,ve);V(this,Pt);V(this,vt);V(this,wt);V(this,tt);V(this,Bt);V(this,jt);P(this,"render",(...e)=>(x(this,vt)??F(this,vt,t=>this.html(t)),x(this,vt).call(this,...e)));P(this,"setLayout",e=>F(this,Pt,e));P(this,"getLayout",()=>x(this,Pt));P(this,"setRenderer",e=>{F(this,vt,e)});P(this,"header",(e,t,n)=>{this.finalized&&F(this,ve,new Response(x(this,ve).body,x(this,ve)));const s=x(this,ve)?x(this,ve).headers:x(this,tt)??F(this,tt,new Headers);t===void 0?s.delete(e):n!=null&&n.append?s.append(e,t):s.set(e,t)});P(this,"status",e=>{F(this,yt,e)});P(this,"set",(e,t)=>{x(this,Ce)??F(this,Ce,new Map),x(this,Ce).set(e,t)});P(this,"get",e=>x(this,Ce)?x(this,Ce).get(e):void 0);P(this,"newResponse",(...e)=>ne(this,je,pt).call(this,...e));P(this,"body",(e,t,n)=>ne(this,je,pt).call(this,e,t,n));P(this,"text",(e,t,n)=>!x(this,tt)&&!x(this,yt)&&!t&&!n&&!this.finalized?new Response(e):ne(this,je,pt).call(this,e,t,ln(fa,n)));P(this,"json",(e,t,n)=>ne(this,je,pt).call(this,JSON.stringify(e),t,ln("application/json",n)));P(this,"html",(e,t,n)=>{const s=r=>ne(this,je,pt).call(this,r,t,ln("text/html; charset=UTF-8",n));return typeof e=="object"?Ds(e,ga.Stringify,!1,{}).then(s):s(e)});P(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});P(this,"notFound",()=>(x(this,wt)??F(this,wt,()=>new Response),x(this,wt).call(this,this)));F(this,Mt,e),t&&(F(this,Ae,t.executionCtx),this.env=t.env,F(this,wt,t.notFoundHandler),F(this,jt,t.path),F(this,Bt,t.matchResult))}get req(){return x(this,$t)??F(this,$t,new Ss(x(this,Mt),x(this,jt),x(this,Bt))),x(this,$t)}get event(){if(x(this,Ae)&&"respondWith"in x(this,Ae))return x(this,Ae);throw Error("This context has no FetchEvent")}get executionCtx(){if(x(this,Ae))return x(this,Ae);throw Error("This context has no ExecutionContext")}get res(){return x(this,ve)||F(this,ve,new Response(null,{headers:x(this,tt)??F(this,tt,new Headers)}))}set res(e){if(x(this,ve)&&e){e=new Response(e.body,e);for(const[t,n]of x(this,ve).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=x(this,ve).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of s)e.headers.append("set-cookie",r)}else e.headers.set(t,n)}F(this,ve,e),this.finalized=!0}get var(){return x(this,Ce)?Object.fromEntries(x(this,Ce)):{}}},Mt=new WeakMap,$t=new WeakMap,Ce=new WeakMap,yt=new WeakMap,Ae=new WeakMap,ve=new WeakMap,Pt=new WeakMap,vt=new WeakMap,wt=new WeakMap,tt=new WeakMap,Bt=new WeakMap,jt=new WeakMap,je=new WeakSet,pt=function(e,t,n){const s=x(this,ve)?new Headers(x(this,ve).headers):x(this,tt)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??x(this,yt);return new Response(e,{status:r,headers:s})},hs),ue="ALL",va="all",wa=["get","post","put","delete","options","patch"],Rs="Can not add a route since the matcher is already built.",Os=class extends Error{},ba="__COMPOSED_HANDLER",_a=e=>e.text("404 Not Found",404),Gn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},Ee,me,Ns,Te,Qe,zt,Kt,bt,Ea=(bt=class{constructor(t={}){V(this,me);P(this,"get");P(this,"post");P(this,"put");P(this,"delete");P(this,"options");P(this,"patch");P(this,"all");P(this,"on");P(this,"use");P(this,"router");P(this,"getPath");P(this,"_basePath","/");V(this,Ee,"/");P(this,"routes",[]);V(this,Te,_a);P(this,"errorHandler",Gn);P(this,"onError",t=>(this.errorHandler=t,this));P(this,"notFound",t=>(F(this,Te,t),this));P(this,"fetch",(t,...n)=>ne(this,me,Kt).call(this,t,n[1],n[0],t.method));P(this,"request",(t,n,s,r)=>t instanceof Request?this.fetch(n?new Request(t,n):t,s,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${mt("/",t)}`,n),s,r)));P(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(ne(this,me,Kt).call(this,t.request,t,void 0,t.request.method))})});[...wa,va].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?F(this,Ee,i):ne(this,me,Qe).call(this,a,x(this,Ee),i),o.forEach(l=>{ne(this,me,Qe).call(this,a,x(this,Ee),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){F(this,Ee,l);for(const c of[a].flat())o.map(d=>{ne(this,me,Qe).call(this,c.toUpperCase(),x(this,Ee),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?F(this,Ee,a):(F(this,Ee,"*"),i.unshift(a)),i.forEach(o=>{ne(this,me,Qe).call(this,ue,x(this,Ee),o)}),this);const{strict:s,...r}=t;Object.assign(this,r),this.getPath=s??!0?t.getPath??bs:ma}route(t,n){const s=this.basePath(t);return n.routes.map(r=>{var i;let a;n.errorHandler===Gn?a=r.handler:(a=async(o,l)=>(await Hn([],n.errorHandler)(o,()=>r.handler(o,l))).res,a[ba]=r.handler),ne(i=s,me,Qe).call(i,r.method,r.path,a)}),this}basePath(t){const n=ne(this,me,Ns).call(this);return n._basePath=mt(this._basePath,t),n}mount(t,n,s){let r,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?r=l=>l:r=s.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};r||(r=(()=>{const l=mt(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(r(l.req.raw),...i(l));if(d)return d;await c()};return ne(this,me,Qe).call(this,ue,mt(t,"*"),o),this}},Ee=new WeakMap,me=new WeakSet,Ns=function(){const t=new bt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,Te,x(this,Te)),t.routes=this.routes,t},Te=new WeakMap,Qe=function(t,n,s){t=t.toUpperCase(),n=mt(this._basePath,n);const r={basePath:this._basePath,path:n,method:t,handler:s};this.router.add(t,n,[s,r]),this.routes.push(r)},zt=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},Kt=function(t,n,s,r){if(r==="HEAD")return(async()=>new Response(null,await ne(this,me,Kt).call(this,t,n,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(r,a),o=new ya(t,{path:a,matchResult:i,env:s,executionCtx:n,notFoundHandler:x(this,Te)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await x(this,Te).call(this,o)})}catch(d){return ne(this,me,zt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:x(this,Te).call(this,o))).catch(d=>ne(this,me,zt).call(this,d,o)):c??x(this,Te).call(this,o)}const l=Hn(i[0],this.errorHandler,x(this,Te));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return ne(this,me,zt).call(this,c,o)}})()},bt),Is=[];function Ta(e,t){const n=this.buildAllMatchers(),s=((r,a)=>{const i=n[r]||n[ue],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],Is];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=s,s(e,t)}var Vt="[^/]+",Rt=".*",Ot="(?:|/.*)",ht=Symbol(),Sa=new Set(".\\+*[^]$()");function xa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Rt||e===Ot?1:t===Rt||t===Ot?-1:e===Vt?1:t===Vt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var nt,st,Se,it,ka=(it=class{constructor(){V(this,nt);V(this,st);V(this,Se,Object.create(null))}insert(t,n,s,r,a){if(t.length===0){if(x(this,nt)!==void 0)throw ht;if(a)return;F(this,nt,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Rt]:["","",Vt]:i==="/*"?["","",Ot]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||Vt;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ht;if(c=x(this,Se)[u],!c){if(Object.keys(x(this,Se)).some(p=>p!==Rt&&p!==Ot))throw ht;if(a)return;c=x(this,Se)[u]=new it,d!==""&&F(c,st,r.varIndex++)}!a&&d!==""&&s.push([d,x(c,st)])}else if(c=x(this,Se)[i],!c){if(Object.keys(x(this,Se)).some(d=>d.length>1&&d!==Rt&&d!==Ot))throw ht;if(a)return;c=x(this,Se)[i]=new it}c.insert(o,n,s,r,a)}buildRegExpStr(){const n=Object.keys(x(this,Se)).sort(xa).map(s=>{const r=x(this,Se)[s];return(typeof x(r,st)=="number"?`(${s})@${x(r,st)}`:Sa.has(s)?`\\${s}`:s)+r.buildRegExpStr()});return typeof x(this,nt)=="number"&&n.unshift(`#${x(this,nt)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},nt=new WeakMap,st=new WeakMap,Se=new WeakMap,it),Zt,Ut,gs,Da=(gs=class{constructor(){V(this,Zt,{varIndex:0});V(this,Ut,new ka)}insert(e,t,n){const s=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return r[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,r[i][1]);break}}return x(this,Ut).insert(a,t,s,x(this,Zt),n),s}buildRegExp(){let e=x(this,Ut).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,s]}},Zt=new WeakMap,Ut=new WeakMap,gs),Ra=[/^$/,[],Object.create(null)],Yt=Object.create(null);function Cs(e){return Yt[e]??(Yt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function Oa(){Yt=Object.create(null)}function Na(e){var c;const t=new Da,n=[];if(e.length===0)return Ra;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[p,g])=>d?1:p?-1:u.length-g.length),r=Object.create(null);for(let d=0,u=-1,p=s.length;d<p;d++){const[g,f,b]=s[d];g?r[f]=[b.map(([T])=>[T,Object.create(null)]),Is]:u++;let w;try{w=t.insert(f,u,g)}catch(T){throw T===ht?new Os(f):T}g||(n[u]=b.map(([T,S])=>{const R=Object.create(null);for(S-=1;S>=0;S--){const[O,M]=w[S];R[O]=M}return[T,R]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let p=0,g=n[d].length;p<g;p++){const f=(c=n[d][p])==null?void 0:c[1];if(!f)continue;const b=Object.keys(f);for(let w=0,T=b.length;w<T;w++)f[b[w]]=o[f[b[w]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,r]}function lt(e,t){if(e){for(const n of Object.keys(e).sort((s,r)=>r.length-s.length))if(Cs(n).test(t))return[...e[n]]}}var Ue,He,Xt,As,fs,Ia=(fs=class{constructor(){V(this,Xt);P(this,"name","RegExpRouter");V(this,Ue);V(this,He);P(this,"match",Ta);F(this,Ue,{[ue]:Object.create(null)}),F(this,He,{[ue]:Object.create(null)})}add(e,t,n){var o;const s=x(this,Ue),r=x(this,He);if(!s||!r)throw new Error(Rs);s[e]||[s,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ue]).forEach(c=>{l[e][c]=[...l[ue][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Cs(t);e===ue?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=lt(s[c],t)||lt(s[ue],t)||[])}):(o=s[e])[t]||(o[t]=lt(s[e],t)||lt(s[ue],t)||[]),Object.keys(s).forEach(c=>{(e===ue||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([n,a])})}),Object.keys(r).forEach(c=>{(e===ue||e===c)&&Object.keys(r[c]).forEach(d=>l.test(d)&&r[c][d].push([n,a]))});return}const i=_s(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(r).forEach(u=>{var p;(e===ue||e===u)&&((p=r[u])[d]||(p[d]=[...lt(s[u],d)||lt(s[ue],d)||[]]),r[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(x(this,He)).concat(Object.keys(x(this,Ue))).forEach(t=>{e[t]||(e[t]=ne(this,Xt,As).call(this,t))}),F(this,Ue,F(this,He,void 0)),Oa(),e}},Ue=new WeakMap,He=new WeakMap,Xt=new WeakSet,As=function(e){const t=[];let n=e===ue;return[x(this,Ue),x(this,He)].forEach(s=>{const r=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];r.length!==0?(n||(n=!0),t.push(...r)):e!==ue&&t.push(...Object.keys(s[ue]).map(a=>[a,s[ue][a]]))}),n?Na(t):null},fs),Fe,Le,ys,Ca=(ys=class{constructor(e){P(this,"name","SmartRouter");V(this,Fe,[]);V(this,Le,[]);F(this,Fe,e.routers)}add(e,t,n){if(!x(this,Le))throw new Error(Rs);x(this,Le).push([e,t,n])}match(e,t){if(!x(this,Le))throw new Error("Fatal error");const n=x(this,Fe),s=x(this,Le),r=n.length;let a=0,i;for(;a<r;a++){const o=n[a];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof Os)continue;throw l}this.match=o.match.bind(o),F(this,Fe,[o]),F(this,Le,void 0);break}if(a===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(x(this,Le)||x(this,Fe).length!==1)throw new Error("No active router has been determined yet.");return x(this,Fe)[0]}},Fe=new WeakMap,Le=new WeakMap,ys),xt=Object.create(null),Ge,fe,rt,_t,pe,Me,et,Et,Aa=(Et=class{constructor(t,n,s){V(this,Me);V(this,Ge);V(this,fe);V(this,rt);V(this,_t,0);V(this,pe,xt);if(F(this,fe,s||Object.create(null)),F(this,Ge,[]),t&&n){const r=Object.create(null);r[t]={handler:n,possibleKeys:[],score:0},F(this,Ge,[r])}F(this,rt,[])}insert(t,n,s){F(this,_t,++Un(this,_t)._);let r=this;const a=oa(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=da(c,d),p=Array.isArray(u)?u[0]:c;if(p in x(r,fe)){r=x(r,fe)[p],u&&i.push(u[1]);continue}x(r,fe)[p]=new Et,u&&(x(r,rt).push(u),i.push(u[1])),r=x(r,fe)[p]}return x(r,Ge).push({[t]:{handler:s,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:x(this,_t)}}),r}search(t,n){var l;const s=[];F(this,pe,xt);let a=[this];const i=ws(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],p=c===d-1,g=[];for(let f=0,b=a.length;f<b;f++){const w=a[f],T=x(w,fe)[u];T&&(F(T,pe,x(w,pe)),p?(x(T,fe)["*"]&&s.push(...ne(this,Me,et).call(this,x(T,fe)["*"],t,x(w,pe))),s.push(...ne(this,Me,et).call(this,T,t,x(w,pe)))):g.push(T));for(let S=0,R=x(w,rt).length;S<R;S++){const O=x(w,rt)[S],M=x(w,pe)===xt?{}:{...x(w,pe)};if(O==="*"){const A=x(w,fe)["*"];A&&(s.push(...ne(this,Me,et).call(this,A,t,x(w,pe))),F(A,pe,M),g.push(A));continue}const[L,U,Y]=O;if(!u&&!(Y instanceof RegExp))continue;const ee=x(w,fe)[L],re=i.slice(c).join("/");if(Y instanceof RegExp){const A=Y.exec(re);if(A){if(M[U]=A[0],s.push(...ne(this,Me,et).call(this,ee,t,x(w,pe),M)),Object.keys(x(ee,fe)).length){F(ee,pe,M);const K=((l=A[0].match(/\//))==null?void 0:l.length)??0;(o[K]||(o[K]=[])).push(ee)}continue}}(Y===!0||Y.test(u))&&(M[U]=u,p?(s.push(...ne(this,Me,et).call(this,ee,t,M,x(w,pe))),x(ee,fe)["*"]&&s.push(...ne(this,Me,et).call(this,x(ee,fe)["*"],t,M,x(w,pe)))):(F(ee,pe,M),g.push(ee)))}}a=g.concat(o.shift()??[])}return s.length>1&&s.sort((c,d)=>c.score-d.score),[s.map(({handler:c,params:d})=>[c,d])]}},Ge=new WeakMap,fe=new WeakMap,rt=new WeakMap,_t=new WeakMap,pe=new WeakMap,Me=new WeakSet,et=function(t,n,s,r){const a=[];for(let i=0,o=x(t,Ge).length;i<o;i++){const l=x(t,Ge)[i],c=l[n]||l[ue],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),s!==xt||r&&r!==xt))for(let u=0,p=c.possibleKeys.length;u<p;u++){const g=c.possibleKeys[u],f=d[c.score];c.params[g]=r!=null&&r[g]&&!f?r[g]:s[g]??(r==null?void 0:r[g]),d[c.score]=!0}}return a},Et),at,vs,La=(vs=class{constructor(){P(this,"name","TrieRouter");V(this,at);F(this,at,new Aa)}add(e,t,n){const s=_s(t);if(s){for(let r=0,a=s.length;r<a;r++)x(this,at).insert(e,s[r],n);return}x(this,at).insert(e,t,n)}match(e,t){return x(this,at).search(e,t)}},at=new WeakMap,vs),be=class extends Ea{constructor(e={}){super(e),this.router=e.router??new Ca({routers:[new Ia,new La]})}},Ma=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),r=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,p){i.res.headers.set(u,p)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await r(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let p=n.allowHeaders;if(!(p!=null&&p.length)){const g=i.req.header("Access-Control-Request-Headers");g&&(p=g.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function $a(){return`  // === Karna v3.1 Frontend ===
...
`}function Ls(e=""){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`);return a.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:a.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${a.join("<br>")}</p>`}).join("")}</body></html>`}function Jn(e){const t=new TextEncoder().encode(e);let n="";for(let s=0;s<t.length;s++)n+=String.fromCharCode(t[s]);return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Jt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function Vn(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<img[^>]+alt=["']([^"']+)["'][^>]*>/gi,`
$1
`).replace(/<br\s*\/?>/gi,`
`).replace(/<\/t[dh]>/gi,`
`).replace(/<\/p>/gi,`
...
Write a synthesized research report answering the query above.`;try{return(await n.chat([{role:"system",content:a},{role:"user",content:i}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(o){return`Research synthesis error: ${o.message}. Raw search results were found but could not be analyzed.`}}const ki=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:or,fetchPageContent:ir},Symbol.toStringTag,{value:"Module"})),qe="https://api.browser-use.com/api/v2",Qn=2e4,vn=6e3,Di=3e5,Dn=12e3,lr=new Set(["finished","stopped"]);async function It(e,t,n=Dn){const s=new AbortController,r=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}finally{clearTimeout(r)}}async function Ri(e){const t=()=>fetch(`${qe}/sessions`,{method:"POST",headers:{"X-Browser-Use-API-Key":e,"Content-Type":"application/json"},body:JSON.stringify({})});try{let n=await t();if(!n.ok){const r=await n.text().catch(()=>"");if(dr(n.status,r)){if(console.log("[createBrowserSession] concurrency limit — reaping stale sessions and retrying"),await cr(e),n=await t(),!n.ok)return console.log(`[createBrowserSession] FAILED after reap HTTP ${n.status}`),null}else return console.log(`[createBrowserSession] FAILED HTTP ${n.status}: ${r}`),null}const s=await n.json();return console.log(`[createBrowserSession] sessionId=${s.id}`),s.id??null}catch(n){return console.log(`[createBrowserSession] ERROR ${n.message}`),null}}async function nn(e,t){try{await fetch(`${qe}/sessions/${e}`,{method:"DELETE",headers:{"X-Browser-Use-API-Key":t}}),console.log(`[closeBrowserSession] closed sessionId=${e}`)}catch{}}async function Oi(e){try{const t=await It(`${qe}/sessions?filterBy=active&pageSize=100`,{headers:{"X-Browser-Use-API-Key":e}});return t.ok?(await t.json()).items??[]:[]}catch{return[]}}async function cr(e,t){const n=await Oi(e);let s=0;for(const r of n)!r.id||t&&r.id===t||(await nn(r.id,e),s++);return s>0&&console.log(`[reapActiveBrowserSessions] closed ${s} stale session(s)`),s}function dr(e,t){const n=(t||"").toLowerCase();return/session/.test(n)?/concurrent|too many|maximum|limit|exceeded/.test(n):!1}async function ur(e,t,n){var o;const s=(n==null?void 0:n.timeoutMs)??Di;console.log(`[runBrowserTask] starting taskLen=${e.length} timeoutMs=${s} hasSecrets=${!!(n!=null&&n.secrets)} reuseSession=${!!(n!=null&&n.sessionId)}`);let r,a;try{const l={task:e};n!=null&&n.secrets&&Object.keys(n.secrets).length>0&&(l.secrets=n.secrets),n!=null&&n.sessionId&&(l.sessionId=n.sessionId);const c=()=>fetch(`${qe}/tasks`,{method:"POST",headers:{"X-Browser-Use-API-Key":t,"Content-Type":"application/json"},body:JSON.stringify(l)});let d=await c();if(!d.ok){const p=await d.text().catch(()=>"");if(dr(d.status,p)&&(console.log("[runBrowserTask] concurrency limit — reaping stale sessions and retrying"),await cr(t,n==null?void 0:n.sessionId),d=await c()),!d.ok){const g=await d.text().catch(()=>p);return console.log(`[runBrowserTask] CREATE_FAILED HTTP ${d.status}: ${g}`),{output:null,taskId:"",status:"failed",error:`HTTP ${d.status}: ${g}`}}}const u=await d.json();if(r=u.id,a=u.sessionId||void 0,console.log(`[runBrowserTask] CREATED taskId=${r} sessionId=${a}`),!r)return{output:null,taskId:"",status:"failed",error:"No id in create response"}}catch(l){return{output:null,taskId:"",status:"failed",error:l.message}}await new Promise(l=>setTimeout(l,Qn));const i=Date.now()+(s-Qn);for(;Date.now()<i;){try{const l=await It(`${qe}/tasks/${r}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(l.ok){const c=await l.json();if(lr.has(c.status)){if(c.status==="finished"){let d=c.output??null;if(!d)try{const u=await It(`${qe}/tasks/${r}`,{headers:{"X-Browser-Use-API-Key":t}},Dn);if(u.ok){const p=await u.json();if(d=p.output??null,!d&&((o=p.steps)!=null&&o.length)){const g=p.steps[p.steps.length-1];d=g.extracted_content??g.output??g.result??null}}}catch{}return console.log(`[runBrowserTask] COMPLETED taskId=${r} outputLen=${(d??"").length}`),{output:d,taskId:r,sessionId:a,status:"completed"}}return console.log(`[runBrowserTask] FAILED taskId=${r} status=${c.status}`),{output:c.output??null,taskId:r,status:"failed",error:c.output??"Task was stopped before completing"}}}}catch{}await new Promise(l=>setTimeout(l,vn))}return console.log(`[runBrowserTask] TIMEOUT taskId=${r} sessionId=${a}`),{output:null,taskId:r,sessionId:a,status:"timeout"}}async function mr(e,t,n){var a;const s=(n==null?void 0:n.waitMs)??3e4,r=Date.now()+s;for(;Date.now()<r;){try{const i=await It(`${qe}/tasks/${e}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(!i.ok){await new Promise(l=>setTimeout(l,vn));continue}const o=await i.json();if(lr.has(o.status)){let l=null;const c=await It(`${qe}/tasks/${e}`,{headers:{"X-Browser-Use-API-Key":t}},Dn);if(c.ok){const d=await c.json();if(l=d.output??null,!l&&((a=d.steps)!=null&&a.length)){const u=d.steps[d.steps.length-1];l=u.extracted_content??u.output??u.result??null}}else l=o.output??null;return{status:o.status,output:l,done:!0}}}catch{}await new Promise(i=>setTimeout(i,vn))}return{status:"running",output:null,done:!1}}function Ni(e){return`Navigate to https://www.bluedart.com/tracking.
...
- **HARD RULE — no false confirmations**: You have ZERO tool access. You CANNOT set reminders, create schedules, send emails, read sheets, or perform any action. NEVER output phrases like "Reminder set for...", "I've scheduled...", "Done ✅", "Task created", or any language implying an action was completed. If the user wants an action, say: "I can do that — just send your message and I'll take care of it." Do NOT simulate the outcome.`;default:return""}}const Li=Object.freeze(Object.defineProperty({__proto__:null,buildPurchaseGmailQuery:On,buildSubAgentPrompt:fr,classifyIntentFast:Rn,detectDeterministicOp:Nn,detectTierTwoOp:In,extractPurchaseProduct:gr},Symbol.toStringTag,{value:"Module"})),Mi=new Set(["create_skill","list_skills","store_memory","search_memory","delete_memory","update_memory","get_schedules","delete_schedule","create_schedule","toggle_schedule","gmail_unread_count"]),$i=3,Pi=3,yr=5,vr=.4,wr=5;async function br(e,t,n,s,r,a,i=!0){try{const o=r.filter(f=>!Mi.has(f));if(o.length<$i)return;const c=[...[...new Set(o)]].sort().join(","),d=await e.prepare(`INSERT INTO skill_patterns (user_id, tool_signature, user_message_sample, tool_sequence, turn_count, succeeded)
     ...
     )`).bind(t.id,s,n).first(),a=(r==null?void 0:r.avg_success)??1,i=(r==null?void 0:r.total)??0,o=a<vr&&i>=wr;if(await e.prepare(`UPDATE user_skills
...
`}catch{return""}}async function ji(e,t,n){var i;let s=0,r=0,a=0;try{const o=await e.prepare(`SELECT us.id, us.user_id, us.name, us.instructions, us.refinement_count,
       ...
       WHERE us.user_id = ? AND us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < ? AND us.usage_count >= ?`).bind(n,vr,wr).all();for(const l of o.results??[]){s++;const c=await e.prepare(`SELECT user_message_sample, tool_sequence
         FROM skill_patterns
         WHERE auto_skill_id = ? AND succeeded = 1
         ORDER BY created_at DESC LIMIT 3`).bind(l.id).all();if((c.results??[]).length<2||l.refinement_count>=yr){await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),await e.prepare(`INSERT INTO notifications (user_id, type, title, body, source, is_read)
...
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const b=(((i=(await t.chat(p,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);b&&b[1].trim()&&(await e.prepare(`UPDATE user_skills
             ...
             WHERE id = ?`).bind(b[1].trim(),l.id).run(),r++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:s,rewritten:r,disabled:a}}async function Ui(e,t,n,s,r){var R;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
...
INSTRUCTIONS: <step-by-step instructions referencing exact tool names, under 200 words>`}],c=((R=(await t.chat(o,{tools:[]})).content)==null?void 0:R.trim())??"",d=c.match(/^NAME:\s*(.+)$/m),u=c.match(/^DESCRIPTION:\s*(.+)$/m),p=c.match(/^INSTRUCTIONS:\s*([\s\S]+)$/m);if(!d||!u||!p)return;const g=d[1].trim(),f=u[1].trim(),b=p[1].trim();if(!g||!f||!b)return;let w=`auto_${g.toLowerCase().replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").substring(0,40)}`;await e.prepare("SELECT id FROM user_skills WHERE user_id = ? AND slug = ?").bind(n.id,w).first()&&(w=`${w}_${Date.now().toString().slice(-4)}`);const S=await e.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, required_tools, is_auto, source)
     VALUES (?, ?, ?, ?, ?, ?, 1, 'auto')
     RETURNING id`).bind(n.id,g,w,f,b,JSON.stringify(r)).first();S!=null&&S.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE user_id = ? AND tool_signature = ?").bind(S.id,n.id,s).run()}async function Hi(e,t,n,s,r,a){var u;const i=await e.prepare("SELECT name, instructions, refinement_count FROM user_skills WHERE id = ? AND user_id = ?").bind(s,n.id).first();if(!i||i.refinement_count>=yr)return;const o=[{role:"system",content:"You are a workflow optimizer. Given an existing skill and a new usage example, decide if the instructions should be improved."},{role:"user",content:`Existing skill "${i.name}":
${i.instructions}
...
${s}
`:"",l=ts(t,Wi);let c="";try{const u=new Date;c=new Intl.DateTimeFormat("en-GB",{timeZone:e.timezone,day:"numeric",month:"short",year:"numeric"}).format(u)}catch{c=""}return`You are ${a}.
...
Folder: "${(await pn(E,h.spreadsheetId,t.folder_name)).folderName}"`}catch(E){v=`
...
Folder: "${(await pn(E,h.documentId,t.folder_name)).folderName}"`}catch(E){v=`
...
${h}`}catch(m){return await H(n,s,"gmail","read",m.message),`Gmail read error: ${m.message}`}}case"gmail_search":{if(!r)return"Authentication context unavailable.";try{const m=Xi(t);if(!m)return"Gmail search requires a non-empty query (e.g. from:sender@example.com subject:invoice). Use Gmail search syntax.";const y=typeof t.product_hint=="string"?t.product_hint.trim():"",h=Math.min(Math.max(t.max_results||10,1),20),v=new xe(n,s,r,a||"",i||"");let E=await v.search(m,h);if(E.length===0&&y){const _=On(y).replace("180d","365d");E=await v.search(_,h)}return E.length===0?`No results for: ${m}`:y?bi(E,y,m):E.map((_,k)=>`${_.isUnread?"● ":"  "}${k+1}. **${_.subject}**
   From: ${_.from}
   Date: ${_.date}
   ${_.snippet}
   [id: ${_.id}]`).join(`
...
${h}]`})}}catch{}await o.storeMessage(s.id,e.channel,"user",e.text,"{}",l);const O=(i==null?void 0:i.maxTurns)??10,M=(i==null?void 0:i.tools)??await $n(t,s.id);let L="",U=0;const Y=[];let ee,re=0,A=0;const K={hasActiveTask:!1,persistSession:!1,threadId:l,channel:e.channel};for(let y=0;y<O;y++){re=y+1;try{y>0&&Ar(w);const h=await n.chat(w,{tools:M,toolChoice:y===0&&(i!=null&&i.forceToolUseOnFirstTurn)?"required":void 0});if(h.usage&&(U+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){const v=h.content||"(tools executed)";w.push({role:"assistant",content:v});for(const _ of h.toolCalls)Y.push(_.name);const E=await Promise.all(h.toolCalls.map(async _=>{try{const k=await At(_.name,_.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},K);ee=Dr(_.name,_.arguments,k,ee);const D=["parse_document","drive_read_file","read_library_file"].includes(_.name)?2e4:8e3,N=k.length>D?k.substring(0,D)+`
...
`;for(const c of a)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=r;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:s,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Ke(e.env.DB,t.id,t.pin_hash),u=new ReadableStream({async start(p){const g=new TextEncoder;try{const f=uo(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const b of f)b.data.threadId||(b.data.threadId=o),p.enqueue(g.encode(is(b)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),p.close()}catch(f){const b={type:"error",data:{error:f.message||"An error occurred",threadId:o}};p.enqueue(g.encode(is(b))),p.close()}}});return new Response(u,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});ce.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
`)}he.post("/briefings/:id/resend",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));try{const s=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!s)return e.json({error:"Briefing not found"},404);const r=JSON.parse(s.content||"{}"),a=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(n).all(),{text:i,inlineKeyboard:o}=Gr(r,a.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(n).run(),await Wr(e.env.DB,t,i,o,n);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(n).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(s){return e.json({error:s.message},500)}});he.delete("/briefings/:id",async e=>{const t=e.get("user"),n=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});const ot=new be;async function Ft(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,role:s.role,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}function Yr(e){return e.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"")}ot.post("/cron/review-low-confidence",async e=>{if((e.req.header("X-Cron-Secret")||"")!==(e.env.CRON_SECRET||"karna-cron-default-v1"))return e.json({error:"Unauthorized"},401);let n=0,s=0,r=0;try{const a=await e.env.DB.prepare(`SELECT DISTINCT u.id, u.pin_hash
       ...
       WHERE us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < 0.4 AND us.usage_count >= 5`).all();for(const i of a.results??[])try{const{provider:o}=await Ke(e.env.DB,i.id,i.pin_hash),l=await ji(e.env.DB,o,i.id);n+=l.reviewed,s+=l.rewritten,r+=l.disabled}catch{}}catch(a){return e.json({error:a.message,reviewed:n,rewritten:s,disabled:r},500)}return e.json({reviewed:n,rewritten:s,disabled:r})});ot.get("/",Ft,async e=>{const t=e.get("user"),s=(await e.env.DB.prepare(`SELECT id, name, slug, description, instructions, parameters, required_tools, examples,
