var tr=Object.defineProperty;var jt=e=>{throw TypeError(e)};var ar=(e,t,a)=>t in e?tr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var S=(e,t,a)=>ar(e,typeof t!="symbol"?t+"":t,a),wt=(e,t,a)=>t.has(e)||jt("Cannot "+a);var b=(e,t,a)=>(wt(e,t,"read from private field"),a?a.call(e):t.get(e)),A=(e,t,a)=>t.has(e)?jt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),R=(e,t,a,r)=>(wt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),N=(e,t,a)=>(wt(e,t,"access private method"),a);var Pt=(e,t,a,r)=>({set _(n){R(e,t,n,a)},get _(){return b(e,t,r)}});var Ut=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,c=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,l=await t(m,r),c=!0;else throw m}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},rr=Symbol(),nr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ca?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?sr(e,{all:a,dot:r}):{}};async function sr(e,t){const a=await e.formData();return a?or(a,t):{}}function or(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?ir(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(lr(a,r,n),delete a[r])}),a}var ir=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},lr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},na=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},cr=e=>{const{groups:t,path:a}=dr(e),r=na(a);return ur(r,t)},dr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},ur=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},nt={},pr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return nt[r]||(a[2]?nt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:nt[r]=[e,a[1],!0]),nt[r]}return null},At=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},mr=e=>At(e,decodeURI),sa=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return mr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},hr=e=>{const t=sa(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ce=(e,t,...a)=>(a.length&&(t=Ce(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),oa=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},_t=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?At(e,la):e):e,ia=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return _t(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=_t(l)),s=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=_t(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},gr=ia,fr=(e,t)=>ia(e,t,!0),la=decodeURIComponent,Ht=e=>At(e,la),$e,Y,ce,da,ua,St,pe,Zt,ca=(Zt=class{constructor(e,t="/",a=[[]]){A(this,ce);S(this,"raw");A(this,$e);A(this,Y);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});A(this,pe,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,R(this,Y,a),R(this,$e,{})}param(e){return e?N(this,ce,da).call(this,e):N(this,ce,ua).call(this)}query(e){return gr(this.url,e)}queries(e){return fr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await nr(this,e))}json(){return b(this,pe).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,pe).call(this,"text")}arrayBuffer(){return b(this,pe).call(this,"arrayBuffer")}blob(){return b(this,pe).call(this,"blob")}formData(){return b(this,pe).call(this,"formData")}addValidatedData(e,t){b(this,$e)[e]=t}valid(e){return b(this,$e)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[rr](){return b(this,Y)}get matchedRoutes(){return b(this,Y)[0].map(([[,e]])=>e)}get routePath(){return b(this,Y)[0].map(([[,e]])=>e)[this.routeIndex].path}},$e=new WeakMap,Y=new WeakMap,ce=new WeakSet,da=function(e){const t=b(this,Y)[0][this.routeIndex][1][e],a=N(this,ce,St).call(this,t);return a&&/\%/.test(a)?Ht(a):a},ua=function(){const e={},t=Object.keys(b(this,Y)[0][this.routeIndex][1]);for(const a of t){const r=N(this,ce,St).call(this,b(this,Y)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ht(r):r)}return e},St=function(e){return b(this,Y)[1]?b(this,Y)[1][e]:e},pe=new WeakMap,Zt),yr={Stringify:1},pa=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>pa(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},vr="text/plain; charset=UTF-8",xt=(e,t)=>({"Content-Type":e,...t}),Ve,Xe,se,Me,oe,q,Ze,Be,je,xe,Qe,et,me,Ae,Qt,br=(Qt=class{constructor(e,t){A(this,me);A(this,Ve);A(this,Xe);S(this,"env",{});A(this,se);S(this,"finalized",!1);S(this,"error");A(this,Me);A(this,oe);A(this,q);A(this,Ze);A(this,Be);A(this,je);A(this,xe);A(this,Qe);A(this,et);S(this,"render",(...e)=>(b(this,Be)??R(this,Be,t=>this.html(t)),b(this,Be).call(this,...e)));S(this,"setLayout",e=>R(this,Ze,e));S(this,"getLayout",()=>b(this,Ze));S(this,"setRenderer",e=>{R(this,Be,e)});S(this,"header",(e,t,a)=>{this.finalized&&R(this,q,new Response(b(this,q).body,b(this,q)));const r=b(this,q)?b(this,q).headers:b(this,xe)??R(this,xe,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});S(this,"status",e=>{R(this,Me,e)});S(this,"set",(e,t)=>{b(this,se)??R(this,se,new Map),b(this,se).set(e,t)});S(this,"get",e=>b(this,se)?b(this,se).get(e):void 0);S(this,"newResponse",(...e)=>N(this,me,Ae).call(this,...e));S(this,"body",(e,t,a)=>N(this,me,Ae).call(this,e,t,a));S(this,"text",(e,t,a)=>!b(this,xe)&&!b(this,Me)&&!t&&!a&&!this.finalized?new Response(e):N(this,me,Ae).call(this,e,t,xt(vr,a)));S(this,"json",(e,t,a)=>N(this,me,Ae).call(this,JSON.stringify(e),t,xt("application/json",a)));S(this,"html",(e,t,a)=>{const r=n=>N(this,me,Ae).call(this,n,t,xt("text/html; charset=UTF-8",a));return typeof e=="object"?pa(e,yr.Stringify,!1,{}).then(r):r(e)});S(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});S(this,"notFound",()=>(b(this,je)??R(this,je,()=>new Response),b(this,je).call(this,this)));R(this,Ve,e),t&&(R(this,oe,t.executionCtx),this.env=t.env,R(this,je,t.notFoundHandler),R(this,et,t.path),R(this,Qe,t.matchResult))}get req(){return b(this,Xe)??R(this,Xe,new ca(b(this,Ve),b(this,et),b(this,Qe))),b(this,Xe)}get event(){if(b(this,oe)&&"respondWith"in b(this,oe))return b(this,oe);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,oe))return b(this,oe);throw Error("This context has no ExecutionContext")}get res(){return b(this,q)||R(this,q,new Response(null,{headers:b(this,xe)??R(this,xe,new Headers)}))}set res(e){if(b(this,q)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,q).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,q).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}R(this,q,e),this.finalized=!0}get var(){return b(this,se)?Object.fromEntries(b(this,se)):{}}},Ve=new WeakMap,Xe=new WeakMap,se=new WeakMap,Me=new WeakMap,oe=new WeakMap,q=new WeakMap,Ze=new WeakMap,Be=new WeakMap,je=new WeakMap,xe=new WeakMap,Qe=new WeakMap,et=new WeakMap,me=new WeakSet,Ae=function(e,t,a){const r=b(this,q)?new Headers(b(this,q).headers):b(this,xe)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Me);return new Response(e,{status:n,headers:r})},Qt),P="ALL",wr="all",_r=["get","post","put","delete","options","patch"],ma="Can not add a route since the matcher is already built.",ha=class extends Error{},xr="__COMPOSED_HANDLER",Er=e=>e.text("404 Not Found",404),Gt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},X,U,ga,Z,we,it,lt,Pe,Tr=(Pe=class{constructor(t={}){A(this,U);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");A(this,X,"/");S(this,"routes",[]);A(this,Z,Er);S(this,"errorHandler",Gt);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(R(this,Z,t),this));S(this,"fetch",(t,...a)=>N(this,U,lt).call(this,t,a[1],a[0],t.method));S(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ce("/",t)}`,a),r,n)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(N(this,U,lt).call(this,t.request,t,void 0,t.request.method))})});[..._r,wr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?R(this,X,o):N(this,U,we).call(this,s,b(this,X),o),i.forEach(l=>{N(this,U,we).call(this,s,b(this,X),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){R(this,X,l);for(const c of[s].flat())i.map(u=>{N(this,U,we).call(this,c.toUpperCase(),b(this,X),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?R(this,X,s):(R(this,X,"*"),o.unshift(s)),o.forEach(i=>{N(this,U,we).call(this,P,b(this,X),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??sa:hr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Gt?s=n.handler:(s=async(i,l)=>(await Ut([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[xr]=n.handler),N(o=r,U,we).call(o,n.method,n.path,s)}),this}basePath(t){const a=N(this,U,ga).call(this);return a._basePath=Ce(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ce(this._basePath,t),c=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,u)}})());const i=async(l,c)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await c()};return N(this,U,we).call(this,P,Ce(t,"*"),i),this}},X=new WeakMap,U=new WeakSet,ga=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,R(t,Z,b(this,Z)),t.routes=this.routes,t},Z=new WeakMap,we=function(t,a,r){t=t.toUpperCase(),a=Ce(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},it=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},lt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await N(this,U,lt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new br(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,Z)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await b(this,Z).call(this,i)})}catch(u){return N(this,U,it).call(this,u,i)}return c instanceof Promise?c.then(u=>u||(i.finalized?i.res:b(this,Z).call(this,i))).catch(u=>N(this,U,it).call(this,u,i)):c??b(this,Z).call(this,i)}const l=Ut(o[0],this.errorHandler,b(this,Z));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return N(this,U,it).call(this,c,i)}})()},Pe),fa=[];function kr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[P],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],fa];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var dt="[^/]+",Ke=".*",Ye="(?:|/.*)",Le=Symbol(),Sr=new Set(".\\+*[^]$()");function Ir(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ke||e===Ye?1:t===Ke||t===Ye?-1:e===dt?1:t===dt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ee,Te,Q,Ie,Dr=(Ie=class{constructor(){A(this,Ee);A(this,Te);A(this,Q,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Ee)!==void 0)throw Le;if(s)return;R(this,Ee,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Ke]:["","",dt]:o==="/*"?["","",Ye]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let m=l[2]||dt;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Le;if(c=b(this,Q)[m],!c){if(Object.keys(b(this,Q)).some(f=>f!==Ke&&f!==Ye))throw Le;if(s)return;c=b(this,Q)[m]=new Ie,u!==""&&R(c,Te,n.varIndex++)}!s&&u!==""&&r.push([u,b(c,Te)])}else if(c=b(this,Q)[o],!c){if(Object.keys(b(this,Q)).some(u=>u.length>1&&u!==Ke&&u!==Ye))throw Le;if(s)return;c=b(this,Q)[o]=new Ie}c.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,Q)).sort(Ir).map(r=>{const n=b(this,Q)[r];return(typeof b(n,Te)=="number"?`(${r})@${b(n,Te)}`:Sr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Ee)=="number"&&a.unshift(`#${b(this,Ee)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Ee=new WeakMap,Te=new WeakMap,Q=new WeakMap,Ie),pt,tt,ea,Or=(ea=class{constructor(){A(this,pt,{varIndex:0});A(this,tt,new Dr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return n[o]=[c,l],o++,i=!0,c}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return b(this,tt).insert(s,t,r,b(this,pt),a),r}buildRegExp(){let e=b(this,tt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},pt=new WeakMap,tt=new WeakMap,ea),Rr=[/^$/,[],Object.create(null)],ct=Object.create(null);function ya(e){return ct[e]??(ct[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Cr(){ct=Object.create(null)}function Ar(e){var c;const t=new Or,a=[];if(e.length===0)return Rr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[f,v])=>u?1:f?-1:m.length-v.length),n=Object.create(null);for(let u=0,m=-1,f=r.length;u<f;u++){const[v,y,x]=r[u];v?n[y]=[x.map(([E])=>[E,Object.create(null)]),fa]:m++;let w;try{w=t.insert(y,m,v)}catch(E){throw E===Le?new ha(y):E}v||(a[m]=x.map(([E,d])=>{const g=Object.create(null);for(d-=1;d>=0;d--){const[p,h]=w[d];g[p]=h}return[E,g]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=a.length;u<m;u++)for(let f=0,v=a[u].length;f<v;f++){const y=(c=a[u][f])==null?void 0:c[1];if(!y)continue;const x=Object.keys(y);for(let w=0,E=x.length;w<E;w++)y[x[w]]=i[y[x[w]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function Oe(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ya(a).test(t))return[...e[a]]}}var he,ge,mt,va,ta,Lr=(ta=class{constructor(){A(this,mt);S(this,"name","RegExpRouter");A(this,he);A(this,ge);S(this,"match",kr);R(this,he,{[P]:Object.create(null)}),R(this,ge,{[P]:Object.create(null)})}add(e,t,a){var i;const r=b(this,he),n=b(this,ge);if(!r||!n)throw new Error(ma);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(c=>{l[e][c]=[...l[P][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ya(t);e===P?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=Oe(r[c],t)||Oe(r[P],t)||[])}):(i=r[e])[t]||(i[t]=Oe(r[e],t)||Oe(r[P],t)||[]),Object.keys(r).forEach(c=>{(e===P||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,s])})}),Object.keys(n).forEach(c=>{(e===P||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,s]))});return}const o=oa(t)||[t];for(let l=0,c=o.length;l<c;l++){const u=o[l];Object.keys(n).forEach(m=>{var f;(e===P||e===m)&&((f=n[m])[u]||(f[u]=[...Oe(r[m],u)||Oe(r[P],u)||[]]),n[m][u].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,ge)).concat(Object.keys(b(this,he))).forEach(t=>{e[t]||(e[t]=N(this,mt,va).call(this,t))}),R(this,he,R(this,ge,void 0)),Cr(),e}},he=new WeakMap,ge=new WeakMap,mt=new WeakSet,va=function(e){const t=[];let a=e===P;return[b(this,he),b(this,ge)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?Ar(t):null},ta),fe,ie,aa,Nr=(aa=class{constructor(e){S(this,"name","SmartRouter");A(this,fe,[]);A(this,ie,[]);R(this,fe,e.routers)}add(e,t,a){if(!b(this,ie))throw new Error(ma);b(this,ie).push([e,t,a])}match(e,t){if(!b(this,ie))throw new Error("Fatal error");const a=b(this,fe),r=b(this,ie),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof ha)continue;throw l}this.match=i.match.bind(i),R(this,fe,[i]),R(this,ie,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ie)||b(this,fe).length!==1)throw new Error("No active router has been determined yet.");return b(this,fe)[0]}},fe=new WeakMap,ie=new WeakMap,aa),ze=Object.create(null),ye,F,ke,Ue,H,le,_e,He,$r=(He=class{constructor(t,a,r){A(this,le);A(this,ye);A(this,F);A(this,ke);A(this,Ue,0);A(this,H,ze);if(R(this,F,r||Object.create(null)),R(this,ye,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},R(this,ye,[n])}R(this,ke,[])}insert(t,a,r){R(this,Ue,++Pt(this,Ue)._);let n=this;const s=cr(a),o=[];for(let i=0,l=s.length;i<l;i++){const c=s[i],u=s[i+1],m=pr(c,u),f=Array.isArray(m)?m[0]:c;if(f in b(n,F)){n=b(n,F)[f],m&&o.push(m[1]);continue}b(n,F)[f]=new He,m&&(b(n,ke).push(m),o.push(m[1])),n=b(n,F)[f]}return b(n,ye).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:b(this,Ue)}}),n}search(t,a){var l;const r=[];R(this,H,ze);let s=[this];const o=na(a),i=[];for(let c=0,u=o.length;c<u;c++){const m=o[c],f=c===u-1,v=[];for(let y=0,x=s.length;y<x;y++){const w=s[y],E=b(w,F)[m];E&&(R(E,H,b(w,H)),f?(b(E,F)["*"]&&r.push(...N(this,le,_e).call(this,b(E,F)["*"],t,b(w,H))),r.push(...N(this,le,_e).call(this,E,t,b(w,H)))):v.push(E));for(let d=0,g=b(w,ke).length;d<g;d++){const p=b(w,ke)[d],h=b(w,H)===ze?{}:{...b(w,H)};if(p==="*"){const D=b(w,F)["*"];D&&(r.push(...N(this,le,_e).call(this,D,t,b(w,H))),R(D,H,h),v.push(D));continue}const[_,T,O]=p;if(!m&&!(O instanceof RegExp))continue;const k=b(w,F)[_],I=o.slice(c).join("/");if(O instanceof RegExp){const D=O.exec(I);if(D){if(h[T]=D[0],r.push(...N(this,le,_e).call(this,k,t,b(w,H),h)),Object.keys(b(k,F)).length){R(k,H,h);const L=((l=D[0].match(/\//))==null?void 0:l.length)??0;(i[L]||(i[L]=[])).push(k)}continue}}(O===!0||O.test(m))&&(h[T]=m,f?(r.push(...N(this,le,_e).call(this,k,t,h,b(w,H))),b(k,F)["*"]&&r.push(...N(this,le,_e).call(this,b(k,F)["*"],t,h,b(w,H)))):(R(k,H,h),v.push(k)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},ye=new WeakMap,F=new WeakMap,ke=new WeakMap,Ue=new WeakMap,H=new WeakMap,le=new WeakSet,_e=function(t,a,r,n){const s=[];for(let o=0,i=b(t,ye).length;o<i;o++){const l=b(t,ye)[o],c=l[a]||l[P],u={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==ze||n&&n!==ze))for(let m=0,f=c.possibleKeys.length;m<f;m++){const v=c.possibleKeys[m],y=u[c.score];c.params[v]=n!=null&&n[v]&&!y?n[v]:r[v]??(n==null?void 0:n[v]),u[c.score]=!0}}return s},He),Se,ra,Mr=(ra=class{constructor(){S(this,"name","TrieRouter");A(this,Se);R(this,Se,new $r)}add(e,t,a){const r=oa(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Se).insert(e,r[n],a);return}b(this,Se).insert(e,t,a)}match(e,t){return b(this,Se).search(e,t)}},Se=new WeakMap,ra),ve=class extends Tr{constructor(e={}){super(e),this.router=e.router??new Nr({routers:[new Lr,new Mr]})}},Br=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(m,f){o.res.headers.set(m,f)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let f=a.allowHeaders;if(!(f!=null&&f.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(f=v.split(/\s*,\s*/))}return f!=null&&f.length&&(l("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function ba(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`),i=btoa(unescape(encodeURIComponent(o))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),l=await fetch(`${re}/drafts`,{method:"POST",headers:n,body:JSON.stringify({message:{raw:i}})});if(!l.ok){const c=await l.text();throw new Error(`Gmail draft failed (${l.status}): ${c.substring(0,200)}`)}return await l.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${re}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const r=await this.authHeaders();let n={};switch(a){case"archive":n={removeLabelIds:["INBOX"]};break;case"trash":n={addLabelIds:["TRASH"]};break;case"read":n={removeLabelIds:["UNREAD"]};break;case"unread":n={addLabelIds:["UNREAD"]};break;case"star":n={addLabelIds:["STARRED"]};break;case"unstar":n={removeLabelIds:["STARRED"]};break}const s=await fetch(`${re}/messages/${t}/modify`,{method:"POST",headers:{...r,"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.text();throw new Error(`Failed to modify message: ${o}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${re}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${re}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function Ga(e){var t,a,r;if(!e)return"";if((t=e.body)!=null&&t.data)return Tt(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((a=n.body)!=null&&a.data))return Tt(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((r=n.body)!=null&&r.data)){const s=Tt(n.body.data);return en(s)}for(const n of e.parts)if(n.parts){const s=Ga(n);if(s)return s}}return e.snippet||""}function Tt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function en(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const tn=1e4,an=1e4;async function za(e,t){try{const a=new AbortController,r=setTimeout(()=>a.abort(),an),n=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(r),!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const o=await n.text(),i=rn(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||tn)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function rn(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Fa(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await gt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async f=>{const v=await za(f.link);return{title:f.title,url:f.link,displayLink:f.displayLink,snippet:f.snippet,content:v.text,error:v.error}}),c=(await Promise.all(i)).filter(f=>f.content.length>50);if(c.length===0){const f=s.results.map((y,x)=>`[${x+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Ft(e,f,t,"snippets"),sources:s.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const u=c.map((f,v)=>`--- SOURCE ${v+1}: ${f.title} (${f.displayLink}) ---
${f.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Ft(e,u,t,"full"),sources:c.map(f=>({title:f.title,url:f.url})),pagesRead:c.length}}async function Ft(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function qt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function yt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}function dn(e){const t=e.replace(/(\d+)\s*[.,;!]+\s*(minutes?|mins?|hours?|hrs?|h|days?|seconds?|secs?)/gi,"$1 $2"),a=t.toLowerCase().trim(),r=a.match(/\bin\s+(\d+)\s*(minutes?|mins?|hours?|hrs?|h|days?)\b/i);if(r){let o=parseInt(r[1],10);const i=r[2].toLowerCase();i.startsWith("h")&&(o*=60),i.startsWith("d")&&(o*=1440);const l=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let c;l?c=l[1].trim():c=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/in\s+\d+\s*\.?\s*(minutes?|mins?|hours?|hrs?|h|days?)\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const u=c.length>50?c.substring(0,47)+"...":c;return{args:{name:u.charAt(0).toUpperCase()+u.slice(1),description:c,schedule_type:"once",minutes_from_now:o,action_type:"reminder",action_description:c,schedule_value:""}}}const n=a.match(/(?:at|by)\s+(\d{1,2})[:.]?(\d{2})?\s*(am|pm|a\.m\.|p\.m\.)?/i);if(n){let o=parseInt(n[1],10);const i=n[2]?parseInt(n[2],10):0,l=(n[3]||"").replace(/\./g,"").toLowerCase();l==="pm"&&o<12&&(o+=12),l==="am"&&o===12&&(o=0);const c=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let u;c?u=c[1].trim():u=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/(?:at|by)\s+\d{1,2}[:.]?\d{0,2}\s*(am|pm|a\.m\.|p\.m\.)?\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const m=u.length>50?u.substring(0,47)+"...":u,f=new Date,v=f.getFullYear(),y=String(f.getMonth()+1).padStart(2,"0"),x=String(f.getDate()).padStart(2,"0"),w=`${v}-${y}-${x} ${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}`;return{args:{name:m.charAt(0).toUpperCase()+m.slice(1),description:u,schedule_type:"once",schedule_value:w,action_type:"reminder",action_description:u}}}const s=a.match(/^(remind|alert|notify)\s+me\s+(?:to|about|that)\s+(.+?)\.?$/i);if(s){const o=s[2].trim(),i=o.length>50?o.substring(0,47)+"...":o;return{args:{name:i.charAt(0).toUpperCase()+i.slice(1),description:o,schedule_type:"once",minutes_from_now:5,action_type:"reminder",action_description:o,schedule_value:""}}}return null}async function Ne(e,t,a,r,n,s,o,i,l,c,u,m){const f=Date.now();let v=!0,y="",x="";try{return x=await un(e,t,a,r,s,o,i,l,c,u,m),x}catch(w){throw v=!1,y=w.message||"Unknown error",w}finally{const w=Date.now()-f;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?x:"").substring(0,500),v?1:0,y||null,w,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function un(e,t,a,r,n,s,o,i,l,c,u){var f,v,y,x,w,E;const m=new J(a);switch(e){case"create_schedule":{const d=new Date;let g;const p=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){g=new Date(d.getTime()+t.minutes_from_now*60*1e3);const O=g.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[k,I,D]=(O[0]||"").split("/");t.schedule_value=`${D}-${k}-${I} ${O[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);g=new Date(d.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"){const[T,O]=t.schedule_value.split(":").map(Number),k=d.toLocaleString("en-US",{timeZone:p}),I=new Date(k),D=new Date(I);D.setHours(T,O,0,0),D<=I&&D.setDate(D.getDate()+1);const L=new Date(D.toLocaleString("en-US",{timeZone:"UTC"})),$=new Date(D.toLocaleString("en-US",{timeZone:p})),z=L.getTime()-$.getTime();g=new Date(D.getTime()+z)}else if(t.schedule_type==="weekly"){const[T,O]=t.schedule_value.split(" "),[k,I]=(O||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(bt=>bt.toLowerCase()===T.toLowerCase()),$=d.toLocaleString("en-US",{timeZone:p}),z=new Date($),K=new Date(z);K.setHours(k,I,0,0);let W=(L-K.getDay()+7)%7;W===0&&K<=z&&(W=7),K.setDate(K.getDate()+W);const De=new Date(K.toLocaleString("en-US",{timeZone:"UTC"})),ue=new Date(K.toLocaleString("en-US",{timeZone:p})),vt=De.getTime()-ue.getTime();g=new Date(K.getTime()+vt)}else if(t.schedule_type==="once"){const[T,O]=t.schedule_value.split(" "),[k,I,D]=T.split("-").map(Number),[L,$]=(O||"00:00").split(":").map(Number),z=d.toLocaleString("en-US",{timeZone:p}),K=new Date(z),W=new Date(K);W.setFullYear(k,I-1,D),W.setHours(L,$,0,0);const De=new Date(W.toLocaleString("en-US",{timeZone:"UTC"})),ue=new Date(W.toLocaleString("en-US",{timeZone:p})),vt=De.getTime()-ue.getTime();g=new Date(W.getTime()+vt);const bt=new Date(d.getTime()+120*1e3);if(g.getTime()<d.getTime()+60*1e3){const Qa=g.toISOString();g=bt;const er=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${Qa} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${g.toISOString()}.]`;t._pastTimeWarning=er}}else g=new Date(d.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),g.toISOString()).run();const h=t._pastTimeWarning||"",_=g.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${_} (${p}). [UTC: ${g.toISOString()}]${h}. IMPORTANT: Use the exact time "${_}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const g=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return g.length===0?"No scheduled tasks found.":g.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const d=t.enabled?1:0,g=d?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(d,g,t.job_id,r).run(),`Schedule ${t.job_id} ${d?"enabled (active)":"paused"}.`}case"update_schedule_state":{const d=["created","active","reminding","paused","completed"],g=t.state;if(!d.includes(g))return`Invalid state "${g}". Valid states: ${d.join(", ")}`;const p=g==="completed"||g==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(g,p,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${g}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const d=t.importance||5,g=d>=7?"working":"long_term";return await m.store(r,t.type,t.title,t.content,d,g),`Stored in ${g==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${d})`}case"search_memory":{const d=await m.search(r,t.query);return d.length===0?"No matching memories found.":d.map(g=>`[${g.tier||"long_term"}] [${g.type}] **${g.title}**: ${g.content}`).join(`
`)}case"get_system_status":{const d=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),g=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),_=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new te(a,r,n,s||"",o||""),g=t.spreadsheet_id;let p=t.range;const h=await d.sheets.getMetadata(g),_=h.sheets;p.includes("!")||(p=`${_[0]}!${p}`);let T;try{T=await d.sheets.readRange(g,p)}catch(k){if((f=k.message)!=null&&f.includes("Unable to parse range")||(v=k.message)!=null&&v.includes("400")){const I=p.includes("!")?p.split("!")[1]:p;p=`${_[0]}!${I}`,T=await d.sheets.readRange(g,p)}else throw k}let O=`[Spreadsheet: "${h.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(k=>`"${k}"`).join(", ")}]
`;return _.length>1&&(O+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),T.length===0?O+"No data found in the specified range.":O+T.map(k=>k.join("	| ")).join(`
...
Folder: "${(await qt(_,p.spreadsheetId,t.folder_name)).folderName}"`}catch(_){h=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new J(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${h}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(d){return await C(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new te(a,r,n,s||"",o||""),g=t.calendar_id||"primary",p=t.days_ahead||7,h=new Date,_=new Date(h.getTime()+p*24*60*60*1e3),T=await d.calendar.listEvents(g,{timeMin:h.toISOString(),timeMax:_.toISOString(),query:t.query});return T.length===0?`No events found in the next ${p} days.`:T.map(O=>{var $;const k=O.start.dateTime||O.start.date||"TBD",I=O.end.dateTime||O.end.date||"",D=O.location?` 📍 ${O.location}`:"",L=(($=O.attendees)==null?void 0:$.map(z=>z.email).join(", "))||"";return`• ${O.summary} — ${k} to ${I}${D}${L?`
  Attendees: ${L}`:""}`}).join(`
`)}catch(d){return await C(a,r,"google","list_calendar",d.message),`Failed to list events: ${d.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const d=new te(a,r,n,s||"",o||""),g=t.calendar_id||"primary",p=await d.calendar.createEvent(g,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
...
Folder: "${(await qt(_,p.documentId,t.folder_name)).folderName}"`}catch(_){h=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new J(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${h}
ID: ${p.documentId}
URL: ${p.url}`}catch(d){return await C(a,r,"google","create_doc",d.message),`Failed to create document: ${d.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const g=await new te(a,r,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${g.title}"
...
`)}catch(d){return await C(a,r,"search","web_search",d.message),`Web search error: ${d.message}`}case"read_url":try{const d=t.url;if(!d||!d.startsWith("http://")&&!d.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const g=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>nn),h=await p(d,g);return h.error?`Failed to read page: ${h.error}`:!h.text||h.text.length<20?`Page at ${d} returned no readable content.`:`Content from ${d} (${h.text.length} chars):

${h.text}`}catch(d){return await C(a,r,"search","read_url",d.message),`Read URL error: ${d.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const g=Fa(t.query,u,{depth:t.depth||"quick",site:t.site}),p=new Promise(T=>setTimeout(()=>T(null),45e3)),h=await Promise.race([g,p]);if(h===null){const{webSearch:T}=await Promise.resolve().then(()=>Qr),O=await T(t.query,{num:5});if(O.error||O.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let k=`Research took too long, but here are the top search results:

`;return k+=O.results.map((I,D)=>`${D+1}. **${I.title}**
   ${I.snippet}
   ${I.link}`).join(`

`),k}if(h.error)return`Research failed: ${h.error}`;let _=h.report;return h.sources.length>0&&(_+=`

---
**Sources** (`+h.pagesRead+` pages read):
`,_+=h.sources.map((T,O)=>`[${O+1}] ${T.title}
    ${T.url}`).join(`
`)),_}catch(d){return await C(a,r,"research","research",d.message),`Research error: ${d.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const g=await M(d.encrypted_value,n),p=await $a(g,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((h,_)=>{const T=h.rating?` ★${h.rating} (${h.userRatingsTotal||0} reviews)`:"",O=h.openNow!==void 0?h.openNow?" · Open now":" · Closed":"",k=h.googleMapsUri?`
   ${h.googleMapsUri}`:"";return`${_+1}. **${h.name}**${T}${O}
   ${h.address}${k}
   [place_id: ${h.placeId}]`}).join(`

`)}catch(d){return await C(a,r,"google_api","search_places",d.message),`Places search error: ${d.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),p=await Ma(g,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const h=p.details;let _=`**${h.name}**
...
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return _}catch(d){return await C(a,r,"google_api","place_details",d.message),`Place details error: ${d.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),p=await Ba(g,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const h=p.route;let _=`**${h.startAddress}** → **${h.endAddress}**
`;return _+=`📏 ${h.distance} · ⏱️ ${h.duration}`,h.durationInTraffic&&(_+=` (with traffic: ${h.durationInTraffic})`),_+=`
via ${h.summary}`,_+=`

Steps:`,h.steps.forEach((T,O)=>{_+=`
${O+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),_}catch(d){return await C(a,r,"google_api","directions",d.message),`Directions error: ${d.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),p=await Ha(g,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let h=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(h+=` (with traffic: ${p.durationInTraffic})`),h}catch(d){return await C(a,r,"google_api","travel_time",d.message),`Travel time error: ${d.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),p=await ja(g,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(d){return await C(a,r,"google_api","translate",d.message),`Translation error: ${d.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),p=await Ua(g,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((h,_)=>{var T;return`${_+1}. **${h.title}**
   ${h.channelTitle} · ${((T=h.publishedAt)==null?void 0:T.split("T")[0])||""}
   ${h.description}
   ${h.url}`}).join(`

`)}catch(d){return await C(a,r,"google_api","youtube_search",d.message),`YouTube search error: ${d.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),p=await Pa(g,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((h,_)=>`${_+1}. ${h.address}
   Coordinates: ${h.lat}, ${h.lng}`).join(`
`)}catch(d){return await C(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Kt(e,t,a,r,n,s){var E;const o=new J(t),i=(E=e.metadata)==null?void 0:E.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),m=[{role:"system",content:Ya(r,l)},...c.map(d=>({role:d.role,content:d.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",y=0;const x=[];for(let d=0;d<f;d++)try{const g=await a.chat(m,{tools:ft});if(g.usage&&(y+=g.usage.promptTokens+g.usage.completionTokens),g.toolCalls&&g.toolCalls.length>0){g.content&&m.push({role:"assistant",content:g.content});for(const p of g.toolCalls){x.push(p.name);try{const h=await Ne(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);m.push({role:"user",content:`[Tool Result for ${p.name}]: ${h}`})}catch(h){await C(t,r.id,"tool",p.name,h.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${p.name}]: ${h.message||"Execution failed"}`})}}continue}v=g.content;break}catch(g){if(n){const p=g.message||"",h=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),_=p.includes("429"),T=h?1440:_?10:5;await n.recordError(a.name,p,T)}throw await C(t,r.id,"llm","provider_error",g.message||"Unknown LLM error",{provider:a.name,turn:d}),g}if(n&&y>0)try{await n.recordUsage(a.name,y)}catch{}const w=x.length>0?`[TOOLS_USED: ${[...new Set(x)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",w+v,"{}",i),await o.compactHistory(r.id,30),v}const Yt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function pn(e){for(const[t,a]of Object.entries(Yt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Yt.default}function mn(e,t,a,r){const n=pn(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const c=kt(e);o.push({role:"system",content:e}),i+=c;const u=kt(a);i+=u;const m=s-i,f=[];let v=0;for(let y=t.length-1;y>=0;y--){const x=t[y],w=kt(x.content);if(v+w<=m)f.unshift({role:x.role,content:x.content}),v+=w;else{l=!0;break}}return o.push(...f),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*hn(e,t,a,r,n,s){var w;const o=new J(t),i=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),u=Ya(r,l),m=mn(u,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",y=0;const x=[...m.messages];for(let E=0;E<f;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:ft});if(d.usage&&(y+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const p of d.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const h=await Ne(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:h.substring(0,500)+(h.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${p.name}]: ${h}`})}catch(h){await C(t,r.id,"tool",p.name,h.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${h.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${p.name}]: ${h.message||"Execution failed"}`})}}continue}v=d.content;const g=50;for(let p=0;p<v.length;p+=g)yield{type:"chunk",data:{text:v.substring(p,p+g),threadId:i}},p+g<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(d){if(n){const g=d.message||"",p=g.includes("401")||g.includes("403")||g.includes("authentication")||g.includes("credit balance"),h=g.includes("429"),_=p?1440:h?10:5;await n.recordError(a.name,g,_)}await C(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&y>0)try{await n.recordUsage(a.name,y)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:y}}}async function Bt(e,t,a,r,n,s){var u;const o=new J(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=Wa(e.text,l);if(c.agent==="conversation")return fn(e,t,a,r,l,n,i);if(c.agent==="multi"||c.confidence<.5)return Kt(e,t,a,r,n,s);try{return await gn(c.agent,e,t,a,r,l,n,s,i)}catch(m){return await C(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${m.message}`,{route:c}),Kt(e,t,a,r,n,s)}}async function gn(e,t,a,r,n,s,o,i,l){const c=new J(a),u=yt(n.timezone),m=ut(e,n,s,n.timezone,u),f=qa(e,ft),v=(await c.getRecentConversations(n.id,25,l)).map(k=>({...k,content:k.content.replace(/^\[TOOLS_USED: [^\]]+\]\s*/i,"")})),y=[{role:"system",content:m},...v.map(k=>({role:k.role,content:k.content})),{role:"user",content:t.text}];await c.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const x=10;let w="",E=0,d="",g=!1;const p=[];for(let k=0;k<x;k++)try{const I=await r.chat(y,{tools:f.length>0?f:void 0});if(I.usage&&(E+=I.usage.promptTokens+I.usage.completionTokens),I.toolCalls&&I.toolCalls.length>0){g=!0,I.content&&(d=I.content,y.push({role:"assistant",content:I.content}));for(const D of I.toolCalls){p.push(D.name);try{const L=await Ne(D.name,D.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y.push({role:"user",content:`[Tool Result for ${D.name}]: ${L}`})}catch(L){await C(a,n.id,"tool",D.name,L.message||"Tool execution failed"),y.push({role:"user",content:`[Tool Error for ${D.name}]: ${L.message||"Execution failed"}`})}}continue}w=I.content,!w&&d&&(w=d);break}catch(I){if(o){const D=I.message||"",L=D.includes("401")||D.includes("403")||D.includes("authentication")||D.includes("credit balance"),$=D.includes("429"),z=L?1440:$?10:5;await o.recordError(r.name,D,z)}throw await C(a,n.id,"llm","subagent_error",I.message||"Unknown error",{agent:e,provider:r.name,turn:k}),I}const h=["scheduler","workspace","research"],_=e==="scheduler"&&!p.includes("create_schedule")&&!p.includes("list_schedules")&&!p.includes("toggle_schedule")&&!p.includes("update_schedule_state")&&!p.includes("delete_schedule")&&/\b(remind|in\s+\d+|at\s+\d{1,2}[:.]\d{0,2}|timer|alarm|schedule|tell\s+me\s+in|notify|alert|ping)\b/i.test(t.text);if(!g&&h.includes(e)&&f.length>0||_){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),w.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{y.push({role:"assistant",content:w}),y.push({role:"user",content:e==="scheduler"&&_?`[SYSTEM OVERRIDE] You called ${p.join(", ")||"no tools"} but did NOT call create_schedule. The user wants a reminder or schedule created. Call create_schedule NOW with the correct parameters. Do NOT respond with text saying a reminder is set — actually create it.`:`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${f.slice(0,3).map(I=>I.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`});const k=await r.chat(y,{tools:f});if(k.usage&&(E+=k.usage.promptTokens+k.usage.completionTokens),k.toolCalls&&k.toolCalls.length>0){g=!0;for(const D of k.toolCalls){p.push(D.name);try{const L=await Ne(D.name,D.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y.push({role:"user",content:`[Tool Result for ${D.name}]: ${L}`})}catch(L){y.push({role:"user",content:`[Tool Error for ${D.name}]: ${L.message||"Execution failed"}`})}}const I=await r.chat(y,{tools:f});I.content&&(w=I.content),I.usage&&(E+=I.usage.promptTokens+I.usage.completionTokens)}if(!p.includes("create_schedule")&&e==="scheduler")try{const I=dn(t.text);if(I){const D=await Ne("create_schedule",I.args,a,n.id,{agentType:"scheduler",providerName:"programmatic_fallback",channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g=!0,p.push("create_schedule"),w=D}}catch(I){await C(a,n.id,"tool_enforcement","scheduler_fallback",`Programmatic scheduler fallback failed: ${I.message||"Unknown"}`)}}catch(k){await C(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${k.message||"Unknown"}`,{originalResponse:w.substring(0,200)})}}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}const O=p.length>0?`[TOOLS_USED: ${[...new Set(p)].join(", ")}] `:"";return await c.storeMessage(n.id,t.channel,"assistant",O+w,"{}",l),await c.compactHistory(n.id,30),w}async function fn(e,t,a,r,n,s,o){const i=new J(t),l=yt(r.timezone),c=ut("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),m=[{role:"system",content:c},...u.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let f=0,v="";try{const y=await a.chat(m,{temperature:.8});y.usage&&(f=y.usage.promptTokens+y.usage.completionTokens),v=y.content}catch(y){if(s){const x=y.message||"",w=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),E=x.includes("429"),d=w?1440:E?10:5;await s.recordError(a.name,x,d)}throw await C(t,r.id,"llm","conversation_error",y.message,{provider:a.name}),y}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*yn(e,t,a,r,n,s){var d;const o=new J(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=Wa(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*hn(e,t,a,r,n,s);return}const u=yt(r.timezone),m=c.agent==="conversation"?ut("conversation",r,l,r.timezone,u):ut(c.agent,r,l,r.timezone,u),f=qa(c.agent,ft),v=await o.getRecentConversations(r.id,25,i),y=[{role:"system",content:m},...v.map(g=>({role:g.role,content:g.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let w="",E=0;for(let g=0;g<x;g++)try{g>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(y,{tools:f.length>0?f:void 0});if(p.usage&&(E+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},y.push({role:"assistant",content:p.content}));for(const _ of p.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const T=await Ne(_.name,_.arguments,t,r.id,{agentType:c.agent,providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},y.push({role:"user",content:`[Tool Result for ${_.name}]: ${T}`})}catch(T){await C(t,r.id,"tool",_.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},y.push({role:"user",content:`[Tool Error for ${_.name}]: ${T.message||"Execution failed"}`})}}continue}w=p.content;const h=50;for(let _=0;_<w.length;_+=h)yield{type:"chunk",data:{text:w.substring(_,_+h),threadId:i}},_+h<w.length&&await new Promise(O=>setTimeout(O,10));break}catch(p){if(n){const h=p.message||"",_=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),T=h.includes("429"),O=_?1440:T?10:5;await n.recordError(a.name,h,O)}await C(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:c.agent,provider:a.name,turn:g}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const B=new ve;async function vn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}B.use("/*",vn);B.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const c of s)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:u}=await at(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(f){const v=new TextEncoder;try{const y=yn(l,e.env.DB,c,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of y)x.data.threadId||(x.data.threadId=i),f.enqueue(v.encode(Jt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),f.close()}catch(y){const x={type:"error",data:{error:y.message||"An error occurred",threadId:i}};f.enqueue(v.encode(Jt(x))),f.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const u=c.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});B.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
- Example bad: "I checked your spreadsheet and found the March tab. Looking through the data, I can see there are events at JBT but nothing at Tata Theatre..."`;function _n(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${qe}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${qe}`}function xn(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function En(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const rt=new ve,Tn=4e3;async function G(e,t,a,r="Markdown"){var s,o;const n=Sn(a,Tn);for(const i of n)try{const l=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i,parse_mode:r,disable_web_page_preview:!1})});if(!l.ok){const c=await l.json().catch(()=>null);((s=c==null?void 0:c.description)!=null&&s.includes("parse")||(o=c==null?void 0:c.description)!=null&&o.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i})})}}catch{}}async function kn(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Sn(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let n=r.lastIndexOf(`
`,t);n<t*.3&&(n=r.lastIndexOf(" ",t)),n<t*.3&&(n=t),a.push(r.substring(0,n)),r=r.substring(n).trimStart()}return a}async function In(e,t,a,r,n){switch(e.split("@")[0].toLowerCase()){case"/start":{const o=(r==null?void 0:r.name)||"there",i=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${o}!*
...
Status: ✅ Online`;await G(a,t,u)}catch{await G(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await G(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await G(a,t,"⚠️ Account not linked."),!0);default:return!1}}rt.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await Dn(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const l=!!i.text,c=!!i.voice,u=!!i.document,m=!!i.photo,f=!!i.caption;if(!l&&!c&&!u&&!m)return e.json({ok:!0});const v=String(i.chat.id);let y=i.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let w=null;if(x){const h=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();h&&(w=await M(h.encrypted_value,x.pin_hash))}if(!w){const h=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();h&&(w=await M(h.encrypted_value,h.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(y.startsWith("/")&&await In(y,v,w,x,e.env.DB))return e.json({ok:!0});if(!x)return await G(w,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&w&&x)try{await G(w,v,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${i.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const O=await(await fetch(`https://api.telegram.org/file/bot${w}/${_.result.file_path}`)).blob();let k="",I="",D="whisper-1";const L=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const W of L.results){const De=await M(W.encrypted_value,x.pin_hash);if(W.service==="openai"){k="https://api.openai.com/v1/audio/transcriptions",I=De;break}else if(W.service.startsWith("llm_slot_"))try{const ue=JSON.parse(De);if(ue.provider==="openai"){k="https://api.openai.com/v1/audio/transcriptions",I=ue.apiKey;break}else if(ue.provider==="groq"){k="https://api.groq.com/openai/v1/audio/transcriptions",I=ue.apiKey,D="whisper-large-v3";break}}catch{}}if(!k)return await G(w,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const $=new FormData;$.append("file",O,"voice.ogg"),$.append("model",D),$.append("language","en");const z=await fetch(k,{method:"POST",headers:{Authorization:`Bearer ${I}`},body:$});if(!z.ok){const W=await z.text();return await G(w,v,`⚠️ Transcription failed: ${z.status} ${W}`),e.json({ok:!0})}y=(await z.json()).text,await G(w,v,`🗣️ *You said:* ${y}`)}}catch(h){return await G(w,v,`⚠️ Failed to process voice note: ${h.message}`),e.json({ok:!0})}if((u||m)&&w&&x)try{let h,_="unknown",T="unknown",O=0;if(u)h=i.document.file_id,_=i.document.file_name||"document",T=i.document.mime_type||"unknown",O=i.document.file_size||0;else if(m){const k=i.photo[i.photo.length-1];h=k.file_id,_="photo.jpg",T="image/jpeg",O=k.file_size||0}if(h){const I=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${h}`)).json();let D="";if(I.ok&&((a=I.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(_)||/^text\/|application\/json|application\/xml|application\/csv/i.test(T))&&O<5e4)try{D=await(await fetch(`https://api.telegram.org/file/bot${w}/${I.result.file_path}`)).text()}catch{}const L=i.caption||"",$=`[Telegram file received: "${_}" (${T}, ${Math.round(O/1024)}KB)]`;D?y=`${L?L+`

`:""}${$}
File contents:
${D.substring(0,8e3)}${D.length>8e3?`
[...truncated]`:""}`:y=`${L?L+`

`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(h){if(f&&i.caption)y=i.caption;else return await G(w,v,`⚠️ Received your file but couldn't process it: ${h.message}`),e.json({ok:!0})}if(!y)return e.json({ok:!0});await kn(w,v);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=xn(x.id,x.username,y,v);d.metadata={thread_id:E.id};let g,p;try{const h=await at(e.env.DB,x.id,x.pin_hash);g=h.provider,p=h.rotation}catch(h){console.error("Telegram provider setup error:",h);const _=(r=h.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=h.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${h.message||"Unknown error"}`;return await G(w,v,_),e.json({ok:!0})}try{const h=await Bt(d,e.env.DB,g,x,p,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),_=En(h,"telegram");await G(w,v,_||"(empty response)")}catch(h){console.error("Telegram agent error:",h);const _=(s=h.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${g.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(h.message||"Unknown").substring(0,200)}`;await G(w,v,_);try{const{logError:T}=await Promise.resolve().then(()=>Ot);await T(e.env.DB,x.id,"telegram","agent_error",h.message||"Agent error",{provider:g.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>Ot);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});rt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
  ...
  `).bind(f,f,m.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!v)return;const y=await M(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:f?"✅ Checked!":"☐ Unchecked"})}),(x=n.reply_markup)!=null&&x.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(E=>E.map(d=>{var g;if((g=d.callback_data)!=null&&g.includes(i)){const p=f?"✅":"☐",h=d.text.replace(/^[☐✅]\s*/,"");return{...d,text:`${p} ${h}`}}return d}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function On(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function Rn(e,t,a,r,n,s){try{return(await new Mt(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function Cn(e,t,a,r,n){try{const s=new ne(e,t,a,r,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const f=m.from.split("<")[0].trim()||m.from;l[f]=(l[f]||0)+1}const c=Object.entries(l).sort(([,m],[,f])=>f-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:c,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function An(e,t){var a;try{const r=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(r.results||[]).map(l=>l.name),i=(r.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((a=r.results)==null?void 0:a.length)||0,dueToday:i,items:o}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function Ln(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],a=[];for(const r of t){const n=`latest ${r} news today`;try{const s=await gt(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!a.some(i=>i.url===o.link)&&(a.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),a.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(a.length>=5)break}return a.slice(0,5)}function Nn(e){const t=[];t.push(`📋 Briefing for ${e.targetDate}`),t.push("");const a=e.calendar.totalCount;if(a>0){t.push(`📅 Tomorrow: ${a} event${a===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const r=e.emails.gmail.unreadCount;if(r>0?(t.push(`📧 Gmail: ${r} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function $n(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Mn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function Va(e,t,a){var E;const r=t.timezone||"Asia/Kolkata",n=On(r),{components:s,newsTopics:o}=await Mn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(Rn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(Cn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(An(e,t.id)),l.push("tasks")),s.news&&(i.push(Ln(o)),l.push("news"));const c=await Promise.all(i),u={};l.forEach((d,g)=>{u[d]=c[g]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},f={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((E=u.googleEvents)==null?void 0:E.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||f,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};v.summary=Nn(v);const y=$n(v),x=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(v)).first(),w=(x==null?void 0:x.id)||0;for(const d of y)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(w,d.type,d.key,d.text,JSON.stringify(d.metadata),d.sortOrder).run();return{briefingId:w,content:v,items:y}}async function Bn(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function jn(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function Pn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function Un(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,c=o*60+i;return l===c}function Hn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const V=new ve;async function Xa(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(Un(l,i,s))try{const c=await Va(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:m}=Hn(c.content,c.items);await Gn(e.env.DB,o,u,m,c.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:i})}catch(c){n.push({user_id:o.id,status:"error",error:c.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});V.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const u=await M(c.encrypted_value,l.pin_hash),f=JSON.parse(u).access_token;if(!f)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${f}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(d=>{var p;const g=(p=d.start)==null?void 0:p.dateTime;return g?g>=s.toISOString()&&g<=o:!1});if(x.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!w)continue;const E=await M(w.encrypted_value,l.pin_hash);for(const d of x){const g=new Date(d.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=d.location?`
📍 ${d.location}`:"",h=`⏰ Meeting in 10 minutes!

*${d.summary||"Untitled Event"}*
🕐 ${g}${p}`;await fetch(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:h,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:x.length})}catch(c){n.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function Gn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
...
${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}V.delete("/briefings/:id",Xa,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const ee=new ve;ee.use("/api/*",Br());ee.route("/api/auth",be);ee.route("/api/chat",B);ee.route("/api/settings",j);ee.route("/api/system",de);ee.route("/api/telegram",rt);ee.route("/api/proactive",V);ee.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Re(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Re(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Re(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Re(!1,"Session expired. Please log in again and retry."));const l=i.user_id,c=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,m=await Ca(e.env.DB,l,c,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Re(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Re(!1,`OAuth failed: ${s.message}`))}});ee.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ba())));ee.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ba())));function Re(e,t,a){return`<!DOCTYPE html>
