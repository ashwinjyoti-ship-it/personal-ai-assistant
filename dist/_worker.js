var nr=Object.defineProperty;var Pt=e=>{throw TypeError(e)};var sr=(e,t,a)=>t in e?nr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var S=(e,t,a)=>sr(e,typeof t!="symbol"?t+"":t,a),wt=(e,t,a)=>t.has(e)||Pt("Cannot "+a);var b=(e,t,a)=>(wt(e,t,"read from private field"),a?a.call(e):t.get(e)),N=(e,t,a)=>t.has(e)?Pt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(wt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),M=(e,t,a)=>(wt(e,t,"access private method"),a);var Ut=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return b(e,t,r)}});var Ht=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let c,l=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{c=await u(r,()=>o(i+1))}catch(h){if(h instanceof Error&&t)r.error=h,c=await t(h,r),l=!0;else throw h}else r.finalized===!1&&a&&(c=await a(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},or=Symbol(),ir=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ua?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?lr(e,{all:a,dot:r}):{}};async function lr(e,t){const a=await e.formData();return a?cr(a,t):{}}function cr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?dr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(ur(a,r,n),delete a[r])}),a}var dr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ur=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},oa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},pr=e=>{const{groups:t,path:a}=mr(e),r=oa(a);return hr(r,t)},mr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},hr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},nt={},gr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return nt[r]||(a[2]?nt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:nt[r]=[e,a[1],!0]),nt[r]}return null},Nt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},fr=e=>Nt(e,decodeURI),ia=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),c=t.slice(a,i);return fr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return t.slice(a,r)},yr=e=>{const t=ia(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Re=(e,t,...a)=>(a.length&&(t=Re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),la=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},_t=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Nt(e,da):e):e,ca=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const c=o+t.length+2,l=e.indexOf("&",c);return _t(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let c=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(c=_t(c)),s=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),r&&(l=_t(l))),a?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(l)):n[c]??(n[c]=l)}return t?n[t]:n},vr=ca,br=(e,t)=>ca(e,t,!0),da=decodeURIComponent,Gt=e=>Nt(e,da),$e,V,ue,pa,ma,It,me,ea,ua=(ea=class{constructor(e,t="/",a=[[]]){N(this,ue);S(this,"raw");N(this,$e);N(this,V);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});N(this,me,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,V,a),D(this,$e,{})}param(e){return e?M(this,ue,pa).call(this,e):M(this,ue,ma).call(this)}query(e){return vr(this.url,e)}queries(e){return br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ir(this,e))}json(){return b(this,me).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,me).call(this,"text")}arrayBuffer(){return b(this,me).call(this,"arrayBuffer")}blob(){return b(this,me).call(this,"blob")}formData(){return b(this,me).call(this,"formData")}addValidatedData(e,t){b(this,$e)[e]=t}valid(e){return b(this,$e)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[or](){return b(this,V)}get matchedRoutes(){return b(this,V)[0].map(([[,e]])=>e)}get routePath(){return b(this,V)[0].map(([[,e]])=>e)[this.routeIndex].path}},$e=new WeakMap,V=new WeakMap,ue=new WeakSet,pa=function(e){const t=b(this,V)[0][this.routeIndex][1][e],a=M(this,ue,It).call(this,t);return a&&/\%/.test(a)?Gt(a):a},ma=function(){const e={},t=Object.keys(b(this,V)[0][this.routeIndex][1]);for(const a of t){const r=M(this,ue,It).call(this,b(this,V)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Gt(r):r)}return e},It=function(e){return b(this,V)[1]?b(this,V)[1][e]:e},me=new WeakMap,ea),wr={Stringify:1},ha=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(c=>ha(c,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},_r="text/plain; charset=UTF-8",xt=(e,t)=>({"Content-Type":e,...t}),Ve,Xe,ie,Me,le,K,Ze,Be,je,Ee,Qe,et,he,Ae,ta,xr=(ta=class{constructor(e,t){N(this,he);N(this,Ve);N(this,Xe);S(this,"env",{});N(this,ie);S(this,"finalized",!1);S(this,"error");N(this,Me);N(this,le);N(this,K);N(this,Ze);N(this,Be);N(this,je);N(this,Ee);N(this,Qe);N(this,et);S(this,"render",(...e)=>(b(this,Be)??D(this,Be,t=>this.html(t)),b(this,Be).call(this,...e)));S(this,"setLayout",e=>D(this,Ze,e));S(this,"getLayout",()=>b(this,Ze));S(this,"setRenderer",e=>{D(this,Be,e)});S(this,"header",(e,t,a)=>{this.finalized&&D(this,K,new Response(b(this,K).body,b(this,K)));const r=b(this,K)?b(this,K).headers:b(this,Ee)??D(this,Ee,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});S(this,"status",e=>{D(this,Me,e)});S(this,"set",(e,t)=>{b(this,ie)??D(this,ie,new Map),b(this,ie).set(e,t)});S(this,"get",e=>b(this,ie)?b(this,ie).get(e):void 0);S(this,"newResponse",(...e)=>M(this,he,Ae).call(this,...e));S(this,"body",(e,t,a)=>M(this,he,Ae).call(this,e,t,a));S(this,"text",(e,t,a)=>!b(this,Ee)&&!b(this,Me)&&!t&&!a&&!this.finalized?new Response(e):M(this,he,Ae).call(this,e,t,xt(_r,a)));S(this,"json",(e,t,a)=>M(this,he,Ae).call(this,JSON.stringify(e),t,xt("application/json",a)));S(this,"html",(e,t,a)=>{const r=n=>M(this,he,Ae).call(this,n,t,xt("text/html; charset=UTF-8",a));return typeof e=="object"?ha(e,wr.Stringify,!1,{}).then(r):r(e)});S(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});S(this,"notFound",()=>(b(this,je)??D(this,je,()=>new Response),b(this,je).call(this,this)));D(this,Ve,e),t&&(D(this,le,t.executionCtx),this.env=t.env,D(this,je,t.notFoundHandler),D(this,et,t.path),D(this,Qe,t.matchResult))}get req(){return b(this,Xe)??D(this,Xe,new ua(b(this,Ve),b(this,et),b(this,Qe))),b(this,Xe)}get event(){if(b(this,le)&&"respondWith"in b(this,le))return b(this,le);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,le))return b(this,le);throw Error("This context has no ExecutionContext")}get res(){return b(this,K)||D(this,K,new Response(null,{headers:b(this,Ee)??D(this,Ee,new Headers)}))}set res(e){if(b(this,K)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,K).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,K).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,K,e),this.finalized=!0}get var(){return b(this,ie)?Object.fromEntries(b(this,ie)):{}}},Ve=new WeakMap,Xe=new WeakMap,ie=new WeakMap,Me=new WeakMap,le=new WeakMap,K=new WeakMap,Ze=new WeakMap,Be=new WeakMap,je=new WeakMap,Ee=new WeakMap,Qe=new WeakMap,et=new WeakMap,he=new WeakSet,Ae=function(e,t,a){const r=b(this,K)?new Headers(b(this,K).headers):b(this,Ee)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Me);return new Response(e,{status:n,headers:r})},ta),G="ALL",Er="all",Tr=["get","post","put","delete","options","patch"],ga="Can not add a route since the matcher is already built.",fa=class extends Error{},kr="__COMPOSED_HANDLER",Sr=e=>e.text("404 Not Found",404),zt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,z,ya,ee,_e,it,lt,Pe,Ir=(Pe=class{constructor(t={}){N(this,z);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");N(this,Q,"/");S(this,"routes",[]);N(this,ee,Sr);S(this,"errorHandler",zt);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(D(this,ee,t),this));S(this,"fetch",(t,...a)=>M(this,z,lt).call(this,t,a[1],a[0],t.method));S(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Re("/",t)}`,a),r,n)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(M(this,z,lt).call(this,t.request,t,void 0,t.request.method))})});[...Tr,Er].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?D(this,Q,o):M(this,z,_e).call(this,s,b(this,Q),o),i.forEach(c=>{M(this,z,_e).call(this,s,b(this,Q),c)}),this)}),this.on=(s,o,...i)=>{for(const c of[o].flat()){D(this,Q,c);for(const l of[s].flat())i.map(u=>{M(this,z,_e).call(this,l.toUpperCase(),b(this,Q),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?D(this,Q,s):(D(this,Q,"*"),o.unshift(s)),o.forEach(i=>{M(this,z,_e).call(this,G,b(this,Q),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ia:yr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===zt?s=n.handler:(s=async(i,c)=>(await Ht([],a.errorHandler)(i,()=>n.handler(i,c))).res,s[kr]=n.handler),M(o=r,z,_e).call(o,n.method,n.path,s)}),this}basePath(t){const a=M(this,z,ya).call(this);return a._basePath=Re(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=c=>c:n=r.replaceRequest));const o=s?c=>{const l=s(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};n||(n=(()=>{const c=Re(this._basePath,t),l=c==="/"?0:c.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(l)||"/",new Request(h,u)}})());const i=async(c,l)=>{const u=await a(n(c.req.raw),...o(c));if(u)return u;await l()};return M(this,z,_e).call(this,G,Re(t,"*"),i),this}},Q=new WeakMap,z=new WeakSet,ya=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,ee,b(this,ee)),t.routes=this.routes,t},ee=new WeakMap,_e=function(t,a,r){t=t.toUpperCase(),a=Re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},it=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},lt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await M(this,z,lt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new xr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,ee)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await b(this,ee).call(this,i)})}catch(u){return M(this,z,it).call(this,u,i)}return l instanceof Promise?l.then(u=>u||(i.finalized?i.res:b(this,ee).call(this,i))).catch(u=>M(this,z,it).call(this,u,i)):l??b(this,ee).call(this,i)}const c=Ht(o[0],this.errorHandler,b(this,ee));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return M(this,z,it).call(this,l,i)}})()},Pe),va=[];function Cr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[G],i=o[2][s];if(i)return i;const c=s.match(o[0]);if(!c)return[[],va];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=r,r(e,t)}var dt="[^/]+",Ke=".*",Ye="(?:|/.*)",Ne=Symbol(),Or=new Set(".\\+*[^]$()");function Dr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ke||e===Ye?1:t===Ke||t===Ye?-1:e===dt?1:t===dt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Te,ke,te,Ce,Rr=(Ce=class{constructor(){N(this,Te);N(this,ke);N(this,te,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Te)!==void 0)throw Ne;if(s)return;D(this,Te,a);return}const[o,...i]=t,c=o==="*"?i.length===0?["","",Ke]:["","",dt]:o==="/*"?["","",Ye]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let h=c[2]||dt;if(u&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw Ne;if(l=b(this,te)[h],!l){if(Object.keys(b(this,te)).some(f=>f!==Ke&&f!==Ye))throw Ne;if(s)return;l=b(this,te)[h]=new Ce,u!==""&&D(l,ke,n.varIndex++)}!s&&u!==""&&r.push([u,b(l,ke)])}else if(l=b(this,te)[o],!l){if(Object.keys(b(this,te)).some(u=>u.length>1&&u!==Ke&&u!==Ye))throw Ne;if(s)return;l=b(this,te)[o]=new Ce}l.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,te)).sort(Dr).map(r=>{const n=b(this,te)[r];return(typeof b(n,ke)=="number"?`(${r})@${b(n,ke)}`:Or.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Te)=="number"&&a.unshift(`#${b(this,Te)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Te=new WeakMap,ke=new WeakMap,te=new WeakMap,Ce),pt,tt,aa,Ar=(aa=class{constructor(){N(this,pt,{varIndex:0});N(this,tt,new Rr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return n[o]=[l,c],o++,i=!0,l}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let c=s.length-1;c>=0;c--)if(s[c].indexOf(i)!==-1){s[c]=s[c].replace(i,n[o][1]);break}}return b(this,tt).insert(s,t,r,b(this,pt),a),r}buildRegExp(){let e=b(this,tt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},pt=new WeakMap,tt=new WeakMap,aa),Nr=[/^$/,[],Object.create(null)],ct=Object.create(null);function ba(e){return ct[e]??(ct[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Lr(){ct=Object.create(null)}function $r(e){var l;const t=new Ar,a=[];if(e.length===0)return Nr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[f,v])=>u?1:f?-1:h.length-v.length),n=Object.create(null);for(let u=0,h=-1,f=r.length;u<f;u++){const[v,g,x]=r[u];v?n[g]=[x.map(([E])=>[E,Object.create(null)]),va]:h++;let w;try{w=t.insert(g,h,v)}catch(E){throw E===Ne?new fa(g):E}v||(a[h]=x.map(([E,d])=>{const y=Object.create(null);for(d-=1;d>=0;d--){const[p,m]=w[d];y[p]=m}return[E,y]}))}const[s,o,i]=t.buildRegExp();for(let u=0,h=a.length;u<h;u++)for(let f=0,v=a[u].length;f<v;f++){const g=(l=a[u][f])==null?void 0:l[1];if(!g)continue;const x=Object.keys(g);for(let w=0,E=x.length;w<E;w++)g[x[w]]=i[g[x[w]]]}const c=[];for(const u in o)c[u]=a[o[u]];return[s,c,n]}function Oe(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ba(a).test(t))return[...e[a]]}}var ge,fe,mt,wa,ra,Mr=(ra=class{constructor(){N(this,mt);S(this,"name","RegExpRouter");N(this,ge);N(this,fe);S(this,"match",Cr);D(this,ge,{[G]:Object.create(null)}),D(this,fe,{[G]:Object.create(null)})}add(e,t,a){var i;const r=b(this,ge),n=b(this,fe);if(!r||!n)throw new Error(ga);r[e]||[r,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[G]).forEach(l=>{c[e][l]=[...c[G][l]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=ba(t);e===G?Object.keys(r).forEach(l=>{var u;(u=r[l])[t]||(u[t]=Oe(r[l],t)||Oe(r[G],t)||[])}):(i=r[e])[t]||(i[t]=Oe(r[e],t)||Oe(r[G],t)||[]),Object.keys(r).forEach(l=>{(e===G||e===l)&&Object.keys(r[l]).forEach(u=>{c.test(u)&&r[l][u].push([a,s])})}),Object.keys(n).forEach(l=>{(e===G||e===l)&&Object.keys(n[l]).forEach(u=>c.test(u)&&n[l][u].push([a,s]))});return}const o=la(t)||[t];for(let c=0,l=o.length;c<l;c++){const u=o[c];Object.keys(n).forEach(h=>{var f;(e===G||e===h)&&((f=n[h])[u]||(f[u]=[...Oe(r[h],u)||Oe(r[G],u)||[]]),n[h][u].push([a,s-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,fe)).concat(Object.keys(b(this,ge))).forEach(t=>{e[t]||(e[t]=M(this,mt,wa).call(this,t))}),D(this,ge,D(this,fe,void 0)),Lr(),e}},ge=new WeakMap,fe=new WeakMap,mt=new WeakSet,wa=function(e){const t=[];let a=e===G;return[b(this,ge),b(this,fe)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==G&&t.push(...Object.keys(r[G]).map(s=>[s,r[G][s]]))}),a?$r(t):null},ra),ye,ce,na,Br=(na=class{constructor(e){S(this,"name","SmartRouter");N(this,ye,[]);N(this,ce,[]);D(this,ye,e.routers)}add(e,t,a){if(!b(this,ce))throw new Error(ga);b(this,ce).push([e,t,a])}match(e,t){if(!b(this,ce))throw new Error("Fatal error");const a=b(this,ye),r=b(this,ce),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let c=0,l=r.length;c<l;c++)i.add(...r[c]);o=i.match(e,t)}catch(c){if(c instanceof fa)continue;throw c}this.match=i.match.bind(i),D(this,ye,[i]),D(this,ce,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ce)||b(this,ye).length!==1)throw new Error("No active router has been determined yet.");return b(this,ye)[0]}},ye=new WeakMap,ce=new WeakMap,na),ze=Object.create(null),ve,q,Se,Ue,F,de,xe,He,jr=(He=class{constructor(t,a,r){N(this,de);N(this,ve);N(this,q);N(this,Se);N(this,Ue,0);N(this,F,ze);if(D(this,q,r||Object.create(null)),D(this,ve,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,ve,[n])}D(this,Se,[])}insert(t,a,r){D(this,Ue,++Ut(this,Ue)._);let n=this;const s=pr(a),o=[];for(let i=0,c=s.length;i<c;i++){const l=s[i],u=s[i+1],h=gr(l,u),f=Array.isArray(h)?h[0]:l;if(f in b(n,q)){n=b(n,q)[f],h&&o.push(h[1]);continue}b(n,q)[f]=new He,h&&(b(n,Se).push(h),o.push(h[1])),n=b(n,q)[f]}return b(n,ve).push({[t]:{handler:r,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:b(this,Ue)}}),n}search(t,a){var c;const r=[];D(this,F,ze);let s=[this];const o=oa(a),i=[];for(let l=0,u=o.length;l<u;l++){const h=o[l],f=l===u-1,v=[];for(let g=0,x=s.length;g<x;g++){const w=s[g],E=b(w,q)[h];E&&(D(E,F,b(w,F)),f?(b(E,q)["*"]&&r.push(...M(this,de,xe).call(this,b(E,q)["*"],t,b(w,F))),r.push(...M(this,de,xe).call(this,E,t,b(w,F)))):v.push(E));for(let d=0,y=b(w,Se).length;d<y;d++){const p=b(w,Se)[d],m=b(w,F)===ze?{}:{...b(w,F)};if(p==="*"){const k=b(w,q)["*"];k&&(r.push(...M(this,de,xe).call(this,k,t,b(w,F))),D(k,F,m),v.push(k));continue}const[_,T,I]=p;if(!h&&!(I instanceof RegExp))continue;const C=b(w,q)[_],L=o.slice(l).join("/");if(I instanceof RegExp){const k=I.exec(L);if(k){if(m[T]=k[0],r.push(...M(this,de,xe).call(this,C,t,b(w,F),m)),Object.keys(b(C,q)).length){D(C,F,m);const O=((c=k[0].match(/\//))==null?void 0:c.length)??0;(i[O]||(i[O]=[])).push(C)}continue}}(I===!0||I.test(h))&&(m[T]=h,f?(r.push(...M(this,de,xe).call(this,C,t,m,b(w,F))),b(C,q)["*"]&&r.push(...M(this,de,xe).call(this,b(C,q)["*"],t,m,b(w,F)))):(D(C,F,m),v.push(C)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((l,u)=>l.score-u.score),[r.map(({handler:l,params:u})=>[l,u])]}},ve=new WeakMap,q=new WeakMap,Se=new WeakMap,Ue=new WeakMap,F=new WeakMap,de=new WeakSet,xe=function(t,a,r,n){const s=[];for(let o=0,i=b(t,ve).length;o<i;o++){const c=b(t,ve)[o],l=c[a]||c[G],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),r!==ze||n&&n!==ze))for(let h=0,f=l.possibleKeys.length;h<f;h++){const v=l.possibleKeys[h],g=u[l.score];l.params[v]=n!=null&&n[v]&&!g?n[v]:r[v]??(n==null?void 0:n[v]),u[l.score]=!0}}return s},He),Ie,sa,Pr=(sa=class{constructor(){S(this,"name","TrieRouter");N(this,Ie);D(this,Ie,new jr)}add(e,t,a){const r=la(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ie).insert(e,r[n],a);return}b(this,Ie).insert(e,t,a)}match(e,t){return b(this,Ie).search(e,t)}},Ie=new WeakMap,sa),be=class extends Ir{constructor(e={}){super(e),this.router=e.router??new Br({routers:[new Mr,new Pr]})}},Ur=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function c(h,f){o.res.headers.set(h,f)}const l=await r(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),a.credentials&&c("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&c("Vary","Origin"),a.maxAge!=null&&c("Access-Control-Max-Age",a.maxAge.toString());const h=await n(o.req.header("origin")||"",o);h.length&&c("Access-Control-Allow-Methods",h.join(","));let f=a.allowHeaders;if(!(f!=null&&f.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(f=v.split(/\s*,\s*/))}return f!=null&&f.length&&(c("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function _a(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:l}=await Promise.resolve().then(()=>Ta),u=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(u!=null&&u.telegram_chat_id))return;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!h)return;const f=await l(h.encrypted_value,u.pin_hash);await fetch(`https://api.telegram.org/bot${f}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:u.telegram_chat_id,text:c})})}catch(o){console.error("Failed to send provider alert:",o)}}function Ft(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class ka{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){S(this,"name");S(this,"apiKey");S(this,"model");S(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var u,h,f,v;const r=t.find(g=>g.role==="system"),n=t.filter(g=>g.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(g=>({role:g.role,content:g.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(g=>({name:g.name,description:g.description,input_schema:g.parameters})));const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const g=await o.text();throw new Error(this.name+" API error "+o.status+": "+g)}const i=await o.json(),c=((u=i.content)==null?void 0:u.filter(g=>g.type==="text"))||[],l=((h=i.content)==null?void 0:h.filter(g=>g.type==="tool_use"))||[];return{content:c.map(g=>g.text).join(`
`),toolCalls:l.map(g=>({id:g.id,name:g.name,arguments:g.input})),usage:{promptTokens:((f=i.usage)==null?void 0:f.input_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(l=>l.role==="system"),n=t.filter(l=>l.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(l=>({role:l.role,content:l.content}))};r&&(s.system=r.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const l=await o.text();throw new Error(this.name+" stream error "+o.status+": "+l)}const i=o.body.getReader(),c=new TextDecoder;return new ReadableStream({async pull(l){var g;const{done:u,value:h}=await i.read();if(u){l.close();return}const v=c.decode(h,{stream:!0}).split(`
`);for(const x of v)if(x.startsWith("data: ")){const w=x.slice(6);if(w==="[DONE]")continue;try{const E=JSON.parse(w);E.type==="content_block_delta"&&((g=E.delta)!=null&&g.text)&&l.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Gr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,o]of Object.entries(r))o&&typeof o=="object"?n[s]=Ct(o):n[s]=o;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Ct(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=Ct(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Ct(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Sa{constructor(t,a,r,n){S(this,"name");S(this,"apiKey");S(this,"model");S(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var c,l,u,h,f,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(g=>({role:g.role,content:g.content}))},n=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&n)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(g=>({type:"function",function:{name:g.name,description:g.description,parameters:Gr(g.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const g=await s.text();throw new Error(this.name+" API error "+s.status+": "+g)}const o=await s.json(),i=(c=o.choices)==null?void 0:c[0];return{content:((l=i==null?void 0:i.message)==null?void 0:l.content)||"",toolCalls:(h=(u=i==null?void 0:i.message)==null?void 0:u.tool_calls)==null?void 0:h.map(g=>({id:g.id,name:g.function.name,arguments:typeof g.function.arguments=="string"?JSON.parse(g.function.arguments||"{}"):g.function.arguments||{}})),usage:{promptTokens:((f=o.usage)==null?void 0:f.prompt_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const i=await n.text();throw new Error(this.name+" stream error "+n.status+": "+i)}const s=n.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var f,v,g;const{done:c,value:l}=await s.read();if(c){i.close();return}const h=o.decode(l,{stream:!0}).split(`
`);for(const x of h)if(x.startsWith("data: ")){const w=x.slice(6);if(w==="[DONE]")continue;try{const d=(g=(v=(f=JSON.parse(w).choices)==null?void 0:f[0])==null?void 0:v.delta)==null?void 0:g.content;d&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:d})+`

`))}catch{}}}})}}function Ot(e,t,a,r){const n=Je[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new ka(t,s,n.apiBase,a):new Sa(t,s,n.apiBase,a)}class Ia{constructor(){S(this,"errorLog",new Map);S(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const zr=["llm_slot_1","llm_slot_2","llm_slot_3"],Fr=["anthropic","openai"];async function at(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Ta),n=new Ia,s=[];for(const h of zr){const f=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(f)try{const v=await r(f.encrypted_value,a),g=JSON.parse(v);if(g.provider&&g.apiKey&&Je[g.provider]){const w=g.provider,E=Ot(g.provider,g.apiKey,w,g.model);s.push({name:w,provider:E})}}catch(v){console.error(`Failed to load ${h}:`,v)}}const o=new Set(s.map(h=>h.name));for(const h of Fr){if(o.has(h))continue;const f=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(f)try{const v=await r(f.encrypted_value,a);if(Je[h]){const x=Ot(h,v,h);s.push({name:h,provider:x})}}catch{console.error(`Failed to decrypt legacy ${h} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(h=>h.name),c=await n.pickProvider(i);if(!c)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const l=s.find(h=>h.name===c);return{provider:Wr(l.provider,s,n,e,t),rotation:n}}function Wr(e,t,a,r,n){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(c){const l=c.message||"";throw s(l)&&!l.includes("TOOLS_UNSUPPORTED")&&Et(r,n,"all_providers_down",e.name,null,l),c}},async streamChat(o,i){return await e.streamChat(o,i)}}:{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(c){const l=c.message||"";if(!s(l))throw c;const u=l.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${u?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,l,u?1:1440);const h=t.filter(f=>f.name!==e.name);for(const f of h)try{const v=await f.provider.chat(o,i);return this.name=f.name,u||Et(r,n,"provider_switched",e.name,f.name,l),v}catch(v){const g=v.message||"";if(s(g)){await a.recordError(f.name,g,1440);continue}throw v}throw Et(r,n,"all_providers_down",e.name,null,l),new Error(`All LLM providers failed. Primary (${e.name}): ${l.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,i){return await e.streamChat(o,i)}}}const Dt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ka,OpenAICompatibleProvider:Sa,ProviderRotation:Ia,createProviderFromConfig:Ot,createRotatingProvider:at,logError:A},Symbol.toStringTag,{value:"Module"})),Tt=20,qr=2e3,Kr=2e3,Ca=4;function Yr(e){return Math.ceil(e.length/Ca)}function Wt(e,t){const a=t*Ca;return e.length<=a?e:e.slice(0,a)+`
...
`),t.trim()}async function Ka(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await gt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async f=>{const v=await qa(f.link);return{title:f.title,url:f.link,displayLink:f.displayLink,snippet:f.snippet,content:v.text,error:v.error}}),l=(await Promise.all(i)).filter(f=>f.content.length>50);if(l.length===0){const f=s.results.map((g,x)=>`[${x+1}] ${g.title}
${g.snippet}
Source: ${g.link}`).join(`

`);return{report:await qt(e,f,t,"snippets"),sources:s.results.map(g=>({title:g.title,url:g.link})),pagesRead:0}}const u=l.map((f,v)=>`--- SOURCE ${v+1}: ${f.title} (${f.displayLink}) ---
${f.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await qt(e,u,t,"full"),sources:l.map(f=>({title:f.title,url:f.url})),pagesRead:l.length}}async function qt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.spreadsheet_id;let p=t.range;const m=await d.sheets.getMetadata(y),_=m.sheets;p.includes("!")||(p=`${_[0]}!${p}`);let T;try{T=await d.sheets.readRange(y,p)}catch(C){if((f=C.message)!=null&&f.includes("Unable to parse range")||(v=C.message)!=null&&v.includes("400")){const L=p.includes("!")?p.split("!")[1]:p;p=`${_[0]}!${L}`,T=await d.sheets.readRange(y,p)}else throw C}let I=`[Spreadsheet: "${m.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(C=>`"${C}"`).join(", ")}]
`;return _.length>1&&(I+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),T.length===0?I+"No data found in the specified range.":I+T.map(C=>C.join("	| ")).join(`
`)}catch(d){return await A(a,r,"google","read_sheet",d.message),`Failed to read sheet: ${d.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.values;let p=t.range;const T=Math.max(...y.map(k=>k.length))+4,I=y.map(k=>{const O=[...k];for(;O.length<T;)O.push("");return O}),C=p.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(C){const k=C[1]||"",O=C[2],R=C[3],B=C[5],$=O.toUpperCase().charCodeAt(0)-64+T-1,Y=$<=26?String.fromCharCode(64+$):"Z";p=`${k}${O}${R}:${Y}${B}`}return`Written ${(await d.sheets.writeRange(t.spreadsheet_id,p,I)).updatedCells} cells to ${p}.`}catch(d){return await A(a,r,"google","write_sheet",d.message),`Failed to write sheet: ${d.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new re(a,r,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(d){return await A(a,r,"google","append_sheet",d.message),`Failed to append to sheet: ${d.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await d.sheets.createSpreadsheet(t.title,t.sheet_names);let m="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ot)).getGoogleAuth(a,r,n,s||"",o||"");m=`
Folder: "${(await Yt(_,p.spreadsheetId,t.folder_name)).folderName}"`}catch(_){m=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new X(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${m}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(d){return await A(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.calendar_id||"primary",p=t.days_ahead||7,m=new Date,_=new Date(m.getTime()+p*24*60*60*1e3),T=await d.calendar.listEvents(y,{timeMin:m.toISOString(),timeMax:_.toISOString(),query:t.query});return T.length===0?`No events found in the next ${p} days.`:T.map(I=>{var R;const C=I.start.dateTime||I.start.date||"TBD",L=I.end.dateTime||I.end.date||"",k=I.location?` 📍 ${I.location}`:"",O=((R=I.attendees)==null?void 0:R.map(B=>B.email).join(", "))||"";return`• ${I.summary} — ${C} to ${L}${k}${O?`
  Attendees: ${O}`:""}`}).join(`
...
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(d){return await A(a,r,"google","create_event",d.message),`Failed to create event: ${d.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await d.docs.createDocument(t.title);t.content&&await d.docs.appendText(p.documentId,t.content);let m="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ot)).getGoogleAuth(a,r,n,s||"",o||"");m=`
Folder: "${(await Yt(_,p.documentId,t.folder_name)).folderName}"`}catch(_){m=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new X(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${m}
ID: ${p.documentId}
...
`)}catch(d){return await A(a,r,"search","web_search",d.message),`Web search error: ${d.message}`}case"read_url":try{const d=t.url;if(!d||!d.startsWith("http://")&&!d.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>on),m=await p(d,y);return m.error?`Failed to read page: ${m.error}`:!m.text||m.text.length<20?`Page at ${d} returned no readable content.`:`Content from ${d} (${m.text.length} chars):

${m.text}`}catch(d){return await A(a,r,"search","read_url",d.message),`Read URL error: ${d.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const y=Ka(t.query,u,{depth:t.depth||"quick",site:t.site}),p=new Promise(T=>setTimeout(()=>T(null),45e3)),m=await Promise.race([y,p]);if(m===null){const{webSearch:T}=await Promise.resolve().then(()=>tn),I=await T(t.query,{num:5});if(I.error||I.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let C=`Research took too long, but here are the top search results:

`;return C+=I.results.map((L,k)=>`${k+1}. **${L.title}**
   ${L.snippet}
   ${L.link}`).join(`

`),C}if(m.error)return`Research failed: ${m.error}`;let _=m.report;return m.sources.length>0&&(_+=`

---
**Sources** (`+m.pagesRead+` pages read):
`,_+=m.sources.map((T,I)=>`[${I+1}] ${T.title}
    ${T.url}`).join(`
`)),_}catch(d){return await A(a,r,"research","research",d.message),`Research error: ${d.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await j(d.encrypted_value,n),p=await ja(y,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((m,_)=>{const T=m.rating?` ★${m.rating} (${m.userRatingsTotal||0} reviews)`:"",I=m.openNow!==void 0?m.openNow?" · Open now":" · Closed":"",C=m.googleMapsUri?`
   ${m.googleMapsUri}`:"";return`${_+1}. **${m.name}**${T}${I}
   ${m.address}${C}
   [place_id: ${m.placeId}]`}).join(`

`)}catch(d){return await A(a,r,"google_api","search_places",d.message),`Places search error: ${d.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await j(d.encrypted_value,n),p=await Pa(y,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const m=p.details;let _=`**${m.name}**
📍 ${m.address}`;if(m.phone&&(_+=`
📞 ${m.phone}`),m.website&&(_+=`
🌐 ${m.website}`),m.rating&&(_+=`
★ ${m.rating}`),m.googleMapsUri&&(_+=`
📌 ${m.googleMapsUri}`),m.openingHours&&(_+=`

Opening Hours:
${m.openingHours.join(`
`)}`),m.reviews&&m.reviews.length>0){_+=`

Recent Reviews:`;for(const T of m.reviews)_+=`
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return _}catch(d){return await A(a,r,"google_api","place_details",d.message),`Place details error: ${d.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await j(d.encrypted_value,n),p=await Ua(y,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const m=p.route;let _=`**${m.startAddress}** → **${m.endAddress}**
`;return _+=`📏 ${m.distance} · ⏱️ ${m.duration}`,m.durationInTraffic&&(_+=` (with traffic: ${m.durationInTraffic})`),_+=`
via ${m.summary}`,_+=`

Steps:`,m.steps.forEach((T,I)=>{_+=`
${I+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),_}catch(d){return await A(a,r,"google_api","directions",d.message),`Directions error: ${d.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await j(d.encrypted_value,n),p=await Fa(y,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let m=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(m+=` (with traffic: ${p.durationInTraffic})`),m}catch(d){return await A(a,r,"google_api","travel_time",d.message),`Travel time error: ${d.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await j(d.encrypted_value,n),p=await Ha(y,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(d){return await A(a,r,"google_api","translate",d.message),`Translation error: ${d.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await j(d.encrypted_value,n),p=await za(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((m,_)=>{var T;return`${_+1}. **${m.title}**
   ${m.channelTitle} · ${((T=m.publishedAt)==null?void 0:T.split("T")[0])||""}
   ${m.description}
   ${m.url}`}).join(`

`)}catch(d){return await A(a,r,"google_api","youtube_search",d.message),`YouTube search error: ${d.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await j(d.encrypted_value,n),p=await Ga(y,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((m,_)=>`${_+1}. ${m.address}
   Coordinates: ${m.lat}, ${m.lng}`).join(`
`)}catch(d){return await A(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Jt(e,t,a,r,n,s){var d;const o=new X(t),i=(d=e.metadata)==null?void 0:d.thread_id,c=await o.buildContext(r.id),l=await o.getRecentConversations(r.id,25,i),h=[{role:"system",content:Xa(r,c)},...l.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",g=0;const x=[];for(let y=0;y<f;y++)try{const p=await a.chat(h,{tools:ft});if(p.usage&&(g+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&h.push({role:"assistant",content:p.content});for(const m of p.toolCalls){x.push(m.name);try{const _=await Le(m.name,m.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);h.push({role:"user",content:`[Tool Result for ${m.name}]: ${_}`})}catch(_){await A(t,r.id,"tool",m.name,_.message||"Tool execution failed"),h.push({role:"user",content:`[Tool Error for ${m.name}]: ${_.message||"Execution failed"}`})}}continue}v=p.content;break}catch(p){if(n){const m=p.message||"",_=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),T=m.includes("429"),I=_?1440:T?10:5;await n.recordError(a.name,m,I)}throw await A(t,r.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:a.name,turn:y}),p}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}const w=v.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),E=x.length>0?`[TOOLS_USED: ${[...new Set(x)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",E+w,"{}",i),await o.compactHistory(r.id,30),v}const Vt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function hn(e){for(const[t,a]of Object.entries(Vt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Vt.default}function gn(e,t,a,r){const n=hn(r),s=Math.floor(n*.75),o=[];let i=0,c=!1;const l=St(e);o.push({role:"system",content:e}),i+=l;const u=St(a);i+=u;const h=s-i,f=[];let v=0;for(let g=t.length-1;g>=0;g--){const x=t[g],w=St(x.content);if(v+w<=h)f.unshift({role:x.role,content:x.content}),v+=w;else{c=!0;break}}return o.push(...f),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:c}}async function*fn(e,t,a,r,n,s){var w;const o=new X(t),i=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const c=await o.buildContext(r.id),l=await o.getRecentConversations(r.id,20,i),u=Xa(r,c),h=gn(u,l,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",g=0;const x=[...h.messages];for(let E=0;E<f;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:ft});if(d.usage&&(g+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const p of d.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const m=await Le(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:m.substring(0,500)+(m.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${p.name}]: ${m}`})}catch(m){await A(t,r.id,"tool",p.name,m.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${m.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${p.name}]: ${m.message||"Execution failed"}`})}}continue}v=d.content;const y=50;for(let p=0;p<v.length;p+=y)yield{type:"chunk",data:{text:v.substring(p,p+y),threadId:i}},p+y<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(d){if(n){const y=d.message||"",p=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),m=y.includes("429"),_=p?1440:m?10:5;await n.recordError(a.name,y,_)}await A(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:g}}}async function jt(e,t,a,r,n,s){var u;const o=new X(t),i=(u=e.metadata)==null?void 0:u.thread_id,c=await o.buildContext(r.id),l=Ya(e.text,c);if(l.agent==="conversation")return vn(e,t,a,r,c,n,i);if(l.agent==="multi"||l.confidence<.5)return Jt(e,t,a,r,n,s);try{return await yn(l.agent,e,t,a,r,c,n,s,i)}catch(h){return await A(t,r.id,"router","subagent_fallback",`${l.agent} failed: ${h.message}`,{route:l}),Jt(e,t,a,r,n,s)}}async function yn(e,t,a,r,n,s,o,i,c){const l=new X(a),u=yt(n.timezone),h=ut(e,n,s,n.timezone,u),f=Ja(e,ft),v=(await l.getRecentConversations(n.id,25,c)).map(k=>({...k,content:k.content.replace(/^\[TOOLS_USED: [^\]]+\]\s*/i,"")})),g=[{role:"system",content:h},...v.map(k=>({role:k.role,content:k.content})),{role:"user",content:t.text}];await l.storeMessage(n.id,t.channel,"user",t.text,"{}",c);const x=10;let w="",E=0,d="",y=!1;const p=[];for(let k=0;k<x;k++)try{const O=await r.chat(g,{tools:f.length>0?f:void 0});if(O.usage&&(E+=O.usage.promptTokens+O.usage.completionTokens),O.toolCalls&&O.toolCalls.length>0){y=!0,O.content&&(d=O.content,g.push({role:"assistant",content:O.content}));for(const R of O.toolCalls){p.push(R.name);try{const B=await Le(R.name,R.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g.push({role:"user",content:`[Tool Result for ${R.name}]: ${B}`})}catch(B){await A(a,n.id,"tool",R.name,B.message||"Tool execution failed"),g.push({role:"user",content:`[Tool Error for ${R.name}]: ${B.message||"Execution failed"}`})}}continue}w=O.content,!w&&d&&(w=d);break}catch(O){if(o){const R=O.message||"",B=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),H=R.includes("429"),$=B?1440:H?10:5;await o.recordError(r.name,R,$)}throw await A(a,n.id,"llm","subagent_error",O.message||"Unknown error",{agent:e,provider:r.name,turn:k}),O}const m=["scheduler","workspace","research"],_=e==="scheduler"&&!p.includes("create_schedule")&&!p.includes("list_schedules")&&!p.includes("toggle_schedule")&&!p.includes("update_schedule_state")&&!p.includes("delete_schedule")&&/\b(remind|in\s+\d+|at\s+\d{1,2}[:.]\d{0,2}|timer|alarm|schedule|tell\s+me\s+in|notify|alert|ping)\b/i.test(t.text),T=e==="workspace"&&p.includes("read_sheet")&&!p.includes("write_sheet")&&!p.includes("append_sheet")&&/\b(fix|correct|update|change|delete|remove|clean|clear|repair|replace|overwrite|set\s+to|should\s+be|wrong|broken|gap|missing)\b/i.test(t.text);if(!y&&m.includes(e)&&f.length>0||_||T){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),w.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{g.push({role:"assistant",content:w});let k;e==="scheduler"&&_?k=`[SYSTEM OVERRIDE] You called ${p.join(", ")||"no tools"} but did NOT call create_schedule. The user wants a reminder or schedule created. Call create_schedule NOW with the correct parameters. Do NOT respond with text saying a reminder is set — actually create it.`:e==="workspace"&&T?k="[SYSTEM OVERRIDE] You called read_sheet but did NOT call write_sheet. The user asked you to FIX or UPDATE the sheet data. You MUST call write_sheet NOW to make the actual changes. Reading data and then describing what you would fix is NOT the same as fixing it. Call write_sheet with the corrected values, then call read_sheet again to verify the fix landed correctly. Do NOT claim data is fixed without actually writing to the sheet.":k=`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${f.slice(0,3).map(R=>R.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`,g.push({role:"user",content:k});const O=await r.chat(g,{tools:f});if(O.usage&&(E+=O.usage.promptTokens+O.usage.completionTokens),O.toolCalls&&O.toolCalls.length>0){y=!0;let R=O.toolCalls,B=O.content;for(let H=0;H<5;H++){B&&g.push({role:"assistant",content:B});for(const Y of R){p.push(Y.name);try{const J=await Le(Y.name,Y.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g.push({role:"user",content:`[Tool Result for ${Y.name}]: ${J}`})}catch(J){g.push({role:"user",content:`[Tool Error for ${Y.name}]: ${J.message||"Execution failed"}`})}}const $=await r.chat(g,{tools:f});if($.usage&&(E+=$.usage.promptTokens+$.usage.completionTokens),$.toolCalls&&$.toolCalls.length>0){R=$.toolCalls,B=$.content;continue}$.content&&(w=$.content);break}}if(!p.includes("create_schedule")&&e==="scheduler")try{const R=pn(t.text);if(R){const B=await Le("create_schedule",R.args,a,n.id,{agentType:"scheduler",providerName:"programmatic_fallback",channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y=!0,p.push("create_schedule"),w=B}}catch(R){await A(a,n.id,"tool_enforcement","scheduler_fallback",`Programmatic scheduler fallback failed: ${R.message||"Unknown"}`)}}catch(k){await A(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${k.message||"Unknown"}`,{originalResponse:w.substring(0,200)})}}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}const C=w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),L=p.length>0?`[TOOLS_USED: ${[...new Set(p)].join(", ")}] `:"";return await l.storeMessage(n.id,t.channel,"assistant",L+C,"{}",c),await l.compactHistory(n.id,30),w}async function vn(e,t,a,r,n,s,o){const i=new X(t),c=yt(r.timezone),l=ut("conversation",r,n,r.timezone,c),u=await i.getRecentConversations(r.id,25,o),h=[{role:"system",content:l},...u.map(g=>({role:g.role,content:g.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let f=0,v="";try{const g=await a.chat(h,{temperature:.8});g.usage&&(f=g.usage.promptTokens+g.usage.completionTokens),v=g.content}catch(g){if(s){const x=g.message||"",w=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),E=x.includes("429"),d=w?1440:E?10:5;await s.recordError(a.name,x,d)}throw await A(t,r.id,"llm","conversation_error",g.message,{provider:a.name}),g}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*bn(e,t,a,r,n,s){var d;const o=new X(t),i=(d=e.metadata)==null?void 0:d.thread_id,c=await o.buildContext(r.id),l=Ya(e.text,c);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},l.agent==="multi"||l.confidence<.5){yield*fn(e,t,a,r,n,s);return}const u=yt(r.timezone),h=l.agent==="conversation"?ut("conversation",r,c,r.timezone,u):ut(l.agent,r,c,r.timezone,u),f=Ja(l.agent,ft),v=await o.getRecentConversations(r.id,25,i),g=[{role:"system",content:h},...v.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let w="",E=0;for(let y=0;y<x;y++)try{y>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(g,{tools:f.length>0?f:void 0});if(p.usage&&(E+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},g.push({role:"assistant",content:p.content}));for(const _ of p.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const T=await Le(_.name,_.arguments,t,r.id,{agentType:l.agent,providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},g.push({role:"user",content:`[Tool Result for ${_.name}]: ${T}`})}catch(T){await A(t,r.id,"tool",_.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},g.push({role:"user",content:`[Tool Error for ${_.name}]: ${T.message||"Execution failed"}`})}}continue}w=p.content;const m=50;for(let _=0;_<w.length;_+=m)yield{type:"chunk",data:{text:w.substring(_,_+m),threadId:i}},_+m<w.length&&await new Promise(I=>setTimeout(I,10));break}catch(p){if(n){const m=p.message||"",_=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),T=m.includes("429"),I=_?1440:T?10:5;await n.recordError(a.name,m,I)}await A(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:l.agent,provider:a.name,turn:y}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const P=new be;async function wn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}P.use("/*",wn);P.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const l=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=l==null?void 0:l.id}const c={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:l,rotation:u}=await at(e.env.DB,t.id,t.pin_hash),h=await jt(c,e.env.DB,l,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});return!n&&i?await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run():i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),e.json({response:h,timestamp:new Date().toISOString(),channel:c.channel,provider:l.name,thread_id:i})}catch(l){console.error("Chat error:",l);const u=l.message||"";if(u.includes("No LLM provider configured"))return e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400);if(u.includes("All LLM providers failed"))return e.json({error:u,type:"no_provider",thread_id:i},400);if(u.includes("limit reached"))return e.json({error:u,type:"cost_limit",thread_id:i},429);const h=u.includes("401")||u.includes("403")||u.includes("authentication")||u.includes("credit balance")||u.includes("invalid")&&u.includes("key");try{const{logError:f}=await Promise.resolve().then(()=>Dt);await f(e.env.DB,t.id,"llm","chat_error",u)}catch{}return e.json({error:h?"API key error — your provider returned an authentication or billing error. Check Settings → Keys to verify your API keys are valid.":"Something went wrong. I'll be back in a moment.",details:u,type:h?"no_provider":void 0,thread_id:i},h?400:500)}});function Xt(e){return`event: ${e.type}
data: ${JSON.stringify(e.data)}

`}P.post("/stream",async e=>{const t=e.get("user"),{message:a,channel:r="web",thread_id:n,files:s}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let o="";if(s&&Array.isArray(s)&&s.length>0){o=`

[Attached files:
`;for(const l of s)o+=`- ${l.name} (${l.type}, ${Math.round(l.size/1024)}KB, file_id: ${l.file_id})`,l.text_preview&&(o+=`
  Preview: ${l.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const l=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=l==null?void 0:l.id}const c={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:l,rotation:u}=await at(e.env.DB,t.id,t.pin_hash),h=new ReadableStream({async start(f){const v=new TextEncoder;try{const g=bn(c,e.env.DB,l,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of g)x.data.threadId||(x.data.threadId=i),f.enqueue(v.encode(Xt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),f.close()}catch(g){const x={type:"error",data:{error:g.message||"An error occurred",threadId:i}};f.enqueue(v.encode(Xt(x))),f.close()}}});return new Response(h,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(l){console.error("Stream setup error:",l);const u=l.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});P.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?`).bind(t.id,a,r).all();return e.json({messages:(n.results||[]).reverse(),total:((s=n.results)==null?void 0:s.length)||0})});P.get("/history",async e=>{var c;const t=e.get("user"),a=parseInt(e.req.query("limit")||"50"),r=parseInt(e.req.query("offset")||"0"),n=e.req.query("thread_id");let s,o;n?(s=`SELECT id, role, content, channel, thread_id, created_at FROM conversations 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await W(a,t,c),!0}case"/help":{const i=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await W(a,t,i),!0}case"/status":{if(!r)return await W(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[o,i,c,l]=await Promise.all([n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),u=`📊 *System Status*
...
Status: ✅ Online`;await W(a,t,u)}catch{await W(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await W(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await W(a,t,"⚠️ Account not linked."),!0);default:return!1}}rt.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await Dn(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const c=!!i.text,l=!!i.voice,u=!!i.document,h=!!i.photo,f=!!i.caption;if(!c&&!l&&!u&&!h)return e.json({ok:!0});const v=String(i.chat.id);let g=i.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let w=null;if(x){const m=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();m&&(w=await j(m.encrypted_value,x.pin_hash))}if(!w){const m=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();m&&(w=await j(m.encrypted_value,m.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(g.startsWith("/")&&await On(g,v,w,x,e.env.DB))return e.json({ok:!0});if(!x)return await W(w,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&w&&x)try{await W(w,v,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${i.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const I=await(await fetch(`https://api.telegram.org/file/bot${w}/${_.result.file_path}`)).blob();let C="",L="",k="whisper-1";const O=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const $ of O.results){const Y=await j($.encrypted_value,x.pin_hash);if($.service==="openai"){C="https://api.openai.com/v1/audio/transcriptions",L=Y;break}else if($.service.startsWith("llm_slot_"))try{const J=JSON.parse(Y);if(J.provider==="openai"){C="https://api.openai.com/v1/audio/transcriptions",L=J.apiKey;break}else if(J.provider==="groq"){C="https://api.groq.com/openai/v1/audio/transcriptions",L=J.apiKey,k="whisper-large-v3";break}}catch{}}if(!C)return await W(w,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const R=new FormData;R.append("file",I,"voice.ogg"),R.append("model",k),R.append("language","en");const B=await fetch(C,{method:"POST",headers:{Authorization:`Bearer ${L}`},body:R});if(!B.ok){const $=await B.text();return await W(w,v,`⚠️ Transcription failed: ${B.status} ${$}`),e.json({ok:!0})}g=(await B.json()).text,await W(w,v,`🗣️ *You said:* ${g}`)}}catch(m){return await W(w,v,`⚠️ Failed to process voice note: ${m.message}`),e.json({ok:!0})}if((u||h)&&w&&x)try{let m,_="unknown",T="unknown",I=0;if(u)m=i.document.file_id,_=i.document.file_name||"document",T=i.document.mime_type||"unknown",I=i.document.file_size||0;else if(h){const C=i.photo[i.photo.length-1];m=C.file_id,_="photo.jpg",T="image/jpeg",I=C.file_size||0}if(m){const L=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${m}`)).json();let k="";if(L.ok&&((a=L.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(_)||/^text\/|application\/json|application\/xml|application\/csv/i.test(T))&&I<5e4)try{k=await(await fetch(`https://api.telegram.org/file/bot${w}/${L.result.file_path}`)).text()}catch{}const O=i.caption||"",R=`[Telegram file received: "${_}" (${T}, ${Math.round(I/1024)}KB)]`;k?g=`${O?O+`
...
`:""}${R}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(m){if(f&&i.caption)g=i.caption;else return await W(w,v,`⚠️ Received your file but couldn't process it: ${m.message}`),e.json({ok:!0})}if(!g)return e.json({ok:!0});await In(w,v);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=Tn(x.id,x.username,g,v);d.metadata={thread_id:E.id};let y,p;try{const m=await at(e.env.DB,x.id,x.pin_hash);y=m.provider,p=m.rotation}catch(m){console.error("Telegram provider setup error:",m);const _=(r=m.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=m.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${m.message||"Unknown error"}`;return await W(w,v,_),e.json({ok:!0})}try{const m=await jt(d,e.env.DB,y,x,p,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),_=kn(m,"telegram");await W(w,v,_||"(empty response)")}catch(m){console.error("Telegram agent error:",m);const _=(s=m.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${y.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(m.message||"Unknown").substring(0,200)}`;await W(w,v,_);try{const{logError:T}=await Promise.resolve().then(()=>Dt);await T(e.env.DB,x.id,"telegram","agent_error",m.message||"Agent error",{provider:y.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>Dt);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});rt.post("/setup-webhook",async e=>{var c;const t=(c=e.req.header("Authorization"))==null?void 0:c.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await j(n.encrypted_value,a.pin_hash);if(!r){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});rt.get("/webhook-status",async e=>{var s,o,i,c,l,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await j(r.encrypted_value,a.pin_hash);try{const f=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=f.result)==null?void 0:o.url)||"",has_webhook:!!((i=f.result)!=null&&i.url),pending_updates:((c=f.result)==null?void 0:c.pending_update_count)||0,last_error:((l=f.result)==null?void 0:l.last_error_message)||"",last_error_date:((u=f.result)==null?void 0:u.last_error_date)||null})}catch(h){return e.json({configured:!0,error:h.message})}});rt.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await j(r.encrypted_value,a.pin_hash);try{const l=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const h=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();l&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:l,allowed_updates:["message"]})});const f=h.result||[];if(f.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],g=new Set;for(let w=f.length-1;w>=0;w--){const E=f[w].message;if(E&&E.chat){const d=String(E.chat.id);g.has(d)||(g.add(d),v.push({chat_id:d,name:[E.chat.first_name,E.chat.last_name].filter(Boolean).join(" ")||E.chat.title||"Unknown",username:E.chat.username||"",date:new Date((E.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const x=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(x,a.user_id).run(),e.json({found:!0,chat_id:x,name:v[0].name,all_chats:v,message:`Chat ID ${x} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function Dn(e,t){var x;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const o=r.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],c=parseInt(o[2]);if(!c||!i)return;const l=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const h=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(u.id,c,i).first();if(!h)return;const f=h.checked?0:1;await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ?
  `).bind(f,f,h.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!v)return;const g=await j(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${g}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:f?"✅ Checked!":"☐ Unchecked"})}),(x=n.reply_markup)!=null&&x.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(E=>E.map(d=>{var y;if((y=d.callback_data)!=null&&y.includes(i)){const p=f?"✅":"☐",m=d.text.replace(/^[☐✅]\s*/,"");return{...d,text:`${p} ${m}`}}return d}));try{await fetch(`https://api.telegram.org/bot${g}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function Rn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function An(e,t,a,r,n,s){try{return(await new Bt(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(c=>{var l;return{id:c.id||`google-${Date.now()}`,title:c.summary||"Untitled Event",startTime:c.start.dateTime||c.start.date||"",endTime:c.end.dateTime||c.end.date||"",location:c.location,attendees:(l=c.attendees)==null?void 0:l.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function Nn(e,t,a,r,n){try{const s=new oe(e,t,a,r,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),c={};for(const h of o){const f=h.from.split("<")[0].trim()||h.from;c[f]=(c[f]||0)+1}const l=Object.entries(c).sort(([,h],[,f])=>f-h).slice(0,5).map(([h])=>h),u=o.some(h=>h.subject.toLowerCase().includes("urgent")||h.subject.toLowerCase().includes("asap")||h.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:l,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Ln(e,t){var a;try{const r=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(r.results||[]).map(c=>c.name),i=(r.results||[]).filter(c=>new Date(c.next_run)<=s).length;return{pending:((a=r.results)==null?void 0:a.length)||0,dueToday:i,items:o}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function $n(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],a=[];for(const r of t){const n=`latest ${r} news today`;try{const s=await gt(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!a.some(i=>i.url===o.link)&&(a.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),a.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(a.length>=5)break}return a.slice(0,5)}function Mn(e){const t=[];t.push(`📋 Briefing for ${e.targetDate}`),t.push("");const a=e.calendar.totalCount;if(a>0){t.push(`📅 Tomorrow: ${a} event${a===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const r=e.emails.gmail.unreadCount;if(r>0?(t.push(`📧 Gmail: ${r} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function Bn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function jn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function Qa(e,t,a){var E;const r=t.timezone||"Asia/Kolkata",n=Rn(r),{components:s,newsTopics:o}=await jn(e,t.id),i=[],c=[];s.google_calendar&&(i.push(An(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),c.push("googleEvents")),s.gmail&&(i.push(Nn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),c.push("gmailSummary")),s.tasks&&(i.push(Ln(e,t.id)),c.push("tasks")),s.news&&(i.push($n(o)),c.push("news"));const l=await Promise.all(i),u={};c.forEach((d,y)=>{u[d]=l[y]});const h={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},f={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((E=u.googleEvents)==null?void 0:E.length)||0},emails:{gmail:u.gmailSummary||h},tasks:u.tasks||f,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};v.summary=Mn(v);const g=Bn(v),x=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(v)).first(),w=(x==null?void 0:x.id)||0;for(const d of g)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(w,d.type,d.key,d.text,JSON.stringify(d.metadata),d.sortOrder).run();return{briefingId:w,content:v,items:g}}async function Pn(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function Un(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function Hn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function Gn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),c=n*60+s,l=o*60+i;return c===l}function zn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const Z=new be;async function er(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",c=o.briefing_time||"20:00";if(Gn(c,i,s))try{const l=await Qa(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:h}=zn(l.content,l.items);await Fn(e.env.DB,o,u,h,l.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:l.briefingId,briefing_time:c,timezone:i})}catch(l){n.push({user_id:o.id,status:"error",error:l.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});Z.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const c of r.results||[])try{const l=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(c.id).first();if(!l)continue;const u=await j(l.encrypted_value,c.pin_hash),f=JSON.parse(u).access_token;if(!f)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${f}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(d=>{var p;const y=(p=d.start)==null?void 0:p.dateTime;return y?y>=s.toISOString()&&y<=o:!1});if(x.length===0){n.push({user_id:c.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(c.id).first();if(!w)continue;const E=await j(w.encrypted_value,c.pin_hash);for(const d of x){const y=new Date(d.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=d.location?`
📍 ${d.location}`:"",m=`⏰ Meeting in 10 minutes!

*${d.summary||"Untitled Event"}*
🕐 ${y}${p}`;await fetch(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c.telegram_chat_id,text:m,parse_mode:"Markdown"})})}n.push({user_id:c.id,reminders_sent:x.length})}catch(l){n.push({user_id:c.id,status:"error",error:l.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function Fn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const o=await j(s.encrypted_value,s.pin_hash);await fetch(`https://api.telegram.org/bot${o}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:`📋 *Briefing*

${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(c=>({...c,callback_data:`${c.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}Z.delete("/briefings/:id",er,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const ae=new be;ae.use("/api/*",Ur());ae.route("/api/auth",we);ae.route("/api/chat",P);ae.route("/api/settings",U);ae.route("/api/system",pe);ae.route("/api/telegram",rt);ae.route("/api/proactive",Z);ae.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(De(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(De(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(De(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(De(!1,"Session expired. Please log in again and retry."));const c=i.user_id,l=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,h=await La(e.env.DB,c,l,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(De(!0,`Connected as ${h.email}`,h.email))}catch(s){return e.html(De(!1,`OAuth failed: ${s.message}`))}});ae.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(_a())));ae.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(_a())));function De(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function Wn(e,t,a){const r="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const i=await(await fetch(`${r}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(i.results&&i.results.length>0){const l=i.results.filter(h=>h.needs_agent&&h.status==="dispatched");if(l.length>0){const h=l.map(f=>fetch(`${r}/api/system/cron/run-task/${f.job_id}`,{method:"POST",headers:s}).then(v=>v.json()).catch(v=>({job_id:f.job_id,error:v.message})));a.waitUntil(Promise.allSettled(h).then(f=>{console.log(`Cron: ${i.executed} dispatched, ${l.length} agent tasks`,JSON.stringify(f.map(v=>v.status==="fulfilled"?v.value:v.reason)))}))}const u=i.results.filter(h=>!h.needs_agent&&h.status==="dispatched");if(u.length>0){const h=u.map(f=>fetch(`${r}/api/system/cron/run-task/${f.job_id}`,{method:"POST",headers:s}).catch(()=>{}));a.waitUntil(Promise.allSettled(h))}}a.waitUntil(fetch(`${r}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(l=>l.json()).then(l=>{l.executed>0&&console.log("Evening briefing result:",JSON.stringify(l))}).catch(l=>{console.error("Evening briefing error:",l.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${r}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(l=>l.json()).then(l=>{var u;(u=l.results)!=null&&u.some(h=>h.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(l))}).catch(()=>{}))}catch(o){console.error("Scheduled cron error:",o.message||o)}}const qn={fetch:ae.fetch,scheduled:Wn},Qt=new be,Kn=Object.assign({"/src/index.tsx":qn});let tr=!1;for(const[,e]of Object.entries(Kn))e&&(Qt.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Qt.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),tr=!0);if(!tr)throw new Error("Can't import modules from ['/src/index.tsx']");export{Qt as default};
