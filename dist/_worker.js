var Ya=Object.defineProperty;var $t=e=>{throw TypeError(e)};var Va=(e,t,a)=>t in e?Ya(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var k=(e,t,a)=>Va(e,typeof t!="symbol"?t+"":t,a),vt=(e,t,a)=>t.has(e)||$t("Cannot "+a);var b=(e,t,a)=>(vt(e,t,"read from private field"),a?a.call(e):t.get(e)),R=(e,t,a)=>t.has(e)?$t("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(vt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(vt(e,t,"access private method"),a);var Mt=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return b(e,t,r)}});var Bt=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,d=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(h){if(h instanceof Error&&t)r.error=h,l=await t(h,r),d=!0;else throw h}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},Xa=Symbol(),Za=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof sa?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Qa(e,{all:a,dot:r}):{}};async function Qa(e,t){const a=await e.formData();return a?er(a,t):{}}function er(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?tr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(ar(a,r,n),delete a[r])}),a}var tr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ar=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},ea=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},rr=e=>{const{groups:t,path:a}=nr(e),r=ea(a);return sr(r,t)},nr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},sr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},at={},or=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return at[r]||(a[2]?at[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:at[r]=[e,a[1],!0]),at[r]}return null},Rt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},ir=e=>Rt(e,decodeURI),ta=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return ir(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},lr=e=>{const t=ta(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Re=(e,t,...a)=>(a.length&&(t=Re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),aa=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},yt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Rt(e,na):e):e,ra=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,d=e.indexOf("&",l);return yt(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=yt(l)),s=o,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),r&&(d=yt(d))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},dr=ra,cr=(e,t)=>ra(e,t,!0),na=decodeURIComponent,jt=e=>Rt(e,na),Le,q,le,oa,ia,Et,de,Jt,sa=(Jt=class{constructor(e,t="/",a=[[]]){R(this,le);k(this,"raw");R(this,Le);R(this,q);k(this,"routeIndex",0);k(this,"path");k(this,"bodyCache",{});R(this,de,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,q,a),D(this,Le,{})}param(e){return e?L(this,le,oa).call(this,e):L(this,le,ia).call(this)}query(e){return dr(this.url,e)}queries(e){return cr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Za(this,e))}json(){return b(this,de).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,de).call(this,"text")}arrayBuffer(){return b(this,de).call(this,"arrayBuffer")}blob(){return b(this,de).call(this,"blob")}formData(){return b(this,de).call(this,"formData")}addValidatedData(e,t){b(this,Le)[e]=t}valid(e){return b(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Xa](){return b(this,q)}get matchedRoutes(){return b(this,q)[0].map(([[,e]])=>e)}get routePath(){return b(this,q)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,q=new WeakMap,le=new WeakSet,oa=function(e){const t=b(this,q)[0][this.routeIndex][1][e],a=L(this,le,Et).call(this,t);return a&&/\%/.test(a)?jt(a):a},ia=function(){const e={},t=Object.keys(b(this,q)[0][this.routeIndex][1]);for(const a of t){const r=L(this,le,Et).call(this,b(this,q)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?jt(r):r)}return e},Et=function(e){return b(this,q)[1]?b(this,q)[1][e]:e},de=new WeakMap,Jt),ur={Stringify:1},la=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>la(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},pr="text/plain; charset=UTF-8",bt=(e,t)=>({"Content-Type":e,...t}),Je,Ye,ne,Ne,se,W,Ve,$e,Me,be,Xe,Ze,ce,Oe,Yt,mr=(Yt=class{constructor(e,t){R(this,ce);R(this,Je);R(this,Ye);k(this,"env",{});R(this,ne);k(this,"finalized",!1);k(this,"error");R(this,Ne);R(this,se);R(this,W);R(this,Ve);R(this,$e);R(this,Me);R(this,be);R(this,Xe);R(this,Ze);k(this,"render",(...e)=>(b(this,$e)??D(this,$e,t=>this.html(t)),b(this,$e).call(this,...e)));k(this,"setLayout",e=>D(this,Ve,e));k(this,"getLayout",()=>b(this,Ve));k(this,"setRenderer",e=>{D(this,$e,e)});k(this,"header",(e,t,a)=>{this.finalized&&D(this,W,new Response(b(this,W).body,b(this,W)));const r=b(this,W)?b(this,W).headers:b(this,be)??D(this,be,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});k(this,"status",e=>{D(this,Ne,e)});k(this,"set",(e,t)=>{b(this,ne)??D(this,ne,new Map),b(this,ne).set(e,t)});k(this,"get",e=>b(this,ne)?b(this,ne).get(e):void 0);k(this,"newResponse",(...e)=>L(this,ce,Oe).call(this,...e));k(this,"body",(e,t,a)=>L(this,ce,Oe).call(this,e,t,a));k(this,"text",(e,t,a)=>!b(this,be)&&!b(this,Ne)&&!t&&!a&&!this.finalized?new Response(e):L(this,ce,Oe).call(this,e,t,bt(pr,a)));k(this,"json",(e,t,a)=>L(this,ce,Oe).call(this,JSON.stringify(e),t,bt("application/json",a)));k(this,"html",(e,t,a)=>{const r=n=>L(this,ce,Oe).call(this,n,t,bt("text/html; charset=UTF-8",a));return typeof e=="object"?la(e,ur.Stringify,!1,{}).then(r):r(e)});k(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});k(this,"notFound",()=>(b(this,Me)??D(this,Me,()=>new Response),b(this,Me).call(this,this)));D(this,Je,e),t&&(D(this,se,t.executionCtx),this.env=t.env,D(this,Me,t.notFoundHandler),D(this,Ze,t.path),D(this,Xe,t.matchResult))}get req(){return b(this,Ye)??D(this,Ye,new sa(b(this,Je),b(this,Ze),b(this,Xe))),b(this,Ye)}get event(){if(b(this,se)&&"respondWith"in b(this,se))return b(this,se);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,se))return b(this,se);throw Error("This context has no ExecutionContext")}get res(){return b(this,W)||D(this,W,new Response(null,{headers:b(this,be)??D(this,be,new Headers)}))}set res(e){if(b(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,W,e),this.finalized=!0}get var(){return b(this,ne)?Object.fromEntries(b(this,ne)):{}}},Je=new WeakMap,Ye=new WeakMap,ne=new WeakMap,Ne=new WeakMap,se=new WeakMap,W=new WeakMap,Ve=new WeakMap,$e=new WeakMap,Me=new WeakMap,be=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,ce=new WeakSet,Oe=function(e,t,a){const r=b(this,W)?new Headers(b(this,W).headers):b(this,be)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Ne);return new Response(e,{status:n,headers:r})},Yt),P="ALL",hr="all",gr=["get","post","put","delete","options","patch"],da="Can not add a route since the matcher is already built.",ca=class extends Error{},fr="__COMPOSED_HANDLER",vr=e=>e.text("404 Not Found",404),Pt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Y,U,ua,V,ve,st,ot,Be,yr=(Be=class{constructor(t={}){R(this,U);k(this,"get");k(this,"post");k(this,"put");k(this,"delete");k(this,"options");k(this,"patch");k(this,"all");k(this,"on");k(this,"use");k(this,"router");k(this,"getPath");k(this,"_basePath","/");R(this,Y,"/");k(this,"routes",[]);R(this,V,vr);k(this,"errorHandler",Pt);k(this,"onError",t=>(this.errorHandler=t,this));k(this,"notFound",t=>(D(this,V,t),this));k(this,"fetch",(t,...a)=>L(this,U,ot).call(this,t,a[1],a[0],t.method));k(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Re("/",t)}`,a),r,n)));k(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,U,ot).call(this,t.request,t,void 0,t.request.method))})});[...gr,hr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?D(this,Y,o):L(this,U,ve).call(this,s,b(this,Y),o),i.forEach(l=>{L(this,U,ve).call(this,s,b(this,Y),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){D(this,Y,l);for(const d of[s].flat())i.map(u=>{L(this,U,ve).call(this,d.toUpperCase(),b(this,Y),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?D(this,Y,s):(D(this,Y,"*"),o.unshift(s)),o.forEach(i=>{L(this,U,ve).call(this,P,b(this,Y),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ta:lr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Pt?s=n.handler:(s=async(i,l)=>(await Bt([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[fr]=n.handler),L(o=r,U,ve).call(o,n.method,n.path,s)}),this}basePath(t){const a=L(this,U,ua).call(this);return a._basePath=Re(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Re(this._basePath,t),d=l==="/"?0:l.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const i=async(l,d)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await d()};return L(this,U,ve).call(this,P,Re(t,"*"),i),this}},Y=new WeakMap,U=new WeakSet,ua=function(){const t=new Be({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,V,b(this,V)),t.routes=this.routes,t},V=new WeakMap,ve=function(t,a,r){t=t.toUpperCase(),a=Re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},st=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ot=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await L(this,U,ot).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new mr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,V)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await b(this,V).call(this,i)})}catch(u){return L(this,U,st).call(this,u,i)}return d instanceof Promise?d.then(u=>u||(i.finalized?i.res:b(this,V).call(this,i))).catch(u=>L(this,U,st).call(this,u,i)):d??b(this,V).call(this,i)}const l=Bt(o[0],this.errorHandler,b(this,V));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return L(this,U,st).call(this,d,i)}})()},Be),pa=[];function br(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[P],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],pa];const d=l.indexOf("",1);return[o[1][d],l]});return this.match=r,r(e,t)}var lt="[^/]+",We=".*",qe="(?:|/.*)",Ae=Symbol(),wr=new Set(".\\+*[^]$()");function xr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===lt?1:t===lt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,xe,X,Te,_r=(Te=class{constructor(){R(this,we);R(this,xe);R(this,X,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,we)!==void 0)throw Ae;if(s)return;D(this,we,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",We]:["","",lt]:o==="/*"?["","",qe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let h=l[2]||lt;if(u&&l[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw Ae;if(d=b(this,X)[h],!d){if(Object.keys(b(this,X)).some(v=>v!==We&&v!==qe))throw Ae;if(s)return;d=b(this,X)[h]=new Te,u!==""&&D(d,xe,n.varIndex++)}!s&&u!==""&&r.push([u,b(d,xe)])}else if(d=b(this,X)[o],!d){if(Object.keys(b(this,X)).some(u=>u.length>1&&u!==We&&u!==qe))throw Ae;if(s)return;d=b(this,X)[o]=new Te}d.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,X)).sort(xr).map(r=>{const n=b(this,X)[r];return(typeof b(n,xe)=="number"?`(${r})@${b(n,xe)}`:wr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,we)=="number"&&a.unshift(`#${b(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,xe=new WeakMap,X=new WeakMap,Te),ct,Qe,Vt,Er=(Vt=class{constructor(){R(this,ct,{varIndex:0});R(this,Qe,new _r)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,i=!0,d}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return b(this,Qe).insert(s,t,r,b(this,ct),a),r}buildRegExp(){let e=b(this,Qe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},ct=new WeakMap,Qe=new WeakMap,Vt),Tr=[/^$/,[],Object.create(null)],it=Object.create(null);function ma(e){return it[e]??(it[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function kr(){it=Object.create(null)}function Sr(e){var d;const t=new Er,a=[];if(e.length===0)return Tr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[v,y])=>u?1:v?-1:h.length-y.length),n=Object.create(null);for(let u=0,h=-1,v=r.length;u<v;u++){const[y,f,_]=r[u];y?n[f]=[_.map(([E])=>[E,Object.create(null)]),pa]:h++;let x;try{x=t.insert(f,h,y)}catch(E){throw E===Ae?new ca(f):E}y||(a[h]=_.map(([E,c])=>{const g=Object.create(null);for(c-=1;c>=0;c--){const[p,m]=x[c];g[p]=m}return[E,g]}))}const[s,o,i]=t.buildRegExp();for(let u=0,h=a.length;u<h;u++)for(let v=0,y=a[u].length;v<y;v++){const f=(d=a[u][v])==null?void 0:d[1];if(!f)continue;const _=Object.keys(f);for(let x=0,E=_.length;x<E;x++)f[_[x]]=i[f[_[x]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ma(a).test(t))return[...e[a]]}}var ue,pe,ut,ha,Xt,Ir=(Xt=class{constructor(){R(this,ut);k(this,"name","RegExpRouter");R(this,ue);R(this,pe);k(this,"match",br);D(this,ue,{[P]:Object.create(null)}),D(this,pe,{[P]:Object.create(null)})}add(e,t,a){var i;const r=b(this,ue),n=b(this,pe);if(!r||!n)throw new Error(da);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(d=>{l[e][d]=[...l[P][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ma(t);e===P?Object.keys(r).forEach(d=>{var u;(u=r[d])[t]||(u[t]=De(r[d],t)||De(r[P],t)||[])}):(i=r[e])[t]||(i[t]=De(r[e],t)||De(r[P],t)||[]),Object.keys(r).forEach(d=>{(e===P||e===d)&&Object.keys(r[d]).forEach(u=>{l.test(u)&&r[d][u].push([a,s])})}),Object.keys(n).forEach(d=>{(e===P||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([a,s]))});return}const o=aa(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(h=>{var v;(e===P||e===h)&&((v=n[h])[u]||(v[u]=[...De(r[h],u)||De(r[P],u)||[]]),n[h][u].push([a,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,pe)).concat(Object.keys(b(this,ue))).forEach(t=>{e[t]||(e[t]=L(this,ut,ha).call(this,t))}),D(this,ue,D(this,pe,void 0)),kr(),e}},ue=new WeakMap,pe=new WeakMap,ut=new WeakSet,ha=function(e){const t=[];let a=e===P;return[b(this,ue),b(this,pe)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?Sr(t):null},Xt),me,oe,Zt,Dr=(Zt=class{constructor(e){k(this,"name","SmartRouter");R(this,me,[]);R(this,oe,[]);D(this,me,e.routers)}add(e,t,a){if(!b(this,oe))throw new Error(da);b(this,oe).push([e,t,a])}match(e,t){if(!b(this,oe))throw new Error("Fatal error");const a=b(this,me),r=b(this,oe),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,d=r.length;l<d;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof ca)continue;throw l}this.match=i.match.bind(i),D(this,me,[i]),D(this,oe,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,oe)||b(this,me).length!==1)throw new Error("No active router has been determined yet.");return b(this,me)[0]}},me=new WeakMap,oe=new WeakMap,Zt),Ge=Object.create(null),he,F,_e,je,G,ie,ye,Pe,Cr=(Pe=class{constructor(t,a,r){R(this,ie);R(this,he);R(this,F);R(this,_e);R(this,je,0);R(this,G,Ge);if(D(this,F,r||Object.create(null)),D(this,he,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,he,[n])}D(this,_e,[])}insert(t,a,r){D(this,je,++Mt(this,je)._);let n=this;const s=rr(a),o=[];for(let i=0,l=s.length;i<l;i++){const d=s[i],u=s[i+1],h=or(d,u),v=Array.isArray(h)?h[0]:d;if(v in b(n,F)){n=b(n,F)[v],h&&o.push(h[1]);continue}b(n,F)[v]=new Pe,h&&(b(n,_e).push(h),o.push(h[1])),n=b(n,F)[v]}return b(n,he).push({[t]:{handler:r,possibleKeys:o.filter((i,l,d)=>d.indexOf(i)===l),score:b(this,je)}}),n}search(t,a){var l;const r=[];D(this,G,Ge);let s=[this];const o=ea(a),i=[];for(let d=0,u=o.length;d<u;d++){const h=o[d],v=d===u-1,y=[];for(let f=0,_=s.length;f<_;f++){const x=s[f],E=b(x,F)[h];E&&(D(E,G,b(x,G)),v?(b(E,F)["*"]&&r.push(...L(this,ie,ye).call(this,b(E,F)["*"],t,b(x,G))),r.push(...L(this,ie,ye).call(this,E,t,b(x,G)))):y.push(E));for(let c=0,g=b(x,_e).length;c<g;c++){const p=b(x,_e)[c],m=b(x,G)===Ge?{}:{...b(x,G)};if(p==="*"){const O=b(x,F)["*"];O&&(r.push(...L(this,ie,ye).call(this,O,t,b(x,G))),D(O,G,m),y.push(O));continue}const[w,T,S]=p;if(!h&&!(S instanceof RegExp))continue;const I=b(x,F)[w],A=o.slice(d).join("/");if(S instanceof RegExp){const O=S.exec(A);if(O){if(m[T]=O[0],r.push(...L(this,ie,ye).call(this,I,t,b(x,G),m)),Object.keys(b(I,F)).length){D(I,G,m);const N=((l=O[0].match(/\//))==null?void 0:l.length)??0;(i[N]||(i[N]=[])).push(I)}continue}}(S===!0||S.test(h))&&(m[T]=h,v?(r.push(...L(this,ie,ye).call(this,I,t,m,b(x,G))),b(I,F)["*"]&&r.push(...L(this,ie,ye).call(this,b(I,F)["*"],t,m,b(x,G)))):(D(I,G,m),y.push(I)))}}s=y.concat(i.shift()??[])}return r.length>1&&r.sort((d,u)=>d.score-u.score),[r.map(({handler:d,params:u})=>[d,u])]}},he=new WeakMap,F=new WeakMap,_e=new WeakMap,je=new WeakMap,G=new WeakMap,ie=new WeakSet,ye=function(t,a,r,n){const s=[];for(let o=0,i=b(t,he).length;o<i;o++){const l=b(t,he)[o],d=l[a]||l[P],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),r!==Ge||n&&n!==Ge))for(let h=0,v=d.possibleKeys.length;h<v;h++){const y=d.possibleKeys[h],f=u[d.score];d.params[y]=n!=null&&n[y]&&!f?n[y]:r[y]??(n==null?void 0:n[y]),u[d.score]=!0}}return s},Pe),Ee,Qt,Rr=(Qt=class{constructor(){k(this,"name","TrieRouter");R(this,Ee);D(this,Ee,new Cr)}add(e,t,a){const r=aa(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ee).insert(e,r[n],a);return}b(this,Ee).insert(e,t,a)}match(e,t){return b(this,Ee).search(e,t)}},Ee=new WeakMap,Qt),ge=class extends yr{constructor(e={}){super(e),this.router=e.router??new Dr({routers:[new Ir,new Rr]})}},Or=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(h,v){o.res.headers.set(h,v)}const d=await r(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const h=await n(o.req.header("origin")||"",o);h.length&&l("Access-Control-Allow-Methods",h.join(","));let v=a.allowHeaders;if(!(v!=null&&v.length)){const y=o.req.header("Access-Control-Request-Headers");y&&(v=y.split(/\s*,\s*/))}return v!=null&&v.length&&(l("Access-Control-Allow-Headers",v.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function ga(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}const Ot="AES-GCM",Ar=256;async function fa(e){const t=new TextEncoder,a=await crypto.subtle.importKey("raw",t.encode(e.padEnd(32,"0").slice(0,32)),{name:"PBKDF2"},!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode("karna-salt-v1"),iterations:1e5,hash:"SHA-256"},a,{name:Ot,length:Ar},!1,["encrypt","decrypt"])}async function At(e,t){const a=await fa(t),r=crypto.getRandomValues(new Uint8Array(12)),n=new TextEncoder,s=await crypto.subtle.encrypt({name:Ot,iv:r},a,n.encode(e)),o=new Uint8Array(r.length+new Uint8Array(s).length);return o.set(r),o.set(new Uint8Array(s),r.length),btoa(String.fromCharCode(...o))}async function M(e,t){const a=await fa(t),r=new Uint8Array(atob(e).split("").map(i=>i.charCodeAt(0))),n=r.slice(0,12),s=r.slice(12),o=await crypto.subtle.decrypt({name:Ot,iv:n},a,s);return new TextDecoder().decode(o)}async function pt(e){const a=new TextEncoder().encode(e+"karna-pin-salt"),r=await crypto.subtle.digest("SHA-256",a);return btoa(String.fromCharCode(...new Uint8Array(r)))}async function va(e,t){return await pt(e)===t}const Lr=Object.freeze(Object.defineProperty({__proto__:null,decrypt:M,encrypt:At,hashPin:pt,verifyPin:va},Symbol.toStringTag,{value:"Module"})),fe=new ge;fe.get("/check",async e=>{const t=await e.env.DB.prepare("SELECT COUNT(*) as cnt FROM users").first();return e.json({hasUsers:((t==null?void 0:t.cnt)||0)>0})});fe.post("/setup",async e=>{const{username:t,name:a,pin:r,personality_prompt:n,timezone:s}=await e.req.json();if(!t||!a||!r)return e.json({error:"Username, name, and PIN are required"},400);if(r.length<4)return e.json({error:"PIN must be at least 4 characters"},400);if(await e.env.DB.prepare("SELECT id FROM users WHERE username = ?").bind(t).first())return e.json({error:"Username already taken"},409);const i=await pt(r);await e.env.DB.prepare("INSERT INTO users (username, name, pin_hash, personality_prompt, timezone) VALUES (?, ?, ?, ?, ?)").bind(t,a,i,n||"",s||"Asia/Kolkata").run();const l=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first(),d=crypto.randomUUID(),u=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(d,l.id,"web",u).run(),e.json({success:!0,sessionId:d,user:{id:l.id,username:l.username,name:l.name}})});fe.post("/login",async e=>{const{username:t,pin:a}=await e.req.json();if(!t||!a)return e.json({error:"Username and PIN required"},400);const r=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first();if(!r)return e.json({error:"User not found"},404);if(!await va(a,r.pin_hash))return e.json({error:"Invalid PIN"},401);const s=crypto.randomUUID(),o=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(s,r.id,"web",o).run(),e.json({success:!0,sessionId:s,user:{id:r.id,username:r.username,name:r.name}})});fe.post("/logout",async e=>{var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");return t&&await e.env.DB.prepare("DELETE FROM sessions WHERE id = ?").bind(t).run(),e.json({success:!0})});fe.get("/users/hints",async e=>{const a=((await e.env.DB.prepare("SELECT username, name, created_at FROM users ORDER BY created_at ASC").all()).results||[]).map(r=>{var n;return{username:r.username,name_hint:r.name.split(" ")[0],created:((n=r.created_at)==null?void 0:n.split(" ")[0])||""}});return e.json({users:a,count:a.length})});fe.post("/reset-pin",async e=>{var i;const{username:t,name:a,new_pin:r}=await e.req.json();if(!t||!a||!r)return e.json({error:"Username, display name, and new PIN are required"},400);if(r.length<4)return e.json({error:"PIN must be at least 4 characters"},400);const n=await e.env.DB.prepare("SELECT id, username, name FROM users WHERE username = ?").bind(t).first();if(!n)return e.json({error:"User not found"},404);if(n.name.toLowerCase().trim()!==a.toLowerCase().trim())return e.json({error:"Display name does not match. This is required for identity verification."},403);const s=await pt(r);await e.env.DB.prepare("UPDATE users SET pin_hash = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n.id).run();const o=await e.env.DB.prepare("DELETE FROM credentials WHERE user_id = ?").bind(n.id).run();return await e.env.DB.prepare("DELETE FROM sessions WHERE user_id = ?").bind(n.id).run(),e.json({success:!0,message:"PIN reset successfully. All API keys and credentials have been cleared (they were encrypted with your old PIN). Please log in with your new PIN and re-enter your API keys in Settings.",credentials_cleared:((i=o.meta)==null?void 0:i.changes)||0})});fe.get("/me",async e=>{var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return e.json({error:"No session"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.id as uid, u.username, u.name, u.role, u.timezone 
     FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();return a?e.json({user:{id:a.uid,username:a.username,name:a.name,role:a.role,timezone:a.timezone}}):e.json({error:"Invalid or expired session"},401)});const Ke={anthropic:{id:"anthropic",label:"Anthropic Claude",apiBase:"https://api.anthropic.com",apiFormat:"anthropic",defaultModel:"claude-sonnet-4-20250514",keyPlaceholder:"sk-ant-api03-...",modelHint:"claude-sonnet-4-20250514, claude-haiku-4-20250514",validatePath:"/v1/messages"},openai:{id:"openai",label:"OpenAI GPT",apiBase:"https://api.openai.com",apiFormat:"openai-compatible",defaultModel:"gpt-4o",keyPlaceholder:"sk-...",modelHint:"gpt-4o, gpt-4o-mini, o3-mini",validatePath:"/v1/models"},grok:{id:"grok",label:"xAI Grok",apiBase:"https://api.x.ai",apiFormat:"openai-compatible",defaultModel:"grok-3-mini",keyPlaceholder:"xai-...",modelHint:"grok-3-mini, grok-3",validatePath:"/v1/models"},deepseek:{id:"deepseek",label:"DeepSeek",apiBase:"https://api.deepseek.com",apiFormat:"openai-compatible",defaultModel:"deepseek-chat",keyPlaceholder:"sk-...",modelHint:"deepseek-chat, deepseek-reasoner",validatePath:"/v1/models"},gemini:{id:"gemini",label:"Google Gemini",apiBase:"https://generativelanguage.googleapis.com/v1beta/openai",apiFormat:"openai-compatible",defaultModel:"gemini-2.0-flash",keyPlaceholder:"AIzaSy...",modelHint:"gemini-2.0-flash, gemini-2.5-pro-preview",validatePath:"/models"},openrouter:{id:"openrouter",label:"OpenRouter",apiBase:"https://openrouter.ai/api",apiFormat:"openai-compatible",defaultModel:"anthropic/claude-sonnet-4",keyPlaceholder:"sk-or-...",modelHint:"e.g. deepseek/deepseek-chat, meta-llama/llama-3.1-70b",validatePath:"/v1/models"},abacus:{id:"abacus",label:"Abacus AI (RouteLLM)",apiBase:"https://routellm.abacus.ai",apiFormat:"openai-compatible",defaultModel:"route-llm",keyPlaceholder:"Your Abacus API key",modelHint:"route-llm (auto), grok-4, deepseek-v3.2, claude-4-5-sonnet, gemini-3-flash",validatePath:"/v1/models"}};async function C(e,t,a,r,n,s={}){try{await e.prepare("INSERT INTO error_log (user_id, source, error_type, message, details) VALUES (?, ?, ?, ?, ?)").bind(t,a,r,n,JSON.stringify(s)).run()}catch(o){console.error("Failed to log error:",o)}}class ya{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){k(this,"name");k(this,"apiKey");k(this,"model");k(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var u,h,v,y;const r=t.find(f=>f.role==="system"),n=t.filter(f=>f.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(f=>({role:f.role,content:f.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})));const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const f=await o.text();throw new Error(this.name+" API error "+o.status+": "+f)}const i=await o.json(),l=((u=i.content)==null?void 0:u.filter(f=>f.type==="text"))||[],d=((h=i.content)==null?void 0:h.filter(f=>f.type==="tool_use"))||[];return{content:l.map(f=>f.text).join(`
`),toolCalls:d.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((v=i.usage)==null?void 0:v.input_tokens)||0,completionTokens:((y=i.usage)==null?void 0:y.output_tokens)||0}}}async streamChat(t,a){const r=t.find(d=>d.role==="system"),n=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(d=>({role:d.role,content:d.content}))};r&&(s.system=r.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const d=await o.text();throw new Error(this.name+" stream error "+o.status+": "+d)}const i=o.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var f;const{done:u,value:h}=await i.read();if(u){d.close();return}const y=l.decode(h,{stream:!0}).split(`
`);for(const _ of y)if(_.startsWith("data: ")){const x=_.slice(6);if(x==="[DONE]")continue;try{const E=JSON.parse(x);E.type==="content_block_delta"&&((f=E.delta)!=null&&f.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Nr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,o]of Object.entries(r))o&&typeof o=="object"?n[s]=Tt(o):n[s]=o;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Tt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=Tt(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Tt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class ba{constructor(t,a,r,n){k(this,"name");k(this,"apiKey");k(this,"model");k(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var l,d,u,h,v,y;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},n=this.apiBase.includes("routellm.abacus.ai");a!=null&&a.tools&&a.tools.length>0&&!n&&(r.tools=a.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:Nr(f.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const f=await s.text();throw new Error(this.name+" API error "+s.status+": "+f)}const o=await s.json(),i=(l=o.choices)==null?void 0:l[0];return{content:((d=i==null?void 0:i.message)==null?void 0:d.content)||"",toolCalls:(h=(u=i==null?void 0:i.message)==null?void 0:u.tool_calls)==null?void 0:h.map(f=>({id:f.id,name:f.function.name,arguments:typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}})),usage:{promptTokens:((v=o.usage)==null?void 0:v.prompt_tokens)||0,completionTokens:((y=o.usage)==null?void 0:y.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const i=await n.text();throw new Error(this.name+" stream error "+n.status+": "+i)}const s=n.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var v,y,f;const{done:l,value:d}=await s.read();if(l){i.close();return}const h=o.decode(d,{stream:!0}).split(`
`);for(const _ of h)if(_.startsWith("data: ")){const x=_.slice(6);if(x==="[DONE]")continue;try{const c=(f=(y=(v=JSON.parse(x).choices)==null?void 0:v[0])==null?void 0:y.delta)==null?void 0:f.content;c&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:c})+`

`))}catch{}}}})}}function kt(e,t,a,r){const n=Ke[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new ya(t,s,n.apiBase,a):new ba(t,s,n.apiBase,a)}class wa{constructor(){k(this,"errorLog",new Map);k(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const $r=["llm_slot_1","llm_slot_2","llm_slot_3"],Mr=["anthropic","openai"];async function et(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Lr),n=new wa,s=[];for(const h of $r){const v=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(v)try{const y=await r(v.encrypted_value,a),f=JSON.parse(y);if(f.provider&&f.apiKey&&Ke[f.provider]){const x=f.provider,E=kt(f.provider,f.apiKey,x,f.model);s.push({name:x,provider:E})}}catch(y){console.error(`Failed to load ${h}:`,y)}}const o=new Set(s.map(h=>h.name));for(const h of Mr){if(o.has(h))continue;const v=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(v)try{const y=await r(v.encrypted_value,a);if(Ke[h]){const _=kt(h,y,h);s.push({name:h,provider:_})}}catch{console.error(`Failed to decrypt legacy ${h} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(h=>h.name),l=await n.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const d=s.find(h=>h.name===l);return{provider:Br(d.provider,s,n),rotation:n}}function Br(e,t,a){return t.length<=1?e:{name:e.name,async chat(r,n){try{return await e.chat(r,n)}catch(s){const o=s.message||"";if(!(o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")))throw s;console.warn(`Provider ${e.name} auth/billing error, trying fallback...`),await a.recordError(e.name,o,1440);const l=t.filter(d=>d.name!==e.name);for(const d of l)try{const u=await d.provider.chat(r,n);return this.name=d.name,u}catch(u){const h=u.message||"";if(h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance")||h.includes("properties field not found")){await a.recordError(d.name,h,1440);continue}throw u}throw new Error(`All LLM providers failed. Primary (${e.name}): ${o.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(r,n){return await e.streamChat(r,n)}}}const St=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ya,OpenAICompatibleProvider:ba,ProviderRotation:wa,createProviderFromConfig:kt,createRotatingProvider:et,logError:C},Symbol.toStringTag,{value:"Module"})),wt=20,jr=2e3,Pr=2e3,xa=4;function Ur(e){return Math.ceil(e.length/xa)}function Ut(e,t){const a=t*xa;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class K{constructor(t){this.db=t}async store(t,a,r,n,s=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>wt){const r=((a==null?void 0:a.cnt)||0)-wt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
...
`),i=btoa(unescape(encodeURIComponent(o))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),l=await fetch(`${ae}/drafts`,{method:"POST",headers:n,body:JSON.stringify({message:{raw:i}})});if(!l.ok){const d=await l.text();throw new Error(`Gmail draft failed (${l.status}): ${d.substring(0,200)}`)}return await l.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${ae}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const r=await this.authHeaders();let n={};switch(a){case"archive":n={removeLabelIds:["INBOX"]};break;case"trash":n={addLabelIds:["TRASH"]};break;case"read":n={removeLabelIds:["UNREAD"]};break;case"unread":n={addLabelIds:["UNREAD"]};break;case"star":n={addLabelIds:["STARRED"]};break;case"unstar":n={removeLabelIds:["STARRED"]};break}const s=await fetch(`${ae}/messages/${t}/modify`,{method:"POST",headers:{...r,"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.text();throw new Error(`Failed to modify message: ${o}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${ae}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${ae}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function ja(e){var t,a,r;if(!e)return"";if((t=e.body)!=null&&t.data)return xt(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((a=n.body)!=null&&a.data))return xt(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((r=n.body)!=null&&r.data)){const s=xt(n.body.data);return Jr(s)}for(const n of e.parts)if(n.parts){const s=ja(n);if(s)return s}}return e.snippet||""}function xt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function Jr(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const Yr=1e4,Vr=1e4;async function Pa(e,t){try{const a=new AbortController,r=setTimeout(()=>a.abort(),Vr),n=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(r),!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const o=await n.text(),i=Xr(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||Yr)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function Xr(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Ua(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await mt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async v=>{const y=await Pa(v.link);return{title:v.title,url:v.link,displayLink:v.displayLink,snippet:v.snippet,content:y.text,error:y.error}}),d=(await Promise.all(i)).filter(v=>v.content.length>50);if(d.length===0){const v=s.results.map((f,_)=>`[${_+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await Ht(e,v,t,"snippets"),sources:s.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const u=d.map((v,y)=>`--- SOURCE ${y+1}: ${v.title} (${v.displayLink}) ---
${v.content}
--- END SOURCE ${y+1} ---`).join(`

`);return{report:await Ht(e,u,t,"full"),sources:d.map(v=>({title:v.title,url:v.url})),pagesRead:d.length}}async function Ht(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function zt(e,t,a){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function gt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function ft(e,t,a,r,n,s,o,i,l,d,u){var v,y,f,_,x,E;const h=new K(a);switch(e){case"create_schedule":{const c=new Date;let g;const p=d||"UTC";if(t.schedule_type==="interval"){const m=parseInt(t.schedule_value,10);g=new Date(c.getTime()+m*60*1e3)}else if(t.schedule_type==="daily"){const[m,w]=t.schedule_value.split(":").map(Number),T=c.toLocaleString("en-US",{timeZone:p}),S=new Date(T),I=new Date(S);I.setHours(m,w,0,0),I<=S&&I.setDate(I.getDate()+1);const A=new Date(I.toLocaleString("en-US",{timeZone:"UTC"})),O=new Date(I.toLocaleString("en-US",{timeZone:p})),N=A.getTime()-O.getTime();g=new Date(I.getTime()+N)}else if(t.schedule_type==="weekly"){const[m,w]=t.schedule_value.split(" "),[T,S]=(w||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ie=>Ie.toLowerCase()===m.toLowerCase()),O=c.toLocaleString("en-US",{timeZone:p}),N=new Date(O),$=new Date(N);$.setHours(T,S,0,0);let H=(A-$.getDay()+7)%7;H===0&&$<=N&&(H=7),$.setDate($.getDate()+H);const ke=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),te=new Date($.toLocaleString("en-US",{timeZone:p})),Se=ke.getTime()-te.getTime();g=new Date($.getTime()+Se)}else if(t.schedule_type==="once"){const[m,w]=t.schedule_value.split(" "),[T,S,I]=m.split("-").map(Number),[A,O]=(w||"00:00").split(":").map(Number),N=c.toLocaleString("en-US",{timeZone:p}),$=new Date(N),H=new Date($);H.setFullYear(T,S-1,I),H.setHours(A,O,0,0);const ke=new Date(H.toLocaleString("en-US",{timeZone:"UTC"})),te=new Date(H.toLocaleString("en-US",{timeZone:p})),Se=ke.getTime()-te.getTime();g=new Date(H.getTime()+Se)}else g=new Date(c.getTime()+3600*1e3);return await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
`)}case"toggle_schedule":{const c=t.enabled?1:0,g=c?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(c,g,t.job_id,r).run(),`Schedule ${t.job_id} ${c?"enabled (active)":"paused"}.`}case"update_schedule_state":{const c=["created","active","reminding","paused","completed"],g=t.state;if(!c.includes(g))return`Invalid state "${g}". Valid states: ${c.join(", ")}`;const p=g==="completed"||g==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(g,p,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${g}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const c=t.importance||5,g=c>=7?"working":"long_term";return await h.store(r,t.type,t.title,t.content,c,g),`Stored in ${g==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${c})`}case"search_memory":{const c=await h.search(r,t.query);return c.length===0?"No matching memories found.":c.map(g=>`[${g.tier||"long_term"}] [${g.type}] **${g.title}**: ${g.content}`).join(`
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Q(a,r,n,s||"",o||""),g=t.spreadsheet_id;let p=t.range;const m=await c.sheets.getMetadata(g),w=m.sheets;p.includes("!")||(p=`${w[0]}!${p}`);let T;try{T=await c.sheets.readRange(g,p)}catch(I){if((v=I.message)!=null&&v.includes("Unable to parse range")||(y=I.message)!=null&&y.includes("400")){const A=p.includes("!")?p.split("!")[1]:p;p=`${w[0]}!${A}`,T=await c.sheets.readRange(g,p)}else throw I}let S=`[Spreadsheet: "${m.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${w.map(I=>`"${I}"`).join(", ")}]
...
`)}catch(c){return await C(a,r,"google","read_sheet",c.message),`Failed to read sheet: ${c.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new Q(a,r,n,s||"",o||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await C(a,r,"google","write_sheet",c.message),`Failed to write sheet: ${c.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new Q(a,r,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await C(a,r,"google","append_sheet",c.message),`Failed to append to sheet: ${c.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Q(a,r,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.sheets.createSpreadsheet(t.title,t.sheet_names);let m="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",o||"");m=`
Folder: "${(await zt(w,p.spreadsheetId,t.folder_name)).folderName}"`}catch(w){m=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new K(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${m}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(c){return await C(a,r,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new Q(a,r,n,s||"",o||""),g=t.calendar_id||"primary",p=t.days_ahead||7,m=new Date,w=new Date(m.getTime()+p*24*60*60*1e3),T=await c.calendar.listEvents(g,{timeMin:m.toISOString(),timeMax:w.toISOString(),query:t.query});return T.length===0?`No events found in the next ${p} days.`:T.map(S=>{var $;const I=S.start.dateTime||S.start.date||"TBD",A=S.end.dateTime||S.end.date||"",O=S.location?` 📍 ${S.location}`:"",N=(($=S.attendees)==null?void 0:$.map(H=>H.email).join(", "))||"";return`• ${S.summary} — ${I} to ${A}${O}${N?`
  Attendees: ${N}`:""}`}).join(`
`)}catch(c){return await C(a,r,"google","list_calendar",c.message),`Failed to list events: ${c.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const c=new Q(a,r,n,s||"",o||""),g=t.calendar_id||"primary",p=await c.calendar.createEvent(g,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(c){return await C(a,r,"google","create_event",c.message),`Failed to create event: ${c.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Q(a,r,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.docs.createDocument(t.title);t.content&&await c.docs.appendText(p.documentId,t.content);let m="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",o||"");m=`
Folder: "${(await zt(w,p.documentId,t.folder_name)).folderName}"`}catch(w){m=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new K(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${m}
ID: ${p.documentId}
URL: ${p.url}`}catch(c){return await C(a,r,"google","create_doc",c.message),`Failed to create document: ${c.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const g=await new Q(a,r,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${g.title}"

${g.content}`}catch(c){return await C(a,r,"google","read_doc",c.message),`Failed to read document: ${c.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Q(a,r,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await c.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await c.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await C(a,r,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const g=await new re(a,r,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return g.length===0?"No messages found.":g.map((p,m)=>`${p.isUnread?"● ":"  "}${m+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await C(a,r,"gmail","list",c.message),(f=c.message)!=null&&f.includes("not connected")?c.message:`Gmail list error: ${c.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const c=new re(a,r,n,s||"",o||""),g=await c.getMessage(t.message_id);if(!g)return"Message not found.";const p=await c.getMessageBody(t.message_id);return`**${g.subject}**
From: ${g.from}
To: ${g.to}
Date: ${g.date}

${p}`}catch(c){return await C(a,r,"gmail","read",c.message),`Gmail read error: ${c.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const g=await new re(a,r,n,s||"",o||"").search(t.query,t.max_results||10);return g.length===0?`No results for: ${t.query}`:g.map((p,m)=>`${p.isUnread?"● ":"  "}${m+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await C(a,r,"gmail","search",c.message),`Gmail search error: ${c.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const g=await new re(a,r,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${g.id}]`}catch(c){return await C(a,r,"gmail","send",c.message),`Gmail send error: ${c.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const g=await new re(a,r,n,s||"",o||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${g.id}]`}catch(c){return await C(a,r,"gmail","draft",c.message),`Gmail draft error: ${c.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new re(a,r,n,s||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(c){return await C(a,r,"gmail","modify",c.message),`Gmail modify error: ${c.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const g=await new re(a,r,n,s||"",o||"").getUnreadCount();return`You have ${g} unread email${g!==1?"s":""} in Gmail.`}catch(c){return(_=c.message)!=null&&_.includes("not connected")?c.message:`Gmail error: ${c.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",o||""),g=new URLSearchParams;g.set("pageSize",String(t.max_results||10)),g.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),g.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",g.set("q",p);const m=await fetch(`https://www.googleapis.com/drive/v3/files?${g}`,{headers:{Authorization:`Bearer ${c}`}});if(!m.ok)throw new Error(`Drive API error (${m.status})`);const w=await m.json();return(x=w.files)!=null&&x.length?w.files.map((T,S)=>{var N,$;const I=((N=T.mimeType)==null?void 0:N.split(".").pop())||T.mimeType,A=T.size?`${(parseInt(T.size)/1024).toFixed(1)} KB`:"",O=(($=T.modifiedTime)==null?void 0:$.split("T")[0])||"";return`${S+1}. **${T.name}** (${I})
   ${A} · Modified: ${O}
   ${T.webViewLink||""}`}).join(`

`):"No files found."}catch(c){return await C(a,r,"google","drive_list",c.message),`Drive list error: ${c.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",o||""),g=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",g),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const m=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${c}`}});if(!m.ok)throw new Error(`Drive API error (${m.status})`);const w=await m.json();return(E=w.files)!=null&&E.length?w.files.map((T,S)=>{var O,N;const I=((O=T.mimeType)==null?void 0:O.split(".").pop())||T.mimeType,A=((N=T.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${S+1}. **${T.name}** (${I}) — Modified: ${A}
   ${T.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(c){return await C(a,r,"google","drive_search",c.message),`Drive search error: ${c.message}`}}case"web_search":try{const c=await mt(t.query,{num:t.num_results||5,site:t.site});return c.error?`Web search failed: ${c.error}`:c.results.length===0?`No results found for "${t.query}".`:c.results.map((g,p)=>`${p+1}. **${g.title}**
   ${g.link}
   ${g.snippet}`).join(`

`)}catch(c){return await C(a,r,"search","web_search",c.message),`Web search error: ${c.message}`}case"read_url":try{const c=t.url;if(!c||!c.startsWith("http://")&&!c.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const g=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>Zr),m=await p(c,g);return m.error?`Failed to read page: ${m.error}`:!m.text||m.text.length<20?`Page at ${c} returned no readable content.`:`Content from ${c} (${m.text.length} chars):

${m.text}`}catch(c){return await C(a,r,"search","read_url",c.message),`Read URL error: ${c.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const g=Ua(t.query,u,{depth:t.depth||"quick",site:t.site}),p=new Promise(T=>setTimeout(()=>T(null),45e3)),m=await Promise.race([g,p]);if(m===null){const{webSearch:T}=await Promise.resolve().then(()=>Kr),S=await T(t.query,{num:5});if(S.error||S.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let I=`Research took too long, but here are the top search results:

`;return I+=S.results.map((A,O)=>`${O+1}. **${A.title}**
   ${A.snippet}
   ${A.link}`).join(`
...
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return w}catch(c){return await C(a,r,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const g=await M(c.encrypted_value,n),p=await La(g,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const m=p.route;let w=`**${m.startAddress}** → **${m.endAddress}**
`;return w+=`📏 ${m.distance} · ⏱️ ${m.duration}`,m.durationInTraffic&&(w+=` (with traffic: ${m.durationInTraffic})`),w+=`
via ${m.summary}`,w+=`

Steps:`,m.steps.forEach((T,S)=>{w+=`
${S+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),w}catch(c){return await C(a,r,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const g=await M(c.encrypted_value,n),p=await Ba(g,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let m=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(m+=` (with traffic: ${p.durationInTraffic})`),m}catch(c){return await C(a,r,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const g=await M(c.encrypted_value,n),p=await Na(g,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(c){return await C(a,r,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const g=await M(c.encrypted_value,n),p=await Ma(g,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((m,w)=>{var T;return`${w+1}. **${m.title}**
   ${m.channelTitle} · ${((T=m.publishedAt)==null?void 0:T.split("T")[0])||""}
   ${m.description}
   ${m.url}`}).join(`

`)}catch(c){return await C(a,r,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const g=await M(c.encrypted_value,n),p=await $a(g,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((m,w)=>`${w+1}. ${m.address}
   Coordinates: ${m.lat}, ${m.lng}`).join(`
`)}catch(c){return await C(a,r,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function Dt(e,t,a,r,n,s){var _;const o=new K(t),i=(_=e.metadata)==null?void 0:_.thread_id,l=await o.buildContext(r.id),d=await o.getRecentConversations(r.id,25,i),h=[{role:"system",content:Fa(r,l)},...d.map(x=>({role:x.role,content:x.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const v=10;let y="",f=0;for(let x=0;x<v;x++)try{const E=await a.chat(h,{tools:ht});if(E.usage&&(f+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){E.content&&h.push({role:"assistant",content:E.content});for(const c of E.toolCalls)try{const g=await ft(c.name,c.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);h.push({role:"user",content:`[Tool Result for ${c.name}]: ${g}`})}catch(g){await C(t,r.id,"tool",c.name,g.message||"Tool execution failed"),h.push({role:"user",content:`[Tool Error for ${c.name}]: ${g.message||"Execution failed"}`})}continue}y=E.content;break}catch(E){if(n){const c=E.message||"",g=c.includes("401")||c.includes("403")||c.includes("authentication")||c.includes("credit balance"),p=c.includes("429"),m=g?1440:p?10:5;await n.recordError(a.name,c,m)}throw await C(t,r.id,"llm","provider_error",E.message||"Unknown LLM error",{provider:a.name,turn:x}),E}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}return await o.storeMessage(r.id,e.channel,"assistant",y,"{}",i),await o.compactHistory(r.id,30),y}const Ft={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function rn(e){for(const[t,a]of Object.entries(Ft))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Ft.default}function nn(e,t,a,r){const n=rn(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const d=_t(e);o.push({role:"system",content:e}),i+=d;const u=_t(a);i+=u;const h=s-i,v=[];let y=0;for(let f=t.length-1;f>=0;f--){const _=t[f],x=_t(_.content);if(y+x<=h)v.unshift({role:_.role,content:_.content}),y+=x;else{l=!0;break}}return o.push(...v),o.push({role:"user",content:a}),i+=y,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*sn(e,t,a,r,n,s){var x;const o=new K(t),i=(x=e.metadata)==null?void 0:x.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),d=await o.getRecentConversations(r.id,20,i),u=Fa(r,l),h=nn(u,d,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const v=10;let y="",f=0;const _=[...h.messages];for(let E=0;E<v;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const c=await a.chat(_,{tools:ht});if(c.usage&&(f+=c.usage.promptTokens+c.usage.completionTokens),c.toolCalls&&c.toolCalls.length>0){c.content&&(yield{type:"chunk",data:{text:c.content,threadId:i}},_.push({role:"assistant",content:c.content}));for(const p of c.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const m=await ft(p.name,p.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:m.substring(0,500)+(m.length>500?"...":""),threadId:i}},_.push({role:"user",content:`[Tool Result for ${p.name}]: ${m}`})}catch(m){await C(t,r.id,"tool",p.name,m.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${m.message||"Execution failed"}`,threadId:i}},_.push({role:"user",content:`[Tool Error for ${p.name}]: ${m.message||"Execution failed"}`})}}continue}y=c.content;const g=50;for(let p=0;p<y.length;p+=g)yield{type:"chunk",data:{text:y.substring(p,p+g),threadId:i}},p+g<y.length&&await new Promise(w=>setTimeout(w,10));break}catch(c){if(n){const g=c.message||"",p=g.includes("401")||g.includes("403")||g.includes("authentication")||g.includes("credit balance"),m=g.includes("429"),w=p?1440:m?10:5;await n.recordError(a.name,g,w)}await C(t,r.id,"llm","provider_error",c.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:c.message||"An error occurred",threadId:i}};return}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",y,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function Wa(e,t,a,r,n,s){var u;const o=new K(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),d=Ha(e.text,l);if(d.agent==="conversation")return ln(e,t,a,r,l,n,i);if(d.agent==="multi"||d.confidence<.5)return Dt(e,t,a,r,n,s);try{return await on(d.agent,e,t,a,r,l,n,s,i)}catch(h){return await C(t,r.id,"router","subagent_fallback",`${d.agent} failed: ${h.message}`,{route:d}),Dt(e,t,a,r,n,s)}}async function on(e,t,a,r,n,s,o,i,l){const d=new K(a),u=gt(n.timezone),h=dt(e,n,s,n.timezone,u),v=Ga(e,ht),y=await d.getRecentConversations(n.id,25,l),f=[{role:"system",content:h},...y.map(c=>({role:c.role,content:c.content})),{role:"user",content:t.text}];await d.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const _=10;let x="",E=0;for(let c=0;c<_;c++)try{const g=await r.chat(f,{tools:v.length>0?v:void 0});if(g.usage&&(E+=g.usage.promptTokens+g.usage.completionTokens),g.toolCalls&&g.toolCalls.length>0){g.content&&f.push({role:"assistant",content:g.content});for(const p of g.toolCalls)try{const m=await ft(p.name,p.arguments,a,n.id,n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${p.name}]: ${m}`})}catch(m){await C(a,n.id,"tool",p.name,m.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${p.name}]: ${m.message||"Execution failed"}`})}continue}x=g.content;break}catch(g){if(o){const p=g.message||"",m=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),w=p.includes("429"),T=m?1440:w?10:5;await o.recordError(r.name,p,T)}throw await C(a,n.id,"llm","subagent_error",g.message||"Unknown error",{agent:e,provider:r.name,turn:c}),g}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}return await d.storeMessage(n.id,t.channel,"assistant",x,"{}",l),await d.compactHistory(n.id,30),x}async function ln(e,t,a,r,n,s,o){const i=new K(t),l=gt(r.timezone),d=dt("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),h=[{role:"system",content:d},...u.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let v=0,y="";try{const f=await a.chat(h,{temperature:.8});f.usage&&(v=f.usage.promptTokens+f.usage.completionTokens),y=f.content}catch(f){if(s){const _=f.message||"",x=_.includes("401")||_.includes("403")||_.includes("authentication")||_.includes("credit balance"),E=_.includes("429"),c=x?1440:E?10:5;await s.recordError(a.name,_,c)}throw await C(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(s&&v>0)try{await s.recordUsage(a.name,v)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",y,"{}",o),await i.compactHistory(r.id,30),y}async function*dn(e,t,a,r,n,s){var c;const o=new K(t),i=(c=e.metadata)==null?void 0:c.thread_id,l=await o.buildContext(r.id),d=Ha(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},d.agent==="multi"||d.confidence<.5){yield*sn(e,t,a,r,n,s);return}const u=gt(r.timezone),h=d.agent==="conversation"?dt("conversation",r,l,r.timezone,u):dt(d.agent,r,l,r.timezone,u),v=Ga(d.agent,ht),y=await o.getRecentConversations(r.id,25,i),f=[{role:"system",content:h},...y.map(g=>({role:g.role,content:g.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const _=10;let x="",E=0;for(let g=0;g<_;g++)try{g>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(f,{tools:v.length>0?v:void 0});if(p.usage&&(E+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},f.push({role:"assistant",content:p.content}));for(const w of p.toolCalls){yield{type:"tool_start",data:{tool:w.name,toolArgs:w.arguments,threadId:i}};try{const T=await ft(w.name,w.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:w.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},f.push({role:"user",content:`[Tool Result for ${w.name}]: ${T}`})}catch(T){await C(t,r.id,"tool",w.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:w.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},f.push({role:"user",content:`[Tool Error for ${w.name}]: ${T.message||"Execution failed"}`})}}continue}x=p.content;const m=50;for(let w=0;w<x.length;w+=m)yield{type:"chunk",data:{text:x.substring(w,w+m),threadId:i}},w+m<x.length&&await new Promise(S=>setTimeout(S,10));break}catch(p){if(n){const m=p.message||"",w=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),T=m.includes("429"),S=w?1440:T?10:5;await n.recordError(a.name,m,S)}await C(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:d.agent,provider:a.name,turn:g}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",x,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const B=new ge;async function cn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}B.use("/*",cn);B.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const d of s)o+=`- ${d.name} (${d.type}, ${Math.round(d.size/1024)}KB, file_id: ${d.file_id})`,d.text_preview&&(o+=`
  Preview: ${d.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const d=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=d==null?void 0:d.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:d,rotation:u}=await et(e.env.DB,t.id,t.pin_hash),h=new ReadableStream({async start(v){const y=new TextEncoder;try{const f=dn(l,e.env.DB,d,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const _ of f)_.data.threadId||(_.data.threadId=i),v.enqueue(y.encode(Wt(_)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),v.close()}catch(f){const _={type:"error",data:{error:f.message||"An error occurred",threadId:i}};v.enqueue(y.encode(Wt(_))),v.close()}}});return new Response(h,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(d){console.error("Stream setup error:",d);const u=d.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});B.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
Status: ✅ Online`;await z(a,t,u)}catch{await z(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await z(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await z(a,t,"⚠️ Account not linked."),!0);default:return!1}}tt.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await bn(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const l=!!i.text,d=!!i.voice,u=!!i.document,h=!!i.photo,v=!!i.caption;if(!l&&!d&&!u&&!h)return e.json({ok:!0});const y=String(i.chat.id);let f=i.text||"";const _=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(y).first();let x=null;if(_){const m=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(_.id,"telegram_bot_token").first();m&&(x=await M(m.encrypted_value,_.pin_hash))}if(!x){const m=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();m&&(x=await M(m.encrypted_value,m.pin_hash))}if(!x)return e.json({ok:!0,message:"Bot token not configured"});if(f.startsWith("/")&&await yn(f,y,x,_,e.env.DB))return e.json({ok:!0});if(!_)return await z(x,y,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${y}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&x&&_)try{await z(x,y,"🎤 Processing voice note...");const w=await(await fetch(`https://api.telegram.org/bot${x}/getFile?file_id=${i.voice.file_id}`)).json();if(w.ok&&((t=w.result)!=null&&t.file_path)){const S=await(await fetch(`https://api.telegram.org/file/bot${x}/${w.result.file_path}`)).blob();let I="",A="",O="whisper-1";const N=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(_.id).all();for(const te of N.results){const Se=await M(te.encrypted_value,_.pin_hash);if(te.service==="openai"){I="https://api.openai.com/v1/audio/transcriptions",A=Se;break}else if(te.service.startsWith("llm_slot_"))try{const Ie=JSON.parse(Se);if(Ie.provider==="openai"){I="https://api.openai.com/v1/audio/transcriptions",A=Ie.apiKey;break}else if(Ie.provider==="groq"){I="https://api.groq.com/openai/v1/audio/transcriptions",A=Ie.apiKey,O="whisper-large-v3";break}}catch{}}if(!I)return await z(x,y,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const $=new FormData;$.append("file",S,"voice.ogg"),$.append("model",O);const H=await fetch(I,{method:"POST",headers:{Authorization:`Bearer ${A}`},body:$});if(!H.ok){const te=await H.text();return await z(x,y,`⚠️ Transcription failed: ${H.status} ${te}`),e.json({ok:!0})}f=(await H.json()).text,await z(x,y,`🗣️ *You said:* ${f}`)}}catch(m){return await z(x,y,`⚠️ Failed to process voice note: ${m.message}`),e.json({ok:!0})}if((u||h)&&x&&_)try{let m,w="unknown",T="unknown",S=0;if(u)m=i.document.file_id,w=i.document.file_name||"document",T=i.document.mime_type||"unknown",S=i.document.file_size||0;else if(h){const I=i.photo[i.photo.length-1];m=I.file_id,w="photo.jpg",T="image/jpeg",S=I.file_size||0}if(m){const A=await(await fetch(`https://api.telegram.org/bot${x}/getFile?file_id=${m}`)).json();let O="";if(A.ok&&((a=A.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(w)||/^text\/|application\/json|application\/xml|application\/csv/i.test(T))&&S<5e4)try{O=await(await fetch(`https://api.telegram.org/file/bot${x}/${A.result.file_path}`)).text()}catch{}const N=i.caption||"",$=`[Telegram file received: "${w}" (${T}, ${Math.round(S/1024)}KB)]`;O?f=`${N?N+`
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(m){if(v&&i.caption)f=i.caption;else return await z(x,y,`⚠️ Received your file but couldn't process it: ${m.message}`),e.json({ok:!0})}if(!f)return e.json({ok:!0});await fn(x,y);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(_.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(_.id).run()).meta.last_row_id};const c=mn(_.id,_.username,f,y);c.metadata={thread_id:E.id};let g,p;try{const m=await et(e.env.DB,_.id,_.pin_hash);g=m.provider,p=m.rotation}catch(m){console.error("Telegram provider setup error:",m);const w=(r=m.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=m.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${m.message||"Unknown error"}`;return await z(x,y,w),e.json({ok:!0})}try{const m=await Wa(c,e.env.DB,g,_,p,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),w=hn(m,"telegram");await z(x,y,w||"(empty response)")}catch(m){console.error("Telegram agent error:",m);const w=(s=m.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${g.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(m.message||"Unknown").substring(0,200)}`;await z(x,y,w);try{const{logError:T}=await Promise.resolve().then(()=>St);await T(e.env.DB,_.id,"telegram","agent_error",m.message||"Agent error",{provider:g.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>St);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});tt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await M(n.encrypted_value,a.pin_hash);if(!r){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});tt.get("/webhook-status",async e=>{var s,o,i,l,d,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await M(r.encrypted_value,a.pin_hash);try{const v=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=v.result)==null?void 0:o.url)||"",has_webhook:!!((i=v.result)!=null&&i.url),pending_updates:((l=v.result)==null?void 0:l.pending_update_count)||0,last_error:((d=v.result)==null?void 0:d.last_error_message)||"",last_error_date:((u=v.result)==null?void 0:u.last_error_date)||null})}catch(h){return e.json({configured:!0,error:h.message})}});tt.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await M(r.encrypted_value,a.pin_hash);try{const d=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(x=>setTimeout(x,500));const h=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const v=h.result||[];if(v.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const y=[],f=new Set;for(let x=v.length-1;x>=0;x--){const E=v[x].message;if(E&&E.chat){const c=String(E.chat.id);f.has(c)||(f.add(c),y.push({chat_id:c,name:[E.chat.first_name,E.chat.last_name].filter(Boolean).join(" ")||E.chat.title||"Unknown",username:E.chat.username||"",date:new Date((E.date||0)*1e3).toISOString()}))}}if(y.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=y[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,a.user_id).run(),e.json({found:!0,chat_id:_,name:y[0].name,all_chats:y,message:`Chat ID ${_} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function bn(e,t){var _;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const o=r.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],l=parseInt(o[2]);if(!l||!i)return;const d=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!u)return;const h=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(u.id,l,i).first();if(!h)return;const v=h.checked?0:1;await e.prepare(`
  ...
  `).bind(v,v,h.id).run();const y=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!y)return;const f=await M(y.encrypted_value,y.pin_hash);if(await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:v?"✅ Checked!":"☐ Unchecked"})}),(_=n.reply_markup)!=null&&_.inline_keyboard){const x=n.reply_markup.inline_keyboard.map(E=>E.map(c=>{var g;if((g=c.callback_data)!=null&&g.includes(i)){const p=v?"✅":"☐",m=c.text.replace(/^[☐✅]\s*/,"");return{...c,text:`${p} ${m}`}}return c}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:x}})})}catch{}}}function wn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function xn(e,t,a,r,n,s){try{return(await new Nt(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function _n(e,t,a,r,n){try{const s=new re(e,t,a,r,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const h of o){const v=h.from.split("<")[0].trim()||h.from;l[v]=(l[v]||0)+1}const d=Object.entries(l).sort(([,h],[,v])=>v-h).slice(0,5).map(([h])=>h),u=o.some(h=>h.subject.toLowerCase().includes("urgent")||h.subject.toLowerCase().includes("asap")||h.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:d,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function En(e,t){var a;try{const r=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(r.results||[]).map(l=>l.name),i=(r.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((a=r.results)==null?void 0:a.length)||0,dueToday:i,items:o}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function Tn(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],a=[];for(const r of t){const n=`latest ${r} news today`;try{const s=await mt(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!a.some(i=>i.url===o.link)&&(a.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),a.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(a.length>=5)break}return a.slice(0,5)}function kn(e){const t=[];t.push(`📋 Briefing for ${e.targetDate}`),t.push("");const a=e.calendar.totalCount;if(a>0){t.push(`📅 Tomorrow: ${a} event${a===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const r=e.emails.gmail.unreadCount;if(r>0?(t.push(`📧 Gmail: ${r} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function Sn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function In(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function qa(e,t,a){var E;const r=t.timezone||"Asia/Kolkata",n=wn(r),{components:s,newsTopics:o}=await In(e,t.id),i=[],l=[];s.google_calendar&&(i.push(xn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(_n(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(En(e,t.id)),l.push("tasks")),s.news&&(i.push(Tn(o)),l.push("news"));const d=await Promise.all(i),u={};l.forEach((c,g)=>{u[c]=d[g]});const h={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},v={pending:0,dueToday:0,items:[]},y={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((E=u.googleEvents)==null?void 0:E.length)||0},emails:{gmail:u.gmailSummary||h},tasks:u.tasks||v,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};y.summary=kn(y);const f=Sn(y),_=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(y)).first(),x=(_==null?void 0:_.id)||0;for(const c of f)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(x,c.type,c.key,c.text,JSON.stringify(c.metadata),c.sortOrder).run();return{briefingId:x,content:y,items:f}}async function Dn(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function Cn(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function Rn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
    ...
    LIMIT ?
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function On(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,d=o*60+i;return l===d}function An(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const J=new ge;async function Ka(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}J.use("/*",Ka);J.get("/briefings",async e=>{const t=e.get("user"),a=parseInt(e.req.query("limit")||"10");try{const r=await Rn(e.env.DB,t.id,a);return e.json({briefings:r})}catch(r){return e.json({error:r.message},500)}});J.get("/briefings/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const r=await Dn(e.env.DB,t.id,a);return r?e.json(r):e.json({error:"Briefing not found"},404)}catch(r){return e.json({error:r.message},500)}});J.post("/briefings/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.param("itemId"));try{const n=await Cn(e.env.DB,t.id,a,r);return n?e.json(n):e.json({error:"Item not found"},404)}catch(n){return e.json({error:n.message},500)}});J.post("/briefings/generate",async e=>{const t=e.get("user");try{const a=await qa(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(a)}catch(a){return e.json({error:a.message},500)}});J.get("/briefing-preferences",async e=>{const t=e.get("user");try{const a=await e.env.DB.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t.id).first();if(!a){const n={briefingTime:"20:00",briefingEnabled:!0,components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0,weather:!1},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"],notificationChannels:{telegram:!0,web:!0},proactiveLevel:"moderate"};return e.json({preferences:n})}const r={briefingTime:a.briefing_time,briefingEnabled:a.briefing_enabled!==0,components:JSON.parse(a.components),newsTopics:a.news_topics.split(",").map(n=>n.trim()).filter(Boolean),notificationChannels:JSON.parse(a.notification_channels),proactiveLevel:a.proactive_level};return e.json({preferences:r})}catch(a){return e.json({error:a.message},500)}});J.post("/briefing-preferences",async e=>{const t=e.get("user"),a=await e.req.json(),r=[];if(a.briefingTime&&(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.test(a.briefingTime)||r.push("Invalid time format. Use HH:MM (e.g., 20:00)")),a.newsTopics&&(a.newsTopics.length>5&&r.push("Maximum 5 news topics allowed"),a.newsTopics.some(n=>n.length>50)&&r.push("Each news topic must be 50 characters or less")),a.proactiveLevel&&!["conservative","moderate","aggressive"].includes(a.proactiveLevel)&&r.push("Invalid proactive level. Use conservative, moderate, or aggressive"),r.length>0)return e.json({error:r.join("; ")},400);try{const n=await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first(),s=a.components?JSON.stringify(a.components):null,o=a.notificationChannels?JSON.stringify(a.notificationChannels):null,i=a.newsTopics?a.newsTopics.join(", "):null;if(n){const l=[],d=[];a.briefingTime!==void 0&&(l.push("briefing_time = ?"),d.push(a.briefingTime)),a.briefingEnabled!==void 0&&(l.push("briefing_enabled = ?"),d.push(a.briefingEnabled?1:0)),s!==null&&(l.push("components = ?"),d.push(s)),i!==null&&(l.push("news_topics = ?"),d.push(i)),o!==null&&(l.push("notification_channels = ?"),d.push(o)),a.proactiveLevel!==void 0&&(l.push("proactive_level = ?"),d.push(a.proactiveLevel)),l.length>0&&(l.push("updated_at = CURRENT_TIMESTAMP"),d.push(t.id),await e.env.DB.prepare(`UPDATE briefing_preferences SET ${l.join(", ")} WHERE user_id = ?`).bind(...d).run())}else await e.env.DB.prepare(`
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(On(l,i,s))try{const d=await qa(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:h}=An(d.content,d.items);await Ln(e.env.DB,o,u,h,d.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:i})}catch(d){n.push({user_id:o.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});J.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const d=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!d)continue;const u=await M(d.encrypted_value,l.pin_hash),v=JSON.parse(u).access_token;if(!v)continue;const y=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${v}`}});if(!y.ok)continue;const _=((await y.json()).items||[]).filter(c=>{var p;const g=(p=c.start)==null?void 0:p.dateTime;return g?g>=s.toISOString()&&g<=o:!1});if(_.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const x=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!x)continue;const E=await M(x.encrypted_value,l.pin_hash);for(const c of _){const g=new Date(c.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=c.location?`
📍 ${c.location}`:"",m=`⏰ Meeting in 10 minutes!

*${c.summary||"Untitled Event"}*
🕐 ${g}${p}`;await fetch(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:m,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:_.length})}catch(d){n.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function Ln(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
...
${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}J.delete("/briefings/:id",Ka,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const Z=new ge;Z.use("/api/*",Or());Z.route("/api/auth",fe);Z.route("/api/chat",B);Z.route("/api/settings",j);Z.route("/api/system",He);Z.route("/api/telegram",tt);Z.route("/api/proactive",J);Z.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ce(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Ce(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Ce(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Ce(!1,"Session expired. Please log in again and retry."));const l=i.user_id,d=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,h=await Ia(e.env.DB,l,d,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Ce(!0,`Connected as ${h.email}`,h.email))}catch(s){return e.html(Ce(!1,`OAuth failed: ${s.message}`))}});Z.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ga())));Z.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ga())));function Ce(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function Nn(e,t,a){const r="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const i=await(await fetch(`${r}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(i.results&&i.results.length>0){const d=i.results.filter(h=>h.needs_agent&&h.status==="dispatched");if(d.length>0){const h=d.map(v=>fetch(`${r}/api/system/cron/run-task/${v.job_id}`,{method:"POST",headers:s}).then(y=>y.json()).catch(y=>({job_id:v.job_id,error:y.message})));a.waitUntil(Promise.allSettled(h).then(v=>{console.log(`Cron: ${i.executed} dispatched, ${d.length} agent tasks`,JSON.stringify(v.map(y=>y.status==="fulfilled"?y.value:y.reason)))}))}const u=i.results.filter(h=>!h.needs_agent&&h.status==="dispatched");if(u.length>0){const h=u.map(v=>fetch(`${r}/api/system/cron/run-task/${v.job_id}`,{method:"POST",headers:s}).catch(()=>{}));a.waitUntil(Promise.allSettled(h))}}a.waitUntil(fetch(`${r}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{d.executed>0&&console.log("Evening briefing result:",JSON.stringify(d))}).catch(d=>{console.error("Evening briefing error:",d.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${r}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{var u;(u=d.results)!=null&&u.some(h=>h.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(d))}).catch(()=>{}))}catch(o){console.error("Scheduled cron error:",o.message||o)}}const $n={fetch:Z.fetch,scheduled:Nn},Kt=new ge,Mn=Object.assign({"/src/index.tsx":$n});let Ja=!1;for(const[,e]of Object.entries(Mn))e&&(Kt.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Kt.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Ja=!0);if(!Ja)throw new Error("Can't import modules from ['/src/index.tsx']");export{Kt as default};
