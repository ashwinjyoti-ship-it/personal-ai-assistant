var Qs=Object.defineProperty;var Un=e=>{throw TypeError(e)};var ea=(e,t,n)=>t in e?Qs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var B=(e,t,n)=>ea(e,typeof t!="symbol"?t+"":t,n),an=(e,t,n)=>t.has(e)||Un("Cannot "+n);var x=(e,t,n)=>(an(e,t,"read from private field"),n?n.call(e):t.get(e)),K=(e,t,n)=>t.has(e)?Un("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),F=(e,t,n,r)=>(an(e,t,"write to private field"),r?r.call(e,n):t.set(e,n),n),ee=(e,t,n)=>(an(e,t,"access private method"),n);var Hn=(e,t,n,r)=>({set _(s){F(e,t,s,n)},get _(){return x(e,t,r)}});var Fn=(e,t,n)=>(r,s)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],r.req.routeIndex=o):d=o===e.length&&s||void 0,d)try{l=await d(r,()=>i(o+1))}catch(u){if(u instanceof Error&&t)r.error=u,l=await t(u,r),c=!0;else throw u}else r.finalized===!1&&n&&(l=await n(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},ta=Symbol(),na=async(e,t=Object.create(null))=>{const{all:n=!1,dot:r=!1}=t,a=(e instanceof xr?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?ra(e,{all:n,dot:r}):{}};async function ra(e,t){const n=await e.formData();return n?sa(n,t):{}}function sa(e,t){const n=Object.create(null);return e.forEach((r,s)=>{t.all||s.endsWith("[]")?aa(n,s,r):n[s]=r}),t.dot&&Object.entries(n).forEach(([r,s])=>{r.includes(".")&&(ia(n,r,s),delete n[r])}),n}var aa=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},ia=(e,t,n)=>{let r=e;const s=t.split(".");s.forEach((a,i)=>{i===s.length-1?r[a]=n:((!r[a]||typeof r[a]!="object"||Array.isArray(r[a])||r[a]instanceof File)&&(r[a]=Object.create(null)),r=r[a])})},br=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},oa=e=>{const{groups:t,path:n}=la(e),r=br(n);return ca(r,t)},la=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,r)=>{const s=`@${r}`;return t.push([s,n]),s}),{groups:t,path:e}},ca=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[r]=t[n];for(let s=e.length-1;s>=0;s--)if(e[s].includes(r)){e[s]=e[s].replace(r,t[n][1]);break}}return e},qt={},da=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const r=`${e}#${t}`;return qt[r]||(n[2]?qt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:qt[r]=[e,n[1],!0]),qt[r]}return null},Tn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},ua=e=>Tn(e,decodeURI),_r=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let r=n;for(;r<t.length;r++){const s=t.charCodeAt(r);if(s===37){const a=t.indexOf("?",r),i=t.indexOf("#",r),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return ua(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(s===63||s===35)break}return t.slice(n,r)},ma=e=>{const t=_r(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},mt=(e,t,...n)=>(n.length&&(t=mt(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Er=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let r="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))r+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){n.length===0&&r===""?n.push("/"):n.push(r);const a=s.replace("?","");r+="/"+a,n.push(r)}else r+="/"+s}),n.filter((s,a,i)=>i.indexOf(s)===a)},on=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Tn(e,Sr):e):e,Tr=(e,t,n)=>{let r;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return on(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const s={};r??(r=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(r&&(l=on(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),r&&(c=on(c))),n?(s[l]&&Array.isArray(s[l])||(s[l]=[]),s[l].push(c)):s[l]??(s[l]=c)}return t?s[t]:s},pa=Tr,ha=(e,t)=>Tr(e,t,!0),Sr=decodeURIComponent,Gn=e=>Tn(e,Sr),ft,be,je,kr,Dr,hn,Ue,hr,xr=(hr=class{constructor(e,t="/",n=[[]]){K(this,je);B(this,"raw");K(this,ft);K(this,be);B(this,"routeIndex",0);B(this,"path");B(this,"bodyCache",{});K(this,Ue,e=>{const{bodyCache:t,raw:n}=this,r=t[e];if(r)return r;const s=Object.keys(t)[0];return s?t[s].then(a=>(s==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,F(this,be,n),F(this,ft,{})}param(e){return e?ee(this,je,kr).call(this,e):ee(this,je,Dr).call(this)}query(e){return pa(this.url,e)}queries(e){return ha(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,r)=>{t[r]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await na(this,e))}json(){return x(this,Ue).call(this,"text").then(e=>JSON.parse(e))}text(){return x(this,Ue).call(this,"text")}arrayBuffer(){return x(this,Ue).call(this,"arrayBuffer")}blob(){return x(this,Ue).call(this,"blob")}formData(){return x(this,Ue).call(this,"formData")}addValidatedData(e,t){x(this,ft)[e]=t}valid(e){return x(this,ft)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ta](){return x(this,be)}get matchedRoutes(){return x(this,be)[0].map(([[,e]])=>e)}get routePath(){return x(this,be)[0].map(([[,e]])=>e)[this.routeIndex].path}},ft=new WeakMap,be=new WeakMap,je=new WeakSet,kr=function(e){const t=x(this,be)[0][this.routeIndex][1][e],n=ee(this,je,hn).call(this,t);return n&&/\%/.test(n)?Gn(n):n},Dr=function(){const e={},t=Object.keys(x(this,be)[0][this.routeIndex][1]);for(const n of t){const r=ee(this,je,hn).call(this,x(this,be)[0][this.routeIndex][1][n]);r!==void 0&&(e[n]=/\%/.test(r)?Gn(r):r)}return e},hn=function(e){return x(this,be)[1]?x(this,be)[1][e]:e},Ue=new WeakMap,hr),ga={Stringify:1},Rr=async(e,t,n,r,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(s?s[0]+=e:s=[e],Promise.all(a.map(o=>o({phase:t,buffer:s,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Rr(l,t,!1,r,s))).then(()=>s[0]))):Promise.resolve(e)},fa="text/plain; charset=UTF-8",ln=(e,t)=>({"Content-Type":e,...t}),Mt,$t,Me,yt,$e,we,Pt,vt,wt,tt,Bt,jt,He,pt,gr,ya=(gr=class{constructor(e,t){K(this,He);K(this,Mt);K(this,$t);B(this,"env",{});K(this,Me);B(this,"finalized",!1);B(this,"error");K(this,yt);K(this,$e);K(this,we);K(this,Pt);K(this,vt);K(this,wt);K(this,tt);K(this,Bt);K(this,jt);B(this,"render",(...e)=>(x(this,vt)??F(this,vt,t=>this.html(t)),x(this,vt).call(this,...e)));B(this,"setLayout",e=>F(this,Pt,e));B(this,"getLayout",()=>x(this,Pt));B(this,"setRenderer",e=>{F(this,vt,e)});B(this,"header",(e,t,n)=>{this.finalized&&F(this,we,new Response(x(this,we).body,x(this,we)));const r=x(this,we)?x(this,we).headers:x(this,tt)??F(this,tt,new Headers);t===void 0?r.delete(e):n!=null&&n.append?r.append(e,t):r.set(e,t)});B(this,"status",e=>{F(this,yt,e)});B(this,"set",(e,t)=>{x(this,Me)??F(this,Me,new Map),x(this,Me).set(e,t)});B(this,"get",e=>x(this,Me)?x(this,Me).get(e):void 0);B(this,"newResponse",(...e)=>ee(this,He,pt).call(this,...e));B(this,"body",(e,t,n)=>ee(this,He,pt).call(this,e,t,n));B(this,"text",(e,t,n)=>!x(this,tt)&&!x(this,yt)&&!t&&!n&&!this.finalized?new Response(e):ee(this,He,pt).call(this,e,t,ln(fa,n)));B(this,"json",(e,t,n)=>ee(this,He,pt).call(this,JSON.stringify(e),t,ln("application/json",n)));B(this,"html",(e,t,n)=>{const r=s=>ee(this,He,pt).call(this,s,t,ln("text/html; charset=UTF-8",n));return typeof e=="object"?Rr(e,ga.Stringify,!1,{}).then(r):r(e)});B(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});B(this,"notFound",()=>(x(this,wt)??F(this,wt,()=>new Response),x(this,wt).call(this,this)));F(this,Mt,e),t&&(F(this,$e,t.executionCtx),this.env=t.env,F(this,wt,t.notFoundHandler),F(this,jt,t.path),F(this,Bt,t.matchResult))}get req(){return x(this,$t)??F(this,$t,new xr(x(this,Mt),x(this,jt),x(this,Bt))),x(this,$t)}get event(){if(x(this,$e)&&"respondWith"in x(this,$e))return x(this,$e);throw Error("This context has no FetchEvent")}get executionCtx(){if(x(this,$e))return x(this,$e);throw Error("This context has no ExecutionContext")}get res(){return x(this,we)||F(this,we,new Response(null,{headers:x(this,tt)??F(this,tt,new Headers)}))}set res(e){if(x(this,we)&&e){e=new Response(e.body,e);for(const[t,n]of x(this,we).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=x(this,we).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of r)e.headers.append("set-cookie",s)}else e.headers.set(t,n)}F(this,we,e),this.finalized=!0}get var(){return x(this,Me)?Object.fromEntries(x(this,Me)):{}}},Mt=new WeakMap,$t=new WeakMap,Me=new WeakMap,yt=new WeakMap,$e=new WeakMap,we=new WeakMap,Pt=new WeakMap,vt=new WeakMap,wt=new WeakMap,tt=new WeakMap,Bt=new WeakMap,jt=new WeakMap,He=new WeakSet,pt=function(e,t,n){const r=x(this,we)?new Headers(x(this,we).headers):x(this,tt)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")r.set(a,i);else{r.delete(a);for(const o of i)r.append(a,o)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??x(this,yt);return new Response(e,{status:s,headers:r})},gr),de="ALL",va="all",wa=["get","post","put","delete","options","patch"],Or="Can not add a route since the matcher is already built.",Ir=class extends Error{},ba="__COMPOSED_HANDLER",_a=e=>e.text("404 Not Found",404),Wn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},Se,ue,Nr,xe,Qe,zt,Kt,bt,Ea=(bt=class{constructor(t={}){K(this,ue);B(this,"get");B(this,"post");B(this,"put");B(this,"delete");B(this,"options");B(this,"patch");B(this,"all");B(this,"on");B(this,"use");B(this,"router");B(this,"getPath");B(this,"_basePath","/");K(this,Se,"/");B(this,"routes",[]);K(this,xe,_a);B(this,"errorHandler",Wn);B(this,"onError",t=>(this.errorHandler=t,this));B(this,"notFound",t=>(F(this,xe,t),this));B(this,"fetch",(t,...n)=>ee(this,ue,Kt).call(this,t,n[1],n[0],t.method));B(this,"request",(t,n,r,s)=>t instanceof Request?this.fetch(n?new Request(t,n):t,r,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${mt("/",t)}`,n),r,s)));B(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(ee(this,ue,Kt).call(this,t.request,t,void 0,t.request.method))})});[...wa,va].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?F(this,Se,i):ee(this,ue,Qe).call(this,a,x(this,Se),i),o.forEach(l=>{ee(this,ue,Qe).call(this,a,x(this,Se),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){F(this,Se,l);for(const c of[a].flat())o.map(d=>{ee(this,ue,Qe).call(this,c.toUpperCase(),x(this,Se),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?F(this,Se,a):(F(this,Se,"*"),i.unshift(a)),i.forEach(o=>{ee(this,ue,Qe).call(this,de,x(this,Se),o)}),this);const{strict:r,...s}=t;Object.assign(this,s),this.getPath=r??!0?t.getPath??_r:ma}route(t,n){const r=this.basePath(t);return n.routes.map(s=>{var i;let a;n.errorHandler===Wn?a=s.handler:(a=async(o,l)=>(await Fn([],n.errorHandler)(o,()=>s.handler(o,l))).res,a[ba]=s.handler),ee(i=r,ue,Qe).call(i,s.method,s.path,a)}),this}basePath(t){const n=ee(this,ue,Nr).call(this);return n._basePath=mt(this._basePath,t),n}mount(t,n,r){let s,a;r&&(typeof r=="function"?a=r:(a=r.optionHandler,r.replaceRequest===!1?s=l=>l:s=r.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};s||(s=(()=>{const l=mt(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(s(l.req.raw),...i(l));if(d)return d;await c()};return ee(this,ue,Qe).call(this,de,mt(t,"*"),o),this}},Se=new WeakMap,ue=new WeakSet,Nr=function(){const t=new bt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,xe,x(this,xe)),t.routes=this.routes,t},xe=new WeakMap,Qe=function(t,n,r){t=t.toUpperCase(),n=mt(this._basePath,n);const s={basePath:this._basePath,path:n,method:t,handler:r};this.router.add(t,n,[r,s]),this.routes.push(s)},zt=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},Kt=function(t,n,r,s){if(s==="HEAD")return(async()=>new Response(null,await ee(this,ue,Kt).call(this,t,n,r,"GET")))();const a=this.getPath(t,{env:r}),i=this.router.match(s,a),o=new ya(t,{path:a,matchResult:i,env:r,executionCtx:n,notFoundHandler:x(this,xe)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await x(this,xe).call(this,o)})}catch(d){return ee(this,ue,zt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:x(this,xe).call(this,o))).catch(d=>ee(this,ue,zt).call(this,d,o)):c??x(this,xe).call(this,o)}const l=Fn(i[0],this.errorHandler,x(this,xe));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return ee(this,ue,zt).call(this,c,o)}})()},bt),Cr=[];function Ta(e,t){const n=this.buildAllMatchers(),r=((s,a)=>{const i=n[s]||n[de],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],Cr];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=r,r(e,t)}var Vt="[^/]+",Rt=".*",Ot="(?:|/.*)",ht=Symbol(),Sa=new Set(".\\+*[^]$()");function xa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Rt||e===Ot?1:t===Rt||t===Ot?-1:e===Vt?1:t===Vt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var nt,rt,ke,it,ka=(it=class{constructor(){K(this,nt);K(this,rt);K(this,ke,Object.create(null))}insert(t,n,r,s,a){if(t.length===0){if(x(this,nt)!==void 0)throw ht;if(a)return;F(this,nt,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Rt]:["","",Vt]:i==="/*"?["","",Ot]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||Vt;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ht;if(c=x(this,ke)[u],!c){if(Object.keys(x(this,ke)).some(p=>p!==Rt&&p!==Ot))throw ht;if(a)return;c=x(this,ke)[u]=new it,d!==""&&F(c,rt,s.varIndex++)}!a&&d!==""&&r.push([d,x(c,rt)])}else if(c=x(this,ke)[i],!c){if(Object.keys(x(this,ke)).some(d=>d.length>1&&d!==Rt&&d!==Ot))throw ht;if(a)return;c=x(this,ke)[i]=new it}c.insert(o,n,r,s,a)}buildRegExpStr(){const n=Object.keys(x(this,ke)).sort(xa).map(r=>{const s=x(this,ke)[r];return(typeof x(s,rt)=="number"?`(${r})@${x(s,rt)}`:Sa.has(r)?`\\${r}`:r)+s.buildRegExpStr()});return typeof x(this,nt)=="number"&&n.unshift(`#${x(this,nt)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},nt=new WeakMap,rt=new WeakMap,ke=new WeakMap,it),Zt,Ut,fr,Da=(fr=class{constructor(){K(this,Zt,{varIndex:0});K(this,Ut,new ka)}insert(e,t,n){const r=[],s=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return s[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=s.length-1;i>=0;i--){const[o]=s[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,s[i][1]);break}}return x(this,Ut).insert(a,t,r,x(this,Zt),n),r}buildRegExp(){let e=x(this,Ut).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,r]}},Zt=new WeakMap,Ut=new WeakMap,fr),Ra=[/^$/,[],Object.create(null)],Yt=Object.create(null);function Ar(e){return Yt[e]??(Yt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function Oa(){Yt=Object.create(null)}function Ia(e){var c;const t=new Da,n=[];if(e.length===0)return Ra;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[p,g])=>d?1:p?-1:u.length-g.length),s=Object.create(null);for(let d=0,u=-1,p=r.length;d<p;d++){const[g,f,b]=r[d];g?s[f]=[b.map(([T])=>[T,Object.create(null)]),Cr]:u++;let w;try{w=t.insert(f,u,g)}catch(T){throw T===ht?new Ir(f):T}g||(n[u]=b.map(([T,S])=>{const R=Object.create(null);for(S-=1;S>=0;S--){const[C,M]=w[S];R[C]=M}return[T,R]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let p=0,g=n[d].length;p<g;p++){const f=(c=n[d][p])==null?void 0:c[1];if(!f)continue;const b=Object.keys(f);for(let w=0,T=b.length;w<T;w++)f[b[w]]=o[f[b[w]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,s]}function lt(e,t){if(e){for(const n of Object.keys(e).sort((r,s)=>s.length-r.length))if(Ar(n).test(t))return[...e[n]]}}var Fe,Ge,Xt,Lr,yr,Na=(yr=class{constructor(){K(this,Xt);B(this,"name","RegExpRouter");K(this,Fe);K(this,Ge);B(this,"match",Ta);F(this,Fe,{[de]:Object.create(null)}),F(this,Ge,{[de]:Object.create(null)})}add(e,t,n){var o;const r=x(this,Fe),s=x(this,Ge);if(!r||!s)throw new Error(Or);r[e]||[r,s].forEach(l=>{l[e]=Object.create(null),Object.keys(l[de]).forEach(c=>{l[e][c]=[...l[de][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Ar(t);e===de?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=lt(r[c],t)||lt(r[de],t)||[])}):(o=r[e])[t]||(o[t]=lt(r[e],t)||lt(r[de],t)||[]),Object.keys(r).forEach(c=>{(e===de||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([n,a])})}),Object.keys(s).forEach(c=>{(e===de||e===c)&&Object.keys(s[c]).forEach(d=>l.test(d)&&s[c][d].push([n,a]))});return}const i=Er(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(s).forEach(u=>{var p;(e===de||e===u)&&((p=s[u])[d]||(p[d]=[...lt(r[u],d)||lt(r[de],d)||[]]),s[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(x(this,Ge)).concat(Object.keys(x(this,Fe))).forEach(t=>{e[t]||(e[t]=ee(this,Xt,Lr).call(this,t))}),F(this,Fe,F(this,Ge,void 0)),Oa(),e}},Fe=new WeakMap,Ge=new WeakMap,Xt=new WeakSet,Lr=function(e){const t=[];let n=e===de;return[x(this,Fe),x(this,Ge)].forEach(r=>{const s=r[e]?Object.keys(r[e]).map(a=>[a,r[e][a]]):[];s.length!==0?(n||(n=!0),t.push(...s)):e!==de&&t.push(...Object.keys(r[de]).map(a=>[a,r[de][a]]))}),n?Ia(t):null},yr),We,Pe,vr,Ca=(vr=class{constructor(e){B(this,"name","SmartRouter");K(this,We,[]);K(this,Pe,[]);F(this,We,e.routers)}add(e,t,n){if(!x(this,Pe))throw new Error(Or);x(this,Pe).push([e,t,n])}match(e,t){if(!x(this,Pe))throw new Error("Fatal error");const n=x(this,We),r=x(this,Pe),s=n.length;let a=0,i;for(;a<s;a++){const o=n[a];try{for(let l=0,c=r.length;l<c;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof Ir)continue;throw l}this.match=o.match.bind(o),F(this,We,[o]),F(this,Pe,void 0);break}if(a===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(x(this,Pe)||x(this,We).length!==1)throw new Error("No active router has been determined yet.");return x(this,We)[0]}},We=new WeakMap,Pe=new WeakMap,vr),xt=Object.create(null),qe,ye,st,_t,pe,Be,et,Et,Aa=(Et=class{constructor(t,n,r){K(this,Be);K(this,qe);K(this,ye);K(this,st);K(this,_t,0);K(this,pe,xt);if(F(this,ye,r||Object.create(null)),F(this,qe,[]),t&&n){const s=Object.create(null);s[t]={handler:n,possibleKeys:[],score:0},F(this,qe,[s])}F(this,st,[])}insert(t,n,r){F(this,_t,++Hn(this,_t)._);let s=this;const a=oa(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=da(c,d),p=Array.isArray(u)?u[0]:c;if(p in x(s,ye)){s=x(s,ye)[p],u&&i.push(u[1]);continue}x(s,ye)[p]=new Et,u&&(x(s,st).push(u),i.push(u[1])),s=x(s,ye)[p]}return x(s,qe).push({[t]:{handler:r,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:x(this,_t)}}),s}search(t,n){var l;const r=[];F(this,pe,xt);let a=[this];const i=br(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],p=c===d-1,g=[];for(let f=0,b=a.length;f<b;f++){const w=a[f],T=x(w,ye)[u];T&&(F(T,pe,x(w,pe)),p?(x(T,ye)["*"]&&r.push(...ee(this,Be,et).call(this,x(T,ye)["*"],t,x(w,pe))),r.push(...ee(this,Be,et).call(this,T,t,x(w,pe)))):g.push(T));for(let S=0,R=x(w,st).length;S<R;S++){const C=x(w,st)[S],M=x(w,pe)===xt?{}:{...x(w,pe)};if(C==="*"){const L=x(w,ye)["*"];L&&(r.push(...ee(this,Be,et).call(this,L,t,x(w,pe))),F(L,pe,M),g.push(L));continue}const[A,U,q]=C;if(!u&&!(q instanceof RegExp))continue;const Z=x(w,ye)[A],re=i.slice(c).join("/");if(q instanceof RegExp){const L=q.exec(re);if(L){if(M[U]=L[0],r.push(...ee(this,Be,et).call(this,Z,t,x(w,pe),M)),Object.keys(x(Z,ye)).length){F(Z,pe,M);const z=((l=L[0].match(/\//))==null?void 0:l.length)??0;(o[z]||(o[z]=[])).push(Z)}continue}}(q===!0||q.test(u))&&(M[U]=u,p?(r.push(...ee(this,Be,et).call(this,Z,t,M,x(w,pe))),x(Z,ye)["*"]&&r.push(...ee(this,Be,et).call(this,x(Z,ye)["*"],t,M,x(w,pe)))):(F(Z,pe,M),g.push(Z)))}}a=g.concat(o.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},qe=new WeakMap,ye=new WeakMap,st=new WeakMap,_t=new WeakMap,pe=new WeakMap,Be=new WeakSet,et=function(t,n,r,s){const a=[];for(let i=0,o=x(t,qe).length;i<o;i++){const l=x(t,qe)[i],c=l[n]||l[de],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),r!==xt||s&&s!==xt))for(let u=0,p=c.possibleKeys.length;u<p;u++){const g=c.possibleKeys[u],f=d[c.score];c.params[g]=s!=null&&s[g]&&!f?s[g]:r[g]??(s==null?void 0:s[g]),d[c.score]=!0}}return a},Et),at,wr,La=(wr=class{constructor(){B(this,"name","TrieRouter");K(this,at);F(this,at,new Aa)}add(e,t,n){const r=Er(t);if(r){for(let s=0,a=r.length;s<a;s++)x(this,at).insert(e,r[s],n);return}x(this,at).insert(e,t,n)}match(e,t){return x(this,at).search(e,t)}},at=new WeakMap,wr),_e=class extends Ea{constructor(e={}){super(e),this.router=e.router??new Ca({routers:[new Na,new La]})}},Ma=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),s=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,p){i.res.headers.set(u,p)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await s(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let p=n.allowHeaders;if(!(p!=null&&p.length)){const g=i.req.header("Access-Control-Request-Headers");g&&(p=g.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function $a(){return`  // === Karna v3.1 Frontend ===
...
`}function Mr(e=""){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`))}catch{}}}})}}function fn(e,t,n,r){const s=It[e];if(!s)throw new Error(`Unknown LLM provider: ${e}`);const a=r||s.defaultModel;return s.apiFormat==="anthropic"?new Ur(t,a,s.apiBase,n):new Hr(t,a,s.apiBase,n)}class Fr{constructor(){B(this,"errorLog",new Map);B(this,"usageLog",new Map)}async pickProvider(t){const n=Date.now(),r=t.filter(s=>{const a=this.errorLog.get(s);return a?a.cooldownUntil<=n:!0});return r.length>0?r[0]:null}async recordUsage(t,n){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+n,requests:r.requests+1})}async recordError(t,n,r=5){this.errorLog.set(t,{error:n,cooldownUntil:Date.now()+r*60*1e3})}}const Qa=["llm_slot_1","llm_slot_2","llm_slot_3"],ei=["anthropic","openai"];async function Je(e,t,n){const{decrypt:r}=await Promise.resolve().then(()=>en),s=new Fr,a=[];for(const u of Qa){const p=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(p)try{const g=await r(p.encrypted_value,n),f=JSON.parse(g);if(f.provider&&f.apiKey&&It[f.provider]){const w=f.provider,T=fn(f.provider,f.apiKey,w,f.model);a.push({name:w,provider:T})}}catch(g){console.error(`Failed to load ${u}:`,g)}}const i=new Set(a.map(u=>u.name));for(const u of ei){if(i.has(u))continue;const p=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(p)try{const g=await r(p.encrypted_value,n);if(It[u]){const b=fn(u,g,u);a.push({name:u,provider:b})}}catch{console.error(`Failed to decrypt legacy ${u} key`)}}if(a.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=a.map(u=>u.name),l=await s.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:a[0].provider,rotation:s};const c=a.find(u=>u.name===l);return{provider:ti(c.provider,a,s,e,t),rotation:s}}function ti(e,t,n,r,s){const a=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"";throw a(d)&&!d.includes("TOOLS_UNSUPPORTED")&&cn(r,s,"all_providers_down",e.name,null,d),c}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"",u=i(d);if(!a(d)&&!u)throw c;const p=d.includes("TOOLS_UNSUPPORTED"),g=p?1:u?10:1440;console.warn(`Provider ${e.name} ${u?"rate limited":p?"tools unsupported":"auth/billing error"}, trying fallback...`),await n.recordError(e.name,d,g);const f=t.filter(b=>b.name!==e.name);for(const b of f)try{const w=await b.provider.chat(o,l);return this.name=b.name,!p&&!u&&cn(r,s,"provider_switched",e.name,b.name,d),w}catch(w){const T=w.message||"";if(a(T)||i(T)){await n.recordError(b.name,T,i(T)?10:1440);continue}throw w}throw cn(r,s,"all_providers_down",e.name,null,d),new Error(`All LLM providers failed. Primary (${e.name}): ${d.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const gt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Ur,OpenAICompatibleProvider:Hr,ProviderRotation:Fr,createProviderFromConfig:fn,createRotatingProvider:Je,logError:H},Symbol.toStringTag,{value:"Module"})),dn=20,ni=2e3,ri=2e3,Gr=4;function si(e){return Math.ceil(e.length/Gr)}function Kn(e,t){const n=t*Gr;return e.length<=n?e:e.slice(0,n)+`
[...truncated to fit token budget]`}class Q{constructor(t){this.db=t}async store(t,n,r,s,a=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,n,r).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,a,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,r,s,a,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       WHERE user_id = ? AND type = 'task' AND status = 'done' AND tier = 'working'
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const n=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((n==null?void 0:n.cnt)||0)>dn){const r=((n==null?void 0:n.cnt)||0)-dn;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
...
`).trim()}function un(e,t){const n=`${e.subject} ${e.snippet} ${e.from}`.toLowerCase(),r=t.toLowerCase();let s=0;n.includes(r)&&(s+=10);for(const a of r.split(/\s+/))a.length>2&&n.includes(a)&&(s+=3);return/\b(order|ordered|confirmation|invoice|receipt|thank you for your order)\b/i.test(`${e.subject} ${e.snippet}`)&&(s+=6),/\b(delivered|delivery|out for delivery|shipped|dispatch|dispatched|arriving)\b/i.test(e.subject)&&(s-=4),s}function Xn(e){return e.map((t,n)=>`${t.isUnread?"● ":"  "}${n+1}. **${t.subject}**
   From: ${t.from}
   Date: ${t.date}
   ${t.snippet}
   [id: ${t.id}]`).join(`

`)}function bi(e,t,n){if(e.length===0)return`No purchase-related emails found for "${t}" (query: ${n}).`;const r=[...e].sort((i,o)=>un(o,t)-un(i,t)),s=r[0];if(un(s,t)>0){const i=`**Purchase email for "${t}"**
...
`);return{report:await Qn(e,d,t,"full"),sources:c.map(p=>({title:p.title,url:p.url})),pagesRead:c.length}}async function Qn(e,t,n,r){const a=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Write a synthesized research report answering the query above.`;try{return(await n.chat([{role:"system",content:a},{role:"user",content:i}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(o){return`Research synthesis error: ${o.message}. Raw search results were found but could not be analyzed.`}}const ki=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:ls,fetchPageContent:os},Symbol.toStringTag,{value:"Module"})),Ke="https://api.browser-use.com/api/v2",er=2e4,vn=6e3,Di=3e5,Dn=12e3,cs=new Set(["finished","stopped"]);async function Nt(e,t,n=Dn){const r=new AbortController,s=setTimeout(()=>r.abort(),n);try{return await fetch(e,{...t,signal:r.signal})}finally{clearTimeout(s)}}async function Ri(e){const t=()=>fetch(`${Ke}/sessions`,{method:"POST",headers:{"X-Browser-Use-API-Key":e,"Content-Type":"application/json"},body:JSON.stringify({})});try{let n=await t();if(!n.ok){const s=await n.text().catch(()=>"");if(us(n.status,s)){if(console.log("[createBrowserSession] concurrency limit — reaping stale sessions and retrying"),await ds(e),n=await t(),!n.ok)return console.log(`[createBrowserSession] FAILED after reap HTTP ${n.status}`),null}else return console.log(`[createBrowserSession] FAILED HTTP ${n.status}: ${s}`),null}const r=await n.json();return console.log(`[createBrowserSession] sessionId=${r.id}`),r.id??null}catch(n){return console.log(`[createBrowserSession] ERROR ${n.message}`),null}}async function nn(e,t){try{await fetch(`${Ke}/sessions/${e}`,{method:"DELETE",headers:{"X-Browser-Use-API-Key":t}}),console.log(`[closeBrowserSession] closed sessionId=${e}`)}catch{}}async function Oi(e){try{const t=await Nt(`${Ke}/sessions?filterBy=active&pageSize=100`,{headers:{"X-Browser-Use-API-Key":e}});return t.ok?(await t.json()).items??[]:[]}catch{return[]}}async function ds(e,t){const n=await Oi(e);let r=0;for(const s of n)!s.id||t&&s.id===t||(await nn(s.id,e),r++);return r>0&&console.log(`[reapActiveBrowserSessions] closed ${r} stale session(s)`),r}function us(e,t){const n=(t||"").toLowerCase();return/session/.test(n)?/concurrent|too many|maximum|limit|exceeded/.test(n):!1}async function ms(e,t,n){var o;const r=(n==null?void 0:n.timeoutMs)??Di;console.log(`[runBrowserTask] starting taskLen=${e.length} timeoutMs=${r} hasSecrets=${!!(n!=null&&n.secrets)} reuseSession=${!!(n!=null&&n.sessionId)}`);let s,a;try{const l={task:e};n!=null&&n.secrets&&Object.keys(n.secrets).length>0&&(l.secrets=n.secrets),n!=null&&n.sessionId&&(l.sessionId=n.sessionId);const c=()=>fetch(`${Ke}/tasks`,{method:"POST",headers:{"X-Browser-Use-API-Key":t,"Content-Type":"application/json"},body:JSON.stringify(l)});let d=await c();if(!d.ok){const p=await d.text().catch(()=>"");if(us(d.status,p)&&(console.log("[runBrowserTask] concurrency limit — reaping stale sessions and retrying"),await ds(t,n==null?void 0:n.sessionId),d=await c()),!d.ok){const g=await d.text().catch(()=>p);return console.log(`[runBrowserTask] CREATE_FAILED HTTP ${d.status}: ${g}`),{output:null,taskId:"",status:"failed",error:`HTTP ${d.status}: ${g}`}}}const u=await d.json();if(s=u.id,a=u.sessionId||void 0,console.log(`[runBrowserTask] CREATED taskId=${s} sessionId=${a}`),!s)return{output:null,taskId:"",status:"failed",error:"No id in create response"}}catch(l){return{output:null,taskId:"",status:"failed",error:l.message}}await new Promise(l=>setTimeout(l,er));const i=Date.now()+(r-er);for(;Date.now()<i;){try{const l=await Nt(`${Ke}/tasks/${s}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(l.ok){const c=await l.json();if(cs.has(c.status)){if(c.status==="finished"){let d=c.output??null;if(!d)try{const u=await Nt(`${Ke}/tasks/${s}`,{headers:{"X-Browser-Use-API-Key":t}},Dn);if(u.ok){const p=await u.json();if(d=p.output??null,!d&&((o=p.steps)!=null&&o.length)){const g=p.steps[p.steps.length-1];d=g.extracted_content??g.output??g.result??null}}}catch{}return console.log(`[runBrowserTask] COMPLETED taskId=${s} outputLen=${(d??"").length}`),{output:d,taskId:s,sessionId:a,status:"completed"}}return console.log(`[runBrowserTask] FAILED taskId=${s} status=${c.status}`),{output:c.output??null,taskId:s,status:"failed",error:c.output??"Task was stopped before completing"}}}}catch{}await new Promise(l=>setTimeout(l,vn))}return console.log(`[runBrowserTask] TIMEOUT taskId=${s} sessionId=${a}`),{output:null,taskId:s,sessionId:a,status:"timeout"}}async function ps(e,t,n){var a;const r=(n==null?void 0:n.waitMs)??3e4,s=Date.now()+r;for(;Date.now()<s;){try{const i=await Nt(`${Ke}/tasks/${e}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(!i.ok){await new Promise(l=>setTimeout(l,vn));continue}const o=await i.json();if(cs.has(o.status)){let l=null;const c=await Nt(`${Ke}/tasks/${e}`,{headers:{"X-Browser-Use-API-Key":t}},Dn);if(c.ok){const d=await c.json();if(l=d.output??null,!l&&((a=d.steps)!=null&&a.length)){const u=d.steps[d.steps.length-1];l=u.extracted_content??u.output??u.result??null}}else l=o.output??null;return{status:o.status,output:l,done:!0}}}catch{}await new Promise(i=>setTimeout(i,vn))}return{status:"running",output:null,done:!1}}function Ii(e){return`Navigate to https://www.bluedart.com/tracking.
...
`)}
`}catch{return""}}async function ji(e,t,n){var i;let r=0,s=0,a=0;try{const o=await e.prepare(`SELECT us.id, us.user_id, us.name, us.instructions, us.refinement_count,
              us.confidence_score, us.usage_count
       FROM user_skills us
       WHERE us.user_id = ? AND us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < ? AND us.usage_count >= ?`).bind(n,ws,bs).all();for(const l of o.results??[]){r++;const c=await e.prepare(`SELECT user_message_sample, tool_sequence
         FROM skill_patterns
         WHERE auto_skill_id = ? AND succeeded = 1
         ORDER BY created_at DESC LIMIT 3`).bind(l.id).all();if((c.results??[]).length<2||l.refinement_count>=vs){await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),await e.prepare(`INSERT INTO notifications (user_id, type, title, body, source, is_read)
...
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const b=(((i=(await t.chat(p,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);b&&b[1].trim()&&(await e.prepare(`UPDATE user_skills
             ...
             WHERE id = ?`).bind(b[1].trim(),l.id).run(),s++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:r,rewritten:s,disabled:a}}async function Ui(e,t,n,r,s){var R;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
     WHERE user_id = ? AND tool_signature = ?
     ORDER BY created_at DESC LIMIT 3`).bind(n.id,r).all()).results??[]).map(C=>C.user_message_sample),o=[{role:"system",content:"You are a workflow analyst. Given examples of user requests that all triggered the same multi-tool sequence, write a concise reusable skill procedure."},{role:"user",content:`These user requests all produced the same multi-tool workflow:
...
INSTRUCTIONS: <step-by-step instructions referencing exact tool names, under 200 words>`}],c=((R=(await t.chat(o,{tools:[]})).content)==null?void 0:R.trim())??"",d=c.match(/^NAME:\s*(.+)$/m),u=c.match(/^DESCRIPTION:\s*(.+)$/m),p=c.match(/^INSTRUCTIONS:\s*([\s\S]+)$/m);if(!d||!u||!p)return;const g=d[1].trim(),f=u[1].trim(),b=p[1].trim();if(!g||!f||!b)return;let w=`auto_${g.toLowerCase().replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").substring(0,40)}`;await e.prepare("SELECT id FROM user_skills WHERE user_id = ? AND slug = ?").bind(n.id,w).first()&&(w=`${w}_${Date.now().toString().slice(-4)}`);const S=await e.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, required_tools, is_auto, source)
     VALUES (?, ?, ?, ?, ?, ?, 1, 'auto')
     RETURNING id`).bind(n.id,g,w,f,b,JSON.stringify(s)).first();S!=null&&S.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE user_id = ? AND tool_signature = ?").bind(S.id,n.id,r).run()}async function Hi(e,t,n,r,s,a){var u;const i=await e.prepare("SELECT name, instructions, refinement_count FROM user_skills WHERE id = ? AND user_id = ?").bind(r,n.id).first();if(!i||i.refinement_count>=vs)return;const o=[{role:"system",content:"You are a workflow optimizer. Given an existing skill and a new usage example, decide if the instructions should be improved."},{role:"user",content:`Existing skill "${i.name}":
${i.instructions}
...
Keep changes minimal. Only update if the new example reveals a real gap.`}],c=((u=(await t.chat(o,{tools:[]})).content)==null?void 0:u.trim())??"";if(!c||c.startsWith("NO_CHANGE")||!c.includes("UPDATED_INSTRUCTIONS:"))return;const d=c.replace(/^UPDATED_INSTRUCTIONS:\s*/m,"").trim();!d||d===i.instructions||await e.prepare(`UPDATE user_skills
     SET instructions = ?, refinement_count = refinement_count + 1, updated_at = CURRENT_TIMESTAMP
     WHERE id = ?`).bind(d,r).run()}function Fi(e,t,n){const r={timestamp:new Date().toISOString(),level:e,message:t};n&&Object.keys(n).length>0&&Object.assign(r,n);try{return JSON.stringify(r)}catch{return JSON.stringify({timestamp:r.timestamp,level:e,message:t,context:"[unserializable context]"})}}function Cn(e,t,n){const r=Fi(e,t,n);switch(e){case"error":console.error(r);break;case"warn":console.warn(r);break;case"debug":console.debug(r);break;default:console.log(r)}}function tr(e,t){Cn("info",e,t)}function Ts(e,t){Cn("warn",e,t)}function wn(e,t){Cn("error",e,t)}const Gi=2e3,Wi=2e3,Ss=4;function mn(e){return Math.ceil(e.length/Ss)}function nr(e,t){const n=t*Ss;return e.length<=n?e:e.slice(0,n)+`
[...truncated to fit token budget]`}const xs=6e3,bn="The user is following up on prior research in this thread. Answer from the injected research context first. If the follow-up requires new or updated information, call the research tool again with a query that includes the original topic.";function An(e){try{const t=JSON.parse(e||"{}");return typeof t=="object"&&t!==null?t:{}}catch{return{}}}function ks(e,t){const n=[...new Set(e)],r={};return n.length>0&&(r.tools=n),t&&(r.research_query=t.query.substring(0,200),r.research_report=t.report.substring(0,xs)),JSON.stringify(r)}function Ln(e){const t=[];for(const n of e)if(!(n.role!=="user"&&n.role!=="assistant")){if(n.role==="assistant"){const r=An(n.metadata);r.research_report&&t.push({role:"user",content:`[Tool Result for research]: ${r.research_report}`})}t.push({role:n.role,content:n.content})}return t}function Ds(e){return e.slice(-6).map(t=>{var n;return t.role==="assistant"&&(n=An(t.metadata).tools)!=null&&n.includes("research")?`[TOOLS_USED: research] ${t.content}`:t.content}).join(`
`)}function Mn(e){var t;for(let n=e.length-1;n>=0;n--){const r=e[n];if(r.role==="assistant")return((t=An(r.metadata).tools)==null?void 0:t.includes("research"))??!1}return!1}function Rs(e,t,n,r){return e!=="research"||/^(Research failed|Research error|Research timed out|\[Tool Error)/i.test(n)?r:{query:String(t.query||""),report:n.substring(0,xs)}}function Os(e,t){if(!t)return;const n=e[e.length-1];(n==null?void 0:n.role)!=="user"||typeof n.content!="string"||n.content.startsWith(bn)||(e[e.length-1]={role:"user",content:`${bn}
...
${r}
`:"",l=nr(t,Wi);let c="";try{const u=new Date;c=new Intl.DateTimeFormat("en-GB",{timeZone:e.timezone,day:"numeric",month:"short",year:"numeric"}).format(u)}catch{c=""}return`You are ${a}.
...
---
## Current Date & Time
${Ns(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.${n==="telegram"?'\n\n## TELEGRAM CONSTRAINTS\n- **Essays / save to Drive**: When the user wants an essay, article, or report saved to Google Drive (or says "store/save to drive"), you MUST call `create_doc` with the **full** text in the `content` parameter — never truncate for Telegram. Do NOT paste the essay body in chat (reply with title + Doc link only). Write from your knowledge unless they asked for research — do NOT call web_search before a plain essay. One `create_doc` call with title + full content (+ optional `folder_name`).\n- **Research + save**: One web_search, then immediately create_doc or gmail_draft with the findings. Do NOT call read_url on multiple pages. Pattern: web_search → create_doc (or gmail_draft).\n- **Reminders**: When the user says "remind me in X" or "set a reminder", you MUST call create_schedule. For a specific time/date ("at 13:00", "tomorrow at noon", "next Friday at 5pm"), ALWAYS use `schedule_value` with the exact datetime in the user\'s local timezone — NEVER use `minutes_from_now` for clock-time requests (it causes wrong times). Only use `minutes_from_now` for pure duration requests like "in 30 minutes" or "in 2 hours".\n- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I\'ll now..." — just call the tool.\n- **Long content intent check**: When asked to write long-form content (essay, article, report) WITHOUT any save destination (no mention of Drive, Google Doc, or "save/store"), ask first: "Should I save the full piece as a Google Doc and send you the link, or give you a brief summary here in chat?" Default to Google Doc for anything over ~300 words. If they already said Drive/Doc/save/store, skip this question and call `create_doc` with the complete text immediately. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**':""}`}async function pn(e,t,n){var c;const s=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${n.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let a;((c=s.files)==null?void 0:c.length)>0?a=s.files[0].id:a=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:n,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${a}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:a,folderName:n}}function Ct(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").replace(/^\[calling:[^\]]*\]\s*/i,"").trim()}function Ns(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}const qi={read_sheet:"read",search_memory:"read",list_schedules:"read",write_sheet:"write",append_sheet:"write",update_schedule:"write",delete_schedule:"write",gmail_send:"external_effect",create_calendar_event:"external_effect"};function zi(e,t){const n=qi[e]||"read";if(n==="read")return null;const r=Cs(t);return n==="write"&&r!=="execute"?`POLICY BLOCKED (${n}): ${e} requires transaction_mode=execute.`:n==="external_effect"&&r!=="execute"?`POLICY BLOCKED (${n}): ${e} can cause external side effects and needs transaction_mode=execute.`:null}const Ki=["ETIMEDOUT","TIMEOUT","429","503","ECONNRESET","network"],Yi=new Set(["write_sheet","append_sheet","gmail_send","create_calendar_event","update_schedule","delete_schedule","delete_memory"]),Ji={create_schedule:{required:["name","schedule_type","action_type"],enum:{schedule_type:["interval","daily","weekly","once"]}},update_schedule:{required:["job_id"]},delete_schedule:{required:["job_id"]},write_sheet:{required:["spreadsheet_id","range","values"]},append_sheet:{required:["spreadsheet_id","range","values"]},gmail_send:{required:["to","subject","body"]}};function Vi(e){const t=String((e==null?void 0:e.message)||e||"Unknown tool error");return/timeout|timed out/i.test(t)?"TOOL_TIMEOUT":/unauthorized|forbidden|401|403/i.test(t)?"TOOL_AUTH":/not found|404/i.test(t)?"TOOL_NOT_FOUND":/rate limit|429/i.test(t)?"TOOL_RATE_LIMIT":/validation|invalid|required/i.test(t)?"TOOL_VALIDATION":"TOOL_EXECUTION_FAILED"}function Zi(e){const t=String((e==null?void 0:e.message)||e||"").toLowerCase();return Ki.some(n=>t.includes(n.toLowerCase()))}function Xi(e){const t=e.query??e.q??e.search_query??e.search;return typeof t=="string"?t.trim():""}function Qi(e,t){const n=Ji[e];if(n){for(const r of n.required||[])if(t[r]===void 0||t[r]===null||t[r]==="")throw new Error(`Validation failed: ${r} is required for ${e}`);for(const[r,s]of Object.entries(n.enum||{}))if(t[r]!==void 0&&!s.includes(String(t[r])))throw new Error(`Validation failed: ${r} must be one of ${s.join(", ")}`)}}function Cs(e){const t=e.transaction_mode;return t==="dry_run"||t==="confirm_required"||t==="execute"?t:"execute"}function eo(e,t){if(!Yi.has(e))return null;const n=Cs(t);return n==="dry_run"?`DRY RUN: ${e} validated. No write action was executed.`:n==="confirm_required"?`CONFIRMATION REQUIRED: ${e} is a write action. Re-run with transaction_mode=execute to proceed.`:null}const to=new Set(["gmail_send","gmail_draft","gmail_modify","append_sheet","create_sheet","write_sheet","create_doc","append_to_doc","rewrite_doc","create_calendar_event","create_schedule","create_skill"]),no=new Set(["list_schedules","search_memory","get_system_status","read_sheet","list_calendar_events","read_doc","gmail_list","gmail_read","gmail_search","gmail_unread_count","drive_list","drive_search","drive_read_file","web_search","read_url","research","browser_task_status","vault_lookup","search_places","get_place_details","get_directions","get_travel_time","translate_text","search_youtube","geocode_address","parse_document","search_library","read_library_file","list_skills"]),ro=5;async function At(e,t,n,r,s,a,i,o,l,c,d,u,p,g,f){const b=Date.now();let w=!0,T="",S="";const R=s.traceId||crypto.randomUUID(),C=`${r}:${e}:${JSON.stringify(t)}`;if(to.has(e)&&!no.has(e))try{const A=await n.prepare(`SELECT tool_result FROM tool_execution_log
           WHERE user_id = ? AND tool_name = ? AND idempotency_key = ? AND success = 1
             AND created_at >= datetime('now', '-${ro} minutes')
           ORDER BY created_at DESC
           LIMIT 1`).bind(r,e,C).first();if(A)return A.tool_result||""}catch{}try{Qi(e,t);const A=zi(e,t);if(A)return S=A,S;const U=eo(e,t);if(U)return S=U,S;const q=2;for(let Z=1;Z<=q;Z++)try{const re=e==="browser_task"?31e4:e==="browser_task_status"?35e3:e==="research"?18e4:9e4;S=await Promise.race([ao(e,t,n,r,a,i,o,l,c,d,u,p,g,s.channel,f),new Promise((L,z)=>setTimeout(()=>z(new Error("Tool timed out")),re))]);break}catch(re){if(Z<q&&Zi(re)){await new Promise(L=>setTimeout(L,250*Z));continue}throw re}return S}catch(A){throw w=!1,T=`${Vi(A)}: ${A.message||"Unknown error"}`,new Error(T)}finally{const A=Date.now()-b;try{await n.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel, idempotency_key)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,s.agentType||null,s.providerName||null,e,JSON.stringify({...t,_idempotency_key:C,_trace_id:R}).substring(0,2e3),(w?S:"").substring(0,500),w?1:0,T||null,A,s.isEnforcementRetry?1:0,s.channel||"web",C).run()}catch{}}}function As(e){const t=e.length;for(let n=0;n<t-1;n++){const r=e[n];if(r.role!=="user"||typeof r.content!="string")continue;const s=t-1-n,a=s<=2?12e3:s<=4?5e3:2e3;r.content.length>a&&(e[n]={...r,content:r.content.substring(0,a)+`
[...truncated in history to reduce context size]`})}}function so(e){const t=[];let n=[],r="",s=!1,a=0;const i=e.length;for(;a<i;){const o=e[a];if(s){if(o==='"'){if(e[a+1]==='"'){r+='"',a+=2;continue}s=!1,a++;continue}r+=o,a++;continue}if(o==='"'){s=!0,a++;continue}if(o===","){n.push(r),r="",a++;continue}if(o==="\r"&&e[a+1]===`
`){n.push(r),t.push(n),n=[],r="",a+=2;continue}if(o===`
`||o==="\r"){n.push(r),t.push(n),n=[],r="",a++;continue}r+=o,a++}for((r||n.length)&&(n.push(r),t.push(n));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function ao(e,t,n,r,s,a,i,o,l,c,d,u,p,g,f){var w,T,S,R,C,M,A,U,q,Z,re,L,z,J,W,te,le,ne,me;const b=new Q(n);switch(e){case"create_schedule":{const m=new Date;let y;const h=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(m.getTime()+t.minutes_from_now*60*1e3);const O=y.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[$,I,N]=(O[0]||"").split("/");t.schedule_value=`${N}-${$}-${I} ${O[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const D=parseInt(t.schedule_value,10);y=new Date(m.getTime()+D*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const D=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(D)){const[$,I]=t.schedule_value.split(":").map(Number),N=m.toLocaleString("en-US",{timeZone:h}),P=new Date(N),j=new Date(P);j.setHours($,I,0,0),j<=P&&j.setDate(j.getDate()+1);const G=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(j.toLocaleString("en-US",{timeZone:h})),V=G.getTime()-X.getTime();y=new Date(j.getTime()+V)}else{const[$,I]=t.schedule_value.split(":").map(Number),N=m.toLocaleString("en-US",{timeZone:h}),P=new Date(N),j=new Date(P);j.setHours($,I,0,0),j<=P&&j.setDate(j.getDate()+1);const G=Te=>String(Te).padStart(2,"0"),X=j.getFullYear(),V=G(j.getMonth()+1),oe=G(j.getDate());t.schedule_value=`${X}-${V}-${oe} ${G($)}:${G(I)}`,t.schedule_type="once";const ie=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),fe=new Date(j.toLocaleString("en-US",{timeZone:h})),Ne=ie.getTime()-fe.getTime();y=new Date(j.getTime()+Ne)}}else if(t.schedule_type==="daily"){const[D,O]=t.schedule_value.split(":").map(Number),$=m.toLocaleString("en-US",{timeZone:h}),I=new Date($),N=new Date(I);N.setHours(D,O,0,0),N<=I&&N.setDate(N.getDate()+1);const P=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),j=new Date(N.toLocaleString("en-US",{timeZone:h})),G=P.getTime()-j.getTime();y=new Date(N.getTime()+G)}else if(t.schedule_type==="weekly"){const[D,O]=t.schedule_value.split(" "),[$,I]=(O||"00:00").split(":").map(Number),P=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ne=>Ne.toLowerCase()===D.toLowerCase()),j=m.toLocaleString("en-US",{timeZone:h}),G=new Date(j),X=new Date(G);X.setHours($,I,0,0);let V=(P-X.getDay()+7)%7;V===0&&X<=G&&(V=7),X.setDate(X.getDate()+V);const oe=new Date(X.toLocaleString("en-US",{timeZone:"UTC"})),ie=new Date(X.toLocaleString("en-US",{timeZone:h})),fe=oe.getTime()-ie.getTime();y=new Date(X.getTime()+fe)}else if(t.schedule_type==="once"){const[D,O]=t.schedule_value.split(" "),[$,I,N]=D.split("-").map(Number),[P,j]=(O||"00:00").split(":").map(Number),G=m.toLocaleString("en-US",{timeZone:h}),X=new Date(G),V=new Date(X);V.setFullYear($,I-1,N),V.setHours(P,j,0,0);const oe=new Date(V.toLocaleString("en-US",{timeZone:"UTC"})),ie=new Date(V.toLocaleString("en-US",{timeZone:h})),fe=oe.getTime()-ie.getTime();y=new Date(V.getTime()+fe);const Ne=new Date(m.getTime()+120*1e3);if(y.getTime()<m.getTime()+60*1e3){const Te=y.toISOString();y=Ne;const Gt=` [Note: The requested time ${t.schedule_value} in ${h} resolved to ${Te} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=Gt}}else y=new Date(m.getTime()+3600*1e3);if((t.schedule_type==="interval"||t.schedule_type==="daily"||t.schedule_type==="weekly")&&t.action_type==="custom"){const D=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(send|forward)\b.{0,40}\b(email|mail)\b|\bemail.{0,20}\bto\b|\bgmail_send\b/.test(D)&&(t.schedule_type="once")}if(t.action_type==="custom"&&t.schedule_type==="once"){const D=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(D)||(t.action_type="reminder")}if(await n.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(r,t.name,t.schedule_type,t.schedule_value).first()){const D=y.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${D} (${h}). No duplicate created.`}await n.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),y.toISOString()).run();const E=t._pastTimeWarning||"",k=y.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${k} (${h}). [UTC: ${y.toISOString()}]${E}. IMPORTANT: Use the exact time "${k}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const y=(await n.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return y.length===0?"No scheduled tasks found.":y.map(h=>`[ID:${h.id}] ${h.enabled?"▶":"⏸"} "${h.name}" — [${h.schedule_type}] ${h.schedule_value} — ${h.action_type} — state: ${h.state||"active"} — next: ${h.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const m=t.enabled?1:0,y=m?"active":"paused";return await n.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(m,y,t.job_id,r).run(),`Schedule ${t.job_id} ${m?"enabled (active)":"paused"}.`}case"update_schedule_state":{const m=["created","active","reminding","paused","completed"],y=t.state;if(!m.includes(y))return`Invalid state "${y}". Valid states: ${m.join(", ")}`;const h=y==="completed"||y==="paused"?0:1;return await n.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,h,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"update_schedule":{const m=t.job_id,y=c||"UTC",h=new Date,v=["updated_at = CURRENT_TIMESTAMP"],_=[];t.name&&(v.push("name = ?"),_.push(t.name)),t.description&&(v.push("description = ?"),_.push(t.description));let E=null,k=t.schedule_type,D=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){E=new Date(h.getTime()+t.minutes_from_now*60*1e3);const I=E.toLocaleString("en-US",{timeZone:y,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,P,j]=(I[0]||"").split("/");D=`${j}-${N}-${P} ${I[1]||"00:00"}`,k="once"}else if(k&&D){if(k==="interval")E=new Date(h.getTime()+parseInt(D,10)*60*1e3);else if(k==="daily"){const[$,I]=D.split(":").map(Number),N=new Date(h.toLocaleString("en-US",{timeZone:y})),P=new Date(N);P.setHours($,I,0,0),P<=N&&P.setDate(P.getDate()+1);const j=new Date(P.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(P.toLocaleString("en-US",{timeZone:y})).getTime();E=new Date(P.getTime()+j)}else if(k==="weekly"){const[$,I]=D.split(" "),[N,P]=(I||"00:00").split(":").map(Number),G=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(fe=>fe.toLowerCase()===$.toLowerCase()),X=new Date(h.toLocaleString("en-US",{timeZone:y})),V=new Date(X);V.setHours(N,P,0,0);let oe=(G-V.getDay()+7)%7;oe===0&&V<=X&&(oe=7),V.setDate(V.getDate()+oe);const ie=new Date(V.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(V.toLocaleString("en-US",{timeZone:y})).getTime();E=new Date(V.getTime()+ie)}else if(k==="once"){const[$,I]=D.split(" "),[N,P,j]=$.split("-").map(Number),[G,X]=(I||"00:00").split(":").map(Number),V=new Date(h.toLocaleString("en-US",{timeZone:y})),oe=new Date(V);oe.setFullYear(N,P-1,j),oe.setHours(G,X,0,0);const ie=new Date(oe.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(oe.toLocaleString("en-US",{timeZone:y})).getTime();E=new Date(oe.getTime()+ie),E.getTime()<h.getTime()+60*1e3&&(E=new Date(h.getTime()+120*1e3))}}if(k&&(v.push("schedule_type = ?"),_.push(k)),D&&(v.push("schedule_value = ?"),_.push(D)),E&&(v.push("next_run = ?"),_.push(E.toISOString())),v.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";_.push(m,r),await n.prepare(`UPDATE cron_jobs SET ${v.join(", ")} WHERE id = ? AND user_id = ?`).bind(..._).run();const O=E?E.toLocaleString("en-US",{timeZone:y,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${m} updated.${O?` New fire time: ${O} (${y}).`:""} IMPORTANT: Use this exact time "${O}" when confirming to the user.`}case"delete_schedule":return await n.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const m=t.importance||5,y=t.type==="task"?"preference":t.type,h=m>=7?"working":"long_term";return await b.store(r,y,t.title,t.content,m,h),`Stored in ${h==="working"?"working":"long-term"} memory: [${y}] ${t.title} (importance: ${m})`}case"search_memory":{const m=await b.search(r,t.query);return m.length===0?"No matching memories found.":m.map(y=>`[id:${y.id}] [${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
`)}case"delete_memory":return await b.remove(t.id,r),`Memory entry ${t.id} deleted.`;case"update_memory":return await b.update(t.id,r,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const m=await n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),y=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),h=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),v=await n.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),_=await n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||""),y=t.spreadsheet_id;let h=t.range;const v=await m.sheets.getMetadata(y),_=v.sheets;h.includes("!")||(h=`${_[0]}!${h}`);let E;try{E=await m.sheets.readRange(y,h)}catch(D){if((w=D.message)!=null&&w.includes("Unable to parse range")||(T=D.message)!=null&&T.includes("400")){const O=h.includes("!")?h.split("!")[1]:h;h=`${_[0]}!${O}`,E=await m.sheets.readRange(y,h)}else throw D}let k=`[Spreadsheet: "${v.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(D=>`"${D}"`).join(", ")}]
`;return _.length>1&&(k+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),E.length===0?k+"No data found in the specified range.":k+E.map(D=>D.join("	| ")).join(`
`)}catch(m){return await H(n,r,"google","read_sheet",m.message),`Failed to read sheet: ${m.message}`}}case"write_sheet":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const I=new Q(n),N=JSON.stringify(t.values);await I.store(r,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:N.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const h=t.values;let v=t.range;const k=Math.max(...h.map(I=>I.length))+4,D=h.map(I=>{const N=[...I];for(;N.length<k;)N.push("");return N}),O=v.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(O){const I=O[1]||"",N=O[2],P=O[3],j=O[5],X=N.toUpperCase().charCodeAt(0)-64+k-1,V=X<=26?String.fromCharCode(64+X):"Z";v=`${I}${N}${P}:${V}${j}`}const $=await m.sheets.writeRange(t.spreadsheet_id,v,D);try{const I=new Q(n),N=await I.search(r,`Pending sheet write: ${t.spreadsheet_id}`);for(const P of N)P.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await I.remove(P.id,r)}catch{}return`Written ${$.updatedCells} cells to ${v}.`}catch(m){return await H(n,r,"google","write_sheet",m.message),`Failed to write sheet: ${m.message}`}}case"append_sheet":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new Q(n).store(r,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const h=await m.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const v=new Q(n),_=await v.search(r,`Pending sheet append: ${t.spreadsheet_id}`);for(const E of _)E.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await v.remove(E.id,r)}catch{}return`Appended ${h.updatedCells} cells to ${t.range}.`}catch(m){return await H(n,r,"google","append_sheet",m.message),`Failed to append to sheet: ${m.message}`}}case"create_sheet":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title)try{await new Q(n).store(r,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`
...
(Note: spreadsheet saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new Q(n).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${v}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(m){return await H(n,r,"google","create_sheet",m.message),`Failed to create spreadsheet: ${m.message}`}}case"list_calendar_events":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||""),y=t.calendar_id||"primary",h=t.days_ahead||7,v=new Date,_=new Date(v.getTime()+h*24*60*60*1e3),E=await m.calendar.listEvents(y,{timeMin:v.toISOString(),timeMax:_.toISOString(),query:t.query});return E.length===0?`No events found in the next ${h} days.`:E.map(k=>{var N;const D=k.start.dateTime||k.start.date||"TBD",O=k.end.dateTime||k.end.date||"",$=k.location?` 📍 ${k.location}`:"",I=((N=k.attendees)==null?void 0:N.map(P=>P.email).join(", "))||"";return`• ${k.summary} — ${D} to ${O}${$}${I?`
  Attendees: ${I}`:""}`}).join(`
`)}catch(m){return await H(n,r,"google","list_calendar",m.message),`Failed to list events: ${m.message}`}}case"create_calendar_event":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||"");if(!(await m.isConnected()).connected){if(t.summary&&t.start_datetime&&t.end_datetime)try{await new Q(n).store(r,"context",`Pending calendar event: "${t.summary}"`,JSON.stringify({tool:"create_calendar_event",summary:t.summary,description:t.description??null,location:t.location??null,start_datetime:t.start_datetime,end_datetime:t.end_datetime,attendees:t.attendees??null,calendar_id:t.calendar_id??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.summary&&t.start_datetime?`

The calendar event has been saved to temporary memory. After reconnecting, tell me "create the pending event" and I'll add it to your calendar.`:"")}const h=t.calendar_id||"primary",v=await m.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});try{const _=new Q(n),E=await _.search(r,`Pending calendar event: "${t.summary}"`);for(const k of E)k.title.startsWith(`Pending calendar event: "${t.summary}"`)&&await _.remove(k.id,r)}catch{}return`Event created: "${v.summary}"
ID: ${v.id}
Start: ${v.start.dateTime||v.start.date}`}catch(m){return await H(n,r,"google","create_event",m.message),`Failed to create event: ${m.message}`}}case"create_doc":{if(!s)return"Authentication context unavailable.";const m=new ve(n,r,s,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title&&t.content){try{await new Q(n).store(r,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" and I'll complete this automatically.`:"")}let h;try{h=await m.docs.createDocument(t.title)}catch(_){return await H(n,r,"google","create_doc",_.message),`Failed to create document: ${_.message}`}if(t.content){const _=t.content,E=async()=>{_.length>12e3?await m.docs.appendText(h.documentId,_):await m.docs.appendFormattedContent(h.documentId,_)};try{await E()}catch(k){try{await m.docs.appendText(h.documentId,_)}catch(D){return await H(n,r,"google","create_doc_append",D.message),`Document created but content could not be written (${D.message}).
ID: ${h.documentId}
URL: ${h.url}

Use append_to_doc with the document ID above to add content.`}await H(n,r,"google","create_doc_append_fallback",`Formatted append failed, used plain text: ${k.message}`)}}let v="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,r,s,a||"",i||"");v=`
Folder: "${(await pn(_,h.documentId,t.folder_name)).folderName}"`}catch(_){v=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new Q(n).store(r,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}try{const _=t.content;await n.prepare(`INSERT OR IGNORE INTO document_library (user_id, source, drive_file_id, name, summary, extracted_text, status)
           VALUES (?, 'drive', ?, ?, ?, ?, 'parsed')`).bind(r,h.documentId,t.title,_?_.substring(0,500):null,_?_.substring(0,5e4):null).run()}catch{}try{const _=new Q(n),E=await _.search(r,`Pending Google Doc save: "${t.title}"`);for(const k of E)k.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await _.remove(k.id,r)}catch{}return`Document created: "${t.title}"${v}
ID: ${h.documentId}
URL: ${h.url}`}case"read_doc":{if(!s)return"Authentication context unavailable.";try{const y=await new ve(n,r,s,a||"",i||"").docs.readDocument(t.document_id);return`Document: "${y.title}"

${y.content}`}catch(m){return await H(n,r,"google","read_doc",m.message),`Failed to read document: ${m.message}`}}case"append_to_doc":{if(!s)return"Authentication context unavailable.";try{const m=new ve(n,r,s,a||"",i||"");if(!(await m.isConnected()).connected){if(t.document_id&&t.content)try{await new Q(n).store(r,"context",`Pending append to doc: "${t.document_id}"`,JSON.stringify({tool:"append_to_doc",document_id:t.document_id,content:t.content}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.'+(t.document_id&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" to complete this.`:"")}await m.docs.appendFormattedContent(t.document_id,t.content);let h=t.document_id;try{h=(await m.docs.readDocument(t.document_id)).title}catch{}try{const v=new Q(n),_=await v.search(r,`Pending append to doc: "${t.document_id}"`);for(const E of _)E.title.startsWith(`Pending append to doc: "${t.document_id}"`)&&await v.remove(E.id,r)}catch{}try{const v=t.content;await n.prepare(`UPDATE document_library
...
${h}`}catch(m){return await H(n,r,"gmail","read",m.message),`Gmail read error: ${m.message}`}}case"gmail_search":{if(!s)return"Authentication context unavailable.";try{const m=Xi(t);if(!m)return"Gmail search requires a non-empty query (e.g. from:sender@example.com subject:invoice). Use Gmail search syntax.";const y=typeof t.product_hint=="string"?t.product_hint.trim():"",h=Math.min(Math.max(t.max_results||10,1),20),v=new De(n,r,s,a||"",i||"");let _=await v.search(m,h);if(_.length===0&&y){const E=On(y).replace("180d","365d");_=await v.search(E,h)}return _.length===0?`No results for: ${m}`:y?bi(_,y,m):_.map((E,k)=>`${E.isUnread?"● ":"  "}${k+1}. **${E.subject}**
   From: ${E.from}
   Date: ${E.date}
   ${E.snippet}
   [id: ${E.id}]`).join(`

`)}catch(m){await H(n,r,"gmail","search",m.message);const y=String((m==null?void 0:m.message)||m);return/403|access denied|insufficient|permission/i.test(y)?`${y} Go to Settings → Keys → Google Workspace and reconnect your account.`:`Gmail search error: ${y}`}}case"gmail_send":{if(!s)return"Authentication context unavailable.";try{const m=new De(n,r,s,a||"",i||"");if(!(await new ve(n,r,s,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body){try{await new Q(n).store(r,"context",`Pending email: "${t.subject}"`,JSON.stringify({tool:"gmail_send",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const v=await m.send(t.to,t.subject,t.body,{cc:t.cc});try{const _=new Q(n),E=await _.search(r,`Pending email: "${t.subject}"`);for(const k of E)k.title.startsWith(`Pending email: "${t.subject}"`)&&await _.remove(k.id,r)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${v.id}]`}catch(m){return await H(n,r,"gmail","send",m.message),`Gmail send error: ${m.message}`}}case"gmail_draft":{if(!s)return"Authentication context unavailable.";try{const m=new De(n,r,s,a||"",i||"");if(!(await new ve(n,r,s,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new Q(n).store(r,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const v=await m.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const E=new Q(n),k=await E.search(r,`Pending draft: "${t.subject}"`);for(const D of k)D.title.startsWith(`Pending draft: "${t.subject}"`)&&await E.remove(D.id,r)}catch{}const _=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${_}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${v.id}]`}catch(m){return await H(n,r,"gmail","draft",m.message),`Gmail draft error: ${m.message}`}}case"gmail_modify":{if(!s)return"Authentication context unavailable.";try{return await new De(n,r,s,a||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(m){return await H(n,r,"gmail","modify",m.message),`Gmail modify error: ${m.message}`}}case"gmail_unread_count":{if(!s)return"Authentication context unavailable.";try{const y=await new De(n,r,s,a||"",i||"").getUnreadCount();return`You have ${y} unread email${y!==1?"s":""} in Gmail.`}catch(m){return(R=m.message)!=null&&R.includes("not connected")?m.message:`Gmail error: ${m.message}`}}case"drive_list":{if(!s)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,r,s,a||"",i||""),y=new URLSearchParams;y.set("pageSize",String(t.max_results||10)),y.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),y.set("orderBy","modifiedTime desc");let h="";t.folder_id?h=`'${t.folder_id}' in parents and trashed = false`:t.query?h=`${t.query} and trashed = false`:h="trashed = false",y.set("q",h);const v=await fetch(`https://www.googleapis.com/drive/v3/files?${y}`,{headers:{Authorization:`Bearer ${m}`}});if(!v.ok)throw new Error(`Drive API error (${v.status})`);const _=await v.json();return(C=_.files)!=null&&C.length?_.files.map((E,k)=>{var I,N;const D=((I=E.mimeType)==null?void 0:I.split(".").pop())||E.mimeType,O=E.size?`${(parseInt(E.size)/1024).toFixed(1)} KB`:"",$=((N=E.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${k+1}. **${E.name}** (${D})
   ${O} · Modified: ${$}
   ${E.webViewLink||""}`}).join(`

`):"No files found."}catch(m){return await H(n,r,"google","drive_list",m.message),`Drive list error: ${m.message}`}}case"drive_search":{if(!s)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,r,s,a||"",i||""),y=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,h=new URLSearchParams;h.set("q",y),h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");const v=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${m}`}});if(!v.ok)throw new Error(`Drive API error (${v.status})`);const _=await v.json();return(M=_.files)!=null&&M.length?_.files.map((E,k)=>{var $,I;const D=(($=E.mimeType)==null?void 0:$.split(".").pop())||E.mimeType,O=((I=E.modifiedTime)==null?void 0:I.split("T")[0])||"";return`${k+1}. **${E.name}** (${D}) — Modified: ${O}
   ${E.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(m){return await H(n,r,"google","drive_search",m.message),`Drive search error: ${m.message}`}}case"drive_read_file":{if(!s)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,r,s,a||"",i||""),y=t.url_or_id.trim();let h=y;const v=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const j of v){const G=y.match(j);if(G){h=G[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${m}`}});if(!_.ok)throw new Error(`Drive API error (${_.status}): could not fetch file metadata`);const E=await _.json(),{name:k,mimeType:D}=E,O=t.extract_focus,$=O?`Focus specifically on extracting: ${O}`:"Extract and return all readable text content. Preserve structure where relevant.",I={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(I[D]){const j=I[D],G=await fetch(`https://www.googleapis.com/drive/v3/files/${h}/export?mimeType=${encodeURIComponent(j)}`,{headers:{Authorization:`Bearer ${m}`}});if(!G.ok)throw new Error(`Drive export error (${G.status})`);const X=await G.text();if(D==="application/vnd.google-apps.spreadsheet"){const V=so(X),oe=V.length,ie=((A=V[0])==null?void 0:A.length)??0;return`**${k}** (Google Sheet — ${oe} rows × ${ie} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(V)}`}return`**${k}**

${X.substring(0,2e4)}`}if(D==="application/pdf"||k.toLowerCase().endsWith(".pdf")){const j=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!j.ok)throw new Error(`Drive download error (${j.status})`);const G=await j.arrayBuffer(),X=Buffer.from(G).toString("base64");let V=null,oe="claude-sonnet-4-6";for(const Te of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const Gt=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,Te).first();if(Gt&&s){const Xs=await Y(Gt.encrypted_value,s),Wt=JSON.parse(Xs);if(Wt.provider==="anthropic"){V=Wt.apiKey,Wt.model&&(oe=Wt.model);break}}}catch{}if(!V)return`"${k}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const ie=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":V,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:oe,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:X}},{type:"text",text:$}]}]})});if(!ie.ok){const Te=await ie.text();throw new Error(`Anthropic PDF extraction error: ${Te.substring(0,200)}`)}const Ne=((q=(U=(await ie.json()).content)==null?void 0:U[0])==null?void 0:q.text)||"";return`**${k}** (PDF from Drive)

${Ne}`}const N=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!N.ok)throw new Error(`Drive download error (${N.status})`);const P=await N.text();return`**${k}** (${D})

${P.substring(0,2e4)}`}catch(m){return await H(n,r,"google","drive_read_file",m.message),`Drive read error: ${m.message}`}}case"drive_delete_file":{if(!s)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,r,s,a||"",i||""),y=t.url_or_id.trim();let h=y;const v=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const D of v){const O=y.match(D);if(O){h=O[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?fields=name`,{headers:{Authorization:`Bearer ${m}`}});if(!_.ok)throw new Error(`Drive API error (${_.status})`);const E=await _.json(),k=await fetch(`https://www.googleapis.com/drive/v3/files/${h}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!k.ok)throw new Error(`Drive API error (${k.status})`);return`"${E.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(m){return await H(n,r,"google","drive_delete_file",m.message),`Drive delete error: ${m.message}`}}case"drive_organise":{if(!s)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:m}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,r,s,a||"",i||""),y=t.url_or_id.trim();let h=y;const v=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const E of v){const k=y.match(E);if(k){h=k[1];break}}const _=[];if(t.new_name){const E=await fetch(`https://www.googleapis.com/drive/v3/files/${h}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!E.ok)throw new Error(`Drive rename error (${E.status})`);_.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:E}=await pn(m,h,t.folder_name);_.push(`Moved to folder "${E}"`)}return _.join(". ")+"."}catch(m){return await H(n,r,"google","drive_organise",m.message),`Drive organise error: ${m.message}`}}case"web_search":try{const m=await tn(t.query,{num:t.num_results||5,site:t.site,googleApiKey:o||void 0,googleCseId:l||void 0});return m.error?`Web search failed: ${m.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:m.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:m.results.map((y,h)=>`${h+1}. [${y.title}](${y.link})
   ${y.snippet}`).join(`

`)}catch(m){return await H(n,r,"search","web_search",m.message),`Web search error: ${m.message}`}case"read_url":try{const m=t.url;if(!m||!m.startsWith("http://")&&!m.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:h}=await Promise.resolve().then(()=>ki),v=await h(m,y);return v.error?`Failed to read page: ${v.error}`:!v.text||v.text.length<20?`Page at ${m} returned no readable content.`:`Content from ${m} (${v.text.length} chars):

${v.text}`}catch(m){return await H(n,r,"search","read_url",m.message),`Read URL error: ${m.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{let m;try{const D=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"perplexity_api_key").first();D&&s&&(m=await Y(D.encrypted_value,s))}catch{}const y=t.depth||"quick",h=y==="thorough"?15e4:9e4,v=ls(t.query,d,{depth:y,site:t.site,perplexityApiKey:m,googleApiKey:o||void 0,googleCseId:l||void 0}),_=new Promise(D=>setTimeout(()=>D(null),h)),E=await Promise.race([v,_]);if(E===null){const{webSearch:D}=await Promise.resolve().then(()=>gi),O=await D(t.query,{num:5,googleApiKey:o||void 0,googleCseId:l||void 0});if(O.error||O.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let $=`Research took too long, but here are the top search results:

`;return $+=O.results.map((I,N)=>`${N+1}. [${I.title}](${I.link})
   ${I.snippet}`).join(`

`),$}if(E.error)return`Research failed: ${E.error}`;let k=E.report;E.sources.length>0&&(k+=`

---
**Sources** (`+E.pagesRead+` pages read):
`,k+=E.sources.map((D,O)=>`[${O+1}] [${D.title}](${D.url})`).join(`
`));try{const D=new Q(n),O=E.report.substring(0,600);await D.store(r,"context",`Research: ${t.query.substring(0,80)}`,O,6,"long_term")}catch{}return k}catch(m){return await H(n,r,"research","research",m.message),`Research error: ${m.message}`}}case"browser_task":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const y=(await Y(m.encrypted_value,s)).trim();let h,v=t.task,_,E;if(!t.site_name)try{const P=await n.prepare("SELECT name FROM site_credentials WHERE user_id = ?").bind(r).all(),j=v.toLowerCase(),G=(P.results||[]).find(X=>j.includes(X.name.toLowerCase()));G&&(t={...t,site_name:G.name},tr("browser_task auto-vault: inferred site_name from task text",{siteName:G.name,userId:r}))}catch{}if(t.site_name)try{const P=await n.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(r,t.site_name).first();if(P){const j=JSON.parse(await Y(P.encrypted_blob,s));h={username:j.username,password:j.password},E=j.sessionId,_=P.id,v=`${v}

When prompted to log in, use username {username} and password {password}.`}}catch{}const k=async P=>{if(_)try{const j=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(_,r).first();if(!j)return;const G=JSON.parse(await Y(j.encrypted_blob,s));G.sessionId=P,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await Tt(JSON.stringify(G),s),_,r).run()}catch{}},D=async()=>{if(!(!_||!E))try{const P=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(_,r).first();if(!P)return;const j=JSON.parse(await Y(P.encrypted_blob,s));delete j.sessionId,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await Tt(JSON.stringify(j),s),_,r).run()}catch{}},O=/blue[\s-]?dart[\s\S]{0,100}?(\d{10,11})|(\d{10,11})[\s\S]{0,100}?blue[\s-]?dart/i.exec(v);if(O){const P=O[1]||O[2];v=Ii(P)}const $=void 0;f&&(f.apiKey=y,E&&!f.sessionId?(f.sessionId=E,f.persistSession=!0):!f.sessionId&&_&&(f.sessionId=await Ri(y)??void 0)),tr("browser_task starting",{userId:r,channel:g,timeoutMs:$??3e5,sessionId:f==null?void 0:f.sessionId,vaultSession:!!E});const I=await ms(v,y,{secrets:h,sessionId:f==null?void 0:f.sessionId,timeoutMs:$});if(I.status==="completed"){const P=(f==null?void 0:f.sessionId)??void 0;return _&&P&&(f&&(f.persistSession=!0),await k(P)),(Z=I.output)!=null&&Z.includes('"captcha_required": true')?"Captcha detected — manual verification required. The site blocked automated access. Please try completing it manually or try again later.":I.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again."}if(I.status==="timeout"){f&&(f.hasActiveTask=!0);try{await new Q(n).store(r,"context",`Browser task in progress: ${I.taskId}`,JSON.stringify({task_id:I.taskId,task:t.task}),9,"working")}catch{}try{const P=(t.task||"").substring(0,200);await n.prepare("INSERT INTO pending_browser_tasks (user_id, task_id, task_description, thread_id, channel) VALUES (?, ?, ?, ?, ?)").bind(r,I.taskId,P,(f==null?void 0:f.threadId)??null,g).run()}catch{}return`[BROWSER_TIMEOUT:${I.taskId}] Browser task did not finish within the time limit. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}E&&y&&nn(E,y).catch(()=>{}),f&&(f.persistSession=!1),await D();const N=[I.error,I.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${I.taskId}\`): ${N||"No details returned."} | Operator hint: Check Browser Use dashboard — taskId=${I.taskId}`}catch(m){return await H(n,r,"browser","browser_task",m.message),`Browser task error: ${m.message}`}}case"browser_task_status":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured.";const y=await Y(m.encrypted_value,s),h=await ps(t.task_id,y);if(h.done){try{const v=new Q(n),_=await v.search(r,`Browser task in progress: ${t.task_id}`);for(const E of _)await v.remove(E.id,r)}catch{}return h.status==="finished"||h.status==="completed"?h.output?h.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${h.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${h.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}catch(m){return await H(n,r,"browser","browser_task_status",m.message),`Browser status check error: ${m.message}`}}case"vault_lookup":try{const m=(t.site_name||"").trim();if(!m)return"No site name provided.";const h=((await n.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(r,`%${m}%`).all()).results||[]).map(v=>v.name);return h.length===0?`No vault entries found matching "${m}".`:`Vault entries matching "${m}": ${h.join(", ")}. Use site_name="${h[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await Y(m.encrypted_value,s),h=await Qr(y,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((v,_)=>{const E=v.rating?` ★${v.rating} (${v.userRatingsTotal||0} reviews)`:"",k=v.openNow!==void 0?v.openNow?" · Open now":" · Closed":"",D=v.googleMapsUri?`
   ${v.googleMapsUri}`:"";return`${_+1}. **${v.name}**${E}${k}
   ${v.address}${D}
   [place_id: ${v.placeId}]`}).join(`

`)}catch(m){return await H(n,r,"google_api","search_places",m.message),`Places search error: ${m.message}`}}case"get_place_details":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Y(m.encrypted_value,s),h=await es(y,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const v=h.details;let _=`**${v.name}**
...
— ${E.author} (★${E.rating}, ${E.time}): "${E.text}"`}return _}catch(m){return await H(n,r,"google_api","place_details",m.message),`Place details error: ${m.message}`}}case"get_directions":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Y(m.encrypted_value,s),h=await ts(y,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const v=h.route;let _=`**${v.startAddress}** → **${v.endAddress}**
`;return _+=`📏 ${v.distance} · ⏱️ ${v.duration}`,v.durationInTraffic&&(_+=` (with traffic: ${v.durationInTraffic})`),_+=`
via ${v.summary}`,_+=`

Steps:`,v.steps.forEach((E,k)=>{_+=`
${k+1}. ${E.instruction} (${E.distance}, ${E.duration})`}),_}catch(m){return await H(n,r,"google_api","directions",m.message),`Directions error: ${m.message}`}}case"get_travel_time":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Y(m.encrypted_value,s),h=await is(y,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let v=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(v+=` (with traffic: ${h.durationInTraffic})`),v}catch(m){return await H(n,r,"google_api","travel_time",m.message),`Travel time error: ${m.message}`}}case"translate_text":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Y(m.encrypted_value,s),h=await ns(y,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(m){return await H(n,r,"google_api","translate",m.message),`Translation error: ${m.message}`}}case"search_youtube":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Y(m.encrypted_value,s),h=await ss(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((v,_)=>{var E;return`${_+1}. **${v.title}**
   ${v.channelTitle} · ${((E=v.publishedAt)==null?void 0:E.split("T")[0])||""}
   ${v.description}
   ${v.url}`}).join(`

`)}catch(m){return await H(n,r,"google_api","youtube_search",m.message),`YouTube search error: ${m.message}`}}case"geocode_address":{if(!s)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Y(m.encrypted_value,s),h=await rs(y,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((v,_)=>`${_+1}. ${v.address}
...
${h.extracted_text}`;const{file_name:v,file_type:_}=h;let{file_data:E}=h;if(E==="r2"){if(!u)return`File "${v}" is stored in R2 but no storage bucket is configured.`;const k=await u.get(m);if(!k)return`File "${v}" not found in storage. It may have been deleted.`;const D=await k.arrayBuffer();E=Buffer.from(D).toString("base64")}if(_.startsWith("text/"))try{const k=Buffer.from(E,"base64").toString("utf-8");return`Document: ${v}

${k.substring(0,2e4)}`}catch{return`Could not decode text file: ${v}`}if(_==="application/pdf"||_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||v.toLowerCase().endsWith(".pdf")||v.toLowerCase().endsWith(".docx")){if(_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||v.toLowerCase().endsWith(".docx")){try{const O=await hs(Buffer.from(E,"base64"));if(O.length>50){try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(O,m,r).run();const $=O.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind($,O.substring(0,5e4),m,r).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const I=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,r).first();if(I){const{indexDocumentChunks:N}=await Promise.resolve().then(()=>ze);N({DB:n,AI:p.ai,VECTORIZE:p.vectorize},r,I.id,O).catch(()=>{})}}}catch{}return`Document: ${v}

${O.substring(0,2e4)}`}}catch{}return`Could not extract text from "${v}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let k=null,D="claude-sonnet-4-6";for(const O of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const $=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,O).first();if($&&s){const I=await Y($.encrypted_value,s),N=JSON.parse(I);if(N.provider==="anthropic"){k=N.apiKey,N.model&&(D=N.model);break}}}catch{}if(k)try{const O=y?`Focus specifically on extracting: ${y}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",$=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:E}},{type:"text",text:O}]}]})});if($.ok){const N=((L=(re=(await $.json()).content)==null?void 0:re[0])==null?void 0:L.text)||"";if(N&&N.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(N,m,r).run();const P=N.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(P,N.substring(0,5e4),m,r).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const j=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,r).first();if(j){const{indexDocumentChunks:G}=await Promise.resolve().then(()=>ze);G({DB:n,AI:p.ai,VECTORIZE:p.vectorize},r,j.id,N).catch(()=>{})}}}catch{}return`Document: ${v}

${N}`}else{const I=await $.text();return`Could not parse ${v} via Anthropic API: ${I.substring(0,200)}`}}catch(O){return`Document parsing error for ${v}: ${O.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}if(_.startsWith("image/")){let k=null,D="claude-sonnet-4-6";for(const $ of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const I=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,$).first();if(I&&s){const N=await Y(I.encrypted_value,s),P=JSON.parse(N);if(P.provider==="anthropic"){k=P.apiKey,P.model&&(D=P.model);break}}}catch{}if(!k)return"To extract text from images, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set.";const O=y?`Focus specifically on: ${y}`:"Extract all visible text from this image. Include any text from signs, documents, screenshots, or diagrams. If the image contains charts or tables, describe their structure and data.";try{const $=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:_,data:E}},{type:"text",text:O}]}]})});if($.ok){const N=((J=(z=(await $.json()).content)==null?void 0:z[0])==null?void 0:J.text)||"";if(N&&N.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(N,m,r).run();const P=N.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(P,N.substring(0,5e4),m,r).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const j=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,r).first();if(j){const{indexDocumentChunks:G}=await Promise.resolve().then(()=>ze);G({DB:n,AI:p.ai,VECTORIZE:p.vectorize},r,j.id,N).catch(()=>{})}}}catch{}return`Document: ${v}

${N}`}else{const I=await $.text();return`Could not parse ${v} via Anthropic API: ${I.substring(0,200)}`}}catch($){return`Image parsing error for ${v}: ${$.message}`}}try{const k=Buffer.from(E,"base64").toString("utf-8").substring(0,2e3);return`Document: ${v} (${_})

Content preview:
${k}`}catch{return`Cannot read file: ${v} (${_})`}}case"search_library":{const m=t.query,y=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!m)return"query is required for search_library.";if(p!=null&&p.ai&&(p!=null&&p.vectorize))try{const{semanticDocumentSearch:k}=await Promise.resolve().then(()=>ze),D=await k({DB:n,AI:p.ai,VECTORIZE:p.vectorize},r,m,y);if(D.length>0){const O=D.map($=>`[id:${$.document_id}] "${$.filename}" (relevance: ${($.relevance_score*100).toFixed(1)}%)
...
Use read_library_file with the id to get the full document text.`}}catch{}const h=await n.prepare(`
      ...
      `).bind(r,`%${m}%`,`%${m}%`,`%${m}%`,y).all(),v=await n.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(r,r,`%${m}%`,r,`%${m}%`,`%${m}%`,`%${m}%`,y).all(),_=[...h.results||[],...v.results||[]].slice(0,y);if(_.length===0)return`No documents found matching "${m}" in your library.`;const E=_.map(k=>{const D=(k.summary||k.dl_extracted||"").substring(0,200);return`[id:${k.id}] "${k.name}" (source: ${k.source}, status: ${k.status})
...
Use read_library_file with the id to get full text.`}case"read_library_file":{const m=String(t.id_or_name||"").trim();if(!m)return"id_or_name is required for read_library_file.";const y=parseInt(m,10);let h=null;if(isNaN(y)||(h=await n.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           ...
           FROM document_library dl WHERE dl.user_id = ? AND dl.name LIKE ? LIMIT 1`).bind(r,`%${m}%`).first()),!h)return`Document "${m}" not found. Use search_library to find available documents.`;let v=h.extracted_text||null;if(!v&&h.file_id){const _=await n.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(h.file_id,r).first();v=(_==null?void 0:_.extracted_text)||null}return v||(v=h.summary||null),v?`Document: ${h.name}

${v.substring(0,2e4)}`:`Document "${h.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${h.file_id}") to extract the text first.`}case"create_skill":{const m=(W=t.name)==null?void 0:W.trim(),y=(te=t.description)==null?void 0:te.trim(),h=(le=t.instructions)==null?void 0:le.trim();if(!m||!y||!h)return"create_skill requires name, description, and instructions.";let v=m.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");v||(v=`skill_${Date.now()}`);const _=await n.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(r,`${v}%`).all();(ne=_.results)!=null&&ne.some(O=>O.slug===v)&&(v=`${v}_${(((me=_.results)==null?void 0:me.length)||0)+1}`);const E=JSON.stringify(t.parameters||{}),k=JSON.stringify(t.required_tools||[]),D=JSON.stringify(t.examples||[]);return await n.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,m,v,y,h,E,k,D).run(),`Skill created: **${m}** (invoke as: "${v}")

You can now ask me to run "${m}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${m} skill" to execute it.`}case"list_skills":{const y=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",v=(await n.prepare(y).bind(r).all()).results||[];if(v.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const _=v.map(E=>`• **${E.name}** (${E.slug}): ${E.description} [used ${E.usage_count} times${E.enabled?"":" — disabled"}]`).join(`
`);return`Your custom skills (${v.length}):

${_}`}default:{const m=e,y=await n.prepare("SELECT id, name, description, instructions, required_tools FROM user_skills WHERE user_id = ? AND slug = ? AND enabled = 1").bind(r,m).first();if(y){await n.prepare("UPDATE user_skills SET usage_count = usage_count + 1, last_used_at = CURRENT_TIMESTAMP WHERE id = ?").bind(y.id).run();const h=(()=>{try{return JSON.parse(y.required_tools).join(", ")}catch{return""}})(),v=Object.keys(t).length>0?`
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function Ls(e,t,n,r,s){if(t.length>0&&t[t.length-1].role==="user"){const a="(Previous request did not complete. Please try again.)";await e.storeMessage(n,r,"assistant",a,"{}",s),t.push({id:-1,user_id:n,channel:r,role:"assistant",content:a,metadata:"{}",token_estimate:a.length,created_at:new Date().toISOString()})}}function Ms(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const n=typeof e[t].content=="string"?e[t].content:"";n.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(n.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function sr(e,t,n,r,s,a,i){var te,le,ne,me,m;const o=new Q(t),l=(te=e.metadata)==null?void 0:te.thread_id,c=Date.now(),[d,u,p]=await Promise.all([o.buildContext(r.id),Bn(t,r.id),Es(t,r.id)]),g=await o.getRecentConversations(r.id,30,l);await Ls(o,g,r.id,e.channel,l);const f=Is(r,d,e.channel,u,p),b=Mn(g),w=$n([{role:"system",content:f},...Ln(g),{role:"user",content:e.text}]);Os(w,b),Ms(w);const T=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],S=(d.match(/^- /gm)||[]).length;if(T.some(y=>y.test(e.text))||S<3)try{const y=await o.searchLongTerm(r.id,e.text,5);if(y.length>0){const h=y.map(v=>`- [${v.type}] ${v.title}: ${v.content}`).join(`
...
`)){const p=u.trim().split("|");if(p.length<4)continue;const[g,f,b,w]=p,T=["fact","preference","context","decision","summary","task"].find(R=>R===g.trim().toLowerCase());if(!T||!(f!=null&&f.trim())||!(b!=null&&b.trim()))continue;const S=Math.min(10,Math.max(1,parseInt(w)||5));await r.store(n.id,T,f.trim(),b.trim(),S,"long_term")}}const ar={"claude-sonnet-4-6":1e6,"claude-haiku-4-5":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function oo(e){for(const[t,n]of Object.entries(ar))if(e.toLowerCase().includes(t.toLowerCase()))return n;return ar.default}function lo(e,t,n,r){const s=oo(r),a=Math.floor(s*.75),i=[];let o=0,l=!1;const c=mn(e);i.push({role:"system",content:e}),o+=c;const d=mn(n);o+=d;const u=a-o,p=[];let g=0;for(let f=t.length-1;f>=0;f--){const b=t[f],w=mn(b.content);if(g+w<=u)p.unshift({role:b.role,content:b.content}),g+=w;else{l=!0;break}}return i.push(...p),i.push({role:"user",content:n}),o+=g,{maxTokens:s,usedTokens:o,messages:i,wasTruncated:l}}async function*co(e,t,n,r,s,a){var ne,me,m;const i=new Q(t),o=(ne=e.metadata)==null?void 0:ne.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:n.name}};const[c,d,u]=await Promise.all([i.buildContext(r.id),Bn(t,r.id),Es(t,r.id)]),p=await i.getRecentConversations(r.id,30,o);await Ls(i,p,r.id,e.channel,o);const g=Is(r,c,e.channel,d,u),f=Mn(p),b=$n([...Ln(p)]);let w=e.text;f&&(w=`${bn}

${e.text}`);const T=lo(g,b.map(y=>({role:y.role,content:y.content})),w,n.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const S=await Pn(t,r.id),R=10;let C="",M=0;const A=[...T.messages],U=[];let q,Z=0,re=0;const L={hasActiveTask:!1,persistSession:!1,threadId:o,channel:e.channel},z=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],J=(c.match(/^- /gm)||[]).length;if(z.some(y=>y.test(e.text))||J<3||f)try{const y=await i.searchLongTerm(r.id,e.text,5);if(y.length>0){const h=y.map(v=>`- [${v.type}] ${v.title}: ${v.content}`).join(`
...
${h}]`})}}catch{}Ms(A);const te=()=>ks(U,q);for(let y=0;y<R;y++){Z=y+1;try{y>0&&(yield{type:"thinking",data:{threadId:o}},As(A));const h=await n.chat(A,{tools:S});if(h.usage&&(M+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){const E=((me=h.content)==null?void 0:me.trim())??"";E&&E.length<=150&&!/^\[calling:/i.test(E)&&(yield{type:"chunk",data:{text:h.content,threadId:o}});const k=h.content||"(tools executed)";A.push({role:"assistant",content:k});const D=[];for(const O of h.toolCalls){yield{type:"tool_start",data:{tool:O.name,toolArgs:O.arguments,threadId:o}},U.push(O.name);try{const $=(G,X)=>At(G,X,t,r.id,{agentType:"full",providerName:n.name,channel:e.channel},r.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,r.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},L);let I;if(O.name==="browser_task"||O.name==="browser_task_status"){if(O.name==="browser_task"){const ie=O.arguments.site_name;yield{type:"browser_ack",data:{message:ie?`Starting now — opening ${ie} in a browser. I'll notify you when done.`:"Starting now — running browser task. I'll notify you when done.",startedAt:new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:r.timezone||"UTC"}),threadId:o}}}const X=["Still working — browser launched, navigating to site...","Still working — page loaded, scanning for content...","Still working — reading and extracting results...","Still working — almost there, finalising output...","Taking a bit longer — site may require extra steps...","Still running — browser is working through the page...","Continuing — extracting and processing data...","Still going — complex task, nearly there...","Almost done — wrapping up the browser session...","Still running — holding on a little longer...","Browser is still active — this one is taking time...","Patience — still working through the task...","Still running — will have a result for you shortly..."],V=$(O.name,O.arguments);let oe=0;e:for(;;){const ie=await Promise.race([V.then(fe=>({done:!0,r:fe})),new Promise(fe=>setTimeout(()=>fe({done:!1}),15e3))]);if(ie.done){I=ie.r;break e}O.name==="browser_task"?yield{type:"browser_progress",data:{message:X[Math.min(oe,X.length-1)],elapsed_s:(oe+1)*15,threadId:o}}:yield{type:"thinking",data:{threadId:o}},oe++}if(O.name==="browser_task"){const ie=I.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(ie){yield{type:"browser_progress",data:{message:"Task still running — checking final status...",threadId:o}};const fe=$("browser_task_status",{task_id:ie[1]});e:for(;;){const Ne=await Promise.race([fe.then(Te=>({done:!0,r:Te})),new Promise(Te=>setTimeout(()=>Te({done:!1}),15e3))]);if(Ne.done){I=Ne.r;break e}yield{type:"thinking",data:{threadId:o}}}if(!I.startsWith("[still-running]")&&!I.startsWith("[NO-OUTPUT]")&&!I.startsWith("Browser"))try{await t.prepare("DELETE FROM pending_browser_tasks WHERE user_id = ? AND task_id = ? AND notified = 0").bind(r.id,ie[1]).run()}catch{}}}}else I=await $(O.name,O.arguments);let N=I;(O.name==="browser_task"||O.name==="browser_task_status")&&(/^\[BROWSER_TIMEOUT:/.test(N)?N="Task timed out — still running in background.":/^\[NO-OUTPUT\]/.test(N)?N="Browser task finished but returned no content.":/^\[still-running\]/.test(N)?N="Still running — will notify when done.":N=N.replace(/\s*\|\s*Operator hint:.*$/s,"")),yield{type:"tool_end",data:{tool:O.name,toolResult:N.substring(0,500)+(N.length>500?"...":""),threadId:o}};const P=["parse_document","drive_read_file","read_library_file"].includes(O.name)?2e4:8e3,j=I.length>P?I.substring(0,P)+`
[...result truncated to prevent token limit — full content was extracted]`:I;q=Rs(O.name,O.arguments,I,q),D.push(`[Tool Result for ${O.name}]: ${j}`)}catch($){re++,await H(t,r.id,"tool",O.name,$.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:O.name,toolResult:`Error: ${$.message||"Execution failed"}`,threadId:o}},D.push(`[Tool Error for ${O.name}]: ${$.message||"Execution failed"}`)}}A.push({role:"user",content:D.join(`

`)});continue}C=h.content;const v=Ct(C);await i.storeMessage(r.id,e.channel,"assistant",v,te(),o);const _=50;for(let E=0;E<v.length;E+=_)yield{type:"chunk",data:{text:v.substring(E,E+_),threadId:o}},E+_<v.length&&await new Promise(D=>setTimeout(D,10));break}catch(h){if(s){const E=h.message||"",k=E.includes("401")||E.includes("403")||E.includes("authentication")||E.includes("credit balance"),D=E.includes("429"),O=k?1440:D?10:5;await s.recordError(n.name,E,O)}await H(t,r.id,"llm","provider_error",h.message||"Unknown LLM error",{provider:n.name,turn:y});const v=h.message||"An error occurred",_=v.includes("429")||v.toLowerCase().includes("rate limit")||v.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":v;try{await i.storeMessage(r.id,e.channel,"assistant",`⚠️ ${_}`,"{}",o)}catch{}yield{type:"error",data:{error:_,threadId:o}};return}}if(C=(C==null?void 0:C.trim())??"",!C)try{A.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),C=(await n.chat(A,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const h=Ct(C);await i.storeMessage(r.id,e.channel,"assistant",h,te(),o);const v=50;for(let _=0;_<h.length;_+=v)yield{type:"chunk",data:{text:h.substring(_,_+v),threadId:o}},_+v<h.length&&await new Promise(E=>setTimeout(E,10))}catch{C="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(r.id,e.channel,"assistant",C,te(),o).catch(()=>{}),yield{type:"chunk",data:{text:C,threadId:o}}}if(s&&M>0)try{await s.recordUsage(n.name,M)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,n.name,"full",M,Date.now()-l,1,e.channel).run()}catch{}const le=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const y of le){const h=y.claimPattern.test(C),v=y.requiredTools.some(_=>U.includes(_));if(h&&!v){try{await H(t,r.id,"llm",y.logType,"LLM claimed action without tool call (streaming)",{response:C.substring(0,200)}),A.push({role:"assistant",content:C}),A.push({role:"user",content:y.enforcementMsg});const _=await n.chat(A,{tools:S.filter(E=>y.requiredTools.includes(E.name)),temperature:0});if((m=_.toolCalls)!=null&&m.length){for(const k of _.toolCalls){const D=await At(k.name,k.arguments,t,r.id,{agentType:"full",providerName:n.name,channel:e.channel},r.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,r.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});U.push(k.name),A.push({role:"assistant",content:"",toolCalls:_.toolCalls}),A.push({role:"user",content:D})}const E=await n.chat(A,{tools:[]});E.content&&(C=E.content)}else C="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}U.length>=3&&Promise.race([_s(t,n,r,e.text,U,Z,re===0),new Promise(y=>setTimeout(y,6e3))]).catch(()=>{}),L.sessionId&&L.apiKey&&!L.hasActiveTask&&!L.persistSession&&nn(L.sessionId,L.apiKey).catch(()=>{}),yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:M}}}async function _n(e,t,n,r,s,a,i,o){await a.storeMessage(s.id,t.channel,"user",t.text,"{}",o);const l=await At(e.tool,e.args,n,s.id,{agentType:"direct",channel:t.channel},s.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,s.timezone,r,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),c=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await a.storeMessage(s.id,t.channel,"assistant",c,"{}",o),l}async function jn(e,t,n,r,s,a){var b;const i=new Q(t),o=(b=e.metadata)==null?void 0:b.thread_id,l=await i.buildContext(r.id),c=await i.getRecentConversations(r.id,6,o),d=Rn(e.text,l,Ds(c));if(d.agent==="conversation")return $s(e,t,n,r,l,s,o);const u=In(e.text);if(u)return _n(u,e,t,n,r,i,a,o);const p=(await i.getRecentConversations(r.id,10,o)).map(w=>w.content).join(`
`),g=Nn(e.text,p);if(g)return _n(g,e,t,n,r,i,a,o);const f=d.confidence>=.85;if(e.channel==="telegram"){const w=await Pn(t,r.id);return sr(e,t,n,r,s,a,{maxTurns:10,tools:w,forceToolUseOnFirstTurn:f})}return sr(e,t,n,r,s,a,{forceToolUseOnFirstTurn:f})}async function $s(e,t,n,r,s,a,i){const o=new Q(t),l=Date.now(),c=Ns(r.timezone),d=await Bn(t,r.id),u=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${s}`:s,p=ys("conversation",r,u,r.timezone,c,e.channel),g=(await o.getRecentConversations(r.id,30,i)).filter(R=>!R.content.startsWith("[Autonomous Scheduled Task]")&&!R.content.startsWith("[Scheduled Reminder]")),f=Mn(g),b=$n([{role:"system",content:p},...Ln(g),{role:"user",content:e.text}]);Os(b,f),await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);let w=0,T="";try{const R=await n.chat(b,{temperature:.8});R.usage&&(w=R.usage.promptTokens+R.usage.completionTokens),T=R.content}catch(R){if(a){const C=R.message||"",M=C.includes("401")||C.includes("403")||C.includes("authentication")||C.includes("credit balance"),A=C.includes("429"),U=M?1440:A?10:5;await a.recordError(n.name,C,U)}throw await H(t,r.id,"llm","conversation_error",R.message,{provider:n.name}),R}if(a&&w>0)try{await a.recordUsage(n.name,w)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,n.name,"conversation",w,Date.now()-l,1,e.channel).run()}catch{}const S=Ct(T);return await o.storeMessage(r.id,e.channel,"assistant",S,"{}",i),S}async function*ir(e,t,n,r,s,a,i,o){yield{type:"tool_start",data:{tool:e.tool,toolArgs:e.args,threadId:o}};const l=await _n(e,t,n,r,s,a,i,o);yield{type:"tool_end",data:{tool:e.tool,toolResult:l.substring(0,500)+(l.length>500?"...":""),threadId:o}};const c=Ct(l),d=50;for(let u=0;u<c.length;u+=d)yield{type:"chunk",data:{text:c.substring(u,u+d),threadId:o}},u+d<c.length&&await new Promise(p=>setTimeout(p,10));yield{type:"done",data:{threadId:o,provider:r.name,tokenCount:0}}}async function*uo(e,t,n,r,s,a){var u;const i=new Q(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=await i.buildContext(r.id),c=await i.getRecentConversations(r.id,6,o),d=Rn(e.text,l,Ds(c));if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){const p=In(e.text);if(p){yield*ir(p,e,t,n,r,i,a,o);return}const g=(await i.getRecentConversations(r.id,10,o)).map(b=>b.content).join(`
`),f=Nn(e.text,g);if(f){yield*ir(f,e,t,n,r,i,a,o);return}yield*co(e,t,n,r,s,a);return}try{const p=await $s(e,t,n,r,l,s,o),g=50;for(let f=0;f<p.length;f+=g)yield{type:"chunk",data:{text:p.substring(f,f+g),threadId:o}},f+g<p.length&&await new Promise(b=>setTimeout(b,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const ce=new _e;async function mo(e,t){var s;const n=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",n),await t()}ce.use("/*",mo);ce.get("/threads",async e=>{const t=e.get("user"),n=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),s=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const c of a)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=s;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Je(e.env.DB,t.id,t.pin_hash),u=new ReadableStream({async start(p){const g=new TextEncoder;try{const f=uo(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const b of f)b.data.threadId||(b.data.threadId=o),p.enqueue(g.encode(or(b)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),p.close()}catch(f){const b={type:"error",data:{error:f.message||"An error occurred",threadId:o}};p.enqueue(g.encode(or(b))),p.close()}}});return new Response(u,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});ce.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),s=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
`+g,b=await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0) RETURNING id").bind(s.user_id,"reminder",o,g,"cron:"+s.id).first(),w=b==null?void 0:b.id;return d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(s.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:s.id})).run(),s.telegram_chat_id&&await Ps(e.env.DB,s.user_id,s.telegram_chat_id,f,w),e.json({job_id:r,status:"completed",response_length:c.length})});async function Bs(e){var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return null;const n=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(n==null?void 0:n.user_id)||null}Oe.get("/health/tools",async e=>{var n;const t=await Bs(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function ho(e,t,n,r){return n==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:n==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
${c.output.substring(0,500)}${c.output.length>500?"...":""}`):c.status==="finished"?(u="Browser task completed (no output)",p=`${d} finished, but the browser returned no readable content. You may want to retry.`):(u="Browser task ended",p=`${d} ended with status "${c.status}". Check the browser dashboard for details.`),i.thread_id){const g=c.status==="finished"&&c.output?c.output.substring(0,8e3):p,f=Math.ceil(g.length/4);try{await e.env.DB.prepare(`INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id)
               VALUES (?, ?, 'assistant', ?, '{}', ?, ?)`).bind(i.user_id,i.channel||"web",g,f,i.thread_id).run()}catch{}}try{await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, 'info', ?, ?, ?, 0)").bind(i.user_id,u,p,`browser_task:${i.task_id}`).run()}catch{}i.telegram_chat_id&&await Ps(e.env.DB,i.user_id,i.telegram_chat_id,`*${u}*
...
${p}`),await e.env.DB.prepare("UPDATE pending_browser_tasks SET notified = 1 WHERE id = ?").bind(i.id).run(),s++,await new Promise(g=>setTimeout(g,200))}catch{}}}catch{}return e.json({checked:r,notified:s})});Oe.get("/scorecard/weekly",async e=>{var u;const t=(u=e.req.header("Authorization"))==null?void 0:u.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const r=n.user_id,s=new Date(Date.now()-10080*60*1e3).toISOString(),[a,i,o]=await Promise.all([e.env.DB.prepare(`SELECT COUNT(*) as total,
       ...
       FROM conversations
       WHERE user_id = ? AND role = 'assistant' AND created_at >= ? AND (content LIKE '%[S1]%' OR content LIKE '%source%')`).bind(r,s).first()]),l=Number((a==null?void 0:a.total)||0),c=Number((a==null?void 0:a.success_count)||0),d=l?c/l:0;return e.json({window:"7d",task_success_rate:Number(d.toFixed(3)),groundedness_rate_hint:Number((Number((o==null?void 0:o.cited_responses)||0)/Math.max(1,l)).toFixed(3)),avg_latency_ms:Math.round(Number((a==null?void 0:a.avg_latency)||0)),p95_latency_hint_ms:Math.round(Number((a==null?void 0:a.p95_latency_hint)||0)),fallback_frequency_hint:Number((Number((i==null?void 0:i.retry_count)||0)/Math.max(1,l)).toFixed(3)),totals:{total_tool_calls:l,successful_tool_calls:c}})});function go(e,t,n,r){return{userId:e,username:t,channel:"telegram",text:n,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function fo(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const yo=["llm_slot_1","llm_slot_2","llm_slot_3"],vo=["openai","groq"];function cr(e,t){const n=t==null?void 0:t.trim();if(!n)return null;const r=e.trim().toLowerCase();return r==="openai"?{url:"https://api.openai.com/v1/audio/transcriptions",apiKey:n,model:"whisper-1"}:r==="groq"?{url:"https://api.groq.com/openai/v1/audio/transcriptions",apiKey:n,model:"whisper-large-v3"}:null}function wo(e){var t,n;return((t=e.apiKey)==null?void 0:t.trim())||((n=e.api_key)==null?void 0:n.trim())}async function bo(e,t,n){for(const r of yo){const s=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,r).first();if(s)try{const a=await Y(s.encrypted_value,n),i=JSON.parse(a),o=wo(i);if(i.provider&&o){const l=cr(i.provider,o);if(l)return l}}catch(a){console.error(`[telegram stt] Failed to load ${r}:`,a)}}for(const r of vo){const s=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,r).first();if(s)try{const a=await Y(s.encrypted_value,n),i=cr(r,a);if(i)return i}catch(a){console.error(`[telegram stt] Failed to load legacy ${r}:`,a)}}return null}const js=["message","callback_query"],_o=4e3,Eo=1e4,To=3e4;async function Re(e,t={}){const n=new AbortController,r=setTimeout(()=>n.abort(),Eo);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(r)}}async function dr(e){const t=new AbortController,n=setTimeout(()=>t.abort(),To);try{return await fetch(e,{signal:t.signal})}finally{clearTimeout(n)}}async function se(e,t,n,r="Markdown",s,a){var c,d;const i=xo(n,_o),o=[];let l=!0;for(let u=0;u<i.length;u++){const p=i[u];let g=!1,f="";for(let b=0;b<3;b++)try{const w=await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p,parse_mode:r,disable_web_page_preview:!1})});if(w.ok){g=!0;break}const T=await w.json().catch(()=>null);if(f=`HTTP ${w.status}: ${(T==null?void 0:T.description)||"Unknown error"}`,(c=T==null?void 0:T.description)!=null&&c.includes("parse")||(d=T==null?void 0:T.description)!=null&&d.includes("entities")){if((await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p})})).ok){g=!0;break}f+=" (plain-text retry also failed)"}if(w.status===429||w.status>=500){const S=Math.pow(2,b)*1e3;await new Promise(R=>setTimeout(R,S));continue}break}catch(w){if(f=`Network error: ${w.message}`,b<2){const T=Math.pow(2,b)*1e3;await new Promise(S=>setTimeout(S,T));continue}}g||(l=!1,o.push(`Chunk ${u+1}/${i.length}: ${f}`))}if(!l&&s&&a&&o.length>0)try{const{logError:u}=await Promise.resolve().then(()=>gt);await u(s,a,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function So(e,t){try{await Re(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function xo(e,t){if(e.length<=t)return[e];const n=[];let r=e;for(;r.length>0;){if(r.length<=t){n.push(r);break}let s=r.lastIndexOf(`
`,t);s<t*.3&&(s=r.lastIndexOf(" ",t)),s<t*.3&&(s=t),n.push(r.substring(0,s)),r=r.substring(s).trimStart()}return n}function ko(e){const t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const r=Math.floor(n/60);return r<24?`${r}h ago`:`${Math.floor(r/24)}d ago`}async function Do(e,t,n){const s={reminder:"⏰",mail:"✉️",calendar:"📅",error:"⚠️",system:"⚙️"}[n.type]||"🔔",a={daily:"📅 Daily",weekly:"📅 Weekly",once:"✓ Once"},i=n.schedule_type?` · _${a[n.schedule_type]||"⏱ Repeating"}_`:"",o=n.body?`
`+n.body.substring(0,150)+(n.body.length>150?"…":""):"",l=`${s} *${n.title}*${i}
_${ko(n.created_at)}_${o}`,c=Us(n.id);if(!(await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l,parse_mode:"Markdown",reply_markup:{inline_keyboard:c}})})).ok){const u=await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l.replace(/[_*`[\]]/g,""),reply_markup:{inline_keyboard:c}})});u.ok||console.warn("[sendNotifMessage] plain-text fallback also failed:",t,u.status)}}async function Ro(e,t,n,r,s){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(r==null?void 0:r.name)||"there",o=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`),c=await se(n,t,l,"Markdown",s,r==null?void 0:r.id);return!c.success&&c.errors.length>0&&console.warn(`[/start] Failed to send message: ${c.errors.join(" | ")}`),!0}case"/help":{const o=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
`),"Markdown",s,r.id);g.success||console.warn(`[/tasks] Failed to send message: ${g.errors.join(" | ")}`)}catch(i){const o=await se(n,t,"❌ Could not fetch tasks: "+i.message,"Markdown",s,r==null?void 0:r.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/notifications":case"/notif":{if(!r){const i=await se(n,t,"⚠️ Account not linked.","Markdown",s);return i.success||console.warn(`[/notifications] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await s.prepare(`
          ...
          LIMIT 5
        `).bind(r.id).all()).results||[];if(o.length===0){const c=await se(n,t,"🎉 No pending notifications. You're all caught up.","Markdown",s,r.id);return c.success||console.warn(`[/notifications] Failed to send message: ${c.errors.join(" | ")}`),!0}const l=await se(n,t,`📬 *${o.length} pending notification${o.length>1?"s":""}:*`,"Markdown",s,r.id);l.success||console.warn(`[/notifications] Failed to send header: ${l.errors.join(" | ")}`);for(const c of o)await Do(n,t,c)}catch(i){const o=await se(n,t,"❌ Could not fetch notifications: "+i.message,"Markdown",s,r==null?void 0:r.id);o.success||console.warn(`[/notifications error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}async function Oo(e,t){var s,a,i,o,l,c;const n=t.db,r=t.env;console.log(`[telegram webhook] envVars keys=${Object.keys(r).join(",")}`);try{if(e.callback_query){await Ao(n,e.callback_query);return}const d=e.message;if(!d)return;const u=!!d.text,p=!!d.voice,g=!!d.document,f=!!d.photo,b=!!d.caption;if(!u&&!p&&!g&&!f)return;const w=String(d.chat.id);let T=d.text||"";const S=await n.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(w).first();let R=null;if(S){const L=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(S.id,"telegram_bot_token").first();L&&(R=await Y(L.encrypted_value,S.pin_hash))}if(!R){const L=await n.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();L&&(R=await Y(L.encrypted_value,L.pin_hash))}if(!R||T.startsWith("/")&&await Ro(T,w,R,S,n))return;if(!S){const L=await se(R,w,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${w}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",n);L.success||console.warn(`Failed to send unlinked account message: ${L.errors.join(" | ")}`);return}if(d.voice&&R&&S)try{if((d.voice.file_size??0)>20*1024*1024){const W=await se(R,w,"⚠️ Voice note is too large to process (max 20 MB).","Markdown",n,S.id);W.success||console.warn(`[voice size] Failed to send message: ${W.errors.join(" | ")}`);return}const L=await se(R,w,"🎤 Processing voice note...","Markdown",n,S.id);L.success||console.warn(`[voice start] Failed to send message: ${L.errors.join(" | ")}`);const J=await(await Re(`https://api.telegram.org/bot${R}/getFile?file_id=${d.voice.file_id}`)).json();if(J.ok&&((s=J.result)!=null&&s.file_path)){const te=await(await dr(`https://api.telegram.org/file/bot${R}/${J.result.file_path}`)).blob(),le=await bo(n,S.id,S.pin_hash);if(!le){const h=await se(R,w,"⚠️ To use voice notes, add an OpenAI or Groq API key in Settings → Keys (LLM slot or legacy openai/groq).","Markdown",n,S.id);h.success||console.warn(`[voice no stt] Failed to send message: ${h.errors.join(" | ")}`);return}const ne=new FormData;ne.append("file",te,"voice.ogg"),ne.append("model",le.model),ne.append("language","en");const me=await fetch(le.url,{method:"POST",headers:{Authorization:`Bearer ${le.apiKey}`},body:ne});if(!me.ok){const h=await me.text(),v=await se(R,w,`⚠️ Transcription failed: ${me.status} ${h}`,"Markdown",n,S.id);v.success||console.warn(`[voice transcription error] Failed to send message: ${v.errors.join(" | ")}`);return}T=(await me.json()).text;const y=await se(R,w,`🗣️ *You said:* ${T}`,"Markdown",n,S.id);y.success||console.warn(`[voice transcript echo] Failed to send message: ${y.errors.join(" | ")}`)}}catch(L){const z=await se(R,w,`⚠️ Failed to process voice note: ${L.message}`,"Markdown",n,S==null?void 0:S.id);z.success||console.warn(`[voice processing error] Failed to send message: ${z.errors.join(" | ")}`);return}if((g||f)&&R&&S)try{let L,z="unknown",J="unknown",W=0;if(g)L=d.document.file_id,z=d.document.file_name||"document",J=d.document.mime_type||"unknown",W=d.document.file_size||0;else if(f){const te=d.photo[d.photo.length-1];L=te.file_id,z="photo.jpg",J="image/jpeg",W=te.file_size||0}if(L){const le=await(await Re(`https://api.telegram.org/bot${R}/getFile?file_id=${L}`)).json();let ne="";if(le.ok&&((a=le.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(z)||/^text\/|application\/json|application\/xml|application\/csv/i.test(J))&&W<5e4)try{ne=await(await dr(`https://api.telegram.org/file/bot${R}/${le.result.file_path}`)).text()}catch{}const me=d.caption||"",m=`[Telegram file received: "${z}" (${J}, ${Math.round(W/1024)}KB)]`;ne?T=`${me?me+`
...
`:""}${m}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(L){if(b&&d.caption)T=d.caption;else{const z=await se(R,w,`⚠️ Received your file but couldn't process it: ${L.message}`,"Markdown",n,S==null?void 0:S.id);z.success||console.warn(`[file processing error] Failed to send message: ${z.errors.join(" | ")}`);return}}if(!T)return;So(R,w).catch(()=>{});let C=await n.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(S.id).first();if(C)await n.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(C.id).run();else{const L=await n.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(S.id).run();if(!((i=L.meta)!=null&&i.last_row_id))throw new Error("Thread creation failed — no row ID returned");C={id:L.meta.last_row_id}}const M=go(S.id,S.username,T,w);M.metadata={thread_id:C.id},console.log(`[telegram webhook] user=${S.id} msgLen=${T.length} thread=${C.id}`);let A,U;try{const L=await Je(n,S.id,S.pin_hash);A=L.provider,U=L.rotation}catch(L){console.error("Telegram provider setup error:",L);const z=(o=L.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=L.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${L.message||"Unknown error"}`,J=await se(R,w,z,"Markdown",n,S.id);J.success||console.warn(`[provider error] Failed to send message: ${J.errors.join(" | ")}`);return}const{classifyIntentFast:q}=await Promise.resolve().then(()=>Li);if(q(T).agent==="multi"){const L=await se(R,w,"🔍 On it…","Markdown",n,S.id);L.success||console.warn(`[ack] Failed to send: ${L.errors.join(" | ")}`)}const Z=6e5;let re=!1;try{const L=await Promise.race([jn(M,n,A,S,U,r),new Promise((W,te)=>setTimeout(()=>te(new Error("TELEGRAM_TIMEOUT")),Z))]),z=fo(L,"telegram"),J=await se(R,w,z||"(empty response)","Markdown",n,S.id);if(await n.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(C.id).run().catch(()=>{}),re=J.success,!J.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${S.id}:`,J.errors);try{const{logError:W}=await Promise.resolve().then(()=>gt);await W(n,S.id,"telegram","response_send_failed",`Failed to deliver response: ${J.errors.join(" | ")}`)}catch{}}}catch(L){console.error("Telegram agent error:",L);const z=L.message==="TELEGRAM_TIMEOUT",J=z?`⏱️ This is taking too long to complete via Telegram.

If you requested a browser task, the result will arrive as a notification when ready. For other long tasks, try the web app.`:(c=L.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${A.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(L.message||"Unknown").substring(0,200)}`,W=await se(R,w,J,"Markdown",n,S.id);re=W.success,W.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${S.id}:`,W.errors);try{const{logError:te}=await Promise.resolve().then(()=>gt);await te(n,S.id,"telegram",z?"timeout":"agent_error",L.message||"Agent error",{provider:A.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:u}=await Promise.resolve().then(()=>gt);await u(n,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}}function ur(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}function Io(e){const t=new Date(new Date().toLocaleString("en-US",{timeZone:e})),n=new Date(t);n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const r=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),s=new Date(n.toLocaleString("en-US",{timeZone:e}));return new Date(n.getTime()+(r.getTime()-s.getTime())).toISOString()}const Us=e=>[[{text:"✅ Seen",callback_data:`notif_seen:${e}`},{text:"⏰ Snooze",callback_data:`notif_snooze_menu:${e}`},{text:"✓ Done",callback_data:`notif_done:${e}`}]],No=e=>[[{text:"10 minutes",callback_data:`notif_snooze:${e}:10m`},{text:"1 hour",callback_data:`notif_snooze:${e}:1h`}],[{text:"Tomorrow 9 AM",callback_data:`notif_snooze:${e}:tomorrow`},{text:"← Back",callback_data:`notif_back:${e}`}]];async function ct(e,t,n){const r=await Re(`https://api.telegram.org/bot${e}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:t,text:n})});r.ok||console.warn("[answerCallback]",t,r.status)}async function dt(e,t,n,r){const s=await Re(`https://api.telegram.org/bot${e}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,message_id:n,reply_markup:r?{inline_keyboard:r}:{}})});s.ok||console.warn("[editKeyboard]",t,n,s.status)}async function Co(e,t,n,r,s,a,i,o,l,c){const d=await e.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).first();if(!d){await ct(t,n,"Notification not found — may have already been actioned."),await dt(t,r,s,null);return}if(i==="notif_seen")await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ct(t,n,"✅ Dismissed"),await dt(t,r,s,null);else if(i==="notif_snooze_menu")await ct(t,n),await dt(t,r,s,No(o));else if(i==="notif_back")await ct(t,n),await dt(t,r,s,Us(o));else if(i==="notif_snooze"){const u=ur(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run();let p,g;l==="10m"?(p=new Date(Date.now()+600*1e3).toISOString(),g="10 minutes"):l==="1h"?(p=new Date(Date.now()+3600*1e3).toISOString(),g="1 hour"):(p=Io(c||"UTC"),g="tomorrow 9 AM"),await e.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
       VALUES (?, ?, ?, 'once', ?, 'reminder', ?, ?, 1, 'active')`).bind(a,d.title,d.body,p,JSON.stringify({description:d.body||""}),p).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ct(t,n,`⏰ Snoozed until ${g}`),await dt(t,r,s,null)}else if(i==="notif_done"){const u=ur(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ct(t,n,"✓ Done!"),await dt(t,r,s,null)}}async function Ao(e,t){var w;const{id:n,data:r,message:s,from:a}=t;if(!r||!s)return;const i=r.split(":"),o=i[0],l=String(s.chat.id);if(o.startsWith("notif_")){const T=parseInt(i[1]);if(!T)return;const S=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!S)return;const R=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
       JOIN users u ON c.user_id = u.id
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(S.id).first();if(!R)return;const C=await Y(R.encrypted_value,R.pin_hash),M=i[2];await Co(e,C,n,l,s.message_id,S.id,o,T,M,S.timezone);return}if(i[0]!=="briefing_toggle"||i.length<3)return;const c=i[1],d=parseInt(i[2]);if(!d||!c)return;const u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const p=await e.prepare(`
  ...
  `).bind(g,g,p.id).run();const f=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!f)return;const b=await Y(f.encrypted_value,f.pin_hash);try{const T=await Re(`https://api.telegram.org/bot${b}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:n,text:g?"✅ Checked!":"☐ Unchecked"})});T.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${T.status}`)}catch(T){console.warn(`[callback answer] Error answering callback: ${T.message}`)}if((w=s.reply_markup)!=null&&w.inline_keyboard){const T=s.reply_markup.inline_keyboard.map(S=>S.map(R=>{var C;if((C=R.callback_data)!=null&&C.includes(c)){const M=g?"✅":"☐",A=R.text.replace(/^[☐✅]\s*/,"");return{...R,text:`${M} ${A}`}}return R}));try{await Re(`https://api.telegram.org/bot${b}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:s.message_id,reply_markup:{inline_keyboard:T}})})}catch{}}}const Ht=new _e;function Lo(e){return{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE}}Ht.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const r={db:e.env.DB,env:Lo(e)};return e.executionCtx.waitUntil(Oo(t,r)),e.json({ok:!0})});Ht.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Telegram bot token not configured in Settings"},400);const a=await Y(s.encrypted_value,n.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${a}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${a}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:[...js],drop_pending_updates:!1})})).json();return e.json(o)});Ht.get("/webhook-status",async e=>{var a,i,o,l,c,d;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const s=await Y(r.encrypted_value,n.pin_hash);try{const p=await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=p.result)==null?void 0:i.url)||"",has_webhook:!!((o=p.result)!=null&&o.url),pending_updates:((l=p.result)==null?void 0:l.pending_update_count)||0,last_error:((c=p.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=p.result)==null?void 0:d.last_error_date)||null})}catch(u){return e.json({configured:!0,error:u.message})}});Ht.post("/detect-chat-id",async e=>{var a,i;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const s=await Y(r.encrypted_value,n.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const u=await(await fetch(`https://api.telegram.org/bot${s}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:[...js]})});const p=u.result||[];if(p.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const g=[],f=new Set;for(let w=p.length-1;w>=0;w--){const T=p[w].message;if(T&&T.chat){const S=String(T.chat.id);f.has(S)||(f.add(S),g.push({chat_id:S,name:[T.chat.first_name,T.chat.last_name].filter(Boolean).join(" ")||T.chat.title||"Unknown",username:T.chat.username||"",date:new Date((T.date||0)*1e3).toISOString()}))}}if(g.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const b=g[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(b,n.user_id).run(),e.json({found:!0,chat_id:b,name:g[0].name,all_chats:g,message:`Chat ID ${b} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});function Mo(e){const t=new Date,n=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(n);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const s=new Date(r);s.setHours(23,59,59,999);const a=r.toISOString().split("T")[0];return{start:r.toISOString(),end:s.toISOString(),dateStr:a}}function rn(e,t=new Date){return new Intl.DateTimeFormat("en-CA",{timeZone:e||"Asia/Kolkata",year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}async function $o(e,t,n,r,s,a){try{return(await new kn(e,t,n,r,s).listEvents("primary",{timeMin:a.start,timeMax:a.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Po(e,t,n,r,s){try{const a=new De(e,t,n,r,s),i=await a.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await a.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const u of i){const p=u.from.split("<")[0].trim()||u.from;l[p]=(l[p]||0)+1}const c=Object.entries(l).sort(([,u],[,p])=>p-u).slice(0,5).map(([u])=>u),d=i.some(u=>u.subject.toLowerCase().includes("urgent")||u.subject.toLowerCase().includes("asap")||u.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(a){return console.error("Gmail fetch error:",a.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Bo(e,t){try{const n=await e.prepare(`
...
`)}function Fo(e){const t=[];let n=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:n++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:n++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:n++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:n++});return t}async function Go(e,t){const n=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!n)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const a=JSON.parse(n.components);r={google_calendar:a.google_calendar!==!1,gmail:a.gmail!==!1,tasks:a.tasks!==!1,news:a.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const s=n.news_topics?n.news_topics.split(",").map(a=>a.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:s}}async function Hs(e,t,n){var R,C;const r=t.timezone||"Asia/Kolkata",s=Mo(r),{components:a,newsTopics:i}=await Go(e,t.id),o=[],l=[];a.google_calendar&&(o.push($o(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET,s)),l.push("googleEvents")),a.gmail&&(o.push(Po(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),a.tasks&&(o.push(Bo(e,t.id)),l.push("tasks")),a.news&&(o.push(Uo(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((M,A)=>{d[M]=c[A]});const u={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},p={pending:0,dueToday:0,items:[]},g={generatedAt:new Date().toISOString(),targetDate:s.dateStr,calendar:{google:d.googleEvents||[],totalCount:((R=d.googleEvents)==null?void 0:R.length)||0},emails:{gmail:d.gmailSummary||u},tasks:d.tasks||p,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((C=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:C.briefing_time)||"20:00";g.summary=Ho(g,f);const b=Fo(g),w=rn(r),T=await e.prepare(`
  ...
  `).bind(t.id,JSON.stringify(g),w).first(),S=(T==null?void 0:T.id)||0;for(const M of b)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(S,M.type,M.key,M.text,JSON.stringify(M.metadata),M.sortOrder).run();return{briefingId:S,content:g,items:b}}async function Wo(e,t,n){const r=await e.prepare(`
  ...
  `).bind(n).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:s.results||[]}}async function qo(e,t,n,r){if(!await e.prepare(`
  ...
  `).bind(i,i,r,n).run(),{checked:i===1}}async function zo(e,t,n=10){return((await e.prepare(`
    SELECT b.*, 
...
🕐 ${R}${C}`;await Lt(`https://api.telegram.org/bot${T}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:M,parse_mode:"Markdown"})})}s.push({user_id:l.id,reminders_sent:b.length})}catch(c){s.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:s.length,results:s})}catch(r){return e.json({error:r.message},500)}});he.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),s=[],a=new Date;for(const i of r.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(!Fs(l,o,a))continue;const c=rn(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'morning' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await zs(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let p={telegram:!0,web:!0};try{p=JSON.parse(i.notification_channels||"{}")}catch{}if(p.telegram!==!1&&i.telegram_chat_id&&u.briefingId){const g=Zo(u.content);await qs(e.env.DB,i,g),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run()}s.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){s.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:s.length,results:s})}catch(r){return e.json({error:r.message},500)}});he.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),s=[];for(const a of r.results||[]){let i={};try{i=JSON.parse(a.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Ks(e.env.DB,a,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{skipBrowserUse:!0}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,c=JSON.stringify(o,null,2),d=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
    ...
    `).all(),s=[],a=new Date;for(const i of r.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(Jo(l,o,a))try{const c=await Vo(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),d=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,u=JSON.stringify(c,null,2),p=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,d,u,`weekly_review_${Date.now()}`,null,null,null).first();let g={telegram:!0,web:!0};try{g=JSON.parse(i.notification_channels||"{}")}catch{}if(g.telegram!==!1&&i.telegram_chat_id){const f=Xo(c);await qs(e.env.DB,i,f)}s.push({user_id:i.id,status:"success",action_item_id:p==null?void 0:p.id})}catch(c){s.push({user_id:i.id,status:"error",error:c.message})}}return e.json({executed:s.length,results:s})}catch(r){return e.json({error:r.message},500)}});async function Ws(e,t,n,r,s){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!a)return;const i=await Y(a.encrypted_value,a.pin_hash);if(!(i!=null&&i.trim())){Ts("sendTelegramWithKeyboard: empty bot token",{userId:t.id});return}if(!(await(await Lt(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(c=>c.map(d=>({...d,callback_data:`${d.callback_data}:${s}`})))}})})).json()).ok){const d=await(await Lt(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:r.map(u=>u.map(p=>({...p,callback_data:`${p.callback_data}:${s}`})))}})})).json();if(!d.ok){wn("Telegram briefing send failed",{description:d.description,chatId:t.telegram_chat_id});return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(s).run()}catch(a){wn("Telegram briefing error",{error:(a==null?void 0:a.message)||String(a)})}}async function qs(e,t,n){try{const r=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!r)return;const s=await Y(r.encrypted_value,r.pin_hash);if(!(s!=null&&s.trim())){Ts("sendTelegramPlainText: empty bot token",{userId:t.id});return}(await Lt(`https://api.telegram.org/bot${s}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3),parse_mode:"Markdown"})})).ok||await Lt(`https://api.telegram.org/bot${s}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3).replace(/[_*[`\]]/g,"")})})}catch(r){wn("Telegram plain text error",{error:(r==null?void 0:r.message)||String(r)})}}async function zs(e,t,n){const r=new Date;r.setHours(0,0,0,0);const s=new Date;s.setHours(23,59,59,999);const a=await e.prepare(`
