var nr=Object.defineProperty;var Pt=e=>{throw TypeError(e)};var sr=(e,t,a)=>t in e?nr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var S=(e,t,a)=>sr(e,typeof t!="symbol"?t+"":t,a),wt=(e,t,a)=>t.has(e)||Pt("Cannot "+a);var b=(e,t,a)=>(wt(e,t,"read from private field"),a?a.call(e):t.get(e)),N=(e,t,a)=>t.has(e)?Pt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),C=(e,t,a,r)=>(wt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),M=(e,t,a)=>(wt(e,t,"access private method"),a);var Ut=(e,t,a,r)=>({set _(n){C(e,t,n,a)},get _(){return b(e,t,r)}});var Ht=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let c,l=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{c=await u(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,c=await t(m,r),l=!0;else throw m}else r.finalized===!1&&a&&(c=await a(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},or=Symbol(),ir=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof pa?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?lr(e,{all:a,dot:r}):{}};async function lr(e,t){const a=await e.formData();return a?cr(a,t):{}}function cr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?dr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(ur(a,r,n),delete a[r])}),a}var dr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ur=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},ia=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},pr=e=>{const{groups:t,path:a}=mr(e),r=ia(a);return hr(r,t)},mr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},hr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},nt={},gr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return nt[r]||(a[2]?nt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:nt[r]=[e,a[1],!0]),nt[r]}return null},Nt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},fr=e=>Nt(e,decodeURI),la=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),c=t.slice(a,i);return fr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return t.slice(a,r)},yr=e=>{const t=la(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Re=(e,t,...a)=>(a.length&&(t=Re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ca=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},_t=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Nt(e,ua):e):e,da=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const c=o+t.length+2,l=e.indexOf("&",c);return _t(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let c=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(c=_t(c)),s=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),r&&(l=_t(l))),a?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(l)):n[c]??(n[c]=l)}return t?n[t]:n},vr=da,br=(e,t)=>da(e,t,!0),ua=decodeURIComponent,Gt=e=>Nt(e,ua),$e,V,ue,ma,ha,It,me,ta,pa=(ta=class{constructor(e,t="/",a=[[]]){N(this,ue);S(this,"raw");N(this,$e);N(this,V);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});N(this,me,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,C(this,V,a),C(this,$e,{})}param(e){return e?M(this,ue,ma).call(this,e):M(this,ue,ha).call(this)}query(e){return vr(this.url,e)}queries(e){return br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ir(this,e))}json(){return b(this,me).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,me).call(this,"text")}arrayBuffer(){return b(this,me).call(this,"arrayBuffer")}blob(){return b(this,me).call(this,"blob")}formData(){return b(this,me).call(this,"formData")}addValidatedData(e,t){b(this,$e)[e]=t}valid(e){return b(this,$e)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[or](){return b(this,V)}get matchedRoutes(){return b(this,V)[0].map(([[,e]])=>e)}get routePath(){return b(this,V)[0].map(([[,e]])=>e)[this.routeIndex].path}},$e=new WeakMap,V=new WeakMap,ue=new WeakSet,ma=function(e){const t=b(this,V)[0][this.routeIndex][1][e],a=M(this,ue,It).call(this,t);return a&&/\%/.test(a)?Gt(a):a},ha=function(){const e={},t=Object.keys(b(this,V)[0][this.routeIndex][1]);for(const a of t){const r=M(this,ue,It).call(this,b(this,V)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Gt(r):r)}return e},It=function(e){return b(this,V)[1]?b(this,V)[1][e]:e},me=new WeakMap,ta),wr={Stringify:1},ga=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(c=>ga(c,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},_r="text/plain; charset=UTF-8",xt=(e,t)=>({"Content-Type":e,...t}),Ve,Xe,ie,Me,le,K,Ze,Be,je,Ee,Qe,et,he,Ae,aa,xr=(aa=class{constructor(e,t){N(this,he);N(this,Ve);N(this,Xe);S(this,"env",{});N(this,ie);S(this,"finalized",!1);S(this,"error");N(this,Me);N(this,le);N(this,K);N(this,Ze);N(this,Be);N(this,je);N(this,Ee);N(this,Qe);N(this,et);S(this,"render",(...e)=>(b(this,Be)??C(this,Be,t=>this.html(t)),b(this,Be).call(this,...e)));S(this,"setLayout",e=>C(this,Ze,e));S(this,"getLayout",()=>b(this,Ze));S(this,"setRenderer",e=>{C(this,Be,e)});S(this,"header",(e,t,a)=>{this.finalized&&C(this,K,new Response(b(this,K).body,b(this,K)));const r=b(this,K)?b(this,K).headers:b(this,Ee)??C(this,Ee,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});S(this,"status",e=>{C(this,Me,e)});S(this,"set",(e,t)=>{b(this,ie)??C(this,ie,new Map),b(this,ie).set(e,t)});S(this,"get",e=>b(this,ie)?b(this,ie).get(e):void 0);S(this,"newResponse",(...e)=>M(this,he,Ae).call(this,...e));S(this,"body",(e,t,a)=>M(this,he,Ae).call(this,e,t,a));S(this,"text",(e,t,a)=>!b(this,Ee)&&!b(this,Me)&&!t&&!a&&!this.finalized?new Response(e):M(this,he,Ae).call(this,e,t,xt(_r,a)));S(this,"json",(e,t,a)=>M(this,he,Ae).call(this,JSON.stringify(e),t,xt("application/json",a)));S(this,"html",(e,t,a)=>{const r=n=>M(this,he,Ae).call(this,n,t,xt("text/html; charset=UTF-8",a));return typeof e=="object"?ga(e,wr.Stringify,!1,{}).then(r):r(e)});S(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});S(this,"notFound",()=>(b(this,je)??C(this,je,()=>new Response),b(this,je).call(this,this)));C(this,Ve,e),t&&(C(this,le,t.executionCtx),this.env=t.env,C(this,je,t.notFoundHandler),C(this,et,t.path),C(this,Qe,t.matchResult))}get req(){return b(this,Xe)??C(this,Xe,new pa(b(this,Ve),b(this,et),b(this,Qe))),b(this,Xe)}get event(){if(b(this,le)&&"respondWith"in b(this,le))return b(this,le);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,le))return b(this,le);throw Error("This context has no ExecutionContext")}get res(){return b(this,K)||C(this,K,new Response(null,{headers:b(this,Ee)??C(this,Ee,new Headers)}))}set res(e){if(b(this,K)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,K).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,K).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}C(this,K,e),this.finalized=!0}get var(){return b(this,ie)?Object.fromEntries(b(this,ie)):{}}},Ve=new WeakMap,Xe=new WeakMap,ie=new WeakMap,Me=new WeakMap,le=new WeakMap,K=new WeakMap,Ze=new WeakMap,Be=new WeakMap,je=new WeakMap,Ee=new WeakMap,Qe=new WeakMap,et=new WeakMap,he=new WeakSet,Ae=function(e,t,a){const r=b(this,K)?new Headers(b(this,K).headers):b(this,Ee)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Me);return new Response(e,{status:n,headers:r})},aa),z="ALL",Er="all",Tr=["get","post","put","delete","options","patch"],fa="Can not add a route since the matcher is already built.",ya=class extends Error{},kr="__COMPOSED_HANDLER",Sr=e=>e.text("404 Not Found",404),zt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,F,va,ee,_e,it,lt,Pe,Ir=(Pe=class{constructor(t={}){N(this,F);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");N(this,Q,"/");S(this,"routes",[]);N(this,ee,Sr);S(this,"errorHandler",zt);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(C(this,ee,t),this));S(this,"fetch",(t,...a)=>M(this,F,lt).call(this,t,a[1],a[0],t.method));S(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Re("/",t)}`,a),r,n)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(M(this,F,lt).call(this,t.request,t,void 0,t.request.method))})});[...Tr,Er].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?C(this,Q,o):M(this,F,_e).call(this,s,b(this,Q),o),i.forEach(c=>{M(this,F,_e).call(this,s,b(this,Q),c)}),this)}),this.on=(s,o,...i)=>{for(const c of[o].flat()){C(this,Q,c);for(const l of[s].flat())i.map(u=>{M(this,F,_e).call(this,l.toUpperCase(),b(this,Q),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?C(this,Q,s):(C(this,Q,"*"),o.unshift(s)),o.forEach(i=>{M(this,F,_e).call(this,z,b(this,Q),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??la:yr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===zt?s=n.handler:(s=async(i,c)=>(await Ht([],a.errorHandler)(i,()=>n.handler(i,c))).res,s[kr]=n.handler),M(o=r,F,_e).call(o,n.method,n.path,s)}),this}basePath(t){const a=M(this,F,va).call(this);return a._basePath=Re(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=c=>c:n=r.replaceRequest));const o=s?c=>{const l=s(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};n||(n=(()=>{const c=Re(this._basePath,t),l=c==="/"?0:c.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(l)||"/",new Request(m,u)}})());const i=async(c,l)=>{const u=await a(n(c.req.raw),...o(c));if(u)return u;await l()};return M(this,F,_e).call(this,z,Re(t,"*"),i),this}},Q=new WeakMap,F=new WeakSet,va=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,C(t,ee,b(this,ee)),t.routes=this.routes,t},ee=new WeakMap,_e=function(t,a,r){t=t.toUpperCase(),a=Re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},it=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},lt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await M(this,F,lt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new xr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,ee)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await b(this,ee).call(this,i)})}catch(u){return M(this,F,it).call(this,u,i)}return l instanceof Promise?l.then(u=>u||(i.finalized?i.res:b(this,ee).call(this,i))).catch(u=>M(this,F,it).call(this,u,i)):l??b(this,ee).call(this,i)}const c=Ht(o[0],this.errorHandler,b(this,ee));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return M(this,F,it).call(this,l,i)}})()},Pe),ba=[];function Or(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[z],i=o[2][s];if(i)return i;const c=s.match(o[0]);if(!c)return[[],ba];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=r,r(e,t)}var dt="[^/]+",Ke=".*",Ye="(?:|/.*)",Ne=Symbol(),Dr=new Set(".\\+*[^]$()");function Cr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ke||e===Ye?1:t===Ke||t===Ye?-1:e===dt?1:t===dt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Te,ke,te,Oe,Rr=(Oe=class{constructor(){N(this,Te);N(this,ke);N(this,te,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Te)!==void 0)throw Ne;if(s)return;C(this,Te,a);return}const[o,...i]=t,c=o==="*"?i.length===0?["","",Ke]:["","",dt]:o==="/*"?["","",Ye]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let m=c[2]||dt;if(u&&c[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Ne;if(l=b(this,te)[m],!l){if(Object.keys(b(this,te)).some(g=>g!==Ke&&g!==Ye))throw Ne;if(s)return;l=b(this,te)[m]=new Oe,u!==""&&C(l,ke,n.varIndex++)}!s&&u!==""&&r.push([u,b(l,ke)])}else if(l=b(this,te)[o],!l){if(Object.keys(b(this,te)).some(u=>u.length>1&&u!==Ke&&u!==Ye))throw Ne;if(s)return;l=b(this,te)[o]=new Oe}l.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,te)).sort(Cr).map(r=>{const n=b(this,te)[r];return(typeof b(n,ke)=="number"?`(${r})@${b(n,ke)}`:Dr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Te)=="number"&&a.unshift(`#${b(this,Te)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Te=new WeakMap,ke=new WeakMap,te=new WeakMap,Oe),pt,tt,ra,Ar=(ra=class{constructor(){N(this,pt,{varIndex:0});N(this,tt,new Rr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return n[o]=[l,c],o++,i=!0,l}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let c=s.length-1;c>=0;c--)if(s[c].indexOf(i)!==-1){s[c]=s[c].replace(i,n[o][1]);break}}return b(this,tt).insert(s,t,r,b(this,pt),a),r}buildRegExp(){let e=b(this,tt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},pt=new WeakMap,tt=new WeakMap,ra),Nr=[/^$/,[],Object.create(null)],ct=Object.create(null);function wa(e){return ct[e]??(ct[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Lr(){ct=Object.create(null)}function $r(e){var l;const t=new Ar,a=[];if(e.length===0)return Nr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[g,v])=>u?1:g?-1:m.length-v.length),n=Object.create(null);for(let u=0,m=-1,g=r.length;u<g;u++){const[v,f,x]=r[u];v?n[f]=[x.map(([E])=>[E,Object.create(null)]),ba]:m++;let w;try{w=t.insert(f,m,v)}catch(E){throw E===Ne?new ya(f):E}v||(a[m]=x.map(([E,d])=>{const y=Object.create(null);for(d-=1;d>=0;d--){const[p,h]=w[d];y[p]=h}return[E,y]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=a.length;u<m;u++)for(let g=0,v=a[u].length;g<v;g++){const f=(l=a[u][g])==null?void 0:l[1];if(!f)continue;const x=Object.keys(f);for(let w=0,E=x.length;w<E;w++)f[x[w]]=i[f[x[w]]]}const c=[];for(const u in o)c[u]=a[o[u]];return[s,c,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(wa(a).test(t))return[...e[a]]}}var ge,fe,mt,_a,na,Mr=(na=class{constructor(){N(this,mt);S(this,"name","RegExpRouter");N(this,ge);N(this,fe);S(this,"match",Or);C(this,ge,{[z]:Object.create(null)}),C(this,fe,{[z]:Object.create(null)})}add(e,t,a){var i;const r=b(this,ge),n=b(this,fe);if(!r||!n)throw new Error(fa);r[e]||[r,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[z]).forEach(l=>{c[e][l]=[...c[z][l]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=wa(t);e===z?Object.keys(r).forEach(l=>{var u;(u=r[l])[t]||(u[t]=De(r[l],t)||De(r[z],t)||[])}):(i=r[e])[t]||(i[t]=De(r[e],t)||De(r[z],t)||[]),Object.keys(r).forEach(l=>{(e===z||e===l)&&Object.keys(r[l]).forEach(u=>{c.test(u)&&r[l][u].push([a,s])})}),Object.keys(n).forEach(l=>{(e===z||e===l)&&Object.keys(n[l]).forEach(u=>c.test(u)&&n[l][u].push([a,s]))});return}const o=ca(t)||[t];for(let c=0,l=o.length;c<l;c++){const u=o[c];Object.keys(n).forEach(m=>{var g;(e===z||e===m)&&((g=n[m])[u]||(g[u]=[...De(r[m],u)||De(r[z],u)||[]]),n[m][u].push([a,s-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,fe)).concat(Object.keys(b(this,ge))).forEach(t=>{e[t]||(e[t]=M(this,mt,_a).call(this,t))}),C(this,ge,C(this,fe,void 0)),Lr(),e}},ge=new WeakMap,fe=new WeakMap,mt=new WeakSet,_a=function(e){const t=[];let a=e===z;return[b(this,ge),b(this,fe)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==z&&t.push(...Object.keys(r[z]).map(s=>[s,r[z][s]]))}),a?$r(t):null},na),ye,ce,sa,Br=(sa=class{constructor(e){S(this,"name","SmartRouter");N(this,ye,[]);N(this,ce,[]);C(this,ye,e.routers)}add(e,t,a){if(!b(this,ce))throw new Error(fa);b(this,ce).push([e,t,a])}match(e,t){if(!b(this,ce))throw new Error("Fatal error");const a=b(this,ye),r=b(this,ce),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let c=0,l=r.length;c<l;c++)i.add(...r[c]);o=i.match(e,t)}catch(c){if(c instanceof ya)continue;throw c}this.match=i.match.bind(i),C(this,ye,[i]),C(this,ce,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ce)||b(this,ye).length!==1)throw new Error("No active router has been determined yet.");return b(this,ye)[0]}},ye=new WeakMap,ce=new WeakMap,sa),ze=Object.create(null),ve,q,Se,Ue,W,de,xe,He,jr=(He=class{constructor(t,a,r){N(this,de);N(this,ve);N(this,q);N(this,Se);N(this,Ue,0);N(this,W,ze);if(C(this,q,r||Object.create(null)),C(this,ve,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},C(this,ve,[n])}C(this,Se,[])}insert(t,a,r){C(this,Ue,++Ut(this,Ue)._);let n=this;const s=pr(a),o=[];for(let i=0,c=s.length;i<c;i++){const l=s[i],u=s[i+1],m=gr(l,u),g=Array.isArray(m)?m[0]:l;if(g in b(n,q)){n=b(n,q)[g],m&&o.push(m[1]);continue}b(n,q)[g]=new He,m&&(b(n,Se).push(m),o.push(m[1])),n=b(n,q)[g]}return b(n,ve).push({[t]:{handler:r,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:b(this,Ue)}}),n}search(t,a){var c;const r=[];C(this,W,ze);let s=[this];const o=ia(a),i=[];for(let l=0,u=o.length;l<u;l++){const m=o[l],g=l===u-1,v=[];for(let f=0,x=s.length;f<x;f++){const w=s[f],E=b(w,q)[m];E&&(C(E,W,b(w,W)),g?(b(E,q)["*"]&&r.push(...M(this,de,xe).call(this,b(E,q)["*"],t,b(w,W))),r.push(...M(this,de,xe).call(this,E,t,b(w,W)))):v.push(E));for(let d=0,y=b(w,Se).length;d<y;d++){const p=b(w,Se)[d],h=b(w,W)===ze?{}:{...b(w,W)};if(p==="*"){const k=b(w,q)["*"];k&&(r.push(...M(this,de,xe).call(this,k,t,b(w,W))),C(k,W,h),v.push(k));continue}const[_,T,I]=p;if(!m&&!(I instanceof RegExp))continue;const O=b(w,q)[_],L=o.slice(l).join("/");if(I instanceof RegExp){const k=I.exec(L);if(k){if(h[T]=k[0],r.push(...M(this,de,xe).call(this,O,t,b(w,W),h)),Object.keys(b(O,q)).length){C(O,W,h);const D=((c=k[0].match(/\//))==null?void 0:c.length)??0;(i[D]||(i[D]=[])).push(O)}continue}}(I===!0||I.test(m))&&(h[T]=m,g?(r.push(...M(this,de,xe).call(this,O,t,h,b(w,W))),b(O,q)["*"]&&r.push(...M(this,de,xe).call(this,b(O,q)["*"],t,h,b(w,W)))):(C(O,W,h),v.push(O)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((l,u)=>l.score-u.score),[r.map(({handler:l,params:u})=>[l,u])]}},ve=new WeakMap,q=new WeakMap,Se=new WeakMap,Ue=new WeakMap,W=new WeakMap,de=new WeakSet,xe=function(t,a,r,n){const s=[];for(let o=0,i=b(t,ve).length;o<i;o++){const c=b(t,ve)[o],l=c[a]||c[z],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),r!==ze||n&&n!==ze))for(let m=0,g=l.possibleKeys.length;m<g;m++){const v=l.possibleKeys[m],f=u[l.score];l.params[v]=n!=null&&n[v]&&!f?n[v]:r[v]??(n==null?void 0:n[v]),u[l.score]=!0}}return s},He),Ie,oa,Pr=(oa=class{constructor(){S(this,"name","TrieRouter");N(this,Ie);C(this,Ie,new jr)}add(e,t,a){const r=ca(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ie).insert(e,r[n],a);return}b(this,Ie).insert(e,t,a)}match(e,t){return b(this,Ie).search(e,t)}},Ie=new WeakMap,oa),be=class extends Ir{constructor(e={}){super(e),this.router=e.router??new Br({routers:[new Mr,new Pr]})}},Ur=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function c(m,g){o.res.headers.set(m,g)}const l=await r(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),a.credentials&&c("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&c("Vary","Origin"),a.maxAge!=null&&c("Access-Control-Max-Age",a.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&c("Access-Control-Allow-Methods",m.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(c("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function xa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:l}=await Promise.resolve().then(()=>ka),u=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(u!=null&&u.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const g=await l(m.encrypted_value,u.pin_hash);await fetch(`https://api.telegram.org/bot${g}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:u.telegram_chat_id,text:c})})}catch(o){console.error("Failed to send provider alert:",o)}}function Ft(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Sa{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){S(this,"name");S(this,"apiKey");S(this,"model");S(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var u,m,g,v;const r=t.find(f=>f.role==="system"),n=t.filter(f=>f.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(f=>({role:f.role,content:f.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})));const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const f=await o.text();throw new Error(this.name+" API error "+o.status+": "+f)}const i=await o.json(),c=((u=i.content)==null?void 0:u.filter(f=>f.type==="text"))||[],l=((m=i.content)==null?void 0:m.filter(f=>f.type==="tool_use"))||[];return{content:c.map(f=>f.text).join(`
`),toolCalls:l.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((g=i.usage)==null?void 0:g.input_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(l=>l.role==="system"),n=t.filter(l=>l.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(l=>({role:l.role,content:l.content}))};r&&(s.system=r.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const l=await o.text();throw new Error(this.name+" stream error "+o.status+": "+l)}const i=o.body.getReader(),c=new TextDecoder;return new ReadableStream({async pull(l){var f;const{done:u,value:m}=await i.read();if(u){l.close();return}const v=c.decode(m,{stream:!0}).split(`
`);for(const x of v)if(x.startsWith("data: ")){const w=x.slice(6);if(w==="[DONE]")continue;try{const E=JSON.parse(w);E.type==="content_block_delta"&&((f=E.delta)!=null&&f.text)&&l.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Gr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,o]of Object.entries(r))o&&typeof o=="object"?n[s]=Ot(o):n[s]=o;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Ot(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=Ot(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Ot(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ia{constructor(t,a,r,n){S(this,"name");S(this,"apiKey");S(this,"model");S(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var c,l,u,m,g,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},n=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&n)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:Gr(f.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const f=await s.text();throw new Error(this.name+" API error "+s.status+": "+f)}const o=await s.json(),i=(c=o.choices)==null?void 0:c[0];return{content:((l=i==null?void 0:i.message)==null?void 0:l.content)||"",toolCalls:(m=(u=i==null?void 0:i.message)==null?void 0:u.tool_calls)==null?void 0:m.map(f=>({id:f.id,name:f.function.name,arguments:typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}})),usage:{promptTokens:((g=o.usage)==null?void 0:g.prompt_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const i=await n.text();throw new Error(this.name+" stream error "+n.status+": "+i)}const s=n.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var g,v,f;const{done:c,value:l}=await s.read();if(c){i.close();return}const m=o.decode(l,{stream:!0}).split(`
`);for(const x of m)if(x.startsWith("data: ")){const w=x.slice(6);if(w==="[DONE]")continue;try{const d=(f=(v=(g=JSON.parse(w).choices)==null?void 0:g[0])==null?void 0:v.delta)==null?void 0:f.content;d&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:d})+`

`))}catch{}}}})}}function Dt(e,t,a,r){const n=Je[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new Sa(t,s,n.apiBase,a):new Ia(t,s,n.apiBase,a)}class Oa{constructor(){S(this,"errorLog",new Map);S(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const zr=["llm_slot_1","llm_slot_2","llm_slot_3"],Fr=["anthropic","openai"];async function at(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>ka),n=new Oa,s=[];for(const m of zr){const g=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(g)try{const v=await r(g.encrypted_value,a),f=JSON.parse(v);if(f.provider&&f.apiKey&&Je[f.provider]){const w=f.provider,E=Dt(f.provider,f.apiKey,w,f.model);s.push({name:w,provider:E})}}catch(v){console.error(`Failed to load ${m}:`,v)}}const o=new Set(s.map(m=>m.name));for(const m of Fr){if(o.has(m))continue;const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(g)try{const v=await r(g.encrypted_value,a);if(Je[m]){const x=Dt(m,v,m);s.push({name:m,provider:x})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(m=>m.name),c=await n.pickProvider(i);if(!c)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const l=s.find(m=>m.name===c);return{provider:Wr(l.provider,s,n,e,t),rotation:n}}function Wr(e,t,a,r,n){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(c){const l=c.message||"";throw s(l)&&!l.includes("TOOLS_UNSUPPORTED")&&Et(r,n,"all_providers_down",e.name,null,l),c}},async streamChat(o,i){return await e.streamChat(o,i)}}:{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(c){const l=c.message||"";if(!s(l))throw c;const u=l.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${u?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,l,u?1:1440);const m=t.filter(g=>g.name!==e.name);for(const g of m)try{const v=await g.provider.chat(o,i);return this.name=g.name,u||Et(r,n,"provider_switched",e.name,g.name,l),v}catch(v){const f=v.message||"";if(s(f)){await a.recordError(g.name,f,1440);continue}throw v}throw Et(r,n,"all_providers_down",e.name,null,l),new Error(`All LLM providers failed. Primary (${e.name}): ${l.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,i){return await e.streamChat(o,i)}}}const Ct=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Sa,OpenAICompatibleProvider:Ia,ProviderRotation:Oa,createProviderFromConfig:Dt,createRotatingProvider:at,logError:A},Symbol.toStringTag,{value:"Module"})),Tt=20,qr=2e3,Kr=2e3,Da=4;function Yr(e){return Math.ceil(e.length/Da)}function Wt(e,t){const a=t*Da;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class X{constructor(t){this.db=t}async store(t,a,r,n,s=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>Tt){const r=((a==null?void 0:a.cnt)||0)-Tt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
...
`}return Wt(n,qr)}static truncatePersonality(t){return Wt(t,Kr)}async getRecentConversations(t,a=20,r){return r?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r,a).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a).all()).results||[]).reverse()}async storeMessage(t,a,r,n,s="{}",o){const i=Yr(n);o?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,i,o).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,i).run()}async compactHistory(t,a=30){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((r==null?void 0:r.cnt)||0)<=a*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,a).run()}}const Jr="https://accounts.google.com/o/oauth2/v2/auth",Ca="https://oauth2.googleapis.com/token",Vr="https://www.googleapis.com/oauth2/v2/userinfo",Xr=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let ne=null;async function Rt(e,t,a){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!r)return null;try{const n=await P(r.encrypted_value,a);return JSON.parse(n)}catch{return null}}async function Zr(e,t,a,r){const n=await $t(JSON.stringify(r),a);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,n).run()}function Ra(e,t,a){const r=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Xr,access_type:"offline",prompt:"consent",state:a,include_granted_scopes:"true"});return`${Jr}?${r}`}async function Aa(e,t,a,r){const n=await fetch(Ca,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:a,redirect_uri:r,grant_type:"authorization_code"})}),s=await n.text();if(!n.ok)throw new Error(`Token exchange failed (${n.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function Qr(e,t,a){const r=await fetch(Ca,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:a,grant_type:"refresh_token"})}),n=await r.text();if(!r.ok)throw r.status===400||r.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${r.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function Na(e){const t=await fetch(Vr,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function Ge(e,t,a,r,n){if(!r||!n)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(ne&&ne.userId===t&&ne.expiresAt>Date.now()/1e3+60){const i=await Rt(e,t,a);return{token:ne.token,email:(i==null?void 0:i.email)||"unknown"}}const s=await Rt(e,t,a);if(!s)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const o=await Qr(s.refresh_token,r,n);return ne={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{token:o.access_token,email:s.email}}async function Mt(e,t,a){try{const r=await Rt(e,t,a);return r?{connected:!0,email:r.email,connectedAt:r.connected_at}:{connected:!1}}catch{return{connected:!1}}}function La(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function $a(e,t,a,r,n,s,o){const i=await Aa(r,s,o,n);if(!i.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const c=await Na(i.access_token),l={refresh_token:i.refresh_token,email:c.email,name:c.name,connected_at:new Date().toISOString()};return await Zr(e,t,a,l),ne={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{email:c.email,name:c.name}}async function Ma(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(ne==null?void 0:ne.userId)===t&&(ne=null)}const Fe="https://sheets.googleapis.com/v4/spreadsheets";class Ba{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ge(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,a){const r=await this.authHeaders(),n=encodeURIComponent(a),s=await fetch(`${Fe}/${t}/values/${n}`,{headers:r});if(!s.ok){const i=await s.text();throw new Error(`Sheets read failed (${s.status}): ${i}`)}return(await s.json()).values||[]}async writeRange(t,a,r){const n=await this.authHeaders(),s=encodeURIComponent(a),o=await fetch(`${Fe}/${t}/values/${s}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:n,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!o.ok){const c=await o.text();throw new Error(`Sheets write failed (${o.status}): ${c}`)}return{updatedCells:(await o.json()).updatedCells||0}}async appendRows(t,a,r){var c;const n=await this.authHeaders(),s=encodeURIComponent(a),o=await fetch(`${Fe}/${t}/values/${s}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:n,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!o.ok){const l=await o.text();throw new Error(`Sheets append failed (${o.status}): ${l}`)}return{updatedCells:((c=(await o.json()).updates)==null?void 0:c.updatedCells)||r.length}}async createSpreadsheet(t,a){const r=await this.authHeaders(),n={properties:{title:t},sheets:a&&a.length>0?a.map(i=>({properties:{title:i}})):[{properties:{title:"Sheet1"}}]},s=await fetch(Fe,{method:"POST",headers:r,body:JSON.stringify(n)});if(!s.ok){const i=await s.text();throw new Error(`Sheets create failed (${s.status}): ${i}`)}const o=await s.json();return{spreadsheetId:o.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${o.spreadsheetId}/edit`}}async getMetadata(t){const a=await this.authHeaders(),r=await fetch(`${Fe}/${t}?fields=properties.title,sheets.properties.title`,{headers:a});if(!r.ok){const s=await r.text();throw new Error(`Sheets metadata failed (${r.status}): ${s}`)}const n=await r.json();return{title:n.properties.title,sheets:n.sheets.map(s=>s.properties.title)}}}const We="https://www.googleapis.com/calendar/v3";class Bt{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ge(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",a={}){const r=await this.authHeaders(),n=new URLSearchParams;a.timeMin&&n.set("timeMin",a.timeMin),a.timeMax&&n.set("timeMax",a.timeMax),n.set("maxResults",String(a.maxResults||20)),n.set("singleEvents","true"),n.set("orderBy","startTime"),a.query&&n.set("q",a.query);const s=await fetch(`${We}/calendars/${encodeURIComponent(t)}/events?${n}`,{headers:r});if(!s.ok){const i=await s.text();throw new Error(`Calendar list failed (${s.status}): ${i}`)}return(await s.json()).items||[]}async createEvent(t="primary",a){var i;const r=await this.authHeaders(),n=a.timeZone||"Asia/Kolkata",s={summary:a.summary,description:a.description||"",location:a.location||"",start:{dateTime:a.startDateTime,timeZone:n},end:{dateTime:a.endDateTime,timeZone:n}};(i=a.attendees)!=null&&i.length&&(s.attendees=a.attendees.map(c=>({email:c})));const o=await fetch(`${We}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:r,body:JSON.stringify(s)});if(!o.ok){const c=await o.text();throw new Error(`Calendar create failed (${o.status}): ${c}`)}return await o.json()}async updateEvent(t="primary",a,r){const n=await this.authHeaders(),s=r.timeZone||"Asia/Kolkata",o={};r.summary&&(o.summary=r.summary),r.description&&(o.description=r.description),r.location&&(o.location=r.location),r.startDateTime&&(o.start={dateTime:r.startDateTime,timeZone:s}),r.endDateTime&&(o.end={dateTime:r.endDateTime,timeZone:s});const i=await fetch(`${We}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"PATCH",headers:n,body:JSON.stringify(o)});if(!i.ok){const c=await i.text();throw new Error(`Calendar update failed (${i.status}): ${c}`)}return await i.json()}async deleteEvent(t="primary",a){const r=await this.authHeaders(),n=await fetch(`${We}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"DELETE",headers:r});if(!n.ok&&n.status!==410){const s=await n.text();throw new Error(`Calendar delete failed (${n.status}): ${s}`)}}async listCalendars(){const t=await this.authHeaders(),a=await fetch(`${We}/users/me/calendarList`,{headers:t});if(!a.ok){const n=await a.text();throw new Error(`Calendar list calendars failed (${a.status}): ${n}`)}return((await a.json()).items||[]).map(n=>({id:n.id,summary:n.summary,primary:n.primary||!1}))}}const st="https://docs.googleapis.com/v1/documents",en="https://www.googleapis.com/drive/v3/files";class ja{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ge(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const a=await this.authHeaders(),r=await fetch(st,{method:"POST",headers:a,body:JSON.stringify({title:t})});if(!r.ok){const s=await r.text();throw new Error(`Docs create failed (${r.status}): ${s}`)}const n=await r.json();return{documentId:n.documentId,url:`https://docs.google.com/document/d/${n.documentId}/edit`}}async readDocument(t){var o,i;const a=await this.authHeaders(),r=await fetch(`${st}/${t}`,{headers:a});if(!r.ok){const c=await r.text();throw new Error(`Docs read failed (${r.status}): ${c}`)}const n=await r.json();let s="";for(const c of((o=n.body)==null?void 0:o.content)||[])if(c.paragraph)for(const l of c.paragraph.elements)(i=l.textRun)!=null&&i.content&&(s+=l.textRun.content);return{title:n.title,content:s.trim()}}async appendText(t,a){const r=await this.authHeaders(),n=await fetch(`${st}/${t}`,{headers:r});if(!n.ok){const c=await n.text();throw new Error(`Docs read for append failed (${n.status}): ${c}`)}const s=await n.json(),o=s.body.content[s.body.content.length-1].endIndex-1,i=await fetch(`${st}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{insertText:{location:{index:o},text:a}}]})});if(!i.ok){const c=await i.text();throw new Error(`Docs append failed (${i.status}): ${c}`)}}async shareDocument(t,a,r="writer"){const n=await this.authHeaders(),s=await fetch(`${en}/${t}/permissions`,{method:"POST",headers:n,body:JSON.stringify({type:"user",role:r,emailAddress:a})});if(!s.ok){const o=await s.text();throw new Error(`Share failed (${s.status}): ${o}`)}}}class re{constructor(t,a,r,n,s){S(this,"sheets");S(this,"calendar");S(this,"docs");S(this,"db");S(this,"userId");S(this,"pinHash");this.db=t,this.userId=a,this.pinHash=r,this.sheets=new Ba(t,a,r,n,s),this.calendar=new Bt(t,a,r,n,s),this.docs=new ja(t,a,r,n,s)}async isConnected(){return Mt(this.db,this.userId,this.pinHash)}}const ot=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:Bt,GoogleDocs:ja,GoogleServices:re,GoogleSheets:Ba,completeOAuthFlow:$a,disconnectGoogle:Ma,exchangeCodeForTokens:Aa,fetchUserInfo:Na,generateAuthUrl:Ra,getGoogleAuth:Ge,isGoogleConnected:Mt,isOAuthClientConfigured:La},Symbol.toStringTag,{value:"Module"}));async function Pa(e,t,a={}){const r={textQuery:t,languageCode:"en",pageSize:8};if(a.type&&(r.includedType=a.type),a.location){const c=a.location.split(",").map(Number);c.length===2&&!isNaN(c[0])&&!isNaN(c[1])&&(r.locationBias={circle:{center:{latitude:c[0],longitude:c[1]},radius:a.radius||5e3}})}const n=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),s=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":n},body:JSON.stringify(r)});if(!s.ok){const c=await s.text();return{results:[],error:`Places API error (${s.status}): ${c.substring(0,200)}`}}const o=await s.json();return!o.places||o.places.length===0?{results:[]}:{results:o.places.map(c=>{var l,u,m;return{name:((l=c.displayName)==null?void 0:l.text)||"",address:c.formattedAddress||"",rating:c.rating,userRatingsTotal:c.userRatingCount,priceLevel:c.priceLevel,openNow:(u=c.currentOpeningHours)==null?void 0:u.openNow,types:(m=c.types)==null?void 0:m.slice(0,5),placeId:c.id||"",location:c.location?{lat:c.location.latitude,lng:c.location.longitude}:void 0,googleMapsUri:c.googleMapsUri}})}}async function Ua(e,t){var s,o,i;const a=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),r=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":a}});if(!r.ok){const c=await r.text();return{error:`Place Details API error (${r.status}): ${c.substring(0,200)}`}}const n=await r.json();return{details:{name:((s=n.displayName)==null?void 0:s.text)||"",address:n.formattedAddress||"",phone:n.internationalPhoneNumber,website:n.websiteUri,rating:n.rating,reviews:(o=n.reviews)==null?void 0:o.slice(0,3).map(c=>{var l,u,m;return{author:((l=c.authorAttribution)==null?void 0:l.displayName)||"Anonymous",rating:c.rating||0,text:((m=(u=c.text)==null?void 0:u.text)==null?void 0:m.substring(0,200))||"",time:c.relativePublishTimeDescription||""}}),openingHours:(i=n.currentOpeningHours)==null?void 0:i.weekdayDescriptions,location:n.location?{lat:n.location.latitude,lng:n.location.longitude}:void 0,googleMapsUri:n.googleMapsUri}}}async function Ha(e,t,a,r={}){var l;const n=new URLSearchParams({origin:t,destination:a,key:e,mode:r.mode||"driving"});(r.mode==="driving"||!r.mode)&&n.set("departure_time","now");const s=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${n}`);if(!s.ok)return{error:`Directions API error: ${s.status}`};const o=await s.json();if(o.status!=="OK")return{error:`Directions: ${o.status} — ${o.error_message||""}`};const i=o.routes[0],c=i.legs[0];return{route:{summary:i.summary,distance:c.distance.text,duration:c.duration.text,durationInTraffic:(l=c.duration_in_traffic)==null?void 0:l.text,steps:c.steps.slice(0,10).map(u=>{var m,g,v;return{instruction:((m=u.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((g=u.distance)==null?void 0:g.text)||"",duration:((v=u.duration)==null?void 0:v.text)||""}}),startAddress:c.start_address,endAddress:c.end_address}}}async function Ga(e,t,a,r){var c,l;const n={q:t,target:a,key:e,format:"text"};r&&(n.source=r);const s=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const u=await s.text();return{translatedText:"",error:`Translate API error (${s.status}): ${u.substring(0,200)}`}}const i=(l=(c=(await s.json()).data)==null?void 0:c.translations)==null?void 0:l[0];return i?{translatedText:i.translatedText,detectedSourceLang:i.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function za(e,t){const a=new URLSearchParams({address:t,key:e}),r=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${a}`);if(!r.ok)return{results:[],error:`Geocoding API error: ${r.status}`};const n=await r.json();return n.status!=="OK"&&n.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${n.status} — ${n.error_message||""}`}:{results:(n.results||[]).slice(0,5).map(s=>{var o;return{address:s.formatted_address,lat:s.geometry.location.lat,lng:s.geometry.location.lng,placeId:s.place_id,types:(o=s.types)==null?void 0:o.slice(0,3)}})}}async function Fa(e,t,a={}){const r=new URLSearchParams({part:"snippet",q:t,key:e,type:a.type||"video",maxResults:String(a.maxResults||5),order:a.order||"relevance"}),n=await fetch(`https://www.googleapis.com/youtube/v3/search?${r}`);if(!n.ok){const o=await n.text();return{results:[],error:`YouTube API error (${n.status}): ${o.substring(0,200)}`}}return{results:((await n.json()).items||[]).map(o=>{var i,c,l,u,m,g,v,f;return{title:o.snippet.title,channelTitle:o.snippet.channelTitle,description:(i=o.snippet.description)==null?void 0:i.substring(0,200),videoId:((c=o.id)==null?void 0:c.videoId)||((l=o.id)==null?void 0:l.channelId)||((u=o.id)==null?void 0:u.playlistId)||"",publishedAt:o.snippet.publishedAt,url:(m=o.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${o.id.videoId}`:(g=o.id)!=null&&g.channelId?`https://www.youtube.com/channel/${o.id.channelId}`:"",thumbnailUrl:(f=(v=o.snippet.thumbnails)==null?void 0:v.medium)==null?void 0:f.url}})}}async function gt(e,t={}){const a=Math.min(t.num||5,10),r=t.site?`site:${t.site} ${e}`:e;try{const n=new URLSearchParams({q:r}),s=await fetch(`https://html.duckduckgo.com/html/?${n}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!s.ok)return{results:[],error:`Search request failed (${s.status})`};const o=await s.text(),i=[],c=o.split(/class="result results_links/g).slice(1);for(const l of c){if(i.length>=a)break;const u=l.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=l.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(u){let g=u[1];const v=g.match(/uddg=([^&]+)/);v?g=decodeURIComponent(v[1]):g.startsWith("//")&&(g="https:"+g);const f=E=>E.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),x=f(u[2]),w=m?f(m[1]):"";if(x&&g.startsWith("http")){const E=g.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];i.push({title:x,link:g,snippet:w,displayLink:E})}}}return i.length===0?{results:[],error:void 0}:{results:i}}catch(n){return{results:[],error:`Web search error: ${n.message}`}}}async function Wa(e,t,a,r="driving"){var c,l,u,m;const n=new URLSearchParams({origins:t,destinations:a,key:e,mode:r,departure_time:"now"}),s=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${n}`);if(!s.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${s.status}`};const o=await s.json(),i=(u=(l=(c=o.rows)==null?void 0:c[0])==null?void 0:l.elements)==null?void 0:u[0];return!i||i.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(i==null?void 0:i.status)||o.status}`}:{distance:i.distance.text,duration:i.duration.text,durationInTraffic:(m=i.duration_in_traffic)==null?void 0:m.text}}const tn=Object.freeze(Object.defineProperty({__proto__:null,geocode:za,getDirections:Ha,getDistanceMatrix:Wa,getPlaceDetails:Ua,searchPlaces:Pa,searchYouTube:Fa,translateText:Ga,webSearch:gt},Symbol.toStringTag,{value:"Module"})),se="https://gmail.googleapis.com/gmail/v1/users/me";class oe{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ge(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var i;const a=await this.authHeaders(),r=new URLSearchParams;if(r.set("maxResults",String(t.maxResults||10)),t.query&&r.set("q",t.query),(i=t.labelIds)!=null&&i.length)for(const c of t.labelIds)r.append("labelIds",c);const n=await fetch(`${se}/messages?${r}`,{headers:a});if(!n.ok){const c=await n.text();throw new Error(`Gmail list failed (${n.status}): ${c.substring(0,200)}`)}const s=await n.json();if(!s.messages||s.messages.length===0)return[];const o=[];for(const c of s.messages.slice(0,t.maxResults||10))try{const l=await this.getMessage(c.id,a);l&&o.push(l)}catch{}return o}async getMessage(t,a){const r=a||await this.authHeaders(),n=await fetch(`${se}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:r});if(!n.ok)return null;const s=await n.json(),o=i=>{var c,l,u;return((u=(l=(c=s.payload)==null?void 0:c.headers)==null?void 0:l.find(m=>m.name.toLowerCase()===i.toLowerCase()))==null?void 0:u.value)||""};return{id:s.id,threadId:s.threadId,snippet:s.snippet||"",subject:o("Subject")||"(no subject)",from:o("From"),to:o("To"),date:o("Date")||new Date(parseInt(s.internalDate)).toISOString(),isUnread:(s.labelIds||[]).includes("UNREAD"),labels:s.labelIds||[]}}async getMessageBody(t){const a=await this.authHeaders(),r=await fetch(`${se}/messages/${t}?format=full`,{headers:a});if(!r.ok){const s=await r.text();throw new Error(`Gmail message body failed (${r.status}): ${s.substring(0,200)}`)}const n=await r.json();return qa(n.payload)}async search(t,a=10){return this.listMessages({query:t,maxResults:a})}async send(t,a,r,n={}){const s=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&o.push(`Cc: ${n.cc}`),n.bcc&&o.push(`Bcc: ${n.bcc}`),n.replyToMessageId&&(o.push(`In-Reply-To: ${n.replyToMessageId}`),o.push(`References: ${n.replyToMessageId}`)),o.push("",r);const i=o.join(`\r
`),l={raw:btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")};n.threadId&&(l.threadId=n.threadId);const u=await fetch(`${se}/messages/send`,{method:"POST",headers:s,body:JSON.stringify(l)});if(!u.ok){const m=await u.text();throw new Error(`Gmail send failed (${u.status}): ${m.substring(0,200)}`)}return await u.json()}async createDraft(t,a,r,n={}){const s=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&o.push(`Cc: ${n.cc}`),o.push("",r);const i=o.join(`\r
`),c=btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),l=await fetch(`${se}/drafts`,{method:"POST",headers:s,body:JSON.stringify({message:{raw:c}})});if(!l.ok){const u=await l.text();throw new Error(`Gmail draft failed (${l.status}): ${u.substring(0,200)}`)}return await l.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${se}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const r=await this.authHeaders();let n={};switch(a){case"archive":n={removeLabelIds:["INBOX"]};break;case"trash":n={addLabelIds:["TRASH"]};break;case"read":n={removeLabelIds:["UNREAD"]};break;case"unread":n={addLabelIds:["UNREAD"]};break;case"star":n={addLabelIds:["STARRED"]};break;case"unstar":n={removeLabelIds:["STARRED"]};break}const s=await fetch(`${se}/messages/${t}/modify`,{method:"POST",headers:{...r,"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.text();throw new Error(`Failed to modify message: ${o}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${se}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${se}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function qa(e){var t,a,r;if(!e)return"";if((t=e.body)!=null&&t.data)return kt(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((a=n.body)!=null&&a.data))return kt(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((r=n.body)!=null&&r.data)){const s=kt(n.body.data);return an(s)}for(const n of e.parts)if(n.parts){const s=qa(n);if(s)return s}}return e.snippet||""}function kt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function an(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const rn=1e4,nn=1e4;async function Ka(e,t){try{const a=new AbortController,r=setTimeout(()=>a.abort(),nn),n=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(r),!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const o=await n.text(),i=sn(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||rn)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function sn(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Ya(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await gt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async g=>{const v=await Ka(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),l=(await Promise.all(i)).filter(g=>g.content.length>50);if(l.length===0){const g=s.results.map((f,x)=>`[${x+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await qt(e,g,t,"snippets"),sources:s.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const u=l.map((g,v)=>`--- SOURCE ${v+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await qt(e,u,t,"full"),sources:l.map(g=>({title:g.title,url:g.url})),pagesRead:l.length}}async function qt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
- **1-3 sentences for factual answers.** Longer only for deep research requests.`;case"memory":return`You are ${s}, managing the user's memory and system status.
...
## Current Date & Time
${yt(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Yt(e,t,a){var l;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((l=n.files)==null?void 0:l.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const c=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${c}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function yt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}function pn(e){const t=e.replace(/(\d+)\s*[.,;!]+\s*(minutes?|mins?|hours?|hrs?|h|days?|seconds?|secs?)/gi,"$1 $2"),a=t.toLowerCase().trim(),r=a.match(/\bin\s+(\d+)\s*(minutes?|mins?|hours?|hrs?|h|days?)\b/i);if(r){let o=parseInt(r[1],10);const i=r[2].toLowerCase();i.startsWith("h")&&(o*=60),i.startsWith("d")&&(o*=1440);const c=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let l;c?l=c[1].trim():l=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/in\s+\d+\s*\.?\s*(minutes?|mins?|hours?|hrs?|h|days?)\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const u=l.length>50?l.substring(0,47)+"...":l;return{args:{name:u.charAt(0).toUpperCase()+u.slice(1),description:l,schedule_type:"once",minutes_from_now:o,action_type:"reminder",action_description:l,schedule_value:""}}}const n=a.match(/(?:at|by)\s+(\d{1,2})[:.]?(\d{2})?\s*(am|pm|a\.m\.|p\.m\.)?/i);if(n){let o=parseInt(n[1],10);const i=n[2]?parseInt(n[2],10):0,c=(n[3]||"").replace(/\./g,"").toLowerCase();c==="pm"&&o<12&&(o+=12),c==="am"&&o===12&&(o=0);const l=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let u;l?u=l[1].trim():u=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/(?:at|by)\s+\d{1,2}[:.]?\d{0,2}\s*(am|pm|a\.m\.|p\.m\.)?\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const m=u.length>50?u.substring(0,47)+"...":u,g=new Date,v=g.getFullYear(),f=String(g.getMonth()+1).padStart(2,"0"),x=String(g.getDate()).padStart(2,"0"),w=`${v}-${f}-${x} ${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}`;return{args:{name:m.charAt(0).toUpperCase()+m.slice(1),description:u,schedule_type:"once",schedule_value:w,action_type:"reminder",action_description:u}}}const s=a.match(/^(remind|alert|notify)\s+me\s+(?:to|about|that)\s+(.+?)\.?$/i);if(s){const o=s[2].trim(),i=o.length>50?o.substring(0,47)+"...":o;return{args:{name:i.charAt(0).toUpperCase()+i.slice(1),description:o,schedule_type:"once",minutes_from_now:5,action_type:"reminder",action_description:o,schedule_value:""}}}return null}async function Le(e,t,a,r,n,s,o,i,c,l,u,m){const g=Date.now();let v=!0,f="",x="";try{return x=await mn(e,t,a,r,s,o,i,c,l,u,m),x}catch(w){throw v=!1,f=w.message||"Unknown error",w}finally{const w=Date.now()-g;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?x:"").substring(0,500),v?1:0,f||null,w,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function mn(e,t,a,r,n,s,o,i,c,l,u){var g,v,f,x,w,E;const m=new X(a);switch(e){case"create_schedule":{const d=new Date;let y;const p=l||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(d.getTime()+t.minutes_from_now*60*1e3);const I=y.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[O,L,k]=(I[0]||"").split("/");t.schedule_value=`${k}-${O}-${L} ${I[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);y=new Date(d.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"){const[T,I]=t.schedule_value.split(":").map(Number),O=d.toLocaleString("en-US",{timeZone:p}),L=new Date(O),k=new Date(L);k.setHours(T,I,0,0),k<=L&&k.setDate(k.getDate()+1);const D=new Date(k.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(k.toLocaleString("en-US",{timeZone:p})),B=D.getTime()-R.getTime();y=new Date(k.getTime()+B)}else if(t.schedule_type==="weekly"){const[T,I]=t.schedule_value.split(" "),[O,L]=(I||"00:00").split(":").map(Number),D=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(bt=>bt.toLowerCase()===T.toLowerCase()),R=d.toLocaleString("en-US",{timeZone:p}),B=new Date(R),G=new Date(B);G.setHours(O,L,0,0);let $=(D-G.getDay()+7)%7;$===0&&G<=B&&($=7),G.setDate(G.getDate()+$);const Y=new Date(G.toLocaleString("en-US",{timeZone:"UTC"})),J=new Date(G.toLocaleString("en-US",{timeZone:p})),vt=Y.getTime()-J.getTime();y=new Date(G.getTime()+vt)}else if(t.schedule_type==="once"){const[T,I]=t.schedule_value.split(" "),[O,L,k]=T.split("-").map(Number),[D,R]=(I||"00:00").split(":").map(Number),B=d.toLocaleString("en-US",{timeZone:p}),G=new Date(B),$=new Date(G);$.setFullYear(O,L-1,k),$.setHours(D,R,0,0);const Y=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),J=new Date($.toLocaleString("en-US",{timeZone:p})),vt=Y.getTime()-J.getTime();y=new Date($.getTime()+vt);const bt=new Date(d.getTime()+120*1e3);if(y.getTime()<d.getTime()+60*1e3){const ar=y.toISOString();y=bt;const rr=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${ar} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=rr}}else y=new Date(d.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),y.toISOString()).run();const h=t._pastTimeWarning||"",_=y.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${_} (${p}). [UTC: ${y.toISOString()}]${h}. IMPORTANT: Use the exact time "${_}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const y=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return y.length===0?"No scheduled tasks found.":y.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const d=t.enabled?1:0,y=d?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(d,y,t.job_id,r).run(),`Schedule ${t.job_id} ${d?"enabled (active)":"paused"}.`}case"update_schedule_state":{const d=["created","active","reminding","paused","completed"],y=t.state;if(!d.includes(y))return`Invalid state "${y}". Valid states: ${d.join(", ")}`;const p=y==="completed"||y==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,p,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const d=t.importance||5,y=t.type,p=y==="task"||d>=7?"working":"long_term";if(await m.store(r,y,t.title,t.content,d,p),y==="task"){const h=[],_=[];t.due_date&&(h.push("due_date = ?"),_.push(t.due_date)),t.status&&(h.push("status = ?"),_.push(t.status)),h.length>0&&(_.push(r,t.title),await a.prepare(`UPDATE memory SET ${h.join(", ")} WHERE user_id = ? AND title = ? AND type = 'task'`).bind(..._).run());const T=t.due_date?` (due: ${new Date(t.due_date).toLocaleDateString("en-GB")})`:"",I=t.status==="done"?" ✅ marked done":"";return`Task saved: "${t.title}"${T}${I}. It will appear in your briefing until marked done.`}return`Stored in ${p==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${d})`}case"search_memory":{const d=await m.search(r,t.query);return d.length===0?"No matching memories found.":d.map(y=>`[${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
`)}case"get_system_status":{const d=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),y=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),_=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.spreadsheet_id;let p=t.range;const h=await d.sheets.getMetadata(y),_=h.sheets;p.includes("!")||(p=`${_[0]}!${p}`);let T;try{T=await d.sheets.readRange(y,p)}catch(O){if((g=O.message)!=null&&g.includes("Unable to parse range")||(v=O.message)!=null&&v.includes("400")){const L=p.includes("!")?p.split("!")[1]:p;p=`${_[0]}!${L}`,T=await d.sheets.readRange(y,p)}else throw O}let I=`[Spreadsheet: "${h.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(O=>`"${O}"`).join(", ")}]
`;return _.length>1&&(I+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),T.length===0?I+"No data found in the specified range.":I+T.map(O=>O.join("	| ")).join(`
`)}catch(d){return await A(a,r,"google","read_sheet",d.message),`Failed to read sheet: ${d.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.values;let p=t.range;const T=Math.max(...y.map(k=>k.length))+4,I=y.map(k=>{const D=[...k];for(;D.length<T;)D.push("");return D}),O=p.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(O){const k=O[1]||"",D=O[2],R=O[3],B=O[5],$=D.toUpperCase().charCodeAt(0)-64+T-1,Y=$<=26?String.fromCharCode(64+$):"Z";p=`${k}${D}${R}:${Y}${B}`}return`Written ${(await d.sheets.writeRange(t.spreadsheet_id,p,I)).updatedCells} cells to ${p}.`}catch(d){return await A(a,r,"google","write_sheet",d.message),`Failed to write sheet: ${d.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new re(a,r,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(d){return await A(a,r,"google","append_sheet",d.message),`Failed to append to sheet: ${d.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await d.sheets.createSpreadsheet(t.title,t.sheet_names);let h="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ot)).getGoogleAuth(a,r,n,s||"",o||"");h=`
Folder: "${(await Yt(_,p.spreadsheetId,t.folder_name)).folderName}"`}catch(_){h=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new X(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${h}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(d){return await A(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.calendar_id||"primary",p=t.days_ahead||7,h=new Date,_=new Date(h.getTime()+p*24*60*60*1e3),T=await d.calendar.listEvents(y,{timeMin:h.toISOString(),timeMax:_.toISOString(),query:t.query});return T.length===0?`No events found in the next ${p} days.`:T.map(I=>{var R;const O=I.start.dateTime||I.start.date||"TBD",L=I.end.dateTime||I.end.date||"",k=I.location?` 📍 ${I.location}`:"",D=((R=I.attendees)==null?void 0:R.map(B=>B.email).join(", "))||"";return`• ${I.summary} — ${O} to ${L}${k}${D?`
  Attendees: ${D}`:""}`}).join(`
`)}catch(d){return await A(a,r,"google","list_calendar",d.message),`Failed to list events: ${d.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.calendar_id||"primary",p=await d.calendar.createEvent(y,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(d){return await A(a,r,"google","create_event",d.message),`Failed to create event: ${d.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await d.docs.createDocument(t.title);t.content&&await d.docs.appendText(p.documentId,t.content);let h="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ot)).getGoogleAuth(a,r,n,s||"",o||"");h=`
Folder: "${(await Yt(_,p.documentId,t.folder_name)).folderName}"`}catch(_){h=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new X(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${h}
ID: ${p.documentId}
URL: ${p.url}`}catch(d){return await A(a,r,"google","create_doc",d.message),`Failed to create document: ${d.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const y=await new re(a,r,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${y.title}"

${y.content}`}catch(d){return await A(a,r,"google","read_doc",d.message),`Failed to read document: ${d.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await d.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await d.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(d){return await A(a,r,"google","append_to_doc",d.message),`Failed to append to document: ${d.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const y=await new oe(a,r,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return y.length===0?"No messages found.":y.map((p,h)=>`${p.isUnread?"● ":"  "}${h+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(d){return await A(a,r,"gmail","list",d.message),(f=d.message)!=null&&f.includes("not connected")?d.message:`Gmail list error: ${d.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const d=new oe(a,r,n,s||"",o||""),y=await d.getMessage(t.message_id);if(!y)return"Message not found.";const p=await d.getMessageBody(t.message_id);return`**${y.subject}**
From: ${y.from}
To: ${y.to}
Date: ${y.date}

${p}`}catch(d){return await A(a,r,"gmail","read",d.message),`Gmail read error: ${d.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const y=await new oe(a,r,n,s||"",o||"").search(t.query,t.max_results||10);return y.length===0?`No results for: ${t.query}`:y.map((p,h)=>`${p.isUnread?"● ":"  "}${h+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(d){return await A(a,r,"gmail","search",d.message),`Gmail search error: ${d.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const y=await new oe(a,r,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${y.id}]`}catch(d){return await A(a,r,"gmail","send",d.message),`Gmail send error: ${d.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const y=await new oe(a,r,n,s||"",o||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),p=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${p}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${y.id}]`}catch(d){return await A(a,r,"gmail","draft",d.message),`Gmail draft error: ${d.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new oe(a,r,n,s||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(d){return await A(a,r,"gmail","modify",d.message),`Gmail modify error: ${d.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const y=await new oe(a,r,n,s||"",o||"").getUnreadCount();return`You have ${y} unread email${y!==1?"s":""} in Gmail.`}catch(d){return(x=d.message)!=null&&x.includes("not connected")?d.message:`Gmail error: ${d.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:d}=await(await Promise.resolve().then(()=>ot)).getGoogleAuth(a,r,n,s||"",o||""),y=new URLSearchParams;y.set("pageSize",String(t.max_results||10)),y.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),y.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",y.set("q",p);const h=await fetch(`https://www.googleapis.com/drive/v3/files?${y}`,{headers:{Authorization:`Bearer ${d}`}});if(!h.ok)throw new Error(`Drive API error (${h.status})`);const _=await h.json();return(w=_.files)!=null&&w.length?_.files.map((T,I)=>{var D,R;const O=((D=T.mimeType)==null?void 0:D.split(".").pop())||T.mimeType,L=T.size?`${(parseInt(T.size)/1024).toFixed(1)} KB`:"",k=((R=T.modifiedTime)==null?void 0:R.split("T")[0])||"";return`${I+1}. **${T.name}** (${O})
   ${L} · Modified: ${k}
   ${T.webViewLink||""}`}).join(`

`):"No files found."}catch(d){return await A(a,r,"google","drive_list",d.message),`Drive list error: ${d.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:d}=await(await Promise.resolve().then(()=>ot)).getGoogleAuth(a,r,n,s||"",o||""),y=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",y),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const h=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${d}`}});if(!h.ok)throw new Error(`Drive API error (${h.status})`);const _=await h.json();return(E=_.files)!=null&&E.length?_.files.map((T,I)=>{var k,D;const O=((k=T.mimeType)==null?void 0:k.split(".").pop())||T.mimeType,L=((D=T.modifiedTime)==null?void 0:D.split("T")[0])||"";return`${I+1}. **${T.name}** (${O}) — Modified: ${L}
   ${T.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(d){return await A(a,r,"google","drive_search",d.message),`Drive search error: ${d.message}`}}case"web_search":try{const d=await gt(t.query,{num:t.num_results||5,site:t.site});return d.error?`Web search failed: ${d.error}`:d.results.length===0?`No results found for "${t.query}".`:d.results.map((y,p)=>`${p+1}. **${y.title}**
   ${y.link}
   ${y.snippet}`).join(`

`)}catch(d){return await A(a,r,"search","web_search",d.message),`Web search error: ${d.message}`}case"read_url":try{const d=t.url;if(!d||!d.startsWith("http://")&&!d.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>on),h=await p(d,y);return h.error?`Failed to read page: ${h.error}`:!h.text||h.text.length<20?`Page at ${d} returned no readable content.`:`Content from ${d} (${h.text.length} chars):

${h.text}`}catch(d){return await A(a,r,"search","read_url",d.message),`Read URL error: ${d.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const y=Ya(t.query,u,{depth:t.depth||"quick",site:t.site}),p=new Promise(T=>setTimeout(()=>T(null),45e3)),h=await Promise.race([y,p]);if(h===null){const{webSearch:T}=await Promise.resolve().then(()=>tn),I=await T(t.query,{num:5});if(I.error||I.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let O=`Research took too long, but here are the top search results:

`;return O+=I.results.map((L,k)=>`${k+1}. **${L.title}**
   ${L.snippet}
   ${L.link}`).join(`

`),O}if(h.error)return`Research failed: ${h.error}`;let _=h.report;return h.sources.length>0&&(_+=`

---
**Sources** (`+h.pagesRead+` pages read):
`,_+=h.sources.map((T,I)=>`[${I+1}] ${T.title}
    ${T.url}`).join(`
`)),_}catch(d){return await A(a,r,"research","research",d.message),`Research error: ${d.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await P(d.encrypted_value,n),p=await Pa(y,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((h,_)=>{const T=h.rating?` ★${h.rating} (${h.userRatingsTotal||0} reviews)`:"",I=h.openNow!==void 0?h.openNow?" · Open now":" · Closed":"",O=h.googleMapsUri?`
   ${h.googleMapsUri}`:"";return`${_+1}. **${h.name}**${T}${I}
   ${h.address}${O}
   [place_id: ${h.placeId}]`}).join(`

`)}catch(d){return await A(a,r,"google_api","search_places",d.message),`Places search error: ${d.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await P(d.encrypted_value,n),p=await Ua(y,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const h=p.details;let _=`**${h.name}**
📍 ${h.address}`;if(h.phone&&(_+=`
📞 ${h.phone}`),h.website&&(_+=`
🌐 ${h.website}`),h.rating&&(_+=`
★ ${h.rating}`),h.googleMapsUri&&(_+=`
📌 ${h.googleMapsUri}`),h.openingHours&&(_+=`

Opening Hours:
${h.openingHours.join(`
`)}`),h.reviews&&h.reviews.length>0){_+=`

Recent Reviews:`;for(const T of h.reviews)_+=`
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return _}catch(d){return await A(a,r,"google_api","place_details",d.message),`Place details error: ${d.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await P(d.encrypted_value,n),p=await Ha(y,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const h=p.route;let _=`**${h.startAddress}** → **${h.endAddress}**
`;return _+=`📏 ${h.distance} · ⏱️ ${h.duration}`,h.durationInTraffic&&(_+=` (with traffic: ${h.durationInTraffic})`),_+=`
via ${h.summary}`,_+=`

Steps:`,h.steps.forEach((T,I)=>{_+=`
${I+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),_}catch(d){return await A(a,r,"google_api","directions",d.message),`Directions error: ${d.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await P(d.encrypted_value,n),p=await Wa(y,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let h=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(h+=` (with traffic: ${p.durationInTraffic})`),h}catch(d){return await A(a,r,"google_api","travel_time",d.message),`Travel time error: ${d.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await P(d.encrypted_value,n),p=await Ga(y,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(d){return await A(a,r,"google_api","translate",d.message),`Translation error: ${d.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await P(d.encrypted_value,n),p=await Fa(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((h,_)=>{var T;return`${_+1}. **${h.title}**
   ${h.channelTitle} · ${((T=h.publishedAt)==null?void 0:T.split("T")[0])||""}
   ${h.description}
   ${h.url}`}).join(`

`)}catch(d){return await A(a,r,"google_api","youtube_search",d.message),`YouTube search error: ${d.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await P(d.encrypted_value,n),p=await za(y,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((h,_)=>`${_+1}. ${h.address}
   Coordinates: ${h.lat}, ${h.lng}`).join(`
`)}catch(d){return await A(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Jt(e,t,a,r,n,s){var d;const o=new X(t),i=(d=e.metadata)==null?void 0:d.thread_id,c=await o.buildContext(r.id),l=await o.getRecentConversations(r.id,25,i),m=[{role:"system",content:Za(r,c)},...l.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;const x=[];for(let y=0;y<g;y++)try{const p=await a.chat(m,{tools:ft});if(p.usage&&(f+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&m.push({role:"assistant",content:p.content});for(const h of p.toolCalls){x.push(h.name);try{const _=await Le(h.name,h.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);m.push({role:"user",content:`[Tool Result for ${h.name}]: ${_}`})}catch(_){await A(t,r.id,"tool",h.name,_.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${h.name}]: ${_.message||"Execution failed"}`})}}continue}v=p.content;break}catch(p){if(n){const h=p.message||"",_=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),T=h.includes("429"),I=_?1440:T?10:5;await n.recordError(a.name,h,I)}throw await A(t,r.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:a.name,turn:y}),p}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}const w=v.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),E=x.length>0?`[TOOLS_USED: ${[...new Set(x)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",E+w,"{}",i),await o.compactHistory(r.id,30),v}const Vt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function hn(e){for(const[t,a]of Object.entries(Vt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Vt.default}function gn(e,t,a,r){const n=hn(r),s=Math.floor(n*.75),o=[];let i=0,c=!1;const l=St(e);o.push({role:"system",content:e}),i+=l;const u=St(a);i+=u;const m=s-i,g=[];let v=0;for(let f=t.length-1;f>=0;f--){const x=t[f],w=St(x.content);if(v+w<=m)g.unshift({role:x.role,content:x.content}),v+=w;else{c=!0;break}}return o.push(...g),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:c}}async function*fn(e,t,a,r,n,s){var w;const o=new X(t),i=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const c=await o.buildContext(r.id),l=await o.getRecentConversations(r.id,20,i),u=Za(r,c),m=gn(u,l,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;const x=[...m.messages];for(let E=0;E<g;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:ft});if(d.usage&&(f+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const p of d.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const h=await Le(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:h.substring(0,500)+(h.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${p.name}]: ${h}`})}catch(h){await A(t,r.id,"tool",p.name,h.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${h.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${p.name}]: ${h.message||"Execution failed"}`})}}continue}v=d.content;const y=50;for(let p=0;p<v.length;p+=y)yield{type:"chunk",data:{text:v.substring(p,p+y),threadId:i}},p+y<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(d){if(n){const y=d.message||"",p=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),h=y.includes("429"),_=p?1440:h?10:5;await n.recordError(a.name,y,_)}await A(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function jt(e,t,a,r,n,s){var u;const o=new X(t),i=(u=e.metadata)==null?void 0:u.thread_id,c=await o.buildContext(r.id),l=Ja(e.text,c);if(l.agent==="conversation")return vn(e,t,a,r,c,n,i);if(l.agent==="multi"||l.confidence<.5)return Jt(e,t,a,r,n,s);try{return await yn(l.agent,e,t,a,r,c,n,s,i)}catch(m){return await A(t,r.id,"router","subagent_fallback",`${l.agent} failed: ${m.message}`,{route:l}),Jt(e,t,a,r,n,s)}}async function yn(e,t,a,r,n,s,o,i,c){const l=new X(a),u=yt(n.timezone),m=ut(e,n,s,n.timezone,u),g=Va(e,ft),v=(await l.getRecentConversations(n.id,25,c)).map(k=>({...k,content:k.content.replace(/^\[TOOLS_USED: [^\]]+\]\s*/i,"")})),f=[{role:"system",content:m},...v.map(k=>({role:k.role,content:k.content})),{role:"user",content:t.text}];await l.storeMessage(n.id,t.channel,"user",t.text,"{}",c);const x=10;let w="",E=0,d="",y=!1;const p=[];for(let k=0;k<x;k++)try{const D=await r.chat(f,{tools:g.length>0?g:void 0});if(D.usage&&(E+=D.usage.promptTokens+D.usage.completionTokens),D.toolCalls&&D.toolCalls.length>0){y=!0,D.content&&(d=D.content,f.push({role:"assistant",content:D.content}));for(const R of D.toolCalls){p.push(R.name);try{const B=await Le(R.name,R.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${R.name}]: ${B}`})}catch(B){await A(a,n.id,"tool",R.name,B.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${R.name}]: ${B.message||"Execution failed"}`})}}continue}w=D.content,!w&&d&&(w=d);break}catch(D){if(o){const R=D.message||"",B=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),G=R.includes("429"),$=B?1440:G?10:5;await o.recordError(r.name,R,$)}throw await A(a,n.id,"llm","subagent_error",D.message||"Unknown error",{agent:e,provider:r.name,turn:k}),D}const h=["scheduler","workspace","research"],_=e==="scheduler"&&!p.includes("create_schedule")&&!p.includes("list_schedules")&&!p.includes("toggle_schedule")&&!p.includes("update_schedule_state")&&!p.includes("delete_schedule")&&/\b(remind|in\s+\d+|at\s+\d{1,2}[:.]\d{0,2}|timer|alarm|schedule|tell\s+me\s+in|notify|alert|ping)\b/i.test(t.text),T=e==="workspace"&&p.includes("read_sheet")&&!p.includes("write_sheet")&&!p.includes("append_sheet")&&/\b(fix|correct|update|change|delete|remove|clean|clear|repair|replace|overwrite|set\s+to|should\s+be|wrong|broken|gap|missing)\b/i.test(t.text);if(!y&&h.includes(e)&&g.length>0||_||T){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),w.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{f.push({role:"assistant",content:w});let k;e==="scheduler"&&_?k=`[SYSTEM OVERRIDE] You called ${p.join(", ")||"no tools"} but did NOT call create_schedule. The user wants a reminder or schedule created. Call create_schedule NOW with the correct parameters. Do NOT respond with text saying a reminder is set — actually create it.`:e==="workspace"&&T?k="[SYSTEM OVERRIDE] You called read_sheet but did NOT call write_sheet. The user asked you to FIX or UPDATE the sheet data. You MUST call write_sheet NOW to make the actual changes. Reading data and then describing what you would fix is NOT the same as fixing it. Call write_sheet with the corrected values, then call read_sheet again to verify the fix landed correctly. Do NOT claim data is fixed without actually writing to the sheet.":k=`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${g.slice(0,3).map(R=>R.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`,f.push({role:"user",content:k});const D=await r.chat(f,{tools:g});if(D.usage&&(E+=D.usage.promptTokens+D.usage.completionTokens),D.toolCalls&&D.toolCalls.length>0){y=!0;let R=D.toolCalls,B=D.content;for(let G=0;G<5;G++){B&&f.push({role:"assistant",content:B});for(const Y of R){p.push(Y.name);try{const J=await Le(Y.name,Y.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${Y.name}]: ${J}`})}catch(J){f.push({role:"user",content:`[Tool Error for ${Y.name}]: ${J.message||"Execution failed"}`})}}const $=await r.chat(f,{tools:g});if($.usage&&(E+=$.usage.promptTokens+$.usage.completionTokens),$.toolCalls&&$.toolCalls.length>0){R=$.toolCalls,B=$.content;continue}$.content&&(w=$.content);break}}if(!p.includes("create_schedule")&&e==="scheduler")try{const R=pn(t.text);if(R){const B=await Le("create_schedule",R.args,a,n.id,{agentType:"scheduler",providerName:"programmatic_fallback",channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y=!0,p.push("create_schedule"),w=B}}catch(R){await A(a,n.id,"tool_enforcement","scheduler_fallback",`Programmatic scheduler fallback failed: ${R.message||"Unknown"}`)}}catch(k){await A(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${k.message||"Unknown"}`,{originalResponse:w.substring(0,200)})}}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}const O=w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),L=p.length>0?`[TOOLS_USED: ${[...new Set(p)].join(", ")}] `:"";return await l.storeMessage(n.id,t.channel,"assistant",L+O,"{}",c),await l.compactHistory(n.id,30),w}async function vn(e,t,a,r,n,s,o){const i=new X(t),c=yt(r.timezone),l=ut("conversation",r,n,r.timezone,c),u=await i.getRecentConversations(r.id,25,o),m=[{role:"system",content:l},...u.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let g=0,v="";try{const f=await a.chat(m,{temperature:.8});f.usage&&(g=f.usage.promptTokens+f.usage.completionTokens),v=f.content}catch(f){if(s){const x=f.message||"",w=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),E=x.includes("429"),d=w?1440:E?10:5;await s.recordError(a.name,x,d)}throw await A(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(s&&g>0)try{await s.recordUsage(a.name,g)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*bn(e,t,a,r,n,s){var d;const o=new X(t),i=(d=e.metadata)==null?void 0:d.thread_id,c=await o.buildContext(r.id),l=Ja(e.text,c);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},l.agent==="multi"||l.confidence<.5){yield*fn(e,t,a,r,n,s);return}const u=yt(r.timezone),m=l.agent==="conversation"?ut("conversation",r,c,r.timezone,u):ut(l.agent,r,c,r.timezone,u),g=Va(l.agent,ft),v=await o.getRecentConversations(r.id,25,i),f=[{role:"system",content:m},...v.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let w="",E=0;for(let y=0;y<x;y++)try{y>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(f,{tools:g.length>0?g:void 0});if(p.usage&&(E+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},f.push({role:"assistant",content:p.content}));for(const _ of p.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const T=await Le(_.name,_.arguments,t,r.id,{agentType:l.agent,providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},f.push({role:"user",content:`[Tool Result for ${_.name}]: ${T}`})}catch(T){await A(t,r.id,"tool",_.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},f.push({role:"user",content:`[Tool Error for ${_.name}]: ${T.message||"Execution failed"}`})}}continue}w=p.content;const h=50;for(let _=0;_<w.length;_+=h)yield{type:"chunk",data:{text:w.substring(_,_+h),threadId:i}},_+h<w.length&&await new Promise(I=>setTimeout(I,10));break}catch(p){if(n){const h=p.message||"",_=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),T=h.includes("429"),I=_?1440:T?10:5;await n.recordError(a.name,h,I)}await A(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:l.agent,provider:a.name,turn:y}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const U=new be;async function wn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}U.use("/*",wn);U.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
     ...
     LIMIT ?`).bind(t.id,a?1:0,r).all();return e.json({threads:n.results||[]})});U.post("/threads",async e=>{const t=e.get("user"),{title:a}=await e.req.json(),r=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a||"New conversation").first();return e.json({thread:r})});U.put("/threads/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),r=await e.req.json(),n=[],s=[];return r.title!==void 0&&(n.push("title = ?"),s.push(r.title)),r.is_archived!==void 0&&(n.push("is_archived = ?"),s.push(r.is_archived?1:0)),n.push("updated_at = CURRENT_TIMESTAMP"),s.push(a,t.id),n.length<=1?e.json({error:"Nothing to update"},400):(await e.env.DB.prepare(`UPDATE threads SET ${n.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});U.delete("/threads/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM conversations WHERE thread_id = ? AND user_id = ?").bind(a,t.id).run(),await e.env.DB.prepare("DELETE FROM threads WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});U.post("/upload",async e=>e.json({error:"File upload is not available in this version."},404));U.post("/send",async e=>{const t=e.get("user"),{message:a,channel:r="web",thread_id:n,files:s}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let o="";if(s&&Array.isArray(s)&&s.length>0){o=`

[Attached files:
`;for(const l of s)o+=`- ${l.name} (${l.type}, ${Math.round(l.size/1024)}KB, file_id: ${l.file_id})`,l.text_preview&&(o+=`
  Preview: ${l.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const l=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=l==null?void 0:l.id}const c={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:l,rotation:u}=await at(e.env.DB,t.id,t.pin_hash),m=await jt(c,e.env.DB,l,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});return!n&&i?await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run():i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),e.json({response:m,timestamp:new Date().toISOString(),channel:c.channel,provider:l.name,thread_id:i})}catch(l){console.error("Chat error:",l);const u=l.message||"";if(u.includes("No LLM provider configured"))return e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400);if(u.includes("All LLM providers failed"))return e.json({error:u,type:"no_provider",thread_id:i},400);if(u.includes("limit reached"))return e.json({error:u,type:"cost_limit",thread_id:i},429);const m=u.includes("401")||u.includes("403")||u.includes("authentication")||u.includes("credit balance")||u.includes("invalid")&&u.includes("key");try{const{logError:g}=await Promise.resolve().then(()=>Ct);await g(e.env.DB,t.id,"llm","chat_error",u)}catch{}return e.json({error:m?"API key error — your provider returned an authentication or billing error. Check Settings → Keys to verify your API keys are valid.":"Something went wrong. I'll be back in a moment.",details:u,type:m?"no_provider":void 0,thread_id:i},m?400:500)}});function Xt(e){return`event: ${e.type}
data: ${JSON.stringify(e.data)}

`}U.post("/stream",async e=>{const t=e.get("user"),{message:a,channel:r="web",thread_id:n,files:s}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let o="";if(s&&Array.isArray(s)&&s.length>0){o=`

[Attached files:
`;for(const l of s)o+=`- ${l.name} (${l.type}, ${Math.round(l.size/1024)}KB, file_id: ${l.file_id})`,l.text_preview&&(o+=`
  Preview: ${l.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const l=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=l==null?void 0:l.id}const c={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:l,rotation:u}=await at(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(g){const v=new TextEncoder;try{const f=bn(c,e.env.DB,l,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of f)x.data.threadId||(x.data.threadId=i),g.enqueue(v.encode(Xt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),g.close()}catch(f){const x={type:"error",data:{error:f.message||"An error occurred",threadId:i}};g.enqueue(v.encode(Xt(x))),g.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(l){console.error("Stream setup error:",l);const u=l.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});U.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?`).bind(t.id,a,r).all();return e.json({messages:(n.results||[]).reverse(),total:((s=n.results)==null?void 0:s.length)||0})});U.get("/history",async e=>{var c;const t=e.get("user"),a=parseInt(e.req.query("limit")||"50"),r=parseInt(e.req.query("offset")||"0"),n=e.req.query("thread_id");let s,o;n?(s=`SELECT id, role, content, channel, thread_id, created_at FROM conversations 
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function En(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
You MUST call list_calendar_events immediately.${qe}`:a==="check_sheet"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
You MUST call read_sheet immediately with the relevant spreadsheet.${qe}`:a==="custom"&&t?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${qe}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${qe}`}function Tn(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function kn(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const rt=new be,Sn=4e3;async function j(e,t,a,r="Markdown"){var s,o;const n=On(a,Sn);for(const i of n)try{const c=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i,parse_mode:r,disable_web_page_preview:!1})});if(!c.ok){const l=await c.json().catch(()=>null);((s=l==null?void 0:l.description)!=null&&s.includes("parse")||(o=l==null?void 0:l.description)!=null&&o.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i})})}}catch{}}async function In(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function On(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let n=r.lastIndexOf(`
`,t);n<t*.3&&(n=r.lastIndexOf(" ",t)),n<t*.3&&(n=t),a.push(r.substring(0,n)),r=r.substring(n).trimStart()}return a}async function Dn(e,t,a,r,n){switch(e.split("@")[0].toLowerCase()){case"/start":{const o=(r==null?void 0:r.name)||"there",i=(r==null?void 0:r.assistant_name)||"Karna",c=`👋 *Hello, ${o}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await j(a,t,c),!0}case"/help":{const i=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await j(a,t,i),!0}case"/status":{if(!r)return await j(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[o,i,c,l]=await Promise.all([n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),u=`📊 *System Status*
...
Status: ✅ Online`;await j(a,t,u)}catch{await j(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await j(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await j(a,t,"⚠️ Account not linked."),!0);case"/tasks":{if(!r)return await j(a,t,"⚠️ Account not linked."),!0;try{const i=(await n.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(i.length===0)return await j(a,t,"✅ No open tasks. You're all clear."),!0;const c=new Date,l=new Date(c);l.setDate(l.getDate()+1),l.setHours(23,59,59,999);const u=[`📋 *Open Tasks (${i.length})*
`];for(const m of i){let g="";if(m.due_date){const v=new Date(m.due_date);v<c?g=" ⚠️ _overdue_":v<=l?g=" 🔴 _due today_":g=` _${v.toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}u.push(`☐ ${m.title}${g}`)}u.push(`
_Say "mark [task] as done" to close a task._`),await j(a,t,u.join(`
`))}catch(o){await j(a,t,"❌ Could not fetch tasks: "+o.message)}return!0}default:return!1}}rt.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await Cn(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const c=!!i.text,l=!!i.voice,u=!!i.document,m=!!i.photo,g=!!i.caption;if(!c&&!l&&!u&&!m)return e.json({ok:!0});const v=String(i.chat.id);let f=i.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let w=null;if(x){const h=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();h&&(w=await P(h.encrypted_value,x.pin_hash))}if(!w){const h=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();h&&(w=await P(h.encrypted_value,h.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(f.startsWith("/")&&await Dn(f,v,w,x,e.env.DB))return e.json({ok:!0});if(!x)return await j(w,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&w&&x)try{await j(w,v,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${i.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const I=await(await fetch(`https://api.telegram.org/file/bot${w}/${_.result.file_path}`)).blob();let O="",L="",k="whisper-1";const D=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const $ of D.results){const Y=await P($.encrypted_value,x.pin_hash);if($.service==="openai"){O="https://api.openai.com/v1/audio/transcriptions",L=Y;break}else if($.service.startsWith("llm_slot_"))try{const J=JSON.parse(Y);if(J.provider==="openai"){O="https://api.openai.com/v1/audio/transcriptions",L=J.apiKey;break}else if(J.provider==="groq"){O="https://api.groq.com/openai/v1/audio/transcriptions",L=J.apiKey,k="whisper-large-v3";break}}catch{}}if(!O)return await j(w,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const R=new FormData;R.append("file",I,"voice.ogg"),R.append("model",k),R.append("language","en");const B=await fetch(O,{method:"POST",headers:{Authorization:`Bearer ${L}`},body:R});if(!B.ok){const $=await B.text();return await j(w,v,`⚠️ Transcription failed: ${B.status} ${$}`),e.json({ok:!0})}f=(await B.json()).text,await j(w,v,`🗣️ *You said:* ${f}`)}}catch(h){return await j(w,v,`⚠️ Failed to process voice note: ${h.message}`),e.json({ok:!0})}if((u||m)&&w&&x)try{let h,_="unknown",T="unknown",I=0;if(u)h=i.document.file_id,_=i.document.file_name||"document",T=i.document.mime_type||"unknown",I=i.document.file_size||0;else if(m){const O=i.photo[i.photo.length-1];h=O.file_id,_="photo.jpg",T="image/jpeg",I=O.file_size||0}if(h){const L=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${h}`)).json();let k="";if(L.ok&&((a=L.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(_)||/^text\/|application\/json|application\/xml|application\/csv/i.test(T))&&I<5e4)try{k=await(await fetch(`https://api.telegram.org/file/bot${w}/${L.result.file_path}`)).text()}catch{}const D=i.caption||"",R=`[Telegram file received: "${_}" (${T}, ${Math.round(I/1024)}KB)]`;k?f=`${D?D+`

`:""}${R}
File contents:
${k.substring(0,8e3)}${k.length>8e3?`
[...truncated]`:""}`:f=`${D?D+`

`:""}${R}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(h){if(g&&i.caption)f=i.caption;else return await j(w,v,`⚠️ Received your file but couldn't process it: ${h.message}`),e.json({ok:!0})}if(!f)return e.json({ok:!0});await In(w,v);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=Tn(x.id,x.username,f,v);d.metadata={thread_id:E.id};let y,p;try{const h=await at(e.env.DB,x.id,x.pin_hash);y=h.provider,p=h.rotation}catch(h){console.error("Telegram provider setup error:",h);const _=(r=h.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=h.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${h.message||"Unknown error"}`;return await j(w,v,_),e.json({ok:!0})}try{const h=await jt(d,e.env.DB,y,x,p,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),_=kn(h,"telegram");await j(w,v,_||"(empty response)")}catch(h){console.error("Telegram agent error:",h);const _=(s=h.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${y.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(h.message||"Unknown").substring(0,200)}`;await j(w,v,_);try{const{logError:T}=await Promise.resolve().then(()=>Ct);await T(e.env.DB,x.id,"telegram","agent_error",h.message||"Agent error",{provider:y.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>Ct);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});rt.post("/setup-webhook",async e=>{var c;const t=(c=e.req.header("Authorization"))==null?void 0:c.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await P(n.encrypted_value,a.pin_hash);if(!r){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});rt.get("/webhook-status",async e=>{var s,o,i,c,l,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await P(r.encrypted_value,a.pin_hash);try{const g=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=g.result)==null?void 0:o.url)||"",has_webhook:!!((i=g.result)!=null&&i.url),pending_updates:((c=g.result)==null?void 0:c.pending_update_count)||0,last_error:((l=g.result)==null?void 0:l.last_error_message)||"",last_error_date:((u=g.result)==null?void 0:u.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});rt.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await P(r.encrypted_value,a.pin_hash);try{const l=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();l&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:l,allowed_updates:["message"]})});const g=m.result||[];if(g.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],f=new Set;for(let w=g.length-1;w>=0;w--){const E=g[w].message;if(E&&E.chat){const d=String(E.chat.id);f.has(d)||(f.add(d),v.push({chat_id:d,name:[E.chat.first_name,E.chat.last_name].filter(Boolean).join(" ")||E.chat.title||"Unknown",username:E.chat.username||"",date:new Date((E.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const x=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(x,a.user_id).run(),e.json({found:!0,chat_id:x,name:v[0].name,all_chats:v,message:`Chat ID ${x} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function Cn(e,t){var x;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const o=r.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],c=parseInt(o[2]);if(!c||!i)return;const l=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const m=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(u.id,c,i).first();if(!m)return;const g=m.checked?0:1;await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ?
  `).bind(g,g,m.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!v)return;const f=await P(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:g?"✅ Checked!":"☐ Unchecked"})}),(x=n.reply_markup)!=null&&x.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(E=>E.map(d=>{var y;if((y=d.callback_data)!=null&&y.includes(i)){const p=g?"✅":"☐",h=d.text.replace(/^[☐✅]\s*/,"");return{...d,text:`${p} ${h}`}}return d}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function Rn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function An(e,t,a,r,n,s){try{return(await new Bt(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(c=>{var l;return{id:c.id||`google-${Date.now()}`,title:c.summary||"Untitled Event",startTime:c.start.dateTime||c.start.date||"",endTime:c.end.dateTime||c.end.date||"",location:c.location,attendees:(l=c.attendees)==null?void 0:l.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function Nn(e,t,a,r,n){try{const s=new oe(e,t,a,r,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),c={};for(const m of o){const g=m.from.split("<")[0].trim()||m.from;c[g]=(c[g]||0)+1}const l=Object.entries(c).sort(([,m],[,g])=>g-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:l,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Ln(e,t){try{const a=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),r=new Date,n=new Date(r);n.setDate(n.getDate()+1),n.setHours(23,59,59,999);const s=a.results||[],o=s.map(c=>{if(c.due_date){const l=new Date(c.due_date),u=l<=r?"overdue":l<=n?"due today":l.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${c.title} [${u}]`}return c.title}),i=s.filter(c=>c.due_date?new Date(c.due_date)<=n:!1).length;return{pending:s.length,dueToday:i,items:o}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function $n(e,t){try{const a=Math.floor((Date.now()-1728e5)/1e3),r=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${a},points>10`,n=await fetch(r,{headers:{"User-Agent":"Karna/1.0"}});return n.ok?((await n.json()).hits||[]).filter(o=>o.url&&!t.has(o.url)).slice(0,2).map(o=>({title:o.title,summary:`${o.points} pts · ${o.num_comments} comments on HN`,url:o.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const Qt=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function Mn(e,t,a){const r=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],n=new Set;if(t&&a)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(a).all()).results||[]).forEach(l=>n.add(l.url))}catch{}const s=[];if(r.some(c=>Qt.some(l=>c.toLowerCase().includes(l.toLowerCase())))){const c=r.find(u=>Qt.some(m=>u.toLowerCase().includes(m.toLowerCase())))||"AI agents",l=await $n(c,n);for(const u of l)s.push(u),n.add(u.url)}for(const c of r){if(s.length>=8)break;const l=`latest ${c} news today`;try{const u=await gt(l,{num:5});if(u.results)for(const m of u.results){if(s.length>=8)break;n.has(m.link)||(s.push({title:m.title,summary:m.snippet,url:m.link,source:m.displayLink}),n.add(m.link))}}catch(u){console.error(`News search error for "${l}":`,u.message)}}const i=s.slice(0,7);if(t&&a&&i.length>0)for(const c of i)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(a,c.url,c.title).run()}catch{}return i}function Bn(e,t){const a=[],r=t;a.push(`🗓 Your ${r} Brief — ${e.targetDate}`),a.push("");const n=e.calendar.totalCount;if(n>0){a.push(`📅 Tomorrow: ${n} event${n===1?"":"s"}`);for(const o of e.calendar.google.slice(0,5)){const i=o.startTime?new Date(o.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";a.push(`   • ${i} ${o.title}`)}}else a.push("📅 Tomorrow: Nothing scheduled");a.push("");const s=e.emails.gmail.unreadCount;if(s>0?(a.push(`📧 Gmail: ${s} unread`),e.emails.gmail.importantCount>0&&a.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&a.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&a.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):a.push("📧 Gmail: Inbox clear"),a.push(""),e.tasks.pending>0){a.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const o of e.tasks.items)a.push(`   ☐ ${o}`)}else a.push("✅ Tasks: All clear");if(a.push(""),e.news.items.length>0){a.push("📡 Today's Signal:");for(const o of e.news.items){const i=o.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${o.source}`;a.push(`   • ${o.title.substring(0,90)}${o.title.length>90?"…":""}`),a.push(`     ${i} — ${o.summary.substring(0,80)}${o.summary.length>80?"…":""}`)}}return a.join(`
`)}function jn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Pn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function er(e,t,a){var d,y;const r=t.timezone||"Asia/Kolkata",n=Rn(r),{components:s,newsTopics:o}=await Pn(e,t.id),i=[],c=[];s.google_calendar&&(i.push(An(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),c.push("googleEvents")),s.gmail&&(i.push(Nn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),c.push("gmailSummary")),s.tasks&&(i.push(Ln(e,t.id)),c.push("tasks")),s.news&&(i.push(Mn(o,e,t.id)),c.push("news"));const l=await Promise.all(i),u={};c.forEach((p,h)=>{u[p]=l[h]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((d=u.googleEvents)==null?void 0:d.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||g,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((y=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:y.briefing_time)||"20:00";v.summary=Bn(v,f);const x=jn(v),w=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(v)).first(),E=(w==null?void 0:w.id)||0;for(const p of x)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(E,p.type,p.key,p.text,JSON.stringify(p.metadata),p.sortOrder).run();return{briefingId:E,content:v,items:x}}async function Un(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function Hn(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function Gn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
    ...
    LIMIT ?
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function zn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),c=n*60+s,l=o*60+i;return c===l}function Fn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const Z=new be;async function Wn(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}Z.use("/*",Wn);Z.get("/briefings",async e=>{const t=e.get("user"),a=parseInt(e.req.query("limit")||"10");try{const r=await Gn(e.env.DB,t.id,a);return e.json({briefings:r})}catch(r){return e.json({error:r.message},500)}});Z.get("/briefings/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const r=await Un(e.env.DB,t.id,a);return r?e.json(r):e.json({error:"Briefing not found"},404)}catch(r){return e.json({error:r.message},500)}});Z.post("/briefings/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.param("itemId"));try{const n=await Hn(e.env.DB,t.id,a,r);return n?e.json(n):e.json({error:"Item not found"},404)}catch(n){return e.json({error:n.message},500)}});Z.post("/briefings/generate",async e=>{const t=e.get("user");try{const a=await er(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(a)}catch(a){return e.json({error:a.message},500)}});Z.get("/briefing-preferences",async e=>{const t=e.get("user");try{const a=await e.env.DB.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t.id).first();if(!a){const n={briefingTime:"20:00",briefingEnabled:!0,components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0,weather:!1},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"],notificationChannels:{telegram:!0,web:!0},proactiveLevel:"moderate"};return e.json({preferences:n})}const r={briefingTime:a.briefing_time,briefingEnabled:a.briefing_enabled!==0,components:JSON.parse(a.components),newsTopics:a.news_topics.split(",").map(n=>n.trim()).filter(Boolean),notificationChannels:JSON.parse(a.notification_channels),proactiveLevel:a.proactive_level};return e.json({preferences:r})}catch(a){return e.json({error:a.message},500)}});Z.post("/briefing-preferences",async e=>{const t=e.get("user"),a=await e.req.json(),r=[];if(a.briefingTime&&(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.test(a.briefingTime)||r.push("Invalid time format. Use HH:MM (e.g., 20:00)")),a.newsTopics&&(a.newsTopics.length>5&&r.push("Maximum 5 news topics allowed"),a.newsTopics.some(n=>n.length>50)&&r.push("Each news topic must be 50 characters or less")),a.proactiveLevel&&!["conservative","moderate","aggressive"].includes(a.proactiveLevel)&&r.push("Invalid proactive level. Use conservative, moderate, or aggressive"),r.length>0)return e.json({error:r.join("; ")},400);try{const n=await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first(),s=a.components?JSON.stringify(a.components):null,o=a.notificationChannels?JSON.stringify(a.notificationChannels):null,i=a.newsTopics?a.newsTopics.join(", "):null;if(n){const c=[],l=[];a.briefingTime!==void 0&&(c.push("briefing_time = ?"),l.push(a.briefingTime)),a.briefingEnabled!==void 0&&(c.push("briefing_enabled = ?"),l.push(a.briefingEnabled?1:0)),s!==null&&(c.push("components = ?"),l.push(s)),i!==null&&(c.push("news_topics = ?"),l.push(i)),o!==null&&(c.push("notification_channels = ?"),l.push(o)),a.proactiveLevel!==void 0&&(c.push("proactive_level = ?"),l.push(a.proactiveLevel)),c.length>0&&(c.push("updated_at = CURRENT_TIMESTAMP"),l.push(t.id),await e.env.DB.prepare(`UPDATE briefing_preferences SET ${c.join(", ")} WHERE user_id = ?`).bind(...l).run())}else await e.env.DB.prepare(`
        INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(t.id,a.briefingTime||"20:00",s||'{"google_calendar":true,"gmail":true,"tasks":true,"news":true}',i||"AI, LLM, Tools, Agentic Workflows, AI Features",o||'{"telegram":true,"web":true}',a.proactiveLevel||"moderate").run();return e.json({success:!0})}catch(n){return e.json({error:n.message},500)}});Z.post("/briefing-preferences/init-defaults",async e=>{const t=e.get("user");try{return await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first()?e.json({success:!0,message:"Preferences already exist"}):(await e.env.DB.prepare(`
      INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",c=o.briefing_time||"20:00";if(zn(c,i,s))try{const l=await er(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:m}=Fn(l.content,l.items);await qn(e.env.DB,o,u,m,l.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:l.briefingId,briefing_time:c,timezone:i})}catch(l){n.push({user_id:o.id,status:"error",error:l.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});Z.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const c of r.results||[])try{const l=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(c.id).first();if(!l)continue;const u=await P(l.encrypted_value,c.pin_hash),g=JSON.parse(u).access_token;if(!g)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${g}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(d=>{var p;const y=(p=d.start)==null?void 0:p.dateTime;return y?y>=s.toISOString()&&y<=o:!1});if(x.length===0){n.push({user_id:c.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(c.id).first();if(!w)continue;const E=await P(w.encrypted_value,c.pin_hash);for(const d of x){const y=new Date(d.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=d.location?`
📍 ${d.location}`:"",h=`⏰ Meeting in 10 minutes!

*${d.summary||"Untitled Event"}*
🕐 ${y}${p}`;await fetch(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c.telegram_chat_id,text:h,parse_mode:"Markdown"})})}n.push({user_id:c.id,reminders_sent:x.length})}catch(l){n.push({user_id:c.id,status:"error",error:l.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function qn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const o=await P(s.encrypted_value,s.pin_hash);await fetch(`https://api.telegram.org/bot${o}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(c=>({...c,callback_data:`${c.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}Z.delete("/briefings/:id",async e=>{const t=e.get("user"),a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});const ae=new be;ae.use("/api/*",Ur());ae.route("/api/auth",we);ae.route("/api/chat",U);ae.route("/api/settings",H);ae.route("/api/system",pe);ae.route("/api/telegram",rt);ae.route("/api/proactive",Z);ae.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ce(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Ce(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Ce(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Ce(!1,"Session expired. Please log in again and retry."));const c=i.user_id,l=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,m=await $a(e.env.DB,c,l,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Ce(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Ce(!1,`OAuth failed: ${s.message}`))}});ae.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(xa())));ae.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(xa())));function Ce(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function Kn(e,t,a){const r="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const i=await(await fetch(`${r}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(i.results&&i.results.length>0){const l=i.results.filter(m=>m.needs_agent&&m.status==="dispatched");if(l.length>0){const m=l.map(g=>fetch(`${r}/api/system/cron/run-task/${g.job_id}`,{method:"POST",headers:s}).then(v=>v.json()).catch(v=>({job_id:g.job_id,error:v.message})));a.waitUntil(Promise.allSettled(m).then(g=>{console.log(`Cron: ${i.executed} dispatched, ${l.length} agent tasks`,JSON.stringify(g.map(v=>v.status==="fulfilled"?v.value:v.reason)))}))}const u=i.results.filter(m=>!m.needs_agent&&m.status==="dispatched");if(u.length>0){const m=u.map(g=>fetch(`${r}/api/system/cron/run-task/${g.job_id}`,{method:"POST",headers:s}).catch(()=>{}));a.waitUntil(Promise.allSettled(m))}}a.waitUntil(fetch(`${r}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(l=>l.json()).then(l=>{l.executed>0&&console.log("Evening briefing result:",JSON.stringify(l))}).catch(l=>{console.error("Evening briefing error:",l.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${r}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(l=>l.json()).then(l=>{var u;(u=l.results)!=null&&u.some(m=>m.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(l))}).catch(()=>{}))}catch(o){console.error("Scheduled cron error:",o.message||o)}}const Yn={fetch:ae.fetch,scheduled:Kn},ea=new be,Jn=Object.assign({"/src/index.tsx":Yn});let tr=!1;for(const[,e]of Object.entries(Jn))e&&(ea.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ea.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),tr=!0);if(!tr)throw new Error("Can't import modules from ['/src/index.tsx']");export{ea as default};
