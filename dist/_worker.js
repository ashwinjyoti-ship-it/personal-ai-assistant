var Qa=Object.defineProperty;var Bt=e=>{throw TypeError(e)};var er=(e,t,a)=>t in e?Qa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var I=(e,t,a)=>er(e,typeof t!="symbol"?t+"":t,a),vt=(e,t,a)=>t.has(e)||Bt("Cannot "+a);var b=(e,t,a)=>(vt(e,t,"read from private field"),a?a.call(e):t.get(e)),C=(e,t,a)=>t.has(e)?Bt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),O=(e,t,a,r)=>(vt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(vt(e,t,"access private method"),a);var jt=(e,t,a,r)=>({set _(n){O(e,t,n,a)},get _(){return b(e,t,r)}});var Pt=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,c=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,l=await t(m,r),c=!0;else throw m}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},tr=Symbol(),ar=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ia?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?rr(e,{all:a,dot:r}):{}};async function rr(e,t){const a=await e.formData();return a?nr(a,t):{}}function nr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?sr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(or(a,r,n),delete a[r])}),a}var sr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},or=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},aa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ir=e=>{const{groups:t,path:a}=lr(e),r=aa(a);return cr(r,t)},lr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},cr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},rt={},dr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return rt[r]||(a[2]?rt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:rt[r]=[e,a[1],!0]),rt[r]}return null},Ct=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},ur=e=>Ct(e,decodeURI),ra=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return ur(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},pr=e=>{const t=ra(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ce=(e,t,...a)=>(a.length&&(t=Ce(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),na=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},bt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ct(e,oa):e):e,sa=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return bt(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=bt(l)),s=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=bt(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},mr=sa,hr=(e,t)=>sa(e,t,!0),oa=decodeURIComponent,Ut=e=>Ct(e,oa),Ne,K,ce,la,ca,Tt,pe,Vt,ia=(Vt=class{constructor(e,t="/",a=[[]]){C(this,ce);I(this,"raw");C(this,Ne);C(this,K);I(this,"routeIndex",0);I(this,"path");I(this,"bodyCache",{});C(this,pe,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,O(this,K,a),O(this,Ne,{})}param(e){return e?L(this,ce,la).call(this,e):L(this,ce,ca).call(this)}query(e){return mr(this.url,e)}queries(e){return hr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ar(this,e))}json(){return b(this,pe).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,pe).call(this,"text")}arrayBuffer(){return b(this,pe).call(this,"arrayBuffer")}blob(){return b(this,pe).call(this,"blob")}formData(){return b(this,pe).call(this,"formData")}addValidatedData(e,t){b(this,Ne)[e]=t}valid(e){return b(this,Ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[tr](){return b(this,K)}get matchedRoutes(){return b(this,K)[0].map(([[,e]])=>e)}get routePath(){return b(this,K)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ne=new WeakMap,K=new WeakMap,ce=new WeakSet,la=function(e){const t=b(this,K)[0][this.routeIndex][1][e],a=L(this,ce,Tt).call(this,t);return a&&/\%/.test(a)?Ut(a):a},ca=function(){const e={},t=Object.keys(b(this,K)[0][this.routeIndex][1]);for(const a of t){const r=L(this,ce,Tt).call(this,b(this,K)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ut(r):r)}return e},Tt=function(e){return b(this,K)[1]?b(this,K)[1][e]:e},pe=new WeakMap,Vt),gr={Stringify:1},da=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>da(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},fr="text/plain; charset=UTF-8",wt=(e,t)=>({"Content-Type":e,...t}),Je,Ve,se,$e,oe,W,Xe,Me,Be,xe,Ze,Qe,me,Ae,Xt,yr=(Xt=class{constructor(e,t){C(this,me);C(this,Je);C(this,Ve);I(this,"env",{});C(this,se);I(this,"finalized",!1);I(this,"error");C(this,$e);C(this,oe);C(this,W);C(this,Xe);C(this,Me);C(this,Be);C(this,xe);C(this,Ze);C(this,Qe);I(this,"render",(...e)=>(b(this,Me)??O(this,Me,t=>this.html(t)),b(this,Me).call(this,...e)));I(this,"setLayout",e=>O(this,Xe,e));I(this,"getLayout",()=>b(this,Xe));I(this,"setRenderer",e=>{O(this,Me,e)});I(this,"header",(e,t,a)=>{this.finalized&&O(this,W,new Response(b(this,W).body,b(this,W)));const r=b(this,W)?b(this,W).headers:b(this,xe)??O(this,xe,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});I(this,"status",e=>{O(this,$e,e)});I(this,"set",(e,t)=>{b(this,se)??O(this,se,new Map),b(this,se).set(e,t)});I(this,"get",e=>b(this,se)?b(this,se).get(e):void 0);I(this,"newResponse",(...e)=>L(this,me,Ae).call(this,...e));I(this,"body",(e,t,a)=>L(this,me,Ae).call(this,e,t,a));I(this,"text",(e,t,a)=>!b(this,xe)&&!b(this,$e)&&!t&&!a&&!this.finalized?new Response(e):L(this,me,Ae).call(this,e,t,wt(fr,a)));I(this,"json",(e,t,a)=>L(this,me,Ae).call(this,JSON.stringify(e),t,wt("application/json",a)));I(this,"html",(e,t,a)=>{const r=n=>L(this,me,Ae).call(this,n,t,wt("text/html; charset=UTF-8",a));return typeof e=="object"?da(e,gr.Stringify,!1,{}).then(r):r(e)});I(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});I(this,"notFound",()=>(b(this,Be)??O(this,Be,()=>new Response),b(this,Be).call(this,this)));O(this,Je,e),t&&(O(this,oe,t.executionCtx),this.env=t.env,O(this,Be,t.notFoundHandler),O(this,Qe,t.path),O(this,Ze,t.matchResult))}get req(){return b(this,Ve)??O(this,Ve,new ia(b(this,Je),b(this,Qe),b(this,Ze))),b(this,Ve)}get event(){if(b(this,oe)&&"respondWith"in b(this,oe))return b(this,oe);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,oe))return b(this,oe);throw Error("This context has no ExecutionContext")}get res(){return b(this,W)||O(this,W,new Response(null,{headers:b(this,xe)??O(this,xe,new Headers)}))}set res(e){if(b(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}O(this,W,e),this.finalized=!0}get var(){return b(this,se)?Object.fromEntries(b(this,se)):{}}},Je=new WeakMap,Ve=new WeakMap,se=new WeakMap,$e=new WeakMap,oe=new WeakMap,W=new WeakMap,Xe=new WeakMap,Me=new WeakMap,Be=new WeakMap,xe=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,me=new WeakSet,Ae=function(e,t,a){const r=b(this,W)?new Headers(b(this,W).headers):b(this,xe)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,$e);return new Response(e,{status:n,headers:r})},Xt),P="ALL",vr="all",br=["get","post","put","delete","options","patch"],ua="Can not add a route since the matcher is already built.",pa=class extends Error{},wr="__COMPOSED_HANDLER",_r=e=>e.text("404 Not Found",404),Ht=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},V,U,ma,X,we,ot,it,je,xr=(je=class{constructor(t={}){C(this,U);I(this,"get");I(this,"post");I(this,"put");I(this,"delete");I(this,"options");I(this,"patch");I(this,"all");I(this,"on");I(this,"use");I(this,"router");I(this,"getPath");I(this,"_basePath","/");C(this,V,"/");I(this,"routes",[]);C(this,X,_r);I(this,"errorHandler",Ht);I(this,"onError",t=>(this.errorHandler=t,this));I(this,"notFound",t=>(O(this,X,t),this));I(this,"fetch",(t,...a)=>L(this,U,it).call(this,t,a[1],a[0],t.method));I(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ce("/",t)}`,a),r,n)));I(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,U,it).call(this,t.request,t,void 0,t.request.method))})});[...br,vr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?O(this,V,o):L(this,U,we).call(this,s,b(this,V),o),i.forEach(l=>{L(this,U,we).call(this,s,b(this,V),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){O(this,V,l);for(const c of[s].flat())i.map(u=>{L(this,U,we).call(this,c.toUpperCase(),b(this,V),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?O(this,V,s):(O(this,V,"*"),o.unshift(s)),o.forEach(i=>{L(this,U,we).call(this,P,b(this,V),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ra:pr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Ht?s=n.handler:(s=async(i,l)=>(await Pt([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[wr]=n.handler),L(o=r,U,we).call(o,n.method,n.path,s)}),this}basePath(t){const a=L(this,U,ma).call(this);return a._basePath=Ce(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ce(this._basePath,t),c=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,u)}})());const i=async(l,c)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await c()};return L(this,U,we).call(this,P,Ce(t,"*"),i),this}},V=new WeakMap,U=new WeakSet,ma=function(){const t=new je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,O(t,X,b(this,X)),t.routes=this.routes,t},X=new WeakMap,we=function(t,a,r){t=t.toUpperCase(),a=Ce(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},ot=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},it=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await L(this,U,it).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new yr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,X)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await b(this,X).call(this,i)})}catch(u){return L(this,U,ot).call(this,u,i)}return c instanceof Promise?c.then(u=>u||(i.finalized?i.res:b(this,X).call(this,i))).catch(u=>L(this,U,ot).call(this,u,i)):c??b(this,X).call(this,i)}const l=Pt(o[0],this.errorHandler,b(this,X));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return L(this,U,ot).call(this,c,i)}})()},je),ha=[];function Er(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[P],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],ha];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var ct="[^/]+",We=".*",qe="(?:|/.*)",Le=Symbol(),Tr=new Set(".\\+*[^]$()");function kr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===ct?1:t===ct?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ee,Te,Z,Ie,Sr=(Ie=class{constructor(){C(this,Ee);C(this,Te);C(this,Z,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Ee)!==void 0)throw Le;if(s)return;O(this,Ee,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",We]:["","",ct]:o==="/*"?["","",qe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let m=l[2]||ct;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Le;if(c=b(this,Z)[m],!c){if(Object.keys(b(this,Z)).some(y=>y!==We&&y!==qe))throw Le;if(s)return;c=b(this,Z)[m]=new Ie,u!==""&&O(c,Te,n.varIndex++)}!s&&u!==""&&r.push([u,b(c,Te)])}else if(c=b(this,Z)[o],!c){if(Object.keys(b(this,Z)).some(u=>u.length>1&&u!==We&&u!==qe))throw Le;if(s)return;c=b(this,Z)[o]=new Ie}c.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,Z)).sort(kr).map(r=>{const n=b(this,Z)[r];return(typeof b(n,Te)=="number"?`(${r})@${b(n,Te)}`:Tr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Ee)=="number"&&a.unshift(`#${b(this,Ee)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Ee=new WeakMap,Te=new WeakMap,Z=new WeakMap,Ie),ut,et,Zt,Ir=(Zt=class{constructor(){C(this,ut,{varIndex:0});C(this,et,new Sr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return n[o]=[c,l],o++,i=!0,c}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return b(this,et).insert(s,t,r,b(this,ut),a),r}buildRegExp(){let e=b(this,et).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},ut=new WeakMap,et=new WeakMap,Zt),Dr=[/^$/,[],Object.create(null)],lt=Object.create(null);function ga(e){return lt[e]??(lt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Or(){lt=Object.create(null)}function Rr(e){var c;const t=new Ir,a=[];if(e.length===0)return Dr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[y,v])=>u?1:y?-1:m.length-v.length),n=Object.create(null);for(let u=0,m=-1,y=r.length;u<y;u++){const[v,g,x]=r[u];v?n[g]=[x.map(([T])=>[T,Object.create(null)]),ha]:m++;let w;try{w=t.insert(g,m,v)}catch(T){throw T===Le?new pa(g):T}v||(a[m]=x.map(([T,d])=>{const f=Object.create(null);for(d-=1;d>=0;d--){const[p,h]=w[d];f[p]=h}return[T,f]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=a.length;u<m;u++)for(let y=0,v=a[u].length;y<v;y++){const g=(c=a[u][y])==null?void 0:c[1];if(!g)continue;const x=Object.keys(g);for(let w=0,T=x.length;w<T;w++)g[x[w]]=i[g[x[w]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function Oe(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ga(a).test(t))return[...e[a]]}}var he,ge,pt,fa,Qt,Cr=(Qt=class{constructor(){C(this,pt);I(this,"name","RegExpRouter");C(this,he);C(this,ge);I(this,"match",Er);O(this,he,{[P]:Object.create(null)}),O(this,ge,{[P]:Object.create(null)})}add(e,t,a){var i;const r=b(this,he),n=b(this,ge);if(!r||!n)throw new Error(ua);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(c=>{l[e][c]=[...l[P][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ga(t);e===P?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=Oe(r[c],t)||Oe(r[P],t)||[])}):(i=r[e])[t]||(i[t]=Oe(r[e],t)||Oe(r[P],t)||[]),Object.keys(r).forEach(c=>{(e===P||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,s])})}),Object.keys(n).forEach(c=>{(e===P||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,s]))});return}const o=na(t)||[t];for(let l=0,c=o.length;l<c;l++){const u=o[l];Object.keys(n).forEach(m=>{var y;(e===P||e===m)&&((y=n[m])[u]||(y[u]=[...Oe(r[m],u)||Oe(r[P],u)||[]]),n[m][u].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,ge)).concat(Object.keys(b(this,he))).forEach(t=>{e[t]||(e[t]=L(this,pt,fa).call(this,t))}),O(this,he,O(this,ge,void 0)),Or(),e}},he=new WeakMap,ge=new WeakMap,pt=new WeakSet,fa=function(e){const t=[];let a=e===P;return[b(this,he),b(this,ge)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?Rr(t):null},Qt),fe,ie,ea,Ar=(ea=class{constructor(e){I(this,"name","SmartRouter");C(this,fe,[]);C(this,ie,[]);O(this,fe,e.routers)}add(e,t,a){if(!b(this,ie))throw new Error(ua);b(this,ie).push([e,t,a])}match(e,t){if(!b(this,ie))throw new Error("Fatal error");const a=b(this,fe),r=b(this,ie),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof pa)continue;throw l}this.match=i.match.bind(i),O(this,fe,[i]),O(this,ie,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ie)||b(this,fe).length!==1)throw new Error("No active router has been determined yet.");return b(this,fe)[0]}},fe=new WeakMap,ie=new WeakMap,ea),Ge=Object.create(null),ye,F,ke,Pe,G,le,_e,Ue,Lr=(Ue=class{constructor(t,a,r){C(this,le);C(this,ye);C(this,F);C(this,ke);C(this,Pe,0);C(this,G,Ge);if(O(this,F,r||Object.create(null)),O(this,ye,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},O(this,ye,[n])}O(this,ke,[])}insert(t,a,r){O(this,Pe,++jt(this,Pe)._);let n=this;const s=ir(a),o=[];for(let i=0,l=s.length;i<l;i++){const c=s[i],u=s[i+1],m=dr(c,u),y=Array.isArray(m)?m[0]:c;if(y in b(n,F)){n=b(n,F)[y],m&&o.push(m[1]);continue}b(n,F)[y]=new Ue,m&&(b(n,ke).push(m),o.push(m[1])),n=b(n,F)[y]}return b(n,ye).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:b(this,Pe)}}),n}search(t,a){var l;const r=[];O(this,G,Ge);let s=[this];const o=aa(a),i=[];for(let c=0,u=o.length;c<u;c++){const m=o[c],y=c===u-1,v=[];for(let g=0,x=s.length;g<x;g++){const w=s[g],T=b(w,F)[m];T&&(O(T,G,b(w,G)),y?(b(T,F)["*"]&&r.push(...L(this,le,_e).call(this,b(T,F)["*"],t,b(w,G))),r.push(...L(this,le,_e).call(this,T,t,b(w,G)))):v.push(T));for(let d=0,f=b(w,ke).length;d<f;d++){const p=b(w,ke)[d],h=b(w,G)===Ge?{}:{...b(w,G)};if(p==="*"){const A=b(w,F)["*"];A&&(r.push(...L(this,le,_e).call(this,A,t,b(w,G))),O(A,G,h),v.push(A));continue}const[_,E,k]=p;if(!m&&!(k instanceof RegExp))continue;const S=b(w,F)[_],D=o.slice(c).join("/");if(k instanceof RegExp){const A=k.exec(D);if(A){if(h[E]=A[0],r.push(...L(this,le,_e).call(this,S,t,b(w,G),h)),Object.keys(b(S,F)).length){O(S,G,h);const N=((l=A[0].match(/\//))==null?void 0:l.length)??0;(i[N]||(i[N]=[])).push(S)}continue}}(k===!0||k.test(m))&&(h[E]=m,y?(r.push(...L(this,le,_e).call(this,S,t,h,b(w,G))),b(S,F)["*"]&&r.push(...L(this,le,_e).call(this,b(S,F)["*"],t,h,b(w,G)))):(O(S,G,h),v.push(S)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},ye=new WeakMap,F=new WeakMap,ke=new WeakMap,Pe=new WeakMap,G=new WeakMap,le=new WeakSet,_e=function(t,a,r,n){const s=[];for(let o=0,i=b(t,ye).length;o<i;o++){const l=b(t,ye)[o],c=l[a]||l[P],u={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==Ge||n&&n!==Ge))for(let m=0,y=c.possibleKeys.length;m<y;m++){const v=c.possibleKeys[m],g=u[c.score];c.params[v]=n!=null&&n[v]&&!g?n[v]:r[v]??(n==null?void 0:n[v]),u[c.score]=!0}}return s},Ue),Se,ta,Nr=(ta=class{constructor(){I(this,"name","TrieRouter");C(this,Se);O(this,Se,new Lr)}add(e,t,a){const r=na(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Se).insert(e,r[n],a);return}b(this,Se).insert(e,t,a)}match(e,t){return b(this,Se).search(e,t)}},Se=new WeakMap,ta),ve=class extends xr{constructor(e={}){super(e),this.router=e.router??new Ar({routers:[new Cr,new Nr]})}},$r=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(m,y){o.res.headers.set(m,y)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let y=a.allowHeaders;if(!(y!=null&&y.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(y=v.split(/\s*,\s*/))}return y!=null&&y.length&&(l("Access-Control-Allow-Headers",y.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function ya(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
- Time-aware: reference current date/time when relevant`;default:return""}}const sn=2e3,on=2e3,Wa=4;function Et(e){return Math.ceil(e.length/Wa)}function Ft(e,t){const a=t*Wa;return e.length<=a?e:e.slice(0,a)+`
...
`,sn):"",n=Ft(t,on);return`You are ${a} — a personal AI assistant. You are intelligent, direct, and genuinely helpful. You speak with clarity and warmth, never robotic. Your name is ${a} — always refer to yourself by this name if asked.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Wt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function ft(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function Ye(e,t,a,r,n,s,o,i,l,c,u,m){const y=Date.now();let v=!0,g="",x="";try{return x=await ln(e,t,a,r,s,o,i,l,c,u,m),x}catch(w){throw v=!1,g=w.message||"Unknown error",w}finally{const w=Date.now()-y;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?x:"").substring(0,500),v?1:0,g||null,w,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function ln(e,t,a,r,n,s,o,i,l,c,u){var y,v,g,x,w,T;const m=new Y(a);switch(e){case"create_schedule":{const d=new Date;let f;const p=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){f=new Date(d.getTime()+t.minutes_from_now*60*1e3);const E=f.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[k,S,D]=(E[0]||"").split("/");t.schedule_value=`${D}-${k}-${S} ${E[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const _=parseInt(t.schedule_value,10);f=new Date(d.getTime()+_*60*1e3)}else if(t.schedule_type==="daily"){const[_,E]=t.schedule_value.split(":").map(Number),k=d.toLocaleString("en-US",{timeZone:p}),S=new Date(k),D=new Date(S);D.setHours(_,E,0,0),D<=S&&D.setDate(D.getDate()+1);const A=new Date(D.toLocaleString("en-US",{timeZone:"UTC"})),N=new Date(D.toLocaleString("en-US",{timeZone:p})),$=A.getTime()-N.getTime();f=new Date(D.getTime()+$)}else if(t.schedule_type==="weekly"){const[_,E]=t.schedule_value.split(" "),[k,S]=(E||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(yt=>yt.toLowerCase()===_.toLowerCase()),N=d.toLocaleString("en-US",{timeZone:p}),$=new Date(N),H=new Date($);H.setHours(k,S,0,0);let q=(A-H.getDay()+7)%7;q===0&&H<=$&&(q=7),H.setDate(H.getDate()+q);const ae=new Date(H.toLocaleString("en-US",{timeZone:"UTC"})),De=new Date(H.toLocaleString("en-US",{timeZone:p})),ue=ae.getTime()-De.getTime();f=new Date(H.getTime()+ue)}else if(t.schedule_type==="once"){const[_,E]=t.schedule_value.split(" "),[k,S,D]=_.split("-").map(Number),[A,N]=(E||"00:00").split(":").map(Number),$=d.toLocaleString("en-US",{timeZone:p}),H=new Date($),q=new Date(H);q.setFullYear(k,S-1,D),q.setHours(A,N,0,0);const ae=new Date(q.toLocaleString("en-US",{timeZone:"UTC"})),De=new Date(q.toLocaleString("en-US",{timeZone:p})),ue=ae.getTime()-De.getTime();f=new Date(q.getTime()+ue);const yt=new Date(d.getTime()+120*1e3);if(f.getTime()<d.getTime()+60*1e3){const Xa=f.toISOString();f=yt;const Za=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${Xa} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${f.toISOString()}.]`;t._pastTimeWarning=Za}}else f=new Date(d.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),f.toISOString()).run();const h=t._pastTimeWarning||"";return`Schedule created: "${t.name}" — ${t.schedule_type} at ${t.schedule_value}. State: active. Next run: ${f.toISOString()}${h}`}case"list_schedules":{const f=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return f.length===0?"No scheduled tasks found.":f.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
...
`)}case"get_system_status":{const d=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),f=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),_=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),f=t.spreadsheet_id;let p=t.range;const h=await d.sheets.getMetadata(f),_=h.sheets;p.includes("!")||(p=`${_[0]}!${p}`);let E;try{E=await d.sheets.readRange(f,p)}catch(S){if((y=S.message)!=null&&y.includes("Unable to parse range")||(v=S.message)!=null&&v.includes("400")){const D=p.includes("!")?p.split("!")[1]:p;p=`${_[0]}!${D}`,E=await d.sheets.readRange(f,p)}else throw S}let k=`[Spreadsheet: "${h.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(S=>`"${S}"`).join(", ")}]
...
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new Y(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${h}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(d){return await R(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),f=t.calendar_id||"primary",p=t.days_ahead||7,h=new Date,_=new Date(h.getTime()+p*24*60*60*1e3),E=await d.calendar.listEvents(f,{timeMin:h.toISOString(),timeMax:_.toISOString(),query:t.query});return E.length===0?`No events found in the next ${p} days.`:E.map(k=>{var $;const S=k.start.dateTime||k.start.date||"TBD",D=k.end.dateTime||k.end.date||"",A=k.location?` 📍 ${k.location}`:"",N=(($=k.attendees)==null?void 0:$.map(H=>H.email).join(", "))||"";return`• ${k.summary} — ${S} to ${D}${A}${N?`
  Attendees: ${N}`:""}`}).join(`
`)}catch(d){return await R(a,r,"google","list_calendar",d.message),`Failed to list events: ${d.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),f=t.calendar_id||"primary",p=await d.calendar.createEvent(f,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
...
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new Y(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${h}
ID: ${p.documentId}
URL: ${p.url}`}catch(d){return await R(a,r,"google","create_doc",d.message),`Failed to create document: ${d.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const f=await new ee(a,r,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${f.title}"
...
`)}catch(d){return await R(a,r,"search","web_search",d.message),`Web search error: ${d.message}`}case"read_url":try{const d=t.url;if(!d||!d.startsWith("http://")&&!d.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const f=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>an),h=await p(d,f);return h.error?`Failed to read page: ${h.error}`:!h.text||h.text.length<20?`Page at ${d} returned no readable content.`:`Content from ${d} (${h.text.length} chars):

${h.text}`}catch(d){return await R(a,r,"search","read_url",d.message),`Read URL error: ${d.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const f=Ga(t.query,u,{depth:t.depth||"quick",site:t.site}),p=new Promise(E=>setTimeout(()=>E(null),45e3)),h=await Promise.race([f,p]);if(h===null){const{webSearch:E}=await Promise.resolve().then(()=>Xr),k=await E(t.query,{num:5});if(k.error||k.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let S=`Research took too long, but here are the top search results:

`;return S+=k.results.map((D,A)=>`${A+1}. **${D.title}**
   ${D.snippet}
   ${D.link}`).join(`

`),S}if(h.error)return`Research failed: ${h.error}`;let _=h.report;return h.sources.length>0&&(_+=`

---
**Sources** (`+h.pagesRead+` pages read):
`,_+=h.sources.map((E,k)=>`[${k+1}] ${E.title}
    ${E.url}`).join(`
`)),_}catch(d){return await R(a,r,"research","research",d.message),`Research error: ${d.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const f=await M(d.encrypted_value,n),p=await La(f,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((h,_)=>{const E=h.rating?` ★${h.rating} (${h.userRatingsTotal||0} reviews)`:"",k=h.openNow!==void 0?h.openNow?" · Open now":" · Closed":"",S=h.googleMapsUri?`
   ${h.googleMapsUri}`:"";return`${_+1}. **${h.name}**${E}${k}
   ${h.address}${S}
   [place_id: ${h.placeId}]`}).join(`

`)}catch(d){return await R(a,r,"google_api","search_places",d.message),`Places search error: ${d.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const f=await M(d.encrypted_value,n),p=await Na(f,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const h=p.details;let _=`**${h.name}**
...
Recent Reviews:`;for(const E of h.reviews)_+=`
— ${E.author} (★${E.rating}, ${E.time}): "${E.text}"`}return _}catch(d){return await R(a,r,"google_api","place_details",d.message),`Place details error: ${d.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const f=await M(d.encrypted_value,n),p=await $a(f,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const h=p.route;let _=`**${h.startAddress}** → **${h.endAddress}**
`;return _+=`📏 ${h.distance} · ⏱️ ${h.duration}`,h.durationInTraffic&&(_+=` (with traffic: ${h.durationInTraffic})`),_+=`
via ${h.summary}`,_+=`

Steps:`,h.steps.forEach((E,k)=>{_+=`
${k+1}. ${E.instruction} (${E.distance}, ${E.duration})`}),_}catch(d){return await R(a,r,"google_api","directions",d.message),`Directions error: ${d.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const f=await M(d.encrypted_value,n),p=await Pa(f,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let h=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(h+=` (with traffic: ${p.durationInTraffic})`),h}catch(d){return await R(a,r,"google_api","travel_time",d.message),`Travel time error: ${d.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const f=await M(d.encrypted_value,n),p=await Ma(f,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(d){return await R(a,r,"google_api","translate",d.message),`Translation error: ${d.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const f=await M(d.encrypted_value,n),p=await ja(f,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((h,_)=>{var E;return`${_+1}. **${h.title}**
   ${h.channelTitle} · ${((E=h.publishedAt)==null?void 0:E.split("T")[0])||""}
   ${h.description}
   ${h.url}`}).join(`

`)}catch(d){return await R(a,r,"google_api","youtube_search",d.message),`YouTube search error: ${d.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const f=await M(d.encrypted_value,n),p=await Ba(f,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((h,_)=>`${_+1}. ${h.address}
   Coordinates: ${h.lat}, ${h.lng}`).join(`
`)}catch(d){return await R(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Ot(e,t,a,r,n,s){var T;const o=new Y(t),i=(T=e.metadata)==null?void 0:T.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),m=[{role:"system",content:qa(r,l)},...c.map(d=>({role:d.role,content:d.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const y=10;let v="",g=0;const x=[];for(let d=0;d<y;d++)try{const f=await a.chat(m,{tools:gt});if(f.usage&&(g+=f.usage.promptTokens+f.usage.completionTokens),f.toolCalls&&f.toolCalls.length>0){f.content&&m.push({role:"assistant",content:f.content});for(const p of f.toolCalls){x.push(p.name);try{const h=await Ye(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);m.push({role:"user",content:`[Tool Result for ${p.name}]: ${h}`})}catch(h){await R(t,r.id,"tool",p.name,h.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${p.name}]: ${h.message||"Execution failed"}`})}}continue}v=f.content;break}catch(f){if(n){const p=f.message||"",h=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),_=p.includes("429"),E=h?1440:_?10:5;await n.recordError(a.name,p,E)}throw await R(t,r.id,"llm","provider_error",f.message||"Unknown LLM error",{provider:a.name,turn:d}),f}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}const w=x.length>0?`[TOOLS_USED: ${[...new Set(x)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",w+v,"{}",i),await o.compactHistory(r.id,30),v}const qt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function cn(e){for(const[t,a]of Object.entries(qt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return qt.default}function dn(e,t,a,r){const n=cn(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const c=Et(e);o.push({role:"system",content:e}),i+=c;const u=Et(a);i+=u;const m=s-i,y=[];let v=0;for(let g=t.length-1;g>=0;g--){const x=t[g],w=Et(x.content);if(v+w<=m)y.unshift({role:x.role,content:x.content}),v+=w;else{l=!0;break}}return o.push(...y),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*un(e,t,a,r,n,s){var w;const o=new Y(t),i=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),u=qa(r,l),m=dn(u,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const y=10;let v="",g=0;const x=[...m.messages];for(let T=0;T<y;T++)try{T>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:gt});if(d.usage&&(g+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const p of d.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const h=await Ye(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:h.substring(0,500)+(h.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${p.name}]: ${h}`})}catch(h){await R(t,r.id,"tool",p.name,h.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${h.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${p.name}]: ${h.message||"Execution failed"}`})}}continue}v=d.content;const f=50;for(let p=0;p<v.length;p+=f)yield{type:"chunk",data:{text:v.substring(p,p+f),threadId:i}},p+f<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(d){if(n){const f=d.message||"",p=f.includes("401")||f.includes("403")||f.includes("authentication")||f.includes("credit balance"),h=f.includes("429"),_=p?1440:h?10:5;await n.recordError(a.name,f,_)}await R(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:T}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:g}}}async function Mt(e,t,a,r,n,s){var u;const o=new Y(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=za(e.text,l);if(c.agent==="conversation")return mn(e,t,a,r,l,n,i);if(c.agent==="multi"||c.confidence<.5)return Ot(e,t,a,r,n,s);try{return await pn(c.agent,e,t,a,r,l,n,s,i)}catch(m){return await R(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${m.message}`,{route:c}),Ot(e,t,a,r,n,s)}}async function pn(e,t,a,r,n,s,o,i,l){const c=new Y(a),u=ft(n.timezone),m=dt(e,n,s,n.timezone,u),y=Fa(e,gt),v=await c.getRecentConversations(n.id,25,l),g=[{role:"system",content:m},...v.map(E=>({role:E.role,content:E.content})),{role:"user",content:t.text}];await c.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const x=10;let w="",T=0,d="",f=!1;const p=[];for(let E=0;E<x;E++)try{const k=await r.chat(g,{tools:y.length>0?y:void 0});if(k.usage&&(T+=k.usage.promptTokens+k.usage.completionTokens),k.toolCalls&&k.toolCalls.length>0){f=!0,k.content&&(d=k.content,g.push({role:"assistant",content:k.content}));for(const S of k.toolCalls){p.push(S.name);try{const D=await Ye(S.name,S.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g.push({role:"user",content:`[Tool Result for ${S.name}]: ${D}`})}catch(D){await R(a,n.id,"tool",S.name,D.message||"Tool execution failed"),g.push({role:"user",content:`[Tool Error for ${S.name}]: ${D.message||"Execution failed"}`})}}continue}w=k.content,!w&&d&&(w=d);break}catch(k){if(o){const S=k.message||"",D=S.includes("401")||S.includes("403")||S.includes("authentication")||S.includes("credit balance"),A=S.includes("429"),N=D?1440:A?10:5;await o.recordError(r.name,S,N)}throw await R(a,n.id,"llm","subagent_error",k.message||"Unknown error",{agent:e,provider:r.name,turn:E}),k}if(!f&&["scheduler","workspace","research"].includes(e)&&y.length>0){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),w.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{g.push({role:"assistant",content:w}),g.push({role:"user",content:`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${y.slice(0,3).map(k=>k.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`});const E=await r.chat(g,{tools:y});if(E.usage&&(T+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){f=!0;for(const S of E.toolCalls){p.push(S.name);try{const D=await Ye(S.name,S.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g.push({role:"user",content:`[Tool Result for ${S.name}]: ${D}`})}catch(D){g.push({role:"user",content:`[Tool Error for ${S.name}]: ${D.message||"Execution failed"}`})}}const k=await r.chat(g,{tools:y});k.content&&(w=k.content),k.usage&&(T+=k.usage.promptTokens+k.usage.completionTokens)}}catch(E){await R(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${E.message||"Unknown"}`,{originalResponse:w.substring(0,200)})}}if(o&&T>0)try{await o.recordUsage(r.name,T)}catch{}const _=p.length>0?`[TOOLS_USED: ${[...new Set(p)].join(", ")}] `:"";return await c.storeMessage(n.id,t.channel,"assistant",_+w,"{}",l),await c.compactHistory(n.id,30),w}async function mn(e,t,a,r,n,s,o){const i=new Y(t),l=ft(r.timezone),c=dt("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),m=[{role:"system",content:c},...u.map(g=>({role:g.role,content:g.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let y=0,v="";try{const g=await a.chat(m,{temperature:.8});g.usage&&(y=g.usage.promptTokens+g.usage.completionTokens),v=g.content}catch(g){if(s){const x=g.message||"",w=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),T=x.includes("429"),d=w?1440:T?10:5;await s.recordError(a.name,x,d)}throw await R(t,r.id,"llm","conversation_error",g.message,{provider:a.name}),g}if(s&&y>0)try{await s.recordUsage(a.name,y)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*hn(e,t,a,r,n,s){var d;const o=new Y(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=za(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*un(e,t,a,r,n,s);return}const u=ft(r.timezone),m=c.agent==="conversation"?dt("conversation",r,l,r.timezone,u):dt(c.agent,r,l,r.timezone,u),y=Fa(c.agent,gt),v=await o.getRecentConversations(r.id,25,i),g=[{role:"system",content:m},...v.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let w="",T=0;for(let f=0;f<x;f++)try{f>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(g,{tools:y.length>0?y:void 0});if(p.usage&&(T+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},g.push({role:"assistant",content:p.content}));for(const _ of p.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const E=await Ye(_.name,_.arguments,t,r.id,{agentType:c.agent,providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:E.substring(0,500)+(E.length>500?"...":""),threadId:i}},g.push({role:"user",content:`[Tool Result for ${_.name}]: ${E}`})}catch(E){await R(t,r.id,"tool",_.name,E.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${E.message||"Execution failed"}`,threadId:i}},g.push({role:"user",content:`[Tool Error for ${_.name}]: ${E.message||"Execution failed"}`})}}continue}w=p.content;const h=50;for(let _=0;_<w.length;_+=h)yield{type:"chunk",data:{text:w.substring(_,_+h),threadId:i}},_+h<w.length&&await new Promise(k=>setTimeout(k,10));break}catch(p){if(n){const h=p.message||"",_=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),E=h.includes("429"),k=_?1440:E?10:5;await n.recordError(a.name,h,k)}await R(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:c.agent,provider:a.name,turn:f}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&T>0)try{await n.recordUsage(a.name,T)}catch{}await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:T}}}const B=new ve;async function gn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}B.use("/*",gn);B.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const c of s)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:u}=await tt(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(y){const v=new TextEncoder;try{const g=hn(l,e.env.DB,c,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of g)x.data.threadId||(x.data.threadId=i),y.enqueue(v.encode(Kt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),y.close()}catch(g){const x={type:"error",data:{error:g.message||"An error occurred",threadId:i}};y.enqueue(v.encode(Kt(x))),y.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const u=c.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});B.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     WHERE cj.enabled = 1 AND cj.next_run <= ? AND (cj.state IS NULL OR cj.state != 'completed')`).bind(n).all(),o=[];for(const i of s.results||[])try{const l=i.user_timezone||"UTC";let c,u=!1,m=i.state||"active";if(i.schedule_type==="interval"){const g=parseInt(i.schedule_value,10);c=new Date(r.getTime()+g*60*1e3)}else if(i.schedule_type==="daily"){const[g,x]=i.schedule_value.split(":").map(Number),w=Yt(l),T=new Date(w);T.setHours(g,x,0,0),T<=w&&T.setDate(T.getDate()+1);const d=new Date(T.toLocaleString("en-US",{timeZone:"UTC"})),f=new Date(T.toLocaleString("en-US",{timeZone:l})),p=d.getTime()-f.getTime();c=new Date(T.getTime()+p)}else if(i.schedule_type==="weekly"){const[g,x]=i.schedule_value.split(" "),[w,T]=(x||"00:00").split(":").map(Number),f=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(D=>D.toLowerCase()===g.toLowerCase()),p=Yt(l),h=new Date(p);h.setHours(w,T,0,0);let _=(f-h.getDay()+7)%7;_===0&&h<=p&&(_=7),h.setDate(h.getDate()+_);const E=new Date(h.toLocaleString("en-US",{timeZone:"UTC"})),k=new Date(h.toLocaleString("en-US",{timeZone:l})),S=E.getTime()-k.getTime();c=new Date(h.getTime()+S)}else i.schedule_type==="once"?(u=!0,m="completed",c=new Date(r.getTime()+365*24*60*60*1e3)):c=new Date(r.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,c.toISOString(),u?0:i.enabled,m,i.id).run();const v=(JSON.parse(i.action_config||"{}").description||i.description)&&(i.action_type==="check_mail"||i.action_type==="check_calendar"||i.action_type==="check_sheet"||i.action_type==="custom");o.push({job_id:i.id,name:i.name,status:"dispatched",needs_agent:v,next_run:c.toISOString()})}catch(l){o.push({job_id:i.id,name:i.name,status:"error",error:l.message})}return e.json({executed:o.length,results:o,timestamp:n})});de.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);const r=parseInt(e.req.param("jobId"),10);if(!r)return e.json({error:"Invalid job ID"},400);const n=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(r).first();if(!n)return e.json({error:"Job not found"},404);const o=JSON.parse(n.action_config||"{}").description||n.description||"",i="⏰ "+(n.name||"Scheduled Task"),l=new Date().toISOString();let c="";try{const v={id:n.user_id,username:n.username||"user",name:n.user_name||"User",pin_hash:n.pin_hash||"",role:n.user_role||"",personality_prompt:n.personality_prompt||"",telegram_chat_id:n.telegram_chat_id||"",timezone:n.user_timezone||"UTC",assistant_name:n.assistant_name||"Karna",created_at:"",updated_at:""},g={userId:n.user_id,username:v.username,channel:"web",text:vn(n.name,o,n.action_type),sessionId:"cron-"+n.id,timestamp:l},{provider:x,rotation:w}=await tt(e.env.DB,n.user_id,n.pin_hash);c=n.action_type!=="reminder"&&o.length>0?await Mt(g,e.env.DB,x,v,w,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}):await Ot(g,e.env.DB,x,v,w,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(v){const g=v.message||"unknown error",x=g.includes("rate_limit")||g.includes("429")||g.includes("quota"),w=g.includes("timeout")||g.includes("Timeout");x?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":w?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await R(e.env.DB,n.user_id,"cron_agent","execution_error",g,{job_id:n.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(n.action_type))try{const v=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(n.user_id).first();(!v||v.cnt===0)&&await R(e.env.DB,n.user_id,"cron_verification","no_tools_called",`Cron job "${n.name}" (${n.action_type}) completed without any tool calls`,{job_id:n.id,action_type:n.action_type,response_preview:c.substring(0,200)})}catch{}const m=c||o||"Time for your scheduled task.",y=i+`
`+m;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(n.user_id,"reminder",i,m,"cron:"+n.id).run(),await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(n.user_id,"system","assistant",y,JSON.stringify({type:"cron",job_id:n.id})).run(),n.telegram_chat_id&&await yn(e.env.DB,n.user_id,n.telegram_chat_id,y),e.json({job_id:r,status:"completed",response_length:c.length})});async function Ka(e){var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return null;const a=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(a==null?void 0:a.user_id)||null}de.get("/health/tools",async e=>{var a;const t=await Ka(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
       ...
       ORDER BY calls DESC`).bind(t).all();return e.json({period:"last_24h",tool_stats:r.results,enforcement:{triggers:n.results,retry_results:((a=s.results)==null?void 0:a[0])||{total_retries:0,successful_retries:0}},cron:{executions:o.results,warnings:i.results},providers:l.results})}catch(r){return e.json({error:r.message||"Failed to fetch metrics"},500)}});de.get("/health/tools/recent",async e=>{const t=await Ka(e);if(!t)return e.json({error:"Not authenticated"},401);try{const a=await e.env.DB.prepare(`SELECT id, agent_type, provider_name, tool_name, tool_args, tool_result,
              success, error_message, latency_ms, was_enforcement_retry, channel, created_at
       FROM tool_execution_log
       WHERE user_id = ?
       ORDER BY id DESC LIMIT 50`).bind(t).all();return e.json({logs:a.results})}catch(a){return e.json({error:a.message},500)}});function vn(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}. Respond with a short, clean plain-text summary.`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.) and present the results as a concise plain-text summary.`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}. Respond with a short, clean plain-text summary.`}function bn(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function wn(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const at=new ve,_n=4e3;async function z(e,t,a,r="Markdown"){var s,o;const n=En(a,_n);for(const i of n)try{const l=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i,parse_mode:r,disable_web_page_preview:!1})});if(!l.ok){const c=await l.json().catch(()=>null);((s=c==null?void 0:c.description)!=null&&s.includes("parse")||(o=c==null?void 0:c.description)!=null&&o.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i})})}}catch{}}async function xn(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function En(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let n=r.lastIndexOf(`
`,t);n<t*.3&&(n=r.lastIndexOf(" ",t)),n<t*.3&&(n=t),a.push(r.substring(0,n)),r=r.substring(n).trimStart()}return a}async function Tn(e,t,a,r,n){switch(e.split("@")[0].toLowerCase()){case"/start":{const o=(r==null?void 0:r.name)||"there",i=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${o}!*
...
Status: ✅ Online`;await z(a,t,u)}catch{await z(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await z(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await z(a,t,"⚠️ Account not linked."),!0);default:return!1}}at.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await kn(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const l=!!i.text,c=!!i.voice,u=!!i.document,m=!!i.photo,y=!!i.caption;if(!l&&!c&&!u&&!m)return e.json({ok:!0});const v=String(i.chat.id);let g=i.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let w=null;if(x){const h=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();h&&(w=await M(h.encrypted_value,x.pin_hash))}if(!w){const h=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();h&&(w=await M(h.encrypted_value,h.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(g.startsWith("/")&&await Tn(g,v,w,x,e.env.DB))return e.json({ok:!0});if(!x)return await z(w,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&w&&x)try{await z(w,v,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${i.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const k=await(await fetch(`https://api.telegram.org/file/bot${w}/${_.result.file_path}`)).blob();let S="",D="",A="whisper-1";const N=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const ae of N.results){const De=await M(ae.encrypted_value,x.pin_hash);if(ae.service==="openai"){S="https://api.openai.com/v1/audio/transcriptions",D=De;break}else if(ae.service.startsWith("llm_slot_"))try{const ue=JSON.parse(De);if(ue.provider==="openai"){S="https://api.openai.com/v1/audio/transcriptions",D=ue.apiKey;break}else if(ue.provider==="groq"){S="https://api.groq.com/openai/v1/audio/transcriptions",D=ue.apiKey,A="whisper-large-v3";break}}catch{}}if(!S)return await z(w,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const $=new FormData;$.append("file",k,"voice.ogg"),$.append("model",A),$.append("language","en");const H=await fetch(S,{method:"POST",headers:{Authorization:`Bearer ${D}`},body:$});if(!H.ok){const ae=await H.text();return await z(w,v,`⚠️ Transcription failed: ${H.status} ${ae}`),e.json({ok:!0})}g=(await H.json()).text,await z(w,v,`🗣️ *You said:* ${g}`)}}catch(h){return await z(w,v,`⚠️ Failed to process voice note: ${h.message}`),e.json({ok:!0})}if((u||m)&&w&&x)try{let h,_="unknown",E="unknown",k=0;if(u)h=i.document.file_id,_=i.document.file_name||"document",E=i.document.mime_type||"unknown",k=i.document.file_size||0;else if(m){const S=i.photo[i.photo.length-1];h=S.file_id,_="photo.jpg",E="image/jpeg",k=S.file_size||0}if(h){const D=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${h}`)).json();let A="";if(D.ok&&((a=D.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(_)||/^text\/|application\/json|application\/xml|application\/csv/i.test(E))&&k<5e4)try{A=await(await fetch(`https://api.telegram.org/file/bot${w}/${D.result.file_path}`)).text()}catch{}const N=i.caption||"",$=`[Telegram file received: "${_}" (${E}, ${Math.round(k/1024)}KB)]`;A?g=`${N?N+`
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(h){if(y&&i.caption)g=i.caption;else return await z(w,v,`⚠️ Received your file but couldn't process it: ${h.message}`),e.json({ok:!0})}if(!g)return e.json({ok:!0});await xn(w,v);let T=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();T?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(T.id).run():T={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=bn(x.id,x.username,g,v);d.metadata={thread_id:T.id};let f,p;try{const h=await tt(e.env.DB,x.id,x.pin_hash);f=h.provider,p=h.rotation}catch(h){console.error("Telegram provider setup error:",h);const _=(r=h.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=h.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${h.message||"Unknown error"}`;return await z(w,v,_),e.json({ok:!0})}try{const h=await Mt(d,e.env.DB,f,x,p,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),_=wn(h,"telegram");await z(w,v,_||"(empty response)")}catch(h){console.error("Telegram agent error:",h);const _=(s=h.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${f.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(h.message||"Unknown").substring(0,200)}`;await z(w,v,_);try{const{logError:E}=await Promise.resolve().then(()=>It);await E(e.env.DB,x.id,"telegram","agent_error",h.message||"Agent error",{provider:f.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>It);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});at.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
  ...
  `).bind(y,y,m.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!v)return;const g=await M(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${g}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:y?"✅ Checked!":"☐ Unchecked"})}),(x=n.reply_markup)!=null&&x.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(T=>T.map(d=>{var f;if((f=d.callback_data)!=null&&f.includes(i)){const p=y?"✅":"☐",h=d.text.replace(/^[☐✅]\s*/,"");return{...d,text:`${p} ${h}`}}return d}));try{await fetch(`https://api.telegram.org/bot${g}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function Sn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function In(e,t,a,r,n,s){try{return(await new $t(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function Dn(e,t,a,r,n){try{const s=new ne(e,t,a,r,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const y=m.from.split("<")[0].trim()||m.from;l[y]=(l[y]||0)+1}const c=Object.entries(l).sort(([,m],[,y])=>y-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:c,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function On(e,t){var a;try{const r=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(r.results||[]).map(l=>l.name),i=(r.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((a=r.results)==null?void 0:a.length)||0,dueToday:i,items:o}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function Rn(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],a=[];for(const r of t){const n=`latest ${r} news today`;try{const s=await ht(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!a.some(i=>i.url===o.link)&&(a.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),a.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(a.length>=5)break}return a.slice(0,5)}function Cn(e){const t=[];t.push(`📋 Briefing for ${e.targetDate}`),t.push("");const a=e.calendar.totalCount;if(a>0){t.push(`📅 Tomorrow: ${a} event${a===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const r=e.emails.gmail.unreadCount;if(r>0?(t.push(`📧 Gmail: ${r} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function An(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Ln(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function Ya(e,t,a){var T;const r=t.timezone||"Asia/Kolkata",n=Sn(r),{components:s,newsTopics:o}=await Ln(e,t.id),i=[],l=[];s.google_calendar&&(i.push(In(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(Dn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(On(e,t.id)),l.push("tasks")),s.news&&(i.push(Rn(o)),l.push("news"));const c=await Promise.all(i),u={};l.forEach((d,f)=>{u[d]=c[f]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},y={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((T=u.googleEvents)==null?void 0:T.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||y,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};v.summary=Cn(v);const g=An(v),x=await e.prepare(`
  ...
  `).bind(t.id,JSON.stringify(v)).first(),w=(x==null?void 0:x.id)||0;for(const d of g)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(w,d.type,d.key,d.text,JSON.stringify(d.metadata),d.sortOrder).run();return{briefingId:w,content:v,items:g}}async function Nn(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function $n(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function Mn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function Bn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,c=o*60+i;return l===c}function jn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const J=new ve;async function Ja(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(Bn(l,i,s))try{const c=await Ya(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:m}=jn(c.content,c.items);await Pn(e.env.DB,o,u,m,c.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:i})}catch(c){n.push({user_id:o.id,status:"error",error:c.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});J.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const u=await M(c.encrypted_value,l.pin_hash),y=JSON.parse(u).access_token;if(!y)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${y}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(d=>{var p;const f=(p=d.start)==null?void 0:p.dateTime;return f?f>=s.toISOString()&&f<=o:!1});if(x.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!w)continue;const T=await M(w.encrypted_value,l.pin_hash);for(const d of x){const f=new Date(d.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=d.location?`
📍 ${d.location}`:"",h=`⏰ Meeting in 10 minutes!

*${d.summary||"Untitled Event"}*
🕐 ${f}${p}`;await fetch(`https://api.telegram.org/bot${T}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:h,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:x.length})}catch(c){n.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function Pn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
...
${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}J.delete("/briefings/:id",Ja,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const Q=new ve;Q.use("/api/*",$r());Q.route("/api/auth",be);Q.route("/api/chat",B);Q.route("/api/settings",j);Q.route("/api/system",de);Q.route("/api/telegram",at);Q.route("/api/proactive",J);Q.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Re(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Re(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Re(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Re(!1,"Session expired. Please log in again and retry."));const l=i.user_id,c=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,m=await Oa(e.env.DB,l,c,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Re(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Re(!1,`OAuth failed: ${s.message}`))}});Q.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ya())));Q.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ya())));function Re(e,t,a){return`<!DOCTYPE html>
