var Mr=Object.defineProperty;var Dt=e=>{throw TypeError(e)};var $r=(e,t,r)=>t in e?Mr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var E=(e,t,r)=>$r(e,typeof t!="symbol"?t+"":t,r),dt=(e,t,r)=>t.has(e)||Dt("Cannot "+r);var v=(e,t,r)=>(dt(e,t,"read from private field"),r?r.call(e):t.get(e)),k=(e,t,r)=>t.has(e)?Dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),T=(e,t,r,a)=>(dt(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),D=(e,t,r)=>(dt(e,t,"access private method"),r);var Ct=(e,t,r,a)=>({set _(n){T(e,t,n,r)},get _(){return v(e,t,a)}});var Ot=(e,t,r)=>(a,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,d=!1,u;if(e[i]?(u=e[i][0][0],a.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(a,()=>o(i+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&r&&(l=await r(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},Br=Symbol(),jr=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,s=(e instanceof Zt?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Pr(e,{all:r,dot:a}):{}};async function Pr(e,t){const r=await e.formData();return r?Hr(r,t):{}}function Hr(e,t){const r=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Ur(r,n,a):r[n]=a}),t.dot&&Object.entries(r).forEach(([a,n])=>{a.includes(".")&&(Gr(r,a,n),delete r[a])}),r}var Ur=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Gr=(e,t,r)=>{let a=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?a[s]=r:((!a[s]||typeof a[s]!="object"||Array.isArray(a[s])||a[s]instanceof File)&&(a[s]=Object.create(null)),a=a[s])})},Kt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},zr=e=>{const{groups:t,path:r}=Fr(e),a=Kt(r);return Wr(a,t)},Fr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const n=`@${a}`;return t.push([n,r]),n}),{groups:t,path:e}},Wr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[r][1]);break}}return e},Xe={},qr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return Xe[a]||(r[2]?Xe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Xe[a]=[e,r[1],!0]),Xe[a]}return null},xt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Kr=e=>xt(e,decodeURI),Jt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const s=t.indexOf("?",a),o=t.indexOf("#",a),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(r,i);return Kr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(r,a)},Jr=e=>{const t=Jt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Te=(e,t,...r)=>(r.length&&(t=Te(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Yt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&a===""?r.push("/"):r.push(a);const s=n.replace("?","");a+="/"+s,r.push(a)}else a+="/"+n}),r.filter((n,s,o)=>o.indexOf(n)===s)},ct=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?xt(e,Xt):e):e,Vt=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,d=e.indexOf("&",l);return ct(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(a&&(l=ct(l)),s=o,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),a&&(d=ct(d))),r?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Yr=Vt,Vr=(e,t)=>Vt(e,t,!0),Xt=decodeURIComponent,Rt=e=>xt(e,Xt),Ie,F,ne,Qt,er,gt,se,Ut,Zt=(Ut=class{constructor(e,t="/",r=[[]]){k(this,ne);E(this,"raw");k(this,Ie);k(this,F);E(this,"routeIndex",0);E(this,"path");E(this,"bodyCache",{});k(this,se,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,T(this,F,r),T(this,Ie,{})}param(e){return e?D(this,ne,Qt).call(this,e):D(this,ne,er).call(this)}query(e){return Yr(this.url,e)}queries(e){return Vr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await jr(this,e))}json(){return v(this,se).call(this,"text").then(e=>JSON.parse(e))}text(){return v(this,se).call(this,"text")}arrayBuffer(){return v(this,se).call(this,"arrayBuffer")}blob(){return v(this,se).call(this,"blob")}formData(){return v(this,se).call(this,"formData")}addValidatedData(e,t){v(this,Ie)[e]=t}valid(e){return v(this,Ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Br](){return v(this,F)}get matchedRoutes(){return v(this,F)[0].map(([[,e]])=>e)}get routePath(){return v(this,F)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ie=new WeakMap,F=new WeakMap,ne=new WeakSet,Qt=function(e){const t=v(this,F)[0][this.routeIndex][1][e],r=D(this,ne,gt).call(this,t);return r&&/\%/.test(r)?Rt(r):r},er=function(){const e={},t=Object.keys(v(this,F)[0][this.routeIndex][1]);for(const r of t){const a=D(this,ne,gt).call(this,v(this,F)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Rt(a):a)}return e},gt=function(e){return v(this,F)[1]?v(this,F)[1][e]:e},se=new WeakMap,Ut),Xr={Stringify:1},tr=async(e,t,r,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>tr(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Zr="text/plain; charset=UTF-8",ut=(e,t)=>({"Content-Type":e,...t}),Ge,ze,ee,De,te,z,Fe,Ce,Oe,fe,We,qe,oe,ke,Gt,Qr=(Gt=class{constructor(e,t){k(this,oe);k(this,Ge);k(this,ze);E(this,"env",{});k(this,ee);E(this,"finalized",!1);E(this,"error");k(this,De);k(this,te);k(this,z);k(this,Fe);k(this,Ce);k(this,Oe);k(this,fe);k(this,We);k(this,qe);E(this,"render",(...e)=>(v(this,Ce)??T(this,Ce,t=>this.html(t)),v(this,Ce).call(this,...e)));E(this,"setLayout",e=>T(this,Fe,e));E(this,"getLayout",()=>v(this,Fe));E(this,"setRenderer",e=>{T(this,Ce,e)});E(this,"header",(e,t,r)=>{this.finalized&&T(this,z,new Response(v(this,z).body,v(this,z)));const a=v(this,z)?v(this,z).headers:v(this,fe)??T(this,fe,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});E(this,"status",e=>{T(this,De,e)});E(this,"set",(e,t)=>{v(this,ee)??T(this,ee,new Map),v(this,ee).set(e,t)});E(this,"get",e=>v(this,ee)?v(this,ee).get(e):void 0);E(this,"newResponse",(...e)=>D(this,oe,ke).call(this,...e));E(this,"body",(e,t,r)=>D(this,oe,ke).call(this,e,t,r));E(this,"text",(e,t,r)=>!v(this,fe)&&!v(this,De)&&!t&&!r&&!this.finalized?new Response(e):D(this,oe,ke).call(this,e,t,ut(Zr,r)));E(this,"json",(e,t,r)=>D(this,oe,ke).call(this,JSON.stringify(e),t,ut("application/json",r)));E(this,"html",(e,t,r)=>{const a=n=>D(this,oe,ke).call(this,n,t,ut("text/html; charset=UTF-8",r));return typeof e=="object"?tr(e,Xr.Stringify,!1,{}).then(a):a(e)});E(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});E(this,"notFound",()=>(v(this,Oe)??T(this,Oe,()=>new Response),v(this,Oe).call(this,this)));T(this,Ge,e),t&&(T(this,te,t.executionCtx),this.env=t.env,T(this,Oe,t.notFoundHandler),T(this,qe,t.path),T(this,We,t.matchResult))}get req(){return v(this,ze)??T(this,ze,new Zt(v(this,Ge),v(this,qe),v(this,We))),v(this,ze)}get event(){if(v(this,te)&&"respondWith"in v(this,te))return v(this,te);throw Error("This context has no FetchEvent")}get executionCtx(){if(v(this,te))return v(this,te);throw Error("This context has no ExecutionContext")}get res(){return v(this,z)||T(this,z,new Response(null,{headers:v(this,fe)??T(this,fe,new Headers)}))}set res(e){if(v(this,z)&&e){e=new Response(e.body,e);for(const[t,r]of v(this,z).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=v(this,z).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}T(this,z,e),this.finalized=!0}get var(){return v(this,ee)?Object.fromEntries(v(this,ee)):{}}},Ge=new WeakMap,ze=new WeakMap,ee=new WeakMap,De=new WeakMap,te=new WeakMap,z=new WeakMap,Fe=new WeakMap,Ce=new WeakMap,Oe=new WeakMap,fe=new WeakMap,We=new WeakMap,qe=new WeakMap,oe=new WeakSet,ke=function(e,t,r){const a=v(this,z)?new Headers(v(this,z).headers):v(this,fe)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?a.append(o,i):a.set(o,i)}if(r)for(const[s,o]of Object.entries(r))if(typeof o=="string")a.set(s,o);else{a.delete(s);for(const i of o)a.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??v(this,De);return new Response(e,{status:n,headers:a})},Gt),j="ALL",ea="all",ta=["get","post","put","delete","options","patch"],rr="Can not add a route since the matcher is already built.",ar=class extends Error{},ra="__COMPOSED_HANDLER",aa=e=>e.text("404 Not Found",404),At=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},q,P,nr,K,he,et,tt,Re,na=(Re=class{constructor(t={}){k(this,P);E(this,"get");E(this,"post");E(this,"put");E(this,"delete");E(this,"options");E(this,"patch");E(this,"all");E(this,"on");E(this,"use");E(this,"router");E(this,"getPath");E(this,"_basePath","/");k(this,q,"/");E(this,"routes",[]);k(this,K,aa);E(this,"errorHandler",At);E(this,"onError",t=>(this.errorHandler=t,this));E(this,"notFound",t=>(T(this,K,t),this));E(this,"fetch",(t,...r)=>D(this,P,tt).call(this,t,r[1],r[0],t.method));E(this,"request",(t,r,a,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Te("/",t)}`,r),a,n)));E(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(D(this,P,tt).call(this,t.request,t,void 0,t.request.method))})});[...ta,ea].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?T(this,q,o):D(this,P,he).call(this,s,v(this,q),o),i.forEach(l=>{D(this,P,he).call(this,s,v(this,q),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){T(this,q,l);for(const d of[s].flat())i.map(u=>{D(this,P,he).call(this,d.toUpperCase(),v(this,q),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?T(this,q,s):(T(this,q,"*"),o.unshift(s)),o.forEach(i=>{D(this,P,he).call(this,j,v(this,q),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Jt:Jr}route(t,r){const a=this.basePath(t);return r.routes.map(n=>{var o;let s;r.errorHandler===At?s=n.handler:(s=async(i,l)=>(await Ot([],r.errorHandler)(i,()=>n.handler(i,l))).res,s[ra]=n.handler),D(o=a,P,he).call(o,n.method,n.path,s)}),this}basePath(t){const r=D(this,P,nr).call(this);return r._basePath=Te(this._basePath,t),r}mount(t,r,a){let n,s;a&&(typeof a=="function"?s=a:(s=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const o=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Te(this._basePath,t),d=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,u)}})());const i=async(l,d)=>{const u=await r(n(l.req.raw),...o(l));if(u)return u;await d()};return D(this,P,he).call(this,j,Te(t,"*"),i),this}},q=new WeakMap,P=new WeakSet,nr=function(){const t=new Re({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,T(t,K,v(this,K)),t.routes=this.routes,t},K=new WeakMap,he=function(t,r,a){t=t.toUpperCase(),r=Te(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,n]),this.routes.push(n)},et=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},tt=function(t,r,a,n){if(n==="HEAD")return(async()=>new Response(null,await D(this,P,tt).call(this,t,r,a,"GET")))();const s=this.getPath(t,{env:a}),o=this.router.match(n,s),i=new Qr(t,{path:s,matchResult:o,env:a,executionCtx:r,notFoundHandler:v(this,K)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await v(this,K).call(this,i)})}catch(u){return D(this,P,et).call(this,u,i)}return d instanceof Promise?d.then(u=>u||(i.finalized?i.res:v(this,K).call(this,i))).catch(u=>D(this,P,et).call(this,u,i)):d??v(this,K).call(this,i)}const l=Ot(o[0],this.errorHandler,v(this,K));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return D(this,P,et).call(this,d,i)}})()},Re),sr=[];function sa(e,t){const r=this.buildAllMatchers(),a=((n,s)=>{const o=r[n]||r[j],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],sr];const d=l.indexOf("",1);return[o[1][d],l]});return this.match=a,a(e,t)}var at="[^/]+",Pe=".*",He="(?:|/.*)",Se=Symbol(),oa=new Set(".\\+*[^]$()");function ia(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Pe||e===He?1:t===Pe||t===He?-1:e===at?1:t===at?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ve,ye,J,xe,la=(xe=class{constructor(){k(this,ve);k(this,ye);k(this,J,Object.create(null))}insert(t,r,a,n,s){if(t.length===0){if(v(this,ve)!==void 0)throw Se;if(s)return;T(this,ve,r);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Pe]:["","",at]:o==="/*"?["","",He]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let m=l[2]||at;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Se;if(d=v(this,J)[m],!d){if(Object.keys(v(this,J)).some(g=>g!==Pe&&g!==He))throw Se;if(s)return;d=v(this,J)[m]=new xe,u!==""&&T(d,ye,n.varIndex++)}!s&&u!==""&&a.push([u,v(d,ye)])}else if(d=v(this,J)[o],!d){if(Object.keys(v(this,J)).some(u=>u.length>1&&u!==Pe&&u!==He))throw Se;if(s)return;d=v(this,J)[o]=new xe}d.insert(i,r,a,n,s)}buildRegExpStr(){const r=Object.keys(v(this,J)).sort(ia).map(a=>{const n=v(this,J)[a];return(typeof v(n,ye)=="number"?`(${a})@${v(n,ye)}`:oa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof v(this,ve)=="number"&&r.unshift(`#${v(this,ve)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},ve=new WeakMap,ye=new WeakMap,J=new WeakMap,xe),nt,Ke,zt,da=(zt=class{constructor(){k(this,nt,{varIndex:0});k(this,Ke,new la)}insert(e,t,r){const a=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,i=!0,d}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return v(this,Ke).insert(s,t,a,v(this,nt),r),a}buildRegExp(){let e=v(this,Ke).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(r[++t]=Number(s),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,a]}},nt=new WeakMap,Ke=new WeakMap,zt),ca=[/^$/,[],Object.create(null)],rt=Object.create(null);function or(e){return rt[e]??(rt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ua(){rt=Object.create(null)}function pa(e){var d;const t=new da,r=[];if(e.length===0)return ca;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[g,b])=>u?1:g?-1:m.length-b.length),n=Object.create(null);for(let u=0,m=-1,g=a.length;u<g;u++){const[b,y,w]=a[u];b?n[y]=[w.map(([h])=>[h,Object.create(null)]),sr]:m++;let c;try{c=t.insert(y,m,b)}catch(h){throw h===Se?new ar(y):h}b||(r[m]=w.map(([h,p])=>{const f=Object.create(null);for(p-=1;p>=0;p--){const[x,_]=c[p];f[x]=_}return[h,f]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=r.length;u<m;u++)for(let g=0,b=r[u].length;g<b;g++){const y=(d=r[u][g])==null?void 0:d[1];if(!y)continue;const w=Object.keys(y);for(let c=0,h=w.length;c<h;c++)y[w[c]]=i[y[w[c]]]}const l=[];for(const u in o)l[u]=r[o[u]];return[s,l,n]}function _e(e,t){if(e){for(const r of Object.keys(e).sort((a,n)=>n.length-a.length))if(or(r).test(t))return[...e[r]]}}var ie,le,st,ir,Ft,ma=(Ft=class{constructor(){k(this,st);E(this,"name","RegExpRouter");k(this,ie);k(this,le);E(this,"match",sa);T(this,ie,{[j]:Object.create(null)}),T(this,le,{[j]:Object.create(null)})}add(e,t,r){var i;const a=v(this,ie),n=v(this,le);if(!a||!n)throw new Error(rr);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[j]).forEach(d=>{l[e][d]=[...l[j][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=or(t);e===j?Object.keys(a).forEach(d=>{var u;(u=a[d])[t]||(u[t]=_e(a[d],t)||_e(a[j],t)||[])}):(i=a[e])[t]||(i[t]=_e(a[e],t)||_e(a[j],t)||[]),Object.keys(a).forEach(d=>{(e===j||e===d)&&Object.keys(a[d]).forEach(u=>{l.test(u)&&a[d][u].push([r,s])})}),Object.keys(n).forEach(d=>{(e===j||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([r,s]))});return}const o=Yt(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(m=>{var g;(e===j||e===m)&&((g=n[m])[u]||(g[u]=[..._e(a[m],u)||_e(a[j],u)||[]]),n[m][u].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(v(this,le)).concat(Object.keys(v(this,ie))).forEach(t=>{e[t]||(e[t]=D(this,st,ir).call(this,t))}),T(this,ie,T(this,le,void 0)),ua(),e}},ie=new WeakMap,le=new WeakMap,st=new WeakSet,ir=function(e){const t=[];let r=e===j;return[v(this,ie),v(this,le)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(s=>[s,a[e][s]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==j&&t.push(...Object.keys(a[j]).map(s=>[s,a[j][s]]))}),r?pa(t):null},Ft),de,re,Wt,ha=(Wt=class{constructor(e){E(this,"name","SmartRouter");k(this,de,[]);k(this,re,[]);T(this,de,e.routers)}add(e,t,r){if(!v(this,re))throw new Error(rr);v(this,re).push([e,t,r])}match(e,t){if(!v(this,re))throw new Error("Fatal error");const r=v(this,de),a=v(this,re),n=r.length;let s=0,o;for(;s<n;s++){const i=r[s];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);o=i.match(e,t)}catch(l){if(l instanceof ar)continue;throw l}this.match=i.match.bind(i),T(this,de,[i]),T(this,re,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(v(this,re)||v(this,de).length!==1)throw new Error("No active router has been determined yet.");return v(this,de)[0]}},de=new WeakMap,re=new WeakMap,Wt),$e=Object.create(null),ce,U,be,Ae,H,ae,ge,Le,ga=(Le=class{constructor(t,r,a){k(this,ae);k(this,ce);k(this,U);k(this,be);k(this,Ae,0);k(this,H,$e);if(T(this,U,a||Object.create(null)),T(this,ce,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},T(this,ce,[n])}T(this,be,[])}insert(t,r,a){T(this,Ae,++Ct(this,Ae)._);let n=this;const s=zr(r),o=[];for(let i=0,l=s.length;i<l;i++){const d=s[i],u=s[i+1],m=qr(d,u),g=Array.isArray(m)?m[0]:d;if(g in v(n,U)){n=v(n,U)[g],m&&o.push(m[1]);continue}v(n,U)[g]=new Le,m&&(v(n,be).push(m),o.push(m[1])),n=v(n,U)[g]}return v(n,ce).push({[t]:{handler:a,possibleKeys:o.filter((i,l,d)=>d.indexOf(i)===l),score:v(this,Ae)}}),n}search(t,r){var l;const a=[];T(this,H,$e);let s=[this];const o=Kt(r),i=[];for(let d=0,u=o.length;d<u;d++){const m=o[d],g=d===u-1,b=[];for(let y=0,w=s.length;y<w;y++){const c=s[y],h=v(c,U)[m];h&&(T(h,H,v(c,H)),g?(v(h,U)["*"]&&a.push(...D(this,ae,ge).call(this,v(h,U)["*"],t,v(c,H))),a.push(...D(this,ae,ge).call(this,h,t,v(c,H)))):b.push(h));for(let p=0,f=v(c,be).length;p<f;p++){const x=v(c,be)[p],_=v(c,H)===$e?{}:{...v(c,H)};if(x==="*"){const C=v(c,U)["*"];C&&(a.push(...D(this,ae,ge).call(this,C,t,v(c,H))),T(C,H,_),b.push(C));continue}const[S,O,L]=x;if(!m&&!(L instanceof RegExp))continue;const R=v(c,U)[S],A=o.slice(d).join("/");if(L instanceof RegExp){const C=L.exec(A);if(C){if(_[O]=C[0],a.push(...D(this,ae,ge).call(this,R,t,v(c,H),_)),Object.keys(v(R,U)).length){T(R,H,_);const N=((l=C[0].match(/\//))==null?void 0:l.length)??0;(i[N]||(i[N]=[])).push(R)}continue}}(L===!0||L.test(m))&&(_[O]=m,g?(a.push(...D(this,ae,ge).call(this,R,t,_,v(c,H))),v(R,U)["*"]&&a.push(...D(this,ae,ge).call(this,v(R,U)["*"],t,_,v(c,H)))):(T(R,H,_),b.push(R)))}}s=b.concat(i.shift()??[])}return a.length>1&&a.sort((d,u)=>d.score-u.score),[a.map(({handler:d,params:u})=>[d,u])]}},ce=new WeakMap,U=new WeakMap,be=new WeakMap,Ae=new WeakMap,H=new WeakMap,ae=new WeakSet,ge=function(t,r,a,n){const s=[];for(let o=0,i=v(t,ce).length;o<i;o++){const l=v(t,ce)[o],d=l[r]||l[j],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),a!==$e||n&&n!==$e))for(let m=0,g=d.possibleKeys.length;m<g;m++){const b=d.possibleKeys[m],y=u[d.score];d.params[b]=n!=null&&n[b]&&!y?n[b]:a[b]??(n==null?void 0:n[b]),u[d.score]=!0}}return s},Le),we,qt,fa=(qt=class{constructor(){E(this,"name","TrieRouter");k(this,we);T(this,we,new ga)}add(e,t,r){const a=Yt(t);if(a){for(let n=0,s=a.length;n<s;n++)v(this,we).insert(e,a[n],r);return}v(this,we).insert(e,t,r)}match(e,t){return v(this,we).search(e,t)}},we=new WeakMap,qt),pe=class extends na{constructor(e={}){super(e),this.router=e.router??new ha({routers:[new ma,new fa]})}},va=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(r.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(o,i){var u;function l(m,g){o.res.headers.set(m,g)}const d=await a(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let g=r.allowHeaders;if(!(g!=null&&g.length)){const b=o.req.header("Access-Control-Request-Headers");b&&(g=b.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function lr(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Write a synthesized research report answering the query above.`;try{return(await r.chat([{role:"system",content:s},{role:"user",content:o}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(i){return`Research synthesis error: ${i.message}. Raw search results were found but could not be analyzed.`}}const Fa=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:Sr,fetchPageContent:kr},Symbol.toStringTag,{value:"Module"})),Wa=2e3,qa=2e3,Ir=4;function ht(e){return Math.ceil(e.length/Ir)}function Mt(e,t){const r=t*Ir;return e.length<=r?e:e.slice(0,r)+`
...
`,Wa):"",n=Mt(t,qa);return`You are ${r} — a personal AI assistant. You are intelligent, direct, and genuinely helpful. You speak with clarity and warmth, never robotic. Your name is ${r} — always refer to yourself by this name if asked.
...
## Current Date & Time
${Ka(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function $t(e,t,r){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${r.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:r,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:r}}function Ka(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function Or(e,t,r,a,n,s,o,i,l,d,u){var g,b,y,w;const m=new ue(r);switch(e){case"create_schedule":{const c=new Date;let h;const p=d||"UTC";if(t.schedule_type==="interval"){const f=parseInt(t.schedule_value,10);h=new Date(c.getTime()+f*60*1e3)}else if(t.schedule_type==="daily"){const[f,x]=t.schedule_value.split(":").map(Number),_=c.toLocaleString("en-US",{timeZone:p}),S=new Date(_),O=new Date(S);O.setHours(f,x,0,0),O<=S&&O.setDate(O.getDate()+1);const L=new Date(O.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(O.toLocaleString("en-US",{timeZone:p})),A=L.getTime()-R.getTime();h=new Date(O.getTime()+A)}else if(t.schedule_type==="weekly"){const[f,x]=t.schedule_value.split(" "),[_,S]=(x||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Nr=>Nr.toLowerCase()===f.toLowerCase()),R=c.toLocaleString("en-US",{timeZone:p}),A=new Date(R),C=new Date(A);C.setHours(_,S,0,0);let N=(L-C.getDay()+7)%7;N===0&&C<=A&&(N=7),C.setDate(C.getDate()+N);const Ve=new Date(C.toLocaleString("en-US",{timeZone:"UTC"})),it=new Date(C.toLocaleString("en-US",{timeZone:p})),lt=Ve.getTime()-it.getTime();h=new Date(C.getTime()+lt)}else if(t.schedule_type==="once"){const[f,x]=t.schedule_value.split(" "),[_,S,O]=f.split("-").map(Number),[L,R]=(x||"00:00").split(":").map(Number),A=c.toLocaleString("en-US",{timeZone:p}),C=new Date(A),N=new Date(C);N.setFullYear(_,S-1,O),N.setHours(L,R,0,0);const Ve=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),it=new Date(N.toLocaleString("en-US",{timeZone:p})),lt=Ve.getTime()-it.getTime();h=new Date(N.getTime()+lt)}else h=new Date(c.getTime()+3600*1e3);return await r.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
- Unread errors: ${(x==null?void 0:x.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const h=await new V(r,a,n,s||"",o||"").sheets.readRange(t.spreadsheet_id,t.range);return h.length===0?"No data found in the specified range.":h.map(p=>p.join("	| ")).join(`
`)}catch(c){return await I(r,a,"google","read_sheet",c.message),`Failed to read sheet: ${c.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new V(r,a,n,s||"",o||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await I(r,a,"google","write_sheet",c.message),`Failed to write sheet: ${c.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new V(r,a,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await I(r,a,"google","append_sheet",c.message),`Failed to append to sheet: ${c.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.sheets.createSpreadsheet(t.title,t.sheet_names);let f="";if(t.folder_name)try{const{token:x}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||"");f=`
Folder: "${(await $t(x,p.spreadsheetId,t.folder_name)).folderName}"`}catch(x){f=`
(Could not move to folder "${t.folder_name}": ${x.message})`}try{await new ue(r).store(a,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${f}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(c){return await I(r,a,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||""),h=t.calendar_id||"primary",p=t.days_ahead||7,f=new Date,x=new Date(f.getTime()+p*24*60*60*1e3),_=await c.calendar.listEvents(h,{timeMin:f.toISOString(),timeMax:x.toISOString(),query:t.query});return _.length===0?`No events found in the next ${p} days.`:_.map(S=>{var C;const O=S.start.dateTime||S.start.date||"TBD",L=S.end.dateTime||S.end.date||"",R=S.location?` 📍 ${S.location}`:"",A=((C=S.attendees)==null?void 0:C.map(N=>N.email).join(", "))||"";return`• ${S.summary} — ${O} to ${L}${R}${A?`
  Attendees: ${A}`:""}`}).join(`
...
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(c){return await I(r,a,"google","create_event",c.message),`Failed to create event: ${c.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.docs.createDocument(t.title);t.content&&await c.docs.appendText(p.documentId,t.content);let f="";if(t.folder_name)try{const{token:x}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||"");f=`
Folder: "${(await $t(x,p.documentId,t.folder_name)).folderName}"`}catch(x){f=`
(Could not move to folder "${t.folder_name}": ${x.message})`}try{await new ue(r).store(a,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${f}
ID: ${p.documentId}
...
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await I(r,a,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new Q(r,a,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((p,f)=>`${p.isUnread?"● ":"  "}${f+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`
...
`)}catch(c){return await I(r,a,"search","web_search",c.message),`Web search error: ${c.message}`}case"read_url":try{const c=t.url;if(!c||!c.startsWith("http://")&&!c.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>Fa),f=await p(c,h);return f.error?`Failed to read page: ${f.error}`:!f.text||f.text.length<20?`Page at ${c} returned no readable content.`:`Content from ${c} (${f.text.length} chars):

${f.text}`}catch(c){return await I(r,a,"search","read_url",c.message),`Read URL error: ${c.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const c=await Sr(t.query,u,{depth:t.depth||"quick",site:t.site});if(c.error)return`Research failed: ${c.error}`;let h=c.report;return c.sources.length>0&&(h+=`

---
**Sources** (`+c.pagesRead+` pages read):
`,h+=c.sources.map((p,f)=>`[${f+1}] ${p.title}
    ${p.url}`).join(`
`)),h}catch(c){return await I(r,a,"research","research",c.message),`Research error: ${c.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await M(c.encrypted_value,n),p=await La(h,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((f,x)=>{const _=f.rating?` ★${f.rating} (${f.userRatingsTotal||0} reviews)`:"",S=f.openNow!==void 0?f.openNow?" · Open now":" · Closed":"",O=f.googleMapsUri?`
   ${f.googleMapsUri}`:"";return`${x+1}. **${f.name}**${_}${S}
   ${f.address}${O}
   [place_id: ${f.placeId}]`}).join(`

`)}catch(c){return await I(r,a,"google_api","search_places",c.message),`Places search error: ${c.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await M(c.encrypted_value,n),p=await Na(h,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const f=p.details;let x=`**${f.name}**
📍 ${f.address}`;if(f.phone&&(x+=`
📞 ${f.phone}`),f.website&&(x+=`
🌐 ${f.website}`),f.rating&&(x+=`
★ ${f.rating}`),f.googleMapsUri&&(x+=`
📌 ${f.googleMapsUri}`),f.openingHours&&(x+=`

Opening Hours:
${f.openingHours.join(`
`)}`),f.reviews&&f.reviews.length>0){x+=`

Recent Reviews:`;for(const _ of f.reviews)x+=`
— ${_.author} (★${_.rating}, ${_.time}): "${_.text}"`}return x}catch(c){return await I(r,a,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await M(c.encrypted_value,n),p=await Ma(h,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const f=p.route;let x=`**${f.startAddress}** → **${f.endAddress}**
`;return x+=`📏 ${f.distance} · ⏱️ ${f.duration}`,f.durationInTraffic&&(x+=` (with traffic: ${f.durationInTraffic})`),x+=`
via ${f.summary}`,x+=`

Steps:`,f.steps.forEach((_,S)=>{x+=`
${S+1}. ${_.instruction} (${_.distance}, ${_.duration})`}),x}catch(c){return await I(r,a,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await M(c.encrypted_value,n),p=await Pa(h,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let f=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(f+=` (with traffic: ${p.durationInTraffic})`),f}catch(c){return await I(r,a,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await M(c.encrypted_value,n),p=await $a(h,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(c){return await I(r,a,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await M(c.encrypted_value,n),p=await ja(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((f,x)=>{var _;return`${x+1}. **${f.title}**
   ${f.channelTitle} · ${((_=f.publishedAt)==null?void 0:_.split("T")[0])||""}
   ${f.description}
   ${f.url}`}).join(`

`)}catch(c){return await I(r,a,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await M(c.encrypted_value,n),p=await Ba(h,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((f,x)=>`${x+1}. ${f.address}
   Coordinates: ${f.lat}, ${f.lng}`).join(`
`)}catch(c){return await I(r,a,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function It(e,t,r,a,n,s){var w;const o=new ue(t),i=(w=e.metadata)==null?void 0:w.thread_id,l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,25,i),m=[{role:"system",content:Cr(a,l)},...d.map(c=>({role:c.role,content:c.content})),{role:"user",content:e.text}];await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let b="",y=0;for(let c=0;c<g;c++)try{const h=await r.chat(m,{tools:Dr});if(h.usage&&(y+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){h.content&&m.push({role:"assistant",content:h.content});for(const p of h.toolCalls)try{const f=await Or(p.name,p.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);m.push({role:"user",content:`[Tool Result for ${p.name}]: ${f}`})}catch(f){await I(t,a.id,"tool",p.name,f.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${p.name}]: ${f.message||"Execution failed"}`})}continue}b=h.content;break}catch(h){if(n){const p=h.message||"",f=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),x=p.includes("429"),_=f?1440:x?10:5;await n.recordError(r.name,p,_)}throw await I(t,a.id,"llm","provider_error",h.message||"Unknown LLM error",{provider:r.name,turn:c}),h}if(n&&y>0)try{await n.recordUsage(r.name,y)}catch{}return await o.storeMessage(a.id,e.channel,"assistant",b,"{}",i),await o.compactHistory(a.id,30),b}const Bt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Ja(e){for(const[t,r]of Object.entries(Bt))if(e.toLowerCase().includes(t.toLowerCase()))return r;return Bt.default}function Ya(e,t,r,a){const n=Ja(a),s=Math.floor(n*.75),o=[];let i=0,l=!1;const d=ht(e);o.push({role:"system",content:e}),i+=d;const u=ht(r);i+=u;const m=s-i,g=[];let b=0;for(let y=t.length-1;y>=0;y--){const w=t[y],c=ht(w.content);if(b+c<=m)g.unshift({role:w.role,content:w.content}),b+=c;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:r}),i+=b,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*Va(e,t,r,a,n,s){var c;const o=new ue(t),i=(c=e.metadata)==null?void 0:c.thread_id;yield{type:"thinking",data:{threadId:i,provider:r.name}};const l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,20,i),u=Cr(a,l),m=Ya(u,d,e.text,r.name);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let b="",y=0;const w=[...m.messages];for(let h=0;h<g;h++)try{h>0&&(yield{type:"thinking",data:{threadId:i}});const p=await r.chat(w,{tools:Dr});if(p.usage&&(y+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},w.push({role:"assistant",content:p.content}));for(const x of p.toolCalls){yield{type:"tool_start",data:{tool:x.name,toolArgs:x.arguments,threadId:i}};try{const _=await Or(x.name,x.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);yield{type:"tool_end",data:{tool:x.name,toolResult:_.substring(0,500)+(_.length>500?"...":""),threadId:i}},w.push({role:"user",content:`[Tool Result for ${x.name}]: ${_}`})}catch(_){await I(t,a.id,"tool",x.name,_.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:x.name,toolResult:`Error: ${_.message||"Execution failed"}`,threadId:i}},w.push({role:"user",content:`[Tool Error for ${x.name}]: ${_.message||"Execution failed"}`})}}continue}b=p.content;const f=50;for(let x=0;x<b.length;x+=f)yield{type:"chunk",data:{text:b.substring(x,x+f),threadId:i}},x+f<b.length&&await new Promise(S=>setTimeout(S,10));break}catch(p){if(n){const f=p.message||"",x=f.includes("401")||f.includes("403")||f.includes("authentication")||f.includes("credit balance"),_=f.includes("429"),S=x?1440:_?10:5;await n.recordError(r.name,f,S)}await I(t,a.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:r.name,turn:h}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&y>0)try{await n.recordUsage(r.name,y)}catch{}await o.storeMessage(a.id,e.channel,"assistant",b,"{}",i),await o.compactHistory(a.id,30),yield{type:"done",data:{threadId:i,provider:r.name,tokenCount:y}}}const $=new pe;async function Xa(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}$.use("/*",Xa);$.get("/threads",async e=>{const t=e.get("user"),r=e.req.query("archived")==="1",a=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await G(r,t,l),!0}case"/help":{const i=`🛠 *${(a==null?void 0:a.assistant_name)||"Karna"} — Commands*
...
Status: ✅ Online`;await G(r,t,u)}catch{await G(r,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return a?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(a.id).run(),await G(r,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await G(r,t,"⚠️ Account not linked."),!0);default:return!1}}Ye.post("/webhook",async e=>{var t,r,a,n;try{const s=await e.req.json();if(s.callback_query)return await on(e.env.DB,s.callback_query),e.json({ok:!0});const o=s.message;if(!(o!=null&&o.text)&&!(o!=null&&o.voice))return e.json({ok:!0});const i=String(o.chat.id);let l=o.text||"";const d=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(i).first();let u=null;if(d){const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(d.id,"telegram_bot_token").first();w&&(u=await M(w.encrypted_value,d.pin_hash))}if(!u){const w=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();w&&(u=await M(w.encrypted_value,w.pin_hash))}if(!u)return e.json({ok:!0,message:"Bot token not configured"});if(l.startsWith("/")&&await sn(l,i,u,d,e.env.DB))return e.json({ok:!0});if(!d)return await G(u,i,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${i}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(o.voice&&u&&d)try{await G(u,i,"🎤 Processing voice note...");const c=await(await fetch(`https://api.telegram.org/bot${u}/getFile?file_id=${o.voice.file_id}`)).json();if(c.ok&&((t=c.result)!=null&&t.file_path)){const p=await(await fetch(`https://api.telegram.org/file/bot${u}/${c.result.file_path}`)).blob();let f="",x="",_="whisper-1";const S=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(d.id).all();for(const A of S.results){const C=await M(A.encrypted_value,d.pin_hash);if(A.service==="openai"){f="https://api.openai.com/v1/audio/transcriptions",x=C;break}else if(A.service.startsWith("llm_slot_"))try{const N=JSON.parse(C);if(N.provider==="openai"){f="https://api.openai.com/v1/audio/transcriptions",x=N.apiKey;break}else if(N.provider==="groq"){f="https://api.groq.com/openai/v1/audio/transcriptions",x=N.apiKey,_="whisper-large-v3";break}}catch{}}if(!f)return await G(u,i,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const O=new FormData;O.append("file",p,"voice.ogg"),O.append("model",_);const L=await fetch(f,{method:"POST",headers:{Authorization:`Bearer ${x}`},body:O});if(!L.ok){const A=await L.text();return await G(u,i,`⚠️ Transcription failed: ${L.status} ${A}`),e.json({ok:!0})}l=(await L.json()).text,await G(u,i,`🗣️ *You said:* ${l}`)}}catch(w){return await G(u,i,`⚠️ Failed to process voice note: ${w.message}`),e.json({ok:!0})}if(!l)return e.json({ok:!0});await an(u,i);let m=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(d.id).first();m?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(m.id).run():m={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(d.id).run()).meta.last_row_id};const g=en(d.id,d.username,l,i);g.metadata={thread_id:m.id};let b,y;try{const w=await Je(e.env.DB,d.id,d.pin_hash);b=w.provider,y=w.rotation}catch(w){console.error("Telegram provider setup error:",w);const c=(r=w.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(a=w.message)!=null&&a.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${w.message||"Unknown error"}`;return await G(u,i,c),e.json({ok:!0})}try{const w=await It(g,e.env.DB,b,d,y,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),c=tn(w,"telegram");await G(u,i,c||"(empty response)")}catch(w){console.error("Telegram agent error:",w);const c=(n=w.message)!=null&&n.includes("API error")?`⚠️ AI provider returned an error. The provider (${b.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(w.message||"Unknown").substring(0,200)}`;await G(u,i,c);try{const{logError:h}=await Promise.resolve().then(()=>yt);await h(e.env.DB,d.id,"telegram","agent_error",w.message||"Agent error",{provider:b.name})}catch{}}return e.json({ok:!0})}catch(s){console.error("Telegram webhook error:",s);try{const{logError:o}=await Promise.resolve().then(()=>yt);await o(e.env.DB,null,"telegram","webhook_error",s.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:s.message})}});Ye.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
  ...
  `).bind(u.id,l,i).first();if(!m)return;const g=m.checked?0:1;await e.prepare(`
    ...
    WHERE id = ?
  `).bind(g,g,m.id).run();const b=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!b)return;const y=await M(b.encrypted_value,b.pin_hash);if(await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:r,text:g?"✅ Checked!":"☐ Unchecked"})}),(w=n.reply_markup)!=null&&w.inline_keyboard){const c=n.reply_markup.inline_keyboard.map(h=>h.map(p=>{var f;if((f=p.callback_data)!=null&&f.includes(i)){const x=g?"✅":"☐",_=p.text.replace(/^[☐✅]\s*/,"");return{...p,text:`${x} ${_}`}}return p}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:c}})})}catch{}}}function ln(e){const t=new Date,r=new Date(t.toLocaleString("en-US",{timeZone:e})),a=new Date(r);a.setDate(a.getDate()+1),a.setHours(0,0,0,0);const n=new Date(a);n.setHours(23,59,59,999);const s=a.toISOString().split("T")[0];return{start:a.toISOString(),end:n.toISOString(),dateStr:s}}async function dn(e,t,r,a,n,s){try{return(await new kt(e,t,r,a,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function cn(e,t,r,a,n){try{const s=new Q(e,t,r,a,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const g=m.from.split("<")[0].trim()||m.from;l[g]=(l[g]||0)+1}const d=Object.entries(l).sort(([,m],[,g])=>g-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:d,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function un(e,t){var r;try{const a=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(a.results||[]).map(l=>l.name),i=(a.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((r=a.results)==null?void 0:r.length)||0,dueToday:i,items:o}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function pn(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],r=[];for(const a of t){const n=`latest ${a} news today`;try{const s=await St(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!r.some(i=>i.url===o.link)&&(r.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),r.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(r.length>=5)break}return r.slice(0,5)}function mn(e){const t=[];t.push(`📋 Evening Briefing for ${e.targetDate}`),t.push("");const r=e.calendar.totalCount;if(r>0){t.push(`📅 Tomorrow: ${r} event${r===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const a=e.emails.gmail.unreadCount;if(a>0?(t.push(`📧 Gmail: ${a} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function hn(e){const t=[];let r=0;for(const a of e.calendar.google)t.push({type:"calendar",key:a.id,text:`${a.title} - ${new Date(a.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:a},sortOrder:r++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:r++});for(const a of e.tasks.items)t.push({type:"task",key:`task-${a}`,text:a,metadata:{},sortOrder:r++});for(const a of e.news.items)t.push({type:"news",key:`news-${a.url}`,text:`📰 ${a.title}`,metadata:{url:a.url,source:a.source},sortOrder:r++});return t}async function gn(e,t){const r=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!r)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let a;try{a=JSON.parse(r.components)}catch{a={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=r.news_topics?r.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:a,newsTopics:n}}async function Rr(e,t,r){var h;const a=t.timezone||"Asia/Kolkata",n=ln(a),{components:s,newsTopics:o}=await gn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(dn(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(cn(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(un(e,t.id)),l.push("tasks")),s.news&&(i.push(pn(o)),l.push("news"));const d=await Promise.all(i),u={};l.forEach((p,f)=>{u[p]=d[f]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},b={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((h=u.googleEvents)==null?void 0:h.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||g,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};b.summary=mn(b);const y=hn(b),w=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(b)).first(),c=(w==null?void 0:w.id)||0;for(const p of y)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(c,p.type,p.key,p.text,JSON.stringify(p.metadata),p.sortOrder).run();return{briefingId:c,content:b,items:y}}async function fn(e,t,r){const a=await e.prepare(`
  ...
  `).bind(r).all();return{briefing:{...a,content:JSON.parse(a.content_json||"{}")},items:n.results||[]}}async function vn(e,t,r,a){if(!await e.prepare(`
  ...
  `).bind(o,o,a,r).run(),{checked:o===1}}async function yn(e,t,r=10){return((await e.prepare(`
    SELECT b.*, 
...
${r}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:a.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}W.delete("/briefings/:id",Ar,async e=>{const t=e.get("user").id,r=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(r,t).run(),e.json({success:!0})});const Y=new pe;Y.use("/api/*",va());Y.route("/api/auth",me);Y.route("/api/chat",$);Y.route("/api/settings",B);Y.route("/api/system",Me);Y.route("/api/telegram",Ye);Y.route("/api/proactive",W);Y.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),r=t.searchParams.get("code"),a=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ee(!1,`Google denied access: ${n}`));if(!r||!a)return e.html(Ee(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(a)).sessionId;if(!o)return e.html(Ee(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
