var Nr=Object.defineProperty;var Dt=e=>{throw TypeError(e)};var Mr=(e,t,r)=>t in e?Nr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var E=(e,t,r)=>Mr(e,typeof t!="symbol"?t+"":t,r),dt=(e,t,r)=>t.has(e)||Dt("Cannot "+r);var b=(e,t,r)=>(dt(e,t,"read from private field"),r?r.call(e):t.get(e)),k=(e,t,r)=>t.has(e)?Dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),T=(e,t,r,a)=>(dt(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),D=(e,t,r)=>(dt(e,t,"access private method"),r);var Ct=(e,t,r,a)=>({set _(n){T(e,t,n,r)},get _(){return b(e,t,a)}});var Ot=(e,t,r)=>(a,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,d=!1,u;if(e[i]?(u=e[i][0][0],a.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(a,()=>o(i+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&r&&(l=await r(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},$r=Symbol(),Br=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,s=(e instanceof Zt?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?jr(e,{all:r,dot:a}):{}};async function jr(e,t){const r=await e.formData();return r?Pr(r,t):{}}function Pr(e,t){const r=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Hr(r,n,a):r[n]=a}),t.dot&&Object.entries(r).forEach(([a,n])=>{a.includes(".")&&(Ur(r,a,n),delete r[a])}),r}var Hr=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Ur=(e,t,r)=>{let a=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?a[s]=r:((!a[s]||typeof a[s]!="object"||Array.isArray(a[s])||a[s]instanceof File)&&(a[s]=Object.create(null)),a=a[s])})},Kt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Gr=e=>{const{groups:t,path:r}=zr(e),a=Kt(r);return Fr(a,t)},zr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const n=`@${a}`;return t.push([n,r]),n}),{groups:t,path:e}},Fr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[r][1]);break}}return e},Xe={},Wr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return Xe[a]||(r[2]?Xe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Xe[a]=[e,r[1],!0]),Xe[a]}return null},xt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},qr=e=>xt(e,decodeURI),Jt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const s=t.indexOf("?",a),o=t.indexOf("#",a),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(r,i);return qr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(r,a)},Kr=e=>{const t=Jt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Te=(e,t,...r)=>(r.length&&(t=Te(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Yt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&a===""?r.push("/"):r.push(a);const s=n.replace("?","");a+="/"+s,r.push(a)}else a+="/"+n}),r.filter((n,s,o)=>o.indexOf(n)===s)},ct=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?xt(e,Xt):e):e,Vt=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,d=e.indexOf("&",l);return ct(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(a&&(l=ct(l)),s=o,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),a&&(d=ct(d))),r?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Jr=Vt,Yr=(e,t)=>Vt(e,t,!0),Xt=decodeURIComponent,Rt=e=>xt(e,Xt),Ie,z,re,Qt,er,gt,se,Ut,Zt=(Ut=class{constructor(e,t="/",r=[[]]){k(this,re);E(this,"raw");k(this,Ie);k(this,z);E(this,"routeIndex",0);E(this,"path");E(this,"bodyCache",{});k(this,se,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,T(this,z,r),T(this,Ie,{})}param(e){return e?D(this,re,Qt).call(this,e):D(this,re,er).call(this)}query(e){return Jr(this.url,e)}queries(e){return Yr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Br(this,e))}json(){return b(this,se).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,se).call(this,"text")}arrayBuffer(){return b(this,se).call(this,"arrayBuffer")}blob(){return b(this,se).call(this,"blob")}formData(){return b(this,se).call(this,"formData")}addValidatedData(e,t){b(this,Ie)[e]=t}valid(e){return b(this,Ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[$r](){return b(this,z)}get matchedRoutes(){return b(this,z)[0].map(([[,e]])=>e)}get routePath(){return b(this,z)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ie=new WeakMap,z=new WeakMap,re=new WeakSet,Qt=function(e){const t=b(this,z)[0][this.routeIndex][1][e],r=D(this,re,gt).call(this,t);return r&&/\%/.test(r)?Rt(r):r},er=function(){const e={},t=Object.keys(b(this,z)[0][this.routeIndex][1]);for(const r of t){const a=D(this,re,gt).call(this,b(this,z)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Rt(a):a)}return e},gt=function(e){return b(this,z)[1]?b(this,z)[1][e]:e},se=new WeakMap,Ut),Vr={Stringify:1},tr=async(e,t,r,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>tr(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Xr="text/plain; charset=UTF-8",ut=(e,t)=>({"Content-Type":e,...t}),Ge,ze,Z,De,Q,G,Fe,Ce,Oe,fe,We,qe,oe,ke,Gt,Zr=(Gt=class{constructor(e,t){k(this,oe);k(this,Ge);k(this,ze);E(this,"env",{});k(this,Z);E(this,"finalized",!1);E(this,"error");k(this,De);k(this,Q);k(this,G);k(this,Fe);k(this,Ce);k(this,Oe);k(this,fe);k(this,We);k(this,qe);E(this,"render",(...e)=>(b(this,Ce)??T(this,Ce,t=>this.html(t)),b(this,Ce).call(this,...e)));E(this,"setLayout",e=>T(this,Fe,e));E(this,"getLayout",()=>b(this,Fe));E(this,"setRenderer",e=>{T(this,Ce,e)});E(this,"header",(e,t,r)=>{this.finalized&&T(this,G,new Response(b(this,G).body,b(this,G)));const a=b(this,G)?b(this,G).headers:b(this,fe)??T(this,fe,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});E(this,"status",e=>{T(this,De,e)});E(this,"set",(e,t)=>{b(this,Z)??T(this,Z,new Map),b(this,Z).set(e,t)});E(this,"get",e=>b(this,Z)?b(this,Z).get(e):void 0);E(this,"newResponse",(...e)=>D(this,oe,ke).call(this,...e));E(this,"body",(e,t,r)=>D(this,oe,ke).call(this,e,t,r));E(this,"text",(e,t,r)=>!b(this,fe)&&!b(this,De)&&!t&&!r&&!this.finalized?new Response(e):D(this,oe,ke).call(this,e,t,ut(Xr,r)));E(this,"json",(e,t,r)=>D(this,oe,ke).call(this,JSON.stringify(e),t,ut("application/json",r)));E(this,"html",(e,t,r)=>{const a=n=>D(this,oe,ke).call(this,n,t,ut("text/html; charset=UTF-8",r));return typeof e=="object"?tr(e,Vr.Stringify,!1,{}).then(a):a(e)});E(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});E(this,"notFound",()=>(b(this,Oe)??T(this,Oe,()=>new Response),b(this,Oe).call(this,this)));T(this,Ge,e),t&&(T(this,Q,t.executionCtx),this.env=t.env,T(this,Oe,t.notFoundHandler),T(this,qe,t.path),T(this,We,t.matchResult))}get req(){return b(this,ze)??T(this,ze,new Zt(b(this,Ge),b(this,qe),b(this,We))),b(this,ze)}get event(){if(b(this,Q)&&"respondWith"in b(this,Q))return b(this,Q);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,Q))return b(this,Q);throw Error("This context has no ExecutionContext")}get res(){return b(this,G)||T(this,G,new Response(null,{headers:b(this,fe)??T(this,fe,new Headers)}))}set res(e){if(b(this,G)&&e){e=new Response(e.body,e);for(const[t,r]of b(this,G).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=b(this,G).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}T(this,G,e),this.finalized=!0}get var(){return b(this,Z)?Object.fromEntries(b(this,Z)):{}}},Ge=new WeakMap,ze=new WeakMap,Z=new WeakMap,De=new WeakMap,Q=new WeakMap,G=new WeakMap,Fe=new WeakMap,Ce=new WeakMap,Oe=new WeakMap,fe=new WeakMap,We=new WeakMap,qe=new WeakMap,oe=new WeakSet,ke=function(e,t,r){const a=b(this,G)?new Headers(b(this,G).headers):b(this,fe)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?a.append(o,i):a.set(o,i)}if(r)for(const[s,o]of Object.entries(r))if(typeof o=="string")a.set(s,o);else{a.delete(s);for(const i of o)a.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,De);return new Response(e,{status:n,headers:a})},Gt),$="ALL",Qr="all",ea=["get","post","put","delete","options","patch"],rr="Can not add a route since the matcher is already built.",ar=class extends Error{},ta="__COMPOSED_HANDLER",ra=e=>e.text("404 Not Found",404),At=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},F,j,nr,W,he,et,tt,Re,aa=(Re=class{constructor(t={}){k(this,j);E(this,"get");E(this,"post");E(this,"put");E(this,"delete");E(this,"options");E(this,"patch");E(this,"all");E(this,"on");E(this,"use");E(this,"router");E(this,"getPath");E(this,"_basePath","/");k(this,F,"/");E(this,"routes",[]);k(this,W,ra);E(this,"errorHandler",At);E(this,"onError",t=>(this.errorHandler=t,this));E(this,"notFound",t=>(T(this,W,t),this));E(this,"fetch",(t,...r)=>D(this,j,tt).call(this,t,r[1],r[0],t.method));E(this,"request",(t,r,a,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Te("/",t)}`,r),a,n)));E(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(D(this,j,tt).call(this,t.request,t,void 0,t.request.method))})});[...ea,Qr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?T(this,F,o):D(this,j,he).call(this,s,b(this,F),o),i.forEach(l=>{D(this,j,he).call(this,s,b(this,F),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){T(this,F,l);for(const d of[s].flat())i.map(u=>{D(this,j,he).call(this,d.toUpperCase(),b(this,F),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?T(this,F,s):(T(this,F,"*"),o.unshift(s)),o.forEach(i=>{D(this,j,he).call(this,$,b(this,F),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Jt:Kr}route(t,r){const a=this.basePath(t);return r.routes.map(n=>{var o;let s;r.errorHandler===At?s=n.handler:(s=async(i,l)=>(await Ot([],r.errorHandler)(i,()=>n.handler(i,l))).res,s[ta]=n.handler),D(o=a,j,he).call(o,n.method,n.path,s)}),this}basePath(t){const r=D(this,j,nr).call(this);return r._basePath=Te(this._basePath,t),r}mount(t,r,a){let n,s;a&&(typeof a=="function"?s=a:(s=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const o=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Te(this._basePath,t),d=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,u)}})());const i=async(l,d)=>{const u=await r(n(l.req.raw),...o(l));if(u)return u;await d()};return D(this,j,he).call(this,$,Te(t,"*"),i),this}},F=new WeakMap,j=new WeakSet,nr=function(){const t=new Re({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,T(t,W,b(this,W)),t.routes=this.routes,t},W=new WeakMap,he=function(t,r,a){t=t.toUpperCase(),r=Te(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,n]),this.routes.push(n)},et=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},tt=function(t,r,a,n){if(n==="HEAD")return(async()=>new Response(null,await D(this,j,tt).call(this,t,r,a,"GET")))();const s=this.getPath(t,{env:a}),o=this.router.match(n,s),i=new Zr(t,{path:s,matchResult:o,env:a,executionCtx:r,notFoundHandler:b(this,W)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await b(this,W).call(this,i)})}catch(u){return D(this,j,et).call(this,u,i)}return d instanceof Promise?d.then(u=>u||(i.finalized?i.res:b(this,W).call(this,i))).catch(u=>D(this,j,et).call(this,u,i)):d??b(this,W).call(this,i)}const l=Ot(o[0],this.errorHandler,b(this,W));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return D(this,j,et).call(this,d,i)}})()},Re),sr=[];function na(e,t){const r=this.buildAllMatchers(),a=((n,s)=>{const o=r[n]||r[$],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],sr];const d=l.indexOf("",1);return[o[1][d],l]});return this.match=a,a(e,t)}var at="[^/]+",Pe=".*",He="(?:|/.*)",Se=Symbol(),sa=new Set(".\\+*[^]$()");function oa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Pe||e===He?1:t===Pe||t===He?-1:e===at?1:t===at?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ve,ye,q,xe,ia=(xe=class{constructor(){k(this,ve);k(this,ye);k(this,q,Object.create(null))}insert(t,r,a,n,s){if(t.length===0){if(b(this,ve)!==void 0)throw Se;if(s)return;T(this,ve,r);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Pe]:["","",at]:o==="/*"?["","",He]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let m=l[2]||at;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Se;if(d=b(this,q)[m],!d){if(Object.keys(b(this,q)).some(g=>g!==Pe&&g!==He))throw Se;if(s)return;d=b(this,q)[m]=new xe,u!==""&&T(d,ye,n.varIndex++)}!s&&u!==""&&a.push([u,b(d,ye)])}else if(d=b(this,q)[o],!d){if(Object.keys(b(this,q)).some(u=>u.length>1&&u!==Pe&&u!==He))throw Se;if(s)return;d=b(this,q)[o]=new xe}d.insert(i,r,a,n,s)}buildRegExpStr(){const r=Object.keys(b(this,q)).sort(oa).map(a=>{const n=b(this,q)[a];return(typeof b(n,ye)=="number"?`(${a})@${b(n,ye)}`:sa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof b(this,ve)=="number"&&r.unshift(`#${b(this,ve)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},ve=new WeakMap,ye=new WeakMap,q=new WeakMap,xe),nt,Ke,zt,la=(zt=class{constructor(){k(this,nt,{varIndex:0});k(this,Ke,new ia)}insert(e,t,r){const a=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,i=!0,d}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return b(this,Ke).insert(s,t,a,b(this,nt),r),a}buildRegExp(){let e=b(this,Ke).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(r[++t]=Number(s),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,a]}},nt=new WeakMap,Ke=new WeakMap,zt),da=[/^$/,[],Object.create(null)],rt=Object.create(null);function or(e){return rt[e]??(rt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ca(){rt=Object.create(null)}function ua(e){var d;const t=new la,r=[];if(e.length===0)return da;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[g,f])=>u?1:g?-1:m.length-f.length),n=Object.create(null);for(let u=0,m=-1,g=a.length;u<g;u++){const[f,y,_]=a[u];f?n[y]=[_.map(([h])=>[h,Object.create(null)]),sr]:m++;let c;try{c=t.insert(y,m,f)}catch(h){throw h===Se?new ar(y):h}f||(r[m]=_.map(([h,p])=>{const v=Object.create(null);for(p-=1;p>=0;p--){const[w,x]=c[p];v[w]=x}return[h,v]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=r.length;u<m;u++)for(let g=0,f=r[u].length;g<f;g++){const y=(d=r[u][g])==null?void 0:d[1];if(!y)continue;const _=Object.keys(y);for(let c=0,h=_.length;c<h;c++)y[_[c]]=i[y[_[c]]]}const l=[];for(const u in o)l[u]=r[o[u]];return[s,l,n]}function _e(e,t){if(e){for(const r of Object.keys(e).sort((a,n)=>n.length-a.length))if(or(r).test(t))return[...e[r]]}}var ie,le,st,ir,Ft,pa=(Ft=class{constructor(){k(this,st);E(this,"name","RegExpRouter");k(this,ie);k(this,le);E(this,"match",na);T(this,ie,{[$]:Object.create(null)}),T(this,le,{[$]:Object.create(null)})}add(e,t,r){var i;const a=b(this,ie),n=b(this,le);if(!a||!n)throw new Error(rr);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[$]).forEach(d=>{l[e][d]=[...l[$][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=or(t);e===$?Object.keys(a).forEach(d=>{var u;(u=a[d])[t]||(u[t]=_e(a[d],t)||_e(a[$],t)||[])}):(i=a[e])[t]||(i[t]=_e(a[e],t)||_e(a[$],t)||[]),Object.keys(a).forEach(d=>{(e===$||e===d)&&Object.keys(a[d]).forEach(u=>{l.test(u)&&a[d][u].push([r,s])})}),Object.keys(n).forEach(d=>{(e===$||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([r,s]))});return}const o=Yt(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(m=>{var g;(e===$||e===m)&&((g=n[m])[u]||(g[u]=[..._e(a[m],u)||_e(a[$],u)||[]]),n[m][u].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,le)).concat(Object.keys(b(this,ie))).forEach(t=>{e[t]||(e[t]=D(this,st,ir).call(this,t))}),T(this,ie,T(this,le,void 0)),ca(),e}},ie=new WeakMap,le=new WeakMap,st=new WeakSet,ir=function(e){const t=[];let r=e===$;return[b(this,ie),b(this,le)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(s=>[s,a[e][s]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==$&&t.push(...Object.keys(a[$]).map(s=>[s,a[$][s]]))}),r?ua(t):null},Ft),de,ee,Wt,ma=(Wt=class{constructor(e){E(this,"name","SmartRouter");k(this,de,[]);k(this,ee,[]);T(this,de,e.routers)}add(e,t,r){if(!b(this,ee))throw new Error(rr);b(this,ee).push([e,t,r])}match(e,t){if(!b(this,ee))throw new Error("Fatal error");const r=b(this,de),a=b(this,ee),n=r.length;let s=0,o;for(;s<n;s++){const i=r[s];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);o=i.match(e,t)}catch(l){if(l instanceof ar)continue;throw l}this.match=i.match.bind(i),T(this,de,[i]),T(this,ee,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ee)||b(this,de).length!==1)throw new Error("No active router has been determined yet.");return b(this,de)[0]}},de=new WeakMap,ee=new WeakMap,Wt),$e=Object.create(null),ce,H,be,Ae,P,te,ge,Le,ha=(Le=class{constructor(t,r,a){k(this,te);k(this,ce);k(this,H);k(this,be);k(this,Ae,0);k(this,P,$e);if(T(this,H,a||Object.create(null)),T(this,ce,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},T(this,ce,[n])}T(this,be,[])}insert(t,r,a){T(this,Ae,++Ct(this,Ae)._);let n=this;const s=Gr(r),o=[];for(let i=0,l=s.length;i<l;i++){const d=s[i],u=s[i+1],m=Wr(d,u),g=Array.isArray(m)?m[0]:d;if(g in b(n,H)){n=b(n,H)[g],m&&o.push(m[1]);continue}b(n,H)[g]=new Le,m&&(b(n,be).push(m),o.push(m[1])),n=b(n,H)[g]}return b(n,ce).push({[t]:{handler:a,possibleKeys:o.filter((i,l,d)=>d.indexOf(i)===l),score:b(this,Ae)}}),n}search(t,r){var l;const a=[];T(this,P,$e);let s=[this];const o=Kt(r),i=[];for(let d=0,u=o.length;d<u;d++){const m=o[d],g=d===u-1,f=[];for(let y=0,_=s.length;y<_;y++){const c=s[y],h=b(c,H)[m];h&&(T(h,P,b(c,P)),g?(b(h,H)["*"]&&a.push(...D(this,te,ge).call(this,b(h,H)["*"],t,b(c,P))),a.push(...D(this,te,ge).call(this,h,t,b(c,P)))):f.push(h));for(let p=0,v=b(c,be).length;p<v;p++){const w=b(c,be)[p],x=b(c,P)===$e?{}:{...b(c,P)};if(w==="*"){const C=b(c,H)["*"];C&&(a.push(...D(this,te,ge).call(this,C,t,b(c,P))),T(C,P,x),f.push(C));continue}const[S,R,N]=w;if(!m&&!(N instanceof RegExp))continue;const O=b(c,H)[S],M=o.slice(d).join("/");if(N instanceof RegExp){const C=N.exec(M);if(C){if(x[R]=C[0],a.push(...D(this,te,ge).call(this,O,t,b(c,P),x)),Object.keys(b(O,H)).length){T(O,P,x);const U=((l=C[0].match(/\//))==null?void 0:l.length)??0;(i[U]||(i[U]=[])).push(O)}continue}}(N===!0||N.test(m))&&(x[R]=m,g?(a.push(...D(this,te,ge).call(this,O,t,x,b(c,P))),b(O,H)["*"]&&a.push(...D(this,te,ge).call(this,b(O,H)["*"],t,x,b(c,P)))):(T(O,P,x),f.push(O)))}}s=f.concat(i.shift()??[])}return a.length>1&&a.sort((d,u)=>d.score-u.score),[a.map(({handler:d,params:u})=>[d,u])]}},ce=new WeakMap,H=new WeakMap,be=new WeakMap,Ae=new WeakMap,P=new WeakMap,te=new WeakSet,ge=function(t,r,a,n){const s=[];for(let o=0,i=b(t,ce).length;o<i;o++){const l=b(t,ce)[o],d=l[r]||l[$],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),a!==$e||n&&n!==$e))for(let m=0,g=d.possibleKeys.length;m<g;m++){const f=d.possibleKeys[m],y=u[d.score];d.params[f]=n!=null&&n[f]&&!y?n[f]:a[f]??(n==null?void 0:n[f]),u[d.score]=!0}}return s},Le),we,qt,ga=(qt=class{constructor(){E(this,"name","TrieRouter");k(this,we);T(this,we,new ha)}add(e,t,r){const a=Yt(t);if(a){for(let n=0,s=a.length;n<s;n++)b(this,we).insert(e,a[n],r);return}b(this,we).insert(e,t,r)}match(e,t){return b(this,we).search(e,t)}},we=new WeakMap,qt),pe=class extends aa{constructor(e={}){super(e),this.router=e.router??new ma({routers:[new pa,new ga]})}},fa=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(r.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(o,i){var u;function l(m,g){o.res.headers.set(m,g)}const d=await a(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let g=r.allowHeaders;if(!(g!=null&&g.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(g=f.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function lr(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`),t.trim()}async function Sr(e,t,r={}){const a=r.maxPages||(r.depth==="thorough"?5:3),n=r.maxResults||(r.depth==="thorough"?8:5),s=await St(e,{num:n,site:r.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,a).map(async g=>{const f=await kr(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:f.text,error:f.error}}),d=(await Promise.all(i)).filter(g=>g.content.length>50);if(d.length===0){const g=s.results.map((y,_)=>`[${_+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Nt(e,g,t,"snippets"),sources:s.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const u=d.map((g,f)=>`--- SOURCE ${f+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${f+1} ---`).join(`

`);return{report:await Nt(e,u,t,"full"),sources:d.map(g=>({title:g.title,url:g.url})),pagesRead:d.length}}async function Nt(e,t,r,a){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Folder: "${(await $t(w,p.spreadsheetId,t.folder_name)).folderName}"`}catch(w){v=`
...
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(c){return await I(r,a,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||""),h=t.calendar_id||"primary",p=t.days_ahead||7,v=new Date,w=new Date(v.getTime()+p*24*60*60*1e3),x=await c.calendar.listEvents(h,{timeMin:v.toISOString(),timeMax:w.toISOString(),query:t.query});return x.length===0?`No events found in the next ${p} days.`:x.map(S=>{var C;const R=S.start.dateTime||S.start.date||"TBD",N=S.end.dateTime||S.end.date||"",O=S.location?` 📍 ${S.location}`:"",M=((C=S.attendees)==null?void 0:C.map(U=>U.email).join(", "))||"";return`• ${S.summary} — ${R} to ${N}${O}${M?`
  Attendees: ${M}`:""}`}).join(`
...
Folder: "${(await $t(w,p.documentId,t.folder_name)).folderName}"`}catch(w){v=`
...
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await I(r,a,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new ne(r,a,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((p,v)=>`${p.isUnread?"● ":"  "}${v+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await I(r,a,"gmail","list",c.message),(g=c.message)!=null&&g.includes("not connected")?c.message:`Gmail list error: ${c.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const c=new ne(r,a,n,s||"",o||""),h=await c.getMessage(t.message_id);if(!h)return"Message not found.";const p=await c.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${p}`}catch(c){return await I(r,a,"gmail","read",c.message),`Gmail read error: ${c.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new ne(r,a,n,s||"",o||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((p,v)=>`${p.isUnread?"● ":"  "}${v+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await I(r,a,"gmail","search",c.message),`Gmail search error: ${c.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new ne(r,a,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(c){return await I(r,a,"gmail","send",c.message),`Gmail send error: ${c.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new ne(r,a,n,s||"",o||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(c){return await I(r,a,"gmail","draft",c.message),`Gmail draft error: ${c.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new ne(r,a,n,s||"",o||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(c){return(f=c.message)!=null&&f.includes("not connected")?c.message:`Gmail error: ${c.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",h.set("q",p);const v=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${c}`}});if(!v.ok)throw new Error(`Drive API error (${v.status})`);const w=await v.json();return(y=w.files)!=null&&y.length?w.files.map((x,S)=>{var M,C;const R=((M=x.mimeType)==null?void 0:M.split(".").pop())||x.mimeType,N=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",O=((C=x.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${S+1}. **${x.name}** (${R})
   ${N} · Modified: ${O}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(c){return await I(r,a,"google","drive_list",c.message),`Drive list error: ${c.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",h),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const v=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${c}`}});if(!v.ok)throw new Error(`Drive API error (${v.status})`);const w=await v.json();return(_=w.files)!=null&&_.length?w.files.map((x,S)=>{var O,M;const R=((O=x.mimeType)==null?void 0:O.split(".").pop())||x.mimeType,N=((M=x.modifiedTime)==null?void 0:M.split("T")[0])||"";return`${S+1}. **${x.name}** (${R}) — Modified: ${N}
   ${x.webViewLink||""}`}).join(`
...
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return w}catch(c){return await I(r,a,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await B(c.encrypted_value,n),p=await Na(h,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const v=p.route;let w=`**${v.startAddress}** → **${v.endAddress}**
`;return w+=`📏 ${v.distance} · ⏱️ ${v.duration}`,v.durationInTraffic&&(w+=` (with traffic: ${v.durationInTraffic})`),w+=`
via ${v.summary}`,w+=`

Steps:`,v.steps.forEach((x,S)=>{w+=`
${S+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),w}catch(c){return await I(r,a,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await B(c.encrypted_value,n),p=await ja(h,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let v=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(v+=` (with traffic: ${p.durationInTraffic})`),v}catch(c){return await I(r,a,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await B(c.encrypted_value,n),p=await Ma(h,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(c){return await I(r,a,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await B(c.encrypted_value,n),p=await Ba(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((v,w)=>{var x;return`${w+1}. **${v.title}**
   ${v.channelTitle} · ${((x=v.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${v.description}
   ${v.url}`}).join(`

`)}catch(c){return await I(r,a,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await B(c.encrypted_value,n),p=await $a(h,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((v,w)=>`${w+1}. ${v.address}
   Coordinates: ${v.lat}, ${v.lng}`).join(`
`)}catch(c){return await I(r,a,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function It(e,t,r,a,n,s){var _;const o=new ue(t),i=(_=e.metadata)==null?void 0:_.thread_id,l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,15,i),m=[{role:"system",content:Cr(a,l)},...d.map(c=>({role:c.role,content:c.content})),{role:"user",content:e.text}];await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let f="",y=0;for(let c=0;c<g;c++)try{const h=await r.chat(m,{tools:Dr});if(h.usage&&(y+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){h.content&&m.push({role:"assistant",content:h.content});for(const p of h.toolCalls)try{const v=await Or(p.name,p.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);m.push({role:"user",content:`[Tool Result for ${p.name}]: ${v}`})}catch(v){await I(t,a.id,"tool",p.name,v.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${p.name}]: ${v.message||"Execution failed"}`})}continue}f=h.content;break}catch(h){if(n){const p=h.message||"",v=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),w=p.includes("429"),x=v?1440:w?10:5;await n.recordError(r.name,p,x)}throw await I(t,a.id,"llm","provider_error",h.message||"Unknown LLM error",{provider:r.name,turn:c}),h}if(n&&y>0)try{await n.recordUsage(r.name,y)}catch{}return await o.storeMessage(a.id,e.channel,"assistant",f,"{}",i),await o.compactHistory(a.id,30),f}const Bt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Ka(e){for(const[t,r]of Object.entries(Bt))if(e.toLowerCase().includes(t.toLowerCase()))return r;return Bt.default}function Ja(e,t,r,a){const n=Ka(a),s=Math.floor(n*.75),o=[];let i=0,l=!1;const d=ht(e);o.push({role:"system",content:e}),i+=d;const u=ht(r);i+=u;const m=s-i,g=[];let f=0;for(let y=t.length-1;y>=0;y--){const _=t[y],c=ht(_.content);if(f+c<=m)g.unshift({role:_.role,content:_.content}),f+=c;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:r}),i+=f,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*Ya(e,t,r,a,n,s){var c;const o=new ue(t),i=(c=e.metadata)==null?void 0:c.thread_id;yield{type:"thinking",data:{threadId:i,provider:r.name}};const l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,20,i),u=Cr(a,l),m=Ja(u,d,e.text,r.name);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let f="",y=0;const _=[...m.messages];for(let h=0;h<g;h++)try{h>0&&(yield{type:"thinking",data:{threadId:i}});const p=await r.chat(_,{tools:Dr});if(p.usage&&(y+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},_.push({role:"assistant",content:p.content}));for(const w of p.toolCalls){yield{type:"tool_start",data:{tool:w.name,toolArgs:w.arguments,threadId:i}};try{const x=await Or(w.name,w.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);yield{type:"tool_end",data:{tool:w.name,toolResult:x.substring(0,500)+(x.length>500?"...":""),threadId:i}},_.push({role:"user",content:`[Tool Result for ${w.name}]: ${x}`})}catch(x){await I(t,a.id,"tool",w.name,x.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:w.name,toolResult:`Error: ${x.message||"Execution failed"}`,threadId:i}},_.push({role:"user",content:`[Tool Error for ${w.name}]: ${x.message||"Execution failed"}`})}}continue}f=p.content;const v=50;for(let w=0;w<f.length;w+=v)yield{type:"chunk",data:{text:f.substring(w,w+v),threadId:i}},w+v<f.length&&await new Promise(S=>setTimeout(S,10));break}catch(p){if(n){const v=p.message||"",w=v.includes("401")||v.includes("403")||v.includes("authentication")||v.includes("credit balance"),x=v.includes("429"),S=w?1440:x?10:5;await n.recordError(r.name,v,S)}await I(t,a.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:r.name,turn:h}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&y>0)try{await n.recordUsage(r.name,y)}catch{}await o.storeMessage(a.id,e.channel,"assistant",f,"{}",i),await o.compactHistory(a.id,30),yield{type:"done",data:{threadId:i,provider:r.name,tokenCount:y}}}const A=new pe;async function Va(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}A.use("/*",Va);A.get("/threads",async e=>{const t=e.get("user"),r=e.req.query("archived")==="1",a=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await K(r,t,l),!0}case"/help":{const i=`🛠 *${(a==null?void 0:a.assistant_name)||"Karna"} — Commands*
...
Status: ✅ Online`;await K(r,t,u)}catch{await K(r,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return a?(await K(r,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await K(r,t,"⚠️ Account not linked."),!0);default:return!1}}Ye.post("/webhook",async e=>{var t,r,a;try{const n=await e.req.json();if(n.callback_query)return await sn(e.env.DB,n.callback_query),e.json({ok:!0});const s=n.message;if(!(s!=null&&s.text))return e.json({ok:!0});const o=String(s.chat.id),i=s.text,l=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(o).first();let d=null;if(l){const f=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(l.id,"telegram_bot_token").first();f&&(d=await B(f.encrypted_value,l.pin_hash))}if(!d){const f=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();f&&(d=await B(f.encrypted_value,f.pin_hash))}if(!d)return e.json({ok:!0,message:"Bot token not configured"});if(i.startsWith("/")&&await nn(i,o,d,l,e.env.DB))return e.json({ok:!0});if(!l)return await K(d,o,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${o}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});await rn(d,o);const u=Qa(l.id,l.username,i,o);let m,g;try{const f=await Je(e.env.DB,l.id,l.pin_hash);m=f.provider,g=f.rotation}catch(f){console.error("Telegram provider setup error:",f);const y=(t=f.message)!=null&&t.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(r=f.message)!=null&&r.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${f.message||"Unknown error"}`;return await K(d,o,y),e.json({ok:!0})}try{const f=await It(u,e.env.DB,m,l,g,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),y=en(f,"telegram");await K(d,o,y||"(empty response)")}catch(f){console.error("Telegram agent error:",f);const y=(a=f.message)!=null&&a.includes("API error")?`⚠️ AI provider returned an error. The provider (${m.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(f.message||"Unknown").substring(0,200)}`;await K(d,o,y);try{const{logError:_}=await Promise.resolve().then(()=>yt);await _(e.env.DB,l.id,"telegram","agent_error",f.message||"Agent error",{provider:m.name})}catch{}}return e.json({ok:!0})}catch(n){console.error("Telegram webhook error:",n);try{const{logError:s}=await Promise.resolve().then(()=>yt);await s(e.env.DB,null,"telegram","webhook_error",n.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:n.message})}});Ye.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const{webhook_url:a}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await B(n.encrypted_value,r.pin_hash);if(!a){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:a,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});Ye.get("/webhook-status",async e=>{var s,o,i,l,d,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({configured:!1,error:"Bot token not set"});const n=await B(a.encrypted_value,r.pin_hash);try{const g=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=g.result)==null?void 0:o.url)||"",has_webhook:!!((i=g.result)!=null&&i.url),pending_updates:((l=g.result)==null?void 0:l.pending_update_count)||0,last_error:((d=g.result)==null?void 0:d.last_error_message)||"",last_error_date:((u=g.result)==null?void 0:u.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Ye.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({error:"Bot token not configured"},400);const n=await B(a.encrypted_value,r.pin_hash);try{const d=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(c=>setTimeout(c,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const g=m.result||[];if(g.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const f=[],y=new Set;for(let c=g.length-1;c>=0;c--){const h=g[c].message;if(h&&h.chat){const p=String(h.chat.id);y.has(p)||(y.add(p),f.push({chat_id:p,name:[h.chat.first_name,h.chat.last_name].filter(Boolean).join(" ")||h.chat.title||"Unknown",username:h.chat.username||"",date:new Date((h.date||0)*1e3).toISOString()}))}}if(f.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=f[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,r.user_id).run(),e.json({found:!0,chat_id:_,name:f[0].name,all_chats:f,message:`Chat ID ${_} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function sn(e,t){var _;const{id:r,data:a,message:n,from:s}=t;if(!a||!n)return;const o=a.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],l=parseInt(o[2]);if(!l||!i)return;const d=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!u)return;const m=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(u.id,l,i).first();if(!m)return;const g=m.checked?0:1;await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ?
  `).bind(g,g,m.id).run();const f=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!f)return;const y=await B(f.encrypted_value,f.pin_hash);if(await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:r,text:g?"✅ Checked!":"☐ Unchecked"})}),(_=n.reply_markup)!=null&&_.inline_keyboard){const c=n.reply_markup.inline_keyboard.map(h=>h.map(p=>{var v;if((v=p.callback_data)!=null&&v.includes(i)){const w=g?"✅":"☐",x=p.text.replace(/^[☐✅]\s*/,"");return{...p,text:`${w} ${x}`}}return p}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:c}})})}catch{}}}function on(e){const t=new Date,r=new Date(t.toLocaleString("en-US",{timeZone:e})),a=new Date(r);a.setDate(a.getDate()+1),a.setHours(0,0,0,0);const n=new Date(a);n.setHours(23,59,59,999);const s=a.toISOString().split("T")[0];return{start:a.toISOString(),end:n.toISOString(),dateStr:s}}async function ln(e,t,r,a,n,s){try{return(await new kt(e,t,r,a,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function dn(e,t,r,a,n){try{const s=new ne(e,t,r,a,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const g=m.from.split("<")[0].trim()||m.from;l[g]=(l[g]||0)+1}const d=Object.entries(l).sort(([,m],[,g])=>g-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:d,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function cn(e,t){var r;try{const a=await e.prepare(`
