var cr=Object.defineProperty;var Ft=e=>{throw TypeError(e)};var dr=(e,t,a)=>t in e?cr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var I=(e,t,a)=>dr(e,typeof t!="symbol"?t+"":t,a),xt=(e,t,a)=>t.has(e)||Ft("Cannot "+a);var w=(e,t,a)=>(xt(e,t,"read from private field"),a?a.call(e):t.get(e)),L=(e,t,a)=>t.has(e)?Ft("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),N=(e,t,a,r)=>(xt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),B=(e,t,a)=>(xt(e,t,"access private method"),a);var Wt=(e,t,a,r)=>({set _(s){N(e,t,s,a)},get _(){return w(e,t,r)}});var zt=(e,t,a)=>(r,s)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let l,c=!1,d;if(e[i]?(d=e[i][0][0],r.req.routeIndex=i):d=i===e.length&&s||void 0,d)try{l=await d(r,()=>o(i+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),c=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},ur=Symbol(),mr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,n=(e instanceof fa?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?pr(e,{all:a,dot:r}):{}};async function pr(e,t){const a=await e.formData();return a?hr(a,t):{}}function hr(e,t){const a=Object.create(null);return e.forEach((r,s)=>{t.all||s.endsWith("[]")?gr(a,s,r):a[s]=r}),t.dot&&Object.entries(a).forEach(([r,s])=>{r.includes(".")&&(fr(a,r,s),delete a[r])}),a}var gr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},fr=(e,t,a)=>{let r=e;const s=t.split(".");s.forEach((n,o)=>{o===s.length-1?r[n]=a:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},ua=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},yr=e=>{const{groups:t,path:a}=vr(e),r=ua(a);return wr(r,t)},vr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const s=`@${r}`;return t.push([s,a]),s}),{groups:t,path:e}},wr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let s=e.length-1;s>=0;s--)if(e[s].includes(r)){e[s]=e[s].replace(r,t[a][1]);break}}return e},ct={},br=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return ct[r]||(a[2]?ct[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ct[r]=[e,a[1],!0]),ct[r]}return null},Bt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},_r=e=>Bt(e,decodeURI),ma=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const s=t.charCodeAt(r);if(s===37){const n=t.indexOf("?",r),o=t.indexOf("#",r),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),l=t.slice(a,i);return _r(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(s===63||s===35)break}return t.slice(a,r)},Er=e=>{const t=ma(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Le=(e,t,...a)=>(a.length&&(t=Le(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),pa=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))r+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){a.length===0&&r===""?a.push("/"):a.push(r);const n=s.replace("?","");r+="/"+n,a.push(r)}else r+="/"+s}),a.filter((s,n,o)=>o.indexOf(s)===n)},kt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Bt(e,ga):e):e,ha=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return kt(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const s={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let l=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(r&&(l=kt(l)),n=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=kt(c))),a?(s[l]&&Array.isArray(s[l])||(s[l]=[]),s[l].push(c)):s[l]??(s[l]=c)}return t?s[t]:s},Tr=ha,xr=(e,t)=>ha(e,t,!0),ga=decodeURIComponent,qt=e=>Bt(e,ga),je,X,me,ya,va,Dt,he,na,fa=(na=class{constructor(e,t="/",a=[[]]){L(this,me);I(this,"raw");L(this,je);L(this,X);I(this,"routeIndex",0);I(this,"path");I(this,"bodyCache",{});L(this,he,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const s=Object.keys(t)[0];return s?t[s].then(n=>(s==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,N(this,X,a),N(this,je,{})}param(e){return e?B(this,me,ya).call(this,e):B(this,me,va).call(this)}query(e){return Tr(this.url,e)}queries(e){return xr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await mr(this,e))}json(){return w(this,he).call(this,"text").then(e=>JSON.parse(e))}text(){return w(this,he).call(this,"text")}arrayBuffer(){return w(this,he).call(this,"arrayBuffer")}blob(){return w(this,he).call(this,"blob")}formData(){return w(this,he).call(this,"formData")}addValidatedData(e,t){w(this,je)[e]=t}valid(e){return w(this,je)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ur](){return w(this,X)}get matchedRoutes(){return w(this,X)[0].map(([[,e]])=>e)}get routePath(){return w(this,X)[0].map(([[,e]])=>e)[this.routeIndex].path}},je=new WeakMap,X=new WeakMap,me=new WeakSet,ya=function(e){const t=w(this,X)[0][this.routeIndex][1][e],a=B(this,me,Dt).call(this,t);return a&&/\%/.test(a)?qt(a):a},va=function(){const e={},t=Object.keys(w(this,X)[0][this.routeIndex][1]);for(const a of t){const r=B(this,me,Dt).call(this,w(this,X)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?qt(r):r)}return e},Dt=function(e){return w(this,X)[1]?w(this,X)[1][e]:e},he=new WeakMap,na),kr={Stringify:1},wa=async(e,t,a,r,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(s?s[0]+=e:s=[e],Promise.all(n.map(i=>i({phase:t,buffer:s,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>wa(l,t,!1,r,s))).then(()=>s[0]))):Promise.resolve(e)},Sr="text/plain; charset=UTF-8",St=(e,t)=>({"Content-Type":e,...t}),Qe,et,le,Pe,ce,J,tt,Ue,He,ke,at,rt,ge,Me,oa,Ir=(oa=class{constructor(e,t){L(this,ge);L(this,Qe);L(this,et);I(this,"env",{});L(this,le);I(this,"finalized",!1);I(this,"error");L(this,Pe);L(this,ce);L(this,J);L(this,tt);L(this,Ue);L(this,He);L(this,ke);L(this,at);L(this,rt);I(this,"render",(...e)=>(w(this,Ue)??N(this,Ue,t=>this.html(t)),w(this,Ue).call(this,...e)));I(this,"setLayout",e=>N(this,tt,e));I(this,"getLayout",()=>w(this,tt));I(this,"setRenderer",e=>{N(this,Ue,e)});I(this,"header",(e,t,a)=>{this.finalized&&N(this,J,new Response(w(this,J).body,w(this,J)));const r=w(this,J)?w(this,J).headers:w(this,ke)??N(this,ke,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});I(this,"status",e=>{N(this,Pe,e)});I(this,"set",(e,t)=>{w(this,le)??N(this,le,new Map),w(this,le).set(e,t)});I(this,"get",e=>w(this,le)?w(this,le).get(e):void 0);I(this,"newResponse",(...e)=>B(this,ge,Me).call(this,...e));I(this,"body",(e,t,a)=>B(this,ge,Me).call(this,e,t,a));I(this,"text",(e,t,a)=>!w(this,ke)&&!w(this,Pe)&&!t&&!a&&!this.finalized?new Response(e):B(this,ge,Me).call(this,e,t,St(Sr,a)));I(this,"json",(e,t,a)=>B(this,ge,Me).call(this,JSON.stringify(e),t,St("application/json",a)));I(this,"html",(e,t,a)=>{const r=s=>B(this,ge,Me).call(this,s,t,St("text/html; charset=UTF-8",a));return typeof e=="object"?wa(e,kr.Stringify,!1,{}).then(r):r(e)});I(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});I(this,"notFound",()=>(w(this,He)??N(this,He,()=>new Response),w(this,He).call(this,this)));N(this,Qe,e),t&&(N(this,ce,t.executionCtx),this.env=t.env,N(this,He,t.notFoundHandler),N(this,rt,t.path),N(this,at,t.matchResult))}get req(){return w(this,et)??N(this,et,new fa(w(this,Qe),w(this,rt),w(this,at))),w(this,et)}get event(){if(w(this,ce)&&"respondWith"in w(this,ce))return w(this,ce);throw Error("This context has no FetchEvent")}get executionCtx(){if(w(this,ce))return w(this,ce);throw Error("This context has no ExecutionContext")}get res(){return w(this,J)||N(this,J,new Response(null,{headers:w(this,ke)??N(this,ke,new Headers)}))}set res(e){if(w(this,J)&&e){e=new Response(e.body,e);for(const[t,a]of w(this,J).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=w(this,J).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of r)e.headers.append("set-cookie",s)}else e.headers.set(t,a)}N(this,J,e),this.finalized=!0}get var(){return w(this,le)?Object.fromEntries(w(this,le)):{}}},Qe=new WeakMap,et=new WeakMap,le=new WeakMap,Pe=new WeakMap,ce=new WeakMap,J=new WeakMap,tt=new WeakMap,Ue=new WeakMap,He=new WeakMap,ke=new WeakMap,at=new WeakMap,rt=new WeakMap,ge=new WeakSet,Me=function(e,t,a){const r=w(this,J)?new Headers(w(this,J).headers):w(this,ke)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[n,o]of Object.entries(a))if(typeof o=="string")r.set(n,o);else{r.delete(n);for(const i of o)r.append(n,i)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??w(this,Pe);return new Response(e,{status:s,headers:r})},oa),F="ALL",Or="all",Cr=["get","post","put","delete","options","patch"],ba="Can not add a route since the matcher is already built.",_a=class extends Error{},Rr="__COMPOSED_HANDLER",Dr=e=>e.text("404 Not Found",404),Kt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,W,Ea,ee,Te,mt,pt,Ge,Nr=(Ge=class{constructor(t={}){L(this,W);I(this,"get");I(this,"post");I(this,"put");I(this,"delete");I(this,"options");I(this,"patch");I(this,"all");I(this,"on");I(this,"use");I(this,"router");I(this,"getPath");I(this,"_basePath","/");L(this,Q,"/");I(this,"routes",[]);L(this,ee,Dr);I(this,"errorHandler",Kt);I(this,"onError",t=>(this.errorHandler=t,this));I(this,"notFound",t=>(N(this,ee,t),this));I(this,"fetch",(t,...a)=>B(this,W,pt).call(this,t,a[1],a[0],t.method));I(this,"request",(t,a,r,s)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Le("/",t)}`,a),r,s)));I(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(B(this,W,pt).call(this,t.request,t,void 0,t.request.method))})});[...Cr,Or].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?N(this,Q,o):B(this,W,Te).call(this,n,w(this,Q),o),i.forEach(l=>{B(this,W,Te).call(this,n,w(this,Q),l)}),this)}),this.on=(n,o,...i)=>{for(const l of[o].flat()){N(this,Q,l);for(const c of[n].flat())i.map(d=>{B(this,W,Te).call(this,c.toUpperCase(),w(this,Q),d)})}return this},this.use=(n,...o)=>(typeof n=="string"?N(this,Q,n):(N(this,Q,"*"),o.unshift(n)),o.forEach(i=>{B(this,W,Te).call(this,F,w(this,Q),i)}),this);const{strict:r,...s}=t;Object.assign(this,s),this.getPath=r??!0?t.getPath??ma:Er}route(t,a){const r=this.basePath(t);return a.routes.map(s=>{var o;let n;a.errorHandler===Kt?n=s.handler:(n=async(i,l)=>(await zt([],a.errorHandler)(i,()=>s.handler(i,l))).res,n[Rr]=s.handler),B(o=r,W,Te).call(o,s.method,s.path,n)}),this}basePath(t){const a=B(this,W,Ea).call(this);return a._basePath=Le(this._basePath,t),a}mount(t,a,r){let s,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?s=l=>l:s=r.replaceRequest));const o=n?l=>{const c=n(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};s||(s=(()=>{const l=Le(this._basePath,t),c=l==="/"?0:l.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const i=async(l,c)=>{const d=await a(s(l.req.raw),...o(l));if(d)return d;await c()};return B(this,W,Te).call(this,F,Le(t,"*"),i),this}},Q=new WeakMap,W=new WeakSet,Ea=function(){const t=new Ge({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,N(t,ee,w(this,ee)),t.routes=this.routes,t},ee=new WeakMap,Te=function(t,a,r){t=t.toUpperCase(),a=Le(this._basePath,a);const s={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,s]),this.routes.push(s)},mt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},pt=function(t,a,r,s){if(s==="HEAD")return(async()=>new Response(null,await B(this,W,pt).call(this,t,a,r,"GET")))();const n=this.getPath(t,{env:r}),o=this.router.match(s,n),i=new Ir(t,{path:n,matchResult:o,env:r,executionCtx:a,notFoundHandler:w(this,ee)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await w(this,ee).call(this,i)})}catch(d){return B(this,W,mt).call(this,d,i)}return c instanceof Promise?c.then(d=>d||(i.finalized?i.res:w(this,ee).call(this,i))).catch(d=>B(this,W,mt).call(this,d,i)):c??w(this,ee).call(this,i)}const l=zt(o[0],this.errorHandler,w(this,ee));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return B(this,W,mt).call(this,c,i)}})()},Ge),Ta=[];function Ar(e,t){const a=this.buildAllMatchers(),r=((s,n)=>{const o=a[s]||a[F],i=o[2][n];if(i)return i;const l=n.match(o[0]);if(!l)return[[],Ta];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var gt="[^/]+",Ve=".*",Xe="(?:|/.*)",$e=Symbol(),Lr=new Set(".\\+*[^]$()");function Mr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ve||e===Xe?1:t===Ve||t===Xe?-1:e===gt?1:t===gt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Se,Ie,te,Re,$r=(Re=class{constructor(){L(this,Se);L(this,Ie);L(this,te,Object.create(null))}insert(t,a,r,s,n){if(t.length===0){if(w(this,Se)!==void 0)throw $e;if(n)return;N(this,Se,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Ve]:["","",gt]:o==="/*"?["","",Xe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let p=l[2]||gt;if(d&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw $e;if(c=w(this,te)[p],!c){if(Object.keys(w(this,te)).some(g=>g!==Ve&&g!==Xe))throw $e;if(n)return;c=w(this,te)[p]=new Re,d!==""&&N(c,Ie,s.varIndex++)}!n&&d!==""&&r.push([d,w(c,Ie)])}else if(c=w(this,te)[o],!c){if(Object.keys(w(this,te)).some(d=>d.length>1&&d!==Ve&&d!==Xe))throw $e;if(n)return;c=w(this,te)[o]=new Re}c.insert(i,a,r,s,n)}buildRegExpStr(){const a=Object.keys(w(this,te)).sort(Mr).map(r=>{const s=w(this,te)[r];return(typeof w(s,Ie)=="number"?`(${r})@${w(s,Ie)}`:Lr.has(r)?`\\${r}`:r)+s.buildRegExpStr()});return typeof w(this,Se)=="number"&&a.unshift(`#${w(this,Se)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Se=new WeakMap,Ie=new WeakMap,te=new WeakMap,Re),yt,st,ia,Br=(ia=class{constructor(){L(this,yt,{varIndex:0});L(this,st,new $r)}insert(e,t,a){const r=[],s=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return s[o]=[c,l],o++,i=!0,c}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=s.length-1;o>=0;o--){const[i]=s[o];for(let l=n.length-1;l>=0;l--)if(n[l].indexOf(i)!==-1){n[l]=n[l].replace(i,s[o][1]);break}}return w(this,st).insert(n,t,r,w(this,yt),a),r}buildRegExp(){let e=w(this,st).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,n,o)=>n!==void 0?(a[++t]=Number(n),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},yt=new WeakMap,st=new WeakMap,ia),jr=[/^$/,[],Object.create(null)],ht=Object.create(null);function xa(e){return ht[e]??(ht[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Pr(){ht=Object.create(null)}function Ur(e){var c;const t=new Br,a=[];if(e.length===0)return jr;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[g,v])=>d?1:g?-1:p.length-v.length),s=Object.create(null);for(let d=0,p=-1,g=r.length;d<g;d++){const[v,f,E]=r[d];v?s[f]=[E.map(([T])=>[T,Object.create(null)]),Ta]:p++;let b;try{b=t.insert(f,p,v)}catch(T){throw T===$e?new _a(f):T}v||(a[p]=E.map(([T,u])=>{const h=Object.create(null);for(u-=1;u>=0;u--){const[m,y]=b[u];h[m]=y}return[T,h]}))}const[n,o,i]=t.buildRegExp();for(let d=0,p=a.length;d<p;d++)for(let g=0,v=a[d].length;g<v;g++){const f=(c=a[d][g])==null?void 0:c[1];if(!f)continue;const E=Object.keys(f);for(let b=0,T=E.length;b<T;b++)f[E[b]]=i[f[E[b]]]}const l=[];for(const d in o)l[d]=a[o[d]];return[n,l,s]}function Ne(e,t){if(e){for(const a of Object.keys(e).sort((r,s)=>s.length-r.length))if(xa(a).test(t))return[...e[a]]}}var fe,ye,vt,ka,la,Hr=(la=class{constructor(){L(this,vt);I(this,"name","RegExpRouter");L(this,fe);L(this,ye);I(this,"match",Ar);N(this,fe,{[F]:Object.create(null)}),N(this,ye,{[F]:Object.create(null)})}add(e,t,a){var i;const r=w(this,fe),s=w(this,ye);if(!r||!s)throw new Error(ba);r[e]||[r,s].forEach(l=>{l[e]=Object.create(null),Object.keys(l[F]).forEach(c=>{l[e][c]=[...l[F][c]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=xa(t);e===F?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=Ne(r[c],t)||Ne(r[F],t)||[])}):(i=r[e])[t]||(i[t]=Ne(r[e],t)||Ne(r[F],t)||[]),Object.keys(r).forEach(c=>{(e===F||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,n])})}),Object.keys(s).forEach(c=>{(e===F||e===c)&&Object.keys(s[c]).forEach(d=>l.test(d)&&s[c][d].push([a,n]))});return}const o=pa(t)||[t];for(let l=0,c=o.length;l<c;l++){const d=o[l];Object.keys(s).forEach(p=>{var g;(e===F||e===p)&&((g=s[p])[d]||(g[d]=[...Ne(r[p],d)||Ne(r[F],d)||[]]),s[p][d].push([a,n-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(w(this,ye)).concat(Object.keys(w(this,fe))).forEach(t=>{e[t]||(e[t]=B(this,vt,ka).call(this,t))}),N(this,fe,N(this,ye,void 0)),Pr(),e}},fe=new WeakMap,ye=new WeakMap,vt=new WeakSet,ka=function(e){const t=[];let a=e===F;return[w(this,fe),w(this,ye)].forEach(r=>{const s=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];s.length!==0?(a||(a=!0),t.push(...s)):e!==F&&t.push(...Object.keys(r[F]).map(n=>[n,r[F][n]]))}),a?Ur(t):null},la),ve,de,ca,Gr=(ca=class{constructor(e){I(this,"name","SmartRouter");L(this,ve,[]);L(this,de,[]);N(this,ve,e.routers)}add(e,t,a){if(!w(this,de))throw new Error(ba);w(this,de).push([e,t,a])}match(e,t){if(!w(this,de))throw new Error("Fatal error");const a=w(this,ve),r=w(this,de),s=a.length;let n=0,o;for(;n<s;n++){const i=a[n];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof _a)continue;throw l}this.match=i.match.bind(i),N(this,ve,[i]),N(this,de,void 0);break}if(n===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(w(this,de)||w(this,ve).length!==1)throw new Error("No active router has been determined yet.");return w(this,ve)[0]}},ve=new WeakMap,de=new WeakMap,ca),qe=Object.create(null),we,K,Oe,Fe,q,ue,xe,We,Fr=(We=class{constructor(t,a,r){L(this,ue);L(this,we);L(this,K);L(this,Oe);L(this,Fe,0);L(this,q,qe);if(N(this,K,r||Object.create(null)),N(this,we,[]),t&&a){const s=Object.create(null);s[t]={handler:a,possibleKeys:[],score:0},N(this,we,[s])}N(this,Oe,[])}insert(t,a,r){N(this,Fe,++Wt(this,Fe)._);let s=this;const n=yr(a),o=[];for(let i=0,l=n.length;i<l;i++){const c=n[i],d=n[i+1],p=br(c,d),g=Array.isArray(p)?p[0]:c;if(g in w(s,K)){s=w(s,K)[g],p&&o.push(p[1]);continue}w(s,K)[g]=new We,p&&(w(s,Oe).push(p),o.push(p[1])),s=w(s,K)[g]}return w(s,we).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:w(this,Fe)}}),s}search(t,a){var l;const r=[];N(this,q,qe);let n=[this];const o=ua(a),i=[];for(let c=0,d=o.length;c<d;c++){const p=o[c],g=c===d-1,v=[];for(let f=0,E=n.length;f<E;f++){const b=n[f],T=w(b,K)[p];T&&(N(T,q,w(b,q)),g?(w(T,K)["*"]&&r.push(...B(this,ue,xe).call(this,w(T,K)["*"],t,w(b,q))),r.push(...B(this,ue,xe).call(this,T,t,w(b,q)))):v.push(T));for(let u=0,h=w(b,Oe).length;u<h;u++){const m=w(b,Oe)[u],y=w(b,q)===qe?{}:{...w(b,q)};if(m==="*"){const k=w(b,K)["*"];k&&(r.push(...B(this,ue,xe).call(this,k,t,w(b,q))),N(k,q,y),v.push(k));continue}const[_,x,C]=m;if(!p&&!(C instanceof RegExp))continue;const R=w(b,K)[_],S=o.slice(c).join("/");if(C instanceof RegExp){const k=C.exec(S);if(k){if(y[x]=k[0],r.push(...B(this,ue,xe).call(this,R,t,w(b,q),y)),Object.keys(w(R,K)).length){N(R,q,y);const O=((l=k[0].match(/\//))==null?void 0:l.length)??0;(i[O]||(i[O]=[])).push(R)}continue}}(C===!0||C.test(p))&&(y[x]=p,g?(r.push(...B(this,ue,xe).call(this,R,t,y,w(b,q))),w(R,K)["*"]&&r.push(...B(this,ue,xe).call(this,w(R,K)["*"],t,y,w(b,q)))):(N(R,q,y),v.push(R)))}}n=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},we=new WeakMap,K=new WeakMap,Oe=new WeakMap,Fe=new WeakMap,q=new WeakMap,ue=new WeakSet,xe=function(t,a,r,s){const n=[];for(let o=0,i=w(t,we).length;o<i;o++){const l=w(t,we)[o],c=l[a]||l[F],d={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),r!==qe||s&&s!==qe))for(let p=0,g=c.possibleKeys.length;p<g;p++){const v=c.possibleKeys[p],f=d[c.score];c.params[v]=s!=null&&s[v]&&!f?s[v]:r[v]??(s==null?void 0:s[v]),d[c.score]=!0}}return n},We),Ce,da,Wr=(da=class{constructor(){I(this,"name","TrieRouter");L(this,Ce);N(this,Ce,new Fr)}add(e,t,a){const r=pa(t);if(r){for(let s=0,n=r.length;s<n;s++)w(this,Ce).insert(e,r[s],a);return}w(this,Ce).insert(e,t,a)}match(e,t){return w(this,Ce).search(e,t)}},Ce=new WeakMap,da),be=class extends Nr{constructor(e={}){super(e),this.router=e.router??new Gr({routers:[new Hr,new Wr]})}},zr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(a.origin),s=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(a.allowMethods);return async function(o,i){var d;function l(p,g){o.res.headers.set(p,g)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await s(o.req.header("origin")||"",o);p.length&&l("Access-Control-Allow-Methods",p.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Sa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>Ca),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const p=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!p)return;const g=await c(p.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${g}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(o){console.error("Failed to send provider alert:",o)}}function Yt(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Da{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",s="anthropic"){I(this,"name");I(this,"apiKey");I(this,"model");I(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=s}async chat(t,a){var d,p,g,v;const r=t.find(f=>f.role==="system"),s=t.filter(f=>f.role!=="system"),n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:s.map(f=>({role:f.role,content:f.content}))};r&&(n.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(n.tools=a.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})));const o=await Ra(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(n)}),this.name);if(!o.ok){const f=await o.text();throw new Error(this.name+" API error "+o.status+": "+f)}const i=await o.json(),l=((d=i.content)==null?void 0:d.filter(f=>f.type==="text"))||[],c=((p=i.content)==null?void 0:p.filter(f=>f.type==="tool_use"))||[];return{content:l.map(f=>f.text).join(`
`),toolCalls:c.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((g=i.usage)==null?void 0:g.input_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(c=>c.role==="system"),s=t.filter(c=>c.role!=="system"),n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:s.map(c=>({role:c.role,content:c.content}))};r&&(n.system=r.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(n)});if(!o.ok){const c=await o.text();throw new Error(this.name+" stream error "+o.status+": "+c)}const i=o.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var f;const{done:d,value:p}=await i.read();if(d){c.close();return}const v=l.decode(p,{stream:!0}).split(`
`);for(const E of v)if(E.startsWith("data: ")){const b=E.slice(6);if(b==="[DONE]")continue;try{const T=JSON.parse(b);T.type==="content_block_delta"&&((f=T.delta)!=null&&f.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:T.delta.text})+`

`))}catch{}}}})}}function Yr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const s={};for(const[n,o]of Object.entries(r))o&&typeof o=="object"?s[n]=Nt(o):s[n]=o;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Nt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[s,n]of Object.entries(a))n&&typeof n=="object"?r[s]=Nt(n):r[s]=n;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Nt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Na{constructor(t,a,r,s){I(this,"name");I(this,"apiKey");I(this,"model");I(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=s}async chat(t,a){var l,c,d,p,g,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},s=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&s)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:Yr(f.parameters||{})}})));const n=await Ra(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)}),this.name);if(!n.ok){const f=await n.text();throw new Error(this.name+" API error "+n.status+": "+f)}const o=await n.json(),i=(l=o.choices)==null?void 0:l[0];return{content:((c=i==null?void 0:i.message)==null?void 0:c.content)||"",toolCalls:(p=(d=i==null?void 0:i.message)==null?void 0:d.tool_calls)==null?void 0:p.map(f=>({id:f.id,name:f.function.name,arguments:(()=>{try{return typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((g=o.usage)==null?void 0:g.prompt_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const i=await s.text();throw new Error(this.name+" stream error "+s.status+": "+i)}const n=s.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var g,v,f;const{done:l,value:c}=await n.read();if(l){i.close();return}const p=o.decode(c,{stream:!0}).split(`
...
`))}catch{}}}})}}function At(e,t,a,r){const s=Ze[e];if(!s)throw new Error(`Unknown LLM provider: ${e}`);const n=r||s.defaultModel;return s.apiFormat==="anthropic"?new Da(t,n,s.apiBase,a):new Na(t,n,s.apiBase,a)}class Aa{constructor(){I(this,"errorLog",new Map);I(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(s=>{const n=this.errorLog.get(s);return n?n.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const Jr=["llm_slot_1","llm_slot_2","llm_slot_3"],Vr=["anthropic","openai"];async function nt(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Ca),s=new Aa,n=[];for(const p of Jr){const g=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(g)try{const v=await r(g.encrypted_value,a),f=JSON.parse(v);if(f.provider&&f.apiKey&&Ze[f.provider]){const b=f.provider,T=At(f.provider,f.apiKey,b,f.model);n.push({name:b,provider:T})}}catch(v){console.error(`Failed to load ${p}:`,v)}}const o=new Set(n.map(p=>p.name));for(const p of Vr){if(o.has(p))continue;const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(g)try{const v=await r(g.encrypted_value,a);if(Ze[p]){const E=At(p,v,p);n.push({name:p,provider:E})}}catch{console.error(`Failed to decrypt legacy ${p} key`)}}if(n.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=n.map(p=>p.name),l=await s.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:n[0].provider,rotation:s};const c=n.find(p=>p.name===l);return{provider:Xr(c.provider,n,s,e,t),rotation:s}}function Xr(e,t,a,r,s){const n=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(l){const c=l.message||"";throw n(c)&&!c.includes("TOOLS_UNSUPPORTED")&&It(r,s,"all_providers_down",e.name,null,c),l}},async streamChat(o,i){return await e.streamChat(o,i)}}:{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(l){const c=l.message||"";if(!n(c))throw l;const d=c.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${d?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,d?1:1440);const p=t.filter(g=>g.name!==e.name);for(const g of p)try{const v=await g.provider.chat(o,i);return this.name=g.name,d||It(r,s,"provider_switched",e.name,g.name,c),v}catch(v){const f=v.message||"";if(n(f)){await a.recordError(g.name,f,1440);continue}throw v}throw It(r,s,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,i){return await e.streamChat(o,i)}}}const Lt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Da,OpenAICompatibleProvider:Na,ProviderRotation:Aa,createProviderFromConfig:At,createRotatingProvider:nt,logError:A},Symbol.toStringTag,{value:"Module"})),Ot=20,Zr=2e3,Qr=2e3,La=4;function es(e){return Math.ceil(e.length/La)}function Jt(e,t){const a=t*La;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class Z{constructor(t){this.db=t}async store(t,a,r,s,n=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>Ot){const r=((a==null?void 0:a.cnt)||0)-Ot;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
         ...
         )`).bind(t,t,r).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,Ot).all()).results||[]}async getAll(t,a,r=50){return a?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a,r).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,r).all()).results||[]}async search(t,a,r=10){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${a}%`,`%${a}%`,r).all()).results||[]}async update(t,a,r){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t,a).run()}async promote(t,a){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run(),await this.enforceWorkingMemoryCap(a)}async demote(t,a){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run()}async remove(t,a){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,a).run()}async buildContext(t){const a=await this.getWorkingMemory(t);if(a.length===0)return"";const r={};for(const n of a)r[n.type]||(r[n.type]=[]),r[n.type].push(n);let s=`
## Working Memory (Active Context)
`;for(const[n,o]of Object.entries(r)){s+=`
### ${n.charAt(0).toUpperCase()+n.slice(1)}s
`;for(const i of o)s+=`- **${i.title}**: ${i.content}
`}return Jt(s,Zr)}static truncatePersonality(t){return Jt(t,Qr)}async getRecentConversations(t,a=20,r){return r?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r,a).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a).all()).results||[]).reverse()}async storeMessage(t,a,r,s,n="{}",o){const i=es(s);o?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,i,o).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,i).run()}async compactHistory(t,a=30){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((r==null?void 0:r.cnt)||0)<=a*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,a).run()}}const ts="https://accounts.google.com/o/oauth2/v2/auth",Ma="https://oauth2.googleapis.com/token",as="https://www.googleapis.com/oauth2/v2/userinfo",rs=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let se=null;async function Mt(e,t,a){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!r)return null;try{const s=await U(r.encrypted_value,a);return JSON.parse(s)}catch{return null}}async function ss(e,t,a,r){const s=await Pt(JSON.stringify(r),a);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,s).run()}function $a(e,t,a){const r=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:rs,access_type:"offline",prompt:"consent",state:a,include_granted_scopes:"true"});return`${ts}?${r}`}async function Ba(e,t,a,r){const s=await fetch(Ma,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:a,redirect_uri:r,grant_type:"authorization_code"})}),n=await s.text();if(!s.ok)throw new Error(`Token exchange failed (${s.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function ns(e,t,a){const r=await fetch(Ma,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:a,grant_type:"refresh_token"})}),s=await r.text();if(!r.ok)throw r.status===400||r.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${r.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function ja(e){const t=await fetch(as,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function ze(e,t,a,r,s){if(!r||!s)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(se&&se.userId===t&&se.expiresAt>Date.now()/1e3+60){const i=await Mt(e,t,a);return{token:se.token,email:(i==null?void 0:i.email)||"unknown"}}const n=await Mt(e,t,a);if(!n)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const o=await ns(n.refresh_token,r,s);return se={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{token:o.access_token,email:n.email}}async function Ut(e,t,a){try{const r=await Mt(e,t,a);return r?{connected:!0,email:r.email,connectedAt:r.connected_at}:{connected:!1}}catch{return{connected:!1}}}function Pa(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function Ua(e,t,a,r,s,n,o){const i=await Ba(r,n,o,s);if(!i.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await ja(i.access_token),c={refresh_token:i.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await ss(e,t,a,c),se={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{email:l.email,name:l.name}}async function Ha(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(se==null?void 0:se.userId)===t&&(se=null)}const Ke="https://sheets.googleapis.com/v4/spreadsheets";class Ga{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await ze(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,a){const r=await this.authHeaders(),s=encodeURIComponent(a),n=await fetch(`${Ke}/${t}/values/${s}`,{headers:r});if(!n.ok){const i=await n.text();throw new Error(`Sheets read failed (${n.status}): ${i}`)}return(await n.json()).values||[]}async writeRange(t,a,r){const s=await this.authHeaders(),n=encodeURIComponent(a),o=await fetch(`${Ke}/${t}/values/${n}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:s,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!o.ok){const l=await o.text();throw new Error(`Sheets write failed (${o.status}): ${l}`)}return{updatedCells:(await o.json()).updatedCells||0}}async appendRows(t,a,r){var l;const s=await this.authHeaders(),n=encodeURIComponent(a),o=await fetch(`${Ke}/${t}/values/${n}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:s,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!o.ok){const c=await o.text();throw new Error(`Sheets append failed (${o.status}): ${c}`)}return{updatedCells:((l=(await o.json()).updates)==null?void 0:l.updatedCells)||r.length}}async createSpreadsheet(t,a){const r=await this.authHeaders(),s={properties:{title:t},sheets:a&&a.length>0?a.map(i=>({properties:{title:i}})):[{properties:{title:"Sheet1"}}]},n=await fetch(Ke,{method:"POST",headers:r,body:JSON.stringify(s)});if(!n.ok){const i=await n.text();throw new Error(`Sheets create failed (${n.status}): ${i}`)}const o=await n.json();return{spreadsheetId:o.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${o.spreadsheetId}/edit`}}async getMetadata(t){const a=await this.authHeaders(),r=await fetch(`${Ke}/${t}?fields=properties.title,sheets.properties.title`,{headers:a});if(!r.ok){const n=await r.text();throw new Error(`Sheets metadata failed (${r.status}): ${n}`)}const s=await r.json();return{title:s.properties.title,sheets:s.sheets.map(n=>n.properties.title)}}}const Ye="https://www.googleapis.com/calendar/v3";class Ht{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await ze(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",a={}){const r=await this.authHeaders(),s=new URLSearchParams;a.timeMin&&s.set("timeMin",a.timeMin),a.timeMax&&s.set("timeMax",a.timeMax),s.set("maxResults",String(a.maxResults||20)),s.set("singleEvents","true"),s.set("orderBy","startTime"),a.query&&s.set("q",a.query);const n=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events?${s}`,{headers:r});if(!n.ok){const i=await n.text();throw new Error(`Calendar list failed (${n.status}): ${i}`)}return(await n.json()).items||[]}async createEvent(t="primary",a){var i;const r=await this.authHeaders(),s=a.timeZone||"Asia/Kolkata",n={summary:a.summary,description:a.description||"",location:a.location||"",start:{dateTime:a.startDateTime,timeZone:s},end:{dateTime:a.endDateTime,timeZone:s}};(i=a.attendees)!=null&&i.length&&(n.attendees=a.attendees.map(l=>({email:l})));const o=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:r,body:JSON.stringify(n)});if(!o.ok){const l=await o.text();throw new Error(`Calendar create failed (${o.status}): ${l}`)}return await o.json()}async updateEvent(t="primary",a,r){const s=await this.authHeaders(),n=r.timeZone||"Asia/Kolkata",o={};r.summary&&(o.summary=r.summary),r.description&&(o.description=r.description),r.location&&(o.location=r.location),r.startDateTime&&(o.start={dateTime:r.startDateTime,timeZone:n}),r.endDateTime&&(o.end={dateTime:r.endDateTime,timeZone:n});const i=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"PATCH",headers:s,body:JSON.stringify(o)});if(!i.ok){const l=await i.text();throw new Error(`Calendar update failed (${i.status}): ${l}`)}return await i.json()}async deleteEvent(t="primary",a){const r=await this.authHeaders(),s=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"DELETE",headers:r});if(!s.ok&&s.status!==410){const n=await s.text();throw new Error(`Calendar delete failed (${s.status}): ${n}`)}}async listCalendars(){const t=await this.authHeaders(),a=await fetch(`${Ye}/users/me/calendarList`,{headers:t});if(!a.ok){const s=await a.text();throw new Error(`Calendar list calendars failed (${a.status}): ${s}`)}return((await a.json()).items||[]).map(s=>({id:s.id,summary:s.summary,primary:s.primary||!1}))}}const dt="https://docs.googleapis.com/v1/documents",os="https://www.googleapis.com/drive/v3/files";class Fa{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await ze(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const a=await this.authHeaders(),r=await fetch(dt,{method:"POST",headers:a,body:JSON.stringify({title:t})});if(!r.ok){const n=await r.text();throw new Error(`Docs create failed (${r.status}): ${n}`)}const s=await r.json();return{documentId:s.documentId,url:`https://docs.google.com/document/d/${s.documentId}/edit`}}async readDocument(t){var o,i;const a=await this.authHeaders(),r=await fetch(`${dt}/${t}`,{headers:a});if(!r.ok){const l=await r.text();throw new Error(`Docs read failed (${r.status}): ${l}`)}const s=await r.json();let n="";for(const l of((o=s.body)==null?void 0:o.content)||[])if(l.paragraph)for(const c of l.paragraph.elements)(i=c.textRun)!=null&&i.content&&(n+=c.textRun.content);return{title:s.title,content:n.trim()}}async appendText(t,a){const r=await this.authHeaders(),s=await fetch(`${dt}/${t}`,{headers:r});if(!s.ok){const l=await s.text();throw new Error(`Docs read for append failed (${s.status}): ${l}`)}const n=await s.json(),o=n.body.content[n.body.content.length-1].endIndex-1,i=await fetch(`${dt}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{insertText:{location:{index:o},text:a}}]})});if(!i.ok){const l=await i.text();throw new Error(`Docs append failed (${i.status}): ${l}`)}}async shareDocument(t,a,r="writer"){const s=await this.authHeaders(),n=await fetch(`${os}/${t}/permissions`,{method:"POST",headers:s,body:JSON.stringify({type:"user",role:r,emailAddress:a})});if(!n.ok){const o=await n.text();throw new Error(`Share failed (${n.status}): ${o}`)}}}class re{constructor(t,a,r,s,n){I(this,"sheets");I(this,"calendar");I(this,"docs");I(this,"db");I(this,"userId");I(this,"pinHash");this.db=t,this.userId=a,this.pinHash=r,this.sheets=new Ga(t,a,r,s,n),this.calendar=new Ht(t,a,r,s,n),this.docs=new Fa(t,a,r,s,n)}async isConnected(){return Ut(this.db,this.userId,this.pinHash)}}const ut=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:Ht,GoogleDocs:Fa,GoogleServices:re,GoogleSheets:Ga,completeOAuthFlow:Ua,disconnectGoogle:Ha,exchangeCodeForTokens:Ba,fetchUserInfo:ja,generateAuthUrl:$a,getGoogleAuth:ze,isGoogleConnected:Ut,isOAuthClientConfigured:Pa},Symbol.toStringTag,{value:"Module"}));async function Wa(e,t,a={}){const r={textQuery:t,languageCode:"en",pageSize:8};if(a.type&&(r.includedType=a.type),a.location){const l=a.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(r.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:a.radius||5e3}})}const s=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),n=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":s},body:JSON.stringify(r)});if(!n.ok){const l=await n.text();return{results:[],error:`Places API error (${n.status}): ${l.substring(0,200)}`}}const o=await n.json();return!o.places||o.places.length===0?{results:[]}:{results:o.places.map(l=>{var c,d,p;return{name:((c=l.displayName)==null?void 0:c.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(d=l.currentOpeningHours)==null?void 0:d.openNow,types:(p=l.types)==null?void 0:p.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function za(e,t){var n,o,i;const a=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),r=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":a}});if(!r.ok){const l=await r.text();return{error:`Place Details API error (${r.status}): ${l.substring(0,200)}`}}const s=await r.json();return{details:{name:((n=s.displayName)==null?void 0:n.text)||"",address:s.formattedAddress||"",phone:s.internationalPhoneNumber,website:s.websiteUri,rating:s.rating,reviews:(o=s.reviews)==null?void 0:o.slice(0,3).map(l=>{var c,d,p;return{author:((c=l.authorAttribution)==null?void 0:c.displayName)||"Anonymous",rating:l.rating||0,text:((p=(d=l.text)==null?void 0:d.text)==null?void 0:p.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(i=s.currentOpeningHours)==null?void 0:i.weekdayDescriptions,location:s.location?{lat:s.location.latitude,lng:s.location.longitude}:void 0,googleMapsUri:s.googleMapsUri}}}async function qa(e,t,a,r={}){var c;const s=new URLSearchParams({origin:t,destination:a,key:e,mode:r.mode||"driving"});(r.mode==="driving"||!r.mode)&&s.set("departure_time","now");const n=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${s}`);if(!n.ok)return{error:`Directions API error: ${n.status}`};const o=await n.json();if(o.status!=="OK")return{error:`Directions: ${o.status} — ${o.error_message||""}`};const i=o.routes[0],l=i.legs[0];return{route:{summary:i.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(c=l.duration_in_traffic)==null?void 0:c.text,steps:l.steps.slice(0,10).map(d=>{var p,g,v;return{instruction:((p=d.html_instructions)==null?void 0:p.replace(/<[^>]*>/g,""))||"",distance:((g=d.distance)==null?void 0:g.text)||"",duration:((v=d.duration)==null?void 0:v.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function Ka(e,t,a,r){var l,c;const s={q:t,target:a,key:e,format:"text"};r&&(s.source=r);const n=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(!n.ok){const d=await n.text();return{translatedText:"",error:`Translate API error (${n.status}): ${d.substring(0,200)}`}}const i=(c=(l=(await n.json()).data)==null?void 0:l.translations)==null?void 0:c[0];return i?{translatedText:i.translatedText,detectedSourceLang:i.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function Ya(e,t){const a=new URLSearchParams({address:t,key:e}),r=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${a}`);if(!r.ok)return{results:[],error:`Geocoding API error: ${r.status}`};const s=await r.json();return s.status!=="OK"&&s.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${s.status} — ${s.error_message||""}`}:{results:(s.results||[]).slice(0,5).map(n=>{var o;return{address:n.formatted_address,lat:n.geometry.location.lat,lng:n.geometry.location.lng,placeId:n.place_id,types:(o=n.types)==null?void 0:o.slice(0,3)}})}}async function Ja(e,t,a={}){const r=new URLSearchParams({part:"snippet",q:t,key:e,type:a.type||"video",maxResults:String(a.maxResults||5),order:a.order||"relevance"}),s=await fetch(`https://www.googleapis.com/youtube/v3/search?${r}`);if(!s.ok){const o=await s.text();return{results:[],error:`YouTube API error (${s.status}): ${o.substring(0,200)}`}}return{results:((await s.json()).items||[]).map(o=>{var i,l,c,d,p,g,v,f;return{title:o.snippet.title,channelTitle:o.snippet.channelTitle,description:(i=o.snippet.description)==null?void 0:i.substring(0,200),videoId:((l=o.id)==null?void 0:l.videoId)||((c=o.id)==null?void 0:c.channelId)||((d=o.id)==null?void 0:d.playlistId)||"",publishedAt:o.snippet.publishedAt,url:(p=o.id)!=null&&p.videoId?`https://www.youtube.com/watch?v=${o.id.videoId}`:(g=o.id)!=null&&g.channelId?`https://www.youtube.com/channel/${o.id.channelId}`:"",thumbnailUrl:(f=(v=o.snippet.thumbnails)==null?void 0:v.medium)==null?void 0:f.url}})}}async function bt(e,t={}){const a=Math.min(t.num||5,10),r=t.site?`site:${t.site} ${e}`:e;try{const s=new URLSearchParams({q:r}),n=await fetch(`https://html.duckduckgo.com/html/?${s}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!n.ok)return{results:[],error:`Search request failed (${n.status})`};const o=await n.text(),i=[],l=o.split(/class="result results_links/g).slice(1);for(const c of l){if(i.length>=a)break;const d=c.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),p=c.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(d){let g=d[1];const v=g.match(/uddg=([^&]+)/);v?g=decodeURIComponent(v[1]):g.startsWith("//")&&(g="https:"+g);const f=T=>T.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),E=f(d[2]),b=p?f(p[1]):"";if(E&&g.startsWith("http")){const T=g.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];i.push({title:E,link:g,snippet:b,displayLink:T})}}}return i.length===0?{results:[],error:void 0}:{results:i}}catch(s){return{results:[],error:`Web search error: ${s.message}`}}}async function Va(e,t,a,r="driving"){var l,c,d,p;const s=new URLSearchParams({origins:t,destinations:a,key:e,mode:r,departure_time:"now"}),n=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${s}`);if(!n.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${n.status}`};const o=await n.json(),i=(d=(c=(l=o.rows)==null?void 0:l[0])==null?void 0:c.elements)==null?void 0:d[0];return!i||i.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(i==null?void 0:i.status)||o.status}`}:{distance:i.distance.text,duration:i.duration.text,durationInTraffic:(p=i.duration_in_traffic)==null?void 0:p.text}}const is=Object.freeze(Object.defineProperty({__proto__:null,geocode:Ya,getDirections:qa,getDistanceMatrix:Va,getPlaceDetails:za,searchPlaces:Wa,searchYouTube:Ja,translateText:Ka,webSearch:bt},Symbol.toStringTag,{value:"Module"})),oe="https://gmail.googleapis.com/gmail/v1/users/me";class ie{constructor(t,a,r,s,n){this.db=t,this.userId=a,this.pinHash=r,this.clientId=s,this.clientSecret=n}async authHeaders(){const{token:t}=await ze(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var i;const a=await this.authHeaders(),r=new URLSearchParams;if(r.set("maxResults",String(t.maxResults||10)),t.query&&r.set("q",t.query),(i=t.labelIds)!=null&&i.length)for(const l of t.labelIds)r.append("labelIds",l);const s=await fetch(`${oe}/messages?${r}`,{headers:a});if(!s.ok){const l=await s.text();throw new Error(`Gmail list failed (${s.status}): ${l.substring(0,200)}`)}const n=await s.json();if(!n.messages||n.messages.length===0)return[];const o=[];for(const l of n.messages.slice(0,t.maxResults||10))try{const c=await this.getMessage(l.id,a);c&&o.push(c)}catch{}return o}async getMessage(t,a){const r=a||await this.authHeaders(),s=await fetch(`${oe}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:r});if(!s.ok)return null;const n=await s.json(),o=i=>{var l,c,d;return((d=(c=(l=n.payload)==null?void 0:l.headers)==null?void 0:c.find(p=>p.name.toLowerCase()===i.toLowerCase()))==null?void 0:d.value)||""};return{id:n.id,threadId:n.threadId,snippet:n.snippet||"",subject:o("Subject")||"(no subject)",from:o("From"),to:o("To"),date:o("Date")||new Date(parseInt(n.internalDate)).toISOString(),isUnread:(n.labelIds||[]).includes("UNREAD"),labels:n.labelIds||[]}}async getMessageBody(t){const a=await this.authHeaders(),r=await fetch(`${oe}/messages/${t}?format=full`,{headers:a});if(!r.ok){const n=await r.text();throw new Error(`Gmail message body failed (${r.status}): ${n.substring(0,200)}`)}const s=await r.json();return Xa(s.payload)}async search(t,a=10){return this.listMessages({query:t,maxResults:a})}async send(t,a,r,s={}){const n=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];s.cc&&o.push(`Cc: ${s.cc}`),s.bcc&&o.push(`Bcc: ${s.bcc}`),s.replyToMessageId&&(o.push(`In-Reply-To: ${s.replyToMessageId}`),o.push(`References: ${s.replyToMessageId}`)),o.push("",r);const i=o.join(`\r
`),c={raw:btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")};s.threadId&&(c.threadId=s.threadId);const d=await fetch(`${oe}/messages/send`,{method:"POST",headers:n,body:JSON.stringify(c)});if(!d.ok){const p=await d.text();throw new Error(`Gmail send failed (${d.status}): ${p.substring(0,200)}`)}return await d.json()}async createDraft(t,a,r,s={}){const n=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];s.cc&&o.push(`Cc: ${s.cc}`),o.push("",r);const i=o.join(`\r
`),l=btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),c=await fetch(`${oe}/drafts`,{method:"POST",headers:n,body:JSON.stringify({message:{raw:l}})});if(!c.ok){const d=await c.text();throw new Error(`Gmail draft failed (${c.status}): ${d.substring(0,200)}`)}return await c.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${oe}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const r=await this.authHeaders();let s={};switch(a){case"archive":s={removeLabelIds:["INBOX"]};break;case"trash":s={addLabelIds:["TRASH"]};break;case"read":s={removeLabelIds:["UNREAD"]};break;case"unread":s={addLabelIds:["UNREAD"]};break;case"star":s={addLabelIds:["STARRED"]};break;case"unstar":s={removeLabelIds:["STARRED"]};break}const n=await fetch(`${oe}/messages/${t}/modify`,{method:"POST",headers:{...r,"Content-Type":"application/json"},body:JSON.stringify(s)});if(!n.ok){const o=await n.text();throw new Error(`Failed to modify message: ${o}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${oe}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${oe}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function Xa(e){var t,a,r;if(!e)return"";if((t=e.body)!=null&&t.data)return Ct(e.body.data);if(e.parts){for(const s of e.parts)if(s.mimeType==="text/plain"&&((a=s.body)!=null&&a.data))return Ct(s.body.data);for(const s of e.parts)if(s.mimeType==="text/html"&&((r=s.body)!=null&&r.data)){const n=Ct(s.body.data);return ls(n)}for(const s of e.parts)if(s.parts){const n=Xa(s);if(n)return n}}return e.snippet||""}function Ct(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function ls(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const cs=1e4,ds=1e4;async function Za(e,t){try{const a=new AbortController,r=setTimeout(()=>a.abort(),ds),s=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(r),!s.ok)return{text:"",error:`HTTP ${s.status}`};const n=s.headers.get("content-type")||"";if(!n.includes("text/html")&&!n.includes("text/plain")&&!n.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${n.split(";")[0]}`};const o=await s.text(),i=us(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||cs)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function us(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Qa(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),s=a.maxResults||(a.depth==="thorough"?8:5),n=await bt(e,{num:s,site:a.site});if(n.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${n.error}`};if(n.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=n.results.slice(0,r).map(async g=>{const v=await Za(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),c=(await Promise.all(i)).filter(g=>g.content.length>50);if(c.length===0){const g=n.results.map((f,E)=>`[${E+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await Vt(e,g,t,"snippets"),sources:n.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const d=c.map((g,v)=>`--- SOURCE ${v+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Vt(e,d,t,"full"),sources:c.map(g=>({title:g.title,url:g.url})),pagesRead:c.length}}async function Vt(e,t,a,r){const n=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
`;switch(e){case"scheduler":return`You are ${o}, managing schedules and reminders for the user.
...
- Be concise — confirm the schedule and move on`;case"workspace":return`You are ${o}, handling Google Workspace operations for the user.
...
- This keeps document creation fast. Research-first adds unnecessary latency and is rarely needed.${n==="telegram"?`
...
- **Email confirmations must be SHORT.** When you draft or send an email, confirm with ONLY: "Draft saved. Subject: [subject]. To: [recipient]." Do NOT repeat the email body back. The user already knows what they wrote — they just need confirmation it's done.
  ...
  - NOT: "Here's what I wrote: Dear Mr. Kale, We experienced a significant... [full body]"`;case"research":return`You are ${o}, handling information retrieval for the user.
...
- **1-3 sentences for factual answers.** Longer only for deep research requests.`;case"memory":return`You are ${o}, managing the user's memory and system status.
...
- Be concise — confirm what was stored/found`;case"conversation":return`You are ${o} — a personal AI assistant. You are intelligent, direct, and genuinely helpful. You speak with clarity and warmth, never robotic.
...
## Current Date & Time
${Tt(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Zt(e,t,a){var c;const s=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let n;((c=s.files)==null?void 0:c.length)>0?n=s.files[0].id:n=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${n}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:n,folderName:a}}function Tt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}function ys(e){const t=e.replace(/(\d+)\s*[.,;!]+\s*(minutes?|mins?|hours?|hrs?|h|days?|seconds?|secs?)/gi,"$1 $2"),a=t.toLowerCase().trim(),r=a.match(/\bin\s+(\d+)\s*(minutes?|mins?|hours?|hrs?|h|days?)\b/i);if(r){let o=parseInt(r[1],10);const i=r[2].toLowerCase();i.startsWith("h")&&(o*=60),i.startsWith("d")&&(o*=1440);const l=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let c;l?c=l[1].trim():c=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/in\s+\d+\s*\.?\s*(minutes?|mins?|hours?|hrs?|h|days?)\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const d=c.length>50?c.substring(0,47)+"...":c;return{args:{name:d.charAt(0).toUpperCase()+d.slice(1),description:c,schedule_type:"once",minutes_from_now:o,action_type:"reminder",action_description:c,schedule_value:""}}}const s=a.match(/(?:at|by)\s+(\d{1,2})[:.]?(\d{2})?\s*(am|pm|a\.m\.|p\.m\.)?/i);if(s){let o=parseInt(s[1],10);const i=s[2]?parseInt(s[2],10):0,l=(s[3]||"").replace(/\./g,"").toLowerCase();l==="pm"&&o<12&&(o+=12),l==="am"&&o===12&&(o=0);const c=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let d;c?d=c[1].trim():d=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/(?:at|by)\s+\d{1,2}[:.]?\d{0,2}\s*(am|pm|a\.m\.|p\.m\.)?\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const p=d.length>50?d.substring(0,47)+"...":d,g=new Date,v=g.getFullYear(),f=String(g.getMonth()+1).padStart(2,"0"),E=String(g.getDate()).padStart(2,"0"),b=`${v}-${f}-${E} ${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}`;return{args:{name:p.charAt(0).toUpperCase()+p.slice(1),description:d,schedule_type:"once",schedule_value:b,action_type:"reminder",action_description:d}}}const n=a.match(/^(remind|alert|notify)\s+me\s+(?:to|about|that)\s+(.+?)\.?$/i);if(n){const o=n[2].trim(),i=o.length>50?o.substring(0,47)+"...":o;return{args:{name:i.charAt(0).toUpperCase()+i.slice(1),description:o,schedule_type:"once",minutes_from_now:5,action_type:"reminder",action_description:o,schedule_value:""}}}return null}async function Be(e,t,a,r,s,n,o,i,l,c,d,p){const g=Date.now();let v=!0,f="",E="";try{return E=await vs(e,t,a,r,n,o,i,l,c,d,p),E}catch(b){throw v=!1,f=b.message||"Unknown error",b}finally{const b=Date.now()-g;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,s.agentType||null,s.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?E:"").substring(0,500),v?1:0,f||null,b,s.isEnforcementRetry?1:0,s.channel||"web").run()}catch{}}}async function vs(e,t,a,r,s,n,o,i,l,c,d){var g,v,f,E,b,T;const p=new Z(a);switch(e){case"create_schedule":{const u=new Date;let h;const m=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){h=new Date(u.getTime()+t.minutes_from_now*60*1e3);const C=h.toLocaleString("en-US",{timeZone:m,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[R,S,k]=(C[0]||"").split("/");t.schedule_value=`${k}-${R}-${S} ${C[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const x=parseInt(t.schedule_value,10);h=new Date(u.getTime()+x*60*1e3)}else if(t.schedule_type==="daily"){const[x,C]=t.schedule_value.split(":").map(Number),R=u.toLocaleString("en-US",{timeZone:m}),S=new Date(R),k=new Date(S);k.setHours(x,C,0,0),k<=S&&k.setDate(k.getDate()+1);const O=new Date(k.toLocaleString("en-US",{timeZone:"UTC"})),D=new Date(k.toLocaleString("en-US",{timeZone:m})),M=O.getTime()-D.getTime();h=new Date(k.getTime()+M)}else if(t.schedule_type==="weekly"){const[x,C]=t.schedule_value.split(" "),[R,S]=(C||"00:00").split(":").map(Number),O=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(De=>De.toLowerCase()===x.toLowerCase()),D=u.toLocaleString("en-US",{timeZone:m}),M=new Date(D),j=new Date(M);j.setHours(R,S,0,0);let $=(O-j.getDay()+7)%7;$===0&&j<=M&&($=7),j.setDate(j.getDate()+$);const z=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),Y=new Date(j.toLocaleString("en-US",{timeZone:m})),ne=z.getTime()-Y.getTime();h=new Date(j.getTime()+ne)}else if(t.schedule_type==="once"){const[x,C]=t.schedule_value.split(" "),[R,S,k]=x.split("-").map(Number),[O,D]=(C||"00:00").split(":").map(Number),M=u.toLocaleString("en-US",{timeZone:m}),j=new Date(M),$=new Date(j);$.setFullYear(R,S-1,k),$.setHours(O,D,0,0);const z=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),Y=new Date($.toLocaleString("en-US",{timeZone:m})),ne=z.getTime()-Y.getTime();h=new Date($.getTime()+ne);const De=new Date(u.getTime()+120*1e3);if(h.getTime()<u.getTime()+60*1e3){const Ee=h.toISOString();h=De;const it=` [Note: The requested time ${t.schedule_value} in ${m} resolved to ${Ee} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${h.toISOString()}.]`;t._pastTimeWarning=it}}else h=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||""),h=t.spreadsheet_id;let m=t.range;const y=await u.sheets.getMetadata(h),_=y.sheets;m.includes("!")||(m=`${_[0]}!${m}`);let x;try{x=await u.sheets.readRange(h,m)}catch(R){if((g=R.message)!=null&&g.includes("Unable to parse range")||(v=R.message)!=null&&v.includes("400")){const S=m.includes("!")?m.split("!")[1]:m;m=`${_[0]}!${S}`,x=await u.sheets.readRange(h,m)}else throw R}let C=`[Spreadsheet: "${y.title}" | Reading tab: "${m.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(R=>`"${R}"`).join(", ")}]
`;return _.length>1&&(C+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),x.length===0?C+"No data found in the specified range.":C+x.map(R=>R.join("	| ")).join(`
`)}catch(u){return await A(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||""),h=t.values;let m=t.range;const x=Math.max(...h.map(k=>k.length))+4,C=h.map(k=>{const O=[...k];for(;O.length<x;)O.push("");return O}),R=m.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(R){const k=R[1]||"",O=R[2],D=R[3],M=R[5],$=O.toUpperCase().charCodeAt(0)-64+x-1,z=$<=26?String.fromCharCode(64+$):"Z";m=`${k}${O}${D}:${z}${M}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,m,C)).updatedCells} cells to ${m}.`}catch(u){return await A(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!s)return"Authentication context unavailable.";try{return`Appended ${(await new re(a,r,s,n||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await A(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let y="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,s,n||"",o||"");y=`
Folder: "${(await Zt(_,m.spreadsheetId,t.folder_name)).folderName}"`}catch(_){y=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new Z(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${m.spreadsheetId} | URL: ${m.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${y}
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(u){return await A(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||""),h=t.calendar_id||"primary",m=t.days_ahead||7,y=new Date,_=new Date(y.getTime()+m*24*60*60*1e3),x=await u.calendar.listEvents(h,{timeMin:y.toISOString(),timeMax:_.toISOString(),query:t.query});return x.length===0?`No events found in the next ${m} days.`:x.map(C=>{var D;const R=C.start.dateTime||C.start.date||"TBD",S=C.end.dateTime||C.end.date||"",k=C.location?` 📍 ${C.location}`:"",O=((D=C.attendees)==null?void 0:D.map(M=>M.email).join(", "))||"";return`• ${C.summary} — ${R} to ${S}${k}${O?`
  Attendees: ${O}`:""}`}).join(`
...
ID: ${m.id}
Start: ${m.start.dateTime||m.start.date}`}catch(u){return await A(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(m.documentId,t.content);let y="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,s,n||"",o||"");y=`
Folder: "${(await Zt(_,m.documentId,t.folder_name)).folderName}"`}catch(_){y=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new Z(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${m.documentId} | URL: ${m.url}`,6,"working")}catch{}return`Document created: "${t.title}"${y}
ID: ${m.documentId}
URL: ${m.url}`}catch(u){return await A(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!s)return"Authentication context unavailable.";try{const h=await new re(a,r,s,n||"",o||"").docs.readDocument(t.document_id);return`Document: "${h.title}"

${h.content}`}catch(u){return await A(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let m=t.document_id;try{m=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${m}".
...
${m}`}catch(u){return await A(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!s)return"Authentication context unavailable.";try{const h=await new ie(a,r,s,n||"",o||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((m,y)=>`${m.isUnread?"● ":"  "}${y+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await A(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!s)return"Authentication context unavailable.";try{const h=await new ie(a,r,s,n||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(u){return await A(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!s)return"Authentication context unavailable.";try{const h=await new ie(a,r,s,n||"",o||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),m=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${m}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(u){return await A(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!s)return"Authentication context unavailable.";try{return await new ie(a,r,s,n||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await A(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!s)return"Authentication context unavailable.";try{const h=await new ie(a,r,s,n||"",o||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(u){return(E=u.message)!=null&&E.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,s,n||"",o||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let m="";t.folder_id?m=`'${t.folder_id}' in parents and trashed = false`:t.query?m=`${t.query} and trashed = false`:m="trashed = false",h.set("q",m);const y=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${u}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const _=await y.json();return(b=_.files)!=null&&b.length?_.files.map((x,C)=>{var O,D;const R=((O=x.mimeType)==null?void 0:O.split(".").pop())||x.mimeType,S=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",k=((D=x.modifiedTime)==null?void 0:D.split("T")[0])||"";return`${C+1}. **${x.name}** (${R})
   ${S} · Modified: ${k}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await A(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,s,n||"",o||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,m=new URLSearchParams;m.set("q",h),m.set("pageSize",String(t.max_results||10)),m.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),m.set("orderBy","modifiedTime desc");const y=await fetch(`https://www.googleapis.com/drive/v3/files?${m}`,{headers:{Authorization:`Bearer ${u}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const _=await y.json();return(T=_.files)!=null&&T.length?_.files.map((x,C)=>{var k,O;const R=((k=x.mimeType)==null?void 0:k.split(".").pop())||x.mimeType,S=((O=x.modifiedTime)==null?void 0:O.split("T")[0])||"";return`${C+1}. **${x.name}** (${R}) — Modified: ${S}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await A(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await bt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}`:u.results.length===0?`No results found for "${t.query}".`:u.results.map((h,m)=>`${m+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(u){return await A(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:m}=await Promise.resolve().then(()=>ms),y=await m(u,h);return y.error?`Failed to read page: ${y.error}`:!y.text||y.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${y.text.length} chars):

${y.text}`}catch(u){return await A(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const h=Qa(t.query,d,{depth:t.depth||"quick",site:t.site}),m=new Promise(x=>setTimeout(()=>x(null),45e3)),y=await Promise.race([h,m]);if(y===null){const{webSearch:x}=await Promise.resolve().then(()=>is),C=await x(t.query,{num:5});if(C.error||C.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let R=`Research took too long, but here are the top search results:

`;return R+=C.results.map((S,k)=>`${k+1}. **${S.title}**
   ${S.snippet}
   ${S.link}`).join(`

`),R}if(y.error)return`Research failed: ${y.error}`;let _=y.report;return y.sources.length>0&&(_+=`

---
**Sources** (`+y.pagesRead+` pages read):
`,_+=y.sources.map((x,C)=>`[${C+1}] ${x.title}
    ${x.url}`).join(`
`)),_}catch(u){return await A(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await U(u.encrypted_value,s),m=await Wa(h,t.query,{type:t.type});return m.error?`Places search failed: ${m.error}`:m.results.length===0?`No places found for "${t.query}".`:m.results.map((y,_)=>{const x=y.rating?` ★${y.rating} (${y.userRatingsTotal||0} reviews)`:"",C=y.openNow!==void 0?y.openNow?" · Open now":" · Closed":"",R=y.googleMapsUri?`
   ${y.googleMapsUri}`:"";return`${_+1}. **${y.name}**${x}${C}
   ${y.address}${R}
   [place_id: ${y.placeId}]`}).join(`

`)}catch(u){return await A(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,s),m=await za(h,t.place_id);if(m.error)return`Details lookup failed: ${m.error}`;if(!m.details)return"No details found.";const y=m.details;let _=`**${y.name}**
...
Recent Reviews:`;for(const x of y.reviews)_+=`
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return _}catch(u){return await A(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,s),m=await qa(h,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const y=m.route;let _=`**${y.startAddress}** → **${y.endAddress}**
`;return _+=`📏 ${y.distance} · ⏱️ ${y.duration}`,y.durationInTraffic&&(_+=` (with traffic: ${y.durationInTraffic})`),_+=`
via ${y.summary}`,_+=`

Steps:`,y.steps.forEach((x,C)=>{_+=`
${C+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),_}catch(u){return await A(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,s),m=await Va(h,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let y=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(y+=` (with traffic: ${m.durationInTraffic})`),y}catch(u){return await A(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,s),m=await Ka(h,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(u){return await A(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,s),m=await Ja(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((y,_)=>{var x;return`${_+1}. **${y.title}**
   ${y.channelTitle} · ${((x=y.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${y.description}
   ${y.url}`}).join(`

`)}catch(u){return await A(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,s),m=await Ya(h,t.address);return m.error?`Geocoding failed: ${m.error}`:m.results.length===0?`Location not found: "${t.address}"`:m.results.map((y,_)=>`${_+1}. ${y.address}
   Coordinates: ${y.lat}, ${y.lng}`).join(`
`)}catch(u){return await A(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function Qt(e,t,a,r,s,n){var u;const o=new Z(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),d=rr(r,l),p=_t([{role:"system",content:d},...c.map(h=>({role:h.role,content:h.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;const E=[];for(let h=0;h<g;h++)try{const m=await a.chat(p,{tools:Et});if(m.usage&&(f+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){m.content&&p.push({role:"assistant",content:m.content});for(const y of m.toolCalls){E.push(y.name);try{const _=await Be(y.name,y.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a);p.push({role:"user",content:`[Tool Result for ${y.name}]: ${_}`})}catch(_){await A(t,r.id,"tool",y.name,_.message||"Tool execution failed"),p.push({role:"user",content:`[Tool Error for ${y.name}]: ${_.message||"Execution failed"}`})}}continue}v=m.content;break}catch(m){if(s){const y=m.message||"",_=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),x=y.includes("429"),C=_?1440:x?10:5;await s.recordError(a.name,y,C)}throw await A(t,r.id,"llm","provider_error",m.message||"Unknown LLM error",{provider:a.name,turn:h}),m}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}const b=v.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),T=E.length>0?`[TOOLS_USED: ${[...new Set(E)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",T+b,"{}",i),await o.compactHistory(r.id,30),v}const ea={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function ws(e){for(const[t,a]of Object.entries(ea))if(e.toLowerCase().includes(t.toLowerCase()))return a;return ea.default}function bs(e,t,a,r){const s=ws(r),n=Math.floor(s*.75),o=[];let i=0,l=!1;const c=Rt(e);o.push({role:"system",content:e}),i+=c;const d=Rt(a);i+=d;const p=n-i,g=[];let v=0;for(let f=t.length-1;f>=0;f--){const E=t[f],b=Rt(E.content);if(v+b<=p)g.unshift({role:E.role,content:E.content}),v+=b;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:a}),i+=v,{maxTokens:s,usedTokens:i,messages:o,wasTruncated:l}}async function*_s(e,t,a,r,s,n){var b;const o=new Z(t),i=(b=e.metadata)==null?void 0:b.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),d=rr(r,l),p=bs(d,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;const E=[...p.messages];for(let T=0;T<g;T++)try{T>0&&(yield{type:"thinking",data:{threadId:i}});const u=await a.chat(E,{tools:Et});if(u.usage&&(f+=u.usage.promptTokens+u.usage.completionTokens),u.toolCalls&&u.toolCalls.length>0){u.content&&(yield{type:"chunk",data:{text:u.content,threadId:i}},E.push({role:"assistant",content:u.content}));for(const m of u.toolCalls){yield{type:"tool_start",data:{tool:m.name,toolArgs:m.arguments,threadId:i}};try{const y=await Be(m.name,m.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:m.name,toolResult:y.substring(0,500)+(y.length>500?"...":""),threadId:i}},E.push({role:"user",content:`[Tool Result for ${m.name}]: ${y}`})}catch(y){await A(t,r.id,"tool",m.name,y.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:m.name,toolResult:`Error: ${y.message||"Execution failed"}`,threadId:i}},E.push({role:"user",content:`[Tool Error for ${m.name}]: ${y.message||"Execution failed"}`})}}continue}v=u.content;const h=50;for(let m=0;m<v.length;m+=h)yield{type:"chunk",data:{text:v.substring(m,m+h),threadId:i}},m+h<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(u){if(s){const m=u.message||"",y=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),_=m.includes("429"),x=y?1440:_?10:5;await s.recordError(a.name,m,x)}await A(t,r.id,"llm","provider_error",u.message||"Unknown LLM error",{provider:a.name,turn:T});const h=u.message||"An error occurred";try{await o.storeMessage(r.id,e.channel,"assistant",`⚠️ ${h}`,"{}",i)}catch{}yield{type:"error",data:{error:h,threadId:i}};return}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function Gt(e,t,a,r,s,n){var d;const o=new Z(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=er(e.text,l);if(c.agent==="conversation")return Ts(e,t,a,r,l,s,i);if(c.agent==="multi"||c.confidence<.5)return Qt(e,t,a,r,s,n);try{return await Es(c.agent,e,t,a,r,l,s,n,i)}catch(p){return await A(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${p.message}`,{route:c}),Qt(e,t,a,r,s,n)}}async function Es(e,t,a,r,s,n,o,i,l){const c=new Z(a),d=Tt(s.timezone),p=ft(e,s,n,s.timezone,d,t.channel),g=tr(e,Et,t.channel),v=(await c.getRecentConversations(s.id,25,l)).filter(k=>!k.content.startsWith("[Autonomous Scheduled Task]")&&!k.content.startsWith("[Scheduled Reminder]")).map(k=>({...k,content:k.content.replace(/^\[TOOLS_USED: [^\]]+\]\s*/i,"")})),f=_t([{role:"system",content:p},...v.map(k=>({role:k.role,content:k.content})),{role:"user",content:t.text}]);await c.storeMessage(s.id,t.channel,"user",t.text,"{}",l);const E=10;let b="",T=0,u="",h=!1;const m=[];for(let k=0;k<E;k++)try{const O=await r.chat(f,{tools:g.length>0?g:void 0});if(O.usage&&(T+=O.usage.promptTokens+O.usage.completionTokens),O.toolCalls&&O.toolCalls.length>0){h=!0,O.content&&(u=O.content,f.push({role:"assistant",content:O.content}));for(const D of O.toolCalls){m.push(D.name);try{const M=await Be(D.name,D.arguments,a,s.id,{agentType:e,providerName:r.name,channel:t.channel},s.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,s.timezone,r);f.push({role:"user",content:`[Tool Result for ${D.name}]: ${M}`})}catch(M){await A(a,s.id,"tool",D.name,M.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${D.name}]: ${M.message||"Execution failed"}`})}}continue}b=O.content,!b&&u&&(b=u);break}catch(O){if(o){const D=O.message||"",M=D.includes("401")||D.includes("403")||D.includes("authentication")||D.includes("credit balance"),j=D.includes("429"),$=M?1440:j?10:5;await o.recordError(r.name,D,$)}throw await A(a,s.id,"llm","subagent_error",O.message||"Unknown error",{agent:e,provider:r.name,turn:k}),O}const y=["scheduler","workspace","research"],_=e==="scheduler"&&!m.includes("create_schedule")&&!m.includes("list_schedules")&&!m.includes("toggle_schedule")&&!m.includes("update_schedule_state")&&!m.includes("delete_schedule")&&/\b(remind|in\s+\d+|at\s+\d{1,2}[:.]\d{0,2}|timer|alarm|schedule|tell\s+me\s+in|notify|alert|ping)\b/i.test(t.text),x=e==="workspace"&&m.includes("read_sheet")&&!m.includes("write_sheet")&&!m.includes("append_sheet")&&/\b(fix|correct|update|change|delete|remove|clean|clear|repair|replace|overwrite|set\s+to|should\s+be|wrong|broken|gap|missing)\b/i.test(t.text);if(!h&&y.includes(e)&&g.length>0||_||x){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(s.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),b.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{f.push({role:"assistant",content:b});let k;e==="scheduler"&&_?k=`[SYSTEM OVERRIDE] You called ${m.join(", ")||"no tools"} but did NOT call create_schedule. The user wants a reminder or schedule created. Call create_schedule NOW with the correct parameters. Do NOT respond with text saying a reminder is set — actually create it.`:e==="workspace"&&x?k="[SYSTEM OVERRIDE] You called read_sheet but did NOT call write_sheet. The user asked you to FIX or UPDATE the sheet data. You MUST call write_sheet NOW to make the actual changes. Reading data and then describing what you would fix is NOT the same as fixing it. Call write_sheet with the corrected values, then call read_sheet again to verify the fix landed correctly. Do NOT claim data is fixed without actually writing to the sheet.":k=`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${g.slice(0,3).map(D=>D.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`,f.push({role:"user",content:k});const O=await r.chat(f,{tools:g});if(O.usage&&(T+=O.usage.promptTokens+O.usage.completionTokens),O.toolCalls&&O.toolCalls.length>0){h=!0;let D=O.toolCalls,M=O.content;for(let j=0;j<5;j++){M&&f.push({role:"assistant",content:M});for(const z of D){m.push(z.name);try{const Y=await Be(z.name,z.arguments,a,s.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},s.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,s.timezone,r);f.push({role:"user",content:`[Tool Result for ${z.name}]: ${Y}`})}catch(Y){f.push({role:"user",content:`[Tool Error for ${z.name}]: ${Y.message||"Execution failed"}`})}}const $=await r.chat(f,{tools:g});if($.usage&&(T+=$.usage.promptTokens+$.usage.completionTokens),$.toolCalls&&$.toolCalls.length>0){D=$.toolCalls,M=$.content;continue}$.content&&(b=$.content);break}}if(!m.includes("create_schedule")&&e==="scheduler")try{const D=ys(t.text);if(D){const M=await Be("create_schedule",D.args,a,s.id,{agentType:"scheduler",providerName:"programmatic_fallback",channel:t.channel,isEnforcementRetry:!0},s.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,s.timezone,r);h=!0,m.push("create_schedule"),b=M}}catch(D){await A(a,s.id,"tool_enforcement","scheduler_fallback",`Programmatic scheduler fallback failed: ${D.message||"Unknown"}`)}}catch(k){await A(a,s.id,"tool_enforcement",e,`Tool enforcement retry failed: ${k.message||"Unknown"}`,{originalResponse:b.substring(0,200)})}}if(o&&T>0)try{await o.recordUsage(r.name,T)}catch{}const R=b.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),S=m.length>0?`[TOOLS_USED: ${[...new Set(m)].join(", ")}] `:"";return await c.storeMessage(s.id,t.channel,"assistant",S+R,"{}",l),await c.compactHistory(s.id,30),b}async function Ts(e,t,a,r,s,n,o){const i=new Z(t),l=Tt(r.timezone),c=ft("conversation",r,s,r.timezone,l,e.channel),d=(await i.getRecentConversations(r.id,25,o)).filter(f=>!f.content.startsWith("[Autonomous Scheduled Task]")&&!f.content.startsWith("[Scheduled Reminder]")),p=_t([{role:"system",content:c},...d.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}]);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let g=0,v="";try{const f=await a.chat(p,{temperature:.8});f.usage&&(g=f.usage.promptTokens+f.usage.completionTokens),v=f.content}catch(f){if(n){const E=f.message||"",b=E.includes("401")||E.includes("403")||E.includes("authentication")||E.includes("credit balance"),T=E.includes("429"),u=b?1440:T?10:5;await n.recordError(a.name,E,u)}throw await A(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*xs(e,t,a,r,s,n){var u;const o=new Z(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=er(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*_s(e,t,a,r,s,n);return}const d=Tt(r.timezone),p=c.agent==="conversation"?ft("conversation",r,l,r.timezone,d,e.channel):ft(c.agent,r,l,r.timezone,d,e.channel),g=tr(c.agent,Et,e.channel),v=(await o.getRecentConversations(r.id,25,i)).filter(h=>!h.content.startsWith("[Autonomous Scheduled Task]")&&!h.content.startsWith("[Scheduled Reminder]")),f=_t([{role:"system",content:p},...v.map(h=>({role:h.role,content:h.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const E=10;let b="",T=0;for(let h=0;h<E;h++)try{h>0&&(yield{type:"thinking",data:{threadId:i}});const m=await a.chat(f,{tools:g.length>0?g:void 0});if(m.usage&&(T+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){m.content&&(yield{type:"chunk",data:{text:m.content,threadId:i}},f.push({role:"assistant",content:m.content}));for(const _ of m.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const x=await Be(_.name,_.arguments,t,r.id,{agentType:c.agent,providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:x.substring(0,500)+(x.length>500?"...":""),threadId:i}},f.push({role:"user",content:`[Tool Result for ${_.name}]: ${x}`})}catch(x){await A(t,r.id,"tool",_.name,x.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${x.message||"Execution failed"}`,threadId:i}},f.push({role:"user",content:`[Tool Error for ${_.name}]: ${x.message||"Execution failed"}`})}}continue}b=m.content;const y=50;for(let _=0;_<b.length;_+=y)yield{type:"chunk",data:{text:b.substring(_,_+y),threadId:i}},_+y<b.length&&await new Promise(C=>setTimeout(C,10));break}catch(m){if(s){const _=m.message||"",x=_.includes("401")||_.includes("403")||_.includes("authentication")||_.includes("credit balance"),C=_.includes("429"),R=x?1440:C?10:5;await s.recordError(a.name,_,R)}await A(t,r.id,"llm","subagent_stream_error",m.message||"Unknown error",{agent:c.agent,provider:a.name,turn:h});const y=m.message||"An error occurred";try{await o.storeMessage(r.id,e.channel,"assistant",`⚠️ ${y}`,"{}",i)}catch{}yield{type:"error",data:{error:y,threadId:i}};return}if(s&&T>0)try{await s.recordUsage(a.name,T)}catch{}await o.storeMessage(r.id,e.channel,"assistant",b,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:T}}}const H=new be;async function ks(e,t){var s;const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}H.use("/*",ks);H.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),s=await e.env.DB.prepare(`SELECT t.*, 
...
[Attached files:
`;for(const c of n)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=s;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:d}=await nt(e.env.DB,t.id,t.pin_hash),p=await Gt(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});return!s&&i?await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run():i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),e.json({response:p,timestamp:new Date().toISOString(),channel:l.channel,provider:c.name,thread_id:i})}catch(c){console.error("Chat error:",c);const d=c.message||"";if(d.includes("No LLM provider configured"))return e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400);if(d.includes("All LLM providers failed"))return e.json({error:d,type:"no_provider",thread_id:i},400);if(d.includes("limit reached"))return e.json({error:d,type:"cost_limit",thread_id:i},429);const p=d.includes("401")||d.includes("403")||d.includes("authentication")||d.includes("credit balance")||d.includes("invalid")&&d.includes("key");try{const{logError:g}=await Promise.resolve().then(()=>Lt);await g(e.env.DB,t.id,"llm","chat_error",d)}catch{}return e.json({error:p?"API key error — your provider returned an authentication or billing error. Check Settings → Keys to verify your API keys are valid.":"Something went wrong. I'll be back in a moment.",details:d,type:p?"no_provider":void 0,thread_id:i},p?400:500)}});function ta(e){return`event: ${e.type}
...
`;for(const c of n)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=s;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:d}=await nt(e.env.DB,t.id,t.pin_hash),p=new ReadableStream({async start(g){const v=new TextEncoder;try{const f=xs(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const E of f)E.data.threadId||(E.data.threadId=i),g.enqueue(v.encode(ta(E)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),g.close()}catch(f){const E={type:"error",data:{error:f.message||"An error occurred",threadId:i}};g.enqueue(v.encode(ta(E))),g.close()}}});return new Response(p,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):d.includes("limit reached")?e.json({error:d,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:i},500)}});H.get("/threads/:id/messages",async e=>{var n;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),s=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?`).bind(t.id,a,r).all();return e.json({messages:(s.results||[]).reverse(),total:((n=s.results)==null?void 0:n.length)||0})});H.get("/history",async e=>{var l;const t=e.get("user"),a=parseInt(e.req.query("limit")||"50"),r=parseInt(e.req.query("offset")||"0"),s=e.req.query("thread_id");let n,o;s?(n=`SELECT id, role, content, channel, thread_id, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(s).all(),o=[];for(const i of n.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(s,i.id).run();const l=i.user_timezone||"UTC";let c,d=!1,p=i.state||"active";if(i.schedule_type==="interval"){const f=parseInt(i.schedule_value,10);c=new Date(r.getTime()+f*60*1e3)}else if(i.schedule_type==="daily"){const[f,E]=i.schedule_value.split(":").map(Number),b=aa(l),T=new Date(b);T.setHours(f,E,0,0),T<=b&&T.setDate(T.getDate()+1);const u=new Date(T.toLocaleString("en-US",{timeZone:"UTC"})),h=new Date(T.toLocaleString("en-US",{timeZone:l})),m=u.getTime()-h.getTime();c=new Date(T.getTime()+m)}else if(i.schedule_type==="weekly"){const[f,E]=i.schedule_value.split(" "),[b,T]=(E||"00:00").split(":").map(Number),h=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(S=>S.toLowerCase()===f.toLowerCase()),m=aa(l),y=new Date(m);y.setHours(b,T,0,0);let _=(h-y.getDay()+7)%7;_===0&&y<=m&&(_=7),y.setDate(y.getDate()+_);const x=new Date(y.toLocaleString("en-US",{timeZone:"UTC"})),C=new Date(y.toLocaleString("en-US",{timeZone:l})),R=x.getTime()-C.getTime();c=new Date(y.getTime()+R)}else i.schedule_type==="once"?(d=!0,p="completed",c=new Date(r.getTime()+365*24*60*60*1e3)):c=new Date(r.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,c.toISOString(),d?0:i.enabled,p,i.id).run();const v=(JSON.parse(i.action_config||"{}").description||i.description)&&(i.action_type==="check_mail"||i.action_type==="check_calendar"||i.action_type==="check_sheet"||i.action_type==="custom");o.push({job_id:i.id,name:i.name,status:"dispatched",needs_agent:v,next_run:c.toISOString()})}catch(l){o.push({job_id:i.id,name:i.name,status:"error",error:l.message})}return e.json({executed:o.length,results:o,timestamp:s})});pe.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);const r=parseInt(e.req.param("jobId"),10);if(!r)return e.json({error:"Invalid job ID"},400);const s=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(r).first();if(!s)return e.json({error:"Job not found"},404);const o=JSON.parse(s.action_config||"{}").description||s.description||"",i="⏰ "+(s.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=s.action_type==="reminder",p=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&s.action_type==="custom"&&p.test(o),d)c=o||s.name||"Time for your scheduled task.";else try{const E={id:s.user_id,username:s.username||"user",name:s.user_name||"User",pin_hash:s.pin_hash||"",role:s.user_role||"",personality_prompt:s.personality_prompt||"",telegram_chat_id:s.telegram_chat_id||"",timezone:s.user_timezone||"UTC",assistant_name:s.assistant_name||"Karna",created_at:"",updated_at:""},b={userId:s.user_id,username:E.username,channel:"cron",text:Os(s.name,o,s.action_type),sessionId:"cron-"+s.id,timestamp:l},{provider:T,rotation:u}=await nt(e.env.DB,s.user_id,s.pin_hash);c=await Gt(b,e.env.DB,T,E,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(E){const b=E.message||"unknown error",T=b.includes("rate_limit")||b.includes("429")||b.includes("quota"),u=b.includes("timeout")||b.includes("Timeout");T?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":u?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await A(e.env.DB,s.user_id,"cron_agent","execution_error",b,{job_id:s.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(s.action_type))try{const E=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(s.user_id).first();(!E||E.cnt===0)&&await A(e.env.DB,s.user_id,"cron_verification","no_tools_called",`Cron job "${s.name}" (${s.action_type}) completed without any tool calls`,{job_id:s.id,action_type:s.action_type,response_preview:c.substring(0,200)})}catch{}let v=c||o||"Time for your scheduled task.";v=v.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const f=i+`
`+v;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(s.user_id,"reminder",i,v,"cron:"+s.id).run(),d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(s.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:s.id})).run(),s.telegram_chat_id&&await Is(e.env.DB,s.user_id,s.telegram_chat_id,f),e.json({job_id:r,status:"completed",response_length:c.length})});async function sr(e){var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return null;const a=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(a==null?void 0:a.user_id)||null}pe.get("/health/tools",async e=>{var a;const t=await sr(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function Os(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${Je}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${Je}`}function Cs(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function Rs(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const ot=new be,Ds=4e3;async function P(e,t,a,r="Markdown"){var n,o;const s=As(a,Ds);for(const i of s)try{const l=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i,parse_mode:r,disable_web_page_preview:!1})});if(!l.ok){const c=await l.json().catch(()=>null);((n=c==null?void 0:c.description)!=null&&n.includes("parse")||(o=c==null?void 0:c.description)!=null&&o.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i})})}}catch{}}async function Ns(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function As(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let s=r.lastIndexOf(`
`,t);s<t*.3&&(s=r.lastIndexOf(" ",t)),s<t*.3&&(s=t),a.push(r.substring(0,s)),r=r.substring(s).trimStart()}return a}async function Ls(e,t,a,r,s){switch(e.split("@")[0].toLowerCase()){case"/start":{const o=(r==null?void 0:r.name)||"there",i=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${o}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await P(a,t,l),!0}case"/help":{const i=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await P(a,t,i),!0}case"/status":{if(!r)return await P(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[o,i,l,c]=await Promise.all([s.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),s.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),s.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),s.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),d=`📊 *System Status*
...
Status: ✅ Online`;await P(a,t,d)}catch{await P(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await s.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await P(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await P(a,t,"⚠️ Account not linked."),!0);case"/tasks":case"/task":{if(!r)return await P(a,t,"⚠️ Account not linked."),!0;try{const i=(await s.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(i.length===0)return await P(a,t,"✅ No open tasks. You're all clear."),!0;const l=new Date,c=l.toISOString().slice(0,10),d=new Date(l);d.setDate(d.getDate()+1);const p=d.toISOString().slice(0,10),g=[`📋 *Open Tasks (${i.length})*
`];for(const v of i){let f="";if(v.due_date){const E=v.due_date.slice(0,10);E<c?f=" ⚠️ _overdue_":E===c?f=" 🔴 _due today_":E===p?f=" 🟡 _due tomorrow_":f=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}g.push(`☐ ${v.title}${f}`)}g.push(`
_Say "mark [task] as done" to close a task._`),await P(a,t,g.join(`
`))}catch(o){await P(a,t,"❌ Could not fetch tasks: "+o.message)}return!0}default:return!1}}ot.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},s=async()=>{var n,o,i,l,c;try{if(t.callback_query){await Ms(a,t.callback_query);return}const d=t.message;if(!d)return;const p=!!d.text,g=!!d.voice,v=!!d.document,f=!!d.photo,E=!!d.caption;if(!p&&!g&&!v&&!f)return;const b=String(d.chat.id);let T=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(b).first();let h=null;if(u){const S=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();S&&(h=await U(S.encrypted_value,u.pin_hash))}if(!h){const S=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();S&&(h=await U(S.encrypted_value,S.pin_hash))}if(!h||T.startsWith("/")&&await Ls(T,b,h,u,a))return;if(!u){await P(h,b,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${b}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&h&&u)try{await P(h,b,"🎤 Processing voice note...");const k=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${d.voice.file_id}`)).json();if(k.ok&&((n=k.result)!=null&&n.file_path)){const D=await(await fetch(`https://api.telegram.org/file/bot${h}/${k.result.file_path}`)).blob();let M="",j="",$="whisper-1";const z=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const Ee of z.results){const it=await U(Ee.encrypted_value,u.pin_hash);if(Ee.service==="openai"){M="https://api.openai.com/v1/audio/transcriptions",j=it;break}else if(Ee.service.startsWith("llm_slot_"))try{const lt=JSON.parse(it);if(lt.provider==="openai"){M="https://api.openai.com/v1/audio/transcriptions",j=lt.apiKey;break}else if(lt.provider==="groq"){M="https://api.groq.com/openai/v1/audio/transcriptions",j=lt.apiKey,$="whisper-large-v3";break}}catch{}}if(!M){await P(h,b,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const Y=new FormData;Y.append("file",D,"voice.ogg"),Y.append("model",$),Y.append("language","en");const ne=await fetch(M,{method:"POST",headers:{Authorization:`Bearer ${j}`},body:Y});if(!ne.ok){const Ee=await ne.text();await P(h,b,`⚠️ Transcription failed: ${ne.status} ${Ee}`);return}T=(await ne.json()).text,await P(h,b,`🗣️ *You said:* ${T}`)}}catch(S){await P(h,b,`⚠️ Failed to process voice note: ${S.message}`);return}if((v||f)&&h&&u)try{let S,k="unknown",O="unknown",D=0;if(v)S=d.document.file_id,k=d.document.file_name||"document",O=d.document.mime_type||"unknown",D=d.document.file_size||0;else if(f){const M=d.photo[d.photo.length-1];S=M.file_id,k="photo.jpg",O="image/jpeg",D=M.file_size||0}if(S){const j=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${S}`)).json();let $="";if(j.ok&&((o=j.result)!=null&&o.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(k)||/^text\/|application\/json|application\/xml|application\/csv/i.test(O))&&D<5e4)try{$=await(await fetch(`https://api.telegram.org/file/bot${h}/${j.result.file_path}`)).text()}catch{}const z=d.caption||"",Y=`[Telegram file received: "${k}" (${O}, ${Math.round(D/1024)}KB)]`;$?T=`${z?z+`
...
`:""}${Y}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(S){if(E&&d.caption)T=d.caption;else{await P(h,b,`⚠️ Received your file but couldn't process it: ${S.message}`);return}}if(!T)return;Ns(h,b).catch(()=>{});let m=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();m?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(m.id).run():m={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const y=Cs(u.id,u.username,T,b);y.metadata={thread_id:m.id};let _,x;try{const S=await nt(a,u.id,u.pin_hash);_=S.provider,x=S.rotation}catch(S){console.error("Telegram provider setup error:",S);const k=(i=S.message)!=null&&i.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=S.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${S.message||"Unknown error"}`;await P(h,b,k);return}/\b(write\s+(an?\s+)?(essay|article|report|document|doc|blog|post|summary|draft)|draft\s+(an?\s+)?(essay|article|report|document)|research\s+.{0,60}(save|store|drive|doc))\b/i.test(T)&&await P(h,b,"📝 Working on it— searching and saving to Drive takes about 20 seconds...");const R=25e3;try{const S=await Promise.race([Gt(y,a,_,u,x,r),new Promise((O,D)=>setTimeout(()=>D(new Error("TELEGRAM_TIMEOUT")),R))]),k=Rs(S,"telegram");await P(h,b,k||"(empty response)")}catch(S){console.error("Telegram agent error:",S);const k=S.message==="TELEGRAM_TIMEOUT",O=k?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=S.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${_.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(S.message||"Unknown").substring(0,200)}`;await P(h,b,O);try{const{logError:D}=await Promise.resolve().then(()=>Lt);await D(a,u.id,"telegram",k?"timeout":"agent_error",S.message||"Agent error",{provider:_.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:p}=await Promise.resolve().then(()=>Lt);await p(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(s()),e.json({ok:!0})});ot.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Telegram bot token not configured in Settings"},400);const n=await U(s.encrypted_value,a.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const i=await(await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});ot.get("/webhook-status",async e=>{var n,o,i,l,c,d;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const s=await U(r.encrypted_value,a.pin_hash);try{const g=await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=g.result)==null?void 0:o.url)||"",has_webhook:!!((i=g.result)!=null&&i.url),pending_updates:((l=g.result)==null?void 0:l.pending_update_count)||0,last_error:((c=g.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=g.result)==null?void 0:d.last_error_date)||null})}catch(p){return e.json({configured:!0,error:p.message})}});ot.post("/detect-chat-id",async e=>{var n,o;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const s=await U(r.encrypted_value,a.pin_hash);try{const c=((o=(await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(b=>setTimeout(b,500));const p=await(await fetch(`https://api.telegram.org/bot${s}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:["message"]})});const g=p.result||[];if(g.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],f=new Set;for(let b=g.length-1;b>=0;b--){const T=g[b].message;if(T&&T.chat){const u=String(T.chat.id);f.has(u)||(f.add(u),v.push({chat_id:u,name:[T.chat.first_name,T.chat.last_name].filter(Boolean).join(" ")||T.chat.title||"Unknown",username:T.chat.username||"",date:new Date((T.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const E=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E,a.user_id).run(),e.json({found:!0,chat_id:E,name:v[0].name,all_chats:v,message:`Chat ID ${E} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function Ms(e,t){var E;const{id:a,data:r,message:s,from:n}=t;if(!r||!s)return;const o=r.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],l=parseInt(o[2]);if(!l||!i)return;const c=String(s.chat.id),d=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(c).first();if(!d)return;const p=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(d.id,l,i).first();if(!p)return;const g=p.checked?0:1;await e.prepare(`
  ...
  `).bind(g,g,p.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(d.id).first();if(!v)return;const f=await U(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:g?"✅ Checked!":"☐ Unchecked"})}),(E=s.reply_markup)!=null&&E.inline_keyboard){const b=s.reply_markup.inline_keyboard.map(T=>T.map(u=>{var h;if((h=u.callback_data)!=null&&h.includes(i)){const m=g?"✅":"☐",y=u.text.replace(/^[☐✅]\s*/,"");return{...u,text:`${m} ${y}`}}return u}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:s.message_id,reply_markup:{inline_keyboard:b}})})}catch{}}}function $s(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const s=new Date(r);s.setHours(23,59,59,999);const n=r.toISOString().split("T")[0];return{start:r.toISOString(),end:s.toISOString(),dateStr:n}}async function Bs(e,t,a,r,s,n){try{return(await new Ht(e,t,a,r,s).listEvents("primary",{timeMin:n.start,timeMax:n.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function js(e,t,a,r,s){try{const n=new ie(e,t,a,r,s),o=await n.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await n.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const p of o){const g=p.from.split("<")[0].trim()||p.from;l[g]=(l[g]||0)+1}const c=Object.entries(l).sort(([,p],[,g])=>g-p).slice(0,5).map(([p])=>p),d=o.some(p=>p.subject.toLowerCase().includes("urgent")||p.subject.toLowerCase().includes("asap")||p.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:c,hasUrgent:d}}catch(n){return console.error("Gmail fetch error:",n.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Ps(e,t){try{const a=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),r=new Date,s=new Date(r);s.setDate(s.getDate()+1),s.setHours(23,59,59,999);const n=a.results||[],o=n.map(l=>{if(l.due_date){const c=new Date(l.due_date),d=c<=r?"overdue":c<=s?"due today":c.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${l.title} [${d}]`}return l.title}),i=n.filter(l=>l.due_date?new Date(l.due_date)<=s:!1).length;return{pending:n.length,dueToday:i,items:o}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function Us(e,t){try{const a=Math.floor((Date.now()-1728e5)/1e3),r=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${a},points>10`,s=await fetch(r,{headers:{"User-Agent":"Karna/1.0"}});return s.ok?((await s.json()).hits||[]).filter(o=>o.url&&!t.has(o.url)).slice(0,2).map(o=>({title:o.title,summary:`${o.points} pts · ${o.num_comments} comments on HN`,url:o.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const ra=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function Hs(e,t,a){const r=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],s=new Set;if(t&&a)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(a).all()).results||[]).forEach(c=>s.add(c.url))}catch{}const n=[];if(r.some(l=>ra.some(c=>l.toLowerCase().includes(c.toLowerCase())))){const l=r.find(d=>ra.some(p=>d.toLowerCase().includes(p.toLowerCase())))||"AI agents",c=await Us(l,s);for(const d of c)n.push(d),s.add(d.url)}for(const l of r){if(n.length>=8)break;const c=`latest ${l} news today`;try{const d=await bt(c,{num:5});if(d.results)for(const p of d.results){if(n.length>=8)break;s.has(p.link)||(n.push({title:p.title,summary:p.snippet,url:p.link,source:p.displayLink}),s.add(p.link))}}catch(d){console.error(`News search error for "${c}":`,d.message)}}const i=n.slice(0,7);if(t&&a&&i.length>0)for(const l of i)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(a,l.url,l.title).run()}catch{}return i}function Gs(e,t){const a=[];let r="20:00";{const[o,i]=t.split(":"),l=parseInt(o,10),c=i||"00",d=l>=12?"PM":"AM";r=`${l===0?12:l>12?l-12:l}:${c} ${d}`}a.push(`🗓 Your ${r} Brief — ${e.targetDate}`),a.push("");const s=e.calendar.totalCount;if(s>0){a.push(`📅 Tomorrow: ${s} event${s===1?"":"s"}`);for(const o of e.calendar.google.slice(0,5)){const i=o.startTime?new Date(o.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";a.push(`   • ${i} ${o.title}`)}}else a.push("📅 Tomorrow: Nothing scheduled");a.push("");const n=e.emails.gmail.unreadCount;if(n>0?(a.push(`📧 Gmail: ${n} unread`),e.emails.gmail.importantCount>0&&a.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&a.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&a.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):a.push("📧 Gmail: Inbox clear"),a.push(""),e.tasks.pending>0){a.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const o of e.tasks.items)a.push(`   ☐ ${o}`)}else a.push("✅ Tasks: All clear");if(a.push(""),e.news.items.length>0){a.push("📡 Today's Signal:");for(const o of e.news.items){const i=o.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${o.source}`;a.push(`   • ${o.title.substring(0,90)}${o.title.length>90?"…":""}`),a.push(`     ${i} — ${o.summary.substring(0,80)}${o.summary.length>80?"…":""}`)}}return a.join(`
`)}function Fs(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Ws(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const n=JSON.parse(a.components);r={google_calendar:n.google_calendar!==!1,gmail:n.gmail!==!1,tasks:n.tasks!==!1,news:n.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const s=a.news_topics?a.news_topics.split(",").map(n=>n.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:s}}async function nr(e,t,a){var u,h;const r=t.timezone||"Asia/Kolkata",s=$s(r),{components:n,newsTopics:o}=await Ws(e,t.id),i=[],l=[];n.google_calendar&&(i.push(Bs(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,s)),l.push("googleEvents")),n.gmail&&(i.push(js(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),n.tasks&&(i.push(Ps(e,t.id)),l.push("tasks")),n.news&&(i.push(Hs(o,e,t.id)),l.push("news"));const c=await Promise.all(i),d={};l.forEach((m,y)=>{d[m]=c[y]});const p={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:s.dateStr,calendar:{google:d.googleEvents||[],totalCount:((u=d.googleEvents)==null?void 0:u.length)||0},emails:{gmail:d.gmailSummary||p},tasks:d.tasks||g,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((h=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:h.briefing_time)||"20:00";v.summary=Gs(v,f);const E=Fs(v),b=await e.prepare(`
  ...
  `).bind(t.id,JSON.stringify(v)).first(),T=(b==null?void 0:b.id)||0;for(const m of E)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(T,m.type,m.key,m.text,JSON.stringify(m.metadata),m.sortOrder).run();return{briefingId:T,content:v,items:E}}async function zs(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:s.results||[]}}async function qs(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function Ks(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
    ...
    LIMIT ?
  `).bind(t,a).all()).results||[]).map(s=>({...s,content:JSON.parse(s.content_json||"{}")}))}function Ys(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),s=r.getHours(),n=r.getMinutes(),[o,i]=e.split(":").map(Number),l=s*60+n,c=o*60+i;return l===c}function or(e,t){const a=e.summary,r=[];for(const s of t.slice(0,10))r.push([{text:`☐ ${s.text.substring(0,40)}${s.text.length>40?"...":""}`,callback_data:`briefing_toggle:${s.key}`}]);return{text:a,inlineKeyboard:r}}const V=new be;async function Js(e,t){var s;if(e.req.path.includes("/cron/"))return t();const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}V.use("/*",Js);V.get("/briefings",async e=>{const t=e.get("user"),a=parseInt(e.req.query("limit")||"10");try{const r=await Ks(e.env.DB,t.id,a);return e.json({briefings:r})}catch(r){return e.json({error:r.message},500)}});V.get("/briefings/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const r=await zs(e.env.DB,t.id,a);return r?e.json(r):e.json({error:"Briefing not found"},404)}catch(r){return e.json({error:r.message},500)}});V.post("/briefings/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.param("itemId"));try{const s=await qs(e.env.DB,t.id,a,r);return s?e.json(s):e.json({error:"Item not found"},404)}catch(s){return e.json({error:s.message},500)}});V.post("/briefings/generate",async e=>{const t=e.get("user");try{const a=await nr(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(a)}catch(a){return e.json({error:a.message},500)}});V.get("/briefing-preferences",async e=>{const t=e.get("user");try{const a=await e.env.DB.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t.id).first();if(!a){const s={briefingTime:"20:00",briefingEnabled:!0,components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0,weather:!1},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"],notificationChannels:{telegram:!0,web:!0},proactiveLevel:"moderate"};return e.json({preferences:s})}const r={briefingTime:a.briefing_time,briefingEnabled:a.briefing_enabled!==0,components:JSON.parse(a.components),newsTopics:a.news_topics.split(",").map(s=>s.trim()).filter(Boolean),notificationChannels:JSON.parse(a.notification_channels),proactiveLevel:a.proactive_level};return e.json({preferences:r})}catch(a){return e.json({error:a.message},500)}});V.post("/briefing-preferences",async e=>{const t=e.get("user"),a=await e.req.json(),r=[];if(a.briefingTime&&(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.test(a.briefingTime)||r.push("Invalid time format. Use HH:MM (e.g., 20:00)")),a.newsTopics&&(a.newsTopics.length>5&&r.push("Maximum 5 news topics allowed"),a.newsTopics.some(s=>s.length>50)&&r.push("Each news topic must be 50 characters or less")),a.proactiveLevel&&!["conservative","moderate","aggressive"].includes(a.proactiveLevel)&&r.push("Invalid proactive level. Use conservative, moderate, or aggressive"),r.length>0)return e.json({error:r.join("; ")},400);try{const s=await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first(),n=a.components?JSON.stringify(a.components):null,o=a.notificationChannels?JSON.stringify(a.notificationChannels):null,i=a.newsTopics?a.newsTopics.join(", "):null;if(s){const l=[],c=[];a.briefingTime!==void 0&&(l.push("briefing_time = ?"),c.push(a.briefingTime)),a.briefingEnabled!==void 0&&(l.push("briefing_enabled = ?"),c.push(a.briefingEnabled?1:0)),n!==null&&(l.push("components = ?"),c.push(n)),i!==null&&(l.push("news_topics = ?"),c.push(i)),o!==null&&(l.push("notification_channels = ?"),c.push(o)),a.proactiveLevel!==void 0&&(l.push("proactive_level = ?"),c.push(a.proactiveLevel)),l.length>0&&(l.push("updated_at = CURRENT_TIMESTAMP"),c.push(t.id),await e.env.DB.prepare(`UPDATE briefing_preferences SET ${l.join(", ")} WHERE user_id = ?`).bind(...c).run())}else await e.env.DB.prepare(`
        INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(t.id,a.briefingTime||"20:00",n||'{"google_calendar":true,"gmail":true,"tasks":true,"news":true}',i||"AI, LLM, Tools, Agentic Workflows, AI Features",o||'{"telegram":true,"web":true}',a.proactiveLevel||"moderate").run();return e.json({success:!0})}catch(s){return e.json({error:s.message},500)}});V.post("/briefing-preferences/init-defaults",async e=>{const t=e.get("user");try{return await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first()?e.json({success:!0,message:"Preferences already exist"}):(await e.env.DB.prepare(`
      INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
