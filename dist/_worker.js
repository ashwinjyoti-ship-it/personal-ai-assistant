var Or=Object.defineProperty;var kt=e=>{throw TypeError(e)};var Dr=(e,t,r)=>t in e?Or(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var E=(e,t,r)=>Dr(e,typeof t!="symbol"?t+"":t,r),ot=(e,t,r)=>t.has(e)||kt("Cannot "+r);var v=(e,t,r)=>(ot(e,t,"read from private field"),r?r.call(e):t.get(e)),k=(e,t,r)=>t.has(e)?kt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),T=(e,t,r,a)=>(ot(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),I=(e,t,r)=>(ot(e,t,"access private method"),r);var St=(e,t,r,a)=>({set _(n){T(e,t,n,r)},get _(){return v(e,t,a)}});var It=(e,t,r)=>(a,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,d=!1,u;if(e[i]?(u=e[i][0][0],a.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(a,()=>o(i+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&r&&(l=await r(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},Rr=Symbol(),Ar=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,s=(e instanceof Jt?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Lr(e,{all:r,dot:a}):{}};async function Lr(e,t){const r=await e.formData();return r?Nr(r,t):{}}function Nr(e,t){const r=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?$r(r,n,a):r[n]=a}),t.dot&&Object.entries(r).forEach(([a,n])=>{a.includes(".")&&(Mr(r,a,n),delete r[a])}),r}var $r=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Mr=(e,t,r)=>{let a=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?a[s]=r:((!a[s]||typeof a[s]!="object"||Array.isArray(a[s])||a[s]instanceof File)&&(a[s]=Object.create(null)),a=a[s])})},zt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Br=e=>{const{groups:t,path:r}=jr(e),a=zt(r);return Pr(a,t)},jr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const n=`@${a}`;return t.push([n,r]),n}),{groups:t,path:e}},Pr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[r][1]);break}}return e},Ve={},Hr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return Ve[a]||(r[2]?Ve[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Ve[a]=[e,r[1],!0]),Ve[a]}return null},yt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Ur=e=>yt(e,decodeURI),Ft=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const s=t.indexOf("?",a),o=t.indexOf("#",a),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(r,i);return Ur(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(r,a)},Gr=e=>{const t=Ft(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ee=(e,t,...r)=>(r.length&&(t=Ee(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Wt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&a===""?r.push("/"):r.push(a);const s=n.replace("?","");a+="/"+s,r.push(a)}else a+="/"+n}),r.filter((n,s,o)=>o.indexOf(n)===s)},it=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?yt(e,Kt):e):e,qt=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,d=e.indexOf("&",l);return it(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(a&&(l=it(l)),s=o,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),a&&(d=it(d))),r?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},zr=qt,Fr=(e,t)=>qt(e,t,!0),Kt=decodeURIComponent,Ct=e=>yt(e,Kt),Se,G,te,Yt,Vt,pt,ne,Bt,Jt=(Bt=class{constructor(e,t="/",r=[[]]){k(this,te);E(this,"raw");k(this,Se);k(this,G);E(this,"routeIndex",0);E(this,"path");E(this,"bodyCache",{});k(this,ne,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,T(this,G,r),T(this,Se,{})}param(e){return e?I(this,te,Yt).call(this,e):I(this,te,Vt).call(this)}query(e){return zr(this.url,e)}queries(e){return Fr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ar(this,e))}json(){return v(this,ne).call(this,"text").then(e=>JSON.parse(e))}text(){return v(this,ne).call(this,"text")}arrayBuffer(){return v(this,ne).call(this,"arrayBuffer")}blob(){return v(this,ne).call(this,"blob")}formData(){return v(this,ne).call(this,"formData")}addValidatedData(e,t){v(this,Se)[e]=t}valid(e){return v(this,Se)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Rr](){return v(this,G)}get matchedRoutes(){return v(this,G)[0].map(([[,e]])=>e)}get routePath(){return v(this,G)[0].map(([[,e]])=>e)[this.routeIndex].path}},Se=new WeakMap,G=new WeakMap,te=new WeakSet,Yt=function(e){const t=v(this,G)[0][this.routeIndex][1][e],r=I(this,te,pt).call(this,t);return r&&/\%/.test(r)?Ct(r):r},Vt=function(){const e={},t=Object.keys(v(this,G)[0][this.routeIndex][1]);for(const r of t){const a=I(this,te,pt).call(this,v(this,G)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Ct(a):a)}return e},pt=function(e){return v(this,G)[1]?v(this,G)[1][e]:e},ne=new WeakMap,Bt),Wr={Stringify:1},Xt=async(e,t,r,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>Xt(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},qr="text/plain; charset=UTF-8",lt=(e,t)=>({"Content-Type":e,...t}),Ge,ze,X,Ie,Z,j,Fe,Ce,Oe,ge,We,qe,se,Te,jt,Kr=(jt=class{constructor(e,t){k(this,se);k(this,Ge);k(this,ze);E(this,"env",{});k(this,X);E(this,"finalized",!1);E(this,"error");k(this,Ie);k(this,Z);k(this,j);k(this,Fe);k(this,Ce);k(this,Oe);k(this,ge);k(this,We);k(this,qe);E(this,"render",(...e)=>(v(this,Ce)??T(this,Ce,t=>this.html(t)),v(this,Ce).call(this,...e)));E(this,"setLayout",e=>T(this,Fe,e));E(this,"getLayout",()=>v(this,Fe));E(this,"setRenderer",e=>{T(this,Ce,e)});E(this,"header",(e,t,r)=>{this.finalized&&T(this,j,new Response(v(this,j).body,v(this,j)));const a=v(this,j)?v(this,j).headers:v(this,ge)??T(this,ge,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});E(this,"status",e=>{T(this,Ie,e)});E(this,"set",(e,t)=>{v(this,X)??T(this,X,new Map),v(this,X).set(e,t)});E(this,"get",e=>v(this,X)?v(this,X).get(e):void 0);E(this,"newResponse",(...e)=>I(this,se,Te).call(this,...e));E(this,"body",(e,t,r)=>I(this,se,Te).call(this,e,t,r));E(this,"text",(e,t,r)=>!v(this,ge)&&!v(this,Ie)&&!t&&!r&&!this.finalized?new Response(e):I(this,se,Te).call(this,e,t,lt(qr,r)));E(this,"json",(e,t,r)=>I(this,se,Te).call(this,JSON.stringify(e),t,lt("application/json",r)));E(this,"html",(e,t,r)=>{const a=n=>I(this,se,Te).call(this,n,t,lt("text/html; charset=UTF-8",r));return typeof e=="object"?Xt(e,Wr.Stringify,!1,{}).then(a):a(e)});E(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});E(this,"notFound",()=>(v(this,Oe)??T(this,Oe,()=>new Response),v(this,Oe).call(this,this)));T(this,Ge,e),t&&(T(this,Z,t.executionCtx),this.env=t.env,T(this,Oe,t.notFoundHandler),T(this,qe,t.path),T(this,We,t.matchResult))}get req(){return v(this,ze)??T(this,ze,new Jt(v(this,Ge),v(this,qe),v(this,We))),v(this,ze)}get event(){if(v(this,Z)&&"respondWith"in v(this,Z))return v(this,Z);throw Error("This context has no FetchEvent")}get executionCtx(){if(v(this,Z))return v(this,Z);throw Error("This context has no ExecutionContext")}get res(){return v(this,j)||T(this,j,new Response(null,{headers:v(this,ge)??T(this,ge,new Headers)}))}set res(e){if(v(this,j)&&e){e=new Response(e.body,e);for(const[t,r]of v(this,j).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=v(this,j).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}T(this,j,e),this.finalized=!0}get var(){return v(this,X)?Object.fromEntries(v(this,X)):{}}},Ge=new WeakMap,ze=new WeakMap,X=new WeakMap,Ie=new WeakMap,Z=new WeakMap,j=new WeakMap,Fe=new WeakMap,Ce=new WeakMap,Oe=new WeakMap,ge=new WeakMap,We=new WeakMap,qe=new WeakMap,se=new WeakSet,Te=function(e,t,r){const a=v(this,j)?new Headers(v(this,j).headers):v(this,ge)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?a.append(o,i):a.set(o,i)}if(r)for(const[s,o]of Object.entries(r))if(typeof o=="string")a.set(s,o);else{a.delete(s);for(const i of o)a.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??v(this,Ie);return new Response(e,{status:n,headers:a})},jt),R="ALL",Jr="all",Yr=["get","post","put","delete","options","patch"],Zt="Can not add a route since the matcher is already built.",Qt=class extends Error{},Vr="__COMPOSED_HANDLER",Xr=e=>e.text("404 Not Found",404),Ot=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},z,L,er,F,me,Qe,et,De,Zr=(De=class{constructor(t={}){k(this,L);E(this,"get");E(this,"post");E(this,"put");E(this,"delete");E(this,"options");E(this,"patch");E(this,"all");E(this,"on");E(this,"use");E(this,"router");E(this,"getPath");E(this,"_basePath","/");k(this,z,"/");E(this,"routes",[]);k(this,F,Xr);E(this,"errorHandler",Ot);E(this,"onError",t=>(this.errorHandler=t,this));E(this,"notFound",t=>(T(this,F,t),this));E(this,"fetch",(t,...r)=>I(this,L,et).call(this,t,r[1],r[0],t.method));E(this,"request",(t,r,a,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ee("/",t)}`,r),a,n)));E(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(I(this,L,et).call(this,t.request,t,void 0,t.request.method))})});[...Yr,Jr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?T(this,z,o):I(this,L,me).call(this,s,v(this,z),o),i.forEach(l=>{I(this,L,me).call(this,s,v(this,z),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){T(this,z,l);for(const d of[s].flat())i.map(u=>{I(this,L,me).call(this,d.toUpperCase(),v(this,z),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?T(this,z,s):(T(this,z,"*"),o.unshift(s)),o.forEach(i=>{I(this,L,me).call(this,R,v(this,z),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Ft:Gr}route(t,r){const a=this.basePath(t);return r.routes.map(n=>{var o;let s;r.errorHandler===Ot?s=n.handler:(s=async(i,l)=>(await It([],r.errorHandler)(i,()=>n.handler(i,l))).res,s[Vr]=n.handler),I(o=a,L,me).call(o,n.method,n.path,s)}),this}basePath(t){const r=I(this,L,er).call(this);return r._basePath=Ee(this._basePath,t),r}mount(t,r,a){let n,s;a&&(typeof a=="function"?s=a:(s=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const o=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Ee(this._basePath,t),d=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,u)}})());const i=async(l,d)=>{const u=await r(n(l.req.raw),...o(l));if(u)return u;await d()};return I(this,L,me).call(this,R,Ee(t,"*"),i),this}},z=new WeakMap,L=new WeakSet,er=function(){const t=new De({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,T(t,F,v(this,F)),t.routes=this.routes,t},F=new WeakMap,me=function(t,r,a){t=t.toUpperCase(),r=Ee(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,n]),this.routes.push(n)},Qe=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},et=function(t,r,a,n){if(n==="HEAD")return(async()=>new Response(null,await I(this,L,et).call(this,t,r,a,"GET")))();const s=this.getPath(t,{env:a}),o=this.router.match(n,s),i=new Kr(t,{path:s,matchResult:o,env:a,executionCtx:r,notFoundHandler:v(this,F)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await v(this,F).call(this,i)})}catch(u){return I(this,L,Qe).call(this,u,i)}return d instanceof Promise?d.then(u=>u||(i.finalized?i.res:v(this,F).call(this,i))).catch(u=>I(this,L,Qe).call(this,u,i)):d??v(this,F).call(this,i)}const l=It(o[0],this.errorHandler,v(this,F));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return I(this,L,Qe).call(this,d,i)}})()},De),tr=[];function Qr(e,t){const r=this.buildAllMatchers(),a=((n,s)=>{const o=r[n]||r[R],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],tr];const d=l.indexOf("",1);return[o[1][d],l]});return this.match=a,a(e,t)}var rt="[^/]+",Pe=".*",He="(?:|/.*)",ke=Symbol(),ea=new Set(".\\+*[^]$()");function ta(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Pe||e===He?1:t===Pe||t===He?-1:e===rt?1:t===rt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var fe,ve,W,we,ra=(we=class{constructor(){k(this,fe);k(this,ve);k(this,W,Object.create(null))}insert(t,r,a,n,s){if(t.length===0){if(v(this,fe)!==void 0)throw ke;if(s)return;T(this,fe,r);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Pe]:["","",rt]:o==="/*"?["","",He]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let m=l[2]||rt;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw ke;if(d=v(this,W)[m],!d){if(Object.keys(v(this,W)).some(g=>g!==Pe&&g!==He))throw ke;if(s)return;d=v(this,W)[m]=new we,u!==""&&T(d,ve,n.varIndex++)}!s&&u!==""&&a.push([u,v(d,ve)])}else if(d=v(this,W)[o],!d){if(Object.keys(v(this,W)).some(u=>u.length>1&&u!==Pe&&u!==He))throw ke;if(s)return;d=v(this,W)[o]=new we}d.insert(i,r,a,n,s)}buildRegExpStr(){const r=Object.keys(v(this,W)).sort(ta).map(a=>{const n=v(this,W)[a];return(typeof v(n,ve)=="number"?`(${a})@${v(n,ve)}`:ea.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof v(this,fe)=="number"&&r.unshift(`#${v(this,fe)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},fe=new WeakMap,ve=new WeakMap,W=new WeakMap,we),at,Ke,Pt,aa=(Pt=class{constructor(){k(this,at,{varIndex:0});k(this,Ke,new ra)}insert(e,t,r){const a=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,i=!0,d}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return v(this,Ke).insert(s,t,a,v(this,at),r),a}buildRegExp(){let e=v(this,Ke).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(r[++t]=Number(s),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,a]}},at=new WeakMap,Ke=new WeakMap,Pt),na=[/^$/,[],Object.create(null)],tt=Object.create(null);function rr(e){return tt[e]??(tt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function sa(){tt=Object.create(null)}function oa(e){var d;const t=new aa,r=[];if(e.length===0)return na;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[g,f])=>u?1:g?-1:m.length-f.length),n=Object.create(null);for(let u=0,m=-1,g=a.length;u<g;u++){const[f,b,x]=a[u];f?n[b]=[x.map(([h])=>[h,Object.create(null)]),tr]:m++;let c;try{c=t.insert(b,m,f)}catch(h){throw h===ke?new Qt(b):h}f||(r[m]=x.map(([h,p])=>{const y=Object.create(null);for(p-=1;p>=0;p--){const[w,_]=c[p];y[w]=_}return[h,y]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=r.length;u<m;u++)for(let g=0,f=r[u].length;g<f;g++){const b=(d=r[u][g])==null?void 0:d[1];if(!b)continue;const x=Object.keys(b);for(let c=0,h=x.length;c<h;c++)b[x[c]]=i[b[x[c]]]}const l=[];for(const u in o)l[u]=r[o[u]];return[s,l,n]}function xe(e,t){if(e){for(const r of Object.keys(e).sort((a,n)=>n.length-a.length))if(rr(r).test(t))return[...e[r]]}}var oe,ie,nt,ar,Ht,ia=(Ht=class{constructor(){k(this,nt);E(this,"name","RegExpRouter");k(this,oe);k(this,ie);E(this,"match",Qr);T(this,oe,{[R]:Object.create(null)}),T(this,ie,{[R]:Object.create(null)})}add(e,t,r){var i;const a=v(this,oe),n=v(this,ie);if(!a||!n)throw new Error(Zt);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[R]).forEach(d=>{l[e][d]=[...l[R][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=rr(t);e===R?Object.keys(a).forEach(d=>{var u;(u=a[d])[t]||(u[t]=xe(a[d],t)||xe(a[R],t)||[])}):(i=a[e])[t]||(i[t]=xe(a[e],t)||xe(a[R],t)||[]),Object.keys(a).forEach(d=>{(e===R||e===d)&&Object.keys(a[d]).forEach(u=>{l.test(u)&&a[d][u].push([r,s])})}),Object.keys(n).forEach(d=>{(e===R||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([r,s]))});return}const o=Wt(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(m=>{var g;(e===R||e===m)&&((g=n[m])[u]||(g[u]=[...xe(a[m],u)||xe(a[R],u)||[]]),n[m][u].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(v(this,ie)).concat(Object.keys(v(this,oe))).forEach(t=>{e[t]||(e[t]=I(this,nt,ar).call(this,t))}),T(this,oe,T(this,ie,void 0)),sa(),e}},oe=new WeakMap,ie=new WeakMap,nt=new WeakSet,ar=function(e){const t=[];let r=e===R;return[v(this,oe),v(this,ie)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(s=>[s,a[e][s]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==R&&t.push(...Object.keys(a[R]).map(s=>[s,a[R][s]]))}),r?oa(t):null},Ht),le,Q,Ut,la=(Ut=class{constructor(e){E(this,"name","SmartRouter");k(this,le,[]);k(this,Q,[]);T(this,le,e.routers)}add(e,t,r){if(!v(this,Q))throw new Error(Zt);v(this,Q).push([e,t,r])}match(e,t){if(!v(this,Q))throw new Error("Fatal error");const r=v(this,le),a=v(this,Q),n=r.length;let s=0,o;for(;s<n;s++){const i=r[s];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);o=i.match(e,t)}catch(l){if(l instanceof Qt)continue;throw l}this.match=i.match.bind(i),T(this,le,[i]),T(this,Q,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(v(this,Q)||v(this,le).length!==1)throw new Error("No active router has been determined yet.");return v(this,le)[0]}},le=new WeakMap,Q=new WeakMap,Ut),Me=Object.create(null),de,B,ye,Re,M,ee,he,Ae,da=(Ae=class{constructor(t,r,a){k(this,ee);k(this,de);k(this,B);k(this,ye);k(this,Re,0);k(this,M,Me);if(T(this,B,a||Object.create(null)),T(this,de,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},T(this,de,[n])}T(this,ye,[])}insert(t,r,a){T(this,Re,++St(this,Re)._);let n=this;const s=Br(r),o=[];for(let i=0,l=s.length;i<l;i++){const d=s[i],u=s[i+1],m=Hr(d,u),g=Array.isArray(m)?m[0]:d;if(g in v(n,B)){n=v(n,B)[g],m&&o.push(m[1]);continue}v(n,B)[g]=new Ae,m&&(v(n,ye).push(m),o.push(m[1])),n=v(n,B)[g]}return v(n,de).push({[t]:{handler:a,possibleKeys:o.filter((i,l,d)=>d.indexOf(i)===l),score:v(this,Re)}}),n}search(t,r){var l;const a=[];T(this,M,Me);let s=[this];const o=zt(r),i=[];for(let d=0,u=o.length;d<u;d++){const m=o[d],g=d===u-1,f=[];for(let b=0,x=s.length;b<x;b++){const c=s[b],h=v(c,B)[m];h&&(T(h,M,v(c,M)),g?(v(h,B)["*"]&&a.push(...I(this,ee,he).call(this,v(h,B)["*"],t,v(c,M))),a.push(...I(this,ee,he).call(this,h,t,v(c,M)))):f.push(h));for(let p=0,y=v(c,ye).length;p<y;p++){const w=v(c,ye)[p],_=v(c,M)===Me?{}:{...v(c,M)};if(w==="*"){const P=v(c,B)["*"];P&&(a.push(...I(this,ee,he).call(this,P,t,v(c,M))),T(P,M,_),f.push(P));continue}const[C,N,H]=w;if(!m&&!(H instanceof RegExp))continue;const $=v(c,B)[C],U=o.slice(d).join("/");if(H instanceof RegExp){const P=H.exec(U);if(P){if(_[N]=P[0],a.push(...I(this,ee,he).call(this,$,t,v(c,M),_)),Object.keys(v($,B)).length){T($,M,_);const $e=((l=P[0].match(/\//))==null?void 0:l.length)??0;(i[$e]||(i[$e]=[])).push($)}continue}}(H===!0||H.test(m))&&(_[N]=m,g?(a.push(...I(this,ee,he).call(this,$,t,_,v(c,M))),v($,B)["*"]&&a.push(...I(this,ee,he).call(this,v($,B)["*"],t,_,v(c,M)))):(T($,M,_),f.push($)))}}s=f.concat(i.shift()??[])}return a.length>1&&a.sort((d,u)=>d.score-u.score),[a.map(({handler:d,params:u})=>[d,u])]}},de=new WeakMap,B=new WeakMap,ye=new WeakMap,Re=new WeakMap,M=new WeakMap,ee=new WeakSet,he=function(t,r,a,n){const s=[];for(let o=0,i=v(t,de).length;o<i;o++){const l=v(t,de)[o],d=l[r]||l[R],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),a!==Me||n&&n!==Me))for(let m=0,g=d.possibleKeys.length;m<g;m++){const f=d.possibleKeys[m],b=u[d.score];d.params[f]=n!=null&&n[f]&&!b?n[f]:a[f]??(n==null?void 0:n[f]),u[d.score]=!0}}return s},Ae),be,Gt,ca=(Gt=class{constructor(){E(this,"name","TrieRouter");k(this,be);T(this,be,new da)}add(e,t,r){const a=Wt(t);if(a){for(let n=0,s=a.length;n<s;n++)v(this,be).insert(e,a[n],r);return}v(this,be).insert(e,t,r)}match(e,t){return v(this,be).search(e,t)}},be=new WeakMap,Gt),ue=class extends Zr{constructor(e={}){super(e),this.router=e.router??new la({routers:[new ia,new ca]})}},ua=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(r.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(o,i){var u;function l(m,g){o.res.headers.set(m,g)}const d=await a(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let g=r.allowHeaders;if(!(g!=null&&g.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(g=f.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function nr(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}const bt="AES-GCM",pa=256;async function sr(e){const t=new TextEncoder,r=await crypto.subtle.importKey("raw",t.encode(e.padEnd(32,"0").slice(0,32)),{name:"PBKDF2"},!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode("karna-salt-v1"),iterations:1e5,hash:"SHA-256"},r,{name:bt,length:pa},!1,["encrypt","decrypt"])}async function wt(e,t){const r=await sr(t),a=crypto.getRandomValues(new Uint8Array(12)),n=new TextEncoder,s=await crypto.subtle.encrypt({name:bt,iv:a},r,n.encode(e)),o=new Uint8Array(a.length+new Uint8Array(s).length);return o.set(a),o.set(new Uint8Array(s),a.length),btoa(String.fromCharCode(...o))}async function A(e,t){const r=await sr(t),a=new Uint8Array(atob(e).split("").map(i=>i.charCodeAt(0))),n=a.slice(0,12),s=a.slice(12),o=await crypto.subtle.decrypt({name:bt,iv:n},r,s);return new TextDecoder().decode(o)}async function st(e){const r=new TextEncoder().encode(e+"karna-pin-salt"),a=await crypto.subtle.digest("SHA-256",r);return btoa(String.fromCharCode(...new Uint8Array(a)))}async function or(e,t){return await st(e)===t}const ma=Object.freeze(Object.defineProperty({__proto__:null,decrypt:A,encrypt:wt,hashPin:st,verifyPin:or},Symbol.toStringTag,{value:"Module"})),pe=new ue;pe.get("/check",async e=>{const t=await e.env.DB.prepare("SELECT COUNT(*) as cnt FROM users").first();return e.json({hasUsers:((t==null?void 0:t.cnt)||0)>0})});pe.post("/setup",async e=>{const{username:t,name:r,pin:a,personality_prompt:n,timezone:s}=await e.req.json();if(!t||!r||!a)return e.json({error:"Username, name, and PIN are required"},400);if(a.length<4)return e.json({error:"PIN must be at least 4 characters"},400);if(await e.env.DB.prepare("SELECT id FROM users WHERE username = ?").bind(t).first())return e.json({error:"Username already taken"},409);const i=await st(a);await e.env.DB.prepare("INSERT INTO users (username, name, pin_hash, personality_prompt, timezone) VALUES (?, ?, ?, ?, ?)").bind(t,r,i,n||"",s||"Asia/Kolkata").run();const l=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first(),d=crypto.randomUUID(),u=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(d,l.id,"web",u).run(),e.json({success:!0,sessionId:d,user:{id:l.id,username:l.username,name:l.name}})});pe.post("/login",async e=>{const{username:t,pin:r}=await e.req.json();if(!t||!r)return e.json({error:"Username and PIN required"},400);const a=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first();if(!a)return e.json({error:"User not found"},404);if(!await or(r,a.pin_hash))return e.json({error:"Invalid PIN"},401);const s=crypto.randomUUID(),o=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(s,a.id,"web",o).run(),e.json({success:!0,sessionId:s,user:{id:a.id,username:a.username,name:a.name}})});pe.post("/logout",async e=>{var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");return t&&await e.env.DB.prepare("DELETE FROM sessions WHERE id = ?").bind(t).run(),e.json({success:!0})});pe.get("/users/hints",async e=>{const r=((await e.env.DB.prepare("SELECT username, name, created_at FROM users ORDER BY created_at ASC").all()).results||[]).map(a=>{var n;return{username:a.username,name_hint:a.name.split(" ")[0],created:((n=a.created_at)==null?void 0:n.split(" ")[0])||""}});return e.json({users:r,count:r.length})});pe.post("/reset-pin",async e=>{var i;const{username:t,name:r,new_pin:a}=await e.req.json();if(!t||!r||!a)return e.json({error:"Username, display name, and new PIN are required"},400);if(a.length<4)return e.json({error:"PIN must be at least 4 characters"},400);const n=await e.env.DB.prepare("SELECT id, username, name FROM users WHERE username = ?").bind(t).first();if(!n)return e.json({error:"User not found"},404);if(n.name.toLowerCase().trim()!==r.toLowerCase().trim())return e.json({error:"Display name does not match. This is required for identity verification."},403);const s=await st(a);await e.env.DB.prepare("UPDATE users SET pin_hash = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n.id).run();const o=await e.env.DB.prepare("DELETE FROM credentials WHERE user_id = ?").bind(n.id).run();return await e.env.DB.prepare("DELETE FROM sessions WHERE user_id = ?").bind(n.id).run(),e.json({success:!0,message:"PIN reset successfully. All API keys and credentials have been cleared (they were encrypted with your old PIN). Please log in with your new PIN and re-enter your API keys in Settings.",credentials_cleared:((i=o.meta)==null?void 0:i.changes)||0})});pe.get("/me",async e=>{var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"No session"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.id as uid, u.username, u.name, u.role, u.timezone 
     FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();return r?e.json({user:{id:r.uid,username:r.username,name:r.name,role:r.role,timezone:r.timezone}}):e.json({error:"Invalid or expired session"},401)});const Ue={anthropic:{id:"anthropic",label:"Anthropic Claude",apiBase:"https://api.anthropic.com",apiFormat:"anthropic",defaultModel:"claude-sonnet-4-20250514",keyPlaceholder:"sk-ant-api03-...",modelHint:"claude-sonnet-4-20250514, claude-haiku-4-20250514",validatePath:"/v1/messages"},openai:{id:"openai",label:"OpenAI GPT",apiBase:"https://api.openai.com",apiFormat:"openai-compatible",defaultModel:"gpt-4o",keyPlaceholder:"sk-...",modelHint:"gpt-4o, gpt-4o-mini, o3-mini",validatePath:"/v1/models"},grok:{id:"grok",label:"xAI Grok",apiBase:"https://api.x.ai",apiFormat:"openai-compatible",defaultModel:"grok-3-mini",keyPlaceholder:"xai-...",modelHint:"grok-3-mini, grok-3",validatePath:"/v1/models"},deepseek:{id:"deepseek",label:"DeepSeek",apiBase:"https://api.deepseek.com",apiFormat:"openai-compatible",defaultModel:"deepseek-chat",keyPlaceholder:"sk-...",modelHint:"deepseek-chat, deepseek-reasoner",validatePath:"/v1/models"},gemini:{id:"gemini",label:"Google Gemini",apiBase:"https://generativelanguage.googleapis.com/v1beta/openai",apiFormat:"openai-compatible",defaultModel:"gemini-2.0-flash",keyPlaceholder:"AIzaSy...",modelHint:"gemini-2.0-flash, gemini-2.5-pro-preview",validatePath:"/models"},openrouter:{id:"openrouter",label:"OpenRouter",apiBase:"https://openrouter.ai/api",apiFormat:"openai-compatible",defaultModel:"anthropic/claude-sonnet-4",keyPlaceholder:"sk-or-...",modelHint:"e.g. deepseek/deepseek-chat, meta-llama/llama-3.1-70b",validatePath:"/v1/models"},abacus:{id:"abacus",label:"Abacus AI (RouteLLM)",apiBase:"https://routellm.abacus.ai",apiFormat:"openai-compatible",defaultModel:"route-llm",keyPlaceholder:"Your Abacus API key",modelHint:"route-llm (auto), grok-4, deepseek-v3.2, claude-4-5-sonnet, gemini-3-flash",validatePath:"/v1/models"}};async function S(e,t,r,a,n,s={}){try{await e.prepare("INSERT INTO error_log (user_id, source, error_type, message, details) VALUES (?, ?, ?, ?, ?)").bind(t,r,a,n,JSON.stringify(s)).run()}catch(o){console.error("Failed to log error:",o)}}class ir{constructor(t,r="claude-sonnet-4-20250514",a="https://api.anthropic.com",n="anthropic"){E(this,"name");E(this,"apiKey");E(this,"model");E(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=a,this.name=n}async chat(t,r){var u,m,g,f;const a=t.find(b=>b.role==="system"),n=t.filter(b=>b.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:n.map(b=>({role:b.role,content:b.content}))};a&&(s.system=a.content),r!=null&&r.tools&&r.tools.length>0&&(s.tools=r.tools.map(b=>({name:b.name,description:b.description,input_schema:b.parameters})));const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const b=await o.text();throw new Error(this.name+" API error "+o.status+": "+b)}const i=await o.json(),l=((u=i.content)==null?void 0:u.filter(b=>b.type==="text"))||[],d=((m=i.content)==null?void 0:m.filter(b=>b.type==="tool_use"))||[];return{content:l.map(b=>b.text).join(`
`),toolCalls:d.map(b=>({id:b.id,name:b.name,arguments:b.input})),usage:{promptTokens:((g=i.usage)==null?void 0:g.input_tokens)||0,completionTokens:((f=i.usage)==null?void 0:f.output_tokens)||0}}}async streamChat(t,r){const a=t.find(d=>d.role==="system"),n=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:n.map(d=>({role:d.role,content:d.content}))};a&&(s.system=a.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const d=await o.text();throw new Error(this.name+" stream error "+o.status+": "+d)}const i=o.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var b;const{done:u,value:m}=await i.read();if(u){d.close();return}const f=l.decode(m,{stream:!0}).split(`
`);for(const x of f)if(x.startsWith("data: ")){const c=x.slice(6);if(c==="[DONE]")continue;try{const h=JSON.parse(c);h.type==="content_block_delta"&&((b=h.delta)!=null&&b.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:h.delta.text})+`

`))}catch{}}}})}}function ha(e){const t={},r=e||{};if(t.type=r.type||"object",t.type==="object"){const a=r.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const n={};for(const[s,o]of Object.entries(a))o&&typeof o=="object"?n[s]=mt(o):n[s]=o;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(r.required)?t.required=r.required:t.required=[]}return r.description&&(t.description=r.description),t}function mt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const r=t.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const a={};for(const[n,s]of Object.entries(r))s&&typeof s=="object"?a[n]=mt(s):a[n]=s;t.properties=a}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=mt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class lr{constructor(t,r,a,n){E(this,"name");E(this,"apiKey");E(this,"model");E(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=a.replace(/\/+$/,""),this.name=n}async chat(t,r){var l,d,u,m,g,f;const a={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:t.map(b=>({role:b.role,content:b.content}))},n=this.apiBase.includes("routellm.abacus.ai");r!=null&&r.tools&&r.tools.length>0&&!n&&(a.tools=r.tools.map(b=>({type:"function",function:{name:b.name,description:b.description,parameters:ha(b.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)});if(!s.ok){const b=await s.text();throw new Error(this.name+" API error "+s.status+": "+b)}const o=await s.json(),i=(l=o.choices)==null?void 0:l[0];return{content:((d=i==null?void 0:i.message)==null?void 0:d.content)||"",toolCalls:(m=(u=i==null?void 0:i.message)==null?void 0:u.tool_calls)==null?void 0:m.map(b=>({id:b.id,name:b.function.name,arguments:typeof b.function.arguments=="string"?JSON.parse(b.function.arguments||"{}"):b.function.arguments||{}})),usage:{promptTokens:((g=o.usage)==null?void 0:g.prompt_tokens)||0,completionTokens:((f=o.usage)==null?void 0:f.completion_tokens)||0}}}async streamChat(t,r){const a={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)});if(!n.ok){const i=await n.text();throw new Error(this.name+" stream error "+n.status+": "+i)}const s=n.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var g,f,b;const{done:l,value:d}=await s.read();if(l){i.close();return}const m=o.decode(d,{stream:!0}).split(`
`);for(const x of m)if(x.startsWith("data: ")){const c=x.slice(6);if(c==="[DONE]")continue;try{const p=(b=(f=(g=JSON.parse(c).choices)==null?void 0:g[0])==null?void 0:f.delta)==null?void 0:b.content;p&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:p})+`

`))}catch{}}}})}}function ht(e,t,r,a){const n=Ue[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=a||n.defaultModel;return n.apiFormat==="anthropic"?new ir(t,s,n.apiBase,r):new lr(t,s,n.apiBase,r)}class dr{constructor(){E(this,"errorLog",new Map);E(this,"usageLog",new Map)}async pickProvider(t){const r=Date.now(),a=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=r:!0});return a.length>0?a[0]:null}async recordUsage(t,r){const a=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:a.tokens+r,requests:a.requests+1})}async recordError(t,r,a=5){this.errorLog.set(t,{error:r,cooldownUntil:Date.now()+a*60*1e3})}}const ga=["llm_slot_1","llm_slot_2","llm_slot_3"],fa=["anthropic","openai"];async function Je(e,t,r){const{decrypt:a}=await Promise.resolve().then(()=>ma),n=new dr,s=[];for(const m of ga){const g=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(g)try{const f=await a(g.encrypted_value,r),b=JSON.parse(f);if(b.provider&&b.apiKey&&Ue[b.provider]){const c=b.provider,h=ht(b.provider,b.apiKey,c,b.model);s.push({name:c,provider:h})}}catch(f){console.error(`Failed to load ${m}:`,f)}}const o=new Set(s.map(m=>m.name));for(const m of fa){if(o.has(m))continue;const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(g)try{const f=await a(g.encrypted_value,r);if(Ue[m]){const x=ht(m,f,m);s.push({name:m,provider:x})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(m=>m.name),l=await n.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const d=s.find(m=>m.name===l);return{provider:va(d.provider,s,n),rotation:n}}function va(e,t,r){return t.length<=1?e:{name:e.name,async chat(a,n){try{return await e.chat(a,n)}catch(s){const o=s.message||"";if(!(o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")))throw s;console.warn(`Provider ${e.name} auth/billing error, trying fallback...`),await r.recordError(e.name,o,1440);const l=t.filter(d=>d.name!==e.name);for(const d of l)try{const u=await d.provider.chat(a,n);return this.name=d.name,u}catch(u){const m=u.message||"";if(m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance")||m.includes("properties field not found")){await r.recordError(d.name,m,1440);continue}throw u}throw new Error(`All LLM providers failed. Primary (${e.name}): ${o.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(a,n){return await e.streamChat(a,n)}}}const gt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ir,OpenAICompatibleProvider:lr,ProviderRotation:dr,createProviderFromConfig:ht,createRotatingProvider:Je,logError:S},Symbol.toStringTag,{value:"Module"})),dt=20,ya=2e3,ba=2e3,cr=4;function wa(e){return Math.ceil(e.length/cr)}function Dt(e,t){const r=t*cr;return e.length<=r?e:e.slice(0,r)+`
[...truncated to fit token budget]`}class ce{constructor(t){this.db=t}async store(t,r,a,n,s=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,r,a).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((r==null?void 0:r.cnt)||0)>dt){const a=((r==null?void 0:r.cnt)||0)-dt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
         ...
         )`).bind(t,t,a).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,dt).all()).results||[]}async getAll(t,r,a=50){return r?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,r,a).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a).all()).results||[]}async search(t,r,a=10){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${r}%`,`%${r}%`,a).all()).results||[]}async update(t,r,a){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t,r).run()}async promote(t,r){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,r).run(),await this.enforceWorkingMemoryCap(r)}async demote(t,r){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,r).run()}async remove(t,r){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,r).run()}async buildContext(t){const r=await this.getWorkingMemory(t);if(r.length===0)return"";const a={};for(const s of r)a[s.type]||(a[s.type]=[]),a[s.type].push(s);let n=`
## Working Memory (Active Context)
`;for(const[s,o]of Object.entries(a)){n+=`
### ${s.charAt(0).toUpperCase()+s.slice(1)}s
`;for(const i of o)n+=`- **${i.title}**: ${i.content}
`}return Dt(n,ya)}static truncatePersonality(t){return Dt(t,ba)}async getRecentConversations(t,r=20,a){return a?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a,r).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r).all()).results||[]).reverse()}async storeMessage(t,r,a,n,s="{}",o){const i=wa(n);o?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,i,o).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,i).run()}async compactHistory(t,r=30){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((a==null?void 0:a.cnt)||0)<=r*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,r).run()}}const xa="https://accounts.google.com/o/oauth2/v2/auth",ur="https://oauth2.googleapis.com/token",_a="https://www.googleapis.com/oauth2/v2/userinfo",Ea=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let V=null;async function ft(e,t,r){const a=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!a)return null;try{const n=await A(a.encrypted_value,r);return JSON.parse(n)}catch{return null}}async function Ta(e,t,r,a){const n=await wt(JSON.stringify(a),r);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,n).run()}function pr(e,t,r){const a=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Ea,access_type:"offline",prompt:"consent",state:r,include_granted_scopes:"true"});return`${xa}?${a}`}async function mr(e,t,r,a){const n=await fetch(ur,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:r,redirect_uri:a,grant_type:"authorization_code"})}),s=await n.text();if(!n.ok)throw new Error(`Token exchange failed (${n.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function ka(e,t,r){const a=await fetch(ur,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:r,grant_type:"refresh_token"})}),n=await a.text();if(!a.ok)throw a.status===400||a.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${a.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function hr(e){const t=await fetch(_a,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function Le(e,t,r,a,n){if(!a||!n)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(V&&V.userId===t&&V.expiresAt>Date.now()/1e3+60){const i=await ft(e,t,r);return{token:V.token,email:(i==null?void 0:i.email)||"unknown"}}const s=await ft(e,t,r);if(!s)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const o=await ka(s.refresh_token,a,n);return V={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{token:o.access_token,email:s.email}}async function xt(e,t,r){try{const a=await ft(e,t,r);return a?{connected:!0,email:a.email,connectedAt:a.connected_at}:{connected:!1}}catch{return{connected:!1}}}function gr(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function fr(e,t,r,a,n,s,o){const i=await mr(a,s,o,n);if(!i.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await hr(i.access_token),d={refresh_token:i.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Ta(e,t,r,d),V={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{email:l.email,name:l.name}}async function vr(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(V==null?void 0:V.userId)===t&&(V=null)}const Be="https://sheets.googleapis.com/v4/spreadsheets";class yr{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Le(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,r){const a=await this.authHeaders(),n=encodeURIComponent(r),s=await fetch(`${Be}/${t}/values/${n}`,{headers:a});if(!s.ok){const i=await s.text();throw new Error(`Sheets read failed (${s.status}): ${i}`)}return(await s.json()).values||[]}async writeRange(t,r,a){const n=await this.authHeaders(),s=encodeURIComponent(r),o=await fetch(`${Be}/${t}/values/${s}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:n,body:JSON.stringify({range:r,majorDimension:"ROWS",values:a})});if(!o.ok){const l=await o.text();throw new Error(`Sheets write failed (${o.status}): ${l}`)}return{updatedCells:(await o.json()).updatedCells||0}}async appendRows(t,r,a){var l;const n=await this.authHeaders(),s=encodeURIComponent(r),o=await fetch(`${Be}/${t}/values/${s}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:n,body:JSON.stringify({range:r,majorDimension:"ROWS",values:a})});if(!o.ok){const d=await o.text();throw new Error(`Sheets append failed (${o.status}): ${d}`)}return{updatedCells:((l=(await o.json()).updates)==null?void 0:l.updatedCells)||a.length}}async createSpreadsheet(t,r){const a=await this.authHeaders(),n={properties:{title:t},sheets:r&&r.length>0?r.map(i=>({properties:{title:i}})):[{properties:{title:"Sheet1"}}]},s=await fetch(Be,{method:"POST",headers:a,body:JSON.stringify(n)});if(!s.ok){const i=await s.text();throw new Error(`Sheets create failed (${s.status}): ${i}`)}const o=await s.json();return{spreadsheetId:o.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${o.spreadsheetId}/edit`}}async getMetadata(t){const r=await this.authHeaders(),a=await fetch(`${Be}/${t}?fields=properties.title,sheets.properties.title`,{headers:r});if(!a.ok){const s=await a.text();throw new Error(`Sheets metadata failed (${a.status}): ${s}`)}const n=await a.json();return{title:n.properties.title,sheets:n.sheets.map(s=>s.properties.title)}}}const je="https://www.googleapis.com/calendar/v3";class _t{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Le(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",r={}){const a=await this.authHeaders(),n=new URLSearchParams;r.timeMin&&n.set("timeMin",r.timeMin),r.timeMax&&n.set("timeMax",r.timeMax),n.set("maxResults",String(r.maxResults||20)),n.set("singleEvents","true"),n.set("orderBy","startTime"),r.query&&n.set("q",r.query);const s=await fetch(`${je}/calendars/${encodeURIComponent(t)}/events?${n}`,{headers:a});if(!s.ok){const i=await s.text();throw new Error(`Calendar list failed (${s.status}): ${i}`)}return(await s.json()).items||[]}async createEvent(t="primary",r){var i;const a=await this.authHeaders(),n=r.timeZone||"Asia/Kolkata",s={summary:r.summary,description:r.description||"",location:r.location||"",start:{dateTime:r.startDateTime,timeZone:n},end:{dateTime:r.endDateTime,timeZone:n}};(i=r.attendees)!=null&&i.length&&(s.attendees=r.attendees.map(l=>({email:l})));const o=await fetch(`${je}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:a,body:JSON.stringify(s)});if(!o.ok){const l=await o.text();throw new Error(`Calendar create failed (${o.status}): ${l}`)}return await o.json()}async updateEvent(t="primary",r,a){const n=await this.authHeaders(),s=a.timeZone||"Asia/Kolkata",o={};a.summary&&(o.summary=a.summary),a.description&&(o.description=a.description),a.location&&(o.location=a.location),a.startDateTime&&(o.start={dateTime:a.startDateTime,timeZone:s}),a.endDateTime&&(o.end={dateTime:a.endDateTime,timeZone:s});const i=await fetch(`${je}/calendars/${encodeURIComponent(t)}/events/${r}`,{method:"PATCH",headers:n,body:JSON.stringify(o)});if(!i.ok){const l=await i.text();throw new Error(`Calendar update failed (${i.status}): ${l}`)}return await i.json()}async deleteEvent(t="primary",r){const a=await this.authHeaders(),n=await fetch(`${je}/calendars/${encodeURIComponent(t)}/events/${r}`,{method:"DELETE",headers:a});if(!n.ok&&n.status!==410){const s=await n.text();throw new Error(`Calendar delete failed (${n.status}): ${s}`)}}async listCalendars(){const t=await this.authHeaders(),r=await fetch(`${je}/users/me/calendarList`,{headers:t});if(!r.ok){const n=await r.text();throw new Error(`Calendar list calendars failed (${r.status}): ${n}`)}return((await r.json()).items||[]).map(n=>({id:n.id,summary:n.summary,primary:n.primary||!1}))}}const Xe="https://docs.googleapis.com/v1/documents",Sa="https://www.googleapis.com/drive/v3/files";class br{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Le(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const r=await this.authHeaders(),a=await fetch(Xe,{method:"POST",headers:r,body:JSON.stringify({title:t})});if(!a.ok){const s=await a.text();throw new Error(`Docs create failed (${a.status}): ${s}`)}const n=await a.json();return{documentId:n.documentId,url:`https://docs.google.com/document/d/${n.documentId}/edit`}}async readDocument(t){var o,i;const r=await this.authHeaders(),a=await fetch(`${Xe}/${t}`,{headers:r});if(!a.ok){const l=await a.text();throw new Error(`Docs read failed (${a.status}): ${l}`)}const n=await a.json();let s="";for(const l of((o=n.body)==null?void 0:o.content)||[])if(l.paragraph)for(const d of l.paragraph.elements)(i=d.textRun)!=null&&i.content&&(s+=d.textRun.content);return{title:n.title,content:s.trim()}}async appendText(t,r){const a=await this.authHeaders(),n=await fetch(`${Xe}/${t}`,{headers:a});if(!n.ok){const l=await n.text();throw new Error(`Docs read for append failed (${n.status}): ${l}`)}const s=await n.json(),o=s.body.content[s.body.content.length-1].endIndex-1,i=await fetch(`${Xe}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:[{insertText:{location:{index:o},text:r}}]})});if(!i.ok){const l=await i.text();throw new Error(`Docs append failed (${i.status}): ${l}`)}}async shareDocument(t,r,a="writer"){const n=await this.authHeaders(),s=await fetch(`${Sa}/${t}/permissions`,{method:"POST",headers:n,body:JSON.stringify({type:"user",role:a,emailAddress:r})});if(!s.ok){const o=await s.text();throw new Error(`Share failed (${s.status}): ${o}`)}}}class Y{constructor(t,r,a,n,s){E(this,"sheets");E(this,"calendar");E(this,"docs");E(this,"db");E(this,"userId");E(this,"pinHash");this.db=t,this.userId=r,this.pinHash=a,this.sheets=new yr(t,r,a,n,s),this.calendar=new _t(t,r,a,n,s),this.docs=new br(t,r,a,n,s)}async isConnected(){return xt(this.db,this.userId,this.pinHash)}}const Ze=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:_t,GoogleDocs:br,GoogleServices:Y,GoogleSheets:yr,completeOAuthFlow:fr,disconnectGoogle:vr,exchangeCodeForTokens:mr,fetchUserInfo:hr,generateAuthUrl:pr,getGoogleAuth:Le,isGoogleConnected:xt,isOAuthClientConfigured:gr},Symbol.toStringTag,{value:"Module"}));async function Ia(e,t,r={}){const a={textQuery:t,languageCode:"en",pageSize:8};if(r.type&&(a.includedType=r.type),r.location){const l=r.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(a.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:r.radius||5e3}})}const n=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),s=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":n},body:JSON.stringify(a)});if(!s.ok){const l=await s.text();return{results:[],error:`Places API error (${s.status}): ${l.substring(0,200)}`}}const o=await s.json();return!o.places||o.places.length===0?{results:[]}:{results:o.places.map(l=>{var d,u,m;return{name:((d=l.displayName)==null?void 0:d.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(u=l.currentOpeningHours)==null?void 0:u.openNow,types:(m=l.types)==null?void 0:m.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function Ca(e,t){var s,o,i;const r=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),a=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":r}});if(!a.ok){const l=await a.text();return{error:`Place Details API error (${a.status}): ${l.substring(0,200)}`}}const n=await a.json();return{details:{name:((s=n.displayName)==null?void 0:s.text)||"",address:n.formattedAddress||"",phone:n.internationalPhoneNumber,website:n.websiteUri,rating:n.rating,reviews:(o=n.reviews)==null?void 0:o.slice(0,3).map(l=>{var d,u,m;return{author:((d=l.authorAttribution)==null?void 0:d.displayName)||"Anonymous",rating:l.rating||0,text:((m=(u=l.text)==null?void 0:u.text)==null?void 0:m.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(i=n.currentOpeningHours)==null?void 0:i.weekdayDescriptions,location:n.location?{lat:n.location.latitude,lng:n.location.longitude}:void 0,googleMapsUri:n.googleMapsUri}}}async function Oa(e,t,r,a={}){var d;const n=new URLSearchParams({origin:t,destination:r,key:e,mode:a.mode||"driving"});(a.mode==="driving"||!a.mode)&&n.set("departure_time","now");const s=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${n}`);if(!s.ok)return{error:`Directions API error: ${s.status}`};const o=await s.json();if(o.status!=="OK")return{error:`Directions: ${o.status} — ${o.error_message||""}`};const i=o.routes[0],l=i.legs[0];return{route:{summary:i.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(d=l.duration_in_traffic)==null?void 0:d.text,steps:l.steps.slice(0,10).map(u=>{var m,g,f;return{instruction:((m=u.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((g=u.distance)==null?void 0:g.text)||"",duration:((f=u.duration)==null?void 0:f.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function Da(e,t,r,a){var l,d;const n={q:t,target:r,key:e,format:"text"};a&&(n.source=a);const s=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const u=await s.text();return{translatedText:"",error:`Translate API error (${s.status}): ${u.substring(0,200)}`}}const i=(d=(l=(await s.json()).data)==null?void 0:l.translations)==null?void 0:d[0];return i?{translatedText:i.translatedText,detectedSourceLang:i.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function Ra(e,t){const r=new URLSearchParams({address:t,key:e}),a=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${r}`);if(!a.ok)return{results:[],error:`Geocoding API error: ${a.status}`};const n=await a.json();return n.status!=="OK"&&n.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${n.status} — ${n.error_message||""}`}:{results:(n.results||[]).slice(0,5).map(s=>{var o;return{address:s.formatted_address,lat:s.geometry.location.lat,lng:s.geometry.location.lng,placeId:s.place_id,types:(o=s.types)==null?void 0:o.slice(0,3)}})}}async function Aa(e,t,r={}){const a=new URLSearchParams({part:"snippet",q:t,key:e,type:r.type||"video",maxResults:String(r.maxResults||5),order:r.order||"relevance"}),n=await fetch(`https://www.googleapis.com/youtube/v3/search?${a}`);if(!n.ok){const o=await n.text();return{results:[],error:`YouTube API error (${n.status}): ${o.substring(0,200)}`}}return{results:((await n.json()).items||[]).map(o=>{var i,l,d,u,m,g,f,b;return{title:o.snippet.title,channelTitle:o.snippet.channelTitle,description:(i=o.snippet.description)==null?void 0:i.substring(0,200),videoId:((l=o.id)==null?void 0:l.videoId)||((d=o.id)==null?void 0:d.channelId)||((u=o.id)==null?void 0:u.playlistId)||"",publishedAt:o.snippet.publishedAt,url:(m=o.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${o.id.videoId}`:(g=o.id)!=null&&g.channelId?`https://www.youtube.com/channel/${o.id.channelId}`:"",thumbnailUrl:(b=(f=o.snippet.thumbnails)==null?void 0:f.medium)==null?void 0:b.url}})}}async function Et(e,t={}){const r=Math.min(t.num||5,10),a=t.site?`site:${t.site} ${e}`:e;try{const n=new URLSearchParams({q:a}),s=await fetch(`https://html.duckduckgo.com/html/?${n}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!s.ok)return{results:[],error:`Search request failed (${s.status})`};const o=await s.text(),i=[],l=o.split(/class="result results_links/g).slice(1);for(const d of l){if(i.length>=r)break;const u=d.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=d.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(u){let g=u[1];const f=g.match(/uddg=([^&]+)/);f?g=decodeURIComponent(f[1]):g.startsWith("//")&&(g="https:"+g);const b=h=>h.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),x=b(u[2]),c=m?b(m[1]):"";if(x&&g.startsWith("http")){const h=g.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];i.push({title:x,link:g,snippet:c,displayLink:h})}}}return i.length===0?{results:[],error:void 0}:{results:i}}catch(n){return{results:[],error:`Web search error: ${n.message}`}}}async function La(e,t,r,a="driving"){var l,d,u,m;const n=new URLSearchParams({origins:t,destinations:r,key:e,mode:a,departure_time:"now"}),s=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${n}`);if(!s.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${s.status}`};const o=await s.json(),i=(u=(d=(l=o.rows)==null?void 0:l[0])==null?void 0:d.elements)==null?void 0:u[0];return!i||i.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(i==null?void 0:i.status)||o.status}`}:{distance:i.distance.text,duration:i.duration.text,durationInTraffic:(m=i.duration_in_traffic)==null?void 0:m.text}}const re="https://gmail.googleapis.com/gmail/v1/users/me";class ae{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Le(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var i;const r=await this.authHeaders(),a=new URLSearchParams;if(a.set("maxResults",String(t.maxResults||10)),t.query&&a.set("q",t.query),(i=t.labelIds)!=null&&i.length)for(const l of t.labelIds)a.append("labelIds",l);const n=await fetch(`${re}/messages?${a}`,{headers:r});if(!n.ok){const l=await n.text();throw new Error(`Gmail list failed (${n.status}): ${l.substring(0,200)}`)}const s=await n.json();if(!s.messages||s.messages.length===0)return[];const o=[];for(const l of s.messages.slice(0,t.maxResults||10))try{const d=await this.getMessage(l.id,r);d&&o.push(d)}catch{}return o}async getMessage(t,r){const a=r||await this.authHeaders(),n=await fetch(`${re}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:a});if(!n.ok)return null;const s=await n.json(),o=i=>{var l,d,u;return((u=(d=(l=s.payload)==null?void 0:l.headers)==null?void 0:d.find(m=>m.name.toLowerCase()===i.toLowerCase()))==null?void 0:u.value)||""};return{id:s.id,threadId:s.threadId,snippet:s.snippet||"",subject:o("Subject")||"(no subject)",from:o("From"),to:o("To"),date:o("Date")||new Date(parseInt(s.internalDate)).toISOString(),isUnread:(s.labelIds||[]).includes("UNREAD"),labels:s.labelIds||[]}}async getMessageBody(t){const r=await this.authHeaders(),a=await fetch(`${re}/messages/${t}?format=full`,{headers:r});if(!a.ok){const s=await a.text();throw new Error(`Gmail message body failed (${a.status}): ${s.substring(0,200)}`)}const n=await a.json();return wr(n.payload)}async search(t,r=10){return this.listMessages({query:t,maxResults:r})}async send(t,r,a,n={}){const s=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${r}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&o.push(`Cc: ${n.cc}`),n.bcc&&o.push(`Bcc: ${n.bcc}`),n.replyToMessageId&&(o.push(`In-Reply-To: ${n.replyToMessageId}`),o.push(`References: ${n.replyToMessageId}`)),o.push("",a);const i=o.join(`\r
`),d={raw:btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")};n.threadId&&(d.threadId=n.threadId);const u=await fetch(`${re}/messages/send`,{method:"POST",headers:s,body:JSON.stringify(d)});if(!u.ok){const m=await u.text();throw new Error(`Gmail send failed (${u.status}): ${m.substring(0,200)}`)}return await u.json()}async createDraft(t,r,a){const n=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${r}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8","",a].join(`\r
`),i=btoa(unescape(encodeURIComponent(o))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),l=await fetch(`${re}/drafts`,{method:"POST",headers:n,body:JSON.stringify({message:{raw:i}})});if(!l.ok){const d=await l.text();throw new Error(`Gmail draft failed (${l.status}): ${d.substring(0,200)}`)}return await l.json()}async markAsRead(t){const r=await this.authHeaders();await fetch(`${re}/messages/${t}/modify`,{method:"POST",headers:r,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async getUnreadCount(){const t=await this.authHeaders(),r=await fetch(`${re}/labels/INBOX`,{headers:t});return r.ok&&(await r.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),r=await fetch(`${re}/profile`,{headers:t});if(!r.ok)throw new Error("Failed to get Gmail profile");return await r.json()}}function wr(e){var t,r,a;if(!e)return"";if((t=e.body)!=null&&t.data)return ct(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((r=n.body)!=null&&r.data))return ct(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((a=n.body)!=null&&a.data)){const s=ct(n.body.data);return Na(s)}for(const n of e.parts)if(n.parts){const s=wr(n);if(s)return s}}return e.snippet||""}function ct(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function Na(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const $a=8e3,Ma=8e3;async function xr(e,t){try{const r=new AbortController,a=setTimeout(()=>r.abort(),Ma),n=await fetch(e,{signal:r.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(a),!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const o=await n.text(),i=Ba(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||$a)}}catch(r){return{text:"",error:r.name==="AbortError"?"Timeout":r.message}}}function Ba(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function _r(e,t,r={}){const a=r.maxPages||(r.depth==="thorough"?5:3),n=r.maxResults||(r.depth==="thorough"?8:5),s=await Et(e,{num:n,site:r.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,a).map(async g=>{const f=await xr(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:f.text,error:f.error}}),d=(await Promise.all(i)).filter(g=>g.content.length>50);if(d.length===0){const g=s.results.map((b,x)=>`[${x+1}] ${b.title}
${b.snippet}
Source: ${b.link}`).join(`

`);return{report:await Rt(e,g,t,"snippets"),sources:s.results.map(b=>({title:b.title,url:b.link})),pagesRead:0}}const u=d.map((g,f)=>`--- SOURCE ${f+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${f+1} ---`).join(`

`);return{report:await Rt(e,u,t,"full"),sources:d.map(g=>({title:g.title,url:g.url})),pagesRead:d.length}}async function Rt(e,t,r,a){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
## Current Date & Time
${Ua(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Lt(e,t,r){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${r.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:r,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:r}}function Ua(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function Sr(e,t,r,a,n,s,o,i,l,d,u){var g,f,b,x;const m=new ce(r);switch(e){case"create_schedule":{const c=new Date;let h;const p=d||"UTC";if(t.schedule_type==="interval"){const y=parseInt(t.schedule_value,10);h=new Date(c.getTime()+y*60*1e3)}else{const[y,w]=t.schedule_value.split(":").map(Number),_=c.toLocaleString("en-US",{timeZone:p}),C=new Date(_),N=new Date(C);N.setHours(y,w,0,0),N<=C&&N.setDate(N.getDate()+1);const H=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),$=new Date(N.toLocaleString("en-US",{timeZone:p})),U=H.getTime()-$.getTime();h=new Date(N.getTime()+U)}return await r.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(a,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),h.toISOString()).run(),`Schedule created: "${t.name}" — ${t.schedule_type==="interval"?`every ${t.schedule_value} minutes`:`daily at ${t.schedule_value}`}. State: active. Next run: ${h.toISOString()}`}case"list_schedules":{const h=(await r.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(a).all()).results||[];return h.length===0?"No scheduled tasks found.":h.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — ${p.schedule_type==="interval"?`every ${p.schedule_value} min`:`daily at ${p.schedule_value}`} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const h=await new Y(r,a,n,s||"",o||"").sheets.readRange(t.spreadsheet_id,t.range);return h.length===0?"No data found in the specified range.":h.map(p=>p.join("	| ")).join(`
`)}catch(c){return await S(r,a,"google","read_sheet",c.message),`Failed to read sheet: ${c.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new Y(r,a,n,s||"",o||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await S(r,a,"google","write_sheet",c.message),`Failed to write sheet: ${c.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new Y(r,a,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await S(r,a,"google","append_sheet",c.message),`Failed to append to sheet: ${c.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Y(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.sheets.createSpreadsheet(t.title,t.sheet_names);let y="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>Ze)).getGoogleAuth(r,a,n,s||"",o||"");y=`
Folder: "${(await Lt(w,p.spreadsheetId,t.folder_name)).folderName}"`}catch(w){y=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ce(r).store(a,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${y}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(c){return await S(r,a,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new Y(r,a,n,s||"",o||""),h=t.calendar_id||"primary",p=t.days_ahead||7,y=new Date,w=new Date(y.getTime()+p*24*60*60*1e3),_=await c.calendar.listEvents(h,{timeMin:y.toISOString(),timeMax:w.toISOString(),query:t.query});return _.length===0?`No events found in the next ${p} days.`:_.map(C=>{var P;const N=C.start.dateTime||C.start.date||"TBD",H=C.end.dateTime||C.end.date||"",$=C.location?` 📍 ${C.location}`:"",U=((P=C.attendees)==null?void 0:P.map($e=>$e.email).join(", "))||"";return`• ${C.summary} — ${N} to ${H}${$}${U?`
  Attendees: ${U}`:""}`}).join(`
`)}catch(c){return await S(r,a,"google","list_calendar",c.message),`Failed to list events: ${c.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const c=new Y(r,a,n,s||"",o||""),h=t.calendar_id||"primary",p=await c.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(c){return await S(r,a,"google","create_event",c.message),`Failed to create event: ${c.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Y(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.docs.createDocument(t.title);t.content&&await c.docs.appendText(p.documentId,t.content);let y="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>Ze)).getGoogleAuth(r,a,n,s||"",o||"");y=`
Folder: "${(await Lt(w,p.documentId,t.folder_name)).folderName}"`}catch(w){y=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ce(r).store(a,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${y}
ID: ${p.documentId}
URL: ${p.url}`}catch(c){return await S(r,a,"google","create_doc",c.message),`Failed to create document: ${c.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const h=await new Y(r,a,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${h.title}"

${h.content}`}catch(c){return await S(r,a,"google","read_doc",c.message),`Failed to read document: ${c.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Y(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await c.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await c.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await S(r,a,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new ae(r,a,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((p,y)=>`${p.isUnread?"● ":"  "}${y+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await S(r,a,"gmail","list",c.message),(g=c.message)!=null&&g.includes("not connected")?c.message:`Gmail list error: ${c.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const c=new ae(r,a,n,s||"",o||""),h=await c.getMessage(t.message_id);if(!h)return"Message not found.";const p=await c.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${p}`}catch(c){return await S(r,a,"gmail","read",c.message),`Gmail read error: ${c.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new ae(r,a,n,s||"",o||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((p,y)=>`${p.isUnread?"● ":"  "}${y+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await S(r,a,"gmail","search",c.message),`Gmail search error: ${c.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new ae(r,a,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(c){return await S(r,a,"gmail","send",c.message),`Gmail send error: ${c.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new ae(r,a,n,s||"",o||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(c){return await S(r,a,"gmail","draft",c.message),`Gmail draft error: ${c.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new ae(r,a,n,s||"",o||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(c){return(f=c.message)!=null&&f.includes("not connected")?c.message:`Gmail error: ${c.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>Ze)).getGoogleAuth(r,a,n,s||"",o||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",h.set("q",p);const y=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${c}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const w=await y.json();return(b=w.files)!=null&&b.length?w.files.map((_,C)=>{var U,P;const N=((U=_.mimeType)==null?void 0:U.split(".").pop())||_.mimeType,H=_.size?`${(parseInt(_.size)/1024).toFixed(1)} KB`:"",$=((P=_.modifiedTime)==null?void 0:P.split("T")[0])||"";return`${C+1}. **${_.name}** (${N})
   ${H} · Modified: ${$}
   ${_.webViewLink||""}`}).join(`

`):"No files found."}catch(c){return await S(r,a,"google","drive_list",c.message),`Drive list error: ${c.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>Ze)).getGoogleAuth(r,a,n,s||"",o||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",h),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const y=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${c}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const w=await y.json();return(x=w.files)!=null&&x.length?w.files.map((_,C)=>{var $,U;const N=(($=_.mimeType)==null?void 0:$.split(".").pop())||_.mimeType,H=((U=_.modifiedTime)==null?void 0:U.split("T")[0])||"";return`${C+1}. **${_.name}** (${N}) — Modified: ${H}
   ${_.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(c){return await S(r,a,"google","drive_search",c.message),`Drive search error: ${c.message}`}}case"web_search":try{const c=await Et(t.query,{num:t.num_results||5,site:t.site});return c.error?`Web search failed: ${c.error}`:c.results.length===0?`No results found for "${t.query}".`:c.results.map((h,p)=>`${p+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(c){return await S(r,a,"search","web_search",c.message),`Web search error: ${c.message}`}case"read_url":try{const c=t.url;if(!c||!c.startsWith("http://")&&!c.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>ja),y=await p(c,h);return y.error?`Failed to read page: ${y.error}`:!y.text||y.text.length<20?`Page at ${c} returned no readable content.`:`Content from ${c} (${y.text.length} chars):

${y.text}`}catch(c){return await S(r,a,"search","read_url",c.message),`Read URL error: ${c.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const c=await _r(t.query,u,{depth:t.depth||"quick",site:t.site});if(c.error)return`Research failed: ${c.error}`;let h=c.report;return c.sources.length>0&&(h+=`

---
**Sources** (`+c.pagesRead+` pages read):
`,h+=c.sources.map((p,y)=>`[${y+1}] ${p.title}
    ${p.url}`).join(`
`)),h}catch(c){return await S(r,a,"research","research",c.message),`Research error: ${c.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await A(c.encrypted_value,n),p=await Ia(h,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((y,w)=>{const _=y.rating?` ★${y.rating} (${y.userRatingsTotal||0} reviews)`:"",C=y.openNow!==void 0?y.openNow?" · Open now":" · Closed":"",N=y.googleMapsUri?`
   ${y.googleMapsUri}`:"";return`${w+1}. **${y.name}**${_}${C}
   ${y.address}${N}
   [place_id: ${y.placeId}]`}).join(`

`)}catch(c){return await S(r,a,"google_api","search_places",c.message),`Places search error: ${c.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await A(c.encrypted_value,n),p=await Ca(h,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const y=p.details;let w=`**${y.name}**
...
Recent Reviews:`;for(const _ of y.reviews)w+=`
— ${_.author} (★${_.rating}, ${_.time}): "${_.text}"`}return w}catch(c){return await S(r,a,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await A(c.encrypted_value,n),p=await Oa(h,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const y=p.route;let w=`**${y.startAddress}** → **${y.endAddress}**
`;return w+=`📏 ${y.distance} · ⏱️ ${y.duration}`,y.durationInTraffic&&(w+=` (with traffic: ${y.durationInTraffic})`),w+=`
via ${y.summary}`,w+=`

Steps:`,y.steps.forEach((_,C)=>{w+=`
${C+1}. ${_.instruction} (${_.distance}, ${_.duration})`}),w}catch(c){return await S(r,a,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await A(c.encrypted_value,n),p=await La(h,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let y=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(y+=` (with traffic: ${p.durationInTraffic})`),y}catch(c){return await S(r,a,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await A(c.encrypted_value,n),p=await Da(h,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(c){return await S(r,a,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await A(c.encrypted_value,n),p=await Aa(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((y,w)=>{var _;return`${w+1}. **${y.title}**
   ${y.channelTitle} · ${((_=y.publishedAt)==null?void 0:_.split("T")[0])||""}
   ${y.description}
   ${y.url}`}).join(`

`)}catch(c){return await S(r,a,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await A(c.encrypted_value,n),p=await Ra(h,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((y,w)=>`${w+1}. ${y.address}
   Coordinates: ${y.lat}, ${y.lng}`).join(`
`)}catch(c){return await S(r,a,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function Tt(e,t,r,a,n,s){var x;const o=new ce(t),i=(x=e.metadata)==null?void 0:x.thread_id,l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,15,i),m=[{role:"system",content:kr(a,l)},...d.map(c=>({role:c.role,content:c.content})),{role:"user",content:e.text}];await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let f="",b=0;for(let c=0;c<g;c++)try{const h=await r.chat(m,{tools:Tr});if(h.usage&&(b+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){h.content&&m.push({role:"assistant",content:h.content});for(const p of h.toolCalls)try{const y=await Sr(p.name,p.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);m.push({role:"user",content:`[Tool Result for ${p.name}]: ${y}`})}catch(y){await S(t,a.id,"tool",p.name,y.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${p.name}]: ${y.message||"Execution failed"}`})}continue}f=h.content;break}catch(h){if(n){const p=h.message||"",y=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),w=p.includes("429"),_=y?1440:w?10:5;await n.recordError(r.name,p,_)}throw await S(t,a.id,"llm","provider_error",h.message||"Unknown LLM error",{provider:r.name,turn:c}),h}if(n&&b>0)try{await n.recordUsage(r.name,b)}catch{}return await o.storeMessage(a.id,e.channel,"assistant",f,"{}",i),await o.compactHistory(a.id,30),f}const Nt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Ga(e){for(const[t,r]of Object.entries(Nt))if(e.toLowerCase().includes(t.toLowerCase()))return r;return Nt.default}function za(e,t,r,a){const n=Ga(a),s=Math.floor(n*.75),o=[];let i=0,l=!1;const d=ut(e);o.push({role:"system",content:e}),i+=d;const u=ut(r);i+=u;const m=s-i,g=[];let f=0;for(let b=t.length-1;b>=0;b--){const x=t[b],c=ut(x.content);if(f+c<=m)g.unshift({role:x.role,content:x.content}),f+=c;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:r}),i+=f,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*Fa(e,t,r,a,n,s){var c;const o=new ce(t),i=(c=e.metadata)==null?void 0:c.thread_id;yield{type:"thinking",data:{threadId:i,provider:r.name}};const l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,20,i),u=kr(a,l),m=za(u,d,e.text,r.name);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let f="",b=0;const x=[...m.messages];for(let h=0;h<g;h++)try{h>0&&(yield{type:"thinking",data:{threadId:i}});const p=await r.chat(x,{tools:Tr});if(p.usage&&(b+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},x.push({role:"assistant",content:p.content}));for(const w of p.toolCalls){yield{type:"tool_start",data:{tool:w.name,toolArgs:w.arguments,threadId:i}};try{const _=await Sr(w.name,w.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);yield{type:"tool_end",data:{tool:w.name,toolResult:_.substring(0,500)+(_.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${w.name}]: ${_}`})}catch(_){await S(t,a.id,"tool",w.name,_.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:w.name,toolResult:`Error: ${_.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${w.name}]: ${_.message||"Execution failed"}`})}}continue}f=p.content;const y=50;for(let w=0;w<f.length;w+=y)yield{type:"chunk",data:{text:f.substring(w,w+y),threadId:i}},w+y<f.length&&await new Promise(C=>setTimeout(C,10));break}catch(p){if(n){const y=p.message||"",w=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),_=y.includes("429"),C=w?1440:_?10:5;await n.recordError(r.name,y,C)}await S(t,a.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:r.name,turn:h}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&b>0)try{await n.recordUsage(r.name,b)}catch{}await o.storeMessage(a.id,e.channel,"assistant",f,"{}",i),await o.compactHistory(a.id,30),yield{type:"done",data:{threadId:i,provider:r.name,tokenCount:b}}}const O=new ue;async function Wa(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}O.use("/*",Wa);O.get("/threads",async e=>{const t=e.get("user"),r=e.req.query("archived")==="1",a=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await q(r,t,l),!0}case"/help":{const i=`🛠 *${(a==null?void 0:a.assistant_name)||"Karna"} — Commands*
...
Status: ✅ Online`;await q(r,t,u)}catch{await q(r,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return a?(await q(r,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await q(r,t,"⚠️ Account not linked."),!0);default:return!1}}Ye.post("/webhook",async e=>{var t,r,a;try{const n=await e.req.json();if(n.callback_query)return await tn(e.env.DB,n.callback_query),e.json({ok:!0});const s=n.message;if(!(s!=null&&s.text))return e.json({ok:!0});const o=String(s.chat.id),i=s.text,l=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(o).first();let d=null;if(l){const f=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(l.id,"telegram_bot_token").first();f&&(d=await A(f.encrypted_value,l.pin_hash))}if(!d){const f=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();f&&(d=await A(f.encrypted_value,f.pin_hash))}if(!d)return e.json({ok:!0,message:"Bot token not configured"});if(i.startsWith("/")&&await en(i,o,d,l,e.env.DB))return e.json({ok:!0});if(!l)return await q(d,o,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${o}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});await Za(d,o);const u=Ya(l.id,l.username,i,o);let m,g;try{const f=await Je(e.env.DB,l.id,l.pin_hash);m=f.provider,g=f.rotation}catch(f){console.error("Telegram provider setup error:",f);const b=(t=f.message)!=null&&t.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(r=f.message)!=null&&r.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${f.message||"Unknown error"}`;return await q(d,o,b),e.json({ok:!0})}try{const f=await Tt(u,e.env.DB,m,l,g,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),b=Va(f,"telegram");await q(d,o,b||"(empty response)")}catch(f){console.error("Telegram agent error:",f);const b=(a=f.message)!=null&&a.includes("API error")?`⚠️ AI provider returned an error. The provider (${m.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(f.message||"Unknown").substring(0,200)}`;await q(d,o,b);try{const{logError:x}=await Promise.resolve().then(()=>gt);await x(e.env.DB,l.id,"telegram","agent_error",f.message||"Agent error",{provider:m.name})}catch{}}return e.json({ok:!0})}catch(n){console.error("Telegram webhook error:",n);try{const{logError:s}=await Promise.resolve().then(()=>gt);await s(e.env.DB,null,"telegram","webhook_error",n.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:n.message})}});Ye.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const{webhook_url:a}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await A(n.encrypted_value,r.pin_hash);if(!a){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:a,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});Ye.get("/webhook-status",async e=>{var s,o,i,l,d,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({configured:!1,error:"Bot token not set"});const n=await A(a.encrypted_value,r.pin_hash);try{const g=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=g.result)==null?void 0:o.url)||"",has_webhook:!!((i=g.result)!=null&&i.url),pending_updates:((l=g.result)==null?void 0:l.pending_update_count)||0,last_error:((d=g.result)==null?void 0:d.last_error_message)||"",last_error_date:((u=g.result)==null?void 0:u.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Ye.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({error:"Bot token not configured"},400);const n=await A(a.encrypted_value,r.pin_hash);try{const d=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(c=>setTimeout(c,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const g=m.result||[];if(g.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const f=[],b=new Set;for(let c=g.length-1;c>=0;c--){const h=g[c].message;if(h&&h.chat){const p=String(h.chat.id);b.has(p)||(b.add(p),f.push({chat_id:p,name:[h.chat.first_name,h.chat.last_name].filter(Boolean).join(" ")||h.chat.title||"Unknown",username:h.chat.username||"",date:new Date((h.date||0)*1e3).toISOString()}))}}if(f.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const x=f[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(x,r.user_id).run(),e.json({found:!0,chat_id:x,name:f[0].name,all_chats:f,message:`Chat ID ${x} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function tn(e,t){var x;const{id:r,data:a,message:n,from:s}=t;if(!a||!n)return;const o=a.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],l=parseInt(o[2]);if(!l||!i)return;const d=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!u)return;const m=await e.prepare(`
  ...
  `).bind(g,g,m.id).run();const f=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!f)return;const b=await A(f.encrypted_value,f.pin_hash);if(await fetch(`https://api.telegram.org/bot${b}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:r,text:g?"✅ Checked!":"☐ Unchecked"})}),(x=n.reply_markup)!=null&&x.inline_keyboard){const c=n.reply_markup.inline_keyboard.map(h=>h.map(p=>{var y;if((y=p.callback_data)!=null&&y.includes(i)){const w=g?"✅":"☐",_=p.text.replace(/^[☐✅]\s*/,"");return{...p,text:`${w} ${_}`}}return p}));try{await fetch(`https://api.telegram.org/bot${b}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:c}})})}catch{}}}function rn(e){const t=new Date,r=new Date(t.toLocaleString("en-US",{timeZone:e})),a=new Date(r);a.setDate(a.getDate()+1),a.setHours(0,0,0,0);const n=new Date(a);n.setHours(23,59,59,999);const s=a.toISOString().split("T")[0];return{start:a.toISOString(),end:n.toISOString(),dateStr:s}}async function an(e,t,r,a,n,s){try{return(await new _t(e,t,r,a,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function nn(e,t,r,a,n){try{const s=new ae(e,t,r,a,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const g=m.from.split("<")[0].trim()||m.from;l[g]=(l[g]||0)+1}const d=Object.entries(l).sort(([,m],[,g])=>g-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:d,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function sn(e,t){var r;try{const a=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(a.results||[]).map(l=>l.name),i=(a.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((r=a.results)==null?void 0:r.length)||0,dueToday:i,items:o}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function on(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],r=[];for(const a of t){const n=`latest ${a} news today`;try{const s=await Et(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!r.some(i=>i.url===o.link)&&(r.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),r.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(r.length>=5)break}return r.slice(0,5)}function ln(e){const t=[];t.push(`📋 Evening Briefing for ${e.targetDate}`),t.push("");const r=e.calendar.totalCount;if(r>0){t.push(`📅 Tomorrow: ${r} event${r===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const a=e.emails.gmail.unreadCount;if(a>0?(t.push(`📧 Gmail: ${a} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function dn(e){const t=[];let r=0;for(const a of e.calendar.google)t.push({type:"calendar",key:a.id,text:`${a.title} - ${new Date(a.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:a},sortOrder:r++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:r++});for(const a of e.tasks.items)t.push({type:"task",key:`task-${a}`,text:a,metadata:{},sortOrder:r++});for(const a of e.news.items)t.push({type:"news",key:`news-${a.url}`,text:`📰 ${a.title}`,metadata:{url:a.url,source:a.source},sortOrder:r++});return t}async function cn(e,t){const r=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!r)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let a;try{a=JSON.parse(r.components)}catch{a={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=r.news_topics?r.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:a,newsTopics:n}}async function Ir(e,t,r){var h;const a=t.timezone||"Asia/Kolkata",n=rn(a),{components:s,newsTopics:o}=await cn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(an(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(nn(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(sn(e,t.id)),l.push("tasks")),s.news&&(i.push(on(o)),l.push("news"));const d=await Promise.all(i),u={};l.forEach((p,y)=>{u[p]=d[y]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},f={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((h=u.googleEvents)==null?void 0:h.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||g,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};f.summary=ln(f);const b=dn(f),x=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(f)).first(),c=(x==null?void 0:x.id)||0;for(const p of b)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(c,p.type,p.key,p.text,JSON.stringify(p.metadata),p.sortOrder).run();return{briefingId:c,content:f,items:b}}async function un(e,t,r){const a=await e.prepare(`
  ...
  `).bind(r).all();return{briefing:{...a,content:JSON.parse(a.content_json||"{}")},items:n.results||[]}}async function pn(e,t,r,a){if(!await e.prepare(`
  ...
  `).bind(o,o,a,r).run(),{checked:o===1}}async function mn(e,t,r=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,r).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function hn(e,t,r=new Date){const a=new Date(r.toLocaleString("en-US",{timeZone:t})),n=a.getHours(),s=a.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,d=o*60+i;return l>=d&&l<d+5}function gn(e,t){const r=e.summary,a=[];for(const n of t.slice(0,10))a.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:r,inlineKeyboard:a}}const K=new ue;async function fn(e,t){var n;if(e.req.path.includes("/cron/"))return t();const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of a.results||[]){const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(hn(l,i,s))try{const d=await Ir(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:m}=gn(d.content,d.items);await vn(e.env.DB,o,u,m,d.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:i})}catch(d){n.push({user_id:o.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});K.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of a.results||[])try{const d=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!d)continue;const u=await A(d.encrypted_value,l.pin_hash),g=JSON.parse(u).access_token;if(!g)continue;const f=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${g}`}});if(!f.ok)continue;const x=((await f.json()).items||[]).filter(p=>{var w;const y=(w=p.start)==null?void 0:w.dateTime;return y?y>=s.toISOString()&&y<=o:!1});if(x.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!c)continue;const h=await A(c.encrypted_value,l.pin_hash);for(const p of x){const y=new Date(p.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),w=p.location?`
📍 ${p.location}`:"",_=`⏰ Meeting in 10 minutes!

*${p.summary||"Untitled Event"}*
🕐 ${y}${w}`;await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:_,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:x.length})}catch(d){n.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});async function vn(e,t,r,a,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const o=await A(s.encrypted_value,s.pin_hash);await fetch(`https://api.telegram.org/bot${o}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:`🌙 *Evening Briefing*

${r}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:a.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}const J=new ue;J.use("/api/*",ua());J.route("/api/auth",pe);J.route("/api/chat",O);J.route("/api/settings",D);J.route("/api/system",Ne);J.route("/api/telegram",Ye);J.route("/api/proactive",K);J.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),r=t.searchParams.get("code"),a=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(_e(!1,`Google denied access: ${n}`));if(!r||!a)return e.html(_e(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(a)).sessionId;if(!o)return e.html(_e(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(_e(!1,"Session expired. Please log in again and retry."));const l=i.user_id,d=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,m=await fr(e.env.DB,l,d,r,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(_e(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(_e(!1,`OAuth failed: ${s.message}`))}});J.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(nr())));J.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(nr())));function _e(e,t,r){return`<!DOCTYPE html>
