var nr=Object.defineProperty;var Ut=e=>{throw TypeError(e)};var sr=(e,t,a)=>t in e?nr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var I=(e,t,a)=>sr(e,typeof t!="symbol"?t+"":t,a),_t=(e,t,a)=>t.has(e)||Ut("Cannot "+a);var b=(e,t,a)=>(_t(e,t,"read from private field"),a?a.call(e):t.get(e)),N=(e,t,a)=>t.has(e)?Ut("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(_t(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),B=(e,t,a)=>(_t(e,t,"access private method"),a);var Ht=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return b(e,t,r)}});var Gt=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let c,l=!1,d;if(e[i]?(d=e[i][0][0],r.req.routeIndex=i):d=i===e.length&&n||void 0,d)try{c=await d(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,c=await t(m,r),l=!0;else throw m}else r.finalized===!1&&a&&(c=await a(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},or=Symbol(),ir=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ma?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?lr(e,{all:a,dot:r}):{}};async function lr(e,t){const a=await e.formData();return a?cr(a,t):{}}function cr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?dr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(ur(a,r,n),delete a[r])}),a}var dr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ur=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},la=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},pr=e=>{const{groups:t,path:a}=mr(e),r=la(a);return hr(r,t)},mr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},hr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},it={},gr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return it[r]||(a[2]?it[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:it[r]=[e,a[1],!0]),it[r]}return null},Lt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},fr=e=>Lt(e,decodeURI),ca=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),c=t.slice(a,i);return fr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return t.slice(a,r)},yr=e=>{const t=ca(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Le=(e,t,...a)=>(a.length&&(t=Le(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),da=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},xt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Lt(e,pa):e):e,ua=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const c=o+t.length+2,l=e.indexOf("&",c);return xt(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let c=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(c=xt(c)),s=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),r&&(l=xt(l))),a?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(l)):n[c]??(n[c]=l)}return t?n[t]:n},vr=ua,br=(e,t)=>ua(e,t,!0),pa=decodeURIComponent,zt=e=>Lt(e,pa),je,J,pe,ha,ga,Ot,he,aa,ma=(aa=class{constructor(e,t="/",a=[[]]){N(this,pe);I(this,"raw");N(this,je);N(this,J);I(this,"routeIndex",0);I(this,"path");I(this,"bodyCache",{});N(this,he,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,J,a),D(this,je,{})}param(e){return e?B(this,pe,ha).call(this,e):B(this,pe,ga).call(this)}query(e){return vr(this.url,e)}queries(e){return br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ir(this,e))}json(){return b(this,he).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,he).call(this,"text")}arrayBuffer(){return b(this,he).call(this,"arrayBuffer")}blob(){return b(this,he).call(this,"blob")}formData(){return b(this,he).call(this,"formData")}addValidatedData(e,t){b(this,je)[e]=t}valid(e){return b(this,je)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[or](){return b(this,J)}get matchedRoutes(){return b(this,J)[0].map(([[,e]])=>e)}get routePath(){return b(this,J)[0].map(([[,e]])=>e)[this.routeIndex].path}},je=new WeakMap,J=new WeakMap,pe=new WeakSet,ha=function(e){const t=b(this,J)[0][this.routeIndex][1][e],a=B(this,pe,Ot).call(this,t);return a&&/\%/.test(a)?zt(a):a},ga=function(){const e={},t=Object.keys(b(this,J)[0][this.routeIndex][1]);for(const a of t){const r=B(this,pe,Ot).call(this,b(this,J)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?zt(r):r)}return e},Ot=function(e){return b(this,J)[1]?b(this,J)[1][e]:e},he=new WeakMap,aa),wr={Stringify:1},fa=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(c=>fa(c,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},_r="text/plain; charset=UTF-8",Et=(e,t)=>({"Content-Type":e,...t}),Qe,et,le,Pe,ce,Y,tt,Ue,He,Te,at,rt,ge,$e,ra,xr=(ra=class{constructor(e,t){N(this,ge);N(this,Qe);N(this,et);I(this,"env",{});N(this,le);I(this,"finalized",!1);I(this,"error");N(this,Pe);N(this,ce);N(this,Y);N(this,tt);N(this,Ue);N(this,He);N(this,Te);N(this,at);N(this,rt);I(this,"render",(...e)=>(b(this,Ue)??D(this,Ue,t=>this.html(t)),b(this,Ue).call(this,...e)));I(this,"setLayout",e=>D(this,tt,e));I(this,"getLayout",()=>b(this,tt));I(this,"setRenderer",e=>{D(this,Ue,e)});I(this,"header",(e,t,a)=>{this.finalized&&D(this,Y,new Response(b(this,Y).body,b(this,Y)));const r=b(this,Y)?b(this,Y).headers:b(this,Te)??D(this,Te,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});I(this,"status",e=>{D(this,Pe,e)});I(this,"set",(e,t)=>{b(this,le)??D(this,le,new Map),b(this,le).set(e,t)});I(this,"get",e=>b(this,le)?b(this,le).get(e):void 0);I(this,"newResponse",(...e)=>B(this,ge,$e).call(this,...e));I(this,"body",(e,t,a)=>B(this,ge,$e).call(this,e,t,a));I(this,"text",(e,t,a)=>!b(this,Te)&&!b(this,Pe)&&!t&&!a&&!this.finalized?new Response(e):B(this,ge,$e).call(this,e,t,Et(_r,a)));I(this,"json",(e,t,a)=>B(this,ge,$e).call(this,JSON.stringify(e),t,Et("application/json",a)));I(this,"html",(e,t,a)=>{const r=n=>B(this,ge,$e).call(this,n,t,Et("text/html; charset=UTF-8",a));return typeof e=="object"?fa(e,wr.Stringify,!1,{}).then(r):r(e)});I(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});I(this,"notFound",()=>(b(this,He)??D(this,He,()=>new Response),b(this,He).call(this,this)));D(this,Qe,e),t&&(D(this,ce,t.executionCtx),this.env=t.env,D(this,He,t.notFoundHandler),D(this,rt,t.path),D(this,at,t.matchResult))}get req(){return b(this,et)??D(this,et,new ma(b(this,Qe),b(this,rt),b(this,at))),b(this,et)}get event(){if(b(this,ce)&&"respondWith"in b(this,ce))return b(this,ce);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ce))return b(this,ce);throw Error("This context has no ExecutionContext")}get res(){return b(this,Y)||D(this,Y,new Response(null,{headers:b(this,Te)??D(this,Te,new Headers)}))}set res(e){if(b(this,Y)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,Y).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,Y).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,Y,e),this.finalized=!0}get var(){return b(this,le)?Object.fromEntries(b(this,le)):{}}},Qe=new WeakMap,et=new WeakMap,le=new WeakMap,Pe=new WeakMap,ce=new WeakMap,Y=new WeakMap,tt=new WeakMap,Ue=new WeakMap,He=new WeakMap,Te=new WeakMap,at=new WeakMap,rt=new WeakMap,ge=new WeakSet,$e=function(e,t,a){const r=b(this,Y)?new Headers(b(this,Y).headers):b(this,Te)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Pe);return new Response(e,{status:n,headers:r})},ra),z="ALL",Er="all",Tr=["get","post","put","delete","options","patch"],ya="Can not add a route since the matcher is already built.",va=class extends Error{},kr="__COMPOSED_HANDLER",Sr=e=>e.text("404 Not Found",404),Ft=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Z,F,ba,Q,xe,dt,ut,Ge,Ir=(Ge=class{constructor(t={}){N(this,F);I(this,"get");I(this,"post");I(this,"put");I(this,"delete");I(this,"options");I(this,"patch");I(this,"all");I(this,"on");I(this,"use");I(this,"router");I(this,"getPath");I(this,"_basePath","/");N(this,Z,"/");I(this,"routes",[]);N(this,Q,Sr);I(this,"errorHandler",Ft);I(this,"onError",t=>(this.errorHandler=t,this));I(this,"notFound",t=>(D(this,Q,t),this));I(this,"fetch",(t,...a)=>B(this,F,ut).call(this,t,a[1],a[0],t.method));I(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Le("/",t)}`,a),r,n)));I(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(B(this,F,ut).call(this,t.request,t,void 0,t.request.method))})});[...Tr,Er].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?D(this,Z,o):B(this,F,xe).call(this,s,b(this,Z),o),i.forEach(c=>{B(this,F,xe).call(this,s,b(this,Z),c)}),this)}),this.on=(s,o,...i)=>{for(const c of[o].flat()){D(this,Z,c);for(const l of[s].flat())i.map(d=>{B(this,F,xe).call(this,l.toUpperCase(),b(this,Z),d)})}return this},this.use=(s,...o)=>(typeof s=="string"?D(this,Z,s):(D(this,Z,"*"),o.unshift(s)),o.forEach(i=>{B(this,F,xe).call(this,z,b(this,Z),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ca:yr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Ft?s=n.handler:(s=async(i,c)=>(await Gt([],a.errorHandler)(i,()=>n.handler(i,c))).res,s[kr]=n.handler),B(o=r,F,xe).call(o,n.method,n.path,s)}),this}basePath(t){const a=B(this,F,ba).call(this);return a._basePath=Le(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=c=>c:n=r.replaceRequest));const o=s?c=>{const l=s(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};n||(n=(()=>{const c=Le(this._basePath,t),l=c==="/"?0:c.length;return d=>{const m=new URL(d.url);return m.pathname=m.pathname.slice(l)||"/",new Request(m,d)}})());const i=async(c,l)=>{const d=await a(n(c.req.raw),...o(c));if(d)return d;await l()};return B(this,F,xe).call(this,z,Le(t,"*"),i),this}},Z=new WeakMap,F=new WeakSet,ba=function(){const t=new Ge({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,Q,b(this,Q)),t.routes=this.routes,t},Q=new WeakMap,xe=function(t,a,r){t=t.toUpperCase(),a=Le(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},dt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ut=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await B(this,F,ut).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new xr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,Q)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await b(this,Q).call(this,i)})}catch(d){return B(this,F,dt).call(this,d,i)}return l instanceof Promise?l.then(d=>d||(i.finalized?i.res:b(this,Q).call(this,i))).catch(d=>B(this,F,dt).call(this,d,i)):l??b(this,Q).call(this,i)}const c=Gt(o[0],this.errorHandler,b(this,Q));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return B(this,F,dt).call(this,l,i)}})()},Ge),wa=[];function Or(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[z],i=o[2][s];if(i)return i;const c=s.match(o[0]);if(!c)return[[],wa];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=r,r(e,t)}var mt="[^/]+",Ve=".*",Xe="(?:|/.*)",Me=Symbol(),Cr=new Set(".\\+*[^]$()");function Rr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ve||e===Xe?1:t===Ve||t===Xe?-1:e===mt?1:t===mt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ke,Se,ee,Ce,Dr=(Ce=class{constructor(){N(this,ke);N(this,Se);N(this,ee,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,ke)!==void 0)throw Me;if(s)return;D(this,ke,a);return}const[o,...i]=t,c=o==="*"?i.length===0?["","",Ve]:["","",mt]:o==="/*"?["","",Xe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const d=c[1];let m=c[2]||mt;if(d&&c[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Me;if(l=b(this,ee)[m],!l){if(Object.keys(b(this,ee)).some(f=>f!==Ve&&f!==Xe))throw Me;if(s)return;l=b(this,ee)[m]=new Ce,d!==""&&D(l,Se,n.varIndex++)}!s&&d!==""&&r.push([d,b(l,Se)])}else if(l=b(this,ee)[o],!l){if(Object.keys(b(this,ee)).some(d=>d.length>1&&d!==Ve&&d!==Xe))throw Me;if(s)return;l=b(this,ee)[o]=new Ce}l.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,ee)).sort(Rr).map(r=>{const n=b(this,ee)[r];return(typeof b(n,Se)=="number"?`(${r})@${b(n,Se)}`:Cr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,ke)=="number"&&a.unshift(`#${b(this,ke)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},ke=new WeakMap,Se=new WeakMap,ee=new WeakMap,Ce),gt,nt,na,Ar=(na=class{constructor(){N(this,gt,{varIndex:0});N(this,nt,new Dr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return n[o]=[l,c],o++,i=!0,l}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let c=s.length-1;c>=0;c--)if(s[c].indexOf(i)!==-1){s[c]=s[c].replace(i,n[o][1]);break}}return b(this,nt).insert(s,t,r,b(this,gt),a),r}buildRegExp(){let e=b(this,nt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},gt=new WeakMap,nt=new WeakMap,na),Nr=[/^$/,[],Object.create(null)],pt=Object.create(null);function _a(e){return pt[e]??(pt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Lr(){pt=Object.create(null)}function $r(e){var l;const t=new Ar,a=[];if(e.length===0)return Nr;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,m],[f,v])=>d?1:f?-1:m.length-v.length),n=Object.create(null);for(let d=0,m=-1,f=r.length;d<f;d++){const[v,y,T]=r[d];v?n[y]=[T.map(([x])=>[x,Object.create(null)]),wa]:m++;let w;try{w=t.insert(y,m,v)}catch(x){throw x===Me?new va(y):x}v||(a[m]=T.map(([x,u])=>{const h=Object.create(null);for(u-=1;u>=0;u--){const[p,g]=w[u];h[p]=g}return[x,h]}))}const[s,o,i]=t.buildRegExp();for(let d=0,m=a.length;d<m;d++)for(let f=0,v=a[d].length;f<v;f++){const y=(l=a[d][f])==null?void 0:l[1];if(!y)continue;const T=Object.keys(y);for(let w=0,x=T.length;w<x;w++)y[T[w]]=i[y[T[w]]]}const c=[];for(const d in o)c[d]=a[o[d]];return[s,c,n]}function Ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(_a(a).test(t))return[...e[a]]}}var fe,ye,ft,xa,sa,Mr=(sa=class{constructor(){N(this,ft);I(this,"name","RegExpRouter");N(this,fe);N(this,ye);I(this,"match",Or);D(this,fe,{[z]:Object.create(null)}),D(this,ye,{[z]:Object.create(null)})}add(e,t,a){var i;const r=b(this,fe),n=b(this,ye);if(!r||!n)throw new Error(ya);r[e]||[r,n].forEach(c=>{c[e]=Object.create(null),Object.keys(c[z]).forEach(l=>{c[e][l]=[...c[z][l]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=_a(t);e===z?Object.keys(r).forEach(l=>{var d;(d=r[l])[t]||(d[t]=Ae(r[l],t)||Ae(r[z],t)||[])}):(i=r[e])[t]||(i[t]=Ae(r[e],t)||Ae(r[z],t)||[]),Object.keys(r).forEach(l=>{(e===z||e===l)&&Object.keys(r[l]).forEach(d=>{c.test(d)&&r[l][d].push([a,s])})}),Object.keys(n).forEach(l=>{(e===z||e===l)&&Object.keys(n[l]).forEach(d=>c.test(d)&&n[l][d].push([a,s]))});return}const o=da(t)||[t];for(let c=0,l=o.length;c<l;c++){const d=o[c];Object.keys(n).forEach(m=>{var f;(e===z||e===m)&&((f=n[m])[d]||(f[d]=[...Ae(r[m],d)||Ae(r[z],d)||[]]),n[m][d].push([a,s-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,ye)).concat(Object.keys(b(this,fe))).forEach(t=>{e[t]||(e[t]=B(this,ft,xa).call(this,t))}),D(this,fe,D(this,ye,void 0)),Lr(),e}},fe=new WeakMap,ye=new WeakMap,ft=new WeakSet,xa=function(e){const t=[];let a=e===z;return[b(this,fe),b(this,ye)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==z&&t.push(...Object.keys(r[z]).map(s=>[s,r[z][s]]))}),a?$r(t):null},sa),ve,de,oa,Br=(oa=class{constructor(e){I(this,"name","SmartRouter");N(this,ve,[]);N(this,de,[]);D(this,ve,e.routers)}add(e,t,a){if(!b(this,de))throw new Error(ya);b(this,de).push([e,t,a])}match(e,t){if(!b(this,de))throw new Error("Fatal error");const a=b(this,ve),r=b(this,de),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let c=0,l=r.length;c<l;c++)i.add(...r[c]);o=i.match(e,t)}catch(c){if(c instanceof va)continue;throw c}this.match=i.match.bind(i),D(this,ve,[i]),D(this,de,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,de)||b(this,ve).length!==1)throw new Error("No active router has been determined yet.");return b(this,ve)[0]}},ve=new WeakMap,de=new WeakMap,oa),qe=Object.create(null),be,K,Ie,ze,q,ue,Ee,Fe,jr=(Fe=class{constructor(t,a,r){N(this,ue);N(this,be);N(this,K);N(this,Ie);N(this,ze,0);N(this,q,qe);if(D(this,K,r||Object.create(null)),D(this,be,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,be,[n])}D(this,Ie,[])}insert(t,a,r){D(this,ze,++Ht(this,ze)._);let n=this;const s=pr(a),o=[];for(let i=0,c=s.length;i<c;i++){const l=s[i],d=s[i+1],m=gr(l,d),f=Array.isArray(m)?m[0]:l;if(f in b(n,K)){n=b(n,K)[f],m&&o.push(m[1]);continue}b(n,K)[f]=new Fe,m&&(b(n,Ie).push(m),o.push(m[1])),n=b(n,K)[f]}return b(n,be).push({[t]:{handler:r,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:b(this,ze)}}),n}search(t,a){var c;const r=[];D(this,q,qe);let s=[this];const o=la(a),i=[];for(let l=0,d=o.length;l<d;l++){const m=o[l],f=l===d-1,v=[];for(let y=0,T=s.length;y<T;y++){const w=s[y],x=b(w,K)[m];x&&(D(x,q,b(w,q)),f?(b(x,K)["*"]&&r.push(...B(this,ue,Ee).call(this,b(x,K)["*"],t,b(w,q))),r.push(...B(this,ue,Ee).call(this,x,t,b(w,q)))):v.push(x));for(let u=0,h=b(w,Ie).length;u<h;u++){const p=b(w,Ie)[u],g=b(w,q)===qe?{}:{...b(w,q)};if(p==="*"){const O=b(w,K)["*"];O&&(r.push(...B(this,ue,Ee).call(this,O,t,b(w,q))),D(O,q,g),v.push(O));continue}const[_,k,E]=p;if(!m&&!(E instanceof RegExp))continue;const S=b(w,K)[_],L=o.slice(l).join("/");if(E instanceof RegExp){const O=E.exec(L);if(O){if(g[k]=O[0],r.push(...B(this,ue,Ee).call(this,S,t,b(w,q),g)),Object.keys(b(S,K)).length){D(S,q,g);const C=((c=O[0].match(/\//))==null?void 0:c.length)??0;(i[C]||(i[C]=[])).push(S)}continue}}(E===!0||E.test(m))&&(g[k]=m,f?(r.push(...B(this,ue,Ee).call(this,S,t,g,b(w,q))),b(S,K)["*"]&&r.push(...B(this,ue,Ee).call(this,b(S,K)["*"],t,g,b(w,q)))):(D(S,q,g),v.push(S)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((l,d)=>l.score-d.score),[r.map(({handler:l,params:d})=>[l,d])]}},be=new WeakMap,K=new WeakMap,Ie=new WeakMap,ze=new WeakMap,q=new WeakMap,ue=new WeakSet,Ee=function(t,a,r,n){const s=[];for(let o=0,i=b(t,be).length;o<i;o++){const c=b(t,be)[o],l=c[a]||c[z],d={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),r!==qe||n&&n!==qe))for(let m=0,f=l.possibleKeys.length;m<f;m++){const v=l.possibleKeys[m],y=d[l.score];l.params[v]=n!=null&&n[v]&&!y?n[v]:r[v]??(n==null?void 0:n[v]),d[l.score]=!0}}return s},Fe),Oe,ia,Pr=(ia=class{constructor(){I(this,"name","TrieRouter");N(this,Oe);D(this,Oe,new jr)}add(e,t,a){const r=da(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Oe).insert(e,r[n],a);return}b(this,Oe).insert(e,t,a)}match(e,t){return b(this,Oe).search(e,t)}},Oe=new WeakMap,ia),we=class extends Ir{constructor(e={}){super(e),this.router=e.router??new Br({routers:[new Mr,new Pr]})}},Ur=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var d;function c(m,f){o.res.headers.set(m,f)}const l=await r(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),a.credentials&&c("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&c("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&c("Vary","Origin"),a.maxAge!=null&&c("Access-Control-Max-Age",a.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&c("Access-Control-Allow-Methods",m.join(","));let f=a.allowHeaders;if(!(f!=null&&f.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(f=v.split(/\s*,\s*/))}return f!=null&&f.length&&(c("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Ea(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:l}=await Promise.resolve().then(()=>Sa),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const f=await l(m.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${f}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:c})})}catch(o){console.error("Failed to send provider alert:",o)}}function Wt(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Ia{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){I(this,"name");I(this,"apiKey");I(this,"model");I(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var d,m,f,v;const r=t.find(y=>y.role==="system"),n=t.filter(y=>y.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(y=>({role:y.role,content:y.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(y=>({name:y.name,description:y.description,input_schema:y.parameters})));const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const y=await o.text();throw new Error(this.name+" API error "+o.status+": "+y)}const i=await o.json(),c=((d=i.content)==null?void 0:d.filter(y=>y.type==="text"))||[],l=((m=i.content)==null?void 0:m.filter(y=>y.type==="tool_use"))||[];return{content:c.map(y=>y.text).join(`
`),toolCalls:l.map(y=>({id:y.id,name:y.name,arguments:y.input})),usage:{promptTokens:((f=i.usage)==null?void 0:f.input_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(l=>l.role==="system"),n=t.filter(l=>l.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(l=>({role:l.role,content:l.content}))};r&&(s.system=r.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const l=await o.text();throw new Error(this.name+" stream error "+o.status+": "+l)}const i=o.body.getReader(),c=new TextDecoder;return new ReadableStream({async pull(l){var y;const{done:d,value:m}=await i.read();if(d){l.close();return}const v=c.decode(m,{stream:!0}).split(`
`);for(const T of v)if(T.startsWith("data: ")){const w=T.slice(6);if(w==="[DONE]")continue;try{const x=JSON.parse(w);x.type==="content_block_delta"&&((y=x.delta)!=null&&y.text)&&l.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:x.delta.text})+`

`))}catch{}}}})}}function Gr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,o]of Object.entries(r))o&&typeof o=="object"?n[s]=Ct(o):n[s]=o;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Ct(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=Ct(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Ct(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Oa{constructor(t,a,r,n){I(this,"name");I(this,"apiKey");I(this,"model");I(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var c,l,d,m,f,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(y=>({role:y.role,content:y.content}))},n=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&n)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(y=>({type:"function",function:{name:y.name,description:y.description,parameters:Gr(y.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const y=await s.text();throw new Error(this.name+" API error "+s.status+": "+y)}const o=await s.json(),i=(c=o.choices)==null?void 0:c[0];return{content:((l=i==null?void 0:i.message)==null?void 0:l.content)||"",toolCalls:(m=(d=i==null?void 0:i.message)==null?void 0:d.tool_calls)==null?void 0:m.map(y=>({id:y.id,name:y.function.name,arguments:typeof y.function.arguments=="string"?JSON.parse(y.function.arguments||"{}"):y.function.arguments||{}})),usage:{promptTokens:((f=o.usage)==null?void 0:f.prompt_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const i=await n.text();throw new Error(this.name+" stream error "+n.status+": "+i)}const s=n.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var f,v,y;const{done:c,value:l}=await s.read();if(c){i.close();return}const m=o.decode(l,{stream:!0}).split(`
`);for(const T of m)if(T.startsWith("data: ")){const w=T.slice(6);if(w==="[DONE]")continue;try{const u=(y=(v=(f=JSON.parse(w).choices)==null?void 0:f[0])==null?void 0:v.delta)==null?void 0:y.content;u&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:u})+`

`))}catch{}}}})}}function Rt(e,t,a,r){const n=Ze[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new Ia(t,s,n.apiBase,a):new Oa(t,s,n.apiBase,a)}class Ca{constructor(){I(this,"errorLog",new Map);I(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const zr=["llm_slot_1","llm_slot_2","llm_slot_3"],Fr=["anthropic","openai"];async function st(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Sa),n=new Ca,s=[];for(const m of zr){const f=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(f)try{const v=await r(f.encrypted_value,a),y=JSON.parse(v);if(y.provider&&y.apiKey&&Ze[y.provider]){const w=y.provider,x=Rt(y.provider,y.apiKey,w,y.model);s.push({name:w,provider:x})}}catch(v){console.error(`Failed to load ${m}:`,v)}}const o=new Set(s.map(m=>m.name));for(const m of Fr){if(o.has(m))continue;const f=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(f)try{const v=await r(f.encrypted_value,a);if(Ze[m]){const T=Rt(m,v,m);s.push({name:m,provider:T})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(m=>m.name),c=await n.pickProvider(i);if(!c)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const l=s.find(m=>m.name===c);return{provider:Wr(l.provider,s,n,e,t),rotation:n}}function Wr(e,t,a,r,n){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(c){const l=c.message||"";throw s(l)&&!l.includes("TOOLS_UNSUPPORTED")&&Tt(r,n,"all_providers_down",e.name,null,l),c}},async streamChat(o,i){return await e.streamChat(o,i)}}:{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(c){const l=c.message||"";if(!s(l))throw c;const d=l.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${d?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,l,d?1:1440);const m=t.filter(f=>f.name!==e.name);for(const f of m)try{const v=await f.provider.chat(o,i);return this.name=f.name,d||Tt(r,n,"provider_switched",e.name,f.name,l),v}catch(v){const y=v.message||"";if(s(y)){await a.recordError(f.name,y,1440);continue}throw v}throw Tt(r,n,"all_providers_down",e.name,null,l),new Error(`All LLM providers failed. Primary (${e.name}): ${l.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,i){return await e.streamChat(o,i)}}}const Dt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Ia,OpenAICompatibleProvider:Oa,ProviderRotation:Ca,createProviderFromConfig:Rt,createRotatingProvider:st,logError:A},Symbol.toStringTag,{value:"Module"})),kt=20,qr=2e3,Kr=2e3,Ra=4;function Yr(e){return Math.ceil(e.length/Ra)}function qt(e,t){const a=t*Ra;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class V{constructor(t){this.db=t}async store(t,a,r,n,s=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>kt){const r=((a==null?void 0:a.cnt)||0)-kt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
         ...
         )`).bind(t,t,r).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,kt).all()).results||[]}async getAll(t,a,r=50){return a?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a,r).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,r).all()).results||[]}async search(t,a,r=10){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${a}%`,`%${a}%`,r).all()).results||[]}async update(t,a,r){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t,a).run()}async promote(t,a){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run(),await this.enforceWorkingMemoryCap(a)}async demote(t,a){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run()}async remove(t,a){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,a).run()}async buildContext(t){const a=await this.getWorkingMemory(t);if(a.length===0)return"";const r={};for(const s of a)r[s.type]||(r[s.type]=[]),r[s.type].push(s);let n=`
## Working Memory (Active Context)
`;for(const[s,o]of Object.entries(r)){n+=`
### ${s.charAt(0).toUpperCase()+s.slice(1)}s
`;for(const i of o)n+=`- **${i.title}**: ${i.content}
`}return qt(n,qr)}static truncatePersonality(t){return qt(t,Kr)}async getRecentConversations(t,a=20,r){return r?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r,a).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a).all()).results||[]).reverse()}async storeMessage(t,a,r,n,s="{}",o){const i=Yr(n);o?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,i,o).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,i).run()}async compactHistory(t,a=30){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((r==null?void 0:r.cnt)||0)<=a*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,a).run()}}const Jr="https://accounts.google.com/o/oauth2/v2/auth",Da="https://oauth2.googleapis.com/token",Vr="https://www.googleapis.com/oauth2/v2/userinfo",Xr=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let ne=null;async function At(e,t,a){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!r)return null;try{const n=await U(r.encrypted_value,a);return JSON.parse(n)}catch{return null}}async function Zr(e,t,a,r){const n=await Mt(JSON.stringify(r),a);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,n).run()}function Aa(e,t,a){const r=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Xr,access_type:"offline",prompt:"consent",state:a,include_granted_scopes:"true"});return`${Jr}?${r}`}async function Na(e,t,a,r){const n=await fetch(Da,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:a,redirect_uri:r,grant_type:"authorization_code"})}),s=await n.text();if(!n.ok)throw new Error(`Token exchange failed (${n.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function Qr(e,t,a){const r=await fetch(Da,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:a,grant_type:"refresh_token"})}),n=await r.text();if(!r.ok)throw r.status===400||r.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${r.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function La(e){const t=await fetch(Vr,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function We(e,t,a,r,n){if(!r||!n)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(ne&&ne.userId===t&&ne.expiresAt>Date.now()/1e3+60){const i=await At(e,t,a);return{token:ne.token,email:(i==null?void 0:i.email)||"unknown"}}const s=await At(e,t,a);if(!s)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const o=await Qr(s.refresh_token,r,n);return ne={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{token:o.access_token,email:s.email}}async function Bt(e,t,a){try{const r=await At(e,t,a);return r?{connected:!0,email:r.email,connectedAt:r.connected_at}:{connected:!1}}catch{return{connected:!1}}}function $a(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function Ma(e,t,a,r,n,s,o){const i=await Na(r,s,o,n);if(!i.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const c=await La(i.access_token),l={refresh_token:i.refresh_token,email:c.email,name:c.name,connected_at:new Date().toISOString()};return await Zr(e,t,a,l),ne={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{email:c.email,name:c.name}}async function Ba(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(ne==null?void 0:ne.userId)===t&&(ne=null)}const Ke="https://sheets.googleapis.com/v4/spreadsheets";class ja{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await We(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,a){const r=await this.authHeaders(),n=encodeURIComponent(a),s=await fetch(`${Ke}/${t}/values/${n}`,{headers:r});if(!s.ok){const i=await s.text();throw new Error(`Sheets read failed (${s.status}): ${i}`)}return(await s.json()).values||[]}async writeRange(t,a,r){const n=await this.authHeaders(),s=encodeURIComponent(a),o=await fetch(`${Ke}/${t}/values/${s}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:n,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!o.ok){const c=await o.text();throw new Error(`Sheets write failed (${o.status}): ${c}`)}return{updatedCells:(await o.json()).updatedCells||0}}async appendRows(t,a,r){var c;const n=await this.authHeaders(),s=encodeURIComponent(a),o=await fetch(`${Ke}/${t}/values/${s}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:n,body:JSON.stringify({range:a,majorDimension:"ROWS",values:r})});if(!o.ok){const l=await o.text();throw new Error(`Sheets append failed (${o.status}): ${l}`)}return{updatedCells:((c=(await o.json()).updates)==null?void 0:c.updatedCells)||r.length}}async createSpreadsheet(t,a){const r=await this.authHeaders(),n={properties:{title:t},sheets:a&&a.length>0?a.map(i=>({properties:{title:i}})):[{properties:{title:"Sheet1"}}]},s=await fetch(Ke,{method:"POST",headers:r,body:JSON.stringify(n)});if(!s.ok){const i=await s.text();throw new Error(`Sheets create failed (${s.status}): ${i}`)}const o=await s.json();return{spreadsheetId:o.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${o.spreadsheetId}/edit`}}async getMetadata(t){const a=await this.authHeaders(),r=await fetch(`${Ke}/${t}?fields=properties.title,sheets.properties.title`,{headers:a});if(!r.ok){const s=await r.text();throw new Error(`Sheets metadata failed (${r.status}): ${s}`)}const n=await r.json();return{title:n.properties.title,sheets:n.sheets.map(s=>s.properties.title)}}}const Ye="https://www.googleapis.com/calendar/v3";class jt{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await We(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",a={}){const r=await this.authHeaders(),n=new URLSearchParams;a.timeMin&&n.set("timeMin",a.timeMin),a.timeMax&&n.set("timeMax",a.timeMax),n.set("maxResults",String(a.maxResults||20)),n.set("singleEvents","true"),n.set("orderBy","startTime"),a.query&&n.set("q",a.query);const s=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events?${n}`,{headers:r});if(!s.ok){const i=await s.text();throw new Error(`Calendar list failed (${s.status}): ${i}`)}return(await s.json()).items||[]}async createEvent(t="primary",a){var i;const r=await this.authHeaders(),n=a.timeZone||"Asia/Kolkata",s={summary:a.summary,description:a.description||"",location:a.location||"",start:{dateTime:a.startDateTime,timeZone:n},end:{dateTime:a.endDateTime,timeZone:n}};(i=a.attendees)!=null&&i.length&&(s.attendees=a.attendees.map(c=>({email:c})));const o=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:r,body:JSON.stringify(s)});if(!o.ok){const c=await o.text();throw new Error(`Calendar create failed (${o.status}): ${c}`)}return await o.json()}async updateEvent(t="primary",a,r){const n=await this.authHeaders(),s=r.timeZone||"Asia/Kolkata",o={};r.summary&&(o.summary=r.summary),r.description&&(o.description=r.description),r.location&&(o.location=r.location),r.startDateTime&&(o.start={dateTime:r.startDateTime,timeZone:s}),r.endDateTime&&(o.end={dateTime:r.endDateTime,timeZone:s});const i=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"PATCH",headers:n,body:JSON.stringify(o)});if(!i.ok){const c=await i.text();throw new Error(`Calendar update failed (${i.status}): ${c}`)}return await i.json()}async deleteEvent(t="primary",a){const r=await this.authHeaders(),n=await fetch(`${Ye}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"DELETE",headers:r});if(!n.ok&&n.status!==410){const s=await n.text();throw new Error(`Calendar delete failed (${n.status}): ${s}`)}}async listCalendars(){const t=await this.authHeaders(),a=await fetch(`${Ye}/users/me/calendarList`,{headers:t});if(!a.ok){const n=await a.text();throw new Error(`Calendar list calendars failed (${a.status}): ${n}`)}return((await a.json()).items||[]).map(n=>({id:n.id,summary:n.summary,primary:n.primary||!1}))}}const lt="https://docs.googleapis.com/v1/documents",en="https://www.googleapis.com/drive/v3/files";class Pa{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await We(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const a=await this.authHeaders(),r=await fetch(lt,{method:"POST",headers:a,body:JSON.stringify({title:t})});if(!r.ok){const s=await r.text();throw new Error(`Docs create failed (${r.status}): ${s}`)}const n=await r.json();return{documentId:n.documentId,url:`https://docs.google.com/document/d/${n.documentId}/edit`}}async readDocument(t){var o,i;const a=await this.authHeaders(),r=await fetch(`${lt}/${t}`,{headers:a});if(!r.ok){const c=await r.text();throw new Error(`Docs read failed (${r.status}): ${c}`)}const n=await r.json();let s="";for(const c of((o=n.body)==null?void 0:o.content)||[])if(c.paragraph)for(const l of c.paragraph.elements)(i=l.textRun)!=null&&i.content&&(s+=l.textRun.content);return{title:n.title,content:s.trim()}}async appendText(t,a){const r=await this.authHeaders(),n=await fetch(`${lt}/${t}`,{headers:r});if(!n.ok){const c=await n.text();throw new Error(`Docs read for append failed (${n.status}): ${c}`)}const s=await n.json(),o=s.body.content[s.body.content.length-1].endIndex-1,i=await fetch(`${lt}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{insertText:{location:{index:o},text:a}}]})});if(!i.ok){const c=await i.text();throw new Error(`Docs append failed (${i.status}): ${c}`)}}async shareDocument(t,a,r="writer"){const n=await this.authHeaders(),s=await fetch(`${en}/${t}/permissions`,{method:"POST",headers:n,body:JSON.stringify({type:"user",role:r,emailAddress:a})});if(!s.ok){const o=await s.text();throw new Error(`Share failed (${s.status}): ${o}`)}}}class re{constructor(t,a,r,n,s){I(this,"sheets");I(this,"calendar");I(this,"docs");I(this,"db");I(this,"userId");I(this,"pinHash");this.db=t,this.userId=a,this.pinHash=r,this.sheets=new ja(t,a,r,n,s),this.calendar=new jt(t,a,r,n,s),this.docs=new Pa(t,a,r,n,s)}async isConnected(){return Bt(this.db,this.userId,this.pinHash)}}const ct=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:jt,GoogleDocs:Pa,GoogleServices:re,GoogleSheets:ja,completeOAuthFlow:Ma,disconnectGoogle:Ba,exchangeCodeForTokens:Na,fetchUserInfo:La,generateAuthUrl:Aa,getGoogleAuth:We,isGoogleConnected:Bt,isOAuthClientConfigured:$a},Symbol.toStringTag,{value:"Module"}));async function Ua(e,t,a={}){const r={textQuery:t,languageCode:"en",pageSize:8};if(a.type&&(r.includedType=a.type),a.location){const c=a.location.split(",").map(Number);c.length===2&&!isNaN(c[0])&&!isNaN(c[1])&&(r.locationBias={circle:{center:{latitude:c[0],longitude:c[1]},radius:a.radius||5e3}})}const n=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),s=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":n},body:JSON.stringify(r)});if(!s.ok){const c=await s.text();return{results:[],error:`Places API error (${s.status}): ${c.substring(0,200)}`}}const o=await s.json();return!o.places||o.places.length===0?{results:[]}:{results:o.places.map(c=>{var l,d,m;return{name:((l=c.displayName)==null?void 0:l.text)||"",address:c.formattedAddress||"",rating:c.rating,userRatingsTotal:c.userRatingCount,priceLevel:c.priceLevel,openNow:(d=c.currentOpeningHours)==null?void 0:d.openNow,types:(m=c.types)==null?void 0:m.slice(0,5),placeId:c.id||"",location:c.location?{lat:c.location.latitude,lng:c.location.longitude}:void 0,googleMapsUri:c.googleMapsUri}})}}async function Ha(e,t){var s,o,i;const a=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),r=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":a}});if(!r.ok){const c=await r.text();return{error:`Place Details API error (${r.status}): ${c.substring(0,200)}`}}const n=await r.json();return{details:{name:((s=n.displayName)==null?void 0:s.text)||"",address:n.formattedAddress||"",phone:n.internationalPhoneNumber,website:n.websiteUri,rating:n.rating,reviews:(o=n.reviews)==null?void 0:o.slice(0,3).map(c=>{var l,d,m;return{author:((l=c.authorAttribution)==null?void 0:l.displayName)||"Anonymous",rating:c.rating||0,text:((m=(d=c.text)==null?void 0:d.text)==null?void 0:m.substring(0,200))||"",time:c.relativePublishTimeDescription||""}}),openingHours:(i=n.currentOpeningHours)==null?void 0:i.weekdayDescriptions,location:n.location?{lat:n.location.latitude,lng:n.location.longitude}:void 0,googleMapsUri:n.googleMapsUri}}}async function Ga(e,t,a,r={}){var l;const n=new URLSearchParams({origin:t,destination:a,key:e,mode:r.mode||"driving"});(r.mode==="driving"||!r.mode)&&n.set("departure_time","now");const s=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${n}`);if(!s.ok)return{error:`Directions API error: ${s.status}`};const o=await s.json();if(o.status!=="OK")return{error:`Directions: ${o.status} — ${o.error_message||""}`};const i=o.routes[0],c=i.legs[0];return{route:{summary:i.summary,distance:c.distance.text,duration:c.duration.text,durationInTraffic:(l=c.duration_in_traffic)==null?void 0:l.text,steps:c.steps.slice(0,10).map(d=>{var m,f,v;return{instruction:((m=d.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((f=d.distance)==null?void 0:f.text)||"",duration:((v=d.duration)==null?void 0:v.text)||""}}),startAddress:c.start_address,endAddress:c.end_address}}}async function za(e,t,a,r){var c,l;const n={q:t,target:a,key:e,format:"text"};r&&(n.source=r);const s=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const d=await s.text();return{translatedText:"",error:`Translate API error (${s.status}): ${d.substring(0,200)}`}}const i=(l=(c=(await s.json()).data)==null?void 0:c.translations)==null?void 0:l[0];return i?{translatedText:i.translatedText,detectedSourceLang:i.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function Fa(e,t){const a=new URLSearchParams({address:t,key:e}),r=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${a}`);if(!r.ok)return{results:[],error:`Geocoding API error: ${r.status}`};const n=await r.json();return n.status!=="OK"&&n.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${n.status} — ${n.error_message||""}`}:{results:(n.results||[]).slice(0,5).map(s=>{var o;return{address:s.formatted_address,lat:s.geometry.location.lat,lng:s.geometry.location.lng,placeId:s.place_id,types:(o=s.types)==null?void 0:o.slice(0,3)}})}}async function Wa(e,t,a={}){const r=new URLSearchParams({part:"snippet",q:t,key:e,type:a.type||"video",maxResults:String(a.maxResults||5),order:a.order||"relevance"}),n=await fetch(`https://www.googleapis.com/youtube/v3/search?${r}`);if(!n.ok){const o=await n.text();return{results:[],error:`YouTube API error (${n.status}): ${o.substring(0,200)}`}}return{results:((await n.json()).items||[]).map(o=>{var i,c,l,d,m,f,v,y;return{title:o.snippet.title,channelTitle:o.snippet.channelTitle,description:(i=o.snippet.description)==null?void 0:i.substring(0,200),videoId:((c=o.id)==null?void 0:c.videoId)||((l=o.id)==null?void 0:l.channelId)||((d=o.id)==null?void 0:d.playlistId)||"",publishedAt:o.snippet.publishedAt,url:(m=o.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${o.id.videoId}`:(f=o.id)!=null&&f.channelId?`https://www.youtube.com/channel/${o.id.channelId}`:"",thumbnailUrl:(y=(v=o.snippet.thumbnails)==null?void 0:v.medium)==null?void 0:y.url}})}}async function vt(e,t={}){const a=Math.min(t.num||5,10),r=t.site?`site:${t.site} ${e}`:e;try{const n=new URLSearchParams({q:r}),s=await fetch(`https://html.duckduckgo.com/html/?${n}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!s.ok)return{results:[],error:`Search request failed (${s.status})`};const o=await s.text(),i=[],c=o.split(/class="result results_links/g).slice(1);for(const l of c){if(i.length>=a)break;const d=l.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=l.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(d){let f=d[1];const v=f.match(/uddg=([^&]+)/);v?f=decodeURIComponent(v[1]):f.startsWith("//")&&(f="https:"+f);const y=x=>x.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),T=y(d[2]),w=m?y(m[1]):"";if(T&&f.startsWith("http")){const x=f.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];i.push({title:T,link:f,snippet:w,displayLink:x})}}}return i.length===0?{results:[],error:void 0}:{results:i}}catch(n){return{results:[],error:`Web search error: ${n.message}`}}}async function qa(e,t,a,r="driving"){var c,l,d,m;const n=new URLSearchParams({origins:t,destinations:a,key:e,mode:r,departure_time:"now"}),s=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${n}`);if(!s.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${s.status}`};const o=await s.json(),i=(d=(l=(c=o.rows)==null?void 0:c[0])==null?void 0:l.elements)==null?void 0:d[0];return!i||i.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(i==null?void 0:i.status)||o.status}`}:{distance:i.distance.text,duration:i.duration.text,durationInTraffic:(m=i.duration_in_traffic)==null?void 0:m.text}}const tn=Object.freeze(Object.defineProperty({__proto__:null,geocode:Fa,getDirections:Ga,getDistanceMatrix:qa,getPlaceDetails:Ha,searchPlaces:Ua,searchYouTube:Wa,translateText:za,webSearch:vt},Symbol.toStringTag,{value:"Module"})),oe="https://gmail.googleapis.com/gmail/v1/users/me";class ie{constructor(t,a,r,n,s){this.db=t,this.userId=a,this.pinHash=r,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await We(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var i;const a=await this.authHeaders(),r=new URLSearchParams;if(r.set("maxResults",String(t.maxResults||10)),t.query&&r.set("q",t.query),(i=t.labelIds)!=null&&i.length)for(const c of t.labelIds)r.append("labelIds",c);const n=await fetch(`${oe}/messages?${r}`,{headers:a});if(!n.ok){const c=await n.text();throw new Error(`Gmail list failed (${n.status}): ${c.substring(0,200)}`)}const s=await n.json();if(!s.messages||s.messages.length===0)return[];const o=[];for(const c of s.messages.slice(0,t.maxResults||10))try{const l=await this.getMessage(c.id,a);l&&o.push(l)}catch{}return o}async getMessage(t,a){const r=a||await this.authHeaders(),n=await fetch(`${oe}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:r});if(!n.ok)return null;const s=await n.json(),o=i=>{var c,l,d;return((d=(l=(c=s.payload)==null?void 0:c.headers)==null?void 0:l.find(m=>m.name.toLowerCase()===i.toLowerCase()))==null?void 0:d.value)||""};return{id:s.id,threadId:s.threadId,snippet:s.snippet||"",subject:o("Subject")||"(no subject)",from:o("From"),to:o("To"),date:o("Date")||new Date(parseInt(s.internalDate)).toISOString(),isUnread:(s.labelIds||[]).includes("UNREAD"),labels:s.labelIds||[]}}async getMessageBody(t){const a=await this.authHeaders(),r=await fetch(`${oe}/messages/${t}?format=full`,{headers:a});if(!r.ok){const s=await r.text();throw new Error(`Gmail message body failed (${r.status}): ${s.substring(0,200)}`)}const n=await r.json();return Ka(n.payload)}async search(t,a=10){return this.listMessages({query:t,maxResults:a})}async send(t,a,r,n={}){const s=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&o.push(`Cc: ${n.cc}`),n.bcc&&o.push(`Bcc: ${n.bcc}`),n.replyToMessageId&&(o.push(`In-Reply-To: ${n.replyToMessageId}`),o.push(`References: ${n.replyToMessageId}`)),o.push("",r);const i=o.join(`\r
`),l={raw:btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")};n.threadId&&(l.threadId=n.threadId);const d=await fetch(`${oe}/messages/send`,{method:"POST",headers:s,body:JSON.stringify(l)});if(!d.ok){const m=await d.text();throw new Error(`Gmail send failed (${d.status}): ${m.substring(0,200)}`)}return await d.json()}async createDraft(t,a,r,n={}){const s=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&o.push(`Cc: ${n.cc}`),o.push("",r);const i=o.join(`\r
`),c=btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),l=await fetch(`${oe}/drafts`,{method:"POST",headers:s,body:JSON.stringify({message:{raw:c}})});if(!l.ok){const d=await l.text();throw new Error(`Gmail draft failed (${l.status}): ${d.substring(0,200)}`)}return await l.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${oe}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const r=await this.authHeaders();let n={};switch(a){case"archive":n={removeLabelIds:["INBOX"]};break;case"trash":n={addLabelIds:["TRASH"]};break;case"read":n={removeLabelIds:["UNREAD"]};break;case"unread":n={addLabelIds:["UNREAD"]};break;case"star":n={addLabelIds:["STARRED"]};break;case"unstar":n={removeLabelIds:["STARRED"]};break}const s=await fetch(`${oe}/messages/${t}/modify`,{method:"POST",headers:{...r,"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.text();throw new Error(`Failed to modify message: ${o}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${oe}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${oe}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function Ka(e){var t,a,r;if(!e)return"";if((t=e.body)!=null&&t.data)return St(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((a=n.body)!=null&&a.data))return St(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((r=n.body)!=null&&r.data)){const s=St(n.body.data);return an(s)}for(const n of e.parts)if(n.parts){const s=Ka(n);if(s)return s}}return e.snippet||""}function St(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function an(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const rn=1e4,nn=1e4;async function Ya(e,t){try{const a=new AbortController,r=setTimeout(()=>a.abort(),nn),n=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(r),!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const o=await n.text(),i=sn(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||rn)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function sn(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Ja(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await vt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async f=>{const v=await Ya(f.link);return{title:f.title,url:f.link,displayLink:f.displayLink,snippet:f.snippet,content:v.text,error:v.error}}),l=(await Promise.all(i)).filter(f=>f.content.length>50);if(l.length===0){const f=s.results.map((y,T)=>`[${T+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Kt(e,f,t,"snippets"),sources:s.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const d=l.map((f,v)=>`--- SOURCE ${v+1}: ${f.title} (${f.displayLink}) ---
${f.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Kt(e,d,t,"full"),sources:l.map(f=>({title:f.title,url:f.url})),pagesRead:l.length}}async function Kt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
## Current Date & Time
${wt(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Jt(e,t,a){var l;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((l=n.files)==null?void 0:l.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const c=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${c}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function wt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}function pn(e){const t=e.replace(/(\d+)\s*[.,;!]+\s*(minutes?|mins?|hours?|hrs?|h|days?|seconds?|secs?)/gi,"$1 $2"),a=t.toLowerCase().trim(),r=a.match(/\bin\s+(\d+)\s*(minutes?|mins?|hours?|hrs?|h|days?)\b/i);if(r){let o=parseInt(r[1],10);const i=r[2].toLowerCase();i.startsWith("h")&&(o*=60),i.startsWith("d")&&(o*=1440);const c=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let l;c?l=c[1].trim():l=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/in\s+\d+\s*\.?\s*(minutes?|mins?|hours?|hrs?|h|days?)\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const d=l.length>50?l.substring(0,47)+"...":l;return{args:{name:d.charAt(0).toUpperCase()+d.slice(1),description:l,schedule_type:"once",minutes_from_now:o,action_type:"reminder",action_description:l,schedule_value:""}}}const n=a.match(/(?:at|by)\s+(\d{1,2})[:.]?(\d{2})?\s*(am|pm|a\.m\.|p\.m\.)?/i);if(n){let o=parseInt(n[1],10);const i=n[2]?parseInt(n[2],10):0,c=(n[3]||"").replace(/\./g,"").toLowerCase();c==="pm"&&o<12&&(o+=12),c==="am"&&o===12&&(o=0);const l=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let d;l?d=l[1].trim():d=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/(?:at|by)\s+\d{1,2}[:.]?\d{0,2}\s*(am|pm|a\.m\.|p\.m\.)?\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const m=d.length>50?d.substring(0,47)+"...":d,f=new Date,v=f.getFullYear(),y=String(f.getMonth()+1).padStart(2,"0"),T=String(f.getDate()).padStart(2,"0"),w=`${v}-${y}-${T} ${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}`;return{args:{name:m.charAt(0).toUpperCase()+m.slice(1),description:d,schedule_type:"once",schedule_value:w,action_type:"reminder",action_description:d}}}const s=a.match(/^(remind|alert|notify)\s+me\s+(?:to|about|that)\s+(.+?)\.?$/i);if(s){const o=s[2].trim(),i=o.length>50?o.substring(0,47)+"...":o;return{args:{name:i.charAt(0).toUpperCase()+i.slice(1),description:o,schedule_type:"once",minutes_from_now:5,action_type:"reminder",action_description:o,schedule_value:""}}}return null}async function Be(e,t,a,r,n,s,o,i,c,l,d,m){const f=Date.now();let v=!0,y="",T="";try{return T=await mn(e,t,a,r,s,o,i,c,l,d,m),T}catch(w){throw v=!1,y=w.message||"Unknown error",w}finally{const w=Date.now()-f;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?T:"").substring(0,500),v?1:0,y||null,w,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function mn(e,t,a,r,n,s,o,i,c,l,d){var f,v,y,T,w,x;const m=new V(a);switch(e){case"create_schedule":{const u=new Date;let h;const p=l||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){h=new Date(u.getTime()+t.minutes_from_now*60*1e3);const E=h.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[S,L,O]=(E[0]||"").split("/");t.schedule_value=`${O}-${S}-${L} ${E[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const k=parseInt(t.schedule_value,10);h=new Date(u.getTime()+k*60*1e3)}else if(t.schedule_type==="daily"){const[k,E]=t.schedule_value.split(":").map(Number),S=u.toLocaleString("en-US",{timeZone:p}),L=new Date(S),O=new Date(L);O.setHours(k,E,0,0),O<=L&&O.setDate(O.getDate()+1);const C=new Date(O.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(O.toLocaleString("en-US",{timeZone:p})),M=C.getTime()-R.getTime();h=new Date(O.getTime()+M)}else if(t.schedule_type==="weekly"){const[k,E]=t.schedule_value.split(" "),[S,L]=(E||"00:00").split(":").map(Number),C=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Re=>Re.toLowerCase()===k.toLowerCase()),R=u.toLocaleString("en-US",{timeZone:p}),M=new Date(R),j=new Date(M);j.setHours(S,L,0,0);let $=(C-j.getDay()+7)%7;$===0&&j<=M&&($=7),j.setDate(j.getDate()+$);const W=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),ae=new Date(j.toLocaleString("en-US",{timeZone:p})),se=W.getTime()-ae.getTime();h=new Date(j.getTime()+se)}else if(t.schedule_type==="once"){const[k,E]=t.schedule_value.split(" "),[S,L,O]=k.split("-").map(Number),[C,R]=(E||"00:00").split(":").map(Number),M=u.toLocaleString("en-US",{timeZone:p}),j=new Date(M),$=new Date(j);$.setFullYear(S,L-1,O),$.setHours(C,R,0,0);const W=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),ae=new Date($.toLocaleString("en-US",{timeZone:p})),se=W.getTime()-ae.getTime();h=new Date($.getTime()+se);const Re=new Date(u.getTime()+120*1e3);if(h.getTime()<u.getTime()+60*1e3){const De=h.toISOString();h=Re;const rr=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${De} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${h.toISOString()}.]`;t._pastTimeWarning=rr}}else h=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),h.toISOString()).run();const g=t._pastTimeWarning||"",_=h.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${_} (${p}). [UTC: ${h.toISOString()}]${g}. IMPORTANT: Use the exact time "${_}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const h=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return h.length===0?"No scheduled tasks found.":h.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,h=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,h,t.job_id,r).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],h=t.state;if(!u.includes(h))return`Invalid state "${h}". Valid states: ${u.join(", ")}`;const p=h==="completed"||h==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(h,p,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${h}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,h=t.type,p=h==="task"||u>=7?"working":"long_term";if(h==="task"&&t.status==="done"){const g=t.title.toLowerCase(),k=((await a.prepare("SELECT id, title FROM memory WHERE user_id = ? AND type = 'task' AND (status = 'open' OR status IS NULL)").bind(r).all()).results||[]).find(E=>{const S=E.title.toLowerCase();return S.includes(g.slice(0,12))||g.includes(S.slice(0,12))});if(k)return await a.prepare("UPDATE memory SET status = 'done', updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(k.id).run(),`Task "${k.title}" marked done ✅. Removed from your briefing.`}if(await m.store(r,h,t.title,t.content,u,p),h==="task"){const g=[],_=[];t.due_date&&(g.push("due_date = ?"),_.push(t.due_date)),t.status&&(g.push("status = ?"),_.push(t.status)),g.length>0&&(_.push(r,t.title),await a.prepare(`UPDATE memory SET ${g.join(", ")} WHERE user_id = ? AND title = ? AND type = 'task'`).bind(..._).run());const k=t.due_date?` (due: ${new Date(t.due_date).toLocaleDateString("en-GB")})`:"",E=t.status==="done"?" ✅ marked done":"";return`Task saved: "${t.title}"${k}${E}. It will appear in your briefing until marked done.`}return`Stored in ${p==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await m.search(r,t.query);return u.length===0?"No matching memories found.":u.map(h=>`[${h.tier||"long_term"}] [${h.type}] **${h.title}**: ${h.content}`).join(`
`)}case"get_system_status":{const u=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),g=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),_=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
- Active schedules: ${(u==null?void 0:u.cnt)||0}
- Memory: ${(p==null?void 0:p.cnt)||0} working / ${(h==null?void 0:h.cnt)||0} total
- Total messages: ${(g==null?void 0:g.cnt)||0}
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||""),h=t.spreadsheet_id;let p=t.range;const g=await u.sheets.getMetadata(h),_=g.sheets;p.includes("!")||(p=`${_[0]}!${p}`);let k;try{k=await u.sheets.readRange(h,p)}catch(S){if((f=S.message)!=null&&f.includes("Unable to parse range")||(v=S.message)!=null&&v.includes("400")){const L=p.includes("!")?p.split("!")[1]:p;p=`${_[0]}!${L}`,k=await u.sheets.readRange(h,p)}else throw S}let E=`[Spreadsheet: "${g.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(S=>`"${S}"`).join(", ")}]
`;return _.length>1&&(E+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),k.length===0?E+"No data found in the specified range.":E+k.map(S=>S.join("	| ")).join(`
`)}catch(u){return await A(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||""),h=t.values;let p=t.range;const k=Math.max(...h.map(O=>O.length))+4,E=h.map(O=>{const C=[...O];for(;C.length<k;)C.push("");return C}),S=p.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(S){const O=S[1]||"",C=S[2],R=S[3],M=S[5],$=C.toUpperCase().charCodeAt(0)-64+k-1,W=$<=26?String.fromCharCode(64+$):"Z";p=`${O}${C}${R}:${W}${M}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,p,E)).updatedCells} cells to ${p}.`}catch(u){return await A(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new re(a,r,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await A(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let g="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ct)).getGoogleAuth(a,r,n,s||"",o||"");g=`
Folder: "${(await Jt(_,p.spreadsheetId,t.folder_name)).folderName}"`}catch(_){g=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new V(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${g}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(u){return await A(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||""),h=t.calendar_id||"primary",p=t.days_ahead||7,g=new Date,_=new Date(g.getTime()+p*24*60*60*1e3),k=await u.calendar.listEvents(h,{timeMin:g.toISOString(),timeMax:_.toISOString(),query:t.query});return k.length===0?`No events found in the next ${p} days.`:k.map(E=>{var R;const S=E.start.dateTime||E.start.date||"TBD",L=E.end.dateTime||E.end.date||"",O=E.location?` 📍 ${E.location}`:"",C=((R=E.attendees)==null?void 0:R.map(M=>M.email).join(", "))||"";return`• ${E.summary} — ${S} to ${L}${O}${C?`
  Attendees: ${C}`:""}`}).join(`
`)}catch(u){return await A(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||""),h=t.calendar_id||"primary",p=await u.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(u){return await A(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(p.documentId,t.content);let g="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>ct)).getGoogleAuth(a,r,n,s||"",o||"");g=`
Folder: "${(await Jt(_,p.documentId,t.folder_name)).folderName}"`}catch(_){g=`
(Could not move to folder "${t.folder_name}": ${_.message})`}try{await new V(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${g}
ID: ${p.documentId}
URL: ${p.url}`}catch(u){return await A(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const h=await new re(a,r,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${h.title}"

${h.content}`}catch(u){return await A(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await A(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new ie(a,r,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((p,g)=>`${p.isUnread?"● ":"  "}${g+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await A(a,r,"gmail","list",u.message),(y=u.message)!=null&&y.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const u=new ie(a,r,n,s||"",o||""),h=await u.getMessage(t.message_id);if(!h)return"Message not found.";const p=await u.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${p}`}catch(u){return await A(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new ie(a,r,n,s||"",o||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((p,g)=>`${p.isUnread?"● ":"  "}${g+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await A(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new ie(a,r,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(u){return await A(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new ie(a,r,n,s||"",o||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),p=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${p}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(u){return await A(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ie(a,r,n,s||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await A(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new ie(a,r,n,s||"",o||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(u){return(T=u.message)!=null&&T.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ct)).getGoogleAuth(a,r,n,s||"",o||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",h.set("q",p);const g=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const _=await g.json();return(w=_.files)!=null&&w.length?_.files.map((k,E)=>{var C,R;const S=((C=k.mimeType)==null?void 0:C.split(".").pop())||k.mimeType,L=k.size?`${(parseInt(k.size)/1024).toFixed(1)} KB`:"",O=((R=k.modifiedTime)==null?void 0:R.split("T")[0])||"";return`${E+1}. **${k.name}** (${S})
   ${L} · Modified: ${O}
   ${k.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await A(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ct)).getGoogleAuth(a,r,n,s||"",o||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",h),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const g=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const _=await g.json();return(x=_.files)!=null&&x.length?_.files.map((k,E)=>{var O,C;const S=((O=k.mimeType)==null?void 0:O.split(".").pop())||k.mimeType,L=((C=k.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${E+1}. **${k.name}** (${S}) — Modified: ${L}
   ${k.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await A(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await vt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}`:u.results.length===0?`No results found for "${t.query}".`:u.results.map((h,p)=>`${p+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(u){return await A(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>on),g=await p(u,h);return g.error?`Failed to read page: ${g.error}`:!g.text||g.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${g.text.length} chars):

${g.text}`}catch(u){return await A(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const h=Ja(t.query,d,{depth:t.depth||"quick",site:t.site}),p=new Promise(k=>setTimeout(()=>k(null),45e3)),g=await Promise.race([h,p]);if(g===null){const{webSearch:k}=await Promise.resolve().then(()=>tn),E=await k(t.query,{num:5});if(E.error||E.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let S=`Research took too long, but here are the top search results:

`;return S+=E.results.map((L,O)=>`${O+1}. **${L.title}**
   ${L.snippet}
   ${L.link}`).join(`

`),S}if(g.error)return`Research failed: ${g.error}`;let _=g.report;return g.sources.length>0&&(_+=`

---
**Sources** (`+g.pagesRead+` pages read):
`,_+=g.sources.map((k,E)=>`[${E+1}] ${k.title}
    ${k.url}`).join(`
`)),_}catch(u){return await A(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await U(u.encrypted_value,n),p=await Ua(h,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((g,_)=>{const k=g.rating?` ★${g.rating} (${g.userRatingsTotal||0} reviews)`:"",E=g.openNow!==void 0?g.openNow?" · Open now":" · Closed":"",S=g.googleMapsUri?`
   ${g.googleMapsUri}`:"";return`${_+1}. **${g.name}**${k}${E}
   ${g.address}${S}
   [place_id: ${g.placeId}]`}).join(`

`)}catch(u){return await A(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,n),p=await Ha(h,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const g=p.details;let _=`**${g.name}**
...
Recent Reviews:`;for(const k of g.reviews)_+=`
— ${k.author} (★${k.rating}, ${k.time}): "${k.text}"`}return _}catch(u){return await A(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,n),p=await Ga(h,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const g=p.route;let _=`**${g.startAddress}** → **${g.endAddress}**
`;return _+=`📏 ${g.distance} · ⏱️ ${g.duration}`,g.durationInTraffic&&(_+=` (with traffic: ${g.durationInTraffic})`),_+=`
via ${g.summary}`,_+=`

Steps:`,g.steps.forEach((k,E)=>{_+=`
${E+1}. ${k.instruction} (${k.distance}, ${k.duration})`}),_}catch(u){return await A(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,n),p=await qa(h,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let g=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(g+=` (with traffic: ${p.durationInTraffic})`),g}catch(u){return await A(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,n),p=await za(h,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await A(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,n),p=await Wa(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((g,_)=>{var k;return`${_+1}. **${g.title}**
   ${g.channelTitle} · ${((k=g.publishedAt)==null?void 0:k.split("T")[0])||""}
   ${g.description}
   ${g.url}`}).join(`

`)}catch(u){return await A(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await U(u.encrypted_value,n),p=await Fa(h,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((g,_)=>`${_+1}. ${g.address}
   Coordinates: ${g.lat}, ${g.lng}`).join(`
`)}catch(u){return await A(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function Vt(e,t,a,r,n,s){var u;const o=new V(t),i=(u=e.metadata)==null?void 0:u.thread_id,c=await o.buildContext(r.id),l=await o.getRecentConversations(r.id,25,i),m=[{role:"system",content:Qa(r,c)},...l.map(h=>({role:h.role,content:h.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",y=0;const T=[];for(let h=0;h<f;h++)try{const p=await a.chat(m,{tools:bt});if(p.usage&&(y+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&m.push({role:"assistant",content:p.content});for(const g of p.toolCalls){T.push(g.name);try{const _=await Be(g.name,g.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);m.push({role:"user",content:`[Tool Result for ${g.name}]: ${_}`})}catch(_){await A(t,r.id,"tool",g.name,_.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${g.name}]: ${_.message||"Execution failed"}`})}}continue}v=p.content;break}catch(p){if(n){const g=p.message||"",_=g.includes("401")||g.includes("403")||g.includes("authentication")||g.includes("credit balance"),k=g.includes("429"),E=_?1440:k?10:5;await n.recordError(a.name,g,E)}throw await A(t,r.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:a.name,turn:h}),p}if(n&&y>0)try{await n.recordUsage(a.name,y)}catch{}const w=v.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),x=T.length>0?`[TOOLS_USED: ${[...new Set(T)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",x+w,"{}",i),await o.compactHistory(r.id,30),v}const Xt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function hn(e){for(const[t,a]of Object.entries(Xt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Xt.default}function gn(e,t,a,r){const n=hn(r),s=Math.floor(n*.75),o=[];let i=0,c=!1;const l=It(e);o.push({role:"system",content:e}),i+=l;const d=It(a);i+=d;const m=s-i,f=[];let v=0;for(let y=t.length-1;y>=0;y--){const T=t[y],w=It(T.content);if(v+w<=m)f.unshift({role:T.role,content:T.content}),v+=w;else{c=!0;break}}return o.push(...f),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:c}}async function*fn(e,t,a,r,n,s){var w;const o=new V(t),i=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const c=await o.buildContext(r.id),l=await o.getRecentConversations(r.id,20,i),d=Qa(r,c),m=gn(d,l,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",y=0;const T=[...m.messages];for(let x=0;x<f;x++)try{x>0&&(yield{type:"thinking",data:{threadId:i}});const u=await a.chat(T,{tools:bt});if(u.usage&&(y+=u.usage.promptTokens+u.usage.completionTokens),u.toolCalls&&u.toolCalls.length>0){u.content&&(yield{type:"chunk",data:{text:u.content,threadId:i}},T.push({role:"assistant",content:u.content}));for(const p of u.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const g=await Be(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:g.substring(0,500)+(g.length>500?"...":""),threadId:i}},T.push({role:"user",content:`[Tool Result for ${p.name}]: ${g}`})}catch(g){await A(t,r.id,"tool",p.name,g.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${g.message||"Execution failed"}`,threadId:i}},T.push({role:"user",content:`[Tool Error for ${p.name}]: ${g.message||"Execution failed"}`})}}continue}v=u.content;const h=50;for(let p=0;p<v.length;p+=h)yield{type:"chunk",data:{text:v.substring(p,p+h),threadId:i}},p+h<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(u){if(n){const h=u.message||"",p=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),g=h.includes("429"),_=p?1440:g?10:5;await n.recordError(a.name,h,_)}await A(t,r.id,"llm","provider_error",u.message||"Unknown LLM error",{provider:a.name,turn:x}),yield{type:"error",data:{error:u.message||"An error occurred",threadId:i}};return}if(n&&y>0)try{await n.recordUsage(a.name,y)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:y}}}async function Pt(e,t,a,r,n,s){var d;const o=new V(t),i=(d=e.metadata)==null?void 0:d.thread_id,c=await o.buildContext(r.id),l=Va(e.text,c);if(l.agent==="conversation")return vn(e,t,a,r,c,n,i);if(l.agent==="multi"||l.confidence<.5)return Vt(e,t,a,r,n,s);try{return await yn(l.agent,e,t,a,r,c,n,s,i)}catch(m){return await A(t,r.id,"router","subagent_fallback",`${l.agent} failed: ${m.message}`,{route:l}),Vt(e,t,a,r,n,s)}}async function yn(e,t,a,r,n,s,o,i,c){const l=new V(a),d=wt(n.timezone),m=ht(e,n,s,n.timezone,d),f=Xa(e,bt),v=(await l.getRecentConversations(n.id,25,c)).map(O=>({...O,content:O.content.replace(/^\[TOOLS_USED: [^\]]+\]\s*/i,"")})),y=[{role:"system",content:m},...v.map(O=>({role:O.role,content:O.content})),{role:"user",content:t.text}];await l.storeMessage(n.id,t.channel,"user",t.text,"{}",c);const T=10;let w="",x=0,u="",h=!1;const p=[];for(let O=0;O<T;O++)try{const C=await r.chat(y,{tools:f.length>0?f:void 0});if(C.usage&&(x+=C.usage.promptTokens+C.usage.completionTokens),C.toolCalls&&C.toolCalls.length>0){h=!0,C.content&&(u=C.content,y.push({role:"assistant",content:C.content}));for(const R of C.toolCalls){p.push(R.name);try{const M=await Be(R.name,R.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y.push({role:"user",content:`[Tool Result for ${R.name}]: ${M}`})}catch(M){await A(a,n.id,"tool",R.name,M.message||"Tool execution failed"),y.push({role:"user",content:`[Tool Error for ${R.name}]: ${M.message||"Execution failed"}`})}}continue}w=C.content,!w&&u&&(w=u);break}catch(C){if(o){const R=C.message||"",M=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),j=R.includes("429"),$=M?1440:j?10:5;await o.recordError(r.name,R,$)}throw await A(a,n.id,"llm","subagent_error",C.message||"Unknown error",{agent:e,provider:r.name,turn:O}),C}const g=["scheduler","workspace","research"],_=e==="scheduler"&&!p.includes("create_schedule")&&!p.includes("list_schedules")&&!p.includes("toggle_schedule")&&!p.includes("update_schedule_state")&&!p.includes("delete_schedule")&&/\b(remind|in\s+\d+|at\s+\d{1,2}[:.]\d{0,2}|timer|alarm|schedule|tell\s+me\s+in|notify|alert|ping)\b/i.test(t.text),k=e==="workspace"&&p.includes("read_sheet")&&!p.includes("write_sheet")&&!p.includes("append_sheet")&&/\b(fix|correct|update|change|delete|remove|clean|clear|repair|replace|overwrite|set\s+to|should\s+be|wrong|broken|gap|missing)\b/i.test(t.text);if(!h&&g.includes(e)&&f.length>0||_||k){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),w.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{y.push({role:"assistant",content:w});let O;e==="scheduler"&&_?O=`[SYSTEM OVERRIDE] You called ${p.join(", ")||"no tools"} but did NOT call create_schedule. The user wants a reminder or schedule created. Call create_schedule NOW with the correct parameters. Do NOT respond with text saying a reminder is set — actually create it.`:e==="workspace"&&k?O="[SYSTEM OVERRIDE] You called read_sheet but did NOT call write_sheet. The user asked you to FIX or UPDATE the sheet data. You MUST call write_sheet NOW to make the actual changes. Reading data and then describing what you would fix is NOT the same as fixing it. Call write_sheet with the corrected values, then call read_sheet again to verify the fix landed correctly. Do NOT claim data is fixed without actually writing to the sheet.":O=`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${f.slice(0,3).map(R=>R.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`,y.push({role:"user",content:O});const C=await r.chat(y,{tools:f});if(C.usage&&(x+=C.usage.promptTokens+C.usage.completionTokens),C.toolCalls&&C.toolCalls.length>0){h=!0;let R=C.toolCalls,M=C.content;for(let j=0;j<5;j++){M&&y.push({role:"assistant",content:M});for(const W of R){p.push(W.name);try{const ae=await Be(W.name,W.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y.push({role:"user",content:`[Tool Result for ${W.name}]: ${ae}`})}catch(ae){y.push({role:"user",content:`[Tool Error for ${W.name}]: ${ae.message||"Execution failed"}`})}}const $=await r.chat(y,{tools:f});if($.usage&&(x+=$.usage.promptTokens+$.usage.completionTokens),$.toolCalls&&$.toolCalls.length>0){R=$.toolCalls,M=$.content;continue}$.content&&(w=$.content);break}}if(!p.includes("create_schedule")&&e==="scheduler")try{const R=pn(t.text);if(R){const M=await Be("create_schedule",R.args,a,n.id,{agentType:"scheduler",providerName:"programmatic_fallback",channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);h=!0,p.push("create_schedule"),w=M}}catch(R){await A(a,n.id,"tool_enforcement","scheduler_fallback",`Programmatic scheduler fallback failed: ${R.message||"Unknown"}`)}}catch(O){await A(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${O.message||"Unknown"}`,{originalResponse:w.substring(0,200)})}}if(o&&x>0)try{await o.recordUsage(r.name,x)}catch{}const S=w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),L=p.length>0?`[TOOLS_USED: ${[...new Set(p)].join(", ")}] `:"";return await l.storeMessage(n.id,t.channel,"assistant",L+S,"{}",c),await l.compactHistory(n.id,30),w}async function vn(e,t,a,r,n,s,o){const i=new V(t),c=wt(r.timezone),l=ht("conversation",r,n,r.timezone,c),d=await i.getRecentConversations(r.id,25,o),m=[{role:"system",content:l},...d.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let f=0,v="";try{const y=await a.chat(m,{temperature:.8});y.usage&&(f=y.usage.promptTokens+y.usage.completionTokens),v=y.content}catch(y){if(s){const T=y.message||"",w=T.includes("401")||T.includes("403")||T.includes("authentication")||T.includes("credit balance"),x=T.includes("429"),u=w?1440:x?10:5;await s.recordError(a.name,T,u)}throw await A(t,r.id,"llm","conversation_error",y.message,{provider:a.name}),y}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*bn(e,t,a,r,n,s){var u;const o=new V(t),i=(u=e.metadata)==null?void 0:u.thread_id,c=await o.buildContext(r.id),l=Va(e.text,c);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},l.agent==="multi"||l.confidence<.5){yield*fn(e,t,a,r,n,s);return}const d=wt(r.timezone),m=l.agent==="conversation"?ht("conversation",r,c,r.timezone,d):ht(l.agent,r,c,r.timezone,d),f=Xa(l.agent,bt),v=await o.getRecentConversations(r.id,25,i),y=[{role:"system",content:m},...v.map(h=>({role:h.role,content:h.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const T=10;let w="",x=0;for(let h=0;h<T;h++)try{h>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(y,{tools:f.length>0?f:void 0});if(p.usage&&(x+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},y.push({role:"assistant",content:p.content}));for(const _ of p.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const k=await Be(_.name,_.arguments,t,r.id,{agentType:l.agent,providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:k.substring(0,500)+(k.length>500?"...":""),threadId:i}},y.push({role:"user",content:`[Tool Result for ${_.name}]: ${k}`})}catch(k){await A(t,r.id,"tool",_.name,k.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${k.message||"Execution failed"}`,threadId:i}},y.push({role:"user",content:`[Tool Error for ${_.name}]: ${k.message||"Execution failed"}`})}}continue}w=p.content;const g=50;for(let _=0;_<w.length;_+=g)yield{type:"chunk",data:{text:w.substring(_,_+g),threadId:i}},_+g<w.length&&await new Promise(E=>setTimeout(E,10));break}catch(p){if(n){const g=p.message||"",_=g.includes("401")||g.includes("403")||g.includes("authentication")||g.includes("credit balance"),k=g.includes("429"),E=_?1440:k?10:5;await n.recordError(a.name,g,E)}await A(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:l.agent,provider:a.name,turn:h}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&x>0)try{await n.recordUsage(a.name,x)}catch{}await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:x}}}const H=new we;async function wn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}H.use("/*",wn);H.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const l=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=l==null?void 0:l.id}const c={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:l,rotation:d}=await st(e.env.DB,t.id,t.pin_hash),m=await Pt(c,e.env.DB,l,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});return!n&&i?await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run():i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),e.json({response:m,timestamp:new Date().toISOString(),channel:c.channel,provider:l.name,thread_id:i})}catch(l){console.error("Chat error:",l);const d=l.message||"";if(d.includes("No LLM provider configured"))return e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400);if(d.includes("All LLM providers failed"))return e.json({error:d,type:"no_provider",thread_id:i},400);if(d.includes("limit reached"))return e.json({error:d,type:"cost_limit",thread_id:i},429);const m=d.includes("401")||d.includes("403")||d.includes("authentication")||d.includes("credit balance")||d.includes("invalid")&&d.includes("key");try{const{logError:f}=await Promise.resolve().then(()=>Dt);await f(e.env.DB,t.id,"llm","chat_error",d)}catch{}return e.json({error:m?"API key error — your provider returned an authentication or billing error. Check Settings → Keys to verify your API keys are valid.":"Something went wrong. I'll be back in a moment.",details:d,type:m?"no_provider":void 0,thread_id:i},m?400:500)}});function Zt(e){return`event: ${e.type}
data: ${JSON.stringify(e.data)}

`}H.post("/stream",async e=>{const t=e.get("user"),{message:a,channel:r="web",thread_id:n,files:s}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let o="";if(s&&Array.isArray(s)&&s.length>0){o=`

[Attached files:
`;for(const l of s)o+=`- ${l.name} (${l.type}, ${Math.round(l.size/1024)}KB, file_id: ${l.file_id})`,l.text_preview&&(o+=`
  Preview: ${l.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const l=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=l==null?void 0:l.id}const c={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:l,rotation:d}=await st(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(f){const v=new TextEncoder;try{const y=bn(c,e.env.DB,l,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const T of y)T.data.threadId||(T.data.threadId=i),f.enqueue(v.encode(Zt(T)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),f.close()}catch(y){const T={type:"error",data:{error:y.message||"An error occurred",threadId:i}};f.enqueue(v.encode(Zt(T))),f.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(l){console.error("Stream setup error:",l);const d=l.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):d.includes("limit reached")?e.json({error:d,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:i},500)}});H.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?`).bind(t.id,a,r).all();return e.json({messages:(n.results||[]).reverse(),total:((s=n.results)==null?void 0:s.length)||0})});H.get("/history",async e=>{var c;const t=e.get("user"),a=parseInt(e.req.query("limit")||"50"),r=parseInt(e.req.query("offset")||"0"),n=e.req.query("thread_id");let s,o;n?(s=`SELECT id, role, content, channel, thread_id, created_at FROM conversations 
...
Just type naturally — I'll figure out the rest.`;return await P(a,t,i),!0}case"/status":{if(!r)return await P(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[o,i,c,l]=await Promise.all([n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),d=`📊 *System Status*
...
Status: ✅ Online`;await P(a,t,d)}catch{await P(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await P(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await P(a,t,"⚠️ Account not linked."),!0);case"/tasks":case"/task":{if(!r)return await P(a,t,"⚠️ Account not linked."),!0;try{const i=(await n.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(i.length===0)return await P(a,t,"✅ No open tasks. You're all clear."),!0;const c=new Date,l=c.toISOString().slice(0,10),d=new Date(c);d.setDate(d.getDate()+1);const m=d.toISOString().slice(0,10),f=[`📋 *Open Tasks (${i.length})*
`];for(const v of i){let y="";if(v.due_date){const T=v.due_date.slice(0,10);T<l?y=" ⚠️ _overdue_":T===l?y=" 🔴 _due today_":T===m?y=" 🟡 _due tomorrow_":y=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}f.push(`☐ ${v.title}${y}`)}f.push(`
_Say "mark [task] as done" to close a task._`),await P(a,t,f.join(`
`))}catch(o){await P(a,t,"❌ Could not fetch tasks: "+o.message)}return!0}default:return!1}}ot.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},n=async()=>{var s,o,i,c,l;try{if(t.callback_query){await Rn(a,t.callback_query);return}const d=t.message;if(!d)return;const m=!!d.text,f=!!d.voice,v=!!d.document,y=!!d.photo,T=!!d.caption;if(!m&&!f&&!v&&!y)return;const w=String(d.chat.id);let x=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(w).first();let h=null;if(u){const E=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();E&&(h=await U(E.encrypted_value,u.pin_hash))}if(!h){const E=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();E&&(h=await U(E.encrypted_value,E.pin_hash))}if(!h||x.startsWith("/")&&await Cn(x,w,h,u,a))return;if(!u){await P(h,w,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${w}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&h&&u)try{await P(h,w,"🎤 Processing voice note...");const S=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${d.voice.file_id}`)).json();if(S.ok&&((s=S.result)!=null&&s.file_path)){const O=await(await fetch(`https://api.telegram.org/file/bot${h}/${S.result.file_path}`)).blob();let C="",R="",M="whisper-1";const j=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const se of j.results){const Re=await U(se.encrypted_value,u.pin_hash);if(se.service==="openai"){C="https://api.openai.com/v1/audio/transcriptions",R=Re;break}else if(se.service.startsWith("llm_slot_"))try{const De=JSON.parse(Re);if(De.provider==="openai"){C="https://api.openai.com/v1/audio/transcriptions",R=De.apiKey;break}else if(De.provider==="groq"){C="https://api.groq.com/openai/v1/audio/transcriptions",R=De.apiKey,M="whisper-large-v3";break}}catch{}}if(!C){await P(h,w,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const $=new FormData;$.append("file",O,"voice.ogg"),$.append("model",M),$.append("language","en");const W=await fetch(C,{method:"POST",headers:{Authorization:`Bearer ${R}`},body:$});if(!W.ok){const se=await W.text();await P(h,w,`⚠️ Transcription failed: ${W.status} ${se}`);return}x=(await W.json()).text,await P(h,w,`🗣️ *You said:* ${x}`)}}catch(E){await P(h,w,`⚠️ Failed to process voice note: ${E.message}`);return}if((v||y)&&h&&u)try{let E,S="unknown",L="unknown",O=0;if(v)E=d.document.file_id,S=d.document.file_name||"document",L=d.document.mime_type||"unknown",O=d.document.file_size||0;else if(y){const C=d.photo[d.photo.length-1];E=C.file_id,S="photo.jpg",L="image/jpeg",O=C.file_size||0}if(E){const R=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${E}`)).json();let M="";if(R.ok&&((o=R.result)!=null&&o.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(S)||/^text\/|application\/json|application\/xml|application\/csv/i.test(L))&&O<5e4)try{M=await(await fetch(`https://api.telegram.org/file/bot${h}/${R.result.file_path}`)).text()}catch{}const j=d.caption||"",$=`[Telegram file received: "${S}" (${L}, ${Math.round(O/1024)}KB)]`;M?x=`${j?j+`

`:""}${$}
File contents:
${M.substring(0,8e3)}${M.length>8e3?`
[...truncated]`:""}`:x=`${j?j+`

`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(E){if(T&&d.caption)x=d.caption;else{await P(h,w,`⚠️ Received your file but couldn't process it: ${E.message}`);return}}if(!x)return;In(h,w).catch(()=>{});let p=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();p?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(p.id).run():p={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const g=Tn(u.id,u.username,x,w);g.metadata={thread_id:p.id};let _,k;try{const E=await st(a,u.id,u.pin_hash);_=E.provider,k=E.rotation}catch(E){console.error("Telegram provider setup error:",E);const S=(i=E.message)!=null&&i.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(c=E.message)!=null&&c.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${E.message||"Unknown error"}`;await P(h,w,S);return}try{const E=await Pt(g,a,_,u,k,r),S=kn(E,"telegram");await P(h,w,S||"(empty response)")}catch(E){console.error("Telegram agent error:",E);const S=(l=E.message)!=null&&l.includes("API error")?`⚠️ AI provider returned an error. The provider (${_.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(E.message||"Unknown").substring(0,200)}`;await P(h,w,S);try{const{logError:L}=await Promise.resolve().then(()=>Dt);await L(a,u.id,"telegram","agent_error",E.message||"Agent error",{provider:_.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:m}=await Promise.resolve().then(()=>Dt);await m(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(n()),e.json({ok:!0})});ot.post("/setup-webhook",async e=>{var c;const t=(c=e.req.header("Authorization"))==null?void 0:c.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await U(n.encrypted_value,a.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});ot.get("/webhook-status",async e=>{var s,o,i,c,l,d;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await U(r.encrypted_value,a.pin_hash);try{const f=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=f.result)==null?void 0:o.url)||"",has_webhook:!!((i=f.result)!=null&&i.url),pending_updates:((c=f.result)==null?void 0:c.pending_update_count)||0,last_error:((l=f.result)==null?void 0:l.last_error_message)||"",last_error_date:((d=f.result)==null?void 0:d.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});ot.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await U(r.encrypted_value,a.pin_hash);try{const l=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();l&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:l,allowed_updates:["message"]})});const f=m.result||[];if(f.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],y=new Set;for(let w=f.length-1;w>=0;w--){const x=f[w].message;if(x&&x.chat){const u=String(x.chat.id);y.has(u)||(y.add(u),v.push({chat_id:u,name:[x.chat.first_name,x.chat.last_name].filter(Boolean).join(" ")||x.chat.title||"Unknown",username:x.chat.username||"",date:new Date((x.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const T=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(T,a.user_id).run(),e.json({found:!0,chat_id:T,name:v[0].name,all_chats:v,message:`Chat ID ${T} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function Rn(e,t){var T;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const o=r.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],c=parseInt(o[2]);if(!c||!i)return;const l=String(n.chat.id),d=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!d)return;const m=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(d.id,c,i).first();if(!m)return;const f=m.checked?0:1;await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ?
  `).bind(f,f,m.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(d.id).first();if(!v)return;const y=await U(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:f?"✅ Checked!":"☐ Unchecked"})}),(T=n.reply_markup)!=null&&T.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(x=>x.map(u=>{var h;if((h=u.callback_data)!=null&&h.includes(i)){const p=f?"✅":"☐",g=u.text.replace(/^[☐✅]\s*/,"");return{...u,text:`${p} ${g}`}}return u}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function Dn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function An(e,t,a,r,n,s){try{return(await new jt(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(c=>{var l;return{id:c.id||`google-${Date.now()}`,title:c.summary||"Untitled Event",startTime:c.start.dateTime||c.start.date||"",endTime:c.end.dateTime||c.end.date||"",location:c.location,attendees:(l=c.attendees)==null?void 0:l.map(d=>d.displayName||d.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function Nn(e,t,a,r,n){try{const s=new ie(e,t,a,r,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),c={};for(const m of o){const f=m.from.split("<")[0].trim()||m.from;c[f]=(c[f]||0)+1}const l=Object.entries(c).sort(([,m],[,f])=>f-m).slice(0,5).map(([m])=>m),d=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:l,hasUrgent:d}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Ln(e,t){try{const a=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),r=new Date,n=new Date(r);n.setDate(n.getDate()+1),n.setHours(23,59,59,999);const s=a.results||[],o=s.map(c=>{if(c.due_date){const l=new Date(c.due_date),d=l<=r?"overdue":l<=n?"due today":l.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${c.title} [${d}]`}return c.title}),i=s.filter(c=>c.due_date?new Date(c.due_date)<=n:!1).length;return{pending:s.length,dueToday:i,items:o}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function $n(e,t){try{const a=Math.floor((Date.now()-1728e5)/1e3),r=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${a},points>10`,n=await fetch(r,{headers:{"User-Agent":"Karna/1.0"}});return n.ok?((await n.json()).hits||[]).filter(o=>o.url&&!t.has(o.url)).slice(0,2).map(o=>({title:o.title,summary:`${o.points} pts · ${o.num_comments} comments on HN`,url:o.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const ea=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function Mn(e,t,a){const r=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],n=new Set;if(t&&a)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(a).all()).results||[]).forEach(l=>n.add(l.url))}catch{}const s=[];if(r.some(c=>ea.some(l=>c.toLowerCase().includes(l.toLowerCase())))){const c=r.find(d=>ea.some(m=>d.toLowerCase().includes(m.toLowerCase())))||"AI agents",l=await $n(c,n);for(const d of l)s.push(d),n.add(d.url)}for(const c of r){if(s.length>=8)break;const l=`latest ${c} news today`;try{const d=await vt(l,{num:5});if(d.results)for(const m of d.results){if(s.length>=8)break;n.has(m.link)||(s.push({title:m.title,summary:m.snippet,url:m.link,source:m.displayLink}),n.add(m.link))}}catch(d){console.error(`News search error for "${l}":`,d.message)}}const i=s.slice(0,7);if(t&&a&&i.length>0)for(const c of i)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(a,c.url,c.title).run()}catch{}return i}function Bn(e,t){const a=[];let r="20:00";{const[o,i]=t.split(":"),c=parseInt(o,10),l=i||"00",d=c>=12?"PM":"AM";r=`${c===0?12:c>12?c-12:c}:${l} ${d}`}a.push(`🗓 Your ${r} Brief — ${e.targetDate}`),a.push("");const n=e.calendar.totalCount;if(n>0){a.push(`📅 Tomorrow: ${n} event${n===1?"":"s"}`);for(const o of e.calendar.google.slice(0,5)){const i=o.startTime?new Date(o.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";a.push(`   • ${i} ${o.title}`)}}else a.push("📅 Tomorrow: Nothing scheduled");a.push("");const s=e.emails.gmail.unreadCount;if(s>0?(a.push(`📧 Gmail: ${s} unread`),e.emails.gmail.importantCount>0&&a.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&a.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&a.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):a.push("📧 Gmail: Inbox clear"),a.push(""),e.tasks.pending>0){a.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const o of e.tasks.items)a.push(`   ☐ ${o}`)}else a.push("✅ Tasks: All clear");if(a.push(""),e.news.items.length>0){a.push("📡 Today's Signal:");for(const o of e.news.items){const i=o.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${o.source}`;a.push(`   • ${o.title.substring(0,90)}${o.title.length>90?"…":""}`),a.push(`     ${i} — ${o.summary.substring(0,80)}${o.summary.length>80?"…":""}`)}}return a.join(`
`)}function jn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Pn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const s=JSON.parse(a.components);r={google_calendar:s.google_calendar!==!1,gmail:s.gmail!==!1,tasks:s.tasks!==!1,news:s.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function tr(e,t,a){var u,h;const r=t.timezone||"Asia/Kolkata",n=Dn(r),{components:s,newsTopics:o}=await Pn(e,t.id),i=[],c=[];s.google_calendar&&(i.push(An(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),c.push("googleEvents")),s.gmail&&(i.push(Nn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),c.push("gmailSummary")),s.tasks&&(i.push(Ln(e,t.id)),c.push("tasks")),s.news&&(i.push(Mn(o,e,t.id)),c.push("news"));const l=await Promise.all(i),d={};c.forEach((p,g)=>{d[p]=l[g]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},f={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:d.googleEvents||[],totalCount:((u=d.googleEvents)==null?void 0:u.length)||0},emails:{gmail:d.gmailSummary||m},tasks:d.tasks||f,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},y=((h=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:h.briefing_time)||"20:00";v.summary=Bn(v,y);const T=jn(v),w=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(v)).first(),x=(w==null?void 0:w.id)||0;for(const p of T)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(x,p.type,p.key,p.text,JSON.stringify(p.metadata),p.sortOrder).run();return{briefingId:x,content:v,items:T}}async function Un(e,t,a){const r=await e.prepare(`
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function zn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),c=n*60+s,l=o*60+i;return c===l}function Fn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const X=new we;async function Wn(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",c=o.briefing_time||"20:00";if(zn(c,i,s))try{const l=await tr(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:d,inlineKeyboard:m}=Fn(l.content,l.items);await qn(e.env.DB,o,d,m,l.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:l.briefingId,briefing_time:c,timezone:i})}catch(l){n.push({user_id:o.id,status:"error",error:l.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});X.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const c of r.results||[])try{const l=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(c.id).first();if(!l)continue;const d=await U(l.encrypted_value,c.pin_hash),f=JSON.parse(d).access_token;if(!f)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${f}`}});if(!v.ok)continue;const T=((await v.json()).items||[]).filter(u=>{var p;const h=(p=u.start)==null?void 0:p.dateTime;return h?h>=s.toISOString()&&h<=o:!1});if(T.length===0){n.push({user_id:c.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(c.id).first();if(!w)continue;const x=await U(w.encrypted_value,c.pin_hash);for(const u of T){const h=new Date(u.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=u.location?`
📍 ${u.location}`:"",g=`⏰ Meeting in 10 minutes!

*${u.summary||"Untitled Event"}*
🕐 ${h}${p}`;await fetch(`https://api.telegram.org/bot${x}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c.telegram_chat_id,text:g,parse_mode:"Markdown"})})}n.push({user_id:c.id,reminders_sent:T.length})}catch(l){n.push({user_id:c.id,status:"error",error:l.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function qn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const o=await U(s.encrypted_value,s.pin_hash);await fetch(`https://api.telegram.org/bot${o}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(c=>({...c,callback_data:`${c.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}X.delete("/briefings/:id",async e=>{const t=e.get("user"),a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});const te=new we;te.use("/api/*",Ur());te.route("/api/auth",_e);te.route("/api/chat",H);te.route("/api/settings",G);te.route("/api/system",me);te.route("/api/telegram",ot);te.route("/api/proactive",X);te.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ne(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Ne(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Ne(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Ne(!1,"Session expired. Please log in again and retry."));const c=i.user_id,l=i.pin_hash,d=`${t.protocol}//${t.host}/auth/google/callback`,m=await Ma(e.env.DB,c,l,a,d,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Ne(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Ne(!1,`OAuth failed: ${s.message}`))}});te.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Ea())));te.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Ea())));function Ne(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function Kn(e,t,a){const r="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const i=await(await fetch(`${r}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(i.results&&i.results.length>0){const l=i.results.filter(m=>m.needs_agent&&m.status==="dispatched");if(l.length>0){const m=l.map(f=>fetch(`${r}/api/system/cron/run-task/${f.job_id}`,{method:"POST",headers:s}).then(v=>v.json()).catch(v=>({job_id:f.job_id,error:v.message})));a.waitUntil(Promise.allSettled(m).then(f=>{console.log(`Cron: ${i.executed} dispatched, ${l.length} agent tasks`,JSON.stringify(f.map(v=>v.status==="fulfilled"?v.value:v.reason)))}))}const d=i.results.filter(m=>!m.needs_agent&&m.status==="dispatched");if(d.length>0){const m=d.map(f=>fetch(`${r}/api/system/cron/run-task/${f.job_id}`,{method:"POST",headers:s}).catch(()=>{}));a.waitUntil(Promise.allSettled(m))}}a.waitUntil(fetch(`${r}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(l=>l.json()).then(l=>{l.executed>0&&console.log("Evening briefing result:",JSON.stringify(l))}).catch(l=>{console.error("Evening briefing error:",l.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${r}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(l=>l.json()).then(l=>{var d;(d=l.results)!=null&&d.some(m=>m.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(l))}).catch(()=>{}))}catch(o){console.error("Scheduled cron error:",o.message||o)}}const Yn={fetch:te.fetch,scheduled:Kn},ta=new we,Jn=Object.assign({"/src/index.tsx":Yn});let ar=!1;for(const[,e]of Object.entries(Jn))e&&(ta.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ta.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),ar=!0);if(!ar)throw new Error("Can't import modules from ['/src/index.tsx']");export{ta as default};
