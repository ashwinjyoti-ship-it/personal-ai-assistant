var ea=Object.defineProperty;var mr=e=>{throw TypeError(e)};var ta=(e,t,r)=>t in e?ea(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var L=(e,t,r)=>ta(e,typeof t!="symbol"?t+"":t,r),Gt=(e,t,r)=>t.has(e)||mr("Cannot "+r);var k=(e,t,r)=>(Gt(e,t,"read from private field"),r?r.call(e):t.get(e)),z=(e,t,r)=>t.has(e)?mr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),P=(e,t,r,n)=>(Gt(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),V=(e,t,r)=>(Gt(e,t,"access private method"),r);var pr=(e,t,r,n)=>({set _(a){P(e,t,a,r)},get _(){return k(e,t,n)}});var hr=(e,t,r)=>(n,a)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,d=!1,c;if(e[o]?(c=e[o][0][0],n.req.routeIndex=o):c=o===e.length&&a||void 0,c)try{l=await c(n,()=>i(o+1))}catch(m){if(m instanceof Error&&t)n.error=m,l=await t(m,n),d=!0;else throw m}else n.finalized===!1&&r&&(l=await r(n));return l&&(n.finalized===!1||d)&&(n.res=l),n}},ra=Symbol(),na=async(e,t=Object.create(null))=>{const{all:r=!1,dot:n=!1}=t,s=(e instanceof Gr?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?aa(e,{all:r,dot:n}):{}};async function aa(e,t){const r=await e.formData();return r?sa(r,t):{}}function sa(e,t){const r=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?ia(r,a,n):r[a]=n}),t.dot&&Object.entries(r).forEach(([n,a])=>{n.includes(".")&&(oa(r,n,a),delete r[n])}),r}var ia=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},oa=(e,t,r)=>{let n=e;const a=t.split(".");a.forEach((s,i)=>{i===a.length-1?n[s]=r:((!n[s]||typeof n[s]!="object"||Array.isArray(n[s])||n[s]instanceof File)&&(n[s]=Object.create(null)),n=n[s])})},jr=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},la=e=>{const{groups:t,path:r}=da(e),n=jr(r);return ca(n,t)},da=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,n)=>{const a=`@${n}`;return t.push([a,r]),a}),{groups:t,path:e}},ca=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[n]=t[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[r][1]);break}}return e},Nt={},ua=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const n=`${e}#${t}`;return Nt[n]||(r[2]?Nt[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Nt[n]=[e,r[1],!0]),Nt[n]}return null},nr=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},ma=e=>nr(e,decodeURI),Pr=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let n=r;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const s=t.indexOf("?",n),i=t.indexOf("#",n),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(r,o);return ma(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63||a===35)break}return t.slice(r,n)},pa=e=>{const t=Pr(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Qe=(e,t,...r)=>(r.length&&(t=Qe(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ur=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&n===""?r.push("/"):r.push(n);const s=a.replace("?","");n+="/"+s,r.push(n)}else n+="/"+a}),r.filter((a,s,i)=>i.indexOf(a)===s)},Wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?nr(e,Fr):e):e,Hr=(e,t,r)=>{let n;if(!r&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,d=e.indexOf("&",l);return Wt(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(n&&(l=Wt(l)),s=i,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),n&&(d=Wt(d))),r?(a[l]&&Array.isArray(a[l])||(a[l]=[]),a[l].push(d)):a[l]??(a[l]=d)}return t?a[t]:a},ha=Hr,ga=(e,t)=>Hr(e,t,!0),Fr=decodeURIComponent,gr=e=>nr(e,Fr),nt,he,Re,Wr,qr,Zt,Ie,Ir,Gr=(Ir=class{constructor(e,t="/",r=[[]]){z(this,Re);L(this,"raw");z(this,nt);z(this,he);L(this,"routeIndex",0);L(this,"path");L(this,"bodyCache",{});z(this,Ie,e=>{const{bodyCache:t,raw:r}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(s=>(a==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,P(this,he,r),P(this,nt,{})}param(e){return e?V(this,Re,Wr).call(this,e):V(this,Re,qr).call(this)}query(e){return ha(this.url,e)}queries(e){return ga(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,n)=>{t[n]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await na(this,e))}json(){return k(this,Ie).call(this,"text").then(e=>JSON.parse(e))}text(){return k(this,Ie).call(this,"text")}arrayBuffer(){return k(this,Ie).call(this,"arrayBuffer")}blob(){return k(this,Ie).call(this,"blob")}formData(){return k(this,Ie).call(this,"formData")}addValidatedData(e,t){k(this,nt)[e]=t}valid(e){return k(this,nt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ra](){return k(this,he)}get matchedRoutes(){return k(this,he)[0].map(([[,e]])=>e)}get routePath(){return k(this,he)[0].map(([[,e]])=>e)[this.routeIndex].path}},nt=new WeakMap,he=new WeakMap,Re=new WeakSet,Wr=function(e){const t=k(this,he)[0][this.routeIndex][1][e],r=V(this,Re,Zt).call(this,t);return r&&/\%/.test(r)?gr(r):r},qr=function(){const e={},t=Object.keys(k(this,he)[0][this.routeIndex][1]);for(const r of t){const n=V(this,Re,Zt).call(this,k(this,he)[0][this.routeIndex][1][r]);n!==void 0&&(e[r]=/\%/.test(n)?gr(n):n)}return e},Zt=function(e){return k(this,he)[1]?k(this,he)[1][e]:e},Ie=new WeakMap,Ir),fa={Stringify:1},zr=async(e,t,r,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(a?a[0]+=e:a=[e],Promise.all(s.map(o=>o({phase:t,buffer:a,context:n}))).then(o=>Promise.all(o.filter(Boolean).map(l=>zr(l,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},ya="text/plain; charset=UTF-8",qt=(e,t)=>({"Content-Type":e,...t}),Et,Tt,Se,at,xe,me,St,st,it,We,xt,kt,Ae,et,Ar,va=(Ar=class{constructor(e,t){z(this,Ae);z(this,Et);z(this,Tt);L(this,"env",{});z(this,Se);L(this,"finalized",!1);L(this,"error");z(this,at);z(this,xe);z(this,me);z(this,St);z(this,st);z(this,it);z(this,We);z(this,xt);z(this,kt);L(this,"render",(...e)=>(k(this,st)??P(this,st,t=>this.html(t)),k(this,st).call(this,...e)));L(this,"setLayout",e=>P(this,St,e));L(this,"getLayout",()=>k(this,St));L(this,"setRenderer",e=>{P(this,st,e)});L(this,"header",(e,t,r)=>{this.finalized&&P(this,me,new Response(k(this,me).body,k(this,me)));const n=k(this,me)?k(this,me).headers:k(this,We)??P(this,We,new Headers);t===void 0?n.delete(e):r!=null&&r.append?n.append(e,t):n.set(e,t)});L(this,"status",e=>{P(this,at,e)});L(this,"set",(e,t)=>{k(this,Se)??P(this,Se,new Map),k(this,Se).set(e,t)});L(this,"get",e=>k(this,Se)?k(this,Se).get(e):void 0);L(this,"newResponse",(...e)=>V(this,Ae,et).call(this,...e));L(this,"body",(e,t,r)=>V(this,Ae,et).call(this,e,t,r));L(this,"text",(e,t,r)=>!k(this,We)&&!k(this,at)&&!t&&!r&&!this.finalized?new Response(e):V(this,Ae,et).call(this,e,t,qt(ya,r)));L(this,"json",(e,t,r)=>V(this,Ae,et).call(this,JSON.stringify(e),t,qt("application/json",r)));L(this,"html",(e,t,r)=>{const n=a=>V(this,Ae,et).call(this,a,t,qt("text/html; charset=UTF-8",r));return typeof e=="object"?zr(e,fa.Stringify,!1,{}).then(n):n(e)});L(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});L(this,"notFound",()=>(k(this,it)??P(this,it,()=>new Response),k(this,it).call(this,this)));P(this,Et,e),t&&(P(this,xe,t.executionCtx),this.env=t.env,P(this,it,t.notFoundHandler),P(this,kt,t.path),P(this,xt,t.matchResult))}get req(){return k(this,Tt)??P(this,Tt,new Gr(k(this,Et),k(this,kt),k(this,xt))),k(this,Tt)}get event(){if(k(this,xe)&&"respondWith"in k(this,xe))return k(this,xe);throw Error("This context has no FetchEvent")}get executionCtx(){if(k(this,xe))return k(this,xe);throw Error("This context has no ExecutionContext")}get res(){return k(this,me)||P(this,me,new Response(null,{headers:k(this,We)??P(this,We,new Headers)}))}set res(e){if(k(this,me)&&e){e=new Response(e.body,e);for(const[t,r]of k(this,me).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=k(this,me).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,r)}P(this,me,e),this.finalized=!0}get var(){return k(this,Se)?Object.fromEntries(k(this,Se)):{}}},Et=new WeakMap,Tt=new WeakMap,Se=new WeakMap,at=new WeakMap,xe=new WeakMap,me=new WeakMap,St=new WeakMap,st=new WeakMap,it=new WeakMap,We=new WeakMap,xt=new WeakMap,kt=new WeakMap,Ae=new WeakSet,et=function(e,t,r){const n=k(this,me)?new Headers(k(this,me).headers):k(this,We)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?n.append(i,o):n.set(i,o)}if(r)for(const[s,i]of Object.entries(r))if(typeof i=="string")n.set(s,i);else{n.delete(s);for(const o of i)n.append(s,o)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??k(this,at);return new Response(e,{status:a,headers:n})},Ar),ae="ALL",wa="all",ba=["get","post","put","delete","options","patch"],Kr="Can not add a route since the matcher is already built.",Yr=class extends Error{},_a="__COMPOSED_HANDLER",Ea=e=>e.text("404 Not Found",404),fr=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},ye,se,Jr,ve,Fe,Ct,It,ot,Ta=(ot=class{constructor(t={}){z(this,se);L(this,"get");L(this,"post");L(this,"put");L(this,"delete");L(this,"options");L(this,"patch");L(this,"all");L(this,"on");L(this,"use");L(this,"router");L(this,"getPath");L(this,"_basePath","/");z(this,ye,"/");L(this,"routes",[]);z(this,ve,Ea);L(this,"errorHandler",fr);L(this,"onError",t=>(this.errorHandler=t,this));L(this,"notFound",t=>(P(this,ve,t),this));L(this,"fetch",(t,...r)=>V(this,se,It).call(this,t,r[1],r[0],t.method));L(this,"request",(t,r,n,a)=>t instanceof Request?this.fetch(r?new Request(t,r):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Qe("/",t)}`,r),n,a)));L(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(V(this,se,It).call(this,t.request,t,void 0,t.request.method))})});[...ba,wa].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?P(this,ye,i):V(this,se,Fe).call(this,s,k(this,ye),i),o.forEach(l=>{V(this,se,Fe).call(this,s,k(this,ye),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){P(this,ye,l);for(const d of[s].flat())o.map(c=>{V(this,se,Fe).call(this,d.toUpperCase(),k(this,ye),c)})}return this},this.use=(s,...i)=>(typeof s=="string"?P(this,ye,s):(P(this,ye,"*"),i.unshift(s)),i.forEach(o=>{V(this,se,Fe).call(this,ae,k(this,ye),o)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??Pr:pa}route(t,r){const n=this.basePath(t);return r.routes.map(a=>{var i;let s;r.errorHandler===fr?s=a.handler:(s=async(o,l)=>(await hr([],r.errorHandler)(o,()=>a.handler(o,l))).res,s[_a]=a.handler),V(i=n,se,Fe).call(i,a.method,a.path,s)}),this}basePath(t){const r=V(this,se,Jr).call(this);return r._basePath=Qe(this._basePath,t),r}mount(t,r,n){let a,s;n&&(typeof n=="function"?s=n:(s=n.optionHandler,n.replaceRequest===!1?a=l=>l:a=n.replaceRequest));const i=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};a||(a=(()=>{const l=Qe(this._basePath,t),d=l==="/"?0:l.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const o=async(l,d)=>{const c=await r(a(l.req.raw),...i(l));if(c)return c;await d()};return V(this,se,Fe).call(this,ae,Qe(t,"*"),o),this}},ye=new WeakMap,se=new WeakSet,Jr=function(){const t=new ot({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,P(t,ve,k(this,ve)),t.routes=this.routes,t},ve=new WeakMap,Fe=function(t,r,n){t=t.toUpperCase(),r=Qe(this._basePath,r);const a={basePath:this._basePath,path:r,method:t,handler:n};this.router.add(t,r,[n,a]),this.routes.push(a)},Ct=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},It=function(t,r,n,a){if(a==="HEAD")return(async()=>new Response(null,await V(this,se,It).call(this,t,r,n,"GET")))();const s=this.getPath(t,{env:n}),i=this.router.match(a,s),o=new va(t,{path:s,matchResult:i,env:n,executionCtx:r,notFoundHandler:k(this,ve)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await k(this,ve).call(this,o)})}catch(c){return V(this,se,Ct).call(this,c,o)}return d instanceof Promise?d.then(c=>c||(o.finalized?o.res:k(this,ve).call(this,o))).catch(c=>V(this,se,Ct).call(this,c,o)):d??k(this,ve).call(this,o)}const l=hr(i[0],this.errorHandler,k(this,ve));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return V(this,se,Ct).call(this,d,o)}})()},ot),Vr=[];function Sa(e,t){const r=this.buildAllMatchers(),n=((a,s)=>{const i=r[a]||r[ae],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],Vr];const d=l.indexOf("",1);return[i[1][d],l]});return this.match=n,n(e,t)}var Lt="[^/]+",vt=".*",wt="(?:|/.*)",tt=Symbol(),xa=new Set(".\\+*[^]$()");function ka(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===vt||e===wt?1:t===vt||t===wt?-1:e===Lt?1:t===Lt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var qe,ze,we,Je,Da=(Je=class{constructor(){z(this,qe);z(this,ze);z(this,we,Object.create(null))}insert(t,r,n,a,s){if(t.length===0){if(k(this,qe)!==void 0)throw tt;if(s)return;P(this,qe,r);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",vt]:["","",Lt]:i==="/*"?["","",wt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let m=l[2]||Lt;if(c&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw tt;if(d=k(this,we)[m],!d){if(Object.keys(k(this,we)).some(h=>h!==vt&&h!==wt))throw tt;if(s)return;d=k(this,we)[m]=new Je,c!==""&&P(d,ze,a.varIndex++)}!s&&c!==""&&n.push([c,k(d,ze)])}else if(d=k(this,we)[i],!d){if(Object.keys(k(this,we)).some(c=>c.length>1&&c!==vt&&c!==wt))throw tt;if(s)return;d=k(this,we)[i]=new Je}d.insert(o,r,n,a,s)}buildRegExpStr(){const r=Object.keys(k(this,we)).sort(ka).map(n=>{const a=k(this,we)[n];return(typeof k(a,ze)=="number"?`(${n})@${k(a,ze)}`:xa.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof k(this,qe)=="number"&&r.unshift(`#${k(this,qe)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},qe=new WeakMap,ze=new WeakMap,we=new WeakMap,Je),Bt,Dt,Lr,Ra=(Lr=class{constructor(){z(this,Bt,{varIndex:0});z(this,Dt,new Da)}insert(e,t,r){const n=[],a=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return a[i]=[d,l],i++,o=!0,d}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=a.length-1;i>=0;i--){const[o]=a[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,a[i][1]);break}}return k(this,Dt).insert(s,t,n,k(this,Bt),r),n}buildRegExp(){let e=k(this,Dt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,s,i)=>s!==void 0?(r[++t]=Number(s),"$()"):(i!==void 0&&(n[Number(i)]=++t),"")),[new RegExp(`^${e}`),r,n]}},Bt=new WeakMap,Dt=new WeakMap,Lr),Oa=[/^$/,[],Object.create(null)],At=Object.create(null);function Zr(e){return At[e]??(At[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Na(){At=Object.create(null)}function Ca(e){var d;const t=new Ra,r=[];if(e.length===0)return Oa;const n=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[h,_])=>c?1:h?-1:m.length-_.length),a=Object.create(null);for(let c=0,m=-1,h=n.length;c<h;c++){const[_,f,b]=n[c];_?a[f]=[b.map(([S])=>[S,Object.create(null)]),Vr]:m++;let v;try{v=t.insert(f,m,_)}catch(S){throw S===tt?new Yr(f):S}_||(r[m]=b.map(([S,E])=>{const R=Object.create(null);for(E-=1;E>=0;E--){const[I,$]=v[E];R[I]=$}return[S,R]}))}const[s,i,o]=t.buildRegExp();for(let c=0,m=r.length;c<m;c++)for(let h=0,_=r[c].length;h<_;h++){const f=(d=r[c][h])==null?void 0:d[1];if(!f)continue;const b=Object.keys(f);for(let v=0,S=b.length;v<S;v++)f[b[v]]=o[f[b[v]]]}const l=[];for(const c in i)l[c]=r[i[c]];return[s,l,a]}function Ze(e,t){if(e){for(const r of Object.keys(e).sort((n,a)=>a.length-n.length))if(Zr(r).test(t))return[...e[r]]}}var Le,Me,jt,Xr,Mr,Ia=(Mr=class{constructor(){z(this,jt);L(this,"name","RegExpRouter");z(this,Le);z(this,Me);L(this,"match",Sa);P(this,Le,{[ae]:Object.create(null)}),P(this,Me,{[ae]:Object.create(null)})}add(e,t,r){var o;const n=k(this,Le),a=k(this,Me);if(!n||!a)throw new Error(Kr);n[e]||[n,a].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ae]).forEach(d=>{l[e][d]=[...l[ae][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Zr(t);e===ae?Object.keys(n).forEach(d=>{var c;(c=n[d])[t]||(c[t]=Ze(n[d],t)||Ze(n[ae],t)||[])}):(o=n[e])[t]||(o[t]=Ze(n[e],t)||Ze(n[ae],t)||[]),Object.keys(n).forEach(d=>{(e===ae||e===d)&&Object.keys(n[d]).forEach(c=>{l.test(c)&&n[d][c].push([r,s])})}),Object.keys(a).forEach(d=>{(e===ae||e===d)&&Object.keys(a[d]).forEach(c=>l.test(c)&&a[d][c].push([r,s]))});return}const i=Ur(t)||[t];for(let l=0,d=i.length;l<d;l++){const c=i[l];Object.keys(a).forEach(m=>{var h;(e===ae||e===m)&&((h=a[m])[c]||(h[c]=[...Ze(n[m],c)||Ze(n[ae],c)||[]]),a[m][c].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(k(this,Me)).concat(Object.keys(k(this,Le))).forEach(t=>{e[t]||(e[t]=V(this,jt,Xr).call(this,t))}),P(this,Le,P(this,Me,void 0)),Na(),e}},Le=new WeakMap,Me=new WeakMap,jt=new WeakSet,Xr=function(e){const t=[];let r=e===ae;return[k(this,Le),k(this,Me)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(s=>[s,n[e][s]]):[];a.length!==0?(r||(r=!0),t.push(...a)):e!==ae&&t.push(...Object.keys(n[ae]).map(s=>[s,n[ae][s]]))}),r?Ca(t):null},Mr),$e,ke,$r,Aa=($r=class{constructor(e){L(this,"name","SmartRouter");z(this,$e,[]);z(this,ke,[]);P(this,$e,e.routers)}add(e,t,r){if(!k(this,ke))throw new Error(Kr);k(this,ke).push([e,t,r])}match(e,t){if(!k(this,ke))throw new Error("Fatal error");const r=k(this,$e),n=k(this,ke),a=r.length;let s=0,i;for(;s<a;s++){const o=r[s];try{for(let l=0,d=n.length;l<d;l++)o.add(...n[l]);i=o.match(e,t)}catch(l){if(l instanceof Yr)continue;throw l}this.match=o.match.bind(o),P(this,$e,[o]),P(this,ke,void 0);break}if(s===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(k(this,ke)||k(this,$e).length!==1)throw new Error("No active router has been determined yet.");return k(this,$e)[0]}},$e=new WeakMap,ke=new WeakMap,$r),gt=Object.create(null),Be,le,Ke,lt,ie,De,Ge,dt,La=(dt=class{constructor(t,r,n){z(this,De);z(this,Be);z(this,le);z(this,Ke);z(this,lt,0);z(this,ie,gt);if(P(this,le,n||Object.create(null)),P(this,Be,[]),t&&r){const a=Object.create(null);a[t]={handler:r,possibleKeys:[],score:0},P(this,Be,[a])}P(this,Ke,[])}insert(t,r,n){P(this,lt,++pr(this,lt)._);let a=this;const s=la(r),i=[];for(let o=0,l=s.length;o<l;o++){const d=s[o],c=s[o+1],m=ua(d,c),h=Array.isArray(m)?m[0]:d;if(h in k(a,le)){a=k(a,le)[h],m&&i.push(m[1]);continue}k(a,le)[h]=new dt,m&&(k(a,Ke).push(m),i.push(m[1])),a=k(a,le)[h]}return k(a,Be).push({[t]:{handler:n,possibleKeys:i.filter((o,l,d)=>d.indexOf(o)===l),score:k(this,lt)}}),a}search(t,r){var l;const n=[];P(this,ie,gt);let s=[this];const i=jr(r),o=[];for(let d=0,c=i.length;d<c;d++){const m=i[d],h=d===c-1,_=[];for(let f=0,b=s.length;f<b;f++){const v=s[f],S=k(v,le)[m];S&&(P(S,ie,k(v,ie)),h?(k(S,le)["*"]&&n.push(...V(this,De,Ge).call(this,k(S,le)["*"],t,k(v,ie))),n.push(...V(this,De,Ge).call(this,S,t,k(v,ie)))):_.push(S));for(let E=0,R=k(v,Ke).length;E<R;E++){const I=k(v,Ke)[E],$=k(v,ie)===gt?{}:{...k(v,ie)};if(I==="*"){const O=k(v,le)["*"];O&&(n.push(...V(this,De,Ge).call(this,O,t,k(v,ie))),P(O,ie,$),_.push(O));continue}const[G,F,j]=I;if(!m&&!(j instanceof RegExp))continue;const W=k(v,le)[G],q=i.slice(d).join("/");if(j instanceof RegExp){const O=j.exec(q);if(O){if($[F]=O[0],n.push(...V(this,De,Ge).call(this,W,t,k(v,ie),$)),Object.keys(k(W,le)).length){P(W,ie,$);const H=((l=O[0].match(/\//))==null?void 0:l.length)??0;(o[H]||(o[H]=[])).push(W)}continue}}(j===!0||j.test(m))&&($[F]=m,h?(n.push(...V(this,De,Ge).call(this,W,t,$,k(v,ie))),k(W,le)["*"]&&n.push(...V(this,De,Ge).call(this,k(W,le)["*"],t,$,k(v,ie)))):(P(W,ie,$),_.push(W)))}}s=_.concat(o.shift()??[])}return n.length>1&&n.sort((d,c)=>d.score-c.score),[n.map(({handler:d,params:c})=>[d,c])]}},Be=new WeakMap,le=new WeakMap,Ke=new WeakMap,lt=new WeakMap,ie=new WeakMap,De=new WeakSet,Ge=function(t,r,n,a){const s=[];for(let i=0,o=k(t,Be).length;i<o;i++){const l=k(t,Be)[i],d=l[r]||l[ae],c={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),n!==gt||a&&a!==gt))for(let m=0,h=d.possibleKeys.length;m<h;m++){const _=d.possibleKeys[m],f=c[d.score];d.params[_]=a!=null&&a[_]&&!f?a[_]:n[_]??(a==null?void 0:a[_]),c[d.score]=!0}}return s},dt),Ye,Br,Ma=(Br=class{constructor(){L(this,"name","TrieRouter");z(this,Ye);P(this,Ye,new La)}add(e,t,r){const n=Ur(t);if(n){for(let a=0,s=n.length;a<s;a++)k(this,Ye).insert(e,n[a],r);return}k(this,Ye).insert(e,t,r)}match(e,t){return k(this,Ye).search(e,t)}},Ye=new WeakMap,Br),pe=class extends Ta{constructor(e={}){super(e),this.router=e.router??new Aa({routers:[new Ia,new Ma]})}},$a=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(r.origin),a=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(i,o){var c;function l(m,h){i.res.headers.set(m,h)}const d=await n(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(c=r.exposeHeaders)!=null&&c.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),i.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const m=await a(i.req.header("origin")||"",i);m.length&&l("Access-Control-Allow-Methods",m.join(","));let h=r.allowHeaders;if(!(h!=null&&h.length)){const _=i.req.header("Access-Control-Request-Headers");_&&(h=_.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),r.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Qr(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${n} API credit balance or key.`;const{decrypt:d}=await Promise.resolve().then(()=>Ut),c=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(c!=null&&c.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const h=await d(m.encrypted_value,c.pin_hash);await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function yr(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class nn{constructor(t,r="claude-sonnet-4-20250514",n="https://api.anthropic.com",a="anthropic"){L(this,"name");L(this,"apiKey");L(this,"model");L(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=n,this.name=a}async chat(t,r){var c,m,h,_;const n=t.find(f=>f.role==="system"),a=t.filter(f=>f.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:a.map(f=>({role:f.role,content:f.content}))};n&&(s.system=n.content),r!=null&&r.tools&&r.tools.length>0&&(s.tools=r.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})),r.toolChoice==="required"&&(s.tool_choice={type:"any"}));const i=await rn(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)}),this.name);if(!i.ok){const f=await i.text();throw new Error(this.name+" API error "+i.status+": "+f)}const o=await i.json(),l=((c=o.content)==null?void 0:c.filter(f=>f.type==="text"))||[],d=((m=o.content)==null?void 0:m.filter(f=>f.type==="tool_use"))||[];return{content:l.map(f=>f.text).join(`
`),toolCalls:d.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((h=o.usage)==null?void 0:h.input_tokens)||0,completionTokens:((_=o.usage)==null?void 0:_.output_tokens)||0}}}async streamChat(t,r){const n=t.find(d=>d.role==="system"),a=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:a.map(d=>({role:d.role,content:d.content}))};n&&(s.system=n.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const d=await i.text();throw new Error(this.name+" stream error "+i.status+": "+d)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var f;const{done:c,value:m}=await o.read();if(c){d.close();return}const _=l.decode(m,{stream:!0}).split(`
`);for(const b of _)if(b.startsWith("data: ")){const v=b.slice(6);if(v==="[DONE]")continue;try{const S=JSON.parse(v);S.type==="content_block_delta"&&((f=S.delta)!=null&&f.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:S.delta.text})+`

`))}catch{}}}})}}function Pa(e){const t={},r=e||{};if(t.type=r.type||"object",t.type==="object"){const n=r.properties;if(n&&typeof n=="object"&&Object.keys(n).length>0){const a={};for(const[s,i]of Object.entries(n))i&&typeof i=="object"?a[s]=Xt(i):a[s]=i;t.properties=a}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(r.required)?t.required=r.required:t.required=[]}return r.description&&(t.description=r.description),t}function Xt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const r=t.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[a,s]of Object.entries(r))s&&typeof s=="object"?n[a]=Xt(s):n[a]=s;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Xt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class an{constructor(t,r,n,a){L(this,"name");L(this,"apiKey");L(this,"model");L(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=n.replace(/\/+$/,""),this.name=a}async chat(t,r){var l,d,c,m,h,_;const n={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},a=this.apiBase.includes("routellm.abacus.ai");if(r!=null&&r.tools&&r.tools.length>0&&a)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");r!=null&&r.tools&&r.tools.length>0&&(n.tools=r.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:Pa(f.parameters||{})}})),r.toolChoice==="required"&&(n.tool_choice="required"));const s=await rn(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(n)}),this.name);if(!s.ok){const f=await s.text();throw new Error(this.name+" API error "+s.status+": "+f)}const i=await s.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((d=o==null?void 0:o.message)==null?void 0:d.content)||"",toolCalls:(m=(c=o==null?void 0:o.message)==null?void 0:c.tool_calls)==null?void 0:m.map(f=>({id:f.id,name:f.function.name,arguments:(()=>{try{return typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=i.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((_=i.usage)==null?void 0:_.completion_tokens)||0}}}async streamChat(t,r){const n={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},a=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(n)});if(!a.ok){const o=await a.text();throw new Error(this.name+" stream error "+a.status+": "+o)}const s=a.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var h,_,f;const{done:l,value:d}=await s.read();if(l){o.close();return}const m=i.decode(d,{stream:!0}).split(`
`);for(const b of m)if(b.startsWith("data: ")){const v=b.slice(6);if(v==="[DONE]")continue;try{const E=(f=(_=(h=JSON.parse(v).choices)==null?void 0:h[0])==null?void 0:_.delta)==null?void 0:f.content;E&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E})+`

`))}catch{}}}})}}function Qt(e,t,r,n){const a=bt[e];if(!a)throw new Error(`Unknown LLM provider: ${e}`);const s=n||a.defaultModel;return a.apiFormat==="anthropic"?new nn(t,s,a.apiBase,r):new an(t,s,a.apiBase,r)}class sn{constructor(){L(this,"errorLog",new Map);L(this,"usageLog",new Map)}async pickProvider(t){const r=Date.now(),n=t.filter(a=>{const s=this.errorLog.get(a);return s?s.cooldownUntil<=r:!0});return n.length>0?n[0]:null}async recordUsage(t,r){const n=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:n.tokens+r,requests:n.requests+1})}async recordError(t,r,n=5){this.errorLog.set(t,{error:r,cooldownUntil:Date.now()+n*60*1e3})}}const Ua=["llm_slot_1","llm_slot_2","llm_slot_3"],Ha=["anthropic","openai"];async function ut(e,t,r){const{decrypt:n}=await Promise.resolve().then(()=>Ut),a=new sn,s=[];for(const m of Ua){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const _=await n(h.encrypted_value,r),f=JSON.parse(_);if(f.provider&&f.apiKey&&bt[f.provider]){const v=f.provider,S=Qt(f.provider,f.apiKey,v,f.model);s.push({name:v,provider:S})}}catch(_){console.error(`Failed to load ${m}:`,_)}}const i=new Set(s.map(m=>m.name));for(const m of Ha){if(i.has(m))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const _=await n(h.encrypted_value,r);if(bt[m]){const b=Qt(m,_,m);s.push({name:m,provider:b})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=s.map(m=>m.name),l=await a.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:a};const d=s.find(m=>m.name===l);return{provider:Fa(d.provider,s,a,e,t),rotation:a}}function Fa(e,t,r,n,a){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"";throw s(c)&&!c.includes("TOOLS_UNSUPPORTED")&&zt(n,a,"all_providers_down",e.name,null,c),d}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"",m=i(c);if(!s(c)&&!m)throw d;const h=c.includes("TOOLS_UNSUPPORTED"),_=h?1:m?10:1440;console.warn(`Provider ${e.name} ${m?"rate limited":h?"tools unsupported":"auth/billing error"}, trying fallback...`),await r.recordError(e.name,c,_);const f=t.filter(b=>b.name!==e.name);for(const b of f)try{const v=await b.provider.chat(o,l);return this.name=b.name,!h&&!m&&zt(n,a,"provider_switched",e.name,b.name,c),v}catch(v){const S=v.message||"";if(s(S)||i(S)){await r.recordError(b.name,S,i(S)?10:1440);continue}throw v}throw zt(n,a,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const rt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:nn,OpenAICompatibleProvider:an,ProviderRotation:sn,createProviderFromConfig:Qt,createRotatingProvider:ut,logError:U},Symbol.toStringTag,{value:"Module"})),Kt=20,Ga=2e3,Wa=2e3,on=4;function qa(e){return Math.ceil(e.length/on)}function vr(e,t){const r=t*on;return e.length<=r?e:e.slice(0,r)+`
[...truncated to fit token budget]`}class Y{constructor(t){this.db=t}async store(t,r,n,a,s=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,r,n).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(a,s,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,n,a,s,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       ...
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((r==null?void 0:r.cnt)||0)>Kt){const n=((r==null?void 0:r.cnt)||0)-Kt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
...
${n}
`:"",o=Tr(t,hs);return`You are ${a} — a personal AI assistant. Your name is ${a} — always refer to yourself by this name if asked.
...
- **Long content intent check**: When asked to write long-form content (essay, article, report — likely over 200 words) WITHOUT a save destination specified, do NOT start writing. Ask first: "Should I save this as a Google Doc and send you the link, or write it here in chat?" Wait for the response. If Drive/Doc, call \`create_doc\` with full content and return only the link. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**`:""}`}async function Vt(e,t,r){var d;const a=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${r.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=a.files)==null?void 0:d.length)>0?s=a.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:r,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:r}}function $t(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").trim()}function Bn(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function _t(e,t,r,n,a,s,i,o,l,d,c,m,h){const _=Date.now();let f=!0,b="",v="";try{return v=await fs(e,t,r,n,s,i,o,l,d,c,m,h),v}catch(S){throw f=!1,b=S.message||"Unknown error",S}finally{const S=Date.now()-_;try{await r.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n,a.agentType||null,a.providerName||null,e,JSON.stringify(t).substring(0,2e3),(f?v:"").substring(0,500),f?1:0,b||null,S,a.isEnforcementRetry?1:0,a.channel||"web").run()}catch{}}}function jn(e){const t=e.length;for(let r=0;r<t-1;r++){const n=e[r];if(n.role!=="user"||typeof n.content!="string")continue;const a=t-1-r,s=a<=2?12e3:a<=4?5e3:2e3;n.content.length>s&&(e[r]={...n,content:n.content.substring(0,s)+`
[...truncated in history to reduce context size]`})}}function gs(e){const t=[];let r=[],n="",a=!1,s=0;const i=e.length;for(;s<i;){const o=e[s];if(a){if(o==='"'){if(e[s+1]==='"'){n+='"',s+=2;continue}a=!1,s++;continue}n+=o,s++;continue}if(o==='"'){a=!0,s++;continue}if(o===","){r.push(n),n="",s++;continue}if(o==="\r"&&e[s+1]===`
`){r.push(n),t.push(r),r=[],n="",s+=2;continue}if(o===`
`||o==="\r"){r.push(n),t.push(r),r=[],n="",s++;continue}n+=o,s++}for((n||r.length)&&(r.push(n),t.push(r));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function fs(e,t,r,n,a,s,i,o,l,d,c,m){var _,f,b,v,S,E,R,I,$,G,F,j,W,q,O,H;const h=new Y(r);switch(e){case"create_schedule":{const u=new Date;let y;const p=d||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(u.getTime()+t.minutes_from_now*60*1e3);const D=y.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[C,B,N]=(D[0]||"").split("/");t.schedule_value=`${N}-${C}-${B} ${D[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);y=new Date(u.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const T=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(T)){const[C,B]=t.schedule_value.split(":").map(Number),N=u.toLocaleString("en-US",{timeZone:p}),A=new Date(N),M=new Date(A);M.setHours(C,B,0,0),M<=A&&M.setDate(M.getDate()+1);const K=new Date(M.toLocaleString("en-US",{timeZone:"UTC"})),Z=new Date(M.toLocaleString("en-US",{timeZone:p})),Q=K.getTime()-Z.getTime();y=new Date(M.getTime()+Q)}else{const[C,B]=t.schedule_value.split(":").map(Number),N=u.toLocaleString("en-US",{timeZone:p}),A=new Date(N),M=new Date(A);M.setHours(C,B,0,0),M<=A&&M.setDate(M.getDate()+1);const K=pt=>String(pt).padStart(2,"0"),Z=M.getFullYear(),Q=K(M.getMonth()+1),ee=K(M.getDate());t.schedule_value=`${Z}-${Q}-${ee} ${K(C)}:${K(B)}`,t.schedule_type="once";const ne=new Date(M.toLocaleString("en-US",{timeZone:"UTC"})),ce=new Date(M.toLocaleString("en-US",{timeZone:p})),Ce=ne.getTime()-ce.getTime();y=new Date(M.getTime()+Ce)}}else if(t.schedule_type==="daily"){const[T,D]=t.schedule_value.split(":").map(Number),C=u.toLocaleString("en-US",{timeZone:p}),B=new Date(C),N=new Date(B);N.setHours(T,D,0,0),N<=B&&N.setDate(N.getDate()+1);const A=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),M=new Date(N.toLocaleString("en-US",{timeZone:p})),K=A.getTime()-M.getTime();y=new Date(N.getTime()+K)}else if(t.schedule_type==="weekly"){const[T,D]=t.schedule_value.split(" "),[C,B]=(D||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ce=>Ce.toLowerCase()===T.toLowerCase()),M=u.toLocaleString("en-US",{timeZone:p}),K=new Date(M),Z=new Date(K);Z.setHours(C,B,0,0);let Q=(A-Z.getDay()+7)%7;Q===0&&Z<=K&&(Q=7),Z.setDate(Z.getDate()+Q);const ee=new Date(Z.toLocaleString("en-US",{timeZone:"UTC"})),ne=new Date(Z.toLocaleString("en-US",{timeZone:p})),ce=ee.getTime()-ne.getTime();y=new Date(Z.getTime()+ce)}else if(t.schedule_type==="once"){const[T,D]=t.schedule_value.split(" "),[C,B,N]=T.split("-").map(Number),[A,M]=(D||"00:00").split(":").map(Number),K=u.toLocaleString("en-US",{timeZone:p}),Z=new Date(K),Q=new Date(Z);Q.setFullYear(C,B-1,N),Q.setHours(A,M,0,0);const ee=new Date(Q.toLocaleString("en-US",{timeZone:"UTC"})),ne=new Date(Q.toLocaleString("en-US",{timeZone:p})),ce=ee.getTime()-ne.getTime();y=new Date(Q.getTime()+ce);const Ce=new Date(u.getTime()+120*1e3);if(y.getTime()<u.getTime()+60*1e3){const pt=y.toISOString();y=Ce;const ht=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${pt} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=ht}}else y=new Date(u.getTime()+3600*1e3);if(t.action_type==="custom"&&t.schedule_type==="once"){const T=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(T)||(t.action_type="reminder")}if(await r.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(n,t.name,t.schedule_type,t.schedule_value).first()){const T=y.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${T} (${p}). No duplicate created.`}await r.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(n,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),y.toISOString()).run();const w=t._pastTimeWarning||"",x=y.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${x} (${p}). [UTC: ${y.toISOString()}]${w}. IMPORTANT: Use the exact time "${x}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const y=(await r.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(n).all()).results||[];return y.length===0?"No scheduled tasks found.":y.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,y=u?"active":"paused";return await r.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,y,t.job_id,n).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],y=t.state;if(!u.includes(y))return`Invalid state "${y}". Valid states: ${u.join(", ")}`;const p=y==="completed"||y==="paused"?0:1;return await r.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,p,t.job_id,n).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"update_schedule":{const u=t.job_id,y=d||"UTC",p=new Date,g=["updated_at = CURRENT_TIMESTAMP"],w=[];t.name&&(g.push("name = ?"),w.push(t.name)),t.description&&(g.push("description = ?"),w.push(t.description));let x=null,T=t.schedule_type,D=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){x=new Date(p.getTime()+t.minutes_from_now*60*1e3);const N=x.toLocaleString("en-US",{timeZone:y,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[A,M,K]=(N[0]||"").split("/");D=`${K}-${A}-${M} ${N[1]||"00:00"}`,T="once"}else if(T&&D){if(T==="interval")x=new Date(p.getTime()+parseInt(D,10)*60*1e3);else if(T==="daily"){const[B,N]=D.split(":").map(Number),A=new Date(p.toLocaleString("en-US",{timeZone:y})),M=new Date(A);M.setHours(B,N,0,0),M<=A&&M.setDate(M.getDate()+1);const K=new Date(M.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(M.toLocaleString("en-US",{timeZone:y})).getTime();x=new Date(M.getTime()+K)}else if(T==="weekly"){const[B,N]=D.split(" "),[A,M]=(N||"00:00").split(":").map(Number),Z=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ce=>Ce.toLowerCase()===B.toLowerCase()),Q=new Date(p.toLocaleString("en-US",{timeZone:y})),ee=new Date(Q);ee.setHours(A,M,0,0);let ne=(Z-ee.getDay()+7)%7;ne===0&&ee<=Q&&(ne=7),ee.setDate(ee.getDate()+ne);const ce=new Date(ee.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(ee.toLocaleString("en-US",{timeZone:y})).getTime();x=new Date(ee.getTime()+ce)}else if(T==="once"){const[B,N]=D.split(" "),[A,M,K]=B.split("-").map(Number),[Z,Q]=(N||"00:00").split(":").map(Number),ee=new Date(p.toLocaleString("en-US",{timeZone:y})),ne=new Date(ee);ne.setFullYear(A,M-1,K),ne.setHours(Z,Q,0,0);const ce=new Date(ne.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(ne.toLocaleString("en-US",{timeZone:y})).getTime();x=new Date(ne.getTime()+ce),x.getTime()<p.getTime()+60*1e3&&(x=new Date(p.getTime()+120*1e3))}}if(T&&(g.push("schedule_type = ?"),w.push(T)),D&&(g.push("schedule_value = ?"),w.push(D)),x&&(g.push("next_run = ?"),w.push(x.toISOString())),g.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";w.push(u,n),await r.prepare(`UPDATE cron_jobs SET ${g.join(", ")} WHERE id = ? AND user_id = ?`).bind(...w).run();const C=x?x.toLocaleString("en-US",{timeZone:y,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${C?` New fire time: ${C} (${y}).`:""} IMPORTANT: Use this exact time "${C}" when confirming to the user.`}case"delete_schedule":return await r.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,n).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,y=t.type==="task"?"preference":t.type,p=u>=7?"working":"long_term";return await h.store(n,y,t.title,t.content,u,p),`Stored in ${p==="working"?"working":"long-term"} memory: [${y}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await h.search(n,t.query);return u.length===0?"No matching memories found.":u.map(y=>`[id:${y.id}] [${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!a)return"Authentication context unavailable.";try{const u=new ue(r,n,a,s||"",i||""),y=t.spreadsheet_id;let p=t.range;const g=await u.sheets.getMetadata(y),w=g.sheets;p.includes("!")||(p=`${w[0]}!${p}`);let x;try{x=await u.sheets.readRange(y,p)}catch(D){if((_=D.message)!=null&&_.includes("Unable to parse range")||(f=D.message)!=null&&f.includes("400")){const C=p.includes("!")?p.split("!")[1]:p;p=`${w[0]}!${C}`,x=await u.sheets.readRange(y,p)}else throw D}let T=`[Spreadsheet: "${g.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${w.map(D=>`"${D}"`).join(", ")}]
...
`)}catch(u){return await U(r,n,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!a)return"Authentication context unavailable.";try{const u=new ue(r,n,a,s||"",i||"");if(!(await u.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const N=new Y(r),A=JSON.stringify(t.values);await N.store(n,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:A.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const p=t.values;let g=t.range;const T=Math.max(...p.map(N=>N.length))+4,D=p.map(N=>{const A=[...N];for(;A.length<T;)A.push("");return A}),C=g.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(C){const N=C[1]||"",A=C[2],M=C[3],K=C[5],Q=A.toUpperCase().charCodeAt(0)-64+T-1,ee=Q<=26?String.fromCharCode(64+Q):"Z";g=`${N}${A}${M}:${ee}${K}`}const B=await u.sheets.writeRange(t.spreadsheet_id,g,D);try{const N=new Y(r),A=await N.search(n,`Pending sheet write: ${t.spreadsheet_id}`);for(const M of A)M.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await N.remove(M.id,n)}catch{}return`Written ${B.updatedCells} cells to ${g}.`}catch(u){return await U(r,n,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!a)return"Authentication context unavailable.";try{const u=new ue(r,n,a,s||"",i||"");if(!(await u.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new Y(r).store(n,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const p=await u.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const g=new Y(r),w=await g.search(n,`Pending sheet append: ${t.spreadsheet_id}`);for(const x of w)x.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await g.remove(x.id,n)}catch{}return`Appended ${p.updatedCells} cells to ${t.range}.`}catch(u){return await U(r,n,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!a)return"Authentication context unavailable.";try{const u=new ue(r,n,a,s||"",i||"");if(!(await u.isConnected()).connected){if(t.title)try{await new Y(r).store(n,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`

The spreadsheet request has been saved to temporary memory. After reconnecting, tell me "create the pending spreadsheet" and I'll complete this automatically.`:"")}const p=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let g="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||"");g=`
Folder: "${(await Vt(w,p.spreadsheetId,t.folder_name)).folderName}"`}catch(w){g=`
...
Use append_to_doc with the document ID above to add content.`}let g="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||"");g=`
Folder: "${(await Vt(w,p.documentId,t.folder_name)).folderName}"`}catch(w){g=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${w.message})`}try{await new Y(r).store(n,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}try{const w=new Y(r),x=await w.search(n,`Pending Google Doc save: "${t.title}"`);for(const T of x)T.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await w.remove(T.id,n)}catch{}return`Document created: "${t.title}"${g}
ID: ${p.documentId}
URL: ${p.url}`}case"read_doc":{if(!a)return"Authentication context unavailable.";try{const y=await new ue(r,n,a,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${y.title}"
...
Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const g=await u.send(t.to,t.subject,t.body,{cc:t.cc});try{const w=new Y(r),x=await w.search(n,`Pending email: "${t.subject}"`);for(const T of x)T.title.startsWith(`Pending email: "${t.subject}"`)&&await w.remove(T.id,n)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${g.id}]`}catch(u){return await U(r,n,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!a)return"Authentication context unavailable.";try{const u=new be(r,n,a,s||"",i||"");if(!(await new ue(r,n,a,s||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new Y(r).store(n,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const g=await u.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const x=new Y(r),T=await x.search(n,`Pending draft: "${t.subject}"`);for(const D of T)D.title.startsWith(`Pending draft: "${t.subject}"`)&&await x.remove(D.id,n)}catch{}const w=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${w}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${g.id}]`}catch(u){return await U(r,n,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!a)return"Authentication context unavailable.";try{return await new be(r,n,a,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await U(r,n,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!a)return"Authentication context unavailable.";try{const y=await new be(r,n,a,s||"",i||"").getUnreadCount();return`You have ${y} unread email${y!==1?"s":""} in Gmail.`}catch(u){return(v=u.message)!=null&&v.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!a)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||""),y=new URLSearchParams;y.set("pageSize",String(t.max_results||10)),y.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),y.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",y.set("q",p);const g=await fetch(`https://www.googleapis.com/drive/v3/files?${y}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const w=await g.json();return(S=w.files)!=null&&S.length?w.files.map((x,T)=>{var N,A;const D=((N=x.mimeType)==null?void 0:N.split(".").pop())||x.mimeType,C=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",B=((A=x.modifiedTime)==null?void 0:A.split("T")[0])||"";return`${T+1}. **${x.name}** (${D})
   ${C} · Modified: ${B}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await U(r,n,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!a)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||""),y=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",y),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const g=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const w=await g.json();return(E=w.files)!=null&&E.length?w.files.map((x,T)=>{var B,N;const D=((B=x.mimeType)==null?void 0:B.split(".").pop())||x.mimeType,C=((N=x.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${T+1}. **${x.name}** (${D}) — Modified: ${C}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await U(r,n,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"drive_read_file":{if(!a)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||""),y=t.url_or_id.trim();let p=y;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const K of g){const Z=y.match(K);if(Z){p=Z[1];break}}const w=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${u}`}});if(!w.ok)throw new Error(`Drive API error (${w.status}): could not fetch file metadata`);const x=await w.json(),{name:T,mimeType:D}=x,C=t.extract_focus,B=C?`Focus specifically on extracting: ${C}`:"Extract and return all readable text content. Preserve structure where relevant.",N={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(N[D]){const K=N[D],Z=await fetch(`https://www.googleapis.com/drive/v3/files/${p}/export?mimeType=${encodeURIComponent(K)}`,{headers:{Authorization:`Bearer ${u}`}});if(!Z.ok)throw new Error(`Drive export error (${Z.status})`);const Q=await Z.text();if(D==="application/vnd.google-apps.spreadsheet"){const ee=gs(Q),ne=ee.length,ce=((R=ee[0])==null?void 0:R.length)??0;return`**${T}** (Google Sheet — ${ne} rows × ${ce} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(ee)}`}return`**${T}**

${Q.substring(0,2e4)}`}if(D==="application/pdf"||T.toLowerCase().endsWith(".pdf")){const K=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!K.ok)throw new Error(`Drive download error (${K.status})`);const Z=await K.arrayBuffer(),Q=Buffer.from(Z).toString("base64");let ee=null,ne="claude-haiku-4-5-20251001";for(const ht of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const ur=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,ht).first();if(ur&&a){const Qn=await J(ur.encrypted_value,a),Ot=JSON.parse(Qn);if(Ot.provider==="anthropic"){ee=Ot.apiKey,Ot.model&&(ne=Ot.model);break}}}catch{}if(!ee)return`"${T}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const ce=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":ee,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:ne,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:Q}},{type:"text",text:B}]}]})});if(!ce.ok){const ht=await ce.text();throw new Error(`Anthropic PDF extraction error: ${ht.substring(0,200)}`)}const pt=(($=(I=(await ce.json()).content)==null?void 0:I[0])==null?void 0:$.text)||"";return`**${T}** (PDF from Drive)

${pt}`}const A=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!A.ok)throw new Error(`Drive download error (${A.status})`);const M=await A.text();return`**${T}** (${D})

${M.substring(0,2e4)}`}catch(u){return await U(r,n,"google","drive_read_file",u.message),`Drive read error: ${u.message}`}}case"drive_delete_file":{if(!a)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||""),y=t.url_or_id.trim();let p=y;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const D of g){const C=y.match(D);if(C){p=C[1];break}}const w=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=name`,{headers:{Authorization:`Bearer ${u}`}});if(!w.ok)throw new Error(`Drive API error (${w.status})`);const x=await w.json(),T=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${u}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!T.ok)throw new Error(`Drive API error (${T.status})`);return`"${x.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(u){return await U(r,n,"google","drive_delete_file",u.message),`Drive delete error: ${u.message}`}}case"drive_organise":{if(!a)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,n,a,s||"",i||""),y=t.url_or_id.trim();let p=y;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const x of g){const T=y.match(x);if(T){p=T[1];break}}const w=[];if(t.new_name){const x=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${u}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!x.ok)throw new Error(`Drive rename error (${x.status})`);w.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:x}=await Vt(u,p,t.folder_name);w.push(`Moved to folder "${x}"`)}return w.join(". ")+"."}catch(u){return await U(r,n,"google","drive_organise",u.message),`Drive organise error: ${u.message}`}}case"web_search":try{const u=await Ht(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((y,p)=>`${p+1}. [${y.title}](${y.link})
   ${y.snippet}`).join(`

`)}catch(u){return await U(r,n,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>ls),g=await p(u,y);return g.error?`Failed to read page: ${g.error}`:!g.text||g.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${g.text.length} chars):

${g.text}`}catch(u){return await U(r,n,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!c)return"Research tool requires an LLM provider but none is available.";try{let u;try{const T=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"perplexity_api_key").first();T&&a&&(u=await J(T.encrypted_value,a))}catch{}const y=2e4,p=kn(t.query,c,{depth:t.depth||"quick",site:t.site,perplexityApiKey:u}),g=new Promise(T=>setTimeout(()=>T(null),y)),w=await Promise.race([p,g]);if(w===null){const{webSearch:T}=await Promise.resolve().then(()=>es),D=await T(t.query,{num:5});if(D.error||D.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let C=`Research took too long, but here are the top search results:

`;return C+=D.results.map((B,N)=>`${N+1}. [${B.title}](${B.link})
   ${B.snippet}`).join(`

`),C}if(w.error)return`Research failed: ${w.error}`;let x=w.report;w.sources.length>0&&(x+=`

---
**Sources** (`+w.pagesRead+` pages read):
`,x+=w.sources.map((T,D)=>`[${D+1}] [${T.title}](${T.url})`).join(`
`));try{const T=new Y(r),D=w.report.substring(0,600);await T.store(n,"context",`Research: ${t.query.substring(0,80)}`,D,6,"long_term")}catch{}return x}catch(u){return await U(r,n,"research","research",u.message),`Research error: ${u.message}`}}case"browser_task":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const y=(await J(u.encrypted_value,a)).trim();let p,g=t.task,w,x;if(t.site_name)try{const N=await r.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(n,t.site_name).first();if(N){const A=JSON.parse(await J(N.encrypted_blob,a));p={username:A.username,password:A.password},x=A.sessionId,w=N.id,g=`${g}

When prompted to log in, use username {username} and password {password}.`}}catch{}const T=await Rn(g,y,{secrets:p,sessionId:x}),D=async N=>{if(w)try{const A=await r.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(w,n).first();if(!A)return;const M=JSON.parse(await J(A.encrypted_blob,a));M.sessionId=N;const K=await ct(JSON.stringify(M),a);await r.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(K,w,n).run()}catch{}},C=async()=>{if(!(!w||!x))try{const N=await r.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(w,n).first();if(!N)return;const A=JSON.parse(await J(N.encrypted_blob,a));delete A.sessionId;const M=await ct(JSON.stringify(A),a);await r.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(M,w,n).run()}catch{}};if(T.status==="completed")return T.sessionId&&await D(T.sessionId),T.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again.";if(T.status==="timeout"){T.sessionId&&await D(T.sessionId);try{await new Y(r).store(n,"context",`Browser task in progress: ${T.taskId}`,JSON.stringify({task_id:T.taskId,task:t.task}),9,"working")}catch{}return`[BROWSER_TIMEOUT:${T.taskId}] Browser task did not finish within the time limit. Tell the user it is still running and ask them to follow up in 2–3 minutes.`}await C();const B=[T.error,T.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${T.taskId}\`): ${B||"No details returned. Check your Browser Use dashboard at cloud.browser-use.com."}`}catch(u){return await U(r,n,"browser","browser_task",u.message),`Browser task error: ${u.message}`}}case"browser_task_status":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured.";const y=await J(u.encrypted_value,a),p=await cs(t.task_id,y);if(p.done){try{const g=new Y(r),w=await g.search(n,`Browser task in progress: ${t.task_id}`);for(const x of w)await g.remove(x.id,n)}catch{}return p.status==="finished"||p.status==="completed"?p.output?p.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${p.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${p.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working. Ask me 'what happened with the browser task?' in 2–3 minutes."`}catch(u){return await U(r,n,"browser","browser_task_status",u.message),`Browser status check error: ${u.message}`}}case"vault_lookup":try{const u=(t.site_name||"").trim();if(!u)return"No site name provided.";const p=((await r.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(n,`%${u}%`).all()).results||[]).map(g=>g.name);return p.length===0?`No vault entries found matching "${u}".`:`Vault entries matching "${u}": ${p.join(", ")}. Use site_name="${p[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await J(u.encrypted_value,a),p=await yn(y,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((g,w)=>{const x=g.rating?` ★${g.rating} (${g.userRatingsTotal||0} reviews)`:"",T=g.openNow!==void 0?g.openNow?" · Open now":" · Closed":"",D=g.googleMapsUri?`
   ${g.googleMapsUri}`:"";return`${w+1}. **${g.name}**${x}${T}
   ${g.address}${D}
   [place_id: ${g.placeId}]`}).join(`

`)}catch(u){return await U(r,n,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await J(u.encrypted_value,a),p=await vn(y,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const g=p.details;let w=`**${g.name}**
...
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return w}catch(u){return await U(r,n,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await J(u.encrypted_value,a),p=await wn(y,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const g=p.route;let w=`**${g.startAddress}** → **${g.endAddress}**
`;return w+=`📏 ${g.distance} · ⏱️ ${g.duration}`,g.durationInTraffic&&(w+=` (with traffic: ${g.durationInTraffic})`),w+=`
via ${g.summary}`,w+=`

Steps:`,g.steps.forEach((x,T)=>{w+=`
${T+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),w}catch(u){return await U(r,n,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await J(u.encrypted_value,a),p=await Tn(y,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let g=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(g+=` (with traffic: ${p.durationInTraffic})`),g}catch(u){return await U(r,n,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await J(u.encrypted_value,a),p=await bn(y,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await U(r,n,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await J(u.encrypted_value,a),p=await En(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((g,w)=>{var x;return`${w+1}. **${g.title}**
   ${g.channelTitle} · ${((x=g.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${g.description}
   ${g.url}`}).join(`

`)}catch(u){return await U(r,n,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!a)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await J(u.encrypted_value,a),p=await _n(y,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((g,w)=>`${w+1}. ${g.address}
...
${p.extracted_text}`;const{file_name:g,file_type:w}=p;let{file_data:x}=p;if(x==="r2"){if(!m)return`File "${g}" is stored in R2 but no storage bucket is configured.`;const T=await m.get(u);if(!T)return`File "${g}" not found in storage. It may have been deleted.`;const D=await T.arrayBuffer();x=Buffer.from(D).toString("base64")}if(w.startsWith("text/"))try{const T=Buffer.from(x,"base64").toString("utf-8");return`Document: ${g}

${T.substring(0,2e4)}`}catch{return`Could not decode text file: ${g}`}if(w==="application/pdf"||w==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||g.toLowerCase().endsWith(".pdf")||g.toLowerCase().endsWith(".docx")){if(w==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||g.toLowerCase().endsWith(".docx")){try{const C=await On(Buffer.from(x,"base64"));if(C.length>50)return`Document: ${g}

${C.substring(0,2e4)}`}catch{}return`Could not extract text from "${g}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let T=null,D="claude-haiku-4-5-20251001";for(const C of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const B=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,C).first();if(B&&a){const N=await J(B.encrypted_value,a),A=JSON.parse(N);if(A.provider==="anthropic"){T=A.apiKey,A.model&&(D=A.model);break}}}catch{}if(T)try{const C=y?`Focus specifically on extracting: ${y}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",B=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":T,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:x}},{type:"text",text:C}]}]})});if(B.ok){const A=((F=(G=(await B.json()).content)==null?void 0:G[0])==null?void 0:F.text)||"";return`Document: ${g}

${A}`}else{const N=await B.text();return`Could not parse ${g} via Anthropic API: ${N.substring(0,200)}`}}catch(C){return`Document parsing error for ${g}: ${C.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}try{const T=Buffer.from(x,"base64").toString("utf-8").substring(0,2e3);return`Document: ${g} (${w})
...
${T}`}catch{return`Cannot read file: ${g} (${w})`}}case"search_library":{const u=t.query,y=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!u)return"query is required for search_library.";const p=await r.prepare(`
      ...
      `).bind(n,`%${u}%`,`%${u}%`,`%${u}%`,y).all(),g=await r.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(n,n,`%${u}%`,n,`%${u}%`,`%${u}%`,`%${u}%`,y).all(),w=[...p.results||[],...g.results||[]].slice(0,y);if(w.length===0)return`No documents found matching "${u}" in your library.`;const x=w.map(T=>{const D=(T.summary||T.dl_extracted||"").substring(0,200);return`[id:${T.id}] "${T.name}" (source: ${T.source}, status: ${T.status})
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function Pn(e,t,r,n,a){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(r,n,"assistant",s,"{}",a),t.push({id:-1,user_id:r,channel:n,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function Un(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const r=typeof e[t].content=="string"?e[t].content:"";r.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(r.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function xr(e,t,r,n,a,s,i){var q,O,H,u,y;const o=new Y(t),l=(q=e.metadata)==null?void 0:q.thread_id,d=Date.now(),[c,m]=await Promise.all([o.buildContext(n.id),dr(t,n.id)]),h=await o.getRecentConversations(n.id,30,l);await Pn(o,h,n.id,e.channel,l);const _=$n(n,c,e.channel,m),f=Mn([{role:"system",content:_},...h.map(p=>({role:p.role,content:p.content})),{role:"user",content:e.text}]);Un(f);const b=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],v=(c.match(/^- /gm)||[]).length;if(b.some(p=>p.test(e.text))||v<3)try{const p=await o.searchLongTerm(n.id,e.text,5);if(p.length>0){const g=p.map(w=>`- [${w.type}] ${w.title}: ${w.content}`).join(`
...
`)){const h=m.trim().split("|");if(h.length<4)continue;const[_,f,b,v]=h,S=["fact","preference","context","decision","summary","task"].find(R=>R===_.trim().toLowerCase());if(!S||!(f!=null&&f.trim())||!(b!=null&&b.trim()))continue;const E=Math.min(10,Math.max(1,parseInt(v)||5));await n.store(r.id,S,f.trim(),b.trim(),E,"long_term")}}const kr={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function vs(e){for(const[t,r]of Object.entries(kr))if(e.toLowerCase().includes(t.toLowerCase()))return r;return kr.default}function ws(e,t,r,n){const a=vs(n),s=Math.floor(a*.75),i=[];let o=0,l=!1;const d=Jt(e);i.push({role:"system",content:e}),o+=d;const c=Jt(r);o+=c;const m=s-o,h=[];let _=0;for(let f=t.length-1;f>=0;f--){const b=t[f],v=Jt(b.content);if(_+v<=m)h.unshift({role:b.role,content:b.content}),_+=v;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:r}),o+=_,{maxTokens:a,usedTokens:o,messages:i,wasTruncated:l}}async function*bs(e,t,r,n,a,s){var $,G;const i=new Y(t),o=($=e.metadata)==null?void 0:$.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:r.name}};const[d,c]=await Promise.all([i.buildContext(n.id),dr(t,n.id)]),m=await i.getRecentConversations(n.id,30,o);await Pn(i,m,n.id,e.channel,o);const h=$n(n,d,e.channel,c),_=ws(h,m,e.text,r.name);await i.storeMessage(n.id,e.channel,"user",e.text,"{}",o);const f=await lr(t,n.id),b=10;let v="",S=0;const E=[..._.messages],R=[];Un(E);for(let F=0;F<b;F++)try{F>0&&(yield{type:"thinking",data:{threadId:o}},jn(E));const j=await r.chat(E,{tools:f});if(j.usage&&(S+=j.usage.promptTokens+j.usage.completionTokens),j.toolCalls&&j.toolCalls.length>0){j.content&&(yield{type:"chunk",data:{text:j.content,threadId:o}});const O=j.content||`[calling: ${j.toolCalls.map(u=>{const y=u.arguments||{},p=Object.entries(y).filter(([g])=>!["content","values","body"].includes(g)).map(([g,w])=>`${g}="${String(w).substring(0,100)}"`).join(", ");return`${u.name}(${p})`}).join(", ")}]`;E.push({role:"assistant",content:O});const H=[];for(const u of j.toolCalls){yield{type:"tool_start",data:{tool:u.name,toolArgs:u.arguments,threadId:o}},R.push(u.name);try{const y=(x,T)=>_t(x,T,t,n.id,{agentType:"full",providerName:r.name,channel:e.channel},n.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,n.timezone,r,s==null?void 0:s.DOCUMENTS_BUCKET);let p;if(u.name==="browser_task"||u.name==="browser_task_status"){const T=y(u.name,u.arguments);e:for(;;){const D=await Promise.race([T.then(C=>({done:!0,r:C})),new Promise(C=>setTimeout(()=>C({done:!1}),15e3))]);if(D.done){p=D.r;break e}yield{type:"thinking",data:{threadId:o}}}if(u.name==="browser_task"){const D=p.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(D){yield{type:"thinking",data:{threadId:o}};const C=y("browser_task_status",{task_id:D[1]});e:for(;;){const B=await Promise.race([C.then(N=>({done:!0,r:N})),new Promise(N=>setTimeout(()=>N({done:!1}),15e3))]);if(B.done){p=B.r;break e}yield{type:"thinking",data:{threadId:o}}}}}}else p=await y(u.name,u.arguments);yield{type:"tool_end",data:{tool:u.name,toolResult:p.substring(0,500)+(p.length>500?"...":""),threadId:o}};const g=["parse_document","drive_read_file","read_library_file"].includes(u.name)?2e4:8e3,w=p.length>g?p.substring(0,g)+`
...
`)});continue}v=j.content;const W=$t(v);await i.storeMessage(n.id,e.channel,"assistant",W,"{}",o);const q=50;for(let O=0;O<W.length;O+=q)yield{type:"chunk",data:{text:W.substring(O,O+q),threadId:o}},O+q<W.length&&await new Promise(u=>setTimeout(u,10));break}catch(j){if(a){const O=j.message||"",H=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),u=O.includes("429"),y=H?1440:u?10:5;await a.recordError(r.name,O,y)}await U(t,n.id,"llm","provider_error",j.message||"Unknown LLM error",{provider:r.name,turn:F});const W=j.message||"An error occurred",q=W.includes("429")||W.toLowerCase().includes("rate limit")||W.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":W;try{await i.storeMessage(n.id,e.channel,"assistant",`⚠️ ${q}`,"{}",o)}catch{}yield{type:"error",data:{error:q,threadId:o}};return}if(v=(v==null?void 0:v.trim())??"",!v)try{E.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),v=(await r.chat(E,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const j=$t(v);await i.storeMessage(n.id,e.channel,"assistant",j,"{}",o);const W=50;for(let q=0;q<j.length;q+=W)yield{type:"chunk",data:{text:j.substring(q,q+W),threadId:o}},q+W<j.length&&await new Promise(O=>setTimeout(O,10))}catch{v="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(n.id,e.channel,"assistant",v,"{}",o).catch(()=>{}),yield{type:"chunk",data:{text:v,threadId:o}}}if(a&&S>0)try{await a.recordUsage(r.name,S)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(n.id,r.name,"full",S,Date.now()-l,1,e.channel).run()}catch{}const I=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc)\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a Google Document but create_doc was never called. You MUST call create_doc NOW.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const F of I){const j=F.claimPattern.test(v),W=F.requiredTools.some(q=>R.includes(q));if(j&&!W){try{await U(t,n.id,"llm",F.logType,"LLM claimed action without tool call (streaming)",{response:v.substring(0,200)}),E.push({role:"assistant",content:v}),E.push({role:"user",content:F.enforcementMsg});const q=await r.chat(E,{tools:f.filter(O=>F.requiredTools.includes(O.name)),temperature:0});if((G=q.toolCalls)!=null&&G.length){for(const H of q.toolCalls){const u=await _t(H.name,H.arguments,t,n.id,{agentType:"full",providerName:r.name,channel:e.channel},n.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,n.timezone,r,s==null?void 0:s.DOCUMENTS_BUCKET);R.push(H.name),E.push({role:"assistant",content:"",toolCalls:q.toolCalls}),E.push({role:"user",content:u})}const O=await r.chat(E,{tools:[]});O.content&&(v=O.content)}else v="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}yield{type:"done",data:{threadId:o,provider:r.name,tokenCount:S}}}async function Dr(e,t,r,n,a,s,i,o){await s.storeMessage(a.id,t.channel,"user",t.text,"{}",o);const l=await _t(e.tool,e.args,r,a.id,{agentType:"direct",channel:t.channel},a.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,a.timezone,n,i==null?void 0:i.DOCUMENTS_BUCKET),d=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await s.storeMessage(a.id,t.channel,"assistant",d,"{}",o),l}async function cr(e,t,r,n,a,s){var f;const i=new Y(t),o=(f=e.metadata)==null?void 0:f.thread_id,l=await i.buildContext(n.id),d=or(e.text,l);if(d.agent==="conversation")return Hn(e,t,r,n,l,a,o);const c=Cn(e.text);if(c)return Dr(c,e,t,r,n,i,s,o);const m=(await i.getRecentConversations(n.id,10,o)).map(b=>b.content).join(`
`),h=In(e.text,m);if(h)return Dr(h,e,t,r,n,i,s,o);const _=d.confidence>=.85;if(e.channel==="telegram"){const b=await lr(t,n.id);return xr(e,t,r,n,a,s,{maxTurns:10,tools:b,forceToolUseOnFirstTurn:_})}return xr(e,t,r,n,a,s,{forceToolUseOnFirstTurn:_})}async function Hn(e,t,r,n,a,s,i){const o=new Y(t),l=Date.now(),d=Bn(n.timezone),c=await dr(t,n.id),m=c?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${c}

${a}`:a,h=An("conversation",n,m,n.timezone,d,e.channel),_=(await o.getRecentConversations(n.id,30,i)).filter(E=>!E.content.startsWith("[Autonomous Scheduled Task]")&&!E.content.startsWith("[Scheduled Reminder]")),f=Mn([{role:"system",content:h},..._.map(E=>({role:E.role,content:E.content})),{role:"user",content:e.text}]);await o.storeMessage(n.id,e.channel,"user",e.text,"{}",i);let b=0,v="";try{const E=await r.chat(f,{temperature:.8});E.usage&&(b=E.usage.promptTokens+E.usage.completionTokens),v=E.content}catch(E){if(s){const R=E.message||"",I=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),$=R.includes("429"),G=I?1440:$?10:5;await s.recordError(r.name,R,G)}throw await U(t,n.id,"llm","conversation_error",E.message,{provider:r.name}),E}if(s&&b>0)try{await s.recordUsage(r.name,b)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(n.id,r.name,"conversation",b,Date.now()-l,1,e.channel).run()}catch{}const S=$t(v);return await o.storeMessage(n.id,e.channel,"assistant",S,"{}",i),S}async function*_s(e,t,r,n,a,s){var c;const i=new Y(t),o=(c=e.metadata)==null?void 0:c.thread_id,l=await i.buildContext(n.id),d=or(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:r.name}},d.agent!=="conversation"){yield*bs(e,t,r,n,a,s);return}try{const m=await Hn(e,t,r,n,l,a,o),h=50;for(let _=0;_<m.length;_+=h)yield{type:"chunk",data:{text:m.substring(_,_+h),threadId:o}},_+h<m.length&&await new Promise(f=>setTimeout(f,10))}catch(m){yield{type:"error",data:{error:m.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:r.name,tokenCount:0}}}const re=new pe;async function Es(e,t){var a;const r=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",r),await t()}re.use("/*",Es);re.get("/threads",async e=>{const t=e.get("user"),r=e.req.query("archived")==="1",n=parseInt(e.req.query("limit")||"30"),a=await e.env.DB.prepare(`SELECT t.*, 
...
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=a;if(!o){const d=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,r.trim().substring(0,60)+(r.trim().length>60?"...":"")).first();o=d==null?void 0:d.id}const l={userId:t.id,username:t.username,channel:n,text:r.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:d,rotation:c}=await ut(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(h){const _=new TextEncoder;try{const f=_s(l,e.env.DB,d,t,c,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const b of f)b.data.threadId||(b.data.threadId=o),h.enqueue(_.encode(Rr(b)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),h.close()}catch(f){const b={type:"error",data:{error:f.message||"An error occurred",threadId:o}};h.enqueue(_.encode(Rr(b))),h.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(d){console.error("Stream setup error:",d);const c=d.message||"";return c.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):c.includes("429")||c.includes("limit reached")||c.includes("rate limit")||c.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:c,thread_id:o},500)}});re.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),r=parseInt(e.req.param("id")),n=parseInt(e.req.query("limit")||"50"),a=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(a).all(),i=[];for(const o of s.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(a,o.id).run();const l=o.user_timezone||"UTC";let d,c=!1,m=o.state||"active";if(o.schedule_type==="interval"){const f=parseInt(o.schedule_value,10);d=new Date(n.getTime()+f*60*1e3)}else if(o.schedule_type==="daily"){const[f,b]=o.schedule_value.split(":").map(Number),v=Or(l),S=new Date(v);S.setHours(f,b,0,0),S<=v&&S.setDate(S.getDate()+1);const E=new Date(S.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(S.toLocaleString("en-US",{timeZone:l})),I=E.getTime()-R.getTime();d=new Date(S.getTime()+I)}else if(o.schedule_type==="weekly"){const[f,b]=o.schedule_value.split(" "),[v,S]=(b||"00:00").split(":").map(Number),R=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(q=>q.toLowerCase()===f.toLowerCase()),I=Or(l),$=new Date(I);$.setHours(v,S,0,0);let G=(R-$.getDay()+7)%7;G===0&&$<=I&&(G=7),$.setDate($.getDate()+G);const F=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),j=new Date($.toLocaleString("en-US",{timeZone:l})),W=F.getTime()-j.getTime();d=new Date($.getTime()+W)}else o.schedule_type==="once"?(c=!0,o.action_type==="reminder"?(m="reminding",d=new Date(o.next_run||a)):(m="completed",d=new Date(n.getTime()+365*24*60*60*1e3))):d=new Date(n.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(a,d.toISOString(),c?0:o.enabled,m,o.id).run();const _=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:_,next_run:d.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}try{const{MemoryService:o}=await Promise.resolve().then(()=>za),l=await e.env.DB.prepare("SELECT id FROM users").all();for(const d of l.results||[])await new o(e.env.DB).cleanupDoneTasks(d.id)}catch{}return e.json({executed:i.length,results:i,timestamp:a})});Oe.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);const n=parseInt(e.req.param("jobId"),10);if(!n)return e.json({error:"Invalid job ID"},400);const a=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(n).first();if(!a)return e.json({error:"Job not found"},404);const i=JSON.parse(a.action_config||"{}").description||a.description||"",o="⏰ "+(a.name||"Scheduled Task"),l=new Date().toISOString();let d="";const c=a.action_type==="reminder",m=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!c&&a.action_type==="custom"&&m.test(i),c)d=i||a.name||"Time for your scheduled task.";else try{const b={id:a.user_id,username:a.username||"user",name:a.user_name||"User",pin_hash:a.pin_hash||"",role:a.user_role||"",personality_prompt:a.personality_prompt||"",telegram_chat_id:a.telegram_chat_id||"",timezone:a.user_timezone||"UTC",assistant_name:a.assistant_name||"Karna",created_at:"",updated_at:""},v={userId:a.user_id,username:b.username,channel:"cron",text:xs(a.name,i,a.action_type),sessionId:"cron-"+a.id,timestamp:l},{provider:S,rotation:E}=await ut(e.env.DB,a.user_id,a.pin_hash);d=await cr(v,e.env.DB,S,b,E,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(b){const v=b.message||"unknown error",S=v.includes("rate_limit")||v.includes("429")||v.includes("quota"),E=v.includes("timeout")||v.includes("Timeout");S?d="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":E?d="Task timed out. Will retry at next scheduled time.":d="Task encountered an error. Will retry at next scheduled time.",await U(e.env.DB,a.user_id,"cron_agent","execution_error",v,{job_id:a.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(a.action_type))try{const b=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(a.user_id).first();(!b||b.cnt===0)&&await U(e.env.DB,a.user_id,"cron_verification","no_tools_called",`Cron job "${a.name}" (${a.action_type}) completed without any tool calls`,{job_id:a.id,action_type:a.action_type,response_preview:d.substring(0,200)})}catch{}let _=d||i||"Time for your scheduled task.";_=_.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const f=o+`
`+_;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(a.user_id,"reminder",o,_,"cron:"+a.id).run(),c&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(a.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:a.id})).run(),a.telegram_chat_id&&await Ss(e.env.DB,a.user_id,a.telegram_chat_id,f),e.json({job_id:n,status:"completed",response_length:d.length})});async function Fn(e){var n;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return null;const r=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(r==null?void 0:r.user_id)||null}Oe.get("/health/tools",async e=>{var r;const t=await Fn(e);if(!t)return e.json({error:"Not authenticated"},401);try{const n=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${yt}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${yt}`}function ks(e,t,r,n){return{userId:e,username:t,channel:"telegram",text:r,sessionId:`telegram-${n}`,timestamp:new Date().toISOString()}}function Ds(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const Rt=new pe,Rs=4e3;async function te(e,t,r,n="Markdown",a,s){var d,c;const i=Ns(r,Rs),o=[];let l=!0;for(let m=0;m<i.length;m++){const h=i[m];let _=!1,f="";for(let b=0;b<3;b++)try{const v=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h,parse_mode:n,disable_web_page_preview:!1})});if(v.ok){_=!0;break}const S=await v.json().catch(()=>null);if(f=`HTTP ${v.status}: ${(S==null?void 0:S.description)||"Unknown error"}`,(d=S==null?void 0:S.description)!=null&&d.includes("parse")||(c=S==null?void 0:S.description)!=null&&c.includes("entities")){if((await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h})})).ok){_=!0;break}f+=" (plain-text retry also failed)"}if(v.status===429||v.status>=500){const E=Math.pow(2,b)*1e3;await new Promise(R=>setTimeout(R,E));continue}break}catch(v){if(f=`Network error: ${v.message}`,b<2){const S=Math.pow(2,b)*1e3;await new Promise(E=>setTimeout(E,S));continue}}_||(l=!1,o.push(`Chunk ${m+1}/${i.length}: ${f}`))}if(!l&&a&&s&&o.length>0)try{const{logError:m}=await Promise.resolve().then(()=>rt);await m(a,s,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function Os(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Ns(e,t){if(e.length<=t)return[e];const r=[];let n=e;for(;n.length>0;){if(n.length<=t){r.push(n);break}let a=n.lastIndexOf(`
`,t);a<t*.3&&(a=n.lastIndexOf(" ",t)),a<t*.3&&(a=t),r.push(n.substring(0,a)),n=n.substring(a).trimStart()}return r}async function Cs(e,t,r,n,a){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(n==null?void 0:n.name)||"there",o=(n==null?void 0:n.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
`];for(const f of o){let b="";if(f.due_date){const v=f.due_date.slice(0,10);v<d?b=" ⚠️ _overdue_":v===d?b=" 🔴 _due today_":v===m?b=" 🟡 _due tomorrow_":b=` _${new Date(f.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}h.push(`☐ ${f.title}${b}`)}h.push(`
_Say "mark [task] as done" to close a task._`);const _=await te(r,t,h.join(`
`),"Markdown",a,n.id);_.success||console.warn(`[/tasks] Failed to send message: ${_.errors.join(" | ")}`)}catch(i){const o=await te(r,t,"❌ Could not fetch tasks: "+i.message,"Markdown",a,n==null?void 0:n.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}Rt.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const r=e.env.DB,n={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},a=async()=>{var s,i,o,l,d;try{if(t.callback_query){await Is(r,t.callback_query);return}const c=t.message;if(!c)return;const m=!!c.text,h=!!c.voice,_=!!c.document,f=!!c.photo,b=!!c.caption;if(!m&&!h&&!_&&!f)return;const v=String(c.chat.id);let S=c.text||"";const E=await r.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let R=null;if(E){const O=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(E.id,"telegram_bot_token").first();O&&(R=await J(O.encrypted_value,E.pin_hash))}if(!R){const O=await r.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();O&&(R=await J(O.encrypted_value,O.pin_hash))}if(!R||S.startsWith("/")&&await Cs(S,v,R,E,r))return;if(!E){const O=await te(R,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",r);O.success||console.warn(`Failed to send unlinked account message: ${O.errors.join(" | ")}`);return}if(c.voice&&R&&E)try{const O=await te(R,v,"🎤 Processing voice note...","Markdown",r,E.id);O.success||console.warn(`[voice start] Failed to send message: ${O.errors.join(" | ")}`);const u=await(await fetch(`https://api.telegram.org/bot${R}/getFile?file_id=${c.voice.file_id}`)).json();if(u.ok&&((s=u.result)!=null&&s.file_path)){const p=await(await fetch(`https://api.telegram.org/file/bot${R}/${u.result.file_path}`)).blob();let g="",w="",x="whisper-1";const T=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(E.id).all();for(const A of T.results){const M=await J(A.encrypted_value,E.pin_hash);if(A.service==="openai"){g="https://api.openai.com/v1/audio/transcriptions",w=M;break}else if(A.service.startsWith("llm_slot_"))try{const K=JSON.parse(M);if(K.provider==="openai"){g="https://api.openai.com/v1/audio/transcriptions",w=K.apiKey;break}else if(K.provider==="groq"){g="https://api.groq.com/openai/v1/audio/transcriptions",w=K.apiKey,x="whisper-large-v3";break}}catch{}}if(!g){const A=await te(R,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).","Markdown",r,E.id);A.success||console.warn(`[voice no stt] Failed to send message: ${A.errors.join(" | ")}`);return}const D=new FormData;D.append("file",p,"voice.ogg"),D.append("model",x),D.append("language","en");const C=await fetch(g,{method:"POST",headers:{Authorization:`Bearer ${w}`},body:D});if(!C.ok){const A=await C.text(),M=await te(R,v,`⚠️ Transcription failed: ${C.status} ${A}`,"Markdown",r,E.id);M.success||console.warn(`[voice transcription error] Failed to send message: ${M.errors.join(" | ")}`);return}S=(await C.json()).text;const N=await te(R,v,`🗣️ *You said:* ${S}`,"Markdown",r,E.id);N.success||console.warn(`[voice transcript echo] Failed to send message: ${N.errors.join(" | ")}`)}}catch(O){const H=await te(R,v,`⚠️ Failed to process voice note: ${O.message}`,"Markdown",r,E==null?void 0:E.id);H.success||console.warn(`[voice processing error] Failed to send message: ${H.errors.join(" | ")}`);return}if((_||f)&&R&&E)try{let O,H="unknown",u="unknown",y=0;if(_)O=c.document.file_id,H=c.document.file_name||"document",u=c.document.mime_type||"unknown",y=c.document.file_size||0;else if(f){const p=c.photo[c.photo.length-1];O=p.file_id,H="photo.jpg",u="image/jpeg",y=p.file_size||0}if(O){const g=await(await fetch(`https://api.telegram.org/bot${R}/getFile?file_id=${O}`)).json();let w="";if(g.ok&&((i=g.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(H)||/^text\/|application\/json|application\/xml|application\/csv/i.test(u))&&y<5e4)try{w=await(await fetch(`https://api.telegram.org/file/bot${R}/${g.result.file_path}`)).text()}catch{}const x=c.caption||"",T=`[Telegram file received: "${H}" (${u}, ${Math.round(y/1024)}KB)]`;w?S=`${x?x+`
...
`:""}${T}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(O){if(b&&c.caption)S=c.caption;else{const H=await te(R,v,`⚠️ Received your file but couldn't process it: ${O.message}`,"Markdown",r,E==null?void 0:E.id);H.success||console.warn(`[file processing error] Failed to send message: ${H.errors.join(" | ")}`);return}}if(!S)return;Os(R,v).catch(()=>{});let I=await r.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(E.id).first();I?await r.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(I.id).run():I={id:(await r.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(E.id).run()).meta.last_row_id};const $=ks(E.id,E.username,S,v);$.metadata={thread_id:I.id};let G,F;try{const O=await ut(r,E.id,E.pin_hash);G=O.provider,F=O.rotation}catch(O){console.error("Telegram provider setup error:",O);const H=(o=O.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=O.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${O.message||"Unknown error"}`,u=await te(R,v,H,"Markdown",r,E.id);u.success||console.warn(`[provider error] Failed to send message: ${u.errors.join(" | ")}`);return}const{classifyIntentFast:j}=await Promise.resolve().then(()=>ms);if(j(S).agent==="multi"){const O=await te(R,v,"🔍 On it…","Markdown",r,E.id);O.success||console.warn(`[ack] Failed to send: ${O.errors.join(" | ")}`)}const W=9e4;let q=!1;try{const O=await Promise.race([cr($,r,G,E,F,n),new Promise((y,p)=>setTimeout(()=>p(new Error("TELEGRAM_TIMEOUT")),W))]),H=Ds(O,"telegram"),u=await te(R,v,H||"(empty response)","Markdown",r,E.id);if(await r.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(I.id).run().catch(()=>{}),q=u.success,!u.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${E.id}:`,u.errors);try{const{logError:y}=await Promise.resolve().then(()=>rt);await y(r,E.id,"telegram","response_send_failed",`Failed to deliver response: ${u.errors.join(" | ")}`)}catch{}}}catch(O){console.error("Telegram agent error:",O);const H=O.message==="TELEGRAM_TIMEOUT",u=H?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(d=O.message)!=null&&d.includes("API error")?`⚠️ AI provider returned an error. The provider (${G.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(O.message||"Unknown").substring(0,200)}`,y=await te(R,v,u,"Markdown",r,E.id);q=y.success,y.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${E.id}:`,y.errors);try{const{logError:p}=await Promise.resolve().then(()=>rt);await p(r,E.id,"telegram",H?"timeout":"agent_error",O.message||"Agent error",{provider:G.name})}catch{}}}catch(c){console.error("Telegram webhook error:",c);try{const{logError:m}=await Promise.resolve().then(()=>rt);await m(r,null,"telegram","webhook_error",c.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(a()),e.json({ok:!0})});Rt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const{webhook_url:n}=await e.req.json(),a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await J(a.encrypted_value,r.pin_hash);if(!n){const c=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(c)}const o=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:n,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});Rt.get("/webhook-status",async e=>{var s,i,o,l,d,c;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!n)return e.json({configured:!1,error:"Bot token not set"});const a=await J(n.encrypted_value,r.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${a}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((d=h.result)==null?void 0:d.last_error_message)||"",last_error_date:((c=h.result)==null?void 0:c.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Rt.post("/detect-chat-id",async e=>{var s,i;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Bot token not configured"},400);const a=await J(n.encrypted_value,r.pin_hash);try{const d=((i=(await(await fetch(`https://api.telegram.org/bot${a}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${a}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(v=>setTimeout(v,500));const m=await(await fetch(`https://api.telegram.org/bot${a}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${a}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const h=m.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const _=[],f=new Set;for(let v=h.length-1;v>=0;v--){const S=h[v].message;if(S&&S.chat){const E=String(S.chat.id);f.has(E)||(f.add(E),_.push({chat_id:E,name:[S.chat.first_name,S.chat.last_name].filter(Boolean).join(" ")||S.chat.title||"Unknown",username:S.chat.username||"",date:new Date((S.date||0)*1e3).toISOString()}))}}if(_.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const b=_[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(b,r.user_id).run(),e.json({found:!0,chat_id:b,name:_[0].name,all_chats:_,message:`Chat ID ${b} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function Is(e,t){var b;const{id:r,data:n,message:a,from:s}=t;if(!n||!a)return;const i=n.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const d=String(a.chat.id),c=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!c)return;const m=await e.prepare(`
  ...
  `).bind(c.id,l,o).first();if(!m)return;const h=m.checked?0:1;await e.prepare(`
    ...
    WHERE id = ?
  `).bind(h,h,m.id).run();const _=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(c.id).first();if(!_)return;const f=await J(_.encrypted_value,_.pin_hash);try{const v=await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:r,text:h?"✅ Checked!":"☐ Unchecked"})});v.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${v.status}`)}catch(v){console.warn(`[callback answer] Error answering callback: ${v.message}`)}if((b=a.reply_markup)!=null&&b.inline_keyboard){const v=a.reply_markup.inline_keyboard.map(S=>S.map(E=>{var R;if((R=E.callback_data)!=null&&R.includes(o)){const I=h?"✅":"☐",$=E.text.replace(/^[☐✅]\s*/,"");return{...E,text:`${I} ${$}`}}return E}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:a.message_id,reply_markup:{inline_keyboard:v}})})}catch{}}}function As(e){const t=new Date,r=new Date(t.toLocaleString("en-US",{timeZone:e})),n=new Date(r);n.setDate(n.getDate()+1),n.setHours(0,0,0,0);const a=new Date(n);a.setHours(23,59,59,999);const s=n.toISOString().split("T")[0];return{start:n.toISOString(),end:a.toISOString(),dateStr:s}}async function Ls(e,t,r,n,a,s){try{return(await new ir(e,t,r,n,a).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(c=>c.displayName||c.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Ms(e,t,r,n,a){try{const s=new be(e,t,r,n,a),i=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of i){const h=m.from.split("<")[0].trim()||m.from;l[h]=(l[h]||0)+1}const d=Object.entries(l).sort(([,m],[,h])=>h-m).slice(0,5).map(([m])=>m),c=i.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:d,hasUrgent:c}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function $s(e,t){try{const r=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),n=new Date,a=new Date(n);a.setDate(a.getDate()+1),a.setHours(23,59,59,999);const s=r.results||[],i=s.map(l=>{if(l.due_date){const d=new Date(l.due_date),c=d<=n?"overdue":d<=a?"due today":d.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${l.title} [${c}]`}return l.title}),o=s.filter(l=>l.due_date?new Date(l.due_date)<=a:!1).length;return{pending:s.length,dueToday:o,items:i}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function Bs(e,t){try{const r=Math.floor((Date.now()-1728e5)/1e3),n=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${r},points>10`,a=await fetch(n,{headers:{"User-Agent":"Karna/1.0"}});return a.ok?((await a.json()).hits||[]).filter(i=>i.url&&!t.has(i.url)).slice(0,2).map(i=>({title:i.title,summary:`${i.points} pts · ${i.num_comments} comments on HN`,url:i.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const Nr=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function js(e,t,r){const n=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],a=new Set;if(t&&r)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(r).all()).results||[]).forEach(d=>a.add(d.url))}catch{}const s=[];if(n.some(l=>Nr.some(d=>l.toLowerCase().includes(d.toLowerCase())))){const l=n.find(c=>Nr.some(m=>c.toLowerCase().includes(m.toLowerCase())))||"AI agents",d=await Bs(l,a);for(const c of d)s.push(c),a.add(c.url)}for(const l of n){if(s.length>=8)break;const d=`latest ${l} news today`;try{const c=await Ht(d,{num:5});if(c.results)for(const m of c.results){if(s.length>=8)break;a.has(m.link)||(s.push({title:m.title,summary:m.snippet,url:m.link,source:m.displayLink}),a.add(m.link))}}catch(c){console.error(`News search error for "${d}":`,c.message)}}const o=s.slice(0,7);if(t&&r&&o.length>0)for(const l of o)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(r,l.url,l.title).run()}catch{}return o}function Ps(e,t){const r=[];let n="20:00";{const[i,o]=t.split(":"),l=parseInt(i,10),d=o||"00",c=l>=12?"PM":"AM";n=`${l===0?12:l>12?l-12:l}:${d} ${c}`}r.push(`🗓 Your ${n} Brief — ${e.targetDate}`),r.push("");const a=e.calendar.totalCount;if(a>0){r.push(`📅 Tomorrow: ${a} event${a===1?"":"s"}`);for(const i of e.calendar.google.slice(0,5)){const o=i.startTime?new Date(i.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";r.push(`   • ${o} ${i.title}`)}}else r.push("📅 Tomorrow: Nothing scheduled");r.push("");const s=e.emails.gmail.unreadCount;if(s>0?(r.push(`📧 Gmail: ${s} unread`),e.emails.gmail.importantCount>0&&r.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&r.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&r.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):r.push("📧 Gmail: Inbox clear"),r.push(""),e.tasks.pending>0){r.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const i of e.tasks.items)r.push(`   ☐ ${i}`)}else r.push("✅ Tasks: All clear");if(r.push(""),e.news.items.length>0){r.push("📡 Today's Signal:");for(const i of e.news.items){const o=i.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${i.source}`;r.push(`   • ${i.title.substring(0,90)}${i.title.length>90?"…":""}`),r.push(`     ${o} — ${i.summary.substring(0,80)}${i.summary.length>80?"…":""}`)}}return r.join(`
`)}function Us(e){const t=[];let r=0;for(const n of e.calendar.google)t.push({type:"calendar",key:n.id,text:`${n.title} - ${new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:n},sortOrder:r++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:r++});for(const n of e.tasks.items)t.push({type:"task",key:`task-${n}`,text:n,metadata:{},sortOrder:r++});for(const n of e.news.items)t.push({type:"news",key:`news-${n.url}`,text:`📰 ${n.title}`,metadata:{url:n.url,source:n.source},sortOrder:r++});return t}async function Hs(e,t){const r=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!r)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let n;try{const s=JSON.parse(r.components);n={google_calendar:s.google_calendar!==!1,gmail:s.gmail!==!1,tasks:s.tasks!==!1,news:s.news!==!1}}catch{n={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const a=r.news_topics?r.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:n,newsTopics:a}}async function Gn(e,t,r){var E,R;const n=t.timezone||"Asia/Kolkata",a=As(n),{components:s,newsTopics:i}=await Hs(e,t.id),o=[],l=[];s.google_calendar&&(o.push(Ls(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET,a)),l.push("googleEvents")),s.gmail&&(o.push(Ms(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(o.push($s(e,t.id)),l.push("tasks")),s.news&&(o.push(js(i,e,t.id)),l.push("news"));const d=await Promise.all(o),c={};l.forEach((I,$)=>{c[I]=d[$]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},_={generatedAt:new Date().toISOString(),targetDate:a.dateStr,calendar:{google:c.googleEvents||[],totalCount:((E=c.googleEvents)==null?void 0:E.length)||0},emails:{gmail:c.gmailSummary||m},tasks:c.tasks||h,news:{items:c.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((R=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:R.briefing_time)||"20:00";_.summary=Ps(_,f);const b=Us(_),v=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(_)).first(),S=(v==null?void 0:v.id)||0;for(const I of b)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(S,I.type,I.key,I.text,JSON.stringify(I.metadata),I.sortOrder).run();return{briefingId:S,content:_,items:b}}async function Fs(e,t,r){const n=await e.prepare(`
  ...
  `).bind(r).all();return{briefing:{...n,content:JSON.parse(n.content_json||"{}")},items:a.results||[]}}async function Gs(e,t,r,n){if(!await e.prepare(`
  ...
  `).bind(i,i,n,r).run(),{checked:i===1}}async function Ws(e,t,r=10){return((await e.prepare(`
    SELECT b.*, 
...
🕐 ${R}${I}`;await fetch(`https://api.telegram.org/bot${S}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:$,parse_mode:"Markdown"})})}a.push({user_id:l.id,reminders_sent:b.length})}catch(d){a.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:a.length,results:a})}catch(n){return e.json({error:n.message},500)}});oe.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const n=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),a=[],s=new Date;for(const i of n.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(Wn(l,o,s))try{const d=await Yn(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let c={telegram:!0,web:!0};try{c=JSON.parse(i.notification_channels||"{}")}catch{}if(c.telegram!==!1&&i.telegram_chat_id&&d.briefingId){const m=Ys(d.content);await Kn(e.env.DB,i,m),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(d.briefingId).run()}a.push({user_id:i.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:o})}catch(d){a.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:a.length,results:a})}catch(n){return e.json({error:n.message},500)}});oe.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const n=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),a=[];for(const s of n.results||[]){let i={};try{i=JSON.parse(s.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Jn(e.env.DB,s,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,d=JSON.stringify(o,null,2),c=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
  ...
  `).bind(t.id,n.toISOString(),a.toISOString()).all(),i=await e.prepare(`
    ...
    LIMIT 10
  `).bind(t.id).all(),o=await Jn(e,t,r);let l=[];try{const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first();if(h){const _=await J(h.encrypted_value,t.pin_hash),b=JSON.parse(_).access_token;if(b){const v=n.toISOString(),S=a.toISOString(),E=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(v)}&timeMax=${encodeURIComponent(S)}&maxResults=20`,{headers:{Authorization:`Bearer ${b}`}});E.ok&&(l=((await E.json()).items||[]).map(I=>{var $,G,F,j;return{title:I.summary||"Untitled",startTime:(($=I.start)==null?void 0:$.dateTime)||((G=I.start)==null?void 0:G.date),endTime:((F=I.end)==null?void 0:F.dateTime)||((j=I.end)==null?void 0:j.date)}}))}}}catch{}const d={generatedAt:new Date().toISOString(),type:"morning",todayReminders:(s.results||[]).map(h=>({name:h.name,description:h.description,next_run:h.next_run})),pendingActions:(i.results||[]).map(h=>({title:h.title,priority:h.priority})),emailDigest:o,calendarEvents:l},c=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'morning', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(d)).first();return{briefingId:(c==null?void 0:c.id)||0,content:d}}async function Jn(e,t,r){const n={unreadCount:0,recent:[]},a={message:"",recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const i=new be(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET),o=await i.getUnreadCount(),l=await i.listMessages({maxResults:10,labelIds:["INBOX"]});n.unreadCount=o,n.recent=l.map(d=>({id:d.id,subject:d.subject,from:d.from,snippet:d.snippet,isUnread:d.isUnread}))}}catch(s){n.error=s.message}try{const s=await e.prepare("SELECT name, encrypted_blob FROM site_credentials WHERE user_id = ? AND (name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE) LIMIT 1").bind(t.id,"%Outlook%","%Microsoft%","%Office 365%").first();if(!s)a.message="No Outlook credentials saved in Secret Vault. Add them in Settings → Secret Vault.";else{const i=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t.id,"browser_use_api_key").first();if(!i)a.message="Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key.";else{const o=(await J(i.encrypted_value,t.pin_hash)).trim(),l=JSON.parse(await J(s.encrypted_blob,t.pin_hash)),d=await Rn("Go to https://outlook.live.com or https://outlook.office.com. Log in with username {username} and password {password} if prompted. Navigate to the inbox and extract the 10 most recent emails with sender, subject, date, and snippet. Return the results as structured text.",o,{secrets:{username:l.username,password:l.password},timeoutMs:88e3});d.status==="completed"&&d.output?a.recent=d.output:d.status==="timeout"?a.message="Outlook browser task timed out.":a.message="Outlook returned no content."}}}catch(s){a.message=`Outlook error: ${s.message}`}return{gmail:n,outlook:a}}function zs(e,t,r=new Date){const n=new Date(r.toLocaleString("en-US",{timeZone:t})),a=n.toLocaleDateString("en-US",{weekday:"long"}),s=n.getHours(),i=n.getMinutes(),o=e.trim().split(" "),l=o[o.length-1],d=o.slice(0,o.length-1).join(" "),[c,m]=l.split(":").map(Number),h=s*60+i,_=c*60+m;return a===d&&h===_}async function Ks(e,t,r){const n=new Date,a=new Date(n.getTime()-10080*60*1e3),s=new Date(n.getTime()+10080*60*1e3),i=await e.prepare(`
    SELECT * FROM cron_jobs 
...
`)}oe.post("/briefings/:id/resend",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));try{const n=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!n)return e.json({error:"Briefing not found"},404);const a=JSON.parse(n.content||"{}"),s=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(r).all(),{text:i,inlineKeyboard:o}=qn(a,s.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(r).run(),await zn(e.env.DB,t,i,o,r);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(r).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(n){return e.json({error:n.message},500)}});oe.delete("/briefings/:id",async e=>{const t=e.get("user"),r=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0})});const Ve=new pe;async function Vs(e,t){var a;const r=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     ...
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",r),await t()}ge.use("/*",Qs);ge.get("/",async e=>{const t=e.get("user"),[r,n,a,s,i,o,l,d,c,m,h,_,f]=await Promise.all([e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'pending'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'running'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'failed'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'completed'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'needs_approval'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ?").bind(t.id).first(),e.env.DB.prepare("SELECT type, COUNT(*) as cnt FROM action_items WHERE user_id = ? GROUP BY type").bind(t.id).all(),e.env.DB.prepare(`SELECT * FROM action_items WHERE user_id = ? AND (status IN ('pending', 'running', 'needs_approval') OR date(due_at) = date('now'))
       ...
       FROM cron_jobs WHERE user_id = ? AND ((enabled = 1 AND state = 'active') OR state = 'reminding') AND datetime(next_run) >= datetime('now')
       ORDER BY next_run ASC LIMIT 50`).bind(t.id).all(),e.env.DB.prepare(`SELECT id, name as title, description as body, 'reminder' as type, 'pending' as status, 'high' as priority, next_run as due_at,
              'cron' as source, CAST(id as TEXT) as source_id, schedule_type, schedule_value
       FROM cron_jobs WHERE user_id = ? AND ((enabled = 1 AND state = 'active') OR state = 'reminding') AND datetime(next_run) < datetime('now')
       ORDER BY next_run ASC LIMIT 50`).bind(t.id).all()]),b={};for(const R of l.results||[])b[R.type]=R.cnt;const v=[..._.results||[],...f.results||[]],E=[...d.results||[]];for(const R of v)E.some($=>$.source==="cron"&&$.source_id===String(R.id))||E.push(R);return E.sort((R,I)=>{const $=R.due_at?new Date(R.due_at).getTime():1/0,G=I.due_at?new Date(I.due_at).getTime():1/0;return $-G}),e.json({counts:{pending:((r==null?void 0:r.cnt)||0)+v.length,running:(n==null?void 0:n.cnt)||0,failed:(a==null?void 0:a.cnt)||0,completed:(s==null?void 0:s.cnt)||0,needs_approval:(i==null?void 0:i.cnt)||0,total:((o==null?void 0:o.cnt)||0)+v.length},by_type:b,today:E.slice(0,50),pending:[...c.results||[],...v.filter(R=>R.next_run&&new Date(R.next_run)>=new Date)].slice(0,50),needs_approval:m.results||[],recent_activity:h.results||[],cron_jobs_count:v.length})});ge.get("/pending",async e=>{const t=e.get("user"),r=e.req.query("type"),n=parseInt(e.req.query("limit")||"50");let a="SELECT * FROM action_items WHERE user_id = ? AND status IN ('pending', 'needs_approval')";const s=[t.id];r&&(a+=" AND type = ?",s.push(r)),a+=" ORDER BY CASE priority WHEN 'urgent' THEN 1 WHEN 'high' THEN 2 WHEN 'normal' THEN 3 ELSE 4 END, due_at ASC LIMIT ?",s.push(n);const i=await e.env.DB.prepare(a).bind(...s).all();return e.json({items:i.results||[]})});ge.post("/cron/:id/complete",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await e.env.DB.prepare(`UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP
