var ur=Object.defineProperty;var Ut=e=>{throw TypeError(e)};var pr=(e,t,a)=>t in e?ur(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var O=(e,t,a)=>pr(e,typeof t!="symbol"?t+"":t,a),bt=(e,t,a)=>t.has(e)||Ut("Cannot "+a);var b=(e,t,a)=>(bt(e,t,"read from private field"),a?a.call(e):t.get(e)),R=(e,t,a)=>t.has(e)?Ut("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),C=(e,t,a,r)=>(bt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),N=(e,t,a)=>(bt(e,t,"access private method"),a);var Ht=(e,t,a,r)=>({set _(n){C(e,t,n,a)},get _(){return b(e,t,r)}});var Gt=(e,t,a)=>(r,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],r.req.routeIndex=o):d=o===e.length&&n||void 0,d)try{l=await d(r,()=>i(o+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),c=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},mr=Symbol(),hr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ma?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?gr(e,{all:a,dot:r}):{}};async function gr(e,t){const a=await e.formData();return a?fr(a,t):{}}function fr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?yr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(vr(a,r,n),delete a[r])}),a}var yr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},vr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},la=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},br=e=>{const{groups:t,path:a}=wr(e),r=la(a);return _r(r,t)},wr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},_r=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},lt={},Er=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return lt[r]||(a[2]?lt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:lt[r]=[e,a[1],!0]),lt[r]}return null},At=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Tr=e=>At(e,decodeURI),ca=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),i=t.indexOf("#",r),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return Tr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},xr=e=>{const t=ca(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ne=(e,t,...a)=>(a.length&&(t=Ne(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),da=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,i)=>i.indexOf(n)===s)},wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?At(e,pa):e):e,ua=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return wt(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(r&&(l=wt(l)),s=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),r&&(c=wt(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},kr=ua,Sr=(e,t)=>ua(e,t,!0),pa=decodeURIComponent,Ft=e=>At(e,pa),Be,V,pe,ha,ga,St,he,aa,ma=(aa=class{constructor(e,t="/",a=[[]]){R(this,pe);O(this,"raw");R(this,Be);R(this,V);O(this,"routeIndex",0);O(this,"path");O(this,"bodyCache",{});R(this,he,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,C(this,V,a),C(this,Be,{})}param(e){return e?N(this,pe,ha).call(this,e):N(this,pe,ga).call(this)}query(e){return kr(this.url,e)}queries(e){return Sr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await hr(this,e))}json(){return b(this,he).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,he).call(this,"text")}arrayBuffer(){return b(this,he).call(this,"arrayBuffer")}blob(){return b(this,he).call(this,"blob")}formData(){return b(this,he).call(this,"formData")}addValidatedData(e,t){b(this,Be)[e]=t}valid(e){return b(this,Be)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[mr](){return b(this,V)}get matchedRoutes(){return b(this,V)[0].map(([[,e]])=>e)}get routePath(){return b(this,V)[0].map(([[,e]])=>e)[this.routeIndex].path}},Be=new WeakMap,V=new WeakMap,pe=new WeakSet,ha=function(e){const t=b(this,V)[0][this.routeIndex][1][e],a=N(this,pe,St).call(this,t);return a&&/\%/.test(a)?Ft(a):a},ga=function(){const e={},t=Object.keys(b(this,V)[0][this.routeIndex][1]);for(const a of t){const r=N(this,pe,St).call(this,b(this,V)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ft(r):r)}return e},St=function(e){return b(this,V)[1]?b(this,V)[1][e]:e},he=new WeakMap,aa),Ir={Stringify:1},fa=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>fa(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},Or="text/plain; charset=UTF-8",_t=(e,t)=>({"Content-Type":e,...t}),Ze,Qe,le,je,ce,K,et,Pe,Ue,ke,tt,at,ge,Me,ra,Dr=(ra=class{constructor(e,t){R(this,ge);R(this,Ze);R(this,Qe);O(this,"env",{});R(this,le);O(this,"finalized",!1);O(this,"error");R(this,je);R(this,ce);R(this,K);R(this,et);R(this,Pe);R(this,Ue);R(this,ke);R(this,tt);R(this,at);O(this,"render",(...e)=>(b(this,Pe)??C(this,Pe,t=>this.html(t)),b(this,Pe).call(this,...e)));O(this,"setLayout",e=>C(this,et,e));O(this,"getLayout",()=>b(this,et));O(this,"setRenderer",e=>{C(this,Pe,e)});O(this,"header",(e,t,a)=>{this.finalized&&C(this,K,new Response(b(this,K).body,b(this,K)));const r=b(this,K)?b(this,K).headers:b(this,ke)??C(this,ke,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});O(this,"status",e=>{C(this,je,e)});O(this,"set",(e,t)=>{b(this,le)??C(this,le,new Map),b(this,le).set(e,t)});O(this,"get",e=>b(this,le)?b(this,le).get(e):void 0);O(this,"newResponse",(...e)=>N(this,ge,Me).call(this,...e));O(this,"body",(e,t,a)=>N(this,ge,Me).call(this,e,t,a));O(this,"text",(e,t,a)=>!b(this,ke)&&!b(this,je)&&!t&&!a&&!this.finalized?new Response(e):N(this,ge,Me).call(this,e,t,_t(Or,a)));O(this,"json",(e,t,a)=>N(this,ge,Me).call(this,JSON.stringify(e),t,_t("application/json",a)));O(this,"html",(e,t,a)=>{const r=n=>N(this,ge,Me).call(this,n,t,_t("text/html; charset=UTF-8",a));return typeof e=="object"?fa(e,Ir.Stringify,!1,{}).then(r):r(e)});O(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});O(this,"notFound",()=>(b(this,Ue)??C(this,Ue,()=>new Response),b(this,Ue).call(this,this)));C(this,Ze,e),t&&(C(this,ce,t.executionCtx),this.env=t.env,C(this,Ue,t.notFoundHandler),C(this,at,t.path),C(this,tt,t.matchResult))}get req(){return b(this,Qe)??C(this,Qe,new ma(b(this,Ze),b(this,at),b(this,tt))),b(this,Qe)}get event(){if(b(this,ce)&&"respondWith"in b(this,ce))return b(this,ce);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ce))return b(this,ce);throw Error("This context has no ExecutionContext")}get res(){return b(this,K)||C(this,K,new Response(null,{headers:b(this,ke)??C(this,ke,new Headers)}))}set res(e){if(b(this,K)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,K).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,K).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}C(this,K,e),this.finalized=!0}get var(){return b(this,le)?Object.fromEntries(b(this,le)):{}}},Ze=new WeakMap,Qe=new WeakMap,le=new WeakMap,je=new WeakMap,ce=new WeakMap,K=new WeakMap,et=new WeakMap,Pe=new WeakMap,Ue=new WeakMap,ke=new WeakMap,tt=new WeakMap,at=new WeakMap,ge=new WeakSet,Me=function(e,t,a){const r=b(this,K)?new Headers(b(this,K).headers):b(this,ke)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")r.set(s,i);else{r.delete(s);for(const o of i)r.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,je);return new Response(e,{status:n,headers:r})},ra),F="ALL",Cr="all",Rr=["get","post","put","delete","options","patch"],ya="Can not add a route since the matcher is already built.",va=class extends Error{},Ar="__COMPOSED_HANDLER",Lr=e=>e.text("404 Not Found",404),Wt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Z,W,ba,Q,Te,ut,pt,He,Nr=(He=class{constructor(t={}){R(this,W);O(this,"get");O(this,"post");O(this,"put");O(this,"delete");O(this,"options");O(this,"patch");O(this,"all");O(this,"on");O(this,"use");O(this,"router");O(this,"getPath");O(this,"_basePath","/");R(this,Z,"/");O(this,"routes",[]);R(this,Q,Lr);O(this,"errorHandler",Wt);O(this,"onError",t=>(this.errorHandler=t,this));O(this,"notFound",t=>(C(this,Q,t),this));O(this,"fetch",(t,...a)=>N(this,W,pt).call(this,t,a[1],a[0],t.method));O(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ne("/",t)}`,a),r,n)));O(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(N(this,W,pt).call(this,t.request,t,void 0,t.request.method))})});[...Rr,Cr].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?C(this,Z,i):N(this,W,Te).call(this,s,b(this,Z),i),o.forEach(l=>{N(this,W,Te).call(this,s,b(this,Z),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){C(this,Z,l);for(const c of[s].flat())o.map(d=>{N(this,W,Te).call(this,c.toUpperCase(),b(this,Z),d)})}return this},this.use=(s,...i)=>(typeof s=="string"?C(this,Z,s):(C(this,Z,"*"),i.unshift(s)),i.forEach(o=>{N(this,W,Te).call(this,F,b(this,Z),o)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ca:xr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let s;a.errorHandler===Wt?s=n.handler:(s=async(o,l)=>(await Gt([],a.errorHandler)(o,()=>n.handler(o,l))).res,s[Ar]=n.handler),N(i=r,W,Te).call(i,n.method,n.path,s)}),this}basePath(t){const a=N(this,W,ba).call(this);return a._basePath=Ne(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ne(this._basePath,t),c=l==="/"?0:l.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const o=async(l,c)=>{const d=await a(n(l.req.raw),...i(l));if(d)return d;await c()};return N(this,W,Te).call(this,F,Ne(t,"*"),o),this}},Z=new WeakMap,W=new WeakSet,ba=function(){const t=new He({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,C(t,Q,b(this,Q)),t.routes=this.routes,t},Q=new WeakMap,Te=function(t,a,r){t=t.toUpperCase(),a=Ne(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},ut=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},pt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await N(this,W,pt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),i=this.router.match(n,s),o=new Dr(t,{path:s,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,Q)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await b(this,Q).call(this,o)})}catch(d){return N(this,W,ut).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:b(this,Q).call(this,o))).catch(d=>N(this,W,ut).call(this,d,o)):c??b(this,Q).call(this,o)}const l=Gt(i[0],this.errorHandler,b(this,Q));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return N(this,W,ut).call(this,c,o)}})()},He),wa=[];function Mr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const i=a[n]||a[F],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],wa];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=r,r(e,t)}var ht="[^/]+",Ye=".*",Ve="(?:|/.*)",$e=Symbol(),$r=new Set(".\\+*[^]$()");function Br(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ye||e===Ve?1:t===Ye||t===Ve?-1:e===ht?1:t===ht?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Se,Ie,ee,Ce,jr=(Ce=class{constructor(){R(this,Se);R(this,Ie);R(this,ee,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Se)!==void 0)throw $e;if(s)return;C(this,Se,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Ye]:["","",ht]:i==="/*"?["","",Ve]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let p=l[2]||ht;if(d&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw $e;if(c=b(this,ee)[p],!c){if(Object.keys(b(this,ee)).some(h=>h!==Ye&&h!==Ve))throw $e;if(s)return;c=b(this,ee)[p]=new Ce,d!==""&&C(c,Ie,n.varIndex++)}!s&&d!==""&&r.push([d,b(c,Ie)])}else if(c=b(this,ee)[i],!c){if(Object.keys(b(this,ee)).some(d=>d.length>1&&d!==Ye&&d!==Ve))throw $e;if(s)return;c=b(this,ee)[i]=new Ce}c.insert(o,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,ee)).sort(Br).map(r=>{const n=b(this,ee)[r];return(typeof b(n,Ie)=="number"?`(${r})@${b(n,Ie)}`:$r.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Se)=="number"&&a.unshift(`#${b(this,Se)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Se=new WeakMap,Ie=new WeakMap,ee=new WeakMap,Ce),gt,rt,na,Pr=(na=class{constructor(){R(this,gt,{varIndex:0});R(this,rt,new jr)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,o=!0,c}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return b(this,rt).insert(s,t,r,b(this,gt),a),r}buildRegExp(){let e=b(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},gt=new WeakMap,rt=new WeakMap,na),Ur=[/^$/,[],Object.create(null)],mt=Object.create(null);function _a(e){return mt[e]??(mt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Hr(){mt=Object.create(null)}function Gr(e){var c;const t=new Pr,a=[];if(e.length===0)return Ur;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[h,v])=>d?1:h?-1:p.length-v.length),n=Object.create(null);for(let d=0,p=-1,h=r.length;d<h;d++){const[v,y,T]=r[d];v?n[y]=[T.map(([_])=>[_,Object.create(null)]),wa]:p++;let w;try{w=t.insert(y,p,v)}catch(_){throw _===$e?new va(y):_}v||(a[p]=T.map(([_,u])=>{const g=Object.create(null);for(u-=1;u>=0;u--){const[m,f]=w[u];g[m]=f}return[_,g]}))}const[s,i,o]=t.buildRegExp();for(let d=0,p=a.length;d<p;d++)for(let h=0,v=a[d].length;h<v;h++){const y=(c=a[d][h])==null?void 0:c[1];if(!y)continue;const T=Object.keys(y);for(let w=0,_=T.length;w<_;w++)y[T[w]]=o[y[T[w]]]}const l=[];for(const d in i)l[d]=a[i[d]];return[s,l,n]}function Ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(_a(a).test(t))return[...e[a]]}}var fe,ye,ft,Ea,sa,Fr=(sa=class{constructor(){R(this,ft);O(this,"name","RegExpRouter");R(this,fe);R(this,ye);O(this,"match",Mr);C(this,fe,{[F]:Object.create(null)}),C(this,ye,{[F]:Object.create(null)})}add(e,t,a){var o;const r=b(this,fe),n=b(this,ye);if(!r||!n)throw new Error(ya);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[F]).forEach(c=>{l[e][c]=[...l[F][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=_a(t);e===F?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=Ae(r[c],t)||Ae(r[F],t)||[])}):(o=r[e])[t]||(o[t]=Ae(r[e],t)||Ae(r[F],t)||[]),Object.keys(r).forEach(c=>{(e===F||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,s])})}),Object.keys(n).forEach(c=>{(e===F||e===c)&&Object.keys(n[c]).forEach(d=>l.test(d)&&n[c][d].push([a,s]))});return}const i=da(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(n).forEach(p=>{var h;(e===F||e===p)&&((h=n[p])[d]||(h[d]=[...Ae(r[p],d)||Ae(r[F],d)||[]]),n[p][d].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,ye)).concat(Object.keys(b(this,fe))).forEach(t=>{e[t]||(e[t]=N(this,ft,Ea).call(this,t))}),C(this,fe,C(this,ye,void 0)),Hr(),e}},fe=new WeakMap,ye=new WeakMap,ft=new WeakSet,Ea=function(e){const t=[];let a=e===F;return[b(this,fe),b(this,ye)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==F&&t.push(...Object.keys(r[F]).map(s=>[s,r[F][s]]))}),a?Gr(t):null},sa),ve,de,ia,Wr=(ia=class{constructor(e){O(this,"name","SmartRouter");R(this,ve,[]);R(this,de,[]);C(this,ve,e.routers)}add(e,t,a){if(!b(this,de))throw new Error(ya);b(this,de).push([e,t,a])}match(e,t){if(!b(this,de))throw new Error("Fatal error");const a=b(this,ve),r=b(this,de),n=a.length;let s=0,i;for(;s<n;s++){const o=a[s];try{for(let l=0,c=r.length;l<c;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof va)continue;throw l}this.match=o.match.bind(o),C(this,ve,[o]),C(this,de,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,de)||b(this,ve).length!==1)throw new Error("No active router has been determined yet.");return b(this,ve)[0]}},ve=new WeakMap,de=new WeakMap,ia),ze=Object.create(null),be,q,Oe,Ge,z,ue,xe,Fe,zr=(Fe=class{constructor(t,a,r){R(this,ue);R(this,be);R(this,q);R(this,Oe);R(this,Ge,0);R(this,z,ze);if(C(this,q,r||Object.create(null)),C(this,be,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},C(this,be,[n])}C(this,Oe,[])}insert(t,a,r){C(this,Ge,++Ht(this,Ge)._);let n=this;const s=br(a),i=[];for(let o=0,l=s.length;o<l;o++){const c=s[o],d=s[o+1],p=Er(c,d),h=Array.isArray(p)?p[0]:c;if(h in b(n,q)){n=b(n,q)[h],p&&i.push(p[1]);continue}b(n,q)[h]=new Fe,p&&(b(n,Oe).push(p),i.push(p[1])),n=b(n,q)[h]}return b(n,be).push({[t]:{handler:r,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:b(this,Ge)}}),n}search(t,a){var l;const r=[];C(this,z,ze);let s=[this];const i=la(a),o=[];for(let c=0,d=i.length;c<d;c++){const p=i[c],h=c===d-1,v=[];for(let y=0,T=s.length;y<T;y++){const w=s[y],_=b(w,q)[p];_&&(C(_,z,b(w,z)),h?(b(_,q)["*"]&&r.push(...N(this,ue,xe).call(this,b(_,q)["*"],t,b(w,z))),r.push(...N(this,ue,xe).call(this,_,t,b(w,z)))):v.push(_));for(let u=0,g=b(w,Oe).length;u<g;u++){const m=b(w,Oe)[u],f=b(w,z)===ze?{}:{...b(w,z)};if(m==="*"){const D=b(w,q)["*"];D&&(r.push(...N(this,ue,xe).call(this,D,t,b(w,z))),C(D,z,f),v.push(D));continue}const[E,x,S]=m;if(!p&&!(S instanceof RegExp))continue;const I=b(w,q)[E],k=i.slice(c).join("/");if(S instanceof RegExp){const D=S.exec(k);if(D){if(f[x]=D[0],r.push(...N(this,ue,xe).call(this,I,t,b(w,z),f)),Object.keys(b(I,q)).length){C(I,z,f);const A=((l=D[0].match(/\//))==null?void 0:l.length)??0;(o[A]||(o[A]=[])).push(I)}continue}}(S===!0||S.test(p))&&(f[x]=p,h?(r.push(...N(this,ue,xe).call(this,I,t,f,b(w,z))),b(I,q)["*"]&&r.push(...N(this,ue,xe).call(this,b(I,q)["*"],t,f,b(w,z)))):(C(I,z,f),v.push(I)))}}s=v.concat(o.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},be=new WeakMap,q=new WeakMap,Oe=new WeakMap,Ge=new WeakMap,z=new WeakMap,ue=new WeakSet,xe=function(t,a,r,n){const s=[];for(let i=0,o=b(t,be).length;i<o;i++){const l=b(t,be)[i],c=l[a]||l[F],d={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==ze||n&&n!==ze))for(let p=0,h=c.possibleKeys.length;p<h;p++){const v=c.possibleKeys[p],y=d[c.score];c.params[v]=n!=null&&n[v]&&!y?n[v]:r[v]??(n==null?void 0:n[v]),d[c.score]=!0}}return s},Fe),De,oa,qr=(oa=class{constructor(){O(this,"name","TrieRouter");R(this,De);C(this,De,new zr)}add(e,t,a){const r=da(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,De).insert(e,r[n],a);return}b(this,De).insert(e,t,a)}match(e,t){return b(this,De).search(e,t)}},De=new WeakMap,oa),we=class extends Nr{constructor(e={}){super(e),this.router=e.router??new Wr({routers:[new Fr,new qr]})}},Kr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var d;function l(p,h){i.res.headers.set(p,h)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await n(i.req.header("origin")||"",i);p.length&&l("Access-Control-Allow-Methods",p.join(","));let h=a.allowHeaders;if(!(h!=null&&h.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(h=v.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Ta(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`),t.trim()}async function Va(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await vt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,r).map(async h=>{const v=await Ya(h.link);return{title:h.title,url:h.link,displayLink:h.displayLink,snippet:h.snippet,content:v.text,error:v.error}}),c=(await Promise.all(o)).filter(h=>h.content.length>50);if(c.length===0){const h=s.results.map((y,T)=>`[${T+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Jt(e,h,t,"snippets"),sources:s.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const d=c.map((h,v)=>`--- SOURCE ${v+1}: ${h.title} (${h.displayLink}) ---
${h.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Jt(e,d,t,"full"),sources:c.map(h=>({title:h.title,url:h.url})),pagesRead:c.length}}async function Jt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
- Time-aware: reference current date/time when relevant`;default:return""}}const vn=2e3,bn=2e3,Za=4;function kt(e){return Math.ceil(e.length/Za)}function Yt(e,t){const a=t*Za;return e.length<=a?e:e.slice(0,a)+`
...
- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I'll now..." — just call the tool.`:""}`}async function Vt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function tr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function ar(e,t,a,r,n,s,i,o,l,c,d,p){const h=Date.now();let v=!0,y="",T="";try{return T=await wn(e,t,a,r,s,i,o,l,c,d,p),T}catch(w){throw v=!1,y=w.message||"Unknown error",w}finally{const w=Date.now()-h;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?T:"").substring(0,500),v?1:0,y||null,w,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function wn(e,t,a,r,n,s,i,o,l,c,d){var h,v,y,T,w,_;const p=new te(a);switch(e){case"create_schedule":{const u=new Date;let g;const m=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){g=new Date(u.getTime()+t.minutes_from_now*60*1e3);const S=g.toLocaleString("en-US",{timeZone:m,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[I,k,D]=(S[0]||"").split("/");t.schedule_value=`${D}-${I}-${k} ${S[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const x=parseInt(t.schedule_value,10);g=new Date(u.getTime()+x*60*1e3)}else if(t.schedule_type==="daily"){const[x,S]=t.schedule_value.split(":").map(Number),I=u.toLocaleString("en-US",{timeZone:m}),k=new Date(I),D=new Date(k);D.setHours(x,S,0,0),D<=k&&D.setDate(D.getDate()+1);const A=new Date(D.toLocaleString("en-US",{timeZone:"UTC"})),M=new Date(D.toLocaleString("en-US",{timeZone:m})),P=A.getTime()-M.getTime();g=new Date(D.getTime()+P)}else if(t.schedule_type==="weekly"){const[x,S]=t.schedule_value.split(" "),[I,k]=(S||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Re=>Re.toLowerCase()===x.toLowerCase()),M=u.toLocaleString("en-US",{timeZone:m}),P=new Date(M),U=new Date(P);U.setHours(I,k,0,0);let H=(A-U.getDay()+7)%7;H===0&&U<=P&&(H=7),U.setDate(U.getDate()+H);const Y=new Date(U.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(U.toLocaleString("en-US",{timeZone:m})),se=Y.getTime()-X.getTime();g=new Date(U.getTime()+se)}else if(t.schedule_type==="once"){const[x,S]=t.schedule_value.split(" "),[I,k,D]=x.split("-").map(Number),[A,M]=(S||"00:00").split(":").map(Number),P=u.toLocaleString("en-US",{timeZone:m}),U=new Date(P),H=new Date(U);H.setFullYear(I,k-1,D),H.setHours(A,M,0,0);const Y=new Date(H.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(H.toLocaleString("en-US",{timeZone:m})),se=Y.getTime()-X.getTime();g=new Date(H.getTime()+se);const Re=new Date(u.getTime()+120*1e3);if(g.getTime()<u.getTime()+60*1e3){const Ee=g.toISOString();g=Re;const it=` [Note: The requested time ${t.schedule_value} in ${m} resolved to ${Ee} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${g.toISOString()}.]`;t._pastTimeWarning=it}}else g=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),g.toISOString()).run();const f=t._pastTimeWarning||"",E=g.toLocaleString("en-US",{timeZone:m,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${E} (${m}). [UTC: ${g.toISOString()}]${f}. IMPORTANT: Use the exact time "${E}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const g=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return g.length===0?"No scheduled tasks found.":g.map(m=>`[ID:${m.id}] ${m.enabled?"▶":"⏸"} "${m.name}" — [${m.schedule_type}] ${m.schedule_value} — ${m.action_type} — state: ${m.state||"active"} — next: ${m.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,g=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,g,t.job_id,r).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],g=t.state;if(!u.includes(g))return`Invalid state "${g}". Valid states: ${u.join(", ")}`;const m=g==="completed"||g==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(g,m,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${g}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,g=t.type==="task"?"preference":t.type,m=u>=7?"working":"long_term";return await p.store(r,g,t.title,t.content,u,m),`Stored in ${m==="working"?"working":"long-term"} memory: [${g}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await p.search(r,t.query);return u.length===0?"No matching memories found.":u.map(g=>`[${g.tier||"long_term"}] [${g.type}] **${g.title}**: ${g.content}`).join(`
...
- Unread errors: ${(E==null?void 0:E.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",i||""),g=t.spreadsheet_id;let m=t.range;const f=await u.sheets.getMetadata(g),E=f.sheets;m.includes("!")||(m=`${E[0]}!${m}`);let x;try{x=await u.sheets.readRange(g,m)}catch(I){if((h=I.message)!=null&&h.includes("Unable to parse range")||(v=I.message)!=null&&v.includes("400")){const k=m.includes("!")?m.split("!")[1]:m;m=`${E[0]}!${k}`,x=await u.sheets.readRange(g,m)}else throw I}let S=`[Spreadsheet: "${f.title}" | Reading tab: "${m.split("!")[0]}" | All tabs in this spreadsheet: ${E.map(I=>`"${I}"`).join(", ")}]
...
`)}catch(u){return await L(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",i||""),g=t.values;let m=t.range;const x=Math.max(...g.map(D=>D.length))+4,S=g.map(D=>{const A=[...D];for(;A.length<x;)A.push("");return A}),I=m.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(I){const D=I[1]||"",A=I[2],M=I[3],P=I[5],H=A.toUpperCase().charCodeAt(0)-64+x-1,Y=H<=26?String.fromCharCode(64+H):"Z";m=`${D}${A}${M}:${Y}${P}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,m,S)).updatedCells} cells to ${m}.`}catch(u){return await L(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new re(a,r,n,s||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await L(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let f="";if(t.folder_name)try{const{token:E}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||"");f=`
Folder: "${(await Vt(E,m.spreadsheetId,t.folder_name)).folderName}"`}catch(E){f=`
(Could not move to folder "${t.folder_name}": ${E.message})`}try{await new te(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${m.spreadsheetId} | URL: ${m.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${f}
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(u){return await L(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",i||""),g=t.calendar_id||"primary",m=t.days_ahead||7,f=new Date,E=new Date(f.getTime()+m*24*60*60*1e3),x=await u.calendar.listEvents(g,{timeMin:f.toISOString(),timeMax:E.toISOString(),query:t.query});return x.length===0?`No events found in the next ${m} days.`:x.map(S=>{var M;const I=S.start.dateTime||S.start.date||"TBD",k=S.end.dateTime||S.end.date||"",D=S.location?` 📍 ${S.location}`:"",A=((M=S.attendees)==null?void 0:M.map(P=>P.email).join(", "))||"";return`• ${S.summary} — ${I} to ${k}${D}${A?`
  Attendees: ${A}`:""}`}).join(`
`)}catch(u){return await L(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",i||""),g=t.calendar_id||"primary",m=await u.calendar.createEvent(g,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${m.summary}"
ID: ${m.id}
...
Folder: "${(await Vt(E,m.documentId,t.folder_name)).folderName}"`}catch(E){f=`
(Could not move to folder "${t.folder_name}": ${E.message})`}try{await new te(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${m.documentId} | URL: ${m.url}`,6,"working")}catch{}return`Document created: "${t.title}"${f}
ID: ${m.documentId}
URL: ${m.url}`}catch(u){return await L(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const g=await new re(a,r,n,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${g.title}"

${g.content}`}catch(u){return await L(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const u=new re(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let m=t.document_id;try{m=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${m}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await L(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const g=await new oe(a,r,n,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return g.length===0?"No messages found.":g.map((m,f)=>`${m.isUnread?"● ":"  "}${f+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await L(a,r,"gmail","list",u.message),(y=u.message)!=null&&y.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const u=new oe(a,r,n,s||"",i||""),g=await u.getMessage(t.message_id);if(!g)return"Message not found.";const m=await u.getMessageBody(t.message_id);return`**${g.subject}**
From: ${g.from}
To: ${g.to}
Date: ${g.date}

${m}`}catch(u){return await L(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const g=await new oe(a,r,n,s||"",i||"").search(t.query,t.max_results||10);return g.length===0?`No results for: ${t.query}`:g.map((m,f)=>`${m.isUnread?"● ":"  "}${f+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await L(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const g=await new oe(a,r,n,s||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${g.id}]`}catch(u){return await L(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const g=await new oe(a,r,n,s||"",i||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),m=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${m}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${g.id}]`}catch(u){return await L(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new oe(a,r,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await L(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const g=await new oe(a,r,n,s||"",i||"").getUnreadCount();return`You have ${g} unread email${g!==1?"s":""} in Gmail.`}catch(u){return(T=u.message)!=null&&T.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||""),g=new URLSearchParams;g.set("pageSize",String(t.max_results||10)),g.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),g.set("orderBy","modifiedTime desc");let m="";t.folder_id?m=`'${t.folder_id}' in parents and trashed = false`:t.query?m=`${t.query} and trashed = false`:m="trashed = false",g.set("q",m);const f=await fetch(`https://www.googleapis.com/drive/v3/files?${g}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const E=await f.json();return(w=E.files)!=null&&w.length?E.files.map((x,S)=>{var A,M;const I=((A=x.mimeType)==null?void 0:A.split(".").pop())||x.mimeType,k=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",D=((M=x.modifiedTime)==null?void 0:M.split("T")[0])||"";return`${S+1}. **${x.name}** (${I})
   ${k} · Modified: ${D}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await L(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||""),g=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,m=new URLSearchParams;m.set("q",g),m.set("pageSize",String(t.max_results||10)),m.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),m.set("orderBy","modifiedTime desc");const f=await fetch(`https://www.googleapis.com/drive/v3/files?${m}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const E=await f.json();return(_=E.files)!=null&&_.length?E.files.map((x,S)=>{var D,A;const I=((D=x.mimeType)==null?void 0:D.split(".").pop())||x.mimeType,k=((A=x.modifiedTime)==null?void 0:A.split("T")[0])||"";return`${S+1}. **${x.name}** (${I}) — Modified: ${k}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await L(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await vt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((g,m)=>`${m+1}. **${g.title}**
   ${g.link}
   ${g.snippet}`).join(`

`)}catch(u){return await L(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const g=Math.min(t.max_length||8e3,15e3),{fetchPageContent:m}=await Promise.resolve().then(()=>gn),f=await m(u,g);return f.error?`Failed to read page: ${f.error}`:!f.text||f.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${f.text.length} chars):

${f.text}`}catch(u){return await L(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const g=Va(t.query,d,{depth:t.depth||"quick",site:t.site}),m=new Promise(x=>setTimeout(()=>x(null),45e3)),f=await Promise.race([g,m]);if(f===null){const{webSearch:x}=await Promise.resolve().then(()=>dn),S=await x(t.query,{num:5});if(S.error||S.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let I=`Research took too long, but here are the top search results:

`;return I+=S.results.map((k,D)=>`${D+1}. **${k.title}**
   ${k.snippet}
   ${k.link}`).join(`

`),I}if(f.error)return`Research failed: ${f.error}`;let E=f.report;return f.sources.length>0&&(E+=`

---
**Sources** (`+f.pagesRead+` pages read):
`,E+=f.sources.map((x,S)=>`[${S+1}] ${x.title}
    ${x.url}`).join(`
`)),E}catch(u){return await L(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const g=await G(u.encrypted_value,n),m=await Ha(g,t.query,{type:t.type});return m.error?`Places search failed: ${m.error}`:m.results.length===0?`No places found for "${t.query}".`:m.results.map((f,E)=>{const x=f.rating?` ★${f.rating} (${f.userRatingsTotal||0} reviews)`:"",S=f.openNow!==void 0?f.openNow?" · Open now":" · Closed":"",I=f.googleMapsUri?`
   ${f.googleMapsUri}`:"";return`${E+1}. **${f.name}**${x}${S}
   ${f.address}${I}
   [place_id: ${f.placeId}]`}).join(`

`)}catch(u){return await L(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await G(u.encrypted_value,n),m=await Ga(g,t.place_id);if(m.error)return`Details lookup failed: ${m.error}`;if(!m.details)return"No details found.";const f=m.details;let E=`**${f.name}**
...
Recent Reviews:`;for(const x of f.reviews)E+=`
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return E}catch(u){return await L(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await G(u.encrypted_value,n),m=await Fa(g,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const f=m.route;let E=`**${f.startAddress}** → **${f.endAddress}**
`;return E+=`📏 ${f.distance} · ⏱️ ${f.duration}`,f.durationInTraffic&&(E+=` (with traffic: ${f.durationInTraffic})`),E+=`
via ${f.summary}`,E+=`

Steps:`,f.steps.forEach((x,S)=>{E+=`
${S+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),E}catch(u){return await L(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await G(u.encrypted_value,n),m=await Ka(g,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let f=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(f+=` (with traffic: ${m.durationInTraffic})`),f}catch(u){return await L(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await G(u.encrypted_value,n),m=await Wa(g,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(u){return await L(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await G(u.encrypted_value,n),m=await qa(g,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((f,E)=>{var x;return`${E+1}. **${f.title}**
   ${f.channelTitle} · ${((x=f.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${f.description}
   ${f.url}`}).join(`

`)}catch(u){return await L(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await G(u.encrypted_value,n),m=await za(g,t.address);return m.error?`Geocoding failed: ${m.error}`:m.results.length===0?`Location not found: "${t.address}"`:m.results.map((f,E)=>`${E+1}. ${f.address}
   Coordinates: ${f.lat}, ${f.lng}`).join(`
`)}catch(u){return await L(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function rr(e,t,a,r,n){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(a,r,"assistant",s,"{}",n),t.push({id:-1,user_id:a,channel:r,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function nr(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function _n(e,t,a,r,n,s,i){var E;const o=new te(t),l=(E=e.metadata)==null?void 0:E.thread_id,c=Date.now(),[d,p]=await Promise.all([o.buildContext(r.id),jt(t,r.id)]),h=await o.getRecentConversations(r.id,25,l);await rr(o,h,r.id,e.channel,l);const v=er(r,d,e.channel,p),y=Qa([{role:"system",content:v},...h.map(x=>({role:x.role,content:x.content})),{role:"user",content:e.text}]);nr(y),await o.storeMessage(r.id,e.channel,"user",e.text,"{}",l);const T=(i==null?void 0:i.maxTurns)??10,w=(i==null?void 0:i.tools)??Bt;let _="",u=0;const g=[];for(let x=0;x<T;x++)try{const S=await a.chat(y,{tools:w});if(S.usage&&(u+=S.usage.promptTokens+S.usage.completionTokens),S.toolCalls&&S.toolCalls.length>0){S.content&&y.push({role:"assistant",content:S.content});for(const I of S.toolCalls){g.push(I.name);try{const k=await ar(I.name,I.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);y.push({role:"user",content:`[Tool Result for ${I.name}]: ${k}`})}catch(k){await L(t,r.id,"tool",I.name,k.message||"Tool execution failed"),y.push({role:"user",content:`[Tool Error for ${I.name}]: ${k.message||"Execution failed"}`})}}continue}_=S.content;break}catch(S){if(n){const I=S.message||"",k=I.includes("401")||I.includes("403")||I.includes("authentication")||I.includes("credit balance"),D=I.includes("429"),A=k?1440:D?10:5;await n.recordError(a.name,I,A)}throw await L(t,r.id,"llm","provider_error",S.message||"Unknown LLM error",{provider:a.name,turn:x}),S}if(!_)try{y.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),_=(await a.chat(y,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me directly and I will answer from my knowledge."}catch{_="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge."}if(n&&u>0)try{await n.recordUsage(a.name,u)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",u,Date.now()-c,1,e.channel).run()}catch{}const m=_.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),f=g.length>0?`[TOOLS_USED: ${[...new Set(g)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",f+m,"{}",l),await o.compactHistory(r.id,30),_}const Xt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function En(e){for(const[t,a]of Object.entries(Xt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Xt.default}function Tn(e,t,a,r){const n=En(r),s=Math.floor(n*.75),i=[];let o=0,l=!1;const c=kt(e);i.push({role:"system",content:e}),o+=c;const d=kt(a);o+=d;const p=s-o,h=[];let v=0;for(let y=t.length-1;y>=0;y--){const T=t[y],w=kt(T.content);if(v+w<=p)h.unshift({role:T.role,content:T.content}),v+=w;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:a}),o+=v,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*xn(e,t,a,r,n,s){var u;const i=new te(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:a.name}};const[c,d]=await Promise.all([i.buildContext(r.id),jt(t,r.id)]),p=await i.getRecentConversations(r.id,20,o);await rr(i,p,r.id,e.channel,o);const h=er(r,c,e.channel,d),v=Tn(h,p,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const y=10;let T="",w=0;const _=[...v.messages];nr(_);for(let g=0;g<y;g++)try{g>0&&(yield{type:"thinking",data:{threadId:o}});const m=await a.chat(_,{tools:Bt});if(m.usage&&(w+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){m.content&&(yield{type:"chunk",data:{text:m.content,threadId:o}},_.push({role:"assistant",content:m.content}));for(const E of m.toolCalls){yield{type:"tool_start",data:{tool:E.name,toolArgs:E.arguments,threadId:o}};try{const x=await ar(E.name,E.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:E.name,toolResult:x.substring(0,500)+(x.length>500?"...":""),threadId:o}},_.push({role:"user",content:`[Tool Result for ${E.name}]: ${x}`})}catch(x){await L(t,r.id,"tool",E.name,x.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:E.name,toolResult:`Error: ${x.message||"Execution failed"}`,threadId:o}},_.push({role:"user",content:`[Tool Error for ${E.name}]: ${x.message||"Execution failed"}`})}}continue}T=m.content;const f=50;for(let E=0;E<T.length;E+=f)yield{type:"chunk",data:{text:T.substring(E,E+f),threadId:o}},E+f<T.length&&await new Promise(S=>setTimeout(S,10));break}catch(m){if(n){const E=m.message||"",x=E.includes("401")||E.includes("403")||E.includes("authentication")||E.includes("credit balance"),S=E.includes("429"),I=x?1440:S?10:5;await n.recordError(a.name,E,I)}await L(t,r.id,"llm","provider_error",m.message||"Unknown LLM error",{provider:a.name,turn:g});const f=m.message||"An error occurred";try{await i.storeMessage(r.id,e.channel,"assistant",`⚠️ ${f}`,"{}",o)}catch{}yield{type:"error",data:{error:f,threadId:o}};return}if(!T)try{_.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),T=(await a.chat(_,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const m=50;for(let f=0;f<T.length;f+=m)yield{type:"chunk",data:{text:T.substring(f,f+m),threadId:o}},f+m<T.length&&await new Promise(E=>setTimeout(E,10))}catch{T="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",yield{type:"chunk",data:{text:T,threadId:o}}}if(n&&w>0)try{await n.recordUsage(a.name,w)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",w,Date.now()-l,1,e.channel).run()}catch{}await i.storeMessage(r.id,e.channel,"assistant",T,"{}",o),await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:w}}}async function Pt(e,t,a,r,n,s){var p;const i=new te(t),o=(p=e.metadata)==null?void 0:p.thread_id,l=await i.buildContext(r.id);if(Xa(e.text,l).agent==="conversation")return sr(e,t,a,r,l,n,o);const d=e.channel==="telegram"?{maxTurns:4,tools:Bt.filter(h=>h.name!=="research")}:void 0;return _n(e,t,a,r,n,s,d)}async function sr(e,t,a,r,n,s,i){const o=new te(t),l=Date.now(),c=tr(r.timezone),d=await jt(t,r.id),p=d?`## Your Standing Instructions
These are explicit preferences the user has set. Follow them in every response.
${d}

${n}`:n,h=yn("conversation",r,p,r.timezone,c,e.channel),v=(await o.getRecentConversations(r.id,25,i)).filter(_=>!_.content.startsWith("[Autonomous Scheduled Task]")&&!_.content.startsWith("[Scheduled Reminder]")),y=Qa([{role:"system",content:h},...v.map(_=>({role:_.role,content:_.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);let T=0,w="";try{const _=await a.chat(y,{temperature:.8});_.usage&&(T=_.usage.promptTokens+_.usage.completionTokens),w=_.content}catch(_){if(s){const u=_.message||"",g=u.includes("401")||u.includes("403")||u.includes("authentication")||u.includes("credit balance"),m=u.includes("429"),f=g?1440:m?10:5;await s.recordError(a.name,u,f)}throw await L(t,r.id,"llm","conversation_error",_.message,{provider:a.name}),_}if(s&&T>0)try{await s.recordUsage(a.name,T)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"conversation",T,Date.now()-l,1,e.channel).run()}catch{}return await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),w}async function*kn(e,t,a,r,n,s){var d;const i=new te(t),o=(d=e.metadata)==null?void 0:d.thread_id,l=await i.buildContext(r.id),c=Xa(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:a.name}},c.agent!=="conversation"){yield*xn(e,t,a,r,n,s);return}try{const p=await sr(e,t,a,r,l,n,o),h=50;for(let v=0;v<p.length;v+=h)yield{type:"chunk",data:{text:p.substring(v,v+h),threadId:o}},v+h<p.length&&await new Promise(y=>setTimeout(y,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:0}}}const j=new we;async function Sn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}j.use("/*",Sn);j.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await B(a,t,l),!0}case"/help":{const o=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await B(a,t,o),!0}case"/status":{if(!r)return await B(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[i,o,l,c]=await Promise.all([n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),d=`📊 *System Status*
...
Status: ✅ Online`;await B(a,t,d)}catch{await B(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await B(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await B(a,t,"⚠️ Account not linked."),!0);case"/tasks":case"/task":{if(!r)return await B(a,t,"⚠️ Account not linked."),!0;try{const o=(await n.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(o.length===0)return await B(a,t,"✅ No open tasks. You're all clear."),!0;const l=new Date,c=l.toISOString().slice(0,10),d=new Date(l);d.setDate(d.getDate()+1);const p=d.toISOString().slice(0,10),h=[`📋 *Open Tasks (${o.length})*
`];for(const v of o){let y="";if(v.due_date){const T=v.due_date.slice(0,10);T<c?y=" ⚠️ _overdue_":T===c?y=" 🔴 _due today_":T===p?y=" 🟡 _due tomorrow_":y=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}h.push(`☐ ${v.title}${y}`)}h.push(`
_Say "mark [task] as done" to close a task._`),await B(a,t,h.join(`
`))}catch(i){await B(a,t,"❌ Could not fetch tasks: "+i.message)}return!0}default:return!1}}st.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},n=async()=>{var s,i,o,l,c;try{if(t.callback_query){await $n(a,t.callback_query);return}const d=t.message;if(!d)return;const p=!!d.text,h=!!d.voice,v=!!d.document,y=!!d.photo,T=!!d.caption;if(!p&&!h&&!v&&!y)return;const w=String(d.chat.id);let _=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(w).first();let g=null;if(u){const k=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();k&&(g=await G(k.encrypted_value,u.pin_hash))}if(!g){const k=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();k&&(g=await G(k.encrypted_value,k.pin_hash))}if(!g||_.startsWith("/")&&await Mn(_,w,g,u,a))return;if(!u){await B(g,w,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${w}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&g&&u)try{await B(g,w,"🎤 Processing voice note...");const D=await(await fetch(`https://api.telegram.org/bot${g}/getFile?file_id=${d.voice.file_id}`)).json();if(D.ok&&((s=D.result)!=null&&s.file_path)){const M=await(await fetch(`https://api.telegram.org/file/bot${g}/${D.result.file_path}`)).blob();let P="",U="",H="whisper-1";const Y=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const Ee of Y.results){const it=await G(Ee.encrypted_value,u.pin_hash);if(Ee.service==="openai"){P="https://api.openai.com/v1/audio/transcriptions",U=it;break}else if(Ee.service.startsWith("llm_slot_"))try{const ot=JSON.parse(it);if(ot.provider==="openai"){P="https://api.openai.com/v1/audio/transcriptions",U=ot.apiKey;break}else if(ot.provider==="groq"){P="https://api.groq.com/openai/v1/audio/transcriptions",U=ot.apiKey,H="whisper-large-v3";break}}catch{}}if(!P){await B(g,w,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const X=new FormData;X.append("file",M,"voice.ogg"),X.append("model",H),X.append("language","en");const se=await fetch(P,{method:"POST",headers:{Authorization:`Bearer ${U}`},body:X});if(!se.ok){const Ee=await se.text();await B(g,w,`⚠️ Transcription failed: ${se.status} ${Ee}`);return}_=(await se.json()).text,await B(g,w,`🗣️ *You said:* ${_}`)}}catch(k){await B(g,w,`⚠️ Failed to process voice note: ${k.message}`);return}if((v||y)&&g&&u)try{let k,D="unknown",A="unknown",M=0;if(v)k=d.document.file_id,D=d.document.file_name||"document",A=d.document.mime_type||"unknown",M=d.document.file_size||0;else if(y){const P=d.photo[d.photo.length-1];k=P.file_id,D="photo.jpg",A="image/jpeg",M=P.file_size||0}if(k){const U=await(await fetch(`https://api.telegram.org/bot${g}/getFile?file_id=${k}`)).json();let H="";if(U.ok&&((i=U.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(D)||/^text\/|application\/json|application\/xml|application\/csv/i.test(A))&&M<5e4)try{H=await(await fetch(`https://api.telegram.org/file/bot${g}/${U.result.file_path}`)).text()}catch{}const Y=d.caption||"",X=`[Telegram file received: "${D}" (${A}, ${Math.round(M/1024)}KB)]`;H?_=`${Y?Y+`

`:""}${X}
File contents:
${H.substring(0,8e3)}${H.length>8e3?`
[...truncated]`:""}`:_=`${Y?Y+`

`:""}${X}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(k){if(T&&d.caption)_=d.caption;else{await B(g,w,`⚠️ Received your file but couldn't process it: ${k.message}`);return}}if(!_)return;Ln(g,w).catch(()=>{});let m=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();m?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(m.id).run():m={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const f=Cn(u.id,u.username,_,w);f.metadata={thread_id:m.id};let E,x;try{const k=await nt(a,u.id,u.pin_hash);E=k.provider,x=k.rotation}catch(k){console.error("Telegram provider setup error:",k);const D=(o=k.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=k.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${k.message||"Unknown error"}`;await B(g,w,D);return}/\b(write\s+(an?\s+)?(essay|article|report|document|doc|blog|post|summary|draft)|draft\s+(an?\s+)?(essay|article|report|document)|research\s+.{0,60}(save|store|drive|doc))\b/i.test(_)&&await B(g,w,"📝 Working on it— searching and saving to Drive takes about 20 seconds...");const I=25e3;try{const k=await Promise.race([Pt(f,a,E,u,x,r),new Promise((A,M)=>setTimeout(()=>M(new Error("TELEGRAM_TIMEOUT")),I))]),D=Rn(k,"telegram");await B(g,w,D||"(empty response)")}catch(k){console.error("Telegram agent error:",k);const D=k.message==="TELEGRAM_TIMEOUT",A=D?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=k.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${E.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(k.message||"Unknown").substring(0,200)}`;await B(g,w,A);try{const{logError:M}=await Promise.resolve().then(()=>Dt);await M(a,u.id,"telegram",D?"timeout":"agent_error",k.message||"Agent error",{provider:E.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:p}=await Promise.resolve().then(()=>Dt);await p(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(n()),e.json({ok:!0})});st.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await G(n.encrypted_value,a.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});st.get("/webhook-status",async e=>{var s,i,o,l,c,d;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await G(r.encrypted_value,a.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((c=h.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=h.result)==null?void 0:d.last_error_date)||null})}catch(p){return e.json({configured:!0,error:p.message})}});st.post("/detect-chat-id",async e=>{var s,i;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await G(r.encrypted_value,a.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const p=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:["message"]})});const h=p.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],y=new Set;for(let w=h.length-1;w>=0;w--){const _=h[w].message;if(_&&_.chat){const u=String(_.chat.id);y.has(u)||(y.add(u),v.push({chat_id:u,name:[_.chat.first_name,_.chat.last_name].filter(Boolean).join(" ")||_.chat.title||"Unknown",username:_.chat.username||"",date:new Date((_.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const T=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(T,a.user_id).run(),e.json({found:!0,chat_id:T,name:v[0].name,all_chats:v,message:`Chat ID ${T} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function $n(e,t){var T;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const i=r.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const c=String(n.chat.id),d=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(c).first();if(!d)return;const p=await e.prepare(`
  ...
  `).bind(h,h,p.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(d.id).first();if(!v)return;const y=await G(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:h?"✅ Checked!":"☐ Unchecked"})}),(T=n.reply_markup)!=null&&T.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(_=>_.map(u=>{var g;if((g=u.callback_data)!=null&&g.includes(o)){const m=h?"✅":"☐",f=u.text.replace(/^[☐✅]\s*/,"");return{...u,text:`${m} ${f}`}}return u}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function Bn(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function jn(e,t,a,r,n,s){try{return(await new $t(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Pn(e,t,a,r,n){try{const s=new oe(e,t,a,r,n),i=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const p of i){const h=p.from.split("<")[0].trim()||p.from;l[h]=(l[h]||0)+1}const c=Object.entries(l).sort(([,p],[,h])=>h-p).slice(0,5).map(([p])=>p),d=i.some(p=>p.subject.toLowerCase().includes("urgent")||p.subject.toLowerCase().includes("asap")||p.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Un(e,t){try{const a=await e.prepare(`
