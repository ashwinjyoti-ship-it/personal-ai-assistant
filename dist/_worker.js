var Vr=Object.defineProperty;var $n=e=>{throw TypeError(e)};var Zr=(e,t,n)=>t in e?Vr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var B=(e,t,n)=>Zr(e,typeof t!="symbol"?t+"":t,n),on=(e,t,n)=>t.has(e)||$n("Cannot "+n);var x=(e,t,n)=>(on(e,t,"read from private field"),n?n.call(e):t.get(e)),V=(e,t,n)=>t.has(e)?$n("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),G=(e,t,n,s)=>(on(e,t,"write to private field"),s?s.call(e,n):t.set(e,n),n),se=(e,t,n)=>(on(e,t,"access private method"),n);var Pn=(e,t,n,s)=>({set _(r){G(e,t,r,n)},get _(){return x(e,t,s)}});var Bn=(e,t,n)=>(s,r)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&r||void 0,d)try{l=await d(s,()=>i(o+1))}catch(u){if(u instanceof Error&&t)s.error=u,l=await t(u,s),c=!0;else throw u}else s.finalized===!1&&n&&(l=await n(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},Xr=Symbol(),Qr=async(e,t=Object.create(null))=>{const{all:n=!1,dot:s=!1}=t,a=(e instanceof ws?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?ea(e,{all:n,dot:s}):{}};async function ea(e,t){const n=await e.formData();return n?ta(n,t):{}}function ta(e,t){const n=Object.create(null);return e.forEach((s,r)=>{t.all||r.endsWith("[]")?na(n,r,s):n[r]=s}),t.dot&&Object.entries(n).forEach(([s,r])=>{s.includes(".")&&(sa(n,s,r),delete n[s])}),n}var na=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},sa=(e,t,n)=>{let s=e;const r=t.split(".");r.forEach((a,i)=>{i===r.length-1?s[a]=n:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},hs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ra=e=>{const{groups:t,path:n}=aa(e),s=hs(n);return ia(s,t)},aa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,s)=>{const r=`@${s}`;return t.push([r,n]),r}),{groups:t,path:e}},ia=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[s]=t[n];for(let r=e.length-1;r>=0;r--)if(e[r].includes(s)){e[r]=e[r].replace(s,t[n][1]);break}}return e},zt={},oa=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const s=`${e}#${t}`;return zt[s]||(n[2]?zt[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:zt[s]=[e,n[1],!0]),zt[s]}return null},Tn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},la=e=>Tn(e,decodeURI),gs=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let s=n;for(;s<t.length;s++){const r=t.charCodeAt(s);if(r===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return la(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(n,s)},ca=e=>{const t=gs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ht=(e,t,...n)=>(n.length&&(t=ht(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),fs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let s="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))s+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){n.length===0&&s===""?n.push("/"):n.push(s);const a=r.replace("?","");s+="/"+a,n.push(s)}else s+="/"+r}),n.filter((r,a,i)=>i.indexOf(r)===a)},ln=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Tn(e,vs):e):e,ys=(e,t,n)=>{let s;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return ln(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const r={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(l=ln(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=ln(c))),n?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(c)):r[l]??(r[l]=c)}return t?r[t]:r},da=ys,ua=(e,t)=>ys(e,t,!0),vs=decodeURIComponent,jn=e=>Tn(e,vs),vt,_e,Be,bs,_s,gn,Ue,ls,ws=(ls=class{constructor(e,t="/",n=[[]]){V(this,Be);B(this,"raw");V(this,vt);V(this,_e);B(this,"routeIndex",0);B(this,"path");B(this,"bodyCache",{});V(this,Ue,e=>{const{bodyCache:t,raw:n}=this,s=t[e];if(s)return s;const r=Object.keys(t)[0];return r?t[r].then(a=>(r==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,G(this,_e,n),G(this,vt,{})}param(e){return e?se(this,Be,bs).call(this,e):se(this,Be,_s).call(this)}query(e){return da(this.url,e)}queries(e){return ua(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,s)=>{t[s]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Qr(this,e))}json(){return x(this,Ue).call(this,"text").then(e=>JSON.parse(e))}text(){return x(this,Ue).call(this,"text")}arrayBuffer(){return x(this,Ue).call(this,"arrayBuffer")}blob(){return x(this,Ue).call(this,"blob")}formData(){return x(this,Ue).call(this,"formData")}addValidatedData(e,t){x(this,vt)[e]=t}valid(e){return x(this,vt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Xr](){return x(this,_e)}get matchedRoutes(){return x(this,_e)[0].map(([[,e]])=>e)}get routePath(){return x(this,_e)[0].map(([[,e]])=>e)[this.routeIndex].path}},vt=new WeakMap,_e=new WeakMap,Be=new WeakSet,bs=function(e){const t=x(this,_e)[0][this.routeIndex][1][e],n=se(this,Be,gn).call(this,t);return n&&/\%/.test(n)?jn(n):n},_s=function(){const e={},t=Object.keys(x(this,_e)[0][this.routeIndex][1]);for(const n of t){const s=se(this,Be,gn).call(this,x(this,_e)[0][this.routeIndex][1][n]);s!==void 0&&(e[n]=/\%/.test(s)?jn(s):s)}return e},gn=function(e){return x(this,_e)[1]?x(this,_e)[1][e]:e},Ue=new WeakMap,ls),ma={Stringify:1},Es=async(e,t,n,s,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(r?r[0]+=e:r=[e],Promise.all(a.map(o=>o({phase:t,buffer:r,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Es(l,t,!1,s,r))).then(()=>r[0]))):Promise.resolve(e)},pa="text/plain; charset=UTF-8",cn=(e,t)=>({"Content-Type":e,...t}),$t,Pt,Le,wt,Me,be,Bt,bt,_t,st,jt,Ut,He,gt,cs,ha=(cs=class{constructor(e,t){V(this,He);V(this,$t);V(this,Pt);B(this,"env",{});V(this,Le);B(this,"finalized",!1);B(this,"error");V(this,wt);V(this,Me);V(this,be);V(this,Bt);V(this,bt);V(this,_t);V(this,st);V(this,jt);V(this,Ut);B(this,"render",(...e)=>(x(this,bt)??G(this,bt,t=>this.html(t)),x(this,bt).call(this,...e)));B(this,"setLayout",e=>G(this,Bt,e));B(this,"getLayout",()=>x(this,Bt));B(this,"setRenderer",e=>{G(this,bt,e)});B(this,"header",(e,t,n)=>{this.finalized&&G(this,be,new Response(x(this,be).body,x(this,be)));const s=x(this,be)?x(this,be).headers:x(this,st)??G(this,st,new Headers);t===void 0?s.delete(e):n!=null&&n.append?s.append(e,t):s.set(e,t)});B(this,"status",e=>{G(this,wt,e)});B(this,"set",(e,t)=>{x(this,Le)??G(this,Le,new Map),x(this,Le).set(e,t)});B(this,"get",e=>x(this,Le)?x(this,Le).get(e):void 0);B(this,"newResponse",(...e)=>se(this,He,gt).call(this,...e));B(this,"body",(e,t,n)=>se(this,He,gt).call(this,e,t,n));B(this,"text",(e,t,n)=>!x(this,st)&&!x(this,wt)&&!t&&!n&&!this.finalized?new Response(e):se(this,He,gt).call(this,e,t,cn(pa,n)));B(this,"json",(e,t,n)=>se(this,He,gt).call(this,JSON.stringify(e),t,cn("application/json",n)));B(this,"html",(e,t,n)=>{const s=r=>se(this,He,gt).call(this,r,t,cn("text/html; charset=UTF-8",n));return typeof e=="object"?Es(e,ma.Stringify,!1,{}).then(s):s(e)});B(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});B(this,"notFound",()=>(x(this,_t)??G(this,_t,()=>new Response),x(this,_t).call(this,this)));G(this,$t,e),t&&(G(this,Me,t.executionCtx),this.env=t.env,G(this,_t,t.notFoundHandler),G(this,Ut,t.path),G(this,jt,t.matchResult))}get req(){return x(this,Pt)??G(this,Pt,new ws(x(this,$t),x(this,Ut),x(this,jt))),x(this,Pt)}get event(){if(x(this,Me)&&"respondWith"in x(this,Me))return x(this,Me);throw Error("This context has no FetchEvent")}get executionCtx(){if(x(this,Me))return x(this,Me);throw Error("This context has no ExecutionContext")}get res(){return x(this,be)||G(this,be,new Response(null,{headers:x(this,st)??G(this,st,new Headers)}))}set res(e){if(x(this,be)&&e){e=new Response(e.body,e);for(const[t,n]of x(this,be).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=x(this,be).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of s)e.headers.append("set-cookie",r)}else e.headers.set(t,n)}G(this,be,e),this.finalized=!0}get var(){return x(this,Le)?Object.fromEntries(x(this,Le)):{}}},$t=new WeakMap,Pt=new WeakMap,Le=new WeakMap,wt=new WeakMap,Me=new WeakMap,be=new WeakMap,Bt=new WeakMap,bt=new WeakMap,_t=new WeakMap,st=new WeakMap,jt=new WeakMap,Ut=new WeakMap,He=new WeakSet,gt=function(e,t,n){const s=x(this,be)?new Headers(x(this,be).headers):x(this,st)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??x(this,wt);return new Response(e,{status:r,headers:s})},cs),me="ALL",ga="all",fa=["get","post","put","delete","options","patch"],Ts="Can not add a route since the matcher is already built.",Ss=class extends Error{},ya="__COMPOSED_HANDLER",va=e=>e.text("404 Not Found",404),Un=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},Se,pe,xs,xe,tt,Kt,Yt,Et,wa=(Et=class{constructor(t={}){V(this,pe);B(this,"get");B(this,"post");B(this,"put");B(this,"delete");B(this,"options");B(this,"patch");B(this,"all");B(this,"on");B(this,"use");B(this,"router");B(this,"getPath");B(this,"_basePath","/");V(this,Se,"/");B(this,"routes",[]);V(this,xe,va);B(this,"errorHandler",Un);B(this,"onError",t=>(this.errorHandler=t,this));B(this,"notFound",t=>(G(this,xe,t),this));B(this,"fetch",(t,...n)=>se(this,pe,Yt).call(this,t,n[1],n[0],t.method));B(this,"request",(t,n,s,r)=>t instanceof Request?this.fetch(n?new Request(t,n):t,s,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ht("/",t)}`,n),s,r)));B(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(se(this,pe,Yt).call(this,t.request,t,void 0,t.request.method))})});[...fa,ga].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?G(this,Se,i):se(this,pe,tt).call(this,a,x(this,Se),i),o.forEach(l=>{se(this,pe,tt).call(this,a,x(this,Se),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){G(this,Se,l);for(const c of[a].flat())o.map(d=>{se(this,pe,tt).call(this,c.toUpperCase(),x(this,Se),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?G(this,Se,a):(G(this,Se,"*"),i.unshift(a)),i.forEach(o=>{se(this,pe,tt).call(this,me,x(this,Se),o)}),this);const{strict:s,...r}=t;Object.assign(this,r),this.getPath=s??!0?t.getPath??gs:ca}route(t,n){const s=this.basePath(t);return n.routes.map(r=>{var i;let a;n.errorHandler===Un?a=r.handler:(a=async(o,l)=>(await Bn([],n.errorHandler)(o,()=>r.handler(o,l))).res,a[ya]=r.handler),se(i=s,pe,tt).call(i,r.method,r.path,a)}),this}basePath(t){const n=se(this,pe,xs).call(this);return n._basePath=ht(this._basePath,t),n}mount(t,n,s){let r,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?r=l=>l:r=s.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};r||(r=(()=>{const l=ht(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(r(l.req.raw),...i(l));if(d)return d;await c()};return se(this,pe,tt).call(this,me,ht(t,"*"),o),this}},Se=new WeakMap,pe=new WeakSet,xs=function(){const t=new Et({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,G(t,xe,x(this,xe)),t.routes=this.routes,t},xe=new WeakMap,tt=function(t,n,s){t=t.toUpperCase(),n=ht(this._basePath,n);const r={basePath:this._basePath,path:n,method:t,handler:s};this.router.add(t,n,[s,r]),this.routes.push(r)},Kt=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},Yt=function(t,n,s,r){if(r==="HEAD")return(async()=>new Response(null,await se(this,pe,Yt).call(this,t,n,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(r,a),o=new ha(t,{path:a,matchResult:i,env:s,executionCtx:n,notFoundHandler:x(this,xe)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await x(this,xe).call(this,o)})}catch(d){return se(this,pe,Kt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:x(this,xe).call(this,o))).catch(d=>se(this,pe,Kt).call(this,d,o)):c??x(this,xe).call(this,o)}const l=Bn(i[0],this.errorHandler,x(this,xe));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return se(this,pe,Kt).call(this,c,o)}})()},Et),ks=[];function ba(e,t){const n=this.buildAllMatchers(),s=((r,a)=>{const i=n[r]||n[me],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],ks];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=s,s(e,t)}var Vt="[^/]+",It=".*",Nt="(?:|/.*)",ft=Symbol(),_a=new Set(".\\+*[^]$()");function Ea(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===It||e===Nt?1:t===It||t===Nt?-1:e===Vt?1:t===Vt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var rt,at,ke,lt,Ta=(lt=class{constructor(){V(this,rt);V(this,at);V(this,ke,Object.create(null))}insert(t,n,s,r,a){if(t.length===0){if(x(this,rt)!==void 0)throw ft;if(a)return;G(this,rt,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",It]:["","",Vt]:i==="/*"?["","",Nt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||Vt;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ft;if(c=x(this,ke)[u],!c){if(Object.keys(x(this,ke)).some(p=>p!==It&&p!==Nt))throw ft;if(a)return;c=x(this,ke)[u]=new lt,d!==""&&G(c,at,r.varIndex++)}!a&&d!==""&&s.push([d,x(c,at)])}else if(c=x(this,ke)[i],!c){if(Object.keys(x(this,ke)).some(d=>d.length>1&&d!==It&&d!==Nt))throw ft;if(a)return;c=x(this,ke)[i]=new lt}c.insert(o,n,s,r,a)}buildRegExpStr(){const n=Object.keys(x(this,ke)).sort(Ea).map(s=>{const r=x(this,ke)[s];return(typeof x(r,at)=="number"?`(${s})@${x(r,at)}`:_a.has(s)?`\\${s}`:s)+r.buildRegExpStr()});return typeof x(this,rt)=="number"&&n.unshift(`#${x(this,rt)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},rt=new WeakMap,at=new WeakMap,ke=new WeakMap,lt),Xt,Ht,ds,Sa=(ds=class{constructor(){V(this,Xt,{varIndex:0});V(this,Ht,new Ta)}insert(e,t,n){const s=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return r[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,r[i][1]);break}}return x(this,Ht).insert(a,t,s,x(this,Xt),n),s}buildRegExp(){let e=x(this,Ht).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,s]}},Xt=new WeakMap,Ht=new WeakMap,ds),xa=[/^$/,[],Object.create(null)],Jt=Object.create(null);function Ds(e){return Jt[e]??(Jt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function ka(){Jt=Object.create(null)}function Da(e){var c;const t=new Sa,n=[];if(e.length===0)return xa;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[p,g])=>d?1:p?-1:u.length-g.length),r=Object.create(null);for(let d=0,u=-1,p=s.length;d<p;d++){const[g,y,w]=s[d];g?r[y]=[w.map(([E])=>[E,Object.create(null)]),ks]:u++;let v;try{v=t.insert(y,u,g)}catch(E){throw E===ft?new Ss(y):E}g||(n[u]=w.map(([E,T])=>{const D=Object.create(null);for(T-=1;T>=0;T--){const[O,L]=v[T];D[O]=L}return[E,D]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let p=0,g=n[d].length;p<g;p++){const y=(c=n[d][p])==null?void 0:c[1];if(!y)continue;const w=Object.keys(y);for(let v=0,E=w.length;v<E;v++)y[w[v]]=o[y[w[v]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,r]}function dt(e,t){if(e){for(const n of Object.keys(e).sort((s,r)=>r.length-s.length))if(Ds(n).test(t))return[...e[n]]}}var Fe,Ge,Qt,Rs,us,Ra=(us=class{constructor(){V(this,Qt);B(this,"name","RegExpRouter");V(this,Fe);V(this,Ge);B(this,"match",ba);G(this,Fe,{[me]:Object.create(null)}),G(this,Ge,{[me]:Object.create(null)})}add(e,t,n){var o;const s=x(this,Fe),r=x(this,Ge);if(!s||!r)throw new Error(Ts);s[e]||[s,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[me]).forEach(c=>{l[e][c]=[...l[me][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Ds(t);e===me?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=dt(s[c],t)||dt(s[me],t)||[])}):(o=s[e])[t]||(o[t]=dt(s[e],t)||dt(s[me],t)||[]),Object.keys(s).forEach(c=>{(e===me||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([n,a])})}),Object.keys(r).forEach(c=>{(e===me||e===c)&&Object.keys(r[c]).forEach(d=>l.test(d)&&r[c][d].push([n,a]))});return}const i=fs(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(r).forEach(u=>{var p;(e===me||e===u)&&((p=r[u])[d]||(p[d]=[...dt(s[u],d)||dt(s[me],d)||[]]),r[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(x(this,Ge)).concat(Object.keys(x(this,Fe))).forEach(t=>{e[t]||(e[t]=se(this,Qt,Rs).call(this,t))}),G(this,Fe,G(this,Ge,void 0)),ka(),e}},Fe=new WeakMap,Ge=new WeakMap,Qt=new WeakSet,Rs=function(e){const t=[];let n=e===me;return[x(this,Fe),x(this,Ge)].forEach(s=>{const r=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];r.length!==0?(n||(n=!0),t.push(...r)):e!==me&&t.push(...Object.keys(s[me]).map(a=>[a,s[me][a]]))}),n?Da(t):null},us),We,$e,ms,Oa=(ms=class{constructor(e){B(this,"name","SmartRouter");V(this,We,[]);V(this,$e,[]);G(this,We,e.routers)}add(e,t,n){if(!x(this,$e))throw new Error(Ts);x(this,$e).push([e,t,n])}match(e,t){if(!x(this,$e))throw new Error("Fatal error");const n=x(this,We),s=x(this,$e),r=n.length;let a=0,i;for(;a<r;a++){const o=n[a];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof Ss)continue;throw l}this.match=o.match.bind(o),G(this,We,[o]),G(this,$e,void 0);break}if(a===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(x(this,$e)||x(this,We).length!==1)throw new Error("No active router has been determined yet.");return x(this,We)[0]}},We=new WeakMap,$e=new WeakMap,ms),Dt=Object.create(null),qe,ye,it,Tt,he,Pe,nt,St,Ia=(St=class{constructor(t,n,s){V(this,Pe);V(this,qe);V(this,ye);V(this,it);V(this,Tt,0);V(this,he,Dt);if(G(this,ye,s||Object.create(null)),G(this,qe,[]),t&&n){const r=Object.create(null);r[t]={handler:n,possibleKeys:[],score:0},G(this,qe,[r])}G(this,it,[])}insert(t,n,s){G(this,Tt,++Pn(this,Tt)._);let r=this;const a=ra(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=oa(c,d),p=Array.isArray(u)?u[0]:c;if(p in x(r,ye)){r=x(r,ye)[p],u&&i.push(u[1]);continue}x(r,ye)[p]=new St,u&&(x(r,it).push(u),i.push(u[1])),r=x(r,ye)[p]}return x(r,qe).push({[t]:{handler:s,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:x(this,Tt)}}),r}search(t,n){var l;const s=[];G(this,he,Dt);let a=[this];const i=hs(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],p=c===d-1,g=[];for(let y=0,w=a.length;y<w;y++){const v=a[y],E=x(v,ye)[u];E&&(G(E,he,x(v,he)),p?(x(E,ye)["*"]&&s.push(...se(this,Pe,nt).call(this,x(E,ye)["*"],t,x(v,he))),s.push(...se(this,Pe,nt).call(this,E,t,x(v,he)))):g.push(E));for(let T=0,D=x(v,it).length;T<D;T++){const O=x(v,it)[T],L=x(v,he)===Dt?{}:{...x(v,he)};if(O==="*"){const C=x(v,ye)["*"];C&&(s.push(...se(this,Pe,nt).call(this,C,t,x(v,he))),G(C,he,L),g.push(C));continue}const[A,F,Y]=O;if(!u&&!(Y instanceof RegExp))continue;const ee=x(v,ye)[A],ae=i.slice(c).join("/");if(Y instanceof RegExp){const C=Y.exec(ae);if(C){if(L[F]=C[0],s.push(...se(this,Pe,nt).call(this,ee,t,x(v,he),L)),Object.keys(x(ee,ye)).length){G(ee,he,L);const K=((l=C[0].match(/\//))==null?void 0:l.length)??0;(o[K]||(o[K]=[])).push(ee)}continue}}(Y===!0||Y.test(u))&&(L[F]=u,p?(s.push(...se(this,Pe,nt).call(this,ee,t,L,x(v,he))),x(ee,ye)["*"]&&s.push(...se(this,Pe,nt).call(this,x(ee,ye)["*"],t,L,x(v,he)))):(G(ee,he,L),g.push(ee)))}}a=g.concat(o.shift()??[])}return s.length>1&&s.sort((c,d)=>c.score-d.score),[s.map(({handler:c,params:d})=>[c,d])]}},qe=new WeakMap,ye=new WeakMap,it=new WeakMap,Tt=new WeakMap,he=new WeakMap,Pe=new WeakSet,nt=function(t,n,s,r){const a=[];for(let i=0,o=x(t,qe).length;i<o;i++){const l=x(t,qe)[i],c=l[n]||l[me],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),s!==Dt||r&&r!==Dt))for(let u=0,p=c.possibleKeys.length;u<p;u++){const g=c.possibleKeys[u],y=d[c.score];c.params[g]=r!=null&&r[g]&&!y?r[g]:s[g]??(r==null?void 0:r[g]),d[c.score]=!0}}return a},St),ot,ps,Na=(ps=class{constructor(){B(this,"name","TrieRouter");V(this,ot);G(this,ot,new Ia)}add(e,t,n){const s=fs(t);if(s){for(let r=0,a=s.length;r<a;r++)x(this,ot).insert(e,s[r],n);return}x(this,ot).insert(e,t,n)}match(e,t){return x(this,ot).search(e,t)}},ot=new WeakMap,ps),Ee=class extends wa{constructor(e={}){super(e),this.router=e.router??new Oa({routers:[new Ra,new Na]})}},Ca=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),r=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,p){i.res.headers.set(u,p)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await r(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let p=n.allowHeaders;if(!(p!=null&&p.length)){const g=i.req.header("Access-Control-Request-Headers");g&&(p=g.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Aa(){return`  // === Karna v3.1 Frontend ===
...
`}function La(){return`  // === Render Core ===
  function render() {
...
`}function Ua(){return`  // === Memory Review ===
...
`}function Ha(){return`  // === Document Library ===
...
`}function qa(){return`  // === Init ===
  ...
  // ============================================================`}function za(){return`  async function renderDocumentsView(container) {
...
`}function Os(e=""){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}function Ka(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover">
...
Check your ${s} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>tn),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const u=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!u)return;const p=await c(u.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${p}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function Fn(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Ls{constructor(t,n="claude-sonnet-4-20250514",s="https://api.anthropic.com",r="anthropic"){B(this,"name");B(this,"apiKey");B(this,"model");B(this,"apiBase");this.apiKey=t,this.model=n,this.apiBase=s,this.name=r}async chat(t,n){var d,u,p,g;const s=t.find(y=>y.role==="system"),r=t.filter(y=>y.role!=="system"),a={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,messages:r.map(y=>({role:y.role,content:y.content}))};s&&(a.system=s.content),n!=null&&n.tools&&n.tools.length>0&&(a.tools=n.tools.map(y=>({name:y.name,description:y.description,input_schema:y.parameters})),n.toolChoice==="required"&&(a.tool_choice={type:"any"}));const i=await As(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(a)}),this.name);if(!i.ok){const y=await i.text();throw new Error(this.name+" API error "+i.status+": "+y)}const o=await i.json(),l=((d=o.content)==null?void 0:d.filter(y=>y.type==="text"))||[],c=((u=o.content)==null?void 0:u.filter(y=>y.type==="tool_use"))||[];return{content:l.map(y=>y.text).join(`
`),toolCalls:c.map(y=>({id:y.id,name:y.name,arguments:y.input})),usage:{promptTokens:((p=o.usage)==null?void 0:p.input_tokens)||0,completionTokens:((g=o.usage)==null?void 0:g.output_tokens)||0}}}async streamChat(t,n){const s=t.find(c=>c.role==="system"),r=t.filter(c=>c.role!=="system"),a={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,stream:!0,messages:r.map(c=>({role:c.role,content:c.content}))};s&&(a.system=s.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(a)});if(!i.ok){const c=await i.text();throw new Error(this.name+" stream error "+i.status+": "+c)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var y;const{done:d,value:u}=await o.read();if(d){c.close();return}const g=l.decode(u,{stream:!0}).split(`
`);for(const w of g)if(w.startsWith("data: ")){const v=w.slice(6);if(v==="[DONE]")continue;try{const E=JSON.parse(v);E.type==="content_block_delta"&&((y=E.delta)!=null&&y.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Ja(e){const t={},n=e||{};if(t.type=n.type||"object",t.type==="object"){const s=n.properties;if(s&&typeof s=="object"&&Object.keys(s).length>0){const r={};for(const[a,i]of Object.entries(s))i&&typeof i=="object"?r[a]=fn(i):r[a]=i;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(n.required)?t.required=n.required:t.required=[]}return n.description&&(t.description=n.description),t}function fn(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const n=t.properties;if(n&&typeof n=="object"&&Object.keys(n).length>0){const s={};for(const[r,a]of Object.entries(n))a&&typeof a=="object"?s[r]=fn(a):s[r]=a;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=fn(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ms{constructor(t,n,s,r){B(this,"name");B(this,"apiKey");B(this,"model");B(this,"apiBase");this.apiKey=t,this.model=n,this.apiBase=s.replace(/\/+$/,""),this.name=r}async chat(t,n){var l,c,d,u,p,g;const s={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,messages:t.map(y=>({role:y.role,content:y.content}))},r=this.apiBase.includes("routellm.abacus.ai");if(n!=null&&n.tools&&n.tools.length>0&&r)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");n!=null&&n.tools&&n.tools.length>0&&(s.tools=n.tools.map(y=>({type:"function",function:{name:y.name,description:y.description,parameters:Ja(y.parameters||{})}})),n.toolChoice==="required"&&(s.tool_choice="required"));const a=await As(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(s)}),this.name);if(!a.ok){const y=await a.text();throw new Error(this.name+" API error "+a.status+": "+y)}const i=await a.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((c=o==null?void 0:o.message)==null?void 0:c.content)||"",toolCalls:(u=(d=o==null?void 0:o.message)==null?void 0:d.tool_calls)==null?void 0:u.map(y=>({id:y.id,name:y.function.name,arguments:(()=>{try{return typeof y.function.arguments=="string"?JSON.parse(y.function.arguments||"{}"):y.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((p=i.usage)==null?void 0:p.prompt_tokens)||0,completionTokens:((g=i.usage)==null?void 0:g.completion_tokens)||0}}}async streamChat(t,n){const s={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},r=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(s)});if(!r.ok){const o=await r.text();throw new Error(this.name+" stream error "+r.status+": "+o)}const a=r.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var p,g,y;const{done:l,value:c}=await a.read();if(l){o.close();return}const u=i.decode(c,{stream:!0}).split(`
`);for(const w of u)if(w.startsWith("data: ")){const v=w.slice(6);if(v==="[DONE]")continue;try{const T=(y=(g=(p=JSON.parse(v).choices)==null?void 0:p[0])==null?void 0:g.delta)==null?void 0:y.content;T&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:T})+`

`))}catch{}}}})}}function yn(e,t,n,s){const r=Ct[e];if(!r)throw new Error(`Unknown LLM provider: ${e}`);const a=s||r.defaultModel;return r.apiFormat==="anthropic"?new Ls(t,a,r.apiBase,n):new Ms(t,a,r.apiBase,n)}class $s{constructor(){B(this,"errorLog",new Map);B(this,"usageLog",new Map)}async pickProvider(t){const n=Date.now(),s=t.filter(r=>{const a=this.errorLog.get(r);return a?a.cooldownUntil<=n:!0});return s.length>0?s[0]:null}async recordUsage(t,n){const s=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:s.tokens+n,requests:s.requests+1})}async recordError(t,n,s=5){this.errorLog.set(t,{error:n,cooldownUntil:Date.now()+s*60*1e3})}}const Va=["llm_slot_1","llm_slot_2","llm_slot_3"],Za=["anthropic","openai"];async function Je(e,t,n){const{decrypt:s}=await Promise.resolve().then(()=>tn),r=new $s,a=[];for(const u of Va){const p=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(p)try{const g=await s(p.encrypted_value,n),y=JSON.parse(g);if(y.provider&&y.apiKey&&Ct[y.provider]){const v=y.provider,E=yn(y.provider,y.apiKey,v,y.model);a.push({name:v,provider:E})}}catch(g){console.error(`Failed to load ${u}:`,g)}}const i=new Set(a.map(u=>u.name));for(const u of Za){if(i.has(u))continue;const p=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(p)try{const g=await s(p.encrypted_value,n);if(Ct[u]){const w=yn(u,g,u);a.push({name:u,provider:w})}}catch{console.error(`Failed to decrypt legacy ${u} key`)}}if(a.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=a.map(u=>u.name),l=await r.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:a[0].provider,rotation:r};const c=a.find(u=>u.name===l);return{provider:Xa(c.provider,a,r,e,t),rotation:r}}function Xa(e,t,n,s,r){const a=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"";throw a(d)&&!d.includes("TOOLS_UNSUPPORTED")&&dn(s,r,"all_providers_down",e.name,null,d),c}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"",u=i(d);if(!a(d)&&!u)throw c;const p=d.includes("TOOLS_UNSUPPORTED"),g=p?1:u?10:1440;console.warn(`Provider ${e.name} ${u?"rate limited":p?"tools unsupported":"auth/billing error"}, trying fallback...`),await n.recordError(e.name,d,g);const y=t.filter(w=>w.name!==e.name);for(const w of y)try{const v=await w.provider.chat(o,l);return this.name=w.name,!p&&!u&&dn(s,r,"provider_switched",e.name,w.name,d),v}catch(v){const E=v.message||"";if(a(E)||i(E)){await n.recordError(w.name,E,i(E)?10:1440);continue}throw v}throw dn(s,r,"all_providers_down",e.name,null,d),new Error(`All LLM providers failed. Primary (${e.name}): ${d.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const yt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Ls,OpenAICompatibleProvider:Ms,ProviderRotation:$s,createProviderFromConfig:yn,createRotatingProvider:Je,logError:H},Symbol.toStringTag,{value:"Module"})),un=20,Qa=2e3,ei=2e3,Ps=4;function ti(e){return Math.ceil(e.length/Ps)}function Gn(e,t){const n=t*Ps;return e.length<=n?e:e.slice(0,n)+`
[...truncated to fit token budget]`}class te{constructor(t){this.db=t}async store(t,n,s,r,a=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,n,s).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,a,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       WHERE user_id = ? AND type = 'task' AND status = 'done' AND tier = 'working'
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const n=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((n==null?void 0:n.cnt)||0)>un){const s=((n==null?void 0:n.cnt)||0)-un;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,s).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,un).all()).results||[]}async getAll(t,n,s=50){return n?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,n,s).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,s).all()).results||[]}async search(t,n,s=10){return this.searchMemoryByTier(t,n,s)}async searchLongTerm(t,n,s=5){return this.searchMemoryByTier(t,n,s,"long_term")}async searchMemoryByTier(t,n,s,r){const a=r?" AND tier = ?":"",i=(g,y)=>r?[t,r,g,g,y]:[t,g,g,y],l=(await this.db.prepare(`SELECT * FROM memory WHERE user_id = ?${a} AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?`).bind(...i(`%${n}%`,s)).all()).results||[];if(l.length>0)return await this.touchMemories(t,l.map(g=>g.id)),l;const c=n.split(/\s+/).filter(g=>g.length>2);if(c.length===0)return[];const d=new Map,u=new Map;for(const g of c){const y=await this.db.prepare(`SELECT * FROM memory WHERE user_id = ?${a} AND (title LIKE ? OR content LIKE ?) LIMIT ?`).bind(...i(`%${g}%`,s*2)).all();for(const w of y.results||[])d.set(w.id,(d.get(w.id)||0)+1),u.set(w.id,w)}const p=[...u.values()].sort((g,y)=>(d.get(y.id)||0)-(d.get(g.id)||0)).slice(0,s);return p.length>0&&await this.touchMemories(t,p.map(g=>g.id)),p}async touchMemories(t,n){for(const s of n)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(s,t).run()}async update(t,n,s){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(s,t,n).run()}async promote(t,n){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run(),await this.enforceWorkingMemoryCap(n)}async demote(t,n){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run()}async remove(t,n){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,n).run()}async buildContext(t){const n=await this.getWorkingMemory(t);if(n.length===0)return"";const s={};for(const a of n)s[a.type]||(s[a.type]=[]),s[a.type].push(a);let r=`
## Working Memory (Active Context)
`;for(const[a,i]of Object.entries(s)){r+=`
### ${a.charAt(0).toUpperCase()+a.slice(1)}s
`;for(const o of i)r+=`- **${o.title}**: ${o.content}
`}return Gn(r,Qa)}static truncatePersonality(t){return Gn(t,ei)}async getRecentConversations(t,n=20,s){return s?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,s,n).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,n).all()).results||[]).reverse()}async storeMessage(t,n,s,r,a="{}",i){const o=ti(r);i?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,o,i).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,o).run()}async compactHistory(t,n=30){const s=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((s==null?void 0:s.cnt)||0)<=n*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,n).run()}}const ni=Object.freeze(Object.defineProperty({__proto__:null,MemoryService:te},Symbol.toStringTag,{value:"Module"})),si="https://accounts.google.com/o/oauth2/v2/auth",Bs="https://oauth2.googleapis.com/token",ri="https://www.googleapis.com/oauth2/v2/userinfo",ai=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let Ne=null;async function vn(e,t,n){const s=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!s)return null;try{const r=await Z(s.encrypted_value,n);return JSON.parse(r)}catch{return null}}async function ii(e,t,n,s){const r=await xt(JSON.stringify(s),n);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,r).run()}function js(e,t,n){const s=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:ai,access_type:"offline",prompt:"consent",state:n,include_granted_scopes:"true"});return`${si}?${s}`}async function Us(e,t,n,s){const r=await fetch(Bs,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:n,redirect_uri:s,grant_type:"authorization_code"})}),a=await r.text();if(!r.ok)throw new Error(`Token exchange failed (${r.status}): ${a.substring(0,300)}`);return JSON.parse(a)}async function oi(e,t,n){const s=await fetch(Bs,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:n,grant_type:"refresh_token"})}),r=await s.text();if(!s.ok)throw s.status===400||s.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${s.status}): ${r.substring(0,300)}`);return JSON.parse(r)}async function Hs(e){const t=await fetch(ri,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function kt(e,t,n,s,r){if(!s||!r)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(Ne&&Ne.userId===t&&Ne.expiresAt>Date.now()/1e3+60){const o=await vn(e,t,n);return{token:Ne.token,email:(o==null?void 0:o.email)||"unknown"}}const a=await vn(e,t,n);if(!a)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const i=await oi(a.refresh_token,s,r);return Ne={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{token:i.access_token,email:a.email}}async function xn(e,t,n){try{const s=await vn(e,t,n);return s?{connected:!0,email:s.email,connectedAt:s.connected_at}:{connected:!1}}catch{return{connected:!1}}}function Fs(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function Gs(e,t,n,s,r,a,i){const o=await Us(s,a,i,r);if(!o.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await Hs(o.access_token),c={refresh_token:o.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await ii(e,t,n,c),Ne={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{email:l.email,name:l.name}}async function Ws(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(Ne==null?void 0:Ne.userId)===t&&(Ne=null)}const Qe="https://sheets.googleapis.com/v4/spreadsheets";class qs{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await kt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,n){const s=await this.authHeaders(),r=encodeURIComponent(n),a=await fetch(`${Qe}/${t}/values/${r}`,{headers:s});if(!a.ok){const o=await a.text();throw new Error(`Sheets read failed (${a.status}): ${o}`)}return(await a.json()).values||[]}async writeRange(t,n,s){const r=await this.authHeaders(),a=encodeURIComponent(n),i=await fetch(`${Qe}/${t}/values/${a}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:r,body:JSON.stringify({range:n,majorDimension:"ROWS",values:s})});if(!i.ok){const l=await i.text();throw new Error(`Sheets write failed (${i.status}): ${l}`)}return{updatedCells:(await i.json()).updatedCells||0}}async appendRows(t,n,s){var l;const r=await this.authHeaders(),a=encodeURIComponent(n),i=await fetch(`${Qe}/${t}/values/${a}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:r,body:JSON.stringify({range:n,majorDimension:"ROWS",values:s})});if(!i.ok){const c=await i.text();throw new Error(`Sheets append failed (${i.status}): ${c}`)}return{updatedCells:((l=(await i.json()).updates)==null?void 0:l.updatedCells)||s.length}}async deleteRow(t,n,s){const r=await this.authHeaders(),a=await fetch(`${Qe}/${t}?fields=sheets.properties`,{headers:r});if(!a.ok){const u=await a.text();throw new Error(`Failed to get sheet metadata (${a.status}): ${u}`)}const i=await a.json(),o=i.sheets.find(u=>u.properties.title===n);if(!o){const u=i.sheets.map(p=>p.properties.title).join(", ");throw new Error(`Tab "${n}" not found. Available tabs: ${u}`)}const l=o.properties.sheetId,c=s-1,d=await fetch(`${Qe}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{deleteDimension:{range:{sheetId:l,dimension:"ROWS",startIndex:c,endIndex:c+1}}}]})});if(!d.ok){const u=await d.text();throw new Error(`Row delete failed (${d.status}): ${u}`)}}async createSpreadsheet(t,n){const s=await this.authHeaders(),r={properties:{title:t},sheets:n&&n.length>0?n.map(o=>({properties:{title:o}})):[{properties:{title:"Sheet1"}}]},a=await fetch(Qe,{method:"POST",headers:s,body:JSON.stringify(r)});if(!a.ok){const o=await a.text();throw new Error(`Sheets create failed (${a.status}): ${o}`)}const i=await a.json();return{spreadsheetId:i.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${i.spreadsheetId}/edit`}}async getMetadata(t){const n=await this.authHeaders(),s=await fetch(`${Qe}/${t}?fields=properties.title,sheets.properties.title`,{headers:n});if(!s.ok){const a=await s.text();throw new Error(`Sheets metadata failed (${s.status}): ${a}`)}const r=await s.json();return{title:r.properties.title,sheets:r.sheets.map(a=>a.properties.title)}}}const Rt="https://www.googleapis.com/calendar/v3";class kn{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await kt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",n={}){const s=await this.authHeaders(),r=new URLSearchParams;n.timeMin&&r.set("timeMin",n.timeMin),n.timeMax&&r.set("timeMax",n.timeMax),r.set("maxResults",String(n.maxResults||20)),r.set("singleEvents","true"),r.set("orderBy","startTime"),n.query&&r.set("q",n.query);const a=await fetch(`${Rt}/calendars/${encodeURIComponent(t)}/events?${r}`,{headers:s});if(!a.ok){const o=await a.text();throw new Error(`Calendar list failed (${a.status}): ${o}`)}return(await a.json()).items||[]}async createEvent(t="primary",n){var o;const s=await this.authHeaders(),r=n.timeZone||"Asia/Kolkata",a={summary:n.summary,description:n.description||"",location:n.location||"",start:{dateTime:n.startDateTime,timeZone:r},end:{dateTime:n.endDateTime,timeZone:r}};(o=n.attendees)!=null&&o.length&&(a.attendees=n.attendees.map(l=>({email:l})));const i=await fetch(`${Rt}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:s,body:JSON.stringify(a)});if(!i.ok){const l=await i.text();throw new Error(`Calendar create failed (${i.status}): ${l}`)}return await i.json()}async updateEvent(t="primary",n,s){const r=await this.authHeaders(),a=s.timeZone||"Asia/Kolkata",i={};s.summary&&(i.summary=s.summary),s.description&&(i.description=s.description),s.location&&(i.location=s.location),s.startDateTime&&(i.start={dateTime:s.startDateTime,timeZone:a}),s.endDateTime&&(i.end={dateTime:s.endDateTime,timeZone:a});const o=await fetch(`${Rt}/calendars/${encodeURIComponent(t)}/events/${n}`,{method:"PATCH",headers:r,body:JSON.stringify(i)});if(!o.ok){const l=await o.text();throw new Error(`Calendar update failed (${o.status}): ${l}`)}return await o.json()}async deleteEvent(t="primary",n){const s=await this.authHeaders(),r=await fetch(`${Rt}/calendars/${encodeURIComponent(t)}/events/${n}`,{method:"DELETE",headers:s});if(!r.ok&&r.status!==410){const a=await r.text();throw new Error(`Calendar delete failed (${r.status}): ${a}`)}}async listCalendars(){const t=await this.authHeaders(),n=await fetch(`${Rt}/users/me/calendarList`,{headers:t});if(!n.ok){const r=await n.text();throw new Error(`Calendar list calendars failed (${n.status}): ${r}`)}return((await n.json()).items||[]).map(r=>({id:r.id,summary:r.summary,primary:r.primary||!1}))}}const Ce="https://docs.googleapis.com/v1/documents",li="https://www.googleapis.com/drive/v3/files";function Wn(e){const t=[];for(const n of e.split(`
`)){const s=n.trim();if(s===""||/^---+$/.test(s))continue;let r="NORMAL_TEXT",a=n;const i=s.match(/^###\s+(.+)/),o=!i&&s.match(/^##\s+(.+)/),l=!i&&!o&&s.match(/^#\s+(.+)/);i?(r="HEADING_3",a=i[1]):o?(r="HEADING_2",a=o[1]):l?(r="HEADING_1",a=l[1]):/^\s*[-*]\s/.test(n)&&(a="• "+n.replace(/^\s*[-*]\s+/,""));const{text:c,spans:d}=ci(a);t.push({text:c,namedStyle:r,spans:d})}return t}function ci(e){const t=[];let n="",s=0;for(;s<e.length;)if(e[s]==="*"&&e[s+1]==="*"){const r=e.indexOf("**",s+2);if(r!==-1){const a=n.length;n+=e.substring(s+2,r),t.push({start:a,end:n.length,bold:!0}),s=r+2}else n+=e[s++]}else if(e[s]==="_"&&e[s+1]==="_"){const r=e.indexOf("__",s+2);if(r!==-1){const a=n.length;n+=e.substring(s+2,r),t.push({start:a,end:n.length,bold:!0}),s=r+2}else n+=e[s++]}else if(e[s]==="*"&&e[s+1]!=="*"){const r=e.indexOf("*",s+1);if(r!==-1){const a=n.length;n+=e.substring(s+1,r),t.push({start:a,end:n.length,italic:!0}),s=r+1}else n+=e[s++]}else if(e[s]==="_"){const r=e.indexOf("_",s+1);if(r!==-1){const a=n.length;n+=e.substring(s+1,r),t.push({start:a,end:n.length,italic:!0}),s=r+1}else n+=e[s++]}else n+=e[s++];return{text:n,spans:t}}class zs{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await kt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const n=await this.authHeaders(),s=await fetch(Ce,{method:"POST",headers:n,body:JSON.stringify({title:t})});if(!s.ok){const a=await s.text();throw new Error(`Docs create failed (${s.status}): ${a}`)}const r=await s.json();return{documentId:r.documentId,url:`https://docs.google.com/document/d/${r.documentId}/edit`}}async readDocument(t){var i,o;const n=await this.authHeaders(),s=await fetch(`${Ce}/${t}`,{headers:n});if(!s.ok){const l=await s.text();throw new Error(`Docs read failed (${s.status}): ${l}`)}const r=await s.json();let a="";for(const l of((i=r.body)==null?void 0:i.content)||[])if(l.paragraph)for(const c of l.paragraph.elements)(o=c.textRun)!=null&&o.content&&(a+=c.textRun.content);return{title:r.title,content:a.trim()}}async rewriteDocument(t,n){var y;const s=await this.authHeaders(),r=await fetch(`${Ce}/${t}`,{headers:s});if(!r.ok){const w=await r.text();throw new Error(`Docs fetch failed (${r.status}): ${w.substring(0,200)}`)}const i=((y=(await r.json()).body)==null?void 0:y.content)||[],o=i[i.length-1],l=(o==null?void 0:o.endIndex)??2,c=Wn(n),d=[];if(l>2&&d.push({deleteContentRange:{range:{startIndex:1,endIndex:l-1}}}),c.length===0){d.length>0&&await fetch(`${Ce}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:d})});return}let u="";const p=[];for(const w of c){const v=u.length;u+=w.text+`
`,p.push({start:v,end:u.length,namedStyle:w.namedStyle,spans:w.spans})}d.push({insertText:{location:{index:1},text:u}});for(const w of p){w.namedStyle!=="NORMAL_TEXT"&&d.push({updateParagraphStyle:{range:{startIndex:1+w.start,endIndex:1+w.end},paragraphStyle:{namedStyleType:w.namedStyle},fields:"namedStyleType"}});for(const v of w.spans){const E={},T=[];v.bold&&(E.bold=!0,T.push("bold")),v.italic&&(E.italic=!0,T.push("italic")),T.length>0&&d.push({updateTextStyle:{range:{startIndex:1+w.start+v.start,endIndex:1+w.start+v.end},textStyle:E,fields:T.join(",")}})}}const g=await fetch(`${Ce}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:d})});if(!g.ok){const w=await g.text();throw new Error(`Docs rewrite failed (${g.status}): ${w.substring(0,200)}`)}}async appendFormattedContent(t,n){var y;const s=await this.authHeaders(),r=Wn(n);if(r.length===0)return;const a=await fetch(`${Ce}/${t}`,{headers:s});if(!a.ok){const w=await a.text();throw new Error(`Docs fetch failed (${a.status}): ${w.substring(0,200)}`)}const o=((y=(await a.json()).body)==null?void 0:y.content)||[],l=o[o.length-1],c=Math.max(1,((l==null?void 0:l.endIndex)??2)-1);let d="";const u=[];for(const w of r){const v=d.length;d+=w.text+`
`,u.push({start:v,end:d.length,namedStyle:w.namedStyle,spans:w.spans})}const p=[{insertText:{location:{index:c},text:d}}];for(const w of u){w.namedStyle!=="NORMAL_TEXT"&&p.push({updateParagraphStyle:{range:{startIndex:c+w.start,endIndex:c+w.end},paragraphStyle:{namedStyleType:w.namedStyle},fields:"namedStyleType"}});for(const v of w.spans){const E={},T=[];v.bold&&(E.bold=!0,T.push("bold")),v.italic&&(E.italic=!0,T.push("italic")),T.length>0&&p.push({updateTextStyle:{range:{startIndex:c+w.start+v.start,endIndex:c+w.start+v.end},textStyle:E,fields:T.join(",")}})}}const g=await fetch(`${Ce}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:p})});if(!g.ok){const w=await g.text();throw new Error(`Docs append failed (${g.status}): ${w.substring(0,200)}`)}}async appendText(t,n){const s=await this.authHeaders(),r=await fetch(`${Ce}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:[{insertText:{endOfSegmentLocation:{},text:n}}]})});if(!r.ok){const a=await r.text();throw new Error(`Docs append failed (${r.status}): ${a}`)}}async deleteContent(t,n){var i,o,l;const s=await this.authHeaders(),r=await fetch(`${Ce}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:[{replaceAllText:{containsText:{text:n,matchCase:!0},replaceText:""}}]})});if(!r.ok){const c=await r.text();throw new Error(`Docs delete content failed (${r.status}): ${c.substring(0,200)}`)}return{occurrencesRemoved:((l=(o=(i=(await r.json()).replies)==null?void 0:i[0])==null?void 0:o.replaceAllText)==null?void 0:l.occurrencesChanged)??0}}async shareDocument(t,n,s="writer"){const r=await this.authHeaders(),a=await fetch(`${li}/${t}/permissions`,{method:"POST",headers:r,body:JSON.stringify({type:"user",role:s,emailAddress:n})});if(!a.ok){const i=await a.text();throw new Error(`Share failed (${a.status}): ${i}`)}}}class we{constructor(t,n,s,r,a){B(this,"sheets");B(this,"calendar");B(this,"docs");B(this,"db");B(this,"userId");B(this,"pinHash");this.db=t,this.userId=n,this.pinHash=s,this.sheets=new qs(t,n,s,r,a),this.calendar=new kn(t,n,s,r,a),this.docs=new zs(t,n,s,r,a)}async isConnected(){return xn(this.db,this.userId,this.pinHash)}}const et=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:kn,GoogleDocs:zs,GoogleServices:we,GoogleSheets:qs,completeOAuthFlow:Gs,disconnectGoogle:Ws,exchangeCodeForTokens:Us,fetchUserInfo:Hs,generateAuthUrl:js,getGoogleAuth:kt,isGoogleConnected:xn,isOAuthClientConfigured:Fs},Symbol.toStringTag,{value:"Module"}));async function Ks(e,t,n={}){const s={textQuery:t,languageCode:"en",pageSize:8};if(n.type&&(s.includedType=n.type),n.location){const l=n.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(s.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:n.radius||5e3}})}const r=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),a=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":r},body:JSON.stringify(s)});if(!a.ok){const l=await a.text();return{results:[],error:`Places API error (${a.status}): ${l.substring(0,200)}`}}const i=await a.json();return!i.places||i.places.length===0?{results:[]}:{results:i.places.map(l=>{var c,d,u;return{name:((c=l.displayName)==null?void 0:c.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(d=l.currentOpeningHours)==null?void 0:d.openNow,types:(u=l.types)==null?void 0:u.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function Ys(e,t){var a,i,o;const n=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),s=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":n}});if(!s.ok){const l=await s.text();return{error:`Place Details API error (${s.status}): ${l.substring(0,200)}`}}const r=await s.json();return{details:{name:((a=r.displayName)==null?void 0:a.text)||"",address:r.formattedAddress||"",phone:r.internationalPhoneNumber,website:r.websiteUri,rating:r.rating,reviews:(i=r.reviews)==null?void 0:i.slice(0,3).map(l=>{var c,d,u;return{author:((c=l.authorAttribution)==null?void 0:c.displayName)||"Anonymous",rating:l.rating||0,text:((u=(d=l.text)==null?void 0:d.text)==null?void 0:u.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(o=r.currentOpeningHours)==null?void 0:o.weekdayDescriptions,location:r.location?{lat:r.location.latitude,lng:r.location.longitude}:void 0,googleMapsUri:r.googleMapsUri}}}async function Js(e,t,n,s={}){var c;const r=new URLSearchParams({origin:t,destination:n,key:e,mode:s.mode||"driving"});(s.mode==="driving"||!s.mode)&&r.set("departure_time","now");const a=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${r}`);if(!a.ok)return{error:`Directions API error: ${a.status}`};const i=await a.json();if(i.status!=="OK")return{error:`Directions: ${i.status} — ${i.error_message||""}`};const o=i.routes[0],l=o.legs[0];return{route:{summary:o.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(c=l.duration_in_traffic)==null?void 0:c.text,steps:l.steps.slice(0,10).map(d=>{var u,p,g;return{instruction:((u=d.html_instructions)==null?void 0:u.replace(/<[^>]*>/g,""))||"",distance:((p=d.distance)==null?void 0:p.text)||"",duration:((g=d.duration)==null?void 0:g.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function Vs(e,t,n,s){var l,c;const r={q:t,target:n,key:e,format:"text"};s&&(r.source=s);const a=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const d=await a.text();return{translatedText:"",error:`Translate API error (${a.status}): ${d.substring(0,200)}`}}const o=(c=(l=(await a.json()).data)==null?void 0:l.translations)==null?void 0:c[0];return o?{translatedText:o.translatedText,detectedSourceLang:o.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function Zs(e,t){const n=new URLSearchParams({address:t,key:e}),s=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${n}`);if(!s.ok)return{results:[],error:`Geocoding API error: ${s.status}`};const r=await s.json();return r.status!=="OK"&&r.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${r.status} — ${r.error_message||""}`}:{results:(r.results||[]).slice(0,5).map(a=>{var i;return{address:a.formatted_address,lat:a.geometry.location.lat,lng:a.geometry.location.lng,placeId:a.place_id,types:(i=a.types)==null?void 0:i.slice(0,3)}})}}async function Xs(e,t,n={}){const s=new URLSearchParams({part:"snippet",q:t,key:e,type:n.type||"video",maxResults:String(n.maxResults||5),order:n.order||"relevance"}),r=await fetch(`https://www.googleapis.com/youtube/v3/search?${s}`);if(!r.ok){const i=await r.text();return{results:[],error:`YouTube API error (${r.status}): ${i.substring(0,200)}`}}return{results:((await r.json()).items||[]).map(i=>{var o,l,c,d,u,p,g,y;return{title:i.snippet.title,channelTitle:i.snippet.channelTitle,description:(o=i.snippet.description)==null?void 0:o.substring(0,200),videoId:((l=i.id)==null?void 0:l.videoId)||((c=i.id)==null?void 0:c.channelId)||((d=i.id)==null?void 0:d.playlistId)||"",publishedAt:i.snippet.publishedAt,url:(u=i.id)!=null&&u.videoId?`https://www.youtube.com/watch?v=${i.id.videoId}`:(p=i.id)!=null&&p.channelId?`https://www.youtube.com/channel/${i.id.channelId}`:"",thumbnailUrl:(y=(g=i.snippet.thumbnails)==null?void 0:g.medium)==null?void 0:y.url}})}}const di="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36";function Qs(e,t){if(/anomaly-modal/i.test(e))return[];const n=[],s=e.split(/class="result results_links/g).slice(1);for(const r of s){if(n.length>=t)break;const a=r.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),i=r.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(a){let o=a[1];const l=o.match(/uddg=([^&]+)/);l?o=decodeURIComponent(l[1]):o.startsWith("//")&&(o="https:"+o);const c=p=>p.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),d=c(a[2]),u=i?c(i[1]):"";if(d&&o.startsWith("http")){const p=o.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];n.push({title:d,link:o,snippet:u,displayLink:p})}}}return n}async function ui(e,t,n,s){const r=new URLSearchParams({key:t,cx:n,q:e,num:String(Math.min(s,10))}),a=await fetch(`https://www.googleapis.com/customsearch/v1?${r}`);if(!a.ok){const l=await a.text().catch(()=>"");return{results:[],error:`Google CSE failed (${a.status}): ${l.substring(0,200)}`}}return{results:((await a.json()).items||[]).map(l=>({title:l.title||"",link:l.link||"",snippet:l.snippet||"",displayLink:l.displayLink||(l.link||"").replace(/^https?:\/\/(www\.)?/,"").split("/")[0]})).filter(l=>l.title&&l.link.startsWith("http"))}}async function nn(e,t={}){const n=Math.min(t.num||5,10),s=t.site?`site:${t.site} ${e}`:e;try{const r=new URLSearchParams({q:s}),a=await fetch("https://html.duckduckgo.com/html/",{method:"POST",headers:{"User-Agent":di,"Content-Type":"application/x-www-form-urlencoded"},body:r.toString()});if(!a.ok)return{results:[],error:`Search request failed (${a.status})`};const i=await a.text(),o=Qs(i,n);if(o.length>0)return{results:o};if(t.googleApiKey&&t.googleCseId){const l=await ui(s,t.googleApiKey,t.googleCseId,n);if(l.results.length>0)return l;if(l.error)return{results:[],error:l.error}}return/anomaly-modal/i.test(i)?{results:[],error:"Web search blocked by DuckDuckGo bot protection. Configure GOOGLE_API_KEY + GOOGLE_CSE_ID, or add a Perplexity API key in Settings → Keys for faster research."}:{results:[],error:void 0}}catch(r){return{results:[],error:`Web search error: ${r.message}`}}}async function er(e,t,n,s="driving"){var l,c,d,u;const r=new URLSearchParams({origins:t,destinations:n,key:e,mode:s,departure_time:"now"}),a=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${r}`);if(!a.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${a.status}`};const i=await a.json(),o=(d=(c=(l=i.rows)==null?void 0:l[0])==null?void 0:c.elements)==null?void 0:d[0];return!o||o.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(o==null?void 0:o.status)||i.status}`}:{distance:o.distance.text,duration:o.duration.text,durationInTraffic:(u=o.duration_in_traffic)==null?void 0:u.text}}const mi=Object.freeze(Object.defineProperty({__proto__:null,geocode:Zs,getDirections:Js,getDistanceMatrix:er,getPlaceDetails:Ys,parseDuckDuckGoHtml:Qs,searchPlaces:Ks,searchYouTube:Xs,translateText:Vs,webSearch:nn},Symbol.toStringTag,{value:"Module"})),Ae="https://gmail.googleapis.com/gmail/v1/users/me";function pi(e,t){if(e)return e;const n=t?parseInt(t,10):NaN;return!Number.isNaN(n)&&n>0?new Date(n).toISOString():""}function hi(e,t){return e===403?"Gmail access denied (403). Reconnect your Google account in Settings → Keys → Google Workspace to grant Gmail permissions.":`Gmail list failed (${e}): ${t.substring(0,200)}`}class De{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await kt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var c,d;const n=await this.authHeaders(),s=new URLSearchParams;if(s.set("maxResults",String(t.maxResults||10)),t.query&&s.set("q",t.query),(c=t.labelIds)!=null&&c.length)for(const u of t.labelIds)s.append("labelIds",u);const r=await fetch(`${Ae}/messages?${s}`,{headers:n}),a=r.status;if(!r.ok){const u=await r.text();throw fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"gmail.ts:listMessages:listFail",message:"Gmail messages.list failed",data:{listStatus:a,query:t.query??null,maxResults:t.maxResults??10,errorPreview:u.substring(0,200)},timestamp:Date.now(),hypothesisId:"B"})}).catch(()=>{}),new Error(hi(r.status,u))}const i=await r.json();if(fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"gmail.ts:listMessages:listOk",message:"Gmail messages.list ok",data:{listStatus:a,query:t.query??null,resultSizeEstimate:i.resultSizeEstimate??null,messageIdCount:((d=i.messages)==null?void 0:d.length)??0},timestamp:Date.now(),hypothesisId:"B,C"})}).catch(()=>{}),!i.messages||i.messages.length===0)return[];const o=[];let l=0;for(const u of i.messages.slice(0,t.maxResults||10))try{const p=await this.getMessage(u.id,n);p?o.push(p):l++}catch{l++}if(l>0&&fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"gmail.ts:listMessages:metadataSummary",message:"Gmail metadata fetch summary",data:{requested:i.messages.length,loaded:o.length,metadataFailures:l},timestamp:Date.now(),hypothesisId:"C"})}).catch(()=>{}),o.length===0&&l>0)throw new Error(`Gmail found ${i.messages.length} matching message(s) but could not read message details (${l} metadata fetch failure(s)). Reconnect Google in Settings → Keys → Google Workspace to refresh Gmail permissions, then try again.`);return o}async getMessage(t,n){const s=n||await this.authHeaders(),r=await fetch(`${Ae}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:s});if(!r.ok){const o=await r.text().catch(()=>"");return fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"gmail.ts:getMessage:fail",message:"Gmail messages.get metadata failed",data:{messageId:t,status:r.status,errorPreview:o.substring(0,200)},timestamp:Date.now(),hypothesisId:"C"})}).catch(()=>{}),null}const a=await r.json(),i=o=>{var l,c,d;return((d=(c=(l=a.payload)==null?void 0:l.headers)==null?void 0:c.find(u=>u.name.toLowerCase()===o.toLowerCase()))==null?void 0:d.value)||""};return{id:a.id,threadId:a.threadId,snippet:a.snippet||"",subject:i("Subject")||"(no subject)",from:i("From"),to:i("To"),date:pi(i("Date"),a.internalDate),isUnread:(a.labelIds||[]).includes("UNREAD"),labels:a.labelIds||[]}}async getMessageBody(t){const n=await this.authHeaders(),s=await fetch(`${Ae}/messages/${t}?format=full`,{headers:n});if(!s.ok){const a=await s.text();throw new Error(`Gmail message body failed (${s.status}): ${a.substring(0,200)}`)}const r=await s.json();return tr(r.payload)}async search(t,n=10){return this.listMessages({query:t,maxResults:n})}async send(t,n,s,r={}){const a=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${n}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];r.cc&&i.push(`Cc: ${r.cc}`),r.bcc&&i.push(`Bcc: ${r.bcc}`),r.replyToMessageId&&(i.push(`In-Reply-To: ${r.replyToMessageId}`),i.push(`References: ${r.replyToMessageId}`)),i.push("",qn(s));const o=i.join(`\r
`),c={raw:zn(o)};r.threadId&&(c.threadId=r.threadId);const d=await fetch(`${Ae}/messages/send`,{method:"POST",headers:a,body:JSON.stringify(c)});if(!d.ok){const u=await d.text();throw new Error(`Gmail send failed (${d.status}): ${u.substring(0,200)}`)}return await d.json()}async createDraft(t,n,s,r={}){const a=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${n}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];r.cc&&i.push(`Cc: ${r.cc}`),i.push("",qn(s));const o=i.join(`\r
`),l=zn(o),c=await fetch(`${Ae}/drafts`,{method:"POST",headers:a,body:JSON.stringify({message:{raw:l}})});if(!c.ok){const d=await c.text();throw new Error(`Gmail draft failed (${c.status}): ${d.substring(0,200)}`)}return await c.json()}async markAsRead(t){const n=await this.authHeaders();await fetch(`${Ae}/messages/${t}/modify`,{method:"POST",headers:n,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,n){const s=await this.authHeaders();let r={};switch(n){case"archive":r={removeLabelIds:["INBOX"]};break;case"trash":r={addLabelIds:["TRASH"]};break;case"read":r={removeLabelIds:["UNREAD"]};break;case"unread":r={addLabelIds:["UNREAD"]};break;case"star":r={addLabelIds:["STARRED"]};break;case"unstar":r={removeLabelIds:["STARRED"]};break}const a=await fetch(`${Ae}/messages/${t}/modify`,{method:"POST",headers:{...s,"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const i=await a.text();throw new Error(`Failed to modify message: ${i}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),n=await fetch(`${Ae}/labels/INBOX`,{headers:t});return n.ok&&(await n.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),n=await fetch(`${Ae}/profile`,{headers:t});if(!n.ok)throw new Error("Failed to get Gmail profile");return await n.json()}}function tr(e){var t,n,s;if(!e)return"";if((t=e.body)!=null&&t.data)return mn(e.body.data);if(e.parts){for(const r of e.parts)if(r.mimeType==="text/plain"&&((n=r.body)!=null&&n.data))return mn(r.body.data);for(const r of e.parts)if(r.mimeType==="text/html"&&((s=r.body)!=null&&s.data)){const a=mn(r.body.data);return gi(a)}for(const r of e.parts)if(r.parts){const a=tr(r);if(a)return a}}return e.snippet||""}function qn(e){e=e.replace(/\\n/g,`
...
`);return a.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:a.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${a.join("<br>")}</p>`}).join("")}</body></html>`}function zn(e){const t=new TextEncoder().encode(e);let n="";for(let s=0;s<t.length;s++)n+=String.fromCharCode(t[s]);return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function mn(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function gi(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const fi=1e4,yi=15e3;async function nr(e,t){try{const n=new AbortController,s=setTimeout(()=>n.abort(),yi),r=await fetch(e,{signal:n.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!r.ok)return{text:"",error:`HTTP ${r.status}`};const a=r.headers.get("content-type")||"";if(!a.includes("text/html")&&!a.includes("text/plain")&&!a.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${a.split(";")[0]}`};const i=await r.text();clearTimeout(s);const o=i.length>2e5?i.substring(0,2e5):i,l=vi(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||fi)}}catch(n){return{text:"",error:n.name==="AbortError"?"Timeout":n.message}}}function vi(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}const wi=45e3;async function bi(e,t){var r,a,i;const n=new AbortController,s=setTimeout(()=>n.abort(),wi);try{const o=await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",signal:n.signal,headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:e}],max_tokens:2e3})});if(clearTimeout(s),!o.ok)return{report:"",sources:[],pagesRead:0,error:`Perplexity error ${o.status}`};const l=await o.json(),c=((i=(a=(r=l==null?void 0:l.choices)==null?void 0:r[0])==null?void 0:a.message)==null?void 0:i.content)||"";if(!c.trim())return{report:"",sources:[],pagesRead:0,error:"Perplexity returned an empty response"};const u=(Array.isArray(l==null?void 0:l.citations)?l.citations:[]).filter(p=>typeof p=="string"&&p.startsWith("http")).map(p=>({title:p.replace(/^https?:\/\/(www\.)?/,"").split("/")[0],url:p}));return{report:c,sources:u,pagesRead:u.length}}catch(o){return clearTimeout(s),{report:"",sources:[],pagesRead:0,error:`Perplexity request failed: ${o.message}`}}}async function sr(e,t,n={}){if(n.perplexityApiKey){const p=await bi(e,n.perplexityApiKey);if(!p.error)return p}const s=n.maxPages||(n.depth==="thorough"?5:3),r=n.maxResults||(n.depth==="thorough"?8:5),a=await nn(e,{num:r,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId});if(a.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${a.error}`};if(a.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=a.results.slice(0,s).map(async p=>{const g=await nr(p.link);return{title:p.title,url:p.link,displayLink:p.displayLink,snippet:p.snippet,content:g.text,error:g.error}}),c=(await Promise.all(o)).filter(p=>p.content.length>50);if(c.length===0){const p=a.results.map((y,w)=>`[${w+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Kn(e,p,t,"snippets"),sources:a.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const d=c.map((p,g)=>`--- SOURCE ${g+1}: ${p.title} (${p.displayLink}) ---
${p.content}
--- END SOURCE ${g+1} ---`).join(`

`);return{report:await Kn(e,d,t,"full"),sources:c.map(p=>({title:p.title,url:p.url})),pagesRead:c.length}}async function Kn(e,t,n,s){const a=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Write a synthesized research report answering the query above.`;try{return(await n.chat([{role:"system",content:a},{role:"user",content:i}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(o){return`Research synthesis error: ${o.message}. Raw search results were found but could not be analyzed.`}}const _i=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:sr,fetchPageContent:nr},Symbol.toStringTag,{value:"Module"})),Ke="https://api.browser-use.com/api/v2",Yn=2e4,wn=6e3,Ei=3e5,Dn=12e3,rr=new Set(["finished","stopped"]);async function At(e,t,n=Dn){const s=new AbortController,r=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}finally{clearTimeout(r)}}async function Ti(e){const t=()=>fetch(`${Ke}/sessions`,{method:"POST",headers:{"X-Browser-Use-API-Key":e,"Content-Type":"application/json"},body:JSON.stringify({})});try{let n=await t();if(!n.ok){const r=await n.text().catch(()=>"");if(ir(n.status,r)){if(console.log("[createBrowserSession] concurrency limit — reaping stale sessions and retrying"),await ar(e),n=await t(),!n.ok)return console.log(`[createBrowserSession] FAILED after reap HTTP ${n.status}`),null}else return console.log(`[createBrowserSession] FAILED HTTP ${n.status}: ${r}`),null}const s=await n.json();return console.log(`[createBrowserSession] sessionId=${s.id}`),s.id??null}catch(n){return console.log(`[createBrowserSession] ERROR ${n.message}`),null}}async function sn(e,t){try{await fetch(`${Ke}/sessions/${e}`,{method:"DELETE",headers:{"X-Browser-Use-API-Key":t}}),console.log(`[closeBrowserSession] closed sessionId=${e}`)}catch{}}async function Si(e){try{const t=await At(`${Ke}/sessions?filterBy=active&pageSize=100`,{headers:{"X-Browser-Use-API-Key":e}});return t.ok?(await t.json()).items??[]:[]}catch{return[]}}async function ar(e,t){const n=await Si(e);let s=0;for(const r of n)!r.id||t&&r.id===t||(await sn(r.id,e),s++);return s>0&&console.log(`[reapActiveBrowserSessions] closed ${s} stale session(s)`),s}function ir(e,t){const n=(t||"").toLowerCase();return/session/.test(n)?/concurrent|too many|maximum|limit|exceeded/.test(n):!1}async function or(e,t,n){var o;const s=(n==null?void 0:n.timeoutMs)??Ei;console.log(`[runBrowserTask] starting taskLen=${e.length} timeoutMs=${s} hasSecrets=${!!(n!=null&&n.secrets)} reuseSession=${!!(n!=null&&n.sessionId)}`);let r,a;try{const l={task:e};n!=null&&n.secrets&&Object.keys(n.secrets).length>0&&(l.secrets=n.secrets),n!=null&&n.sessionId&&(l.sessionId=n.sessionId);const c=()=>fetch(`${Ke}/tasks`,{method:"POST",headers:{"X-Browser-Use-API-Key":t,"Content-Type":"application/json"},body:JSON.stringify(l)});let d=await c();if(!d.ok){const p=await d.text().catch(()=>"");if(ir(d.status,p)&&(console.log("[runBrowserTask] concurrency limit — reaping stale sessions and retrying"),await ar(t,n==null?void 0:n.sessionId),d=await c()),!d.ok){const g=await d.text().catch(()=>p);return console.log(`[runBrowserTask] CREATE_FAILED HTTP ${d.status}: ${g}`),{output:null,taskId:"",status:"failed",error:`HTTP ${d.status}: ${g}`}}}const u=await d.json();if(r=u.id,a=u.sessionId||void 0,console.log(`[runBrowserTask] CREATED taskId=${r} sessionId=${a}`),!r)return{output:null,taskId:"",status:"failed",error:"No id in create response"}}catch(l){return{output:null,taskId:"",status:"failed",error:l.message}}await new Promise(l=>setTimeout(l,Yn));const i=Date.now()+(s-Yn);for(;Date.now()<i;){try{const l=await At(`${Ke}/tasks/${r}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(l.ok){const c=await l.json();if(rr.has(c.status)){if(c.status==="finished"){let d=c.output??null;if(!d)try{const u=await At(`${Ke}/tasks/${r}`,{headers:{"X-Browser-Use-API-Key":t}},Dn);if(u.ok){const p=await u.json();if(d=p.output??null,!d&&((o=p.steps)!=null&&o.length)){const g=p.steps[p.steps.length-1];d=g.extracted_content??g.output??g.result??null}}}catch{}return console.log(`[runBrowserTask] COMPLETED taskId=${r} outputLen=${(d??"").length}`),{output:d,taskId:r,sessionId:a,status:"completed"}}return console.log(`[runBrowserTask] FAILED taskId=${r} status=${c.status}`),{output:c.output??null,taskId:r,status:"failed",error:c.output??"Task was stopped before completing"}}}}catch{}await new Promise(l=>setTimeout(l,wn))}return console.log(`[runBrowserTask] TIMEOUT taskId=${r} sessionId=${a}`),{output:null,taskId:r,sessionId:a,status:"timeout"}}async function lr(e,t,n){var a;const s=(n==null?void 0:n.waitMs)??3e4,r=Date.now()+s;for(;Date.now()<r;){try{const i=await At(`${Ke}/tasks/${e}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(!i.ok){await new Promise(l=>setTimeout(l,wn));continue}const o=await i.json();if(rr.has(o.status)){let l=null;const c=await At(`${Ke}/tasks/${e}`,{headers:{"X-Browser-Use-API-Key":t}},Dn);if(c.ok){const d=await c.json();if(l=d.output??null,!l&&((a=d.steps)!=null&&a.length)){const u=d.steps[d.steps.length-1];l=u.extracted_content??u.output??u.result??null}}else l=o.output??null;return{status:o.status,output:l,done:!0}}}catch{}await new Promise(i=>setTimeout(i,wn))}return{status:"running",output:null,done:!1}}function xi(e){return`Navigate to https://www.bluedart.com/tracking.
...
- **HARD RULE — no false confirmations**: You have ZERO tool access. You CANNOT set reminders, create schedules, send emails, read sheets, or perform any action. NEVER output phrases like "Reminder set for...", "I've scheduled...", "Done ✅", "Task created", or any language implying an action was completed. If the user wants an action, say: "I can do that — just send your message and I'll take care of it." Do NOT simulate the outcome.`;default:return""}}const Di=Object.freeze(Object.defineProperty({__proto__:null,buildSubAgentPrompt:pr,classifyIntentFast:Rn,detectDeterministicOp:ur,detectTierTwoOp:mr},Symbol.toStringTag,{value:"Module"})),Ri=new Set(["create_skill","list_skills","store_memory","search_memory","delete_memory","update_memory","get_schedules","delete_schedule","create_schedule","toggle_schedule","gmail_unread_count"]),Oi=3,Ii=3,hr=5,gr=.4,fr=5;async function yr(e,t,n,s,r,a,i=!0){try{const o=r.filter(y=>!Ri.has(y));if(o.length<Oi)return;const c=[...[...new Set(o)]].sort().join(","),d=await e.prepare(`INSERT INTO skill_patterns (user_id, tool_signature, user_message_sample, tool_sequence, turn_count, succeeded)
       VALUES (?, ?, ?, ?, ?, ?)
...
`)}
`}catch{return""}}async function Ci(e,t,n){var i;let s=0,r=0,a=0;try{const o=await e.prepare(`SELECT us.id, us.user_id, us.name, us.instructions, us.refinement_count,
              us.confidence_score, us.usage_count
       FROM user_skills us
       WHERE us.user_id = ? AND us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < ? AND us.usage_count >= ?`).bind(n,gr,fr).all();for(const l of o.results??[]){s++;const c=await e.prepare(`SELECT user_message_sample, tool_sequence
         FROM skill_patterns
         WHERE auto_skill_id = ? AND succeeded = 1
         ORDER BY created_at DESC LIMIT 3`).bind(l.id).all();if((c.results??[]).length<2||l.refinement_count>=hr){await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),await e.prepare(`INSERT INTO notifications (user_id, type, title, body, source, is_read)
...
${d.map((g,y)=>`${y+1}. "${g}"`).join(`
`)}
Tools used: ${u.join(" → ")}

Rewrite the instructions to be clearer and more reliable. Keep them under 200 words.
Respond with EXACTLY:
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const w=(((i=(await t.chat(p,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);w&&w[1].trim()&&(await e.prepare(`UPDATE user_skills
             SET instructions = ?, refinement_count = refinement_count + 1, updated_at = CURRENT_TIMESTAMP
             WHERE id = ?`).bind(w[1].trim(),l.id).run(),r++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:s,rewritten:r,disabled:a}}async function Ai(e,t,n,s,r){var D;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
     WHERE user_id = ? AND tool_signature = ?
     ORDER BY created_at DESC LIMIT 3`).bind(n.id,s).all()).results??[]).map(O=>O.user_message_sample),o=[{role:"system",content:"You are a workflow analyst. Given examples of user requests that all triggered the same multi-tool sequence, write a concise reusable skill procedure."},{role:"user",content:`These user requests all produced the same multi-tool workflow:

${i.map((O,L)=>`${L+1}. "${O}"`).join(`
`)}
...
INSTRUCTIONS: <step-by-step instructions referencing exact tool names, under 200 words>`}],c=((D=(await t.chat(o,{tools:[]})).content)==null?void 0:D.trim())??"",d=c.match(/^NAME:\s*(.+)$/m),u=c.match(/^DESCRIPTION:\s*(.+)$/m),p=c.match(/^INSTRUCTIONS:\s*([\s\S]+)$/m);if(!d||!u||!p)return;const g=d[1].trim(),y=u[1].trim(),w=p[1].trim();if(!g||!y||!w)return;let v=`auto_${g.toLowerCase().replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").substring(0,40)}`;await e.prepare("SELECT id FROM user_skills WHERE user_id = ? AND slug = ?").bind(n.id,v).first()&&(v=`${v}_${Date.now().toString().slice(-4)}`);const T=await e.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, required_tools, is_auto, source)
     VALUES (?, ?, ?, ?, ?, ?, 1, 'auto')
     RETURNING id`).bind(n.id,g,v,y,w,JSON.stringify(r)).first();T!=null&&T.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE user_id = ? AND tool_signature = ?").bind(T.id,n.id,s).run()}async function Li(e,t,n,s,r,a){var u;const i=await e.prepare("SELECT name, instructions, refinement_count FROM user_skills WHERE id = ? AND user_id = ?").bind(s,n.id).first();if(!i||i.refinement_count>=hr)return;const o=[{role:"system",content:"You are a workflow optimizer. Given an existing skill and a new usage example, decide if the instructions should be improved."},{role:"user",content:`Existing skill "${i.name}":
${i.instructions}
...
${s}
`:"",l=Vn(t,Pi);let c="";try{const u=new Date;c=new Intl.DateTimeFormat("en-GB",{timeZone:e.timezone,day:"numeric",month:"short",year:"numeric"}).format(u)}catch{c=""}return`You are ${a}.
...
---
## Current Date & Time
${Rr(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.${n==="telegram"?'\n\n## TELEGRAM CONSTRAINTS\n- **Essays / save to Drive**: When the user wants an essay, article, or report saved to Google Drive (or says "store/save to drive"), you MUST call `create_doc` with the **full** text in the `content` parameter — never truncate for Telegram. Do NOT paste the essay body in chat (reply with title + Doc link only). Write from your knowledge unless they asked for research — do NOT call web_search before a plain essay. One `create_doc` call with title + full content (+ optional `folder_name`).\n- **Research + save**: One web_search, then immediately create_doc or gmail_draft with the findings. Do NOT call read_url on multiple pages. Pattern: web_search → create_doc (or gmail_draft).\n- **Reminders**: When the user says "remind me in X" or "set a reminder", you MUST call create_schedule. For a specific time/date ("at 13:00", "tomorrow at noon", "next Friday at 5pm"), ALWAYS use `schedule_value` with the exact datetime in the user\'s local timezone — NEVER use `minutes_from_now` for clock-time requests (it causes wrong times). Only use `minutes_from_now` for pure duration requests like "in 30 minutes" or "in 2 hours".\n- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I\'ll now..." — just call the tool.\n- **Long content intent check**: When asked to write long-form content (essay, article, report) WITHOUT any save destination (no mention of Drive, Google Doc, or "save/store"), ask first: "Should I save the full piece as a Google Doc and send you the link, or give you a brief summary here in chat?" Default to Google Doc for anything over ~300 words. If they already said Drive/Doc/save/store, skip this question and call `create_doc` with the complete text immediately. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**':""}`}async function hn(e,t,n){var c;const r=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${n.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let a;((c=r.files)==null?void 0:c.length)>0?a=r.files[0].id:a=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:n,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${a}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:a,folderName:n}}function Zt(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").replace(/^\[calling:[^\]]*\]\s*/i,"").trim()}function Rr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}const Bi={read_sheet:"read",search_memory:"read",list_schedules:"read",write_sheet:"write",append_sheet:"write",update_schedule:"write",delete_schedule:"write",gmail_send:"external_effect",create_calendar_event:"external_effect"};function ji(e,t){const n=Bi[e]||"read";if(n==="read")return null;const s=Or(t);return n==="write"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} requires transaction_mode=execute.`:n==="external_effect"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} can cause external side effects and needs transaction_mode=execute.`:null}const Ui=["ETIMEDOUT","TIMEOUT","429","503","ECONNRESET","network"],Hi=new Set(["write_sheet","append_sheet","gmail_send","create_calendar_event","update_schedule","delete_schedule","delete_memory"]),Fi={create_schedule:{required:["name","schedule_type","action_type"],enum:{schedule_type:["interval","daily","weekly","once"]}},update_schedule:{required:["job_id"]},delete_schedule:{required:["job_id"]},write_sheet:{required:["spreadsheet_id","range","values"]},append_sheet:{required:["spreadsheet_id","range","values"]},gmail_send:{required:["to","subject","body"]}};function Gi(e){const t=String((e==null?void 0:e.message)||e||"Unknown tool error");return/timeout|timed out/i.test(t)?"TOOL_TIMEOUT":/unauthorized|forbidden|401|403/i.test(t)?"TOOL_AUTH":/not found|404/i.test(t)?"TOOL_NOT_FOUND":/rate limit|429/i.test(t)?"TOOL_RATE_LIMIT":/validation|invalid|required/i.test(t)?"TOOL_VALIDATION":"TOOL_EXECUTION_FAILED"}function Wi(e){const t=String((e==null?void 0:e.message)||e||"").toLowerCase();return Ui.some(n=>t.includes(n.toLowerCase()))}function qi(e){const t=e.query??e.q??e.search_query??e.search;return typeof t=="string"?t.trim():""}function zi(e,t){const n=Fi[e];if(n){for(const s of n.required||[])if(t[s]===void 0||t[s]===null||t[s]==="")throw new Error(`Validation failed: ${s} is required for ${e}`);for(const[s,r]of Object.entries(n.enum||{}))if(t[s]!==void 0&&!r.includes(String(t[s])))throw new Error(`Validation failed: ${s} must be one of ${r.join(", ")}`)}}function Or(e){const t=e.transaction_mode;return t==="dry_run"||t==="confirm_required"||t==="execute"?t:"execute"}function Ki(e,t){if(!Hi.has(e))return null;const n=Or(t);return n==="dry_run"?`DRY RUN: ${e} validated. No write action was executed.`:n==="confirm_required"?`CONFIRMATION REQUIRED: ${e} is a write action. Re-run with transaction_mode=execute to proceed.`:null}const Yi=new Set(["gmail_send","gmail_draft","gmail_modify","append_sheet","create_sheet","write_sheet","create_doc","append_to_doc","rewrite_doc","create_calendar_event","create_schedule","create_skill"]),Ji=new Set(["list_schedules","search_memory","get_system_status","read_sheet","list_calendar_events","read_doc","gmail_list","gmail_read","gmail_search","gmail_unread_count","drive_list","drive_search","drive_read_file","web_search","read_url","research","browser_task_status","vault_lookup","search_places","get_place_details","get_directions","get_travel_time","translate_text","search_youtube","geocode_address","parse_document","search_library","read_library_file","list_skills"]),Vi=5;async function Lt(e,t,n,s,r,a,i,o,l,c,d,u,p,g,y){const w=Date.now();let v=!0,E="",T="";const D=r.traceId||crypto.randomUUID(),O=`${s}:${e}:${JSON.stringify(t)}`;if(Yi.has(e)&&!Ji.has(e))try{const A=await n.prepare(`SELECT tool_result FROM tool_execution_log
           WHERE user_id = ? AND tool_name = ? AND idempotency_key = ? AND success = 1
             AND created_at >= datetime('now', '-${Vi} minutes')
           ORDER BY created_at DESC
           LIMIT 1`).bind(s,e,O).first();if(A)return A.tool_result||""}catch{}try{zi(e,t);const A=ji(e,t);if(A)return T=A,T;const F=Ki(e,t);if(F)return T=F,T;const Y=2;for(let ee=1;ee<=Y;ee++)try{const ae=e==="browser_task"?31e4:e==="browser_task_status"?35e3:e==="research"?18e4:9e4;T=await Promise.race([Xi(e,t,n,s,a,i,o,l,c,d,u,p,g,r.channel,y),new Promise((C,K)=>setTimeout(()=>K(new Error("Tool timed out")),ae))]);break}catch(ae){if(ee<Y&&Wi(ae)){await new Promise(C=>setTimeout(C,250*ee));continue}throw ae}return T}catch(A){throw v=!1,E=`${Gi(A)}: ${A.message||"Unknown error"}`,new Error(E)}finally{const A=Date.now()-w;try{await n.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel, idempotency_key)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,r.agentType||null,r.providerName||null,e,JSON.stringify({...t,_idempotency_key:O,_trace_id:D}).substring(0,2e3),(v?T:"").substring(0,500),v?1:0,E||null,A,r.isEnforcementRetry?1:0,r.channel||"web",O).run()}catch{}}}function Ir(e){const t=e.length;for(let n=0;n<t-1;n++){const s=e[n];if(s.role!=="user"||typeof s.content!="string")continue;const r=t-1-n,a=r<=2?12e3:r<=4?5e3:2e3;s.content.length>a&&(e[n]={...s,content:s.content.substring(0,a)+`
[...truncated in history to reduce context size]`})}}function Zi(e){const t=[];let n=[],s="",r=!1,a=0;const i=e.length;for(;a<i;){const o=e[a];if(r){if(o==='"'){if(e[a+1]==='"'){s+='"',a+=2;continue}r=!1,a++;continue}s+=o,a++;continue}if(o==='"'){r=!0,a++;continue}if(o===","){n.push(s),s="",a++;continue}if(o==="\r"&&e[a+1]===`
`){n.push(s),t.push(n),n=[],s="",a+=2;continue}if(o===`
`||o==="\r"){n.push(s),t.push(n),n=[],s="",a++;continue}s+=o,a++}for((s||n.length)&&(n.push(s),t.push(n));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function Xi(e,t,n,s,r,a,i,o,l,c,d,u,p,g,y){var v,E,T,D,O,L,A,F,Y,ee,ae,C,K,X,z,re,ce,q,Q,le,U;const w=new te(n);switch(e){case"create_schedule":{const m=new Date;let b;const h=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){b=new Date(m.getTime()+t.minutes_from_now*60*1e3);const $=b.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[j,I,N]=($[0]||"").split("/");t.schedule_value=`${N}-${j}-${I} ${$[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const R=parseInt(t.schedule_value,10);b=new Date(m.getTime()+R*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const R=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(R)){const[j,I]=t.schedule_value.split(":").map(Number),N=m.toLocaleString("en-US",{timeZone:h}),P=new Date(N),M=new Date(P);M.setHours(j,I,0,0),M<=P&&M.setDate(M.getDate()+1);const W=new Date(M.toLocaleString("en-US",{timeZone:"UTC"})),ne=new Date(M.toLocaleString("en-US",{timeZone:h})),J=W.getTime()-ne.getTime();b=new Date(M.getTime()+J)}else{const[j,I]=t.schedule_value.split(":").map(Number),N=m.toLocaleString("en-US",{timeZone:h}),P=new Date(N),M=new Date(P);M.setHours(j,I,0,0),M<=P&&M.setDate(M.getDate()+1);const W=Xe=>String(Xe).padStart(2,"0"),ne=M.getFullYear(),J=W(M.getMonth()+1),ue=W(M.getDate());t.schedule_value=`${ne}-${J}-${ue} ${W(j)}:${W(I)}`,t.schedule_type="once";const ve=new Date(M.toLocaleString("en-US",{timeZone:"UTC"})),je=new Date(M.toLocaleString("en-US",{timeZone:h})),Ze=ve.getTime()-je.getTime();b=new Date(M.getTime()+Ze)}}else if(t.schedule_type==="daily"){const[R,$]=t.schedule_value.split(":").map(Number),j=m.toLocaleString("en-US",{timeZone:h}),I=new Date(j),N=new Date(I);N.setHours(R,$,0,0),N<=I&&N.setDate(N.getDate()+1);const P=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),M=new Date(N.toLocaleString("en-US",{timeZone:h})),W=P.getTime()-M.getTime();b=new Date(N.getTime()+W)}else if(t.schedule_type==="weekly"){const[R,$]=t.schedule_value.split(" "),[j,I]=($||"00:00").split(":").map(Number),P=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ze=>Ze.toLowerCase()===R.toLowerCase()),M=m.toLocaleString("en-US",{timeZone:h}),W=new Date(M),ne=new Date(W);ne.setHours(j,I,0,0);let J=(P-ne.getDay()+7)%7;J===0&&ne<=W&&(J=7),ne.setDate(ne.getDate()+J);const ue=new Date(ne.toLocaleString("en-US",{timeZone:"UTC"})),ve=new Date(ne.toLocaleString("en-US",{timeZone:h})),je=ue.getTime()-ve.getTime();b=new Date(ne.getTime()+je)}else if(t.schedule_type==="once"){const[R,$]=t.schedule_value.split(" "),[j,I,N]=R.split("-").map(Number),[P,M]=($||"00:00").split(":").map(Number),W=m.toLocaleString("en-US",{timeZone:h}),ne=new Date(W),J=new Date(ne);J.setFullYear(j,I-1,N),J.setHours(P,M,0,0);const ue=new Date(J.toLocaleString("en-US",{timeZone:"UTC"})),ve=new Date(J.toLocaleString("en-US",{timeZone:h})),je=ue.getTime()-ve.getTime();b=new Date(J.getTime()+je);const Ze=new Date(m.getTime()+120*1e3);if(b.getTime()<m.getTime()+60*1e3){const Xe=b.toISOString();b=Ze;const Wt=` [Note: The requested time ${t.schedule_value} in ${h} resolved to ${Xe} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${b.toISOString()}.]`;t._pastTimeWarning=Wt}}else b=new Date(m.getTime()+3600*1e3);if((t.schedule_type==="interval"||t.schedule_type==="daily"||t.schedule_type==="weekly")&&t.action_type==="custom"){const R=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(send|forward)\b.{0,40}\b(email|mail)\b|\bemail.{0,20}\bto\b|\bgmail_send\b/.test(R)&&(t.schedule_type="once")}if(t.action_type==="custom"&&t.schedule_type==="once"){const R=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(R)||(t.action_type="reminder")}if(await n.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(s,t.name,t.schedule_type,t.schedule_value).first()){const R=b.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${R} (${h}). No duplicate created.`}await n.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(s,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),b.toISOString()).run();const S=t._pastTimeWarning||"",k=b.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${k} (${h}). [UTC: ${b.toISOString()}]${S}. IMPORTANT: Use the exact time "${k}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const b=(await n.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(s).all()).results||[];return b.length===0?"No scheduled tasks found.":b.map(h=>`[ID:${h.id}] ${h.enabled?"▶":"⏸"} "${h.name}" — [${h.schedule_type}] ${h.schedule_value} — ${h.action_type} — state: ${h.state||"active"} — next: ${h.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const m=t.enabled?1:0,b=m?"active":"paused";return await n.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(m,b,t.job_id,s).run(),`Schedule ${t.job_id} ${m?"enabled (active)":"paused"}.`}case"update_schedule_state":{const m=["created","active","reminding","paused","completed"],b=t.state;if(!m.includes(b))return`Invalid state "${b}". Valid states: ${m.join(", ")}`;const h=b==="completed"||b==="paused"?0:1;return await n.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(b,h,t.job_id,s).run(),`Schedule ${t.job_id} state updated to "${b}".`}case"update_schedule":{const m=t.job_id,b=c||"UTC",h=new Date,f=["updated_at = CURRENT_TIMESTAMP"],_=[];t.name&&(f.push("name = ?"),_.push(t.name)),t.description&&(f.push("description = ?"),_.push(t.description));let S=null,k=t.schedule_type,R=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){S=new Date(h.getTime()+t.minutes_from_now*60*1e3);const I=S.toLocaleString("en-US",{timeZone:b,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,P,M]=(I[0]||"").split("/");R=`${M}-${N}-${P} ${I[1]||"00:00"}`,k="once"}else if(k&&R){if(k==="interval")S=new Date(h.getTime()+parseInt(R,10)*60*1e3);else if(k==="daily"){const[j,I]=R.split(":").map(Number),N=new Date(h.toLocaleString("en-US",{timeZone:b})),P=new Date(N);P.setHours(j,I,0,0),P<=N&&P.setDate(P.getDate()+1);const M=new Date(P.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(P.toLocaleString("en-US",{timeZone:b})).getTime();S=new Date(P.getTime()+M)}else if(k==="weekly"){const[j,I]=R.split(" "),[N,P]=(I||"00:00").split(":").map(Number),W=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(je=>je.toLowerCase()===j.toLowerCase()),ne=new Date(h.toLocaleString("en-US",{timeZone:b})),J=new Date(ne);J.setHours(N,P,0,0);let ue=(W-J.getDay()+7)%7;ue===0&&J<=ne&&(ue=7),J.setDate(J.getDate()+ue);const ve=new Date(J.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(J.toLocaleString("en-US",{timeZone:b})).getTime();S=new Date(J.getTime()+ve)}else if(k==="once"){const[j,I]=R.split(" "),[N,P,M]=j.split("-").map(Number),[W,ne]=(I||"00:00").split(":").map(Number),J=new Date(h.toLocaleString("en-US",{timeZone:b})),ue=new Date(J);ue.setFullYear(N,P-1,M),ue.setHours(W,ne,0,0);const ve=new Date(ue.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(ue.toLocaleString("en-US",{timeZone:b})).getTime();S=new Date(ue.getTime()+ve),S.getTime()<h.getTime()+60*1e3&&(S=new Date(h.getTime()+120*1e3))}}if(k&&(f.push("schedule_type = ?"),_.push(k)),R&&(f.push("schedule_value = ?"),_.push(R)),S&&(f.push("next_run = ?"),_.push(S.toISOString())),f.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";_.push(m,s),await n.prepare(`UPDATE cron_jobs SET ${f.join(", ")} WHERE id = ? AND user_id = ?`).bind(..._).run();const $=S?S.toLocaleString("en-US",{timeZone:b,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${m} updated.${$?` New fire time: ${$} (${b}).`:""} IMPORTANT: Use this exact time "${$}" when confirming to the user.`}case"delete_schedule":return await n.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,s).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const m=t.importance||5,b=t.type==="task"?"preference":t.type,h=m>=7?"working":"long_term";return await w.store(s,b,t.title,t.content,m,h),`Stored in ${h==="working"?"working":"long-term"} memory: [${b}] ${t.title} (importance: ${m})`}case"search_memory":{const m=await w.search(s,t.query);return m.length===0?"No matching memories found.":m.map(b=>`[id:${b.id}] [${b.tier||"long_term"}] [${b.type}] **${b.title}**: ${b.content}`).join(`
`)}case"delete_memory":return await w.remove(t.id,s),`Memory entry ${t.id} deleted.`;case"update_memory":return await w.update(t.id,s,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const m=await n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(s).first(),b=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(s).first(),h=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(s).first(),f=await n.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(s).first(),_=await n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(s).first();return`System Status:
- Active schedules: ${(m==null?void 0:m.cnt)||0}
- Memory: ${(h==null?void 0:h.cnt)||0} working / ${(b==null?void 0:b.cnt)||0} total
- Total messages: ${(f==null?void 0:f.cnt)||0}
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||""),b=t.spreadsheet_id;let h=t.range;const f=await m.sheets.getMetadata(b),_=f.sheets;h.includes("!")||(h=`${_[0]}!${h}`);let S;try{S=await m.sheets.readRange(b,h)}catch(R){if((v=R.message)!=null&&v.includes("Unable to parse range")||(E=R.message)!=null&&E.includes("400")){const $=h.includes("!")?h.split("!")[1]:h;h=`${_[0]}!${$}`,S=await m.sheets.readRange(b,h)}else throw R}let k=`[Spreadsheet: "${f.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(R=>`"${R}"`).join(", ")}]
`;return _.length>1&&(k+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),S.length===0?k+"No data found in the specified range.":k+S.map(R=>R.join("	| ")).join(`
`)}catch(m){return await H(n,s,"google","read_sheet",m.message),`Failed to read sheet: ${m.message}`}}case"write_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const I=new te(n),N=JSON.stringify(t.values);await I.store(s,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:N.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const h=t.values;let f=t.range;const k=Math.max(...h.map(I=>I.length))+4,R=h.map(I=>{const N=[...I];for(;N.length<k;)N.push("");return N}),$=f.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if($){const I=$[1]||"",N=$[2],P=$[3],M=$[5],ne=N.toUpperCase().charCodeAt(0)-64+k-1,J=ne<=26?String.fromCharCode(64+ne):"Z";f=`${I}${N}${P}:${J}${M}`}const j=await m.sheets.writeRange(t.spreadsheet_id,f,R);try{const I=new te(n),N=await I.search(s,`Pending sheet write: ${t.spreadsheet_id}`);for(const P of N)P.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await I.remove(P.id,s)}catch{}return`Written ${j.updatedCells} cells to ${f}.`}catch(m){return await H(n,s,"google","write_sheet",m.message),`Failed to write sheet: ${m.message}`}}case"append_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new te(n).store(s,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const h=await m.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const f=new te(n),_=await f.search(s,`Pending sheet append: ${t.spreadsheet_id}`);for(const S of _)S.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await f.remove(S.id,s)}catch{}return`Appended ${h.updatedCells} cells to ${t.range}.`}catch(m){return await H(n,s,"google","append_sheet",m.message),`Failed to append to sheet: ${m.message}`}}case"create_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title)try{await new te(n).store(s,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`

The spreadsheet request has been saved to temporary memory. After reconnecting, tell me "create the pending spreadsheet" and I'll complete this automatically.`:"")}const h=await m.sheets.createSpreadsheet(t.title,t.sheet_names);let f="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||"");f=`
Folder: "${(await hn(_,h.spreadsheetId,t.folder_name)).folderName}"`}catch(_){f=`
(Note: spreadsheet saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new te(n).store(s,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${f}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(m){return await H(n,s,"google","create_sheet",m.message),`Failed to create spreadsheet: ${m.message}`}}case"list_calendar_events":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||""),b=t.calendar_id||"primary",h=t.days_ahead||7,f=new Date,_=new Date(f.getTime()+h*24*60*60*1e3),S=await m.calendar.listEvents(b,{timeMin:f.toISOString(),timeMax:_.toISOString(),query:t.query});return S.length===0?`No events found in the next ${h} days.`:S.map(k=>{var N;const R=k.start.dateTime||k.start.date||"TBD",$=k.end.dateTime||k.end.date||"",j=k.location?` 📍 ${k.location}`:"",I=((N=k.attendees)==null?void 0:N.map(P=>P.email).join(", "))||"";return`• ${k.summary} — ${R} to ${$}${j}${I?`
  Attendees: ${I}`:""}`}).join(`
`)}catch(m){return await H(n,s,"google","list_calendar",m.message),`Failed to list events: ${m.message}`}}case"create_calendar_event":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.summary&&t.start_datetime&&t.end_datetime)try{await new te(n).store(s,"context",`Pending calendar event: "${t.summary}"`,JSON.stringify({tool:"create_calendar_event",summary:t.summary,description:t.description??null,location:t.location??null,start_datetime:t.start_datetime,end_datetime:t.end_datetime,attendees:t.attendees??null,calendar_id:t.calendar_id??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.summary&&t.start_datetime?`

The calendar event has been saved to temporary memory. After reconnecting, tell me "create the pending event" and I'll add it to your calendar.`:"")}const h=t.calendar_id||"primary",f=await m.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});try{const _=new te(n),S=await _.search(s,`Pending calendar event: "${t.summary}"`);for(const k of S)k.title.startsWith(`Pending calendar event: "${t.summary}"`)&&await _.remove(k.id,s)}catch{}return`Event created: "${f.summary}"
ID: ${f.id}
Start: ${f.start.dateTime||f.start.date}`}catch(m){return await H(n,s,"google","create_event",m.message),`Failed to create event: ${m.message}`}}case"create_doc":{if(!r)return"Authentication context unavailable.";const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title&&t.content){try{await new te(n).store(s,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" and I'll complete this automatically.`:"")}let h;try{h=await m.docs.createDocument(t.title)}catch(_){return await H(n,s,"google","create_doc",_.message),`Failed to create document: ${_.message}`}if(t.content){const _=t.content,S=async()=>{_.length>12e3?await m.docs.appendText(h.documentId,_):await m.docs.appendFormattedContent(h.documentId,_)};try{await S()}catch(k){try{await m.docs.appendText(h.documentId,_)}catch(R){return await H(n,s,"google","create_doc_append",R.message),`Document created but content could not be written (${R.message}).
ID: ${h.documentId}
URL: ${h.url}

Use append_to_doc with the document ID above to add content.`}await H(n,s,"google","create_doc_append_fallback",`Formatted append failed, used plain text: ${k.message}`)}}let f="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||"");f=`
Folder: "${(await hn(_,h.documentId,t.folder_name)).folderName}"`}catch(_){f=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new te(n).store(s,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}try{const _=t.content;await n.prepare(`INSERT OR IGNORE INTO document_library (user_id, source, drive_file_id, name, summary, extracted_text, status)
           VALUES (?, 'drive', ?, ?, ?, ?, 'parsed')`).bind(s,h.documentId,t.title,_?_.substring(0,500):null,_?_.substring(0,5e4):null).run()}catch{}try{const _=new te(n),S=await _.search(s,`Pending Google Doc save: "${t.title}"`);for(const k of S)k.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await _.remove(k.id,s)}catch{}return`Document created: "${t.title}"${f}
ID: ${h.documentId}
URL: ${h.url}`}case"read_doc":{if(!r)return"Authentication context unavailable.";try{const b=await new we(n,s,r,a||"",i||"").docs.readDocument(t.document_id);return`Document: "${b.title}"

${b.content}`}catch(m){return await H(n,s,"google","read_doc",m.message),`Failed to read document: ${m.message}`}}case"append_to_doc":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.document_id&&t.content)try{await new te(n).store(s,"context",`Pending append to doc: "${t.document_id}"`,JSON.stringify({tool:"append_to_doc",document_id:t.document_id,content:t.content}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.'+(t.document_id&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" to complete this.`:"")}await m.docs.appendFormattedContent(t.document_id,t.content);let h=t.document_id;try{h=(await m.docs.readDocument(t.document_id)).title}catch{}try{const f=new te(n),_=await f.search(s,`Pending append to doc: "${t.document_id}"`);for(const S of _)S.title.startsWith(`Pending append to doc: "${t.document_id}"`)&&await f.remove(S.id,s)}catch{}try{const f=t.content;await n.prepare(`UPDATE document_library
             SET extracted_text = SUBSTR(COALESCE(extracted_text, '') || char(10) || ?, 1, 50000),
                 updated_at = CURRENT_TIMESTAMP
             WHERE user_id = ? AND drive_file_id = ?`).bind(f,s,t.document_id).run()}catch{}return`Content appended to "${h}".
...
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(m){return await H(n,s,"google","rewrite_doc",m.message),`Failed to rewrite document: ${m.message}`}}case"delete_sheet_row":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";const h=t.row_number;return h<2?"Row 1 is the header row and cannot be deleted. Specify row 2 or higher.":(await m.sheets.deleteRow(t.spreadsheet_id,t.sheet_name,h),`Row ${h} deleted from "${t.sheet_name}". All rows below have shifted up.`)}catch(m){return await H(n,s,"google","delete_sheet_row",m.message),`Failed to delete row: ${m.message}`}}case"delete_doc_content":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";const h=await m.docs.deleteContent(t.document_id,t.text_to_remove);return h.occurrencesRemoved===0?"No matching text found in the document. The text must match exactly — check spacing, punctuation, and line breaks.":`Removed ${h.occurrencesRemoved} occurrence${h.occurrencesRemoved===1?"":"s"} from the document.`}catch(m){return await H(n,s,"google","delete_doc_content",m.message),`Failed to delete document content: ${m.message}`}}case"gmail_list":{if(!r)return"Authentication context unavailable.";try{const b=await new De(n,s,r,a||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return b.length===0?"No messages found.":b.map((h,f)=>`${h.isUnread?"● ":"  "}${f+1}. **${h.subject}**
   From: ${h.from}
   Date: ${h.date}
   ${h.snippet}
   [id: ${h.id}]`).join(`

`)}catch(m){return await H(n,s,"gmail","list",m.message),(T=m.message)!=null&&T.includes("not connected")?m.message:`Gmail list error: ${m.message}`}}case"gmail_read":{if(!r)return"Authentication context unavailable.";try{const m=new De(n,s,r,a||"",i||""),b=await m.getMessage(t.message_id);if(!b)return"Message not found.";const h=await m.getMessageBody(t.message_id);return`**${b.subject}**
From: ${b.from}
To: ${b.to}
Date: ${b.date}

${h}`}catch(m){return await H(n,s,"gmail","read",m.message),`Gmail read error: ${m.message}`}}case"gmail_search":{if(!r)return"Authentication context unavailable.";try{const m={hasPinHash:!!r,hasGoogleClientId:!!a,hasGoogleClientSecret:!!i,queryType:typeof t.query,queryPreview:String(t.query??"").slice(0,120),maxResults:t.max_results,argKeys:Object.keys(t)};fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"agent.ts:gmail_search:entry",message:"gmail_search invoked",data:m,timestamp:Date.now(),hypothesisId:"A,D"})}).catch(()=>{}),H(n,s,"debug-98e203","gmail_search_entry","gmail_search invoked",m).catch(()=>{});const b=qi(t);if(!b)return"Gmail search requires a non-empty query (e.g. from:sender@example.com subject:invoice). Use Gmail search syntax.";const f=await new De(n,s,r,a||"",i||"").search(b,t.max_results||10),_={query:b,resultCount:f.length,firstSubject:((D=f[0])==null?void 0:D.subject)??null,firstDate:((O=f[0])==null?void 0:O.date)??null};return fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"agent.ts:gmail_search:success",message:"gmail_search completed",data:_,timestamp:Date.now(),hypothesisId:"B,C"})}).catch(()=>{}),H(n,s,"debug-98e203","gmail_search_success","gmail_search completed",_).catch(()=>{}),f.length===0?`No results for: ${b}`:f.map((S,k)=>`${S.isUnread?"● ":"  "}${k+1}. **${S.subject}**
   From: ${S.from}
   Date: ${S.date}
   ${S.snippet}
   [id: ${S.id}]`).join(`

`)}catch(m){const b={error:String((m==null?void 0:m.message)??m).slice(0,300)};fetch("http://127.0.0.1:7448/ingest/9120d54a-e021-41a8-8531-28787f5558fd",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"98e203"},body:JSON.stringify({sessionId:"98e203",location:"agent.ts:gmail_search:error",message:"gmail_search threw",data:b,timestamp:Date.now(),hypothesisId:"A,B,E"})}).catch(()=>{}),H(n,s,"debug-98e203","gmail_search_error","gmail_search threw",b).catch(()=>{}),await H(n,s,"gmail","search",m.message);const h=String((m==null?void 0:m.message)||m);return/403|access denied|insufficient|permission/i.test(h)?`${h} Go to Settings → Keys → Google Workspace and reconnect your account.`:`Gmail search error: ${h}`}}case"gmail_send":{if(!r)return"Authentication context unavailable.";try{const m=new De(n,s,r,a||"",i||"");if(!(await new we(n,s,r,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body){try{await new te(n).store(s,"context",`Pending email: "${t.subject}"`,JSON.stringify({tool:"gmail_send",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const f=await m.send(t.to,t.subject,t.body,{cc:t.cc});try{const _=new te(n),S=await _.search(s,`Pending email: "${t.subject}"`);for(const k of S)k.title.startsWith(`Pending email: "${t.subject}"`)&&await _.remove(k.id,s)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${f.id}]`}catch(m){return await H(n,s,"gmail","send",m.message),`Gmail send error: ${m.message}`}}case"gmail_draft":{if(!r)return"Authentication context unavailable.";try{const m=new De(n,s,r,a||"",i||"");if(!(await new we(n,s,r,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new te(n).store(s,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const f=await m.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const S=new te(n),k=await S.search(s,`Pending draft: "${t.subject}"`);for(const R of k)R.title.startsWith(`Pending draft: "${t.subject}"`)&&await S.remove(R.id,s)}catch{}const _=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${_}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${f.id}]`}catch(m){return await H(n,s,"gmail","draft",m.message),`Gmail draft error: ${m.message}`}}case"gmail_modify":{if(!r)return"Authentication context unavailable.";try{return await new De(n,s,r,a||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(m){return await H(n,s,"gmail","modify",m.message),`Gmail modify error: ${m.message}`}}case"gmail_unread_count":{if(!r)return"Authentication context unavailable.";try{const b=await new De(n,s,r,a||"",i||"").getUnreadCount();return`You have ${b} unread email${b!==1?"s":""} in Gmail.`}catch(m){return(L=m.message)!=null&&L.includes("not connected")?m.message:`Gmail error: ${m.message}`}}case"drive_list":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||""),b=new URLSearchParams;b.set("pageSize",String(t.max_results||10)),b.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),b.set("orderBy","modifiedTime desc");let h="";t.folder_id?h=`'${t.folder_id}' in parents and trashed = false`:t.query?h=`${t.query} and trashed = false`:h="trashed = false",b.set("q",h);const f=await fetch(`https://www.googleapis.com/drive/v3/files?${b}`,{headers:{Authorization:`Bearer ${m}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const _=await f.json();return(A=_.files)!=null&&A.length?_.files.map((S,k)=>{var I,N;const R=((I=S.mimeType)==null?void 0:I.split(".").pop())||S.mimeType,$=S.size?`${(parseInt(S.size)/1024).toFixed(1)} KB`:"",j=((N=S.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${k+1}. **${S.name}** (${R})
   ${$} · Modified: ${j}
   ${S.webViewLink||""}`}).join(`

`):"No files found."}catch(m){return await H(n,s,"google","drive_list",m.message),`Drive list error: ${m.message}`}}case"drive_search":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||""),b=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,h=new URLSearchParams;h.set("q",b),h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");const f=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${m}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const _=await f.json();return(F=_.files)!=null&&F.length?_.files.map((S,k)=>{var j,I;const R=((j=S.mimeType)==null?void 0:j.split(".").pop())||S.mimeType,$=((I=S.modifiedTime)==null?void 0:I.split("T")[0])||"";return`${k+1}. **${S.name}** (${R}) — Modified: ${$}
   ${S.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(m){return await H(n,s,"google","drive_search",m.message),`Drive search error: ${m.message}`}}case"drive_read_file":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||""),b=t.url_or_id.trim();let h=b;const f=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const M of f){const W=b.match(M);if(W){h=W[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${m}`}});if(!_.ok)throw new Error(`Drive API error (${_.status}): could not fetch file metadata`);const S=await _.json(),{name:k,mimeType:R}=S,$=t.extract_focus,j=$?`Focus specifically on extracting: ${$}`:"Extract and return all readable text content. Preserve structure where relevant.",I={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(I[R]){const M=I[R],W=await fetch(`https://www.googleapis.com/drive/v3/files/${h}/export?mimeType=${encodeURIComponent(M)}`,{headers:{Authorization:`Bearer ${m}`}});if(!W.ok)throw new Error(`Drive export error (${W.status})`);const ne=await W.text();if(R==="application/vnd.google-apps.spreadsheet"){const J=Zi(ne),ue=J.length,ve=((Y=J[0])==null?void 0:Y.length)??0;return`**${k}** (Google Sheet — ${ue} rows × ${ve} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(J)}`}return`**${k}**

${ne.substring(0,2e4)}`}if(R==="application/pdf"||k.toLowerCase().endsWith(".pdf")){const M=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!M.ok)throw new Error(`Drive download error (${M.status})`);const W=await M.arrayBuffer(),ne=Buffer.from(W).toString("base64");let J=null,ue="claude-haiku-4-5-20251001";for(const Xe of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const Wt=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,Xe).first();if(Wt&&r){const Jr=await Z(Wt.encrypted_value,r),qt=JSON.parse(Jr);if(qt.provider==="anthropic"){J=qt.apiKey,qt.model&&(ue=qt.model);break}}}catch{}if(!J)return`"${k}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const ve=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":J,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:ue,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ne}},{type:"text",text:j}]}]})});if(!ve.ok){const Xe=await ve.text();throw new Error(`Anthropic PDF extraction error: ${Xe.substring(0,200)}`)}const Ze=((ae=(ee=(await ve.json()).content)==null?void 0:ee[0])==null?void 0:ae.text)||"";return`**${k}** (PDF from Drive)

${Ze}`}const N=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!N.ok)throw new Error(`Drive download error (${N.status})`);const P=await N.text();return`**${k}** (${R})

${P.substring(0,2e4)}`}catch(m){return await H(n,s,"google","drive_read_file",m.message),`Drive read error: ${m.message}`}}case"drive_delete_file":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||""),b=t.url_or_id.trim();let h=b;const f=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const R of f){const $=b.match(R);if($){h=$[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?fields=name`,{headers:{Authorization:`Bearer ${m}`}});if(!_.ok)throw new Error(`Drive API error (${_.status})`);const S=await _.json(),k=await fetch(`https://www.googleapis.com/drive/v3/files/${h}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!k.ok)throw new Error(`Drive API error (${k.status})`);return`"${S.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(m){return await H(n,s,"google","drive_delete_file",m.message),`Drive delete error: ${m.message}`}}case"drive_organise":{if(!r)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:m}=await(await Promise.resolve().then(()=>et)).getGoogleAuth(n,s,r,a||"",i||""),b=t.url_or_id.trim();let h=b;const f=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const S of f){const k=b.match(S);if(k){h=k[1];break}}const _=[];if(t.new_name){const S=await fetch(`https://www.googleapis.com/drive/v3/files/${h}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!S.ok)throw new Error(`Drive rename error (${S.status})`);_.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:S}=await hn(m,h,t.folder_name);_.push(`Moved to folder "${S}"`)}return _.join(". ")+"."}catch(m){return await H(n,s,"google","drive_organise",m.message),`Drive organise error: ${m.message}`}}case"web_search":try{const m=await nn(t.query,{num:t.num_results||5,site:t.site,googleApiKey:o||void 0,googleCseId:l||void 0});return m.error?`Web search failed: ${m.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:m.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:m.results.map((b,h)=>`${h+1}. [${b.title}](${b.link})
   ${b.snippet}`).join(`

`)}catch(m){return await H(n,s,"search","web_search",m.message),`Web search error: ${m.message}`}case"read_url":try{const m=t.url;if(!m||!m.startsWith("http://")&&!m.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const b=Math.min(t.max_length||8e3,15e3),{fetchPageContent:h}=await Promise.resolve().then(()=>_i),f=await h(m,b);return f.error?`Failed to read page: ${f.error}`:!f.text||f.text.length<20?`Page at ${m} returned no readable content.`:`Content from ${m} (${f.text.length} chars):

${f.text}`}catch(m){return await H(n,s,"search","read_url",m.message),`Read URL error: ${m.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{let m;try{const R=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"perplexity_api_key").first();R&&r&&(m=await Z(R.encrypted_value,r))}catch{}const b=t.depth||"quick",h=b==="thorough"?15e4:9e4,f=sr(t.query,d,{depth:b,site:t.site,perplexityApiKey:m,googleApiKey:o||void 0,googleCseId:l||void 0}),_=new Promise(R=>setTimeout(()=>R(null),h)),S=await Promise.race([f,_]);if(S===null){const{webSearch:R}=await Promise.resolve().then(()=>mi),$=await R(t.query,{num:5,googleApiKey:o||void 0,googleCseId:l||void 0});if($.error||$.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let j=`Research took too long, but here are the top search results:

`;return j+=$.results.map((I,N)=>`${N+1}. [${I.title}](${I.link})
   ${I.snippet}`).join(`

`),j}if(S.error)return`Research failed: ${S.error}`;let k=S.report;S.sources.length>0&&(k+=`

---
**Sources** (`+S.pagesRead+` pages read):
`,k+=S.sources.map((R,$)=>`[${$+1}] [${R.title}](${R.url})`).join(`
`));try{const R=new te(n),$=S.report.substring(0,600);await R.store(s,"context",`Research: ${t.query.substring(0,80)}`,$,6,"long_term")}catch{}return k}catch(m){return await H(n,s,"research","research",m.message),`Research error: ${m.message}`}}case"browser_task":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const b=(await Z(m.encrypted_value,r)).trim();let h,f=t.task,_,S;if(!t.site_name)try{const P=await n.prepare("SELECT name FROM site_credentials WHERE user_id = ?").bind(s).all(),M=f.toLowerCase(),W=(P.results||[]).find(ne=>M.includes(ne.name.toLowerCase()));W&&(t={...t,site_name:W.name},Jn("browser_task auto-vault: inferred site_name from task text",{siteName:W.name,userId:s}))}catch{}if(t.site_name)try{const P=await n.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(s,t.site_name).first();if(P){const M=JSON.parse(await Z(P.encrypted_blob,r));h={username:M.username,password:M.password},S=M.sessionId,_=P.id,f=`${f}

When prompted to log in, use username {username} and password {password}.`}}catch{}const k=async P=>{if(_)try{const M=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(_,s).first();if(!M)return;const W=JSON.parse(await Z(M.encrypted_blob,r));W.sessionId=P,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await xt(JSON.stringify(W),r),_,s).run()}catch{}},R=async()=>{if(!(!_||!S))try{const P=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(_,s).first();if(!P)return;const M=JSON.parse(await Z(P.encrypted_blob,r));delete M.sessionId,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await xt(JSON.stringify(M),r),_,s).run()}catch{}},$=/blue[\s-]?dart[\s\S]{0,100}?(\d{10,11})|(\d{10,11})[\s\S]{0,100}?blue[\s-]?dart/i.exec(f);if($){const P=$[1]||$[2];f=xi(P)}const j=void 0;y&&(y.apiKey=b,S&&!y.sessionId?(y.sessionId=S,y.persistSession=!0):!y.sessionId&&_&&(y.sessionId=await Ti(b)??void 0)),Jn("browser_task starting",{userId:s,channel:g,timeoutMs:j??3e5,sessionId:y==null?void 0:y.sessionId,vaultSession:!!S});const I=await or(f,b,{secrets:h,sessionId:y==null?void 0:y.sessionId,timeoutMs:j});if(I.status==="completed"){const P=(y==null?void 0:y.sessionId)??void 0;return _&&P&&(y&&(y.persistSession=!0),await k(P)),(C=I.output)!=null&&C.includes('"captcha_required": true')?"Captcha detected — manual verification required. The site blocked automated access. Please try completing it manually or try again later.":I.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again."}if(I.status==="timeout"){y&&(y.hasActiveTask=!0);try{await new te(n).store(s,"context",`Browser task in progress: ${I.taskId}`,JSON.stringify({task_id:I.taskId,task:t.task}),9,"working")}catch{}try{const P=(t.task||"").substring(0,200);await n.prepare("INSERT INTO pending_browser_tasks (user_id, task_id, task_description, thread_id, channel) VALUES (?, ?, ?, ?, ?)").bind(s,I.taskId,P,(y==null?void 0:y.threadId)??null,g).run()}catch{}return`[BROWSER_TIMEOUT:${I.taskId}] Browser task did not finish within the time limit. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}S&&b&&sn(S,b).catch(()=>{}),y&&(y.persistSession=!1),await R();const N=[I.error,I.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${I.taskId}\`): ${N||"No details returned."} | Operator hint: Check Browser Use dashboard — taskId=${I.taskId}`}catch(m){return await H(n,s,"browser","browser_task",m.message),`Browser task error: ${m.message}`}}case"browser_task_status":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured.";const b=await Z(m.encrypted_value,r),h=await lr(t.task_id,b);if(h.done){try{const f=new te(n),_=await f.search(s,`Browser task in progress: ${t.task_id}`);for(const S of _)await f.remove(S.id,s)}catch{}return h.status==="finished"||h.status==="completed"?h.output?h.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${h.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${h.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}catch(m){return await H(n,s,"browser","browser_task_status",m.message),`Browser status check error: ${m.message}`}}case"vault_lookup":try{const m=(t.site_name||"").trim();if(!m)return"No site name provided.";const h=((await n.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(s,`%${m}%`).all()).results||[]).map(f=>f.name);return h.length===0?`No vault entries found matching "${m}".`:`Vault entries matching "${m}": ${h.join(", ")}. Use site_name="${h[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const b=await Z(m.encrypted_value,r),h=await Ks(b,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((f,_)=>{const S=f.rating?` ★${f.rating} (${f.userRatingsTotal||0} reviews)`:"",k=f.openNow!==void 0?f.openNow?" · Open now":" · Closed":"",R=f.googleMapsUri?`
   ${f.googleMapsUri}`:"";return`${_+1}. **${f.name}**${S}${k}
   ${f.address}${R}
   [place_id: ${f.placeId}]`}).join(`

`)}catch(m){return await H(n,s,"google_api","search_places",m.message),`Places search error: ${m.message}`}}case"get_place_details":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const b=await Z(m.encrypted_value,r),h=await Ys(b,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const f=h.details;let _=`**${f.name}**
📍 ${f.address}`;if(f.phone&&(_+=`
📞 ${f.phone}`),f.website&&(_+=`
🌐 ${f.website}`),f.rating&&(_+=`
★ ${f.rating}`),f.googleMapsUri&&(_+=`
📌 ${f.googleMapsUri}`),f.openingHours&&(_+=`

Opening Hours:
${f.openingHours.join(`
`)}`),f.reviews&&f.reviews.length>0){_+=`

Recent Reviews:`;for(const S of f.reviews)_+=`
— ${S.author} (★${S.rating}, ${S.time}): "${S.text}"`}return _}catch(m){return await H(n,s,"google_api","place_details",m.message),`Place details error: ${m.message}`}}case"get_directions":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const b=await Z(m.encrypted_value,r),h=await Js(b,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const f=h.route;let _=`**${f.startAddress}** → **${f.endAddress}**
`;return _+=`📏 ${f.distance} · ⏱️ ${f.duration}`,f.durationInTraffic&&(_+=` (with traffic: ${f.durationInTraffic})`),_+=`
via ${f.summary}`,_+=`

Steps:`,f.steps.forEach((S,k)=>{_+=`
${k+1}. ${S.instruction} (${S.distance}, ${S.duration})`}),_}catch(m){return await H(n,s,"google_api","directions",m.message),`Directions error: ${m.message}`}}case"get_travel_time":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const b=await Z(m.encrypted_value,r),h=await er(b,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let f=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(f+=` (with traffic: ${h.durationInTraffic})`),f}catch(m){return await H(n,s,"google_api","travel_time",m.message),`Travel time error: ${m.message}`}}case"translate_text":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const b=await Z(m.encrypted_value,r),h=await Vs(b,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(m){return await H(n,s,"google_api","translate",m.message),`Translation error: ${m.message}`}}case"search_youtube":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const b=await Z(m.encrypted_value,r),h=await Xs(b,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((f,_)=>{var S;return`${_+1}. **${f.title}**
   ${f.channelTitle} · ${((S=f.publishedAt)==null?void 0:S.split("T")[0])||""}
   ${f.description}
   ${f.url}`}).join(`

`)}catch(m){return await H(n,s,"google_api","youtube_search",m.message),`YouTube search error: ${m.message}`}}case"geocode_address":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const b=await Z(m.encrypted_value,r),h=await Zs(b,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((f,_)=>`${_+1}. ${f.address}
   Coordinates: ${f.lat}, ${f.lng}`).join(`
`)}catch(m){return await H(n,s,"google_api","geocode",m.message),`Geocoding error: ${m.message}`}}case"parse_document":{const m=t.file_id,b=t.extract_focus;if(!m)return"file_id is required to parse a document.";const h=await n.prepare("SELECT file_name, file_type, file_data, file_size, extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(m,s).first();if(!h)return"File not found. The file may have expired or the file_id is incorrect.";if(h.extracted_text)return`Document: ${h.file_name}

${h.extracted_text}`;const{file_name:f,file_type:_}=h;let{file_data:S}=h;if(S==="r2"){if(!u)return`File "${f}" is stored in R2 but no storage bucket is configured.`;const k=await u.get(m);if(!k)return`File "${f}" not found in storage. It may have been deleted.`;const R=await k.arrayBuffer();S=Buffer.from(R).toString("base64")}if(_.startsWith("text/"))try{const k=Buffer.from(S,"base64").toString("utf-8");return`Document: ${f}

${k.substring(0,2e4)}`}catch{return`Could not decode text file: ${f}`}if(_==="application/pdf"||_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||f.toLowerCase().endsWith(".pdf")||f.toLowerCase().endsWith(".docx")){if(_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||f.toLowerCase().endsWith(".docx")){try{const $=await cr(Buffer.from(S,"base64"));if($.length>50){try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind($,m,s).run();const j=$.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(j,$.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const I=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(I){const{indexDocumentChunks:N}=await Promise.resolve().then(()=>ze);N({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,I.id,$).catch(()=>{})}}}catch{}return`Document: ${f}

${$.substring(0,2e4)}`}}catch{}return`Could not extract text from "${f}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let k=null,R="claude-haiku-4-5-20251001";for(const $ of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const j=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,$).first();if(j&&r){const I=await Z(j.encrypted_value,r),N=JSON.parse(I);if(N.provider==="anthropic"){k=N.apiKey,N.model&&(R=N.model);break}}}catch{}if(k)try{const $=b?`Focus specifically on extracting: ${b}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",j=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:R,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:S}},{type:"text",text:$}]}]})});if(j.ok){const N=((X=(K=(await j.json()).content)==null?void 0:K[0])==null?void 0:X.text)||"";if(N&&N.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(N,m,s).run();const P=N.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(P,N.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const M=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(M){const{indexDocumentChunks:W}=await Promise.resolve().then(()=>ze);W({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,M.id,N).catch(()=>{})}}}catch{}return`Document: ${f}

${N}`}else{const I=await j.text();return`Could not parse ${f} via Anthropic API: ${I.substring(0,200)}`}}catch($){return`Document parsing error for ${f}: ${$.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}if(_.startsWith("image/")){let k=null,R="claude-haiku-4-5-20251001";for(const j of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const I=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,j).first();if(I&&r){const N=await Z(I.encrypted_value,r),P=JSON.parse(N);if(P.provider==="anthropic"){k=P.apiKey,P.model&&(R=P.model);break}}}catch{}if(!k)return"To extract text from images, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set.";const $=b?`Focus specifically on: ${b}`:"Extract all visible text from this image. Include any text from signs, documents, screenshots, or diagrams. If the image contains charts or tables, describe their structure and data.";try{const j=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:R,max_tokens:4096,messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:_,data:S}},{type:"text",text:$}]}]})});if(j.ok){const N=((re=(z=(await j.json()).content)==null?void 0:z[0])==null?void 0:re.text)||"";if(N&&N.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(N,m,s).run();const P=N.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(P,N.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const M=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(M){const{indexDocumentChunks:W}=await Promise.resolve().then(()=>ze);W({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,M.id,N).catch(()=>{})}}}catch{}return`Document: ${f}

${N}`}else{const I=await j.text();return`Could not parse ${f} via Anthropic API: ${I.substring(0,200)}`}}catch(j){return`Image parsing error for ${f}: ${j.message}`}}try{const k=Buffer.from(S,"base64").toString("utf-8").substring(0,2e3);return`Document: ${f} (${_})

Content preview:
${k}`}catch{return`Cannot read file: ${f} (${_})`}}case"search_library":{const m=t.query,b=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!m)return"query is required for search_library.";if(p!=null&&p.ai&&(p!=null&&p.vectorize))try{const{semanticDocumentSearch:k}=await Promise.resolve().then(()=>ze),R=await k({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,m,b);if(R.length>0){const $=R.map(j=>`[id:${j.document_id}] "${j.filename}" (relevance: ${(j.relevance_score*100).toFixed(1)}%)
  Snippet: ${j.chunk.substring(0,350)}`).join(`
...
Use read_library_file with the id to get the full document text.`}}catch{}const h=await n.prepare(`
        ...
        LIMIT ?
      `).bind(s,`%${m}%`,`%${m}%`,`%${m}%`,b).all(),f=await n.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(s,s,`%${m}%`,s,`%${m}%`,`%${m}%`,`%${m}%`,b).all(),_=[...h.results||[],...f.results||[]].slice(0,b);if(_.length===0)return`No documents found matching "${m}" in your library.`;const S=_.map(k=>{const R=(k.summary||k.dl_extracted||"").substring(0,200);return`[id:${k.id}] "${k.name}" (source: ${k.source}, status: ${k.status})
...
Use read_library_file with the id to get full text.`}case"read_library_file":{const m=String(t.id_or_name||"").trim();if(!m)return"id_or_name is required for read_library_file.";const b=parseInt(m,10);let h=null;if(isNaN(b)||(h=await n.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           FROM document_library dl WHERE dl.id = ? AND dl.user_id = ?`).bind(b,s).first()),h||(h=await n.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           FROM document_library dl WHERE dl.user_id = ? AND dl.name LIKE ? LIMIT 1`).bind(s,`%${m}%`).first()),!h)return`Document "${m}" not found. Use search_library to find available documents.`;let f=h.extracted_text||null;if(!f&&h.file_id){const _=await n.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(h.file_id,s).first();f=(_==null?void 0:_.extracted_text)||null}return f||(f=h.summary||null),f?`Document: ${h.name}

${f.substring(0,2e4)}`:`Document "${h.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${h.file_id}") to extract the text first.`}case"create_skill":{const m=(ce=t.name)==null?void 0:ce.trim(),b=(q=t.description)==null?void 0:q.trim(),h=(Q=t.instructions)==null?void 0:Q.trim();if(!m||!b||!h)return"create_skill requires name, description, and instructions.";let f=m.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");f||(f=`skill_${Date.now()}`);const _=await n.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(s,`${f}%`).all();(le=_.results)!=null&&le.some($=>$.slug===f)&&(f=`${f}_${(((U=_.results)==null?void 0:U.length)||0)+1}`);const S=JSON.stringify(t.parameters||{}),k=JSON.stringify(t.required_tools||[]),R=JSON.stringify(t.examples||[]);return await n.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,m,f,b,h,S,k,R).run(),`Skill created: **${m}** (invoke as: "${f}")

You can now ask me to run "${m}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${m} skill" to execute it.`}case"list_skills":{const b=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",f=(await n.prepare(b).bind(s).all()).results||[];if(f.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const _=f.map(S=>`• **${S.name}** (${S.slug}): ${S.description} [used ${S.usage_count} times${S.enabled?"":" — disabled"}]`).join(`
`);return`Your custom skills (${f.length}):

${_}`}default:{const m=e,b=await n.prepare("SELECT id, name, description, instructions, required_tools FROM user_skills WHERE user_id = ? AND slug = ? AND enabled = 1").bind(s,m).first();if(b){await n.prepare("UPDATE user_skills SET usage_count = usage_count + 1, last_used_at = CURRENT_TIMESTAMP WHERE id = ?").bind(b.id).run();const h=(()=>{try{return JSON.parse(b.required_tools).join(", ")}catch{return""}})(),f=Object.keys(t).length>0?`

Inputs provided: ${JSON.stringify(t)}`:"";return`[SKILL: ${b.name}] Follow these instructions exactly:

${b.instructions}${f}

${h?`Tools to use: ${h}`:""}

Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function Nr(e,t,n,s,r){if(t.length>0&&t[t.length-1].role==="user"){const a="(Previous request did not complete. Please try again.)";await e.storeMessage(n,s,"assistant",a,"{}",r),t.push({id:-1,user_id:n,channel:s,role:"assistant",content:a,metadata:"{}",token_estimate:a.length,created_at:new Date().toISOString()})}}function Cr(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const n=typeof e[t].content=="string"?e[t].content:"";n.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(n.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function Xn(e,t,n,s,r,a,i){var re,ce,q,Q,le;const o=new te(t),l=(re=e.metadata)==null?void 0:re.thread_id,c=Date.now(),[d,u,p]=await Promise.all([o.buildContext(s.id),Ln(t,s.id),vr(t,s.id)]),g=await o.getRecentConversations(s.id,30,l);await Nr(o,g,s.id,e.channel,l);const y=Dr(s,d,e.channel,u,p),w=Cn(g),v=kr([{role:"system",content:y},...Nn(g),{role:"user",content:e.text}]);xr(v,w),Cr(v);const E=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],T=(d.match(/^- /gm)||[]).length;if(E.some(U=>U.test(e.text))||T<3)try{const U=await o.searchLongTerm(s.id,e.text,5);if(U.length>0){const m=U.map(b=>`- [${b.type}] ${b.title}: ${b.content}`).join(`
`);v.splice(v.length-1,0,{role:"assistant",content:"I retrieved some relevant context from your long-term memory."},{role:"user",content:`[Long-term memory retrieved for this query:
${m}]`})}}catch{}await o.storeMessage(s.id,e.channel,"user",e.text,"{}",l);const O=(i==null?void 0:i.maxTurns)??10,L=(i==null?void 0:i.tools)??await An(t,s.id);let A="",F=0;const Y=[];let ee,ae=0,C=0;const K={hasActiveTask:!1,persistSession:!1,threadId:l,channel:e.channel};for(let U=0;U<O;U++){ae=U+1;try{U>0&&Ir(v);const m=await n.chat(v,{tools:L,toolChoice:U===0&&(i!=null&&i.forceToolUseOnFirstTurn)?"required":void 0});if(m.usage&&(F+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){const b=m.content||"(tools executed)";v.push({role:"assistant",content:b});for(const f of m.toolCalls)Y.push(f.name);const h=await Promise.all(m.toolCalls.map(async f=>{try{const _=await Lt(f.name,f.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},K);ee=Sr(f.name,f.arguments,_,ee);const S=["parse_document","drive_read_file","read_library_file"].includes(f.name)?2e4:8e3,k=_.length>S?_.substring(0,S)+`
[...result truncated to prevent token limit — full content was extracted]`:_;return`[Tool Result for ${f.name}]: ${k}`}catch(_){return C++,await H(t,s.id,"tool",f.name,_.message||"Tool execution failed"),`[Tool Error for ${f.name}]: ${_.message||"Execution failed"}`}}));v.push({role:"user",content:h.join(`

`)});continue}A=m.content;break}catch(m){if(r){const b=m.message||"",h=b.includes("401")||b.includes("403")||b.includes("authentication")||b.includes("credit balance"),f=b.includes("429"),_=h?1440:f?10:5;await r.recordError(n.name,b,_)}throw await H(t,s.id,"llm","provider_error",m.message||"Unknown LLM error",{provider:n.name,turn:U}),m}}if(A=(A==null?void 0:A.trim())??"",!A)try{((ce=v[v.length-1])==null?void 0:ce.role)==="user"&&v.push({role:"assistant",content:"[gathering results]"}),v.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),A=(await n.chat(v,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me directly and I will answer from my knowledge."}catch{A="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge."}if(r&&F>0)try{await r.recordUsage(n.name,F)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"full",F,Date.now()-c,1,e.channel).run()}catch{}const X=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your|the)\s+(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const U of X){const m=U.claimPattern.test(A),b=U.requiredTools.some(h=>Y.includes(h));if(m&&!b){try{await H(t,s.id,"llm",U.logType,"LLM claimed action without tool call",{response:A.substring(0,200)}),v.push({role:"assistant",content:A}),v.push({role:"user",content:U.enforcementMsg});const h=await n.chat(v,{tools:L.filter(f=>U.requiredTools.includes(f.name)),temperature:0});if((q=h.toolCalls)!=null&&q.length){for(const _ of h.toolCalls){const S=await Lt(_.name,_.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});Y.push(_.name),v.push({role:"assistant",content:"",toolCalls:h.toolCalls}),v.push({role:"user",content:S})}const f=await n.chat(v,{tools:[]});f.content&&(A=f.content)}else A="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}let z=A.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").trim();if(!z&&Y.length>0){const U=[...new Set(Y)].join(", ");try{((Q=v[v.length-1])==null?void 0:Q.role)==="user"&&v.push({role:"assistant",content:"[completed tools]"}),v.push({role:"user",content:"Please summarise what you just did and provide the result to the user."}),z=((le=(await n.chat(v,{tools:[]})).content)==null?void 0:le.trim())||`Done. I used the following tools: ${U}.`}catch{z=`Done. I used the following tools: ${U}.`}}await o.storeMessage(s.id,e.channel,"assistant",Zt(z),Er(Y,ee),l);try{const U=await t.prepare("SELECT COUNT(*) as c FROM conversations WHERE user_id = ? AND role = ?").bind(s.id,"assistant").first();U&&U.c%5===0&&U.c>0&&await Promise.race([Qi(t,n,s,o,v),new Promise(m=>setTimeout(m,5e3))])}catch{}return Y.length>=3&&Promise.race([yr(t,n,s,e.text,Y,ae,C===0),new Promise(U=>setTimeout(U,6e3))]).catch(()=>{}),K.sessionId&&K.apiKey&&!K.hasActiveTask&&!K.persistSession&&sn(K.sessionId,K.apiKey).catch(()=>{}),z}async function Qi(e,t,n,s,r){var d;const a=r.filter(u=>u.role!=="system").slice(-10);if(a.length<4)return;const o=[{role:"system",content:`Review this conversation and extract any information worth remembering long-term.
...
`)){const p=u.trim().split("|");if(p.length<4)continue;const[g,y,w,v]=p,E=["fact","preference","context","decision","summary","task"].find(D=>D===g.trim().toLowerCase());if(!E||!(y!=null&&y.trim())||!(w!=null&&w.trim()))continue;const T=Math.min(10,Math.max(1,parseInt(v)||5));await s.store(n.id,E,y.trim(),w.trim(),T,"long_term")}}const Qn={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function eo(e){for(const[t,n]of Object.entries(Qn))if(e.toLowerCase().includes(t.toLowerCase()))return n;return Qn.default}function to(e,t,n,s){const r=eo(s),a=Math.floor(r*.75),i=[];let o=0,l=!1;const c=pn(e);i.push({role:"system",content:e}),o+=c;const d=pn(n);o+=d;const u=a-o,p=[];let g=0;for(let y=t.length-1;y>=0;y--){const w=t[y],v=pn(w.content);if(g+v<=u)p.unshift({role:w.role,content:w.content}),g+=v;else{l=!0;break}}return i.push(...p),i.push({role:"user",content:n}),o+=g,{maxTokens:r,usedTokens:o,messages:i,wasTruncated:l}}async function*no(e,t,n,s,r,a){var z,re,ce;const i=new te(t),o=(z=e.metadata)==null?void 0:z.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:n.name}};const[c,d,u]=await Promise.all([i.buildContext(s.id),Ln(t,s.id),vr(t,s.id)]),p=await i.getRecentConversations(s.id,30,o);await Nr(i,p,s.id,e.channel,o);const g=Dr(s,c,e.channel,d,u),y=Cn(p),w=Nn(p);let v=e.text;y&&(v=`${_n}

${e.text}`);const E=to(g,w.map(q=>({role:q.role,content:q.content})),v,n.name);await i.storeMessage(s.id,e.channel,"user",e.text,"{}",o);const T=await An(t,s.id),D=10;let O="",L=0;const A=[...E.messages],F=[];let Y,ee=0,ae=0;const C={hasActiveTask:!1,persistSession:!1,threadId:o,channel:e.channel};Cr(A);const K=()=>Er(F,Y);for(let q=0;q<D;q++){ee=q+1;try{q>0&&(yield{type:"thinking",data:{threadId:o}},Ir(A));const Q=await n.chat(A,{tools:T});if(Q.usage&&(L+=Q.usage.promptTokens+Q.usage.completionTokens),Q.toolCalls&&Q.toolCalls.length>0){const m=((re=Q.content)==null?void 0:re.trim())??"";m&&m.length<=150&&!/^\[calling:/i.test(m)&&(yield{type:"chunk",data:{text:Q.content,threadId:o}});const b=Q.content||"(tools executed)";A.push({role:"assistant",content:b});const h=[];for(const f of Q.toolCalls){yield{type:"tool_start",data:{tool:f.name,toolArgs:f.arguments,threadId:o}},F.push(f.name);try{const _=(j,I)=>Lt(j,I,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},C);let S;if(f.name==="browser_task"||f.name==="browser_task_status"){if(f.name==="browser_task"){const M=f.arguments.site_name;yield{type:"browser_ack",data:{message:M?`Starting now — opening ${M} in a browser. I'll notify you when done.`:"Starting now — running browser task. I'll notify you when done.",startedAt:new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:s.timezone||"UTC"}),threadId:o}}}const I=["Still working — browser launched, navigating to site...","Still working — page loaded, scanning for content...","Still working — reading and extracting results...","Still working — almost there, finalising output...","Taking a bit longer — site may require extra steps...","Still running — browser is working through the page...","Continuing — extracting and processing data...","Still going — complex task, nearly there...","Almost done — wrapping up the browser session...","Still running — holding on a little longer...","Browser is still active — this one is taking time...","Patience — still working through the task...","Still running — will have a result for you shortly..."],N=_(f.name,f.arguments);let P=0;e:for(;;){const M=await Promise.race([N.then(W=>({done:!0,r:W})),new Promise(W=>setTimeout(()=>W({done:!1}),15e3))]);if(M.done){S=M.r;break e}f.name==="browser_task"?yield{type:"browser_progress",data:{message:I[Math.min(P,I.length-1)],elapsed_s:(P+1)*15,threadId:o}}:yield{type:"thinking",data:{threadId:o}},P++}if(f.name==="browser_task"){const M=S.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(M){yield{type:"browser_progress",data:{message:"Task still running — checking final status...",threadId:o}};const W=_("browser_task_status",{task_id:M[1]});e:for(;;){const ne=await Promise.race([W.then(J=>({done:!0,r:J})),new Promise(J=>setTimeout(()=>J({done:!1}),15e3))]);if(ne.done){S=ne.r;break e}yield{type:"thinking",data:{threadId:o}}}if(!S.startsWith("[still-running]")&&!S.startsWith("[NO-OUTPUT]")&&!S.startsWith("Browser"))try{await t.prepare("DELETE FROM pending_browser_tasks WHERE user_id = ? AND task_id = ? AND notified = 0").bind(s.id,M[1]).run()}catch{}}}}else S=await _(f.name,f.arguments);let k=S;(f.name==="browser_task"||f.name==="browser_task_status")&&(/^\[BROWSER_TIMEOUT:/.test(k)?k="Task timed out — still running in background.":/^\[NO-OUTPUT\]/.test(k)?k="Browser task finished but returned no content.":/^\[still-running\]/.test(k)?k="Still running — will notify when done.":k=k.replace(/\s*\|\s*Operator hint:.*$/s,"")),yield{type:"tool_end",data:{tool:f.name,toolResult:k.substring(0,500)+(k.length>500?"...":""),threadId:o}};const R=["parse_document","drive_read_file","read_library_file"].includes(f.name)?2e4:8e3,$=S.length>R?S.substring(0,R)+`
[...result truncated to prevent token limit — full content was extracted]`:S;Y=Sr(f.name,f.arguments,S,Y),h.push(`[Tool Result for ${f.name}]: ${$}`)}catch(_){ae++,await H(t,s.id,"tool",f.name,_.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:f.name,toolResult:`Error: ${_.message||"Execution failed"}`,threadId:o}},h.push(`[Tool Error for ${f.name}]: ${_.message||"Execution failed"}`)}}A.push({role:"user",content:h.join(`

`)});continue}O=Q.content;const le=Zt(O);await i.storeMessage(s.id,e.channel,"assistant",le,K(),o);const U=50;for(let m=0;m<le.length;m+=U)yield{type:"chunk",data:{text:le.substring(m,m+U),threadId:o}},m+U<le.length&&await new Promise(h=>setTimeout(h,10));break}catch(Q){if(r){const m=Q.message||"",b=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),h=m.includes("429"),f=b?1440:h?10:5;await r.recordError(n.name,m,f)}await H(t,s.id,"llm","provider_error",Q.message||"Unknown LLM error",{provider:n.name,turn:q});const le=Q.message||"An error occurred",U=le.includes("429")||le.toLowerCase().includes("rate limit")||le.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":le;try{await i.storeMessage(s.id,e.channel,"assistant",`⚠️ ${U}`,"{}",o)}catch{}yield{type:"error",data:{error:U,threadId:o}};return}}if(O=(O==null?void 0:O.trim())??"",!O)try{A.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),O=(await n.chat(A,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const Q=Zt(O);await i.storeMessage(s.id,e.channel,"assistant",Q,K(),o);const le=50;for(let U=0;U<Q.length;U+=le)yield{type:"chunk",data:{text:Q.substring(U,U+le),threadId:o}},U+le<Q.length&&await new Promise(m=>setTimeout(m,10))}catch{O="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(s.id,e.channel,"assistant",O,K(),o).catch(()=>{}),yield{type:"chunk",data:{text:O,threadId:o}}}if(r&&L>0)try{await r.recordUsage(n.name,L)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"full",L,Date.now()-l,1,e.channel).run()}catch{}const X=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const q of X){const Q=q.claimPattern.test(O),le=q.requiredTools.some(U=>F.includes(U));if(Q&&!le){try{await H(t,s.id,"llm",q.logType,"LLM claimed action without tool call (streaming)",{response:O.substring(0,200)}),A.push({role:"assistant",content:O}),A.push({role:"user",content:q.enforcementMsg});const U=await n.chat(A,{tools:T.filter(m=>q.requiredTools.includes(m.name)),temperature:0});if((ce=U.toolCalls)!=null&&ce.length){for(const b of U.toolCalls){const h=await Lt(b.name,b.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});F.push(b.name),A.push({role:"assistant",content:"",toolCalls:U.toolCalls}),A.push({role:"user",content:h})}const m=await n.chat(A,{tools:[]});m.content&&(O=m.content)}else O="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}F.length>=3&&Promise.race([yr(t,n,s,e.text,F,ee,ae===0),new Promise(q=>setTimeout(q,6e3))]).catch(()=>{}),C.sessionId&&C.apiKey&&!C.hasActiveTask&&!C.persistSession&&sn(C.sessionId,C.apiKey).catch(()=>{}),yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:L}}}async function es(e,t,n,s,r,a,i,o){await a.storeMessage(r.id,t.channel,"user",t.text,"{}",o);const l=await Lt(e.tool,e.args,n,r.id,{agentType:"direct",channel:t.channel},r.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,r.timezone,s,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),c=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await a.storeMessage(r.id,t.channel,"assistant",c,"{}",o),l}async function Mn(e,t,n,s,r,a){var w;const i=new te(t),o=(w=e.metadata)==null?void 0:w.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Rn(e.text,l,Tr(c));if(d.agent==="conversation")return Ar(e,t,n,s,l,r,o);const u=ur(e.text);if(u)return es(u,e,t,n,s,i,a,o);const p=(await i.getRecentConversations(s.id,10,o)).map(v=>v.content).join(`
`),g=mr(e.text,p);if(g)return es(g,e,t,n,s,i,a,o);const y=d.confidence>=.85;if(e.channel==="telegram"){const v=await An(t,s.id);return Xn(e,t,n,s,r,a,{maxTurns:10,tools:v,forceToolUseOnFirstTurn:y})}return Xn(e,t,n,s,r,a,{forceToolUseOnFirstTurn:y})}async function Ar(e,t,n,s,r,a,i){const o=new te(t),l=Date.now(),c=Rr(s.timezone),d=await Ln(t,s.id),u=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${r}`:r,p=pr("conversation",s,u,s.timezone,c,e.channel),g=(await o.getRecentConversations(s.id,30,i)).filter(D=>!D.content.startsWith("[Autonomous Scheduled Task]")&&!D.content.startsWith("[Scheduled Reminder]")),y=Cn(g),w=kr([{role:"system",content:p},...Nn(g),{role:"user",content:e.text}]);xr(w,y),await o.storeMessage(s.id,e.channel,"user",e.text,"{}",i);let v=0,E="";try{const D=await n.chat(w,{temperature:.8});D.usage&&(v=D.usage.promptTokens+D.usage.completionTokens),E=D.content}catch(D){if(a){const O=D.message||"",L=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),A=O.includes("429"),F=L?1440:A?10:5;await a.recordError(n.name,O,F)}throw await H(t,s.id,"llm","conversation_error",D.message,{provider:n.name}),D}if(a&&v>0)try{await a.recordUsage(n.name,v)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"conversation",v,Date.now()-l,1,e.channel).run()}catch{}const T=Zt(E);return await o.storeMessage(s.id,e.channel,"assistant",T,"{}",i),T}async function*so(e,t,n,s,r,a){var u;const i=new te(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Rn(e.text,l,Tr(c));if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){yield*no(e,t,n,s,r,a);return}try{const p=await Ar(e,t,n,s,l,r,o),g=50;for(let y=0;y<p.length;y+=g)yield{type:"chunk",data:{text:p.substring(y,y+g),threadId:o}},y+g<p.length&&await new Promise(w=>setTimeout(w,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const de=new Ee;async function ro(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,role:s.role,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}de.use("/*",ro);de.get("/threads",async e=>{const t=e.get("user"),n=e.req.query("archived")==="1",s=parseInt(e.req.query("limit")||"30"),r=await e.env.DB.prepare(`SELECT t.*, 
     ...
     LIMIT ?`).bind(t.id,n?1:0,s).all();return e.json({threads:r.results||[]})});de.post("/threads",async e=>{const t=e.get("user"),{title:n}=await e.req.json(),s=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n||"New conversation").first();return e.json({thread:s})});de.put("/threads/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.req.json(),r=[],a=[];return s.title!==void 0&&(r.push("title = ?"),a.push(s.title)),s.is_archived!==void 0&&(r.push("is_archived = ?"),a.push(s.is_archived?1:0)),r.push("updated_at = CURRENT_TIMESTAMP"),a.push(n,t.id),r.length<=1?e.json({error:"Nothing to update"},400):(await e.env.DB.prepare(`UPDATE threads SET ${r.join(", ")} WHERE id = ? AND user_id = ?`).bind(...a).run(),e.json({success:!0}))});de.delete("/threads/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM conversations WHERE thread_id = ? AND user_id = ?").bind(n,t.id).run(),await e.env.DB.prepare("DELETE FROM threads WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});de.post("/upload",async e=>{const t=e.get("user"),n=!!e.env.DOCUMENTS_BUCKET,s=n?100*1024*1024:700*1024;let r,a,i,o=null,l=null;try{if((e.req.header("Content-Type")||"").includes("multipart/form-data")){const v=(await e.req.formData()).get("file");if(!v)return e.json({error:"No file provided."},400);if(r=v.name,a=v.type||"application/octet-stream",i=v.size,i>s)return e.json({error:`File too large (max ${n?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);o=await v.arrayBuffer()}else{const w=await e.req.json();if(!w.file_name||!w.file_data)return e.json({error:"file_name and file_data are required."},400);if(r=w.file_name,a=w.file_type||"application/octet-stream",l=w.file_data,i=w.file_size||Math.round(l.length*.75),i>s)return e.json({error:`File too large (max ${n?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);if(n){const v=atob(l);o=new ArrayBuffer(v.length);const E=new Uint8Array(o);for(let T=0;T<v.length;T++)E[T]=v.charCodeAt(T)}}const d=crypto.randomUUID();let u;n&&o?(await e.env.DOCUMENTS_BUCKET.put(d,o,{httpMetadata:{contentType:a},customMetadata:{fileName:r,userId:String(t.id)}}),u="r2"):u=l||(o?Buffer.from(o).toString("base64"):""),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(d,t.id,r,a,u,i).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,d,"upload",r,a,i,"uploaded").run();const p=a==="application/pdf"||r.toLowerCase().endsWith(".pdf"),g=a==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||r.toLowerCase().endsWith(".docx");if(g)try{const{extractDocxTextFromBuffer:w}=await Promise.resolve().then(()=>dr),v=l?Buffer.from(l,"base64"):o?Buffer.from(o):null;if(v){const E=await w(v);if(E.length>50){await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(E,d).run();const T=E.substring(0,600);await e.env.DB.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(T,E.substring(0,5e4),d,t.id).run()}}}catch{}if(p&&t.pin_hash){const w=l||(o?Buffer.from(o).toString("base64"):null),v=t.pin_hash,E=t.id,T=e.env.DB,D=e.env.DOCUMENTS_BUCKET,O=(async()=>{var L,A;try{let F=null,Y="claude-haiku-4-5-20251001";const{decrypt:ee}=await Promise.resolve().then(()=>tn);for(const z of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const re=await T.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(E,z).first();if(re){const ce=await ee(re.encrypted_value,v),q=JSON.parse(ce);if(q.provider==="anthropic"){F=q.apiKey,q.model&&(Y=q.model);break}}}catch{}if(!F)return;let ae;if(u==="r2"&&D){const z=await D.get(d);if(!z)return;ae=Buffer.from(await z.arrayBuffer()).toString("base64")}else if(w)ae=w;else return;const C=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":F,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:Y,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ae}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!C.ok)return;const X=((A=(L=(await C.json()).content)==null?void 0:L[0])==null?void 0:A.text)||"";if(X){await T.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(X,d).run();const z=X.substring(0,600);await T.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(z,X.substring(0,5e4),d,E).run()}}catch{}})();try{e.executionCtx.waitUntil(O)}catch{}}let y="";if(a.startsWith("text/"))try{const w=l||(o?Buffer.from(o).toString("base64"):"");y=Buffer.from(w,"base64").toString("utf-8").substring(0,500)}catch{}return e.json({file_id:d,name:r,type:a,size:i,text_preview:y,storage:n?"r2":"d1",extracting:p&&!g})}catch(c){console.error("File upload error:",c);try{const{logError:d}=await Promise.resolve().then(()=>yt);await d(e.env.DB,t.id,"upload","upload_error",c.message||"Unknown upload error")}catch{}return e.json({error:`Upload failed: ${c.message||"Unknown error"}`},500)}});de.post("/send",async e=>{const t=e.get("user"),{message:n,channel:s="web",thread_id:r,files:a}=await e.req.json();if(!n||typeof n!="string"||n.trim().length===0)return e.json({error:"Message is required"},400);let i="";if(a&&Array.isArray(a)&&a.length>0){i=`
...
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=r;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:s,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Je(e.env.DB,t.id,t.pin_hash),u=new ReadableStream({async start(p){const g=new TextEncoder;try{const y=so(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const w of y)w.data.threadId||(w.data.threadId=o),p.enqueue(g.encode(ts(w)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),p.close()}catch(y){const w={type:"error",data:{error:y.message||"An error occurred",threadId:o}};p.enqueue(g.encode(ts(w))),p.close()}}});return new Response(u,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});de.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(r).all(),i=[];for(const o of a.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(r,o.id).run();const l=o.user_timezone||"UTC";let c,d=!1,u=o.state||"active";if(o.schedule_type==="interval"){const y=parseInt(o.schedule_value,10);c=new Date(s.getTime()+y*60*1e3)}else if(o.schedule_type==="daily"){const[y,w]=o.schedule_value.split(":").map(Number),v=ns(l),E=new Date(v);E.setHours(y,w,0,0),E<=v&&E.setDate(E.getDate()+1);const T=new Date(E.toLocaleString("en-US",{timeZone:"UTC"})),D=new Date(E.toLocaleString("en-US",{timeZone:l})),O=T.getTime()-D.getTime();c=new Date(E.getTime()+O)}else if(o.schedule_type==="weekly"){const[y,w]=o.schedule_value.split(" "),[v,E]=(w||"00:00").split(":").map(Number),D=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ae=>ae.toLowerCase()===y.toLowerCase()),O=ns(l),L=new Date(O);L.setHours(v,E,0,0);let A=(D-L.getDay()+7)%7;A===0&&L<=O&&(A=7),L.setDate(L.getDate()+A);const F=new Date(L.toLocaleString("en-US",{timeZone:"UTC"})),Y=new Date(L.toLocaleString("en-US",{timeZone:l})),ee=F.getTime()-Y.getTime();c=new Date(L.getTime()+ee)}else o.schedule_type==="once"?(d=!0,u="completed",c=new Date(s.getTime()+365*24*60*60*1e3)):c=new Date(s.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,c.toISOString(),d?0:o.enabled,u,o.id).run();const g=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:g,next_run:c.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}try{const{MemoryService:o}=await Promise.resolve().then(()=>ni),l=await e.env.DB.prepare("SELECT id FROM users").all();for(const c of l.results||[])await new o(e.env.DB).cleanupDoneTasks(c.id)}catch{}return e.json({executed:i.length,results:i,timestamp:r})});Oe.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);const s=parseInt(e.req.param("jobId"),10);if(!s)return e.json({error:"Invalid job ID"},400);const r=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(s).first();if(!r)return e.json({error:"Job not found"},404);const i=JSON.parse(r.action_config||"{}").description||r.description||"",o="⏰ "+(r.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=r.action_type==="reminder",u=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&r.action_type==="custom"&&u.test(i),d)c=i||r.name||"Time for your scheduled task.";else try{const E={id:r.user_id,username:r.username||"user",name:r.user_name||"User",pin_hash:r.pin_hash||"",role:r.user_role||"",personality_prompt:r.personality_prompt||"",telegram_chat_id:r.telegram_chat_id||"",timezone:r.user_timezone||"UTC",assistant_name:r.assistant_name||"Karna",created_at:"",updated_at:""},T={userId:r.user_id,username:E.username,channel:"cron",text:io(r.name,i,r.action_type,r.schedule_type),sessionId:"cron-"+r.id,timestamp:l},{provider:D,rotation:O}=await Je(e.env.DB,r.user_id,r.pin_hash);c=await Mn(T,e.env.DB,D,E,O,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(E){const T=E.message||"unknown error",D=T.includes("rate_limit")||T.includes("429")||T.includes("quota"),O=T.includes("timeout")||T.includes("Timeout");D?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":O?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await H(e.env.DB,r.user_id,"cron_agent","execution_error",T,{job_id:r.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(r.action_type))try{const E=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(r.user_id).first();(!E||E.cnt===0)&&await H(e.env.DB,r.user_id,"cron_verification","no_tools_called",`Cron job "${r.name}" (${r.action_type}) completed without any tool calls`,{job_id:r.id,action_type:r.action_type,response_preview:c.substring(0,200)})}catch{}let g=c||i||"Time for your scheduled task.";g=g.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const y=o+`
`+g,w=await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0) RETURNING id").bind(r.user_id,"reminder",o,g,"cron:"+r.id).first(),v=w==null?void 0:w.id;return d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(r.user_id,"system","assistant",y,JSON.stringify({type:"cron",job_id:r.id})).run(),r.telegram_chat_id&&await Lr(e.env.DB,r.user_id,r.telegram_chat_id,y,v),e.json({job_id:s,status:"completed",response_length:c.length})});async function Mr(e){var s;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return null;const n=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(n==null?void 0:n.user_id)||null}Oe.get("/health/tools",async e=>{var n;const t=await Mr(e);if(!t)return e.json({error:"Not authenticated"},401);try{const s=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function io(e,t,n,s){return n==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:n==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
CRITICAL SAFETY RULE: This is a RECURRING scheduled task. You MUST NOT call gmail_send or gmail_draft — sending emails on every cron tick spams recipients. Report findings as text only.`:""}${Ot}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${Ot}`}Oe.post("/cron/check-browser-tasks",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);let s=0,r=0;try{const a=await e.env.DB.prepare(`SELECT pbt.id, pbt.user_id, pbt.task_id, pbt.task_description,
       ...
       LIMIT 10`).all();for(const i of a.results||[]){s++;try{const o=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'browser_use_api_key'").bind(i.user_id).first();if(!o)continue;const l=(await Z(o.encrypted_value,i.pin_hash)).trim(),c=await lr(i.task_id,l,{waitMs:8e3});if(!c.done)continue;const d=i.task_description?`"${i.task_description.substring(0,80)}${i.task_description.length>80?"...":""}"`:"Your browser task";let u,p;if(c.status==="finished"&&c.output?(u="Browser task completed",p=`${d} finished.

${c.output.substring(0,500)}${c.output.length>500?"...":""}`):c.status==="finished"?(u="Browser task completed (no output)",p=`${d} finished, but the browser returned no readable content. You may want to retry.`):(u="Browser task ended",p=`${d} ended with status "${c.status}". Check the browser dashboard for details.`),i.thread_id){const g=c.status==="finished"&&c.output?c.output.substring(0,8e3):p,y=Math.ceil(g.length/4);try{await e.env.DB.prepare(`INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id)
               VALUES (?, ?, 'assistant', ?, '{}', ?, ?)`).bind(i.user_id,i.channel||"web",g,y,i.thread_id).run()}catch{}}try{await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, 'info', ?, ?, ?, 0)").bind(i.user_id,u,p,`browser_task:${i.task_id}`).run()}catch{}i.telegram_chat_id&&await Lr(e.env.DB,i.user_id,i.telegram_chat_id,`*${u}*
...
${p}`),await e.env.DB.prepare("UPDATE pending_browser_tasks SET notified = 1 WHERE id = ?").bind(i.id).run(),r++,await new Promise(g=>setTimeout(g,200))}catch{}}}catch{}return e.json({checked:s,notified:r})});Oe.get("/scorecard/weekly",async e=>{var u;const t=(u=e.req.header("Authorization"))==null?void 0:u.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=n.user_id,r=new Date(Date.now()-10080*60*1e3).toISOString(),[a,i,o]=await Promise.all([e.env.DB.prepare(`SELECT COUNT(*) as total,
       ...
       FROM conversations
       WHERE user_id = ? AND role = 'assistant' AND created_at >= ? AND (content LIKE '%[S1]%' OR content LIKE '%source%')`).bind(s,r).first()]),l=Number((a==null?void 0:a.total)||0),c=Number((a==null?void 0:a.success_count)||0),d=l?c/l:0;return e.json({window:"7d",task_success_rate:Number(d.toFixed(3)),groundedness_rate_hint:Number((Number((o==null?void 0:o.cited_responses)||0)/Math.max(1,l)).toFixed(3)),avg_latency_ms:Math.round(Number((a==null?void 0:a.avg_latency)||0)),p95_latency_hint_ms:Math.round(Number((a==null?void 0:a.p95_latency_hint)||0)),fallback_frequency_hint:Number((Number((i==null?void 0:i.retry_count)||0)/Math.max(1,l)).toFixed(3)),totals:{total_tool_calls:l,successful_tool_calls:c}})});function oo(e,t,n,s){return{userId:e,username:t,channel:"telegram",text:n,sessionId:`telegram-${s}`,timestamp:new Date().toISOString()}}function lo(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const co=["llm_slot_1","llm_slot_2","llm_slot_3"],uo=["openai","groq"];function ss(e,t){const n=t==null?void 0:t.trim();if(!n)return null;const s=e.trim().toLowerCase();return s==="openai"?{url:"https://api.openai.com/v1/audio/transcriptions",apiKey:n,model:"whisper-1"}:s==="groq"?{url:"https://api.groq.com/openai/v1/audio/transcriptions",apiKey:n,model:"whisper-large-v3"}:null}function mo(e){var t,n;return((t=e.apiKey)==null?void 0:t.trim())||((n=e.api_key)==null?void 0:n.trim())}async function po(e,t,n){for(const s of co){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await Z(r.encrypted_value,n),i=JSON.parse(a),o=mo(i);if(i.provider&&o){const l=ss(i.provider,o);if(l)return l}}catch(a){console.error(`[telegram stt] Failed to load ${s}:`,a)}}for(const s of uo){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await Z(r.encrypted_value,n),i=ss(s,a);if(i)return i}catch(a){console.error(`[telegram stt] Failed to load legacy ${s}:`,a)}}return null}const $r=["message","callback_query"],ho=4e3,go=1e4,fo=3e4;async function Re(e,t={}){const n=new AbortController,s=setTimeout(()=>n.abort(),go);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function rs(e){const t=new AbortController,n=setTimeout(()=>t.abort(),fo);try{return await fetch(e,{signal:t.signal})}finally{clearTimeout(n)}}async function ie(e,t,n,s="Markdown",r,a){var c,d;const i=vo(n,ho),o=[];let l=!0;for(let u=0;u<i.length;u++){const p=i[u];let g=!1,y="";for(let w=0;w<3;w++)try{const v=await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p,parse_mode:s,disable_web_page_preview:!1})});if(v.ok){g=!0;break}const E=await v.json().catch(()=>null);if(y=`HTTP ${v.status}: ${(E==null?void 0:E.description)||"Unknown error"}`,(c=E==null?void 0:E.description)!=null&&c.includes("parse")||(d=E==null?void 0:E.description)!=null&&d.includes("entities")){if((await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p})})).ok){g=!0;break}y+=" (plain-text retry also failed)"}if(v.status===429||v.status>=500){const T=Math.pow(2,w)*1e3;await new Promise(D=>setTimeout(D,T));continue}break}catch(v){if(y=`Network error: ${v.message}`,w<2){const E=Math.pow(2,w)*1e3;await new Promise(T=>setTimeout(T,E));continue}}g||(l=!1,o.push(`Chunk ${u+1}/${i.length}: ${y}`))}if(!l&&r&&a&&o.length>0)try{const{logError:u}=await Promise.resolve().then(()=>yt);await u(r,a,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function yo(e,t){try{await Re(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function vo(e,t){if(e.length<=t)return[e];const n=[];let s=e;for(;s.length>0;){if(s.length<=t){n.push(s);break}let r=s.lastIndexOf(`
`,t);r<t*.3&&(r=s.lastIndexOf(" ",t)),r<t*.3&&(r=t),n.push(s.substring(0,r)),s=s.substring(r).trimStart()}return n}function wo(e){const t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`}async function bo(e,t,n){const r={reminder:"⏰",mail:"✉️",calendar:"📅",error:"⚠️",system:"⚙️"}[n.type]||"🔔",a={daily:"📅 Daily",weekly:"📅 Weekly",once:"✓ Once"},i=n.schedule_type?` · _${a[n.schedule_type]||"⏱ Repeating"}_`:"",o=n.body?`
`+n.body.substring(0,150)+(n.body.length>150?"…":""):"",l=`${r} *${n.title}*${i}
_${wo(n.created_at)}_${o}`,c=Pr(n.id);if(!(await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l,parse_mode:"Markdown",reply_markup:{inline_keyboard:c}})})).ok){const u=await Re(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l.replace(/[_*`[\]]/g,""),reply_markup:{inline_keyboard:c}})});u.ok||console.warn("[sendNotifMessage] plain-text fallback also failed:",t,u.status)}}async function _o(e,t,n,s,r){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(s==null?void 0:s.name)||"there",o=(s==null?void 0:s.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`),c=await ie(n,t,l,"Markdown",r,s==null?void 0:s.id);return!c.success&&c.errors.length>0&&console.warn(`[/start] Failed to send message: ${c.errors.join(" | ")}`),!0}case"/help":{const o=`🛠 *${(s==null?void 0:s.assistant_name)||"Karna"} — Commands*
...
Status: ✅ Online`,u=await ie(n,t,d,"Markdown",r,s.id);u.success||console.warn(`[/status] Failed to send message: ${u.errors.join(" | ")}`)}catch{const o=await ie(n,t,"✅ Online — but had trouble fetching stats.","Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/status error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/new":{if(!s){const o=await ie(n,t,"⚠️ Account not linked.","Markdown",r);return o.success||console.warn(`[/new] Failed to send message: ${o.errors.join(" | ")}`),!0}await r.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(s.id).run();const i=await ie(n,t,"🆕 Starting fresh conversation. Your next message begins a new thread.","Markdown",r,s.id);return i.success||console.warn(`[/new] Failed to send message: ${i.errors.join(" | ")}`),!0}case"/tasks":case"/task":{if(!s){const i=await ie(n,t,"⚠️ Account not linked.","Markdown",r);return i.success||console.warn(`[/tasks] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await r.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(s.id).all()).results||[];if(o.length===0){const y=await ie(n,t,"✅ No open tasks. You're all clear.","Markdown",r,s.id);return y.success||console.warn(`[/tasks] Failed to send message: ${y.errors.join(" | ")}`),!0}const l=new Date,c=l.toISOString().slice(0,10),d=new Date(l);d.setDate(d.getDate()+1);const u=d.toISOString().slice(0,10),p=[`📋 *Open Tasks (${o.length})*
`];for(const y of o){let w="";if(y.due_date){const v=y.due_date.slice(0,10);v<c?w=" ⚠️ _overdue_":v===c?w=" 🔴 _due today_":v===u?w=" 🟡 _due tomorrow_":w=` _${new Date(y.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}p.push(`☐ ${y.title}${w}`)}p.push(`
_Say "mark [task] as done" to close a task._`);const g=await ie(n,t,p.join(`
`),"Markdown",r,s.id);g.success||console.warn(`[/tasks] Failed to send message: ${g.errors.join(" | ")}`)}catch(i){const o=await ie(n,t,"❌ Could not fetch tasks: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/notifications":case"/notif":{if(!s){const i=await ie(n,t,"⚠️ Account not linked.","Markdown",r);return i.success||console.warn(`[/notifications] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await r.prepare(`
          ...
          LIMIT 5
        `).bind(s.id).all()).results||[];if(o.length===0){const c=await ie(n,t,"🎉 No pending notifications. You're all caught up.","Markdown",r,s.id);return c.success||console.warn(`[/notifications] Failed to send message: ${c.errors.join(" | ")}`),!0}const l=await ie(n,t,`📬 *${o.length} pending notification${o.length>1?"s":""}:*`,"Markdown",r,s.id);l.success||console.warn(`[/notifications] Failed to send header: ${l.errors.join(" | ")}`);for(const c of o)await bo(n,t,c)}catch(i){const o=await ie(n,t,"❌ Could not fetch notifications: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/notifications error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}async function Eo(e,t){var r,a,i,o,l,c;const n=t.db,s=t.env;console.log(`[telegram webhook] envVars keys=${Object.keys(s).join(",")}`);try{if(e.callback_query){await ko(n,e.callback_query);return}const d=e.message;if(!d)return;const u=!!d.text,p=!!d.voice,g=!!d.document,y=!!d.photo,w=!!d.caption;if(!u&&!p&&!g&&!y)return;const v=String(d.chat.id);let E=d.text||"";const T=await n.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let D=null;if(T){const C=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(T.id,"telegram_bot_token").first();C&&(D=await Z(C.encrypted_value,T.pin_hash))}if(!D){const C=await n.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();C&&(D=await Z(C.encrypted_value,C.pin_hash))}if(!D||E.startsWith("/")&&await _o(E,v,D,T,n))return;if(!T){const C=await ie(D,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",n);C.success||console.warn(`Failed to send unlinked account message: ${C.errors.join(" | ")}`);return}if(d.voice&&D&&T)try{if((d.voice.file_size??0)>20*1024*1024){const z=await ie(D,v,"⚠️ Voice note is too large to process (max 20 MB).","Markdown",n,T.id);z.success||console.warn(`[voice size] Failed to send message: ${z.errors.join(" | ")}`);return}const C=await ie(D,v,"🎤 Processing voice note...","Markdown",n,T.id);C.success||console.warn(`[voice start] Failed to send message: ${C.errors.join(" | ")}`);const X=await(await Re(`https://api.telegram.org/bot${D}/getFile?file_id=${d.voice.file_id}`)).json();if(X.ok&&((r=X.result)!=null&&r.file_path)){const re=await(await rs(`https://api.telegram.org/file/bot${D}/${X.result.file_path}`)).blob(),ce=await po(n,T.id,T.pin_hash);if(!ce){const m=await ie(D,v,"⚠️ To use voice notes, add an OpenAI or Groq API key in Settings → Keys (LLM slot or legacy openai/groq).","Markdown",n,T.id);m.success||console.warn(`[voice no stt] Failed to send message: ${m.errors.join(" | ")}`);return}const q=new FormData;q.append("file",re,"voice.ogg"),q.append("model",ce.model),q.append("language","en");const Q=await fetch(ce.url,{method:"POST",headers:{Authorization:`Bearer ${ce.apiKey}`},body:q});if(!Q.ok){const m=await Q.text(),b=await ie(D,v,`⚠️ Transcription failed: ${Q.status} ${m}`,"Markdown",n,T.id);b.success||console.warn(`[voice transcription error] Failed to send message: ${b.errors.join(" | ")}`);return}E=(await Q.json()).text;const U=await ie(D,v,`🗣️ *You said:* ${E}`,"Markdown",n,T.id);U.success||console.warn(`[voice transcript echo] Failed to send message: ${U.errors.join(" | ")}`)}}catch(C){const K=await ie(D,v,`⚠️ Failed to process voice note: ${C.message}`,"Markdown",n,T==null?void 0:T.id);K.success||console.warn(`[voice processing error] Failed to send message: ${K.errors.join(" | ")}`);return}if((g||y)&&D&&T)try{let C,K="unknown",X="unknown",z=0;if(g)C=d.document.file_id,K=d.document.file_name||"document",X=d.document.mime_type||"unknown",z=d.document.file_size||0;else if(y){const re=d.photo[d.photo.length-1];C=re.file_id,K="photo.jpg",X="image/jpeg",z=re.file_size||0}if(C){const ce=await(await Re(`https://api.telegram.org/bot${D}/getFile?file_id=${C}`)).json();let q="";if(ce.ok&&((a=ce.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(K)||/^text\/|application\/json|application\/xml|application\/csv/i.test(X))&&z<5e4)try{q=await(await rs(`https://api.telegram.org/file/bot${D}/${ce.result.file_path}`)).text()}catch{}const Q=d.caption||"",le=`[Telegram file received: "${K}" (${X}, ${Math.round(z/1024)}KB)]`;q?E=`${Q?Q+`

`:""}${le}
File contents:
${q.substring(0,8e3)}${q.length>8e3?`
[...truncated]`:""}`:E=`${Q?Q+`

`:""}${le}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(C){if(w&&d.caption)E=d.caption;else{const K=await ie(D,v,`⚠️ Received your file but couldn't process it: ${C.message}`,"Markdown",n,T==null?void 0:T.id);K.success||console.warn(`[file processing error] Failed to send message: ${K.errors.join(" | ")}`);return}}if(!E)return;yo(D,v).catch(()=>{});let O=await n.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(T.id).first();if(O)await n.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(O.id).run();else{const C=await n.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(T.id).run();if(!((i=C.meta)!=null&&i.last_row_id))throw new Error("Thread creation failed — no row ID returned");O={id:C.meta.last_row_id}}const L=oo(T.id,T.username,E,v);L.metadata={thread_id:O.id},console.log(`[telegram webhook] user=${T.id} msgLen=${E.length} thread=${O.id}`);let A,F;try{const C=await Je(n,T.id,T.pin_hash);A=C.provider,F=C.rotation}catch(C){console.error("Telegram provider setup error:",C);const K=(o=C.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=C.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${C.message||"Unknown error"}`,X=await ie(D,v,K,"Markdown",n,T.id);X.success||console.warn(`[provider error] Failed to send message: ${X.errors.join(" | ")}`);return}const{classifyIntentFast:Y}=await Promise.resolve().then(()=>Di);if(Y(E).agent==="multi"){const C=await ie(D,v,"🔍 On it…","Markdown",n,T.id);C.success||console.warn(`[ack] Failed to send: ${C.errors.join(" | ")}`)}const ee=6e5;let ae=!1;try{const C=await Promise.race([Mn(L,n,A,T,F,s),new Promise((z,re)=>setTimeout(()=>re(new Error("TELEGRAM_TIMEOUT")),ee))]),K=lo(C,"telegram"),X=await ie(D,v,K||"(empty response)","Markdown",n,T.id);if(await n.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(O.id).run().catch(()=>{}),ae=X.success,!X.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${T.id}:`,X.errors);try{const{logError:z}=await Promise.resolve().then(()=>yt);await z(n,T.id,"telegram","response_send_failed",`Failed to deliver response: ${X.errors.join(" | ")}`)}catch{}}}catch(C){console.error("Telegram agent error:",C);const K=C.message==="TELEGRAM_TIMEOUT",X=K?`⏱️ This is taking too long to complete via Telegram.

If you requested a browser task, the result will arrive as a notification when ready. For other long tasks, try the web app.`:(c=C.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${A.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(C.message||"Unknown").substring(0,200)}`,z=await ie(D,v,X,"Markdown",n,T.id);ae=z.success,z.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${T.id}:`,z.errors);try{const{logError:re}=await Promise.resolve().then(()=>yt);await re(n,T.id,"telegram",K?"timeout":"agent_error",C.message||"Agent error",{provider:A.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:u}=await Promise.resolve().then(()=>yt);await u(n,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}}function as(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}function To(e){const t=new Date(new Date().toLocaleString("en-US",{timeZone:e})),n=new Date(t);n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const s=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),r=new Date(n.toLocaleString("en-US",{timeZone:e}));return new Date(n.getTime()+(s.getTime()-r.getTime())).toISOString()}const Pr=e=>[[{text:"✅ Seen",callback_data:`notif_seen:${e}`},{text:"⏰ Snooze",callback_data:`notif_snooze_menu:${e}`},{text:"✓ Done",callback_data:`notif_done:${e}`}]],So=e=>[[{text:"10 minutes",callback_data:`notif_snooze:${e}:10m`},{text:"1 hour",callback_data:`notif_snooze:${e}:1h`}],[{text:"Tomorrow 9 AM",callback_data:`notif_snooze:${e}:tomorrow`},{text:"← Back",callback_data:`notif_back:${e}`}]];async function ut(e,t,n){const s=await Re(`https://api.telegram.org/bot${e}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:t,text:n})});s.ok||console.warn("[answerCallback]",t,s.status)}async function mt(e,t,n,s){const r=await Re(`https://api.telegram.org/bot${e}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,message_id:n,reply_markup:s?{inline_keyboard:s}:{}})});r.ok||console.warn("[editKeyboard]",t,n,r.status)}async function xo(e,t,n,s,r,a,i,o,l,c){const d=await e.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).first();if(!d){await ut(t,n,"Notification not found — may have already been actioned."),await mt(t,s,r,null);return}if(i==="notif_seen")await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ut(t,n,"✅ Dismissed"),await mt(t,s,r,null);else if(i==="notif_snooze_menu")await ut(t,n),await mt(t,s,r,So(o));else if(i==="notif_back")await ut(t,n),await mt(t,s,r,Pr(o));else if(i==="notif_snooze"){const u=as(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run();let p,g;l==="10m"?(p=new Date(Date.now()+600*1e3).toISOString(),g="10 minutes"):l==="1h"?(p=new Date(Date.now()+3600*1e3).toISOString(),g="1 hour"):(p=To(c||"UTC"),g="tomorrow 9 AM"),await e.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
       VALUES (?, ?, ?, 'once', ?, 'reminder', ?, ?, 1, 'active')`).bind(a,d.title,d.body,p,JSON.stringify({description:d.body||""}),p).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ut(t,n,`⏰ Snoozed until ${g}`),await mt(t,s,r,null)}else if(i==="notif_done"){const u=as(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ut(t,n,"✓ Done!"),await mt(t,s,r,null)}}async function ko(e,t){var v;const{id:n,data:s,message:r,from:a}=t;if(!s||!r)return;const i=s.split(":"),o=i[0],l=String(r.chat.id);if(o.startsWith("notif_")){const E=parseInt(i[1]);if(!E)return;const T=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!T)return;const D=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
       JOIN users u ON c.user_id = u.id
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(T.id).first();if(!D)return;const O=await Z(D.encrypted_value,D.pin_hash),L=i[2];await xo(e,O,n,l,r.message_id,T.id,o,E,L,T.timezone);return}if(i[0]!=="briefing_toggle"||i.length<3)return;const c=i[1],d=parseInt(i[2]);if(!d||!c)return;const u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const p=await e.prepare(`
  ...
  `).bind(u.id,d,c).first();if(!p)return;const g=p.checked?0:1;await e.prepare(`
    ...
    WHERE id = ?
  `).bind(g,g,p.id).run();const y=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!y)return;const w=await Z(y.encrypted_value,y.pin_hash);try{const E=await Re(`https://api.telegram.org/bot${w}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:n,text:g?"✅ Checked!":"☐ Unchecked"})});E.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${E.status}`)}catch(E){console.warn(`[callback answer] Error answering callback: ${E.message}`)}if((v=r.reply_markup)!=null&&v.inline_keyboard){const E=r.reply_markup.inline_keyboard.map(T=>T.map(D=>{var O;if((O=D.callback_data)!=null&&O.includes(c)){const L=g?"✅":"☐",A=D.text.replace(/^[☐✅]\s*/,"");return{...D,text:`${L} ${A}`}}return D}));try{await Re(`https://api.telegram.org/bot${w}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:r.message_id,reply_markup:{inline_keyboard:E}})})}catch{}}}const Ft=new Ee;function Do(e){return{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE}}Ft.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const s={db:e.env.DB,env:Do(e)};return e.executionCtx.waitUntil(Eo(t,s)),e.json({ok:!0})});Ft.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const{webhook_url:s}=await e.req.json(),r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Telegram bot token not configured in Settings"},400);const a=await Z(r.encrypted_value,n.pin_hash);if(!s){const d=await(await fetch(`https://api.telegram.org/bot${a}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${a}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:s,allowed_updates:[...$r],drop_pending_updates:!1})})).json();return e.json(o)});Ft.get("/webhook-status",async e=>{var a,i,o,l,c,d;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({configured:!1,error:"Bot token not set"});const r=await Z(s.encrypted_value,n.pin_hash);try{const p=await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=p.result)==null?void 0:i.url)||"",has_webhook:!!((o=p.result)!=null&&o.url),pending_updates:((l=p.result)==null?void 0:l.pending_update_count)||0,last_error:((c=p.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=p.result)==null?void 0:d.last_error_date)||null})}catch(u){return e.json({configured:!0,error:u.message})}});Ft.post("/detect-chat-id",async e=>{var a,i;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Bot token not configured"},400);const r=await Z(s.encrypted_value,n.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${r}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(v=>setTimeout(v,500));const u=await(await fetch(`https://api.telegram.org/bot${r}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${r}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:[...$r]})});const p=u.result||[];if(p.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const g=[],y=new Set;for(let v=p.length-1;v>=0;v--){const E=p[v].message;if(E&&E.chat){const T=String(E.chat.id);y.has(T)||(y.add(T),g.push({chat_id:T,name:[E.chat.first_name,E.chat.last_name].filter(Boolean).join(" ")||E.chat.title||"Unknown",username:E.chat.username||"",date:new Date((E.date||0)*1e3).toISOString()}))}}if(g.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const w=g[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(w,n.user_id).run(),e.json({found:!0,chat_id:w,name:g[0].name,all_chats:g,message:`Chat ID ${w} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});function Ro(e){const t=new Date,n=new Date(t.toLocaleString("en-US",{timeZone:e})),s=new Date(n);s.setDate(s.getDate()+1),s.setHours(0,0,0,0);const r=new Date(s);r.setHours(23,59,59,999);const a=s.toISOString().split("T")[0];return{start:s.toISOString(),end:r.toISOString(),dateStr:a}}function rn(e,t=new Date){return new Intl.DateTimeFormat("en-CA",{timeZone:e||"Asia/Kolkata",year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}async function Oo(e,t,n,s,r,a){try{return(await new kn(e,t,n,s,r).listEvents("primary",{timeMin:a.start,timeMax:a.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Io(e,t,n,s,r){try{const a=new De(e,t,n,s,r),i=await a.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await a.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const u of i){const p=u.from.split("<")[0].trim()||u.from;l[p]=(l[p]||0)+1}const c=Object.entries(l).sort(([,u],[,p])=>p-u).slice(0,5).map(([u])=>u),d=i.some(u=>u.subject.toLowerCase().includes("urgent")||u.subject.toLowerCase().includes("asap")||u.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(a){return console.error("Gmail fetch error:",a.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function No(e,t){try{const n=await e.prepare(`
...
`)}function Mo(e){const t=[];let n=0;for(const s of e.calendar.google)t.push({type:"calendar",key:s.id,text:`${s.title} - ${new Date(s.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:s},sortOrder:n++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:n++});for(const s of e.tasks.items)t.push({type:"task",key:`task-${s}`,text:s,metadata:{},sortOrder:n++});for(const s of e.news.items)t.push({type:"news",key:`news-${s.url}`,text:`📰 ${s.title}`,metadata:{url:s.url,source:s.source},sortOrder:n++});return t}async function $o(e,t){const n=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!n)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let s;try{const a=JSON.parse(n.components);s={google_calendar:a.google_calendar!==!1,gmail:a.gmail!==!1,tasks:a.tasks!==!1,news:a.news!==!1}}catch{s={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const r=n.news_topics?n.news_topics.split(",").map(a=>a.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:s,newsTopics:r}}async function Br(e,t,n){var D,O;const s=t.timezone||"Asia/Kolkata",r=Ro(s),{components:a,newsTopics:i}=await $o(e,t.id),o=[],l=[];a.google_calendar&&(o.push(Oo(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET,r)),l.push("googleEvents")),a.gmail&&(o.push(Io(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),a.tasks&&(o.push(No(e,t.id)),l.push("tasks")),a.news&&(o.push(Ao(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((L,A)=>{d[L]=c[A]});const u={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},p={pending:0,dueToday:0,items:[]},g={generatedAt:new Date().toISOString(),targetDate:r.dateStr,calendar:{google:d.googleEvents||[],totalCount:((D=d.googleEvents)==null?void 0:D.length)||0},emails:{gmail:d.gmailSummary||u},tasks:d.tasks||p,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},y=((O=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:O.briefing_time)||"20:00";g.summary=Lo(g,y);const w=Mo(g),v=rn(s),E=await e.prepare(`
  ...
  `).bind(n).all();return{briefing:{...s,content:JSON.parse(s.content_json||"{}")},items:r.results||[]}}async function Bo(e,t,n,s){if(!await e.prepare(`
  ...
  `).bind(i,i,s,n).run(),{checked:i===1}}async function jo(e,t,n=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,n).all()).results||[]).map(r=>({...r,content:JSON.parse(r.content_json||"{}")}))}function jr(e,t,n=new Date,s=5){const r=new Date(n.toLocaleString("en-US",{timeZone:t})),a=r.getHours(),i=r.getMinutes(),[o,l]=e.split(":").map(Number),c=a*60+i,d=o*60+l,u=c-d;return u>=0&&u<s}function Ur(e,t){const n=e.summary,s=[];for(const r of t.slice(0,10))s.push([{text:`☐ ${r.text.substring(0,40)}${r.text.length>40?"...":""}`,callback_data:`briefing_toggle:${r.key}`}]);return{text:n,inlineKeyboard:s}}const ge=new Ee,Uo=1e4;async function Mt(e,t){const n=new AbortController,s=setTimeout(()=>n.abort(),Uo);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function Ho(e,t){var r;if(e.req.path.includes("/cron/"))return t();const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(!jr(l,o,a))continue;const c=rn(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'evening' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await Br(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(i.telegram_chat_id){const{text:p,inlineKeyboard:g}=Ur(u.content,u.items);await Hr(e.env.DB,i,p,g,u.briefingId)}r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ge.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),r=[],a=new Date,i=new Date(a.getTime()+600*1e3).toISOString(),o=new Date(a.getTime()+900*1e3).toISOString();for(const l of s.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await Z(c.encrypted_value,l.pin_hash),p=JSON.parse(d).access_token;if(!p)continue;const g=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(a.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${p}`}});if(!g.ok)continue;const w=((await g.json()).items||[]).filter(T=>{var O;const D=(O=T.start)==null?void 0:O.dateTime;return D?D>=a.toISOString()&&D<=i:!1});if(w.length===0){r.push({user_id:l.id,reminders_sent:0});continue}const v=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!v)continue;const E=await Z(v.encrypted_value,l.pin_hash);if(!(E!=null&&E.trim()))continue;for(const T of w){const D=new Date(T.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),O=T.location?`
📍 ${T.location}`:"",L=`⏰ Meeting in 10 minutes!

*${T.summary||"Untitled Event"}*
🕐 ${D}${O}`;await Mt(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:L,parse_mode:"Markdown"})})}r.push({user_id:l.id,reminders_sent:w.length})}catch(c){r.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ge.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(!jr(l,o,a))continue;const c=rn(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'morning' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await Gr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let p={telegram:!0,web:!0};try{p=JSON.parse(i.notification_channels||"{}")}catch{}if(p.telegram!==!1&&i.telegram_chat_id&&u.briefingId){const g=Wo(u.content);await Fr(e.env.DB,i,g),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run()}r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ge.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[];for(const a of s.results||[]){let i={};try{i=JSON.parse(a.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Wr(e.env.DB,a,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{skipBrowserUse:!0}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,c=JSON.stringify(o,null,2),d=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(Fo(l,o,a))try{const c=await Go(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),d=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,u=JSON.stringify(c,null,2),p=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,d,u,`weekly_review_${Date.now()}`,null,null,null).first();let g={telegram:!0,web:!0};try{g=JSON.parse(i.notification_channels||"{}")}catch{}if(g.telegram!==!1&&i.telegram_chat_id){const y=qo(c);await Fr(e.env.DB,i,y)}r.push({user_id:i.id,status:"success",action_item_id:p==null?void 0:p.id})}catch(c){r.push({user_id:i.id,status:"error",error:c.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});async function Hr(e,t,n,s,r){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!a)return;const i=await Z(a.encrypted_value,a.pin_hash);if(!(i!=null&&i.trim())){wr("sendTelegramWithKeyboard: empty bot token",{userId:t.id});return}if(!(await(await Mt(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n,parse_mode:"Markdown",reply_markup:{inline_keyboard:s.map(c=>c.map(d=>({...d,callback_data:`${d.callback_data}:${r}`})))}})})).json()).ok){const d=await(await Mt(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:s.map(u=>u.map(p=>({...p,callback_data:`${p.callback_data}:${r}`})))}})})).json();if(!d.ok){bn("Telegram briefing send failed",{description:d.description,chatId:t.telegram_chat_id});return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(r).run()}catch(a){bn("Telegram briefing error",{error:(a==null?void 0:a.message)||String(a)})}}async function Fr(e,t,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const r=await Z(s.encrypted_value,s.pin_hash);if(!(r!=null&&r.trim())){wr("sendTelegramPlainText: empty bot token",{userId:t.id});return}(await Mt(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3),parse_mode:"Markdown"})})).ok||await Mt(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3).replace(/[_*[`\]]/g,"")})})}catch(s){bn("Telegram plain text error",{error:(s==null?void 0:s.message)||String(s)})}}async function Gr(e,t,n){const s=new Date;s.setHours(0,0,0,0);const r=new Date;r.setHours(23,59,59,999);const a=await e.prepare(`
  ...
  `).bind(t.id,r.toISOString()).all(),d=await e.prepare(`
    ...
    ORDER BY next_run ASC
  `).bind(t.id,s.toISOString(),a.toISOString()).all();let u={unreadCount:0,recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const g=new De(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET),y=await g.getUnreadCount(),w=await g.listMessages({maxResults:10,labelIds:["INBOX"]});u={unreadCount:y,recent:w.map(v=>({subject:v.subject,from:v.from,snippet:v.snippet}))}}}catch{}return{generatedAt:s.toISOString(),period:{start:r.toISOString(),end:s.toISOString()},completedTasks:(i.results||[]).map(p=>({name:p.name,last_run:p.last_run})),missedTasks:(o.results||[]).map(p=>({name:p.name,next_run:p.next_run})),openActions:(l.results||[]).map(p=>({title:p.title,priority:p.priority,status:p.status})),recentDocuments:(c.results||[]).map(p=>({name:p.name,status:p.status,created_at:p.created_at})),upcomingTasks:(d.results||[]).map(p=>({name:p.name,next_run:p.next_run})),gmailSummary:u}}function Wo(e){const t=[];t.push("☀️ Morning Briefing"),t.push("");const n=e.todayReminders||[];if(n.length>0){t.push(`📋 Today (${n.length}):`);for(const l of n){const c=l.next_run?new Date(l.next_run).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${c} ${l.name}`)}}else t.push("📋 Today: No scheduled reminders");t.push("");const s=e.pendingActions||[];if(s.length>0){t.push(`🔔 Pending Actions (${s.length}):`);for(const l of s.slice(0,5))t.push(`   • ${l.title} (${l.priority})`)}else t.push("🔔 Pending Actions: None");t.push("");const r=e.emailDigest||{},a=r.gmail||{};a.unreadCount>0?t.push(`📧 Gmail: ${a.unreadCount} unread`):t.push("📧 Gmail: Inbox clear");const i=r.outlook||{};typeof i.recent=="string"&&i.recent.length>0?t.push("📧 Outlook: see digest"):i.message&&t.push(`📧 Outlook: ${i.message}`),t.push("");const o=e.calendarEvents||[];if(o.length>0){t.push(`📅 Calendar (${o.length}):`);for(const l of o.slice(0,5)){const c=l.startTime?new Date(l.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${c} ${l.title}`)}}return t.join(`
`)}function qo(e){const t=[];t.push("📊 Weekly Review"),t.push("");const n=e.completedTasks||[];t.push(`✅ Completed: ${n.length}`);const s=e.missedTasks||[];t.push(`❌ Missed/Overdue: ${s.length}`);const r=e.openActions||[];t.push(`🔔 Open Actions: ${r.length}`),t.push("");const a=e.recentDocuments||[];a.length>0&&t.push(`📄 Documents: ${a.length} this week`);const i=e.upcomingTasks||[];i.length>0&&t.push(`📅 Upcoming: ${i.length} in next 7 days`);const o=e.gmailSummary||{};return o.unreadCount>0&&t.push(`📧 Gmail Unread: ${o.unreadCount}`),t.join(`
`)}ge.post("/briefings/:id/resend",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));try{const s=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!s)return e.json({error:"Briefing not found"},404);const r=JSON.parse(s.content||"{}"),a=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(n).all(),{text:i,inlineKeyboard:o}=Ur(r,a.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(n).run(),await Hr(e.env.DB,t,i,o,n);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(n).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(s){return e.json({error:s.message},500)}});ge.delete("/briefings/:id",async e=>{const t=e.get("user"),n=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});const ct=new Ee;async function Gt(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
...
${r.substring(0,8e3)}`}],{maxTokens:1024})).content)==null?void 0:c.trim())||null}catch{a=null}const i=a||"Summary not yet generated. Ask Karna in chat to summarize this document.";await e.env.DB.prepare("UPDATE document_library SET status = ?, summary = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("summarized",i,n,t.id).run();const l=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return e.json({success:!0,document:l})});Ie.delete("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});Ie.post("/:id/parse",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));await e.env.DB.prepare("UPDATE document_library SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("parsed",n,t.id).run();const s=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return e.json({success:!0,document:s})});const Te=new Ee;async function Vo(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
  ...
  `).bind(t.id).all()).results||[];if(s.length===0)return e.json({migrated:0,skipped:0,samples:[],message:"No oversized memory entries found."});let r=0,a=0;const i=[];for(const o of s){if(["preference","fact","context","decision"].includes(o.type)){a++;continue}const l=o.content.length>1500,c=/\b(essay|article|draft|report|chapter)\b/i.test(o.content)&&o.content.length>500;if(!l&&!c){a++;continue}try{const d=o.content.substring(0,500),u=o.content.substring(0,5e4);await e.env.DB.prepare(`
      ...
      `).bind(t.id,o.title,d,u).run();const p=`[Migrated to Document Library] ${o.title} — content moved to Document Library. Search for it with search_library("${o.title.substring(0,40)}").`;await e.env.DB.prepare("UPDATE memory SET content = ?, importance = 4, tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(p,o.id,t.id).run(),r++,i.length<5&&i.push({id:o.id,title:o.title,action:"migrated to document_library, memory demoted to pointer"})}catch{a++}}return e.json({migrated:r,skipped:a,samples:i,message:`Moved ${r} bulky memory entries to Document Library. ${a} entries were skipped (too short or migration error).`})});const fe=new Ee,Zo=["/api/auth","/api/chat","/api/settings","/api/telegram","/api/system","/api/proactive","/api/skills","/api/notifications","/api/documents","/api/memory"];async function Xo(e){const t=e.env.RENDER_BACKEND_URL,n=e.env.RENDER_API_SECRET;if(!(e.env.ENABLE_RENDER_PROXY==="true")||!t||!n||e.req.header("x-via-render-worker")||!Zo.some(y=>e.req.path.startsWith(y)))return null;const a=new URL(e.req.url);a.protocol=new URL(t).protocol,a.host=new URL(t).host;const i=new Headers(e.req.header());i.set("x-render-api-secret",n);const o=e.req.path.startsWith("/api/chat")||e.req.path.startsWith("/api/telegram"),l=Number(e.env.RENDER_PROXY_TIMEOUT_MS_LONG||"310000"),c=Number(e.env.RENDER_PROXY_TIMEOUT_MS||"8000"),d=o?l:c,u=new AbortController,p=setTimeout(()=>u.abort("render-proxy-timeout"),d);let g;try{g=await fetch(a.toString(),{method:e.req.method,headers:i,body:e.req.method==="GET"||e.req.method==="HEAD"?void 0:await e.req.arrayBuffer(),signal:u.signal})}catch(y){return e.json({error:"Render backend unavailable",detail:String(y)},503)}finally{clearTimeout(p)}return new Response(g.body,{status:g.status,headers:g.headers})}fe.use("/api/*",Ca());fe.use("/api/*",async(e,t)=>{const n=await Xo(e);if(n)return n;await t()});fe.route("/api/auth",Ye);fe.route("/api/chat",de);fe.route("/api/settings",oe);fe.route("/api/system",Oe);fe.route("/api/telegram",Ft);fe.route("/api/proactive",ge);fe.route("/api/skills",ct);fe.route("/api/notifications",Ve);fe.route("/api/documents",Ie);fe.route("/api/memory",Te);fe.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),n=t.searchParams.get("code"),s=t.searchParams.get("state"),r=t.searchParams.get("error");if(r)return e.html(pt(!1,`Google denied access: ${r}`));if(!n||!s)return e.html(pt(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(s)).sessionId;if(!i)return e.html(pt(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(pt(!1,"Session expired. Please log in again and retry."));const l=o.user_id,c=o.pin_hash,d=`${t.protocol}//${t.host}/auth/google/callback`,u=await Gs(e.env.DB,l,c,n,d,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(pt(!0,`Connected as ${u.email}`,u.email))}catch(a){return e.html(pt(!1,`OAuth failed: ${a.message}`))}});fe.get("/preview-dashboard",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.html(Ka())));fe.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Os(e.env.API_BASE_URL||""))));fe.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Os(e.env.API_BASE_URL||""))));function pt(e,t,n){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function Qo(e,t,n){const s="https://karna-5xs.pages.dev",a={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const o=await(await fetch(`${s}/api/system/cron/execute`,{method:"POST",headers:a})).json();if(o.results&&o.results.length>0){const c=o.results.filter(u=>u.needs_agent&&u.status==="dispatched");if(c.length>0){const u=c.map(p=>fetch(`${s}/api/system/cron/run-task/${p.job_id}`,{method:"POST",headers:a}).then(g=>g.json()).catch(g=>({job_id:p.job_id,error:g.message})));n.waitUntil(Promise.allSettled(u).then(p=>{console.log(`Cron: ${o.executed} dispatched, ${c.length} agent tasks`,JSON.stringify(p.map(g=>g.status==="fulfilled"?g.value:g.reason)))}))}const d=o.results.filter(u=>!u.needs_agent&&u.status==="dispatched");if(d.length>0){const u=d.map(p=>fetch(`${s}/api/system/cron/run-task/${p.job_id}`,{method:"POST",headers:a}).catch(()=>{}));n.waitUntil(Promise.allSettled(u))}}n.waitUntil(fetch(`${s}/api/proactive/cron/evening-briefing`,{method:"POST",headers:a}).then(c=>c.json()).then(c=>{c.executed>0&&console.log("Evening briefing result:",JSON.stringify(c))}).catch(c=>{console.error("Evening briefing error:",c.message)})),new Date().getMinutes()%5<2&&n.waitUntil(fetch(`${s}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:a}).then(c=>c.json()).then(c=>{var d;(d=c.results)!=null&&d.some(u=>u.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(c))}).catch(()=>{})),n.waitUntil(fetch(`${s}/api/system/cron/check-browser-tasks`,{method:"POST",headers:a}).catch(()=>{}))}catch(i){console.error("Scheduled cron error:",i.message||i)}}const el={fetch:fe.fetch,scheduled:Qo},os=new Ee,tl=Object.assign({"/src/index.tsx":el});let Kr=!1;for(const[,e]of Object.entries(tl))e&&(os.all("*",t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),os.notFound(t=>{let n;try{n=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,n)}),Kr=!0);if(!Kr)throw new Error("Can't import modules from ['/src/index.tsx']");function Yr(e){if(e.length<100)return e.trim()?[e.trim()]:[];const r=[];let a=0;for(;a<e.length;){let i=Math.min(a+1800,e.length);if(i<e.length){const l=e.lastIndexOf(`

`,i);if(l>a+1800/2)i=l+2;else{const c=e.lastIndexOf(". ",i);c>a+1800/2&&(i=c+2)}}const o=e.slice(a,i).trim();o.length>=100&&r.push(o),a=i-200,a<=0&&(a=i)}return r}async function nl(e,t,n,s){if(!e.AI||!e.VECTORIZE)return;const r=Yr(s);if(r.length===0)return;const a=await e.DB.prepare("SELECT vector_id FROM document_chunks WHERE document_id = ?").bind(n).all();a.results.length>0&&(await e.VECTORIZE.deleteByIds(a.results.map(d=>d.vector_id)),await e.DB.prepare("DELETE FROM document_chunks WHERE document_id = ?").bind(n).run());const o=(await e.AI.run("@cf/baai/bge-large-en-v1.5",{text:r})).data,l=r.map((d,u)=>`doc_${n}_${u}`);await e.VECTORIZE.insert(r.map((d,u)=>({id:l[u],values:o[u],metadata:{userId:String(t),documentId:String(n)}})));const c=e.DB.prepare("INSERT INTO document_chunks (user_id, document_id, chunk_index, text, vector_id) VALUES (?, ?, ?, ?, ?)");await e.DB.batch(r.map((d,u)=>c.bind(t,n,u,d,l[u])))}async function sl(e,t,n,s=5){if(!e.AI||!e.VECTORIZE)return[];const a=(await e.AI.run("@cf/baai/bge-large-en-v1.5",{text:[n]})).data[0],i=await e.VECTORIZE.query(a,{topK:s*3,filter:{userId:String(t)}});if(!i.matches||i.matches.length===0)return[];const o=i.matches.map(w=>w.id),l=new Map(i.matches.map(w=>[w.id,w.score])),c=o.map(()=>"?").join(","),u=((await e.DB.prepare(`SELECT dc.text, dc.vector_id, dc.document_id, dl.name, dc.chunk_index
     FROM document_chunks dc
     JOIN document_library dl ON dc.document_id = dl.id
     WHERE dc.vector_id IN (${c}) AND dc.user_id = ?`).bind(...o,t).all()).results||[]).map(w=>({filename:w.name,relevance_score:l.get(w.vector_id)??0,chunk:w.text,document_id:w.document_id,chunk_index:w.chunk_index,retrieval_method:"vector"})),g=((await e.DB.prepare(`SELECT dc.text, dc.document_id, dc.chunk_index, dl.name
     FROM document_chunks dc
     JOIN document_library dl ON dc.document_id = dl.id
     WHERE dc.user_id = ? AND dc.text LIKE ?
     ORDER BY dc.chunk_index DESC
     LIMIT ?`).bind(t,`%${n.substring(0,80)}%`,s*2).all()).results||[]).map(w=>({filename:w.name,relevance_score:.55,chunk:w.text,document_id:w.document_id,chunk_index:w.chunk_index,retrieval_method:"keyword"})),y=new Map;for(const w of[...u,...g]){const v=`${w.document_id}:${w.chunk_index}`;if(!y.has(v))y.set(v,w);else{const E=y.get(v);y.set(v,{...E,relevance_score:Math.max(E.relevance_score,w.relevance_score),retrieval_method:"hybrid"})}}return[...y.values()].sort((w,v)=>v.relevance_score-w.relevance_score).slice(0,s)}const ze=Object.freeze(Object.defineProperty({__proto__:null,chunkText:Yr,indexDocumentChunks:nl,semanticDocumentSearch:sl},Symbol.toStringTag,{value:"Module"}));export{os as default};
