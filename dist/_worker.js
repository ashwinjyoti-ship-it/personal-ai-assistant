var Yr=Object.defineProperty;var Ln=e=>{throw TypeError(e)};var Jr=(e,t,n)=>t in e?Yr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var P=(e,t,n)=>Jr(e,typeof t!="symbol"?t+"":t,n),an=(e,t,n)=>t.has(e)||Ln("Cannot "+n);var x=(e,t,n)=>(an(e,t,"read from private field"),n?n.call(e):t.get(e)),V=(e,t,n)=>t.has(e)?Ln("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),F=(e,t,n,s)=>(an(e,t,"write to private field"),s?s.call(e,n):t.set(e,n),n),ne=(e,t,n)=>(an(e,t,"access private method"),n);var Mn=(e,t,n,s)=>({set _(r){F(e,t,r,n)},get _(){return x(e,t,s)}});var $n=(e,t,n)=>(s,r)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&r||void 0,d)try{l=await d(s,()=>i(o+1))}catch(u){if(u instanceof Error&&t)s.error=u,l=await t(u,s),c=!0;else throw u}else s.finalized===!1&&n&&(l=await n(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},Vr=Symbol(),Zr=async(e,t=Object.create(null))=>{const{all:n=!1,dot:s=!1}=t,a=(e instanceof vs?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?Xr(e,{all:n,dot:s}):{}};async function Xr(e,t){const n=await e.formData();return n?Qr(n,t):{}}function Qr(e,t){const n=Object.create(null);return e.forEach((s,r)=>{t.all||r.endsWith("[]")?ea(n,r,s):n[r]=s}),t.dot&&Object.entries(n).forEach(([s,r])=>{s.includes(".")&&(ta(n,s,r),delete n[s])}),n}var ea=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},ta=(e,t,n)=>{let s=e;const r=t.split(".");r.forEach((a,i)=>{i===r.length-1?s[a]=n:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},ps=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},na=e=>{const{groups:t,path:n}=sa(e),s=ps(n);return ra(s,t)},sa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,s)=>{const r=`@${s}`;return t.push([r,n]),r}),{groups:t,path:e}},ra=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[s]=t[n];for(let r=e.length-1;r>=0;r--)if(e[r].includes(s)){e[r]=e[r].replace(s,t[n][1]);break}}return e},Wt={},aa=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const s=`${e}#${t}`;return Wt[s]||(n[2]?Wt[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:Wt[s]=[e,n[1],!0]),Wt[s]}return null},_n=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},ia=e=>_n(e,decodeURI),hs=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let s=n;for(;s<t.length;s++){const r=t.charCodeAt(s);if(r===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return ia(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(n,s)},oa=e=>{const t=hs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},mt=(e,t,...n)=>(n.length&&(t=mt(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),gs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let s="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))s+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){n.length===0&&s===""?n.push("/"):n.push(s);const a=r.replace("?","");s+="/"+a,n.push(s)}else s+="/"+r}),n.filter((r,a,i)=>i.indexOf(r)===a)},on=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?_n(e,ys):e):e,fs=(e,t,n)=>{let s;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return on(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const r={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(l=on(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=on(c))),n?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(c)):r[l]??(r[l]=c)}return t?r[t]:r},la=fs,ca=(e,t)=>fs(e,t,!0),ys=decodeURIComponent,Pn=e=>_n(e,ys),ft,we,$e,ws,bs,pn,Be,os,vs=(os=class{constructor(e,t="/",n=[[]]){V(this,$e);P(this,"raw");V(this,ft);V(this,we);P(this,"routeIndex",0);P(this,"path");P(this,"bodyCache",{});V(this,Be,e=>{const{bodyCache:t,raw:n}=this,s=t[e];if(s)return s;const r=Object.keys(t)[0];return r?t[r].then(a=>(r==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,F(this,we,n),F(this,ft,{})}param(e){return e?ne(this,$e,ws).call(this,e):ne(this,$e,bs).call(this)}query(e){return la(this.url,e)}queries(e){return ca(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,s)=>{t[s]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Zr(this,e))}json(){return x(this,Be).call(this,"text").then(e=>JSON.parse(e))}text(){return x(this,Be).call(this,"text")}arrayBuffer(){return x(this,Be).call(this,"arrayBuffer")}blob(){return x(this,Be).call(this,"blob")}formData(){return x(this,Be).call(this,"formData")}addValidatedData(e,t){x(this,ft)[e]=t}valid(e){return x(this,ft)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Vr](){return x(this,we)}get matchedRoutes(){return x(this,we)[0].map(([[,e]])=>e)}get routePath(){return x(this,we)[0].map(([[,e]])=>e)[this.routeIndex].path}},ft=new WeakMap,we=new WeakMap,$e=new WeakSet,ws=function(e){const t=x(this,we)[0][this.routeIndex][1][e],n=ne(this,$e,pn).call(this,t);return n&&/\%/.test(n)?Pn(n):n},bs=function(){const e={},t=Object.keys(x(this,we)[0][this.routeIndex][1]);for(const n of t){const s=ne(this,$e,pn).call(this,x(this,we)[0][this.routeIndex][1][n]);s!==void 0&&(e[n]=/\%/.test(s)?Pn(s):s)}return e},pn=function(e){return x(this,we)[1]?x(this,we)[1][e]:e},Be=new WeakMap,os),da={Stringify:1},_s=async(e,t,n,s,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(r?r[0]+=e:r=[e],Promise.all(a.map(o=>o({phase:t,buffer:r,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>_s(l,t,!1,s,r))).then(()=>r[0]))):Promise.resolve(e)},ua="text/plain; charset=UTF-8",ln=(e,t)=>({"Content-Type":e,...t}),Lt,Mt,Ce,yt,Ae,ve,$t,vt,wt,tt,Pt,Bt,je,pt,ls,ma=(ls=class{constructor(e,t){V(this,je);V(this,Lt);V(this,Mt);P(this,"env",{});V(this,Ce);P(this,"finalized",!1);P(this,"error");V(this,yt);V(this,Ae);V(this,ve);V(this,$t);V(this,vt);V(this,wt);V(this,tt);V(this,Pt);V(this,Bt);P(this,"render",(...e)=>(x(this,vt)??F(this,vt,t=>this.html(t)),x(this,vt).call(this,...e)));P(this,"setLayout",e=>F(this,$t,e));P(this,"getLayout",()=>x(this,$t));P(this,"setRenderer",e=>{F(this,vt,e)});P(this,"header",(e,t,n)=>{this.finalized&&F(this,ve,new Response(x(this,ve).body,x(this,ve)));const s=x(this,ve)?x(this,ve).headers:x(this,tt)??F(this,tt,new Headers);t===void 0?s.delete(e):n!=null&&n.append?s.append(e,t):s.set(e,t)});P(this,"status",e=>{F(this,yt,e)});P(this,"set",(e,t)=>{x(this,Ce)??F(this,Ce,new Map),x(this,Ce).set(e,t)});P(this,"get",e=>x(this,Ce)?x(this,Ce).get(e):void 0);P(this,"newResponse",(...e)=>ne(this,je,pt).call(this,...e));P(this,"body",(e,t,n)=>ne(this,je,pt).call(this,e,t,n));P(this,"text",(e,t,n)=>!x(this,tt)&&!x(this,yt)&&!t&&!n&&!this.finalized?new Response(e):ne(this,je,pt).call(this,e,t,ln(ua,n)));P(this,"json",(e,t,n)=>ne(this,je,pt).call(this,JSON.stringify(e),t,ln("application/json",n)));P(this,"html",(e,t,n)=>{const s=r=>ne(this,je,pt).call(this,r,t,ln("text/html; charset=UTF-8",n));return typeof e=="object"?_s(e,da.Stringify,!1,{}).then(s):s(e)});P(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});P(this,"notFound",()=>(x(this,wt)??F(this,wt,()=>new Response),x(this,wt).call(this,this)));F(this,Lt,e),t&&(F(this,Ae,t.executionCtx),this.env=t.env,F(this,wt,t.notFoundHandler),F(this,Bt,t.path),F(this,Pt,t.matchResult))}get req(){return x(this,Mt)??F(this,Mt,new vs(x(this,Lt),x(this,Bt),x(this,Pt))),x(this,Mt)}get event(){if(x(this,Ae)&&"respondWith"in x(this,Ae))return x(this,Ae);throw Error("This context has no FetchEvent")}get executionCtx(){if(x(this,Ae))return x(this,Ae);throw Error("This context has no ExecutionContext")}get res(){return x(this,ve)||F(this,ve,new Response(null,{headers:x(this,tt)??F(this,tt,new Headers)}))}set res(e){if(x(this,ve)&&e){e=new Response(e.body,e);for(const[t,n]of x(this,ve).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=x(this,ve).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of s)e.headers.append("set-cookie",r)}else e.headers.set(t,n)}F(this,ve,e),this.finalized=!0}get var(){return x(this,Ce)?Object.fromEntries(x(this,Ce)):{}}},Lt=new WeakMap,Mt=new WeakMap,Ce=new WeakMap,yt=new WeakMap,Ae=new WeakMap,ve=new WeakMap,$t=new WeakMap,vt=new WeakMap,wt=new WeakMap,tt=new WeakMap,Pt=new WeakMap,Bt=new WeakMap,je=new WeakSet,pt=function(e,t,n){const s=x(this,ve)?new Headers(x(this,ve).headers):x(this,tt)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??x(this,yt);return new Response(e,{status:r,headers:s})},ls),ue="ALL",pa="all",ha=["get","post","put","delete","options","patch"],Es="Can not add a route since the matcher is already built.",Ts=class extends Error{},ga="__COMPOSED_HANDLER",fa=e=>e.text("404 Not Found",404),Bn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},Ee,me,Ss,Te,Qe,qt,zt,bt,ya=(bt=class{constructor(t={}){V(this,me);P(this,"get");P(this,"post");P(this,"put");P(this,"delete");P(this,"options");P(this,"patch");P(this,"all");P(this,"on");P(this,"use");P(this,"router");P(this,"getPath");P(this,"_basePath","/");V(this,Ee,"/");P(this,"routes",[]);V(this,Te,fa);P(this,"errorHandler",Bn);P(this,"onError",t=>(this.errorHandler=t,this));P(this,"notFound",t=>(F(this,Te,t),this));P(this,"fetch",(t,...n)=>ne(this,me,zt).call(this,t,n[1],n[0],t.method));P(this,"request",(t,n,s,r)=>t instanceof Request?this.fetch(n?new Request(t,n):t,s,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${mt("/",t)}`,n),s,r)));P(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(ne(this,me,zt).call(this,t.request,t,void 0,t.request.method))})});[...ha,pa].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?F(this,Ee,i):ne(this,me,Qe).call(this,a,x(this,Ee),i),o.forEach(l=>{ne(this,me,Qe).call(this,a,x(this,Ee),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){F(this,Ee,l);for(const c of[a].flat())o.map(d=>{ne(this,me,Qe).call(this,c.toUpperCase(),x(this,Ee),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?F(this,Ee,a):(F(this,Ee,"*"),i.unshift(a)),i.forEach(o=>{ne(this,me,Qe).call(this,ue,x(this,Ee),o)}),this);const{strict:s,...r}=t;Object.assign(this,r),this.getPath=s??!0?t.getPath??hs:oa}route(t,n){const s=this.basePath(t);return n.routes.map(r=>{var i;let a;n.errorHandler===Bn?a=r.handler:(a=async(o,l)=>(await $n([],n.errorHandler)(o,()=>r.handler(o,l))).res,a[ga]=r.handler),ne(i=s,me,Qe).call(i,r.method,r.path,a)}),this}basePath(t){const n=ne(this,me,Ss).call(this);return n._basePath=mt(this._basePath,t),n}mount(t,n,s){let r,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?r=l=>l:r=s.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};r||(r=(()=>{const l=mt(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(r(l.req.raw),...i(l));if(d)return d;await c()};return ne(this,me,Qe).call(this,ue,mt(t,"*"),o),this}},Ee=new WeakMap,me=new WeakSet,Ss=function(){const t=new bt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,Te,x(this,Te)),t.routes=this.routes,t},Te=new WeakMap,Qe=function(t,n,s){t=t.toUpperCase(),n=mt(this._basePath,n);const r={basePath:this._basePath,path:n,method:t,handler:s};this.router.add(t,n,[s,r]),this.routes.push(r)},qt=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},zt=function(t,n,s,r){if(r==="HEAD")return(async()=>new Response(null,await ne(this,me,zt).call(this,t,n,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(r,a),o=new ma(t,{path:a,matchResult:i,env:s,executionCtx:n,notFoundHandler:x(this,Te)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await x(this,Te).call(this,o)})}catch(d){return ne(this,me,qt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:x(this,Te).call(this,o))).catch(d=>ne(this,me,qt).call(this,d,o)):c??x(this,Te).call(this,o)}const l=$n(i[0],this.errorHandler,x(this,Te));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return ne(this,me,qt).call(this,c,o)}})()},bt),xs=[];function va(e,t){const n=this.buildAllMatchers(),s=((r,a)=>{const i=n[r]||n[ue],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],xs];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=s,s(e,t)}var Jt="[^/]+",Rt=".*",Ot="(?:|/.*)",ht=Symbol(),wa=new Set(".\\+*[^]$()");function ba(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Rt||e===Ot?1:t===Rt||t===Ot?-1:e===Jt?1:t===Jt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var nt,st,Se,it,_a=(it=class{constructor(){V(this,nt);V(this,st);V(this,Se,Object.create(null))}insert(t,n,s,r,a){if(t.length===0){if(x(this,nt)!==void 0)throw ht;if(a)return;F(this,nt,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Rt]:["","",Jt]:i==="/*"?["","",Ot]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||Jt;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ht;if(c=x(this,Se)[u],!c){if(Object.keys(x(this,Se)).some(p=>p!==Rt&&p!==Ot))throw ht;if(a)return;c=x(this,Se)[u]=new it,d!==""&&F(c,st,r.varIndex++)}!a&&d!==""&&s.push([d,x(c,st)])}else if(c=x(this,Se)[i],!c){if(Object.keys(x(this,Se)).some(d=>d.length>1&&d!==Rt&&d!==Ot))throw ht;if(a)return;c=x(this,Se)[i]=new it}c.insert(o,n,s,r,a)}buildRegExpStr(){const n=Object.keys(x(this,Se)).sort(ba).map(s=>{const r=x(this,Se)[s];return(typeof x(r,st)=="number"?`(${s})@${x(r,st)}`:wa.has(s)?`\\${s}`:s)+r.buildRegExpStr()});return typeof x(this,nt)=="number"&&n.unshift(`#${x(this,nt)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},nt=new WeakMap,st=new WeakMap,Se=new WeakMap,it),Zt,jt,cs,Ea=(cs=class{constructor(){V(this,Zt,{varIndex:0});V(this,jt,new _a)}insert(e,t,n){const s=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return r[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,r[i][1]);break}}return x(this,jt).insert(a,t,s,x(this,Zt),n),s}buildRegExp(){let e=x(this,jt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,s]}},Zt=new WeakMap,jt=new WeakMap,cs),Ta=[/^$/,[],Object.create(null)],Kt=Object.create(null);function ks(e){return Kt[e]??(Kt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function Sa(){Kt=Object.create(null)}function xa(e){var c;const t=new Ea,n=[];if(e.length===0)return Ta;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[p,g])=>d?1:p?-1:u.length-g.length),r=Object.create(null);for(let d=0,u=-1,p=s.length;d<p;d++){const[g,f,b]=s[d];g?r[f]=[b.map(([T])=>[T,Object.create(null)]),xs]:u++;let w;try{w=t.insert(f,u,g)}catch(T){throw T===ht?new Ts(f):T}g||(n[u]=b.map(([T,S])=>{const R=Object.create(null);for(S-=1;S>=0;S--){const[O,M]=w[S];R[O]=M}return[T,R]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let p=0,g=n[d].length;p<g;p++){const f=(c=n[d][p])==null?void 0:c[1];if(!f)continue;const b=Object.keys(f);for(let w=0,T=b.length;w<T;w++)f[b[w]]=o[f[b[w]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,r]}function lt(e,t){if(e){for(const n of Object.keys(e).sort((s,r)=>r.length-s.length))if(ks(n).test(t))return[...e[n]]}}var Ue,He,Xt,Ds,ds,ka=(ds=class{constructor(){V(this,Xt);P(this,"name","RegExpRouter");V(this,Ue);V(this,He);P(this,"match",va);F(this,Ue,{[ue]:Object.create(null)}),F(this,He,{[ue]:Object.create(null)})}add(e,t,n){var o;const s=x(this,Ue),r=x(this,He);if(!s||!r)throw new Error(Es);s[e]||[s,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ue]).forEach(c=>{l[e][c]=[...l[ue][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ks(t);e===ue?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=lt(s[c],t)||lt(s[ue],t)||[])}):(o=s[e])[t]||(o[t]=lt(s[e],t)||lt(s[ue],t)||[]),Object.keys(s).forEach(c=>{(e===ue||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([n,a])})}),Object.keys(r).forEach(c=>{(e===ue||e===c)&&Object.keys(r[c]).forEach(d=>l.test(d)&&r[c][d].push([n,a]))});return}const i=gs(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(r).forEach(u=>{var p;(e===ue||e===u)&&((p=r[u])[d]||(p[d]=[...lt(s[u],d)||lt(s[ue],d)||[]]),r[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(x(this,He)).concat(Object.keys(x(this,Ue))).forEach(t=>{e[t]||(e[t]=ne(this,Xt,Ds).call(this,t))}),F(this,Ue,F(this,He,void 0)),Sa(),e}},Ue=new WeakMap,He=new WeakMap,Xt=new WeakSet,Ds=function(e){const t=[];let n=e===ue;return[x(this,Ue),x(this,He)].forEach(s=>{const r=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];r.length!==0?(n||(n=!0),t.push(...r)):e!==ue&&t.push(...Object.keys(s[ue]).map(a=>[a,s[ue][a]]))}),n?xa(t):null},ds),Fe,Le,us,Da=(us=class{constructor(e){P(this,"name","SmartRouter");V(this,Fe,[]);V(this,Le,[]);F(this,Fe,e.routers)}add(e,t,n){if(!x(this,Le))throw new Error(Es);x(this,Le).push([e,t,n])}match(e,t){if(!x(this,Le))throw new Error("Fatal error");const n=x(this,Fe),s=x(this,Le),r=n.length;let a=0,i;for(;a<r;a++){const o=n[a];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof Ts)continue;throw l}this.match=o.match.bind(o),F(this,Fe,[o]),F(this,Le,void 0);break}if(a===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(x(this,Le)||x(this,Fe).length!==1)throw new Error("No active router has been determined yet.");return x(this,Fe)[0]}},Fe=new WeakMap,Le=new WeakMap,us),xt=Object.create(null),Ge,fe,rt,_t,pe,Me,et,Et,Ra=(Et=class{constructor(t,n,s){V(this,Me);V(this,Ge);V(this,fe);V(this,rt);V(this,_t,0);V(this,pe,xt);if(F(this,fe,s||Object.create(null)),F(this,Ge,[]),t&&n){const r=Object.create(null);r[t]={handler:n,possibleKeys:[],score:0},F(this,Ge,[r])}F(this,rt,[])}insert(t,n,s){F(this,_t,++Mn(this,_t)._);let r=this;const a=na(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=aa(c,d),p=Array.isArray(u)?u[0]:c;if(p in x(r,fe)){r=x(r,fe)[p],u&&i.push(u[1]);continue}x(r,fe)[p]=new Et,u&&(x(r,rt).push(u),i.push(u[1])),r=x(r,fe)[p]}return x(r,Ge).push({[t]:{handler:s,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:x(this,_t)}}),r}search(t,n){var l;const s=[];F(this,pe,xt);let a=[this];const i=ps(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],p=c===d-1,g=[];for(let f=0,b=a.length;f<b;f++){const w=a[f],T=x(w,fe)[u];T&&(F(T,pe,x(w,pe)),p?(x(T,fe)["*"]&&s.push(...ne(this,Me,et).call(this,x(T,fe)["*"],t,x(w,pe))),s.push(...ne(this,Me,et).call(this,T,t,x(w,pe)))):g.push(T));for(let S=0,R=x(w,rt).length;S<R;S++){const O=x(w,rt)[S],M=x(w,pe)===xt?{}:{...x(w,pe)};if(O==="*"){const A=x(w,fe)["*"];A&&(s.push(...ne(this,Me,et).call(this,A,t,x(w,pe))),F(A,pe,M),g.push(A));continue}const[L,U,Y]=O;if(!u&&!(Y instanceof RegExp))continue;const ee=x(w,fe)[L],re=i.slice(c).join("/");if(Y instanceof RegExp){const A=Y.exec(re);if(A){if(M[U]=A[0],s.push(...ne(this,Me,et).call(this,ee,t,x(w,pe),M)),Object.keys(x(ee,fe)).length){F(ee,pe,M);const K=((l=A[0].match(/\//))==null?void 0:l.length)??0;(o[K]||(o[K]=[])).push(ee)}continue}}(Y===!0||Y.test(u))&&(M[U]=u,p?(s.push(...ne(this,Me,et).call(this,ee,t,M,x(w,pe))),x(ee,fe)["*"]&&s.push(...ne(this,Me,et).call(this,x(ee,fe)["*"],t,M,x(w,pe)))):(F(ee,pe,M),g.push(ee)))}}a=g.concat(o.shift()??[])}return s.length>1&&s.sort((c,d)=>c.score-d.score),[s.map(({handler:c,params:d})=>[c,d])]}},Ge=new WeakMap,fe=new WeakMap,rt=new WeakMap,_t=new WeakMap,pe=new WeakMap,Me=new WeakSet,et=function(t,n,s,r){const a=[];for(let i=0,o=x(t,Ge).length;i<o;i++){const l=x(t,Ge)[i],c=l[n]||l[ue],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),s!==xt||r&&r!==xt))for(let u=0,p=c.possibleKeys.length;u<p;u++){const g=c.possibleKeys[u],f=d[c.score];c.params[g]=r!=null&&r[g]&&!f?r[g]:s[g]??(r==null?void 0:r[g]),d[c.score]=!0}}return a},Et),at,ms,Oa=(ms=class{constructor(){P(this,"name","TrieRouter");V(this,at);F(this,at,new Ra)}add(e,t,n){const s=gs(t);if(s){for(let r=0,a=s.length;r<a;r++)x(this,at).insert(e,s[r],n);return}x(this,at).insert(e,t,n)}match(e,t){return x(this,at).search(e,t)}},at=new WeakMap,ms),be=class extends ya{constructor(e={}){super(e),this.router=e.router??new Da({routers:[new ka,new Oa]})}},Na=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),r=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,p){i.res.headers.set(u,p)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await r(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let p=n.allowHeaders;if(!(p!=null&&p.length)){const g=i.req.header("Access-Control-Request-Headers");g&&(p=g.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Ia(){return`  // === Karna v3.1 Frontend ===
...
`}function Ca(){return`  // === Render Core ===
  function render() {
...
`}function Ba(){return`  // === Memory Review ===
...
`}function Rs(e=""){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`);return a.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:a.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${a.join("<br>")}</p>`}).join("")}</body></html>`}function Wn(e){const t=new TextEncoder().encode(e);let n="";for(let s=0;s<t.length;s++)n+=String.fromCharCode(t[s]);return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Yt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function qn(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<img[^>]+alt=["']([^"']+)["'][^>]*>/gi,`
$1
`).replace(/<br\s*\/?>/gi,`
`).replace(/<\/t[dh]>/gi,`
`).replace(/<\/p>/gi,`
...
`).trim()}const gi=1e4,fi=15e3;async function er(e,t){try{const n=new AbortController,s=setTimeout(()=>n.abort(),fi),r=await fetch(e,{signal:n.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!r.ok)return{text:"",error:`HTTP ${r.status}`};const a=r.headers.get("content-type")||"";if(!a.includes("text/html")&&!a.includes("text/plain")&&!a.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${a.split(";")[0]}`};const i=await r.text();clearTimeout(s);const o=i.length>2e5?i.substring(0,2e5):i,l=yi(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||gi)}}catch(n){return{text:"",error:n.name==="AbortError"?"Timeout":n.message}}}function yi(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}const vi=45e3;async function wi(e,t){var r,a,i;const n=new AbortController,s=setTimeout(()=>n.abort(),vi);try{const o=await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",signal:n.signal,headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:e}],max_tokens:2e3})});if(clearTimeout(s),!o.ok)return{report:"",sources:[],pagesRead:0,error:`Perplexity error ${o.status}`};const l=await o.json(),c=((i=(a=(r=l==null?void 0:l.choices)==null?void 0:r[0])==null?void 0:a.message)==null?void 0:i.content)||"";if(!c.trim())return{report:"",sources:[],pagesRead:0,error:"Perplexity returned an empty response"};const u=(Array.isArray(l==null?void 0:l.citations)?l.citations:[]).filter(p=>typeof p=="string"&&p.startsWith("http")).map(p=>({title:p.replace(/^https?:\/\/(www\.)?/,"").split("/")[0],url:p}));return{report:c,sources:u,pagesRead:u.length}}catch(o){return clearTimeout(s),{report:"",sources:[],pagesRead:0,error:`Perplexity request failed: ${o.message}`}}}async function tr(e,t,n={}){if(n.perplexityApiKey){const p=await wi(e,n.perplexityApiKey);if(!p.error)return p}const s=n.maxPages||(n.depth==="thorough"?5:3),r=n.maxResults||(n.depth==="thorough"?8:5),a=await tn(e,{num:r,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId});if(a.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${a.error}`};if(a.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=a.results.slice(0,s).map(async p=>{const g=await er(p.link);return{title:p.title,url:p.link,displayLink:p.displayLink,snippet:p.snippet,content:g.text,error:g.error}}),c=(await Promise.all(o)).filter(p=>p.content.length>50);if(c.length===0){const p=a.results.map((f,b)=>`[${b+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await zn(e,p,t,"snippets"),sources:a.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const d=c.map((p,g)=>`--- SOURCE ${g+1}: ${p.title} (${p.displayLink}) ---
${p.content}
--- END SOURCE ${g+1} ---`).join(`

`);return{report:await zn(e,d,t,"full"),sources:c.map(p=>({title:p.title,url:p.url})),pagesRead:c.length}}async function zn(e,t,n,s){const a=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Write a synthesized research report answering the query above.`;try{return(await n.chat([{role:"system",content:a},{role:"user",content:i}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(o){return`Research synthesis error: ${o.message}. Raw search results were found but could not be analyzed.`}}const bi=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:tr,fetchPageContent:er},Symbol.toStringTag,{value:"Module"})),qe="https://api.browser-use.com/api/v2",Kn=2e4,yn=6e3,_i=3e5,xn=12e3,nr=new Set(["finished","stopped"]);async function It(e,t,n=xn){const s=new AbortController,r=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}finally{clearTimeout(r)}}async function Ei(e){const t=()=>fetch(`${qe}/sessions`,{method:"POST",headers:{"X-Browser-Use-API-Key":e,"Content-Type":"application/json"},body:JSON.stringify({})});try{let n=await t();if(!n.ok){const r=await n.text().catch(()=>"");if(rr(n.status,r)){if(console.log("[createBrowserSession] concurrency limit — reaping stale sessions and retrying"),await sr(e),n=await t(),!n.ok)return console.log(`[createBrowserSession] FAILED after reap HTTP ${n.status}`),null}else return console.log(`[createBrowserSession] FAILED HTTP ${n.status}: ${r}`),null}const s=await n.json();return console.log(`[createBrowserSession] sessionId=${s.id}`),s.id??null}catch(n){return console.log(`[createBrowserSession] ERROR ${n.message}`),null}}async function nn(e,t){try{await fetch(`${qe}/sessions/${e}`,{method:"DELETE",headers:{"X-Browser-Use-API-Key":t}}),console.log(`[closeBrowserSession] closed sessionId=${e}`)}catch{}}async function Ti(e){try{const t=await It(`${qe}/sessions?filterBy=active&pageSize=100`,{headers:{"X-Browser-Use-API-Key":e}});return t.ok?(await t.json()).items??[]:[]}catch{return[]}}async function sr(e,t){const n=await Ti(e);let s=0;for(const r of n)!r.id||t&&r.id===t||(await nn(r.id,e),s++);return s>0&&console.log(`[reapActiveBrowserSessions] closed ${s} stale session(s)`),s}function rr(e,t){const n=(t||"").toLowerCase();return/session/.test(n)?/concurrent|too many|maximum|limit|exceeded/.test(n):!1}async function ar(e,t,n){var o;const s=(n==null?void 0:n.timeoutMs)??_i;console.log(`[runBrowserTask] starting taskLen=${e.length} timeoutMs=${s} hasSecrets=${!!(n!=null&&n.secrets)} reuseSession=${!!(n!=null&&n.sessionId)}`);let r,a;try{const l={task:e};n!=null&&n.secrets&&Object.keys(n.secrets).length>0&&(l.secrets=n.secrets),n!=null&&n.sessionId&&(l.sessionId=n.sessionId);const c=()=>fetch(`${qe}/tasks`,{method:"POST",headers:{"X-Browser-Use-API-Key":t,"Content-Type":"application/json"},body:JSON.stringify(l)});let d=await c();if(!d.ok){const p=await d.text().catch(()=>"");if(rr(d.status,p)&&(console.log("[runBrowserTask] concurrency limit — reaping stale sessions and retrying"),await sr(t,n==null?void 0:n.sessionId),d=await c()),!d.ok){const g=await d.text().catch(()=>p);return console.log(`[runBrowserTask] CREATE_FAILED HTTP ${d.status}: ${g}`),{output:null,taskId:"",status:"failed",error:`HTTP ${d.status}: ${g}`}}}const u=await d.json();if(r=u.id,a=u.sessionId||void 0,console.log(`[runBrowserTask] CREATED taskId=${r} sessionId=${a}`),!r)return{output:null,taskId:"",status:"failed",error:"No id in create response"}}catch(l){return{output:null,taskId:"",status:"failed",error:l.message}}await new Promise(l=>setTimeout(l,Kn));const i=Date.now()+(s-Kn);for(;Date.now()<i;){try{const l=await It(`${qe}/tasks/${r}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(l.ok){const c=await l.json();if(nr.has(c.status)){if(c.status==="finished"){let d=c.output??null;if(!d)try{const u=await It(`${qe}/tasks/${r}`,{headers:{"X-Browser-Use-API-Key":t}},xn);if(u.ok){const p=await u.json();if(d=p.output??null,!d&&((o=p.steps)!=null&&o.length)){const g=p.steps[p.steps.length-1];d=g.extracted_content??g.output??g.result??null}}}catch{}return console.log(`[runBrowserTask] COMPLETED taskId=${r} outputLen=${(d??"").length}`),{output:d,taskId:r,sessionId:a,status:"completed"}}return console.log(`[runBrowserTask] FAILED taskId=${r} status=${c.status}`),{output:c.output??null,taskId:r,status:"failed",error:c.output??"Task was stopped before completing"}}}}catch{}await new Promise(l=>setTimeout(l,yn))}return console.log(`[runBrowserTask] TIMEOUT taskId=${r} sessionId=${a}`),{output:null,taskId:r,sessionId:a,status:"timeout"}}async function ir(e,t,n){var a;const s=(n==null?void 0:n.waitMs)??3e4,r=Date.now()+s;for(;Date.now()<r;){try{const i=await It(`${qe}/tasks/${e}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(!i.ok){await new Promise(l=>setTimeout(l,yn));continue}const o=await i.json();if(nr.has(o.status)){let l=null;const c=await It(`${qe}/tasks/${e}`,{headers:{"X-Browser-Use-API-Key":t}},xn);if(c.ok){const d=await c.json();if(l=d.output??null,!l&&((a=d.steps)!=null&&a.length)){const u=d.steps[d.steps.length-1];l=u.extracted_content??u.output??u.result??null}}else l=o.output??null;return{status:o.status,output:l,done:!0}}}catch{}await new Promise(i=>setTimeout(i,yn))}return{status:"running",output:null,done:!1}}function Si(e){return`Navigate to https://www.bluedart.com/tracking.
...
- **HARD RULE — no false confirmations**: You have ZERO tool access. You CANNOT set reminders, create schedules, send emails, read sheets, or perform any action. NEVER output phrases like "Reminder set for...", "I've scheduled...", "Done ✅", "Task created", or any language implying an action was completed. If the user wants an action, say: "I can do that — just send your message and I'll take care of it." Do NOT simulate the outcome.`;default:return""}}const ki=Object.freeze(Object.defineProperty({__proto__:null,buildSubAgentPrompt:ur,classifyIntentFast:kn,detectDeterministicOp:cr,detectTierTwoOp:dr},Symbol.toStringTag,{value:"Module"})),Di=new Set(["create_skill","list_skills","store_memory","search_memory","delete_memory","update_memory","get_schedules","delete_schedule","create_schedule","toggle_schedule","gmail_unread_count"]),Ri=3,Oi=3,mr=5,pr=.4,hr=5;async function gr(e,t,n,s,r,a,i=!0){try{const o=r.filter(f=>!Di.has(f));if(o.length<Ri)return;const c=[...[...new Set(o)]].sort().join(","),d=await e.prepare(`INSERT INTO skill_patterns (user_id, tool_signature, user_message_sample, tool_sequence, turn_count, succeeded)
       VALUES (?, ?, ?, ?, ?, ?)
...
`)}
`}catch{return""}}async function Ii(e,t,n){var i;let s=0,r=0,a=0;try{const o=await e.prepare(`SELECT us.id, us.user_id, us.name, us.instructions, us.refinement_count,
              us.confidence_score, us.usage_count
       FROM user_skills us
       WHERE us.user_id = ? AND us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < ? AND us.usage_count >= ?`).bind(n,pr,hr).all();for(const l of o.results??[]){s++;const c=await e.prepare(`SELECT user_message_sample, tool_sequence
         FROM skill_patterns
         WHERE auto_skill_id = ? AND succeeded = 1
         ORDER BY created_at DESC LIMIT 3`).bind(l.id).all();if((c.results??[]).length<2||l.refinement_count>=mr){await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),await e.prepare(`INSERT INTO notifications (user_id, type, title, body, source, is_read)
...
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const b=(((i=(await t.chat(p,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);b&&b[1].trim()&&(await e.prepare(`UPDATE user_skills
             ...
             WHERE id = ?`).bind(b[1].trim(),l.id).run(),r++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:s,rewritten:r,disabled:a}}async function Ci(e,t,n,s,r){var R;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
...
INSTRUCTIONS: <step-by-step instructions referencing exact tool names, under 200 words>`}],c=((R=(await t.chat(o,{tools:[]})).content)==null?void 0:R.trim())??"",d=c.match(/^NAME:\s*(.+)$/m),u=c.match(/^DESCRIPTION:\s*(.+)$/m),p=c.match(/^INSTRUCTIONS:\s*([\s\S]+)$/m);if(!d||!u||!p)return;const g=d[1].trim(),f=u[1].trim(),b=p[1].trim();if(!g||!f||!b)return;let w=`auto_${g.toLowerCase().replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").substring(0,40)}`;await e.prepare("SELECT id FROM user_skills WHERE user_id = ? AND slug = ?").bind(n.id,w).first()&&(w=`${w}_${Date.now().toString().slice(-4)}`);const S=await e.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, required_tools, is_auto, source)
     VALUES (?, ?, ?, ?, ?, ?, 1, 'auto')
     RETURNING id`).bind(n.id,g,w,f,b,JSON.stringify(r)).first();S!=null&&S.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE user_id = ? AND tool_signature = ?").bind(S.id,n.id,s).run()}async function Ai(e,t,n,s,r,a){var u;const i=await e.prepare("SELECT name, instructions, refinement_count FROM user_skills WHERE id = ? AND user_id = ?").bind(s,n.id).first();if(!i||i.refinement_count>=mr)return;const o=[{role:"system",content:"You are a workflow optimizer. Given an existing skill and a new usage example, decide if the instructions should be improved."},{role:"user",content:`Existing skill "${i.name}":
${i.instructions}
...
${s}
`:"",l=Jn(t,$i);let c="";try{const u=new Date;c=new Intl.DateTimeFormat("en-GB",{timeZone:e.timezone,day:"numeric",month:"short",year:"numeric"}).format(u)}catch{c=""}return`You are ${a}.
...
---
## Current Date & Time
${kr(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.${n==="telegram"?'\n\n## TELEGRAM CONSTRAINTS\n- **Essays / save to Drive**: When the user wants an essay, article, or report saved to Google Drive (or says "store/save to drive"), you MUST call `create_doc` with the **full** text in the `content` parameter — never truncate for Telegram. Do NOT paste the essay body in chat (reply with title + Doc link only). Write from your knowledge unless they asked for research — do NOT call web_search before a plain essay. One `create_doc` call with title + full content (+ optional `folder_name`).\n- **Research + save**: One web_search, then immediately create_doc or gmail_draft with the findings. Do NOT call read_url on multiple pages. Pattern: web_search → create_doc (or gmail_draft).\n- **Reminders**: When the user says "remind me in X" or "set a reminder", you MUST call create_schedule. For a specific time/date ("at 13:00", "tomorrow at noon", "next Friday at 5pm"), ALWAYS use `schedule_value` with the exact datetime in the user\'s local timezone — NEVER use `minutes_from_now` for clock-time requests (it causes wrong times). Only use `minutes_from_now` for pure duration requests like "in 30 minutes" or "in 2 hours".\n- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I\'ll now..." — just call the tool.\n- **Long content intent check**: When asked to write long-form content (essay, article, report) WITHOUT any save destination (no mention of Drive, Google Doc, or "save/store"), ask first: "Should I save the full piece as a Google Doc and send you the link, or give you a brief summary here in chat?" Default to Google Doc for anything over ~300 words. If they already said Drive/Doc/save/store, skip this question and call `create_doc` with the complete text immediately. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**':""}`}async function mn(e,t,n){var c;const r=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${n.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let a;((c=r.files)==null?void 0:c.length)>0?a=r.files[0].id:a=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:n,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${a}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:a,folderName:n}}function Vt(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").replace(/^\[calling:[^\]]*\]\s*/i,"").trim()}function kr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}const Pi={read_sheet:"read",search_memory:"read",list_schedules:"read",write_sheet:"write",append_sheet:"write",update_schedule:"write",delete_schedule:"write",gmail_send:"external_effect",create_calendar_event:"external_effect"};function Bi(e,t){const n=Pi[e]||"read";if(n==="read")return null;const s=Dr(t);return n==="write"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} requires transaction_mode=execute.`:n==="external_effect"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} can cause external side effects and needs transaction_mode=execute.`:null}const ji=["ETIMEDOUT","TIMEOUT","429","503","ECONNRESET","network"],Ui=new Set(["write_sheet","append_sheet","gmail_send","create_calendar_event","update_schedule","delete_schedule","delete_memory"]),Hi={create_schedule:{required:["name","schedule_type","action_type"],enum:{schedule_type:["interval","daily","weekly","once"]}},update_schedule:{required:["job_id"]},delete_schedule:{required:["job_id"]},write_sheet:{required:["spreadsheet_id","range","values"]},append_sheet:{required:["spreadsheet_id","range","values"]},gmail_send:{required:["to","subject","body"]}};function Fi(e){const t=String((e==null?void 0:e.message)||e||"Unknown tool error");return/timeout|timed out/i.test(t)?"TOOL_TIMEOUT":/unauthorized|forbidden|401|403/i.test(t)?"TOOL_AUTH":/not found|404/i.test(t)?"TOOL_NOT_FOUND":/rate limit|429/i.test(t)?"TOOL_RATE_LIMIT":/validation|invalid|required/i.test(t)?"TOOL_VALIDATION":"TOOL_EXECUTION_FAILED"}function Gi(e){const t=String((e==null?void 0:e.message)||e||"").toLowerCase();return ji.some(n=>t.includes(n.toLowerCase()))}function Wi(e){const t=e.query??e.q??e.search_query??e.search;return typeof t=="string"?t.trim():""}function qi(e,t){const n=Hi[e];if(n){for(const s of n.required||[])if(t[s]===void 0||t[s]===null||t[s]==="")throw new Error(`Validation failed: ${s} is required for ${e}`);for(const[s,r]of Object.entries(n.enum||{}))if(t[s]!==void 0&&!r.includes(String(t[s])))throw new Error(`Validation failed: ${s} must be one of ${r.join(", ")}`)}}function Dr(e){const t=e.transaction_mode;return t==="dry_run"||t==="confirm_required"||t==="execute"?t:"execute"}function zi(e,t){if(!Ui.has(e))return null;const n=Dr(t);return n==="dry_run"?`DRY RUN: ${e} validated. No write action was executed.`:n==="confirm_required"?`CONFIRMATION REQUIRED: ${e} is a write action. Re-run with transaction_mode=execute to proceed.`:null}const Ki=new Set(["gmail_send","gmail_draft","gmail_modify","append_sheet","create_sheet","write_sheet","create_doc","append_to_doc","rewrite_doc","create_calendar_event","create_schedule","create_skill"]),Yi=new Set(["list_schedules","search_memory","get_system_status","read_sheet","list_calendar_events","read_doc","gmail_list","gmail_read","gmail_search","gmail_unread_count","drive_list","drive_search","drive_read_file","web_search","read_url","research","browser_task_status","vault_lookup","search_places","get_place_details","get_directions","get_travel_time","translate_text","search_youtube","geocode_address","parse_document","search_library","read_library_file","list_skills"]),Ji=5;async function Ct(e,t,n,s,r,a,i,o,l,c,d,u,p,g,f){const b=Date.now();let w=!0,T="",S="";const R=r.traceId||crypto.randomUUID(),O=`${s}:${e}:${JSON.stringify(t)}`;if(Ki.has(e)&&!Yi.has(e))try{const L=await n.prepare(`SELECT tool_result FROM tool_execution_log
           WHERE user_id = ? AND tool_name = ? AND idempotency_key = ? AND success = 1
             AND created_at >= datetime('now', '-${Ji} minutes')
           ORDER BY created_at DESC
           LIMIT 1`).bind(s,e,O).first();if(L)return L.tool_result||""}catch{}try{qi(e,t);const L=Bi(e,t);if(L)return S=L,S;const U=zi(e,t);if(U)return S=U,S;const Y=2;for(let ee=1;ee<=Y;ee++)try{const re=e==="browser_task"?31e4:e==="browser_task_status"?35e3:e==="research"?18e4:9e4;S=await Promise.race([Zi(e,t,n,s,a,i,o,l,c,d,u,p,g,r.channel,f),new Promise((A,K)=>setTimeout(()=>K(new Error("Tool timed out")),re))]);break}catch(re){if(ee<Y&&Gi(re)){await new Promise(A=>setTimeout(A,250*ee));continue}throw re}return S}catch(L){throw w=!1,T=`${Fi(L)}: ${L.message||"Unknown error"}`,new Error(T)}finally{const L=Date.now()-b;try{await n.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel, idempotency_key)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,r.agentType||null,r.providerName||null,e,JSON.stringify({...t,_idempotency_key:O,_trace_id:R}).substring(0,2e3),(w?S:"").substring(0,500),w?1:0,T||null,L,r.isEnforcementRetry?1:0,r.channel||"web",O).run()}catch{}}}function Rr(e){const t=e.length;for(let n=0;n<t-1;n++){const s=e[n];if(s.role!=="user"||typeof s.content!="string")continue;const r=t-1-n,a=r<=2?12e3:r<=4?5e3:2e3;s.content.length>a&&(e[n]={...s,content:s.content.substring(0,a)+`
[...truncated in history to reduce context size]`})}}function Vi(e){const t=[];let n=[],s="",r=!1,a=0;const i=e.length;for(;a<i;){const o=e[a];if(r){if(o==='"'){if(e[a+1]==='"'){s+='"',a+=2;continue}r=!1,a++;continue}s+=o,a++;continue}if(o==='"'){r=!0,a++;continue}if(o===","){n.push(s),s="",a++;continue}if(o==="\r"&&e[a+1]===`
`){n.push(s),t.push(n),n=[],s="",a+=2;continue}if(o===`
`||o==="\r"){n.push(s),t.push(n),n=[],s="",a++;continue}s+=o,a++}for((s||n.length)&&(n.push(s),t.push(n));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function Zi(e,t,n,s,r,a,i,o,l,c,d,u,p,g,f){var w,T,S,R,O,M,L,U,Y,ee,re,A,K,X,W,se,oe,G,Q;const b=new te(n);switch(e){case"create_schedule":{const m=new Date;let y;const h=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(m.getTime()+t.minutes_from_now*60*1e3);const N=y.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[B,I,C]=(N[0]||"").split("/");t.schedule_value=`${C}-${B}-${I} ${N[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const D=parseInt(t.schedule_value,10);y=new Date(m.getTime()+D*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const D=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(D)){const[B,I]=t.schedule_value.split(":").map(Number),C=m.toLocaleString("en-US",{timeZone:h}),$=new Date(C),j=new Date($);j.setHours(B,I,0,0),j<=$&&j.setDate(j.getDate()+1);const q=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),J=new Date(j.toLocaleString("en-US",{timeZone:h})),z=q.getTime()-J.getTime();y=new Date(j.getTime()+z)}else{const[B,I]=t.schedule_value.split(":").map(Number),C=m.toLocaleString("en-US",{timeZone:h}),$=new Date(C),j=new Date($);j.setHours(B,I,0,0),j<=$&&j.setDate(j.getDate()+1);const q=Ve=>String(Ve).padStart(2,"0"),J=j.getFullYear(),z=q(j.getMonth()+1),le=q(j.getDate());t.schedule_value=`${J}-${z}-${le} ${q(B)}:${q(I)}`,t.schedule_type="once";const de=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),Pe=new Date(j.toLocaleString("en-US",{timeZone:h})),Je=de.getTime()-Pe.getTime();y=new Date(j.getTime()+Je)}}else if(t.schedule_type==="daily"){const[D,N]=t.schedule_value.split(":").map(Number),B=m.toLocaleString("en-US",{timeZone:h}),I=new Date(B),C=new Date(I);C.setHours(D,N,0,0),C<=I&&C.setDate(C.getDate()+1);const $=new Date(C.toLocaleString("en-US",{timeZone:"UTC"})),j=new Date(C.toLocaleString("en-US",{timeZone:h})),q=$.getTime()-j.getTime();y=new Date(C.getTime()+q)}else if(t.schedule_type==="weekly"){const[D,N]=t.schedule_value.split(" "),[B,I]=(N||"00:00").split(":").map(Number),$=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Je=>Je.toLowerCase()===D.toLowerCase()),j=m.toLocaleString("en-US",{timeZone:h}),q=new Date(j),J=new Date(q);J.setHours(B,I,0,0);let z=($-J.getDay()+7)%7;z===0&&J<=q&&(z=7),J.setDate(J.getDate()+z);const le=new Date(J.toLocaleString("en-US",{timeZone:"UTC"})),de=new Date(J.toLocaleString("en-US",{timeZone:h})),Pe=le.getTime()-de.getTime();y=new Date(J.getTime()+Pe)}else if(t.schedule_type==="once"){const[D,N]=t.schedule_value.split(" "),[B,I,C]=D.split("-").map(Number),[$,j]=(N||"00:00").split(":").map(Number),q=m.toLocaleString("en-US",{timeZone:h}),J=new Date(q),z=new Date(J);z.setFullYear(B,I-1,C),z.setHours($,j,0,0);const le=new Date(z.toLocaleString("en-US",{timeZone:"UTC"})),de=new Date(z.toLocaleString("en-US",{timeZone:h})),Pe=le.getTime()-de.getTime();y=new Date(z.getTime()+Pe);const Je=new Date(m.getTime()+120*1e3);if(y.getTime()<m.getTime()+60*1e3){const Ve=y.toISOString();y=Je;const Ft=` [Note: The requested time ${t.schedule_value} in ${h} resolved to ${Ve} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=Ft}}else y=new Date(m.getTime()+3600*1e3);if((t.schedule_type==="interval"||t.schedule_type==="daily"||t.schedule_type==="weekly")&&t.action_type==="custom"){const D=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(send|forward)\b.{0,40}\b(email|mail)\b|\bemail.{0,20}\bto\b|\bgmail_send\b/.test(D)&&(t.schedule_type="once")}if(t.action_type==="custom"&&t.schedule_type==="once"){const D=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(D)||(t.action_type="reminder")}if(await n.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(s,t.name,t.schedule_type,t.schedule_value).first()){const D=y.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${D} (${h}). No duplicate created.`}await n.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
`)}case"toggle_schedule":{const m=t.enabled?1:0,y=m?"active":"paused";return await n.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(m,y,t.job_id,s).run(),`Schedule ${t.job_id} ${m?"enabled (active)":"paused"}.`}case"update_schedule_state":{const m=["created","active","reminding","paused","completed"],y=t.state;if(!m.includes(y))return`Invalid state "${y}". Valid states: ${m.join(", ")}`;const h=y==="completed"||y==="paused"?0:1;return await n.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,h,t.job_id,s).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"update_schedule":{const m=t.job_id,y=c||"UTC",h=new Date,v=["updated_at = CURRENT_TIMESTAMP"],E=[];t.name&&(v.push("name = ?"),E.push(t.name)),t.description&&(v.push("description = ?"),E.push(t.description));let _=null,k=t.schedule_type,D=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){_=new Date(h.getTime()+t.minutes_from_now*60*1e3);const I=_.toLocaleString("en-US",{timeZone:y,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[C,$,j]=(I[0]||"").split("/");D=`${j}-${C}-${$} ${I[1]||"00:00"}`,k="once"}else if(k&&D){if(k==="interval")_=new Date(h.getTime()+parseInt(D,10)*60*1e3);else if(k==="daily"){const[B,I]=D.split(":").map(Number),C=new Date(h.toLocaleString("en-US",{timeZone:y})),$=new Date(C);$.setHours(B,I,0,0),$<=C&&$.setDate($.getDate()+1);const j=new Date($.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date($.toLocaleString("en-US",{timeZone:y})).getTime();_=new Date($.getTime()+j)}else if(k==="weekly"){const[B,I]=D.split(" "),[C,$]=(I||"00:00").split(":").map(Number),q=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Pe=>Pe.toLowerCase()===B.toLowerCase()),J=new Date(h.toLocaleString("en-US",{timeZone:y})),z=new Date(J);z.setHours(C,$,0,0);let le=(q-z.getDay()+7)%7;le===0&&z<=J&&(le=7),z.setDate(z.getDate()+le);const de=new Date(z.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(z.toLocaleString("en-US",{timeZone:y})).getTime();_=new Date(z.getTime()+de)}else if(k==="once"){const[B,I]=D.split(" "),[C,$,j]=B.split("-").map(Number),[q,J]=(I||"00:00").split(":").map(Number),z=new Date(h.toLocaleString("en-US",{timeZone:y})),le=new Date(z);le.setFullYear(C,$-1,j),le.setHours(q,J,0,0);const de=new Date(le.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(le.toLocaleString("en-US",{timeZone:y})).getTime();_=new Date(le.getTime()+de),_.getTime()<h.getTime()+60*1e3&&(_=new Date(h.getTime()+120*1e3))}}if(k&&(v.push("schedule_type = ?"),E.push(k)),D&&(v.push("schedule_value = ?"),E.push(D)),_&&(v.push("next_run = ?"),E.push(_.toISOString())),v.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";E.push(m,s),await n.prepare(`UPDATE cron_jobs SET ${v.join(", ")} WHERE id = ? AND user_id = ?`).bind(...E).run();const N=_?_.toLocaleString("en-US",{timeZone:y,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${m} updated.${N?` New fire time: ${N} (${y}).`:""} IMPORTANT: Use this exact time "${N}" when confirming to the user.`}case"delete_schedule":return await n.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,s).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const m=t.importance||5,y=t.type==="task"?"preference":t.type,h=m>=7?"working":"long_term";return await b.store(s,y,t.title,t.content,m,h),`Stored in ${h==="working"?"working":"long-term"} memory: [${y}] ${t.title} (importance: ${m})`}case"search_memory":{const m=await b.search(s,t.query);return m.length===0?"No matching memories found.":m.map(y=>`[id:${y.id}] [${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
`)}case"delete_memory":return await b.remove(t.id,s),`Memory entry ${t.id} deleted.`;case"update_memory":return await b.update(t.id,s,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const m=await n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(s).first(),y=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(s).first(),h=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(s).first(),v=await n.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(s).first(),E=await n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(s).first();return`System Status:
...
- Unread errors: ${(E==null?void 0:E.cnt)||0}`}case"read_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||""),y=t.spreadsheet_id;let h=t.range;const v=await m.sheets.getMetadata(y),E=v.sheets;h.includes("!")||(h=`${E[0]}!${h}`);let _;try{_=await m.sheets.readRange(y,h)}catch(D){if((w=D.message)!=null&&w.includes("Unable to parse range")||(T=D.message)!=null&&T.includes("400")){const N=h.includes("!")?h.split("!")[1]:h;h=`${E[0]}!${N}`,_=await m.sheets.readRange(y,h)}else throw D}let k=`[Spreadsheet: "${v.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${E.map(D=>`"${D}"`).join(", ")}]
...
`)}catch(m){return await H(n,s,"google","read_sheet",m.message),`Failed to read sheet: ${m.message}`}}case"write_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const I=new te(n),C=JSON.stringify(t.values);await I.store(s,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:C.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const h=t.values;let v=t.range;const k=Math.max(...h.map(I=>I.length))+4,D=h.map(I=>{const C=[...I];for(;C.length<k;)C.push("");return C}),N=v.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(N){const I=N[1]||"",C=N[2],$=N[3],j=N[5],J=C.toUpperCase().charCodeAt(0)-64+k-1,z=J<=26?String.fromCharCode(64+J):"Z";v=`${I}${C}${$}:${z}${j}`}const B=await m.sheets.writeRange(t.spreadsheet_id,v,D);try{const I=new te(n),C=await I.search(s,`Pending sheet write: ${t.spreadsheet_id}`);for(const $ of C)$.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await I.remove($.id,s)}catch{}return`Written ${B.updatedCells} cells to ${v}.`}catch(m){return await H(n,s,"google","write_sheet",m.message),`Failed to write sheet: ${m.message}`}}case"append_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new te(n).store(s,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const h=await m.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const v=new te(n),E=await v.search(s,`Pending sheet append: ${t.spreadsheet_id}`);for(const _ of E)_.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await v.remove(_.id,s)}catch{}return`Appended ${h.updatedCells} cells to ${t.range}.`}catch(m){return await H(n,s,"google","append_sheet",m.message),`Failed to append to sheet: ${m.message}`}}case"create_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title)try{await new te(n).store(s,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`
...
(Note: spreadsheet saved to Drive root — could not place in folder "${t.folder_name}": ${E.message})`}try{await new te(n).store(s,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${v}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(m){return await H(n,s,"google","create_sheet",m.message),`Failed to create spreadsheet: ${m.message}`}}case"list_calendar_events":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||""),y=t.calendar_id||"primary",h=t.days_ahead||7,v=new Date,E=new Date(v.getTime()+h*24*60*60*1e3),_=await m.calendar.listEvents(y,{timeMin:v.toISOString(),timeMax:E.toISOString(),query:t.query});return _.length===0?`No events found in the next ${h} days.`:_.map(k=>{var C;const D=k.start.dateTime||k.start.date||"TBD",N=k.end.dateTime||k.end.date||"",B=k.location?` 📍 ${k.location}`:"",I=((C=k.attendees)==null?void 0:C.map($=>$.email).join(", "))||"";return`• ${k.summary} — ${D} to ${N}${B}${I?`
  Attendees: ${I}`:""}`}).join(`
`)}catch(m){return await H(n,s,"google","list_calendar",m.message),`Failed to list events: ${m.message}`}}case"create_calendar_event":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.summary&&t.start_datetime&&t.end_datetime)try{await new te(n).store(s,"context",`Pending calendar event: "${t.summary}"`,JSON.stringify({tool:"create_calendar_event",summary:t.summary,description:t.description??null,location:t.location??null,start_datetime:t.start_datetime,end_datetime:t.end_datetime,attendees:t.attendees??null,calendar_id:t.calendar_id??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.summary&&t.start_datetime?`

The calendar event has been saved to temporary memory. After reconnecting, tell me "create the pending event" and I'll add it to your calendar.`:"")}const h=t.calendar_id||"primary",v=await m.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});try{const E=new te(n),_=await E.search(s,`Pending calendar event: "${t.summary}"`);for(const k of _)k.title.startsWith(`Pending calendar event: "${t.summary}"`)&&await E.remove(k.id,s)}catch{}return`Event created: "${v.summary}"
ID: ${v.id}
Start: ${v.start.dateTime||v.start.date}`}catch(m){return await H(n,s,"google","create_event",m.message),`Failed to create event: ${m.message}`}}case"create_doc":{if(!r)return"Authentication context unavailable.";const m=new ye(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title&&t.content){try{await new te(n).store(s,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" and I'll complete this automatically.`:"")}let h;try{h=await m.docs.createDocument(t.title)}catch(E){return await H(n,s,"google","create_doc",E.message),`Failed to create document: ${E.message}`}if(t.content){const E=t.content,_=async()=>{E.length>12e3?await m.docs.appendText(h.documentId,E):await m.docs.appendFormattedContent(h.documentId,E)};try{await _()}catch(k){try{await m.docs.appendText(h.documentId,E)}catch(D){return await H(n,s,"google","create_doc_append",D.message),`Document created but content could not be written (${D.message}).
ID: ${h.documentId}
URL: ${h.url}

Use append_to_doc with the document ID above to add content.`}await H(n,s,"google","create_doc_append_fallback",`Formatted append failed, used plain text: ${k.message}`)}}let v="";if(t.folder_name)try{const{token:E}=await(await Promise.resolve().then(()=>Xe)).getGoogleAuth(n,s,r,a||"",i||"");v=`
Folder: "${(await mn(E,h.documentId,t.folder_name)).folderName}"`}catch(E){v=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${E.message})`}try{await new te(n).store(s,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}try{const E=t.content;await n.prepare(`INSERT OR IGNORE INTO document_library (user_id, source, drive_file_id, name, summary, extracted_text, status)
           VALUES (?, 'drive', ?, ?, ?, ?, 'parsed')`).bind(s,h.documentId,t.title,E?E.substring(0,500):null,E?E.substring(0,5e4):null).run()}catch{}try{const E=new te(n),_=await E.search(s,`Pending Google Doc save: "${t.title}"`);for(const k of _)k.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await E.remove(k.id,s)}catch{}return`Document created: "${t.title}"${v}
ID: ${h.documentId}
URL: ${h.url}`}case"read_doc":{if(!r)return"Authentication context unavailable.";try{const y=await new ye(n,s,r,a||"",i||"").docs.readDocument(t.document_id);return`Document: "${y.title}"

${y.content}`}catch(m){return await H(n,s,"google","read_doc",m.message),`Failed to read document: ${m.message}`}}case"append_to_doc":{if(!r)return"Authentication context unavailable.";try{const m=new ye(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.document_id&&t.content)try{await new te(n).store(s,"context",`Pending append to doc: "${t.document_id}"`,JSON.stringify({tool:"append_to_doc",document_id:t.document_id,content:t.content}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.'+(t.document_id&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" to complete this.`:"")}await m.docs.appendFormattedContent(t.document_id,t.content);let h=t.document_id;try{h=(await m.docs.readDocument(t.document_id)).title}catch{}try{const v=new te(n),E=await v.search(s,`Pending append to doc: "${t.document_id}"`);for(const _ of E)_.title.startsWith(`Pending append to doc: "${t.document_id}"`)&&await v.remove(_.id,s)}catch{}try{const v=t.content;await n.prepare(`UPDATE document_library
...
${h}`}catch(m){return await H(n,s,"gmail","read",m.message),`Gmail read error: ${m.message}`}}case"gmail_search":{if(!r)return"Authentication context unavailable.";try{const m=Wi(t);if(!m)return"Gmail search requires a non-empty query (e.g. from:sender@example.com subject:invoice). Use Gmail search syntax.";const h=await new xe(n,s,r,a||"",i||"").search(m,t.max_results||10);return h.length===0?`No results for: ${m}`:h.map((v,E)=>`${v.isUnread?"● ":"  "}${E+1}. **${v.subject}**
   From: ${v.from}
   Date: ${v.date}
   ${v.snippet}
   [id: ${v.id}]`).join(`

`)}catch(m){await H(n,s,"gmail","search",m.message);const y=String((m==null?void 0:m.message)||m);return/403|access denied|insufficient|permission/i.test(y)?`${y} Go to Settings → Keys → Google Workspace and reconnect your account.`:`Gmail search error: ${y}`}}case"gmail_send":{if(!r)return"Authentication context unavailable.";try{const m=new xe(n,s,r,a||"",i||"");if(!(await new ye(n,s,r,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body){try{await new te(n).store(s,"context",`Pending email: "${t.subject}"`,JSON.stringify({tool:"gmail_send",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
`,k+=_.sources.map((D,N)=>`[${N+1}] [${D.title}](${D.url})`).join(`
`));try{const D=new te(n),N=_.report.substring(0,600);await D.store(s,"context",`Research: ${t.query.substring(0,80)}`,N,6,"long_term")}catch{}return k}catch(m){return await H(n,s,"research","research",m.message),`Research error: ${m.message}`}}case"browser_task":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const y=(await Z(m.encrypted_value,r)).trim();let h,v=t.task,E,_;if(!t.site_name)try{const $=await n.prepare("SELECT name FROM site_credentials WHERE user_id = ?").bind(s).all(),j=v.toLowerCase(),q=($.results||[]).find(J=>j.includes(J.name.toLowerCase()));q&&(t={...t,site_name:q.name},Yn("browser_task auto-vault: inferred site_name from task text",{siteName:q.name,userId:s}))}catch{}if(t.site_name)try{const $=await n.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(s,t.site_name).first();if($){const j=JSON.parse(await Z($.encrypted_blob,r));h={username:j.username,password:j.password},_=j.sessionId,E=$.id,v=`${v}

When prompted to log in, use username {username} and password {password}.`}}catch{}const k=async $=>{if(E)try{const j=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(E,s).first();if(!j)return;const q=JSON.parse(await Z(j.encrypted_blob,r));q.sessionId=$,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await Tt(JSON.stringify(q),r),E,s).run()}catch{}},D=async()=>{if(!(!E||!_))try{const $=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(E,s).first();if(!$)return;const j=JSON.parse(await Z($.encrypted_blob,r));delete j.sessionId,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await Tt(JSON.stringify(j),r),E,s).run()}catch{}},N=/blue[\s-]?dart[\s\S]{0,100}?(\d{10,11})|(\d{10,11})[\s\S]{0,100}?blue[\s-]?dart/i.exec(v);if(N){const $=N[1]||N[2];v=Si($)}const B=void 0;f&&(f.apiKey=y,_&&!f.sessionId?(f.sessionId=_,f.persistSession=!0):!f.sessionId&&E&&(f.sessionId=await Ei(y)??void 0)),Yn("browser_task starting",{userId:s,channel:g,timeoutMs:B??3e5,sessionId:f==null?void 0:f.sessionId,vaultSession:!!_});const I=await ar(v,y,{secrets:h,sessionId:f==null?void 0:f.sessionId,timeoutMs:B});if(I.status==="completed"){const $=(f==null?void 0:f.sessionId)??void 0;return E&&$&&(f&&(f.persistSession=!0),await k($)),(ee=I.output)!=null&&ee.includes('"captcha_required": true')?"Captcha detected — manual verification required. The site blocked automated access. Please try completing it manually or try again later.":I.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again."}if(I.status==="timeout"){f&&(f.hasActiveTask=!0);try{await new te(n).store(s,"context",`Browser task in progress: ${I.taskId}`,JSON.stringify({task_id:I.taskId,task:t.task}),9,"working")}catch{}try{const $=(t.task||"").substring(0,200);await n.prepare("INSERT INTO pending_browser_tasks (user_id, task_id, task_description, thread_id, channel) VALUES (?, ?, ?, ?, ?)").bind(s,I.taskId,$,(f==null?void 0:f.threadId)??null,g).run()}catch{}return`[BROWSER_TIMEOUT:${I.taskId}] Browser task did not finish within the time limit. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}_&&y&&nn(_,y).catch(()=>{}),f&&(f.persistSession=!1),await D();const C=[I.error,I.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${I.taskId}\`): ${C||"No details returned."} | Operator hint: Check Browser Use dashboard — taskId=${I.taskId}`}catch(m){return await H(n,s,"browser","browser_task",m.message),`Browser task error: ${m.message}`}}case"browser_task_status":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured.";const y=await Z(m.encrypted_value,r),h=await ir(t.task_id,y);if(h.done){try{const v=new te(n),E=await v.search(s,`Browser task in progress: ${t.task_id}`);for(const _ of E)await v.remove(_.id,s)}catch{}return h.status==="finished"||h.status==="completed"?h.output?h.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${h.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${h.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}catch(m){return await H(n,s,"browser","browser_task_status",m.message),`Browser status check error: ${m.message}`}}case"vault_lookup":try{const m=(t.site_name||"").trim();if(!m)return"No site name provided.";const h=((await n.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(s,`%${m}%`).all()).results||[]).map(v=>v.name);return h.length===0?`No vault entries found matching "${m}".`:`Vault entries matching "${m}": ${h.join(", ")}. Use site_name="${h[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await Z(m.encrypted_value,r),h=await zs(y,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((v,E)=>{const _=v.rating?` ★${v.rating} (${v.userRatingsTotal||0} reviews)`:"",k=v.openNow!==void 0?v.openNow?" · Open now":" · Closed":"",D=v.googleMapsUri?`
   ${v.googleMapsUri}`:"";return`${E+1}. **${v.name}**${_}${k}
   ${v.address}${D}
   [place_id: ${v.placeId}]`}).join(`

`)}catch(m){return await H(n,s,"google_api","search_places",m.message),`Places search error: ${m.message}`}}case"get_place_details":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Z(m.encrypted_value,r),h=await Ks(y,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const v=h.details;let E=`**${v.name}**
...
— ${_.author} (★${_.rating}, ${_.time}): "${_.text}"`}return E}catch(m){return await H(n,s,"google_api","place_details",m.message),`Place details error: ${m.message}`}}case"get_directions":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Z(m.encrypted_value,r),h=await Ys(y,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const v=h.route;let E=`**${v.startAddress}** → **${v.endAddress}**
`;return E+=`📏 ${v.distance} · ⏱️ ${v.duration}`,v.durationInTraffic&&(E+=` (with traffic: ${v.durationInTraffic})`),E+=`
via ${v.summary}`,E+=`

Steps:`,v.steps.forEach((_,k)=>{E+=`
${k+1}. ${_.instruction} (${_.distance}, ${_.duration})`}),E}catch(m){return await H(n,s,"google_api","directions",m.message),`Directions error: ${m.message}`}}case"get_travel_time":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Z(m.encrypted_value,r),h=await Qs(y,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let v=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(v+=` (with traffic: ${h.durationInTraffic})`),v}catch(m){return await H(n,s,"google_api","travel_time",m.message),`Travel time error: ${m.message}`}}case"translate_text":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Z(m.encrypted_value,r),h=await Js(y,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(m){return await H(n,s,"google_api","translate",m.message),`Translation error: ${m.message}`}}case"search_youtube":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Z(m.encrypted_value,r),h=await Zs(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((v,E)=>{var _;return`${E+1}. **${v.title}**
   ${v.channelTitle} · ${((_=v.publishedAt)==null?void 0:_.split("T")[0])||""}
   ${v.description}
   ${v.url}`}).join(`

`)}catch(m){return await H(n,s,"google_api","youtube_search",m.message),`YouTube search error: ${m.message}`}}case"geocode_address":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const y=await Z(m.encrypted_value,r),h=await Vs(y,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((v,E)=>`${E+1}. ${v.address}
...
${k.substring(0,2e4)}`}catch{return`Could not decode text file: ${v}`}if(E==="application/pdf"||E==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||v.toLowerCase().endsWith(".pdf")||v.toLowerCase().endsWith(".docx")){if(E==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||v.toLowerCase().endsWith(".docx")){try{const N=await or(Buffer.from(_,"base64"));if(N.length>50){try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(N,m,s).run();const B=N.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(B,N.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const I=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(I){const{indexDocumentChunks:C}=await Promise.resolve().then(()=>We);C({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,I.id,N).catch(()=>{})}}}catch{}return`Document: ${v}

${N.substring(0,2e4)}`}}catch{}return`Could not extract text from "${v}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let k=null,D="claude-haiku-4-5-20251001";for(const N of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const B=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,N).first();if(B&&r){const I=await Z(B.encrypted_value,r),C=JSON.parse(I);if(C.provider==="anthropic"){k=C.apiKey,C.model&&(D=C.model);break}}}catch{}if(k)try{const N=y?`Focus specifically on extracting: ${y}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",B=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:_}},{type:"text",text:N}]}]})});if(B.ok){const C=((A=(re=(await B.json()).content)==null?void 0:re[0])==null?void 0:A.text)||"";if(C&&C.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(C,m,s).run();const $=C.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind($,C.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const j=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(j){const{indexDocumentChunks:q}=await Promise.resolve().then(()=>We);q({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,j.id,C).catch(()=>{})}}}catch{}return`Document: ${v}

${C}`}else{const I=await B.text();return`Could not parse ${v} via Anthropic API: ${I.substring(0,200)}`}}catch(N){return`Document parsing error for ${v}: ${N.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}if(E.startsWith("image/")){let k=null,D="claude-haiku-4-5-20251001";for(const B of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const I=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,B).first();if(I&&r){const C=await Z(I.encrypted_value,r),$=JSON.parse(C);if($.provider==="anthropic"){k=$.apiKey,$.model&&(D=$.model);break}}}catch{}if(!k)return"To extract text from images, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set.";const N=y?`Focus specifically on: ${y}`:"Extract all visible text from this image. Include any text from signs, documents, screenshots, or diagrams. If the image contains charts or tables, describe their structure and data.";try{const B=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:E,data:_}},{type:"text",text:N}]}]})});if(B.ok){const C=((X=(K=(await B.json()).content)==null?void 0:K[0])==null?void 0:X.text)||"";if(C&&C.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(C,m,s).run();const $=C.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind($,C.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const j=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(j){const{indexDocumentChunks:q}=await Promise.resolve().then(()=>We);q({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,j.id,C).catch(()=>{})}}}catch{}return`Document: ${v}

${C}`}else{const I=await B.text();return`Could not parse ${v} via Anthropic API: ${I.substring(0,200)}`}}catch(B){return`Image parsing error for ${v}: ${B.message}`}}try{const k=Buffer.from(_,"base64").toString("utf-8").substring(0,2e3);return`Document: ${v} (${E})

Content preview:
${k}`}catch{return`Cannot read file: ${v} (${E})`}}case"search_library":{const m=t.query,y=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!m)return"query is required for search_library.";if(p!=null&&p.ai&&(p!=null&&p.vectorize))try{const{semanticDocumentSearch:k}=await Promise.resolve().then(()=>We),D=await k({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,m,y);if(D.length>0){const N=D.map(B=>`[id:${B.document_id}] "${B.filename}" (relevance: ${(B.relevance_score*100).toFixed(1)}%)
...
Use read_library_file with the id to get the full document text.`}}catch{}const h=await n.prepare(`
      ...
      `).bind(s,`%${m}%`,`%${m}%`,`%${m}%`,y).all(),v=await n.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(s,s,`%${m}%`,s,`%${m}%`,`%${m}%`,`%${m}%`,y).all(),E=[...h.results||[],...v.results||[]].slice(0,y);if(E.length===0)return`No documents found matching "${m}" in your library.`;const _=E.map(k=>{const D=(k.summary||k.dl_extracted||"").substring(0,200);return`[id:${k.id}] "${k.name}" (source: ${k.source}, status: ${k.status})
...
Use read_library_file with the id to get full text.`}case"read_library_file":{const m=String(t.id_or_name||"").trim();if(!m)return"id_or_name is required for read_library_file.";const y=parseInt(m,10);let h=null;if(isNaN(y)||(h=await n.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           ...
           FROM document_library dl WHERE dl.user_id = ? AND dl.name LIKE ? LIMIT 1`).bind(s,`%${m}%`).first()),!h)return`Document "${m}" not found. Use search_library to find available documents.`;let v=h.extracted_text||null;if(!v&&h.file_id){const E=await n.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(h.file_id,s).first();v=(E==null?void 0:E.extracted_text)||null}return v||(v=h.summary||null),v?`Document: ${h.name}

${v.substring(0,2e4)}`:`Document "${h.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${h.file_id}") to extract the text first.`}case"create_skill":{const m=(W=t.name)==null?void 0:W.trim(),y=(se=t.description)==null?void 0:se.trim(),h=(oe=t.instructions)==null?void 0:oe.trim();if(!m||!y||!h)return"create_skill requires name, description, and instructions.";let v=m.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");v||(v=`skill_${Date.now()}`);const E=await n.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(s,`${v}%`).all();(G=E.results)!=null&&G.some(N=>N.slug===v)&&(v=`${v}_${(((Q=E.results)==null?void 0:Q.length)||0)+1}`);const _=JSON.stringify(t.parameters||{}),k=JSON.stringify(t.required_tools||[]),D=JSON.stringify(t.examples||[]);return await n.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,m,v,y,h,_,k,D).run(),`Skill created: **${m}** (invoke as: "${v}")

You can now ask me to run "${m}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${m} skill" to execute it.`}case"list_skills":{const y=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",v=(await n.prepare(y).bind(s).all()).results||[];if(v.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const E=v.map(_=>`• **${_.name}** (${_.slug}): ${_.description} [used ${_.usage_count} times${_.enabled?"":" — disabled"}]`).join(`
`);return`Your custom skills (${v.length}):

${E}`}default:{const m=e,y=await n.prepare("SELECT id, name, description, instructions, required_tools FROM user_skills WHERE user_id = ? AND slug = ? AND enabled = 1").bind(s,m).first();if(y){await n.prepare("UPDATE user_skills SET usage_count = usage_count + 1, last_used_at = CURRENT_TIMESTAMP WHERE id = ?").bind(y.id).run();const h=(()=>{try{return JSON.parse(y.required_tools).join(", ")}catch{return""}})(),v=Object.keys(t).length>0?`
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function Or(e,t,n,s,r){if(t.length>0&&t[t.length-1].role==="user"){const a="(Previous request did not complete. Please try again.)";await e.storeMessage(n,s,"assistant",a,"{}",r),t.push({id:-1,user_id:n,channel:s,role:"assistant",content:a,metadata:"{}",token_estimate:a.length,created_at:new Date().toISOString()})}}function Nr(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const n=typeof e[t].content=="string"?e[t].content:"";n.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(n.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function Zn(e,t,n,s,r,a,i){var se,oe,G,Q,m;const o=new te(t),l=(se=e.metadata)==null?void 0:se.thread_id,c=Date.now(),[d,u,p]=await Promise.all([o.buildContext(s.id),Cn(t,s.id),fr(t,s.id)]),g=await o.getRecentConversations(s.id,30,l);await Or(o,g,s.id,e.channel,l);const f=xr(s,d,e.channel,u,p),b=Nn(g),w=Sr([{role:"system",content:f},...On(g),{role:"user",content:e.text}]);Tr(w,b),Nr(w);const T=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],S=(d.match(/^- /gm)||[]).length;if(T.some(y=>y.test(e.text))||S<3)try{const y=await o.searchLongTerm(s.id,e.text,5);if(y.length>0){const h=y.map(v=>`- [${v.type}] ${v.title}: ${v.content}`).join(`
...
`)){const p=u.trim().split("|");if(p.length<4)continue;const[g,f,b,w]=p,T=["fact","preference","context","decision","summary","task"].find(R=>R===g.trim().toLowerCase());if(!T||!(f!=null&&f.trim())||!(b!=null&&b.trim()))continue;const S=Math.min(10,Math.max(1,parseInt(w)||5));await s.store(n.id,T,f.trim(),b.trim(),S,"long_term")}}const Xn={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Qi(e){for(const[t,n]of Object.entries(Xn))if(e.toLowerCase().includes(t.toLowerCase()))return n;return Xn.default}function eo(e,t,n,s){const r=Qi(s),a=Math.floor(r*.75),i=[];let o=0,l=!1;const c=un(e);i.push({role:"system",content:e}),o+=c;const d=un(n);o+=d;const u=a-o,p=[];let g=0;for(let f=t.length-1;f>=0;f--){const b=t[f],w=un(b.content);if(g+w<=u)p.unshift({role:b.role,content:b.content}),g+=w;else{l=!0;break}}return i.push(...p),i.push({role:"user",content:n}),o+=g,{maxTokens:r,usedTokens:o,messages:i,wasTruncated:l}}async function*to(e,t,n,s,r,a){var W,se,oe;const i=new te(t),o=(W=e.metadata)==null?void 0:W.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:n.name}};const[c,d,u]=await Promise.all([i.buildContext(s.id),Cn(t,s.id),fr(t,s.id)]),p=await i.getRecentConversations(s.id,30,o);await Or(i,p,s.id,e.channel,o);const g=xr(s,c,e.channel,d,u),f=Nn(p),b=On(p);let w=e.text;f&&(w=`${wn}

${e.text}`);const T=eo(g,b.map(G=>({role:G.role,content:G.content})),w,n.name);await i.storeMessage(s.id,e.channel,"user",e.text,"{}",o);const S=await In(t,s.id),R=10;let O="",M=0;const L=[...T.messages],U=[];let Y,ee=0,re=0;const A={hasActiveTask:!1,persistSession:!1,threadId:o,channel:e.channel};Nr(L);const K=()=>br(U,Y);for(let G=0;G<R;G++){ee=G+1;try{G>0&&(yield{type:"thinking",data:{threadId:o}},Rr(L));const Q=await n.chat(L,{tools:S});if(Q.usage&&(M+=Q.usage.promptTokens+Q.usage.completionTokens),Q.toolCalls&&Q.toolCalls.length>0){const h=((se=Q.content)==null?void 0:se.trim())??"";h&&h.length<=150&&!/^\[calling:/i.test(h)&&(yield{type:"chunk",data:{text:Q.content,threadId:o}});const v=Q.content||"(tools executed)";L.push({role:"assistant",content:v});const E=[];for(const _ of Q.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:o}},U.push(_.name);try{const k=(C,$)=>Ct(C,$,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},A);let D;if(_.name==="browser_task"||_.name==="browser_task_status"){if(_.name==="browser_task"){const J=_.arguments.site_name;yield{type:"browser_ack",data:{message:J?`Starting now — opening ${J} in a browser. I'll notify you when done.`:"Starting now — running browser task. I'll notify you when done.",startedAt:new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:s.timezone||"UTC"}),threadId:o}}}const $=["Still working — browser launched, navigating to site...","Still working — page loaded, scanning for content...","Still working — reading and extracting results...","Still working — almost there, finalising output...","Taking a bit longer — site may require extra steps...","Still running — browser is working through the page...","Continuing — extracting and processing data...","Still going — complex task, nearly there...","Almost done — wrapping up the browser session...","Still running — holding on a little longer...","Browser is still active — this one is taking time...","Patience — still working through the task...","Still running — will have a result for you shortly..."],j=k(_.name,_.arguments);let q=0;e:for(;;){const J=await Promise.race([j.then(z=>({done:!0,r:z})),new Promise(z=>setTimeout(()=>z({done:!1}),15e3))]);if(J.done){D=J.r;break e}_.name==="browser_task"?yield{type:"browser_progress",data:{message:$[Math.min(q,$.length-1)],elapsed_s:(q+1)*15,threadId:o}}:yield{type:"thinking",data:{threadId:o}},q++}if(_.name==="browser_task"){const J=D.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(J){yield{type:"browser_progress",data:{message:"Task still running — checking final status...",threadId:o}};const z=k("browser_task_status",{task_id:J[1]});e:for(;;){const le=await Promise.race([z.then(de=>({done:!0,r:de})),new Promise(de=>setTimeout(()=>de({done:!1}),15e3))]);if(le.done){D=le.r;break e}yield{type:"thinking",data:{threadId:o}}}if(!D.startsWith("[still-running]")&&!D.startsWith("[NO-OUTPUT]")&&!D.startsWith("Browser"))try{await t.prepare("DELETE FROM pending_browser_tasks WHERE user_id = ? AND task_id = ? AND notified = 0").bind(s.id,J[1]).run()}catch{}}}}else D=await k(_.name,_.arguments);let N=D;(_.name==="browser_task"||_.name==="browser_task_status")&&(/^\[BROWSER_TIMEOUT:/.test(N)?N="Task timed out — still running in background.":/^\[NO-OUTPUT\]/.test(N)?N="Browser task finished but returned no content.":/^\[still-running\]/.test(N)?N="Still running — will notify when done.":N=N.replace(/\s*\|\s*Operator hint:.*$/s,"")),yield{type:"tool_end",data:{tool:_.name,toolResult:N.substring(0,500)+(N.length>500?"...":""),threadId:o}};const B=["parse_document","drive_read_file","read_library_file"].includes(_.name)?2e4:8e3,I=D.length>B?D.substring(0,B)+`
[...result truncated to prevent token limit — full content was extracted]`:D;Y=Er(_.name,_.arguments,D,Y),E.push(`[Tool Result for ${_.name}]: ${I}`)}catch(k){re++,await H(t,s.id,"tool",_.name,k.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${k.message||"Execution failed"}`,threadId:o}},E.push(`[Tool Error for ${_.name}]: ${k.message||"Execution failed"}`)}}L.push({role:"user",content:E.join(`

`)});continue}O=Q.content;const m=Vt(O);await i.storeMessage(s.id,e.channel,"assistant",m,K(),o);const y=50;for(let h=0;h<m.length;h+=y)yield{type:"chunk",data:{text:m.substring(h,h+y),threadId:o}},h+y<m.length&&await new Promise(E=>setTimeout(E,10));break}catch(Q){if(r){const h=Q.message||"",v=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),E=h.includes("429"),_=v?1440:E?10:5;await r.recordError(n.name,h,_)}await H(t,s.id,"llm","provider_error",Q.message||"Unknown LLM error",{provider:n.name,turn:G});const m=Q.message||"An error occurred",y=m.includes("429")||m.toLowerCase().includes("rate limit")||m.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":m;try{await i.storeMessage(s.id,e.channel,"assistant",`⚠️ ${y}`,"{}",o)}catch{}yield{type:"error",data:{error:y,threadId:o}};return}}if(O=(O==null?void 0:O.trim())??"",!O)try{L.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),O=(await n.chat(L,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const Q=Vt(O);await i.storeMessage(s.id,e.channel,"assistant",Q,K(),o);const m=50;for(let y=0;y<Q.length;y+=m)yield{type:"chunk",data:{text:Q.substring(y,y+m),threadId:o}},y+m<Q.length&&await new Promise(h=>setTimeout(h,10))}catch{O="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(s.id,e.channel,"assistant",O,K(),o).catch(()=>{}),yield{type:"chunk",data:{text:O,threadId:o}}}if(r&&M>0)try{await r.recordUsage(n.name,M)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"full",M,Date.now()-l,1,e.channel).run()}catch{}const X=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const G of X){const Q=G.claimPattern.test(O),m=G.requiredTools.some(y=>U.includes(y));if(Q&&!m){try{await H(t,s.id,"llm",G.logType,"LLM claimed action without tool call (streaming)",{response:O.substring(0,200)}),L.push({role:"assistant",content:O}),L.push({role:"user",content:G.enforcementMsg});const y=await n.chat(L,{tools:S.filter(h=>G.requiredTools.includes(h.name)),temperature:0});if((oe=y.toolCalls)!=null&&oe.length){for(const v of y.toolCalls){const E=await Ct(v.name,v.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});U.push(v.name),L.push({role:"assistant",content:"",toolCalls:y.toolCalls}),L.push({role:"user",content:E})}const h=await n.chat(L,{tools:[]});h.content&&(O=h.content)}else O="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}U.length>=3&&Promise.race([gr(t,n,s,e.text,U,ee,re===0),new Promise(G=>setTimeout(G,6e3))]).catch(()=>{}),A.sessionId&&A.apiKey&&!A.hasActiveTask&&!A.persistSession&&nn(A.sessionId,A.apiKey).catch(()=>{}),yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:M}}}async function Qn(e,t,n,s,r,a,i,o){await a.storeMessage(r.id,t.channel,"user",t.text,"{}",o);const l=await Ct(e.tool,e.args,n,r.id,{agentType:"direct",channel:t.channel},r.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,r.timezone,s,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),c=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await a.storeMessage(r.id,t.channel,"assistant",c,"{}",o),l}async function An(e,t,n,s,r,a){var b;const i=new te(t),o=(b=e.metadata)==null?void 0:b.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=kn(e.text,l,_r(c));if(d.agent==="conversation")return Ir(e,t,n,s,l,r,o);const u=cr(e.text);if(u)return Qn(u,e,t,n,s,i,a,o);const p=(await i.getRecentConversations(s.id,10,o)).map(w=>w.content).join(`
`),g=dr(e.text,p);if(g)return Qn(g,e,t,n,s,i,a,o);const f=d.confidence>=.85;if(e.channel==="telegram"){const w=await In(t,s.id);return Zn(e,t,n,s,r,a,{maxTurns:10,tools:w,forceToolUseOnFirstTurn:f})}return Zn(e,t,n,s,r,a,{forceToolUseOnFirstTurn:f})}async function Ir(e,t,n,s,r,a,i){const o=new te(t),l=Date.now(),c=kr(s.timezone),d=await Cn(t,s.id),u=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${r}`:r,p=ur("conversation",s,u,s.timezone,c,e.channel),g=(await o.getRecentConversations(s.id,30,i)).filter(R=>!R.content.startsWith("[Autonomous Scheduled Task]")&&!R.content.startsWith("[Scheduled Reminder]")),f=Nn(g),b=Sr([{role:"system",content:p},...On(g),{role:"user",content:e.text}]);Tr(b,f),await o.storeMessage(s.id,e.channel,"user",e.text,"{}",i);let w=0,T="";try{const R=await n.chat(b,{temperature:.8});R.usage&&(w=R.usage.promptTokens+R.usage.completionTokens),T=R.content}catch(R){if(a){const O=R.message||"",M=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),L=O.includes("429"),U=M?1440:L?10:5;await a.recordError(n.name,O,U)}throw await H(t,s.id,"llm","conversation_error",R.message,{provider:n.name}),R}if(a&&w>0)try{await a.recordUsage(n.name,w)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"conversation",w,Date.now()-l,1,e.channel).run()}catch{}const S=Vt(T);return await o.storeMessage(s.id,e.channel,"assistant",S,"{}",i),S}async function*no(e,t,n,s,r,a){var u;const i=new te(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=kn(e.text,l,_r(c));if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){yield*to(e,t,n,s,r,a);return}try{const p=await Ir(e,t,n,s,l,r,o),g=50;for(let f=0;f<p.length;f+=g)yield{type:"chunk",data:{text:p.substring(f,f+g),threadId:o}},f+g<p.length&&await new Promise(b=>setTimeout(b,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const ce=new be;async function so(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,role:s.role,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}ce.use("/*",so);ce.get("/threads",async e=>{const t=e.get("user"),n=e.req.query("archived")==="1",s=parseInt(e.req.query("limit")||"30"),r=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const c of a)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=r;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:s,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Ke(e.env.DB,t.id,t.pin_hash),u=new ReadableStream({async start(p){const g=new TextEncoder;try{const f=no(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const b of f)b.data.threadId||(b.data.threadId=o),p.enqueue(g.encode(es(b)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),p.close()}catch(f){const b={type:"error",data:{error:f.message||"An error occurred",threadId:o}};p.enqueue(g.encode(es(b))),p.close()}}});return new Response(u,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});ce.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
`+g,b=await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0) RETURNING id").bind(r.user_id,"reminder",o,g,"cron:"+r.id).first(),w=b==null?void 0:b.id;return d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(r.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:r.id})).run(),r.telegram_chat_id&&await Cr(e.env.DB,r.user_id,r.telegram_chat_id,f,w),e.json({job_id:s,status:"completed",response_length:c.length})});async function Ar(e){var s;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return null;const n=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(n==null?void 0:n.user_id)||null}De.get("/health/tools",async e=>{var n;const t=await Ar(e);if(!t)return e.json({error:"Not authenticated"},401);try{const s=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function ao(e,t,n,s){return n==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:n==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
${c.output.substring(0,500)}${c.output.length>500?"...":""}`):c.status==="finished"?(u="Browser task completed (no output)",p=`${d} finished, but the browser returned no readable content. You may want to retry.`):(u="Browser task ended",p=`${d} ended with status "${c.status}". Check the browser dashboard for details.`),i.thread_id){const g=c.status==="finished"&&c.output?c.output.substring(0,8e3):p,f=Math.ceil(g.length/4);try{await e.env.DB.prepare(`INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id)
               VALUES (?, ?, 'assistant', ?, '{}', ?, ?)`).bind(i.user_id,i.channel||"web",g,f,i.thread_id).run()}catch{}}try{await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, 'info', ?, ?, ?, 0)").bind(i.user_id,u,p,`browser_task:${i.task_id}`).run()}catch{}i.telegram_chat_id&&await Cr(e.env.DB,i.user_id,i.telegram_chat_id,`*${u}*

${p}`),await e.env.DB.prepare("UPDATE pending_browser_tasks SET notified = 1 WHERE id = ?").bind(i.id).run(),r++,await new Promise(g=>setTimeout(g,200))}catch{}}}catch{}return e.json({checked:s,notified:r})});De.get("/scorecard/weekly",async e=>{var u;const t=(u=e.req.header("Authorization"))==null?void 0:u.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=n.user_id,r=new Date(Date.now()-10080*60*1e3).toISOString(),[a,i,o]=await Promise.all([e.env.DB.prepare(`SELECT COUNT(*) as total,
       ...
       FROM conversations
       WHERE user_id = ? AND role = 'assistant' AND created_at >= ? AND (content LIKE '%[S1]%' OR content LIKE '%source%')`).bind(s,r).first()]),l=Number((a==null?void 0:a.total)||0),c=Number((a==null?void 0:a.success_count)||0),d=l?c/l:0;return e.json({window:"7d",task_success_rate:Number(d.toFixed(3)),groundedness_rate_hint:Number((Number((o==null?void 0:o.cited_responses)||0)/Math.max(1,l)).toFixed(3)),avg_latency_ms:Math.round(Number((a==null?void 0:a.avg_latency)||0)),p95_latency_hint_ms:Math.round(Number((a==null?void 0:a.p95_latency_hint)||0)),fallback_frequency_hint:Number((Number((i==null?void 0:i.retry_count)||0)/Math.max(1,l)).toFixed(3)),totals:{total_tool_calls:l,successful_tool_calls:c}})});function io(e,t,n,s){return{userId:e,username:t,channel:"telegram",text:n,sessionId:`telegram-${s}`,timestamp:new Date().toISOString()}}function oo(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const lo=["llm_slot_1","llm_slot_2","llm_slot_3"],co=["openai","groq"];function ns(e,t){const n=t==null?void 0:t.trim();if(!n)return null;const s=e.trim().toLowerCase();return s==="openai"?{url:"https://api.openai.com/v1/audio/transcriptions",apiKey:n,model:"whisper-1"}:s==="groq"?{url:"https://api.groq.com/openai/v1/audio/transcriptions",apiKey:n,model:"whisper-large-v3"}:null}function uo(e){var t,n;return((t=e.apiKey)==null?void 0:t.trim())||((n=e.api_key)==null?void 0:n.trim())}async function mo(e,t,n){for(const s of lo){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await Z(r.encrypted_value,n),i=JSON.parse(a),o=uo(i);if(i.provider&&o){const l=ns(i.provider,o);if(l)return l}}catch(a){console.error(`[telegram stt] Failed to load ${s}:`,a)}}for(const s of co){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await Z(r.encrypted_value,n),i=ns(s,a);if(i)return i}catch(a){console.error(`[telegram stt] Failed to load legacy ${s}:`,a)}}return null}const Lr=["message","callback_query"],po=4e3,ho=1e4,go=3e4;async function ke(e,t={}){const n=new AbortController,s=setTimeout(()=>n.abort(),ho);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function ss(e){const t=new AbortController,n=setTimeout(()=>t.abort(),go);try{return await fetch(e,{signal:t.signal})}finally{clearTimeout(n)}}async function ae(e,t,n,s="Markdown",r,a){var c,d;const i=yo(n,po),o=[];let l=!0;for(let u=0;u<i.length;u++){const p=i[u];let g=!1,f="";for(let b=0;b<3;b++)try{const w=await ke(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p,parse_mode:s,disable_web_page_preview:!1})});if(w.ok){g=!0;break}const T=await w.json().catch(()=>null);if(f=`HTTP ${w.status}: ${(T==null?void 0:T.description)||"Unknown error"}`,(c=T==null?void 0:T.description)!=null&&c.includes("parse")||(d=T==null?void 0:T.description)!=null&&d.includes("entities")){if((await ke(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p})})).ok){g=!0;break}f+=" (plain-text retry also failed)"}if(w.status===429||w.status>=500){const S=Math.pow(2,b)*1e3;await new Promise(R=>setTimeout(R,S));continue}break}catch(w){if(f=`Network error: ${w.message}`,b<2){const T=Math.pow(2,b)*1e3;await new Promise(S=>setTimeout(S,T));continue}}g||(l=!1,o.push(`Chunk ${u+1}/${i.length}: ${f}`))}if(!l&&r&&a&&o.length>0)try{const{logError:u}=await Promise.resolve().then(()=>gt);await u(r,a,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function fo(e,t){try{await ke(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function yo(e,t){if(e.length<=t)return[e];const n=[];let s=e;for(;s.length>0;){if(s.length<=t){n.push(s);break}let r=s.lastIndexOf(`
`,t);r<t*.3&&(r=s.lastIndexOf(" ",t)),r<t*.3&&(r=t),n.push(s.substring(0,r)),s=s.substring(r).trimStart()}return n}function vo(e){const t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`}async function wo(e,t,n){const r={reminder:"⏰",mail:"✉️",calendar:"📅",error:"⚠️",system:"⚙️"}[n.type]||"🔔",a={daily:"📅 Daily",weekly:"📅 Weekly",once:"✓ Once"},i=n.schedule_type?` · _${a[n.schedule_type]||"⏱ Repeating"}_`:"",o=n.body?`
`+n.body.substring(0,150)+(n.body.length>150?"…":""):"",l=`${r} *${n.title}*${i}
_${vo(n.created_at)}_${o}`,c=Mr(n.id);if(!(await ke(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l,parse_mode:"Markdown",reply_markup:{inline_keyboard:c}})})).ok){const u=await ke(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l.replace(/[_*`[\]]/g,""),reply_markup:{inline_keyboard:c}})});u.ok||console.warn("[sendNotifMessage] plain-text fallback also failed:",t,u.status)}}async function bo(e,t,n,s,r){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(s==null?void 0:s.name)||"there",o=(s==null?void 0:s.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
`),"Markdown",r,s.id);g.success||console.warn(`[/tasks] Failed to send message: ${g.errors.join(" | ")}`)}catch(i){const o=await ae(n,t,"❌ Could not fetch tasks: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/notifications":case"/notif":{if(!s){const i=await ae(n,t,"⚠️ Account not linked.","Markdown",r);return i.success||console.warn(`[/notifications] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await r.prepare(`
          ...
          LIMIT 5
        `).bind(s.id).all()).results||[];if(o.length===0){const c=await ae(n,t,"🎉 No pending notifications. You're all caught up.","Markdown",r,s.id);return c.success||console.warn(`[/notifications] Failed to send message: ${c.errors.join(" | ")}`),!0}const l=await ae(n,t,`📬 *${o.length} pending notification${o.length>1?"s":""}:*`,"Markdown",r,s.id);l.success||console.warn(`[/notifications] Failed to send header: ${l.errors.join(" | ")}`);for(const c of o)await wo(n,t,c)}catch(i){const o=await ae(n,t,"❌ Could not fetch notifications: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/notifications error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}async function _o(e,t){var r,a,i,o,l,c;const n=t.db,s=t.env;console.log(`[telegram webhook] envVars keys=${Object.keys(s).join(",")}`);try{if(e.callback_query){await xo(n,e.callback_query);return}const d=e.message;if(!d)return;const u=!!d.text,p=!!d.voice,g=!!d.document,f=!!d.photo,b=!!d.caption;if(!u&&!p&&!g&&!f)return;const w=String(d.chat.id);let T=d.text||"";const S=await n.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(w).first();let R=null;if(S){const A=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(S.id,"telegram_bot_token").first();A&&(R=await Z(A.encrypted_value,S.pin_hash))}if(!R){const A=await n.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();A&&(R=await Z(A.encrypted_value,A.pin_hash))}if(!R||T.startsWith("/")&&await bo(T,w,R,S,n))return;if(!S){const A=await ae(R,w,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${w}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",n);A.success||console.warn(`Failed to send unlinked account message: ${A.errors.join(" | ")}`);return}if(d.voice&&R&&S)try{if((d.voice.file_size??0)>20*1024*1024){const W=await ae(R,w,"⚠️ Voice note is too large to process (max 20 MB).","Markdown",n,S.id);W.success||console.warn(`[voice size] Failed to send message: ${W.errors.join(" | ")}`);return}const A=await ae(R,w,"🎤 Processing voice note...","Markdown",n,S.id);A.success||console.warn(`[voice start] Failed to send message: ${A.errors.join(" | ")}`);const X=await(await ke(`https://api.telegram.org/bot${R}/getFile?file_id=${d.voice.file_id}`)).json();if(X.ok&&((r=X.result)!=null&&r.file_path)){const se=await(await ss(`https://api.telegram.org/file/bot${R}/${X.result.file_path}`)).blob(),oe=await mo(n,S.id,S.pin_hash);if(!oe){const h=await ae(R,w,"⚠️ To use voice notes, add an OpenAI or Groq API key in Settings → Keys (LLM slot or legacy openai/groq).","Markdown",n,S.id);h.success||console.warn(`[voice no stt] Failed to send message: ${h.errors.join(" | ")}`);return}const G=new FormData;G.append("file",se,"voice.ogg"),G.append("model",oe.model),G.append("language","en");const Q=await fetch(oe.url,{method:"POST",headers:{Authorization:`Bearer ${oe.apiKey}`},body:G});if(!Q.ok){const h=await Q.text(),v=await ae(R,w,`⚠️ Transcription failed: ${Q.status} ${h}`,"Markdown",n,S.id);v.success||console.warn(`[voice transcription error] Failed to send message: ${v.errors.join(" | ")}`);return}T=(await Q.json()).text;const y=await ae(R,w,`🗣️ *You said:* ${T}`,"Markdown",n,S.id);y.success||console.warn(`[voice transcript echo] Failed to send message: ${y.errors.join(" | ")}`)}}catch(A){const K=await ae(R,w,`⚠️ Failed to process voice note: ${A.message}`,"Markdown",n,S==null?void 0:S.id);K.success||console.warn(`[voice processing error] Failed to send message: ${K.errors.join(" | ")}`);return}if((g||f)&&R&&S)try{let A,K="unknown",X="unknown",W=0;if(g)A=d.document.file_id,K=d.document.file_name||"document",X=d.document.mime_type||"unknown",W=d.document.file_size||0;else if(f){const se=d.photo[d.photo.length-1];A=se.file_id,K="photo.jpg",X="image/jpeg",W=se.file_size||0}if(A){const oe=await(await ke(`https://api.telegram.org/bot${R}/getFile?file_id=${A}`)).json();let G="";if(oe.ok&&((a=oe.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(K)||/^text\/|application\/json|application\/xml|application\/csv/i.test(X))&&W<5e4)try{G=await(await ss(`https://api.telegram.org/file/bot${R}/${oe.result.file_path}`)).text()}catch{}const Q=d.caption||"",m=`[Telegram file received: "${K}" (${X}, ${Math.round(W/1024)}KB)]`;G?T=`${Q?Q+`
...
`:""}${m}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(A){if(b&&d.caption)T=d.caption;else{const K=await ae(R,w,`⚠️ Received your file but couldn't process it: ${A.message}`,"Markdown",n,S==null?void 0:S.id);K.success||console.warn(`[file processing error] Failed to send message: ${K.errors.join(" | ")}`);return}}if(!T)return;fo(R,w).catch(()=>{});let O=await n.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(S.id).first();if(O)await n.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(O.id).run();else{const A=await n.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(S.id).run();if(!((i=A.meta)!=null&&i.last_row_id))throw new Error("Thread creation failed — no row ID returned");O={id:A.meta.last_row_id}}const M=io(S.id,S.username,T,w);M.metadata={thread_id:O.id},console.log(`[telegram webhook] user=${S.id} msgLen=${T.length} thread=${O.id}`);let L,U;try{const A=await Ke(n,S.id,S.pin_hash);L=A.provider,U=A.rotation}catch(A){console.error("Telegram provider setup error:",A);const K=(o=A.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=A.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${A.message||"Unknown error"}`,X=await ae(R,w,K,"Markdown",n,S.id);X.success||console.warn(`[provider error] Failed to send message: ${X.errors.join(" | ")}`);return}const{classifyIntentFast:Y}=await Promise.resolve().then(()=>ki);if(Y(T).agent==="multi"){const A=await ae(R,w,"🔍 On it…","Markdown",n,S.id);A.success||console.warn(`[ack] Failed to send: ${A.errors.join(" | ")}`)}const ee=6e5;let re=!1;try{const A=await Promise.race([An(M,n,L,S,U,s),new Promise((W,se)=>setTimeout(()=>se(new Error("TELEGRAM_TIMEOUT")),ee))]),K=oo(A,"telegram"),X=await ae(R,w,K||"(empty response)","Markdown",n,S.id);if(await n.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(O.id).run().catch(()=>{}),re=X.success,!X.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${S.id}:`,X.errors);try{const{logError:W}=await Promise.resolve().then(()=>gt);await W(n,S.id,"telegram","response_send_failed",`Failed to deliver response: ${X.errors.join(" | ")}`)}catch{}}}catch(A){console.error("Telegram agent error:",A);const K=A.message==="TELEGRAM_TIMEOUT",X=K?`⏱️ This is taking too long to complete via Telegram.

If you requested a browser task, the result will arrive as a notification when ready. For other long tasks, try the web app.`:(c=A.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${L.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(A.message||"Unknown").substring(0,200)}`,W=await ae(R,w,X,"Markdown",n,S.id);re=W.success,W.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${S.id}:`,W.errors);try{const{logError:se}=await Promise.resolve().then(()=>gt);await se(n,S.id,"telegram",K?"timeout":"agent_error",A.message||"Agent error",{provider:L.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:u}=await Promise.resolve().then(()=>gt);await u(n,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}}function rs(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}function Eo(e){const t=new Date(new Date().toLocaleString("en-US",{timeZone:e})),n=new Date(t);n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const s=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),r=new Date(n.toLocaleString("en-US",{timeZone:e}));return new Date(n.getTime()+(s.getTime()-r.getTime())).toISOString()}const Mr=e=>[[{text:"✅ Seen",callback_data:`notif_seen:${e}`},{text:"⏰ Snooze",callback_data:`notif_snooze_menu:${e}`},{text:"✓ Done",callback_data:`notif_done:${e}`}]],To=e=>[[{text:"10 minutes",callback_data:`notif_snooze:${e}:10m`},{text:"1 hour",callback_data:`notif_snooze:${e}:1h`}],[{text:"Tomorrow 9 AM",callback_data:`notif_snooze:${e}:tomorrow`},{text:"← Back",callback_data:`notif_back:${e}`}]];async function ct(e,t,n){const s=await ke(`https://api.telegram.org/bot${e}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:t,text:n})});s.ok||console.warn("[answerCallback]",t,s.status)}async function dt(e,t,n,s){const r=await ke(`https://api.telegram.org/bot${e}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,message_id:n,reply_markup:s?{inline_keyboard:s}:{}})});r.ok||console.warn("[editKeyboard]",t,n,r.status)}async function So(e,t,n,s,r,a,i,o,l,c){const d=await e.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).first();if(!d){await ct(t,n,"Notification not found — may have already been actioned."),await dt(t,s,r,null);return}if(i==="notif_seen")await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ct(t,n,"✅ Dismissed"),await dt(t,s,r,null);else if(i==="notif_snooze_menu")await ct(t,n),await dt(t,s,r,To(o));else if(i==="notif_back")await ct(t,n),await dt(t,s,r,Mr(o));else if(i==="notif_snooze"){const u=rs(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run();let p,g;l==="10m"?(p=new Date(Date.now()+600*1e3).toISOString(),g="10 minutes"):l==="1h"?(p=new Date(Date.now()+3600*1e3).toISOString(),g="1 hour"):(p=Eo(c||"UTC"),g="tomorrow 9 AM"),await e.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
       VALUES (?, ?, ?, 'once', ?, 'reminder', ?, ?, 1, 'active')`).bind(a,d.title,d.body,p,JSON.stringify({description:d.body||""}),p).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ct(t,n,`⏰ Snoozed until ${g}`),await dt(t,s,r,null)}else if(i==="notif_done"){const u=rs(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ct(t,n,"✓ Done!"),await dt(t,s,r,null)}}async function xo(e,t){var w;const{id:n,data:s,message:r,from:a}=t;if(!s||!r)return;const i=s.split(":"),o=i[0],l=String(r.chat.id);if(o.startsWith("notif_")){const T=parseInt(i[1]);if(!T)return;const S=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!S)return;const R=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
       JOIN users u ON c.user_id = u.id
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(S.id).first();if(!R)return;const O=await Z(R.encrypted_value,R.pin_hash),M=i[2];await So(e,O,n,l,r.message_id,S.id,o,T,M,S.timezone);return}if(i[0]!=="briefing_toggle"||i.length<3)return;const c=i[1],d=parseInt(i[2]);if(!d||!c)return;const u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const p=await e.prepare(`
...
`)}function Lo(e){const t=[];let n=0;for(const s of e.calendar.google)t.push({type:"calendar",key:s.id,text:`${s.title} - ${new Date(s.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:s},sortOrder:n++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:n++});for(const s of e.tasks.items)t.push({type:"task",key:`task-${s}`,text:s,metadata:{},sortOrder:n++});for(const s of e.news.items)t.push({type:"news",key:`news-${s.url}`,text:`📰 ${s.title}`,metadata:{url:s.url,source:s.source},sortOrder:n++});return t}async function Mo(e,t){const n=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!n)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let s;try{const a=JSON.parse(n.components);s={google_calendar:a.google_calendar!==!1,gmail:a.gmail!==!1,tasks:a.tasks!==!1,news:a.news!==!1}}catch{s={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const r=n.news_topics?n.news_topics.split(",").map(a=>a.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:s,newsTopics:r}}async function $r(e,t,n){var R,O;const s=t.timezone||"Asia/Kolkata",r=Do(s),{components:a,newsTopics:i}=await Mo(e,t.id),o=[],l=[];a.google_calendar&&(o.push(Ro(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET,r)),l.push("googleEvents")),a.gmail&&(o.push(Oo(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),a.tasks&&(o.push(No(e,t.id)),l.push("tasks")),a.news&&(o.push(Co(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((M,L)=>{d[M]=c[L]});const u={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},p={pending:0,dueToday:0,items:[]},g={generatedAt:new Date().toISOString(),targetDate:r.dateStr,calendar:{google:d.googleEvents||[],totalCount:((R=d.googleEvents)==null?void 0:R.length)||0},emails:{gmail:d.gmailSummary||u},tasks:d.tasks||p,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((O=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:O.briefing_time)||"20:00";g.summary=Ao(g,f);const b=Lo(g),w=sn(s),T=await e.prepare(`
  ...
  `).bind(t.id,JSON.stringify(g),w).first(),S=(T==null?void 0:T.id)||0;for(const M of b)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(S,M.type,M.key,M.text,JSON.stringify(M.metadata),M.sortOrder).run();return{briefingId:S,content:g,items:b}}async function $o(e,t,n){const s=await e.prepare(`
  ...
  `).bind(n).all();return{briefing:{...s,content:JSON.parse(s.content_json||"{}")},items:r.results||[]}}async function Po(e,t,n,s){if(!await e.prepare(`
  ...
  `).bind(i,i,s,n).run(),{checked:i===1}}async function Bo(e,t,n=10){return((await e.prepare(`
    SELECT b.*, 
...
🕐 ${R}${O}`;await At(`https://api.telegram.org/bot${T}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:M,parse_mode:"Markdown"})})}r.push({user_id:l.id,reminders_sent:b.length})}catch(c){r.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});he.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(!Pr(l,o,a))continue;const c=sn(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'morning' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await Hr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let p={telegram:!0,web:!0};try{p=JSON.parse(i.notification_channels||"{}")}catch{}if(p.telegram!==!1&&i.telegram_chat_id&&u.briefingId){const g=Go(u.content);await Ur(e.env.DB,i,g),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run()}r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});he.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[];for(const a of s.results||[]){let i={};try{i=JSON.parse(a.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Fr(e.env.DB,a,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{skipBrowserUse:!0}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,c=JSON.stringify(o,null,2),d=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(Ho(l,o,a))try{const c=await Fo(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),d=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,u=JSON.stringify(c,null,2),p=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,d,u,`weekly_review_${Date.now()}`,null,null,null).first();let g={telegram:!0,web:!0};try{g=JSON.parse(i.notification_channels||"{}")}catch{}if(g.telegram!==!1&&i.telegram_chat_id){const f=Wo(c);await Ur(e.env.DB,i,f)}r.push({user_id:i.id,status:"success",action_item_id:p==null?void 0:p.id})}catch(c){r.push({user_id:i.id,status:"error",error:c.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});async function jr(e,t,n,s,r){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!a)return;const i=await Z(a.encrypted_value,a.pin_hash);if(!(i!=null&&i.trim())){yr("sendTelegramWithKeyboard: empty bot token",{userId:t.id});return}if(!(await(await At(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n,parse_mode:"Markdown",reply_markup:{inline_keyboard:s.map(c=>c.map(d=>({...d,callback_data:`${d.callback_data}:${r}`})))}})})).json()).ok){const d=await(await At(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:s.map(u=>u.map(p=>({...p,callback_data:`${p.callback_data}:${r}`})))}})})).json();if(!d.ok){vn("Telegram briefing send failed",{description:d.description,chatId:t.telegram_chat_id});return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(r).run()}catch(a){vn("Telegram briefing error",{error:(a==null?void 0:a.message)||String(a)})}}async function Ur(e,t,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const r=await Z(s.encrypted_value,s.pin_hash);if(!(r!=null&&r.trim())){yr("sendTelegramPlainText: empty bot token",{userId:t.id});return}(await At(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3),parse_mode:"Markdown"})})).ok||await At(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.substring(0,4e3).replace(/[_*[`\]]/g,"")})})}catch(s){vn("Telegram plain text error",{error:(s==null?void 0:s.message)||String(s)})}}async function Hr(e,t,n){const s=new Date;s.setHours(0,0,0,0);const r=new Date;r.setHours(23,59,59,999);const a=await e.prepare(`
...
${r.substring(0,8e3)}`}],{maxTokens:1024})).content)==null?void 0:c.trim())||null}catch{a=null}const i=a||"Summary not yet generated. Ask Karna in chat to summarize this document.";await e.env.DB.prepare("UPDATE document_library SET status = ?, summary = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("summarized",i,n,t.id).run();const l=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return e.json({success:!0,document:l})});Re.delete("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});Re.post("/:id/parse",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));await e.env.DB.prepare("UPDATE document_library SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("parsed",n,t.id).run();const s=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return e.json({success:!0,document:s})});const _e=new be;async function Jo(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
  ...
  `).bind(t.id).all()).results||[];if(s.length===0)return e.json({migrated:0,skipped:0,samples:[],message:"No oversized memory entries found."});let r=0,a=0;const i=[];for(const o of s){if(["preference","fact","context","decision"].includes(o.type)){a++;continue}const l=o.content.length>1500,c=/\b(essay|article|draft|report|chapter)\b/i.test(o.content)&&o.content.length>500;if(!l&&!c){a++;continue}try{const d=o.content.substring(0,500),u=o.content.substring(0,5e4);await e.env.DB.prepare(`
      ...
      `).bind(t.id,o.title,d,u).run();const p=`[Migrated to Document Library] ${o.title} — content moved to Document Library. Search for it with search_library("${o.title.substring(0,40)}").`;await e.env.DB.prepare("UPDATE memory SET content = ?, importance = 4, tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(p,o.id,t.id).run(),r++,i.length<5&&i.push({id:o.id,title:o.title,action:"migrated to document_library, memory demoted to pointer"})}catch{a++}}return e.json({migrated:r,skipped:a,samples:i,message:`Moved ${r} bulky memory entries to Document Library. ${a} entries were skipped (too short or migration error).`})});const ge=new be,Vo=["/api/auth","/api/chat","/api/settings","/api/telegram","/api/system","/api/proactive","/api/skills","/api/notifications","/api/documents","/api/memory"];async function Zo(e){const t=e.env.RENDER_BACKEND_URL,n=e.env.RENDER_API_SECRET;if(!(e.env.ENABLE_RENDER_PROXY==="true")||!t||!n||e.req.header("x-via-render-worker")||!Vo.some(f=>e.req.path.startsWith(f)))return null;const a=new URL(e.req.url);a.protocol=new URL(t).protocol,a.host=new URL(t).host;const i=new Headers(e.req.header());i.set("x-render-api-secret",n);const o=e.req.path.startsWith("/api/chat")||e.req.path.startsWith("/api/telegram"),l=Number(e.env.RENDER_PROXY_TIMEOUT_MS_LONG||"310000"),c=Number(e.env.RENDER_PROXY_TIMEOUT_MS||"8000"),d=o?l:c,u=new AbortController,p=setTimeout(()=>u.abort("render-proxy-timeout"),d);let g;try{g=await fetch(a.toString(),{method:e.req.method,headers:i,body:e.req.method==="GET"||e.req.method==="HEAD"?void 0:await e.req.arrayBuffer(),signal:u.signal})}catch(f){return e.json({error:"Render backend unavailable",detail:String(f)},503)}finally{clearTimeout(p)}return new Response(g.body,{status:g.status,headers:g.headers})}ge.use("/api/*",Na());ge.use("/api/*",async(e,t)=>{const n=await Zo(e);if(n)return n;await t()});ge.route("/api/auth",ze);ge.route("/api/chat",ce);ge.route("/api/settings",ie);ge.route("/api/system",De);ge.route("/api/telegram",Ut);ge.route("/api/proactive",he);ge.route("/api/skills",ot);ge.route("/api/notifications",Ye);ge.route("/api/documents",Re);ge.route("/api/memory",_e);ge.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),n=t.searchParams.get("code"),s=t.searchParams.get("state"),r=t.searchParams.get("error");if(r)return e.html(ut(!1,`Google denied access: ${r}`));if(!n||!s)return e.html(ut(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(s)).sessionId;if(!i)return e.html(ut(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(ut(!1,"Session expired. Please log in again and retry."));const l=o.user_id,c=o.pin_hash,d=`${t.protocol}//${t.host}/auth/google/callback`,u=await Fs(e.env.DB,l,c,n,d,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(ut(!0,`Connected as ${u.email}`,u.email))}catch(a){return e.html(ut(!1,`OAuth failed: ${a.message}`))}});ge.get("/preview-dashboard",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.html(qa())));ge.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Rs(e.env.API_BASE_URL||""))));ge.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Rs(e.env.API_BASE_URL||""))));function ut(e,t,n){return`<!DOCTYPE html>
