var Fa=Object.defineProperty;var Rt=e=>{throw TypeError(e)};var Wa=(e,t,a)=>t in e?Fa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var k=(e,t,a)=>Wa(e,typeof t!="symbol"?t+"":t,a),mt=(e,t,a)=>t.has(e)||Rt("Cannot "+a);var b=(e,t,a)=>(mt(e,t,"read from private field"),a?a.call(e):t.get(e)),C=(e,t,a)=>t.has(e)?Rt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(mt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(mt(e,t,"access private method"),a);var At=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return b(e,t,r)}});var Lt=(e,t,a)=>(r,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,d=!1,u;if(e[o]?(u=e[o][0][0],r.req.routeIndex=o):u=o===e.length&&n||void 0,u)try{l=await u(r,()=>i(o+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),d=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||d)&&(r.res=l),r}},qa=Symbol(),Ka=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ta?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Ja(e,{all:a,dot:r}):{}};async function Ja(e,t){const a=await e.formData();return a?Ya(a,t):{}}function Ya(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?Va(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(Xa(a,r,n),delete a[r])}),a}var Va=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},Xa=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},Vt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Za=e=>{const{groups:t,path:a}=Qa(e),r=Vt(a);return er(r,t)},Qa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},er=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},at={},tr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return at[r]||(a[2]?at[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:at[r]=[e,a[1],!0]),at[r]}return null},kt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},ar=e=>kt(e,decodeURI),Xt=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),i=t.indexOf("#",r),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return ar(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},rr=e=>{const t=Xt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Oe=(e,t,...a)=>(a.length&&(t=Oe(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Zt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,i)=>i.indexOf(n)===s)},ht=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?kt(e,ea):e):e,Qt=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,d=e.indexOf("&",l);return ht(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(r&&(l=ht(l)),s=i,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),r&&(d=ht(d))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},nr=Qt,sr=(e,t)=>Qt(e,t,!0),ea=decodeURIComponent,Nt=e=>kt(e,ea),Le,q,oe,aa,ra,bt,le,Ft,ta=(Ft=class{constructor(e,t="/",a=[[]]){C(this,oe);k(this,"raw");C(this,Le);C(this,q);k(this,"routeIndex",0);k(this,"path");k(this,"bodyCache",{});C(this,le,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,q,a),D(this,Le,{})}param(e){return e?L(this,oe,aa).call(this,e):L(this,oe,ra).call(this)}query(e){return nr(this.url,e)}queries(e){return sr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ka(this,e))}json(){return b(this,le).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,le).call(this,"text")}arrayBuffer(){return b(this,le).call(this,"arrayBuffer")}blob(){return b(this,le).call(this,"blob")}formData(){return b(this,le).call(this,"formData")}addValidatedData(e,t){b(this,Le)[e]=t}valid(e){return b(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[qa](){return b(this,q)}get matchedRoutes(){return b(this,q)[0].map(([[,e]])=>e)}get routePath(){return b(this,q)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,q=new WeakMap,oe=new WeakSet,aa=function(e){const t=b(this,q)[0][this.routeIndex][1][e],a=L(this,oe,bt).call(this,t);return a&&/\%/.test(a)?Nt(a):a},ra=function(){const e={},t=Object.keys(b(this,q)[0][this.routeIndex][1]);for(const a of t){const r=L(this,oe,bt).call(this,b(this,q)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Nt(r):r)}return e},bt=function(e){return b(this,q)[1]?b(this,q)[1][e]:e},le=new WeakMap,Ft),ir={Stringify:1},na=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>na(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},or="text/plain; charset=UTF-8",gt=(e,t)=>({"Content-Type":e,...t}),Je,Ye,re,Ne,ne,W,Ve,$e,Me,be,Xe,Ze,de,Re,Wt,lr=(Wt=class{constructor(e,t){C(this,de);C(this,Je);C(this,Ye);k(this,"env",{});C(this,re);k(this,"finalized",!1);k(this,"error");C(this,Ne);C(this,ne);C(this,W);C(this,Ve);C(this,$e);C(this,Me);C(this,be);C(this,Xe);C(this,Ze);k(this,"render",(...e)=>(b(this,$e)??D(this,$e,t=>this.html(t)),b(this,$e).call(this,...e)));k(this,"setLayout",e=>D(this,Ve,e));k(this,"getLayout",()=>b(this,Ve));k(this,"setRenderer",e=>{D(this,$e,e)});k(this,"header",(e,t,a)=>{this.finalized&&D(this,W,new Response(b(this,W).body,b(this,W)));const r=b(this,W)?b(this,W).headers:b(this,be)??D(this,be,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});k(this,"status",e=>{D(this,Ne,e)});k(this,"set",(e,t)=>{b(this,re)??D(this,re,new Map),b(this,re).set(e,t)});k(this,"get",e=>b(this,re)?b(this,re).get(e):void 0);k(this,"newResponse",(...e)=>L(this,de,Re).call(this,...e));k(this,"body",(e,t,a)=>L(this,de,Re).call(this,e,t,a));k(this,"text",(e,t,a)=>!b(this,be)&&!b(this,Ne)&&!t&&!a&&!this.finalized?new Response(e):L(this,de,Re).call(this,e,t,gt(or,a)));k(this,"json",(e,t,a)=>L(this,de,Re).call(this,JSON.stringify(e),t,gt("application/json",a)));k(this,"html",(e,t,a)=>{const r=n=>L(this,de,Re).call(this,n,t,gt("text/html; charset=UTF-8",a));return typeof e=="object"?na(e,ir.Stringify,!1,{}).then(r):r(e)});k(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});k(this,"notFound",()=>(b(this,Me)??D(this,Me,()=>new Response),b(this,Me).call(this,this)));D(this,Je,e),t&&(D(this,ne,t.executionCtx),this.env=t.env,D(this,Me,t.notFoundHandler),D(this,Ze,t.path),D(this,Xe,t.matchResult))}get req(){return b(this,Ye)??D(this,Ye,new ta(b(this,Je),b(this,Ze),b(this,Xe))),b(this,Ye)}get event(){if(b(this,ne)&&"respondWith"in b(this,ne))return b(this,ne);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ne))return b(this,ne);throw Error("This context has no ExecutionContext")}get res(){return b(this,W)||D(this,W,new Response(null,{headers:b(this,be)??D(this,be,new Headers)}))}set res(e){if(b(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,W,e),this.finalized=!0}get var(){return b(this,re)?Object.fromEntries(b(this,re)):{}}},Je=new WeakMap,Ye=new WeakMap,re=new WeakMap,Ne=new WeakMap,ne=new WeakMap,W=new WeakMap,Ve=new WeakMap,$e=new WeakMap,Me=new WeakMap,be=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,de=new WeakSet,Re=function(e,t,a){const r=b(this,W)?new Headers(b(this,W).headers):b(this,be)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")r.set(s,i);else{r.delete(s);for(const o of i)r.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Ne);return new Response(e,{status:n,headers:r})},Wt),P="ALL",dr="all",cr=["get","post","put","delete","options","patch"],sa="Can not add a route since the matcher is already built.",ia=class extends Error{},ur="__COMPOSED_HANDLER",pr=e=>e.text("404 Not Found",404),$t=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},J,H,oa,Y,ve,st,it,je,mr=(je=class{constructor(t={}){C(this,H);k(this,"get");k(this,"post");k(this,"put");k(this,"delete");k(this,"options");k(this,"patch");k(this,"all");k(this,"on");k(this,"use");k(this,"router");k(this,"getPath");k(this,"_basePath","/");C(this,J,"/");k(this,"routes",[]);C(this,Y,pr);k(this,"errorHandler",$t);k(this,"onError",t=>(this.errorHandler=t,this));k(this,"notFound",t=>(D(this,Y,t),this));k(this,"fetch",(t,...a)=>L(this,H,it).call(this,t,a[1],a[0],t.method));k(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Oe("/",t)}`,a),r,n)));k(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,H,it).call(this,t.request,t,void 0,t.request.method))})});[...cr,dr].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?D(this,J,i):L(this,H,ve).call(this,s,b(this,J),i),o.forEach(l=>{L(this,H,ve).call(this,s,b(this,J),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){D(this,J,l);for(const d of[s].flat())o.map(u=>{L(this,H,ve).call(this,d.toUpperCase(),b(this,J),u)})}return this},this.use=(s,...i)=>(typeof s=="string"?D(this,J,s):(D(this,J,"*"),i.unshift(s)),i.forEach(o=>{L(this,H,ve).call(this,P,b(this,J),o)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??Xt:rr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let s;a.errorHandler===$t?s=n.handler:(s=async(o,l)=>(await Lt([],a.errorHandler)(o,()=>n.handler(o,l))).res,s[ur]=n.handler),L(i=r,H,ve).call(i,n.method,n.path,s)}),this}basePath(t){const a=L(this,H,oa).call(this);return a._basePath=Oe(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Oe(this._basePath,t),d=l==="/"?0:l.length;return u=>{const p=new URL(u.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,u)}})());const o=async(l,d)=>{const u=await a(n(l.req.raw),...i(l));if(u)return u;await d()};return L(this,H,ve).call(this,P,Oe(t,"*"),o),this}},J=new WeakMap,H=new WeakSet,oa=function(){const t=new je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,Y,b(this,Y)),t.routes=this.routes,t},Y=new WeakMap,ve=function(t,a,r){t=t.toUpperCase(),a=Oe(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},st=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},it=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await L(this,H,it).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),i=this.router.match(n,s),o=new lr(t,{path:s,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,Y)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await b(this,Y).call(this,o)})}catch(u){return L(this,H,st).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:b(this,Y).call(this,o))).catch(u=>L(this,H,st).call(this,u,o)):d??b(this,Y).call(this,o)}const l=Lt(i[0],this.errorHandler,b(this,Y));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return L(this,H,st).call(this,d,o)}})()},je),la=[];function hr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const i=a[n]||a[P],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],la];const d=l.indexOf("",1);return[i[1][d],l]});return this.match=r,r(e,t)}var lt="[^/]+",We=".*",qe="(?:|/.*)",Ae=Symbol(),gr=new Set(".\\+*[^]$()");function fr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===lt?1:t===lt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,xe,V,Te,vr=(Te=class{constructor(){C(this,we);C(this,xe);C(this,V,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,we)!==void 0)throw Ae;if(s)return;D(this,we,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",We]:["","",lt]:i==="/*"?["","",qe]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let p=l[2]||lt;if(u&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Ae;if(d=b(this,V)[p],!d){if(Object.keys(b(this,V)).some(g=>g!==We&&g!==qe))throw Ae;if(s)return;d=b(this,V)[p]=new Te,u!==""&&D(d,xe,n.varIndex++)}!s&&u!==""&&r.push([u,b(d,xe)])}else if(d=b(this,V)[i],!d){if(Object.keys(b(this,V)).some(u=>u.length>1&&u!==We&&u!==qe))throw Ae;if(s)return;d=b(this,V)[i]=new Te}d.insert(o,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,V)).sort(fr).map(r=>{const n=b(this,V)[r];return(typeof b(n,xe)=="number"?`(${r})@${b(n,xe)}`:gr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,we)=="number"&&a.unshift(`#${b(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,xe=new WeakMap,V=new WeakMap,Te),dt,Qe,qt,yr=(qt=class{constructor(){C(this,dt,{varIndex:0});C(this,Qe,new vr)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return n[i]=[d,l],i++,o=!0,d}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return b(this,Qe).insert(s,t,r,b(this,dt),a),r}buildRegExp(){let e=b(this,Qe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},dt=new WeakMap,Qe=new WeakMap,qt),br=[/^$/,[],Object.create(null)],ot=Object.create(null);function da(e){return ot[e]??(ot[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function wr(){ot=Object.create(null)}function xr(e){var d;const t=new yr,a=[];if(e.length===0)return br;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,p],[g,y])=>u?1:g?-1:p.length-y.length),n=Object.create(null);for(let u=0,p=-1,g=r.length;u<g;u++){const[y,v,_]=r[u];y?n[v]=[_.map(([E])=>[E,Object.create(null)]),la]:p++;let w;try{w=t.insert(v,p,y)}catch(E){throw E===Ae?new ia(v):E}y||(a[p]=_.map(([E,c])=>{const f=Object.create(null);for(c-=1;c>=0;c--){const[h,m]=w[c];f[h]=m}return[E,f]}))}const[s,i,o]=t.buildRegExp();for(let u=0,p=a.length;u<p;u++)for(let g=0,y=a[u].length;g<y;g++){const v=(d=a[u][g])==null?void 0:d[1];if(!v)continue;const _=Object.keys(v);for(let w=0,E=_.length;w<E;w++)v[_[w]]=o[v[_[w]]]}const l=[];for(const u in i)l[u]=a[i[u]];return[s,l,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(da(a).test(t))return[...e[a]]}}var ce,ue,ct,ca,Kt,_r=(Kt=class{constructor(){C(this,ct);k(this,"name","RegExpRouter");C(this,ce);C(this,ue);k(this,"match",hr);D(this,ce,{[P]:Object.create(null)}),D(this,ue,{[P]:Object.create(null)})}add(e,t,a){var o;const r=b(this,ce),n=b(this,ue);if(!r||!n)throw new Error(sa);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(d=>{l[e][d]=[...l[P][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=da(t);e===P?Object.keys(r).forEach(d=>{var u;(u=r[d])[t]||(u[t]=De(r[d],t)||De(r[P],t)||[])}):(o=r[e])[t]||(o[t]=De(r[e],t)||De(r[P],t)||[]),Object.keys(r).forEach(d=>{(e===P||e===d)&&Object.keys(r[d]).forEach(u=>{l.test(u)&&r[d][u].push([a,s])})}),Object.keys(n).forEach(d=>{(e===P||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([a,s]))});return}const i=Zt(t)||[t];for(let l=0,d=i.length;l<d;l++){const u=i[l];Object.keys(n).forEach(p=>{var g;(e===P||e===p)&&((g=n[p])[u]||(g[u]=[...De(r[p],u)||De(r[P],u)||[]]),n[p][u].push([a,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,ue)).concat(Object.keys(b(this,ce))).forEach(t=>{e[t]||(e[t]=L(this,ct,ca).call(this,t))}),D(this,ce,D(this,ue,void 0)),wr(),e}},ce=new WeakMap,ue=new WeakMap,ct=new WeakSet,ca=function(e){const t=[];let a=e===P;return[b(this,ce),b(this,ue)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?xr(t):null},Kt),pe,se,Jt,Er=(Jt=class{constructor(e){k(this,"name","SmartRouter");C(this,pe,[]);C(this,se,[]);D(this,pe,e.routers)}add(e,t,a){if(!b(this,se))throw new Error(sa);b(this,se).push([e,t,a])}match(e,t){if(!b(this,se))throw new Error("Fatal error");const a=b(this,pe),r=b(this,se),n=a.length;let s=0,i;for(;s<n;s++){const o=a[s];try{for(let l=0,d=r.length;l<d;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof ia)continue;throw l}this.match=o.match.bind(o),D(this,pe,[o]),D(this,se,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,se)||b(this,pe).length!==1)throw new Error("No active router has been determined yet.");return b(this,pe)[0]}},pe=new WeakMap,se=new WeakMap,Jt),Ge=Object.create(null),me,F,_e,Be,G,ie,ye,Pe,Tr=(Pe=class{constructor(t,a,r){C(this,ie);C(this,me);C(this,F);C(this,_e);C(this,Be,0);C(this,G,Ge);if(D(this,F,r||Object.create(null)),D(this,me,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,me,[n])}D(this,_e,[])}insert(t,a,r){D(this,Be,++At(this,Be)._);let n=this;const s=Za(a),i=[];for(let o=0,l=s.length;o<l;o++){const d=s[o],u=s[o+1],p=tr(d,u),g=Array.isArray(p)?p[0]:d;if(g in b(n,F)){n=b(n,F)[g],p&&i.push(p[1]);continue}b(n,F)[g]=new Pe,p&&(b(n,_e).push(p),i.push(p[1])),n=b(n,F)[g]}return b(n,me).push({[t]:{handler:r,possibleKeys:i.filter((o,l,d)=>d.indexOf(o)===l),score:b(this,Be)}}),n}search(t,a){var l;const r=[];D(this,G,Ge);let s=[this];const i=Vt(a),o=[];for(let d=0,u=i.length;d<u;d++){const p=i[d],g=d===u-1,y=[];for(let v=0,_=s.length;v<_;v++){const w=s[v],E=b(w,F)[p];E&&(D(E,G,b(w,G)),g?(b(E,F)["*"]&&r.push(...L(this,ie,ye).call(this,b(E,F)["*"],t,b(w,G))),r.push(...L(this,ie,ye).call(this,E,t,b(w,G)))):y.push(E));for(let c=0,f=b(w,_e).length;c<f;c++){const h=b(w,_e)[c],m=b(w,G)===Ge?{}:{...b(w,G)};if(h==="*"){const R=b(w,F)["*"];R&&(r.push(...L(this,ie,ye).call(this,R,t,b(w,G))),D(R,G,m),y.push(R));continue}const[x,T,I]=h;if(!p&&!(I instanceof RegExp))continue;const S=b(w,F)[x],A=i.slice(d).join("/");if(I instanceof RegExp){const R=I.exec(A);if(R){if(m[T]=R[0],r.push(...L(this,ie,ye).call(this,S,t,b(w,G),m)),Object.keys(b(S,F)).length){D(S,G,m);const N=((l=R[0].match(/\//))==null?void 0:l.length)??0;(o[N]||(o[N]=[])).push(S)}continue}}(I===!0||I.test(p))&&(m[T]=p,g?(r.push(...L(this,ie,ye).call(this,S,t,m,b(w,G))),b(S,F)["*"]&&r.push(...L(this,ie,ye).call(this,b(S,F)["*"],t,m,b(w,G)))):(D(S,G,m),y.push(S)))}}s=y.concat(o.shift()??[])}return r.length>1&&r.sort((d,u)=>d.score-u.score),[r.map(({handler:d,params:u})=>[d,u])]}},me=new WeakMap,F=new WeakMap,_e=new WeakMap,Be=new WeakMap,G=new WeakMap,ie=new WeakSet,ye=function(t,a,r,n){const s=[];for(let i=0,o=b(t,me).length;i<o;i++){const l=b(t,me)[i],d=l[a]||l[P],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),r!==Ge||n&&n!==Ge))for(let p=0,g=d.possibleKeys.length;p<g;p++){const y=d.possibleKeys[p],v=u[d.score];d.params[y]=n!=null&&n[y]&&!v?n[y]:r[y]??(n==null?void 0:n[y]),u[d.score]=!0}}return s},Pe),Ee,Yt,kr=(Yt=class{constructor(){k(this,"name","TrieRouter");C(this,Ee);D(this,Ee,new Tr)}add(e,t,a){const r=Zt(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ee).insert(e,r[n],a);return}b(this,Ee).insert(e,t,a)}match(e,t){return b(this,Ee).search(e,t)}},Ee=new WeakMap,Yt),ge=class extends mr{constructor(e={}){super(e),this.router=e.router??new Er({routers:[new _r,new kr]})}},Sr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var u;function l(p,g){i.res.headers.set(p,g)}const d=await r(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await n(i.req.header("origin")||"",i);p.length&&l("Access-Control-Allow-Methods",p.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const y=i.req.header("Access-Control-Request-Headers");y&&(g=y.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function ua(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}const St="AES-GCM",Ir=256;async function pa(e){const t=new TextEncoder,a=await crypto.subtle.importKey("raw",t.encode(e.padEnd(32,"0").slice(0,32)),{name:"PBKDF2"},!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode("karna-salt-v1"),iterations:1e5,hash:"SHA-256"},a,{name:St,length:Ir},!1,["encrypt","decrypt"])}async function It(e,t){const a=await pa(t),r=crypto.getRandomValues(new Uint8Array(12)),n=new TextEncoder,s=await crypto.subtle.encrypt({name:St,iv:r},a,n.encode(e)),i=new Uint8Array(r.length+new Uint8Array(s).length);return i.set(r),i.set(new Uint8Array(s),r.length),btoa(String.fromCharCode(...i))}async function M(e,t){const a=await pa(t),r=new Uint8Array(atob(e).split("").map(o=>o.charCodeAt(0))),n=r.slice(0,12),s=r.slice(12),i=await crypto.subtle.decrypt({name:St,iv:n},a,s);return new TextDecoder().decode(i)}async function ut(e){const a=new TextEncoder().encode(e+"karna-pin-salt"),r=await crypto.subtle.digest("SHA-256",a);return btoa(String.fromCharCode(...new Uint8Array(r)))}async function ma(e,t){return await ut(e)===t}const Dr=Object.freeze(Object.defineProperty({__proto__:null,decrypt:M,encrypt:It,hashPin:ut,verifyPin:ma},Symbol.toStringTag,{value:"Module"})),fe=new ge;fe.get("/check",async e=>{const t=await e.env.DB.prepare("SELECT COUNT(*) as cnt FROM users").first();return e.json({hasUsers:((t==null?void 0:t.cnt)||0)>0})});fe.post("/setup",async e=>{const{username:t,name:a,pin:r,personality_prompt:n,timezone:s}=await e.req.json();if(!t||!a||!r)return e.json({error:"Username, name, and PIN are required"},400);if(r.length<4)return e.json({error:"PIN must be at least 4 characters"},400);if(await e.env.DB.prepare("SELECT id FROM users WHERE username = ?").bind(t).first())return e.json({error:"Username already taken"},409);const o=await ut(r);await e.env.DB.prepare("INSERT INTO users (username, name, pin_hash, personality_prompt, timezone) VALUES (?, ?, ?, ?, ?)").bind(t,a,o,n||"",s||"Asia/Kolkata").run();const l=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first(),d=crypto.randomUUID(),u=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(d,l.id,"web",u).run(),e.json({success:!0,sessionId:d,user:{id:l.id,username:l.username,name:l.name}})});fe.post("/login",async e=>{const{username:t,pin:a}=await e.req.json();if(!t||!a)return e.json({error:"Username and PIN required"},400);const r=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first();if(!r)return e.json({error:"User not found"},404);if(!await ma(a,r.pin_hash))return e.json({error:"Invalid PIN"},401);const s=crypto.randomUUID(),i=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(s,r.id,"web",i).run(),e.json({success:!0,sessionId:s,user:{id:r.id,username:r.username,name:r.name}})});fe.post("/logout",async e=>{var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");return t&&await e.env.DB.prepare("DELETE FROM sessions WHERE id = ?").bind(t).run(),e.json({success:!0})});fe.get("/users/hints",async e=>{const a=((await e.env.DB.prepare("SELECT username, name, created_at FROM users ORDER BY created_at ASC").all()).results||[]).map(r=>{var n;return{username:r.username,name_hint:r.name.split(" ")[0],created:((n=r.created_at)==null?void 0:n.split(" ")[0])||""}});return e.json({users:a,count:a.length})});fe.post("/reset-pin",async e=>{var o;const{username:t,name:a,new_pin:r}=await e.req.json();if(!t||!a||!r)return e.json({error:"Username, display name, and new PIN are required"},400);if(r.length<4)return e.json({error:"PIN must be at least 4 characters"},400);const n=await e.env.DB.prepare("SELECT id, username, name FROM users WHERE username = ?").bind(t).first();if(!n)return e.json({error:"User not found"},404);if(n.name.toLowerCase().trim()!==a.toLowerCase().trim())return e.json({error:"Display name does not match. This is required for identity verification."},403);const s=await ut(r);await e.env.DB.prepare("UPDATE users SET pin_hash = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n.id).run();const i=await e.env.DB.prepare("DELETE FROM credentials WHERE user_id = ?").bind(n.id).run();return await e.env.DB.prepare("DELETE FROM sessions WHERE user_id = ?").bind(n.id).run(),e.json({success:!0,message:"PIN reset successfully. All API keys and credentials have been cleared (they were encrypted with your old PIN). Please log in with your new PIN and re-enter your API keys in Settings.",credentials_cleared:((o=i.meta)==null?void 0:o.changes)||0})});fe.get("/me",async e=>{var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return e.json({error:"No session"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.id as uid, u.username, u.name, u.role, u.timezone 
     FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();return a?e.json({user:{id:a.uid,username:a.username,name:a.name,role:a.role,timezone:a.timezone}}):e.json({error:"Invalid or expired session"},401)});const Ke={anthropic:{id:"anthropic",label:"Anthropic Claude",apiBase:"https://api.anthropic.com",apiFormat:"anthropic",defaultModel:"claude-sonnet-4-20250514",keyPlaceholder:"sk-ant-api03-...",modelHint:"claude-sonnet-4-20250514, claude-haiku-4-20250514",validatePath:"/v1/messages"},openai:{id:"openai",label:"OpenAI GPT",apiBase:"https://api.openai.com",apiFormat:"openai-compatible",defaultModel:"gpt-4o",keyPlaceholder:"sk-...",modelHint:"gpt-4o, gpt-4o-mini, o3-mini",validatePath:"/v1/models"},grok:{id:"grok",label:"xAI Grok",apiBase:"https://api.x.ai",apiFormat:"openai-compatible",defaultModel:"grok-3-mini",keyPlaceholder:"xai-...",modelHint:"grok-3-mini, grok-3",validatePath:"/v1/models"},deepseek:{id:"deepseek",label:"DeepSeek",apiBase:"https://api.deepseek.com",apiFormat:"openai-compatible",defaultModel:"deepseek-chat",keyPlaceholder:"sk-...",modelHint:"deepseek-chat, deepseek-reasoner",validatePath:"/v1/models"},gemini:{id:"gemini",label:"Google Gemini",apiBase:"https://generativelanguage.googleapis.com/v1beta/openai",apiFormat:"openai-compatible",defaultModel:"gemini-2.0-flash",keyPlaceholder:"AIzaSy...",modelHint:"gemini-2.0-flash, gemini-2.5-pro-preview",validatePath:"/models"},openrouter:{id:"openrouter",label:"OpenRouter",apiBase:"https://openrouter.ai/api",apiFormat:"openai-compatible",defaultModel:"anthropic/claude-sonnet-4",keyPlaceholder:"sk-or-...",modelHint:"e.g. deepseek/deepseek-chat, meta-llama/llama-3.1-70b",validatePath:"/v1/models"},abacus:{id:"abacus",label:"Abacus AI (RouteLLM)",apiBase:"https://routellm.abacus.ai",apiFormat:"openai-compatible",defaultModel:"route-llm",keyPlaceholder:"Your Abacus API key",modelHint:"route-llm (auto), grok-4, deepseek-v3.2, claude-4-5-sonnet, gemini-3-flash",validatePath:"/v1/models"}};async function O(e,t,a,r,n,s={}){try{await e.prepare("INSERT INTO error_log (user_id, source, error_type, message, details) VALUES (?, ?, ?, ?, ?)").bind(t,a,r,n,JSON.stringify(s)).run()}catch(i){console.error("Failed to log error:",i)}}class ha{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){k(this,"name");k(this,"apiKey");k(this,"model");k(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var u,p,g,y;const r=t.find(v=>v.role==="system"),n=t.filter(v=>v.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(v=>({role:v.role,content:v.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(v=>({name:v.name,description:v.description,input_schema:v.parameters})));const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const v=await i.text();throw new Error(this.name+" API error "+i.status+": "+v)}const o=await i.json(),l=((u=o.content)==null?void 0:u.filter(v=>v.type==="text"))||[],d=((p=o.content)==null?void 0:p.filter(v=>v.type==="tool_use"))||[];return{content:l.map(v=>v.text).join(`
`),toolCalls:d.map(v=>({id:v.id,name:v.name,arguments:v.input})),usage:{promptTokens:((g=o.usage)==null?void 0:g.input_tokens)||0,completionTokens:((y=o.usage)==null?void 0:y.output_tokens)||0}}}async streamChat(t,a){const r=t.find(d=>d.role==="system"),n=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(d=>({role:d.role,content:d.content}))};r&&(s.system=r.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const d=await i.text();throw new Error(this.name+" stream error "+i.status+": "+d)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var v;const{done:u,value:p}=await o.read();if(u){d.close();return}const y=l.decode(p,{stream:!0}).split(`
`);for(const _ of y)if(_.startsWith("data: ")){const w=_.slice(6);if(w==="[DONE]")continue;try{const E=JSON.parse(w);E.type==="content_block_delta"&&((v=E.delta)!=null&&v.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Cr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,i]of Object.entries(r))i&&typeof i=="object"?n[s]=wt(i):n[s]=i;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function wt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=wt(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=wt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class ga{constructor(t,a,r,n){k(this,"name");k(this,"apiKey");k(this,"model");k(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var l,d,u,p,g,y;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(v=>({role:v.role,content:v.content}))},n=this.apiBase.includes("routellm.abacus.ai");a!=null&&a.tools&&a.tools.length>0&&!n&&(r.tools=a.tools.map(v=>({type:"function",function:{name:v.name,description:v.description,parameters:Cr(v.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const v=await s.text();throw new Error(this.name+" API error "+s.status+": "+v)}const i=await s.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((d=o==null?void 0:o.message)==null?void 0:d.content)||"",toolCalls:(p=(u=o==null?void 0:o.message)==null?void 0:u.tool_calls)==null?void 0:p.map(v=>({id:v.id,name:v.function.name,arguments:typeof v.function.arguments=="string"?JSON.parse(v.function.arguments||"{}"):v.function.arguments||{}})),usage:{promptTokens:((g=i.usage)==null?void 0:g.prompt_tokens)||0,completionTokens:((y=i.usage)==null?void 0:y.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const o=await n.text();throw new Error(this.name+" stream error "+n.status+": "+o)}const s=n.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var g,y,v;const{done:l,value:d}=await s.read();if(l){o.close();return}const p=i.decode(d,{stream:!0}).split(`
`);for(const _ of p)if(_.startsWith("data: ")){const w=_.slice(6);if(w==="[DONE]")continue;try{const c=(v=(y=(g=JSON.parse(w).choices)==null?void 0:g[0])==null?void 0:y.delta)==null?void 0:v.content;c&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:c})+`

`))}catch{}}}})}}function xt(e,t,a,r){const n=Ke[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new ha(t,s,n.apiBase,a):new ga(t,s,n.apiBase,a)}class fa{constructor(){k(this,"errorLog",new Map);k(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const Or=["llm_slot_1","llm_slot_2","llm_slot_3"],Rr=["anthropic","openai"];async function et(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Dr),n=new fa,s=[];for(const p of Or){const g=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(g)try{const y=await r(g.encrypted_value,a),v=JSON.parse(y);if(v.provider&&v.apiKey&&Ke[v.provider]){const w=v.provider,E=xt(v.provider,v.apiKey,w,v.model);s.push({name:w,provider:E})}}catch(y){console.error(`Failed to load ${p}:`,y)}}const i=new Set(s.map(p=>p.name));for(const p of Rr){if(i.has(p))continue;const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(g)try{const y=await r(g.encrypted_value,a);if(Ke[p]){const _=xt(p,y,p);s.push({name:p,provider:_})}}catch{console.error(`Failed to decrypt legacy ${p} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=s.map(p=>p.name),l=await n.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const d=s.find(p=>p.name===l);return{provider:Ar(d.provider,s,n),rotation:n}}function Ar(e,t,a){return t.length<=1?e:{name:e.name,async chat(r,n){try{return await e.chat(r,n)}catch(s){const i=s.message||"";if(!(i.includes("401")||i.includes("403")||i.includes("authentication")||i.includes("credit balance")||i.includes("invalid")&&i.includes("key")||i.includes("properties field not found")))throw s;console.warn(`Provider ${e.name} auth/billing error, trying fallback...`),await a.recordError(e.name,i,1440);const l=t.filter(d=>d.name!==e.name);for(const d of l)try{const u=await d.provider.chat(r,n);return this.name=d.name,u}catch(u){const p=u.message||"";if(p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance")||p.includes("properties field not found")){await a.recordError(d.name,p,1440);continue}throw u}throw new Error(`All LLM providers failed. Primary (${e.name}): ${i.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(r,n){return await e.streamChat(r,n)}}}const _t=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ha,OpenAICompatibleProvider:ga,ProviderRotation:fa,createProviderFromConfig:xt,createRotatingProvider:et,logError:O},Symbol.toStringTag,{value:"Module"})),ft=20,Lr=2e3,Nr=2e3,va=4;function $r(e){return Math.ceil(e.length/va)}function Mt(e,t){const a=t*va;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class he{constructor(t){this.db=t}async store(t,a,r,n,s=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,n,s,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>ft){const r=((a==null?void 0:a.cnt)||0)-ft;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
...
`),t.trim()}async function Ma(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await pt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,r).map(async g=>{const y=await $a(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:y.text,error:y.error}}),d=(await Promise.all(o)).filter(g=>g.content.length>50);if(d.length===0){const g=s.results.map((v,_)=>`[${_+1}] ${v.title}
${v.snippet}
Source: ${v.link}`).join(`

`);return{report:await jt(e,g,t,"snippets"),sources:s.results.map(v=>({title:v.title,url:v.link})),pagesRead:0}}const u=d.map((g,y)=>`--- SOURCE ${y+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${y+1} ---`).join(`

`);return{report:await jt(e,u,t,"full"),sources:d.map(g=>({title:g.title,url:g.url})),pagesRead:d.length}}async function jt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
## Current Date & Time
${Vr(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Pt(e,t,a){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function Vr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function Ha(e,t,a,r,n,s,i,o,l,d,u){var g,y,v,_,w,E;const p=new he(a);switch(e){case"create_schedule":{const c=new Date;let f;const h=d||"UTC";if(t.schedule_type==="interval"){const m=parseInt(t.schedule_value,10);f=new Date(c.getTime()+m*60*1e3)}else if(t.schedule_type==="daily"){const[m,x]=t.schedule_value.split(":").map(Number),T=c.toLocaleString("en-US",{timeZone:h}),I=new Date(T),S=new Date(I);S.setHours(m,x,0,0),S<=I&&S.setDate(S.getDate()+1);const A=new Date(S.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(S.toLocaleString("en-US",{timeZone:h})),N=A.getTime()-R.getTime();f=new Date(S.getTime()+N)}else if(t.schedule_type==="weekly"){const[m,x]=t.schedule_value.split(" "),[T,I]=(x||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ie=>Ie.toLowerCase()===m.toLowerCase()),R=c.toLocaleString("en-US",{timeZone:h}),N=new Date(R),$=new Date(N);$.setHours(T,I,0,0);let U=(A-$.getDay()+7)%7;U===0&&$<=N&&(U=7),$.setDate($.getDate()+U);const ke=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),ee=new Date($.toLocaleString("en-US",{timeZone:h})),Se=ke.getTime()-ee.getTime();f=new Date($.getTime()+Se)}else if(t.schedule_type==="once"){const[m,x]=t.schedule_value.split(" "),[T,I,S]=m.split("-").map(Number),[A,R]=(x||"00:00").split(":").map(Number),N=c.toLocaleString("en-US",{timeZone:h}),$=new Date(N),U=new Date($);U.setFullYear(T,I-1,S),U.setHours(A,R,0,0);const ke=new Date(U.toLocaleString("en-US",{timeZone:"UTC"})),ee=new Date(U.toLocaleString("en-US",{timeZone:h})),Se=ke.getTime()-ee.getTime();f=new Date(U.getTime()+Se)}else f=new Date(c.getTime()+3600*1e3);return await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),f.toISOString()).run(),`Schedule created: "${t.name}" — ${t.schedule_type} at ${t.schedule_value}. State: active. Next run: ${f.toISOString()}`}case"list_schedules":{const f=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return f.length===0?"No scheduled tasks found.":f.map(h=>`[ID:${h.id}] ${h.enabled?"▶":"⏸"} "${h.name}" — [${h.schedule_type}] ${h.schedule_value} — ${h.action_type} — state: ${h.state||"active"} — next: ${h.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const c=t.enabled?1:0,f=c?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(c,f,t.job_id,r).run(),`Schedule ${t.job_id} ${c?"enabled (active)":"paused"}.`}case"update_schedule_state":{const c=["created","active","reminding","paused","completed"],f=t.state;if(!c.includes(f))return`Invalid state "${f}". Valid states: ${c.join(", ")}`;const h=f==="completed"||f==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(f,h,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${f}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const c=t.importance||5,f=c>=7?"working":"long_term";return await p.store(r,t.type,t.title,t.content,c,f),`Stored in ${f==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${c})`}case"search_memory":{const c=await p.search(r,t.query);return c.length===0?"No matching memories found.":c.map(f=>`[${f.tier||"long_term"}] [${f.type}] **${f.title}**: ${f.content}`).join(`
`)}case"get_system_status":{const c=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),f=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),m=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),x=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
- Active schedules: ${(c==null?void 0:c.cnt)||0}
- Memory: ${(h==null?void 0:h.cnt)||0} working / ${(f==null?void 0:f.cnt)||0} total
- Total messages: ${(m==null?void 0:m.cnt)||0}
- Unread errors: ${(x==null?void 0:x.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||""),f=t.spreadsheet_id;let h=t.range;const m=await c.sheets.getMetadata(f),x=m.sheets;h.includes("!")||(h=`${x[0]}!${h}`);let T;try{T=await c.sheets.readRange(f,h)}catch(S){if((g=S.message)!=null&&g.includes("Unable to parse range")||(y=S.message)!=null&&y.includes("400")){const A=h.includes("!")?h.split("!")[1]:h;h=`${x[0]}!${A}`,T=await c.sheets.readRange(f,h)}else throw S}let I=`[Spreadsheet: "${m.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${x.map(S=>`"${S}"`).join(", ")}]
`;return x.length>1&&(I+=`[To read a different tab, call read_sheet again with range like "${x[1]}!A1:Z500"]
`),T.length===0?I+"No data found in the specified range.":I+T.map(S=>S.join("	| ")).join(`
`)}catch(c){return await O(a,r,"google","read_sheet",c.message),`Failed to read sheet: ${c.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new Z(a,r,n,s||"",i||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await O(a,r,"google","write_sheet",c.message),`Failed to write sheet: ${c.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new Z(a,r,n,s||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await O(a,r,"google","append_sheet",c.message),`Failed to append to sheet: ${c.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const h=await c.sheets.createSpreadsheet(t.title,t.sheet_names);let m="";if(t.folder_name)try{const{token:x}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||"");m=`
Folder: "${(await Pt(x,h.spreadsheetId,t.folder_name)).folderName}"`}catch(x){m=`
(Could not move to folder "${t.folder_name}": ${x.message})`}try{await new he(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${m}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(c){return await O(a,r,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||""),f=t.calendar_id||"primary",h=t.days_ahead||7,m=new Date,x=new Date(m.getTime()+h*24*60*60*1e3),T=await c.calendar.listEvents(f,{timeMin:m.toISOString(),timeMax:x.toISOString(),query:t.query});return T.length===0?`No events found in the next ${h} days.`:T.map(I=>{var $;const S=I.start.dateTime||I.start.date||"TBD",A=I.end.dateTime||I.end.date||"",R=I.location?` 📍 ${I.location}`:"",N=(($=I.attendees)==null?void 0:$.map(U=>U.email).join(", "))||"";return`• ${I.summary} — ${S} to ${A}${R}${N?`
  Attendees: ${N}`:""}`}).join(`
`)}catch(c){return await O(a,r,"google","list_calendar",c.message),`Failed to list events: ${c.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||""),f=t.calendar_id||"primary",h=await c.calendar.createEvent(f,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${h.summary}"
ID: ${h.id}
Start: ${h.start.dateTime||h.start.date}`}catch(c){return await O(a,r,"google","create_event",c.message),`Failed to create event: ${c.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const h=await c.docs.createDocument(t.title);t.content&&await c.docs.appendText(h.documentId,t.content);let m="";if(t.folder_name)try{const{token:x}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||"");m=`
Folder: "${(await Pt(x,h.documentId,t.folder_name)).folderName}"`}catch(x){m=`
(Could not move to folder "${t.folder_name}": ${x.message})`}try{await new he(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}return`Document created: "${t.title}"${m}
ID: ${h.documentId}
URL: ${h.url}`}catch(c){return await O(a,r,"google","create_doc",c.message),`Failed to create document: ${c.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const f=await new Z(a,r,n,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${f.title}"

${f.content}`}catch(c){return await O(a,r,"google","read_doc",c.message),`Failed to read document: ${c.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const c=new Z(a,r,n,s||"",i||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await c.docs.appendText(t.document_id,t.content);let h=t.document_id;try{h=(await c.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${h}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await O(a,r,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return f.length===0?"No messages found.":f.map((h,m)=>`${h.isUnread?"● ":"  "}${m+1}. **${h.subject}**
   From: ${h.from}
   Date: ${h.date}
   ${h.snippet}
   [id: ${h.id}]`).join(`

`)}catch(c){return await O(a,r,"gmail","list",c.message),(v=c.message)!=null&&v.includes("not connected")?c.message:`Gmail list error: ${c.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const c=new ae(a,r,n,s||"",i||""),f=await c.getMessage(t.message_id);if(!f)return"Message not found.";const h=await c.getMessageBody(t.message_id);return`**${f.subject}**
From: ${f.from}
To: ${f.to}
Date: ${f.date}

${h}`}catch(c){return await O(a,r,"gmail","read",c.message),`Gmail read error: ${c.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").search(t.query,t.max_results||10);return f.length===0?`No results for: ${t.query}`:f.map((h,m)=>`${h.isUnread?"● ":"  "}${m+1}. **${h.subject}**
   From: ${h.from}
   Date: ${h.date}
   ${h.snippet}
   [id: ${h.id}]`).join(`

`)}catch(c){return await O(a,r,"gmail","search",c.message),`Gmail search error: ${c.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${f.id}]`}catch(c){return await O(a,r,"gmail","send",c.message),`Gmail send error: ${c.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${f.id}]`}catch(c){return await O(a,r,"gmail","draft",c.message),`Gmail draft error: ${c.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ae(a,r,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(c){return await O(a,r,"gmail","modify",c.message),`Gmail modify error: ${c.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const f=await new ae(a,r,n,s||"",i||"").getUnreadCount();return`You have ${f} unread email${f!==1?"s":""} in Gmail.`}catch(c){return(_=c.message)!=null&&_.includes("not connected")?c.message:`Gmail error: ${c.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||""),f=new URLSearchParams;f.set("pageSize",String(t.max_results||10)),f.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),f.set("orderBy","modifiedTime desc");let h="";t.folder_id?h=`'${t.folder_id}' in parents and trashed = false`:t.query?h=`${t.query} and trashed = false`:h="trashed = false",f.set("q",h);const m=await fetch(`https://www.googleapis.com/drive/v3/files?${f}`,{headers:{Authorization:`Bearer ${c}`}});if(!m.ok)throw new Error(`Drive API error (${m.status})`);const x=await m.json();return(w=x.files)!=null&&w.length?x.files.map((T,I)=>{var N,$;const S=((N=T.mimeType)==null?void 0:N.split(".").pop())||T.mimeType,A=T.size?`${(parseInt(T.size)/1024).toFixed(1)} KB`:"",R=(($=T.modifiedTime)==null?void 0:$.split("T")[0])||"";return`${I+1}. **${T.name}** (${S})
   ${A} · Modified: ${R}
   ${T.webViewLink||""}`}).join(`

`):"No files found."}catch(c){return await O(a,r,"google","drive_list",c.message),`Drive list error: ${c.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",i||""),f=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,h=new URLSearchParams;h.set("q",f),h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");const m=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${c}`}});if(!m.ok)throw new Error(`Drive API error (${m.status})`);const x=await m.json();return(E=x.files)!=null&&E.length?x.files.map((T,I)=>{var R,N;const S=((R=T.mimeType)==null?void 0:R.split(".").pop())||T.mimeType,A=((N=T.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${I+1}. **${T.name}** (${S}) — Modified: ${A}
   ${T.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(c){return await O(a,r,"google","drive_search",c.message),`Drive search error: ${c.message}`}}case"web_search":try{const c=await pt(t.query,{num:t.num_results||5,site:t.site});return c.error?`Web search failed: ${c.error}`:c.results.length===0?`No results found for "${t.query}".`:c.results.map((f,h)=>`${h+1}. **${f.title}**
   ${f.link}
   ${f.snippet}`).join(`

`)}catch(c){return await O(a,r,"search","web_search",c.message),`Web search error: ${c.message}`}case"read_url":try{const c=t.url;if(!c||!c.startsWith("http://")&&!c.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const f=Math.min(t.max_length||8e3,15e3),{fetchPageContent:h}=await Promise.resolve().then(()=>Kr),m=await h(c,f);return m.error?`Failed to read page: ${m.error}`:!m.text||m.text.length<20?`Page at ${c} returned no readable content.`:`Content from ${c} (${m.text.length} chars):

${m.text}`}catch(c){return await O(a,r,"search","read_url",c.message),`Read URL error: ${c.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const f=Ma(t.query,u,{depth:t.depth||"quick",site:t.site}),h=new Promise(T=>setTimeout(()=>T(null),45e3)),m=await Promise.race([f,h]);if(m===null){const{webSearch:T}=await Promise.resolve().then(()=>Gr),I=await T(t.query,{num:5});if(I.error||I.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let S=`Research took too long, but here are the top search results:

`;return S+=I.results.map((A,R)=>`${R+1}. **${A.title}**
   ${A.snippet}
   ${A.link}`).join(`

`),S}if(m.error)return`Research failed: ${m.error}`;let x=m.report;return m.sources.length>0&&(x+=`

---
**Sources** (`+m.pagesRead+` pages read):
`,x+=m.sources.map((T,I)=>`[${I+1}] ${T.title}
    ${T.url}`).join(`
`)),x}catch(c){return await O(a,r,"research","research",c.message),`Research error: ${c.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const f=await M(c.encrypted_value,n),h=await Ia(f,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((m,x)=>{const T=m.rating?` ★${m.rating} (${m.userRatingsTotal||0} reviews)`:"",I=m.openNow!==void 0?m.openNow?" · Open now":" · Closed":"",S=m.googleMapsUri?`
   ${m.googleMapsUri}`:"";return`${x+1}. **${m.name}**${T}${I}
   ${m.address}${S}
   [place_id: ${m.placeId}]`}).join(`

`)}catch(c){return await O(a,r,"google_api","search_places",c.message),`Places search error: ${c.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Da(f,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const m=h.details;let x=`**${m.name}**
📍 ${m.address}`;if(m.phone&&(x+=`
📞 ${m.phone}`),m.website&&(x+=`
🌐 ${m.website}`),m.rating&&(x+=`
★ ${m.rating}`),m.googleMapsUri&&(x+=`
📌 ${m.googleMapsUri}`),m.openingHours&&(x+=`

Opening Hours:
${m.openingHours.join(`
`)}`),m.reviews&&m.reviews.length>0){x+=`

Recent Reviews:`;for(const T of m.reviews)x+=`
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return x}catch(c){return await O(a,r,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Ca(f,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const m=h.route;let x=`**${m.startAddress}** → **${m.endAddress}**
`;return x+=`📏 ${m.distance} · ⏱️ ${m.duration}`,m.durationInTraffic&&(x+=` (with traffic: ${m.durationInTraffic})`),x+=`
via ${m.summary}`,x+=`

Steps:`,m.steps.forEach((T,I)=>{x+=`
${I+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),x}catch(c){return await O(a,r,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await La(f,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let m=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(m+=` (with traffic: ${h.durationInTraffic})`),m}catch(c){return await O(a,r,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Oa(f,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(c){return await O(a,r,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Aa(f,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((m,x)=>{var T;return`${x+1}. **${m.title}**
   ${m.channelTitle} · ${((T=m.publishedAt)==null?void 0:T.split("T")[0])||""}
   ${m.description}
   ${m.url}`}).join(`

`)}catch(c){return await O(a,r,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!c)return"Google API Key not configured.";const f=await M(c.encrypted_value,n),h=await Ra(f,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((m,x)=>`${x+1}. ${m.address}
   Coordinates: ${m.lat}, ${m.lng}`).join(`
`)}catch(c){return await O(a,r,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function Ot(e,t,a,r,n,s){var _;const i=new he(t),o=(_=e.metadata)==null?void 0:_.thread_id,l=await i.buildContext(r.id),d=await i.getRecentConversations(r.id,25,o),p=[{role:"system",content:Pa(r,l)},...d.map(w=>({role:w.role,content:w.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const g=10;let y="",v=0;for(let w=0;w<g;w++)try{const E=await a.chat(p,{tools:Ba});if(E.usage&&(v+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){E.content&&p.push({role:"assistant",content:E.content});for(const c of E.toolCalls)try{const f=await Ha(c.name,c.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);p.push({role:"user",content:`[Tool Result for ${c.name}]: ${f}`})}catch(f){await O(t,r.id,"tool",c.name,f.message||"Tool execution failed"),p.push({role:"user",content:`[Tool Error for ${c.name}]: ${f.message||"Execution failed"}`})}continue}y=E.content;break}catch(E){if(n){const c=E.message||"",f=c.includes("401")||c.includes("403")||c.includes("authentication")||c.includes("credit balance"),h=c.includes("429"),m=f?1440:h?10:5;await n.recordError(a.name,c,m)}throw await O(t,r.id,"llm","provider_error",E.message||"Unknown LLM error",{provider:a.name,turn:w}),E}if(n&&v>0)try{await n.recordUsage(a.name,v)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",y,"{}",o),await i.compactHistory(r.id,30),y}const Ht={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Xr(e){for(const[t,a]of Object.entries(Ht))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Ht.default}function Zr(e,t,a,r){const n=Xr(r),s=Math.floor(n*.75),i=[];let o=0,l=!1;const d=yt(e);i.push({role:"system",content:e}),o+=d;const u=yt(a);o+=u;const p=s-o,g=[];let y=0;for(let v=t.length-1;v>=0;v--){const _=t[v],w=yt(_.content);if(y+w<=p)g.unshift({role:_.role,content:_.content}),y+=w;else{l=!0;break}}return i.push(...g),i.push({role:"user",content:a}),o+=y,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*Qr(e,t,a,r,n,s){var w;const i=new he(t),o=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:o,provider:a.name}};const l=await i.buildContext(r.id),d=await i.getRecentConversations(r.id,20,o),u=Pa(r,l),p=Zr(u,d,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const g=10;let y="",v=0;const _=[...p.messages];for(let E=0;E<g;E++)try{E>0&&(yield{type:"thinking",data:{threadId:o}});const c=await a.chat(_,{tools:Ba});if(c.usage&&(v+=c.usage.promptTokens+c.usage.completionTokens),c.toolCalls&&c.toolCalls.length>0){c.content&&(yield{type:"chunk",data:{text:c.content,threadId:o}},_.push({role:"assistant",content:c.content}));for(const h of c.toolCalls){yield{type:"tool_start",data:{tool:h.name,toolArgs:h.arguments,threadId:o}};try{const m=await Ha(h.name,h.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:h.name,toolResult:m.substring(0,500)+(m.length>500?"...":""),threadId:o}},_.push({role:"user",content:`[Tool Result for ${h.name}]: ${m}`})}catch(m){await O(t,r.id,"tool",h.name,m.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:h.name,toolResult:`Error: ${m.message||"Execution failed"}`,threadId:o}},_.push({role:"user",content:`[Tool Error for ${h.name}]: ${m.message||"Execution failed"}`})}}continue}y=c.content;const f=50;for(let h=0;h<y.length;h+=f)yield{type:"chunk",data:{text:y.substring(h,h+f),threadId:o}},h+f<y.length&&await new Promise(x=>setTimeout(x,10));break}catch(c){if(n){const f=c.message||"",h=f.includes("401")||f.includes("403")||f.includes("authentication")||f.includes("credit balance"),m=f.includes("429"),x=h?1440:m?10:5;await n.recordError(a.name,f,x)}await O(t,r.id,"llm","provider_error",c.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:c.message||"An error occurred",threadId:o}};return}if(n&&v>0)try{await n.recordUsage(a.name,v)}catch{}await i.storeMessage(r.id,e.channel,"assistant",y,"{}",o),await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:v}}}const j=new ge;async function en(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}j.use("/*",en);j.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const d of s)i+=`- ${d.name} (${d.type}, ${Math.round(d.size/1024)}KB, file_id: ${d.file_id})`,d.text_preview&&(i+=`
  Preview: ${d.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=n;if(!o){const d=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=d==null?void 0:d.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:d,rotation:u}=await et(e.env.DB,t.id,t.pin_hash),p=new ReadableStream({async start(g){const y=new TextEncoder;try{const v=Qr(l,e.env.DB,d,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const _ of v)_.data.threadId||(_.data.threadId=o),g.enqueue(y.encode(Ut(_)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),g.close()}catch(v){const _={type:"error",data:{error:v.message||"An error occurred",threadId:o}};g.enqueue(y.encode(Ut(_))),g.close()}}});return new Response(p,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(d){console.error("Stream setup error:",d);const u=d.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:o},500)}});j.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
Status: ✅ Online`;await z(a,t,u)}catch{await z(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await z(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await z(a,t,"⚠️ Account not linked."),!0);default:return!1}}tt.post("/webhook",async e=>{var t,a,r,n,s;try{const i=await e.req.json();if(i.callback_query)return await cn(e.env.DB,i.callback_query),e.json({ok:!0});const o=i.message;if(!o)return e.json({ok:!0});const l=!!o.text,d=!!o.voice,u=!!o.document,p=!!o.photo,g=!!o.caption;if(!l&&!d&&!u&&!p)return e.json({ok:!0});const y=String(o.chat.id);let v=o.text||"";const _=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(y).first();let w=null;if(_){const m=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(_.id,"telegram_bot_token").first();m&&(w=await M(m.encrypted_value,_.pin_hash))}if(!w){const m=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();m&&(w=await M(m.encrypted_value,m.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(v.startsWith("/")&&await dn(v,y,w,_,e.env.DB))return e.json({ok:!0});if(!_)return await z(w,y,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${y}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(o.voice&&w&&_)try{await z(w,y,"🎤 Processing voice note...");const x=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${o.voice.file_id}`)).json();if(x.ok&&((t=x.result)!=null&&t.file_path)){const I=await(await fetch(`https://api.telegram.org/file/bot${w}/${x.result.file_path}`)).blob();let S="",A="",R="whisper-1";const N=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(_.id).all();for(const ee of N.results){const Se=await M(ee.encrypted_value,_.pin_hash);if(ee.service==="openai"){S="https://api.openai.com/v1/audio/transcriptions",A=Se;break}else if(ee.service.startsWith("llm_slot_"))try{const Ie=JSON.parse(Se);if(Ie.provider==="openai"){S="https://api.openai.com/v1/audio/transcriptions",A=Ie.apiKey;break}else if(Ie.provider==="groq"){S="https://api.groq.com/openai/v1/audio/transcriptions",A=Ie.apiKey,R="whisper-large-v3";break}}catch{}}if(!S)return await z(w,y,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const $=new FormData;$.append("file",I,"voice.ogg"),$.append("model",R);const U=await fetch(S,{method:"POST",headers:{Authorization:`Bearer ${A}`},body:$});if(!U.ok){const ee=await U.text();return await z(w,y,`⚠️ Transcription failed: ${U.status} ${ee}`),e.json({ok:!0})}v=(await U.json()).text,await z(w,y,`🗣️ *You said:* ${v}`)}}catch(m){return await z(w,y,`⚠️ Failed to process voice note: ${m.message}`),e.json({ok:!0})}if((u||p)&&w&&_)try{let m,x="unknown",T="unknown",I=0;if(u)m=o.document.file_id,x=o.document.file_name||"document",T=o.document.mime_type||"unknown",I=o.document.file_size||0;else if(p){const S=o.photo[o.photo.length-1];m=S.file_id,x="photo.jpg",T="image/jpeg",I=S.file_size||0}if(m){const A=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${m}`)).json();let R="";if(A.ok&&((a=A.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(x)||/^text\/|application\/json|application\/xml|application\/csv/i.test(T))&&I<5e4)try{R=await(await fetch(`https://api.telegram.org/file/bot${w}/${A.result.file_path}`)).text()}catch{}const N=o.caption||"",$=`[Telegram file received: "${x}" (${T}, ${Math.round(I/1024)}KB)]`;R?v=`${N?N+`
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(m){if(g&&o.caption)v=o.caption;else return await z(w,y,`⚠️ Received your file but couldn't process it: ${m.message}`),e.json({ok:!0})}if(!v)return e.json({ok:!0});await on(w,y);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(_.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(_.id).run()).meta.last_row_id};const c=rn(_.id,_.username,v,y);c.metadata={thread_id:E.id};let f,h;try{const m=await et(e.env.DB,_.id,_.pin_hash);f=m.provider,h=m.rotation}catch(m){console.error("Telegram provider setup error:",m);const x=(r=m.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=m.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${m.message||"Unknown error"}`;return await z(w,y,x),e.json({ok:!0})}try{const m=await Ot(c,e.env.DB,f,_,h,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),x=nn(m,"telegram");await z(w,y,x||"(empty response)")}catch(m){console.error("Telegram agent error:",m);const x=(s=m.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${f.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(m.message||"Unknown").substring(0,200)}`;await z(w,y,x);try{const{logError:T}=await Promise.resolve().then(()=>_t);await T(e.env.DB,_.id,"telegram","agent_error",m.message||"Agent error",{provider:f.name})}catch{}}return e.json({ok:!0})}catch(i){console.error("Telegram webhook error:",i);try{const{logError:o}=await Promise.resolve().then(()=>_t);await o(e.env.DB,null,"telegram","webhook_error",i.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:i.message})}});tt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await M(n.encrypted_value,a.pin_hash);if(!r){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const o=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});tt.get("/webhook-status",async e=>{var s,i,o,l,d,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const n=await M(r.encrypted_value,a.pin_hash);try{const g=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=g.result)==null?void 0:i.url)||"",has_webhook:!!((o=g.result)!=null&&o.url),pending_updates:((l=g.result)==null?void 0:l.pending_update_count)||0,last_error:((d=g.result)==null?void 0:d.last_error_message)||"",last_error_date:((u=g.result)==null?void 0:u.last_error_date)||null})}catch(p){return e.json({configured:!0,error:p.message})}});tt.post("/detect-chat-id",async e=>{var s,i;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const n=await M(r.encrypted_value,a.pin_hash);try{const d=((i=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(w=>setTimeout(w,500));const p=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const g=p.result||[];if(g.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const y=[],v=new Set;for(let w=g.length-1;w>=0;w--){const E=g[w].message;if(E&&E.chat){const c=String(E.chat.id);v.has(c)||(v.add(c),y.push({chat_id:c,name:[E.chat.first_name,E.chat.last_name].filter(Boolean).join(" ")||E.chat.title||"Unknown",username:E.chat.username||"",date:new Date((E.date||0)*1e3).toISOString()}))}}if(y.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=y[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,a.user_id).run(),e.json({found:!0,chat_id:_,name:y[0].name,all_chats:y,message:`Chat ID ${_} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function cn(e,t){var _;const{id:a,data:r,message:n,from:s}=t;if(!r||!n)return;const i=r.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const d=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!u)return;const p=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(u.id,l,o).first();if(!p)return;const g=p.checked?0:1;await e.prepare(`
  ...
  `).bind(g,g,p.id).run();const y=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!y)return;const v=await M(y.encrypted_value,y.pin_hash);if(await fetch(`https://api.telegram.org/bot${v}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:g?"✅ Checked!":"☐ Unchecked"})}),(_=n.reply_markup)!=null&&_.inline_keyboard){const w=n.reply_markup.inline_keyboard.map(E=>E.map(c=>{var f;if((f=c.callback_data)!=null&&f.includes(o)){const h=g?"✅":"☐",m=c.text.replace(/^[☐✅]\s*/,"");return{...c,text:`${h} ${m}`}}return c}));try{await fetch(`https://api.telegram.org/bot${v}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:w}})})}catch{}}}function un(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const n=new Date(r);n.setHours(23,59,59,999);const s=r.toISOString().split("T")[0];return{start:r.toISOString(),end:n.toISOString(),dateStr:s}}async function pn(e,t,a,r,n,s){try{return(await new Ct(e,t,a,r,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(u=>u.displayName||u.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function mn(e,t,a,r,n){try{const s=new ae(e,t,a,r,n),i=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const p of i){const g=p.from.split("<")[0].trim()||p.from;l[g]=(l[g]||0)+1}const d=Object.entries(l).sort(([,p],[,g])=>g-p).slice(0,5).map(([p])=>p),u=i.some(p=>p.subject.toLowerCase().includes("urgent")||p.subject.toLowerCase().includes("asap")||p.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:d,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function hn(e,t){var a;try{const r=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const i=(r.results||[]).map(l=>l.name),o=(r.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((a=r.results)==null?void 0:a.length)||0,dueToday:o,items:i}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function gn(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],a=[];for(const r of t){const n=`latest ${r} news today`;try{const s=await pt(n,{num:3});if(s.results){for(const i of s.results.slice(0,2))if(!a.some(o=>o.url===i.link)&&(a.push({title:i.title,summary:i.snippet,url:i.link,source:i.displayLink}),a.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(a.length>=5)break}return a.slice(0,5)}function fn(e){const t=[];t.push(`📋 Evening Briefing for ${e.targetDate}`),t.push("");const a=e.calendar.totalCount;if(a>0){t.push(`📅 Tomorrow: ${a} event${a===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const r=e.emails.gmail.unreadCount;if(r>0?(t.push(`📧 Gmail: ${r} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function vn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function yn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function Ua(e,t,a){var E;const r=t.timezone||"Asia/Kolkata",n=un(r),{components:s,newsTopics:i}=await yn(e,t.id),o=[],l=[];s.google_calendar&&(o.push(pn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(o.push(mn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(o.push(hn(e,t.id)),l.push("tasks")),s.news&&(o.push(gn(i)),l.push("news"));const d=await Promise.all(o),u={};l.forEach((c,f)=>{u[c]=d[f]});const p={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},y={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((E=u.googleEvents)==null?void 0:E.length)||0},emails:{gmail:u.gmailSummary||p},tasks:u.tasks||g,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};y.summary=fn(y);const v=vn(y),_=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(y)).first(),w=(_==null?void 0:_.id)||0;for(const c of v)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(w,c.type,c.key,c.text,JSON.stringify(c.metadata),c.sortOrder).run();return{briefingId:w,content:y,items:v}}async function bn(e,t,a){const r=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:n.results||[]}}async function wn(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(i,i,r,a).run(),{checked:i===1}}async function xn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function _n(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[i,o]=e.split(":").map(Number),l=n*60+s,d=i*60+o;return l>=d&&l<d+5}function En(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const K=new ge;async function Ga(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).bind(t.id).run(),e.json({success:!0,message:"Default preferences created"}))}catch(a){return e.json({error:a.message},500)}});K.post("/cron/evening-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare(`
      SELECT u.*, COALESCE(bp.briefing_time, '20:00') as briefing_time
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),n=[],s=new Date;for(const i of r.results||[]){const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(_n(l,o,s))try{const d=await Ua(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(i.telegram_chat_id){const{text:u,inlineKeyboard:p}=En(d.content,d.items);await Tn(e.env.DB,i,u,p,d.briefingId)}n.push({user_id:i.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:o})}catch(d){n.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});K.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,i=new Date(s.getTime()+600*1e3).toISOString(),o=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const d=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!d)continue;const u=await M(d.encrypted_value,l.pin_hash),g=JSON.parse(u).access_token;if(!g)continue;const y=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${g}`}});if(!y.ok)continue;const _=((await y.json()).items||[]).filter(c=>{var h;const f=(h=c.start)==null?void 0:h.dateTime;return f?f>=s.toISOString()&&f<=i:!1});if(_.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!w)continue;const E=await M(w.encrypted_value,l.pin_hash);for(const c of _){const f=new Date(c.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),h=c.location?`
📍 ${c.location}`:"",m=`⏰ Meeting in 10 minutes!

*${c.summary||"Untitled Event"}*
🕐 ${f}${h}`;await fetch(`https://api.telegram.org/bot${E}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:m,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:_.length})}catch(d){n.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function Tn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const i=await M(s.encrypted_value,s.pin_hash);await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:`🌙 *Evening Briefing*

${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(o=>o.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}K.delete("/briefings/:id",Ga,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const X=new ge;X.use("/api/*",Sr());X.route("/api/auth",fe);X.route("/api/chat",j);X.route("/api/settings",B);X.route("/api/system",Ue);X.route("/api/telegram",tt);X.route("/api/proactive",K);X.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ce(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Ce(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(r)).sessionId;if(!i)return e.html(Ce(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(Ce(!1,"Session expired. Please log in again and retry."));const l=o.user_id,d=o.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,p=await Ea(e.env.DB,l,d,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Ce(!0,`Connected as ${p.email}`,p.email))}catch(s){return e.html(Ce(!1,`OAuth failed: ${s.message}`))}});X.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ua())));X.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ua())));function Ce(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function kn(e,t,a){const r="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const o=await(await fetch(`${r}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(o.results&&o.results.length>0){const d=o.results.filter(p=>p.needs_agent&&p.status==="dispatched");if(d.length>0){const p=d.map(g=>fetch(`${r}/api/system/cron/run-task/${g.job_id}`,{method:"POST",headers:s}).then(y=>y.json()).catch(y=>({job_id:g.job_id,error:y.message})));a.waitUntil(Promise.allSettled(p).then(g=>{console.log(`Cron: ${o.executed} dispatched, ${d.length} agent tasks`,JSON.stringify(g.map(y=>y.status==="fulfilled"?y.value:y.reason)))}))}const u=o.results.filter(p=>!p.needs_agent&&p.status==="dispatched");if(u.length>0){const p=u.map(g=>fetch(`${r}/api/system/cron/run-task/${g.job_id}`,{method:"POST",headers:s}).catch(()=>{}));a.waitUntil(Promise.allSettled(p))}}a.waitUntil(fetch(`${r}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{d.executed>0&&console.log("Evening briefing result:",JSON.stringify(d))}).catch(d=>{console.error("Evening briefing error:",d.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${r}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{var u;(u=d.results)!=null&&u.some(p=>p.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(d))}).catch(()=>{}))}catch(i){console.error("Scheduled cron error:",i.message||i)}}const Sn={fetch:X.fetch,scheduled:kn},zt=new ge,In=Object.assign({"/src/index.tsx":Sn});let za=!1;for(const[,e]of Object.entries(In))e&&(zt.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),zt.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),za=!0);if(!za)throw new Error("Can't import modules from ['/src/index.tsx']");export{zt as default};
