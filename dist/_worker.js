var ur=Object.defineProperty;var Ht=e=>{throw TypeError(e)};var pr=(e,t,a)=>t in e?ur(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var C=(e,t,a)=>pr(e,typeof t!="symbol"?t+"":t,a),_t=(e,t,a)=>t.has(e)||Ht("Cannot "+a);var b=(e,t,a)=>(_t(e,t,"read from private field"),a?a.call(e):t.get(e)),N=(e,t,a)=>t.has(e)?Ht("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),R=(e,t,a,r)=>(_t(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),$=(e,t,a)=>(_t(e,t,"access private method"),a);var Gt=(e,t,a,r)=>({set _(n){R(e,t,n,a)},get _(){return b(e,t,r)}});var Ft=(e,t,a)=>(r,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],r.req.routeIndex=o):d=o===e.length&&n||void 0,d)try{l=await d(r,()=>i(o+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),c=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},mr=Symbol(),hr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ha?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?gr(e,{all:a,dot:r}):{}};async function gr(e,t){const a=await e.formData();return a?fr(a,t):{}}function fr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?yr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(vr(a,r,n),delete a[r])}),a}var yr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},vr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},ca=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},br=e=>{const{groups:t,path:a}=wr(e),r=ca(a);return _r(r,t)},wr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},_r=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},ct={},Er=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return ct[r]||(a[2]?ct[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:ct[r]=[e,a[1],!0]),ct[r]}return null},At=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Tr=e=>At(e,decodeURI),da=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),i=t.indexOf("#",r),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return Tr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},xr=e=>{const t=da(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ae=(e,t,...a)=>(a.length&&(t=Ae(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ua=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,i)=>i.indexOf(n)===s)},Et=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?At(e,ma):e):e,pa=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return Et(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(r&&(l=Et(l)),s=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),r&&(c=Et(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},Sr=pa,kr=(e,t)=>pa(e,t,!0),ma=decodeURIComponent,Wt=e=>At(e,ma),je,X,he,ga,fa,Dt,fe,ra,ha=(ra=class{constructor(e,t="/",a=[[]]){N(this,he);C(this,"raw");N(this,je);N(this,X);C(this,"routeIndex",0);C(this,"path");C(this,"bodyCache",{});N(this,fe,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,R(this,X,a),R(this,je,{})}param(e){return e?$(this,he,ga).call(this,e):$(this,he,fa).call(this)}query(e){return Sr(this.url,e)}queries(e){return kr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await hr(this,e))}json(){return b(this,fe).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,fe).call(this,"text")}arrayBuffer(){return b(this,fe).call(this,"arrayBuffer")}blob(){return b(this,fe).call(this,"blob")}formData(){return b(this,fe).call(this,"formData")}addValidatedData(e,t){b(this,je)[e]=t}valid(e){return b(this,je)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[mr](){return b(this,X)}get matchedRoutes(){return b(this,X)[0].map(([[,e]])=>e)}get routePath(){return b(this,X)[0].map(([[,e]])=>e)[this.routeIndex].path}},je=new WeakMap,X=new WeakMap,he=new WeakSet,ga=function(e){const t=b(this,X)[0][this.routeIndex][1][e],a=$(this,he,Dt).call(this,t);return a&&/\%/.test(a)?Wt(a):a},fa=function(){const e={},t=Object.keys(b(this,X)[0][this.routeIndex][1]);for(const a of t){const r=$(this,he,Dt).call(this,b(this,X)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Wt(r):r)}return e},Dt=function(e){return b(this,X)[1]?b(this,X)[1][e]:e},fe=new WeakMap,ra),Ir={Stringify:1},ya=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>ya(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},Dr="text/plain; charset=UTF-8",Tt=(e,t)=>({"Content-Type":e,...t}),Qe,et,de,Be,ue,V,tt,Pe,Ue,ke,at,rt,ye,Me,na,Or=(na=class{constructor(e,t){N(this,ye);N(this,Qe);N(this,et);C(this,"env",{});N(this,de);C(this,"finalized",!1);C(this,"error");N(this,Be);N(this,ue);N(this,V);N(this,tt);N(this,Pe);N(this,Ue);N(this,ke);N(this,at);N(this,rt);C(this,"render",(...e)=>(b(this,Pe)??R(this,Pe,t=>this.html(t)),b(this,Pe).call(this,...e)));C(this,"setLayout",e=>R(this,tt,e));C(this,"getLayout",()=>b(this,tt));C(this,"setRenderer",e=>{R(this,Pe,e)});C(this,"header",(e,t,a)=>{this.finalized&&R(this,V,new Response(b(this,V).body,b(this,V)));const r=b(this,V)?b(this,V).headers:b(this,ke)??R(this,ke,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});C(this,"status",e=>{R(this,Be,e)});C(this,"set",(e,t)=>{b(this,de)??R(this,de,new Map),b(this,de).set(e,t)});C(this,"get",e=>b(this,de)?b(this,de).get(e):void 0);C(this,"newResponse",(...e)=>$(this,ye,Me).call(this,...e));C(this,"body",(e,t,a)=>$(this,ye,Me).call(this,e,t,a));C(this,"text",(e,t,a)=>!b(this,ke)&&!b(this,Be)&&!t&&!a&&!this.finalized?new Response(e):$(this,ye,Me).call(this,e,t,Tt(Dr,a)));C(this,"json",(e,t,a)=>$(this,ye,Me).call(this,JSON.stringify(e),t,Tt("application/json",a)));C(this,"html",(e,t,a)=>{const r=n=>$(this,ye,Me).call(this,n,t,Tt("text/html; charset=UTF-8",a));return typeof e=="object"?ya(e,Ir.Stringify,!1,{}).then(r):r(e)});C(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});C(this,"notFound",()=>(b(this,Ue)??R(this,Ue,()=>new Response),b(this,Ue).call(this,this)));R(this,Qe,e),t&&(R(this,ue,t.executionCtx),this.env=t.env,R(this,Ue,t.notFoundHandler),R(this,rt,t.path),R(this,at,t.matchResult))}get req(){return b(this,et)??R(this,et,new ha(b(this,Qe),b(this,rt),b(this,at))),b(this,et)}get event(){if(b(this,ue)&&"respondWith"in b(this,ue))return b(this,ue);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ue))return b(this,ue);throw Error("This context has no ExecutionContext")}get res(){return b(this,V)||R(this,V,new Response(null,{headers:b(this,ke)??R(this,ke,new Headers)}))}set res(e){if(b(this,V)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,V).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,V).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}R(this,V,e),this.finalized=!0}get var(){return b(this,de)?Object.fromEntries(b(this,de)):{}}},Qe=new WeakMap,et=new WeakMap,de=new WeakMap,Be=new WeakMap,ue=new WeakMap,V=new WeakMap,tt=new WeakMap,Pe=new WeakMap,Ue=new WeakMap,ke=new WeakMap,at=new WeakMap,rt=new WeakMap,ye=new WeakSet,Me=function(e,t,a){const r=b(this,V)?new Headers(b(this,V).headers):b(this,ke)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")r.set(s,i);else{r.delete(s);for(const o of i)r.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Be);return new Response(e,{status:n,headers:r})},na),z="ALL",Cr="all",Rr=["get","post","put","delete","options","patch"],va="Can not add a route since the matcher is already built.",ba=class extends Error{},Lr="__COMPOSED_HANDLER",Nr=e=>e.text("404 Not Found",404),zt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,q,wa,ee,xe,pt,mt,He,Ar=(He=class{constructor(t={}){N(this,q);C(this,"get");C(this,"post");C(this,"put");C(this,"delete");C(this,"options");C(this,"patch");C(this,"all");C(this,"on");C(this,"use");C(this,"router");C(this,"getPath");C(this,"_basePath","/");N(this,Q,"/");C(this,"routes",[]);N(this,ee,Nr);C(this,"errorHandler",zt);C(this,"onError",t=>(this.errorHandler=t,this));C(this,"notFound",t=>(R(this,ee,t),this));C(this,"fetch",(t,...a)=>$(this,q,mt).call(this,t,a[1],a[0],t.method));C(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ae("/",t)}`,a),r,n)));C(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith($(this,q,mt).call(this,t.request,t,void 0,t.request.method))})});[...Rr,Cr].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?R(this,Q,i):$(this,q,xe).call(this,s,b(this,Q),i),o.forEach(l=>{$(this,q,xe).call(this,s,b(this,Q),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){R(this,Q,l);for(const c of[s].flat())o.map(d=>{$(this,q,xe).call(this,c.toUpperCase(),b(this,Q),d)})}return this},this.use=(s,...i)=>(typeof s=="string"?R(this,Q,s):(R(this,Q,"*"),i.unshift(s)),i.forEach(o=>{$(this,q,xe).call(this,z,b(this,Q),o)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??da:xr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let s;a.errorHandler===zt?s=n.handler:(s=async(o,l)=>(await Ft([],a.errorHandler)(o,()=>n.handler(o,l))).res,s[Lr]=n.handler),$(i=r,q,xe).call(i,n.method,n.path,s)}),this}basePath(t){const a=$(this,q,wa).call(this);return a._basePath=Ae(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ae(this._basePath,t),c=l==="/"?0:l.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const o=async(l,c)=>{const d=await a(n(l.req.raw),...i(l));if(d)return d;await c()};return $(this,q,xe).call(this,z,Ae(t,"*"),o),this}},Q=new WeakMap,q=new WeakSet,wa=function(){const t=new He({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,R(t,ee,b(this,ee)),t.routes=this.routes,t},ee=new WeakMap,xe=function(t,a,r){t=t.toUpperCase(),a=Ae(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},pt=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},mt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await $(this,q,mt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),i=this.router.match(n,s),o=new Or(t,{path:s,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,ee)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await b(this,ee).call(this,o)})}catch(d){return $(this,q,pt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:b(this,ee).call(this,o))).catch(d=>$(this,q,pt).call(this,d,o)):c??b(this,ee).call(this,o)}const l=Ft(i[0],this.errorHandler,b(this,ee));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return $(this,q,pt).call(this,c,o)}})()},He),_a=[];function Mr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const i=a[n]||a[z],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],_a];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=r,r(e,t)}var gt="[^/]+",Ye=".*",Ve="(?:|/.*)",$e=Symbol(),$r=new Set(".\\+*[^]$()");function jr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ye||e===Ve?1:t===Ye||t===Ve?-1:e===gt?1:t===gt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ie,De,te,Re,Br=(Re=class{constructor(){N(this,Ie);N(this,De);N(this,te,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Ie)!==void 0)throw $e;if(s)return;R(this,Ie,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Ye]:["","",gt]:i==="/*"?["","",Ve]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let p=l[2]||gt;if(d&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw $e;if(c=b(this,te)[p],!c){if(Object.keys(b(this,te)).some(g=>g!==Ye&&g!==Ve))throw $e;if(s)return;c=b(this,te)[p]=new Re,d!==""&&R(c,De,n.varIndex++)}!s&&d!==""&&r.push([d,b(c,De)])}else if(c=b(this,te)[i],!c){if(Object.keys(b(this,te)).some(d=>d.length>1&&d!==Ye&&d!==Ve))throw $e;if(s)return;c=b(this,te)[i]=new Re}c.insert(o,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,te)).sort(jr).map(r=>{const n=b(this,te)[r];return(typeof b(n,De)=="number"?`(${r})@${b(n,De)}`:$r.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Ie)=="number"&&a.unshift(`#${b(this,Ie)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Ie=new WeakMap,De=new WeakMap,te=new WeakMap,Re),yt,nt,sa,Pr=(sa=class{constructor(){N(this,yt,{varIndex:0});N(this,nt,new Br)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,o=!0,c}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return b(this,nt).insert(s,t,r,b(this,yt),a),r}buildRegExp(){let e=b(this,nt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},yt=new WeakMap,nt=new WeakMap,sa),Ur=[/^$/,[],Object.create(null)],ht=Object.create(null);function Ea(e){return ht[e]??(ht[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Hr(){ht=Object.create(null)}function Gr(e){var c;const t=new Pr,a=[];if(e.length===0)return Ur;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[g,v])=>d?1:g?-1:p.length-v.length),n=Object.create(null);for(let d=0,p=-1,g=r.length;d<g;d++){const[v,f,T]=r[d];v?n[f]=[T.map(([E])=>[E,Object.create(null)]),_a]:p++;let _;try{_=t.insert(f,p,v)}catch(E){throw E===$e?new ba(f):E}v||(a[p]=T.map(([E,u])=>{const h=Object.create(null);for(u-=1;u>=0;u--){const[m,y]=_[u];h[m]=y}return[E,h]}))}const[s,i,o]=t.buildRegExp();for(let d=0,p=a.length;d<p;d++)for(let g=0,v=a[d].length;g<v;g++){const f=(c=a[d][g])==null?void 0:c[1];if(!f)continue;const T=Object.keys(f);for(let _=0,E=T.length;_<E;_++)f[T[_]]=o[f[T[_]]]}const l=[];for(const d in i)l[d]=a[i[d]];return[s,l,n]}function Le(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(Ea(a).test(t))return[...e[a]]}}var ve,be,vt,Ta,ia,Fr=(ia=class{constructor(){N(this,vt);C(this,"name","RegExpRouter");N(this,ve);N(this,be);C(this,"match",Mr);R(this,ve,{[z]:Object.create(null)}),R(this,be,{[z]:Object.create(null)})}add(e,t,a){var o;const r=b(this,ve),n=b(this,be);if(!r||!n)throw new Error(va);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[z]).forEach(c=>{l[e][c]=[...l[z][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Ea(t);e===z?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=Le(r[c],t)||Le(r[z],t)||[])}):(o=r[e])[t]||(o[t]=Le(r[e],t)||Le(r[z],t)||[]),Object.keys(r).forEach(c=>{(e===z||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,s])})}),Object.keys(n).forEach(c=>{(e===z||e===c)&&Object.keys(n[c]).forEach(d=>l.test(d)&&n[c][d].push([a,s]))});return}const i=ua(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(n).forEach(p=>{var g;(e===z||e===p)&&((g=n[p])[d]||(g[d]=[...Le(r[p],d)||Le(r[z],d)||[]]),n[p][d].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,be)).concat(Object.keys(b(this,ve))).forEach(t=>{e[t]||(e[t]=$(this,vt,Ta).call(this,t))}),R(this,ve,R(this,be,void 0)),Hr(),e}},ve=new WeakMap,be=new WeakMap,vt=new WeakSet,Ta=function(e){const t=[];let a=e===z;return[b(this,ve),b(this,be)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==z&&t.push(...Object.keys(r[z]).map(s=>[s,r[z][s]]))}),a?Gr(t):null},ia),we,pe,oa,Wr=(oa=class{constructor(e){C(this,"name","SmartRouter");N(this,we,[]);N(this,pe,[]);R(this,we,e.routers)}add(e,t,a){if(!b(this,pe))throw new Error(va);b(this,pe).push([e,t,a])}match(e,t){if(!b(this,pe))throw new Error("Fatal error");const a=b(this,we),r=b(this,pe),n=a.length;let s=0,i;for(;s<n;s++){const o=a[s];try{for(let l=0,c=r.length;l<c;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof ba)continue;throw l}this.match=o.match.bind(o),R(this,we,[o]),R(this,pe,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,pe)||b(this,we).length!==1)throw new Error("No active router has been determined yet.");return b(this,we)[0]}},we=new WeakMap,pe=new WeakMap,oa),ze=Object.create(null),_e,Y,Oe,Ge,J,me,Se,Fe,zr=(Fe=class{constructor(t,a,r){N(this,me);N(this,_e);N(this,Y);N(this,Oe);N(this,Ge,0);N(this,J,ze);if(R(this,Y,r||Object.create(null)),R(this,_e,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},R(this,_e,[n])}R(this,Oe,[])}insert(t,a,r){R(this,Ge,++Gt(this,Ge)._);let n=this;const s=br(a),i=[];for(let o=0,l=s.length;o<l;o++){const c=s[o],d=s[o+1],p=Er(c,d),g=Array.isArray(p)?p[0]:c;if(g in b(n,Y)){n=b(n,Y)[g],p&&i.push(p[1]);continue}b(n,Y)[g]=new Fe,p&&(b(n,Oe).push(p),i.push(p[1])),n=b(n,Y)[g]}return b(n,_e).push({[t]:{handler:r,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:b(this,Ge)}}),n}search(t,a){var l;const r=[];R(this,J,ze);let s=[this];const i=ca(a),o=[];for(let c=0,d=i.length;c<d;c++){const p=i[c],g=c===d-1,v=[];for(let f=0,T=s.length;f<T;f++){const _=s[f],E=b(_,Y)[p];E&&(R(E,J,b(_,J)),g?(b(E,Y)["*"]&&r.push(...$(this,me,Se).call(this,b(E,Y)["*"],t,b(_,J))),r.push(...$(this,me,Se).call(this,E,t,b(_,J)))):v.push(E));for(let u=0,h=b(_,Oe).length;u<h;u++){const m=b(_,Oe)[u],y=b(_,J)===ze?{}:{...b(_,J)};if(m==="*"){const I=b(_,Y)["*"];I&&(r.push(...$(this,me,Se).call(this,I,t,b(_,J))),R(I,J,y),v.push(I));continue}const[x,w,D]=m;if(!p&&!(D instanceof RegExp))continue;const k=b(_,Y)[x],S=i.slice(c).join("/");if(D instanceof RegExp){const I=D.exec(S);if(I){if(y[w]=I[0],r.push(...$(this,me,Se).call(this,k,t,b(_,J),y)),Object.keys(b(k,Y)).length){R(k,J,y);const O=((l=I[0].match(/\//))==null?void 0:l.length)??0;(o[O]||(o[O]=[])).push(k)}continue}}(D===!0||D.test(p))&&(y[w]=p,g?(r.push(...$(this,me,Se).call(this,k,t,y,b(_,J))),b(k,Y)["*"]&&r.push(...$(this,me,Se).call(this,b(k,Y)["*"],t,y,b(_,J)))):(R(k,J,y),v.push(k)))}}s=v.concat(o.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},_e=new WeakMap,Y=new WeakMap,Oe=new WeakMap,Ge=new WeakMap,J=new WeakMap,me=new WeakSet,Se=function(t,a,r,n){const s=[];for(let i=0,o=b(t,_e).length;i<o;i++){const l=b(t,_e)[i],c=l[a]||l[z],d={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==ze||n&&n!==ze))for(let p=0,g=c.possibleKeys.length;p<g;p++){const v=c.possibleKeys[p],f=d[c.score];c.params[v]=n!=null&&n[v]&&!f?n[v]:r[v]??(n==null?void 0:n[v]),d[c.score]=!0}}return s},Fe),Ce,la,qr=(la=class{constructor(){C(this,"name","TrieRouter");N(this,Ce);R(this,Ce,new zr)}add(e,t,a){const r=ua(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ce).insert(e,r[n],a);return}b(this,Ce).insert(e,t,a)}match(e,t){return b(this,Ce).search(e,t)}},Ce=new WeakMap,la),Ee=class extends Ar{constructor(e={}){super(e),this.router=e.router??new Wr({routers:[new Fr,new qr]})}},Kr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var d;function l(p,g){i.res.headers.set(p,g)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await n(i.req.header("origin")||"",i);p.length&&l("Access-Control-Allow-Methods",p.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function xa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>Ia),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const p=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!p)return;const g=await c(p.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${g}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function qt(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Oa{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",n="anthropic"){C(this,"name");C(this,"apiKey");C(this,"model");C(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=n}async chat(t,a){var d,p,g,v;const r=t.find(f=>f.role==="system"),n=t.filter(f=>f.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:n.map(f=>({role:f.role,content:f.content}))};r&&(s.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})));const i=await Da(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)}),this.name);if(!i.ok){const f=await i.text();throw new Error(this.name+" API error "+i.status+": "+f)}const o=await i.json(),l=((d=o.content)==null?void 0:d.filter(f=>f.type==="text"))||[],c=((p=o.content)==null?void 0:p.filter(f=>f.type==="tool_use"))||[];return{content:l.map(f=>f.text).join(`
`),toolCalls:c.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((g=o.usage)==null?void 0:g.input_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(c=>c.role==="system"),n=t.filter(c=>c.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:n.map(c=>({role:c.role,content:c.content}))};r&&(s.system=r.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const c=await i.text();throw new Error(this.name+" stream error "+i.status+": "+c)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var f;const{done:d,value:p}=await o.read();if(d){c.close();return}const v=l.decode(p,{stream:!0}).split(`
`);for(const T of v)if(T.startsWith("data: ")){const _=T.slice(6);if(_==="[DONE]")continue;try{const E=JSON.parse(_);E.type==="content_block_delta"&&((f=E.delta)!=null&&f.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E.delta.text})+`

`))}catch{}}}})}}function Vr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const n={};for(const[s,i]of Object.entries(r))i&&typeof i=="object"?n[s]=Ot(i):n[s]=i;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Ot(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[n,s]of Object.entries(a))s&&typeof s=="object"?r[n]=Ot(s):r[n]=s;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Ot(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ca{constructor(t,a,r,n){C(this,"name");C(this,"apiKey");C(this,"model");C(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=n}async chat(t,a){var l,c,d,p,g,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},n=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&n)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:Vr(f.parameters||{})}})));const s=await Da(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)}),this.name);if(!s.ok){const f=await s.text();throw new Error(this.name+" API error "+s.status+": "+f)}const i=await s.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((c=o==null?void 0:o.message)==null?void 0:c.content)||"",toolCalls:(p=(d=o==null?void 0:o.message)==null?void 0:d.tool_calls)==null?void 0:p.map(f=>({id:f.id,name:f.function.name,arguments:(()=>{try{return typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((g=i.usage)==null?void 0:g.prompt_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!n.ok){const o=await n.text();throw new Error(this.name+" stream error "+n.status+": "+o)}const s=n.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var g,v,f;const{done:l,value:c}=await s.read();if(l){o.close();return}const p=i.decode(c,{stream:!0}).split(`
`);for(const T of p)if(T.startsWith("data: ")){const _=T.slice(6);if(_==="[DONE]")continue;try{const u=(f=(v=(g=JSON.parse(_).choices)==null?void 0:g[0])==null?void 0:v.delta)==null?void 0:f.content;u&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:u})+`

`))}catch{}}}})}}function Ct(e,t,a,r){const n=Ze[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new Oa(t,s,n.apiBase,a):new Ca(t,s,n.apiBase,a)}class Ra{constructor(){C(this,"errorLog",new Map);C(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const Zr=["llm_slot_1","llm_slot_2","llm_slot_3"],Xr=["anthropic","openai"];async function st(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Ia),n=new Ra,s=[];for(const p of Zr){const g=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(g)try{const v=await r(g.encrypted_value,a),f=JSON.parse(v);if(f.provider&&f.apiKey&&Ze[f.provider]){const _=f.provider,E=Ct(f.provider,f.apiKey,_,f.model);s.push({name:_,provider:E})}}catch(v){console.error(`Failed to load ${p}:`,v)}}const i=new Set(s.map(p=>p.name));for(const p of Xr){if(i.has(p))continue;const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,p).first();if(g)try{const v=await r(g.encrypted_value,a);if(Ze[p]){const T=Ct(p,v,p);s.push({name:p,provider:T})}}catch{console.error(`Failed to decrypt legacy ${p} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=s.map(p=>p.name),l=await n.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const c=s.find(p=>p.name===l);return{provider:Qr(c.provider,s,n,e,t),rotation:n}}function Qr(e,t,a,r,n){const s=i=>i.includes("401")||i.includes("403")||i.includes("authentication")||i.includes("credit balance")||i.includes("invalid")&&i.includes("key")||i.includes("properties field not found")||i.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(i,o){try{return await e.chat(i,o)}catch(l){const c=l.message||"";throw s(c)&&!c.includes("TOOLS_UNSUPPORTED")&&xt(r,n,"all_providers_down",e.name,null,c),l}},async streamChat(i,o){return await e.streamChat(i,o)}}:{name:e.name,async chat(i,o){try{return await e.chat(i,o)}catch(l){const c=l.message||"";if(!s(c))throw l;const d=c.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${d?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,d?1:1440);const p=t.filter(g=>g.name!==e.name);for(const g of p)try{const v=await g.provider.chat(i,o);return this.name=g.name,d||xt(r,n,"provider_switched",e.name,g.name,c),v}catch(v){const f=v.message||"";if(s(f)){await a.recordError(g.name,f,1440);continue}throw v}throw xt(r,n,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(i,o){return await e.streamChat(i,o)}}}const Rt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Oa,OpenAICompatibleProvider:Ca,ProviderRotation:Ra,createProviderFromConfig:Ct,createRotatingProvider:st,logError:A},Symbol.toStringTag,{value:"Module"})),St=20,en=2e3,tn=2e3,La=4;function an(e){return Math.ceil(e.length/La)}function Kt(e,t){const a=t*La;return e.length<=a?e:e.slice(0,a)+`
...
`),t.trim()}async function Za(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await wt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,r).map(async g=>{const v=await Va(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),c=(await Promise.all(o)).filter(g=>g.content.length>50);if(c.length===0){const g=s.results.map((f,T)=>`[${T+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await Yt(e,g,t,"snippets"),sources:s.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const d=c.map((g,v)=>`--- SOURCE ${v+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Yt(e,d,t,"full"),sources:c.map(g=>({title:g.title,url:g.url})),pagesRead:c.length}}async function Yt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I'll now..." — just call the tool.`:""}`}async function Zt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function ar(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function ft(e,t,a,r,n,s,i,o,l,c,d,p){const g=Date.now();let v=!0,f="",T="";try{return T=await wn(e,t,a,r,s,i,o,l,c,d,p),T}catch(_){throw v=!1,f=_.message||"Unknown error",_}finally{const _=Date.now()-g;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?T:"").substring(0,500),v?1:0,f||null,_,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function wn(e,t,a,r,n,s,i,o,l,c,d){var g,v,f,T,_,E;const p=new ae(a);switch(e){case"create_schedule":{const u=new Date;let h;const m=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){h=new Date(u.getTime()+t.minutes_from_now*60*1e3);const D=h.toLocaleString("en-US",{timeZone:m,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[k,S,I]=(D[0]||"").split("/");t.schedule_value=`${I}-${k}-${S} ${D[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const w=parseInt(t.schedule_value,10);h=new Date(u.getTime()+w*60*1e3)}else if(t.schedule_type==="daily"){const[w,D]=t.schedule_value.split(":").map(Number),k=u.toLocaleString("en-US",{timeZone:m}),S=new Date(k),I=new Date(S);I.setHours(w,D,0,0),I<=S&&I.setDate(I.getDate()+1);const O=new Date(I.toLocaleString("en-US",{timeZone:"UTC"})),L=new Date(I.toLocaleString("en-US",{timeZone:m})),M=O.getTime()-L.getTime();h=new Date(I.getTime()+M)}else if(t.schedule_type==="weekly"){const[w,D]=t.schedule_value.split(" "),[k,S]=(D||"00:00").split(":").map(Number),O=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ne=>ne.toLowerCase()===w.toLowerCase()),L=u.toLocaleString("en-US",{timeZone:m}),M=new Date(L),j=new Date(M);j.setHours(k,S,0,0);let B=(O-j.getDay()+7)%7;B===0&&j<=M&&(B=7),j.setDate(j.getDate()+B);const K=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),U=new Date(j.toLocaleString("en-US",{timeZone:m})),W=K.getTime()-U.getTime();h=new Date(j.getTime()+W)}else if(t.schedule_type==="once"){const[w,D]=t.schedule_value.split(" "),[k,S,I]=w.split("-").map(Number),[O,L]=(D||"00:00").split(":").map(Number),M=u.toLocaleString("en-US",{timeZone:m}),j=new Date(M),B=new Date(j);B.setFullYear(k,S-1,I),B.setHours(O,L,0,0);const K=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),U=new Date(B.toLocaleString("en-US",{timeZone:m})),W=K.getTime()-U.getTime();h=new Date(B.getTime()+W);const ne=new Date(u.getTime()+120*1e3);if(h.getTime()<u.getTime()+60*1e3){const oe=h.toISOString();h=ne;const ot=` [Note: The requested time ${t.schedule_value} in ${m} resolved to ${oe} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${h.toISOString()}.]`;t._pastTimeWarning=ot}}else h=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),h.toISOString()).run();const y=t._pastTimeWarning||"",x=h.toLocaleString("en-US",{timeZone:m,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${x} (${m}). [UTC: ${h.toISOString()}]${y}. IMPORTANT: Use the exact time "${x}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const h=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return h.length===0?"No scheduled tasks found.":h.map(m=>`[ID:${m.id}] ${m.enabled?"▶":"⏸"} "${m.name}" — [${m.schedule_type}] ${m.schedule_value} — ${m.action_type} — state: ${m.state||"active"} — next: ${m.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,h=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,h,t.job_id,r).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],h=t.state;if(!u.includes(h))return`Invalid state "${h}". Valid states: ${u.join(", ")}`;const m=h==="completed"||h==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(h,m,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${h}".`}case"update_schedule":{const u=t.job_id,h=c||"UTC",m=new Date,y=["updated_at = CURRENT_TIMESTAMP"],x=[];t.name&&(y.push("name = ?"),x.push(t.name)),t.description&&(y.push("description = ?"),x.push(t.description));let w=null,D=t.schedule_type,k=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){w=new Date(m.getTime()+t.minutes_from_now*60*1e3);const O=w.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[L,M,j]=(O[0]||"").split("/");k=`${j}-${L}-${M} ${O[1]||"00:00"}`,D="once"}else if(D&&k){if(D==="interval")w=new Date(m.getTime()+parseInt(k,10)*60*1e3);else if(D==="daily"){const[I,O]=k.split(":").map(Number),L=new Date(m.toLocaleString("en-US",{timeZone:h})),M=new Date(L);M.setHours(I,O,0,0),M<=L&&M.setDate(M.getDate()+1);const j=new Date(M.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(M.toLocaleString("en-US",{timeZone:h})).getTime();w=new Date(M.getTime()+j)}else if(D==="weekly"){const[I,O]=k.split(" "),[L,M]=(O||"00:00").split(":").map(Number),B=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(oe=>oe.toLowerCase()===I.toLowerCase()),K=new Date(m.toLocaleString("en-US",{timeZone:h})),U=new Date(K);U.setHours(L,M,0,0);let W=(B-U.getDay()+7)%7;W===0&&U<=K&&(W=7),U.setDate(U.getDate()+W);const ne=new Date(U.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(U.toLocaleString("en-US",{timeZone:h})).getTime();w=new Date(U.getTime()+ne)}else if(D==="once"){const[I,O]=k.split(" "),[L,M,j]=I.split("-").map(Number),[B,K]=(O||"00:00").split(":").map(Number),U=new Date(m.toLocaleString("en-US",{timeZone:h})),W=new Date(U);W.setFullYear(L,M-1,j),W.setHours(B,K,0,0);const ne=new Date(W.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(W.toLocaleString("en-US",{timeZone:h})).getTime();w=new Date(W.getTime()+ne),w.getTime()<m.getTime()+60*1e3&&(w=new Date(m.getTime()+120*1e3))}}if(D&&(y.push("schedule_type = ?"),x.push(D)),k&&(y.push("schedule_value = ?"),x.push(k)),w&&(y.push("next_run = ?"),x.push(w.toISOString())),y.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";x.push(u,r),await a.prepare(`UPDATE cron_jobs SET ${y.join(", ")} WHERE id = ? AND user_id = ?`).bind(...x).run();const S=w?w.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${S?` New fire time: ${S} (${h}).`:""} IMPORTANT: Use this exact time "${S}" when confirming to the user.`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,h=t.type==="task"?"preference":t.type,m=u>=7?"working":"long_term";return await p.store(r,h,t.title,t.content,u,m),`Stored in ${m==="working"?"working":"long-term"} memory: [${h}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await p.search(r,t.query);return u.length===0?"No matching memories found.":u.map(h=>`[${h.tier||"long_term"}] [${h.type}] **${h.title}**: ${h.content}`).join(`
`)}case"get_system_status":{const u=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),m=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),y=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),x=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(x==null?void 0:x.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.spreadsheet_id;let m=t.range;const y=await u.sheets.getMetadata(h),x=y.sheets;m.includes("!")||(m=`${x[0]}!${m}`);let w;try{w=await u.sheets.readRange(h,m)}catch(k){if((g=k.message)!=null&&g.includes("Unable to parse range")||(v=k.message)!=null&&v.includes("400")){const S=m.includes("!")?m.split("!")[1]:m;m=`${x[0]}!${S}`,w=await u.sheets.readRange(h,m)}else throw k}let D=`[Spreadsheet: "${y.title}" | Reading tab: "${m.split("!")[0]}" | All tabs in this spreadsheet: ${x.map(k=>`"${k}"`).join(", ")}]
`;return x.length>1&&(D+=`[To read a different tab, call read_sheet again with range like "${x[1]}!A1:Z500"]
`),w.length===0?D+"No data found in the specified range.":D+w.map(k=>k.join("	| ")).join(`
`)}catch(u){return await A(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.values;let m=t.range;const w=Math.max(...h.map(I=>I.length))+4,D=h.map(I=>{const O=[...I];for(;O.length<w;)O.push("");return O}),k=m.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(k){const I=k[1]||"",O=k[2],L=k[3],M=k[5],B=O.toUpperCase().charCodeAt(0)-64+w-1,K=B<=26?String.fromCharCode(64+B):"Z";m=`${I}${O}${L}:${K}${M}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,m,D)).updatedCells} cells to ${m}.`}catch(u){return await A(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new se(a,r,n,s||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await A(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let y="";if(t.folder_name)try{const{token:x}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||"");y=`
Folder: "${(await Zt(x,m.spreadsheetId,t.folder_name)).folderName}"`}catch(x){y=`
(Could not move to folder "${t.folder_name}": ${x.message})`}try{await new ae(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${m.spreadsheetId} | URL: ${m.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${y}
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(u){return await A(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.calendar_id||"primary",m=t.days_ahead||7,y=new Date,x=new Date(y.getTime()+m*24*60*60*1e3),w=await u.calendar.listEvents(h,{timeMin:y.toISOString(),timeMax:x.toISOString(),query:t.query});return w.length===0?`No events found in the next ${m} days.`:w.map(D=>{var L;const k=D.start.dateTime||D.start.date||"TBD",S=D.end.dateTime||D.end.date||"",I=D.location?` 📍 ${D.location}`:"",O=((L=D.attendees)==null?void 0:L.map(M=>M.email).join(", "))||"";return`• ${D.summary} — ${k} to ${S}${I}${O?`
  Attendees: ${O}`:""}`}).join(`
`)}catch(u){return await A(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.calendar_id||"primary",m=await u.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${m.summary}"
ID: ${m.id}
Start: ${m.start.dateTime||m.start.date}`}catch(u){return await A(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(m.documentId,t.content);let y="";if(t.folder_name)try{const{token:x}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||"");y=`
Folder: "${(await Zt(x,m.documentId,t.folder_name)).folderName}"`}catch(x){y=`
(Could not move to folder "${t.folder_name}": ${x.message})`}try{await new ae(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${m.documentId} | URL: ${m.url}`,6,"working")}catch{}return`Document created: "${t.title}"${y}
ID: ${m.documentId}
URL: ${m.url}`}catch(u){return await A(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const h=await new se(a,r,n,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${h.title}"
...
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await A(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((m,y)=>`${m.isUnread?"● ":"  "}${y+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await A(a,r,"gmail","list",u.message),(f=u.message)!=null&&f.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const u=new ce(a,r,n,s||"",i||""),h=await u.getMessage(t.message_id);if(!h)return"Message not found.";const m=await u.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${m}`}catch(u){return await A(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((m,y)=>`${m.isUnread?"● ":"  "}${y+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await A(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(u){return await A(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),m=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${m}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(u){return await A(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ce(a,r,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await A(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(u){return(T=u.message)!=null&&T.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let m="";t.folder_id?m=`'${t.folder_id}' in parents and trashed = false`:t.query?m=`${t.query} and trashed = false`:m="trashed = false",h.set("q",m);const y=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${u}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const x=await y.json();return(_=x.files)!=null&&_.length?x.files.map((w,D)=>{var O,L;const k=((O=w.mimeType)==null?void 0:O.split(".").pop())||w.mimeType,S=w.size?`${(parseInt(w.size)/1024).toFixed(1)} KB`:"",I=((L=w.modifiedTime)==null?void 0:L.split("T")[0])||"";return`${D+1}. **${w.name}** (${k})
   ${S} · Modified: ${I}
   ${w.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await A(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>ut)).getGoogleAuth(a,r,n,s||"",i||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,m=new URLSearchParams;m.set("q",h),m.set("pageSize",String(t.max_results||10)),m.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),m.set("orderBy","modifiedTime desc");const y=await fetch(`https://www.googleapis.com/drive/v3/files?${m}`,{headers:{Authorization:`Bearer ${u}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const x=await y.json();return(E=x.files)!=null&&E.length?x.files.map((w,D)=>{var I,O;const k=((I=w.mimeType)==null?void 0:I.split(".").pop())||w.mimeType,S=((O=w.modifiedTime)==null?void 0:O.split("T")[0])||"";return`${D+1}. **${w.name}** (${k}) — Modified: ${S}
   ${w.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await A(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await wt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((h,m)=>`${m+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(u){return await A(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:m}=await Promise.resolve().then(()=>gn),y=await m(u,h);return y.error?`Failed to read page: ${y.error}`:!y.text||y.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${y.text.length} chars):

${y.text}`}catch(u){return await A(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const h=Za(t.query,d,{depth:t.depth||"quick",site:t.site}),m=new Promise(w=>setTimeout(()=>w(null),45e3)),y=await Promise.race([h,m]);if(y===null){const{webSearch:w}=await Promise.resolve().then(()=>dn),D=await w(t.query,{num:5});if(D.error||D.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let k=`Research took too long, but here are the top search results:

`;return k+=D.results.map((S,I)=>`${I+1}. **${S.title}**
   ${S.snippet}
   ${S.link}`).join(`

`),k}if(y.error)return`Research failed: ${y.error}`;let x=y.report;return y.sources.length>0&&(x+=`

---
**Sources** (`+y.pagesRead+` pages read):
`,x+=y.sources.map((w,D)=>`[${D+1}] ${w.title}
    ${w.url}`).join(`
`)),x}catch(u){return await A(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await F(u.encrypted_value,n),m=await Ga(h,t.query,{type:t.type});return m.error?`Places search failed: ${m.error}`:m.results.length===0?`No places found for "${t.query}".`:m.results.map((y,x)=>{const w=y.rating?` ★${y.rating} (${y.userRatingsTotal||0} reviews)`:"",D=y.openNow!==void 0?y.openNow?" · Open now":" · Closed":"",k=y.googleMapsUri?`
   ${y.googleMapsUri}`:"";return`${x+1}. **${y.name}**${w}${D}
   ${y.address}${k}
   [place_id: ${y.placeId}]`}).join(`

`)}catch(u){return await A(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Fa(h,t.place_id);if(m.error)return`Details lookup failed: ${m.error}`;if(!m.details)return"No details found.";const y=m.details;let x=`**${y.name}**
📍 ${y.address}`;if(y.phone&&(x+=`
📞 ${y.phone}`),y.website&&(x+=`
🌐 ${y.website}`),y.rating&&(x+=`
★ ${y.rating}`),y.googleMapsUri&&(x+=`
📌 ${y.googleMapsUri}`),y.openingHours&&(x+=`

Opening Hours:
${y.openingHours.join(`
`)}`),y.reviews&&y.reviews.length>0){x+=`

Recent Reviews:`;for(const w of y.reviews)x+=`
— ${w.author} (★${w.rating}, ${w.time}): "${w.text}"`}return x}catch(u){return await A(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Wa(h,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const y=m.route;let x=`**${y.startAddress}** → **${y.endAddress}**
`;return x+=`📏 ${y.distance} · ⏱️ ${y.duration}`,y.durationInTraffic&&(x+=` (with traffic: ${y.durationInTraffic})`),x+=`
via ${y.summary}`,x+=`

Steps:`,y.steps.forEach((w,D)=>{x+=`
${D+1}. ${w.instruction} (${w.distance}, ${w.duration})`}),x}catch(u){return await A(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Ja(h,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let y=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(y+=` (with traffic: ${m.durationInTraffic})`),y}catch(u){return await A(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await za(h,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(u){return await A(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Ka(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((y,x)=>{var w;return`${x+1}. **${y.title}**
   ${y.channelTitle} · ${((w=y.publishedAt)==null?void 0:w.split("T")[0])||""}
   ${y.description}
   ${y.url}`}).join(`

`)}catch(u){return await A(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await qa(h,t.address);return m.error?`Geocoding failed: ${m.error}`:m.results.length===0?`Location not found: "${t.address}"`:m.results.map((y,x)=>`${x+1}. ${y.address}
   Coordinates: ${y.lat}, ${y.lng}`).join(`
`)}catch(u){return await A(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function rr(e,t,a,r,n){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(a,r,"assistant",s,"{}",n),t.push({id:-1,user_id:a,channel:r,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function nr(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function _n(e,t,a,r,n,s,i){var D,k;const o=new ae(t),l=(D=e.metadata)==null?void 0:D.thread_id,c=Date.now(),[d,p]=await Promise.all([o.buildContext(r.id),Pt(t,r.id)]),g=await o.getRecentConversations(r.id,25,l);await rr(o,g,r.id,e.channel,l);const v=tr(r,d,e.channel,p),f=er([{role:"system",content:v},...g.map(S=>({role:S.role,content:S.content})),{role:"user",content:e.text}]);nr(f),await o.storeMessage(r.id,e.channel,"user",e.text,"{}",l);const T=(i==null?void 0:i.maxTurns)??10,_=(i==null?void 0:i.tools)??Xe;let E="",u=0;const h=[];for(let S=0;S<T;S++)try{const I=await a.chat(f,{tools:_});if(I.usage&&(u+=I.usage.promptTokens+I.usage.completionTokens),I.toolCalls&&I.toolCalls.length>0){I.content&&f.push({role:"assistant",content:I.content});for(const O of I.toolCalls){h.push(O.name);try{const L=await ft(O.name,O.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);f.push({role:"user",content:`[Tool Result for ${O.name}]: ${L}`})}catch(L){await A(t,r.id,"tool",O.name,L.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${O.name}]: ${L.message||"Execution failed"}`})}}continue}E=I.content;break}catch(I){if(n){const O=I.message||"",L=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),M=O.includes("429"),j=L?1440:M?10:5;await n.recordError(a.name,O,j)}throw await A(t,r.id,"llm","provider_error",I.message||"Unknown LLM error",{provider:a.name,turn:S}),I}if(!E)try{f.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),E=(await a.chat(f,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me directly and I will answer from my knowledge."}catch{E="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge."}if(n&&u>0)try{await n.recordUsage(a.name,u)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",u,Date.now()-c,1,e.channel).run()}catch{}const m=/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*\bam\b|reminder.*\bpm\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*\bam\b|set for.*\bpm\b)\b/i.test(E),y=h.includes("create_schedule")||h.includes("update_schedule");if(m&&!y)try{await A(t,r.id,"llm","schedule_hallucination","LLM claimed schedule without tool call",{response:E.substring(0,200)}),f.push({role:"assistant",content:E}),f.push({role:"user",content:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW to actually apply the change. Do not respond with text only."});const S=await a.chat(f,{tools:Xe.filter(I=>I.name==="create_schedule"||I.name==="update_schedule"),temperature:0});if((k=S.toolCalls)!=null&&k.length){for(const O of S.toolCalls){const L=await ft(O.name,O.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);h.push(O.name),f.push({role:"assistant",content:null,toolCalls:S.toolCalls}),f.push({role:"user",content:L})}const I=await a.chat(f,{tools:[]});I.content&&(E=I.content)}else E="I need to set that reminder for you — could you confirm the exact time and date you'd like?"}catch{}const x=E.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),w=h.length>0?`[TOOLS_USED: ${[...new Set(h)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",w+x,"{}",l),await o.compactHistory(r.id,30),x}const Xt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function En(e){for(const[t,a]of Object.entries(Xt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Xt.default}function Tn(e,t,a,r){const n=En(r),s=Math.floor(n*.75),i=[];let o=0,l=!1;const c=It(e);i.push({role:"system",content:e}),o+=c;const d=It(a);o+=d;const p=s-o,g=[];let v=0;for(let f=t.length-1;f>=0;f--){const T=t[f],_=It(T.content);if(v+_<=p)g.unshift({role:T.role,content:T.content}),v+=_;else{l=!0;break}}return i.push(...g),i.push({role:"user",content:a}),o+=v,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*xn(e,t,a,r,n,s){var m,y;const i=new ae(t),o=(m=e.metadata)==null?void 0:m.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:a.name}};const[c,d]=await Promise.all([i.buildContext(r.id),Pt(t,r.id)]),p=await i.getRecentConversations(r.id,20,o);await rr(i,p,r.id,e.channel,o);const g=tr(r,c,e.channel,d),v=Tn(g,p,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const f=10;let T="",_=0;const E=[...v.messages];nr(E);for(let x=0;x<f;x++)try{x>0&&(yield{type:"thinking",data:{threadId:o}});const w=await a.chat(E,{tools:Xe});if(w.usage&&(_+=w.usage.promptTokens+w.usage.completionTokens),w.toolCalls&&w.toolCalls.length>0){w.content&&(yield{type:"chunk",data:{text:w.content,threadId:o}},E.push({role:"assistant",content:w.content}));for(const k of w.toolCalls){yield{type:"tool_start",data:{tool:k.name,toolArgs:k.arguments,threadId:o}};try{const S=await ft(k.name,k.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:k.name,toolResult:S.substring(0,500)+(S.length>500?"...":""),threadId:o}},E.push({role:"user",content:`[Tool Result for ${k.name}]: ${S}`})}catch(S){await A(t,r.id,"tool",k.name,S.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:k.name,toolResult:`Error: ${S.message||"Execution failed"}`,threadId:o}},E.push({role:"user",content:`[Tool Error for ${k.name}]: ${S.message||"Execution failed"}`})}}continue}T=w.content;const D=50;for(let k=0;k<T.length;k+=D)yield{type:"chunk",data:{text:T.substring(k,k+D),threadId:o}},k+D<T.length&&await new Promise(I=>setTimeout(I,10));break}catch(w){if(n){const k=w.message||"",S=k.includes("401")||k.includes("403")||k.includes("authentication")||k.includes("credit balance"),I=k.includes("429"),O=S?1440:I?10:5;await n.recordError(a.name,k,O)}await A(t,r.id,"llm","provider_error",w.message||"Unknown LLM error",{provider:a.name,turn:x});const D=w.message||"An error occurred";try{await i.storeMessage(r.id,e.channel,"assistant",`⚠️ ${D}`,"{}",o)}catch{}yield{type:"error",data:{error:D,threadId:o}};return}if(!T)try{E.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),T=(await a.chat(E,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const w=50;for(let D=0;D<T.length;D+=w)yield{type:"chunk",data:{text:T.substring(D,D+w),threadId:o}},D+w<T.length&&await new Promise(k=>setTimeout(k,10))}catch{T="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",yield{type:"chunk",data:{text:T,threadId:o}}}if(n&&_>0)try{await n.recordUsage(a.name,_)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",_,Date.now()-l,1,e.channel).run()}catch{}const u=/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*\bam\b|reminder.*\bpm\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*\bam\b|set for.*\bpm\b)\b/i.test(T),h=toolsCalledList.includes("create_schedule")||toolsCalledList.includes("update_schedule");if(u&&!h)try{await A(t,r.id,"llm","schedule_hallucination","LLM claimed schedule without tool call (streaming)",{response:T.substring(0,200)}),E.push({role:"assistant",content:T}),E.push({role:"user",content:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW to actually apply the change. Do not respond with text only."});const x=await a.chat(E,{tools:Xe.filter(w=>w.name==="create_schedule"||w.name==="update_schedule"),temperature:0});if((y=x.toolCalls)!=null&&y.length){for(const D of x.toolCalls){const k=await ft(D.name,D.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);toolsCalledList.push(D.name),E.push({role:"assistant",content:null,toolCalls:x.toolCalls}),E.push({role:"user",content:k})}const w=await a.chat(E,{tools:[]});w.content&&(T=w.content)}else T="I need to set that reminder for you — could you confirm the exact time and date you'd like?"}catch{}await i.storeMessage(r.id,e.channel,"assistant",T.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),"{}",o),await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:_}}}async function Ut(e,t,a,r,n,s){var p;const i=new ae(t),o=(p=e.metadata)==null?void 0:p.thread_id,l=await i.buildContext(r.id);if(Xa(e.text,l).agent==="conversation")return sr(e,t,a,r,l,n,o);const d=e.channel==="telegram"?{maxTurns:4,tools:Xe.filter(g=>g.name!=="research")}:void 0;return _n(e,t,a,r,n,s,d)}async function sr(e,t,a,r,n,s,i){const o=new ae(t),l=Date.now(),c=ar(r.timezone),d=await Pt(t,r.id),p=d?`## Your Standing Instructions
These are explicit preferences the user has set. Follow them in every response.
${d}

${n}`:n,g=yn("conversation",r,p,r.timezone,c,e.channel),v=(await o.getRecentConversations(r.id,25,i)).filter(u=>!u.content.startsWith("[Autonomous Scheduled Task]")&&!u.content.startsWith("[Scheduled Reminder]")),f=er([{role:"system",content:g},...v.map(u=>({role:u.role,content:u.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);let T=0,_="";try{const u=await a.chat(f,{temperature:.8});u.usage&&(T=u.usage.promptTokens+u.usage.completionTokens),_=u.content}catch(u){if(s){const h=u.message||"",m=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),y=h.includes("429"),x=m?1440:y?10:5;await s.recordError(a.name,h,x)}throw await A(t,r.id,"llm","conversation_error",u.message,{provider:a.name}),u}if(s&&T>0)try{await s.recordUsage(a.name,T)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"conversation",T,Date.now()-l,1,e.channel).run()}catch{}const E=_.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await o.storeMessage(r.id,e.channel,"assistant",E,"{}",i),await o.compactHistory(r.id,30),E}async function*Sn(e,t,a,r,n,s){var d;const i=new ae(t),o=(d=e.metadata)==null?void 0:d.thread_id,l=await i.buildContext(r.id),c=Xa(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:a.name}},c.agent!=="conversation"){yield*xn(e,t,a,r,n,s);return}try{const p=await sr(e,t,a,r,l,n,o),g=50;for(let v=0;v<p.length;v+=g)yield{type:"chunk",data:{text:p.substring(v,v+g),threadId:o}},v+g<p.length&&await new Promise(f=>setTimeout(f,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:0}}}const G=new Ee;async function kn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
...
`;for(const c of s)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=n;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await st(e.env.DB,t.id,t.pin_hash),p=new ReadableStream({async start(g){const v=new TextEncoder;try{const f=Sn(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const T of f)T.data.threadId||(T.data.threadId=o),g.enqueue(v.encode(Qt(T)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),g.close()}catch(f){const T={type:"error",data:{error:f.message||"An error occurred",threadId:o}};g.enqueue(v.encode(Qt(T))),g.close()}}});return new Response(p,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("limit reached")?e.json({error:d,type:"cost_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});G.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function On(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Status: ✅ Online`;await H(a,t,d)}catch{await H(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await H(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await H(a,t,"⚠️ Account not linked."),!0);case"/tasks":case"/task":{if(!r)return await H(a,t,"⚠️ Account not linked."),!0;try{const o=(await n.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(o.length===0)return await H(a,t,"✅ No open tasks. You're all clear."),!0;const l=new Date,c=l.toISOString().slice(0,10),d=new Date(l);d.setDate(d.getDate()+1);const p=d.toISOString().slice(0,10),g=[`📋 *Open Tasks (${o.length})*
`];for(const v of o){let f="";if(v.due_date){const T=v.due_date.slice(0,10);T<c?f=" ⚠️ _overdue_":T===c?f=" 🔴 _due today_":T===p?f=" 🟡 _due tomorrow_":f=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}g.push(`☐ ${v.title}${f}`)}g.push(`
_Say "mark [task] as done" to close a task._`),await H(a,t,g.join(`
`))}catch(i){await H(a,t,"❌ Could not fetch tasks: "+i.message)}return!0}default:return!1}}it.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},n=async()=>{var s,i,o,l,c;try{if(t.callback_query){await $n(a,t.callback_query);return}const d=t.message;if(!d)return;const p=!!d.text,g=!!d.voice,v=!!d.document,f=!!d.photo,T=!!d.caption;if(!p&&!g&&!v&&!f)return;const _=String(d.chat.id);let E=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(_).first();let h=null;if(u){const S=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();S&&(h=await F(S.encrypted_value,u.pin_hash))}if(!h){const S=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();S&&(h=await F(S.encrypted_value,S.pin_hash))}if(!h||E.startsWith("/")&&await Mn(E,_,h,u,a))return;if(!u){await H(h,_,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${_}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&h&&u)try{await H(h,_,"🎤 Processing voice note...");const I=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${d.voice.file_id}`)).json();if(I.ok&&((s=I.result)!=null&&s.file_path)){const L=await(await fetch(`https://api.telegram.org/file/bot${h}/${I.result.file_path}`)).blob();let M="",j="",B="whisper-1";const K=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const oe of K.results){const ot=await F(oe.encrypted_value,u.pin_hash);if(oe.service==="openai"){M="https://api.openai.com/v1/audio/transcriptions",j=ot;break}else if(oe.service.startsWith("llm_slot_"))try{const lt=JSON.parse(ot);if(lt.provider==="openai"){M="https://api.openai.com/v1/audio/transcriptions",j=lt.apiKey;break}else if(lt.provider==="groq"){M="https://api.groq.com/openai/v1/audio/transcriptions",j=lt.apiKey,B="whisper-large-v3";break}}catch{}}if(!M){await H(h,_,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const U=new FormData;U.append("file",L,"voice.ogg"),U.append("model",B),U.append("language","en");const W=await fetch(M,{method:"POST",headers:{Authorization:`Bearer ${j}`},body:U});if(!W.ok){const oe=await W.text();await H(h,_,`⚠️ Transcription failed: ${W.status} ${oe}`);return}E=(await W.json()).text,await H(h,_,`🗣️ *You said:* ${E}`)}}catch(S){await H(h,_,`⚠️ Failed to process voice note: ${S.message}`);return}if((v||f)&&h&&u)try{let S,I="unknown",O="unknown",L=0;if(v)S=d.document.file_id,I=d.document.file_name||"document",O=d.document.mime_type||"unknown",L=d.document.file_size||0;else if(f){const M=d.photo[d.photo.length-1];S=M.file_id,I="photo.jpg",O="image/jpeg",L=M.file_size||0}if(S){const j=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${S}`)).json();let B="";if(j.ok&&((i=j.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(I)||/^text\/|application\/json|application\/xml|application\/csv/i.test(O))&&L<5e4)try{B=await(await fetch(`https://api.telegram.org/file/bot${h}/${j.result.file_path}`)).text()}catch{}const K=d.caption||"",U=`[Telegram file received: "${I}" (${O}, ${Math.round(L/1024)}KB)]`;B?E=`${K?K+`
...
`:""}${U}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(S){if(T&&d.caption)E=d.caption;else{await H(h,_,`⚠️ Received your file but couldn't process it: ${S.message}`);return}}if(!E)return;Nn(h,_).catch(()=>{});let m=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();m?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(m.id).run():m={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const y=Cn(u.id,u.username,E,_);y.metadata={thread_id:m.id};let x,w;try{const S=await st(a,u.id,u.pin_hash);x=S.provider,w=S.rotation}catch(S){console.error("Telegram provider setup error:",S);const I=(o=S.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=S.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${S.message||"Unknown error"}`;await H(h,_,I);return}/\b(write\s+(an?\s+)?(essay|article|report|document|doc|blog|post|summary|draft)|draft\s+(an?\s+)?(essay|article|report|document)|research\s+.{0,60}(save|store|drive|doc))\b/i.test(E)&&await H(h,_,"📝 Working on it— searching and saving to Drive takes about 20 seconds...");const k=25e3;try{const S=await Promise.race([Ut(y,a,x,u,w,r),new Promise((O,L)=>setTimeout(()=>L(new Error("TELEGRAM_TIMEOUT")),k))]),I=Rn(S,"telegram");await H(h,_,I||"(empty response)")}catch(S){console.error("Telegram agent error:",S);const I=S.message==="TELEGRAM_TIMEOUT",O=I?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=S.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${x.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(S.message||"Unknown").substring(0,200)}`;await H(h,_,O);try{const{logError:L}=await Promise.resolve().then(()=>Rt);await L(a,u.id,"telegram",I?"timeout":"agent_error",S.message||"Agent error",{provider:x.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:p}=await Promise.resolve().then(()=>Rt);await p(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(n()),e.json({ok:!0})});it.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
...
`)}function Wn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function zn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const s=JSON.parse(a.components);r={google_calendar:s.google_calendar!==!1,gmail:s.gmail!==!1,tasks:s.tasks!==!1,news:s.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function or(e,t,a){var u,h;const r=t.timezone||"Asia/Kolkata",n=jn(r),{components:s,newsTopics:i}=await zn(e,t.id),o=[],l=[];s.google_calendar&&(o.push(Bn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(o.push(Pn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(o.push(Un(e,t.id)),l.push("tasks")),s.news&&(o.push(Gn(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((m,y)=>{d[m]=c[y]});const p={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:d.googleEvents||[],totalCount:((u=d.googleEvents)==null?void 0:u.length)||0},emails:{gmail:d.gmailSummary||p},tasks:d.tasks||g,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((h=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:h.briefing_time)||"20:00";v.summary=Fn(v,f);const T=Wn(v),_=await e.prepare(`
  ...
  `).bind(i,i,r,a).run(),{checked:i===1}}async function Jn(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
