var ra=Object.defineProperty;var Kn=e=>{throw TypeError(e)};var aa=(e,t,n)=>t in e?ra(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var U=(e,t,n)=>aa(e,typeof t!="symbol"?t+"":t,n),dn=(e,t,n)=>t.has(e)||Kn("Cannot "+n);var k=(e,t,n)=>(dn(e,t,"read from private field"),n?n.call(e):t.get(e)),V=(e,t,n)=>t.has(e)?Kn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),F=(e,t,n,s)=>(dn(e,t,"write to private field"),s?s.call(e,n):t.set(e,n),n),ee=(e,t,n)=>(dn(e,t,"access private method"),n);var Yn=(e,t,n,s)=>({set _(r){F(e,t,r,n)},get _(){return k(e,t,s)}});var Jn=(e,t,n)=>(s,r)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&r||void 0,d)try{l=await d(s,()=>i(o+1))}catch(u){if(u instanceof Error&&t)s.error=u,l=await t(u,s),c=!0;else throw u}else s.finalized===!1&&n&&(l=await n(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},ia=Symbol(),oa=async(e,t=Object.create(null))=>{const{all:n=!1,dot:s=!1}=t,a=(e instanceof Cs?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?la(e,{all:n,dot:s}):{}};async function la(e,t){const n=await e.formData();return n?ca(n,t):{}}function ca(e,t){const n=Object.create(null);return e.forEach((s,r)=>{t.all||r.endsWith("[]")?da(n,r,s):n[r]=s}),t.dot&&Object.entries(n).forEach(([s,r])=>{s.includes(".")&&(ua(n,s,r),delete n[s])}),n}var da=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},ua=(e,t,n)=>{let s=e;const r=t.split(".");r.forEach((a,i)=>{i===r.length-1?s[a]=n:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},Rs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ma=e=>{const{groups:t,path:n}=pa(e),s=Rs(n);return ha(s,t)},pa=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,s)=>{const r=`@${s}`;return t.push([r,n]),r}),{groups:t,path:e}},ha=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[s]=t[n];for(let r=e.length-1;r>=0;r--)if(e[r].includes(s)){e[r]=e[r].replace(s,t[n][1]);break}}return e},Kt={},ga=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const s=`${e}#${t}`;return Kt[s]||(n[2]?Kt[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:Kt[s]=[e,n[1],!0]),Kt[s]}return null},Dn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},fa=e=>Dn(e,decodeURI),Ds=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let s=n;for(;s<t.length;s++){const r=t.charCodeAt(s);if(r===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return fa(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(n,s)},ya=e=>{const t=Ds(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},gt=(e,t,...n)=>(n.length&&(t=gt(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ns=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let s="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))s+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){n.length===0&&s===""?n.push("/"):n.push(s);const a=r.replace("?","");s+="/"+a,n.push(s)}else s+="/"+r}),n.filter((r,a,i)=>i.indexOf(r)===a)},un=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Dn(e,Is):e):e,Os=(e,t,n)=>{let s;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return un(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const r={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(l=un(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=un(c))),n?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(c)):r[l]??(r[l]=c)}return t?r[t]:r},va=Os,wa=(e,t)=>Os(e,t,!0),Is=decodeURIComponent,Vn=e=>Dn(e,Is),wt,Te,Ue,As,Ls,wn,He,_s,Cs=(_s=class{constructor(e,t="/",n=[[]]){V(this,Ue);U(this,"raw");V(this,wt);V(this,Te);U(this,"routeIndex",0);U(this,"path");U(this,"bodyCache",{});V(this,He,e=>{const{bodyCache:t,raw:n}=this,s=t[e];if(s)return s;const r=Object.keys(t)[0];return r?t[r].then(a=>(r==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,F(this,Te,n),F(this,wt,{})}param(e){return e?ee(this,Ue,As).call(this,e):ee(this,Ue,Ls).call(this)}query(e){return va(this.url,e)}queries(e){return wa(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,s)=>{t[s]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await oa(this,e))}json(){return k(this,He).call(this,"text").then(e=>JSON.parse(e))}text(){return k(this,He).call(this,"text")}arrayBuffer(){return k(this,He).call(this,"arrayBuffer")}blob(){return k(this,He).call(this,"blob")}formData(){return k(this,He).call(this,"formData")}addValidatedData(e,t){k(this,wt)[e]=t}valid(e){return k(this,wt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ia](){return k(this,Te)}get matchedRoutes(){return k(this,Te)[0].map(([[,e]])=>e)}get routePath(){return k(this,Te)[0].map(([[,e]])=>e)[this.routeIndex].path}},wt=new WeakMap,Te=new WeakMap,Ue=new WeakSet,As=function(e){const t=k(this,Te)[0][this.routeIndex][1][e],n=ee(this,Ue,wn).call(this,t);return n&&/\%/.test(n)?Vn(n):n},Ls=function(){const e={},t=Object.keys(k(this,Te)[0][this.routeIndex][1]);for(const n of t){const s=ee(this,Ue,wn).call(this,k(this,Te)[0][this.routeIndex][1][n]);s!==void 0&&(e[n]=/\%/.test(s)?Vn(s):s)}return e},wn=function(e){return k(this,Te)[1]?k(this,Te)[1][e]:e},He=new WeakMap,_s),ba={Stringify:1},Ms=async(e,t,n,s,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(r?r[0]+=e:r=[e],Promise.all(a.map(o=>o({phase:t,buffer:r,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Ms(l,t,!1,s,r))).then(()=>r[0]))):Promise.resolve(e)},_a="text/plain; charset=UTF-8",mn=(e,t)=>({"Content-Type":e,...t}),Bt,jt,$e,bt,Pe,be,Ut,_t,Et,st,Ht,Ft,Fe,ft,Es,Ea=(Es=class{constructor(e,t){V(this,Fe);V(this,Bt);V(this,jt);U(this,"env",{});V(this,$e);U(this,"finalized",!1);U(this,"error");V(this,bt);V(this,Pe);V(this,be);V(this,Ut);V(this,_t);V(this,Et);V(this,st);V(this,Ht);V(this,Ft);U(this,"render",(...e)=>(k(this,_t)??F(this,_t,t=>this.html(t)),k(this,_t).call(this,...e)));U(this,"setLayout",e=>F(this,Ut,e));U(this,"getLayout",()=>k(this,Ut));U(this,"setRenderer",e=>{F(this,_t,e)});U(this,"header",(e,t,n)=>{this.finalized&&F(this,be,new Response(k(this,be).body,k(this,be)));const s=k(this,be)?k(this,be).headers:k(this,st)??F(this,st,new Headers);t===void 0?s.delete(e):n!=null&&n.append?s.append(e,t):s.set(e,t)});U(this,"status",e=>{F(this,bt,e)});U(this,"set",(e,t)=>{k(this,$e)??F(this,$e,new Map),k(this,$e).set(e,t)});U(this,"get",e=>k(this,$e)?k(this,$e).get(e):void 0);U(this,"newResponse",(...e)=>ee(this,Fe,ft).call(this,...e));U(this,"body",(e,t,n)=>ee(this,Fe,ft).call(this,e,t,n));U(this,"text",(e,t,n)=>!k(this,st)&&!k(this,bt)&&!t&&!n&&!this.finalized?new Response(e):ee(this,Fe,ft).call(this,e,t,mn(_a,n)));U(this,"json",(e,t,n)=>ee(this,Fe,ft).call(this,JSON.stringify(e),t,mn("application/json",n)));U(this,"html",(e,t,n)=>{const s=r=>ee(this,Fe,ft).call(this,r,t,mn("text/html; charset=UTF-8",n));return typeof e=="object"?Ms(e,ba.Stringify,!1,{}).then(s):s(e)});U(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});U(this,"notFound",()=>(k(this,Et)??F(this,Et,()=>new Response),k(this,Et).call(this,this)));F(this,Bt,e),t&&(F(this,Pe,t.executionCtx),this.env=t.env,F(this,Et,t.notFoundHandler),F(this,Ft,t.path),F(this,Ht,t.matchResult))}get req(){return k(this,jt)??F(this,jt,new Cs(k(this,Bt),k(this,Ft),k(this,Ht))),k(this,jt)}get event(){if(k(this,Pe)&&"respondWith"in k(this,Pe))return k(this,Pe);throw Error("This context has no FetchEvent")}get executionCtx(){if(k(this,Pe))return k(this,Pe);throw Error("This context has no ExecutionContext")}get res(){return k(this,be)||F(this,be,new Response(null,{headers:k(this,st)??F(this,st,new Headers)}))}set res(e){if(k(this,be)&&e){e=new Response(e.body,e);for(const[t,n]of k(this,be).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=k(this,be).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of s)e.headers.append("set-cookie",r)}else e.headers.set(t,n)}F(this,be,e),this.finalized=!0}get var(){return k(this,$e)?Object.fromEntries(k(this,$e)):{}}},Bt=new WeakMap,jt=new WeakMap,$e=new WeakMap,bt=new WeakMap,Pe=new WeakMap,be=new WeakMap,Ut=new WeakMap,_t=new WeakMap,Et=new WeakMap,st=new WeakMap,Ht=new WeakMap,Ft=new WeakMap,Fe=new WeakSet,ft=function(e,t,n){const s=k(this,be)?new Headers(k(this,be).headers):k(this,st)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??k(this,bt);return new Response(e,{status:r,headers:s})},Es),ue="ALL",Ta="all",Sa=["get","post","put","delete","options","patch"],$s="Can not add a route since the matcher is already built.",Ps=class extends Error{},xa="__COMPOSED_HANDLER",ka=e=>e.text("404 Not Found",404),Zn=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},ke,me,Bs,Re,tt,Vt,Zt,Tt,Ra=(Tt=class{constructor(t={}){V(this,me);U(this,"get");U(this,"post");U(this,"put");U(this,"delete");U(this,"options");U(this,"patch");U(this,"all");U(this,"on");U(this,"use");U(this,"router");U(this,"getPath");U(this,"_basePath","/");V(this,ke,"/");U(this,"routes",[]);V(this,Re,ka);U(this,"errorHandler",Zn);U(this,"onError",t=>(this.errorHandler=t,this));U(this,"notFound",t=>(F(this,Re,t),this));U(this,"fetch",(t,...n)=>ee(this,me,Zt).call(this,t,n[1],n[0],t.method));U(this,"request",(t,n,s,r)=>t instanceof Request?this.fetch(n?new Request(t,n):t,s,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${gt("/",t)}`,n),s,r)));U(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(ee(this,me,Zt).call(this,t.request,t,void 0,t.request.method))})});[...Sa,Ta].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?F(this,ke,i):ee(this,me,tt).call(this,a,k(this,ke),i),o.forEach(l=>{ee(this,me,tt).call(this,a,k(this,ke),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){F(this,ke,l);for(const c of[a].flat())o.map(d=>{ee(this,me,tt).call(this,c.toUpperCase(),k(this,ke),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?F(this,ke,a):(F(this,ke,"*"),i.unshift(a)),i.forEach(o=>{ee(this,me,tt).call(this,ue,k(this,ke),o)}),this);const{strict:s,...r}=t;Object.assign(this,r),this.getPath=s??!0?t.getPath??Ds:ya}route(t,n){const s=this.basePath(t);return n.routes.map(r=>{var i;let a;n.errorHandler===Zn?a=r.handler:(a=async(o,l)=>(await Jn([],n.errorHandler)(o,()=>r.handler(o,l))).res,a[xa]=r.handler),ee(i=s,me,tt).call(i,r.method,r.path,a)}),this}basePath(t){const n=ee(this,me,Bs).call(this);return n._basePath=gt(this._basePath,t),n}mount(t,n,s){let r,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?r=l=>l:r=s.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};r||(r=(()=>{const l=gt(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(r(l.req.raw),...i(l));if(d)return d;await c()};return ee(this,me,tt).call(this,ue,gt(t,"*"),o),this}},ke=new WeakMap,me=new WeakSet,Bs=function(){const t=new Tt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,Re,k(this,Re)),t.routes=this.routes,t},Re=new WeakMap,tt=function(t,n,s){t=t.toUpperCase(),n=gt(this._basePath,n);const r={basePath:this._basePath,path:n,method:t,handler:s};this.router.add(t,n,[s,r]),this.routes.push(r)},Vt=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},Zt=function(t,n,s,r){if(r==="HEAD")return(async()=>new Response(null,await ee(this,me,Zt).call(this,t,n,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(r,a),o=new Ea(t,{path:a,matchResult:i,env:s,executionCtx:n,notFoundHandler:k(this,Re)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await k(this,Re).call(this,o)})}catch(d){return ee(this,me,Vt).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:k(this,Re).call(this,o))).catch(d=>ee(this,me,Vt).call(this,d,o)):c??k(this,Re).call(this,o)}const l=Jn(i[0],this.errorHandler,k(this,Re));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return ee(this,me,Vt).call(this,c,o)}})()},Tt),js=[];function Da(e,t){const n=this.buildAllMatchers(),s=((r,a)=>{const i=n[r]||n[ue],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],js];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=s,s(e,t)}var en="[^/]+",It=".*",Ct="(?:|/.*)",yt=Symbol(),Na=new Set(".\\+*[^]$()");function Oa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===It||e===Ct?1:t===It||t===Ct?-1:e===en?1:t===en?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var rt,at,De,lt,Ia=(lt=class{constructor(){V(this,rt);V(this,at);V(this,De,Object.create(null))}insert(t,n,s,r,a){if(t.length===0){if(k(this,rt)!==void 0)throw yt;if(a)return;F(this,rt,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",It]:["","",en]:i==="/*"?["","",Ct]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||en;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw yt;if(c=k(this,De)[u],!c){if(Object.keys(k(this,De)).some(h=>h!==It&&h!==Ct))throw yt;if(a)return;c=k(this,De)[u]=new lt,d!==""&&F(c,at,r.varIndex++)}!a&&d!==""&&s.push([d,k(c,at)])}else if(c=k(this,De)[i],!c){if(Object.keys(k(this,De)).some(d=>d.length>1&&d!==It&&d!==Ct))throw yt;if(a)return;c=k(this,De)[i]=new lt}c.insert(o,n,s,r,a)}buildRegExpStr(){const n=Object.keys(k(this,De)).sort(Oa).map(s=>{const r=k(this,De)[s];return(typeof k(r,at)=="number"?`(${s})@${k(r,at)}`:Na.has(s)?`\\${s}`:s)+r.buildRegExpStr()});return typeof k(this,rt)=="number"&&n.unshift(`#${k(this,rt)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},rt=new WeakMap,at=new WeakMap,De=new WeakMap,lt),tn,qt,Ts,Ca=(Ts=class{constructor(){V(this,tn,{varIndex:0});V(this,qt,new Ia)}insert(e,t,n){const s=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return r[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,r[i][1]);break}}return k(this,qt).insert(a,t,s,k(this,tn),n),s}buildRegExp(){let e=k(this,qt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,s]}},tn=new WeakMap,qt=new WeakMap,Ts),Aa=[/^$/,[],Object.create(null)],Xt=Object.create(null);function Us(e){return Xt[e]??(Xt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function La(){Xt=Object.create(null)}function Ma(e){var c;const t=new Ca,n=[];if(e.length===0)return Aa;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[h,v])=>d?1:h?-1:u.length-v.length),r=Object.create(null);for(let d=0,u=-1,h=s.length;d<h;d++){const[v,g,f]=s[d];v?r[g]=[f.map(([b])=>[b,Object.create(null)]),js]:u++;let w;try{w=t.insert(g,u,v)}catch(b){throw b===yt?new Ps(g):b}v||(n[u]=f.map(([b,T])=>{const R=Object.create(null);for(T-=1;T>=0;T--){const[B,I]=w[T];R[B]=I}return[b,R]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let h=0,v=n[d].length;h<v;h++){const g=(c=n[d][h])==null?void 0:c[1];if(!g)continue;const f=Object.keys(g);for(let w=0,b=f.length;w<b;w++)g[f[w]]=o[g[f[w]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,r]}function ut(e,t){if(e){for(const n of Object.keys(e).sort((s,r)=>r.length-s.length))if(Us(n).test(t))return[...e[n]]}}var qe,Ge,nn,Hs,Ss,$a=(Ss=class{constructor(){V(this,nn);U(this,"name","RegExpRouter");V(this,qe);V(this,Ge);U(this,"match",Da);F(this,qe,{[ue]:Object.create(null)}),F(this,Ge,{[ue]:Object.create(null)})}add(e,t,n){var o;const s=k(this,qe),r=k(this,Ge);if(!s||!r)throw new Error($s);s[e]||[s,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ue]).forEach(c=>{l[e][c]=[...l[ue][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Us(t);e===ue?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=ut(s[c],t)||ut(s[ue],t)||[])}):(o=s[e])[t]||(o[t]=ut(s[e],t)||ut(s[ue],t)||[]),Object.keys(s).forEach(c=>{(e===ue||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([n,a])})}),Object.keys(r).forEach(c=>{(e===ue||e===c)&&Object.keys(r[c]).forEach(d=>l.test(d)&&r[c][d].push([n,a]))});return}const i=Ns(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(r).forEach(u=>{var h;(e===ue||e===u)&&((h=r[u])[d]||(h[d]=[...ut(s[u],d)||ut(s[ue],d)||[]]),r[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(k(this,Ge)).concat(Object.keys(k(this,qe))).forEach(t=>{e[t]||(e[t]=ee(this,nn,Hs).call(this,t))}),F(this,qe,F(this,Ge,void 0)),La(),e}},qe=new WeakMap,Ge=new WeakMap,nn=new WeakSet,Hs=function(e){const t=[];let n=e===ue;return[k(this,qe),k(this,Ge)].forEach(s=>{const r=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];r.length!==0?(n||(n=!0),t.push(...r)):e!==ue&&t.push(...Object.keys(s[ue]).map(a=>[a,s[ue][a]]))}),n?Ma(t):null},Ss),We,Be,xs,Pa=(xs=class{constructor(e){U(this,"name","SmartRouter");V(this,We,[]);V(this,Be,[]);F(this,We,e.routers)}add(e,t,n){if(!k(this,Be))throw new Error($s);k(this,Be).push([e,t,n])}match(e,t){if(!k(this,Be))throw new Error("Fatal error");const n=k(this,We),s=k(this,Be),r=n.length;let a=0,i;for(;a<r;a++){const o=n[a];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof Ps)continue;throw l}this.match=o.match.bind(o),F(this,We,[o]),F(this,Be,void 0);break}if(a===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(k(this,Be)||k(this,We).length!==1)throw new Error("No active router has been determined yet.");return k(this,We)[0]}},We=new WeakMap,Be=new WeakMap,xs),Dt=Object.create(null),ze,ve,it,St,fe,je,nt,xt,Ba=(xt=class{constructor(t,n,s){V(this,je);V(this,ze);V(this,ve);V(this,it);V(this,St,0);V(this,fe,Dt);if(F(this,ve,s||Object.create(null)),F(this,ze,[]),t&&n){const r=Object.create(null);r[t]={handler:n,possibleKeys:[],score:0},F(this,ze,[r])}F(this,it,[])}insert(t,n,s){F(this,St,++Yn(this,St)._);let r=this;const a=ma(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=ga(c,d),h=Array.isArray(u)?u[0]:c;if(h in k(r,ve)){r=k(r,ve)[h],u&&i.push(u[1]);continue}k(r,ve)[h]=new xt,u&&(k(r,it).push(u),i.push(u[1])),r=k(r,ve)[h]}return k(r,ze).push({[t]:{handler:s,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:k(this,St)}}),r}search(t,n){var l;const s=[];F(this,fe,Dt);let a=[this];const i=Rs(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],h=c===d-1,v=[];for(let g=0,f=a.length;g<f;g++){const w=a[g],b=k(w,ve)[u];b&&(F(b,fe,k(w,fe)),h?(k(b,ve)["*"]&&s.push(...ee(this,je,nt).call(this,k(b,ve)["*"],t,k(w,fe))),s.push(...ee(this,je,nt).call(this,b,t,k(w,fe)))):v.push(b));for(let T=0,R=k(w,it).length;T<R;T++){const B=k(w,it)[T],I=k(w,fe)===Dt?{}:{...k(w,fe)};if(B==="*"){const P=k(w,ve)["*"];P&&(s.push(...ee(this,je,nt).call(this,P,t,k(w,fe))),F(P,fe,I),v.push(P));continue}const[L,$,W]=B;if(!u&&!(W instanceof RegExp))continue;const q=k(w,ve)[L],ne=i.slice(c).join("/");if(W instanceof RegExp){const P=W.exec(ne);if(P){if(I[$]=P[0],s.push(...ee(this,je,nt).call(this,q,t,k(w,fe),I)),Object.keys(k(q,ve)).length){F(q,fe,I);const K=((l=P[0].match(/\//))==null?void 0:l.length)??0;(o[K]||(o[K]=[])).push(q)}continue}}(W===!0||W.test(u))&&(I[$]=u,h?(s.push(...ee(this,je,nt).call(this,q,t,I,k(w,fe))),k(q,ve)["*"]&&s.push(...ee(this,je,nt).call(this,k(q,ve)["*"],t,I,k(w,fe)))):(F(q,fe,I),v.push(q)))}}a=v.concat(o.shift()??[])}return s.length>1&&s.sort((c,d)=>c.score-d.score),[s.map(({handler:c,params:d})=>[c,d])]}},ze=new WeakMap,ve=new WeakMap,it=new WeakMap,St=new WeakMap,fe=new WeakMap,je=new WeakSet,nt=function(t,n,s,r){const a=[];for(let i=0,o=k(t,ze).length;i<o;i++){const l=k(t,ze)[i],c=l[n]||l[ue],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),s!==Dt||r&&r!==Dt))for(let u=0,h=c.possibleKeys.length;u<h;u++){const v=c.possibleKeys[u],g=d[c.score];c.params[v]=r!=null&&r[v]&&!g?r[v]:s[v]??(r==null?void 0:r[v]),d[c.score]=!0}}return a},xt),ot,ks,ja=(ks=class{constructor(){U(this,"name","TrieRouter");V(this,ot);F(this,ot,new Ba)}add(e,t,n){const s=Ns(t);if(s){for(let r=0,a=s.length;r<a;r++)k(this,ot).insert(e,s[r],n);return}k(this,ot).insert(e,t,n)}match(e,t){return k(this,ot).search(e,t)}},ot=new WeakMap,ks),_e=class extends Ra{constructor(e={}){super(e),this.router=e.router??new Pa({routers:[new $a,new ja]})}},Ua=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),r=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,h){i.res.headers.set(u,h)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await r(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let h=n.allowHeaders;if(!(h!=null&&h.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(h=v.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Ha(){return`  // === Karna v3.1 Frontend ===
...
`);return En(r,di)}catch{return""}}class Q{constructor(t){this.db=t}async store(t,n,s,r,a=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,n,s).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,a,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       ...
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const n=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((n==null?void 0:n.cnt)||0)>hn){const s=((n==null?void 0:n.cnt)||0)-hn;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,s).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,hn).all()).results||[]}async getAll(t,n,s=50){return n?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,n,s).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,s).all()).results||[]}async search(t,n,s=10){return this.searchMemoryByTier(t,n,s)}async searchLongTerm(t,n,s=5){return this.searchMemoryByTier(t,n,s,"long_term")}async searchMemoryByTier(t,n,s,r){const a=r?" AND tier = ?":"",i=(v,g)=>r?[t,r,v,v,g]:[t,v,v,g],l=(await this.db.prepare(`SELECT * FROM memory WHERE user_id = ?${a} AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?`).bind(...i(`%${n}%`,s)).all()).results||[];if(l.length>0)return await this.touchMemories(t,l.map(v=>v.id)),l;const c=n.split(/\s+/).filter(v=>v.length>2);if(c.length===0)return[];const d=new Map,u=new Map;for(const v of c){const g=await this.db.prepare(`SELECT * FROM memory WHERE user_id = ?${a} AND (title LIKE ? OR content LIKE ?) LIMIT ?`).bind(...i(`%${v}%`,s*2)).all();for(const f of g.results||[])d.set(f.id,(d.get(f.id)||0)+1),u.set(f.id,f)}const h=[...u.values()].sort((v,g)=>(d.get(g.id)||0)-(d.get(v.id)||0)).slice(0,s);return h.length>0&&await this.touchMemories(t,h.map(v=>v.id)),h}async touchMemories(t,n){for(const s of n)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(s,t).run()}async update(t,n,s){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(s,t,n).run()}async promote(t,n){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run(),await this.enforceWorkingMemoryCap(n)}async demote(t,n){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run()}async remove(t,n){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,n).run()}async buildContext(t){const n=await this.getWorkingMemory(t);if(n.length===0)return"";const s={};for(const a of n)s[a.type]||(s[a.type]=[]),s[a.type].push(a);let r=`
...
Identify 2-3 specific information gaps or important angles not yet covered. Return ONLY a JSON array of follow-up search queries.`,300),g=as(v,[]).slice(0,3);if(g.length>0){let w=0;const b=await Promise.all(g.map(T=>i(T,4,"thorough")));for(const T of b)for(const R of T){if(w>=5||d.has(R.result.url))continue;d.add(R.result.url);const I=`[${a.length+1}] ${R.result.title}
${R.result.url}
...
Sources:
${h}`,4096),sources:a,pagesRead:u.length}}async function fr(e,t,n={}){const s=n.depth||"quick",r=async(f,w)=>(await Lt(f,{num:w,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId})).results||[];let a;if(n.anthropicKey)try{const f=await Ai(e,n.anthropicKey,n.tavilyKey||null,s,r);if(f.report.trim())return{report:f.report,sources:f.sources.map(w=>({title:w.title,url:w.url})),pagesRead:f.pagesRead}}catch(f){a=f.message,console.warn("[conductResearch] Opus path failed:",f.message)}if(n.tavilyKey)try{const f=await hr(e,n.tavilyKey,s);if(f.results.length>0){const w=s==="thorough"?8:5,T=(await Promise.all(f.results.slice(0,w).map(async L=>({result:L,content:await gr(L)})))).filter(L=>L.content.length>50),R=T.map(L=>({title:L.result.title,url:L.result.url}));if(T.length>0){const L=T.map((W,q)=>`--- SOURCE ${q+1}: ${W.result.title} ---
${W.content}
--- END SOURCE ${q+1} ---`).join(`
...
`);return{report:await Jt(e,v,t,"full"),sources:h.map(f=>({title:f.title,url:f.url})),pagesRead:h.length}}async function Jt(e,t,n,s){const a=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
If a captcha was encountered, set captcha_required to true and populate whatever tracking data was visible before the captcha appeared.`}async function Er(e){const t=e instanceof Buffer?new Uint8Array(e):e,n=new DataView(t.buffer,t.byteOffset,t.byteLength);let s=0;for(;s<t.length-30&&n.getUint32(s,!0)===67324752;){const r=n.getUint16(s+6,!0),a=n.getUint16(s+8,!0),i=n.getUint32(s+18,!0),o=n.getUint32(s+22,!0),l=n.getUint16(s+26,!0),c=n.getUint16(s+28,!0),d=new TextDecoder().decode(t.slice(s+30,s+30+l)),u=s+30+l+c;if(d==="word/document.xml"){const h=t.slice(u,u+i);let v;if(a===0)v=h;else{const w=new DecompressionStream("deflate-raw"),b=w.writable.getWriter();b.write(h),b.close();const T=w.readable.getReader(),R=[];let B=!1;for(;!B;){const $=await T.read();$.done?B=!0:R.push($.value)}const I=R.reduce(($,W)=>$+W.length,0);v=new Uint8Array(o||I);let L=0;for(const $ of R)v.set($,L),L+=$.length}return new TextDecoder().decode(v).replace(/<\/w:p>/g,`
`).replace(/<\/w:tr>/g,`
...
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const f=(((i=(await t.chat(h,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);f&&f[1].trim()&&(await e.prepare(`UPDATE user_skills
             ...
             WHERE id = ?`).bind(f[1].trim(),l.id).run(),r++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:s,rewritten:r,disabled:a}}async function Yi(e,t,n,s,r){var R;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
...
`)}catch{return""}}function Pr(e,t,n,s,r,a){const i=e.assistant_name||"Karna",o=e.personality_prompt?yn(`## Personality Instructions
...
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new Q(n).store(s,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}try{const _=t.content;await n.prepare(`INSERT OR IGNORE INTO document_library (user_id, source, drive_file_id, name, summary, extracted_text, status)
           VALUES (?, 'drive', ?, ?, ?, ?, 'parsed')`).bind(s,p.documentId,t.title,_?_.substring(0,500):null,_?_.substring(0,5e4):null).run()}catch{}try{const _=new Q(n),S=await _.search(s,`Pending Google Doc save: "${t.title}"`);for(const x of S)x.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await _.remove(x.id,s)}catch{}return`Document created: "${t.title}"${y}
ID: ${p.documentId}
...
⚠️ *Thorough research used ~3 Opus 4.8 API calls (~$0.10–$0.30 at standard rates).*`);try{const A=new Q(n),N=x.report.substring(0,600);await A.store(s,"context",`Research: ${t.query.substring(0,80)}`,N,6,"long_term")}catch{}return D}catch(m){return await H(n,s,"research","research",m.message),`Research error: ${m.message}`}}case"save_note":try{const m=(t.content||"").trim();if(!m)return"Note content cannot be empty.";const E=t.source||"manual",p=["manual","research","chat"].includes(E)?E:"manual",y=await n.prepare(`INSERT INTO notes (user_id, title, content, tags, source, source_query, is_pinned)
...
${y.substring(0,2e4)}`:`Document "${p.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${p.file_id}") to extract the text first.`}case"create_skill":{const m=(Z=t.name)==null?void 0:Z.trim(),E=(te=t.description)==null?void 0:te.trim(),p=(oe=t.instructions)==null?void 0:oe.trim();if(!m||!E||!p)return"create_skill requires name, description, and instructions.";let y=m.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");y||(y=`skill_${Date.now()}`);const _=await n.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(s,`${y}%`).all();(re=_.results)!=null&&re.some(A=>A.slug===y)&&(y=`${y}_${(((pe=_.results)==null?void 0:pe.length)||0)+1}`);const S=JSON.stringify(t.parameters||{}),x=JSON.stringify(t.required_tools||[]),D=JSON.stringify(t.examples||[]);return await n.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
...
`)){const h=u.trim().split("|");if(h.length<4)continue;const[v,g,f,w]=h,b=["fact","preference","context","decision","summary","task"].find(R=>R===v.trim().toLowerCase());if(!b||!(g!=null&&g.trim())||!(f!=null&&f.trim()))continue;const T=Math.min(10,Math.max(1,parseInt(w)||5));await s.store(n.id,b,g.trim(),f.trim(),T,"long_term")}}const us={"claude-opus-4-8":1e6,"claude-sonnet-4-6":1e6,"claude-haiku-4-5":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function yo(e){for(const[t,n]of Object.entries(us))if(e.toLowerCase().includes(t.toLowerCase()))return n;return us.default}function vo(e,t,n,s){const r=yo(s),a=Math.floor(r*.75),i=[];let o=0,l=!1;const c=fn(e);i.push({role:"system",content:e}),o+=c;const d=fn(n);o+=d;const u=a-o,h=[];let v=0;for(let g=t.length-1;g>=0;g--){const f=t[g],w=fn(f.content);if(v+w<=u)h.unshift({role:f.role,content:f.content}),v+=w;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:n}),o+=v,{maxTokens:r,usedTokens:o,messages:i,wasTruncated:l}}async function*wo(e,t,n,s,r,a){var pe,m,E;const i=new Q(t),o=(pe=e.metadata)==null?void 0:pe.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:n.name}};const[c,d,u,h]=await Promise.all([i.buildContext(s.id),On(t,s.id),Wn(t,s.id),Or(t,s.id)]),v=await i.getRecentConversations(s.id,30,o);await Hr(i,v,s.id,e.channel,o);const g=Pr(s,c,e.channel,u,h,d),f=Fn(v),w=qn([...Hn(v)]);let b=e.text;f&&(b=`${xn}

${e.text}`);const T=vo(g,w.map(p=>({role:p.role,content:p.content})),b,n.name);await i.storeMessage(s.id,e.channel,"user",e.text,"{}",o);const R=await Gn(t,s.id),B=10;let I="",L=0;const $=[...T.messages],W=[];let q,ne=0,P=0;const K={hasActiveTask:!1,persistSession:!1,threadId:o,channel:e.channel},G=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],Z=(c.match(/^- /gm)||[]).length;if(G.some(p=>p.test(e.text))||Z<3||f)try{const p=await i.searchLongTerm(s.id,e.text,5);if(p.length>0){const y=p.map(_=>`- [${_.type}] ${_.title}: ${_.content}`).join(`
...
${y}]`})}}catch{}Fr($);const oe=()=>Ar(W,q);for(let p=0;p<B;p++){ne=p+1;try{p>0&&(yield{type:"thinking",data:{threadId:o}},Ur($));const y=await n.chat($,{tools:R});if(y.usage&&(L+=y.usage.promptTokens+y.usage.completionTokens),y.toolCalls&&y.toolCalls.length>0){const x=((m=y.content)==null?void 0:m.trim())??"";x&&x.length<=150&&!/^\[calling:/i.test(x)&&(yield{type:"chunk",data:{text:y.content,threadId:o}});const D=y.content||"(tools executed)";$.push({role:"assistant",content:D});const A=[];for(const N of y.toolCalls){yield{type:"tool_start",data:{tool:N.name,toolArgs:N.arguments,threadId:o}},W.push(N.name);try{const C=(X,z)=>Pt(X,z,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},K);let O;if(N.name==="research"&&(yield{type:"research_ack",data:{message:(N.arguments.depth||"quick")==="thorough"?"Starting deep research with Opus 4.8 — planning queries, reading sources, and identifying gaps. This takes 2-4 minutes and uses ~3 Opus API calls.":"Researching with Opus 4.8... (45–90 seconds)",threadId:o}}),N.name==="browser_task"||N.name==="browser_task_status"){if(N.name==="browser_task"){const le=N.arguments.site_name;yield{type:"browser_ack",data:{message:le?`Starting now — opening ${le} in a browser. I'll notify you when done.`:"Starting now — running browser task. I'll notify you when done.",startedAt:new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:s.timezone||"UTC"}),threadId:o}}}const z=["Still working — browser launched, navigating to site...","Still working — page loaded, scanning for content...","Still working — reading and extracting results...","Still working — almost there, finalising output...","Taking a bit longer — site may require extra steps...","Still running — browser is working through the page...","Continuing — extracting and processing data...","Still going — complex task, nearly there...","Almost done — wrapping up the browser session...","Still running — holding on a little longer...","Browser is still active — this one is taking time...","Patience — still working through the task...","Still running — will have a result for you shortly..."],ie=C(N.name,N.arguments);let de=0;e:for(;;){const le=await Promise.race([ie.then(he=>({done:!0,r:he})),new Promise(he=>setTimeout(()=>he({done:!1}),15e3))]);if(le.done){O=le.r;break e}N.name==="browser_task"?yield{type:"browser_progress",data:{message:z[Math.min(de,z.length-1)],elapsed_s:(de+1)*15,threadId:o}}:yield{type:"thinking",data:{threadId:o}},de++}if(N.name==="browser_task"){const le=O.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(le){yield{type:"browser_progress",data:{message:"Task still running — checking final status...",threadId:o}};const he=C("browser_task_status",{task_id:le[1]});e:for(;;){const xe=await Promise.race([he.then(Ee=>({done:!0,r:Ee})),new Promise(Ee=>setTimeout(()=>Ee({done:!1}),15e3))]);if(xe.done){O=xe.r;break e}yield{type:"thinking",data:{threadId:o}}}if(!O.startsWith("[still-running]")&&!O.startsWith("[NO-OUTPUT]")&&!O.startsWith("Browser"))try{await t.prepare("DELETE FROM pending_browser_tasks WHERE user_id = ? AND task_id = ? AND notified = 0").bind(s.id,le[1]).run()}catch{}}}}else if(N.name==="research"){const ie=(N.arguments.depth||"quick")==="thorough"?["Still researching — planning sub-queries...","Still researching — fetching sources...","Still researching — reading pages...","Still researching — identifying gaps...","Still researching — running gap searches...","Still researching — synthesising findings...","Almost done — writing final report...","Wrapping up — almost there..."]:["Still researching — fetching sources...","Still researching — reading pages...","Almost done — synthesising findings..."],de=C(N.name,N.arguments);let le=0;e:for(;;){const he=await Promise.race([de.then(Ee=>({done:!0,r:Ee})),new Promise(Ee=>setTimeout(()=>Ee({done:!1}),2e4))]);if(he.done){O=he.r;break e}yield{type:"research_progress",data:{message:ie[Math.min(le,ie.length-1)],elapsed_s:(le+1)*20,threadId:o}},le++}}else O=await C(N.name,N.arguments);let M=O;(N.name==="browser_task"||N.name==="browser_task_status")&&(/^\[BROWSER_TIMEOUT:/.test(M)?M="Task timed out — still running in background.":/^\[NO-OUTPUT\]/.test(M)?M="Browser task finished but returned no content.":/^\[still-running\]/.test(M)?M="Still running — will notify when done.":M=M.replace(/\s*\|\s*Operator hint:.*$/s,"")),yield{type:"tool_end",data:{tool:N.name,toolResult:M.substring(0,500)+(M.length>500?"...":""),threadId:o}};const j=["parse_document","drive_read_file","read_library_file"].includes(N.name)?2e4:N.name==="research"?16e3:8e3,Y=O.length>j?O.substring(0,j)+`
[...result truncated to prevent token limit — full content was extracted]`:O;q=Mr(N.name,N.arguments,O,q),A.push(`[Tool Result for ${N.name}]: ${Y}`)}catch(C){P++,await H(t,s.id,"tool",N.name,C.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:N.name,toolResult:`Error: ${C.message||"Execution failed"}`,threadId:o}},A.push(`[Tool Error for ${N.name}]: ${C.message||"Execution failed"}`)}}$.push({role:"user",content:A.join(`

`)});continue}I=y.content;const _=$t(I);await i.storeMessage(s.id,e.channel,"assistant",_,oe(),o);const S=50;for(let x=0;x<_.length;x+=S)yield{type:"chunk",data:{text:_.substring(x,x+S),threadId:o}},x+S<_.length&&await new Promise(A=>setTimeout(A,10));break}catch(y){if(r){const x=y.message||"",D=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),A=x.includes("429"),N=D?1440:A?10:5;await r.recordError(n.name,x,N)}await H(t,s.id,"llm","provider_error",y.message||"Unknown LLM error",{provider:n.name,turn:p});const _=y.message||"An error occurred",S=_.includes("429")||_.toLowerCase().includes("rate limit")||_.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":_;try{await i.storeMessage(s.id,e.channel,"assistant",`⚠️ ${S}`,"{}",o)}catch{}yield{type:"error",data:{error:S,threadId:o}};return}}if(I=(I==null?void 0:I.trim())??"",!I)try{$.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),I=(await n.chat($,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const y=$t(I);await i.storeMessage(s.id,e.channel,"assistant",y,oe(),o);const _=50;for(let S=0;S<y.length;S+=_)yield{type:"chunk",data:{text:y.substring(S,S+_),threadId:o}},S+_<y.length&&await new Promise(x=>setTimeout(x,10))}catch{I="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(s.id,e.channel,"assistant",I,oe(),o).catch(()=>{}),yield{type:"chunk",data:{text:I,threadId:o}}}if(r&&L>0)try{await r.recordUsage(n.name,L)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"full",L,Date.now()-l,1,e.channel).run()}catch{}const re=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const p of re){const y=p.claimPattern.test(I),_=p.requiredTools.some(S=>W.includes(S));if(y&&!_){try{await H(t,s.id,"llm",p.logType,"LLM claimed action without tool call (streaming)",{response:I.substring(0,200)}),$.push({role:"assistant",content:I}),$.push({role:"user",content:p.enforcementMsg});const S=await n.chat($,{tools:R.filter(x=>p.requiredTools.includes(x.name)),temperature:0});if((E=S.toolCalls)!=null&&E.length){for(const D of S.toolCalls){const A=await Pt(D.name,D.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});W.push(D.name),$.push({role:"assistant",content:"",toolCalls:S.toolCalls}),$.push({role:"user",content:A})}const x=await n.chat($,{tools:[]});x.content&&(I=x.content)}else I="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}W.length>=3&&Promise.race([Nr(t,n,s,e.text,W,ne,P===0),new Promise(p=>setTimeout(p,6e3))]).catch(()=>{}),K.sessionId&&K.apiKey&&!K.hasActiveTask&&!K.persistSession&&an(K.sessionId,K.apiKey).catch(()=>{}),yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:L}}}async function kn(e,t,n,s,r,a,i,o){await a.storeMessage(r.id,t.channel,"user",t.text,"{}",o);const l=await Pt(e.tool,e.args,n,r.id,{agentType:"direct",channel:t.channel},r.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,r.timezone,s,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),c=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await a.storeMessage(r.id,t.channel,"assistant",c,"{}",o),l}async function zn(e,t,n,s,r,a){var f;const i=new Q(t),o=(f=e.metadata)==null?void 0:f.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Mn(e.text,l,Lr(c));if(d.agent==="conversation")return qr(e,t,n,s,l,r,o);const u=Pn(e.text);if(u)return kn(u,e,t,n,s,i,a,o);const h=(await i.getRecentConversations(s.id,10,o)).map(w=>w.content).join(`
`),v=Bn(e.text,h);if(v)return kn(v,e,t,n,s,i,a,o);const g=d.confidence>=.85;if(e.channel==="telegram"){const w=await Gn(t,s.id);return ds(e,t,n,s,r,a,{maxTurns:10,tools:w,forceToolUseOnFirstTurn:g})}return ds(e,t,n,s,r,a,{forceToolUseOnFirstTurn:g})}async function qr(e,t,n,s,r,a,i){const o=new Q(t),l=Date.now(),c=Br(s.timezone),d=await Wn(t,s.id),u=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${r}`:r,h=xr("conversation",s,u,s.timezone,c,e.channel),v=(await o.getRecentConversations(s.id,30,i)).filter(R=>!R.content.startsWith("[Autonomous Scheduled Task]")&&!R.content.startsWith("[Scheduled Reminder]")),g=Fn(v),f=qn([{role:"system",content:h},...Hn(v),{role:"user",content:e.text}]);$r(f,g),await o.storeMessage(s.id,e.channel,"user",e.text,"{}",i);let w=0,b="";try{const R=await n.chat(f,{temperature:.8});R.usage&&(w=R.usage.promptTokens+R.usage.completionTokens),b=R.content}catch(R){if(a){const B=R.message||"",I=B.includes("401")||B.includes("403")||B.includes("authentication")||B.includes("credit balance"),L=B.includes("429"),$=I?1440:L?10:5;await a.recordError(n.name,B,$)}throw await H(t,s.id,"llm","conversation_error",R.message,{provider:n.name}),R}if(a&&w>0)try{await a.recordUsage(n.name,w)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"conversation",w,Date.now()-l,1,e.channel).run()}catch{}const T=$t(b);return await o.storeMessage(s.id,e.channel,"assistant",T,"{}",i),T}async function*ms(e,t,n,s,r,a,i,o){yield{type:"tool_start",data:{tool:e.tool,toolArgs:e.args,threadId:o}};const l=await kn(e,t,n,s,r,a,i,o);yield{type:"tool_end",data:{tool:e.tool,toolResult:l.substring(0,500)+(l.length>500?"...":""),threadId:o}};const c=$t(l),d=50;for(let u=0;u<c.length;u+=d)yield{type:"chunk",data:{text:c.substring(u,u+d),threadId:o}},u+d<c.length&&await new Promise(h=>setTimeout(h,10));yield{type:"done",data:{threadId:o,provider:s.name,tokenCount:0}}}async function*bo(e,t,n,s,r,a){var u;const i=new Q(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Mn(e.text,l,Lr(c));if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){const h=Pn(e.text);if(h){yield*ms(h,e,t,n,s,i,a,o);return}const v=(await i.getRecentConversations(s.id,10,o)).map(f=>f.content).join(`
`),g=Bn(e.text,v);if(g){yield*ms(g,e,t,n,s,i,a,o);return}yield*wo(e,t,n,s,r,a);return}try{const h=await qr(e,t,n,s,l,r,o),v=50;for(let g=0;g<h.length;g+=v)yield{type:"chunk",data:{text:h.substring(g,g+v),threadId:o}},g+v<h.length&&await new Promise(f=>setTimeout(f,10))}catch(h){yield{type:"error",data:{error:h.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const ce=new _e;async function _o(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}ce.use("/*",_o);ce.get("/threads",async e=>{const t=e.get("user"),n=e.req.query("archived")==="1",s=parseInt(e.req.query("limit")||"30"),r=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const c of a)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=r;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:s,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Ve(e.env.DB,t.id,t.pin_hash),u=new ReadableStream({async start(h){const v=new TextEncoder;try{const g=bo(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const f of g)f.data.threadId||(f.data.threadId=o),h.enqueue(v.encode(ps(f)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),h.close()}catch(g){const f={type:"error",data:{error:g.message||"An error occurred",threadId:o}};h.enqueue(v.encode(ps(f))),h.close()}}});return new Response(u,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});ce.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     ON CONFLICT(user_id, service) DO UPDATE SET 
       ...
       VALUES (?, 'info', ?, ?, 'ntfy')`).bind(t,n,s).run()}catch(g){console.warn("[sendNotification] in-app insert failed:",t,g==null?void 0:g.message)}let a=r==null?void 0:r.pinHash;if(!a){const g=await e.prepare("SELECT pin_hash FROM users WHERE id = ?").bind(t).first();a=g==null?void 0:g.pin_hash}if(!a)return{sent:!0,channel:"in-app"};let i,o;try{const g=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"ntfy_url").first();if(g){const w=(await J(g.encrypted_value,a)).trim();i=/^https?:\/\//i.test(w)?w:`https://${w}`}const f=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"ntfy_token").first();f&&(o=(await J(f.encrypted_value,a)).trim())}catch(g){return console.warn("[sendNotification] credential decrypt failed:",t,g==null?void 0:g.message),{sent:!0,channel:"in-app"}}if(!i)return{sent:!0,channel:"in-app"};const l=So[(r==null?void 0:r.priority)||"default"]||"3",c=((r==null?void 0:r.tags)||["bell","karna"]).join(","),u={Title:n.replace(/[^\x00-\xff]/g,"").trim()||"Karna Notification",Priority:l,Tags:c,"Content-Type":"text/plain"};o&&(u.Authorization=`Bearer ${o}`);const h=new AbortController,v=setTimeout(()=>h.abort(),To);try{const g=await fetch(i,{method:"POST",headers:u,body:s,signal:h.signal});if(clearTimeout(v),!g.ok){const f=`HTTP ${g.status} from ${i}`;return console.warn(`[sendNotification] ntfy ${f} for user ${t} — check ntfy_url/ntfy_token credentials`),{sent:!0,channel:"ntfy-failed",error:f}}return{sent:!0,channel:"ntfy"}}catch(g){clearTimeout(v);const f=(g==null?void 0:g.message)||String(g);return console.warn(`[sendNotification] ntfy push failed for user ${t}: ${f}`),{sent:!0,channel:"ntfy-failed",error:f}}}const xo=Object.freeze(Object.defineProperty({__proto__:null,sendNotification:Ze},Symbol.toStringTag,{value:"Module"})),Ie=new _e;Ie.get("/debug/time",e=>{const t=new Date,n=new Intl.DateTimeFormat("en-US",{timeZone:"Asia/Kolkata",weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0});return e.json({utc_iso:t.toISOString(),utc_ms:t.getTime(),formatted_ist:n.format(t),toLocaleString_ist:t.toLocaleString("en-US",{timeZone:"Asia/Kolkata"})})});Ie.get("/health",async e=>{try{const t=Date.now();await e.env.DB.prepare("SELECT 1").first();const n=Date.now()-t;return e.json({status:"ok",timestamp:new Date().toISOString(),db_latency_ms:n,version:"3.1.0"})}catch{return e.json({status:"error",error:"Database unreachable"},500)}});Ie.post("/heartbeat",async e=>{try{const t=Date.now();await e.env.DB.prepare("SELECT 1").first();const n=Date.now()-t;return e.json({status:"ok",latency_ms:n})}catch(t){return e.json({status:"error",error:t.message},500)}});Ie.get("/status",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=n.user_id,[r,a,i,o]=await Promise.all([e.env.DB.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(s).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(s).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(s).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(s).first()]);return e.json({active_schedules:(r==null?void 0:r.cnt)||0,memory_entries:(a==null?void 0:a.cnt)||0,total_messages:(i==null?void 0:i.cnt)||0,unread_errors:(o==null?void 0:o.cnt)||0,heartbeat:{status:"ok"},version:"4.0.0"})});function hs(e){const t=new Date().toLocaleString("en-US",{timeZone:e});return new Date(t)}Ie.post("/cron/execute",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);const s=new Date,r=s.toISOString();try{await e.env.DB.prepare("INSERT INTO heartbeat_log (status, latency_ms, details) VALUES (?, ?, ?)").bind("ok",0,JSON.stringify({event:"cron_tick",ts:r})).run()}catch{}const a=await e.env.DB.prepare(`SELECT cj.*, u.telegram_chat_id, u.timezone as user_timezone, u.pin_hash
...
${c.output.substring(0,500)}${c.output.length>500?"...":""}`):c.status==="finished"?(h="Browser task completed (no output)",v=`${u} finished, but the browser returned no readable content. You may want to retry.`):(h="Browser task ended",v=`${u} ended with status "${c.status}". Check the browser dashboard for details.`),i.thread_id){const g=c.status==="finished"&&c.output?c.output.substring(0,8e3):v,f=Math.ceil(g.length/4);try{await e.env.DB.prepare(`INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id)
               VALUES (?, ?, 'assistant', ?, '{}', ?, ?)`).bind(i.user_id,i.channel||"web",g,f,i.thread_id).run()}catch{}}i.pin_hash&&await Ze(e.env.DB,i.user_id,h,v,{pinHash:i.pin_hash,tags:["browser","karna"]}),r++,await new Promise(g=>setTimeout(g,200))}catch{}}}catch{}return e.json({checked:s,notified:r})});Ie.get("/scorecard/weekly",async e=>{var u;const t=(u=e.req.header("Authorization"))==null?void 0:u.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=n.user_id,r=new Date(Date.now()-10080*60*1e3).toISOString(),[a,i,o]=await Promise.all([e.env.DB.prepare(`SELECT COUNT(*) as total,
...
Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",n);P.success||console.warn(`Failed to send unlinked account message: ${P.errors.join(" | ")}`);return}if(d.voice&&R&&T)try{if((d.voice.file_size??0)>20*1024*1024){const Z=await ae(R,w,"⚠️ Voice note is too large to process (max 20 MB).","Markdown",n,T.id);Z.success||console.warn(`[voice size] Failed to send message: ${Z.errors.join(" | ")}`);return}const P=await ae(R,w,"🎤 Processing voice note...","Markdown",n,T.id);P.success||console.warn(`[voice start] Failed to send message: ${P.errors.join(" | ")}`);const G=await(await Oe(`https://api.telegram.org/bot${R}/getFile?file_id=${d.voice.file_id}`)).json();if(G.ok&&((r=G.result)!=null&&r.file_path)){const te=await(await fs(`https://api.telegram.org/file/bot${R}/${G.result.file_path}`)).blob(),oe=await Co(n,T.id,T.pin_hash);if(!oe){const p=await ae(R,w,"⚠️ To use voice notes, add an OpenAI or Groq API key in Settings → Keys (LLM slot or legacy openai/groq).","Markdown",n,T.id);p.success||console.warn(`[voice no stt] Failed to send message: ${p.errors.join(" | ")}`);return}const re=new FormData;re.append("file",te,"voice.ogg"),re.append("model",oe.model),re.append("language","en");const pe=await fetch(oe.url,{method:"POST",headers:{Authorization:`Bearer ${oe.apiKey}`},body:re});if(!pe.ok){const p=await pe.text(),y=await ae(R,w,`⚠️ Transcription failed: ${pe.status} ${p}`,"Markdown",n,T.id);y.success||console.warn(`[voice transcription error] Failed to send message: ${y.errors.join(" | ")}`);return}b=(await pe.json()).text;const E=await ae(R,w,`🗣️ *You said:* ${b}`,"Markdown",n,T.id);E.success||console.warn(`[voice transcript echo] Failed to send message: ${E.errors.join(" | ")}`)}}catch(P){const K=await ae(R,w,`⚠️ Failed to process voice note: ${P.message}`,"Markdown",n,T==null?void 0:T.id);K.success||console.warn(`[voice processing error] Failed to send message: ${K.errors.join(" | ")}`);return}if((v||g)&&R&&T)try{let P,K="unknown",G="unknown",Z=0;if(v)P=d.document.file_id,K=d.document.file_name||"document",G=d.document.mime_type||"unknown",Z=d.document.file_size||0;else if(g){const te=d.photo[d.photo.length-1];P=te.file_id,K="photo.jpg",G="image/jpeg",Z=te.file_size||0}if(P){const oe=await(await Oe(`https://api.telegram.org/bot${R}/getFile?file_id=${P}`)).json();let re="";if(oe.ok&&((a=oe.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(K)||/^text\/|application\/json|application\/xml|application\/csv/i.test(G))&&Z<5e4)try{re=await(await fs(`https://api.telegram.org/file/bot${R}/${oe.result.file_path}`)).text()}catch{}const pe=d.caption||"",m=`[Telegram file received: "${K}" (${G}, ${Math.round(Z/1024)}KB)]`;re?b=`${pe?pe+`
...
🕐 ${b}${T}`;await Ze(e.env.DB,l.id,R,B,{pinHash:l.pin_hash,priority:"high",tags:["calendar","karna"]})}r.push({user_id:l.id,reminders_sent:f.length})}catch(c){r.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ye.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(!Jr(l,o,a))continue;const c=on(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'morning' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await Zr(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let h={telegram:!0,web:!0};try{h=JSON.parse(i.notification_channels||"{}")}catch{}if(h.web!==!1&&u.briefingId){const v=dl(u.content);await Ze(e.env.DB,i.id,"Morning Briefing",v,{pinHash:i.pin_hash,tags:["briefing","karna"]}),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run()}r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ye.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
...
`).slice(0,4e3)}async function gl(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}Ce.use("/*",gl);Ce.get("/",async e=>{const t=e.get("user"),n=e.req.query("status"),s=e.req.query("search"),r=["user_id = ?"],a=[t.id];n&&(r.push("status = ?"),a.push(n)),s&&(r.push("(name LIKE ? OR summary LIKE ?)"),a.push(`%${s}%`,`%${s}%`));const i=`SELECT * FROM document_library WHERE ${r.join(" AND ")} ORDER BY created_at DESC`,o=await e.env.DB.prepare(i).bind(...a).all();return e.json({documents:o.results||[]})});Ce.get("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return s?e.json({document:s}):e.json({error:"Document not found"},404)});Ce.post("/upload",async e=>{const t=e.get("user"),n=!!e.env.DOCUMENTS_BUCKET,s=n?100*1024*1024:700*1024;try{const a=(await e.req.formData()).get("file");if(!a)return e.json({error:"No file provided."},400);const i=a.name,o=a.type||"application/octet-stream",l=a.size;if(l>s)return e.json({error:`File too large (max ${n?"100 MB":"700 KB"}). Try sharing a Google Drive link instead.`},400);const c=await a.arrayBuffer(),d=crypto.randomUUID();let u;n?(await e.env.DOCUMENTS_BUCKET.put(d,c,{httpMetadata:{contentType:o},customMetadata:{fileName:i,userId:String(t.id)}}),u="r2"):u=Buffer.from(c).toString("base64"),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(d,t.id,i,o,u,l).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,d,"upload",i,o,l,"uploaded").run();const h=o==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||i.toLowerCase().endsWith(".docx");if(h)try{const{extractDocxTextFromBuffer:g}=await Promise.resolve().then(()=>Tr),f=await g(Buffer.from(c));if(f.length>50){await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(f,d).run();const w=f.substring(0,600);await e.env.DB.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(w,f.substring(0,5e4),d,t.id).run();const b=e.env,T=t.id,R=f,B=d,I=(async()=>{try{const L=await b.DB.prepare("SELECT id FROM document_library WHERE file_id = ? AND user_id = ?").bind(B,T).first();if(L){const{indexDocumentChunks:$}=await Promise.resolve().then(()=>Ke);await $({DB:b.DB,AI:b.AI,VECTORIZE:b.VECTORIZE},T,L.id,R)}}catch{}})();try{e.executionCtx.waitUntil(I)}catch{}}}catch{}const v=o==="application/pdf"||i.toLowerCase().endsWith(".pdf");if(v&&t.pin_hash){const g=Buffer.from(c).toString("base64"),f=t.pin_hash,w=t.id,b=e.env.DB,T=e.env.DOCUMENTS_BUCKET,R=e.env,B=(async()=>{var I,L;try{let $=null,W="claude-sonnet-4-6";const{decrypt:q}=await Promise.resolve().then(()=>rn);for(const Z of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const te=await b.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(w,Z).first();if(te){const oe=await q(te.encrypted_value,f),re=JSON.parse(oe);if(re.provider==="anthropic"){$=re.apiKey,re.model&&(W=re.model);break}}}catch{}if(!$)return;let ne=g;if(u==="r2"&&T){const Z=await T.get(d);if(!Z)return;ne=Buffer.from(await Z.arrayBuffer()).toString("base64")}const P=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":$,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:W,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ne}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!P.ok)return;const G=((L=(I=(await P.json()).content)==null?void 0:I[0])==null?void 0:L.text)||"";if(G){await b.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(G,d).run();const Z=G.substring(0,600);await b.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(Z,G.substring(0,5e4),d,w).run();try{const te=await b.prepare("SELECT id FROM document_library WHERE file_id = ? AND user_id = ?").bind(d,w).first();if(te){const{indexDocumentChunks:oe}=await Promise.resolve().then(()=>Ke);await oe({DB:b,AI:R.AI,VECTORIZE:R.VECTORIZE},w,te.id,G)}}catch{}}}catch{}})();try{e.executionCtx.waitUntil(B)}catch{}}return e.json({file_id:d,name:i,type:o,size:l,storage:n?"r2":"d1",extracting:v&&!h})}catch(r){return console.error("Document upload error:",r),e.json({error:`Upload failed: ${r.message||"Unknown error"}`},500)}});Ce.post("/search",async e=>{const t=e.get("user"),n=await e.req.json();if(!n.query)return e.json({error:"query is required"},400);const{semanticDocumentSearch:s}=await Promise.resolve().then(()=>Ke),r=await s({DB:e.env.DB,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE},t.id,n.query,Math.min(n.limit||5,20));return e.json({results:r})});Ce.post("/chat",async e=>{var o;const t=e.get("user"),n=await e.req.json(),s=(n.question||n.query||"").trim();if(!s)return e.json({error:"question is required"},400);const{semanticDocumentSearch:r}=await Promise.resolve().then(()=>Ke),a=await r({DB:e.env.DB,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE},t.id,s,6);let i;if(a.length===0)i="No relevant document content found for your question. Make sure your documents have been uploaded and processed first.";else{const l=a.map((c,d)=>`[Source ${d+1}: ${c.filename} | chunk ${c.chunk_index}]
${hl(c.chunk)}`).join(`
