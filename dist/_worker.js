var cr=Object.defineProperty;var Pt=e=>{throw TypeError(e)};var dr=(e,t,a)=>t in e?cr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var S=(e,t,a)=>dr(e,typeof t!="symbol"?t+"":t,a),wt=(e,t,a)=>t.has(e)||Pt("Cannot "+a);var w=(e,t,a)=>(wt(e,t,"read from private field"),a?a.call(e):t.get(e)),C=(e,t,a)=>t.has(e)?Pt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),R=(e,t,a,r)=>(wt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(wt(e,t,"access private method"),a);var Ut=(e,t,a,r)=>({set _(s){R(e,t,s,a)},get _(){return w(e,t,r)}});var Ht=(e,t,a)=>(r,s)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let l,c=!1,d;if(e[i]?(d=e[i][0][0],r.req.routeIndex=i):d=i===e.length&&s||void 0,d)try{l=await d(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,l=await t(m,r),c=!0;else throw m}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},ur=Symbol(),mr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,n=(e instanceof ua?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?pr(e,{all:a,dot:r}):{}};async function pr(e,t){const a=await e.formData();return a?hr(a,t):{}}function hr(e,t){const a=Object.create(null);return e.forEach((r,s)=>{t.all||s.endsWith("[]")?gr(a,s,r):a[s]=r}),t.dot&&Object.entries(a).forEach(([r,s])=>{r.includes(".")&&(fr(a,r,s),delete a[r])}),a}var gr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},fr=(e,t,a)=>{let r=e;const s=t.split(".");s.forEach((n,o)=>{o===s.length-1?r[n]=a:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},oa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},yr=e=>{const{groups:t,path:a}=vr(e),r=oa(a);return wr(r,t)},vr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const s=`@${r}`;return t.push([s,a]),s}),{groups:t,path:e}},wr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let s=e.length-1;s>=0;s--)if(e[s].includes(r)){e[s]=e[s].replace(r,t[a][1]);break}}return e},lt={},br=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return lt[r]||(a[2]?lt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:lt[r]=[e,a[1],!0]),lt[r]}return null},Nt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},_r=e=>Nt(e,decodeURI),ia=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const s=t.charCodeAt(r);if(s===37){const n=t.indexOf("?",r),o=t.indexOf("#",r),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),l=t.slice(a,i);return _r(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(s===63||s===35)break}return t.slice(a,r)},Er=e=>{const t=ia(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Le=(e,t,...a)=>(a.length&&(t=Le(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),la=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(s=>{if(s!==""&&!/\:/.test(s))r+="/"+s;else if(/\:/.test(s))if(/\?/.test(s)){a.length===0&&r===""?a.push("/"):a.push(r);const n=s.replace("?","");r+="/"+n,a.push(r)}else r+="/"+s}),a.filter((s,n,o)=>o.indexOf(s)===n)},bt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Nt(e,da):e):e,ca=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return bt(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const s={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let l=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(r&&(l=bt(l)),n=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=bt(c))),a?(s[l]&&Array.isArray(s[l])||(s[l]=[]),s[l].push(c)):s[l]??(s[l]=c)}return t?s[t]:s},Tr=ca,xr=(e,t)=>ca(e,t,!0),da=decodeURIComponent,Gt=e=>Nt(e,da),Be,V,me,ma,pa,St,he,ea,ua=(ea=class{constructor(e,t="/",a=[[]]){C(this,me);S(this,"raw");C(this,Be);C(this,V);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});C(this,he,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const s=Object.keys(t)[0];return s?t[s].then(n=>(s==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,R(this,V,a),R(this,Be,{})}param(e){return e?L(this,me,ma).call(this,e):L(this,me,pa).call(this)}query(e){return Tr(this.url,e)}queries(e){return xr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await mr(this,e))}json(){return w(this,he).call(this,"text").then(e=>JSON.parse(e))}text(){return w(this,he).call(this,"text")}arrayBuffer(){return w(this,he).call(this,"arrayBuffer")}blob(){return w(this,he).call(this,"blob")}formData(){return w(this,he).call(this,"formData")}addValidatedData(e,t){w(this,Be)[e]=t}valid(e){return w(this,Be)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ur](){return w(this,V)}get matchedRoutes(){return w(this,V)[0].map(([[,e]])=>e)}get routePath(){return w(this,V)[0].map(([[,e]])=>e)[this.routeIndex].path}},Be=new WeakMap,V=new WeakMap,me=new WeakSet,ma=function(e){const t=w(this,V)[0][this.routeIndex][1][e],a=L(this,me,St).call(this,t);return a&&/\%/.test(a)?Gt(a):a},pa=function(){const e={},t=Object.keys(w(this,V)[0][this.routeIndex][1]);for(const a of t){const r=L(this,me,St).call(this,w(this,V)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Gt(r):r)}return e},St=function(e){return w(this,V)[1]?w(this,V)[1][e]:e},he=new WeakMap,ea),kr={Stringify:1},ha=async(e,t,a,r,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(s?s[0]+=e:s=[e],Promise.all(n.map(i=>i({phase:t,buffer:s,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>ha(l,t,!1,r,s))).then(()=>s[0]))):Promise.resolve(e)},Sr="text/plain; charset=UTF-8",_t=(e,t)=>({"Content-Type":e,...t}),Ze,Qe,le,je,ce,K,et,Pe,Ue,ke,tt,at,ge,Me,ta,Ir=(ta=class{constructor(e,t){C(this,ge);C(this,Ze);C(this,Qe);S(this,"env",{});C(this,le);S(this,"finalized",!1);S(this,"error");C(this,je);C(this,ce);C(this,K);C(this,et);C(this,Pe);C(this,Ue);C(this,ke);C(this,tt);C(this,at);S(this,"render",(...e)=>(w(this,Pe)??R(this,Pe,t=>this.html(t)),w(this,Pe).call(this,...e)));S(this,"setLayout",e=>R(this,et,e));S(this,"getLayout",()=>w(this,et));S(this,"setRenderer",e=>{R(this,Pe,e)});S(this,"header",(e,t,a)=>{this.finalized&&R(this,K,new Response(w(this,K).body,w(this,K)));const r=w(this,K)?w(this,K).headers:w(this,ke)??R(this,ke,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});S(this,"status",e=>{R(this,je,e)});S(this,"set",(e,t)=>{w(this,le)??R(this,le,new Map),w(this,le).set(e,t)});S(this,"get",e=>w(this,le)?w(this,le).get(e):void 0);S(this,"newResponse",(...e)=>L(this,ge,Me).call(this,...e));S(this,"body",(e,t,a)=>L(this,ge,Me).call(this,e,t,a));S(this,"text",(e,t,a)=>!w(this,ke)&&!w(this,je)&&!t&&!a&&!this.finalized?new Response(e):L(this,ge,Me).call(this,e,t,_t(Sr,a)));S(this,"json",(e,t,a)=>L(this,ge,Me).call(this,JSON.stringify(e),t,_t("application/json",a)));S(this,"html",(e,t,a)=>{const r=s=>L(this,ge,Me).call(this,s,t,_t("text/html; charset=UTF-8",a));return typeof e=="object"?ha(e,kr.Stringify,!1,{}).then(r):r(e)});S(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});S(this,"notFound",()=>(w(this,Ue)??R(this,Ue,()=>new Response),w(this,Ue).call(this,this)));R(this,Ze,e),t&&(R(this,ce,t.executionCtx),this.env=t.env,R(this,Ue,t.notFoundHandler),R(this,at,t.path),R(this,tt,t.matchResult))}get req(){return w(this,Qe)??R(this,Qe,new ua(w(this,Ze),w(this,at),w(this,tt))),w(this,Qe)}get event(){if(w(this,ce)&&"respondWith"in w(this,ce))return w(this,ce);throw Error("This context has no FetchEvent")}get executionCtx(){if(w(this,ce))return w(this,ce);throw Error("This context has no ExecutionContext")}get res(){return w(this,K)||R(this,K,new Response(null,{headers:w(this,ke)??R(this,ke,new Headers)}))}set res(e){if(w(this,K)&&e){e=new Response(e.body,e);for(const[t,a]of w(this,K).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=w(this,K).headers.getSetCookie();e.headers.delete("set-cookie");for(const s of r)e.headers.append("set-cookie",s)}else e.headers.set(t,a)}R(this,K,e),this.finalized=!0}get var(){return w(this,le)?Object.fromEntries(w(this,le)):{}}},Ze=new WeakMap,Qe=new WeakMap,le=new WeakMap,je=new WeakMap,ce=new WeakMap,K=new WeakMap,et=new WeakMap,Pe=new WeakMap,Ue=new WeakMap,ke=new WeakMap,tt=new WeakMap,at=new WeakMap,ge=new WeakSet,Me=function(e,t,a){const r=w(this,K)?new Headers(w(this,K).headers):w(this,ke)??new Headers;if(typeof t=="object"&&"headers"in t){const n=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[n,o]of Object.entries(a))if(typeof o=="string")r.set(n,o);else{r.delete(n);for(const i of o)r.append(n,i)}const s=typeof t=="number"?t:(t==null?void 0:t.status)??w(this,je);return new Response(e,{status:s,headers:r})},ta),F="ALL",Dr="all",Or=["get","post","put","delete","options","patch"],ga="Can not add a route since the matcher is already built.",fa=class extends Error{},Rr="__COMPOSED_HANDLER",Cr=e=>e.text("404 Not Found",404),Ft=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Z,W,ya,Q,Te,ut,mt,He,Nr=(He=class{constructor(t={}){C(this,W);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");C(this,Z,"/");S(this,"routes",[]);C(this,Q,Cr);S(this,"errorHandler",Ft);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(R(this,Q,t),this));S(this,"fetch",(t,...a)=>L(this,W,mt).call(this,t,a[1],a[0],t.method));S(this,"request",(t,a,r,s)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,s):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Le("/",t)}`,a),r,s)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,W,mt).call(this,t.request,t,void 0,t.request.method))})});[...Or,Dr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?R(this,Z,o):L(this,W,Te).call(this,n,w(this,Z),o),i.forEach(l=>{L(this,W,Te).call(this,n,w(this,Z),l)}),this)}),this.on=(n,o,...i)=>{for(const l of[o].flat()){R(this,Z,l);for(const c of[n].flat())i.map(d=>{L(this,W,Te).call(this,c.toUpperCase(),w(this,Z),d)})}return this},this.use=(n,...o)=>(typeof n=="string"?R(this,Z,n):(R(this,Z,"*"),o.unshift(n)),o.forEach(i=>{L(this,W,Te).call(this,F,w(this,Z),i)}),this);const{strict:r,...s}=t;Object.assign(this,s),this.getPath=r??!0?t.getPath??ia:Er}route(t,a){const r=this.basePath(t);return a.routes.map(s=>{var o;let n;a.errorHandler===Ft?n=s.handler:(n=async(i,l)=>(await Ht([],a.errorHandler)(i,()=>s.handler(i,l))).res,n[Rr]=s.handler),L(o=r,W,Te).call(o,s.method,s.path,n)}),this}basePath(t){const a=L(this,W,ya).call(this);return a._basePath=Le(this._basePath,t),a}mount(t,a,r){let s,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?s=l=>l:s=r.replaceRequest));const o=n?l=>{const c=n(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};s||(s=(()=>{const l=Le(this._basePath,t),c=l==="/"?0:l.length;return d=>{const m=new URL(d.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,d)}})());const i=async(l,c)=>{const d=await a(s(l.req.raw),...o(l));if(d)return d;await c()};return L(this,W,Te).call(this,F,Le(t,"*"),i),this}},Z=new WeakMap,W=new WeakSet,ya=function(){const t=new He({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,R(t,Q,w(this,Q)),t.routes=this.routes,t},Q=new WeakMap,Te=function(t,a,r){t=t.toUpperCase(),a=Le(this._basePath,a);const s={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,s]),this.routes.push(s)},ut=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},mt=function(t,a,r,s){if(s==="HEAD")return(async()=>new Response(null,await L(this,W,mt).call(this,t,a,r,"GET")))();const n=this.getPath(t,{env:r}),o=this.router.match(s,n),i=new Ir(t,{path:n,matchResult:o,env:r,executionCtx:a,notFoundHandler:w(this,Q)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await w(this,Q).call(this,i)})}catch(d){return L(this,W,ut).call(this,d,i)}return c instanceof Promise?c.then(d=>d||(i.finalized?i.res:w(this,Q).call(this,i))).catch(d=>L(this,W,ut).call(this,d,i)):c??w(this,Q).call(this,i)}const l=Ht(o[0],this.errorHandler,w(this,Q));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return L(this,W,ut).call(this,c,i)}})()},He),va=[];function Ar(e,t){const a=this.buildAllMatchers(),r=((s,n)=>{const o=a[s]||a[F],i=o[2][n];if(i)return i;const l=n.match(o[0]);if(!l)return[[],va];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var ht="[^/]+",Je=".*",Ve="(?:|/.*)",$e=Symbol(),Lr=new Set(".\\+*[^]$()");function Mr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Je||e===Ve?1:t===Je||t===Ve?-1:e===ht?1:t===ht?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Se,Ie,ee,Re,$r=(Re=class{constructor(){C(this,Se);C(this,Ie);C(this,ee,Object.create(null))}insert(t,a,r,s,n){if(t.length===0){if(w(this,Se)!==void 0)throw $e;if(n)return;R(this,Se,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Je]:["","",ht]:o==="/*"?["","",Ve]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let m=l[2]||ht;if(d&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw $e;if(c=w(this,ee)[m],!c){if(Object.keys(w(this,ee)).some(h=>h!==Je&&h!==Ve))throw $e;if(n)return;c=w(this,ee)[m]=new Re,d!==""&&R(c,Ie,s.varIndex++)}!n&&d!==""&&r.push([d,w(c,Ie)])}else if(c=w(this,ee)[o],!c){if(Object.keys(w(this,ee)).some(d=>d.length>1&&d!==Je&&d!==Ve))throw $e;if(n)return;c=w(this,ee)[o]=new Re}c.insert(i,a,r,s,n)}buildRegExpStr(){const a=Object.keys(w(this,ee)).sort(Mr).map(r=>{const s=w(this,ee)[r];return(typeof w(s,Ie)=="number"?`(${r})@${w(s,Ie)}`:Lr.has(r)?`\\${r}`:r)+s.buildRegExpStr()});return typeof w(this,Se)=="number"&&a.unshift(`#${w(this,Se)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Se=new WeakMap,Ie=new WeakMap,ee=new WeakMap,Re),gt,rt,aa,Br=(aa=class{constructor(){C(this,gt,{varIndex:0});C(this,rt,new $r)}insert(e,t,a){const r=[],s=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return s[o]=[c,l],o++,i=!0,c}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=s.length-1;o>=0;o--){const[i]=s[o];for(let l=n.length-1;l>=0;l--)if(n[l].indexOf(i)!==-1){n[l]=n[l].replace(i,s[o][1]);break}}return w(this,rt).insert(n,t,r,w(this,gt),a),r}buildRegExp(){let e=w(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(s,n,o)=>n!==void 0?(a[++t]=Number(n),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},gt=new WeakMap,rt=new WeakMap,aa),jr=[/^$/,[],Object.create(null)],pt=Object.create(null);function wa(e){return pt[e]??(pt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Pr(){pt=Object.create(null)}function Ur(e){var c;const t=new Br,a=[];if(e.length===0)return jr;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,m],[h,v])=>d?1:h?-1:m.length-v.length),s=Object.create(null);for(let d=0,m=-1,h=r.length;d<h;d++){const[v,f,_]=r[d];v?s[f]=[_.map(([T])=>[T,Object.create(null)]),va]:m++;let b;try{b=t.insert(f,m,v)}catch(T){throw T===$e?new fa(f):T}v||(a[m]=_.map(([T,u])=>{const g=Object.create(null);for(u-=1;u>=0;u--){const[p,y]=b[u];g[p]=y}return[T,g]}))}const[n,o,i]=t.buildRegExp();for(let d=0,m=a.length;d<m;d++)for(let h=0,v=a[d].length;h<v;h++){const f=(c=a[d][h])==null?void 0:c[1];if(!f)continue;const _=Object.keys(f);for(let b=0,T=_.length;b<T;b++)f[_[b]]=i[f[_[b]]]}const l=[];for(const d in o)l[d]=a[o[d]];return[n,l,s]}function Ne(e,t){if(e){for(const a of Object.keys(e).sort((r,s)=>s.length-r.length))if(wa(a).test(t))return[...e[a]]}}var fe,ye,ft,ba,ra,Hr=(ra=class{constructor(){C(this,ft);S(this,"name","RegExpRouter");C(this,fe);C(this,ye);S(this,"match",Ar);R(this,fe,{[F]:Object.create(null)}),R(this,ye,{[F]:Object.create(null)})}add(e,t,a){var i;const r=w(this,fe),s=w(this,ye);if(!r||!s)throw new Error(ga);r[e]||[r,s].forEach(l=>{l[e]=Object.create(null),Object.keys(l[F]).forEach(c=>{l[e][c]=[...l[F][c]]})}),t==="/*"&&(t="*");const n=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=wa(t);e===F?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=Ne(r[c],t)||Ne(r[F],t)||[])}):(i=r[e])[t]||(i[t]=Ne(r[e],t)||Ne(r[F],t)||[]),Object.keys(r).forEach(c=>{(e===F||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,n])})}),Object.keys(s).forEach(c=>{(e===F||e===c)&&Object.keys(s[c]).forEach(d=>l.test(d)&&s[c][d].push([a,n]))});return}const o=la(t)||[t];for(let l=0,c=o.length;l<c;l++){const d=o[l];Object.keys(s).forEach(m=>{var h;(e===F||e===m)&&((h=s[m])[d]||(h[d]=[...Ne(r[m],d)||Ne(r[F],d)||[]]),s[m][d].push([a,n-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(w(this,ye)).concat(Object.keys(w(this,fe))).forEach(t=>{e[t]||(e[t]=L(this,ft,ba).call(this,t))}),R(this,fe,R(this,ye,void 0)),Pr(),e}},fe=new WeakMap,ye=new WeakMap,ft=new WeakSet,ba=function(e){const t=[];let a=e===F;return[w(this,fe),w(this,ye)].forEach(r=>{const s=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];s.length!==0?(a||(a=!0),t.push(...s)):e!==F&&t.push(...Object.keys(r[F]).map(n=>[n,r[F][n]]))}),a?Ur(t):null},ra),ve,de,sa,Gr=(sa=class{constructor(e){S(this,"name","SmartRouter");C(this,ve,[]);C(this,de,[]);R(this,ve,e.routers)}add(e,t,a){if(!w(this,de))throw new Error(ga);w(this,de).push([e,t,a])}match(e,t){if(!w(this,de))throw new Error("Fatal error");const a=w(this,ve),r=w(this,de),s=a.length;let n=0,o;for(;n<s;n++){const i=a[n];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof fa)continue;throw l}this.match=i.match.bind(i),R(this,ve,[i]),R(this,de,void 0);break}if(n===s)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(w(this,de)||w(this,ve).length!==1)throw new Error("No active router has been determined yet.");return w(this,ve)[0]}},ve=new WeakMap,de=new WeakMap,sa),ze=Object.create(null),we,q,De,Ge,z,ue,xe,Fe,Fr=(Fe=class{constructor(t,a,r){C(this,ue);C(this,we);C(this,q);C(this,De);C(this,Ge,0);C(this,z,ze);if(R(this,q,r||Object.create(null)),R(this,we,[]),t&&a){const s=Object.create(null);s[t]={handler:a,possibleKeys:[],score:0},R(this,we,[s])}R(this,De,[])}insert(t,a,r){R(this,Ge,++Ut(this,Ge)._);let s=this;const n=yr(a),o=[];for(let i=0,l=n.length;i<l;i++){const c=n[i],d=n[i+1],m=br(c,d),h=Array.isArray(m)?m[0]:c;if(h in w(s,q)){s=w(s,q)[h],m&&o.push(m[1]);continue}w(s,q)[h]=new Fe,m&&(w(s,De).push(m),o.push(m[1])),s=w(s,q)[h]}return w(s,we).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:w(this,Ge)}}),s}search(t,a){var l;const r=[];R(this,z,ze);let n=[this];const o=oa(a),i=[];for(let c=0,d=o.length;c<d;c++){const m=o[c],h=c===d-1,v=[];for(let f=0,_=n.length;f<_;f++){const b=n[f],T=w(b,q)[m];T&&(R(T,z,w(b,z)),h?(w(T,q)["*"]&&r.push(...L(this,ue,xe).call(this,w(T,q)["*"],t,w(b,z))),r.push(...L(this,ue,xe).call(this,T,t,w(b,z)))):v.push(T));for(let u=0,g=w(b,De).length;u<g;u++){const p=w(b,De)[u],y=w(b,z)===ze?{}:{...w(b,z)};if(p==="*"){const D=w(b,q)["*"];D&&(r.push(...L(this,ue,xe).call(this,D,t,w(b,z))),R(D,z,y),v.push(D));continue}const[E,x,I]=p;if(!m&&!(I instanceof RegExp))continue;const O=w(b,q)[E],k=o.slice(c).join("/");if(I instanceof RegExp){const D=I.exec(k);if(D){if(y[x]=D[0],r.push(...L(this,ue,xe).call(this,O,t,w(b,z),y)),Object.keys(w(O,q)).length){R(O,z,y);const A=((l=D[0].match(/\//))==null?void 0:l.length)??0;(i[A]||(i[A]=[])).push(O)}continue}}(I===!0||I.test(m))&&(y[x]=m,h?(r.push(...L(this,ue,xe).call(this,O,t,y,w(b,z))),w(O,q)["*"]&&r.push(...L(this,ue,xe).call(this,w(O,q)["*"],t,y,w(b,z)))):(R(O,z,y),v.push(O)))}}n=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},we=new WeakMap,q=new WeakMap,De=new WeakMap,Ge=new WeakMap,z=new WeakMap,ue=new WeakSet,xe=function(t,a,r,s){const n=[];for(let o=0,i=w(t,we).length;o<i;o++){const l=w(t,we)[o],c=l[a]||l[F],d={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),r!==ze||s&&s!==ze))for(let m=0,h=c.possibleKeys.length;m<h;m++){const v=c.possibleKeys[m],f=d[c.score];c.params[v]=s!=null&&s[v]&&!f?s[v]:r[v]??(s==null?void 0:s[v]),d[c.score]=!0}}return n},Fe),Oe,na,Wr=(na=class{constructor(){S(this,"name","TrieRouter");C(this,Oe);R(this,Oe,new Fr)}add(e,t,a){const r=la(t);if(r){for(let s=0,n=r.length;s<n;s++)w(this,Oe).insert(e,r[s],a);return}w(this,Oe).insert(e,t,a)}match(e,t){return w(this,Oe).search(e,t)}},Oe=new WeakMap,na),be=class extends Nr{constructor(e={}){super(e),this.router=e.router??new Gr({routers:[new Hr,new Wr]})}},zr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(a.origin),s=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(a.allowMethods);return async function(o,i){var d;function l(m,h){o.res.headers.set(m,h)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await s(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let h=a.allowHeaders;if(!(h!=null&&h.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(h=v.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function _a(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${r} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>xa),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const h=await c(m.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(o){console.error("Failed to send provider alert:",o)}}function Wt(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class Sa{constructor(t,a="claude-sonnet-4-20250514",r="https://api.anthropic.com",s="anthropic"){S(this,"name");S(this,"apiKey");S(this,"model");S(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r,this.name=s}async chat(t,a){var d,m,h,v;const r=t.find(f=>f.role==="system"),s=t.filter(f=>f.role!=="system"),n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:s.map(f=>({role:f.role,content:f.content}))};r&&(n.system=r.content),a!=null&&a.tools&&a.tools.length>0&&(n.tools=a.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})));const o=await ka(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(n)}),this.name);if(!o.ok){const f=await o.text();throw new Error(this.name+" API error "+o.status+": "+f)}const i=await o.json(),l=((d=i.content)==null?void 0:d.filter(f=>f.type==="text"))||[],c=((m=i.content)==null?void 0:m.filter(f=>f.type==="tool_use"))||[];return{content:l.map(f=>f.text).join(`
`),toolCalls:c.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((h=i.usage)==null?void 0:h.input_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,a){const r=t.find(c=>c.role==="system"),s=t.filter(c=>c.role!=="system"),n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:s.map(c=>({role:c.role,content:c.content}))};r&&(n.system=r.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(n)});if(!o.ok){const c=await o.text();throw new Error(this.name+" stream error "+o.status+": "+c)}const i=o.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var f;const{done:d,value:m}=await i.read();if(d){c.close();return}const v=l.decode(m,{stream:!0}).split(`
`);for(const _ of v)if(_.startsWith("data: ")){const b=_.slice(6);if(b==="[DONE]")continue;try{const T=JSON.parse(b);T.type==="content_block_delta"&&((f=T.delta)!=null&&f.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:T.delta.text})+`

`))}catch{}}}})}}function Yr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const r=a.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const s={};for(const[n,o]of Object.entries(r))o&&typeof o=="object"?s[n]=It(o):s[n]=o;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function It(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const r={};for(const[s,n]of Object.entries(a))n&&typeof n=="object"?r[s]=It(n):r[s]=n;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=It(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class Ia{constructor(t,a,r,s){S(this,"name");S(this,"apiKey");S(this,"model");S(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=r.replace(/\/+$/,""),this.name=s}async chat(t,a){var l,c,d,m,h,v;const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},s=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&s)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(r.tools=a.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:Yr(f.parameters||{})}})));const n=await ka(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)}),this.name);if(!n.ok){const f=await n.text();throw new Error(this.name+" API error "+n.status+": "+f)}const o=await n.json(),i=(l=o.choices)==null?void 0:l[0];return{content:((c=i==null?void 0:i.message)==null?void 0:c.content)||"",toolCalls:(m=(d=i==null?void 0:i.message)==null?void 0:d.tool_calls)==null?void 0:m.map(f=>({id:f.id,name:f.function.name,arguments:(()=>{try{return typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=o.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,a){const r={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(r)});if(!s.ok){const i=await s.text();throw new Error(this.name+" stream error "+s.status+": "+i)}const n=s.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var h,v,f;const{done:l,value:c}=await n.read();if(l){i.close();return}const m=o.decode(c,{stream:!0}).split(`
`);for(const _ of m)if(_.startsWith("data: ")){const b=_.slice(6);if(b==="[DONE]")continue;try{const u=(f=(v=(h=JSON.parse(b).choices)==null?void 0:h[0])==null?void 0:v.delta)==null?void 0:f.content;u&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:u})+`

`))}catch{}}}})}}function Dt(e,t,a,r){const s=Xe[e];if(!s)throw new Error(`Unknown LLM provider: ${e}`);const n=r||s.defaultModel;return s.apiFormat==="anthropic"?new Sa(t,n,s.apiBase,a):new Ia(t,n,s.apiBase,a)}class Da{constructor(){S(this,"errorLog",new Map);S(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(s=>{const n=this.errorLog.get(s);return n?n.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const Jr=["llm_slot_1","llm_slot_2","llm_slot_3"],Vr=["anthropic","openai"];async function st(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>xa),s=new Da,n=[];for(const m of Jr){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const v=await r(h.encrypted_value,a),f=JSON.parse(v);if(f.provider&&f.apiKey&&Xe[f.provider]){const b=f.provider,T=Dt(f.provider,f.apiKey,b,f.model);n.push({name:b,provider:T})}}catch(v){console.error(`Failed to load ${m}:`,v)}}const o=new Set(n.map(m=>m.name));for(const m of Vr){if(o.has(m))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const v=await r(h.encrypted_value,a);if(Xe[m]){const _=Dt(m,v,m);n.push({name:m,provider:_})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(n.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=n.map(m=>m.name),l=await s.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:n[0].provider,rotation:s};const c=n.find(m=>m.name===l);return{provider:Xr(c.provider,n,s,e,t),rotation:s}}function Xr(e,t,a,r,s){const n=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(l){const c=l.message||"";throw n(c)&&!c.includes("TOOLS_UNSUPPORTED")&&Et(r,s,"all_providers_down",e.name,null,c),l}},async streamChat(o,i){return await e.streamChat(o,i)}}:{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(l){const c=l.message||"";if(!n(c))throw l;const d=c.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${d?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,d?1:1440);const m=t.filter(h=>h.name!==e.name);for(const h of m)try{const v=await h.provider.chat(o,i);return this.name=h.name,d||Et(r,s,"provider_switched",e.name,h.name,c),v}catch(v){const f=v.message||"";if(n(f)){await a.recordError(h.name,f,1440);continue}throw v}throw Et(r,s,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,i){return await e.streamChat(o,i)}}}const Ot=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:Sa,OpenAICompatibleProvider:Ia,ProviderRotation:Da,createProviderFromConfig:Dt,createRotatingProvider:st,logError:N},Symbol.toStringTag,{value:"Module"})),Tt=20,Zr=2e3,Qr=2e3,Oa=4;function es(e){return Math.ceil(e.length/Oa)}function zt(e,t){const a=t*Oa;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class te{constructor(t){this.db=t}async store(t,a,r,s,n=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,r).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,r,s,n,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>Tt){const r=((a==null?void 0:a.cnt)||0)-Tt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
...
`),t.trim()}async function Ya(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),s=a.maxResults||(a.depth==="thorough"?8:5),n=await vt(e,{num:s,site:a.site});if(n.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${n.error}`};if(n.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=n.results.slice(0,r).map(async h=>{const v=await Ka(h.link);return{title:h.title,url:h.link,displayLink:h.displayLink,snippet:h.snippet,content:v.text,error:v.error}}),c=(await Promise.all(i)).filter(h=>h.content.length>50);if(c.length===0){const h=n.results.map((f,_)=>`[${_+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await qt(e,h,t,"snippets"),sources:n.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const d=c.map((h,v)=>`--- SOURCE ${v+1}: ${h.title} (${h.displayLink}) ---
${h.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await qt(e,d,t,"full"),sources:c.map(h=>({title:h.title,url:h.url})),pagesRead:c.length}}async function qt(e,t,a,r){const n=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
- Time-aware: reference current date/time when relevant`;default:return""}}const gs=2e3,fs=2e3,Va=4;function kt(e){return Math.ceil(e.length/Va)}function Kt(e,t){const a=t*Va;return e.length<=a?e:e.slice(0,a)+`
...
- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I'll now..." — just call the tool.`:""}`}async function Yt(e,t,a){var c;const s=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let n;((c=s.files)==null?void 0:c.length)>0?n=s.files[0].id:n=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${n}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:n,folderName:a}}function Qa(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function er(e,t,a,r,s,n,o,i,l,c,d,m){const h=Date.now();let v=!0,f="",_="";try{return _=await ys(e,t,a,r,n,o,i,l,c,d,m),_}catch(b){throw v=!1,f=b.message||"Unknown error",b}finally{const b=Date.now()-h;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,s.agentType||null,s.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?_:"").substring(0,500),v?1:0,f||null,b,s.isEnforcementRetry?1:0,s.channel||"web").run()}catch{}}}async function ys(e,t,a,r,s,n,o,i,l,c,d){var h,v,f,_,b,T;const m=new te(a);switch(e){case"create_schedule":{const u=new Date;let g;const p=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){g=new Date(u.getTime()+t.minutes_from_now*60*1e3);const I=g.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[O,k,D]=(I[0]||"").split("/");t.schedule_value=`${D}-${O}-${k} ${I[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const x=parseInt(t.schedule_value,10);g=new Date(u.getTime()+x*60*1e3)}else if(t.schedule_type==="daily"){const[x,I]=t.schedule_value.split(":").map(Number),O=u.toLocaleString("en-US",{timeZone:p}),k=new Date(O),D=new Date(k);D.setHours(x,I,0,0),D<=k&&D.setDate(D.getDate()+1);const A=new Date(D.toLocaleString("en-US",{timeZone:"UTC"})),M=new Date(D.toLocaleString("en-US",{timeZone:p})),B=A.getTime()-M.getTime();g=new Date(D.getTime()+B)}else if(t.schedule_type==="weekly"){const[x,I]=t.schedule_value.split(" "),[O,k]=(I||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ce=>Ce.toLowerCase()===x.toLowerCase()),M=u.toLocaleString("en-US",{timeZone:p}),B=new Date(M),j=new Date(B);j.setHours(O,k,0,0);let P=(A-j.getDay()+7)%7;P===0&&j<=B&&(P=7),j.setDate(j.getDate()+P);const J=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(j.toLocaleString("en-US",{timeZone:p})),ne=J.getTime()-X.getTime();g=new Date(j.getTime()+ne)}else if(t.schedule_type==="once"){const[x,I]=t.schedule_value.split(" "),[O,k,D]=x.split("-").map(Number),[A,M]=(I||"00:00").split(":").map(Number),B=u.toLocaleString("en-US",{timeZone:p}),j=new Date(B),P=new Date(j);P.setFullYear(O,k-1,D),P.setHours(A,M,0,0);const J=new Date(P.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(P.toLocaleString("en-US",{timeZone:p})),ne=J.getTime()-X.getTime();g=new Date(P.getTime()+ne);const Ce=new Date(u.getTime()+120*1e3);if(g.getTime()<u.getTime()+60*1e3){const Ee=g.toISOString();g=Ce;const ot=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${Ee} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${g.toISOString()}.]`;t._pastTimeWarning=ot}}else g=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
- Unread errors: ${(E==null?void 0:E.cnt)||0}`}case"read_sheet":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||""),g=t.spreadsheet_id;let p=t.range;const y=await u.sheets.getMetadata(g),E=y.sheets;p.includes("!")||(p=`${E[0]}!${p}`);let x;try{x=await u.sheets.readRange(g,p)}catch(O){if((h=O.message)!=null&&h.includes("Unable to parse range")||(v=O.message)!=null&&v.includes("400")){const k=p.includes("!")?p.split("!")[1]:p;p=`${E[0]}!${k}`,x=await u.sheets.readRange(g,p)}else throw O}let I=`[Spreadsheet: "${y.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${E.map(O=>`"${O}"`).join(", ")}]
...
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(u){return await N(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||""),g=t.calendar_id||"primary",p=t.days_ahead||7,y=new Date,E=new Date(y.getTime()+p*24*60*60*1e3),x=await u.calendar.listEvents(g,{timeMin:y.toISOString(),timeMax:E.toISOString(),query:t.query});return x.length===0?`No events found in the next ${p} days.`:x.map(I=>{var M;const O=I.start.dateTime||I.start.date||"TBD",k=I.end.dateTime||I.end.date||"",D=I.location?` 📍 ${I.location}`:"",A=((M=I.attendees)==null?void 0:M.map(B=>B.email).join(", "))||"";return`• ${I.summary} — ${O} to ${k}${D}${A?`
  Attendees: ${A}`:""}`}).join(`
`)}catch(u){return await N(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||""),g=t.calendar_id||"primary",p=await u.calendar.createEvent(g,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(u){return await N(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(p.documentId,t.content);let y="";if(t.folder_name)try{const{token:E}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,s,n||"",o||"");y=`
Folder: "${(await Yt(E,p.documentId,t.folder_name)).folderName}"`}catch(E){y=`
...
ID: ${p.documentId}
URL: ${p.url}`}catch(u){return await N(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!s)return"Authentication context unavailable.";try{const g=await new re(a,r,s,n||"",o||"").docs.readDocument(t.document_id);return`Document: "${g.title}"

${g.content}`}catch(u){return await N(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!s)return"Authentication context unavailable.";try{const u=new re(a,r,s,n||"",o||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await N(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!s)return"Authentication context unavailable.";try{const g=await new ie(a,r,s,n||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return g.length===0?"No messages found.":g.map((p,y)=>`${p.isUnread?"● ":"  "}${y+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await N(a,r,"gmail","list",u.message),(f=u.message)!=null&&f.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!s)return"Authentication context unavailable.";try{const u=new ie(a,r,s,n||"",o||""),g=await u.getMessage(t.message_id);if(!g)return"Message not found.";const p=await u.getMessageBody(t.message_id);return`**${g.subject}**
From: ${g.from}
To: ${g.to}
Date: ${g.date}

${p}`}catch(u){return await N(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!s)return"Authentication context unavailable.";try{const g=await new ie(a,r,s,n||"",o||"").search(t.query,t.max_results||10);return g.length===0?`No results for: ${t.query}`:g.map((p,y)=>`${p.isUnread?"● ":"  "}${y+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await N(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!s)return"Authentication context unavailable.";try{const g=await new ie(a,r,s,n||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${g.id}]`}catch(u){return await N(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!s)return"Authentication context unavailable.";try{const g=await new ie(a,r,s,n||"",o||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),p=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${p}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${g.id}]`}catch(u){return await N(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!s)return"Authentication context unavailable.";try{return await new ie(a,r,s,n||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await N(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!s)return"Authentication context unavailable.";try{const g=await new ie(a,r,s,n||"",o||"").getUnreadCount();return`You have ${g} unread email${g!==1?"s":""} in Gmail.`}catch(u){return(_=u.message)!=null&&_.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,s,n||"",o||""),g=new URLSearchParams;g.set("pageSize",String(t.max_results||10)),g.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),g.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",g.set("q",p);const y=await fetch(`https://www.googleapis.com/drive/v3/files?${g}`,{headers:{Authorization:`Bearer ${u}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const E=await y.json();return(b=E.files)!=null&&b.length?E.files.map((x,I)=>{var A,M;const O=((A=x.mimeType)==null?void 0:A.split(".").pop())||x.mimeType,k=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",D=((M=x.modifiedTime)==null?void 0:M.split("T")[0])||"";return`${I+1}. **${x.name}** (${O})
   ${k} · Modified: ${D}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await N(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!s)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,s,n||"",o||""),g=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",g),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const y=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${u}`}});if(!y.ok)throw new Error(`Drive API error (${y.status})`);const E=await y.json();return(T=E.files)!=null&&T.length?E.files.map((x,I)=>{var D,A;const O=((D=x.mimeType)==null?void 0:D.split(".").pop())||x.mimeType,k=((A=x.modifiedTime)==null?void 0:A.split("T")[0])||"";return`${I+1}. **${x.name}** (${O}) — Modified: ${k}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await N(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await vt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}`:u.results.length===0?`No results found for "${t.query}".`:u.results.map((g,p)=>`${p+1}. **${g.title}**
   ${g.link}
   ${g.snippet}`).join(`

`)}catch(u){return await N(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const g=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>ms),y=await p(u,g);return y.error?`Failed to read page: ${y.error}`:!y.text||y.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${y.text.length} chars):

${y.text}`}catch(u){return await N(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const g=Ya(t.query,d,{depth:t.depth||"quick",site:t.site}),p=new Promise(x=>setTimeout(()=>x(null),45e3)),y=await Promise.race([g,p]);if(y===null){const{webSearch:x}=await Promise.resolve().then(()=>is),I=await x(t.query,{num:5});if(I.error||I.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let O=`Research took too long, but here are the top search results:

`;return O+=I.results.map((k,D)=>`${D+1}. **${k.title}**
   ${k.snippet}
   ${k.link}`).join(`
...
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return E}catch(u){return await N(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await U(u.encrypted_value,s),p=await Ha(g,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const y=p.route;let E=`**${y.startAddress}** → **${y.endAddress}**
`;return E+=`📏 ${y.distance} · ⏱️ ${y.duration}`,y.durationInTraffic&&(E+=` (with traffic: ${y.durationInTraffic})`),E+=`
via ${y.summary}`,E+=`

Steps:`,y.steps.forEach((x,I)=>{E+=`
${I+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),E}catch(u){return await N(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await U(u.encrypted_value,s),p=await za(g,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let y=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(y+=` (with traffic: ${p.durationInTraffic})`),y}catch(u){return await N(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await U(u.encrypted_value,s),p=await Ga(g,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await N(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await U(u.encrypted_value,s),p=await Wa(g,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((y,E)=>{var x;return`${E+1}. **${y.title}**
   ${y.channelTitle} · ${((x=y.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${y.description}
   ${y.url}`}).join(`

`)}catch(u){return await N(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!s)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const g=await U(u.encrypted_value,s),p=await Fa(g,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((y,E)=>`${E+1}. ${y.address}
   Coordinates: ${y.lat}, ${y.lng}`).join(`
`)}catch(u){return await N(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function tr(e,t,a,r,s){if(t.length>0&&t[t.length-1].role==="user"){const n="(Previous request did not complete. Please try again.)";await e.storeMessage(a,r,"assistant",n,"{}",s),t.push({id:-1,user_id:a,channel:r,role:"assistant",content:n,metadata:"{}",token_estimate:n.length,created_at:new Date().toISOString()})}}function ar(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function vs(e,t,a,r,s,n,o){var p;const i=new te(t),l=(p=e.metadata)==null?void 0:p.thread_id,c=await i.buildContext(r.id),d=await i.getRecentConversations(r.id,25,l);await tr(i,d,r.id,e.channel,l);const m=Za(r,c,e.channel),h=Xa([{role:"system",content:m},...d.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}]);ar(h),await i.storeMessage(r.id,e.channel,"user",e.text,"{}",l);const v=(o==null?void 0:o.maxTurns)??10,f=(o==null?void 0:o.tools)??Bt;let _="",b=0;const T=[];for(let y=0;y<v;y++)try{const E=await a.chat(h,{tools:f});if(E.usage&&(b+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){E.content&&h.push({role:"assistant",content:E.content});for(const x of E.toolCalls){T.push(x.name);try{const I=await er(x.name,x.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a);h.push({role:"user",content:`[Tool Result for ${x.name}]: ${I}`})}catch(I){await N(t,r.id,"tool",x.name,I.message||"Tool execution failed"),h.push({role:"user",content:`[Tool Error for ${x.name}]: ${I.message||"Execution failed"}`})}}continue}_=E.content;break}catch(E){if(s){const x=E.message||"",I=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),O=x.includes("429"),k=I?1440:O?10:5;await s.recordError(a.name,x,k)}throw await N(t,r.id,"llm","provider_error",E.message||"Unknown LLM error",{provider:a.name,turn:y}),E}if(s&&b>0)try{await s.recordUsage(a.name,b)}catch{}const u=_.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),g=T.length>0?`[TOOLS_USED: ${[...new Set(T)].join(", ")}] `:"";return await i.storeMessage(r.id,e.channel,"assistant",g+u,"{}",l),await i.compactHistory(r.id,30),_}const Jt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function ws(e){for(const[t,a]of Object.entries(Jt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Jt.default}function bs(e,t,a,r){const s=ws(r),n=Math.floor(s*.75),o=[];let i=0,l=!1;const c=kt(e);o.push({role:"system",content:e}),i+=c;const d=kt(a);i+=d;const m=n-i,h=[];let v=0;for(let f=t.length-1;f>=0;f--){const _=t[f],b=kt(_.content);if(v+b<=m)h.unshift({role:_.role,content:_.content}),v+=b;else{l=!0;break}}return o.push(...h),o.push({role:"user",content:a}),i+=v,{maxTokens:s,usedTokens:i,messages:o,wasTruncated:l}}async function*_s(e,t,a,r,s,n){var b;const o=new te(t),i=(b=e.metadata)==null?void 0:b.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i);await tr(o,c,r.id,e.channel,i);const d=Za(r,l,e.channel),m=bs(d,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const h=10;let v="",f=0;const _=[...m.messages];ar(_);for(let T=0;T<h;T++)try{T>0&&(yield{type:"thinking",data:{threadId:i}});const u=await a.chat(_,{tools:Bt});if(u.usage&&(f+=u.usage.promptTokens+u.usage.completionTokens),u.toolCalls&&u.toolCalls.length>0){u.content&&(yield{type:"chunk",data:{text:u.content,threadId:i}},_.push({role:"assistant",content:u.content}));for(const p of u.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const y=await er(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,n==null?void 0:n.GOOGLE_CLIENT_ID,n==null?void 0:n.GOOGLE_CLIENT_SECRET,n==null?void 0:n.GOOGLE_API_KEY,n==null?void 0:n.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:y.substring(0,500)+(y.length>500?"...":""),threadId:i}},_.push({role:"user",content:`[Tool Result for ${p.name}]: ${y}`})}catch(y){await N(t,r.id,"tool",p.name,y.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${y.message||"Execution failed"}`,threadId:i}},_.push({role:"user",content:`[Tool Error for ${p.name}]: ${y.message||"Execution failed"}`})}}continue}v=u.content;const g=50;for(let p=0;p<v.length;p+=g)yield{type:"chunk",data:{text:v.substring(p,p+g),threadId:i}},p+g<v.length&&await new Promise(E=>setTimeout(E,10));break}catch(u){if(s){const p=u.message||"",y=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),E=p.includes("429"),x=y?1440:E?10:5;await s.recordError(a.name,p,x)}await N(t,r.id,"llm","provider_error",u.message||"Unknown LLM error",{provider:a.name,turn:T});const g=u.message||"An error occurred";try{await o.storeMessage(r.id,e.channel,"assistant",`⚠️ ${g}`,"{}",i)}catch{}yield{type:"error",data:{error:g,threadId:i}};return}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function jt(e,t,a,r,s,n){var m;const o=new te(t),i=(m=e.metadata)==null?void 0:m.thread_id,l=await o.buildContext(r.id);if(Ja(e.text,l).agent==="conversation")return rr(e,t,a,r,l,s,i);const d=e.channel==="telegram"?{maxTurns:4,tools:Bt.filter(h=>h.name!=="research")}:void 0;return vs(e,t,a,r,s,n,d)}async function rr(e,t,a,r,s,n,o){const i=new te(t),l=Qa(r.timezone),c=hs("conversation",r,s,r.timezone,l,e.channel),d=(await i.getRecentConversations(r.id,25,o)).filter(f=>!f.content.startsWith("[Autonomous Scheduled Task]")&&!f.content.startsWith("[Scheduled Reminder]")),m=Xa([{role:"system",content:c},...d.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}]);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let h=0,v="";try{const f=await a.chat(m,{temperature:.8});f.usage&&(h=f.usage.promptTokens+f.usage.completionTokens),v=f.content}catch(f){if(n){const _=f.message||"",b=_.includes("401")||_.includes("403")||_.includes("authentication")||_.includes("credit balance"),T=_.includes("429"),u=b?1440:T?10:5;await n.recordError(a.name,_,u)}throw await N(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(n&&h>0)try{await n.recordUsage(a.name,h)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*Es(e,t,a,r,s,n){var d;const o=new te(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=Ja(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent!=="conversation"){yield*_s(e,t,a,r,s,n);return}try{const m=await rr(e,t,a,r,l,s,i),h=50;for(let v=0;v<m.length;v+=h)yield{type:"chunk",data:{text:m.substring(v,v+h),threadId:i}},v+h<m.length&&await new Promise(f=>setTimeout(f,10))}catch(m){yield{type:"error",data:{error:m.message||"An error occurred",threadId:i}};return}yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:0}}}const H=new be;async function Ts(e,t){var s;const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!r)return e.json({error:"Invalid session"},401);e.set("user",{id:r.user_id,username:r.username,name:r.name,pin_hash:r.pin_hash,role:r.role,personality_prompt:r.personality_prompt,telegram_chat_id:r.telegram_chat_id,timezone:r.timezone,assistant_name:r.assistant_name||"Karna",created_at:r.created_at,updated_at:r.updated_at}),e.set("sessionId",a),await t()}H.use("/*",Ts);H.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",r=parseInt(e.req.query("limit")||"30"),s=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const c of n)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=s;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:d}=await st(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(h){const v=new TextEncoder;try{const f=Es(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const _ of f)_.data.threadId||(_.data.threadId=i),h.enqueue(v.encode(Vt(_)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),h.close()}catch(f){const _={type:"error",data:{error:f.message||"An error occurred",threadId:i}};h.enqueue(v.encode(Vt(_))),h.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):d.includes("limit reached")?e.json({error:d,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:i},500)}});H.get("/threads/:id/messages",async e=>{var n;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),s=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(s).all(),o=[];for(const i of n.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(s,i.id).run();const l=i.user_timezone||"UTC";let c,d=!1,m=i.state||"active";if(i.schedule_type==="interval"){const f=parseInt(i.schedule_value,10);c=new Date(r.getTime()+f*60*1e3)}else if(i.schedule_type==="daily"){const[f,_]=i.schedule_value.split(":").map(Number),b=Xt(l),T=new Date(b);T.setHours(f,_,0,0),T<=b&&T.setDate(T.getDate()+1);const u=new Date(T.toLocaleString("en-US",{timeZone:"UTC"})),g=new Date(T.toLocaleString("en-US",{timeZone:l})),p=u.getTime()-g.getTime();c=new Date(T.getTime()+p)}else if(i.schedule_type==="weekly"){const[f,_]=i.schedule_value.split(" "),[b,T]=(_||"00:00").split(":").map(Number),g=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(k=>k.toLowerCase()===f.toLowerCase()),p=Xt(l),y=new Date(p);y.setHours(b,T,0,0);let E=(g-y.getDay()+7)%7;E===0&&y<=p&&(E=7),y.setDate(y.getDate()+E);const x=new Date(y.toLocaleString("en-US",{timeZone:"UTC"})),I=new Date(y.toLocaleString("en-US",{timeZone:l})),O=x.getTime()-I.getTime();c=new Date(y.getTime()+O)}else i.schedule_type==="once"?(d=!0,m="completed",c=new Date(r.getTime()+365*24*60*60*1e3)):c=new Date(r.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,c.toISOString(),d?0:i.enabled,m,i.id).run();const v=(JSON.parse(i.action_config||"{}").description||i.description)&&(i.action_type==="check_mail"||i.action_type==="check_calendar"||i.action_type==="check_sheet"||i.action_type==="custom");o.push({job_id:i.id,name:i.name,status:"dispatched",needs_agent:v,next_run:c.toISOString()})}catch(l){o.push({job_id:i.id,name:i.name,status:"error",error:l.message})}return e.json({executed:o.length,results:o,timestamp:s})});pe.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);const r=parseInt(e.req.param("jobId"),10);if(!r)return e.json({error:"Invalid job ID"},400);const s=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(r).first();if(!s)return e.json({error:"Job not found"},404);const o=JSON.parse(s.action_config||"{}").description||s.description||"",i="⏰ "+(s.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=s.action_type==="reminder",m=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&s.action_type==="custom"&&m.test(o),d)c=o||s.name||"Time for your scheduled task.";else try{const _={id:s.user_id,username:s.username||"user",name:s.user_name||"User",pin_hash:s.pin_hash||"",role:s.user_role||"",personality_prompt:s.personality_prompt||"",telegram_chat_id:s.telegram_chat_id||"",timezone:s.user_timezone||"UTC",assistant_name:s.assistant_name||"Karna",created_at:"",updated_at:""},b={userId:s.user_id,username:_.username,channel:"cron",text:Ss(s.name,o,s.action_type),sessionId:"cron-"+s.id,timestamp:l},{provider:T,rotation:u}=await st(e.env.DB,s.user_id,s.pin_hash);c=await jt(b,e.env.DB,T,_,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(_){const b=_.message||"unknown error",T=b.includes("rate_limit")||b.includes("429")||b.includes("quota"),u=b.includes("timeout")||b.includes("Timeout");T?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":u?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await N(e.env.DB,s.user_id,"cron_agent","execution_error",b,{job_id:s.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(s.action_type))try{const _=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(s.user_id).first();(!_||_.cnt===0)&&await N(e.env.DB,s.user_id,"cron_verification","no_tools_called",`Cron job "${s.name}" (${s.action_type}) completed without any tool calls`,{job_id:s.id,action_type:s.action_type,response_preview:c.substring(0,200)})}catch{}let v=c||o||"Time for your scheduled task.";v=v.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const f=i+`
`+v;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(s.user_id,"reminder",i,v,"cron:"+s.id).run(),d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(s.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:s.id})).run(),s.telegram_chat_id&&await ks(e.env.DB,s.user_id,s.telegram_chat_id,f),e.json({job_id:r,status:"completed",response_length:c.length})});async function sr(e){var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!t)return null;const a=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(a==null?void 0:a.user_id)||null}pe.get("/health/tools",async e=>{var a;const t=await sr(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function Ss(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${Ye}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${Ye}`}function Is(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function Ds(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const nt=new be,Os=4e3;async function $(e,t,a,r="Markdown"){var n,o;const s=Cs(a,Os);for(const i of s)try{const l=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i,parse_mode:r,disable_web_page_preview:!1})});if(!l.ok){const c=await l.json().catch(()=>null);((n=c==null?void 0:c.description)!=null&&n.includes("parse")||(o=c==null?void 0:c.description)!=null&&o.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i})})}}catch{}}async function Rs(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Cs(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let s=r.lastIndexOf(`
`,t);s<t*.3&&(s=r.lastIndexOf(" ",t)),s<t*.3&&(s=t),a.push(r.substring(0,s)),r=r.substring(s).trimStart()}return a}async function Ns(e,t,a,r,s){switch(e.split("@")[0].toLowerCase()){case"/start":{const o=(r==null?void 0:r.name)||"there",i=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${o}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await $(a,t,l),!0}case"/help":{const i=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await $(a,t,i),!0}case"/status":{if(!r)return await $(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[o,i,l,c]=await Promise.all([s.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),s.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),s.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),s.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),d=`📊 *System Status*
...
Status: ✅ Online`;await $(a,t,d)}catch{await $(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await s.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await $(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await $(a,t,"⚠️ Account not linked."),!0);case"/tasks":case"/task":{if(!r)return await $(a,t,"⚠️ Account not linked."),!0;try{const i=(await s.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(r.id).all()).results||[];if(i.length===0)return await $(a,t,"✅ No open tasks. You're all clear."),!0;const l=new Date,c=l.toISOString().slice(0,10),d=new Date(l);d.setDate(d.getDate()+1);const m=d.toISOString().slice(0,10),h=[`📋 *Open Tasks (${i.length})*
`];for(const v of i){let f="";if(v.due_date){const _=v.due_date.slice(0,10);_<c?f=" ⚠️ _overdue_":_===c?f=" 🔴 _due today_":_===m?f=" 🟡 _due tomorrow_":f=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}h.push(`☐ ${v.title}${f}`)}h.push(`
_Say "mark [task] as done" to close a task._`),await $(a,t,h.join(`
`))}catch(o){await $(a,t,"❌ Could not fetch tasks: "+o.message)}return!0}default:return!1}}nt.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},s=async()=>{var n,o,i,l,c;try{if(t.callback_query){await As(a,t.callback_query);return}const d=t.message;if(!d)return;const m=!!d.text,h=!!d.voice,v=!!d.document,f=!!d.photo,_=!!d.caption;if(!m&&!h&&!v&&!f)return;const b=String(d.chat.id);let T=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(b).first();let g=null;if(u){const k=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();k&&(g=await U(k.encrypted_value,u.pin_hash))}if(!g){const k=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();k&&(g=await U(k.encrypted_value,k.pin_hash))}if(!g||T.startsWith("/")&&await Ns(T,b,g,u,a))return;if(!u){await $(g,b,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${b}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&g&&u)try{await $(g,b,"🎤 Processing voice note...");const D=await(await fetch(`https://api.telegram.org/bot${g}/getFile?file_id=${d.voice.file_id}`)).json();if(D.ok&&((n=D.result)!=null&&n.file_path)){const M=await(await fetch(`https://api.telegram.org/file/bot${g}/${D.result.file_path}`)).blob();let B="",j="",P="whisper-1";const J=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const Ee of J.results){const ot=await U(Ee.encrypted_value,u.pin_hash);if(Ee.service==="openai"){B="https://api.openai.com/v1/audio/transcriptions",j=ot;break}else if(Ee.service.startsWith("llm_slot_"))try{const it=JSON.parse(ot);if(it.provider==="openai"){B="https://api.openai.com/v1/audio/transcriptions",j=it.apiKey;break}else if(it.provider==="groq"){B="https://api.groq.com/openai/v1/audio/transcriptions",j=it.apiKey,P="whisper-large-v3";break}}catch{}}if(!B){await $(g,b,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const X=new FormData;X.append("file",M,"voice.ogg"),X.append("model",P),X.append("language","en");const ne=await fetch(B,{method:"POST",headers:{Authorization:`Bearer ${j}`},body:X});if(!ne.ok){const Ee=await ne.text();await $(g,b,`⚠️ Transcription failed: ${ne.status} ${Ee}`);return}T=(await ne.json()).text,await $(g,b,`🗣️ *You said:* ${T}`)}}catch(k){await $(g,b,`⚠️ Failed to process voice note: ${k.message}`);return}if((v||f)&&g&&u)try{let k,D="unknown",A="unknown",M=0;if(v)k=d.document.file_id,D=d.document.file_name||"document",A=d.document.mime_type||"unknown",M=d.document.file_size||0;else if(f){const B=d.photo[d.photo.length-1];k=B.file_id,D="photo.jpg",A="image/jpeg",M=B.file_size||0}if(k){const j=await(await fetch(`https://api.telegram.org/bot${g}/getFile?file_id=${k}`)).json();let P="";if(j.ok&&((o=j.result)!=null&&o.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(D)||/^text\/|application\/json|application\/xml|application\/csv/i.test(A))&&M<5e4)try{P=await(await fetch(`https://api.telegram.org/file/bot${g}/${j.result.file_path}`)).text()}catch{}const J=d.caption||"",X=`[Telegram file received: "${D}" (${A}, ${Math.round(M/1024)}KB)]`;P?T=`${J?J+`
...
`:""}${X}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(k){if(_&&d.caption)T=d.caption;else{await $(g,b,`⚠️ Received your file but couldn't process it: ${k.message}`);return}}if(!T)return;Rs(g,b).catch(()=>{});let p=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();p?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(p.id).run():p={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const y=Is(u.id,u.username,T,b);y.metadata={thread_id:p.id};let E,x;try{const k=await st(a,u.id,u.pin_hash);E=k.provider,x=k.rotation}catch(k){console.error("Telegram provider setup error:",k);const D=(i=k.message)!=null&&i.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=k.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${k.message||"Unknown error"}`;await $(g,b,D);return}/\b(write\s+(an?\s+)?(essay|article|report|document|doc|blog|post|summary|draft)|draft\s+(an?\s+)?(essay|article|report|document)|research\s+.{0,60}(save|store|drive|doc))\b/i.test(T)&&await $(g,b,"📝 Working on it— searching and saving to Drive takes about 20 seconds...");const O=25e3;try{const k=await Promise.race([jt(y,a,E,u,x,r),new Promise((A,M)=>setTimeout(()=>M(new Error("TELEGRAM_TIMEOUT")),O))]),D=Ds(k,"telegram");await $(g,b,D||"(empty response)")}catch(k){console.error("Telegram agent error:",k);const D=k.message==="TELEGRAM_TIMEOUT",A=D?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=k.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${E.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(k.message||"Unknown").substring(0,200)}`;await $(g,b,A);try{const{logError:M}=await Promise.resolve().then(()=>Ot);await M(a,u.id,"telegram",D?"timeout":"agent_error",k.message||"Agent error",{provider:E.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:m}=await Promise.resolve().then(()=>Ot);await m(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(s()),e.json({ok:!0})});nt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:r}=await e.req.json(),s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Telegram bot token not configured in Settings"},400);const n=await U(s.encrypted_value,a.pin_hash);if(!r){const d=await(await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const i=await(await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:r,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});nt.get("/webhook-status",async e=>{var n,o,i,l,c,d;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({configured:!1,error:"Bot token not set"});const s=await U(r.encrypted_value,a.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=h.result)==null?void 0:o.url)||"",has_webhook:!!((i=h.result)!=null&&i.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((c=h.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=h.result)==null?void 0:d.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});nt.post("/detect-chat-id",async e=>{var n,o;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Bot token not configured"},400);const s=await U(r.encrypted_value,a.pin_hash);try{const c=((o=(await(await fetch(`https://api.telegram.org/bot${s}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(b=>setTimeout(b,500));const m=await(await fetch(`https://api.telegram.org/bot${s}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:["message"]})});const h=m.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],f=new Set;for(let b=h.length-1;b>=0;b--){const T=h[b].message;if(T&&T.chat){const u=String(T.chat.id);f.has(u)||(f.add(u),v.push({chat_id:u,name:[T.chat.first_name,T.chat.last_name].filter(Boolean).join(" ")||T.chat.title||"Unknown",username:T.chat.username||"",date:new Date((T.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,a.user_id).run(),e.json({found:!0,chat_id:_,name:v[0].name,all_chats:v,message:`Chat ID ${_} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function As(e,t){var _;const{id:a,data:r,message:s,from:n}=t;if(!r||!s)return;const o=r.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],l=parseInt(o[2]);if(!l||!i)return;const c=String(s.chat.id),d=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(c).first();if(!d)return;const m=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(d.id,l,i).first();if(!m)return;const h=m.checked?0:1;await e.prepare(`
  ...
  `).bind(h,h,m.id).run();const v=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(d.id).first();if(!v)return;const f=await U(v.encrypted_value,v.pin_hash);if(await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:h?"✅ Checked!":"☐ Unchecked"})}),(_=s.reply_markup)!=null&&_.inline_keyboard){const b=s.reply_markup.inline_keyboard.map(T=>T.map(u=>{var g;if((g=u.callback_data)!=null&&g.includes(i)){const p=h?"✅":"☐",y=u.text.replace(/^[☐✅]\s*/,"");return{...u,text:`${p} ${y}`}}return u}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c,message_id:s.message_id,reply_markup:{inline_keyboard:b}})})}catch{}}}function Ls(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),r=new Date(a);r.setDate(r.getDate()+1),r.setHours(0,0,0,0);const s=new Date(r);s.setHours(23,59,59,999);const n=r.toISOString().split("T")[0];return{start:r.toISOString(),end:s.toISOString(),dateStr:n}}async function Ms(e,t,a,r,s,n){try{return(await new $t(e,t,a,r,s).listEvents("primary",{timeMin:n.start,timeMax:n.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function $s(e,t,a,r,s){try{const n=new ie(e,t,a,r,s),o=await n.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await n.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const h=m.from.split("<")[0].trim()||m.from;l[h]=(l[h]||0)+1}const c=Object.entries(l).sort(([,m],[,h])=>h-m).slice(0,5).map(([m])=>m),d=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:c,hasUrgent:d}}catch(n){return console.error("Gmail fetch error:",n.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Bs(e,t){try{const a=await e.prepare(`
...
`)}function Hs(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Gs(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{const n=JSON.parse(a.components);r={google_calendar:n.google_calendar!==!1,gmail:n.gmail!==!1,tasks:n.tasks!==!1,news:n.news!==!1}}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const s=a.news_topics?a.news_topics.split(",").map(n=>n.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:s}}async function nr(e,t,a){var u,g;const r=t.timezone||"Asia/Kolkata",s=Ls(r),{components:n,newsTopics:o}=await Gs(e,t.id),i=[],l=[];n.google_calendar&&(i.push(Ms(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,s)),l.push("googleEvents")),n.gmail&&(i.push($s(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),n.tasks&&(i.push(Bs(e,t.id)),l.push("tasks")),n.news&&(i.push(Ps(o,e,t.id)),l.push("news"));const c=await Promise.all(i),d={};l.forEach((p,y)=>{d[p]=c[y]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:s.dateStr,calendar:{google:d.googleEvents||[],totalCount:((u=d.googleEvents)==null?void 0:u.length)||0},emails:{gmail:d.gmailSummary||m},tasks:d.tasks||h,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((g=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:g.briefing_time)||"20:00";v.summary=Us(v,f);const _=Hs(v),b=await e.prepare(`
  ...
  `).bind(a).all();return{briefing:{...r,content:JSON.parse(r.content_json||"{}")},items:s.results||[]}}async function Ws(e,t,a,r){if(!await e.prepare(`
  ...
  `).bind(o,o,r,a).run(),{checked:o===1}}async function zs(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,a).all()).results||[]).map(s=>({...s,content:JSON.parse(s.content_json||"{}")}))}function qs(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),s=r.getHours(),n=r.getMinutes(),[o,i]=e.split(":").map(Number),l=s*60+n,c=o*60+i;return l===c}function or(e,t){const a=e.summary,r=[];for(const s of t.slice(0,10))r.push([{text:`☐ ${s.text.substring(0,40)}${s.text.length>40?"...":""}`,callback_data:`briefing_toggle:${s.key}`}]);return{text:a,inlineKeyboard:r}}const Y=new be;async function Ks(e,t){var s;if(e.req.path.includes("/cron/"))return t();const a=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),s=[],n=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(qs(l,i,n))try{const c=await nr(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:d,inlineKeyboard:m}=or(c.content,c.items);await ir(e.env.DB,o,d,m,c.briefingId)}s.push({user_id:o.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:i})}catch(c){s.push({user_id:o.id,status:"error",error:c.message})}}return e.json({executed:s.length,results:s})}catch(r){return e.json({error:r.message},500)}});Y.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),s=[],n=new Date,o=new Date(n.getTime()+600*1e3).toISOString(),i=new Date(n.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await U(c.encrypted_value,l.pin_hash),h=JSON.parse(d).access_token;if(!h)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(n.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${h}`}});if(!v.ok)continue;const _=((await v.json()).items||[]).filter(u=>{var p;const g=(p=u.start)==null?void 0:p.dateTime;return g?g>=n.toISOString()&&g<=o:!1});if(_.length===0){s.push({user_id:l.id,reminders_sent:0});continue}const b=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!b)continue;const T=await U(b.encrypted_value,l.pin_hash);for(const u of _){const g=new Date(u.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=u.location?`
