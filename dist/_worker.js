var Za=Object.defineProperty;var Bt=e=>{throw TypeError(e)};var Qa=(e,t,a)=>t in e?Za(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var S=(e,t,a)=>Qa(e,typeof t!="symbol"?t+"":t,a),vt=(e,t,a)=>t.has(e)||Bt("Cannot "+a);var w=(e,t,a)=>(vt(e,t,"read from private field"),a?a.call(e):t.get(e)),R=(e,t,a)=>t.has(e)?Bt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(vt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(vt(e,t,"access private method"),a);var jt=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return w(e,t,r)}});var Pt=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,c=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,l=await t(m,r),c=!0;else throw m}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},er=Symbol(),tr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ia?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?ar(e,{all:a,dot:r}):{}};async function ar(e,t){const a=await e.formData();return a?rr(a,t):{}}function rr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?nr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(sr(a,r,n),delete a[r])}),a}var nr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},sr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},aa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},or=e=>{const{groups:t,path:a}=ir(e),r=aa(a);return lr(r,t)},ir=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},lr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},rt={},cr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return rt[r]||(a[2]?rt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:rt[r]=[e,a[1],!0]),rt[r]}return null},Rt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},dr=e=>Rt(e,decodeURI),ra=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return dr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},ur=e=>{const t=ra(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Re=(e,t,...a)=>(a.length&&(t=Re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),na=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},bt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Rt(e,oa):e):e,sa=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return bt(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=bt(l)),s=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=bt(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},pr=sa,mr=(e,t)=>sa(e,t,!0),oa=decodeURIComponent,Ut=e=>Rt(e,oa),Ne,K,ce,la,ca,Tt,ue,Vt,ia=(Vt=class{constructor(e,t="/",a=[[]]){R(this,ce);S(this,"raw");R(this,Ne);R(this,K);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});R(this,ue,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,K,a),D(this,Ne,{})}param(e){return e?L(this,ce,la).call(this,e):L(this,ce,ca).call(this)}query(e){return pr(this.url,e)}queries(e){return mr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await tr(this,e))}json(){return w(this,ue).call(this,"text").then(e=>JSON.parse(e))}text(){return w(this,ue).call(this,"text")}arrayBuffer(){return w(this,ue).call(this,"arrayBuffer")}blob(){return w(this,ue).call(this,"blob")}formData(){return w(this,ue).call(this,"formData")}addValidatedData(e,t){w(this,Ne)[e]=t}valid(e){return w(this,Ne)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[er](){return w(this,K)}get matchedRoutes(){return w(this,K)[0].map(([[,e]])=>e)}get routePath(){return w(this,K)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ne=new WeakMap,K=new WeakMap,ce=new WeakSet,la=function(e){const t=w(this,K)[0][this.routeIndex][1][e],a=L(this,ce,Tt).call(this,t);return a&&/\%/.test(a)?Ut(a):a},ca=function(){const e={},t=Object.keys(w(this,K)[0][this.routeIndex][1]);for(const a of t){const r=L(this,ce,Tt).call(this,w(this,K)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ut(r):r)}return e},Tt=function(e){return w(this,K)[1]?w(this,K)[1][e]:e},ue=new WeakMap,Vt),hr={Stringify:1},da=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>da(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},gr="text/plain; charset=UTF-8",wt=(e,t)=>({"Content-Type":e,...t}),Ye,Ve,se,$e,oe,W,Xe,Me,Be,_e,Ze,Qe,pe,Ae,Xt,fr=(Xt=class{constructor(e,t){R(this,pe);R(this,Ye);R(this,Ve);S(this,"env",{});R(this,se);S(this,"finalized",!1);S(this,"error");R(this,$e);R(this,oe);R(this,W);R(this,Xe);R(this,Me);R(this,Be);R(this,_e);R(this,Ze);R(this,Qe);S(this,"render",(...e)=>(w(this,Me)??D(this,Me,t=>this.html(t)),w(this,Me).call(this,...e)));S(this,"setLayout",e=>D(this,Xe,e));S(this,"getLayout",()=>w(this,Xe));S(this,"setRenderer",e=>{D(this,Me,e)});S(this,"header",(e,t,a)=>{this.finalized&&D(this,W,new Response(w(this,W).body,w(this,W)));const r=w(this,W)?w(this,W).headers:w(this,_e)??D(this,_e,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});S(this,"status",e=>{D(this,$e,e)});S(this,"set",(e,t)=>{w(this,se)??D(this,se,new Map),w(this,se).set(e,t)});S(this,"get",e=>w(this,se)?w(this,se).get(e):void 0);S(this,"newResponse",(...e)=>L(this,pe,Ae).call(this,...e));S(this,"body",(e,t,a)=>L(this,pe,Ae).call(this,e,t,a));S(this,"text",(e,t,a)=>!w(this,_e)&&!w(this,$e)&&!t&&!a&&!this.finalized?new Response(e):L(this,pe,Ae).call(this,e,t,wt(gr,a)));S(this,"json",(e,t,a)=>L(this,pe,Ae).call(this,JSON.stringify(e),t,wt("application/json",a)));S(this,"html",(e,t,a)=>{const r=n=>L(this,pe,Ae).call(this,n,t,wt("text/html; charset=UTF-8",a));return typeof e=="object"?da(e,hr.Stringify,!1,{}).then(r):r(e)});S(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});S(this,"notFound",()=>(w(this,Be)??D(this,Be,()=>new Response),w(this,Be).call(this,this)));D(this,Ye,e),t&&(D(this,oe,t.executionCtx),this.env=t.env,D(this,Be,t.notFoundHandler),D(this,Qe,t.path),D(this,Ze,t.matchResult))}get req(){return w(this,Ve)??D(this,Ve,new ia(w(this,Ye),w(this,Qe),w(this,Ze))),w(this,Ve)}get event(){if(w(this,oe)&&"respondWith"in w(this,oe))return w(this,oe);throw Error("This context has no FetchEvent")}get executionCtx(){if(w(this,oe))return w(this,oe);throw Error("This context has no ExecutionContext")}get res(){return w(this,W)||D(this,W,new Response(null,{headers:w(this,_e)??D(this,_e,new Headers)}))}set res(e){if(w(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of w(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=w(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,W,e),this.finalized=!0}get var(){return w(this,se)?Object.fromEntries(w(this,se)):{}}},Ye=new WeakMap,Ve=new WeakMap,se=new WeakMap,$e=new WeakMap,oe=new WeakMap,W=new WeakMap,Xe=new WeakMap,Me=new WeakMap,Be=new WeakMap,_e=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,pe=new WeakSet,Ae=function(e,t,a){const r=w(this,W)?new Headers(w(this,W).headers):w(this,_e)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??w(this,$e);return new Response(e,{status:n,headers:r})},Xt),P="ALL",yr="all",vr=["get","post","put","delete","options","patch"],ua="Can not add a route since the matcher is already built.",pa=class extends Error{},br="__COMPOSED_HANDLER",wr=e=>e.text("404 Not Found",404),Gt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},V,U,ma,X,be,ot,it,je,_r=(je=class{constructor(t={}){R(this,U);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");R(this,V,"/");S(this,"routes",[]);R(this,X,wr);S(this,"errorHandler",Gt);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(D(this,X,t),this));S(this,"fetch",(t,...a)=>L(this,U,it).call(this,t,a[1],a[0],t.method));S(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Re("/",t)}`,a),r,n)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,U,it).call(this,t.request,t,void 0,t.request.method))})});[...vr,yr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?D(this,V,o):L(this,U,be).call(this,s,w(this,V),o),i.forEach(l=>{L(this,U,be).call(this,s,w(this,V),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){D(this,V,l);for(const c of[s].flat())i.map(u=>{L(this,U,be).call(this,c.toUpperCase(),w(this,V),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?D(this,V,s):(D(this,V,"*"),o.unshift(s)),o.forEach(i=>{L(this,U,be).call(this,P,w(this,V),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ra:ur}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Gt?s=n.handler:(s=async(i,l)=>(await Pt([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[br]=n.handler),L(o=r,U,be).call(o,n.method,n.path,s)}),this}basePath(t){const a=L(this,U,ma).call(this);return a._basePath=Re(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Re(this._basePath,t),c=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,u)}})());const i=async(l,c)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await c()};return L(this,U,be).call(this,P,Re(t,"*"),i),this}},V=new WeakMap,U=new WeakSet,ma=function(){const t=new je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,X,w(this,X)),t.routes=this.routes,t},X=new WeakMap,be=function(t,a,r){t=t.toUpperCase(),a=Re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},ot=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},it=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await L(this,U,it).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new fr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:w(this,X)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await w(this,X).call(this,i)})}catch(u){return L(this,U,ot).call(this,u,i)}return c instanceof Promise?c.then(u=>u||(i.finalized?i.res:w(this,X).call(this,i))).catch(u=>L(this,U,ot).call(this,u,i)):c??w(this,X).call(this,i)}const l=Pt(o[0],this.errorHandler,w(this,X));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return L(this,U,ot).call(this,c,i)}})()},je),ha=[];function xr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[P],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],ha];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var ct="[^/]+",We=".*",qe="(?:|/.*)",Le=Symbol(),Er=new Set(".\\+*[^]$()");function Tr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===ct?1:t===ct?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var xe,Ee,Z,Se,kr=(Se=class{constructor(){R(this,xe);R(this,Ee);R(this,Z,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(w(this,xe)!==void 0)throw Le;if(s)return;D(this,xe,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",We]:["","",ct]:o==="/*"?["","",qe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let m=l[2]||ct;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Le;if(c=w(this,Z)[m],!c){if(Object.keys(w(this,Z)).some(g=>g!==We&&g!==qe))throw Le;if(s)return;c=w(this,Z)[m]=new Se,u!==""&&D(c,Ee,n.varIndex++)}!s&&u!==""&&r.push([u,w(c,Ee)])}else if(c=w(this,Z)[o],!c){if(Object.keys(w(this,Z)).some(u=>u.length>1&&u!==We&&u!==qe))throw Le;if(s)return;c=w(this,Z)[o]=new Se}c.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(w(this,Z)).sort(Tr).map(r=>{const n=w(this,Z)[r];return(typeof w(n,Ee)=="number"?`(${r})@${w(n,Ee)}`:Er.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof w(this,xe)=="number"&&a.unshift(`#${w(this,xe)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},xe=new WeakMap,Ee=new WeakMap,Z=new WeakMap,Se),ut,et,Zt,Sr=(Zt=class{constructor(){R(this,ut,{varIndex:0});R(this,et,new kr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return n[o]=[c,l],o++,i=!0,c}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return w(this,et).insert(s,t,r,w(this,ut),a),r}buildRegExp(){let e=w(this,et).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},ut=new WeakMap,et=new WeakMap,Zt),Ir=[/^$/,[],Object.create(null)],lt=Object.create(null);function ga(e){return lt[e]??(lt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Dr(){lt=Object.create(null)}function Or(e){var c;const t=new Sr,a=[];if(e.length===0)return Ir;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[g,v])=>u?1:g?-1:m.length-v.length),n=Object.create(null);for(let u=0,m=-1,g=r.length;u<g;u++){const[v,f,x]=r[u];v?n[f]=[x.map(([T])=>[T,Object.create(null)]),ha]:m++;let _;try{_=t.insert(f,m,v)}catch(T){throw T===Le?new pa(f):T}v||(a[m]=x.map(([T,d])=>{const y=Object.create(null);for(d-=1;d>=0;d--){const[h,p]=_[d];y[h]=p}return[T,y]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=a.length;u<m;u++)for(let g=0,v=a[u].length;g<v;g++){const f=(c=a[u][g])==null?void 0:c[1];if(!f)continue;const x=Object.keys(f);for(let _=0,T=x.length;_<T;_++)f[x[_]]=i[f[x[_]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function Oe(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ga(a).test(t))return[...e[a]]}}var me,he,pt,fa,Qt,Cr=(Qt=class{constructor(){R(this,pt);S(this,"name","RegExpRouter");R(this,me);R(this,he);S(this,"match",xr);D(this,me,{[P]:Object.create(null)}),D(this,he,{[P]:Object.create(null)})}add(e,t,a){var i;const r=w(this,me),n=w(this,he);if(!r||!n)throw new Error(ua);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(c=>{l[e][c]=[...l[P][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ga(t);e===P?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=Oe(r[c],t)||Oe(r[P],t)||[])}):(i=r[e])[t]||(i[t]=Oe(r[e],t)||Oe(r[P],t)||[]),Object.keys(r).forEach(c=>{(e===P||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,s])})}),Object.keys(n).forEach(c=>{(e===P||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,s]))});return}const o=na(t)||[t];for(let l=0,c=o.length;l<c;l++){const u=o[l];Object.keys(n).forEach(m=>{var g;(e===P||e===m)&&((g=n[m])[u]||(g[u]=[...Oe(r[m],u)||Oe(r[P],u)||[]]),n[m][u].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(w(this,he)).concat(Object.keys(w(this,me))).forEach(t=>{e[t]||(e[t]=L(this,pt,fa).call(this,t))}),D(this,me,D(this,he,void 0)),Dr(),e}},me=new WeakMap,he=new WeakMap,pt=new WeakSet,fa=function(e){const t=[];let a=e===P;return[w(this,me),w(this,he)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?Or(t):null},Qt),ge,ie,ea,Rr=(ea=class{constructor(e){S(this,"name","SmartRouter");R(this,ge,[]);R(this,ie,[]);D(this,ge,e.routers)}add(e,t,a){if(!w(this,ie))throw new Error(ua);w(this,ie).push([e,t,a])}match(e,t){if(!w(this,ie))throw new Error("Fatal error");const a=w(this,ge),r=w(this,ie),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof pa)continue;throw l}this.match=i.match.bind(i),D(this,ge,[i]),D(this,ie,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(w(this,ie)||w(this,ge).length!==1)throw new Error("No active router has been determined yet.");return w(this,ge)[0]}},ge=new WeakMap,ie=new WeakMap,ea),He=Object.create(null),fe,F,Te,Pe,H,le,we,Ue,Ar=(Ue=class{constructor(t,a,r){R(this,le);R(this,fe);R(this,F);R(this,Te);R(this,Pe,0);R(this,H,He);if(D(this,F,r||Object.create(null)),D(this,fe,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,fe,[n])}D(this,Te,[])}insert(t,a,r){D(this,Pe,++jt(this,Pe)._);let n=this;const s=or(a),o=[];for(let i=0,l=s.length;i<l;i++){const c=s[i],u=s[i+1],m=cr(c,u),g=Array.isArray(m)?m[0]:c;if(g in w(n,F)){n=w(n,F)[g],m&&o.push(m[1]);continue}w(n,F)[g]=new Ue,m&&(w(n,Te).push(m),o.push(m[1])),n=w(n,F)[g]}return w(n,fe).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:w(this,Pe)}}),n}search(t,a){var l;const r=[];D(this,H,He);let s=[this];const o=aa(a),i=[];for(let c=0,u=o.length;c<u;c++){const m=o[c],g=c===u-1,v=[];for(let f=0,x=s.length;f<x;f++){const _=s[f],T=w(_,F)[m];T&&(D(T,H,w(_,H)),g?(w(T,F)["*"]&&r.push(...L(this,le,we).call(this,w(T,F)["*"],t,w(_,H))),r.push(...L(this,le,we).call(this,T,t,w(_,H)))):v.push(T));for(let d=0,y=w(_,Te).length;d<y;d++){const h=w(_,Te)[d],p=w(_,H)===He?{}:{...w(_,H)};if(h==="*"){const A=w(_,F)["*"];A&&(r.push(...L(this,le,we).call(this,A,t,w(_,H))),D(A,H,p),v.push(A));continue}const[b,E,k]=h;if(!m&&!(k instanceof RegExp))continue;const I=w(_,F)[b],C=o.slice(c).join("/");if(k instanceof RegExp){const A=k.exec(C);if(A){if(p[E]=A[0],r.push(...L(this,le,we).call(this,I,t,w(_,H),p)),Object.keys(w(I,F)).length){D(I,H,p);const N=((l=A[0].match(/\//))==null?void 0:l.length)??0;(i[N]||(i[N]=[])).push(I)}continue}}(k===!0||k.test(m))&&(p[E]=m,g?(r.push(...L(this,le,we).call(this,I,t,p,w(_,H))),w(I,F)["*"]&&r.push(...L(this,le,we).call(this,w(I,F)["*"],t,p,w(_,H)))):(D(I,H,p),v.push(I)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},fe=new WeakMap,F=new WeakMap,Te=new WeakMap,Pe=new WeakMap,H=new WeakMap,le=new WeakSet,we=function(t,a,r,n){const s=[];for(let o=0,i=w(t,fe).length;o<i;o++){const l=w(t,fe)[o],c=l[a]||l[P],u={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==He||n&&n!==He))for(let m=0,g=c.possibleKeys.length;m<g;m++){const v=c.possibleKeys[m],f=u[c.score];c.params[v]=n!=null&&n[v]&&!f?n[v]:r[v]??(n==null?void 0:n[v]),u[c.score]=!0}}return s},Ue),ke,ta,Lr=(ta=class{constructor(){S(this,"name","TrieRouter");R(this,ke);D(this,ke,new Ar)}add(e,t,a){const r=na(t);if(r){for(let n=0,s=r.length;n<s;n++)w(this,ke).insert(e,r[n],a);return}w(this,ke).insert(e,t,a)}match(e,t){return w(this,ke).search(e,t)}},ke=new WeakMap,ta),ye=class extends _r{constructor(e={}){super(e),this.router=e.router??new Rr({routers:[new Cr,new Lr]})}},Nr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(m,g){o.res.headers.set(m,g)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function ya(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`),t.trim()}async function Ha(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await ht(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async g=>{const v=await Ga(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),c=(await Promise.all(i)).filter(g=>g.content.length>50);if(c.length===0){const g=s.results.map((f,x)=>`[${x+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await zt(e,g,t,"snippets"),sources:s.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const u=c.map((g,v)=>`--- SOURCE ${v+1}: ${g.title} (${g.displayLink}) ---
${g.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await zt(e,u,t,"full"),sources:c.map(g=>({title:g.title,url:g.url})),pagesRead:c.length}}async function zt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Wt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function ft(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function Je(e,t,a,r,n,s,o,i,l,c,u){var g,v,f,x,_,T;const m=new J(a);switch(e){case"create_schedule":{const d=new Date;let y;const h=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(d.getTime()+t.minutes_from_now*60*1e3);const E=y.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[k,I,C]=(E[0]||"").split("/");t.schedule_value=`${C}-${k}-${I} ${E[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const b=parseInt(t.schedule_value,10);y=new Date(d.getTime()+b*60*1e3)}else if(t.schedule_type==="daily"){const[b,E]=t.schedule_value.split(":").map(Number),k=d.toLocaleString("en-US",{timeZone:h}),I=new Date(k),C=new Date(I);C.setHours(b,E,0,0),C<=I&&C.setDate(C.getDate()+1);const A=new Date(C.toLocaleString("en-US",{timeZone:"UTC"})),N=new Date(C.toLocaleString("en-US",{timeZone:h})),$=A.getTime()-N.getTime();y=new Date(C.getTime()+$)}else if(t.schedule_type==="weekly"){const[b,E]=t.schedule_value.split(" "),[k,I]=(E||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(yt=>yt.toLowerCase()===b.toLowerCase()),N=d.toLocaleString("en-US",{timeZone:h}),$=new Date(N),G=new Date($);G.setHours(k,I,0,0);let q=(A-G.getDay()+7)%7;q===0&&G<=$&&(q=7),G.setDate(G.getDate()+q);const ae=new Date(G.toLocaleString("en-US",{timeZone:"UTC"})),De=new Date(G.toLocaleString("en-US",{timeZone:h})),de=ae.getTime()-De.getTime();y=new Date(G.getTime()+de)}else if(t.schedule_type==="once"){const[b,E]=t.schedule_value.split(" "),[k,I,C]=b.split("-").map(Number),[A,N]=(E||"00:00").split(":").map(Number),$=d.toLocaleString("en-US",{timeZone:h}),G=new Date($),q=new Date(G);q.setFullYear(k,I-1,C),q.setHours(A,N,0,0);const ae=new Date(q.toLocaleString("en-US",{timeZone:"UTC"})),De=new Date(q.toLocaleString("en-US",{timeZone:h})),de=ae.getTime()-De.getTime();y=new Date(q.getTime()+de);const yt=new Date(d.getTime()+120*1e3);if(y.getTime()<d.getTime()+60*1e3){const Va=y.toISOString();y=yt;const Xa=` [Note: The requested time ${t.schedule_value} in ${h} resolved to ${Va} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=Xa}}else y=new Date(d.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),y.toISOString()).run();const p=t._pastTimeWarning||"";return`Schedule created: "${t.name}" — ${t.schedule_type} at ${t.schedule_value}. State: active. Next run: ${y.toISOString()}${p}`}case"list_schedules":{const y=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return y.length===0?"No scheduled tasks found.":y.map(h=>`[ID:${h.id}] ${h.enabled?"▶":"⏸"} "${h.name}" — [${h.schedule_type}] ${h.schedule_value} — ${h.action_type} — state: ${h.state||"active"} — next: ${h.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const d=t.enabled?1:0,y=d?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(d,y,t.job_id,r).run(),`Schedule ${t.job_id} ${d?"enabled (active)":"paused"}.`}case"update_schedule_state":{const d=["created","active","reminding","paused","completed"],y=t.state;if(!d.includes(y))return`Invalid state "${y}". Valid states: ${d.join(", ")}`;const h=y==="completed"||y==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,h,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const d=t.importance||5,y=d>=7?"working":"long_term";return await m.store(r,t.type,t.title,t.content,d,y),`Stored in ${y==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${d})`}case"search_memory":{const d=await m.search(r,t.query);return d.length===0?"No matching memories found.":d.map(y=>`[${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
`)}case"get_system_status":{const d=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),y=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),b=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(b==null?void 0:b.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),y=t.spreadsheet_id;let h=t.range;const p=await d.sheets.getMetadata(y),b=p.sheets;h.includes("!")||(h=`${b[0]}!${h}`);let E;try{E=await d.sheets.readRange(y,h)}catch(I){if((g=I.message)!=null&&g.includes("Unable to parse range")||(v=I.message)!=null&&v.includes("400")){const C=h.includes("!")?h.split("!")[1]:h;h=`${b[0]}!${C}`,E=await d.sheets.readRange(y,h)}else throw I}let k=`[Spreadsheet: "${p.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${b.map(I=>`"${I}"`).join(", ")}]
`;return b.length>1&&(k+=`[To read a different tab, call read_sheet again with range like "${b[1]}!A1:Z500"]
`),E.length===0?k+"No data found in the specified range.":k+E.map(I=>I.join("	| ")).join(`
`)}catch(d){return await O(a,r,"google","read_sheet",d.message),`Failed to read sheet: ${d.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new ee(a,r,n,s||"",o||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(d){return await O(a,r,"google","write_sheet",d.message),`Failed to write sheet: ${d.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new ee(a,r,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(d){return await O(a,r,"google","append_sheet",d.message),`Failed to append to sheet: ${d.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const h=await d.sheets.createSpreadsheet(t.title,t.sheet_names);let p="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>st)).getGoogleAuth(a,r,n,s||"",o||"");p=`
Folder: "${(await Wt(b,h.spreadsheetId,t.folder_name)).folderName}"`}catch(b){p=`
(Could not move to folder "${t.folder_name}": ${b.message})`}try{await new J(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${p}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(d){return await O(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),y=t.calendar_id||"primary",h=t.days_ahead||7,p=new Date,b=new Date(p.getTime()+h*24*60*60*1e3),E=await d.calendar.listEvents(y,{timeMin:p.toISOString(),timeMax:b.toISOString(),query:t.query});return E.length===0?`No events found in the next ${h} days.`:E.map(k=>{var $;const I=k.start.dateTime||k.start.date||"TBD",C=k.end.dateTime||k.end.date||"",A=k.location?` 📍 ${k.location}`:"",N=(($=k.attendees)==null?void 0:$.map(G=>G.email).join(", "))||"";return`• ${k.summary} — ${I} to ${C}${A}${N?`
  Attendees: ${N}`:""}`}).join(`
`)}catch(d){return await O(a,r,"google","list_calendar",d.message),`Failed to list events: ${d.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),y=t.calendar_id||"primary",h=await d.calendar.createEvent(y,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${h.summary}"
ID: ${h.id}
Start: ${h.start.dateTime||h.start.date}`}catch(d){return await O(a,r,"google","create_event",d.message),`Failed to create event: ${d.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const h=await d.docs.createDocument(t.title);t.content&&await d.docs.appendText(h.documentId,t.content);let p="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>st)).getGoogleAuth(a,r,n,s||"",o||"");p=`
Folder: "${(await Wt(b,h.documentId,t.folder_name)).folderName}"`}catch(b){p=`
(Could not move to folder "${t.folder_name}": ${b.message})`}try{await new J(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}return`Document created: "${t.title}"${p}
ID: ${h.documentId}
URL: ${h.url}`}catch(d){return await O(a,r,"google","create_doc",d.message),`Failed to create document: ${d.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const y=await new ee(a,r,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${y.title}"

${y.content}`}catch(d){return await O(a,r,"google","read_doc",d.message),`Failed to read document: ${d.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await d.docs.appendText(t.document_id,t.content);let h=t.document_id;try{h=(await d.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${h}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(d){return await O(a,r,"google","append_to_doc",d.message),`Failed to append to document: ${d.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const y=await new ne(a,r,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return y.length===0?"No messages found.":y.map((h,p)=>`${h.isUnread?"● ":"  "}${p+1}. **${h.subject}**
   From: ${h.from}
   Date: ${h.date}
   ${h.snippet}
   [id: ${h.id}]`).join(`

`)}catch(d){return await O(a,r,"gmail","list",d.message),(f=d.message)!=null&&f.includes("not connected")?d.message:`Gmail list error: ${d.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const d=new ne(a,r,n,s||"",o||""),y=await d.getMessage(t.message_id);if(!y)return"Message not found.";const h=await d.getMessageBody(t.message_id);return`**${y.subject}**
From: ${y.from}
To: ${y.to}
Date: ${y.date}

${h}`}catch(d){return await O(a,r,"gmail","read",d.message),`Gmail read error: ${d.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const y=await new ne(a,r,n,s||"",o||"").search(t.query,t.max_results||10);return y.length===0?`No results for: ${t.query}`:y.map((h,p)=>`${h.isUnread?"● ":"  "}${p+1}. **${h.subject}**
   From: ${h.from}
   Date: ${h.date}
   ${h.snippet}
   [id: ${h.id}]`).join(`

`)}catch(d){return await O(a,r,"gmail","search",d.message),`Gmail search error: ${d.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const y=await new ne(a,r,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${y.id}]`}catch(d){return await O(a,r,"gmail","send",d.message),`Gmail send error: ${d.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const y=await new ne(a,r,n,s||"",o||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${y.id}]`}catch(d){return await O(a,r,"gmail","draft",d.message),`Gmail draft error: ${d.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ne(a,r,n,s||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(d){return await O(a,r,"gmail","modify",d.message),`Gmail modify error: ${d.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const y=await new ne(a,r,n,s||"",o||"").getUnreadCount();return`You have ${y} unread email${y!==1?"s":""} in Gmail.`}catch(d){return(x=d.message)!=null&&x.includes("not connected")?d.message:`Gmail error: ${d.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:d}=await(await Promise.resolve().then(()=>st)).getGoogleAuth(a,r,n,s||"",o||""),y=new URLSearchParams;y.set("pageSize",String(t.max_results||10)),y.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),y.set("orderBy","modifiedTime desc");let h="";t.folder_id?h=`'${t.folder_id}' in parents and trashed = false`:t.query?h=`${t.query} and trashed = false`:h="trashed = false",y.set("q",h);const p=await fetch(`https://www.googleapis.com/drive/v3/files?${y}`,{headers:{Authorization:`Bearer ${d}`}});if(!p.ok)throw new Error(`Drive API error (${p.status})`);const b=await p.json();return(_=b.files)!=null&&_.length?b.files.map((E,k)=>{var N,$;const I=((N=E.mimeType)==null?void 0:N.split(".").pop())||E.mimeType,C=E.size?`${(parseInt(E.size)/1024).toFixed(1)} KB`:"",A=(($=E.modifiedTime)==null?void 0:$.split("T")[0])||"";return`${k+1}. **${E.name}** (${I})
   ${C} · Modified: ${A}
   ${E.webViewLink||""}`}).join(`

`):"No files found."}catch(d){return await O(a,r,"google","drive_list",d.message),`Drive list error: ${d.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:d}=await(await Promise.resolve().then(()=>st)).getGoogleAuth(a,r,n,s||"",o||""),y=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,h=new URLSearchParams;h.set("q",y),h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");const p=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${d}`}});if(!p.ok)throw new Error(`Drive API error (${p.status})`);const b=await p.json();return(T=b.files)!=null&&T.length?b.files.map((E,k)=>{var A,N;const I=((A=E.mimeType)==null?void 0:A.split(".").pop())||E.mimeType,C=((N=E.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${k+1}. **${E.name}** (${I}) — Modified: ${C}
   ${E.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(d){return await O(a,r,"google","drive_search",d.message),`Drive search error: ${d.message}`}}case"web_search":try{const d=await ht(t.query,{num:t.num_results||5,site:t.site});return d.error?`Web search failed: ${d.error}`:d.results.length===0?`No results found for "${t.query}".`:d.results.map((y,h)=>`${h+1}. **${y.title}**
   ${y.link}
   ${y.snippet}`).join(`

`)}catch(d){return await O(a,r,"search","web_search",d.message),`Web search error: ${d.message}`}case"read_url":try{const d=t.url;if(!d||!d.startsWith("http://")&&!d.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:h}=await Promise.resolve().then(()=>tn),p=await h(d,y);return p.error?`Failed to read page: ${p.error}`:!p.text||p.text.length<20?`Page at ${d} returned no readable content.`:`Content from ${d} (${p.text.length} chars):

${p.text}`}catch(d){return await O(a,r,"search","read_url",d.message),`Read URL error: ${d.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const y=Ha(t.query,u,{depth:t.depth||"quick",site:t.site}),h=new Promise(E=>setTimeout(()=>E(null),45e3)),p=await Promise.race([y,h]);if(p===null){const{webSearch:E}=await Promise.resolve().then(()=>Vr),k=await E(t.query,{num:5});if(k.error||k.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let I=`Research took too long, but here are the top search results:

`;return I+=k.results.map((C,A)=>`${A+1}. **${C.title}**
   ${C.snippet}
   ${C.link}`).join(`

`),I}if(p.error)return`Research failed: ${p.error}`;let b=p.report;return p.sources.length>0&&(b+=`

---
**Sources** (`+p.pagesRead+` pages read):
`,b+=p.sources.map((E,k)=>`[${k+1}] ${E.title}
    ${E.url}`).join(`
`)),b}catch(d){return await O(a,r,"research","research",d.message),`Research error: ${d.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await M(d.encrypted_value,n),h=await La(y,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((p,b)=>{const E=p.rating?` ★${p.rating} (${p.userRatingsTotal||0} reviews)`:"",k=p.openNow!==void 0?p.openNow?" · Open now":" · Closed":"",I=p.googleMapsUri?`
   ${p.googleMapsUri}`:"";return`${b+1}. **${p.name}**${E}${k}
   ${p.address}${I}
   [place_id: ${p.placeId}]`}).join(`

`)}catch(d){return await O(a,r,"google_api","search_places",d.message),`Places search error: ${d.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await M(d.encrypted_value,n),h=await Na(y,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const p=h.details;let b=`**${p.name}**
📍 ${p.address}`;if(p.phone&&(b+=`
📞 ${p.phone}`),p.website&&(b+=`
🌐 ${p.website}`),p.rating&&(b+=`
★ ${p.rating}`),p.googleMapsUri&&(b+=`
📌 ${p.googleMapsUri}`),p.openingHours&&(b+=`

Opening Hours:
${p.openingHours.join(`
`)}`),p.reviews&&p.reviews.length>0){b+=`

Recent Reviews:`;for(const E of p.reviews)b+=`
— ${E.author} (★${E.rating}, ${E.time}): "${E.text}"`}return b}catch(d){return await O(a,r,"google_api","place_details",d.message),`Place details error: ${d.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await M(d.encrypted_value,n),h=await $a(y,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const p=h.route;let b=`**${p.startAddress}** → **${p.endAddress}**
`;return b+=`📏 ${p.distance} · ⏱️ ${p.duration}`,p.durationInTraffic&&(b+=` (with traffic: ${p.durationInTraffic})`),b+=`
via ${p.summary}`,b+=`

Steps:`,p.steps.forEach((E,k)=>{b+=`
${k+1}. ${E.instruction} (${E.distance}, ${E.duration})`}),b}catch(d){return await O(a,r,"google_api","directions",d.message),`Directions error: ${d.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await M(d.encrypted_value,n),h=await Pa(y,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let p=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(p+=` (with traffic: ${h.durationInTraffic})`),p}catch(d){return await O(a,r,"google_api","travel_time",d.message),`Travel time error: ${d.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await M(d.encrypted_value,n),h=await Ma(y,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(d){return await O(a,r,"google_api","translate",d.message),`Translation error: ${d.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await M(d.encrypted_value,n),h=await ja(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((p,b)=>{var E;return`${b+1}. **${p.title}**
   ${p.channelTitle} · ${((E=p.publishedAt)==null?void 0:E.split("T")[0])||""}
   ${p.description}
   ${p.url}`}).join(`

`)}catch(d){return await O(a,r,"google_api","youtube_search",d.message),`YouTube search error: ${d.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const y=await M(d.encrypted_value,n),h=await Ba(y,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((p,b)=>`${b+1}. ${p.address}
   Coordinates: ${p.lat}, ${p.lng}`).join(`
`)}catch(d){return await O(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Ot(e,t,a,r,n,s){var x;const o=new J(t),i=(x=e.metadata)==null?void 0:x.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),m=[{role:"system",content:qa(r,l)},...c.map(_=>({role:_.role,content:_.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;for(let _=0;_<g;_++)try{const T=await a.chat(m,{tools:gt});if(T.usage&&(f+=T.usage.promptTokens+T.usage.completionTokens),T.toolCalls&&T.toolCalls.length>0){T.content&&m.push({role:"assistant",content:T.content});for(const d of T.toolCalls)try{const y=await Je(d.name,d.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);m.push({role:"user",content:`[Tool Result for ${d.name}]: ${y}`})}catch(y){await O(t,r.id,"tool",d.name,y.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${d.name}]: ${y.message||"Execution failed"}`})}continue}v=T.content;break}catch(T){if(n){const d=T.message||"",y=d.includes("401")||d.includes("403")||d.includes("authentication")||d.includes("credit balance"),h=d.includes("429"),p=y?1440:h?10:5;await n.recordError(a.name,d,p)}throw await O(t,r.id,"llm","provider_error",T.message||"Unknown LLM error",{provider:a.name,turn:_}),T}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}return await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),v}const qt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function on(e){for(const[t,a]of Object.entries(qt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return qt.default}function ln(e,t,a,r){const n=on(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const c=Et(e);o.push({role:"system",content:e}),i+=c;const u=Et(a);i+=u;const m=s-i,g=[];let v=0;for(let f=t.length-1;f>=0;f--){const x=t[f],_=Et(x.content);if(v+_<=m)g.unshift({role:x.role,content:x.content}),v+=_;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*cn(e,t,a,r,n,s){var _;const o=new J(t),i=(_=e.metadata)==null?void 0:_.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),u=qa(r,l),m=ln(u,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;const x=[...m.messages];for(let T=0;T<g;T++)try{T>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:gt});if(d.usage&&(f+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const h of d.toolCalls){yield{type:"tool_start",data:{tool:h.name,toolArgs:h.arguments,threadId:i}};try{const p=await Je(h.name,h.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:h.name,toolResult:p.substring(0,500)+(p.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${h.name}]: ${p}`})}catch(p){await O(t,r.id,"tool",h.name,p.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:h.name,toolResult:`Error: ${p.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${h.name}]: ${p.message||"Execution failed"}`})}}continue}v=d.content;const y=50;for(let h=0;h<v.length;h+=y)yield{type:"chunk",data:{text:v.substring(h,h+y),threadId:i}},h+y<v.length&&await new Promise(b=>setTimeout(b,10));break}catch(d){if(n){const y=d.message||"",h=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),p=y.includes("429"),b=h?1440:p?10:5;await n.recordError(a.name,y,b)}await O(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:T}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function Mt(e,t,a,r,n,s){var u;const o=new J(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=za(e.text,l);if(c.agent==="conversation")return un(e,t,a,r,l,n,i);if(c.agent==="multi"||c.confidence<.5)return Ot(e,t,a,r,n,s);try{return await dn(c.agent,e,t,a,r,l,n,s,i)}catch(m){return await O(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${m.message}`,{route:c}),Ot(e,t,a,r,n,s)}}async function dn(e,t,a,r,n,s,o,i,l){const c=new J(a),u=ft(n.timezone),m=dt(e,n,s,n.timezone,u),g=Fa(e,gt),v=await c.getRecentConversations(n.id,25,l),f=[{role:"system",content:m},...v.map(p=>({role:p.role,content:p.content})),{role:"user",content:t.text}];await c.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const x=10;let _="",T=0,d="",y=!1;for(let p=0;p<x;p++)try{const b=await r.chat(f,{tools:g.length>0?g:void 0});if(b.usage&&(T+=b.usage.promptTokens+b.usage.completionTokens),b.toolCalls&&b.toolCalls.length>0){y=!0,b.content&&(d=b.content,f.push({role:"assistant",content:b.content}));for(const E of b.toolCalls)try{const k=await Je(E.name,E.arguments,a,n.id,n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${E.name}]: ${k}`})}catch(k){await O(a,n.id,"tool",E.name,k.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${E.name}]: ${k.message||"Execution failed"}`})}continue}_=b.content,!_&&d&&(_=d);break}catch(b){if(o){const E=b.message||"",k=E.includes("401")||E.includes("403")||E.includes("authentication")||E.includes("credit balance"),I=E.includes("429"),C=k?1440:I?10:5;await o.recordError(r.name,E,C)}throw await O(a,n.id,"llm","subagent_error",b.message||"Unknown error",{agent:e,provider:r.name,turn:p}),b}if(!y&&["scheduler","workspace","research"].includes(e)&&g.length>0)try{f.push({role:"assistant",content:_}),f.push({role:"user",content:`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${g.slice(0,3).map(b=>b.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`});const p=await r.chat(f,{tools:g});if(p.usage&&(T+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){y=!0;for(const E of p.toolCalls)try{const k=await Je(E.name,E.arguments,a,n.id,n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${E.name}]: ${k}`})}catch(k){f.push({role:"user",content:`[Tool Error for ${E.name}]: ${k.message||"Execution failed"}`})}const b=await r.chat(f,{tools:g});b.content&&(_=b.content),b.usage&&(T+=b.usage.promptTokens+b.usage.completionTokens)}}catch(p){await O(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${p.message||"Unknown"}`,{originalResponse:_.substring(0,200)})}if(o&&T>0)try{await o.recordUsage(r.name,T)}catch{}return await c.storeMessage(n.id,t.channel,"assistant",_,"{}",l),await c.compactHistory(n.id,30),_}async function un(e,t,a,r,n,s,o){const i=new J(t),l=ft(r.timezone),c=dt("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),m=[{role:"system",content:c},...u.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let g=0,v="";try{const f=await a.chat(m,{temperature:.8});f.usage&&(g=f.usage.promptTokens+f.usage.completionTokens),v=f.content}catch(f){if(s){const x=f.message||"",_=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),T=x.includes("429"),d=_?1440:T?10:5;await s.recordError(a.name,x,d)}throw await O(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(s&&g>0)try{await s.recordUsage(a.name,g)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*pn(e,t,a,r,n,s){var d;const o=new J(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=za(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*cn(e,t,a,r,n,s);return}const u=ft(r.timezone),m=c.agent==="conversation"?dt("conversation",r,l,r.timezone,u):dt(c.agent,r,l,r.timezone,u),g=Fa(c.agent,gt),v=await o.getRecentConversations(r.id,25,i),f=[{role:"system",content:m},...v.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let _="",T=0;for(let y=0;y<x;y++)try{y>0&&(yield{type:"thinking",data:{threadId:i}});const h=await a.chat(f,{tools:g.length>0?g:void 0});if(h.usage&&(T+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){h.content&&(yield{type:"chunk",data:{text:h.content,threadId:i}},f.push({role:"assistant",content:h.content}));for(const b of h.toolCalls){yield{type:"tool_start",data:{tool:b.name,toolArgs:b.arguments,threadId:i}};try{const E=await Je(b.name,b.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:b.name,toolResult:E.substring(0,500)+(E.length>500?"...":""),threadId:i}},f.push({role:"user",content:`[Tool Result for ${b.name}]: ${E}`})}catch(E){await O(t,r.id,"tool",b.name,E.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:b.name,toolResult:`Error: ${E.message||"Execution failed"}`,threadId:i}},f.push({role:"user",content:`[Tool Error for ${b.name}]: ${E.message||"Execution failed"}`})}}continue}_=h.content;const p=50;for(let b=0;b<_.length;b+=p)yield{type:"chunk",data:{text:_.substring(b,b+p),threadId:i}},b+p<_.length&&await new Promise(k=>setTimeout(k,10));break}catch(h){if(n){const p=h.message||"",b=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),E=p.includes("429"),k=b?1440:E?10:5;await n.recordError(a.name,p,k)}await O(t,r.id,"llm","subagent_stream_error",h.message||"Unknown error",{agent:c.agent,provider:a.name,turn:y}),yield{type:"error",data:{error:h.message||"An error occurred",threadId:i}};return}if(n&&T>0)try{await n.recordUsage(a.name,T)}catch{}await o.storeMessage(r.id,e.channel,"assistant",_,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:T}}}const B=new ye;async function mn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
...
`;for(const c of s)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:u}=await tt(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(g){const v=new TextEncoder;try{const f=pn(l,e.env.DB,c,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of f)x.data.threadId||(x.data.threadId=i),g.enqueue(v.encode(Kt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),g.close()}catch(f){const x={type:"error",data:{error:f.message||"An error occurred",threadId:i}};g.enqueue(v.encode(Kt(x))),g.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const u=c.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});B.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
Status: ✅ Online`;await z(a,t,u)}catch{await z(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await z(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await z(a,t,"⚠️ Account not linked."),!0);default:return!1}}at.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await En(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const l=!!i.text,c=!!i.voice,u=!!i.document,m=!!i.photo,g=!!i.caption;if(!l&&!c&&!u&&!m)return e.json({ok:!0});const v=String(i.chat.id);let f=i.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let _=null;if(x){const p=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();p&&(_=await M(p.encrypted_value,x.pin_hash))}if(!_){const p=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();p&&(_=await M(p.encrypted_value,p.pin_hash))}if(!_)return e.json({ok:!0,message:"Bot token not configured"});if(f.startsWith("/")&&await xn(f,v,_,x,e.env.DB))return e.json({ok:!0});if(!x)return await z(_,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&_&&x)try{await z(_,v,"🎤 Processing voice note...");const b=await(await fetch(`https://api.telegram.org/bot${_}/getFile?file_id=${i.voice.file_id}`)).json();if(b.ok&&((t=b.result)!=null&&t.file_path)){const k=await(await fetch(`https://api.telegram.org/file/bot${_}/${b.result.file_path}`)).blob();let I="",C="",A="whisper-1";const N=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const ae of N.results){const De=await M(ae.encrypted_value,x.pin_hash);if(ae.service==="openai"){I="https://api.openai.com/v1/audio/transcriptions",C=De;break}else if(ae.service.startsWith("llm_slot_"))try{const de=JSON.parse(De);if(de.provider==="openai"){I="https://api.openai.com/v1/audio/transcriptions",C=de.apiKey;break}else if(de.provider==="groq"){I="https://api.groq.com/openai/v1/audio/transcriptions",C=de.apiKey,A="whisper-large-v3";break}}catch{}}if(!I)return await z(_,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const $=new FormData;$.append("file",k,"voice.ogg"),$.append("model",A),$.append("language","en");const G=await fetch(I,{method:"POST",headers:{Authorization:`Bearer ${C}`},body:$});if(!G.ok){const ae=await G.text();return await z(_,v,`⚠️ Transcription failed: ${G.status} ${ae}`),e.json({ok:!0})}f=(await G.json()).text,await z(_,v,`🗣️ *You said:* ${f}`)}}catch(p){return await z(_,v,`⚠️ Failed to process voice note: ${p.message}`),e.json({ok:!0})}if((u||m)&&_&&x)try{let p,b="unknown",E="unknown",k=0;if(u)p=i.document.file_id,b=i.document.file_name||"document",E=i.document.mime_type||"unknown",k=i.document.file_size||0;else if(m){const I=i.photo[i.photo.length-1];p=I.file_id,b="photo.jpg",E="image/jpeg",k=I.file_size||0}if(p){const C=await(await fetch(`https://api.telegram.org/bot${_}/getFile?file_id=${p}`)).json();let A="";if(C.ok&&((a=C.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(b)||/^text\/|application\/json|application\/xml|application\/csv/i.test(E))&&k<5e4)try{A=await(await fetch(`https://api.telegram.org/file/bot${_}/${C.result.file_path}`)).text()}catch{}const N=i.caption||"",$=`[Telegram file received: "${b}" (${E}, ${Math.round(k/1024)}KB)]`;A?f=`${N?N+`
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(p){if(g&&i.caption)f=i.caption;else return await z(_,v,`⚠️ Received your file but couldn't process it: ${p.message}`),e.json({ok:!0})}if(!f)return e.json({ok:!0});await wn(_,v);let T=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();T?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(T.id).run():T={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=yn(x.id,x.username,f,v);d.metadata={thread_id:T.id};let y,h;try{const p=await tt(e.env.DB,x.id,x.pin_hash);y=p.provider,h=p.rotation}catch(p){console.error("Telegram provider setup error:",p);const b=(r=p.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=p.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${p.message||"Unknown error"}`;return await z(_,v,b),e.json({ok:!0})}try{const p=await Mt(d,e.env.DB,y,x,h,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),b=vn(p,"telegram");await z(_,v,b||"(empty response)")}catch(p){console.error("Telegram agent error:",p);const b=(s=p.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${y.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(p.message||"Unknown").substring(0,200)}`;await z(_,v,b);try{const{logError:E}=await Promise.resolve().then(()=>It);await E(e.env.DB,x.id,"telegram","agent_error",p.message||"Agent error",{provider:y.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>It);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});at.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
...
`)}function Cn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Rn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function Ka(e,t,a){var T;const r=t.timezone||"Asia/Kolkata",n=Tn(r),{components:s,newsTopics:o}=await Rn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(kn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(Sn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(In(e,t.id)),l.push("tasks")),s.news&&(i.push(Dn(o)),l.push("news"));const c=await Promise.all(i),u={};l.forEach((d,y)=>{u[d]=c[y]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},g={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((T=u.googleEvents)==null?void 0:T.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||g,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};v.summary=On(v);const f=Cn(v),x=await e.prepare(`
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function $n(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,c=o*60+i;return l===c}function Mn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const Y=new ye;async function Ja(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if($n(l,i,s))try{const c=await Ka(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:m}=Mn(c.content,c.items);await Bn(e.env.DB,o,u,m,c.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:i})}catch(c){n.push({user_id:o.id,status:"error",error:c.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});Y.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const u=await M(c.encrypted_value,l.pin_hash),g=JSON.parse(u).access_token;if(!g)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${g}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(d=>{var h;const y=(h=d.start)==null?void 0:h.dateTime;return y?y>=s.toISOString()&&y<=o:!1});if(x.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const _=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!_)continue;const T=await M(_.encrypted_value,l.pin_hash);for(const d of x){const y=new Date(d.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),h=d.location?`
📍 ${d.location}`:"",p=`⏰ Meeting in 10 minutes!

*${d.summary||"Untitled Event"}*
🕐 ${y}${h}`;await fetch(`https://api.telegram.org/bot${T}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:p,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:x.length})}catch(c){n.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});async function Bn(e,t,a,r,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
