var Gr=Object.defineProperty;var Rt=e=>{throw TypeError(e)};var Hr=(e,t,r)=>t in e?Gr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var E=(e,t,r)=>Hr(e,typeof t!="symbol"?t+"":t,r),ut=(e,t,r)=>t.has(e)||Rt("Cannot "+r);var v=(e,t,r)=>(ut(e,t,"read from private field"),r?r.call(e):t.get(e)),O=(e,t,r)=>t.has(e)?Rt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),k=(e,t,r,a)=>(ut(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),C=(e,t,r)=>(ut(e,t,"access private method"),r);var Dt=(e,t,r,a)=>({set _(n){k(e,t,n,r)},get _(){return v(e,t,a)}});var At=(e,t,r)=>(a,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,d=!1,u;if(e[i]?(u=e[i][0][0],a.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(a,()=>o(i+1))}catch(h){if(h instanceof Error&&t)a.error=h,l=await t(h,a),d=!0;else throw h}else a.finalized===!1&&r&&(l=await r(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},Fr=Symbol(),qr=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,s=(e instanceof rr?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?zr(e,{all:r,dot:a}):{}};async function zr(e,t){const r=await e.formData();return r?Wr(r,t):{}}function Wr(e,t){const r=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Kr(r,n,a):r[n]=a}),t.dot&&Object.entries(r).forEach(([a,n])=>{a.includes(".")&&(Jr(r,a,n),delete r[a])}),r}var Kr=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Jr=(e,t,r)=>{let a=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?a[s]=r:((!a[s]||typeof a[s]!="object"||Array.isArray(a[s])||a[s]instanceof File)&&(a[s]=Object.create(null)),a=a[s])})},Xt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Yr=e=>{const{groups:t,path:r}=Vr(e),a=Xt(r);return Xr(a,t)},Vr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const n=`@${a}`;return t.push([n,r]),n}),{groups:t,path:e}},Xr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[r][1]);break}}return e},tt={},Zr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return tt[a]||(r[2]?tt[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:tt[a]=[e,r[1],!0]),tt[a]}return null},Et=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},Qr=e=>Et(e,decodeURI),Zt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const s=t.indexOf("?",a),o=t.indexOf("#",a),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(r,i);return Qr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(r,a)},ea=e=>{const t=Zt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Se=(e,t,...r)=>(r.length&&(t=Se(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Qt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&a===""?r.push("/"):r.push(a);const s=n.replace("?","");a+="/"+s,r.push(a)}else a+="/"+n}),r.filter((n,s,o)=>o.indexOf(n)===s)},pt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Et(e,tr):e):e,er=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,d=e.indexOf("&",l);return pt(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(a&&(l=pt(l)),s=o,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),a&&(d=pt(d))),r?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},ta=er,ra=(e,t)=>er(e,t,!0),tr=decodeURIComponent,Lt=e=>Et(e,tr),Ce,F,se,ar,nr,yt,ie,zt,rr=(zt=class{constructor(e,t="/",r=[[]]){O(this,se);E(this,"raw");O(this,Ce);O(this,F);E(this,"routeIndex",0);E(this,"path");E(this,"bodyCache",{});O(this,ie,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,k(this,F,r),k(this,Ce,{})}param(e){return e?C(this,se,ar).call(this,e):C(this,se,nr).call(this)}query(e){return ta(this.url,e)}queries(e){return ra(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await qr(this,e))}json(){return v(this,ie).call(this,"text").then(e=>JSON.parse(e))}text(){return v(this,ie).call(this,"text")}arrayBuffer(){return v(this,ie).call(this,"arrayBuffer")}blob(){return v(this,ie).call(this,"blob")}formData(){return v(this,ie).call(this,"formData")}addValidatedData(e,t){v(this,Ce)[e]=t}valid(e){return v(this,Ce)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Fr](){return v(this,F)}get matchedRoutes(){return v(this,F)[0].map(([[,e]])=>e)}get routePath(){return v(this,F)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ce=new WeakMap,F=new WeakMap,se=new WeakSet,ar=function(e){const t=v(this,F)[0][this.routeIndex][1][e],r=C(this,se,yt).call(this,t);return r&&/\%/.test(r)?Lt(r):r},nr=function(){const e={},t=Object.keys(v(this,F)[0][this.routeIndex][1]);for(const r of t){const a=C(this,se,yt).call(this,v(this,F)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Lt(a):a)}return e},yt=function(e){return v(this,F)[1]?v(this,F)[1][e]:e},ie=new WeakMap,zt),aa={Stringify:1},sr=async(e,t,r,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>sr(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},na="text/plain; charset=UTF-8",mt=(e,t)=>({"Content-Type":e,...t}),We,Ke,te,Re,re,H,Je,De,Ae,ve,Ye,Ve,le,Ie,Wt,sa=(Wt=class{constructor(e,t){O(this,le);O(this,We);O(this,Ke);E(this,"env",{});O(this,te);E(this,"finalized",!1);E(this,"error");O(this,Re);O(this,re);O(this,H);O(this,Je);O(this,De);O(this,Ae);O(this,ve);O(this,Ye);O(this,Ve);E(this,"render",(...e)=>(v(this,De)??k(this,De,t=>this.html(t)),v(this,De).call(this,...e)));E(this,"setLayout",e=>k(this,Je,e));E(this,"getLayout",()=>v(this,Je));E(this,"setRenderer",e=>{k(this,De,e)});E(this,"header",(e,t,r)=>{this.finalized&&k(this,H,new Response(v(this,H).body,v(this,H)));const a=v(this,H)?v(this,H).headers:v(this,ve)??k(this,ve,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});E(this,"status",e=>{k(this,Re,e)});E(this,"set",(e,t)=>{v(this,te)??k(this,te,new Map),v(this,te).set(e,t)});E(this,"get",e=>v(this,te)?v(this,te).get(e):void 0);E(this,"newResponse",(...e)=>C(this,le,Ie).call(this,...e));E(this,"body",(e,t,r)=>C(this,le,Ie).call(this,e,t,r));E(this,"text",(e,t,r)=>!v(this,ve)&&!v(this,Re)&&!t&&!r&&!this.finalized?new Response(e):C(this,le,Ie).call(this,e,t,mt(na,r)));E(this,"json",(e,t,r)=>C(this,le,Ie).call(this,JSON.stringify(e),t,mt("application/json",r)));E(this,"html",(e,t,r)=>{const a=n=>C(this,le,Ie).call(this,n,t,mt("text/html; charset=UTF-8",r));return typeof e=="object"?sr(e,aa.Stringify,!1,{}).then(a):a(e)});E(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});E(this,"notFound",()=>(v(this,Ae)??k(this,Ae,()=>new Response),v(this,Ae).call(this,this)));k(this,We,e),t&&(k(this,re,t.executionCtx),this.env=t.env,k(this,Ae,t.notFoundHandler),k(this,Ve,t.path),k(this,Ye,t.matchResult))}get req(){return v(this,Ke)??k(this,Ke,new rr(v(this,We),v(this,Ve),v(this,Ye))),v(this,Ke)}get event(){if(v(this,re)&&"respondWith"in v(this,re))return v(this,re);throw Error("This context has no FetchEvent")}get executionCtx(){if(v(this,re))return v(this,re);throw Error("This context has no ExecutionContext")}get res(){return v(this,H)||k(this,H,new Response(null,{headers:v(this,ve)??k(this,ve,new Headers)}))}set res(e){if(v(this,H)&&e){e=new Response(e.body,e);for(const[t,r]of v(this,H).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=v(this,H).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}k(this,H,e),this.finalized=!0}get var(){return v(this,te)?Object.fromEntries(v(this,te)):{}}},We=new WeakMap,Ke=new WeakMap,te=new WeakMap,Re=new WeakMap,re=new WeakMap,H=new WeakMap,Je=new WeakMap,De=new WeakMap,Ae=new WeakMap,ve=new WeakMap,Ye=new WeakMap,Ve=new WeakMap,le=new WeakSet,Ie=function(e,t,r){const a=v(this,H)?new Headers(v(this,H).headers):v(this,ve)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?a.append(o,i):a.set(o,i)}if(r)for(const[s,o]of Object.entries(r))if(typeof o=="string")a.set(s,o);else{a.delete(s);for(const i of o)a.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??v(this,Re);return new Response(e,{status:n,headers:a})},Wt),j="ALL",oa="all",ia=["get","post","put","delete","options","patch"],or="Can not add a route since the matcher is already built.",ir=class extends Error{},la="__COMPOSED_HANDLER",da=e=>e.text("404 Not Found",404),Nt=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},z,B,lr,W,fe,at,nt,Le,ca=(Le=class{constructor(t={}){O(this,B);E(this,"get");E(this,"post");E(this,"put");E(this,"delete");E(this,"options");E(this,"patch");E(this,"all");E(this,"on");E(this,"use");E(this,"router");E(this,"getPath");E(this,"_basePath","/");O(this,z,"/");E(this,"routes",[]);O(this,W,da);E(this,"errorHandler",Nt);E(this,"onError",t=>(this.errorHandler=t,this));E(this,"notFound",t=>(k(this,W,t),this));E(this,"fetch",(t,...r)=>C(this,B,nt).call(this,t,r[1],r[0],t.method));E(this,"request",(t,r,a,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Se("/",t)}`,r),a,n)));E(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(C(this,B,nt).call(this,t.request,t,void 0,t.request.method))})});[...ia,oa].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?k(this,z,o):C(this,B,fe).call(this,s,v(this,z),o),i.forEach(l=>{C(this,B,fe).call(this,s,v(this,z),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){k(this,z,l);for(const d of[s].flat())i.map(u=>{C(this,B,fe).call(this,d.toUpperCase(),v(this,z),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?k(this,z,s):(k(this,z,"*"),o.unshift(s)),o.forEach(i=>{C(this,B,fe).call(this,j,v(this,z),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Zt:ea}route(t,r){const a=this.basePath(t);return r.routes.map(n=>{var o;let s;r.errorHandler===Nt?s=n.handler:(s=async(i,l)=>(await At([],r.errorHandler)(i,()=>n.handler(i,l))).res,s[la]=n.handler),C(o=a,B,fe).call(o,n.method,n.path,s)}),this}basePath(t){const r=C(this,B,lr).call(this);return r._basePath=Se(this._basePath,t),r}mount(t,r,a){let n,s;a&&(typeof a=="function"?s=a:(s=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const o=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Se(this._basePath,t),d=l==="/"?0:l.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const i=async(l,d)=>{const u=await r(n(l.req.raw),...o(l));if(u)return u;await d()};return C(this,B,fe).call(this,j,Se(t,"*"),i),this}},z=new WeakMap,B=new WeakSet,lr=function(){const t=new Le({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,k(t,W,v(this,W)),t.routes=this.routes,t},W=new WeakMap,fe=function(t,r,a){t=t.toUpperCase(),r=Se(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,n]),this.routes.push(n)},at=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},nt=function(t,r,a,n){if(n==="HEAD")return(async()=>new Response(null,await C(this,B,nt).call(this,t,r,a,"GET")))();const s=this.getPath(t,{env:a}),o=this.router.match(n,s),i=new sa(t,{path:s,matchResult:o,env:a,executionCtx:r,notFoundHandler:v(this,W)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await v(this,W).call(this,i)})}catch(u){return C(this,B,at).call(this,u,i)}return d instanceof Promise?d.then(u=>u||(i.finalized?i.res:v(this,W).call(this,i))).catch(u=>C(this,B,at).call(this,u,i)):d??v(this,W).call(this,i)}const l=At(o[0],this.errorHandler,v(this,W));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return C(this,B,at).call(this,d,i)}})()},Le),dr=[];function ua(e,t){const r=this.buildAllMatchers(),a=((n,s)=>{const o=r[n]||r[j],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],dr];const d=l.indexOf("",1);return[o[1][d],l]});return this.match=a,a(e,t)}var ot="[^/]+",Fe=".*",qe="(?:|/.*)",Oe=Symbol(),pa=new Set(".\\+*[^]$()");function ma(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Fe||e===qe?1:t===Fe||t===qe?-1:e===ot?1:t===ot?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var be,we,K,Ee,ha=(Ee=class{constructor(){O(this,be);O(this,we);O(this,K,Object.create(null))}insert(t,r,a,n,s){if(t.length===0){if(v(this,be)!==void 0)throw Oe;if(s)return;k(this,be,r);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Fe]:["","",ot]:o==="/*"?["","",qe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let h=l[2]||ot;if(u&&l[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw Oe;if(d=v(this,K)[h],!d){if(Object.keys(v(this,K)).some(g=>g!==Fe&&g!==qe))throw Oe;if(s)return;d=v(this,K)[h]=new Ee,u!==""&&k(d,we,n.varIndex++)}!s&&u!==""&&a.push([u,v(d,we)])}else if(d=v(this,K)[o],!d){if(Object.keys(v(this,K)).some(u=>u.length>1&&u!==Fe&&u!==qe))throw Oe;if(s)return;d=v(this,K)[o]=new Ee}d.insert(i,r,a,n,s)}buildRegExpStr(){const r=Object.keys(v(this,K)).sort(ma).map(a=>{const n=v(this,K)[a];return(typeof v(n,we)=="number"?`(${a})@${v(n,we)}`:pa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof v(this,be)=="number"&&r.unshift(`#${v(this,be)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},be=new WeakMap,we=new WeakMap,K=new WeakMap,Ee),lt,Xe,Kt,ga=(Kt=class{constructor(){O(this,lt,{varIndex:0});O(this,Xe,new ha)}insert(e,t,r){const a=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,i=!0,d}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return v(this,Xe).insert(s,t,a,v(this,lt),r),a}buildRegExp(){let e=v(this,Xe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(r[++t]=Number(s),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,a]}},lt=new WeakMap,Xe=new WeakMap,Kt),fa=[/^$/,[],Object.create(null)],st=Object.create(null);function cr(e){return st[e]??(st[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ya(){st=Object.create(null)}function va(e){var d;const t=new ga,r=[];if(e.length===0)return fa;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[g,f])=>u?1:g?-1:h.length-f.length),n=Object.create(null);for(let u=0,h=-1,g=a.length;u<g;u++){const[f,b,_]=a[u];f?n[b]=[_.map(([c])=>[c,Object.create(null)]),dr]:h++;let x;try{x=t.insert(b,h,f)}catch(c){throw c===Oe?new ir(b):c}f||(r[h]=_.map(([c,p])=>{const m=Object.create(null);for(p-=1;p>=0;p--){const[y,w]=x[p];m[y]=w}return[c,m]}))}const[s,o,i]=t.buildRegExp();for(let u=0,h=r.length;u<h;u++)for(let g=0,f=r[u].length;g<f;g++){const b=(d=r[u][g])==null?void 0:d[1];if(!b)continue;const _=Object.keys(b);for(let x=0,c=_.length;x<c;x++)b[_[x]]=i[b[_[x]]]}const l=[];for(const u in o)l[u]=r[o[u]];return[s,l,n]}function Te(e,t){if(e){for(const r of Object.keys(e).sort((a,n)=>n.length-a.length))if(cr(r).test(t))return[...e[r]]}}var de,ce,dt,ur,Jt,ba=(Jt=class{constructor(){O(this,dt);E(this,"name","RegExpRouter");O(this,de);O(this,ce);E(this,"match",ua);k(this,de,{[j]:Object.create(null)}),k(this,ce,{[j]:Object.create(null)})}add(e,t,r){var i;const a=v(this,de),n=v(this,ce);if(!a||!n)throw new Error(or);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[j]).forEach(d=>{l[e][d]=[...l[j][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=cr(t);e===j?Object.keys(a).forEach(d=>{var u;(u=a[d])[t]||(u[t]=Te(a[d],t)||Te(a[j],t)||[])}):(i=a[e])[t]||(i[t]=Te(a[e],t)||Te(a[j],t)||[]),Object.keys(a).forEach(d=>{(e===j||e===d)&&Object.keys(a[d]).forEach(u=>{l.test(u)&&a[d][u].push([r,s])})}),Object.keys(n).forEach(d=>{(e===j||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([r,s]))});return}const o=Qt(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(h=>{var g;(e===j||e===h)&&((g=n[h])[u]||(g[u]=[...Te(a[h],u)||Te(a[j],u)||[]]),n[h][u].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(v(this,ce)).concat(Object.keys(v(this,de))).forEach(t=>{e[t]||(e[t]=C(this,dt,ur).call(this,t))}),k(this,de,k(this,ce,void 0)),ya(),e}},de=new WeakMap,ce=new WeakMap,dt=new WeakSet,ur=function(e){const t=[];let r=e===j;return[v(this,de),v(this,ce)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(s=>[s,a[e][s]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==j&&t.push(...Object.keys(a[j]).map(s=>[s,a[j][s]]))}),r?va(t):null},Jt),ue,ae,Yt,wa=(Yt=class{constructor(e){E(this,"name","SmartRouter");O(this,ue,[]);O(this,ae,[]);k(this,ue,e.routers)}add(e,t,r){if(!v(this,ae))throw new Error(or);v(this,ae).push([e,t,r])}match(e,t){if(!v(this,ae))throw new Error("Fatal error");const r=v(this,ue),a=v(this,ae),n=r.length;let s=0,o;for(;s<n;s++){const i=r[s];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);o=i.match(e,t)}catch(l){if(l instanceof ir)continue;throw l}this.match=i.match.bind(i),k(this,ue,[i]),k(this,ae,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(v(this,ae)||v(this,ue).length!==1)throw new Error("No active router has been determined yet.");return v(this,ue)[0]}},ue=new WeakMap,ae=new WeakMap,Yt),Be=Object.create(null),pe,G,_e,Ne,U,ne,ye,$e,_a=($e=class{constructor(t,r,a){O(this,ne);O(this,pe);O(this,G);O(this,_e);O(this,Ne,0);O(this,U,Be);if(k(this,G,a||Object.create(null)),k(this,pe,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},k(this,pe,[n])}k(this,_e,[])}insert(t,r,a){k(this,Ne,++Dt(this,Ne)._);let n=this;const s=Yr(r),o=[];for(let i=0,l=s.length;i<l;i++){const d=s[i],u=s[i+1],h=Zr(d,u),g=Array.isArray(h)?h[0]:d;if(g in v(n,G)){n=v(n,G)[g],h&&o.push(h[1]);continue}v(n,G)[g]=new $e,h&&(v(n,_e).push(h),o.push(h[1])),n=v(n,G)[g]}return v(n,pe).push({[t]:{handler:a,possibleKeys:o.filter((i,l,d)=>d.indexOf(i)===l),score:v(this,Ne)}}),n}search(t,r){var l;const a=[];k(this,U,Be);let s=[this];const o=Xt(r),i=[];for(let d=0,u=o.length;d<u;d++){const h=o[d],g=d===u-1,f=[];for(let b=0,_=s.length;b<_;b++){const x=s[b],c=v(x,G)[h];c&&(k(c,U,v(x,U)),g?(v(c,G)["*"]&&a.push(...C(this,ne,ye).call(this,v(c,G)["*"],t,v(x,U))),a.push(...C(this,ne,ye).call(this,c,t,v(x,U)))):f.push(c));for(let p=0,m=v(x,_e).length;p<m;p++){const y=v(x,_e)[p],w=v(x,U)===Be?{}:{...v(x,U)};if(y==="*"){const A=v(x,G)["*"];A&&(a.push(...C(this,ne,ye).call(this,A,t,v(x,U))),k(A,U,w),f.push(A));continue}const[T,I,R]=y;if(!h&&!(R instanceof RegExp))continue;const D=v(x,G)[T],N=o.slice(d).join("/");if(R instanceof RegExp){const A=R.exec(N);if(A){if(w[I]=A[0],a.push(...C(this,ne,ye).call(this,D,t,v(x,U),w)),Object.keys(v(D,G)).length){k(D,U,w);const q=((l=A[0].match(/\//))==null?void 0:l.length)??0;(i[q]||(i[q]=[])).push(D)}continue}}(R===!0||R.test(h))&&(w[I]=h,g?(a.push(...C(this,ne,ye).call(this,D,t,w,v(x,U))),v(D,G)["*"]&&a.push(...C(this,ne,ye).call(this,v(D,G)["*"],t,w,v(x,U)))):(k(D,U,w),f.push(D)))}}s=f.concat(i.shift()??[])}return a.length>1&&a.sort((d,u)=>d.score-u.score),[a.map(({handler:d,params:u})=>[d,u])]}},pe=new WeakMap,G=new WeakMap,_e=new WeakMap,Ne=new WeakMap,U=new WeakMap,ne=new WeakSet,ye=function(t,r,a,n){const s=[];for(let o=0,i=v(t,pe).length;o<i;o++){const l=v(t,pe)[o],d=l[r]||l[j],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),a!==Be||n&&n!==Be))for(let h=0,g=d.possibleKeys.length;h<g;h++){const f=d.possibleKeys[h],b=u[d.score];d.params[f]=n!=null&&n[f]&&!b?n[f]:a[f]??(n==null?void 0:n[f]),u[d.score]=!0}}return s},$e),xe,Vt,xa=(Vt=class{constructor(){E(this,"name","TrieRouter");O(this,xe);k(this,xe,new _a)}add(e,t,r){const a=Qt(t);if(a){for(let n=0,s=a.length;n<s;n++)v(this,xe).insert(e,a[n],r);return}v(this,xe).insert(e,t,r)}match(e,t){return v(this,xe).search(e,t)}},xe=new WeakMap,Vt),he=class extends ca{constructor(e={}){super(e),this.router=e.router??new wa({routers:[new ba,new xa]})}},Ea=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(r.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(o,i){var u;function l(h,g){o.res.headers.set(h,g)}const d=await a(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const h=await n(o.req.header("origin")||"",o);h.length&&l("Access-Control-Allow-Methods",h.join(","));let g=r.allowHeaders;if(!(g!=null&&g.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(g=f.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function pr(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`)}}const Ia=["llm_slot_1","llm_slot_2","llm_slot_3"],Oa=["anthropic","openai"];async function Ze(e,t,r){const{decrypt:a}=await Promise.resolve().then(()=>ka),n=new vr(e,t),s=new gr(e,t),o=await s.checkCaps();if(!o.allowed)throw new Error(o.reason||"Daily usage limit reached.");const i=[];for(const f of Ia){const b=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,f).first();if(b)try{const _=await a(b.encrypted_value,r),x=JSON.parse(_);if(x.provider&&x.apiKey&&ze[x.provider]){const p=x.provider,m=bt(x.provider,x.apiKey,p,x.model);i.push({name:p,provider:m})}}catch(_){console.error(`Failed to load ${f}:`,_)}}const l=new Set(i.map(f=>f.name));for(const f of Oa){if(l.has(f))continue;const b=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,f).first();if(b)try{const _=await a(b.encrypted_value,r);if(ze[f]){const c=bt(f,_,f);i.push({name:f,provider:c})}}catch{console.error(`Failed to decrypt legacy ${f} key`)}}if(i.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const d=i.map(f=>f.name),u=await n.pickProvider(d);if(!u)return console.warn("All providers in cooldown, using first available"),{provider:i[0].provider,rotation:n,costGuard:s};const h=i.find(f=>f.name===u);return{provider:Ca(h.provider,i,n),rotation:n,costGuard:s}}function Ca(e,t,r){return t.length<=1?e:{name:e.name,async chat(a,n){try{return await e.chat(a,n)}catch(s){const o=s.message||"";if(!(o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")))throw s;console.warn(`Provider ${e.name} auth/billing error, trying fallback...`),await r.recordError(e.name,o,1440);const l=t.filter(d=>d.name!==e.name);for(const d of l)try{const u=await d.provider.chat(a,n);return this.name=d.name,u}catch(u){const h=u.message||"";if(h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance")||h.includes("properties field not found")){await r.recordError(d.name,h,1440);continue}throw u}throw new Error(`All LLM providers failed. Primary (${e.name}): ${o.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(a,n){return await e.streamChat(a,n)}}}const it=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:fr,CostGuard:gr,OpenAICompatibleProvider:yr,ProviderRotation:vr,createProviderFromConfig:bt,createRotatingProvider:Ze,logError:S},Symbol.toStringTag,{value:"Module"})),ht=20,Ra=2e3,Da=2e3,br=4;function Aa(e){return Math.ceil(e.length/br)}function jt(e,t){const r=t*br;return e.length<=r?e:e.slice(0,r)+`
...
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(c){return await S(r,a,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||""),p=t.calendar_id||"primary",m=t.days_ahead||7,y=new Date,w=new Date(y.getTime()+m*24*60*60*1e3),T=await c.calendar.listEvents(p,{timeMin:y.toISOString(),timeMax:w.toISOString(),query:t.query});return T.length===0?`No events found in the next ${m} days.`:T.map(I=>{var q;const R=I.start.dateTime||I.start.date||"TBD",D=I.end.dateTime||I.end.date||"",N=I.location?` 📍 ${I.location}`:"",A=((q=I.attendees)==null?void 0:q.map(Q=>Q.email).join(", "))||"";return`• ${I.summary} — ${R} to ${D}${N}${A?`
  Attendees: ${A}`:""}`}).join(`
...
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await S(r,a,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const p=await new ee(r,a,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return p.length===0?"No messages found.":p.map((m,y)=>`${m.isUnread?"● ":"  "}${y+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`
...
\r
`+p.data_base64+`\r
--`+I+"--",N=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart&fields=id,name,webViewLink,size",{method:"POST",headers:{Authorization:`Bearer ${m}`,"Content-Type":`multipart/related; boundary=${I}`},body:D});if(!N.ok){const Q=await N.text();throw new Error(`Drive upload failed (${N.status}): ${Q}`)}const A=await N.json(),q=t.folder_name?` in folder "${t.folder_name}"`:"";return`✅ Uploaded **${A.name}**${q} to Google Drive.
...
`)}catch(c){return await S(r,a,"google_api","search_places",c.message),`Places search error: ${c.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const p=await $(c.encrypted_value,n),m=await Fa(p,t.place_id);if(m.error)return`Details lookup failed: ${m.error}`;if(!m.details)return"No details found.";const y=m.details;let w=`**${y.name}**
...
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return w}catch(c){return await S(r,a,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const p=await $(c.encrypted_value,n),m=await qa(p,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const y=m.route;let w=`**${y.startAddress}** → **${y.endAddress}**
`;return w+=`📏 ${y.distance} · ⏱️ ${y.duration}`,y.durationInTraffic&&(w+=` (with traffic: ${y.durationInTraffic})`),w+=`
via ${y.summary}`,w+=`

Steps:`,y.steps.forEach((T,I)=>{w+=`
${I+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),w}catch(c){return await S(r,a,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const p=await $(c.encrypted_value,n),m=await Ja(p,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let y=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(y+=` (with traffic: ${m.durationInTraffic})`),y}catch(c){return await S(r,a,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const p=await $(c.encrypted_value,n),m=await za(p,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(c){return await S(r,a,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const p=await $(c.encrypted_value,n),m=await Ka(p,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((y,w)=>{var T;return`${w+1}. **${y.title}**
...
`)}catch(c){return await S(r,a,"system","list_features",c.message),`Error listing features: ${c.message}`}case"update_feature_request":try{const c=t.feature_id,p=[],m=[];return t.status&&(p.push("status = ?"),m.push(t.status)),t.notes&&(p.push("implementation_notes = ?"),m.push(t.notes)),p.length===0?"No updates specified.":(p.push("updated_at = CURRENT_TIMESTAMP"),m.push(c,a),await r.prepare(`UPDATE feature_requests SET ${p.join(", ")} WHERE id = ? AND user_id = ?`).bind(...m).run(),`Feature request #${c} updated.`)}catch(c){return await S(r,a,"system","update_feature",c.message),`Error updating feature: ${c.message}`}default:return`Unknown tool: ${e}`}}async function Ot(e,t,r,a,n,s){var _;const o=new me(t),i=(_=e.metadata)==null?void 0:_.thread_id,l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,15,i),h=[{role:"system",content:$r(a,l)},...d.map(x=>({role:x.role,content:x.content})),{role:"user",content:e.text}];await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let f="",b=0;for(let x=0;x<g;x++)try{const c=await r.chat(h,{tools:Nr});if(c.usage&&(b+=c.usage.promptTokens+c.usage.completionTokens),c.toolCalls&&c.toolCalls.length>0){c.content&&h.push({role:"assistant",content:c.content});for(const p of c.toolCalls)try{const m=await Mr(p.name,p.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);h.push({role:"user",content:`[Tool Result for ${p.name}]: ${m}`})}catch(m){await S(t,a.id,"tool",p.name,m.message||"Tool execution failed"),h.push({role:"user",content:`[Tool Error for ${p.name}]: ${m.message||"Execution failed"}`})}continue}f=c.content;break}catch(c){if(n){const p=c.message||"",m=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),y=p.includes("429"),w=m?1440:y?10:5;await n.recordError(r.name,p,w)}throw await S(t,a.id,"llm","provider_error",c.message||"Unknown LLM error",{provider:r.name,turn:x}),c}return n&&b>0&&await n.recordUsage(r.name,b),await o.storeMessage(a.id,e.channel,"assistant",f,"{}",i),await o.compactHistory(a.id,30),f}const Ht={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function an(e){for(const[t,r]of Object.entries(Ht))if(e.toLowerCase().includes(t.toLowerCase()))return r;return Ht.default}function nn(e,t,r,a){const n=an(a),s=Math.floor(n*.75),o=[];let i=0,l=!1;const d=ft(e);o.push({role:"system",content:e}),i+=d;const u=ft(r);i+=u;const h=s-i,g=[];let f=0;for(let b=t.length-1;b>=0;b--){const _=t[b],x=ft(_.content);if(f+x<=h)g.unshift({role:_.role,content:_.content}),f+=x;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:r}),i+=f,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*sn(e,t,r,a,n,s){var x;const o=new me(t),i=(x=e.metadata)==null?void 0:x.thread_id;yield{type:"thinking",data:{threadId:i,provider:r.name}};const l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,20,i),u=$r(a,l),h=nn(u,d,e.text,r.name);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const g=10;let f="",b=0;const _=[...h.messages];for(let c=0;c<g;c++)try{c>0&&(yield{type:"thinking",data:{threadId:i}});const p=await r.chat(_,{tools:Nr});if(p.usage&&(b+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},_.push({role:"assistant",content:p.content}));for(const y of p.toolCalls){yield{type:"tool_start",data:{tool:y.name,toolArgs:y.arguments,threadId:i}};try{const w=await Mr(y.name,y.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);yield{type:"tool_end",data:{tool:y.name,toolResult:w.substring(0,500)+(w.length>500?"...":""),threadId:i}},_.push({role:"user",content:`[Tool Result for ${y.name}]: ${w}`})}catch(w){await S(t,a.id,"tool",y.name,w.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:y.name,toolResult:`Error: ${w.message||"Execution failed"}`,threadId:i}},_.push({role:"user",content:`[Tool Error for ${y.name}]: ${w.message||"Execution failed"}`})}}continue}f=p.content;const m=50;for(let y=0;y<f.length;y+=m)yield{type:"chunk",data:{text:f.substring(y,y+m),threadId:i}},y+m<f.length&&await new Promise(T=>setTimeout(T,10));break}catch(p){if(n){const m=p.message||"",y=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),w=m.includes("429"),T=y?1440:w?10:5;await n.recordError(r.name,m,T)}await S(t,a.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:r.name,turn:c}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}n&&b>0&&await n.recordUsage(r.name,b),await o.storeMessage(a.id,e.channel,"assistant",f,"{}",i),await o.compactHistory(a.id,30),yield{type:"done",data:{threadId:i,provider:r.name,tokenCount:b}}}const M=new he;async function on(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
