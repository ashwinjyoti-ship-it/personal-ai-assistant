var Ba=Object.defineProperty;var is=e=>{throw TypeError(e)};var Ua=(e,t,n)=>t in e?Ba(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var U=(e,t,n)=>Ua(e,typeof t!="symbol"?t+"":t,n),wn=(e,t,n)=>t.has(e)||is("Cannot "+n);var D=(e,t,n)=>(wn(e,t,"read from private field"),n?n.call(e):t.get(e)),V=(e,t,n)=>t.has(e)?is("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),F=(e,t,n,s)=>(wn(e,t,"write to private field"),s?s.call(e,n):t.set(e,n),n),ee=(e,t,n)=>(wn(e,t,"access private method"),n);var os=(e,t,n,s)=>({set _(r){F(e,t,r,n)},get _(){return D(e,t,s)}});var ls=(e,t,n)=>(s,r)=>{let a=-1;return i(0);async function i(o){if(o<=a)throw new Error("next() called multiple times");a=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],s.req.routeIndex=o):d=o===e.length&&r||void 0,d)try{l=await d(s,()=>i(o+1))}catch(u){if(u instanceof Error&&t)s.error=u,l=await t(u,s),c=!0;else throw u}else s.finalized===!1&&n&&(l=await n(s));return l&&(s.finalized===!1||c)&&(s.res=l),s}},Ha=Symbol(),Fa=async(e,t=Object.create(null))=>{const{all:n=!1,dot:s=!1}=t,a=(e instanceof Js?e.raw.headers:e.headers).get("Content-Type");return a!=null&&a.startsWith("multipart/form-data")||a!=null&&a.startsWith("application/x-www-form-urlencoded")?Wa(e,{all:n,dot:s}):{}};async function Wa(e,t){const n=await e.formData();return n?qa(n,t):{}}function qa(e,t){const n=Object.create(null);return e.forEach((s,r)=>{t.all||r.endsWith("[]")?Ga(n,r,s):n[r]=s}),t.dot&&Object.entries(n).forEach(([s,r])=>{s.includes(".")&&(za(n,s,r),delete n[s])}),n}var Ga=(e,t,n)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(n):e[t]=[e[t],n]:t.endsWith("[]")?e[t]=[n]:e[t]=n},za=(e,t,n)=>{let s=e;const r=t.split(".");r.forEach((a,i)=>{i===r.length-1?s[a]=n:((!s[a]||typeof s[a]!="object"||Array.isArray(s[a])||s[a]instanceof File)&&(s[a]=Object.create(null)),s=s[a])})},qs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Ka=e=>{const{groups:t,path:n}=Ya(e),s=qs(n);return Ja(s,t)},Ya=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(n,s)=>{const r=`@${s}`;return t.push([r,n]),r}),{groups:t,path:e}},Ja=(e,t)=>{for(let n=t.length-1;n>=0;n--){const[s]=t[n];for(let r=e.length-1;r>=0;r--)if(e[r].includes(s)){e[r]=e[r].replace(s,t[n][1]);break}}return e},en={},Va=(e,t)=>{if(e==="*")return"*";const n=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(n){const s=`${e}#${t}`;return en[s]||(n[2]?en[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,n[1],new RegExp(`^${n[2]}(?=/${t})`)]:[e,n[1],new RegExp(`^${n[2]}$`)]:en[s]=[e,n[1],!0]),en[s]}return null},jn=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,n=>{try{return t(n)}catch{return n}})}},Za=e=>jn(e,decodeURI),Gs=e=>{const t=e.url,n=t.indexOf("/",t.indexOf(":")+4);let s=n;for(;s<t.length;s++){const r=t.charCodeAt(s);if(r===37){const a=t.indexOf("?",s),i=t.indexOf("#",s),o=a===-1?i===-1?void 0:i:i===-1?a:Math.min(a,i),l=t.slice(n,o);return Za(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(n,s)},Xa=e=>{const t=Gs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},yt=(e,t,...n)=>(n.length&&(t=yt(t,...n)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),zs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),n=[];let s="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))s+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){n.length===0&&s===""?n.push("/"):n.push(s);const a=r.replace("?","");s+="/"+a,n.push(s)}else s+="/"+r}),n.filter((r,a,i)=>i.indexOf(r)===a)},_n=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?jn(e,Ys):e):e,Ks=(e,t,n)=>{let s;if(!n&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return _n(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(s=/[%+]/.test(e),!s)return}const r={};s??(s=/[%+]/.test(e));let a=e.indexOf("?",8);for(;a!==-1;){const i=e.indexOf("&",a+1);let o=e.indexOf("=",a);o>i&&i!==-1&&(o=-1);let l=e.slice(a+1,o===-1?i===-1?void 0:i:o);if(s&&(l=_n(l)),a=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),s&&(c=_n(c))),n?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(c)):r[l]??(r[l]=c)}return t?r[t]:r},Qa=Ks,ei=(e,t)=>Ks(e,t,!0),Ys=decodeURIComponent,cs=e=>jn(e,Ys),Tt,Se,Fe,Vs,Zs,Rn,qe,js,Js=(js=class{constructor(e,t="/",n=[[]]){V(this,Fe);U(this,"raw");V(this,Tt);V(this,Se);U(this,"routeIndex",0);U(this,"path");U(this,"bodyCache",{});V(this,qe,e=>{const{bodyCache:t,raw:n}=this,s=t[e];if(s)return s;const r=Object.keys(t)[0];return r?t[r].then(a=>(r==="json"&&(a=JSON.stringify(a)),new Response(a)[e]())):t[e]=n[e]()});this.raw=e,this.path=t,F(this,Se,n),F(this,Tt,{})}param(e){return e?ee(this,Fe,Vs).call(this,e):ee(this,Fe,Zs).call(this)}query(e){return Qa(this.url,e)}queries(e){return ei(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((n,s)=>{t[s]=n}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Fa(this,e))}json(){return D(this,qe).call(this,"text").then(e=>JSON.parse(e))}text(){return D(this,qe).call(this,"text")}arrayBuffer(){return D(this,qe).call(this,"arrayBuffer")}blob(){return D(this,qe).call(this,"blob")}formData(){return D(this,qe).call(this,"formData")}addValidatedData(e,t){D(this,Tt)[e]=t}valid(e){return D(this,Tt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ha](){return D(this,Se)}get matchedRoutes(){return D(this,Se)[0].map(([[,e]])=>e)}get routePath(){return D(this,Se)[0].map(([[,e]])=>e)[this.routeIndex].path}},Tt=new WeakMap,Se=new WeakMap,Fe=new WeakSet,Vs=function(e){const t=D(this,Se)[0][this.routeIndex][1][e],n=ee(this,Fe,Rn).call(this,t);return n&&/\%/.test(n)?cs(n):n},Zs=function(){const e={},t=Object.keys(D(this,Se)[0][this.routeIndex][1]);for(const n of t){const s=ee(this,Fe,Rn).call(this,D(this,Se)[0][this.routeIndex][1][n]);s!==void 0&&(e[n]=/\%/.test(s)?cs(s):s)}return e},Rn=function(e){return D(this,Se)[1]?D(this,Se)[1][e]:e},qe=new WeakMap,js),ti={Stringify:1},Xs=async(e,t,n,s,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const a=e.callbacks;return a!=null&&a.length?(r?r[0]+=e:r=[e],Promise.all(a.map(o=>o({phase:t,buffer:r,context:s}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Xs(l,t,!1,s,r))).then(()=>r[0]))):Promise.resolve(e)},ni="text/plain; charset=UTF-8",bn=(e,t)=>({"Content-Type":e,...t}),qt,Gt,je,St,Be,_e,zt,kt,xt,at,Kt,Yt,Ge,vt,Bs,si=(Bs=class{constructor(e,t){V(this,Ge);V(this,qt);V(this,Gt);U(this,"env",{});V(this,je);U(this,"finalized",!1);U(this,"error");V(this,St);V(this,Be);V(this,_e);V(this,zt);V(this,kt);V(this,xt);V(this,at);V(this,Kt);V(this,Yt);U(this,"render",(...e)=>(D(this,kt)??F(this,kt,t=>this.html(t)),D(this,kt).call(this,...e)));U(this,"setLayout",e=>F(this,zt,e));U(this,"getLayout",()=>D(this,zt));U(this,"setRenderer",e=>{F(this,kt,e)});U(this,"header",(e,t,n)=>{this.finalized&&F(this,_e,new Response(D(this,_e).body,D(this,_e)));const s=D(this,_e)?D(this,_e).headers:D(this,at)??F(this,at,new Headers);t===void 0?s.delete(e):n!=null&&n.append?s.append(e,t):s.set(e,t)});U(this,"status",e=>{F(this,St,e)});U(this,"set",(e,t)=>{D(this,je)??F(this,je,new Map),D(this,je).set(e,t)});U(this,"get",e=>D(this,je)?D(this,je).get(e):void 0);U(this,"newResponse",(...e)=>ee(this,Ge,vt).call(this,...e));U(this,"body",(e,t,n)=>ee(this,Ge,vt).call(this,e,t,n));U(this,"text",(e,t,n)=>!D(this,at)&&!D(this,St)&&!t&&!n&&!this.finalized?new Response(e):ee(this,Ge,vt).call(this,e,t,bn(ni,n)));U(this,"json",(e,t,n)=>ee(this,Ge,vt).call(this,JSON.stringify(e),t,bn("application/json",n)));U(this,"html",(e,t,n)=>{const s=r=>ee(this,Ge,vt).call(this,r,t,bn("text/html; charset=UTF-8",n));return typeof e=="object"?Xs(e,ti.Stringify,!1,{}).then(s):s(e)});U(this,"redirect",(e,t)=>{const n=String(e);return this.header("Location",/[^\x00-\xFF]/.test(n)?encodeURI(n):n),this.newResponse(null,t??302)});U(this,"notFound",()=>(D(this,xt)??F(this,xt,()=>new Response),D(this,xt).call(this,this)));F(this,qt,e),t&&(F(this,Be,t.executionCtx),this.env=t.env,F(this,xt,t.notFoundHandler),F(this,Yt,t.path),F(this,Kt,t.matchResult))}get req(){return D(this,Gt)??F(this,Gt,new Js(D(this,qt),D(this,Yt),D(this,Kt))),D(this,Gt)}get event(){if(D(this,Be)&&"respondWith"in D(this,Be))return D(this,Be);throw Error("This context has no FetchEvent")}get executionCtx(){if(D(this,Be))return D(this,Be);throw Error("This context has no ExecutionContext")}get res(){return D(this,_e)||F(this,_e,new Response(null,{headers:D(this,at)??F(this,at,new Headers)}))}set res(e){if(D(this,_e)&&e){e=new Response(e.body,e);for(const[t,n]of D(this,_e).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=D(this,_e).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of s)e.headers.append("set-cookie",r)}else e.headers.set(t,n)}F(this,_e,e),this.finalized=!0}get var(){return D(this,je)?Object.fromEntries(D(this,je)):{}}},qt=new WeakMap,Gt=new WeakMap,je=new WeakMap,St=new WeakMap,Be=new WeakMap,_e=new WeakMap,zt=new WeakMap,kt=new WeakMap,xt=new WeakMap,at=new WeakMap,Kt=new WeakMap,Yt=new WeakMap,Ge=new WeakSet,vt=function(e,t,n){const s=D(this,_e)?new Headers(D(this,_e).headers):D(this,at)??new Headers;if(typeof t=="object"&&"headers"in t){const a=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of a)i.toLowerCase()==="set-cookie"?s.append(i,o):s.set(i,o)}if(n)for(const[a,i]of Object.entries(n))if(typeof i=="string")s.set(a,i);else{s.delete(a);for(const o of i)s.append(a,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??D(this,St);return new Response(e,{status:r,headers:s})},Bs),ue="ALL",ri="all",ai=["get","post","put","delete","options","patch"],Qs="Can not add a route since the matcher is already built.",er=class extends Error{},ii="__COMPOSED_HANDLER",oi=e=>e.text("404 Not Found",404),ds=(e,t)=>{if("getResponse"in e){const n=e.getResponse();return t.newResponse(n.body,n)}return console.error(e),t.text("Internal Server Error",500)},Re,me,tr,Ie,st,rn,an,Dt,li=(Dt=class{constructor(t={}){V(this,me);U(this,"get");U(this,"post");U(this,"put");U(this,"delete");U(this,"options");U(this,"patch");U(this,"all");U(this,"on");U(this,"use");U(this,"router");U(this,"getPath");U(this,"_basePath","/");V(this,Re,"/");U(this,"routes",[]);V(this,Ie,oi);U(this,"errorHandler",ds);U(this,"onError",t=>(this.errorHandler=t,this));U(this,"notFound",t=>(F(this,Ie,t),this));U(this,"fetch",(t,...n)=>ee(this,me,an).call(this,t,n[1],n[0],t.method));U(this,"request",(t,n,s,r)=>t instanceof Request?this.fetch(n?new Request(t,n):t,s,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${yt("/",t)}`,n),s,r)));U(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(ee(this,me,an).call(this,t.request,t,void 0,t.request.method))})});[...ai,ri].forEach(a=>{this[a]=(i,...o)=>(typeof i=="string"?F(this,Re,i):ee(this,me,st).call(this,a,D(this,Re),i),o.forEach(l=>{ee(this,me,st).call(this,a,D(this,Re),l)}),this)}),this.on=(a,i,...o)=>{for(const l of[i].flat()){F(this,Re,l);for(const c of[a].flat())o.map(d=>{ee(this,me,st).call(this,c.toUpperCase(),D(this,Re),d)})}return this},this.use=(a,...i)=>(typeof a=="string"?F(this,Re,a):(F(this,Re,"*"),i.unshift(a)),i.forEach(o=>{ee(this,me,st).call(this,ue,D(this,Re),o)}),this);const{strict:s,...r}=t;Object.assign(this,r),this.getPath=s??!0?t.getPath??Gs:Xa}route(t,n){const s=this.basePath(t);return n.routes.map(r=>{var i;let a;n.errorHandler===ds?a=r.handler:(a=async(o,l)=>(await ls([],n.errorHandler)(o,()=>r.handler(o,l))).res,a[ii]=r.handler),ee(i=s,me,st).call(i,r.method,r.path,a)}),this}basePath(t){const n=ee(this,me,tr).call(this);return n._basePath=yt(this._basePath,t),n}mount(t,n,s){let r,a;s&&(typeof s=="function"?a=s:(a=s.optionHandler,s.replaceRequest===!1?r=l=>l:r=s.replaceRequest));const i=a?l=>{const c=a(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};r||(r=(()=>{const l=yt(this._basePath,t),c=l==="/"?0:l.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const o=async(l,c)=>{const d=await n(r(l.req.raw),...i(l));if(d)return d;await c()};return ee(this,me,st).call(this,ue,yt(t,"*"),o),this}},Re=new WeakMap,me=new WeakSet,tr=function(){const t=new Dt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,Ie,D(this,Ie)),t.routes=this.routes,t},Ie=new WeakMap,st=function(t,n,s){t=t.toUpperCase(),n=yt(this._basePath,n);const r={basePath:this._basePath,path:n,method:t,handler:s};this.router.add(t,n,[s,r]),this.routes.push(r)},rn=function(t,n){if(t instanceof Error)return this.errorHandler(t,n);throw t},an=function(t,n,s,r){if(r==="HEAD")return(async()=>new Response(null,await ee(this,me,an).call(this,t,n,s,"GET")))();const a=this.getPath(t,{env:s}),i=this.router.match(r,a),o=new si(t,{path:a,matchResult:i,env:s,executionCtx:n,notFoundHandler:D(this,Ie)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await D(this,Ie).call(this,o)})}catch(d){return ee(this,me,rn).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:D(this,Ie).call(this,o))).catch(d=>ee(this,me,rn).call(this,d,o)):c??D(this,Ie).call(this,o)}const l=ls(i[0],this.errorHandler,D(this,Ie));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return ee(this,me,rn).call(this,c,o)}})()},Dt),nr=[];function ci(e,t){const n=this.buildAllMatchers(),s=((r,a)=>{const i=n[r]||n[ue],o=i[2][a];if(o)return o;const l=a.match(i[0]);if(!l)return[[],nr];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=s,s(e,t)}var cn="[^/]+",Pt=".*",jt="(?:|/.*)",wt=Symbol(),di=new Set(".\\+*[^]$()");function ui(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Pt||e===jt?1:t===Pt||t===jt?-1:e===cn?1:t===cn?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var it,ot,Ne,dt,mi=(dt=class{constructor(){V(this,it);V(this,ot);V(this,Ne,Object.create(null))}insert(t,n,s,r,a){if(t.length===0){if(D(this,it)!==void 0)throw wt;if(a)return;F(this,it,n);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Pt]:["","",cn]:i==="/*"?["","",jt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let u=l[2]||cn;if(d&&l[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw wt;if(c=D(this,Ne)[u],!c){if(Object.keys(D(this,Ne)).some(p=>p!==Pt&&p!==jt))throw wt;if(a)return;c=D(this,Ne)[u]=new dt,d!==""&&F(c,ot,r.varIndex++)}!a&&d!==""&&s.push([d,D(c,ot)])}else if(c=D(this,Ne)[i],!c){if(Object.keys(D(this,Ne)).some(d=>d.length>1&&d!==Pt&&d!==jt))throw wt;if(a)return;c=D(this,Ne)[i]=new dt}c.insert(o,n,s,r,a)}buildRegExpStr(){const n=Object.keys(D(this,Ne)).sort(ui).map(s=>{const r=D(this,Ne)[s];return(typeof D(r,ot)=="number"?`(${s})@${D(r,ot)}`:di.has(s)?`\\${s}`:s)+r.buildRegExpStr()});return typeof D(this,it)=="number"&&n.unshift(`#${D(this,it)}`),n.length===0?"":n.length===1?n[0]:"(?:"+n.join("|")+")"}},it=new WeakMap,ot=new WeakMap,Ne=new WeakMap,dt),dn,Jt,Us,pi=(Us=class{constructor(){V(this,dn,{varIndex:0});V(this,Jt,new mi)}insert(e,t,n){const s=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return r[i]=[c,l],i++,o=!0,c}),!o)break}const a=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=a.length-1;l>=0;l--)if(a[l].indexOf(o)!==-1){a[l]=a[l].replace(o,r[i][1]);break}}return D(this,Jt).insert(a,t,s,D(this,dn),n),s}buildRegExp(){let e=D(this,Jt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const n=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,a,i)=>a!==void 0?(n[++t]=Number(a),"$()"):(i!==void 0&&(s[Number(i)]=++t),"")),[new RegExp(`^${e}`),n,s]}},dn=new WeakMap,Jt=new WeakMap,Us),hi=[/^$/,[],Object.create(null)],on=Object.create(null);function sr(e){return on[e]??(on[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,n)=>n?`\\${n}`:"(?:|/.*)")}$`))}function gi(){on=Object.create(null)}function fi(e){var c;const t=new pi,n=[];if(e.length===0)return hi;const s=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[p,v])=>d?1:p?-1:u.length-v.length),r=Object.create(null);for(let d=0,u=-1,p=s.length;d<p;d++){const[v,g,f]=s[d];v?r[g]=[f.map(([_])=>[_,Object.create(null)]),nr]:u++;let y;try{y=t.insert(g,u,v)}catch(_){throw _===wt?new er(g):_}v||(n[u]=f.map(([_,T])=>{const x=Object.create(null);for(T-=1;T>=0;T--){const[L,N]=y[T];x[L]=N}return[_,x]}))}const[a,i,o]=t.buildRegExp();for(let d=0,u=n.length;d<u;d++)for(let p=0,v=n[d].length;p<v;p++){const g=(c=n[d][p])==null?void 0:c[1];if(!g)continue;const f=Object.keys(g);for(let y=0,_=f.length;y<_;y++)g[f[y]]=o[g[f[y]]]}const l=[];for(const d in i)l[d]=n[i[d]];return[a,l,r]}function pt(e,t){if(e){for(const n of Object.keys(e).sort((s,r)=>r.length-s.length))if(sr(n).test(t))return[...e[n]]}}var ze,Ke,un,rr,Hs,yi=(Hs=class{constructor(){V(this,un);U(this,"name","RegExpRouter");V(this,ze);V(this,Ke);U(this,"match",ci);F(this,ze,{[ue]:Object.create(null)}),F(this,Ke,{[ue]:Object.create(null)})}add(e,t,n){var o;const s=D(this,ze),r=D(this,Ke);if(!s||!r)throw new Error(Qs);s[e]||[s,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ue]).forEach(c=>{l[e][c]=[...l[ue][c]]})}),t==="/*"&&(t="*");const a=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=sr(t);e===ue?Object.keys(s).forEach(c=>{var d;(d=s[c])[t]||(d[t]=pt(s[c],t)||pt(s[ue],t)||[])}):(o=s[e])[t]||(o[t]=pt(s[e],t)||pt(s[ue],t)||[]),Object.keys(s).forEach(c=>{(e===ue||e===c)&&Object.keys(s[c]).forEach(d=>{l.test(d)&&s[c][d].push([n,a])})}),Object.keys(r).forEach(c=>{(e===ue||e===c)&&Object.keys(r[c]).forEach(d=>l.test(d)&&r[c][d].push([n,a]))});return}const i=zs(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(r).forEach(u=>{var p;(e===ue||e===u)&&((p=r[u])[d]||(p[d]=[...pt(s[u],d)||pt(s[ue],d)||[]]),r[u][d].push([n,a-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(D(this,Ke)).concat(Object.keys(D(this,ze))).forEach(t=>{e[t]||(e[t]=ee(this,un,rr).call(this,t))}),F(this,ze,F(this,Ke,void 0)),gi(),e}},ze=new WeakMap,Ke=new WeakMap,un=new WeakSet,rr=function(e){const t=[];let n=e===ue;return[D(this,ze),D(this,Ke)].forEach(s=>{const r=s[e]?Object.keys(s[e]).map(a=>[a,s[e][a]]):[];r.length!==0?(n||(n=!0),t.push(...r)):e!==ue&&t.push(...Object.keys(s[ue]).map(a=>[a,s[ue][a]]))}),n?fi(t):null},Hs),Ye,Ue,Fs,vi=(Fs=class{constructor(e){U(this,"name","SmartRouter");V(this,Ye,[]);V(this,Ue,[]);F(this,Ye,e.routers)}add(e,t,n){if(!D(this,Ue))throw new Error(Qs);D(this,Ue).push([e,t,n])}match(e,t){if(!D(this,Ue))throw new Error("Fatal error");const n=D(this,Ye),s=D(this,Ue),r=n.length;let a=0,i;for(;a<r;a++){const o=n[a];try{for(let l=0,c=s.length;l<c;l++)o.add(...s[l]);i=o.match(e,t)}catch(l){if(l instanceof er)continue;throw l}this.match=o.match.bind(o),F(this,Ye,[o]),F(this,Ue,void 0);break}if(a===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(D(this,Ue)||D(this,Ye).length!==1)throw new Error("No active router has been determined yet.");return D(this,Ye)[0]}},Ye=new WeakMap,Ue=new WeakMap,Fs),Lt=Object.create(null),Je,ve,lt,Rt,fe,He,rt,It,wi=(It=class{constructor(t,n,s){V(this,He);V(this,Je);V(this,ve);V(this,lt);V(this,Rt,0);V(this,fe,Lt);if(F(this,ve,s||Object.create(null)),F(this,Je,[]),t&&n){const r=Object.create(null);r[t]={handler:n,possibleKeys:[],score:0},F(this,Je,[r])}F(this,lt,[])}insert(t,n,s){F(this,Rt,++os(this,Rt)._);let r=this;const a=Ka(n),i=[];for(let o=0,l=a.length;o<l;o++){const c=a[o],d=a[o+1],u=Va(c,d),p=Array.isArray(u)?u[0]:c;if(p in D(r,ve)){r=D(r,ve)[p],u&&i.push(u[1]);continue}D(r,ve)[p]=new It,u&&(D(r,lt).push(u),i.push(u[1])),r=D(r,ve)[p]}return D(r,Je).push({[t]:{handler:s,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:D(this,Rt)}}),r}search(t,n){var l;const s=[];F(this,fe,Lt);let a=[this];const i=qs(n),o=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],p=c===d-1,v=[];for(let g=0,f=a.length;g<f;g++){const y=a[g],_=D(y,ve)[u];_&&(F(_,fe,D(y,fe)),p?(D(_,ve)["*"]&&s.push(...ee(this,He,rt).call(this,D(_,ve)["*"],t,D(y,fe))),s.push(...ee(this,He,rt).call(this,_,t,D(y,fe)))):v.push(_));for(let T=0,x=D(y,lt).length;T<x;T++){const L=D(y,lt)[T],N=D(y,fe)===Lt?{}:{...D(y,fe)};if(L==="*"){const j=D(y,ve)["*"];j&&(s.push(...ee(this,He,rt).call(this,j,t,D(y,fe))),F(j,fe,N),v.push(j));continue}const[M,P,z]=L;if(!u&&!(z instanceof RegExp))continue;const W=D(y,ve)[M],ne=i.slice(c).join("/");if(z instanceof RegExp){const j=z.exec(ne);if(j){if(N[P]=j[0],s.push(...ee(this,He,rt).call(this,W,t,D(y,fe),N)),Object.keys(D(W,ve)).length){F(W,fe,N);const Y=((l=j[0].match(/\//))==null?void 0:l.length)??0;(o[Y]||(o[Y]=[])).push(W)}continue}}(z===!0||z.test(u))&&(N[P]=u,p?(s.push(...ee(this,He,rt).call(this,W,t,N,D(y,fe))),D(W,ve)["*"]&&s.push(...ee(this,He,rt).call(this,D(W,ve)["*"],t,N,D(y,fe)))):(F(W,fe,N),v.push(W)))}}a=v.concat(o.shift()??[])}return s.length>1&&s.sort((c,d)=>c.score-d.score),[s.map(({handler:c,params:d})=>[c,d])]}},Je=new WeakMap,ve=new WeakMap,lt=new WeakMap,Rt=new WeakMap,fe=new WeakMap,He=new WeakSet,rt=function(t,n,s,r){const a=[];for(let i=0,o=D(t,Je).length;i<o;i++){const l=D(t,Je)[i],c=l[n]||l[ue],d={};if(c!==void 0&&(c.params=Object.create(null),a.push(c),s!==Lt||r&&r!==Lt))for(let u=0,p=c.possibleKeys.length;u<p;u++){const v=c.possibleKeys[u],g=d[c.score];c.params[v]=r!=null&&r[v]&&!g?r[v]:s[v]??(r==null?void 0:r[v]),d[c.score]=!0}}return a},It),ct,Ws,_i=(Ws=class{constructor(){U(this,"name","TrieRouter");V(this,ct);F(this,ct,new wi)}add(e,t,n){const s=zs(t);if(s){for(let r=0,a=s.length;r<a;r++)D(this,ct).insert(e,s[r],n);return}D(this,ct).insert(e,t,n)}match(e,t){return D(this,ct).search(e,t)}},ct=new WeakMap,Ws),be=class extends li{constructor(e={}){super(e),this.router=e.router??new vi({routers:[new yi,new _i]})}},bi=e=>{const n={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(a=>typeof a=="string"?a==="*"?()=>a:i=>a===i?i:null:typeof a=="function"?a:i=>a.includes(i)?i:null)(n.origin),r=(a=>typeof a=="function"?a:Array.isArray(a)?()=>a:()=>[])(n.allowMethods);return async function(i,o){var d;function l(u,p){i.res.headers.set(u,p)}const c=await s(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),n.credentials&&l("Access-Control-Allow-Credentials","true"),(d=n.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",n.exposeHeaders.join(",")),i.req.method==="OPTIONS"){n.origin!=="*"&&l("Vary","Origin"),n.maxAge!=null&&l("Access-Control-Max-Age",n.maxAge.toString());const u=await r(i.req.header("origin")||"",i);u.length&&l("Access-Control-Allow-Methods",u.join(","));let p=n.allowHeaders;if(!(p!=null&&p.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(p=v.split(/\s*,\s*/))}return p!=null&&p.length&&(l("Access-Control-Allow-Headers",p.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),n.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Ei(){return`  // === Karna v3.1 Frontend ===
...
`}function Ti(){return`  // === Render Core ===
  function render() {
    var app = document.getElementById('app');
...
`}function Ii(){return`  // === Memory Review ===
...
`}function Ni(){return`  // === Document Library ===
...
`}function Li(){return`  // === Init ===
  ...
  // ============================================================`}function Mi(){return`  async function renderDocumentsView(container) {
    container.innerHTML = '<div class="page-view">' +
      '<div class="page-header">' +
        '<button class="page-back-btn" onclick="goBack()">&#8592;</button>' +
...
`}function ar(e=""){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}function ji(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover">
...
Check your ${s} API credit balance or key.`;const{decrypt:c}=await Promise.resolve().then(()=>Vt),d=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(d!=null&&d.telegram_chat_id))return;const u=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!u)return;const p=await c(u.encrypted_value,d.pin_hash);await fetch(`https://api.telegram.org/bot${p}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function ms(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class dr{constructor(t,n="claude-sonnet-4-6",s="https://api.anthropic.com",r="anthropic"){U(this,"name");U(this,"apiKey");U(this,"model");U(this,"apiBase");this.apiKey=t,this.model=n,this.apiBase=s,this.name=r}async chat(t,n){var d,u,p,v;const s=t.find(g=>g.role==="system"),r=t.filter(g=>g.role!=="system"),a={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,messages:r.map(g=>({role:g.role,content:g.content}))};s&&(a.system=s.content),n!=null&&n.tools&&n.tools.length>0&&(a.tools=n.tools.map(g=>({name:g.name,description:g.description,input_schema:g.parameters})),n.toolChoice==="required"&&(a.tool_choice={type:"any"}));const i=await cr(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(a)}),this.name);if(!i.ok){const g=await i.text();throw new Error(this.name+" API error "+i.status+": "+g)}const o=await i.json(),l=((d=o.content)==null?void 0:d.filter(g=>g.type==="text"))||[],c=((u=o.content)==null?void 0:u.filter(g=>g.type==="tool_use"))||[];return{content:l.map(g=>g.text).join(`
`),toolCalls:c.map(g=>({id:g.id,name:g.name,arguments:g.input})),usage:{promptTokens:((p=o.usage)==null?void 0:p.input_tokens)||0,completionTokens:((v=o.usage)==null?void 0:v.output_tokens)||0}}}async streamChat(t,n){const s=t.find(c=>c.role==="system"),r=t.filter(c=>c.role!=="system"),a={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,stream:!0,messages:r.map(c=>({role:c.role,content:c.content}))};s&&(a.system=s.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(a)});if(!i.ok){const c=await i.text();throw new Error(this.name+" stream error "+i.status+": "+c)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(c){var g;const{done:d,value:u}=await o.read();if(d){c.close();return}const v=l.decode(u,{stream:!0}).split(`
`);for(const f of v)if(f.startsWith("data: ")){const y=f.slice(6);if(y==="[DONE]")continue;try{const _=JSON.parse(y);_.type==="content_block_delta"&&((g=_.delta)!=null&&g.text)&&c.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:_.delta.text})+`

`))}catch{}}}})}}function Ui(e){const t={},n=e||{};if(t.type=n.type||"object",t.type==="object"){const s=n.properties;if(s&&typeof s=="object"&&Object.keys(s).length>0){const r={};for(const[a,i]of Object.entries(s))i&&typeof i=="object"?r[a]=In(i):r[a]=i;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(n.required)?t.required=n.required:t.required=[]}return n.description&&(t.description=n.description),t}function In(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const n=t.properties;if(n&&typeof n=="object"&&Object.keys(n).length>0){const s={};for(const[r,a]of Object.entries(n))a&&typeof a=="object"?s[r]=In(a):s[r]=a;t.properties=s}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=In(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class ur{constructor(t,n,s,r){U(this,"name");U(this,"apiKey");U(this,"model");U(this,"apiBase");this.apiKey=t,this.model=n,this.apiBase=s.replace(/\/+$/,""),this.name=r}async chat(t,n){var l,c,d,u,p,v;const s={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,messages:t.map(g=>({role:g.role,content:g.content}))},r=this.apiBase.includes("routellm.abacus.ai");if(n!=null&&n.tools&&n.tools.length>0&&r)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");n!=null&&n.tools&&n.tools.length>0&&(s.tools=n.tools.map(g=>({type:"function",function:{name:g.name,description:g.description,parameters:Ui(g.parameters||{})}})),n.toolChoice==="required"&&(s.tool_choice="required"));const a=await cr(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(s)}),this.name);if(!a.ok){const g=await a.text();throw new Error(this.name+" API error "+a.status+": "+g)}const i=await a.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((c=o==null?void 0:o.message)==null?void 0:c.content)||"",toolCalls:(u=(d=o==null?void 0:o.message)==null?void 0:d.tool_calls)==null?void 0:u.map(g=>({id:g.id,name:g.function.name,arguments:(()=>{try{return typeof g.function.arguments=="string"?JSON.parse(g.function.arguments||"{}"):g.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((p=i.usage)==null?void 0:p.prompt_tokens)||0,completionTokens:((v=i.usage)==null?void 0:v.completion_tokens)||0}}}async streamChat(t,n){const s={model:this.model,max_tokens:(n==null?void 0:n.maxTokens)||4096,temperature:(n==null?void 0:n.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},r=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(s)});if(!r.ok){const o=await r.text();throw new Error(this.name+" stream error "+r.status+": "+o)}const a=r.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var p,v,g;const{done:l,value:c}=await a.read();if(l){o.close();return}const u=i.decode(c,{stream:!0}).split(`
`);for(const f of u)if(f.startsWith("data: ")){const y=f.slice(6);if(y==="[DONE]")continue;try{const T=(g=(v=(p=JSON.parse(y).choices)==null?void 0:p[0])==null?void 0:v.delta)==null?void 0:g.content;T&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:T})+`

`))}catch{}}}})}}function Nn(e,t,n,s){const r=Ut[e];if(!r)throw new Error(`Unknown LLM provider: ${e}`);const a=s||r.defaultModel;return r.apiFormat==="anthropic"?new dr(t,a,r.apiBase,n):new ur(t,a,r.apiBase,n)}class mr{constructor(){U(this,"errorLog",new Map);U(this,"usageLog",new Map)}async pickProvider(t){const n=Date.now(),s=t.filter(r=>{const a=this.errorLog.get(r);return a?a.cooldownUntil<=n:!0});return s.length>0?s[0]:null}async recordUsage(t,n){const s=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:s.tokens+n,requests:s.requests+1})}async recordError(t,n,s=5){this.errorLog.set(t,{error:n,cooldownUntil:Date.now()+s*60*1e3})}}const Hi=["llm_slot_1","llm_slot_2","llm_slot_3"],Fi=["anthropic","openai"];async function Qe(e,t,n){const{decrypt:s}=await Promise.resolve().then(()=>Vt),r=new mr,a=[];for(const u of Hi){const p=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(p)try{const v=await s(p.encrypted_value,n),g=JSON.parse(v);if(g.provider&&g.apiKey&&Ut[g.provider]){const y=g.provider,_=Nn(g.provider,g.apiKey,y,g.model);a.push({name:y,provider:_})}}catch(v){console.error(`Failed to load ${u}:`,v)}}const i=new Set(a.map(u=>u.name));for(const u of Fi){if(i.has(u))continue;const p=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,u).first();if(p)try{const v=await s(p.encrypted_value,n);if(Ut[u]){const f=Nn(u,v,u);a.push({name:u,provider:f})}}catch{console.error(`Failed to decrypt legacy ${u} key`)}}if(a.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=a.map(u=>u.name),l=await r.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:a[0].provider,rotation:r};const c=a.find(u=>u.name===l);return{provider:Wi(c.provider,a,r,e,t),rotation:r}}function Wi(e,t,n,s,r){const a=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"";throw a(d)&&!d.includes("TOOLS_UNSUPPORTED")&&En(s,r,"all_providers_down",e.name,null,d),c}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(c){const d=c.message||"",u=i(d);if(!a(d)&&!u)throw c;const p=d.includes("TOOLS_UNSUPPORTED"),v=p?1:u?10:1440;console.warn(`Provider ${e.name} ${u?"rate limited":p?"tools unsupported":"auth/billing error"}, trying fallback...`),await n.recordError(e.name,d,v);const g=t.filter(f=>f.name!==e.name);for(const f of g)try{const y=await f.provider.chat(o,l);return this.name=f.name,!p&&!u&&En(s,r,"provider_switched",e.name,f.name,d),y}catch(y){const _=y.message||"";if(a(_)||i(_)){await n.recordError(f.name,_,i(_)?10:1440);continue}throw y}throw En(s,r,"all_providers_down",e.name,null,d),new Error(`All LLM providers failed. Primary (${e.name}): ${d.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const bt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:dr,OpenAICompatibleProvider:ur,ProviderRotation:mr,createProviderFromConfig:Nn,createRotatingProvider:Qe,logError:H},Symbol.toStringTag,{value:"Module"})),Tn=20,qi=2e3,Gi=2e3,pr=4,zi=1e3;function Ki(e){return Math.ceil(e.length/pr)}function On(e,t){const n=t*pr;return e.length<=n?e:e.slice(0,n)+`
[...truncated to fit token budget]`}async function Un(e,t){try{const s=(await e.prepare(`SELECT title, content FROM notes
...
`);return On(r,zi)}catch{return""}}class Q{constructor(t){this.db=t}async store(t,n,s,r,a=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,n,s).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,a,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       ...
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const n=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((n==null?void 0:n.cnt)||0)>Tn){const s=((n==null?void 0:n.cnt)||0)-Tn;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,s).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,Tn).all()).results||[]}async getAll(t,n,s=50){return n?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,n,s).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,s).all()).results||[]}async search(t,n,s=10){return this.searchMemoryByTier(t,n,s)}async searchLongTerm(t,n,s=5){return this.searchMemoryByTier(t,n,s,"long_term")}async searchMemoryByTier(t,n,s,r){const a=r?" AND tier = ?":"",i=(v,g)=>r?[t,r,v,v,g]:[t,v,v,g],l=(await this.db.prepare(`SELECT * FROM memory WHERE user_id = ?${a} AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?`).bind(...i(`%${n}%`,s)).all()).results||[];if(l.length>0)return await this.touchMemories(t,l.map(v=>v.id)),l;const c=n.split(/\s+/).filter(v=>v.length>2);if(c.length===0)return[];const d=new Map,u=new Map;for(const v of c){const g=await this.db.prepare(`SELECT * FROM memory WHERE user_id = ?${a} AND (title LIKE ? OR content LIKE ?) LIMIT ?`).bind(...i(`%${v}%`,s*2)).all();for(const f of g.results||[])d.set(f.id,(d.get(f.id)||0)+1),u.set(f.id,f)}const p=[...u.values()].sort((v,g)=>(d.get(g.id)||0)-(d.get(v.id)||0)).slice(0,s);return p.length>0&&await this.touchMemories(t,p.map(v=>v.id)),p}async touchMemories(t,n){for(const s of n)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(s,t).run()}async update(t,n,s){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(s,t,n).run()}async promote(t,n){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run(),await this.enforceWorkingMemoryCap(n)}async demote(t,n){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,n).run()}async remove(t,n){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,n).run()}async buildContext(t){const n=await this.getWorkingMemory(t);if(n.length===0)return"";const s={};for(const a of n)s[a.type]||(s[a.type]=[]),s[a.type].push(a);let r=`
## Working Memory (Active Context)
`;for(const[a,i]of Object.entries(s)){r+=`
### ${a.charAt(0).toUpperCase()+a.slice(1)}s
`;for(const o of i)r+=`- **${o.title}**: ${o.content}
`}return On(r,qi)}static truncatePersonality(t){return On(t,Gi)}async getRecentConversations(t,n=20,s){return s?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,s,n).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,n).all()).results||[]).reverse()}async storeMessage(t,n,s,r,a="{}",i){const o=Ki(r);i?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,o,i).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,n,s,r,a,o).run()}async compactHistory(t,n=30){const s=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((s==null?void 0:s.cnt)||0)<=n*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,n).run()}}const Yi=Object.freeze(Object.defineProperty({__proto__:null,MemoryService:Q,buildNotesContext:Un},Symbol.toStringTag,{value:"Module"})),Ji="https://accounts.google.com/o/oauth2/v2/auth",hr="https://oauth2.googleapis.com/token",Vi="https://www.googleapis.com/oauth2/v2/userinfo",Zi=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let Me=null;async function Cn(e,t,n){const s=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!s)return null;try{const r=await G(s.encrypted_value,n);return JSON.parse(r)}catch{return null}}async function Xi(e,t,n,s){const r=await Nt(JSON.stringify(s),n);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,r).run()}function gr(e,t,n){const s=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Zi,access_type:"offline",prompt:"consent",state:n,include_granted_scopes:"true"});return`${Ji}?${s}`}async function fr(e,t,n,s){const r=await fetch(hr,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:n,redirect_uri:s,grant_type:"authorization_code"})}),a=await r.text();if(!r.ok)throw new Error(`Token exchange failed (${r.status}): ${a.substring(0,300)}`);return JSON.parse(a)}async function Qi(e,t,n){const s=await fetch(hr,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:n,grant_type:"refresh_token"})}),r=await s.text();if(!s.ok)throw s.status===400||s.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${s.status}): ${r.substring(0,300)}`);return JSON.parse(r)}async function yr(e){const t=await fetch(Vi,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function At(e,t,n,s,r){if(!s||!r)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(Me&&Me.userId===t&&Me.expiresAt>Date.now()/1e3+60){const o=await Cn(e,t,n);return{token:Me.token,email:(o==null?void 0:o.email)||"unknown"}}const a=await Cn(e,t,n);if(!a)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const i=await Qi(a.refresh_token,s,r);return Me={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{token:i.access_token,email:a.email}}async function Hn(e,t,n){try{const s=await Cn(e,t,n);return s?{connected:!0,email:s.email,connectedAt:s.connected_at}:{connected:!1}}catch{return{connected:!1}}}function vr(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function wr(e,t,n,s,r,a,i){const o=await fr(s,a,i,r);if(!o.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await yr(o.access_token),c={refresh_token:o.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Xi(e,t,n,c),Me={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{email:l.email,name:l.name}}async function _r(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(Me==null?void 0:Me.userId)===t&&(Me=null)}const tt="https://sheets.googleapis.com/v4/spreadsheets";class br{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await At(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,n){const s=await this.authHeaders(),r=encodeURIComponent(n),a=await fetch(`${tt}/${t}/values/${r}`,{headers:s});if(!a.ok){const o=await a.text();throw new Error(`Sheets read failed (${a.status}): ${o}`)}return(await a.json()).values||[]}async writeRange(t,n,s){const r=await this.authHeaders(),a=encodeURIComponent(n),i=await fetch(`${tt}/${t}/values/${a}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:r,body:JSON.stringify({range:n,majorDimension:"ROWS",values:s})});if(!i.ok){const l=await i.text();throw new Error(`Sheets write failed (${i.status}): ${l}`)}return{updatedCells:(await i.json()).updatedCells||0}}async appendRows(t,n,s){var l;const r=await this.authHeaders(),a=encodeURIComponent(n),i=await fetch(`${tt}/${t}/values/${a}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:r,body:JSON.stringify({range:n,majorDimension:"ROWS",values:s})});if(!i.ok){const c=await i.text();throw new Error(`Sheets append failed (${i.status}): ${c}`)}return{updatedCells:((l=(await i.json()).updates)==null?void 0:l.updatedCells)||s.length}}async deleteRow(t,n,s){const r=await this.authHeaders(),a=await fetch(`${tt}/${t}?fields=sheets.properties`,{headers:r});if(!a.ok){const u=await a.text();throw new Error(`Failed to get sheet metadata (${a.status}): ${u}`)}const i=await a.json(),o=i.sheets.find(u=>u.properties.title===n);if(!o){const u=i.sheets.map(p=>p.properties.title).join(", ");throw new Error(`Tab "${n}" not found. Available tabs: ${u}`)}const l=o.properties.sheetId,c=s-1,d=await fetch(`${tt}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{deleteDimension:{range:{sheetId:l,dimension:"ROWS",startIndex:c,endIndex:c+1}}}]})});if(!d.ok){const u=await d.text();throw new Error(`Row delete failed (${d.status}): ${u}`)}}async createSpreadsheet(t,n){const s=await this.authHeaders(),r={properties:{title:t},sheets:n&&n.length>0?n.map(o=>({properties:{title:o}})):[{properties:{title:"Sheet1"}}]},a=await fetch(tt,{method:"POST",headers:s,body:JSON.stringify(r)});if(!a.ok){const o=await a.text();throw new Error(`Sheets create failed (${a.status}): ${o}`)}const i=await a.json();return{spreadsheetId:i.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${i.spreadsheetId}/edit`}}async getMetadata(t){const n=await this.authHeaders(),s=await fetch(`${tt}/${t}?fields=properties.title,sheets.properties.title`,{headers:n});if(!s.ok){const a=await s.text();throw new Error(`Sheets metadata failed (${s.status}): ${a}`)}const r=await s.json();return{title:r.properties.title,sheets:r.sheets.map(a=>a.properties.title)}}}const Mt="https://www.googleapis.com/calendar/v3";class pn{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await At(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",n={}){const s=await this.authHeaders(),r=new URLSearchParams;n.timeMin&&r.set("timeMin",n.timeMin),n.timeMax&&r.set("timeMax",n.timeMax),r.set("maxResults",String(n.maxResults||20)),r.set("singleEvents","true"),r.set("orderBy","startTime"),n.query&&r.set("q",n.query);const a=await fetch(`${Mt}/calendars/${encodeURIComponent(t)}/events?${r}`,{headers:s});if(!a.ok){const o=await a.text();throw new Error(`Calendar list failed (${a.status}): ${o}`)}return(await a.json()).items||[]}async createEvent(t="primary",n){var o;const s=await this.authHeaders(),r=n.timeZone||"Asia/Kolkata",a={summary:n.summary,description:n.description||"",location:n.location||"",start:{dateTime:n.startDateTime,timeZone:r},end:{dateTime:n.endDateTime,timeZone:r}};(o=n.attendees)!=null&&o.length&&(a.attendees=n.attendees.map(l=>({email:l})));const i=await fetch(`${Mt}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:s,body:JSON.stringify(a)});if(!i.ok){const l=await i.text();throw new Error(`Calendar create failed (${i.status}): ${l}`)}return await i.json()}async updateEvent(t="primary",n,s){const r=await this.authHeaders(),a=s.timeZone||"Asia/Kolkata",i={};s.summary&&(i.summary=s.summary),s.description&&(i.description=s.description),s.location&&(i.location=s.location),s.startDateTime&&(i.start={dateTime:s.startDateTime,timeZone:a}),s.endDateTime&&(i.end={dateTime:s.endDateTime,timeZone:a});const o=await fetch(`${Mt}/calendars/${encodeURIComponent(t)}/events/${n}`,{method:"PATCH",headers:r,body:JSON.stringify(i)});if(!o.ok){const l=await o.text();throw new Error(`Calendar update failed (${o.status}): ${l}`)}return await o.json()}async deleteEvent(t="primary",n){const s=await this.authHeaders(),r=await fetch(`${Mt}/calendars/${encodeURIComponent(t)}/events/${n}`,{method:"DELETE",headers:s});if(!r.ok&&r.status!==410){const a=await r.text();throw new Error(`Calendar delete failed (${r.status}): ${a}`)}}async listCalendars(){const t=await this.authHeaders(),n=await fetch(`${Mt}/users/me/calendarList`,{headers:t});if(!n.ok){const r=await n.text();throw new Error(`Calendar list calendars failed (${n.status}): ${r}`)}return((await n.json()).items||[]).map(r=>({id:r.id,summary:r.summary,primary:r.primary||!1}))}}const $e="https://docs.googleapis.com/v1/documents",eo="https://www.googleapis.com/drive/v3/files";function ps(e){const t=[];for(const n of e.split(`
`)){const s=n.trim();if(s===""||/^---+$/.test(s))continue;let r="NORMAL_TEXT",a=n;const i=s.match(/^###\s+(.+)/),o=!i&&s.match(/^##\s+(.+)/),l=!i&&!o&&s.match(/^#\s+(.+)/);i?(r="HEADING_3",a=i[1]):o?(r="HEADING_2",a=o[1]):l?(r="HEADING_1",a=l[1]):/^\s*[-*]\s/.test(n)&&(a="• "+n.replace(/^\s*[-*]\s+/,""));const{text:c,spans:d}=to(a);t.push({text:c,namedStyle:r,spans:d})}return t}function to(e){const t=[];let n="",s=0;for(;s<e.length;)if(e[s]==="*"&&e[s+1]==="*"){const r=e.indexOf("**",s+2);if(r!==-1){const a=n.length;n+=e.substring(s+2,r),t.push({start:a,end:n.length,bold:!0}),s=r+2}else n+=e[s++]}else if(e[s]==="_"&&e[s+1]==="_"){const r=e.indexOf("__",s+2);if(r!==-1){const a=n.length;n+=e.substring(s+2,r),t.push({start:a,end:n.length,bold:!0}),s=r+2}else n+=e[s++]}else if(e[s]==="*"&&e[s+1]!=="*"){const r=e.indexOf("*",s+1);if(r!==-1){const a=n.length;n+=e.substring(s+1,r),t.push({start:a,end:n.length,italic:!0}),s=r+1}else n+=e[s++]}else if(e[s]==="_"){const r=e.indexOf("_",s+1);if(r!==-1){const a=n.length;n+=e.substring(s+1,r),t.push({start:a,end:n.length,italic:!0}),s=r+1}else n+=e[s++]}else n+=e[s++];return{text:n,spans:t}}class Er{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await At(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const n=await this.authHeaders(),s=await fetch($e,{method:"POST",headers:n,body:JSON.stringify({title:t})});if(!s.ok){const a=await s.text();throw new Error(`Docs create failed (${s.status}): ${a}`)}const r=await s.json();return{documentId:r.documentId,url:`https://docs.google.com/document/d/${r.documentId}/edit`}}async readDocument(t){var i,o;const n=await this.authHeaders(),s=await fetch(`${$e}/${t}`,{headers:n});if(!s.ok){const l=await s.text();throw new Error(`Docs read failed (${s.status}): ${l}`)}const r=await s.json();let a="";for(const l of((i=r.body)==null?void 0:i.content)||[])if(l.paragraph)for(const c of l.paragraph.elements)(o=c.textRun)!=null&&o.content&&(a+=c.textRun.content);return{title:r.title,content:a.trim()}}async rewriteDocument(t,n){var g;const s=await this.authHeaders(),r=await fetch(`${$e}/${t}`,{headers:s});if(!r.ok){const f=await r.text();throw new Error(`Docs fetch failed (${r.status}): ${f.substring(0,200)}`)}const i=((g=(await r.json()).body)==null?void 0:g.content)||[],o=i[i.length-1],l=(o==null?void 0:o.endIndex)??2,c=ps(n),d=[];if(l>2&&d.push({deleteContentRange:{range:{startIndex:1,endIndex:l-1}}}),c.length===0){d.length>0&&await fetch(`${$e}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:d})});return}let u="";const p=[];for(const f of c){const y=u.length;u+=f.text+`
`,p.push({start:y,end:u.length,namedStyle:f.namedStyle,spans:f.spans})}d.push({insertText:{location:{index:1},text:u}});for(const f of p){f.namedStyle!=="NORMAL_TEXT"&&d.push({updateParagraphStyle:{range:{startIndex:1+f.start,endIndex:1+f.end},paragraphStyle:{namedStyleType:f.namedStyle},fields:"namedStyleType"}});for(const y of f.spans){const _={},T=[];y.bold&&(_.bold=!0,T.push("bold")),y.italic&&(_.italic=!0,T.push("italic")),T.length>0&&d.push({updateTextStyle:{range:{startIndex:1+f.start+y.start,endIndex:1+f.start+y.end},textStyle:_,fields:T.join(",")}})}}const v=await fetch(`${$e}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:d})});if(!v.ok){const f=await v.text();throw new Error(`Docs rewrite failed (${v.status}): ${f.substring(0,200)}`)}}async appendFormattedContent(t,n){var g;const s=await this.authHeaders(),r=ps(n);if(r.length===0)return;const a=await fetch(`${$e}/${t}`,{headers:s});if(!a.ok){const f=await a.text();throw new Error(`Docs fetch failed (${a.status}): ${f.substring(0,200)}`)}const o=((g=(await a.json()).body)==null?void 0:g.content)||[],l=o[o.length-1],c=Math.max(1,((l==null?void 0:l.endIndex)??2)-1);let d="";const u=[];for(const f of r){const y=d.length;d+=f.text+`
`,u.push({start:y,end:d.length,namedStyle:f.namedStyle,spans:f.spans})}const p=[{insertText:{location:{index:c},text:d}}];for(const f of u){f.namedStyle!=="NORMAL_TEXT"&&p.push({updateParagraphStyle:{range:{startIndex:c+f.start,endIndex:c+f.end},paragraphStyle:{namedStyleType:f.namedStyle},fields:"namedStyleType"}});for(const y of f.spans){const _={},T=[];y.bold&&(_.bold=!0,T.push("bold")),y.italic&&(_.italic=!0,T.push("italic")),T.length>0&&p.push({updateTextStyle:{range:{startIndex:c+f.start+y.start,endIndex:c+f.start+y.end},textStyle:_,fields:T.join(",")}})}}const v=await fetch(`${$e}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:p})});if(!v.ok){const f=await v.text();throw new Error(`Docs append failed (${v.status}): ${f.substring(0,200)}`)}}async appendText(t,n){const s=await this.authHeaders(),r=await fetch(`${$e}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:[{insertText:{endOfSegmentLocation:{},text:n}}]})});if(!r.ok){const a=await r.text();throw new Error(`Docs append failed (${r.status}): ${a}`)}}async deleteContent(t,n){var i,o,l;const s=await this.authHeaders(),r=await fetch(`${$e}/${t}:batchUpdate`,{method:"POST",headers:s,body:JSON.stringify({requests:[{replaceAllText:{containsText:{text:n,matchCase:!0},replaceText:""}}]})});if(!r.ok){const c=await r.text();throw new Error(`Docs delete content failed (${r.status}): ${c.substring(0,200)}`)}return{occurrencesRemoved:((l=(o=(i=(await r.json()).replies)==null?void 0:i[0])==null?void 0:o.replaceAllText)==null?void 0:l.occurrencesChanged)??0}}async shareDocument(t,n,s="writer"){const r=await this.authHeaders(),a=await fetch(`${eo}/${t}/permissions`,{method:"POST",headers:r,body:JSON.stringify({type:"user",role:s,emailAddress:n})});if(!a.ok){const i=await a.text();throw new Error(`Share failed (${a.status}): ${i}`)}}}class we{constructor(t,n,s,r,a){U(this,"sheets");U(this,"calendar");U(this,"docs");U(this,"db");U(this,"userId");U(this,"pinHash");this.db=t,this.userId=n,this.pinHash=s,this.sheets=new br(t,n,s,r,a),this.calendar=new pn(t,n,s,r,a),this.docs=new Er(t,n,s,r,a)}async isConnected(){return Hn(this.db,this.userId,this.pinHash)}}const nt=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:pn,GoogleDocs:Er,GoogleServices:we,GoogleSheets:br,completeOAuthFlow:wr,disconnectGoogle:_r,exchangeCodeForTokens:fr,fetchUserInfo:yr,generateAuthUrl:gr,getGoogleAuth:At,isGoogleConnected:Hn,isOAuthClientConfigured:vr},Symbol.toStringTag,{value:"Module"}));async function Tr(e,t,n={}){const s={textQuery:t,languageCode:"en",pageSize:8};if(n.type&&(s.includedType=n.type),n.location){const l=n.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(s.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:n.radius||5e3}})}const r=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),a=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":r},body:JSON.stringify(s)});if(!a.ok){const l=await a.text();return{results:[],error:`Places API error (${a.status}): ${l.substring(0,200)}`}}const i=await a.json();return!i.places||i.places.length===0?{results:[]}:{results:i.places.map(l=>{var c,d,u;return{name:((c=l.displayName)==null?void 0:c.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(d=l.currentOpeningHours)==null?void 0:d.openNow,types:(u=l.types)==null?void 0:u.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function Sr(e,t){var a,i,o;const n=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),s=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":n}});if(!s.ok){const l=await s.text();return{error:`Place Details API error (${s.status}): ${l.substring(0,200)}`}}const r=await s.json();return{details:{name:((a=r.displayName)==null?void 0:a.text)||"",address:r.formattedAddress||"",phone:r.internationalPhoneNumber,website:r.websiteUri,rating:r.rating,reviews:(i=r.reviews)==null?void 0:i.slice(0,3).map(l=>{var c,d,u;return{author:((c=l.authorAttribution)==null?void 0:c.displayName)||"Anonymous",rating:l.rating||0,text:((u=(d=l.text)==null?void 0:d.text)==null?void 0:u.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(o=r.currentOpeningHours)==null?void 0:o.weekdayDescriptions,location:r.location?{lat:r.location.latitude,lng:r.location.longitude}:void 0,googleMapsUri:r.googleMapsUri}}}async function kr(e,t,n,s={}){var c;const r=new URLSearchParams({origin:t,destination:n,key:e,mode:s.mode||"driving"});(s.mode==="driving"||!s.mode)&&r.set("departure_time","now");const a=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${r}`);if(!a.ok)return{error:`Directions API error: ${a.status}`};const i=await a.json();if(i.status!=="OK")return{error:`Directions: ${i.status} — ${i.error_message||""}`};const o=i.routes[0],l=o.legs[0];return{route:{summary:o.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(c=l.duration_in_traffic)==null?void 0:c.text,steps:l.steps.slice(0,10).map(d=>{var u,p,v;return{instruction:((u=d.html_instructions)==null?void 0:u.replace(/<[^>]*>/g,""))||"",distance:((p=d.distance)==null?void 0:p.text)||"",duration:((v=d.duration)==null?void 0:v.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function xr(e,t,n,s){var l,c;const r={q:t,target:n,key:e,format:"text"};s&&(r.source=s);const a=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const d=await a.text();return{translatedText:"",error:`Translate API error (${a.status}): ${d.substring(0,200)}`}}const o=(c=(l=(await a.json()).data)==null?void 0:l.translations)==null?void 0:c[0];return o?{translatedText:o.translatedText,detectedSourceLang:o.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function Dr(e,t){const n=new URLSearchParams({address:t,key:e}),s=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${n}`);if(!s.ok)return{results:[],error:`Geocoding API error: ${s.status}`};const r=await s.json();return r.status!=="OK"&&r.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${r.status} — ${r.error_message||""}`}:{results:(r.results||[]).slice(0,5).map(a=>{var i;return{address:a.formatted_address,lat:a.geometry.location.lat,lng:a.geometry.location.lng,placeId:a.place_id,types:(i=a.types)==null?void 0:i.slice(0,3)}})}}async function Rr(e,t,n={}){const s=new URLSearchParams({part:"snippet",q:t,key:e,type:n.type||"video",maxResults:String(n.maxResults||5),order:n.order||"relevance"}),r=await fetch(`https://www.googleapis.com/youtube/v3/search?${s}`);if(!r.ok){const i=await r.text();return{results:[],error:`YouTube API error (${r.status}): ${i.substring(0,200)}`}}return{results:((await r.json()).items||[]).map(i=>{var o,l,c,d,u,p,v,g;return{title:i.snippet.title,channelTitle:i.snippet.channelTitle,description:(o=i.snippet.description)==null?void 0:o.substring(0,200),videoId:((l=i.id)==null?void 0:l.videoId)||((c=i.id)==null?void 0:c.channelId)||((d=i.id)==null?void 0:d.playlistId)||"",publishedAt:i.snippet.publishedAt,url:(u=i.id)!=null&&u.videoId?`https://www.youtube.com/watch?v=${i.id.videoId}`:(p=i.id)!=null&&p.channelId?`https://www.youtube.com/channel/${i.id.channelId}`:"",thumbnailUrl:(g=(v=i.snippet.thumbnails)==null?void 0:v.medium)==null?void 0:g.url}})}}const no="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36";function Ir(e,t){if(/anomaly-modal/i.test(e))return[];const n=[],s=e.split(/class="result results_links/g).slice(1);for(const r of s){if(n.length>=t)break;const a=r.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),i=r.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(a){let o=a[1];const l=o.match(/uddg=([^&]+)/);l?o=decodeURIComponent(l[1]):o.startsWith("//")&&(o="https:"+o);const c=p=>p.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),d=c(a[2]),u=i?c(i[1]):"";if(d&&o.startsWith("http")){const p=o.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];n.push({title:d,link:o,snippet:u,displayLink:p})}}}return n}async function so(e,t,n,s){const r=new URLSearchParams({key:t,cx:n,q:e,num:String(Math.min(s,10))}),a=await fetch(`https://www.googleapis.com/customsearch/v1?${r}`);if(!a.ok){const l=await a.text().catch(()=>"");return{results:[],error:`Google CSE failed (${a.status}): ${l.substring(0,200)}`}}return{results:((await a.json()).items||[]).map(l=>({title:l.title||"",link:l.link||"",snippet:l.snippet||"",displayLink:l.displayLink||(l.link||"").replace(/^https?:\/\/(www\.)?/,"").split("/")[0]})).filter(l=>l.title&&l.link.startsWith("http"))}}async function Ot(e,t={}){const n=Math.min(t.num||5,10),s=t.site?`site:${t.site} ${e}`:e;try{const r=new URLSearchParams({q:s}),a=await fetch("https://html.duckduckgo.com/html/",{method:"POST",headers:{"User-Agent":no,"Content-Type":"application/x-www-form-urlencoded"},body:r.toString()});if(!a.ok)return{results:[],error:`Search request failed (${a.status})`};const i=await a.text(),o=Ir(i,n);if(o.length>0)return{results:o};if(t.googleApiKey&&t.googleCseId){const l=await so(s,t.googleApiKey,t.googleCseId,n);if(l.results.length>0)return l;if(l.error)return{results:[],error:l.error}}return/anomaly-modal/i.test(i)?{results:[],error:"Web search blocked by DuckDuckGo bot protection. Configure GOOGLE_API_KEY + GOOGLE_CSE_ID, or add a Tavily API key in Settings → Keys for faster research."}:{results:[],error:void 0}}catch(r){return{results:[],error:`Web search error: ${r.message}`}}}async function Nr(e,t,n,s="driving"){var l,c,d,u;const r=new URLSearchParams({origins:t,destinations:n,key:e,mode:s,departure_time:"now"}),a=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${r}`);if(!a.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${a.status}`};const i=await a.json(),o=(d=(c=(l=i.rows)==null?void 0:l[0])==null?void 0:c.elements)==null?void 0:d[0];return!o||o.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(o==null?void 0:o.status)||i.status}`}:{distance:o.distance.text,duration:o.duration.text,durationInTraffic:(u=o.duration_in_traffic)==null?void 0:u.text}}const ro=Object.freeze(Object.defineProperty({__proto__:null,geocode:Dr,getDirections:kr,getDistanceMatrix:Nr,getPlaceDetails:Sr,parseDuckDuckGoHtml:Ir,searchPlaces:Tr,searchYouTube:Rr,translateText:xr,webSearch:Ot},Symbol.toStringTag,{value:"Module"})),Pe="https://gmail.googleapis.com/gmail/v1/users/me";function ao(e,t){if(e)return e;const n=t?parseInt(t,10):NaN;return!Number.isNaN(n)&&n>0?new Date(n).toISOString():""}function io(e,t){return e===403?"Gmail access denied (403). Reconnect your Google account in Settings → Keys → Google Workspace to grant Gmail permissions.":`Gmail list failed (${e}): ${t.substring(0,200)}`}class ke{constructor(t,n,s,r,a){this.db=t,this.userId=n,this.pinHash=s,this.clientId=r,this.clientSecret=a}async authHeaders(){const{token:t}=await At(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var l;const n=await this.authHeaders(),s=new URLSearchParams;if(s.set("maxResults",String(t.maxResults||10)),t.query&&s.set("q",t.query),(l=t.labelIds)!=null&&l.length)for(const c of t.labelIds)s.append("labelIds",c);const r=await fetch(`${Pe}/messages?${s}`,{headers:n});if(!r.ok){const c=await r.text();throw new Error(io(r.status,c))}const a=await r.json();if(!a.messages||a.messages.length===0)return[];const i=[];let o=0;for(const c of a.messages.slice(0,t.maxResults||10))try{const d=await this.getMessage(c.id,n);d?i.push(d):o++}catch{o++}if(i.length===0&&o>0)throw new Error(`Gmail found ${a.messages.length} matching message(s) but could not read message details (${o} metadata fetch failure(s)). Reconnect Google in Settings → Keys → Google Workspace to refresh Gmail permissions, then try again.`);return i}async getMessage(t,n){const s=n||await this.authHeaders(),r=await fetch(`${Pe}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:s});if(!r.ok)return null;const a=await r.json(),i=o=>{var l,c,d;return((d=(c=(l=a.payload)==null?void 0:l.headers)==null?void 0:c.find(u=>u.name.toLowerCase()===o.toLowerCase()))==null?void 0:d.value)||""};return{id:a.id,threadId:a.threadId,snippet:a.snippet||"",subject:i("Subject")||"(no subject)",from:i("From"),to:i("To"),date:ao(i("Date"),a.internalDate),isUnread:(a.labelIds||[]).includes("UNREAD"),labels:a.labelIds||[]}}async getMessageBody(t){const n=await this.authHeaders(),s=await fetch(`${Pe}/messages/${t}?format=full`,{headers:n});if(!s.ok){const a=await s.text();throw new Error(`Gmail message body failed (${s.status}): ${a.substring(0,200)}`)}const r=await s.json();return lo(r.payload)}async search(t,n=10){return this.listMessages({query:t,maxResults:n})}async send(t,n,s,r={}){const a=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${n}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];r.cc&&i.push(`Cc: ${r.cc}`),r.bcc&&i.push(`Bcc: ${r.bcc}`),r.replyToMessageId&&(i.push(`In-Reply-To: ${r.replyToMessageId}`),i.push(`References: ${r.replyToMessageId}`)),i.push("",hs(s));const o=i.join(`\r
`),c={raw:gs(o)};r.threadId&&(c.threadId=r.threadId);const d=await fetch(`${Pe}/messages/send`,{method:"POST",headers:a,body:JSON.stringify(c)});if(!d.ok){const u=await d.text();throw new Error(`Gmail send failed (${d.status}): ${u.substring(0,200)}`)}return await d.json()}async createDraft(t,n,s,r={}){const a=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${n}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];r.cc&&i.push(`Cc: ${r.cc}`),i.push("",hs(s));const o=i.join(`\r
`),l=gs(o),c=await fetch(`${Pe}/drafts`,{method:"POST",headers:a,body:JSON.stringify({message:{raw:l}})});if(!c.ok){const d=await c.text();throw new Error(`Gmail draft failed (${c.status}): ${d.substring(0,200)}`)}return await c.json()}async markAsRead(t){const n=await this.authHeaders();await fetch(`${Pe}/messages/${t}/modify`,{method:"POST",headers:n,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,n){const s=await this.authHeaders();let r={};switch(n){case"archive":r={removeLabelIds:["INBOX"]};break;case"trash":r={addLabelIds:["TRASH"]};break;case"read":r={removeLabelIds:["UNREAD"]};break;case"unread":r={addLabelIds:["UNREAD"]};break;case"star":r={addLabelIds:["STARRED"]};break;case"unstar":r={removeLabelIds:["STARRED"]};break}const a=await fetch(`${Pe}/messages/${t}/modify`,{method:"POST",headers:{...s,"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const i=await a.text();throw new Error(`Failed to modify message: ${i}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),n=await fetch(`${Pe}/labels/INBOX`,{headers:t});return n.ok&&(await n.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),n=await fetch(`${Pe}/profile`,{headers:t});if(!n.ok)throw new Error("Failed to get Gmail profile");return await n.json()}}function oo(e){let t="",n="";function s(r){var a,i,o,l;if(r){if(r.mimeType==="text/plain"&&((a=r.body)!=null&&a.data))t+=ln(r.body.data);else if(r.mimeType==="text/html"&&((i=r.body)!=null&&i.data))n+=ln(r.body.data);else if((o=r.parts)!=null&&o.length)for(const c of r.parts)s(c);else if((l=r.body)!=null&&l.data&&!r.parts){const c=ln(r.body.data);r.mimeType==="text/html"?n+=c:t+=c}}}return s(e),{plain:t.trim(),html:n.trim()}}function lo(e){var r,a;if(!e)return"";if((r=e.body)!=null&&r.data&&!((a=e.parts)!=null&&a.length)){const i=ln(e.body.data);return e.mimeType==="text/html"?fs(i):i}const{plain:t,html:n}=oo(e),s=n?fs(n):"";return t&&s?t.length<200&&s.length>t.length?s:t.length>=s.length?t:s:t||s||e.snippet||""}function hs(e){e=e.replace(/\\n/g,`
...
`);return a.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:a.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${a.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${a.join("<br>")}</p>`}).join("")}</body></html>`}function gs(e){const t=new TextEncoder().encode(e);let n="";for(let s=0;s<t.length;s++)n+=String.fromCharCode(t[s]);return btoa(n).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function ln(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function fs(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<img[^>]+alt=["']([^"']+)["'][^>]*>/gi,`
$1
`).replace(/<br\s*\/?>/gi,`
`).replace(/<\/t[dh]>/gi,`
`).replace(/<\/p>/gi,`
...
`).trim()}function Sn(e,t){const n=`${e.subject} ${e.snippet} ${e.from}`.toLowerCase(),s=t.toLowerCase();let r=0;n.includes(s)&&(r+=10);for(const a of s.split(/\s+/))a.length>2&&n.includes(a)&&(r+=3);return/\b(order|ordered|confirmation|invoice|receipt|thank you for your order)\b/i.test(`${e.subject} ${e.snippet}`)&&(r+=6),/\b(delivered|delivery|out for delivery|shipped|dispatch|dispatched|arriving)\b/i.test(e.subject)&&(r-=4),r}function ys(e){return e.map((t,n)=>`${t.isUnread?"● ":"  "}${n+1}. **${t.subject}**
   From: ${t.from}
   Date: ${t.date}
   ${t.snippet}
   [id: ${t.id}]`).join(`

`)}function co(e,t,n){if(e.length===0)return`No purchase-related emails found for "${t}" (query: ${n}).`;const s=[...e].sort((i,o)=>Sn(o,t)-Sn(i,t)),r=s[0];if(Sn(r,t)>0){const i=`**Purchase email for "${t}"**
...
${ys(s.slice(1,6))}`:"";return i+o}return`No clear purchase confirmation for "${t}". Closest matches:

${ys(s.slice(0,8))}`}const uo=15e3,mo=15e3,po=15e3,ho=6e4;async function Fn(e,t){try{const n=new AbortController,s=setTimeout(()=>n.abort(),mo),r=await fetch(e,{signal:n.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!r.ok)return{text:"",error:`HTTP ${r.status}`};const a=r.headers.get("content-type")||"";if(!a.includes("text/html")&&!a.includes("text/plain")&&!a.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${a.split(";")[0]}`};const i=await r.text();clearTimeout(s);const o=i.length>2e5?i.substring(0,2e5):i,l=go(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||uo)}}catch(n){return{text:"",error:n.name==="AbortError"?"Timeout":n.message}}}function go(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Or(e,t,n){const s=new AbortController,r=setTimeout(()=>s.abort(),po);try{const a=await fetch("https://api.tavily.com/search",{method:"POST",signal:s.signal,headers:{"Content-Type":"application/json"},body:JSON.stringify({api_key:t,query:e,search_depth:n==="quick"?"basic":"advanced",include_raw_content:!0,max_results:n==="quick"?7:5})});return clearTimeout(r),a.ok?{results:(await a.json()).results||[]}:{results:[],error:`Tavily error ${a.status}`}}catch(a){clearTimeout(r);const i=a.name==="AbortError"?"Timeout":a.message;return console.warn("[searchViaTavily]",i),{results:[],error:i}}}async function tn(e,t,n,s){var i,o;const r=new AbortController,a=setTimeout(()=>r.abort(),ho);try{const l=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",signal:r.signal,headers:{"x-api-key":e,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:"claude-opus-4-8",max_tokens:s,system:t,messages:[{role:"user",content:n}]})});if(clearTimeout(a),!l.ok){let d=`Opus API error ${l.status}`;throw l.status===401?d="Opus API error 401: invalid or expired Anthropic API key":l.status===404?d="Opus API error 404: model not found — check the model ID":l.status===529&&(d="Opus API error 529: Anthropic API overloaded"),new Error(d)}return((o=(i=(await l.json()).content)==null?void 0:i[0])==null?void 0:o.text)||""}catch(l){throw clearTimeout(a),l}}function vs(e,t){try{const n=e.match(/\[[\s\S]*\]/);if(!n)return t;const s=JSON.parse(n[0]);if(Array.isArray(s)&&s.every(r=>typeof r=="string"))return s.filter(Boolean)}catch{}return t}async function Cr(e){return e.raw_content&&e.raw_content.length>100?e.raw_content.slice(0,15e3):(await Fn(e.url,15e3)).text}async function fo(e,t,n,s,r){const a=[];async function i(y,_,T){let x=[];return n&&(x=(await Or(y,n,T)).results),x.length===0&&(x=(await r(y,_)).map(M=>({url:M.link,title:M.title,content:M.snippet,raw_content:null,score:0}))),(await Promise.all(x.map(async N=>({result:N,content:await Cr(N)})))).filter(N=>N.content.length>50)}if(s==="quick"){const y=await i(e,7,"quick");let _="";for(let x=0;x<y.length;x++){const L=y[x],N=`[${x+1}] ${L.result.title}
${L.result.url}

${L.content}

`;if(_.length+N.length>8e4)break;_+=N,a.push({url:L.result.url,title:L.result.title})}return{report:await tn(t,"You are an expert research analyst. Write a clear, accurate, well-structured report answering the query based on provided sources. Cite sources as [1], [2] etc. Be precise and factual.",`Query: ${e}

Sources:
${_}`,2048),sources:a,pagesRead:y.length}}const o=await tn(t,"You are a research planning expert.",`I need to research: ${e}

Generate exactly 4-5 specific sub-queries that together cover all important angles (definition, current state, comparisons, recent developments, expert analysis). Return ONLY a JSON array of strings, nothing else.`,400),l=vs(o,[e,`${e} overview`,`${e} examples`,`${e} latest`]).slice(0,5),c=await Promise.all(l.map(y=>i(y,5,"thorough"))),d=new Set,u=[];for(const y of c)for(const _ of y)d.has(_.result.url)||u.length>=20||(d.add(_.result.url),u.push(_));let p="";for(let y=0;y<u.length;y++){const _=u[y],T=`[${y+1}] ${_.result.title}
${_.result.url}

${_.content}

`;if(p.length+T.length>18e4)break;p+=T,a.push({url:_.result.url,title:_.result.title})}const v=await tn(t,"You are a research analyst identifying information gaps.",`I'm researching: ${e}

Here's what I've found so far:
${p.slice(0,6e4)}

Identify 2-3 specific information gaps or important angles not yet covered. Return ONLY a JSON array of follow-up search queries.`,300),g=vs(v,[]).slice(0,3);if(g.length>0){let y=0;const _=await Promise.all(g.map(T=>i(T,4,"thorough")));for(const T of _)for(const x of T){if(y>=5||d.has(x.result.url))continue;d.add(x.result.url);const N=`[${a.length+1}] ${x.result.title}
${x.result.url}

${x.content}

`;if(p.length+N.length>18e4)break;p+=N,a.push({url:x.result.url,title:x.result.title}),u.push(x),y++}}return{report:await tn(t,`You are an expert research analyst producing a comprehensive report. Use this exact structure:
...
Sources:
${p}`,4096),sources:a,pagesRead:u.length}}async function Ar(e,t,n={}){const s=n.depth||"quick",r=async(f,y)=>(await Ot(f,{num:y,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId})).results||[];let a;if(n.anthropicKey)try{const f=await fo(e,n.anthropicKey,n.tavilyKey||null,s,r);if(f.report.trim())return{report:f.report,sources:f.sources.map(y=>({title:y.title,url:y.url})),pagesRead:f.pagesRead}}catch(f){a=f.message,console.warn("[conductResearch] Opus path failed:",f.message)}if(n.tavilyKey)try{const f=await Or(e,n.tavilyKey,s);if(f.results.length>0){const y=s==="thorough"?8:5,T=(await Promise.all(f.results.slice(0,y).map(async M=>({result:M,content:await Cr(M)})))).filter(M=>M.content.length>50),x=T.map(M=>({title:M.result.title,url:M.result.url}));if(T.length>0){const M=T.map((z,W)=>`--- SOURCE ${W+1}: ${z.result.title} ---
${z.content}
--- END SOURCE ${W+1} ---`).join(`

`);return{report:await nn(e,M,t,"full"),sources:x,pagesRead:T.length}}const L=f.results.map((M,P)=>`[${P+1}] ${M.title}
${M.content}
Source: ${M.url}`).join(`

`);return{report:await nn(e,L,t,"snippets"),sources:f.results.map(M=>({title:M.title,url:M.url})),pagesRead:0}}}catch(f){console.warn("[conductResearch] Tavily path failed:",f.message)}const i=n.maxPages||(s==="thorough"?5:3),o=n.maxResults||(s==="thorough"?8:5),l=await Ot(e,{num:o,site:n.site,googleApiKey:n.googleApiKey,googleCseId:n.googleCseId});if(l.error){const f=a?` (Opus: ${a})`:"";return{report:"",sources:[],pagesRead:0,error:`Search failed: ${l.error}${f}`}}if(l.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const d=l.results.slice(0,i).map(async f=>{const y=await Fn(f.link);return{title:f.title,url:f.link,displayLink:f.displayLink,snippet:f.snippet,content:y.text,error:y.error}}),p=(await Promise.all(d)).filter(f=>f.content.length>50);if(p.length===0){const f=l.results.map((_,T)=>`[${T+1}] ${_.title}
${_.snippet}
Source: ${_.link}`).join(`

`);return{report:await nn(e,f,t,"snippets"),sources:l.results.map(_=>({title:_.title,url:_.link})),pagesRead:0}}const v=p.map((f,y)=>`--- SOURCE ${y+1}: ${f.title} (${f.displayLink}) ---
${f.content}
--- END SOURCE ${y+1} ---`).join(`

`);return{report:await nn(e,v,t,"full"),sources:p.map(f=>({title:f.title,url:f.url})),pagesRead:p.length}}async function nn(e,t,n,s){const a=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Write a synthesized research report answering the query above.`;try{return(await n.chat([{role:"system",content:a},{role:"user",content:i}],{temperature:.3,maxTokens:2048})).content||"Research synthesis failed — no response from LLM."}catch(o){return`Research synthesis error: ${o.message}. Raw search results were found but could not be analyzed.`}}const yo=Object.freeze(Object.defineProperty({__proto__:null,conductResearch:Ar,fetchPageContent:Fn},Symbol.toStringTag,{value:"Module"})),Ze="https://api.browser-use.com/api/v2",ws=2e4,An=6e3,vo=3e5,Wn=12e3,Lr=new Set(["finished","stopped"]);async function Ht(e,t,n=Wn){const s=new AbortController,r=setTimeout(()=>s.abort(),n);try{return await fetch(e,{...t,signal:s.signal})}finally{clearTimeout(r)}}async function wo(e){const t=()=>fetch(`${Ze}/sessions`,{method:"POST",headers:{"X-Browser-Use-API-Key":e,"Content-Type":"application/json"},body:JSON.stringify({})});try{let n=await t();if(!n.ok){const r=await n.text().catch(()=>"");if($r(n.status,r)){if(console.log("[createBrowserSession] concurrency limit — reaping stale sessions and retrying"),await Mr(e),n=await t(),!n.ok)return console.log(`[createBrowserSession] FAILED after reap HTTP ${n.status}`),null}else return console.log(`[createBrowserSession] FAILED HTTP ${n.status}: ${r}`),null}const s=await n.json();return console.log(`[createBrowserSession] sessionId=${s.id}`),s.id??null}catch(n){return console.log(`[createBrowserSession] ERROR ${n.message}`),null}}async function hn(e,t){try{await fetch(`${Ze}/sessions/${e}`,{method:"DELETE",headers:{"X-Browser-Use-API-Key":t}}),console.log(`[closeBrowserSession] closed sessionId=${e}`)}catch{}}async function _o(e){try{const t=await Ht(`${Ze}/sessions?filterBy=active&pageSize=100`,{headers:{"X-Browser-Use-API-Key":e}});return t.ok?(await t.json()).items??[]:[]}catch{return[]}}async function Mr(e,t){const n=await _o(e);let s=0;for(const r of n)!r.id||t&&r.id===t||(await hn(r.id,e),s++);return s>0&&console.log(`[reapActiveBrowserSessions] closed ${s} stale session(s)`),s}function $r(e,t){const n=(t||"").toLowerCase();return/session/.test(n)?/concurrent|too many|maximum|limit|exceeded/.test(n):!1}async function qn(e,t,n){var o;const s=(n==null?void 0:n.timeoutMs)??vo;console.log(`[runBrowserTask] starting taskLen=${e.length} timeoutMs=${s} hasSecrets=${!!(n!=null&&n.secrets)} reuseSession=${!!(n!=null&&n.sessionId)}`);let r,a;try{const l={task:e};n!=null&&n.secrets&&Object.keys(n.secrets).length>0&&(l.secrets=n.secrets),n!=null&&n.sessionId&&(l.sessionId=n.sessionId);const c=()=>fetch(`${Ze}/tasks`,{method:"POST",headers:{"X-Browser-Use-API-Key":t,"Content-Type":"application/json"},body:JSON.stringify(l)});let d=await c();if(!d.ok){const p=await d.text().catch(()=>"");if($r(d.status,p)&&(console.log("[runBrowserTask] concurrency limit — reaping stale sessions and retrying"),await Mr(t,n==null?void 0:n.sessionId),d=await c()),!d.ok){const v=await d.text().catch(()=>p);return console.log(`[runBrowserTask] CREATE_FAILED HTTP ${d.status}: ${v}`),{output:null,taskId:"",status:"failed",error:`HTTP ${d.status}: ${v}`}}}const u=await d.json();if(r=u.id,a=u.sessionId||void 0,console.log(`[runBrowserTask] CREATED taskId=${r} sessionId=${a}`),!r)return{output:null,taskId:"",status:"failed",error:"No id in create response"}}catch(l){return{output:null,taskId:"",status:"failed",error:l.message}}await new Promise(l=>setTimeout(l,ws));const i=Date.now()+(s-ws);for(;Date.now()<i;){try{const l=await Ht(`${Ze}/tasks/${r}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(l.ok){const c=await l.json();if(Lr.has(c.status)){if(c.status==="finished"){let d=c.output??null;if(!d)try{const u=await Ht(`${Ze}/tasks/${r}`,{headers:{"X-Browser-Use-API-Key":t}},Wn);if(u.ok){const p=await u.json();if(d=p.output??null,!d&&((o=p.steps)!=null&&o.length)){const v=p.steps[p.steps.length-1];d=v.extracted_content??v.output??v.result??null}}}catch{}return console.log(`[runBrowserTask] COMPLETED taskId=${r} outputLen=${(d??"").length}`),{output:d,taskId:r,sessionId:a,status:"completed"}}return console.log(`[runBrowserTask] FAILED taskId=${r} status=${c.status}`),{output:c.output??null,taskId:r,status:"failed",error:c.output??"Task was stopped before completing"}}}}catch{}await new Promise(l=>setTimeout(l,An))}return console.log(`[runBrowserTask] TIMEOUT taskId=${r} sessionId=${a}`),{output:null,taskId:r,sessionId:a,status:"timeout"}}async function Pr(e,t,n){var a;const s=(n==null?void 0:n.waitMs)??3e4,r=Date.now()+s;for(;Date.now()<r;){try{const i=await Ht(`${Ze}/tasks/${e}/status`,{headers:{"X-Browser-Use-API-Key":t}});if(!i.ok){await new Promise(l=>setTimeout(l,An));continue}const o=await i.json();if(Lr.has(o.status)){let l=null;const c=await Ht(`${Ze}/tasks/${e}`,{headers:{"X-Browser-Use-API-Key":t}},Wn);if(c.ok){const d=await c.json();if(l=d.output??null,!l&&((a=d.steps)!=null&&a.length)){const u=d.steps[d.steps.length-1];l=u.extracted_content??u.output??u.result??null}}else l=o.output??null;return{status:o.status,output:l,done:!0}}}catch{}await new Promise(i=>setTimeout(i,An))}return{status:"running",output:null,done:!1}}function bo(e){return`Navigate to https://www.bluedart.com/tracking.
...
${n}
`:"";let u="";try{const v=new Date;u=new Intl.DateTimeFormat("en-GB",{timeZone:t.timezone,day:"numeric",month:"short",year:"numeric"}).format(v)}catch{u=""}const p=`
## Current User
- **Name**: ${t.name}
- **Timezone**: ${t.timezone}
- **Time**: ${r}
...
- **HARD RULE — no false confirmations**: You have ZERO tool access. You CANNOT set reminders, create schedules, send emails, read sheets, or perform any action. NEVER output phrases like "Reminder set for...", "I've scheduled...", "Done ✅", "Task created", or any language implying an action was completed. If the user wants an action, say: "I can do that — just send your message and I'll take care of it." Do NOT simulate the outcome.`;default:return""}}const ko=Object.freeze(Object.defineProperty({__proto__:null,buildPurchaseGmailQuery:zn,buildSubAgentPrompt:Hr,classifyIntentFast:Gn,detectDeterministicOp:Kn,detectTierTwoOp:Yn,extractPurchaseProduct:Ur},Symbol.toStringTag,{value:"Module"})),xo=new Set(["create_skill","list_skills","store_memory","search_memory","delete_memory","update_memory","get_schedules","delete_schedule","create_schedule","toggle_schedule","gmail_unread_count"]),Do=3,Ro=3,Fr=5,Wr=.4,qr=5;async function Gr(e,t,n,s,r,a,i=!0){try{const o=r.filter(g=>!xo.has(g));if(o.length<Do)return;const c=[...[...new Set(o)]].sort().join(","),d=await e.prepare(`INSERT INTO skill_patterns (user_id, tool_signature, user_message_sample, tool_sequence, turn_count, succeeded)
       VALUES (?, ?, ?, ?, ?, ?)
       RETURNING id`).bind(n.id,c,s.slice(0,500),JSON.stringify(o),a,i?1:0).first(),u=await e.prepare("SELECT COUNT(*) as c FROM skill_patterns WHERE user_id = ? AND tool_signature = ?").bind(n.id,c).first(),p=(u==null?void 0:u.c)??0,v=await e.prepare(`SELECT auto_skill_id FROM skill_patterns
       WHERE user_id = ? AND tool_signature = ? AND auto_skill_id IS NOT NULL LIMIT 1`).bind(n.id,c).first();if(v!=null&&v.auto_skill_id){d!=null&&d.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE id = ?").bind(v.auto_skill_id,d.id).run(),await Io(e,n,v.auto_skill_id,c),i&&await Co(e,t,n,v.auto_skill_id,o,s);return}p>=Ro&&await Oo(e,t,n,c,o)}catch{}}async function Io(e,t,n,s){const r=await e.prepare(`SELECT AVG(CAST(succeeded AS REAL)) as avg_success, COUNT(*) as total
     FROM (
       SELECT succeeded FROM skill_patterns
       WHERE user_id = ? AND tool_signature = ? AND auto_skill_id = ?
       ORDER BY created_at DESC LIMIT 20
     )`).bind(t.id,s,n).first(),a=(r==null?void 0:r.avg_success)??1,i=(r==null?void 0:r.total)??0,o=a<Wr&&i>=qr;if(await e.prepare(`UPDATE user_skills
...
`)}
`}catch{return""}}async function No(e,t,n){var i;let s=0,r=0,a=0;try{const o=await e.prepare(`SELECT us.id, us.user_id, us.name, us.instructions, us.refinement_count,
              us.confidence_score, us.usage_count
       FROM user_skills us
       WHERE us.user_id = ? AND us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < ? AND us.usage_count >= ?`).bind(n,Wr,qr).all();for(const l of o.results??[]){s++;const c=await e.prepare(`SELECT user_message_sample, tool_sequence
         FROM skill_patterns
         WHERE auto_skill_id = ? AND succeeded = 1
         ORDER BY created_at DESC LIMIT 3`).bind(l.id).all();if((c.results??[]).length<2||l.refinement_count>=Fr){await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),await e.prepare(`INSERT INTO notifications (user_id, type, title, body, source, is_read)
           VALUES (?, 'warning', ?, ?, 'skills', 0)`).bind(l.user_id,`Auto-skill retired: ${l.name}`,`"${l.name}" had a ${Math.round(l.confidence_score*100)}% success rate and couldn't be improved — disabled. Check Settings → Skills to manage it.`).run(),a++;continue}const d=c.results.map(v=>v.user_message_sample),u=JSON.parse(c.results[0].tool_sequence),p=[{role:"system",content:"You are a workflow optimizer. Rewrite a skill procedure so it is more reliable, based on examples that previously succeeded."},{role:"user",content:`Skill "${l.name}" has a ${Math.round(l.confidence_score*100)}% success rate.
...
REWRITTEN_INSTRUCTIONS: <revised instructions>`}];try{const f=(((i=(await t.chat(p,{tools:[]})).content)==null?void 0:i.trim())??"").match(/^REWRITTEN_INSTRUCTIONS:\s*([\s\S]+)$/m);f&&f[1].trim()&&(await e.prepare(`UPDATE user_skills
             ...
             WHERE id = ?`).bind(f[1].trim(),l.id).run(),r++)}catch{await e.prepare("UPDATE user_skills SET enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(l.id).run(),a++}}}catch{}return{reviewed:s,rewritten:r,disabled:a}}async function Oo(e,t,n,s,r){var x;const i=((await e.prepare(`SELECT user_message_sample, tool_sequence
     FROM skill_patterns
...
INSTRUCTIONS: <step-by-step instructions referencing exact tool names, under 200 words>`}],c=((x=(await t.chat(o,{tools:[]})).content)==null?void 0:x.trim())??"",d=c.match(/^NAME:\s*(.+)$/m),u=c.match(/^DESCRIPTION:\s*(.+)$/m),p=c.match(/^INSTRUCTIONS:\s*([\s\S]+)$/m);if(!d||!u||!p)return;const v=d[1].trim(),g=u[1].trim(),f=p[1].trim();if(!v||!g||!f)return;let y=`auto_${v.toLowerCase().replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"_").substring(0,40)}`;await e.prepare("SELECT id FROM user_skills WHERE user_id = ? AND slug = ?").bind(n.id,y).first()&&(y=`${y}_${Date.now().toString().slice(-4)}`);const T=await e.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, required_tools, is_auto, source)
     VALUES (?, ?, ?, ?, ?, ?, 1, 'auto')
     RETURNING id`).bind(n.id,v,y,g,f,JSON.stringify(r)).first();T!=null&&T.id&&await e.prepare("UPDATE skill_patterns SET auto_skill_id = ? WHERE user_id = ? AND tool_signature = ?").bind(T.id,n.id,s).run()}async function Co(e,t,n,s,r,a){var u;const i=await e.prepare("SELECT name, instructions, refinement_count FROM user_skills WHERE id = ? AND user_id = ?").bind(s,n.id).first();if(!i||i.refinement_count>=Fr)return;const o=[{role:"system",content:"You are a workflow optimizer. Given an existing skill and a new usage example, decide if the instructions should be improved."},{role:"user",content:`Existing skill "${i.name}":
${i.instructions}
...
${s}
`:"",c=xn(t,Mo),d=a!=null&&a.trim()?xn(`## Pinned Notes Reference
${a}
...
---
## Current Date & Time
${ea(e.timezone)} (${e.timezone})
Note: Always use this date/time as the current time. Do NOT guess or use UTC.${n==="telegram"?'\n\n## TELEGRAM CONSTRAINTS\n- **Essays / save to Drive**: When the user wants an essay, article, or report saved to Google Drive (or says "store/save to drive"), you MUST call `create_doc` with the **full** text in the `content` parameter — never truncate for Telegram. Do NOT paste the essay body in chat (reply with title + Doc link only). Write from your knowledge unless they asked for research — do NOT call web_search before a plain essay. One `create_doc` call with title + full content (+ optional `folder_name`).\n- **Research + save**: One web_search, then immediately create_doc or gmail_draft with the findings. Do NOT call read_url on multiple pages. Pattern: web_search → create_doc (or gmail_draft).\n- **Reminders**: When the user says "remind me in X" or "set a reminder", you MUST call create_schedule. For a specific time/date ("at 13:00", "tomorrow at noon", "next Friday at 5pm"), ALWAYS use `schedule_value` with the exact datetime in the user\'s local timezone — NEVER use `minutes_from_now` for clock-time requests (it causes wrong times). Only use `minutes_from_now` for pure duration requests like "in 30 minutes" or "in 2 hours".\n- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I\'ll now..." — just call the tool.\n- **Long content intent check**: When asked to write long-form content (essay, article, report) WITHOUT any save destination (no mention of Drive, Google Doc, or "save/store"), ask first: "Should I save the full piece as a Google Doc and send you the link, or give you a brief summary here in chat?" Default to Google Doc for anything over ~300 words. If they already said Drive/Doc/save/store, skip this question and call `create_doc` with the complete text immediately. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**':""}`}async function Dn(e,t,n){var c;const r=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${n.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let a;((c=r.files)==null?void 0:c.length)>0?a=r.files[0].id:a=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:n,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${a}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:a,folderName:n}}function Ft(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").replace(/^\[calling:[^\]]*\]\s*/i,"").trim()}function ea(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}const $o={read_sheet:"read",search_memory:"read",list_schedules:"read",write_sheet:"write",append_sheet:"write",update_schedule:"write",delete_schedule:"write",gmail_send:"external_effect",create_calendar_event:"external_effect"};function Po(e,t){const n=$o[e]||"read";if(n==="read")return null;const s=ta(t);return n==="write"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} requires transaction_mode=execute.`:n==="external_effect"&&s!=="execute"?`POLICY BLOCKED (${n}): ${e} can cause external side effects and needs transaction_mode=execute.`:null}const jo=["ETIMEDOUT","TIMEOUT","429","503","ECONNRESET","network"],Bo=new Set(["write_sheet","append_sheet","gmail_send","create_calendar_event","update_schedule","delete_schedule","delete_memory"]),Uo={create_schedule:{required:["name","schedule_type","action_type"],enum:{schedule_type:["interval","daily","weekly","once"]}},update_schedule:{required:["job_id"]},delete_schedule:{required:["job_id"]},write_sheet:{required:["spreadsheet_id","range","values"]},append_sheet:{required:["spreadsheet_id","range","values"]},gmail_send:{required:["to","subject","body"]}};function Ho(e){const t=String((e==null?void 0:e.message)||e||"Unknown tool error");return/timeout|timed out/i.test(t)?"TOOL_TIMEOUT":/unauthorized|forbidden|401|403/i.test(t)?"TOOL_AUTH":/not found|404/i.test(t)?"TOOL_NOT_FOUND":/rate limit|429/i.test(t)?"TOOL_RATE_LIMIT":/validation|invalid|required/i.test(t)?"TOOL_VALIDATION":"TOOL_EXECUTION_FAILED"}function Fo(e){const t=String((e==null?void 0:e.message)||e||"").toLowerCase();return jo.some(n=>t.includes(n.toLowerCase()))}function Wo(e){const t=e.query??e.q??e.search_query??e.search;return typeof t=="string"?t.trim():""}function qo(e,t){const n=Uo[e];if(n){for(const s of n.required||[])if(t[s]===void 0||t[s]===null||t[s]==="")throw new Error(`Validation failed: ${s} is required for ${e}`);for(const[s,r]of Object.entries(n.enum||{}))if(t[s]!==void 0&&!r.includes(String(t[s])))throw new Error(`Validation failed: ${s} must be one of ${r.join(", ")}`)}}function ta(e){const t=e.transaction_mode;return t==="dry_run"||t==="confirm_required"||t==="execute"?t:"execute"}function Go(e,t){if(!Bo.has(e))return null;const n=ta(t);return n==="dry_run"?`DRY RUN: ${e} validated. No write action was executed.`:n==="confirm_required"?`CONFIRMATION REQUIRED: ${e} is a write action. Re-run with transaction_mode=execute to proceed.`:null}const zo=new Set(["gmail_send","gmail_draft","gmail_modify","append_sheet","create_sheet","write_sheet","create_doc","append_to_doc","rewrite_doc","create_calendar_event","create_schedule","create_skill"]),Ko=new Set(["list_schedules","search_memory","get_system_status","read_sheet","list_calendar_events","read_doc","gmail_list","gmail_read","gmail_search","gmail_unread_count","drive_list","drive_search","drive_read_file","web_search","read_url","research","browser_task_status","vault_lookup","search_places","get_place_details","get_directions","get_travel_time","translate_text","search_youtube","geocode_address","parse_document","search_library","read_library_file","list_skills"]),Yo=5;async function Wt(e,t,n,s,r,a,i,o,l,c,d,u,p,v,g){const f=Date.now();let y=!0,_="",T="";const x=r.traceId||crypto.randomUUID(),L=`${s}:${e}:${JSON.stringify(t)}`;if(zo.has(e)&&!Ko.has(e))try{const M=await n.prepare(`SELECT tool_result FROM tool_execution_log
           WHERE user_id = ? AND tool_name = ? AND idempotency_key = ? AND success = 1
             AND created_at >= datetime('now', '-${Yo} minutes')
           ORDER BY created_at DESC
           LIMIT 1`).bind(s,e,L).first();if(M)return M.tool_result||""}catch{}try{qo(e,t);const M=Po(e,t);if(M)return T=M,T;const P=Go(e,t);if(P)return T=P,T;const z=2;for(let W=1;W<=z;W++)try{const ne=e==="browser_task"?31e4:e==="browser_task_status"?35e3:e==="research"?31e4:9e4;T=await Promise.race([Vo(e,t,n,s,a,i,o,l,c,d,u,p,v,r.channel,g),new Promise((j,Y)=>setTimeout(()=>Y(new Error("Tool timed out")),ne))]);break}catch(ne){if(W<z&&Fo(ne)){await new Promise(j=>setTimeout(j,250*W));continue}throw ne}return T}catch(M){throw y=!1,_=`${Ho(M)}: ${M.message||"Unknown error"}`,new Error(_)}finally{const M=Date.now()-f;try{await n.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel, idempotency_key)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,r.agentType||null,r.providerName||null,e,JSON.stringify({...t,_idempotency_key:L,_trace_id:x}).substring(0,2e3),(y?T:"").substring(0,500),y?1:0,_||null,M,r.isEnforcementRetry?1:0,r.channel||"web",L).run()}catch{}}}function na(e){const t=e.length;for(let n=0;n<t-1;n++){const s=e[n];if(s.role!=="user"||typeof s.content!="string")continue;const r=t-1-n,a=r<=2?12e3:r<=4?5e3:2e3;s.content.length>a&&(e[n]={...s,content:s.content.substring(0,a)+`
[...truncated in history to reduce context size]`})}}function Jo(e){const t=[];let n=[],s="",r=!1,a=0;const i=e.length;for(;a<i;){const o=e[a];if(r){if(o==='"'){if(e[a+1]==='"'){s+='"',a+=2;continue}r=!1,a++;continue}s+=o,a++;continue}if(o==='"'){r=!0,a++;continue}if(o===","){n.push(s),s="",a++;continue}if(o==="\r"&&e[a+1]===`
`){n.push(s),t.push(n),n=[],s="",a+=2;continue}if(o===`
`||o==="\r"){n.push(s),t.push(n),n=[],s="",a++;continue}s+=o,a++}for((s||n.length)&&(n.push(s),t.push(n));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function Vo(e,t,n,s,r,a,i,o,l,c,d,u,p,v,g){var y,_,T,x,L,N,M,P,z,W,ne,j,Y,q,Z,te,oe,re,he;const f=new Q(n);switch(e){case"create_schedule":{const m=new Date;let E;const h=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){E=new Date(m.getTime()+t.minutes_from_now*60*1e3);const A=E.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[I,C,O]=(A[0]||"").split("/");t.schedule_value=`${O}-${I}-${C} ${A[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const R=parseInt(t.schedule_value,10);E=new Date(m.getTime()+R*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const R=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(R)){const[I,C]=t.schedule_value.split(":").map(Number),O=m.toLocaleString("en-US",{timeZone:h}),$=new Date(O),B=new Date($);B.setHours(I,C,0,0),B<=$&&B.setDate(B.getDate()+1);const J=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(B.toLocaleString("en-US",{timeZone:h})),K=J.getTime()-X.getTime();E=new Date(B.getTime()+K)}else{const[I,C]=t.schedule_value.split(":").map(Number),O=m.toLocaleString("en-US",{timeZone:h}),$=new Date(O),B=new Date($);B.setHours(I,C,0,0),B<=$&&B.setDate(B.getDate()+1);const J=De=>String(De).padStart(2,"0"),X=B.getFullYear(),K=J(B.getMonth()+1),ie=J(B.getDate());t.schedule_value=`${X}-${K}-${ie} ${J(I)}:${J(C)}`,t.schedule_type="once";const de=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),ce=new Date(B.toLocaleString("en-US",{timeZone:h})),ge=de.getTime()-ce.getTime();E=new Date(B.getTime()+ge)}}else if(t.schedule_type==="daily"){const[R,A]=t.schedule_value.split(":").map(Number),I=m.toLocaleString("en-US",{timeZone:h}),C=new Date(I),O=new Date(C);O.setHours(R,A,0,0),O<=C&&O.setDate(O.getDate()+1);const $=new Date(O.toLocaleString("en-US",{timeZone:"UTC"})),B=new Date(O.toLocaleString("en-US",{timeZone:h})),J=$.getTime()-B.getTime();E=new Date(O.getTime()+J)}else if(t.schedule_type==="weekly"){const[R,A]=t.schedule_value.split(" "),[I,C]=(A||"00:00").split(":").map(Number),$=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ge=>ge.toLowerCase()===R.toLowerCase()),B=m.toLocaleString("en-US",{timeZone:h}),J=new Date(B),X=new Date(J);X.setHours(I,C,0,0);let K=($-X.getDay()+7)%7;K===0&&X<=J&&(K=7),X.setDate(X.getDate()+K);const ie=new Date(X.toLocaleString("en-US",{timeZone:"UTC"})),de=new Date(X.toLocaleString("en-US",{timeZone:h})),ce=ie.getTime()-de.getTime();E=new Date(X.getTime()+ce)}else if(t.schedule_type==="once"){const[R,A]=t.schedule_value.split(" "),[I,C,O]=R.split("-").map(Number),[$,B]=(A||"00:00").split(":").map(Number),J=m.toLocaleString("en-US",{timeZone:h}),X=new Date(J),K=new Date(X);K.setFullYear(I,C-1,O),K.setHours($,B,0,0);const ie=new Date(K.toLocaleString("en-US",{timeZone:"UTC"})),de=new Date(K.toLocaleString("en-US",{timeZone:h})),ce=ie.getTime()-de.getTime();E=new Date(K.getTime()+ce);const ge=new Date(m.getTime()+120*1e3);if(E.getTime()<m.getTime()+5*1e3){const De=E.toISOString();E=ge;const Te=` [Note: The requested time ${t.schedule_value} in ${h} resolved to ${De} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${E.toISOString()}.]`;t._pastTimeWarning=Te}}else E=new Date(m.getTime()+3600*1e3);if((t.schedule_type==="interval"||t.schedule_type==="daily"||t.schedule_type==="weekly")&&t.action_type==="custom"){const R=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(send|forward)\b.{0,40}\b(email|mail)\b|\bemail.{0,20}\bto\b|\bgmail_send\b/.test(R)&&(t.schedule_type="once")}if(t.action_type==="custom"&&t.schedule_type==="once"){const R=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(R)||(t.action_type="reminder")}if(await n.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(s,t.name,t.schedule_type,t.schedule_value).first()){const R=E.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${R} (${h}). No duplicate created.`}await n.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
`)}case"toggle_schedule":{const m=t.enabled?1:0,E=m?"active":"paused";return await n.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(m,E,t.job_id,s).run(),`Schedule ${t.job_id} ${m?"enabled (active)":"paused"}.`}case"update_schedule_state":{const m=["created","active","reminding","paused","completed"],E=t.state;if(!m.includes(E))return`Invalid state "${E}". Valid states: ${m.join(", ")}`;const h=E==="completed"||E==="paused"?0:1;return await n.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(E,h,t.job_id,s).run(),`Schedule ${t.job_id} state updated to "${E}".`}case"update_schedule":{const m=t.job_id,E=c||"UTC",h=new Date,w=["updated_at = CURRENT_TIMESTAMP"],b=[];t.name&&(w.push("name = ?"),b.push(t.name)),t.description&&(w.push("description = ?"),b.push(t.description));let S=null,k=t.schedule_type,R=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){S=new Date(h.getTime()+t.minutes_from_now*60*1e3);const C=S.toLocaleString("en-US",{timeZone:E,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[O,$,B]=(C[0]||"").split("/");R=`${B}-${O}-${$} ${C[1]||"00:00"}`,k="once"}else if(k&&R){if(k==="interval")S=new Date(h.getTime()+parseInt(R,10)*60*1e3);else if(k==="daily"){const[I,C]=R.split(":").map(Number),O=new Date(h.toLocaleString("en-US",{timeZone:E})),$=new Date(O);$.setHours(I,C,0,0),$<=O&&$.setDate($.getDate()+1);const B=new Date($.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date($.toLocaleString("en-US",{timeZone:E})).getTime();S=new Date($.getTime()+B)}else if(k==="weekly"){const[I,C]=R.split(" "),[O,$]=(C||"00:00").split(":").map(Number),J=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ce=>ce.toLowerCase()===I.toLowerCase()),X=new Date(h.toLocaleString("en-US",{timeZone:E})),K=new Date(X);K.setHours(O,$,0,0);let ie=(J-K.getDay()+7)%7;ie===0&&K<=X&&(ie=7),K.setDate(K.getDate()+ie);const de=new Date(K.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(K.toLocaleString("en-US",{timeZone:E})).getTime();S=new Date(K.getTime()+de)}else if(k==="once"){const[I,C]=R.split(" "),[O,$,B]=I.split("-").map(Number),[J,X]=(C||"00:00").split(":").map(Number),K=new Date(h.toLocaleString("en-US",{timeZone:E})),ie=new Date(K);ie.setFullYear(O,$-1,B),ie.setHours(J,X,0,0);const de=new Date(ie.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(ie.toLocaleString("en-US",{timeZone:E})).getTime();S=new Date(ie.getTime()+de),S.getTime()<h.getTime()+60*1e3&&(S=new Date(h.getTime()+120*1e3))}}if(k&&(w.push("schedule_type = ?"),b.push(k)),R&&(w.push("schedule_value = ?"),b.push(R)),S&&(w.push("next_run = ?"),b.push(S.toISOString())),w.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";b.push(m,s),await n.prepare(`UPDATE cron_jobs SET ${w.join(", ")} WHERE id = ? AND user_id = ?`).bind(...b).run();const A=S?S.toLocaleString("en-US",{timeZone:E,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${m} updated.${A?` New fire time: ${A} (${E}).`:""} IMPORTANT: Use this exact time "${A}" when confirming to the user.`}case"delete_schedule":return await n.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,s).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const m=t.importance||5,E=t.type==="task"?"preference":t.type,h=m>=7?"working":"long_term";return await f.store(s,E,t.title,t.content,m,h),`Stored in ${h==="working"?"working":"long-term"} memory: [${E}] ${t.title} (importance: ${m})`}case"search_memory":{const m=await f.search(s,t.query);return m.length===0?"No matching memories found.":m.map(E=>`[id:${E.id}] [${E.tier||"long_term"}] [${E.type}] **${E.title}**: ${E.content}`).join(`
`)}case"delete_memory":return await f.remove(t.id,s),`Memory entry ${t.id} deleted.`;case"update_memory":return await f.update(t.id,s,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const m=await n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(s).first(),E=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(s).first(),h=await n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(s).first(),w=await n.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(s).first(),b=await n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(s).first();return`System Status:
- Active schedules: ${(m==null?void 0:m.cnt)||0}
- Memory: ${(h==null?void 0:h.cnt)||0} working / ${(E==null?void 0:E.cnt)||0} total
- Total messages: ${(w==null?void 0:w.cnt)||0}
- Unread errors: ${(b==null?void 0:b.cnt)||0}`}case"read_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||""),E=t.spreadsheet_id;let h=t.range;const w=await m.sheets.getMetadata(E),b=w.sheets;h.includes("!")||(h=`${b[0]}!${h}`);let S;try{S=await m.sheets.readRange(E,h)}catch(R){if((y=R.message)!=null&&y.includes("Unable to parse range")||(_=R.message)!=null&&_.includes("400")){const A=h.includes("!")?h.split("!")[1]:h;h=`${b[0]}!${A}`,S=await m.sheets.readRange(E,h)}else throw R}let k=`[Spreadsheet: "${w.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${b.map(R=>`"${R}"`).join(", ")}]
...
The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const h=t.values;let w=t.range;const k=Math.max(...h.map(C=>C.length))+4,R=h.map(C=>{const O=[...C];for(;O.length<k;)O.push("");return O}),A=w.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(A){const C=A[1]||"",O=A[2],$=A[3],B=A[5],X=O.toUpperCase().charCodeAt(0)-64+k-1,K=X<=26?String.fromCharCode(64+X):"Z";w=`${C}${O}${$}:${K}${B}`}const I=await m.sheets.writeRange(t.spreadsheet_id,w,R);try{const C=new Q(n),O=await C.search(s,`Pending sheet write: ${t.spreadsheet_id}`);for(const $ of O)$.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await C.remove($.id,s)}catch{}return`Written ${I.updatedCells} cells to ${w}.`}catch(m){return await H(n,s,"google","write_sheet",m.message),`Failed to write sheet: ${m.message}`}}case"append_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new Q(n).store(s,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const h=await m.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const w=new Q(n),b=await w.search(s,`Pending sheet append: ${t.spreadsheet_id}`);for(const S of b)S.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await w.remove(S.id,s)}catch{}return`Appended ${h.updatedCells} cells to ${t.range}.`}catch(m){return await H(n,s,"google","append_sheet",m.message),`Failed to append to sheet: ${m.message}`}}case"create_sheet":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title)try{await new Q(n).store(s,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`

The spreadsheet request has been saved to temporary memory. After reconnecting, tell me "create the pending spreadsheet" and I'll complete this automatically.`:"")}const h=await m.sheets.createSpreadsheet(t.title,t.sheet_names);let w="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||"");w=`
Folder: "${(await Dn(b,h.spreadsheetId,t.folder_name)).folderName}"`}catch(b){w=`
(Note: spreadsheet saved to Drive root — could not place in folder "${t.folder_name}": ${b.message})`}try{await new Q(n).store(s,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${h.spreadsheetId} | URL: ${h.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${w}
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(m){return await H(n,s,"google","create_sheet",m.message),`Failed to create spreadsheet: ${m.message}`}}case"list_calendar_events":{if(!r)return"Authentication context unavailable.";try{const m=new we(n,s,r,a||"",i||""),E=t.calendar_id||"primary",h=t.days_ahead||7,w=new Date,b=new Date(w.getTime()+h*24*60*60*1e3),S=await m.calendar.listEvents(E,{timeMin:w.toISOString(),timeMax:b.toISOString(),query:t.query});return S.length===0?`No events found in the next ${h} days.`:S.map(k=>{var O;const R=k.start.dateTime||k.start.date||"TBD",A=k.end.dateTime||k.end.date||"",I=k.location?` 📍 ${k.location}`:"",C=((O=k.attendees)==null?void 0:O.map($=>$.email).join(", "))||"";return`• ${k.summary} — ${R} to ${A}${I}${C?`
  Attendees: ${C}`:""}`}).join(`
...
The calendar event has been saved to temporary memory. After reconnecting, tell me "create the pending event" and I'll add it to your calendar.`:"")}const h=t.calendar_id||"primary",w=await m.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});try{const b=new Q(n),S=await b.search(s,`Pending calendar event: "${t.summary}"`);for(const k of S)k.title.startsWith(`Pending calendar event: "${t.summary}"`)&&await b.remove(k.id,s)}catch{}return`Event created: "${w.summary}"
ID: ${w.id}
Start: ${w.start.dateTime||w.start.date}`}catch(m){return await H(n,s,"google","create_event",m.message),`Failed to create event: ${m.message}`}}case"create_doc":{if(!r)return"Authentication context unavailable.";const m=new we(n,s,r,a||"",i||"");if(!(await m.isConnected()).connected){if(t.title&&t.content){try{await new Q(n).store(s,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}try{await n.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
...
Use append_to_doc with the document ID above to add content.`}await H(n,s,"google","create_doc_append_fallback",`Formatted append failed, used plain text: ${k.message}`)}}let w="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||"");w=`
Folder: "${(await Dn(b,h.documentId,t.folder_name)).folderName}"`}catch(b){w=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${b.message})`}try{await new Q(n).store(s,"context",`Document: ${t.title}`,`Document ID: ${h.documentId} | URL: ${h.url}`,6,"working")}catch{}try{const b=t.content;await n.prepare(`INSERT OR IGNORE INTO document_library (user_id, source, drive_file_id, name, summary, extracted_text, status)
           VALUES (?, 'drive', ?, ?, ?, ?, 'parsed')`).bind(s,h.documentId,t.title,b?b.substring(0,500):null,b?b.substring(0,5e4):null).run()}catch{}try{const b=new Q(n),S=await b.search(s,`Pending Google Doc save: "${t.title}"`);for(const k of S)k.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await b.remove(k.id,s)}catch{}return`Document created: "${t.title}"${w}
ID: ${h.documentId}
...
${h}`}catch(m){return await H(n,s,"gmail","read",m.message),`Gmail read error: ${m.message}`}}case"gmail_search":{if(!r)return"Authentication context unavailable.";try{const m=Wo(t);if(!m)return"Gmail search requires a non-empty query (e.g. from:sender@example.com subject:invoice). Use Gmail search syntax.";const E=typeof t.product_hint=="string"?t.product_hint.trim():"",h=Math.min(Math.max(t.max_results||10,1),20),w=new ke(n,s,r,a||"",i||"");let b=await w.search(m,h);if(b.length===0&&E){const S=zn(E).replace("180d","365d");b=await w.search(S,h)}return b.length===0?`No results for: ${m}`:E?co(b,E,m):b.map((S,k)=>`${S.isUnread?"● ":"  "}${k+1}. **${S.subject}**
   From: ${S.from}
   Date: ${S.date}
   ${S.snippet}
   [id: ${S.id}]`).join(`
...
Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const w=await m.send(t.to,t.subject,t.body,{cc:t.cc});try{const b=new Q(n),S=await b.search(s,`Pending email: "${t.subject}"`);for(const k of S)k.title.startsWith(`Pending email: "${t.subject}"`)&&await b.remove(k.id,s)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${w.id}]`}catch(m){return await H(n,s,"gmail","send",m.message),`Gmail send error: ${m.message}`}}case"gmail_draft":{if(!r)return"Authentication context unavailable.";try{const m=new ke(n,s,r,a||"",i||"");if(!(await new we(n,s,r,a||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new Q(n).store(s,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const w=await m.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const S=new Q(n),k=await S.search(s,`Pending draft: "${t.subject}"`);for(const R of k)R.title.startsWith(`Pending draft: "${t.subject}"`)&&await S.remove(R.id,s)}catch{}const b=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${b}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${w.id}]`}catch(m){return await H(n,s,"gmail","draft",m.message),`Gmail draft error: ${m.message}`}}case"gmail_modify":{if(!r)return"Authentication context unavailable.";try{return await new ke(n,s,r,a||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(m){return await H(n,s,"gmail","modify",m.message),`Gmail modify error: ${m.message}`}}case"gmail_unread_count":{if(!r)return"Authentication context unavailable.";try{const E=await new ke(n,s,r,a||"",i||"").getUnreadCount();return`You have ${E} unread email${E!==1?"s":""} in Gmail.`}catch(m){return(x=m.message)!=null&&x.includes("not connected")?m.message:`Gmail error: ${m.message}`}}case"drive_list":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||""),E=new URLSearchParams;E.set("pageSize",String(t.max_results||10)),E.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),E.set("orderBy","modifiedTime desc");let h="";t.folder_id?h=`'${t.folder_id}' in parents and trashed = false`:t.query?h=`${t.query} and trashed = false`:h="trashed = false",E.set("q",h);const w=await fetch(`https://www.googleapis.com/drive/v3/files?${E}`,{headers:{Authorization:`Bearer ${m}`}});if(!w.ok)throw new Error(`Drive API error (${w.status})`);const b=await w.json();return(L=b.files)!=null&&L.length?b.files.map((S,k)=>{var C,O;const R=((C=S.mimeType)==null?void 0:C.split(".").pop())||S.mimeType,A=S.size?`${(parseInt(S.size)/1024).toFixed(1)} KB`:"",I=((O=S.modifiedTime)==null?void 0:O.split("T")[0])||"";return`${k+1}. **${S.name}** (${R})
   ${A} · Modified: ${I}
   ${S.webViewLink||""}`}).join(`

`):"No files found."}catch(m){return await H(n,s,"google","drive_list",m.message),`Drive list error: ${m.message}`}}case"drive_search":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||""),E=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,h=new URLSearchParams;h.set("q",E),h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");const w=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${m}`}});if(!w.ok)throw new Error(`Drive API error (${w.status})`);const b=await w.json();return(N=b.files)!=null&&N.length?b.files.map((S,k)=>{var I,C;const R=((I=S.mimeType)==null?void 0:I.split(".").pop())||S.mimeType,A=((C=S.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${k+1}. **${S.name}** (${R}) — Modified: ${A}
   ${S.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(m){return await H(n,s,"google","drive_search",m.message),`Drive search error: ${m.message}`}}case"drive_read_file":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||""),E=t.url_or_id.trim();let h=E;const w=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const B of w){const J=E.match(B);if(J){h=J[1];break}}const b=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${m}`}});if(!b.ok)throw new Error(`Drive API error (${b.status}): could not fetch file metadata`);const S=await b.json(),{name:k,mimeType:R}=S,A=t.extract_focus,I=A?`Focus specifically on extracting: ${A}`:"Extract and return all readable text content. Preserve structure where relevant.",C={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(C[R]){const B=C[R],J=await fetch(`https://www.googleapis.com/drive/v3/files/${h}/export?mimeType=${encodeURIComponent(B)}`,{headers:{Authorization:`Bearer ${m}`}});if(!J.ok)throw new Error(`Drive export error (${J.status})`);const X=await J.text();if(R==="application/vnd.google-apps.spreadsheet"){const K=Jo(X),ie=K.length,de=((M=K[0])==null?void 0:M.length)??0;return`**${k}** (Google Sheet — ${ie} rows × ${de} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(K)}`}return`**${k}**

${X.substring(0,2e4)}`}if(R==="application/pdf"||k.toLowerCase().endsWith(".pdf")){const B=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?alt=media`,{headers:{Authorization:`Bearer ${m}`}});if(!B.ok)throw new Error(`Drive download error (${B.status})`);const J=await B.arrayBuffer(),X=Buffer.from(J).toString("base64");let K=null,ie="claude-sonnet-4-6";for(const De of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const Te=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,De).first();if(Te&&r){const ja=await G(Te.encrypted_value,r),Qt=JSON.parse(ja);if(Qt.provider==="anthropic"){K=Qt.apiKey,Qt.model&&(ie=Qt.model);break}}}catch{}if(!K)return`"${k}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const de=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":K,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:ie,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:X}},{type:"text",text:I}]}]})});if(!de.ok){const De=await de.text();throw new Error(`Anthropic PDF extraction error: ${De.substring(0,200)}`)}const ge=((z=(P=(await de.json()).content)==null?void 0:P[0])==null?void 0:z.text)||"";return`**${k}** (PDF from Drive)
...
${$.substring(0,2e4)}`}catch(m){return await H(n,s,"google","drive_read_file",m.message),`Drive read error: ${m.message}`}}case"drive_delete_file":{if(!r)return"Authentication context unavailable.";try{const{token:m}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||""),E=t.url_or_id.trim();let h=E;const w=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const R of w){const A=E.match(R);if(A){h=A[1];break}}const b=await fetch(`https://www.googleapis.com/drive/v3/files/${h}?fields=name`,{headers:{Authorization:`Bearer ${m}`}});if(!b.ok)throw new Error(`Drive API error (${b.status})`);const S=await b.json(),k=await fetch(`https://www.googleapis.com/drive/v3/files/${h}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!k.ok)throw new Error(`Drive API error (${k.status})`);return`"${S.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(m){return await H(n,s,"google","drive_delete_file",m.message),`Drive delete error: ${m.message}`}}case"drive_organise":{if(!r)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:m}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(n,s,r,a||"",i||""),E=t.url_or_id.trim();let h=E;const w=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const S of w){const k=E.match(S);if(k){h=k[1];break}}const b=[];if(t.new_name){const S=await fetch(`https://www.googleapis.com/drive/v3/files/${h}`,{method:"PATCH",headers:{Authorization:`Bearer ${m}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!S.ok)throw new Error(`Drive rename error (${S.status})`);b.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:S}=await Dn(m,h,t.folder_name);b.push(`Moved to folder "${S}"`)}return b.join(". ")+"."}catch(m){return await H(n,s,"google","drive_organise",m.message),`Drive organise error: ${m.message}`}}case"web_search":try{const m=await Ot(t.query,{num:t.num_results||5,site:t.site,googleApiKey:o||void 0,googleCseId:l||void 0});return m.error?`Web search failed: ${m.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:m.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:m.results.map((E,h)=>`${h+1}. [${E.title}](${E.link})
   ${E.snippet}`).join(`

`)}catch(m){return await H(n,s,"search","web_search",m.message),`Web search error: ${m.message}`}case"read_url":try{const m=t.url;if(!m||!m.startsWith("http://")&&!m.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const E=Math.min(t.max_length||8e3,15e3),{fetchPageContent:h}=await Promise.resolve().then(()=>yo),w=await h(m,E);return w.error?`Failed to read page: ${w.error}`:!w.text||w.text.length<20?`Page at ${m} returned no readable content.`:`Content from ${m} (${w.text.length} chars):

${w.text}`}catch(m){return await H(n,s,"search","read_url",m.message),`Read URL error: ${m.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{let m,E;try{for(const I of["llm_slot_1","llm_slot_2","llm_slot_3"]){const C=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,I).first();if(!C||!r)continue;const O=JSON.parse(await G(C.encrypted_value,r));if(O.provider==="anthropic"&&O.apiKey){m=O.apiKey;break}}const A=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"tavily_api_key").first();A&&r&&(E=await G(A.encrypted_value,r))}catch{}const h=t.depth||"quick",w=h==="thorough"?3e5:9e4,b=Ar(t.query,d,{depth:h,site:t.site,anthropicKey:m,tavilyKey:E,googleApiKey:o||void 0,googleCseId:l||void 0}),S=new Promise(A=>setTimeout(()=>A(null),w)),k=await Promise.race([b,S]);if(k===null){const{webSearch:A}=await Promise.resolve().then(()=>ro),I=await A(t.query,{num:5,googleApiKey:o||void 0,googleCseId:l||void 0});if(I.error||I.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let C=`Research took too long, but here are the top search results:

`;return C+=I.results.map((O,$)=>`${$+1}. [${O.title}](${O.link})
   ${O.snippet}`).join(`
...
`,R+=k.sources.map((A,I)=>`[${I+1}] [${A.title}](${A.url})`).join(`
`)),R+=`

---
💡 *Say "save as note" to store this report in your notes.*`,h==="thorough"&&m&&(R+=`
⚠️ *Thorough research used ~3 Opus 4.8 API calls (~$0.10–$0.30 at standard rates).*`);try{const A=new Q(n),I=k.report.substring(0,600);await A.store(s,"context",`Research: ${t.query.substring(0,80)}`,I,6,"long_term")}catch{}return R}catch(m){return await H(n,s,"research","research",m.message),`Research error: ${m.message}`}}case"save_note":try{const m=(t.content||"").trim();if(!m)return"Note content cannot be empty.";const E=t.source||"manual",h=["manual","research","chat"].includes(E)?E:"manual",w=await n.prepare(`INSERT INTO notes (user_id, title, content, tags, source, source_query, is_pinned)
           VALUES (?, ?, ?, ?, ?, ?, 0) RETURNING id, title`).bind(s,(t.title||"").trim(),m,(t.tags||"").trim(),h,(t.source_query||"").trim()).first();return`Note added — ${w!=null&&w.title&&w.title!=="Untitled"?w.title:m.substring(0,60)+(m.length>60?"…":"")}`}catch(m){return`Failed to save note: ${m.message}`}case"search_notes":try{const m=(t.query||"").trim();if(!m)return"Search query is required.";const E=`%${m}%`,w=(await n.prepare(`SELECT id, title, content, tags, is_pinned, updated_at FROM notes
           WHERE user_id = ? AND (title LIKE ? OR content LIKE ? OR tags LIKE ?)
           ORDER BY updated_at DESC LIMIT 20`).bind(s,E,E,E).all()).results||[];return w.length===0?`No notes found matching "${m}".`:w.map(b=>`[#${b.id}] ${b.is_pinned?"📌 ":""}${b.title||"Untitled"} (${b.updated_at})
${b.content.slice(0,200)}${b.content.length>200?"...":""}${b.tags?`
Tags: ${b.tags}`:""}`).join(`

`)}catch(m){return`Note search failed: ${m.message}`}case"list_notes":try{const m=Math.min(t.limit||10,50),E=t.tag,h=t.pinned_only===!0,w=["user_id = ?"],b=[s];E&&(w.push("tags LIKE ?"),b.push(`%${E}%`)),h&&w.push("is_pinned = 1"),b.push(m);const k=(await n.prepare(`SELECT id, title, content, tags, is_pinned, updated_at FROM notes
           WHERE ${w.join(" AND ")} ORDER BY is_pinned DESC, updated_at DESC LIMIT ?`).bind(...b).all()).results||[];return k.length===0?"No notes found.":k.map(R=>`[#${R.id}] ${R.is_pinned?"📌 ":""}${R.title||"Untitled"} (${R.updated_at})
${R.content.slice(0,150)}${R.content.length>150?"...":""}`).join(`

`)}catch(m){return`Failed to list notes: ${m.message}`}case"delete_note":try{const m=t.id;return m?(await n.prepare("DELETE FROM notes WHERE id = ? AND user_id = ?").bind(m,s).run()).meta.changes?`Note #${m} deleted.`:`Note #${m} not found.`:"Note ID is required."}catch(m){return`Failed to delete note: ${m.message}`}case"browser_task":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const E=(await G(m.encrypted_value,r)).trim();let h,w=t.task,b,S;if(!t.site_name)try{const $=await n.prepare("SELECT name FROM site_credentials WHERE user_id = ?").bind(s).all(),B=w.toLowerCase(),J=($.results||[]).find(X=>B.includes(X.name.toLowerCase()));J&&(t={...t,site_name:J.name},_s("browser_task auto-vault: inferred site_name from task text",{siteName:J.name,userId:s}))}catch{}if(t.site_name)try{const $=await n.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(s,t.site_name).first();if($){const B=JSON.parse(await G($.encrypted_blob,r));h={username:B.username,password:B.password},S=B.sessionId,b=$.id,w=`${w}

When prompted to log in, use username {username} and password {password}.`}}catch{}const k=async $=>{if(b)try{const B=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(b,s).first();if(!B)return;const J=JSON.parse(await G(B.encrypted_blob,r));J.sessionId=$,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await Nt(JSON.stringify(J),r),b,s).run()}catch{}},R=async()=>{if(!(!b||!S))try{const $=await n.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(b,s).first();if(!$)return;const B=JSON.parse(await G($.encrypted_blob,r));delete B.sessionId,await n.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(await Nt(JSON.stringify(B),r),b,s).run()}catch{}},A=/blue[\s-]?dart[\s\S]{0,100}?(\d{10,11})|(\d{10,11})[\s\S]{0,100}?blue[\s-]?dart/i.exec(w);if(A){const $=A[1]||A[2];w=bo($)}const I=void 0;g&&(g.apiKey=E,S&&!g.sessionId?(g.sessionId=S,g.persistSession=!0):!g.sessionId&&b&&(g.sessionId=await wo(E)??void 0)),_s("browser_task starting",{userId:s,channel:v,timeoutMs:I??3e5,sessionId:g==null?void 0:g.sessionId,vaultSession:!!S});const C=await qn(w,E,{secrets:h,sessionId:g==null?void 0:g.sessionId,timeoutMs:I});if(C.status==="completed"){const $=(g==null?void 0:g.sessionId)??void 0;return b&&$&&(g&&(g.persistSession=!0),await k($)),(W=C.output)!=null&&W.includes('"captcha_required": true')?"Captcha detected — manual verification required. The site blocked automated access. Please try completing it manually or try again later.":C.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again."}if(C.status==="timeout"){g&&(g.hasActiveTask=!0);try{await new Q(n).store(s,"context",`Browser task in progress: ${C.taskId}`,JSON.stringify({task_id:C.taskId,task:t.task}),9,"working")}catch{}try{const $=(t.task||"").substring(0,200);await n.prepare("INSERT INTO pending_browser_tasks (user_id, task_id, task_description, thread_id, channel) VALUES (?, ?, ?, ?, ?)").bind(s,C.taskId,$,(g==null?void 0:g.threadId)??null,v).run()}catch{}return`[BROWSER_TIMEOUT:${C.taskId}] Browser task did not finish within the time limit. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}S&&E&&hn(S,E).catch(()=>{}),g&&(g.persistSession=!1),await R();const O=[C.error,C.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${C.taskId}\`): ${O||"No details returned."} | Operator hint: Check Browser Use dashboard — taskId=${C.taskId}`}catch(m){return await H(n,s,"browser","browser_task",m.message),`Browser task error: ${m.message}`}}case"browser_task_status":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"browser_use_api_key").first();if(!m)return"Browser Use API key not configured.";const E=await G(m.encrypted_value,r),h=await Pr(t.task_id,E);if(h.done){try{const w=new Q(n),b=await w.search(s,`Browser task in progress: ${t.task_id}`);for(const S of b)await w.remove(S.id,s)}catch{}return h.status==="finished"||h.status==="completed"?h.output?h.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${h.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${h.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working — I'll send you a notification as soon as it's done. No need to follow up."`}catch(m){return await H(n,s,"browser","browser_task_status",m.message),`Browser status check error: ${m.message}`}}case"vault_lookup":try{const m=(t.site_name||"").trim();if(!m)return"No site name provided.";const h=((await n.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(s,`%${m}%`).all()).results||[]).map(w=>w.name);return h.length===0?`No vault entries found matching "${m}".`:`Vault entries matching "${m}": ${h.join(", ")}. Use site_name="${h[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const E=await G(m.encrypted_value,r),h=await Tr(E,t.query,{type:t.type});return h.error?`Places search failed: ${h.error}`:h.results.length===0?`No places found for "${t.query}".`:h.results.map((w,b)=>{const S=w.rating?` ★${w.rating} (${w.userRatingsTotal||0} reviews)`:"",k=w.openNow!==void 0?w.openNow?" · Open now":" · Closed":"",R=w.googleMapsUri?`
   ${w.googleMapsUri}`:"";return`${b+1}. **${w.name}**${S}${k}
   ${w.address}${R}
   [place_id: ${w.placeId}]`}).join(`

`)}catch(m){return await H(n,s,"google_api","search_places",m.message),`Places search error: ${m.message}`}}case"get_place_details":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const E=await G(m.encrypted_value,r),h=await Sr(E,t.place_id);if(h.error)return`Details lookup failed: ${h.error}`;if(!h.details)return"No details found.";const w=h.details;let b=`**${w.name}**
📍 ${w.address}`;if(w.phone&&(b+=`
📞 ${w.phone}`),w.website&&(b+=`
🌐 ${w.website}`),w.rating&&(b+=`
★ ${w.rating}`),w.googleMapsUri&&(b+=`
📌 ${w.googleMapsUri}`),w.openingHours&&(b+=`

Opening Hours:
${w.openingHours.join(`
`)}`),w.reviews&&w.reviews.length>0){b+=`

Recent Reviews:`;for(const S of w.reviews)b+=`
— ${S.author} (★${S.rating}, ${S.time}): "${S.text}"`}return b}catch(m){return await H(n,s,"google_api","place_details",m.message),`Place details error: ${m.message}`}}case"get_directions":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const E=await G(m.encrypted_value,r),h=await kr(E,t.origin,t.destination,{mode:t.mode||"driving"});if(h.error)return`Directions failed: ${h.error}`;if(!h.route)return"No route found.";const w=h.route;let b=`**${w.startAddress}** → **${w.endAddress}**
`;return b+=`📏 ${w.distance} · ⏱️ ${w.duration}`,w.durationInTraffic&&(b+=` (with traffic: ${w.durationInTraffic})`),b+=`
via ${w.summary}`,b+=`

Steps:`,w.steps.forEach((S,k)=>{b+=`
${k+1}. ${S.instruction} (${S.distance}, ${S.duration})`}),b}catch(m){return await H(n,s,"google_api","directions",m.message),`Directions error: ${m.message}`}}case"get_travel_time":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const E=await G(m.encrypted_value,r),h=await Nr(E,t.origin,t.destination,t.mode||"driving");if(h.error)return`Travel time lookup failed: ${h.error}`;let w=`${t.origin} → ${t.destination}: ${h.distance}, ${h.duration}`;return h.durationInTraffic&&(w+=` (with traffic: ${h.durationInTraffic})`),w}catch(m){return await H(n,s,"google_api","travel_time",m.message),`Travel time error: ${m.message}`}}case"translate_text":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const E=await G(m.encrypted_value,r),h=await xr(E,t.text,t.target_language,t.source_language);return h.error?`Translation failed: ${h.error}`:`[${h.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${h.translatedText}`}catch(m){return await H(n,s,"google_api","translate",m.message),`Translation error: ${m.message}`}}case"search_youtube":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const E=await G(m.encrypted_value,r),h=await Rr(E,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return h.error?`YouTube search failed: ${h.error}`:h.results.length===0?`No YouTube results for "${t.query}".`:h.results.map((w,b)=>{var S;return`${b+1}. **${w.title}**
   ${w.channelTitle} · ${((S=w.publishedAt)==null?void 0:S.split("T")[0])||""}
   ${w.description}
   ${w.url}`}).join(`

`)}catch(m){return await H(n,s,"google_api","youtube_search",m.message),`YouTube search error: ${m.message}`}}case"geocode_address":{if(!r)return"Authentication context unavailable.";try{const m=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,"google_api_key").first();if(!m)return"Google API Key not configured.";const E=await G(m.encrypted_value,r),h=await Dr(E,t.address);return h.error?`Geocoding failed: ${h.error}`:h.results.length===0?`Location not found: "${t.address}"`:h.results.map((w,b)=>`${b+1}. ${w.address}
   Coordinates: ${w.lat}, ${w.lng}`).join(`
...
${h.extracted_text}`;const{file_name:w,file_type:b}=h;let{file_data:S}=h;if(S==="r2"){if(!u)return`File "${w}" is stored in R2 but no storage bucket is configured.`;const k=await u.get(m);if(!k)return`File "${w}" not found in storage. It may have been deleted.`;const R=await k.arrayBuffer();S=Buffer.from(R).toString("base64")}if(b.startsWith("text/"))try{const k=Buffer.from(S,"base64").toString("utf-8");return`Document: ${w}

${k.substring(0,2e4)}`}catch{return`Could not decode text file: ${w}`}if(b==="application/pdf"||b==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||w.toLowerCase().endsWith(".pdf")||w.toLowerCase().endsWith(".docx")){if(b==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||w.toLowerCase().endsWith(".docx")){try{const A=await jr(Buffer.from(S,"base64"));if(A.length>50){try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(A,m,s).run();const I=A.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind(I,A.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const C=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(C){const{indexDocumentChunks:O}=await Promise.resolve().then(()=>Ve);O({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,C.id,A).catch(()=>{})}}}catch{}return`Document: ${w}

${A.substring(0,2e4)}`}}catch{}return`Could not extract text from "${w}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let k=null,R="claude-sonnet-4-6";for(const A of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const I=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,A).first();if(I&&r){const C=await G(I.encrypted_value,r),O=JSON.parse(C);if(O.provider==="anthropic"){k=O.apiKey,O.model&&(R=O.model);break}}}catch{}if(k)try{const A=E?`Focus specifically on extracting: ${E}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",I=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:R,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:S}},{type:"text",text:A}]}]})});if(I.ok){const O=((j=(ne=(await I.json()).content)==null?void 0:ne[0])==null?void 0:j.text)||"";if(O&&O.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(O,m,s).run();const $=O.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind($,O.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const B=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(B){const{indexDocumentChunks:J}=await Promise.resolve().then(()=>Ve);J({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,B.id,O).catch(()=>{})}}}catch{}return`Document: ${w}

${O}`}else{const C=await I.text();return`Could not parse ${w} via Anthropic API: ${C.substring(0,200)}`}}catch(A){return`Document parsing error for ${w}: ${A.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}if(b.startsWith("image/")){let k=null,R="claude-sonnet-4-6";for(const I of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const C=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(s,I).first();if(C&&r){const O=await G(C.encrypted_value,r),$=JSON.parse(O);if($.provider==="anthropic"){k=$.apiKey,$.model&&(R=$.model);break}}}catch{}if(!k)return"To extract text from images, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set.";const A=E?`Focus specifically on: ${E}`:"Extract all visible text from this image. Include any text from signs, documents, screenshots, or diagrams. If the image contains charts or tables, describe their structure and data.";try{const I=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":k,"anthropic-version":"2023-06-01","content-type":"application/json"},body:JSON.stringify({model:R,max_tokens:4096,messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:b,data:S}},{type:"text",text:A}]}]})});if(I.ok){const O=((q=(Y=(await I.json()).content)==null?void 0:Y[0])==null?void 0:q.text)||"";if(O&&O.length>50)try{await n.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ? AND user_id = ? AND extracted_text IS NULL").bind(O,m,s).run();const $=O.substring(0,600);if(await n.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ? AND extracted_text IS NULL").bind($,O.substring(0,5e4),m,s).run(),p!=null&&p.ai&&(p!=null&&p.vectorize)){const B=await n.prepare("SELECT dl.id FROM document_library dl LEFT JOIN document_chunks dc ON dc.document_id = dl.id WHERE dl.file_id = ? AND dl.user_id = ? AND dc.id IS NULL LIMIT 1").bind(m,s).first();if(B){const{indexDocumentChunks:J}=await Promise.resolve().then(()=>Ve);J({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,B.id,O).catch(()=>{})}}}catch{}return`Document: ${w}

${O}`}else{const C=await I.text();return`Could not parse ${w} via Anthropic API: ${C.substring(0,200)}`}}catch(I){return`Image parsing error for ${w}: ${I.message}`}}try{const k=Buffer.from(S,"base64").toString("utf-8").substring(0,2e3);return`Document: ${w} (${b})

Content preview:
${k}`}catch{return`Cannot read file: ${w} (${b})`}}case"search_library":{const m=t.query,E=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!m)return"query is required for search_library.";if(p!=null&&p.ai&&(p!=null&&p.vectorize))try{const{semanticDocumentSearch:k}=await Promise.resolve().then(()=>Ve),R=await k({DB:n,AI:p.ai,VECTORIZE:p.vectorize},s,m,E);if(R.length>0){const A=R.map(I=>`[id:${I.document_id}] "${I.filename}" (relevance: ${(I.relevance_score*100).toFixed(1)}%)
...
Use read_library_file with the id to get the full document text.`}}catch{}const h=await n.prepare(`
        ...
        LIMIT ?
      `).bind(s,`%${m}%`,`%${m}%`,`%${m}%`,E).all(),w=await n.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(s,s,`%${m}%`,s,`%${m}%`,`%${m}%`,`%${m}%`,E).all(),b=[...h.results||[],...w.results||[]].slice(0,E);if(b.length===0)return`No documents found matching "${m}" in your library.`;const S=b.map(k=>{const R=(k.summary||k.dl_extracted||"").substring(0,200);return`[id:${k.id}] "${k.name}" (source: ${k.source}, status: ${k.status})
...
Use read_library_file with the id to get full text.`}case"read_library_file":{const m=String(t.id_or_name||"").trim();if(!m)return"id_or_name is required for read_library_file.";const E=parseInt(m,10);let h=null;if(isNaN(E)||(h=await n.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           ...
           FROM document_library dl WHERE dl.user_id = ? AND dl.name LIKE ? LIMIT 1`).bind(s,`%${m}%`).first()),!h)return`Document "${m}" not found. Use search_library to find available documents.`;let w=h.extracted_text||null;if(!w&&h.file_id){const b=await n.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(h.file_id,s).first();w=(b==null?void 0:b.extracted_text)||null}return w||(w=h.summary||null),w?`Document: ${h.name}

${w.substring(0,2e4)}`:`Document "${h.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${h.file_id}") to extract the text first.`}case"create_skill":{const m=(Z=t.name)==null?void 0:Z.trim(),E=(te=t.description)==null?void 0:te.trim(),h=(oe=t.instructions)==null?void 0:oe.trim();if(!m||!E||!h)return"create_skill requires name, description, and instructions.";let w=m.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");w||(w=`skill_${Date.now()}`);const b=await n.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(s,`${w}%`).all();(re=b.results)!=null&&re.some(A=>A.slug===w)&&(w=`${w}_${(((he=b.results)==null?void 0:he.length)||0)+1}`);const S=JSON.stringify(t.parameters||{}),k=JSON.stringify(t.required_tools||[]),R=JSON.stringify(t.examples||[]);return await n.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(s,m,w,E,h,S,k,R).run(),`Skill created: **${m}** (invoke as: "${w}")

You can now ask me to run "${m}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${m} skill" to execute it.`}case"list_skills":{const E=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",w=(await n.prepare(E).bind(s).all()).results||[];if(w.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const b=w.map(S=>`• **${S.name}** (${S.slug}): ${S.description} [used ${S.usage_count} times${S.enabled?"":" — disabled"}]`).join(`
`);return`Your custom skills (${w.length}):

${b}`}default:{const m=e,E=await n.prepare("SELECT id, name, description, instructions, required_tools FROM user_skills WHERE user_id = ? AND slug = ? AND enabled = 1").bind(s,m).first();if(E){await n.prepare("UPDATE user_skills SET usage_count = usage_count + 1, last_used_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run();const h=(()=>{try{return JSON.parse(E.required_tools).join(", ")}catch{return""}})(),w=Object.keys(t).length>0?`
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function sa(e,t,n,s,r){if(t.length>0&&t[t.length-1].role==="user"){const a="(Previous request did not complete. Please try again.)";await e.storeMessage(n,s,"assistant",a,"{}",r),t.push({id:-1,user_id:n,channel:s,role:"assistant",content:a,metadata:"{}",token_estimate:a.length,created_at:new Date().toISOString()})}}function ra(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const n=typeof e[t].content=="string"?e[t].content:"";n.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(n.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function Es(e,t,n,s,r,a,i){var oe,re,he,m,E;const o=new Q(t),l=(oe=e.metadata)==null?void 0:oe.thread_id,c=Date.now(),[d,u,p,v]=await Promise.all([o.buildContext(s.id),Un(t,s.id),ns(t,s.id),zr(t,s.id)]),g=await o.getRecentConversations(s.id,30,l);await sa(o,g,s.id,e.channel,l);const f=Qr(s,d,e.channel,p,v,u),y=Qn(g),_=es([{role:"system",content:f},...Xn(g),{role:"user",content:e.text}]);Xr(_,y),ra(_);const T=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],x=(d.match(/^- /gm)||[]).length;if(T.some(h=>h.test(e.text))||x<3)try{const h=await o.searchLongTerm(s.id,e.text,5);if(h.length>0){const w=h.map(b=>`- [${b.type}] ${b.title}: ${b.content}`).join(`
...
`)){const p=u.trim().split("|");if(p.length<4)continue;const[v,g,f,y]=p,_=["fact","preference","context","decision","summary","task"].find(x=>x===v.trim().toLowerCase());if(!_||!(g!=null&&g.trim())||!(f!=null&&f.trim()))continue;const T=Math.min(10,Math.max(1,parseInt(y)||5));await s.store(n.id,_,g.trim(),f.trim(),T,"long_term")}}const Ts={"claude-opus-4-8":1e6,"claude-sonnet-4-6":1e6,"claude-haiku-4-5":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Xo(e){for(const[t,n]of Object.entries(Ts))if(e.toLowerCase().includes(t.toLowerCase()))return n;return Ts.default}function Qo(e,t,n,s){const r=Xo(s),a=Math.floor(r*.75),i=[];let o=0,l=!1;const c=kn(e);i.push({role:"system",content:e}),o+=c;const d=kn(n);o+=d;const u=a-o,p=[];let v=0;for(let g=t.length-1;g>=0;g--){const f=t[g],y=kn(f.content);if(v+y<=u)p.unshift({role:f.role,content:f.content}),v+=y;else{l=!0;break}}return i.push(...p),i.push({role:"user",content:n}),o+=v,{maxTokens:r,usedTokens:o,messages:i,wasTruncated:l}}async function*el(e,t,n,s,r,a){var he,m,E;const i=new Q(t),o=(he=e.metadata)==null?void 0:he.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:n.name}};const[c,d,u,p]=await Promise.all([i.buildContext(s.id),Un(t,s.id),ns(t,s.id),zr(t,s.id)]),v=await i.getRecentConversations(s.id,30,o);await sa(i,v,s.id,e.channel,o);const g=Qr(s,c,e.channel,u,p,d),f=Qn(v),y=es([...Xn(v)]);let _=e.text;f&&(_=`${Ln}

${e.text}`);const T=Qo(g,y.map(h=>({role:h.role,content:h.content})),_,n.name);await i.storeMessage(s.id,e.channel,"user",e.text,"{}",o);const x=await ts(t,s.id),L=10;let N="",M=0;const P=[...T.messages],z=[];let W,ne=0,j=0;const Y={hasActiveTask:!1,persistSession:!1,threadId:o,channel:e.channel},q=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],Z=(c.match(/^- /gm)||[]).length;if(q.some(h=>h.test(e.text))||Z<3||f)try{const h=await i.searchLongTerm(s.id,e.text,5);if(h.length>0){const w=h.map(b=>`- [${b.type}] ${b.title}: ${b.content}`).join(`
`);P.splice(P.length-1,0,{role:"assistant",content:"I retrieved some relevant context from your long-term memory."},{role:"user",content:`[Long-term memory retrieved for this query:
${w}]`})}}catch{}ra(P);const oe=()=>Jr(z,W);for(let h=0;h<L;h++){ne=h+1;try{h>0&&(yield{type:"thinking",data:{threadId:o}},na(P));const w=await n.chat(P,{tools:x});if(w.usage&&(M+=w.usage.promptTokens+w.usage.completionTokens),w.toolCalls&&w.toolCalls.length>0){const k=((m=w.content)==null?void 0:m.trim())??"";k&&k.length<=150&&!/^\[calling:/i.test(k)&&(yield{type:"chunk",data:{text:w.content,threadId:o}});const R=w.content||"(tools executed)";P.push({role:"assistant",content:R});const A=[];for(const I of w.toolCalls){yield{type:"tool_start",data:{tool:I.name,toolArgs:I.arguments,threadId:o}},z.push(I.name);try{const C=(X,K)=>Wt(X,K,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE},Y);let O;if(I.name==="research"&&(yield{type:"research_ack",data:{message:(I.arguments.depth||"quick")==="thorough"?"Starting deep research with Opus 4.8 — planning queries, reading sources, and identifying gaps. This takes 2-4 minutes and uses ~3 Opus API calls.":"Researching with Opus 4.8... (45–90 seconds)",threadId:o}}),I.name==="browser_task"||I.name==="browser_task_status"){if(I.name==="browser_task"){const ce=I.arguments.site_name;yield{type:"browser_ack",data:{message:ce?`Starting now — opening ${ce} in a browser. I'll notify you when done.`:"Starting now — running browser task. I'll notify you when done.",startedAt:new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:s.timezone||"UTC"}),threadId:o}}}const K=["Still working — browser launched, navigating to site...","Still working — page loaded, scanning for content...","Still working — reading and extracting results...","Still working — almost there, finalising output...","Taking a bit longer — site may require extra steps...","Still running — browser is working through the page...","Continuing — extracting and processing data...","Still going — complex task, nearly there...","Almost done — wrapping up the browser session...","Still running — holding on a little longer...","Browser is still active — this one is taking time...","Patience — still working through the task...","Still running — will have a result for you shortly..."],ie=C(I.name,I.arguments);let de=0;e:for(;;){const ce=await Promise.race([ie.then(ge=>({done:!0,r:ge})),new Promise(ge=>setTimeout(()=>ge({done:!1}),15e3))]);if(ce.done){O=ce.r;break e}I.name==="browser_task"?yield{type:"browser_progress",data:{message:K[Math.min(de,K.length-1)],elapsed_s:(de+1)*15,threadId:o}}:yield{type:"thinking",data:{threadId:o}},de++}if(I.name==="browser_task"){const ce=O.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(ce){yield{type:"browser_progress",data:{message:"Task still running — checking final status...",threadId:o}};const ge=C("browser_task_status",{task_id:ce[1]});e:for(;;){const De=await Promise.race([ge.then(Te=>({done:!0,r:Te})),new Promise(Te=>setTimeout(()=>Te({done:!1}),15e3))]);if(De.done){O=De.r;break e}yield{type:"thinking",data:{threadId:o}}}if(!O.startsWith("[still-running]")&&!O.startsWith("[NO-OUTPUT]")&&!O.startsWith("Browser"))try{await t.prepare("DELETE FROM pending_browser_tasks WHERE user_id = ? AND task_id = ? AND notified = 0").bind(s.id,ce[1]).run()}catch{}}}}else if(I.name==="research"){const ie=(I.arguments.depth||"quick")==="thorough"?["Still researching — planning sub-queries...","Still researching — fetching sources...","Still researching — reading pages...","Still researching — identifying gaps...","Still researching — running gap searches...","Still researching — synthesising findings...","Almost done — writing final report...","Wrapping up — almost there..."]:["Still researching — fetching sources...","Still researching — reading pages...","Almost done — synthesising findings..."],de=C(I.name,I.arguments);let ce=0;e:for(;;){const ge=await Promise.race([de.then(Te=>({done:!0,r:Te})),new Promise(Te=>setTimeout(()=>Te({done:!1}),2e4))]);if(ge.done){O=ge.r;break e}yield{type:"research_progress",data:{message:ie[Math.min(ce,ie.length-1)],elapsed_s:(ce+1)*20,threadId:o}},ce++}}else O=await C(I.name,I.arguments);let $=O;(I.name==="browser_task"||I.name==="browser_task_status")&&(/^\[BROWSER_TIMEOUT:/.test($)?$="Task timed out — still running in background.":/^\[NO-OUTPUT\]/.test($)?$="Browser task finished but returned no content.":/^\[still-running\]/.test($)?$="Still running — will notify when done.":$=$.replace(/\s*\|\s*Operator hint:.*$/s,"")),yield{type:"tool_end",data:{tool:I.name,toolResult:$.substring(0,500)+($.length>500?"...":""),threadId:o}};const B=["parse_document","drive_read_file","read_library_file"].includes(I.name)?2e4:I.name==="research"?16e3:8e3,J=O.length>B?O.substring(0,B)+`
[...result truncated to prevent token limit — full content was extracted]`:O;W=Zr(I.name,I.arguments,O,W),A.push(`[Tool Result for ${I.name}]: ${J}`)}catch(C){j++,await H(t,s.id,"tool",I.name,C.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:I.name,toolResult:`Error: ${C.message||"Execution failed"}`,threadId:o}},A.push(`[Tool Error for ${I.name}]: ${C.message||"Execution failed"}`)}}P.push({role:"user",content:A.join(`

`)});continue}N=w.content;const b=Ft(N);await i.storeMessage(s.id,e.channel,"assistant",b,oe(),o);const S=50;for(let k=0;k<b.length;k+=S)yield{type:"chunk",data:{text:b.substring(k,k+S),threadId:o}},k+S<b.length&&await new Promise(A=>setTimeout(A,10));break}catch(w){if(r){const k=w.message||"",R=k.includes("401")||k.includes("403")||k.includes("authentication")||k.includes("credit balance"),A=k.includes("429"),I=R?1440:A?10:5;await r.recordError(n.name,k,I)}await H(t,s.id,"llm","provider_error",w.message||"Unknown LLM error",{provider:n.name,turn:h});const b=w.message||"An error occurred",S=b.includes("429")||b.toLowerCase().includes("rate limit")||b.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":b;try{await i.storeMessage(s.id,e.channel,"assistant",`⚠️ ${S}`,"{}",o)}catch{}yield{type:"error",data:{error:S,threadId:o}};return}}if(N=(N==null?void 0:N.trim())??"",!N)try{P.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),N=(await n.chat(P,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const w=Ft(N);await i.storeMessage(s.id,e.channel,"assistant",w,oe(),o);const b=50;for(let S=0;S<w.length;S+=b)yield{type:"chunk",data:{text:w.substring(S,S+b),threadId:o}},S+b<w.length&&await new Promise(k=>setTimeout(k,10))}catch{N="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(s.id,e.channel,"assistant",N,oe(),o).catch(()=>{}),yield{type:"chunk",data:{text:N,threadId:o}}}if(r&&M>0)try{await r.recordUsage(n.name,M)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"full",M,Date.now()-l,1,e.channel).run()}catch{}const re=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc|(saved|stored)\s+(it\s+|the\s+essay\s+|the\s+article\s+)?(to|in|on)\s+(your\s+)?(google\s+)?drive|essay\s+(is\s+)?(saved|stored)\s+(in|on|to)\s+(drive|google\s+docs?))\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created or saved a Google Document but create_doc was never called. You MUST call create_doc NOW with the full content in the content parameter.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const h of re){const w=h.claimPattern.test(N),b=h.requiredTools.some(S=>z.includes(S));if(w&&!b){try{await H(t,s.id,"llm",h.logType,"LLM claimed action without tool call (streaming)",{response:N.substring(0,200)}),P.push({role:"assistant",content:N}),P.push({role:"user",content:h.enforcementMsg});const S=await n.chat(P,{tools:x.filter(k=>h.requiredTools.includes(k.name)),temperature:0});if((E=S.toolCalls)!=null&&E.length){for(const R of S.toolCalls){const A=await Wt(R.name,R.arguments,t,s.id,{agentType:"full",providerName:n.name,channel:e.channel},s.pin_hash,a==null?void 0:a.GOOGLE_CLIENT_ID,a==null?void 0:a.GOOGLE_CLIENT_SECRET,a==null?void 0:a.GOOGLE_API_KEY,a==null?void 0:a.GOOGLE_CSE_ID,s.timezone,n,a==null?void 0:a.DOCUMENTS_BUCKET,{ai:a==null?void 0:a.AI,vectorize:a==null?void 0:a.VECTORIZE});z.push(R.name),P.push({role:"assistant",content:"",toolCalls:S.toolCalls}),P.push({role:"user",content:A})}const k=await n.chat(P,{tools:[]});k.content&&(N=k.content)}else N="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}z.length>=3&&Promise.race([Gr(t,n,s,e.text,z,ne,j===0),new Promise(h=>setTimeout(h,6e3))]).catch(()=>{}),Y.sessionId&&Y.apiKey&&!Y.hasActiveTask&&!Y.persistSession&&hn(Y.sessionId,Y.apiKey).catch(()=>{}),yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:M}}}async function Mn(e,t,n,s,r,a,i,o){await a.storeMessage(r.id,t.channel,"user",t.text,"{}",o);const l=await Wt(e.tool,e.args,n,r.id,{agentType:"direct",channel:t.channel},r.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,r.timezone,s,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),c=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await a.storeMessage(r.id,t.channel,"assistant",c,"{}",o),l}async function ss(e,t,n,s,r,a){var f;const i=new Q(t),o=(f=e.metadata)==null?void 0:f.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Gn(e.text,l,Vr(c));if(d.agent==="conversation")return aa(e,t,n,s,l,r,o);const u=Kn(e.text);if(u)return Mn(u,e,t,n,s,i,a,o);const p=(await i.getRecentConversations(s.id,10,o)).map(y=>y.content).join(`
`),v=Yn(e.text,p);if(v)return Mn(v,e,t,n,s,i,a,o);const g=d.confidence>=.85;if(e.channel==="telegram"){const y=await ts(t,s.id);return Es(e,t,n,s,r,a,{maxTurns:10,tools:y,forceToolUseOnFirstTurn:g})}return Es(e,t,n,s,r,a,{forceToolUseOnFirstTurn:g})}async function aa(e,t,n,s,r,a,i){const o=new Q(t),l=Date.now(),c=ea(s.timezone),d=await ns(t,s.id),u=d?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${d}

${r}`:r,p=Hr("conversation",s,u,s.timezone,c,e.channel),v=(await o.getRecentConversations(s.id,30,i)).filter(x=>!x.content.startsWith("[Autonomous Scheduled Task]")&&!x.content.startsWith("[Scheduled Reminder]")),g=Qn(v),f=es([{role:"system",content:p},...Xn(v),{role:"user",content:e.text}]);Xr(f,g),await o.storeMessage(s.id,e.channel,"user",e.text,"{}",i);let y=0,_="";try{const x=await n.chat(f,{temperature:.8});x.usage&&(y=x.usage.promptTokens+x.usage.completionTokens),_=x.content}catch(x){if(a){const L=x.message||"",N=L.includes("401")||L.includes("403")||L.includes("authentication")||L.includes("credit balance"),M=L.includes("429"),P=N?1440:M?10:5;await a.recordError(n.name,L,P)}throw await H(t,s.id,"llm","conversation_error",x.message,{provider:n.name}),x}if(a&&y>0)try{await a.recordUsage(n.name,y)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(s.id,n.name,"conversation",y,Date.now()-l,1,e.channel).run()}catch{}const T=Ft(_);return await o.storeMessage(s.id,e.channel,"assistant",T,"{}",i),T}async function*Ss(e,t,n,s,r,a,i,o){yield{type:"tool_start",data:{tool:e.tool,toolArgs:e.args,threadId:o}};const l=await Mn(e,t,n,s,r,a,i,o);yield{type:"tool_end",data:{tool:e.tool,toolResult:l.substring(0,500)+(l.length>500?"...":""),threadId:o}};const c=Ft(l),d=50;for(let u=0;u<c.length;u+=d)yield{type:"chunk",data:{text:c.substring(u,u+d),threadId:o}},u+d<c.length&&await new Promise(p=>setTimeout(p,10));yield{type:"done",data:{threadId:o,provider:s.name,tokenCount:0}}}async function*tl(e,t,n,s,r,a){var u;const i=new Q(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=await i.buildContext(s.id),c=await i.getRecentConversations(s.id,6,o),d=Gn(e.text,l,Vr(c));if(yield{type:"thinking",data:{threadId:o,provider:n.name}},d.agent!=="conversation"){const p=Kn(e.text);if(p){yield*Ss(p,e,t,n,s,i,a,o);return}const v=(await i.getRecentConversations(s.id,10,o)).map(f=>f.content).join(`
`),g=Yn(e.text,v);if(g){yield*Ss(g,e,t,n,s,i,a,o);return}yield*el(e,t,n,s,r,a);return}try{const p=await aa(e,t,n,s,l,r,o),v=50;for(let g=0;g<p.length;g+=v)yield{type:"chunk",data:{text:p.substring(g,g+v),threadId:o}},g+v<p.length&&await new Promise(f=>setTimeout(f,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:n.name,tokenCount:0}}}const Et=new Map;function nl(){try{if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID()}catch{}return"run_"+Date.now().toString(36)+Math.random().toString(36).slice(2,10)}async function sl(e,t,n){const s=nl();return await e.prepare(`INSERT INTO chat_runs (run_id, user_id, thread_id, status, events_json)
       VALUES (?, ?, ?, 'running', '[]')`).bind(s,t,n).run(),s}async function ia(e,t){const n=await e.prepare("SELECT * FROM chat_runs WHERE run_id = ?").bind(t).first();if(!n)return null;let s=[];try{s=JSON.parse(n.events_json||"[]")}catch{s=[]}return{runId:n.run_id,userId:n.user_id,threadId:n.thread_id,status:n.status,events:s,error:n.error}}async function rl(e,t,n){const s=await e.prepare("SELECT * FROM chat_runs WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT 1").bind(t,n).first();if(!s)return null;let r=[];try{r=JSON.parse(s.events_json||"[]")}catch{r=[]}return{runId:s.run_id,userId:s.user_id,threadId:s.thread_id,status:s.status,events:r,error:s.error}}async function ks(e,t,n){const s=await e.prepare("SELECT events_json FROM chat_runs WHERE run_id = ?").bind(t).first();let r=[];try{r=JSON.parse((s==null?void 0:s.events_json)||"[]")}catch{r=[]}r.push(n),await e.prepare("UPDATE chat_runs SET events_json = ?, updated_at = CURRENT_TIMESTAMP WHERE run_id = ?").bind(JSON.stringify(r),t).run();const a=Et.get(t);if(a){a.events.push(n);for(const i of a.subscribers)try{i.push(n)}catch{}}}async function xs(e,t,n,s=null){await e.prepare("UPDATE chat_runs SET status = ?, error = ?, updated_at = CURRENT_TIMESTAMP WHERE run_id = ?").bind(n,s,t).run();const r=Et.get(t);if(r){r.status=n,r.error=s;for(const a of r.subscribers)try{a.close()}catch{}setTimeout(()=>{Et.get(t)===r&&Et.delete(t)},6e4)}}async function al(e,t,n){const s=await e.prepare("SELECT user_id FROM chat_runs WHERE run_id = ?").bind(t).first();return!!s&&s.user_id===n}function il(e,t,n,s={}){Et.set(t,{events:[],subscribers:[],status:null,error:null});const r=(async()=>{try{for await(const a of n)await ks(e,t,a);await xs(e,t,"completed")}catch(a){const i=(a==null?void 0:a.message)||String(a);try{await ks(e,t,{type:"error",data:{error:i}})}catch{}await xs(e,t,"failed",i),Ct("chat run failed",{runId:t,error:i})}})();s.waitUntil&&s.waitUntil(r.catch(()=>{}))}function oa(e){const t=e.events,n=Et.get(e.runId);if(!n||n.status!==null)return{replay:t,tail:ol(),status:e.status};const s=ll(n,t.length);return{replay:t,tail:s,status:"running"}}function ol(){return{[Symbol.asyncIterator](){return{next:async()=>({done:!0,value:void 0})}}}}function ll(e,t){return{[Symbol.asyncIterator](){let n=t;const s=[];let r=null;const a={push(i){if(r){const o=r;r=null,o({done:!1,value:i})}else s.push(i)},close(){if(r){const i=r;r=null,i({done:!0,value:void 0})}}};return e.subscribers.push(a),{next(){for(;n<e.events.length;){const i=e.events[n++];return Promise.resolve({done:!1,value:i})}return s.length>0?Promise.resolve({done:!1,value:s.shift()}):e.status!==null?Promise.resolve({done:!0,value:void 0}):new Promise(i=>{r=i})},return(){const i=e.subscribers.indexOf(a);return i>=0&&e.subscribers.splice(i,1),Promise.resolve({done:!0,value:void 0})}}}}}const le=new be;async function cl(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     ...
     WHERE t.user_id = ? AND t.is_archived = ?
      ...
      LIMIT ?`).bind(t.id,n?1:0,s).all();return e.json({threads:r.results||[]})});le.post("/threads",async e=>{const t=e.get("user"),{title:n}=await e.req.json(),s=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n||"New conversation").first();return e.json({thread:s})});le.put("/threads/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.req.json(),r=[],a=[];return s.title!==void 0&&(r.push("title = ?"),a.push(s.title)),s.is_archived!==void 0&&(r.push("is_archived = ?"),a.push(s.is_archived?1:0)),s.is_pinned!==void 0&&(r.push("is_pinned = ?"),a.push(s.is_pinned?1:0)),r.push("updated_at = CURRENT_TIMESTAMP"),a.push(n,t.id),r.length<=1?e.json({error:"Nothing to update"},400):(await e.env.DB.prepare(`UPDATE threads SET ${r.join(", ")} WHERE id = ? AND user_id = ?`).bind(...a).run(),e.json({success:!0}))});le.delete("/threads/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM conversations WHERE thread_id = ? AND user_id = ?").bind(n,t.id).run(),await e.env.DB.prepare("DELETE FROM threads WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});le.post("/upload",async e=>{const t=e.get("user"),n=!!e.env.DOCUMENTS_BUCKET,s=n?100*1024*1024:700*1024;let r,a,i,o=null,l=null;try{if((e.req.header("Content-Type")||"").includes("multipart/form-data")){const y=(await e.req.formData()).get("file");if(!y)return e.json({error:"No file provided."},400);if(r=y.name,a=y.type||"application/octet-stream",i=y.size,i>s)return e.json({error:`File too large (max ${n?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);o=await y.arrayBuffer()}else{const f=await e.req.json();if(!f.file_name||!f.file_data)return e.json({error:"file_name and file_data are required."},400);if(r=f.file_name,a=f.file_type||"application/octet-stream",l=f.file_data,i=f.file_size||Math.round(l.length*.75),i>s)return e.json({error:`File too large (max ${n?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);if(n){const y=atob(l);o=new ArrayBuffer(y.length);const _=new Uint8Array(o);for(let T=0;T<y.length;T++)_[T]=y.charCodeAt(T)}}const d=crypto.randomUUID();let u;n&&o?(await e.env.DOCUMENTS_BUCKET.put(d,o,{httpMetadata:{contentType:a},customMetadata:{fileName:r,userId:String(t.id)}}),u="r2"):u=l||(o?Buffer.from(o).toString("base64"):""),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(d,t.id,r,a,u,i).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,d,"upload",r,a,i,"uploaded").run();const p=a==="application/pdf"||r.toLowerCase().endsWith(".pdf"),v=a==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||r.toLowerCase().endsWith(".docx");if(v)try{const{extractDocxTextFromBuffer:f}=await Promise.resolve().then(()=>Br),y=l?Buffer.from(l,"base64"):o?Buffer.from(o):null;if(y){const _=await f(y);if(_.length>50){await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(_,d).run();const T=_.substring(0,600);await e.env.DB.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(T,_.substring(0,5e4),d,t.id).run()}}}catch{}if(p&&t.pin_hash){const f=l||(o?Buffer.from(o).toString("base64"):null),y=t.pin_hash,_=t.id,T=e.env.DB,x=e.env.DOCUMENTS_BUCKET,L=(async()=>{var N,M;try{let P=null,z="claude-sonnet-4-6";const{decrypt:W}=await Promise.resolve().then(()=>Vt);for(const Z of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const te=await T.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(_,Z).first();if(te){const oe=await W(te.encrypted_value,y),re=JSON.parse(oe);if(re.provider==="anthropic"){P=re.apiKey,re.model&&(z=re.model);break}}}catch{}if(!P)return;let ne;if(u==="r2"&&x){const Z=await x.get(d);if(!Z)return;ne=Buffer.from(await Z.arrayBuffer()).toString("base64")}else if(f)ne=f;else return;const j=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":P,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:z,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ne}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!j.ok)return;const q=((M=(N=(await j.json()).content)==null?void 0:N[0])==null?void 0:M.text)||"";if(q){await T.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(q,d).run();const Z=q.substring(0,600);await T.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(Z,q.substring(0,5e4),d,_).run()}}catch{}})();try{e.executionCtx.waitUntil(L)}catch{}}let g="";if(a.startsWith("text/"))try{const f=l||(o?Buffer.from(o).toString("base64"):"");g=Buffer.from(f,"base64").toString("utf-8").substring(0,500)}catch{}return e.json({file_id:d,name:r,type:a,size:i,text_preview:g,storage:n?"r2":"d1",extracting:p&&!v})}catch(c){console.error("File upload error:",c);try{const{logError:d}=await Promise.resolve().then(()=>bt);await d(e.env.DB,t.id,"upload","upload_error",c.message||"Unknown upload error")}catch{}return e.json({error:`Upload failed: ${c.message||"Unknown error"}`},500)}});le.post("/send",async e=>{const t=e.get("user"),{message:n,channel:s="web",thread_id:r,files:a}=await e.req.json();if(!n||typeof n!="string"||n.trim().length===0)return e.json({error:"Message is required"},400);let i="";if(a&&Array.isArray(a)&&a.length>0){i=`
...
`;for(const c of a)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=r;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,n.trim().substring(0,60)+(n.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:s,text:n.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await Qe(e.env.DB,t.id,t.pin_hash),u=await sl(e.env.DB,t.id,o),p=tl(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET}),v=(async function*(){for await(const y of p)y.data.threadId||(y.data.threadId=o),yield y})(),g=y=>{try{e.executionCtx.waitUntil(y)}catch{}};il(e.env.DB,u,v,{waitUntil:g});const f=new ReadableStream({async start(y){const _=new TextEncoder,T=await ia(e.env.DB,u);if(!T){y.enqueue(_.encode(Bt({type:"error",data:{error:"Run not found"}}))),y.close();return}const{replay:x,tail:L,status:N}=oa(T);for(const M of x)y.enqueue(_.encode(Bt(M)));if(N!=="running"){y.close();return}try{for await(const M of L)y.enqueue(_.encode(Bt(M)))}catch{}y.close()}});return new Response(f,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||""),"X-Run-Id":String(u||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("429")||d.includes("limit reached")||d.includes("rate limit")||d.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});le.get("/runs/:id/resume",async e=>{const t=e.get("user"),n=e.req.param("id");if(!n)return e.json({error:"Run id required"},400);if(!await al(e.env.DB,n,t.id))return e.json({error:"Run not found"},404);const r=await ia(e.env.DB,n);if(!r)return e.json({error:"Run not found"},404);const{replay:a,tail:i,status:o}=oa(r),l=new ReadableStream({async start(c){const d=new TextEncoder;for(const u of a)c.enqueue(d.encode(Bt(u)));if(o!=="running"){c.close();return}try{for await(const u of i)c.enqueue(d.encode(Bt(u)))}catch{}c.close()}});return new Response(l,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(r.threadId||""),"X-Run-Id":String(n)}})});le.get("/threads/:id/active-run",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));if(!Number.isFinite(n))return e.json({error:"Invalid thread id"},400);const s=await rl(e.env.DB,t.id,n);return s?e.json({run:{runId:s.runId,status:s.status,threadId:s.threadId}}):e.json({run:null})});le.get("/threads/:id/messages",async e=>{var a;const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(r).all(),i=[];for(const o of a.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(r,o.id).run();const l=o.user_timezone||"UTC";let c,d=!1,u=o.state||"active";if(o.schedule_type==="interval"){const g=parseInt(o.schedule_value,10);c=new Date(s.getTime()+g*60*1e3)}else if(o.schedule_type==="daily"){const[g,f]=o.schedule_value.split(":").map(Number),y=Ds(l),_=new Date(y);_.setHours(g,f,0,0),_<=y&&_.setDate(_.getDate()+1);const T=new Date(_.toLocaleString("en-US",{timeZone:"UTC"})),x=new Date(_.toLocaleString("en-US",{timeZone:l})),L=T.getTime()-x.getTime();c=new Date(_.getTime()+L)}else if(o.schedule_type==="weekly"){const[g,f]=o.schedule_value.split(" "),[y,_]=(f||"00:00").split(":").map(Number),x=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ne=>ne.toLowerCase()===g.toLowerCase()),L=Ds(l),N=new Date(L);N.setHours(y,_,0,0);let M=(x-N.getDay()+7)%7;M===0&&N<=L&&(M=7),N.setDate(N.getDate()+M);const P=new Date(N.toLocaleString("en-US",{timeZone:"UTC"})),z=new Date(N.toLocaleString("en-US",{timeZone:l})),W=P.getTime()-z.getTime();c=new Date(N.getTime()+W)}else o.schedule_type==="once"?(d=!0,u="completed",c=new Date(s.getTime()+365*24*60*60*1e3)):c=new Date(s.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,c.toISOString(),d?0:o.enabled,u,o.id).run();const v=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");if(o.action_type==="reminder")try{const f=JSON.parse(o.action_config||"{}").description||o.description||o.name||"Time for your scheduled task.",y="⏰ "+(o.name||"Scheduled Task");await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, 'system', 'assistant', ?, ?)").bind(o.user_id,y+`
`+f,JSON.stringify({type:"cron",job_id:o.id})).run();const{channel:_}=await We(e.env.DB,o.user_id,y,f,{pinHash:o.pin_hash||void 0,priority:"default",tags:["reminder","karna"]});_==="ntfy-failed"?console.warn(`[cron/execute] job ${o.id}: Ntfy push failed — in-app delivered. Check ntfy_url/ntfy_token in Settings.`):console.info(`[cron/execute] job ${o.id}: reminder delivered via ${_}`)}catch(g){console.warn("[cron/execute] reminder notification failed for job",o.id,":",g==null?void 0:g.message)}i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:v,next_run:c.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}try{const{MemoryService:o}=await Promise.resolve().then(()=>Yi),l=await e.env.DB.prepare("SELECT id FROM users").all();for(const c of l.results||[])await new o(e.env.DB).cleanupDoneTasks(c.id)}catch{}return e.json({executed:i.length,results:i,timestamp:r})});Ae.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);const s=parseInt(e.req.param("jobId"),10);if(!s)return e.json({error:"Invalid job ID"},400);const r=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(s).first();if(!r)return e.json({error:"Job not found"},404);if(r.action_type==="reminder")return e.json({job_id:s,status:"completed",note:"reminder handled by phase1"});const i=JSON.parse(r.action_config||"{}").description||r.description||"",o="⏰ "+(r.name||"Scheduled Task"),l=new Date().toISOString();let c="";const d=r.action_type==="reminder",u=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!d&&r.action_type==="custom"&&u.test(i),d)c=i||r.name||"Time for your scheduled task.";else try{const f={id:r.user_id,username:r.username||"user",name:r.user_name||"User",pin_hash:r.pin_hash||"",personality_prompt:r.personality_prompt||"",telegram_chat_id:r.telegram_chat_id||"",timezone:r.user_timezone||"UTC",assistant_name:r.assistant_name||"Karna",created_at:"",updated_at:""},y={userId:r.user_id,username:f.username,channel:"cron",text:pl(r.name,i,r.action_type,r.schedule_type),sessionId:"cron-"+r.id,timestamp:l},{provider:_,rotation:T}=await Qe(e.env.DB,r.user_id,r.pin_hash);c=await ss(y,e.env.DB,_,f,T,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(f){const y=f.message||"unknown error",_=y.includes("rate_limit")||y.includes("429")||y.includes("quota"),T=y.includes("timeout")||y.includes("Timeout");_?c="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":T?c="Task timed out. Will retry at next scheduled time.":c="Task encountered an error. Will retry at next scheduled time.",await H(e.env.DB,r.user_id,"cron_agent","execution_error",y,{job_id:r.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(r.action_type))try{const f=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(r.user_id).first();(!f||f.cnt===0)&&await H(e.env.DB,r.user_id,"cron_verification","no_tools_called",`Cron job "${r.name}" (${r.action_type}) completed without any tool calls`,{job_id:r.id,action_type:r.action_type,response_preview:c.substring(0,200)})}catch{}let v=c||i||"Time for your scheduled task.";v=v.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const g=o+`
`+v;if(d&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(r.user_id,"system","assistant",g,JSON.stringify({type:"cron",job_id:r.id})).run(),r.pin_hash){const{channel:f}=await We(e.env.DB,r.user_id,o,v,{pinHash:r.pin_hash,priority:"default",tags:["reminder","karna"]});f==="ntfy-failed"?console.warn(`[run-task] job ${r.id}: Ntfy push failed — in-app notification still delivered. Check ntfy_url/ntfy_token in Settings.`):f==="in-app"&&console.warn(`[run-task] job ${r.id}: Ntfy not configured — delivered in-app only.`)}else await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, 'reminder', ?, ?, ?, 0)").bind(r.user_id,o,v,"cron:"+r.id).run();return e.json({job_id:s,status:"completed",response_length:c.length})});async function da(e){var s;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return null;const n=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(n==null?void 0:n.user_id)||null}Ae.get("/health/tools",async e=>{var n;const t=await da(e);if(!t)return e.json({error:"Not authenticated"},401);try{const s=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function pl(e,t,n,s){return n==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:n==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check Gmail for new/important emails."}
You MUST call gmail_list or gmail_search immediately.${$t}`:n==="check_calendar"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check calendar for upcoming events."}
You MUST call list_calendar_events immediately.${$t}`:n==="check_sheet"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
You MUST call read_sheet immediately with the relevant spreadsheet.${$t}`:n==="custom"&&t?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
...
CRITICAL SAFETY RULE: This is a RECURRING scheduled task. You MUST NOT call gmail_send or gmail_draft — sending emails on every cron tick spams recipients. Report findings as text only.`:""}${$t}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${$t}`}Ae.post("/cron/check-browser-tasks",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);let s=0,r=0;try{const a=await e.env.DB.prepare(`SELECT pbt.id, pbt.user_id, pbt.task_id, pbt.task_description,
       ...
       LIMIT 10`).all();for(const i of a.results||[]){s++;try{const o=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'browser_use_api_key'").bind(i.user_id).first();if(!o)continue;const l=(await G(o.encrypted_value,i.pin_hash)).trim(),c=await Pr(i.task_id,l,{waitMs:8e3});if(!c.done||!(await e.env.DB.prepare(`UPDATE pending_browser_tasks SET notified = 1
           WHERE user_id = ? AND task_id = ? AND notified = 0`).bind(i.user_id,i.task_id).run()).meta.changes)continue;const u=i.task_description?`"${i.task_description.substring(0,80)}${i.task_description.length>80?"...":""}"`:"Your browser task";let p,v;if(c.status==="finished"&&c.output?(p="Browser task completed",v=`${u} finished.

${c.output.substring(0,500)}${c.output.length>500?"...":""}`):c.status==="finished"?(p="Browser task completed (no output)",v=`${u} finished, but the browser returned no readable content. You may want to retry.`):(p="Browser task ended",v=`${u} ended with status "${c.status}". Check the browser dashboard for details.`),i.thread_id){const g=c.status==="finished"&&c.output?c.output.substring(0,8e3):v,f=Math.ceil(g.length/4);try{await e.env.DB.prepare(`INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id)
               VALUES (?, ?, 'assistant', ?, '{}', ?, ?)`).bind(i.user_id,i.channel||"web",g,f,i.thread_id).run()}catch{}}i.pin_hash&&await We(e.env.DB,i.user_id,p,v,{pinHash:i.pin_hash,tags:["browser","karna"]}),r++,await new Promise(g=>setTimeout(g,200))}catch{}}}catch{}return e.json({checked:s,notified:r})});Ae.get("/scorecard/weekly",async e=>{var u;const t=(u=e.req.header("Authorization"))==null?void 0:u.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare("SELECT s.user_id FROM sessions s WHERE s.id = ? AND s.expires_at > datetime('now')").bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=n.user_id,r=new Date(Date.now()-10080*60*1e3).toISOString(),[a,i,o]=await Promise.all([e.env.DB.prepare(`SELECT COUNT(*) as total,
       ...
       FROM conversations
       WHERE user_id = ? AND role = 'assistant' AND created_at >= ? AND (content LIKE '%[S1]%' OR content LIKE '%source%')`).bind(s,r).first()]),l=Number((a==null?void 0:a.total)||0),c=Number((a==null?void 0:a.success_count)||0),d=l?c/l:0;return e.json({window:"7d",task_success_rate:Number(d.toFixed(3)),groundedness_rate_hint:Number((Number((o==null?void 0:o.cited_responses)||0)/Math.max(1,l)).toFixed(3)),avg_latency_ms:Math.round(Number((a==null?void 0:a.avg_latency)||0)),p95_latency_hint_ms:Math.round(Number((a==null?void 0:a.p95_latency_hint)||0)),fallback_frequency_hint:Number((Number((i==null?void 0:i.retry_count)||0)/Math.max(1,l)).toFixed(3)),totals:{total_tool_calls:l,successful_tool_calls:c}})});function hl(e,t,n,s){return{userId:e,username:t,channel:"telegram",text:n,sessionId:`telegram-${s}`,timestamp:new Date().toISOString()}}function gl(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const fl=["llm_slot_1","llm_slot_2","llm_slot_3"],yl=["openai","groq"];function Rs(e,t){const n=t==null?void 0:t.trim();if(!n)return null;const s=e.trim().toLowerCase();return s==="openai"?{url:"https://api.openai.com/v1/audio/transcriptions",apiKey:n,model:"whisper-1"}:s==="groq"?{url:"https://api.groq.com/openai/v1/audio/transcriptions",apiKey:n,model:"whisper-large-v3"}:null}function vl(e){var t,n;return((t=e.apiKey)==null?void 0:t.trim())||((n=e.api_key)==null?void 0:n.trim())}async function wl(e,t,n){for(const s of fl){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await G(r.encrypted_value,n),i=JSON.parse(a),o=vl(i);if(i.provider&&o){const l=Rs(i.provider,o);if(l)return l}}catch(a){console.error(`[telegram stt] Failed to load ${s}:`,a)}}for(const s of yl){const r=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,s).first();if(r)try{const a=await G(r.encrypted_value,n),i=Rs(s,a);if(i)return i}catch(a){console.error(`[telegram stt] Failed to load legacy ${s}:`,a)}}return null}const ua=["message","callback_query"],_l=4e3,bl=1e4,El=3e4;async function Oe(e,t={}){const n=new AbortController,s=setTimeout(()=>n.abort(),bl);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function Is(e){const t=new AbortController,n=setTimeout(()=>t.abort(),El);try{return await fetch(e,{signal:t.signal})}finally{clearTimeout(n)}}async function ae(e,t,n,s="Markdown",r,a){var c,d;const i=Sl(n,_l),o=[];let l=!0;for(let u=0;u<i.length;u++){const p=i[u];let v=!1,g="";for(let f=0;f<3;f++)try{const y=await Oe(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p,parse_mode:s,disable_web_page_preview:!1})});if(y.ok){v=!0;break}const _=await y.json().catch(()=>null);if(g=`HTTP ${y.status}: ${(_==null?void 0:_.description)||"Unknown error"}`,(c=_==null?void 0:_.description)!=null&&c.includes("parse")||(d=_==null?void 0:_.description)!=null&&d.includes("entities")){if((await Oe(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:p})})).ok){v=!0;break}g+=" (plain-text retry also failed)"}if(y.status===429||y.status>=500){const T=Math.pow(2,f)*1e3;await new Promise(x=>setTimeout(x,T));continue}break}catch(y){if(g=`Network error: ${y.message}`,f<2){const _=Math.pow(2,f)*1e3;await new Promise(T=>setTimeout(T,_));continue}}v||(l=!1,o.push(`Chunk ${u+1}/${i.length}: ${g}`))}if(!l&&r&&a&&o.length>0)try{const{logError:u}=await Promise.resolve().then(()=>bt);await u(r,a,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function Tl(e,t){try{await Oe(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Sl(e,t){if(e.length<=t)return[e];const n=[];let s=e;for(;s.length>0;){if(s.length<=t){n.push(s);break}let r=s.lastIndexOf(`
`,t);r<t*.3&&(r=s.lastIndexOf(" ",t)),r<t*.3&&(r=t),n.push(s.substring(0,r)),s=s.substring(r).trimStart()}return n}function kl(e){const t=Date.now()-new Date(e).getTime(),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`}async function xl(e,t,n){const r={reminder:"⏰",mail:"✉️",calendar:"📅",error:"⚠️",system:"⚙️"}[n.type]||"🔔",a={daily:"📅 Daily",weekly:"📅 Weekly",once:"✓ Once"},i=n.schedule_type?` · _${a[n.schedule_type]||"⏱ Repeating"}_`:"",o=n.body?`
`+n.body.substring(0,150)+(n.body.length>150?"…":""):"",l=`${r} *${n.title}*${i}
_${kl(n.created_at)}_${o}`,c=ma(n.id);if(!(await Oe(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l,parse_mode:"Markdown",reply_markup:{inline_keyboard:c}})})).ok){const u=await Oe(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:l.replace(/[_*`[\]]/g,""),reply_markup:{inline_keyboard:c}})});u.ok||console.warn("[sendNotifMessage] plain-text fallback also failed:",t,u.status)}}async function Dl(e,t,n,s,r){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(s==null?void 0:s.name)||"there",o=(s==null?void 0:s.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
`];for(const g of o){let f="";if(g.due_date){const y=g.due_date.slice(0,10);y<c?f=" ⚠️ _overdue_":y===c?f=" 🔴 _due today_":y===u?f=" 🟡 _due tomorrow_":f=` _${new Date(g.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}p.push(`☐ ${g.title}${f}`)}p.push(`
_Say "mark [task] as done" to close a task._`);const v=await ae(n,t,p.join(`
`),"Markdown",r,s.id);v.success||console.warn(`[/tasks] Failed to send message: ${v.errors.join(" | ")}`)}catch(i){const o=await ae(n,t,"❌ Could not fetch tasks: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/notifications":case"/notif":{if(!s){const i=await ae(n,t,"⚠️ Account not linked.","Markdown",r);return i.success||console.warn(`[/notifications] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await r.prepare(`
          ...
          LIMIT 5
        `).bind(s.id).all()).results||[];if(o.length===0){const c=await ae(n,t,"🎉 No pending notifications. You're all caught up.","Markdown",r,s.id);return c.success||console.warn(`[/notifications] Failed to send message: ${c.errors.join(" | ")}`),!0}const l=await ae(n,t,`📬 *${o.length} pending notification${o.length>1?"s":""}:*`,"Markdown",r,s.id);l.success||console.warn(`[/notifications] Failed to send header: ${l.errors.join(" | ")}`);for(const c of o)await xl(n,t,c)}catch(i){const o=await ae(n,t,"❌ Could not fetch notifications: "+i.message,"Markdown",r,s==null?void 0:s.id);o.success||console.warn(`[/notifications error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}async function Rl(e,t){var r,a,i,o,l,c;const n=t.db,s=t.env;console.log(`[telegram webhook] envVars keys=${Object.keys(s).join(",")}`);try{if(e.callback_query){await Cl(n,e.callback_query);return}const d=e.message;if(!d)return;const u=!!d.text,p=!!d.voice,v=!!d.document,g=!!d.photo,f=!!d.caption;if(!u&&!p&&!v&&!g)return;const y=String(d.chat.id);let _=d.text||"";const T=await n.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(y).first();let x=null;if(T){const j=await n.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(T.id,"telegram_bot_token").first();j&&(x=await G(j.encrypted_value,T.pin_hash))}if(!x){const j=await n.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();j&&(x=await G(j.encrypted_value,j.pin_hash))}if(!x||_.startsWith("/")&&await Dl(_,y,x,T,n))return;if(!T){const j=await ae(x,y,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${y}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",n);j.success||console.warn(`Failed to send unlinked account message: ${j.errors.join(" | ")}`);return}if(d.voice&&x&&T)try{if((d.voice.file_size??0)>20*1024*1024){const Z=await ae(x,y,"⚠️ Voice note is too large to process (max 20 MB).","Markdown",n,T.id);Z.success||console.warn(`[voice size] Failed to send message: ${Z.errors.join(" | ")}`);return}const j=await ae(x,y,"🎤 Processing voice note...","Markdown",n,T.id);j.success||console.warn(`[voice start] Failed to send message: ${j.errors.join(" | ")}`);const q=await(await Oe(`https://api.telegram.org/bot${x}/getFile?file_id=${d.voice.file_id}`)).json();if(q.ok&&((r=q.result)!=null&&r.file_path)){const te=await(await Is(`https://api.telegram.org/file/bot${x}/${q.result.file_path}`)).blob(),oe=await wl(n,T.id,T.pin_hash);if(!oe){const h=await ae(x,y,"⚠️ To use voice notes, add an OpenAI or Groq API key in Settings → Keys (LLM slot or legacy openai/groq).","Markdown",n,T.id);h.success||console.warn(`[voice no stt] Failed to send message: ${h.errors.join(" | ")}`);return}const re=new FormData;re.append("file",te,"voice.ogg"),re.append("model",oe.model),re.append("language","en");const he=await fetch(oe.url,{method:"POST",headers:{Authorization:`Bearer ${oe.apiKey}`},body:re});if(!he.ok){const h=await he.text(),w=await ae(x,y,`⚠️ Transcription failed: ${he.status} ${h}`,"Markdown",n,T.id);w.success||console.warn(`[voice transcription error] Failed to send message: ${w.errors.join(" | ")}`);return}_=(await he.json()).text;const E=await ae(x,y,`🗣️ *You said:* ${_}`,"Markdown",n,T.id);E.success||console.warn(`[voice transcript echo] Failed to send message: ${E.errors.join(" | ")}`)}}catch(j){const Y=await ae(x,y,`⚠️ Failed to process voice note: ${j.message}`,"Markdown",n,T==null?void 0:T.id);Y.success||console.warn(`[voice processing error] Failed to send message: ${Y.errors.join(" | ")}`);return}if((v||g)&&x&&T)try{let j,Y="unknown",q="unknown",Z=0;if(v)j=d.document.file_id,Y=d.document.file_name||"document",q=d.document.mime_type||"unknown",Z=d.document.file_size||0;else if(g){const te=d.photo[d.photo.length-1];j=te.file_id,Y="photo.jpg",q="image/jpeg",Z=te.file_size||0}if(j){const oe=await(await Oe(`https://api.telegram.org/bot${x}/getFile?file_id=${j}`)).json();let re="";if(oe.ok&&((a=oe.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(Y)||/^text\/|application\/json|application\/xml|application\/csv/i.test(q))&&Z<5e4)try{re=await(await Is(`https://api.telegram.org/file/bot${x}/${oe.result.file_path}`)).text()}catch{}const he=d.caption||"",m=`[Telegram file received: "${Y}" (${q}, ${Math.round(Z/1024)}KB)]`;re?_=`${he?he+`
...
`:""}${m}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(j){if(f&&d.caption)_=d.caption;else{const Y=await ae(x,y,`⚠️ Received your file but couldn't process it: ${j.message}`,"Markdown",n,T==null?void 0:T.id);Y.success||console.warn(`[file processing error] Failed to send message: ${Y.errors.join(" | ")}`);return}}if(!_)return;Tl(x,y).catch(()=>{});let L=await n.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(T.id).first();if(L)await n.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(L.id).run();else{const j=await n.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(T.id).run();if(!((i=j.meta)!=null&&i.last_row_id))throw new Error("Thread creation failed — no row ID returned");L={id:j.meta.last_row_id}}const N=hl(T.id,T.username,_,y);N.metadata={thread_id:L.id},console.log(`[telegram webhook] user=${T.id} msgLen=${_.length} thread=${L.id}`);let M,P;try{const j=await Qe(n,T.id,T.pin_hash);M=j.provider,P=j.rotation}catch(j){console.error("Telegram provider setup error:",j);const Y=(o=j.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=j.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${j.message||"Unknown error"}`,q=await ae(x,y,Y,"Markdown",n,T.id);q.success||console.warn(`[provider error] Failed to send message: ${q.errors.join(" | ")}`);return}const{classifyIntentFast:z}=await Promise.resolve().then(()=>ko);if(z(_).agent==="multi"){const j=await ae(x,y,"🔍 On it…","Markdown",n,T.id);j.success||console.warn(`[ack] Failed to send: ${j.errors.join(" | ")}`)}const W=6e5;let ne=!1;try{const j=await Promise.race([ss(N,n,M,T,P,s),new Promise((Z,te)=>setTimeout(()=>te(new Error("TELEGRAM_TIMEOUT")),W))]),Y=gl(j,"telegram"),q=await ae(x,y,Y||"(empty response)","Markdown",n,T.id);if(await n.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(L.id).run().catch(()=>{}),ne=q.success,!q.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${T.id}:`,q.errors);try{const{logError:Z}=await Promise.resolve().then(()=>bt);await Z(n,T.id,"telegram","response_send_failed",`Failed to deliver response: ${q.errors.join(" | ")}`)}catch{}}}catch(j){console.error("Telegram agent error:",j);const Y=j.message==="TELEGRAM_TIMEOUT",q=Y?`⏱️ This is taking too long to complete via Telegram.

If you requested a browser task, the result will arrive as a notification when ready. For other long tasks, try the web app.`:(c=j.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${M.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(j.message||"Unknown").substring(0,200)}`,Z=await ae(x,y,q,"Markdown",n,T.id);ne=Z.success,Z.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${T.id}:`,Z.errors);try{const{logError:te}=await Promise.resolve().then(()=>bt);await te(n,T.id,"telegram",Y?"timeout":"agent_error",j.message||"Agent error",{provider:M.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:u}=await Promise.resolve().then(()=>bt);await u(n,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}}function Ns(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}function Il(e){const t=new Date(new Date().toLocaleString("en-US",{timeZone:e})),n=new Date(t);n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const s=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),r=new Date(n.toLocaleString("en-US",{timeZone:e}));return new Date(n.getTime()+(s.getTime()-r.getTime())).toISOString()}const ma=e=>[[{text:"✅ Seen",callback_data:`notif_seen:${e}`},{text:"⏰ Snooze",callback_data:`notif_snooze_menu:${e}`},{text:"✓ Done",callback_data:`notif_done:${e}`}]],Nl=e=>[[{text:"10 minutes",callback_data:`notif_snooze:${e}:10m`},{text:"1 hour",callback_data:`notif_snooze:${e}:1h`}],[{text:"Tomorrow 9 AM",callback_data:`notif_snooze:${e}:tomorrow`},{text:"← Back",callback_data:`notif_back:${e}`}]];async function ht(e,t,n){const s=await Oe(`https://api.telegram.org/bot${e}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:t,text:n})});s.ok||console.warn("[answerCallback]",t,s.status)}async function gt(e,t,n,s){const r=await Oe(`https://api.telegram.org/bot${e}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,message_id:n,reply_markup:s?{inline_keyboard:s}:{}})});r.ok||console.warn("[editKeyboard]",t,n,r.status)}async function Ol(e,t,n,s,r,a,i,o,l,c){const d=await e.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).first();if(!d){await ht(t,n,"Notification not found — may have already been actioned."),await gt(t,s,r,null);return}if(i==="notif_seen")await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ht(t,n,"✅ Dismissed"),await gt(t,s,r,null);else if(i==="notif_snooze_menu")await ht(t,n),await gt(t,s,r,Nl(o));else if(i==="notif_back")await ht(t,n),await gt(t,s,r,ma(o));else if(i==="notif_snooze"){const u=Ns(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run();let p,v;l==="10m"?(p=new Date(Date.now()+600*1e3).toISOString(),v="10 minutes"):l==="1h"?(p=new Date(Date.now()+3600*1e3).toISOString(),v="1 hour"):(p=Il(c||"UTC"),v="tomorrow 9 AM"),await e.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
       VALUES (?, ?, ?, 'once', ?, 'reminder', ?, ?, 1, 'active')`).bind(a,d.title,d.body,p,JSON.stringify({description:d.body||""}),p).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ht(t,n,`⏰ Snoozed until ${v}`),await gt(t,s,r,null)}else if(i==="notif_done"){const u=Ns(d.source);u&&await e.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,a).run(),await e.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(o,a).run(),await ht(t,n,"✓ Done!"),await gt(t,s,r,null)}}async function Cl(e,t){var y;const{id:n,data:s,message:r,from:a}=t;if(!s||!r)return;const i=s.split(":"),o=i[0],l=String(r.chat.id);if(o.startsWith("notif_")){const _=parseInt(i[1]);if(!_)return;const T=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!T)return;const x=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
       JOIN users u ON c.user_id = u.id
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(T.id).first();if(!x)return;const L=await G(x.encrypted_value,x.pin_hash),N=i[2];await Ol(e,L,n,l,r.message_id,T.id,o,_,N,T.timezone);return}if(i[0]!=="briefing_toggle"||i.length<3)return;const c=i[1],d=parseInt(i[2]);if(!d||!c)return;const u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(l).first();if(!u)return;const p=await e.prepare(`
    SELECT bi.* FROM briefing_items bi 
    JOIN briefings b ON bi.briefing_id = b.id 
    WHERE b.user_id = ? AND b.id = ? AND bi.item_key = ?
  `).bind(u.id,d,c).first();if(!p)return;const v=p.checked?0:1;await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ?
  `).bind(v,v,p.id).run();const g=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!g)return;const f=await G(g.encrypted_value,g.pin_hash);try{const _=await Oe(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:n,text:v?"✅ Checked!":"☐ Unchecked"})});_.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${_.status}`)}catch(_){console.warn(`[callback answer] Error answering callback: ${_.message}`)}if((y=r.reply_markup)!=null&&y.inline_keyboard){const _=r.reply_markup.inline_keyboard.map(T=>T.map(x=>{var L;if((L=x.callback_data)!=null&&L.includes(c)){const N=v?"✅":"☐",M=x.text.replace(/^[☐✅]\s*/,"");return{...x,text:`${N} ${M}`}}return x}));try{await Oe(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l,message_id:r.message_id,reply_markup:{inline_keyboard:_}})})}catch{}}}const Zt=new be;function Al(e){return{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE}}Zt.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const s={db:e.env.DB,env:Al(e)};return e.executionCtx.waitUntil(Rl(t,s)),e.json({ok:!0})});Zt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const{webhook_url:s}=await e.req.json(),r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Telegram bot token not configured in Settings"},400);const a=await G(r.encrypted_value,n.pin_hash);if(!s){const d=await(await fetch(`https://api.telegram.org/bot${a}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(d)}const o=await(await fetch(`https://api.telegram.org/bot${a}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:s,allowed_updates:[...ua],drop_pending_updates:!1})})).json();return e.json(o)});Zt.get("/webhook-status",async e=>{var a,i,o,l,c,d;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({configured:!1,error:"Bot token not set"});const r=await G(s.encrypted_value,n.pin_hash);try{const p=await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=p.result)==null?void 0:i.url)||"",has_webhook:!!((o=p.result)!=null&&o.url),pending_updates:((l=p.result)==null?void 0:l.pending_update_count)||0,last_error:((c=p.result)==null?void 0:c.last_error_message)||"",last_error_date:((d=p.result)==null?void 0:d.last_error_date)||null})}catch(u){return e.json({configured:!0,error:u.message})}});Zt.post("/detect-chat-id",async e=>{var a,i;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const n=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!n)return e.json({error:"Invalid session"},401);const s=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n.user_id,"telegram_bot_token").first();if(!s)return e.json({error:"Bot token not configured"},400);const r=await G(s.encrypted_value,n.pin_hash);try{const c=((i=(await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${r}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(y=>setTimeout(y,500));const u=await(await fetch(`https://api.telegram.org/bot${r}/getUpdates?limit=10&timeout=0`)).json();c&&await fetch(`https://api.telegram.org/bot${r}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:c,allowed_updates:[...ua]})});const p=u.result||[];if(p.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const v=[],g=new Set;for(let y=p.length-1;y>=0;y--){const _=p[y].message;if(_&&_.chat){const T=String(_.chat.id);g.has(T)||(g.add(T),v.push({chat_id:T,name:[_.chat.first_name,_.chat.last_name].filter(Boolean).join(" ")||_.chat.title||"Unknown",username:_.chat.username||"",date:new Date((_.date||0)*1e3).toISOString()}))}}if(v.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const f=v[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(f,n.user_id).run(),e.json({found:!0,chat_id:f,name:v[0].name,all_chats:v,message:`Chat ID ${f} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});function Ll(e){const t=new Date,n=new Date(t.toLocaleString("en-US",{timeZone:e})),s=new Date(n);s.setDate(s.getDate()+1),s.setHours(0,0,0,0);const r=new Date(s);r.setHours(23,59,59,999);const a=s.toISOString().split("T")[0];return{start:s.toISOString(),end:r.toISOString(),dateStr:a}}function gn(e,t=new Date){return new Intl.DateTimeFormat("en-CA",{timeZone:e||"Asia/Kolkata",year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}async function Ml(e,t,n,s,r,a){try{return(await new pn(e,t,n,s,r).listEvents("primary",{timeMin:a.start,timeMax:a.end,maxResults:50})).map(l=>{var c;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(c=l.attendees)==null?void 0:c.map(d=>d.displayName||d.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function $l(e,t,n,s,r){try{const a=new ke(e,t,n,s,r),i=await a.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await a.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const u of i){const p=u.from.split("<")[0].trim()||u.from;l[p]=(l[p]||0)+1}const c=Object.entries(l).sort(([,u],[,p])=>p-u).slice(0,5).map(([u])=>u),d=i.some(u=>u.subject.toLowerCase().includes("urgent")||u.subject.toLowerCase().includes("asap")||u.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:c,hasUrgent:d}}catch(a){return console.error("Gmail fetch error:",a.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function Pl(e,t){try{const n=await e.prepare(`
...
`)}function Hl(e){const t=[];let n=0;for(const s of e.calendar.google)t.push({type:"calendar",key:s.id,text:`${s.title} - ${new Date(s.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:s},sortOrder:n++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:n++});for(const s of e.tasks.items)t.push({type:"task",key:`task-${s}`,text:s,metadata:{},sortOrder:n++});for(const s of e.news.items)t.push({type:"news",key:`news-${s.url}`,text:`📰 ${s.title}`,metadata:{url:s.url,source:s.source},sortOrder:n++});return t}async function Fl(e,t){const n=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!n)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let s;try{const a=JSON.parse(n.components);s={google_calendar:a.google_calendar!==!1,gmail:a.gmail!==!1,tasks:a.tasks!==!1,news:a.news!==!1}}catch{s={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const r=n.news_topics?n.news_topics.split(",").map(a=>a.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:s,newsTopics:r}}async function pa(e,t,n){var x,L;const s=t.timezone||"Asia/Kolkata",r=Ll(s),{components:a,newsTopics:i}=await Fl(e,t.id),o=[],l=[];a.google_calendar&&(o.push(Ml(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET,r)),l.push("googleEvents")),a.gmail&&(o.push($l(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),a.tasks&&(o.push(Pl(e,t.id)),l.push("tasks")),a.news&&(o.push(Bl(i,e,t.id)),l.push("news"));const c=await Promise.all(o),d={};l.forEach((N,M)=>{d[N]=c[M]});const u={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},p={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:r.dateStr,calendar:{google:d.googleEvents||[],totalCount:((x=d.googleEvents)==null?void 0:x.length)||0},emails:{gmail:d.gmailSummary||u},tasks:d.tasks||p,news:{items:d.news||[],fetchedAt:new Date().toISOString()},summary:""},g=((L=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:L.briefing_time)||"20:00";v.summary=Ul(v,g);const f=Hl(v),y=gn(s),_=await e.prepare(`
  ...
  `).bind(n).all();return{briefing:{...s,content:JSON.parse(s.content_json||"{}")},items:r.results||[]}}async function ql(e,t,n,s){if(!await e.prepare(`
  ...
  `).bind(i,i,s,n).run(),{checked:i===1}}async function Gl(e,t,n=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,n).all()).results||[]).map(r=>({...r,content:JSON.parse(r.content_json||"{}")}))}function ha(e,t,n=new Date,s=5){const r=new Date(n.toLocaleString("en-US",{timeZone:t})),a=r.getHours(),i=r.getMinutes(),[o,l]=e.split(":").map(Number),c=a*60+i,d=o*60+l,u=c-d;return u>=0&&u<s}function ga(e,t){const n=e.summary,s=[];for(const r of t.slice(0,10))s.push([{text:`☐ ${r.text.substring(0,40)}${r.text.length>40?"...":""}`,callback_data:`briefing_toggle:${r.key}`}]);return{text:n,inlineKeyboard:s}}const ye=new be,zl=1e4;async function Cs(e,t){const n=new AbortController,s=setTimeout(()=>n.abort(),zl);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function Kl(e,t){var r;if(e.req.path.includes("/cron/"))return t();const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(!ha(l,o,a))continue;const c=gn(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'evening' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await pa(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),{text:p}=ga(u.content,u.items);await We(e.env.DB,i.id,"Evening Briefing",p,{pinHash:i.pin_hash,tags:["briefing","karna"]}),u.briefingId&&await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run(),r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ye.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare("SELECT * FROM users").all(),r=[],a=new Date,i=new Date(a.getTime()+600*1e3).toISOString(),o=new Date(a.getTime()+900*1e3).toISOString();for(const l of s.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await G(c.encrypted_value,l.pin_hash),p=JSON.parse(d).access_token;if(!p)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(a.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${p}`}});if(!v.ok)continue;const f=((await v.json()).items||[]).filter(y=>{var T;const _=(T=y.start)==null?void 0:T.dateTime;return _?_>=a.toISOString()&&_<=i:!1});if(f.length===0){r.push({user_id:l.id,reminders_sent:0});continue}for(const y of f){const _=new Date(y.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),T=y.location?`
📍 ${y.location}`:"",x="Meeting in 10 minutes",L=`${y.summary||"Untitled Event"}
🕐 ${_}${T}`;await We(e.env.DB,l.id,x,L,{pinHash:l.pin_hash,priority:"high",tags:["calendar","karna"]})}r.push({user_id:l.id,reminders_sent:f.length})}catch(c){r.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ye.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(!ha(l,o,a))continue;const c=gn(o,a);if(!await e.env.DB.prepare("SELECT 1 FROM briefings WHERE user_id = ? AND briefing_type = 'morning' AND briefing_date = ? LIMIT 1").bind(i.id,c).first())try{const u=await fa(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let p={telegram:!0,web:!0};try{p=JSON.parse(i.notification_channels||"{}")}catch{}if(p.web!==!1&&u.briefingId){const v=Zl(u.content);await We(e.env.DB,i.id,"Morning Briefing",v,{pinHash:i.pin_hash,tags:["briefing","karna"]}),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(u.briefingId).run()}r.push({user_id:i.id,status:"success",briefing_id:u.briefingId,briefing_time:l,timezone:o})}catch(u){r.push({user_id:i.id,status:"error",error:u.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});ye.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==n)return e.json({error:"Unauthorized"},401);try{const s=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[];for(const a of s.results||[]){let i={};try{i=JSON.parse(a.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await ya(e.env.DB,a,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{skipBrowserUse:!0}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,c=JSON.stringify(o,null,2),d=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],a=new Date;for(const i of s.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(Jl(l,o,a))try{const c=await Vl(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),d=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,u=JSON.stringify(c,null,2),p=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,d,u,`weekly_review_${Date.now()}`,null,null,null).first();let v={telegram:!0,web:!0};try{v=JSON.parse(i.notification_channels||"{}")}catch{}if(v.web!==!1){const g=Xl(c);await We(e.env.DB,i.id,"Weekly Review",g,{pinHash:i.pin_hash,tags:["review","karna"]})}r.push({user_id:i.id,status:"success",action_item_id:p==null?void 0:p.id})}catch(c){r.push({user_id:i.id,status:"error",error:c.message})}}return e.json({executed:r.length,results:r})}catch(s){return e.json({error:s.message},500)}});async function Yl(e,t,n,s,r){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!a)return;const i=await G(a.encrypted_value,a.pin_hash);if(!(i!=null&&i.trim())){Vn("sendTelegramWithKeyboard: empty bot token",{userId:t.id});return}if(!(await(await Cs(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n,parse_mode:"Markdown",reply_markup:{inline_keyboard:s.map(c=>c.map(d=>({...d,callback_data:`${d.callback_data}:${r}`})))}})})).json()).ok){const d=await(await Cs(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:n.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:s.map(u=>u.map(p=>({...p,callback_data:`${p.callback_data}:${r}`})))}})})).json();if(!d.ok){Ct("Telegram briefing send failed",{description:d.description,chatId:t.telegram_chat_id});return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(r).run()}catch(a){Ct("Telegram briefing error",{error:(a==null?void 0:a.message)||String(a)})}}async function fa(e,t,n){const s=new Date;s.setHours(0,0,0,0);const r=new Date;r.setHours(23,59,59,999);const a=await e.prepare(`
  ...
  `).bind(t.id,r.toISOString()).all(),d=await e.prepare(`
    ...
    ORDER BY next_run ASC
  `).bind(t.id,s.toISOString(),a.toISOString()).all();let u={unreadCount:0,recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const v=new ke(e,t.id,t.pin_hash,n.GOOGLE_CLIENT_ID,n.GOOGLE_CLIENT_SECRET),g=await v.getUnreadCount(),f=await v.listMessages({maxResults:10,labelIds:["INBOX"]});u={unreadCount:g,recent:f.map(y=>({subject:y.subject,from:y.from,snippet:y.snippet}))}}}catch{}return{generatedAt:s.toISOString(),period:{start:r.toISOString(),end:s.toISOString()},completedTasks:(i.results||[]).map(p=>({name:p.name,last_run:p.last_run})),missedTasks:(o.results||[]).map(p=>({name:p.name,next_run:p.next_run})),openActions:(l.results||[]).map(p=>({title:p.title,priority:p.priority,status:p.status})),recentDocuments:(c.results||[]).map(p=>({name:p.name,status:p.status,created_at:p.created_at})),upcomingTasks:(d.results||[]).map(p=>({name:p.name,next_run:p.next_run})),gmailSummary:u}}function Zl(e){const t=[];t.push("☀️ Morning Briefing"),t.push("");const n=e.todayReminders||[];if(n.length>0){t.push(`📋 Today (${n.length}):`);for(const l of n){const c=l.next_run?new Date(l.next_run).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${c} ${l.name}`)}}else t.push("📋 Today: No scheduled reminders");t.push("");const s=e.pendingActions||[];if(s.length>0){t.push(`🔔 Pending Actions (${s.length}):`);for(const l of s.slice(0,5))t.push(`   • ${l.title} (${l.priority})`)}else t.push("🔔 Pending Actions: None");t.push("");const r=e.emailDigest||{},a=r.gmail||{};a.unreadCount>0?t.push(`📧 Gmail: ${a.unreadCount} unread`):t.push("📧 Gmail: Inbox clear");const i=r.outlook||{};typeof i.recent=="string"&&i.recent.length>0?t.push("📧 Outlook: see digest"):i.message&&t.push(`📧 Outlook: ${i.message}`),t.push("");const o=e.calendarEvents||[];if(o.length>0){t.push(`📅 Calendar (${o.length}):`);for(const l of o.slice(0,5)){const c=l.startTime?new Date(l.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${c} ${l.title}`)}}return t.join(`
`)}function Xl(e){const t=[];t.push("📊 Weekly Review"),t.push("");const n=e.completedTasks||[];t.push(`✅ Completed: ${n.length}`);const s=e.missedTasks||[];t.push(`❌ Missed/Overdue: ${s.length}`);const r=e.openActions||[];t.push(`🔔 Open Actions: ${r.length}`),t.push("");const a=e.recentDocuments||[];a.length>0&&t.push(`📄 Documents: ${a.length} this week`);const i=e.upcomingTasks||[];i.length>0&&t.push(`📅 Upcoming: ${i.length} in next 7 days`);const o=e.gmailSummary||{};return o.unreadCount>0&&t.push(`📧 Gmail Unread: ${o.unreadCount}`),t.join(`
`)}ye.post("/briefings/:id/resend",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));try{const s=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!s)return e.json({error:"Briefing not found"},404);const r=JSON.parse(s.content||"{}"),a=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(n).all(),{text:i,inlineKeyboard:o}=ga(r,a.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(n).run(),await Yl(e.env.DB,t,i,o,n);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(n).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(s){return e.json({error:s.message},500)}});ye.delete("/briefings/:id",async e=>{const t=e.get("user"),n=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});const va=["morning","evening","weekly","email"],wa=["calendar_today","calendar_tomorrow","gmail_summary","outlook_summary","tasks_due","news_ai","cron_jobs_today","cron_completed","cron_missed","action_items_open","documents_recent"],_a=["ntfy","web","telegram"],Pn=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],_t=["AI","LLM","Tools","Agentic Workflows","AI Features"];function sn(e){switch(e){case"morning":return["calendar_today","gmail_summary","cron_jobs_today","action_items_open"];case"evening":return["calendar_tomorrow","gmail_summary","tasks_due","news_ai"];case"weekly":return["cron_completed","cron_missed","action_items_open","documents_recent","gmail_summary"];case"email":return["gmail_summary","outlook_summary"]}}function fn(e){switch(e){case"morning":return{kind:e,enabled:!0,scheduleTime:"08:00",scheduleWeekday:null,sections:sn("morning"),notifyChannels:["ntfy","web"],newsTopics:_t};case"evening":return{kind:e,enabled:!0,scheduleTime:"20:00",scheduleWeekday:null,sections:sn("evening"),notifyChannels:["ntfy","web"],newsTopics:_t};case"weekly":return{kind:e,enabled:!0,scheduleTime:"20:00",scheduleWeekday:"Sunday",sections:sn("weekly"),notifyChannels:["ntfy","web"],newsTopics:_t};case"email":return{kind:e,enabled:!1,scheduleTime:"12:00",scheduleWeekday:null,sections:sn("email"),notifyChannels:["ntfy","web"],newsTopics:_t}}}function Ql(){return va.map(fn)}function As(e,t){try{const n=JSON.parse(e);return Array.isArray(n)?n.filter(s=>typeof s=="string"&&t.includes(s)):[]}catch{return[]}}function rs(e){const t=fn(e.kind),n=As(e.sections_json,wa),s=As(e.notify_channels_json,_a);let r=_t;return e.news_topics!=null&&(r=e.news_topics.split(",").map(a=>a.trim()).filter(Boolean),r.length===0&&(r=_t)),{kind:e.kind,enabled:e.enabled!==0,scheduleTime:/^\d{2}:\d{2}$/.test(e.schedule_time)?e.schedule_time:t.scheduleTime,scheduleWeekday:e.schedule_weekday&&Pn.includes(e.schedule_weekday)?e.schedule_weekday:t.scheduleWeekday,sections:n.length>0?n:t.sections,notifyChannels:s.length>0?s:t.notifyChannels,newsTopics:r}}function ec(e){const t=[];if(e.scheduleTime!==void 0&&(/^([01]\d|2[0-3]):[0-5]\d$/.test(e.scheduleTime)||t.push("scheduleTime must be HH:MM (e.g. 20:00)")),e.scheduleWeekday!==void 0&&e.scheduleWeekday!==null&&(Pn.includes(e.scheduleWeekday)||t.push(`scheduleWeekday must be one of: ${Pn.join(", ")}`)),e.sections!==void 0){const n=e.sections.filter(s=>!wa.includes(s));n.length>0&&t.push(`unknown section(s): ${n.join(", ")}`)}if(e.notifyChannels!==void 0){const n=e.notifyChannels.filter(s=>!_a.includes(s));n.length>0&&t.push(`unknown channel(s): ${n.join(", ")}`),e.notifyChannels.length===0&&t.push("at least one delivery channel is required")}return e.newsTopics!==void 0&&(e.newsTopics.length>5&&t.push("maximum 5 news topics allowed"),e.newsTopics.some(n=>n.length>50)&&t.push("each news topic must be 50 chars or less")),t}async function tc(e,t){const n=await e.prepare("SELECT * FROM digest_configs WHERE user_id = ? ORDER BY kind ASC").bind(t).all(),s=new Map;for(const a of n.results||[])s.set(a.kind,rs(a));const r=[];for(const a of va){const i=s.get(a);if(i)r.push(i);else{const o=fn(a);await ba(e,t,o),r.push(o)}}return r}async function as(e,t,n){const s=await e.prepare("SELECT * FROM digest_configs WHERE user_id = ? AND kind = ?").bind(t,n).first();if(s)return rs(s);const r=fn(n);return await ba(e,t,r),r}async function ba(e,t,n){await e.prepare(`INSERT OR IGNORE INTO digest_configs
        (user_id, kind, enabled, schedule_time, schedule_weekday, sections_json, notify_channels_json, news_topics)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(t,n.kind,n.enabled?1:0,n.scheduleTime,n.scheduleWeekday,JSON.stringify(n.sections),JSON.stringify(n.notifyChannels),n.newsTopics.join(", ")).run()}async function Ea(e,t,n,s){await e.prepare(`INSERT INTO digest_configs
        (user_id, kind, enabled, schedule_time, schedule_weekday, sections_json, notify_channels_json, news_topics)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)
       ON CONFLICT(user_id, kind) DO UPDATE SET
         ...
         updated_at = CURRENT_TIMESTAMP`).bind(t,n,s.enabled?1:0,s.scheduleTime,s.scheduleWeekday,JSON.stringify(s.sections),JSON.stringify(s.notifyChannels),s.newsTopics.join(", ")).run()}function nc(e){return new pn(e.db,e.userId,e.pinHash,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET)}function sc(e){return new ke(e.db,e.userId,e.pinHash,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET)}function Ce(e,t,n=""){return{key:e,title:t,summary:n,items:[]}}function rc(e){return e?new Date(e).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):""}async function Ta(e,t,n,s,r){try{const o=(await nc(e).listEvents("primary",{timeMin:s,timeMax:r,maxResults:50})).map(c=>{var u,p,v,g,f;const d=((u=c.start)==null?void 0:u.dateTime)||((p=c.start)==null?void 0:p.date)||"";return{key:c.id||`cal-${d}-${c.summary}`,text:`${rc(d)} ${c.summary||"Untitled Event"}${c.location?` @ ${c.location}`:""}`,metadata:{title:c.summary,startTime:d,endTime:((v=c.end)==null?void 0:v.dateTime)||((g=c.end)==null?void 0:g.date)||"",location:c.location,attendees:(f=c.attendees)==null?void 0:f.map(y=>y.displayName||y.email)}}}),l=o.length===0?"Nothing scheduled":`${o.length} event${o.length===1?"":"s"}`;return{key:t,title:n,summary:l,items:o}}catch(a){return console.error(`[digest:calendar:${t}] fetch error:`,a==null?void 0:a.message),Ce(t,n)}}const ac={key:"calendar_today",title:"Today",appliesTo:e=>e==="morning"||e==="email",fetch:e=>Ta(e,"calendar_today","Today",e.periodStart,e.periodEnd)},ic={key:"calendar_tomorrow",title:"Tomorrow",appliesTo:e=>e==="evening",fetch:e=>{const t=new Date(e.periodEnd);t.setSeconds(t.getSeconds()+1);const n=new Date(t);return n.setHours(23,59,59,999),Ta(e,"calendar_tomorrow","Tomorrow",t.toISOString(),n.toISOString())}},oc={key:"gmail_summary",title:"Gmail",appliesTo:()=>!0,fetch:async e=>{try{const t=sc(e),n=await t.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),s=await t.listMessages({query:"is:important is:unread",maxResults:10}),r={};for(const l of n){const c=l.from.split("<")[0].trim()||l.from;r[c]=(r[c]||0)+1}const a=Object.entries(r).sort(([,l],[,c])=>c-l).slice(0,5).map(([l])=>l),i=n.some(l=>l.subject.toLowerCase().includes("urgent")||l.subject.toLowerCase().includes("asap")||l.subject.toLowerCase().includes("immediately"));if(n.length===0)return{key:"gmail_summary",title:"Gmail",summary:"Inbox clear",items:[]};const o=[`📬 ${n.length} unread`];return s.length>0&&o.push(`★ ${s.length} important`),i&&o.push("⚠️ Urgent messages present"),a.length>0&&o.push(`From: ${a.slice(0,3).join(", ")}`),{key:"gmail_summary",title:"Gmail",summary:o.join(" · "),items:[{key:"gmail-unread",text:`Review ${n.length} unread Gmail messages`,metadata:{source:"gmail",count:n.length,importantCount:s.length,hasUrgent:i,topSenders:a}}]}}catch(t){return console.error("[digest:gmail_summary] fetch error:",t==null?void 0:t.message),Ce("gmail_summary","Gmail")}}},lc={key:"tasks_due",title:"Tasks",appliesTo:()=>!0,fetch:async e=>{try{const t=await e.db.prepare(`SELECT title, content, due_date
           FROM memory
           WHERE user_id = ? AND type = 'task' AND (status = 'open' OR status IS NULL)
           ORDER BY
             CASE WHEN due_date IS NOT NULL THEN 0 ELSE 1 END,
             due_date ASC,
             importance DESC
           LIMIT 10`).bind(e.userId).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1),s.setHours(23,59,59,999);const r=t.results||[],a=r.map(l=>{let c="";if(l.due_date){const d=new Date(l.due_date);c=d<=n?"overdue":d<=s?"due today":d.toLocaleDateString("en-GB",{day:"numeric",month:"short"})}return{key:`task-${l.title}`,text:c?`${l.title} [${c}]`:l.title,metadata:{title:l.title,dueDate:l.due_date}}}),i=r.filter(l=>l.due_date?new Date(l.due_date)<=s:!1).length;return{key:"tasks_due",title:"Tasks",summary:a.length===0?"All clear":`${a.length} open${i>0?`, ${i} due today`:""}`,items:a}}catch(t){return console.error("[digest:tasks_due] fetch error:",t==null?void 0:t.message),Ce("tasks_due","Tasks")}}},Ls=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function cc(e,t){try{const n=Math.floor((Date.now()-1728e5)/1e3),s=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${n},points>10`,r=await fetch(s,{headers:{"User-Agent":"Karna/1.0"}});return r.ok?((await r.json()).hits||[]).filter(i=>i.url&&!t.has(i.url)).slice(0,2).map(i=>({title:i.title,summary:`${i.points} pts · ${i.num_comments} comments on HN`,url:i.url,source:"news.ycombinator.com"})):[]}catch{return[]}}async function dc(e,t){const n=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],s=new Set;try{((await t.db.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(t.userId).all()).results||[]).forEach(l=>s.add(l.url))}catch{}const r=[];if(n.some(o=>Ls.some(l=>o.toLowerCase().includes(l.toLowerCase())))){const o=n.find(c=>Ls.some(d=>c.toLowerCase().includes(d.toLowerCase())))||"AI agents",l=await cc(o,s);for(const c of l)r.push(c),s.add(c.url)}for(const o of n){if(r.length>=8)break;const l=`latest ${o} news today`;try{const c=await Ot(l,{num:5});if(c.results)for(const d of c.results){if(r.length>=8)break;s.has(d.link)||(r.push({title:d.title,summary:d.snippet,url:d.link,source:d.displayLink}),s.add(d.link))}}catch(c){console.error(`[digest:news] search error for "${l}":`,c==null?void 0:c.message)}}const i=r.slice(0,7);if(i.length>0)for(const o of i)try{await t.db.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(t.userId,o.url,o.title).run()}catch{}return i}const uc={key:"news_ai",title:"Today's Signal",appliesTo:()=>!0,fetch:async e=>{try{const t=await dc(e.newsTopics,e);if(t.length===0)return Ce("news_ai","Today's Signal","No new items");const n=t.map(s=>({key:`news-${s.url}`,text:`📰 ${s.title}`,metadata:{url:s.url,source:s.source,summary:s.summary}}));return{key:"news_ai",title:"Today's Signal",summary:`${t.length} items`,items:n}}catch(t){return console.error("[digest:news_ai] fetch error:",t==null?void 0:t.message),Ce("news_ai","Today's Signal")}}};function Sa(e){return e?new Date(e).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):""}const mc={key:"cron_jobs_today",title:"Today's Reminders",appliesTo:e=>e==="morning",fetch:async e=>{try{const s=((await e.db.prepare(`SELECT * FROM cron_jobs
           WHERE user_id = ? AND enabled = 1
           AND next_run IS NOT NULL AND next_run >= ? AND next_run <= ?
           ORDER BY next_run ASC`).bind(e.userId,e.periodStart,e.periodEnd).all()).results||[]).map(a=>({key:`cron-${a.id}`,text:`${Sa(a.next_run)} ${a.name}`,metadata:{id:a.id,name:a.name,next_run:a.next_run,description:a.description}}));return{key:"cron_jobs_today",title:"Today's Reminders",summary:s.length===0?"No scheduled reminders":`${s.length} scheduled`,items:s}}catch(t){return console.error("[digest:cron_jobs_today] fetch error:",t==null?void 0:t.message),Ce("cron_jobs_today","Today's Reminders")}}},pc={key:"cron_completed",title:"Completed",appliesTo:e=>e==="weekly",fetch:async e=>{try{const n=(await e.db.prepare(`SELECT id, name, last_run FROM cron_jobs
           WHERE user_id = ? AND state = 'completed' AND last_run IS NOT NULL AND last_run >= ?
           ORDER BY last_run DESC LIMIT 20`).bind(e.userId,e.periodStart).all()).results||[],s=n.map(a=>({key:`cron-done-${a.id}`,text:a.name,metadata:{id:a.id,name:a.name,last_run:a.last_run}}));return{key:"cron_completed",title:"Completed",summary:`${n.length} completed`,items:s}}catch(t){return console.error("[digest:cron_completed] fetch error:",t==null?void 0:t.message),Ce("cron_completed","Completed")}}},hc={key:"cron_missed",title:"Missed / Overdue",appliesTo:e=>e==="weekly",fetch:async e=>{try{const s=((await e.db.prepare(`SELECT id, name, next_run FROM cron_jobs
           WHERE user_id = ? AND enabled = 1 AND next_run IS NOT NULL AND next_run < ?
           ORDER BY next_run DESC LIMIT 20`).bind(e.userId,e.periodEnd).all()).results||[]).map(a=>({key:`cron-missed-${a.id}`,text:`${a.name} (was due ${Sa(a.next_run)})`,metadata:{id:a.id,name:a.name,next_run:a.next_run}}));return{key:"cron_missed",title:"Missed / Overdue",summary:s.length===0?"None missed":`${s.length} missed`,items:s}}catch(t){return console.error("[digest:cron_missed] fetch error:",t==null?void 0:t.message),Ce("cron_missed","Missed / Overdue")}}},gc={key:"action_items_open",title:"Pending Actions",appliesTo:()=>!0,fetch:async e=>{try{const s=((await e.db.prepare(`SELECT id, title, priority, type, due_at FROM action_items
           WHERE user_id = ? AND status = 'pending'
             AND type NOT IN ('email_digest', 'weekly_review')
           ORDER BY
             CASE priority WHEN 'urgent' THEN 0 WHEN 'high' THEN 1 WHEN 'normal' THEN 2 ELSE 3 END,
             created_at DESC
           LIMIT 15`).bind(e.userId).all()).results||[]).map(a=>({key:`action-${a.id}`,text:`${a.title} (${a.priority})`,metadata:{id:a.id,title:a.title,priority:a.priority,type:a.type,due_at:a.due_at}}));return{key:"action_items_open",title:"Pending Actions",summary:s.length===0?"None":`${s.length} pending`,items:s}}catch(t){return console.error("[digest:action_items_open] fetch error:",t==null?void 0:t.message),Ce("action_items_open","Pending Actions")}}},fc={key:"documents_recent",title:"Recent Documents",appliesTo:e=>e==="weekly",fetch:async e=>{try{const s=((await e.db.prepare(`SELECT id, name, status, created_at FROM document_library
           WHERE user_id = ? AND created_at >= ?
           ORDER BY created_at DESC LIMIT 10`).bind(e.userId,e.periodStart).all()).results||[]).map(a=>({key:`doc-${a.id}`,text:`${a.name} (${a.status})`,metadata:{id:a.id,name:a.name,status:a.status,created_at:a.created_at}}));return{key:"documents_recent",title:"Recent Documents",summary:s.length===0?"None this week":`${s.length} this week`,items:s}}catch(t){return console.error("[digest:documents_recent] fetch error:",t==null?void 0:t.message),Ce("documents_recent","Recent Documents")}}},yc={key:"outlook_summary",title:"Outlook",appliesTo:e=>e==="email",fetch:async e=>{try{const t=await e.db.prepare(`SELECT name, encrypted_blob FROM site_credentials
           WHERE user_id = ?
             AND (name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE)
           LIMIT 1`).bind(e.userId,"%Outlook%","%Microsoft%","%Office 365%").first();if(!t)return{key:"outlook_summary",title:"Outlook",summary:"No Outlook credentials saved. Add them in Settings → Secret Vault.",items:[]};const n=await e.db.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(e.userId,"browser_use_api_key").first();if(!n)return{key:"outlook_summary",title:"Outlook",summary:"Browser Use API key not configured. Add it in Settings → API Keys.",items:[]};const s=(await G(n.encrypted_value,e.pinHash)).trim(),r=JSON.parse(await G(t.encrypted_blob,e.pinHash)),a=await qn("Go to https://outlook.live.com or https://outlook.office.com. Log in with username {username} and password {password} if prompted. Navigate to the inbox and extract the 10 most recent emails with sender, subject, date, and snippet. Return the results as structured text.",s,{secrets:{username:r.username,password:r.password},timeoutMs:3e5});return a.status==="completed"&&a.output?{key:"outlook_summary",title:"Outlook",summary:"Inbox fetched",items:[{key:"outlook-inbox",text:"See digest for recent Outlook messages",metadata:{source:"outlook",output:a.output}}]}:a.status==="timeout"?{key:"outlook_summary",title:"Outlook",summary:"Browser task timed out.",items:[]}:{key:"outlook_summary",title:"Outlook",summary:"Outlook returned no content.",items:[]}}catch(t){return console.error("[digest:outlook_summary] fetch error:",t==null?void 0:t.message),Ce("outlook_summary","Outlook")}}},ka={calendar_today:ac,calendar_tomorrow:ic,gmail_summary:oc,outlook_summary:yc,tasks_due:lc,news_ai:uc,cron_jobs_today:mc,cron_completed:pc,cron_missed:hc,action_items_open:gc,documents_recent:fc};function vc(e){return ka[e]}function wc(){return Object.values(ka)}function _c(e,t=new Date){return new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).format(t)}function bc(e,t,n=new Date,s=5){const r=new Date(n.toLocaleString("en-US",{timeZone:t||"Asia/Kolkata"})),a=r.getHours(),i=r.getMinutes(),[o,l]=e.scheduleTime.split(":").map(Number);if(!Number.isFinite(o)||!Number.isFinite(l)||e.scheduleWeekday&&r.toLocaleDateString("en-US",{weekday:"long"})!==e.scheduleWeekday)return!1;const c=a*60+i,d=o*60+l,u=c-d;return u>=0&&u<s}async function Ec(e){const t=await e.prepare(`SELECT c.id, c.user_id, c.kind, c.enabled, c.schedule_time, c.schedule_weekday,
       ...
       WHERE c.enabled = 1`).all(),n=[];for(const s of t.results||[]){const r=rs(s);n.push({userId:s.user_id,timezone:s.timezone||"Asia/Kolkata",config:r})}return n}async function Tc(e,t,n,s){return!!await e.prepare("SELECT 1 FROM digests WHERE user_id = ? AND kind = ? AND local_date = ? LIMIT 1").bind(t,n,s).first()}const xa={morning:"☀️",evening:"🗓",weekly:"📊",email:"📧"},Da={morning:"Morning Briefing",evening:"Evening Brief",weekly:"Weekly Review",email:"Email Digest"};function Ra(e){const t=new Date(e.period.start),n=new Date(e.period.end),s=t.toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"}),r=n.toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"});return s===r?s:`${s} – ${r}`}function Sc(e){const[t,n]=e.split(":"),s=parseInt(t,10),r=n||"00",a=s>=12?"PM":"AM";return`${s===0?12:s>12?s-12:s}:${r} ${a}`}function kc(e,t){const n=[];if(n.push(`${xa[t.kind]} ${Da[t.kind]} — ${Sc(t.scheduleTime)} · ${Ra(e)}`),n.push(""),e.highlights.length>0){for(const s of e.highlights)n.push(`▸ ${s}`);n.push("")}for(const s of e.sections){n.push(`${s.title}: ${s.summary}`);for(const r of s.items.slice(0,5))n.push(`   • ${r.text.substring(0,90)}${r.text.length>90?"…":""}`);n.push("")}return n.join(`
`).trimEnd()}function xc(e,t){const n=`${xa[t.kind]} ${Da[t.kind]} · ${Ra(e)}`;return e.highlights.length>0?`${n} — ${e.highlights[0]}`:n}function Dc(e,t){const n=[];for(const s of e.slice(0,10))n.push([{text:`☐ ${s.text.substring(0,40)}${s.text.length>40?"...":""}`,callback_data:`digest_toggle:${s.key}:${t}`}]);return n}const Rc=1e4;async function Ms(e,t){const n=new AbortController,s=setTimeout(()=>n.abort(),Rc);try{return await fetch(e,{...t,signal:n.signal})}finally{clearTimeout(s)}}async function Ia(e,t,n,s,r){const a=[],i=kc(t,{kind:r.kind,scheduleTime:r.scheduleTime}),o=xc(t,{kind:r.kind,scheduleTime:r.scheduleTime}),l=r.channels.includes("web"),c=r.channels.includes("ntfy"),d=r.channels.includes("telegram");if(l||c)try{await We(e,r.userId,o,i,{pinHash:r.pinHash,tags:["digest","karna"]}),l&&a.push("web"),c&&a.push("ntfy")}catch(u){Vn("deliverDigest: notify failed",{userId:r.userId,error:u==null?void 0:u.message}),l&&a.push("web")}return d&&r.telegramChatId&&await Ic(e,r,i,n,s)&&a.push("telegram"),{deliveredChannels:a,digestId:s}}async function Ic(e,t,n,s,r){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.userId).first();if(!a)return!1;const i=await G(a.encrypted_value,a.pin_hash);if(!(i!=null&&i.trim()))return Vn("sendTelegramDigest: empty bot token",{userId:t.userId}),!1;const o=Dc(s,r),l={chat_id:t.telegramChatId,text:n.substring(0,4e3),parse_mode:"Markdown"};if(o.length>0&&(l.reply_markup={inline_keyboard:o}),(await(await Ms(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)})).json()).ok)return!0;const u={chat_id:t.telegramChatId,text:String(l.text).replace(/[_*[`\]]/g,"")};o.length>0&&(u.reply_markup={inline_keyboard:o});const v=await(await Ms(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)})).json();return v.ok?!0:(Ct("Telegram digest send failed",{description:v.description,chatId:t.telegramChatId}),!1)}catch(a){return Ct("Telegram digest error",{error:(a==null?void 0:a.message)||String(a)}),!1}}const Nc=Object.freeze(Object.defineProperty({__proto__:null,deliverDigest:Ia},Symbol.toStringTag,{value:"Module"}));function Oc(e,t,n=new Date){const s=new Intl.DateTimeFormat("en-CA",{timeZone:t,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).formatToParts(n),r=p=>{var v;return((v=s.find(g=>g.type===p))==null?void 0:v.value)||"0"},a=Number(r("year")),i=Number(r("month")),o=Number(r("day")),c=Date.UTC(a,i-1,o,Number(r("hour")),Number(r("minute")),Number(r("second")))-n.getTime(),d=Date.UTC(a,i-1,o,0,0,0,0),u=Date.UTC(a,i-1,o,23,59,59,999);if(e==="weekly"){const p=d-5184e5;return{start:new Date(p-c).toISOString(),end:new Date(u-c).toISOString()}}return{start:new Date(d-c).toISOString(),end:new Date(u-c).toISOString()}}function Cc(e){const t=[];for(const n of e){if(t.length>=3)break;!n.summary||n.summary==="Nothing scheduled"||n.summary==="All clear"||n.summary==="None"||n.summary==="Inbox clear"||t.push(`${n.title}: ${n.summary}`)}return t}async function Na(e,t,n,s,r){const a=t.timezone||"Asia/Kolkata",i=await as(e,t.id,n),o=new Date,l=_c(a,o);if(!(r!=null&&r.force)&&await Tc(e,t.id,n,l)){const L=await $s(e,t.id,n,l);if(L)return{digestId:L.digest.id,content:L.digest.content,items:[],deliveredChannels:L.digest.delivered_channels||"",skipped:!0}}const{start:c,end:d}=Oc(n,a,o),u={db:e,userId:t.id,pinHash:t.pin_hash,timezone:a,kind:n,periodStart:c,periodEnd:d,newsTopics:i.newsTopics,env:s},p=await Promise.all(i.sections.map(async x=>{const L=vc(x);if(!L)return null;try{return await L.fetch(u)}catch(N){return console.error(`[digest:${n}] section ${x} failed:`,N==null?void 0:N.message),null}})),v={generatedAt:o.toISOString(),period:{start:c,end:d},sections:p.filter(x=>x!==null),highlights:[]};v.highlights=Cc(v.sections);const g=[];let f=0;for(const x of v.sections)for(const L of x.items)g.push({section:x.key,key:L.key,text:L.text,metadata:L.metadata,sortOrder:f++});const y=await e.prepare(`INSERT OR IGNORE INTO digests (user_id, kind, content_json, period_start, period_end, local_date)
       VALUES (?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,n,JSON.stringify(v),c,d,l).first();let _=(y==null?void 0:y.id)||0,T="";if(_===0){const x=await $s(e,t.id,n,l);x&&(_=x.digest.id,T=x.digest.delivered_channels||"")}else{for(const x of g)await e.prepare(`INSERT INTO digest_items (digest_id, section, item_key, text, metadata, sort_order)
           VALUES (?, ?, ?, ?, ?, ?)`).bind(_,x.section,x.key,x.text,JSON.stringify(x.metadata),x.sortOrder).run();(r==null?void 0:r.deliver)!==!1&&(T=(await Ia(e,v,g,_,{userId:t.id,pinHash:t.pin_hash,telegramChatId:t.telegram_chat_id,kind:n,scheduleTime:i.scheduleTime,channels:i.notifyChannels})).deliveredChannels.join(","),await e.prepare("UPDATE digests SET delivered_channels = ? WHERE id = ?").bind(T,_).run())}return{digestId:_,content:v,items:g,deliveredChannels:T,skipped:_!==0&&g.length===0&&!(r!=null&&r.force)}}async function Oa(e,t){const n=await t.prepare("SELECT * FROM digest_items WHERE digest_id = ? ORDER BY sort_order ASC").bind(e.id).all();return{digest:{id:e.id,user_id:e.user_id,kind:e.kind,content:JSON.parse(e.content_json||"{}"),period_start:e.period_start,period_end:e.period_end,local_date:e.local_date,delivered_channels:e.delivered_channels||"",created_at:e.created_at},items:(n.results||[]).map(s=>({id:s.id,section:s.section,item_key:s.item_key,text:s.text,metadata:JSON.parse(s.metadata||"{}"),checked:s.checked,checked_at:s.checked_at,sort_order:s.sort_order}))}}async function Ca(e,t,n){const s=await e.prepare("SELECT * FROM digests WHERE id = ? AND user_id = ?").bind(n,t).first();return s?Oa(s,e):null}async function $s(e,t,n,s){const r=await e.prepare("SELECT * FROM digests WHERE user_id = ? AND kind = ? AND local_date = ? LIMIT 1").bind(t,n,s).first();return r?Oa(r,e):null}async function Ac(e,t,n,s){if(!await e.prepare("SELECT id FROM digests WHERE id = ? AND user_id = ?").bind(n,t).first())return null;const a=await e.prepare("SELECT checked FROM digest_items WHERE id = ? AND digest_id = ?").bind(s,n).first();if(!a)return null;const i=a.checked?0:1;return await e.prepare(`UPDATE digest_items
       SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
       WHERE id = ? AND digest_id = ?`).bind(i,i,s,n).run(),{checked:i===1}}async function Lc(e,t,n=20,s){let r="SELECT * FROM digests WHERE user_id = ?";const a=[t];return s&&(r+=" AND kind = ?",a.push(s)),r+=" ORDER BY created_at DESC LIMIT ?",a.push(n),((await e.prepare(r).bind(...a).all()).results||[]).map(o=>({id:o.id,user_id:o.user_id,kind:o.kind,content:JSON.parse(o.content_json||"{}"),period_start:o.period_start,period_end:o.period_end,local_date:o.local_date,delivered_channels:o.delivered_channels||"",created_at:o.created_at}))}async function Mc(e,t,n){await e.prepare("DELETE FROM digests WHERE id = ? AND user_id = ?").bind(n,t).run()}const Ee=new be;async function $c(e,t){var r;if(e.req.path.includes("/cron/"))return t();const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}Ee.use("/*",$c);function Aa(e){const t=e.req.header("X-Cron-Secret")||"",n=e.env.CRON_SECRET||"karna-cron-default-v1";return t===n}Ee.get("/",async e=>{const t=e.get("user"),n=Math.min(parseInt(e.req.query("limit")||"20"),100),s=e.req.query("kind"),a=s&&["morning","evening","weekly","email"].includes(s)?s:void 0;try{const i=await Lc(e.env.DB,t.id,n,a);return e.json({digests:i})}catch(i){return e.json({error:i.message},500)}});Ee.get("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));if(!Number.isFinite(n))return e.json({error:"Invalid id"},400);try{const s=await Ca(e.env.DB,t.id,n);return s?e.json(s):e.json({error:"Digest not found"},404)}catch(s){return e.json({error:s.message},500)}});Ee.post("/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=parseInt(e.req.param("itemId"));if(!Number.isFinite(n)||!Number.isFinite(s))return e.json({error:"Invalid id"},400);try{const r=await Ac(e.env.DB,t.id,n,s);return r?e.json(r):e.json({error:"Item not found"},404)}catch(r){return e.json({error:r.message},500)}});Ee.post("/generate",async e=>{const t=e.get("user"),n=await e.req.json().catch(()=>({})),s=["morning","evening","weekly","email"],r=n.kind&&s.includes(n.kind)?n.kind:"evening";try{const a=await Na(e.env.DB,t,r,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{force:n.force===!0,deliver:!1});return e.json(a)}catch(a){return e.json({error:a.message},500)}});Ee.post("/:id/resend",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));if(!Number.isFinite(n))return e.json({error:"Invalid id"},400);try{const s=await Ca(e.env.DB,t.id,n);if(!s)return e.json({error:"Digest not found"},404);const r=await as(e.env.DB,t.id,s.digest.kind),a=s.items.map((c,d)=>({section:c.section,key:c.item_key,text:c.text,metadata:c.metadata,sortOrder:c.sort_order??d})),{deliverDigest:i}=await Promise.resolve().then(()=>Nc),o=await i(e.env.DB,s.digest.content,a,n,{userId:t.id,pinHash:t.pin_hash,telegramChatId:t.telegram_chat_id,kind:s.digest.kind,scheduleTime:r.scheduleTime,channels:r.notifyChannels}),l=o.deliveredChannels.join(",");return await e.env.DB.prepare("UPDATE digests SET delivered_channels = ? WHERE id = ?").bind(l,n).run(),o.deliveredChannels.length===0?e.json({error:"No channels delivered — check Settings for ntfy/Telegram config"},500):e.json({success:!0,deliveredChannels:o.deliveredChannels})}catch(s){return e.json({error:s.message},500)}});Ee.delete("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));if(!Number.isFinite(n))return e.json({error:"Invalid id"},400);try{return await Mc(e.env.DB,t.id,n),e.json({success:!0})}catch(s){return e.json({error:s.message},500)}});Ee.get("/configs",async e=>{const t=e.get("user");try{const n=await tc(e.env.DB,t.id),s=wc().map(r=>({key:r.key,title:r.title,appliesTo:{morning:r.appliesTo("morning"),evening:r.appliesTo("evening"),weekly:r.appliesTo("weekly"),email:r.appliesTo("email")}}));return e.json({configs:n,sections:s})}catch(n){return e.json({error:n.message},500)}});Ee.put("/configs",async e=>{const t=e.get("user"),n=e.req.query("kind");if(!n||!["morning","evening","weekly","email"].includes(n))return e.json({error:"Invalid or missing ?kind= parameter"},400);const r=await e.req.json().catch(()=>({})),a=ec({enabled:r.enabled,scheduleTime:r.scheduleTime,scheduleWeekday:r.scheduleWeekday,sections:r.sections,notifyChannels:r.notifyChannels,newsTopics:r.newsTopics});if(a.length>0)return e.json({error:a.join("; ")},400);try{const i=await as(e.env.DB,t.id,n),o={kind:n,enabled:r.enabled??i.enabled,scheduleTime:r.scheduleTime??i.scheduleTime,scheduleWeekday:r.scheduleWeekday===void 0?i.scheduleWeekday:r.scheduleWeekday,sections:r.sections??i.sections,notifyChannels:r.notifyChannels??i.notifyChannels,newsTopics:r.newsTopics??i.newsTopics};return await Ea(e.env.DB,t.id,n,o),e.json({success:!0,config:o})}catch(i){return e.json({error:i.message},500)}});Ee.post("/configs/reset",async e=>{const t=e.get("user"),n=e.req.query("kind");if(!n||!["morning","evening","weekly","email"].includes(n))return e.json({error:"Invalid or missing ?kind= parameter"},400);try{const r=Ql().find(a=>a.kind===n);return await Ea(e.env.DB,t.id,n,r),e.json({success:!0,config:r})}catch(r){return e.json({error:r.message},500)}});Ee.post("/cron/tick",async e=>{if(!Aa(e))return e.json({error:"Unauthorized"},401);try{const t=await Ec(e.env.DB),n=new Date,s=[],r=[...new Set(t.map(o=>o.userId))];if(r.length===0)return e.json({executed:0,results:[]});const a=await e.env.DB.prepare(`SELECT * FROM users WHERE id IN (${r.map(()=>"?").join(",")})`).bind(...r).all(),i=new Map;for(const o of a.results||[])i.set(o.id,o);for(const{userId:o,timezone:l,config:c}of t){if(!bc(c,l,n))continue;const d=i.get(o);if(d)try{const u=await Na(e.env.DB,d,c.kind,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET},{deliver:!0});s.push({user_id:o,kind:c.kind,status:u.skipped?"skipped":"success",digest_id:u.digestId,delivered_channels:u.deliveredChannels,schedule_time:c.scheduleTime,timezone:l})}catch(u){Ct("digest cron tick user error",{userId:o,kind:c.kind,error:u==null?void 0:u.message}),s.push({user_id:o,kind:c.kind,status:"error",error:u.message})}}return e.json({executed:s.length,results:s})}catch(t){return e.json({error:t.message},500)}});Ee.post("/cron/meeting-reminders",async e=>{if(!Aa(e))return e.json({error:"Unauthorized"},401);try{const t=await e.env.DB.prepare("SELECT * FROM users").all(),n=[],s=new Date,r=new Date(s.getTime()+600*1e3).toISOString(),a=new Date(s.getTime()+900*1e3).toISOString(),{decrypt:i}=await Promise.resolve().then(()=>Vt),{sendNotification:o}=await Promise.resolve().then(()=>ca);for(const l of t.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const d=await i(c.encrypted_value,l.pin_hash),p=JSON.parse(d).access_token;if(!p)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(a)}&maxResults=10`,{headers:{Authorization:`Bearer ${p}`}});if(!v.ok)continue;const f=((await v.json()).items||[]).filter(y=>{var T;const _=(T=y.start)==null?void 0:T.dateTime;return _?_>=s.toISOString()&&_<=r:!1});if(f.length===0){n.push({user_id:l.id,reminders_sent:0});continue}for(const y of f){const _=new Date(y.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),T=y.location?`
📍 ${y.location}`:"",x="Meeting in 10 minutes",L=`${y.summary||"Untitled Event"}
🕐 ${_}${T}`;await o(e.env.DB,l.id,x,L,{pinHash:l.pin_hash,priority:"high",tags:["calendar","karna"]})}n.push({user_id:l.id,reminders_sent:f.length})}catch(c){n.push({user_id:l.id,status:"error",error:c.message})}return e.json({executed:n.length,results:n})}catch(t){return e.json({error:t.message},500)}});const ut=new be;async function Xt(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}function La(e){return e.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"")}ut.post("/cron/review-low-confidence",async e=>{if((e.req.header("X-Cron-Secret")||"")!==(e.env.CRON_SECRET||"karna-cron-default-v1"))return e.json({error:"Unauthorized"},401);let n=0,s=0,r=0;try{const a=await e.env.DB.prepare(`SELECT DISTINCT u.id, u.pin_hash
       FROM users u
       JOIN user_skills us ON us.user_id = u.id
       WHERE us.is_auto = 1 AND us.enabled = 1
         AND us.confidence_score < 0.4 AND us.usage_count >= 5`).all();for(const i of a.results??[])try{const{provider:o}=await Qe(e.env.DB,i.id,i.pin_hash),l=await No(e.env.DB,o,i.id);n+=l.reviewed,s+=l.rewritten,r+=l.disabled}catch{}}catch(a){return e.json({error:a.message,reviewed:n,rewritten:s,disabled:r},500)}return e.json({reviewed:n,rewritten:s,disabled:r})});ut.get("/",Xt,async e=>{const t=e.get("user"),s=(await e.env.DB.prepare(`SELECT id, name, slug, description, instructions, parameters, required_tools, examples,
            enabled, usage_count, last_used_at, created_at, updated_at,
            is_auto, refinement_count, source, confidence_score
     FROM user_skills WHERE user_id = ? ORDER BY created_at DESC`).bind(t.id).all()).results||[],r=s.filter(i=>!i.is_auto),a=s.filter(i=>i.is_auto);return e.json({skills:r,auto_skills:a})});ut.post("/",Xt,async e=>{var c,d,u;const t=e.get("user"),n=await e.req.json();if(!((c=n.name)!=null&&c.trim()))return e.json({error:"name is required"},400);if(!((d=n.description)!=null&&d.trim()))return e.json({error:"description is required"},400);if(!((u=n.instructions)!=null&&u.trim()))return e.json({error:"instructions is required"},400);let s=La(n.name);s||(s=`skill_${Date.now()}`);const r=await e.env.DB.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(t.id,`${s}%`).all();r.results&&r.results.length>0&&r.results.map(v=>v.slug).includes(s)&&(s=`${s}_${r.results.length+1}`);const a=JSON.stringify(n.parameters||{}),i=JSON.stringify(n.required_tools||[]),o=JSON.stringify(n.examples||[]),l=await e.env.DB.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).bind(t.id,n.name.trim(),s,n.description.trim(),n.instructions.trim(),a,i,o).first();return e.json({skill:l,created:!0})});ut.get("/:id",Xt,async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));if(isNaN(n))return e.json({error:"Invalid skill ID"},400);const s=await e.env.DB.prepare("SELECT * FROM user_skills WHERE id = ? AND user_id = ?").bind(n,t.id).first();return s?e.json({skill:s}):e.json({error:"Skill not found"},404)});ut.put("/:id",Xt,async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));if(isNaN(n))return e.json({error:"Invalid skill ID"},400);const s=await e.req.json(),r=[],a=[];return s.name!==void 0&&(r.push("name = ?","slug = ?"),a.push(s.name.trim(),La(s.name))),s.description!==void 0&&(r.push("description = ?"),a.push(s.description.trim())),s.instructions!==void 0&&(r.push("instructions = ?"),a.push(s.instructions.trim())),s.parameters!==void 0&&(r.push("parameters = ?"),a.push(JSON.stringify(s.parameters))),s.required_tools!==void 0&&(r.push("required_tools = ?"),a.push(JSON.stringify(s.required_tools))),s.examples!==void 0&&(r.push("examples = ?"),a.push(JSON.stringify(s.examples))),s.enabled!==void 0&&(r.push("enabled = ?"),a.push(s.enabled?1:0)),s.promote&&r.push("is_auto = 0","source = 'user'"),r.length===0?e.json({error:"Nothing to update"},400):(r.push("updated_at = CURRENT_TIMESTAMP"),a.push(n,t.id),await e.env.DB.prepare(`UPDATE user_skills SET ${r.join(", ")} WHERE id = ? AND user_id = ?`).bind(...a).run(),e.json({success:!0}))});ut.delete("/:id",Xt,async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return isNaN(n)?e.json({error:"Invalid skill ID"},400):(await e.env.DB.prepare("DELETE FROM user_skills WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0}))});const et=new be;async function Pc(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}et.use("/*",Pc);function jc(e){const t=new Date().toLocaleString("en-US",{timeZone:e});return new Date(t)}function Ma(e){const t=jc(e),n=new Date(t);n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const s=new Date(n.toLocaleString("en-US",{timeZone:"UTC"})),r=new Date(n.toLocaleString("en-US",{timeZone:e})),a=s.getTime()-r.getTime();return new Date(n.getTime()+a)}function yn(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}et.put("/:id/done",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!s)return e.json({error:"Notification not found"},404);const r=yn(s.source);return r&&await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t.id).run(),await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0,cron_completed:r!==null})});et.post("/:id/snooze",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.req.json(),r=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!r)return e.json({error:"Notification not found"},404);let a;if(typeof s.minutes=="number")a=new Date(Date.now()+s.minutes*60*1e3);else if(s.until==="tomorrow_morning")a=Ma(t.timezone||"UTC");else if(s.new_time)a=new Date(s.new_time);else return e.json({error:"Invalid snooze parameters"},400);if(isNaN(a.getTime()))return e.json({error:"Invalid time"},400);const i=a.toISOString(),o=yn(r.source);o&&await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(o,t.id).run();const l=await e.env.DB.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,r.title,r.body,"once",i,"reminder",JSON.stringify({description:r.body||""}),i,1,"active").first();return await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0,job_id:l==null?void 0:l.id})});et.post("/:id/reschedule",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),{new_time:s}=await e.req.json();if(!s)return e.json({error:"new_time is required"},400);const r=new Date(s);if(isNaN(r.getTime()))return e.json({error:"Invalid time"},400);const a=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!a)return e.json({error:"Notification not found"},404);const i=r.toISOString(),o=yn(a.source);if(o)return await e.env.DB.prepare("UPDATE cron_jobs SET next_run = ?, schedule_value = ?, state = 'active', enabled = 1, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(i,i,o,t.id).run(),e.json({success:!0,job_id:o});const l=await e.env.DB.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,a.title,a.body,"once",i,"reminder",JSON.stringify({description:a.body||""}),i,1,"active").first();return e.json({success:!0,job_id:l==null?void 0:l.id})});et.delete("/:id/cancel",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).first();if(!s)return e.json({error:"Notification not found"},404);const r=yn(s.source);return r&&await e.env.DB.prepare("UPDATE cron_jobs SET enabled = 0, state = 'completed', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t.id).run(),await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});et.post("/reminders/:id/snooze",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.req.json();if(!await e.env.DB.prepare("SELECT * FROM cron_jobs WHERE id = ? AND user_id = ?").bind(n,t.id).first())return e.json({error:"Reminder not found"},404);let a;if(typeof s.minutes=="number")a=new Date(Date.now()+s.minutes*60*1e3);else if(s.until_tomorrow_9am)a=Ma(t.timezone||"UTC");else if(s.new_time)a=new Date(s.new_time);else return e.json({error:"Invalid snooze parameters"},400);if(isNaN(a.getTime()))return e.json({error:"Invalid time"},400);const i=a.toISOString();return await e.env.DB.prepare("UPDATE cron_jobs SET next_run = ?, schedule_value = ?, state = 'active', enabled = 1, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(i,i,n,t.id).run(),e.json({success:!0})});et.post("/reminders/:id/done",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare("SELECT * FROM cron_jobs WHERE id = ? AND user_id = ?").bind(n,t.id).first()?(await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(n,t.id).run(),await e.env.DB.prepare("UPDATE notifications SET is_read = 1 WHERE source = ? AND user_id = ?").bind(`cron:${n}`,t.id).run(),e.json({success:!0})):e.json({error:"Reminder not found"},404)});const Le=new be;function Bc(e){return e.split(`
`).filter(t=>!/^(system:|assistant:|ignore previous|follow these instructions|tool:)/i.test(t.trim())).join(`
`).slice(0,4e3)}async function Uc(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}Le.use("/*",Uc);Le.get("/",async e=>{const t=e.get("user"),n=e.req.query("status"),s=e.req.query("search"),r=["user_id = ?"],a=[t.id];n&&(r.push("status = ?"),a.push(n)),s&&(r.push("(name LIKE ? OR summary LIKE ?)"),a.push(`%${s}%`,`%${s}%`));const i=`SELECT * FROM document_library WHERE ${r.join(" AND ")} ORDER BY created_at DESC`,o=await e.env.DB.prepare(i).bind(...a).all();return e.json({documents:o.results||[]})});Le.get("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id")),s=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return s?e.json({document:s}):e.json({error:"Document not found"},404)});Le.post("/upload",async e=>{const t=e.get("user"),n=!!e.env.DOCUMENTS_BUCKET,s=n?100*1024*1024:700*1024;try{const a=(await e.req.formData()).get("file");if(!a)return e.json({error:"No file provided."},400);const i=a.name,o=a.type||"application/octet-stream",l=a.size;if(l>s)return e.json({error:`File too large (max ${n?"100 MB":"700 KB"}). Try sharing a Google Drive link instead.`},400);const c=await a.arrayBuffer(),d=crypto.randomUUID();let u;n?(await e.env.DOCUMENTS_BUCKET.put(d,c,{httpMetadata:{contentType:o},customMetadata:{fileName:i,userId:String(t.id)}}),u="r2"):u=Buffer.from(c).toString("base64"),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(d,t.id,i,o,u,l).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,d,"upload",i,o,l,"uploaded").run();const p=o==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||i.toLowerCase().endsWith(".docx");if(p)try{const{extractDocxTextFromBuffer:g}=await Promise.resolve().then(()=>Br),f=await g(Buffer.from(c));if(f.length>50){await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(f,d).run();const y=f.substring(0,600);await e.env.DB.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(y,f.substring(0,5e4),d,t.id).run();const _=e.env,T=t.id,x=f,L=d,N=(async()=>{try{const M=await _.DB.prepare("SELECT id FROM document_library WHERE file_id = ? AND user_id = ?").bind(L,T).first();if(M){const{indexDocumentChunks:P}=await Promise.resolve().then(()=>Ve);await P({DB:_.DB,AI:_.AI,VECTORIZE:_.VECTORIZE},T,M.id,x)}}catch{}})();try{e.executionCtx.waitUntil(N)}catch{}}}catch{}const v=o==="application/pdf"||i.toLowerCase().endsWith(".pdf");if(v&&t.pin_hash){const g=Buffer.from(c).toString("base64"),f=t.pin_hash,y=t.id,_=e.env.DB,T=e.env.DOCUMENTS_BUCKET,x=e.env,L=(async()=>{var N,M;try{let P=null,z="claude-sonnet-4-6";const{decrypt:W}=await Promise.resolve().then(()=>Vt);for(const Z of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const te=await _.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(y,Z).first();if(te){const oe=await W(te.encrypted_value,f),re=JSON.parse(oe);if(re.provider==="anthropic"){P=re.apiKey,re.model&&(z=re.model);break}}}catch{}if(!P)return;let ne=g;if(u==="r2"&&T){const Z=await T.get(d);if(!Z)return;ne=Buffer.from(await Z.arrayBuffer()).toString("base64")}const j=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":P,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:z,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ne}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!j.ok)return;const q=((M=(N=(await j.json()).content)==null?void 0:N[0])==null?void 0:M.text)||"";if(q){await _.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(q,d).run();const Z=q.substring(0,600);await _.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(Z,q.substring(0,5e4),d,y).run();try{const te=await _.prepare("SELECT id FROM document_library WHERE file_id = ? AND user_id = ?").bind(d,y).first();if(te){const{indexDocumentChunks:oe}=await Promise.resolve().then(()=>Ve);await oe({DB:_,AI:x.AI,VECTORIZE:x.VECTORIZE},y,te.id,q)}}catch{}}}catch{}})();try{e.executionCtx.waitUntil(L)}catch{}}return e.json({file_id:d,name:i,type:o,size:l,storage:n?"r2":"d1",extracting:v&&!p})}catch(r){return console.error("Document upload error:",r),e.json({error:`Upload failed: ${r.message||"Unknown error"}`},500)}});Le.post("/search",async e=>{const t=e.get("user"),n=await e.req.json();if(!n.query)return e.json({error:"query is required"},400);const{semanticDocumentSearch:s}=await Promise.resolve().then(()=>Ve),r=await s({DB:e.env.DB,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE},t.id,n.query,Math.min(n.limit||5,20));return e.json({results:r})});Le.post("/chat",async e=>{var o;const t=e.get("user"),n=await e.req.json(),s=(n.question||n.query||"").trim();if(!s)return e.json({error:"question is required"},400);const{semanticDocumentSearch:r}=await Promise.resolve().then(()=>Ve),a=await r({DB:e.env.DB,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE},t.id,s,6);let i;if(a.length===0)i="No relevant document content found for your question. Make sure your documents have been uploaded and processed first.";else{const l=a.map((c,d)=>`[Source ${d+1}: ${c.filename} | chunk ${c.chunk_index}]
${Bc(c.chunk)}`).join(`
...
${r.substring(0,8e3)}`}],{maxTokens:1024})).content)==null?void 0:c.trim())||null}catch{a=null}const i=a||"Summary not yet generated. Ask Karna in chat to summarize this document.";await e.env.DB.prepare("UPDATE document_library SET status = ?, summary = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("summarized",i,n,t.id).run();const l=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return e.json({success:!0,document:l})});Le.delete("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).run(),e.json({success:!0})});Le.post("/:id/parse",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"));await e.env.DB.prepare("UPDATE document_library SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("parsed",n,t.id).run();const s=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(n,t.id).first();return e.json({success:!0,document:s})});const xe=new be;async function Hc(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
  ...
  `).bind(t.id).all()).results||[];if(s.length===0)return e.json({migrated:0,skipped:0,samples:[],message:"No oversized memory entries found."});let r=0,a=0;const i=[];for(const o of s){if(["preference","fact","context","decision"].includes(o.type)){a++;continue}const l=o.content.length>1500,c=/\b(essay|article|draft|report|chapter)\b/i.test(o.content)&&o.content.length>500;if(!l&&!c){a++;continue}try{const d=o.content.substring(0,500),u=o.content.substring(0,5e4);await e.env.DB.prepare(`
      ...
      `).bind(t.id,o.title,d,u).run();const p=`[Migrated to Document Library] ${o.title} — content moved to Document Library. Search for it with search_library("${o.title.substring(0,40)}").`;await e.env.DB.prepare("UPDATE memory SET content = ?, importance = 4, tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(p,o.id,t.id).run(),r++,i.length<5&&i.push({id:o.id,title:o.title,action:"migrated to document_library, memory demoted to pointer"})}catch{a++}}return e.json({migrated:r,skipped:a,samples:i,message:`Moved ${r} bulky memory entries to Document Library. ${a} entries were skipped (too short or migration error).`})});const mt=new be;async function Fc(e,t){var r;const n=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!n)return e.json({error:"Authentication required"},401);const s=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(n).first();if(!s)return e.json({error:"Invalid session"},401);e.set("user",{id:s.user_id,username:s.username,name:s.name,pin_hash:s.pin_hash,personality_prompt:s.personality_prompt,telegram_chat_id:s.telegram_chat_id,timezone:s.timezone,assistant_name:s.assistant_name||"Karna",created_at:s.created_at,updated_at:s.updated_at}),e.set("sessionId",n),await t()}mt.use("/*",Fc);function vn(e){return{id:e.id,title:e.title||"",content:e.content,tags:e.tags||"",source:e.source,source_query:e.source_query||"",is_pinned:e.is_pinned?1:0,created_at:e.created_at,updated_at:e.updated_at}}mt.get("/",async e=>{const t=e.get("user"),n=Math.min(parseInt(e.req.query("limit")||"50",10)||50,200),s=parseInt(e.req.query("offset")||"0",10)||0,r=e.req.query("tag"),a=e.req.query("pinned_only")==="true"||e.req.query("pinned_only")==="1",i=["user_id = ?"],o=[t.id];r&&(i.push("tags LIKE ?"),o.push(`%${r}%`)),a&&i.push("is_pinned = 1");const l=i.join(" AND "),c=await e.env.DB.prepare(`SELECT COUNT(*) as total FROM notes WHERE ${l}`).bind(...o).first();o.push(n,s);const d=await e.env.DB.prepare(`SELECT * FROM notes WHERE ${l} ORDER BY is_pinned DESC, updated_at DESC LIMIT ? OFFSET ?`).bind(...o).all();return e.json({notes:(d.results||[]).map(vn),total:(c==null?void 0:c.total)||0})});mt.get("/search",async e=>{const t=e.get("user"),n=(e.req.query("q")||"").trim();if(!n)return e.json({notes:[]});const s=`%${n}%`,r=await e.env.DB.prepare(`SELECT * FROM notes WHERE user_id = ? AND (title LIKE ? OR content LIKE ? OR tags LIKE ?)
     ORDER BY updated_at DESC LIMIT 50`).bind(t.id,s,s,s).all();return e.json({notes:(r.results||[]).map(vn)})});mt.post("/",async e=>{const t=e.get("user"),n=await e.req.json(),s=(n.content||"").trim();if(!s)return e.json({error:"content is required"},400);const r=n.source&&["manual","research","chat"].includes(n.source)?n.source:"manual",a=n.is_pinned?1:0,i=await e.env.DB.prepare(`INSERT INTO notes (user_id, title, content, tags, source, source_query, is_pinned)
     VALUES (?, ?, ?, ?, ?, ?, ?)
     RETURNING *`).bind(t.id,(n.title||"").trim(),s,(n.tags||"").trim(),r,(n.source_query||"").trim(),a).first();return e.json({note:vn(i)})});mt.put("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"),10);if(!n)return e.json({error:"Invalid note id"},400);if(!await e.env.DB.prepare("SELECT id FROM notes WHERE id = ? AND user_id = ?").bind(n,t.id).first())return e.json({error:"Note not found"},404);const r=await e.req.json(),a=[],i=[];if(r.title!==void 0&&(a.push("title = ?"),i.push(r.title)),r.content!==void 0){const l=r.content.trim();if(!l)return e.json({error:"content cannot be empty"},400);a.push("content = ?"),i.push(l)}if(r.tags!==void 0&&(a.push("tags = ?"),i.push(r.tags)),r.is_pinned!==void 0&&(a.push("is_pinned = ?"),i.push(r.is_pinned?1:0)),a.length===0)return e.json({error:"No fields to update"},400);a.push("updated_at = CURRENT_TIMESTAMP"),i.push(n,t.id);const o=await e.env.DB.prepare(`UPDATE notes SET ${a.join(", ")} WHERE id = ? AND user_id = ? RETURNING *`).bind(...i).first();return e.json({note:vn(o)})});mt.delete("/:id",async e=>{const t=e.get("user"),n=parseInt(e.req.param("id"),10);return n?(await e.env.DB.prepare("DELETE FROM notes WHERE id = ? AND user_id = ?").bind(n,t.id).run()).meta.changes?e.json({success:!0}):e.json({error:"Note not found"},404):e.json({error:"Invalid note id"},400)});const pe=new be,Wc=["/api/auth","/api/chat","/api/settings","/api/telegram","/api/system","/api/proactive","/api/digests","/api/skills","/api/notifications","/api/documents","/api/memory","/api/notes"];async function qc(e){const t=e.env.RENDER_BACKEND_URL,n=e.env.RENDER_API_SECRET;if(!(e.env.ENABLE_RENDER_PROXY==="true")||!t||!n||e.req.header("x-via-render-worker")||!Wc.some(g=>e.req.path.startsWith(g)))return null;const a=new URL(e.req.url);a.protocol=new URL(t).protocol,a.host=new URL(t).host;const i=new Headers(e.req.header());i.set("x-render-api-secret",n);const o=e.req.path.startsWith("/api/chat")||e.req.path.startsWith("/api/telegram"),l=Number(e.env.RENDER_PROXY_TIMEOUT_MS_LONG||"310000"),c=Number(e.env.RENDER_PROXY_TIMEOUT_MS||"8000"),d=o?l:c,u=new AbortController,p=setTimeout(()=>u.abort("render-proxy-timeout"),d);let v;try{v=await fetch(a.toString(),{method:e.req.method,headers:i,body:e.req.method==="GET"||e.req.method==="HEAD"?void 0:await e.req.arrayBuffer(),signal:u.signal})}catch(g){return e.json({error:"Render backend unavailable",detail:String(g)},503)}finally{clearTimeout(p)}return new Response(v.body,{status:v.status,headers:v.headers})}pe.use("/api/*",bi({exposeHeaders:["X-Thread-Id"]}));pe.use("/api/*",async(e,t)=>{const n=await qc(e);if(n)return n;await t()});pe.route("/api/auth",Xe);pe.route("/api/chat",le);pe.route("/api/settings",se);pe.route("/api/system",Ae);pe.route("/api/telegram",Zt);pe.route("/api/proactive",ye);pe.route("/api/digests",Ee);pe.route("/api/skills",ut);pe.route("/api/notifications",et);pe.route("/api/documents",Le);pe.route("/api/memory",xe);pe.route("/api/notes",mt);pe.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),n=t.searchParams.get("code"),s=t.searchParams.get("state"),r=t.searchParams.get("error");if(r)return e.html(ft(!1,`Google denied access: ${r}`));if(!n||!s)return e.html(ft(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(s)).sessionId;if(!i)return e.html(ft(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(ft(!1,"Session expired. Please log in again and retry."));const l=o.user_id,c=o.pin_hash,d=`${t.protocol}//${t.host}/auth/google/callback`,u=await wr(e.env.DB,l,c,n,d,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(ft(!0,`Connected as ${u.email}`,u.email))}catch(a){return e.html(ft(!1,`OAuth failed: ${a.message}`))}});pe.get("/preview-dashboard",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.html(ji())));pe.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ar(e.env.API_BASE_URL||""))));pe.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ar(e.env.API_BASE_URL||""))));function ft(e,t,n){return`<!DOCTYPE html>
...
`,i);if(l>a+1800/2)i=l+2;else{const c=e.lastIndexOf(". ",i);c>a+1800/2&&(i=c+2)}}const o=e.slice(a,i).trim();o.length>=100&&r.push(o),a=i-200,a<=0&&(a=i)}return r}async function Kc(e,t,n,s){if(!e.AI||!e.VECTORIZE)return;const r=Pa(s);if(r.length===0)return;const a=await e.DB.prepare("SELECT vector_id FROM document_chunks WHERE document_id = ?").bind(n).all();a.results.length>0&&(await e.VECTORIZE.deleteByIds(a.results.map(d=>d.vector_id)),await e.DB.prepare("DELETE FROM document_chunks WHERE document_id = ?").bind(n).run());const o=(await e.AI.run("@cf/baai/bge-large-en-v1.5",{text:r})).data,l=r.map((d,u)=>`doc_${n}_${u}`);await e.VECTORIZE.insert(r.map((d,u)=>({id:l[u],values:o[u],metadata:{userId:String(t),documentId:String(n)}})));const c=e.DB.prepare("INSERT INTO document_chunks (user_id, document_id, chunk_index, text, vector_id) VALUES (?, ?, ?, ?, ?)");await e.DB.batch(r.map((d,u)=>c.bind(t,n,u,d,l[u])))}async function Yc(e,t,n,s=5){if(!e.AI||!e.VECTORIZE)return[];const a=(await e.AI.run("@cf/baai/bge-large-en-v1.5",{text:[n]})).data[0],i=await e.VECTORIZE.query(a,{topK:s*3,filter:{userId:String(t)}});if(!i.matches||i.matches.length===0)return[];const o=i.matches.map(f=>f.id),l=new Map(i.matches.map(f=>[f.id,f.score])),c=o.map(()=>"?").join(","),u=((await e.DB.prepare(`SELECT dc.text, dc.vector_id, dc.document_id, dl.name, dc.chunk_index
     ...
     LIMIT ?`).bind(t,`%${n.substring(0,80)}%`,s*2).all()).results||[]).map(f=>({filename:f.name,relevance_score:.55,chunk:f.text,document_id:f.document_id,chunk_index:f.chunk_index,retrieval_method:"keyword"})),g=new Map;for(const f of[...u,...v]){const y=`${f.document_id}:${f.chunk_index}`;if(!g.has(y))g.set(y,f);else{const _=g.get(y);g.set(y,{..._,relevance_score:Math.max(_.relevance_score,f.relevance_score),retrieval_method:"hybrid"})}}return[...g.values()].sort((f,y)=>y.relevance_score-f.relevance_score).slice(0,s)}const Ve=Object.freeze(Object.defineProperty({__proto__:null,chunkText:Pa,indexDocumentChunks:Kc,semanticDocumentSearch:Yc},Symbol.toStringTag,{value:"Module"}));export{Ps as default};
