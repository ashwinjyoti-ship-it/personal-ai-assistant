var tn=Object.defineProperty;var pr=e=>{throw TypeError(e)};var rn=(e,t,r)=>t in e?tn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var M=(e,t,r)=>rn(e,typeof t!="symbol"?t+"":t,r),Wt=(e,t,r)=>t.has(e)||pr("Cannot "+r);var k=(e,t,r)=>(Wt(e,t,"read from private field"),r?r.call(e):t.get(e)),K=(e,t,r)=>t.has(e)?pr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),U=(e,t,r,a)=>(Wt(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),Z=(e,t,r)=>(Wt(e,t,"access private method"),r);var hr=(e,t,r,a)=>({set _(n){U(e,t,n,r)},get _(){return k(e,t,a)}});var gr=(e,t,r)=>(a,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,d=!1,c;if(e[o]?(c=e[o][0][0],a.req.routeIndex=o):c=o===e.length&&n||void 0,c)try{l=await c(a,()=>i(o+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&r&&(l=await r(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},an=Symbol(),nn=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,s=(e instanceof Wr?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?sn(e,{all:r,dot:a}):{}};async function sn(e,t){const r=await e.formData();return r?on(r,t):{}}function on(e,t){const r=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?ln(r,n,a):r[n]=a}),t.dot&&Object.entries(r).forEach(([a,n])=>{a.includes(".")&&(dn(r,a,n),delete r[a])}),r}var ln=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},dn=(e,t,r)=>{let a=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?a[s]=r:((!a[s]||typeof a[s]!="object"||Array.isArray(a[s])||a[s]instanceof File)&&(a[s]=Object.create(null)),a=a[s])})},Pr=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},cn=e=>{const{groups:t,path:r}=un(e),a=Pr(r);return mn(a,t)},un=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const n=`@${a}`;return t.push([n,r]),n}),{groups:t,path:e}},mn=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[r][1]);break}}return e},Ct={},pn=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return Ct[a]||(r[2]?Ct[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Ct[a]=[e,r[1],!0]),Ct[a]}return null},nr=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},hn=e=>nr(e,decodeURI),Ur=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const s=t.indexOf("?",a),i=t.indexOf("#",a),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(r,o);return hn(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(r,a)},gn=e=>{const t=Ur(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},et=(e,t,...r)=>(r.length&&(t=et(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Hr=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&a===""?r.push("/"):r.push(a);const s=n.replace("?","");a+="/"+s,r.push(a)}else a+="/"+n}),r.filter((n,s,i)=>i.indexOf(n)===s)},qt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?nr(e,Gr):e):e,Fr=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,d=e.indexOf("&",l);return qt(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(a&&(l=qt(l)),s=i,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),a&&(d=qt(d))),r?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},fn=Fr,yn=(e,t)=>Fr(e,t,!0),Gr=decodeURIComponent,fr=e=>nr(e,Gr),nt,he,Oe,qr,zr,Xt,Ne,Ar,Wr=(Ar=class{constructor(e,t="/",r=[[]]){K(this,Oe);M(this,"raw");K(this,nt);K(this,he);M(this,"routeIndex",0);M(this,"path");M(this,"bodyCache",{});K(this,Ne,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,U(this,he,r),U(this,nt,{})}param(e){return e?Z(this,Oe,qr).call(this,e):Z(this,Oe,zr).call(this)}query(e){return fn(this.url,e)}queries(e){return yn(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await nn(this,e))}json(){return k(this,Ne).call(this,"text").then(e=>JSON.parse(e))}text(){return k(this,Ne).call(this,"text")}arrayBuffer(){return k(this,Ne).call(this,"arrayBuffer")}blob(){return k(this,Ne).call(this,"blob")}formData(){return k(this,Ne).call(this,"formData")}addValidatedData(e,t){k(this,nt)[e]=t}valid(e){return k(this,nt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[an](){return k(this,he)}get matchedRoutes(){return k(this,he)[0].map(([[,e]])=>e)}get routePath(){return k(this,he)[0].map(([[,e]])=>e)[this.routeIndex].path}},nt=new WeakMap,he=new WeakMap,Oe=new WeakSet,qr=function(e){const t=k(this,he)[0][this.routeIndex][1][e],r=Z(this,Oe,Xt).call(this,t);return r&&/\%/.test(r)?fr(r):r},zr=function(){const e={},t=Object.keys(k(this,he)[0][this.routeIndex][1]);for(const r of t){const a=Z(this,Oe,Xt).call(this,k(this,he)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?fr(a):a)}return e},Xt=function(e){return k(this,he)[1]?k(this,he)[1][e]:e},Ne=new WeakMap,Ar),vn={Stringify:1},Kr=async(e,t,r,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:a}))).then(o=>Promise.all(o.filter(Boolean).map(l=>Kr(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},wn="text/plain; charset=UTF-8",zt=(e,t)=>({"Content-Type":e,...t}),Tt,xt,Se,st,ke,me,St,it,ot,We,kt,Dt,Ae,tt,Lr,bn=(Lr=class{constructor(e,t){K(this,Ae);K(this,Tt);K(this,xt);M(this,"env",{});K(this,Se);M(this,"finalized",!1);M(this,"error");K(this,st);K(this,ke);K(this,me);K(this,St);K(this,it);K(this,ot);K(this,We);K(this,kt);K(this,Dt);M(this,"render",(...e)=>(k(this,it)??U(this,it,t=>this.html(t)),k(this,it).call(this,...e)));M(this,"setLayout",e=>U(this,St,e));M(this,"getLayout",()=>k(this,St));M(this,"setRenderer",e=>{U(this,it,e)});M(this,"header",(e,t,r)=>{this.finalized&&U(this,me,new Response(k(this,me).body,k(this,me)));const a=k(this,me)?k(this,me).headers:k(this,We)??U(this,We,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});M(this,"status",e=>{U(this,st,e)});M(this,"set",(e,t)=>{k(this,Se)??U(this,Se,new Map),k(this,Se).set(e,t)});M(this,"get",e=>k(this,Se)?k(this,Se).get(e):void 0);M(this,"newResponse",(...e)=>Z(this,Ae,tt).call(this,...e));M(this,"body",(e,t,r)=>Z(this,Ae,tt).call(this,e,t,r));M(this,"text",(e,t,r)=>!k(this,We)&&!k(this,st)&&!t&&!r&&!this.finalized?new Response(e):Z(this,Ae,tt).call(this,e,t,zt(wn,r)));M(this,"json",(e,t,r)=>Z(this,Ae,tt).call(this,JSON.stringify(e),t,zt("application/json",r)));M(this,"html",(e,t,r)=>{const a=n=>Z(this,Ae,tt).call(this,n,t,zt("text/html; charset=UTF-8",r));return typeof e=="object"?Kr(e,vn.Stringify,!1,{}).then(a):a(e)});M(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});M(this,"notFound",()=>(k(this,ot)??U(this,ot,()=>new Response),k(this,ot).call(this,this)));U(this,Tt,e),t&&(U(this,ke,t.executionCtx),this.env=t.env,U(this,ot,t.notFoundHandler),U(this,Dt,t.path),U(this,kt,t.matchResult))}get req(){return k(this,xt)??U(this,xt,new Wr(k(this,Tt),k(this,Dt),k(this,kt))),k(this,xt)}get event(){if(k(this,ke)&&"respondWith"in k(this,ke))return k(this,ke);throw Error("This context has no FetchEvent")}get executionCtx(){if(k(this,ke))return k(this,ke);throw Error("This context has no ExecutionContext")}get res(){return k(this,me)||U(this,me,new Response(null,{headers:k(this,We)??U(this,We,new Headers)}))}set res(e){if(k(this,me)&&e){e=new Response(e.body,e);for(const[t,r]of k(this,me).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=k(this,me).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}U(this,me,e),this.finalized=!0}get var(){return k(this,Se)?Object.fromEntries(k(this,Se)):{}}},Tt=new WeakMap,xt=new WeakMap,Se=new WeakMap,st=new WeakMap,ke=new WeakMap,me=new WeakMap,St=new WeakMap,it=new WeakMap,ot=new WeakMap,We=new WeakMap,kt=new WeakMap,Dt=new WeakMap,Ae=new WeakSet,tt=function(e,t,r){const a=k(this,me)?new Headers(k(this,me).headers):k(this,We)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?a.append(i,o):a.set(i,o)}if(r)for(const[s,i]of Object.entries(r))if(typeof i=="string")a.set(s,i);else{a.delete(s);for(const o of i)a.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??k(this,st);return new Response(e,{status:n,headers:a})},Lr),se="ALL",_n="all",En=["get","post","put","delete","options","patch"],Yr="Can not add a route since the matcher is already built.",Jr=class extends Error{},Tn="__COMPOSED_HANDLER",xn=e=>e.text("404 Not Found",404),yr=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},ye,ie,Vr,ve,Fe,Nt,At,lt,Sn=(lt=class{constructor(t={}){K(this,ie);M(this,"get");M(this,"post");M(this,"put");M(this,"delete");M(this,"options");M(this,"patch");M(this,"all");M(this,"on");M(this,"use");M(this,"router");M(this,"getPath");M(this,"_basePath","/");K(this,ye,"/");M(this,"routes",[]);K(this,ve,xn);M(this,"errorHandler",yr);M(this,"onError",t=>(this.errorHandler=t,this));M(this,"notFound",t=>(U(this,ve,t),this));M(this,"fetch",(t,...r)=>Z(this,ie,At).call(this,t,r[1],r[0],t.method));M(this,"request",(t,r,a,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${et("/",t)}`,r),a,n)));M(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(Z(this,ie,At).call(this,t.request,t,void 0,t.request.method))})});[...En,_n].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?U(this,ye,i):Z(this,ie,Fe).call(this,s,k(this,ye),i),o.forEach(l=>{Z(this,ie,Fe).call(this,s,k(this,ye),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){U(this,ye,l);for(const d of[s].flat())o.map(c=>{Z(this,ie,Fe).call(this,d.toUpperCase(),k(this,ye),c)})}return this},this.use=(s,...i)=>(typeof s=="string"?U(this,ye,s):(U(this,ye,"*"),i.unshift(s)),i.forEach(o=>{Z(this,ie,Fe).call(this,se,k(this,ye),o)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Ur:gn}route(t,r){const a=this.basePath(t);return r.routes.map(n=>{var i;let s;r.errorHandler===yr?s=n.handler:(s=async(o,l)=>(await gr([],r.errorHandler)(o,()=>n.handler(o,l))).res,s[Tn]=n.handler),Z(i=a,ie,Fe).call(i,n.method,n.path,s)}),this}basePath(t){const r=Z(this,ie,Vr).call(this);return r._basePath=et(this._basePath,t),r}mount(t,r,a){let n,s;a&&(typeof a=="function"?s=a:(s=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const i=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=et(this._basePath,t),d=l==="/"?0:l.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const o=async(l,d)=>{const c=await r(n(l.req.raw),...i(l));if(c)return c;await d()};return Z(this,ie,Fe).call(this,se,et(t,"*"),o),this}},ye=new WeakMap,ie=new WeakSet,Vr=function(){const t=new lt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,U(t,ve,k(this,ve)),t.routes=this.routes,t},ve=new WeakMap,Fe=function(t,r,a){t=t.toUpperCase(),r=et(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,n]),this.routes.push(n)},Nt=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},At=function(t,r,a,n){if(n==="HEAD")return(async()=>new Response(null,await Z(this,ie,At).call(this,t,r,a,"GET")))();const s=this.getPath(t,{env:a}),i=this.router.match(n,s),o=new bn(t,{path:s,matchResult:i,env:a,executionCtx:r,notFoundHandler:k(this,ve)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await k(this,ve).call(this,o)})}catch(c){return Z(this,ie,Nt).call(this,c,o)}return d instanceof Promise?d.then(c=>c||(o.finalized?o.res:k(this,ve).call(this,o))).catch(c=>Z(this,ie,Nt).call(this,c,o)):d??k(this,ve).call(this,o)}const l=gr(i[0],this.errorHandler,k(this,ve));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return Z(this,ie,Nt).call(this,d,o)}})()},lt),Zr=[];function kn(e,t){const r=this.buildAllMatchers(),a=((n,s)=>{const i=r[n]||r[se],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],Zr];const d=l.indexOf("",1);return[i[1][d],l]});return this.match=a,a(e,t)}var Mt="[^/]+",vt=".*",wt="(?:|/.*)",rt=Symbol(),Dn=new Set(".\\+*[^]$()");function Rn(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===vt||e===wt?1:t===vt||t===wt?-1:e===Mt?1:t===Mt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var qe,ze,we,Je,On=(Je=class{constructor(){K(this,qe);K(this,ze);K(this,we,Object.create(null))}insert(t,r,a,n,s){if(t.length===0){if(k(this,qe)!==void 0)throw rt;if(s)return;U(this,qe,r);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",vt]:["","",Mt]:i==="/*"?["","",wt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let m=l[2]||Mt;if(c&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw rt;if(d=k(this,we)[m],!d){if(Object.keys(k(this,we)).some(h=>h!==vt&&h!==wt))throw rt;if(s)return;d=k(this,we)[m]=new Je,c!==""&&U(d,ze,n.varIndex++)}!s&&c!==""&&a.push([c,k(d,ze)])}else if(d=k(this,we)[i],!d){if(Object.keys(k(this,we)).some(c=>c.length>1&&c!==vt&&c!==wt))throw rt;if(s)return;d=k(this,we)[i]=new Je}d.insert(o,r,a,n,s)}buildRegExpStr(){const r=Object.keys(k(this,we)).sort(Rn).map(a=>{const n=k(this,we)[a];return(typeof k(n,ze)=="number"?`(${a})@${k(n,ze)}`:Dn.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof k(this,qe)=="number"&&r.unshift(`#${k(this,qe)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},qe=new WeakMap,ze=new WeakMap,we=new WeakMap,Je),jt,Rt,Mr,In=(Mr=class{constructor(){K(this,jt,{varIndex:0});K(this,Rt,new On)}insert(e,t,r){const a=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return n[i]=[d,l],i++,o=!0,d}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return k(this,Rt).insert(s,t,a,k(this,jt),r),a}buildRegExp(){let e=k(this,Rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(r[++t]=Number(s),"$()"):(i!==void 0&&(a[Number(i)]=++t),"")),[new RegExp(`^${e}`),r,a]}},jt=new WeakMap,Rt=new WeakMap,Mr),Cn=[/^$/,[],Object.create(null)],Lt=Object.create(null);function Xr(e){return Lt[e]??(Lt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Nn(){Lt=Object.create(null)}function An(e){var d;const t=new In,r=[];if(e.length===0)return Cn;const a=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[h,w])=>c?1:h?-1:m.length-w.length),n=Object.create(null);for(let c=0,m=-1,h=a.length;c<h;c++){const[w,y,b]=a[c];w?n[y]=[b.map(([x])=>[x,Object.create(null)]),Zr]:m++;let v;try{v=t.insert(y,m,w)}catch(x){throw x===rt?new Jr(y):x}w||(r[m]=b.map(([x,E])=>{const O=Object.create(null);for(E-=1;E>=0;E--){const[C,j]=v[E];O[C]=j}return[x,O]}))}const[s,i,o]=t.buildRegExp();for(let c=0,m=r.length;c<m;c++)for(let h=0,w=r[c].length;h<w;h++){const y=(d=r[c][h])==null?void 0:d[1];if(!y)continue;const b=Object.keys(y);for(let v=0,x=b.length;v<x;v++)y[b[v]]=o[y[b[v]]]}const l=[];for(const c in i)l[c]=r[i[c]];return[s,l,n]}function Xe(e,t){if(e){for(const r of Object.keys(e).sort((a,n)=>n.length-a.length))if(Xr(r).test(t))return[...e[r]]}}var Le,Me,Pt,Qr,$r,Ln=($r=class{constructor(){K(this,Pt);M(this,"name","RegExpRouter");K(this,Le);K(this,Me);M(this,"match",kn);U(this,Le,{[se]:Object.create(null)}),U(this,Me,{[se]:Object.create(null)})}add(e,t,r){var o;const a=k(this,Le),n=k(this,Me);if(!a||!n)throw new Error(Yr);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[se]).forEach(d=>{l[e][d]=[...l[se][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Xr(t);e===se?Object.keys(a).forEach(d=>{var c;(c=a[d])[t]||(c[t]=Xe(a[d],t)||Xe(a[se],t)||[])}):(o=a[e])[t]||(o[t]=Xe(a[e],t)||Xe(a[se],t)||[]),Object.keys(a).forEach(d=>{(e===se||e===d)&&Object.keys(a[d]).forEach(c=>{l.test(c)&&a[d][c].push([r,s])})}),Object.keys(n).forEach(d=>{(e===se||e===d)&&Object.keys(n[d]).forEach(c=>l.test(c)&&n[d][c].push([r,s]))});return}const i=Hr(t)||[t];for(let l=0,d=i.length;l<d;l++){const c=i[l];Object.keys(n).forEach(m=>{var h;(e===se||e===m)&&((h=n[m])[c]||(h[c]=[...Xe(a[m],c)||Xe(a[se],c)||[]]),n[m][c].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(k(this,Me)).concat(Object.keys(k(this,Le))).forEach(t=>{e[t]||(e[t]=Z(this,Pt,Qr).call(this,t))}),U(this,Le,U(this,Me,void 0)),Nn(),e}},Le=new WeakMap,Me=new WeakMap,Pt=new WeakSet,Qr=function(e){const t=[];let r=e===se;return[k(this,Le),k(this,Me)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(s=>[s,a[e][s]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==se&&t.push(...Object.keys(a[se]).map(s=>[s,a[se][s]]))}),r?An(t):null},$r),$e,De,Br,Mn=(Br=class{constructor(e){M(this,"name","SmartRouter");K(this,$e,[]);K(this,De,[]);U(this,$e,e.routers)}add(e,t,r){if(!k(this,De))throw new Error(Yr);k(this,De).push([e,t,r])}match(e,t){if(!k(this,De))throw new Error("Fatal error");const r=k(this,$e),a=k(this,De),n=r.length;let s=0,i;for(;s<n;s++){const o=r[s];try{for(let l=0,d=a.length;l<d;l++)o.add(...a[l]);i=o.match(e,t)}catch(l){if(l instanceof Jr)continue;throw l}this.match=o.match.bind(o),U(this,$e,[o]),U(this,De,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(k(this,De)||k(this,$e).length!==1)throw new Error("No active router has been determined yet.");return k(this,$e)[0]}},$e=new WeakMap,De=new WeakMap,Br),gt=Object.create(null),Be,de,Ke,dt,oe,Re,Ge,ct,$n=(ct=class{constructor(t,r,a){K(this,Re);K(this,Be);K(this,de);K(this,Ke);K(this,dt,0);K(this,oe,gt);if(U(this,de,a||Object.create(null)),U(this,Be,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},U(this,Be,[n])}U(this,Ke,[])}insert(t,r,a){U(this,dt,++hr(this,dt)._);let n=this;const s=cn(r),i=[];for(let o=0,l=s.length;o<l;o++){const d=s[o],c=s[o+1],m=pn(d,c),h=Array.isArray(m)?m[0]:d;if(h in k(n,de)){n=k(n,de)[h],m&&i.push(m[1]);continue}k(n,de)[h]=new ct,m&&(k(n,Ke).push(m),i.push(m[1])),n=k(n,de)[h]}return k(n,Be).push({[t]:{handler:a,possibleKeys:i.filter((o,l,d)=>d.indexOf(o)===l),score:k(this,dt)}}),n}search(t,r){var l;const a=[];U(this,oe,gt);let s=[this];const i=Pr(r),o=[];for(let d=0,c=i.length;d<c;d++){const m=i[d],h=d===c-1,w=[];for(let y=0,b=s.length;y<b;y++){const v=s[y],x=k(v,de)[m];x&&(U(x,oe,k(v,oe)),h?(k(x,de)["*"]&&a.push(...Z(this,Re,Ge).call(this,k(x,de)["*"],t,k(v,oe))),a.push(...Z(this,Re,Ge).call(this,x,t,k(v,oe)))):w.push(x));for(let E=0,O=k(v,Ke).length;E<O;E++){const C=k(v,Ke)[E],j=k(v,oe)===gt?{}:{...k(v,oe)};if(C==="*"){const R=k(v,de)["*"];R&&(a.push(...Z(this,Re,Ge).call(this,R,t,k(v,oe))),U(R,oe,j),w.push(R));continue}const[G,F,P]=C;if(!m&&!(P instanceof RegExp))continue;const q=k(v,de)[G],z=i.slice(d).join("/");if(P instanceof RegExp){const R=P.exec(z);if(R){if(j[F]=R[0],a.push(...Z(this,Re,Ge).call(this,q,t,k(v,oe),j)),Object.keys(k(q,de)).length){U(q,oe,j);const W=((l=R[0].match(/\//))==null?void 0:l.length)??0;(o[W]||(o[W]=[])).push(q)}continue}}(P===!0||P.test(m))&&(j[F]=m,h?(a.push(...Z(this,Re,Ge).call(this,q,t,j,k(v,oe))),k(q,de)["*"]&&a.push(...Z(this,Re,Ge).call(this,k(q,de)["*"],t,j,k(v,oe)))):(U(q,oe,j),w.push(q)))}}s=w.concat(o.shift()??[])}return a.length>1&&a.sort((d,c)=>d.score-c.score),[a.map(({handler:d,params:c})=>[d,c])]}},Be=new WeakMap,de=new WeakMap,Ke=new WeakMap,dt=new WeakMap,oe=new WeakMap,Re=new WeakSet,Ge=function(t,r,a,n){const s=[];for(let i=0,o=k(t,Be).length;i<o;i++){const l=k(t,Be)[i],d=l[r]||l[se],c={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),a!==gt||n&&n!==gt))for(let m=0,h=d.possibleKeys.length;m<h;m++){const w=d.possibleKeys[m],y=c[d.score];d.params[w]=n!=null&&n[w]&&!y?n[w]:a[w]??(n==null?void 0:n[w]),c[d.score]=!0}}return s},ct),Ye,jr,Bn=(jr=class{constructor(){M(this,"name","TrieRouter");K(this,Ye);U(this,Ye,new $n)}add(e,t,r){const a=Hr(t);if(a){for(let n=0,s=a.length;n<s;n++)k(this,Ye).insert(e,a[n],r);return}k(this,Ye).insert(e,t,r)}match(e,t){return k(this,Ye).search(e,t)}},Ye=new WeakMap,jr),ge=class extends Sn{constructor(e={}){super(e),this.router=e.router??new Mn({routers:[new Ln,new Bn]})}},jn=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(r.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(i,o){var c;function l(m,h){i.res.headers.set(m,h)}const d=await a(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(c=r.exposeHeaders)!=null&&c.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),i.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const m=await n(i.req.header("origin")||"",i);m.length&&l("Access-Control-Allow-Methods",m.join(","));let h=r.allowHeaders;if(!(h!=null&&h.length)){const w=i.req.header("Access-Control-Request-Headers");w&&(h=w.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),r.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function ea(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
Check your ${a} API credit balance or key.`;const{decrypt:d}=await Promise.resolve().then(()=>Ht),c=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(c!=null&&c.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const h=await d(m.encrypted_value,c.pin_hash);await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function vr(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class na{constructor(t,r="claude-sonnet-4-20250514",a="https://api.anthropic.com",n="anthropic"){M(this,"name");M(this,"apiKey");M(this,"model");M(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=a,this.name=n}async chat(t,r){var c,m,h,w;const a=t.find(y=>y.role==="system"),n=t.filter(y=>y.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:n.map(y=>({role:y.role,content:y.content}))};a&&(s.system=a.content),r!=null&&r.tools&&r.tools.length>0&&(s.tools=r.tools.map(y=>({name:y.name,description:y.description,input_schema:y.parameters})),r.toolChoice==="required"&&(s.tool_choice={type:"any"}));const i=await aa(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)}),this.name);if(!i.ok){const y=await i.text();throw new Error(this.name+" API error "+i.status+": "+y)}const o=await i.json(),l=((c=o.content)==null?void 0:c.filter(y=>y.type==="text"))||[],d=((m=o.content)==null?void 0:m.filter(y=>y.type==="tool_use"))||[];return{content:l.map(y=>y.text).join(`
`),toolCalls:d.map(y=>({id:y.id,name:y.name,arguments:y.input})),usage:{promptTokens:((h=o.usage)==null?void 0:h.input_tokens)||0,completionTokens:((w=o.usage)==null?void 0:w.output_tokens)||0}}}async streamChat(t,r){const a=t.find(d=>d.role==="system"),n=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:n.map(d=>({role:d.role,content:d.content}))};a&&(s.system=a.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const d=await i.text();throw new Error(this.name+" stream error "+i.status+": "+d)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var y;const{done:c,value:m}=await o.read();if(c){d.close();return}const w=l.decode(m,{stream:!0}).split(`
`);for(const b of w)if(b.startsWith("data: ")){const v=b.slice(6);if(v==="[DONE]")continue;try{const x=JSON.parse(v);x.type==="content_block_delta"&&((y=x.delta)!=null&&y.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:x.delta.text})+`

`))}catch{}}}})}}function Hn(e){const t={},r=e||{};if(t.type=r.type||"object",t.type==="object"){const a=r.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const n={};for(const[s,i]of Object.entries(a))i&&typeof i=="object"?n[s]=Qt(i):n[s]=i;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(r.required)?t.required=r.required:t.required=[]}return r.description&&(t.description=r.description),t}function Qt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const r=t.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const a={};for(const[n,s]of Object.entries(r))s&&typeof s=="object"?a[n]=Qt(s):a[n]=s;t.properties=a}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Qt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class sa{constructor(t,r,a,n){M(this,"name");M(this,"apiKey");M(this,"model");M(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=a.replace(/\/+$/,""),this.name=n}async chat(t,r){var l,d,c,m,h,w;const a={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:t.map(y=>({role:y.role,content:y.content}))},n=this.apiBase.includes("routellm.abacus.ai");if(r!=null&&r.tools&&r.tools.length>0&&n)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");r!=null&&r.tools&&r.tools.length>0&&(a.tools=r.tools.map(y=>({type:"function",function:{name:y.name,description:y.description,parameters:Hn(y.parameters||{})}})),r.toolChoice==="required"&&(a.tool_choice="required"));const s=await aa(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)}),this.name);if(!s.ok){const y=await s.text();throw new Error(this.name+" API error "+s.status+": "+y)}const i=await s.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((d=o==null?void 0:o.message)==null?void 0:d.content)||"",toolCalls:(m=(c=o==null?void 0:o.message)==null?void 0:c.tool_calls)==null?void 0:m.map(y=>({id:y.id,name:y.function.name,arguments:(()=>{try{return typeof y.function.arguments=="string"?JSON.parse(y.function.arguments||"{}"):y.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=i.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((w=i.usage)==null?void 0:w.completion_tokens)||0}}}async streamChat(t,r){const a={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)});if(!n.ok){const o=await n.text();throw new Error(this.name+" stream error "+n.status+": "+o)}const s=n.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var h,w,y;const{done:l,value:d}=await s.read();if(l){o.close();return}const m=i.decode(d,{stream:!0}).split(`
`);for(const b of m)if(b.startsWith("data: ")){const v=b.slice(6);if(v==="[DONE]")continue;try{const E=(y=(w=(h=JSON.parse(v).choices)==null?void 0:h[0])==null?void 0:w.delta)==null?void 0:y.content;E&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E})+`

`))}catch{}}}})}}function er(e,t,r,a){const n=bt[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=a||n.defaultModel;return n.apiFormat==="anthropic"?new na(t,s,n.apiBase,r):new sa(t,s,n.apiBase,r)}class ia{constructor(){M(this,"errorLog",new Map);M(this,"usageLog",new Map)}async pickProvider(t){const r=Date.now(),a=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=r:!0});return a.length>0?a[0]:null}async recordUsage(t,r){const a=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:a.tokens+r,requests:a.requests+1})}async recordError(t,r,a=5){this.errorLog.set(t,{error:r,cooldownUntil:Date.now()+a*60*1e3})}}const Fn=["llm_slot_1","llm_slot_2","llm_slot_3"],Gn=["anthropic","openai"];async function Ve(e,t,r){const{decrypt:a}=await Promise.resolve().then(()=>Ht),n=new ia,s=[];for(const m of Fn){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const w=await a(h.encrypted_value,r),y=JSON.parse(w);if(y.provider&&y.apiKey&&bt[y.provider]){const v=y.provider,x=er(y.provider,y.apiKey,v,y.model);s.push({name:v,provider:x})}}catch(w){console.error(`Failed to load ${m}:`,w)}}const i=new Set(s.map(m=>m.name));for(const m of Gn){if(i.has(m))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const w=await a(h.encrypted_value,r);if(bt[m]){const b=er(m,w,m);s.push({name:m,provider:b})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=s.map(m=>m.name),l=await n.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const d=s.find(m=>m.name===l);return{provider:Wn(d.provider,s,n,e,t),rotation:n}}function Wn(e,t,r,a,n){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"";throw s(c)&&!c.includes("TOOLS_UNSUPPORTED")&&Kt(a,n,"all_providers_down",e.name,null,c),d}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"",m=i(c);if(!s(c)&&!m)throw d;const h=c.includes("TOOLS_UNSUPPORTED"),w=h?1:m?10:1440;console.warn(`Provider ${e.name} ${m?"rate limited":h?"tools unsupported":"auth/billing error"}, trying fallback...`),await r.recordError(e.name,c,w);const y=t.filter(b=>b.name!==e.name);for(const b of y)try{const v=await b.provider.chat(o,l);return this.name=b.name,!h&&!m&&Kt(a,n,"provider_switched",e.name,b.name,c),v}catch(v){const x=v.message||"";if(s(x)||i(x)){await r.recordError(b.name,x,i(x)?10:1440);continue}throw v}throw Kt(a,n,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const at=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:na,OpenAICompatibleProvider:sa,ProviderRotation:ia,createProviderFromConfig:er,createRotatingProvider:Ve,logError:H},Symbol.toStringTag,{value:"Module"})),Yt=20,qn=2e3,zn=2e3,oa=4;function Kn(e){return Math.ceil(e.length/oa)}function wr(e,t){const r=t*oa;return e.length<=r?e:e.slice(0,r)+`
[...truncated to fit token budget]`}class Y{constructor(t){this.db=t}async store(t,r,a,n,s=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,r,a).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       WHERE user_id = ? AND type = 'task' AND status = 'done' AND tier = 'working'
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((r==null?void 0:r.cnt)||0)>Yt){const a=((r==null?void 0:r.cnt)||0)-Yt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,a).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,Yt).all()).results||[]}async getAll(t,r,a=50){return r?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,r,a).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a).all()).results||[]}async search(t,r,a=10){const s=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${r}%`,`%${r}%`,a).all()).results||[];if(s.length>0)return await this.touchMemories(t,s.map(c=>c.id)),s;const i=r.split(/\s+/).filter(c=>c.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const c of i){const m=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${c}%`,`%${c}%`,a*2).all();for(const h of m.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const d=[...l.values()].sort((c,m)=>(o.get(m.id)||0)-(o.get(c.id)||0)).slice(0,a);return d.length>0&&await this.touchMemories(t,d.map(c=>c.id)),d}async searchLongTerm(t,r,a=5){const s=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${r}%`,`%${r}%`,a).all()).results||[];if(s.length>0)return await this.touchMemories(t,s.map(c=>c.id)),s;const i=r.split(/\s+/).filter(c=>c.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const c of i){const m=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${c}%`,`%${c}%`,a*2).all();for(const h of m.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const d=[...l.values()].sort((c,m)=>(o.get(m.id)||0)-(o.get(c.id)||0)).slice(0,a);return d.length>0&&await this.touchMemories(t,d.map(c=>c.id)),d}async touchMemories(t,r){for(const a of r)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t).run()}async update(t,r,a){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t,r).run()}async promote(t,r){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,r).run(),await this.enforceWorkingMemoryCap(r)}async demote(t,r){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,r).run()}async remove(t,r){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,r).run()}async buildContext(t){const r=await this.getWorkingMemory(t);if(r.length===0)return"";const a={};for(const s of r)a[s.type]||(a[s.type]=[]),a[s.type].push(s);let n=`
## Working Memory (Active Context)
`;for(const[s,i]of Object.entries(a)){n+=`
### ${s.charAt(0).toUpperCase()+s.slice(1)}s
`;for(const o of i)n+=`- **${o.title}**: ${o.content}
`}return wr(n,qn)}static truncatePersonality(t){return wr(t,zn)}async getRecentConversations(t,r=20,a){return a?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a,r).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r).all()).results||[]).reverse()}async storeMessage(t,r,a,n,s="{}",i){const o=Kn(n);i?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,o,i).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,o).run()}async compactHistory(t,r=30){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((a==null?void 0:a.cnt)||0)<=r*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,r).run()}}const Yn=Object.freeze(Object.defineProperty({__proto__:null,MemoryService:Y},Symbol.toStringTag,{value:"Module"})),Jn="https://accounts.google.com/o/oauth2/v2/auth",la="https://oauth2.googleapis.com/token",Vn="https://www.googleapis.com/oauth2/v2/userinfo",Zn=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let Ee=null;async function tr(e,t,r){const a=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!a)return null;try{const n=await J(a.encrypted_value,r);return JSON.parse(n)}catch{return null}}async function Xn(e,t,r,a){const n=await ut(JSON.stringify(a),r);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,n).run()}function da(e,t,r){const a=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Zn,access_type:"offline",prompt:"consent",state:r,include_granted_scopes:"true"});return`${Jn}?${a}`}async function ca(e,t,r,a){const n=await fetch(la,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:r,redirect_uri:a,grant_type:"authorization_code"})}),s=await n.text();if(!n.ok)throw new Error(`Token exchange failed (${n.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function Qn(e,t,r){const a=await fetch(la,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:r,grant_type:"refresh_token"})}),n=await a.text();if(!a.ok)throw a.status===400||a.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${a.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function ua(e){const t=await fetch(Vn,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function mt(e,t,r,a,n){if(!a||!n)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(Ee&&Ee.userId===t&&Ee.expiresAt>Date.now()/1e3+60){const o=await tr(e,t,r);return{token:Ee.token,email:(o==null?void 0:o.email)||"unknown"}}const s=await tr(e,t,r);if(!s)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const i=await Qn(s.refresh_token,a,n);return Ee={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{token:i.access_token,email:s.email}}async function ir(e,t,r){try{const a=await tr(e,t,r);return a?{connected:!0,email:a.email,connectedAt:a.connected_at}:{connected:!1}}catch{return{connected:!1}}}function ma(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function pa(e,t,r,a,n,s,i){const o=await ca(a,s,i,n);if(!o.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await ua(o.access_token),d={refresh_token:o.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Xn(e,t,r,d),Ee={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{email:l.email,name:l.name}}async function ha(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(Ee==null?void 0:Ee.userId)===t&&(Ee=null)}const Ue="https://sheets.googleapis.com/v4/spreadsheets";class ga{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,r){const a=await this.authHeaders(),n=encodeURIComponent(r),s=await fetch(`${Ue}/${t}/values/${n}`,{headers:a});if(!s.ok){const o=await s.text();throw new Error(`Sheets read failed (${s.status}): ${o}`)}return(await s.json()).values||[]}async writeRange(t,r,a){const n=await this.authHeaders(),s=encodeURIComponent(r),i=await fetch(`${Ue}/${t}/values/${s}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:n,body:JSON.stringify({range:r,majorDimension:"ROWS",values:a})});if(!i.ok){const l=await i.text();throw new Error(`Sheets write failed (${i.status}): ${l}`)}return{updatedCells:(await i.json()).updatedCells||0}}async appendRows(t,r,a){var l;const n=await this.authHeaders(),s=encodeURIComponent(r),i=await fetch(`${Ue}/${t}/values/${s}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:n,body:JSON.stringify({range:r,majorDimension:"ROWS",values:a})});if(!i.ok){const d=await i.text();throw new Error(`Sheets append failed (${i.status}): ${d}`)}return{updatedCells:((l=(await i.json()).updates)==null?void 0:l.updatedCells)||a.length}}async deleteRow(t,r,a){const n=await this.authHeaders(),s=await fetch(`${Ue}/${t}?fields=sheets.properties`,{headers:n});if(!s.ok){const m=await s.text();throw new Error(`Failed to get sheet metadata (${s.status}): ${m}`)}const i=await s.json(),o=i.sheets.find(m=>m.properties.title===r);if(!o){const m=i.sheets.map(h=>h.properties.title).join(", ");throw new Error(`Tab "${r}" not found. Available tabs: ${m}`)}const l=o.properties.sheetId,d=a-1,c=await fetch(`${Ue}/${t}:batchUpdate`,{method:"POST",headers:n,body:JSON.stringify({requests:[{deleteDimension:{range:{sheetId:l,dimension:"ROWS",startIndex:d,endIndex:d+1}}}]})});if(!c.ok){const m=await c.text();throw new Error(`Row delete failed (${c.status}): ${m}`)}}async createSpreadsheet(t,r){const a=await this.authHeaders(),n={properties:{title:t},sheets:r&&r.length>0?r.map(o=>({properties:{title:o}})):[{properties:{title:"Sheet1"}}]},s=await fetch(Ue,{method:"POST",headers:a,body:JSON.stringify(n)});if(!s.ok){const o=await s.text();throw new Error(`Sheets create failed (${s.status}): ${o}`)}const i=await s.json();return{spreadsheetId:i.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${i.spreadsheetId}/edit`}}async getMetadata(t){const r=await this.authHeaders(),a=await fetch(`${Ue}/${t}?fields=properties.title,sheets.properties.title`,{headers:r});if(!a.ok){const s=await a.text();throw new Error(`Sheets metadata failed (${a.status}): ${s}`)}const n=await a.json();return{title:n.properties.title,sheets:n.sheets.map(s=>s.properties.title)}}}const ft="https://www.googleapis.com/calendar/v3";class or{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",r={}){const a=await this.authHeaders(),n=new URLSearchParams;r.timeMin&&n.set("timeMin",r.timeMin),r.timeMax&&n.set("timeMax",r.timeMax),n.set("maxResults",String(r.maxResults||20)),n.set("singleEvents","true"),n.set("orderBy","startTime"),r.query&&n.set("q",r.query);const s=await fetch(`${ft}/calendars/${encodeURIComponent(t)}/events?${n}`,{headers:a});if(!s.ok){const o=await s.text();throw new Error(`Calendar list failed (${s.status}): ${o}`)}return(await s.json()).items||[]}async createEvent(t="primary",r){var o;const a=await this.authHeaders(),n=r.timeZone||"Asia/Kolkata",s={summary:r.summary,description:r.description||"",location:r.location||"",start:{dateTime:r.startDateTime,timeZone:n},end:{dateTime:r.endDateTime,timeZone:n}};(o=r.attendees)!=null&&o.length&&(s.attendees=r.attendees.map(l=>({email:l})));const i=await fetch(`${ft}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:a,body:JSON.stringify(s)});if(!i.ok){const l=await i.text();throw new Error(`Calendar create failed (${i.status}): ${l}`)}return await i.json()}async updateEvent(t="primary",r,a){const n=await this.authHeaders(),s=a.timeZone||"Asia/Kolkata",i={};a.summary&&(i.summary=a.summary),a.description&&(i.description=a.description),a.location&&(i.location=a.location),a.startDateTime&&(i.start={dateTime:a.startDateTime,timeZone:s}),a.endDateTime&&(i.end={dateTime:a.endDateTime,timeZone:s});const o=await fetch(`${ft}/calendars/${encodeURIComponent(t)}/events/${r}`,{method:"PATCH",headers:n,body:JSON.stringify(i)});if(!o.ok){const l=await o.text();throw new Error(`Calendar update failed (${o.status}): ${l}`)}return await o.json()}async deleteEvent(t="primary",r){const a=await this.authHeaders(),n=await fetch(`${ft}/calendars/${encodeURIComponent(t)}/events/${r}`,{method:"DELETE",headers:a});if(!n.ok&&n.status!==410){const s=await n.text();throw new Error(`Calendar delete failed (${n.status}): ${s}`)}}async listCalendars(){const t=await this.authHeaders(),r=await fetch(`${ft}/users/me/calendarList`,{headers:t});if(!r.ok){const n=await r.text();throw new Error(`Calendar list calendars failed (${r.status}): ${n}`)}return((await r.json()).items||[]).map(n=>({id:n.id,summary:n.summary,primary:n.primary||!1}))}}const Te="https://docs.googleapis.com/v1/documents",es="https://www.googleapis.com/drive/v3/files";function br(e){const t=[];for(const r of e.split(`
`)){const a=r.trim();if(a===""||/^---+$/.test(a))continue;let n="NORMAL_TEXT",s=r;const i=a.match(/^###\s+(.+)/),o=!i&&a.match(/^##\s+(.+)/),l=!i&&!o&&a.match(/^#\s+(.+)/);i?(n="HEADING_3",s=i[1]):o?(n="HEADING_2",s=o[1]):l?(n="HEADING_1",s=l[1]):/^\s*[-*]\s/.test(r)&&(s="• "+r.replace(/^\s*[-*]\s+/,""));const{text:d,spans:c}=ts(s);t.push({text:d,namedStyle:n,spans:c})}return t}function ts(e){const t=[];let r="",a=0;for(;a<e.length;)if(e[a]==="*"&&e[a+1]==="*"){const n=e.indexOf("**",a+2);if(n!==-1){const s=r.length;r+=e.substring(a+2,n),t.push({start:s,end:r.length,bold:!0}),a=n+2}else r+=e[a++]}else if(e[a]==="_"&&e[a+1]==="_"){const n=e.indexOf("__",a+2);if(n!==-1){const s=r.length;r+=e.substring(a+2,n),t.push({start:s,end:r.length,bold:!0}),a=n+2}else r+=e[a++]}else if(e[a]==="*"&&e[a+1]!=="*"){const n=e.indexOf("*",a+1);if(n!==-1){const s=r.length;r+=e.substring(a+1,n),t.push({start:s,end:r.length,italic:!0}),a=n+1}else r+=e[a++]}else if(e[a]==="_"){const n=e.indexOf("_",a+1);if(n!==-1){const s=r.length;r+=e.substring(a+1,n),t.push({start:s,end:r.length,italic:!0}),a=n+1}else r+=e[a++]}else r+=e[a++];return{text:r,spans:t}}class fa{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const r=await this.authHeaders(),a=await fetch(Te,{method:"POST",headers:r,body:JSON.stringify({title:t})});if(!a.ok){const s=await a.text();throw new Error(`Docs create failed (${a.status}): ${s}`)}const n=await a.json();return{documentId:n.documentId,url:`https://docs.google.com/document/d/${n.documentId}/edit`}}async readDocument(t){var i,o;const r=await this.authHeaders(),a=await fetch(`${Te}/${t}`,{headers:r});if(!a.ok){const l=await a.text();throw new Error(`Docs read failed (${a.status}): ${l}`)}const n=await a.json();let s="";for(const l of((i=n.body)==null?void 0:i.content)||[])if(l.paragraph)for(const d of l.paragraph.elements)(o=d.textRun)!=null&&o.content&&(s+=d.textRun.content);return{title:n.title,content:s.trim()}}async rewriteDocument(t,r){var y;const a=await this.authHeaders(),n=await fetch(`${Te}/${t}`,{headers:a});if(!n.ok){const b=await n.text();throw new Error(`Docs fetch failed (${n.status}): ${b.substring(0,200)}`)}const i=((y=(await n.json()).body)==null?void 0:y.content)||[],o=i[i.length-1],l=(o==null?void 0:o.endIndex)??2,d=br(r),c=[];if(l>2&&c.push({deleteContentRange:{range:{startIndex:1,endIndex:l-1}}}),d.length===0){c.length>0&&await fetch(`${Te}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:c})});return}let m="";const h=[];for(const b of d){const v=m.length;m+=b.text+`
`,h.push({start:v,end:m.length,namedStyle:b.namedStyle,spans:b.spans})}c.push({insertText:{location:{index:1},text:m}});for(const b of h){b.namedStyle!=="NORMAL_TEXT"&&c.push({updateParagraphStyle:{range:{startIndex:1+b.start,endIndex:1+b.end},paragraphStyle:{namedStyleType:b.namedStyle},fields:"namedStyleType"}});for(const v of b.spans){const x={},E=[];v.bold&&(x.bold=!0,E.push("bold")),v.italic&&(x.italic=!0,E.push("italic")),E.length>0&&c.push({updateTextStyle:{range:{startIndex:1+b.start+v.start,endIndex:1+b.start+v.end},textStyle:x,fields:E.join(",")}})}}const w=await fetch(`${Te}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:c})});if(!w.ok){const b=await w.text();throw new Error(`Docs rewrite failed (${w.status}): ${b.substring(0,200)}`)}}async appendFormattedContent(t,r){var y;const a=await this.authHeaders(),n=br(r);if(n.length===0)return;const s=await fetch(`${Te}/${t}`,{headers:a});if(!s.ok){const b=await s.text();throw new Error(`Docs fetch failed (${s.status}): ${b.substring(0,200)}`)}const o=((y=(await s.json()).body)==null?void 0:y.content)||[],l=o[o.length-1],d=Math.max(1,((l==null?void 0:l.endIndex)??2)-1);let c="";const m=[];for(const b of n){const v=c.length;c+=b.text+`
`,m.push({start:v,end:c.length,namedStyle:b.namedStyle,spans:b.spans})}const h=[{insertText:{location:{index:d},text:c}}];for(const b of m){b.namedStyle!=="NORMAL_TEXT"&&h.push({updateParagraphStyle:{range:{startIndex:d+b.start,endIndex:d+b.end},paragraphStyle:{namedStyleType:b.namedStyle},fields:"namedStyleType"}});for(const v of b.spans){const x={},E=[];v.bold&&(x.bold=!0,E.push("bold")),v.italic&&(x.italic=!0,E.push("italic")),E.length>0&&h.push({updateTextStyle:{range:{startIndex:d+b.start+v.start,endIndex:d+b.start+v.end},textStyle:x,fields:E.join(",")}})}}const w=await fetch(`${Te}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:h})});if(!w.ok){const b=await w.text();throw new Error(`Docs append failed (${w.status}): ${b.substring(0,200)}`)}}async appendText(t,r){const a=await this.authHeaders(),n=await fetch(`${Te}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:[{insertText:{endOfSegmentLocation:{},text:r}}]})});if(!n.ok){const s=await n.text();throw new Error(`Docs append failed (${n.status}): ${s}`)}}async deleteContent(t,r){var i,o,l;const a=await this.authHeaders(),n=await fetch(`${Te}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:[{replaceAllText:{containsText:{text:r,matchCase:!0},replaceText:""}}]})});if(!n.ok){const d=await n.text();throw new Error(`Docs delete content failed (${n.status}): ${d.substring(0,200)}`)}return{occurrencesRemoved:((l=(o=(i=(await n.json()).replies)==null?void 0:i[0])==null?void 0:o.replaceAllText)==null?void 0:l.occurrencesChanged)??0}}async shareDocument(t,r,a="writer"){const n=await this.authHeaders(),s=await fetch(`${es}/${t}/permissions`,{method:"POST",headers:n,body:JSON.stringify({type:"user",role:a,emailAddress:r})});if(!s.ok){const i=await s.text();throw new Error(`Share failed (${s.status}): ${i}`)}}}class ue{constructor(t,r,a,n,s){M(this,"sheets");M(this,"calendar");M(this,"docs");M(this,"db");M(this,"userId");M(this,"pinHash");this.db=t,this.userId=r,this.pinHash=a,this.sheets=new ga(t,r,a,n,s),this.calendar=new or(t,r,a,n,s),this.docs=new fa(t,r,a,n,s)}async isConnected(){return ir(this.db,this.userId,this.pinHash)}}const He=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:or,GoogleDocs:fa,GoogleServices:ue,GoogleSheets:ga,completeOAuthFlow:pa,disconnectGoogle:ha,exchangeCodeForTokens:ca,fetchUserInfo:ua,generateAuthUrl:da,getGoogleAuth:mt,isGoogleConnected:ir,isOAuthClientConfigured:ma},Symbol.toStringTag,{value:"Module"}));async function ya(e,t,r={}){const a={textQuery:t,languageCode:"en",pageSize:8};if(r.type&&(a.includedType=r.type),r.location){const l=r.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(a.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:r.radius||5e3}})}const n=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),s=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":n},body:JSON.stringify(a)});if(!s.ok){const l=await s.text();return{results:[],error:`Places API error (${s.status}): ${l.substring(0,200)}`}}const i=await s.json();return!i.places||i.places.length===0?{results:[]}:{results:i.places.map(l=>{var d,c,m;return{name:((d=l.displayName)==null?void 0:d.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(c=l.currentOpeningHours)==null?void 0:c.openNow,types:(m=l.types)==null?void 0:m.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function va(e,t){var s,i,o;const r=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),a=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":r}});if(!a.ok){const l=await a.text();return{error:`Place Details API error (${a.status}): ${l.substring(0,200)}`}}const n=await a.json();return{details:{name:((s=n.displayName)==null?void 0:s.text)||"",address:n.formattedAddress||"",phone:n.internationalPhoneNumber,website:n.websiteUri,rating:n.rating,reviews:(i=n.reviews)==null?void 0:i.slice(0,3).map(l=>{var d,c,m;return{author:((d=l.authorAttribution)==null?void 0:d.displayName)||"Anonymous",rating:l.rating||0,text:((m=(c=l.text)==null?void 0:c.text)==null?void 0:m.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(o=n.currentOpeningHours)==null?void 0:o.weekdayDescriptions,location:n.location?{lat:n.location.latitude,lng:n.location.longitude}:void 0,googleMapsUri:n.googleMapsUri}}}async function wa(e,t,r,a={}){var d;const n=new URLSearchParams({origin:t,destination:r,key:e,mode:a.mode||"driving"});(a.mode==="driving"||!a.mode)&&n.set("departure_time","now");const s=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${n}`);if(!s.ok)return{error:`Directions API error: ${s.status}`};const i=await s.json();if(i.status!=="OK")return{error:`Directions: ${i.status} — ${i.error_message||""}`};const o=i.routes[0],l=o.legs[0];return{route:{summary:o.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(d=l.duration_in_traffic)==null?void 0:d.text,steps:l.steps.slice(0,10).map(c=>{var m,h,w;return{instruction:((m=c.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((h=c.distance)==null?void 0:h.text)||"",duration:((w=c.duration)==null?void 0:w.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function ba(e,t,r,a){var l,d;const n={q:t,target:r,key:e,format:"text"};a&&(n.source=a);const s=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const c=await s.text();return{translatedText:"",error:`Translate API error (${s.status}): ${c.substring(0,200)}`}}const o=(d=(l=(await s.json()).data)==null?void 0:l.translations)==null?void 0:d[0];return o?{translatedText:o.translatedText,detectedSourceLang:o.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function _a(e,t){const r=new URLSearchParams({address:t,key:e}),a=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${r}`);if(!a.ok)return{results:[],error:`Geocoding API error: ${a.status}`};const n=await a.json();return n.status!=="OK"&&n.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${n.status} — ${n.error_message||""}`}:{results:(n.results||[]).slice(0,5).map(s=>{var i;return{address:s.formatted_address,lat:s.geometry.location.lat,lng:s.geometry.location.lng,placeId:s.place_id,types:(i=s.types)==null?void 0:i.slice(0,3)}})}}async function Ea(e,t,r={}){const a=new URLSearchParams({part:"snippet",q:t,key:e,type:r.type||"video",maxResults:String(r.maxResults||5),order:r.order||"relevance"}),n=await fetch(`https://www.googleapis.com/youtube/v3/search?${a}`);if(!n.ok){const i=await n.text();return{results:[],error:`YouTube API error (${n.status}): ${i.substring(0,200)}`}}return{results:((await n.json()).items||[]).map(i=>{var o,l,d,c,m,h,w,y;return{title:i.snippet.title,channelTitle:i.snippet.channelTitle,description:(o=i.snippet.description)==null?void 0:o.substring(0,200),videoId:((l=i.id)==null?void 0:l.videoId)||((d=i.id)==null?void 0:d.channelId)||((c=i.id)==null?void 0:c.playlistId)||"",publishedAt:i.snippet.publishedAt,url:(m=i.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${i.id.videoId}`:(h=i.id)!=null&&h.channelId?`https://www.youtube.com/channel/${i.id.channelId}`:"",thumbnailUrl:(y=(w=i.snippet.thumbnails)==null?void 0:w.medium)==null?void 0:y.url}})}}async function Ft(e,t={}){const r=Math.min(t.num||5,10),a=t.site?`site:${t.site} ${e}`:e;try{const n=new URLSearchParams({q:a}),s=await fetch(`https://html.duckduckgo.com/html/?${n}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!s.ok)return{results:[],error:`Search request failed (${s.status})`};const i=await s.text(),o=[],l=i.split(/class="result results_links/g).slice(1);for(const d of l){if(o.length>=r)break;const c=d.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=d.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(c){let h=c[1];const w=h.match(/uddg=([^&]+)/);w?h=decodeURIComponent(w[1]):h.startsWith("//")&&(h="https:"+h);const y=x=>x.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),b=y(c[2]),v=m?y(m[1]):"";if(b&&h.startsWith("http")){const x=h.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];o.push({title:b,link:h,snippet:v,displayLink:x})}}}return o.length===0?{results:[],error:void 0}:{results:o}}catch(n){return{results:[],error:`Web search error: ${n.message}`}}}async function Ta(e,t,r,a="driving"){var l,d,c,m;const n=new URLSearchParams({origins:t,destinations:r,key:e,mode:a,departure_time:"now"}),s=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${n}`);if(!s.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${s.status}`};const i=await s.json(),o=(c=(d=(l=i.rows)==null?void 0:l[0])==null?void 0:d.elements)==null?void 0:c[0];return!o||o.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(o==null?void 0:o.status)||i.status}`}:{distance:o.distance.text,duration:o.duration.text,durationInTraffic:(m=o.duration_in_traffic)==null?void 0:m.text}}const rs=Object.freeze(Object.defineProperty({__proto__:null,geocode:_a,getDirections:wa,getDistanceMatrix:Ta,getPlaceDetails:va,searchPlaces:ya,searchYouTube:Ea,translateText:ba,webSearch:Ft},Symbol.toStringTag,{value:"Module"})),xe="https://gmail.googleapis.com/gmail/v1/users/me";class be{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var o;const r=await this.authHeaders(),a=new URLSearchParams;if(a.set("maxResults",String(t.maxResults||10)),t.query&&a.set("q",t.query),(o=t.labelIds)!=null&&o.length)for(const l of t.labelIds)a.append("labelIds",l);const n=await fetch(`${xe}/messages?${a}`,{headers:r});if(!n.ok){const l=await n.text();throw new Error(`Gmail list failed (${n.status}): ${l.substring(0,200)}`)}const s=await n.json();if(!s.messages||s.messages.length===0)return[];const i=[];for(const l of s.messages.slice(0,t.maxResults||10))try{const d=await this.getMessage(l.id,r);d&&i.push(d)}catch{}return i}async getMessage(t,r){const a=r||await this.authHeaders(),n=await fetch(`${xe}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:a});if(!n.ok)return null;const s=await n.json(),i=o=>{var l,d,c;return((c=(d=(l=s.payload)==null?void 0:l.headers)==null?void 0:d.find(m=>m.name.toLowerCase()===o.toLowerCase()))==null?void 0:c.value)||""};return{id:s.id,threadId:s.threadId,snippet:s.snippet||"",subject:i("Subject")||"(no subject)",from:i("From"),to:i("To"),date:i("Date")||new Date(parseInt(s.internalDate)).toISOString(),isUnread:(s.labelIds||[]).includes("UNREAD"),labels:s.labelIds||[]}}async getMessageBody(t){const r=await this.authHeaders(),a=await fetch(`${xe}/messages/${t}?format=full`,{headers:r});if(!a.ok){const s=await a.text();throw new Error(`Gmail message body failed (${a.status}): ${s.substring(0,200)}`)}const n=await a.json();return xa(n.payload)}async search(t,r=10){return this.listMessages({query:t,maxResults:r})}async send(t,r,a,n={}){const s=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${r}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&i.push(`Cc: ${n.cc}`),n.bcc&&i.push(`Bcc: ${n.bcc}`),n.replyToMessageId&&(i.push(`In-Reply-To: ${n.replyToMessageId}`),i.push(`References: ${n.replyToMessageId}`)),i.push("",a);const o=i.join(`\r
`),d={raw:_r(o)};n.threadId&&(d.threadId=n.threadId);const c=await fetch(`${xe}/messages/send`,{method:"POST",headers:s,body:JSON.stringify(d)});if(!c.ok){const m=await c.text();throw new Error(`Gmail send failed (${c.status}): ${m.substring(0,200)}`)}return await c.json()}async createDraft(t,r,a,n={}){const s=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${r}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];n.cc&&i.push(`Cc: ${n.cc}`),i.push("",as(a));const o=i.join(`\r
`),l=_r(o),d=await fetch(`${xe}/drafts`,{method:"POST",headers:s,body:JSON.stringify({message:{raw:l}})});if(!d.ok){const c=await d.text();throw new Error(`Gmail draft failed (${d.status}): ${c.substring(0,200)}`)}return await d.json()}async markAsRead(t){const r=await this.authHeaders();await fetch(`${xe}/messages/${t}/modify`,{method:"POST",headers:r,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,r){const a=await this.authHeaders();let n={};switch(r){case"archive":n={removeLabelIds:["INBOX"]};break;case"trash":n={addLabelIds:["TRASH"]};break;case"read":n={removeLabelIds:["UNREAD"]};break;case"unread":n={addLabelIds:["UNREAD"]};break;case"star":n={addLabelIds:["STARRED"]};break;case"unstar":n={removeLabelIds:["STARRED"]};break}const s=await fetch(`${xe}/messages/${t}/modify`,{method:"POST",headers:{...a,"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const i=await s.text();throw new Error(`Failed to modify message: ${i}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),r=await fetch(`${xe}/labels/INBOX`,{headers:t});return r.ok&&(await r.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),r=await fetch(`${xe}/profile`,{headers:t});if(!r.ok)throw new Error("Failed to get Gmail profile");return await r.json()}}function xa(e){var t,r,a;if(!e)return"";if((t=e.body)!=null&&t.data)return Jt(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((r=n.body)!=null&&r.data))return Jt(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((a=n.body)!=null&&a.data)){const s=Jt(n.body.data);return ns(s)}for(const n of e.parts)if(n.parts){const s=xa(n);if(s)return s}}return e.snippet||""}function as(e){let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return t=t.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),t=t.replace(new RegExp("(?<!\\*)\\*(?!\\*)(.+?)(?<!\\*)\\*(?!\\*)","g"),"<em>$1</em>"),`<html><body style="font-family:Arial,sans-serif;font-size:14px;line-height:1.6;color:#000000;">${t.split(/\n\n+/).map(n=>{const s=n.split(`
`);return s.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${s.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:s.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${s.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${s.join("<br>")}</p>`}).join("")}</body></html>`}function _r(e){const t=new TextEncoder().encode(e);let r="";for(let a=0;a<t.length;a++)r+=String.fromCharCode(t[a]);return btoa(r).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Jt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function ns(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const ss=1e4,is=1e4;async function Sa(e,t){try{const r=new AbortController,a=setTimeout(()=>r.abort(),is),n=await fetch(e,{signal:r.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const i=await n.text();clearTimeout(a);const o=i.length>2e5?i.substring(0,2e5):i,l=os(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||ss)}}catch(r){return{text:"",error:r.name==="AbortError"?"Timeout":r.message}}}function os(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}const ls=1e4;async function ds(e,t){var n,s,i;const r=new AbortController,a=setTimeout(()=>r.abort(),ls);try{const o=await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",signal:r.signal,headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:e}],max_tokens:2e3})});if(clearTimeout(a),!o.ok)return{report:"",sources:[],pagesRead:0,error:`Perplexity error ${o.status}`};const l=await o.json(),d=((i=(s=(n=l==null?void 0:l.choices)==null?void 0:n[0])==null?void 0:s.message)==null?void 0:i.content)||"",m=((l==null?void 0:l.citations)||[]).map(h=>({title:h,url:h,snippet:""}));return{report:d,sources:m,pagesRead:m.length}}catch(o){return clearTimeout(a),{report:"",sources:[],pagesRead:0,error:`Perplexity request failed: ${o.message}`}}}async function ka(e,t,r={}){if(r.perplexityApiKey){const h=await ds(e,r.perplexityApiKey);if(!h.error)return h}const a=r.maxPages||(r.depth==="thorough"?5:3),n=r.maxResults||(r.depth==="thorough"?8:5),s=await Ft(e,{num:n,site:r.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,a).map(async h=>{const w=await Sa(h.link);return{title:h.title,url:h.link,displayLink:h.displayLink,snippet:h.snippet,content:w.text,error:w.error}}),d=(await Promise.all(o)).filter(h=>h.content.length>50);if(d.length===0){const h=s.results.map((y,b)=>`[${b+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`

`);return{report:await Er(e,h,t,"snippets"),sources:s.results.map(y=>({title:y.title,url:y.link})),pagesRead:0}}const c=d.map((h,w)=>`--- SOURCE ${w+1}: ${h.title} (${h.displayLink}) ---
${h.content}
--- END SOURCE ${w+1} ---`).join(`

`);return{report:await Er(e,c,t,"full"),sources:d.map(h=>({title:h.title,url:h.url})),pagesRead:d.length}}async function Er(e,t,r,a){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
${a}
`:"",o=xr(t,fs);return`You are ${n} — a personal AI assistant. Your name is ${n} — always refer to yourself by this name if asked.
...
- **Long content intent check**: When asked to write long-form content (essay, article, report — likely over 200 words) WITHOUT a save destination specified, do NOT start writing. Ask first: "Should I save this as a Google Doc and send you the link, or write it here in chat?" Wait for the response. If Drive/Doc, call \`create_doc\` with full content and return only the link. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**`:""}`}async function Zt(e,t,r){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${r.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:r,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:r}}function Bt(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").trim()}function Ba(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function _t(e,t,r,a,n,s,i,o,l,d,c,m,h,w){const y=Date.now();let b=!0,v="",x="";try{return x=await vs(e,t,r,a,s,i,o,l,d,c,m,h,w),x}catch(E){throw b=!1,v=E.message||"Unknown error",E}finally{const E=Date.now()-y;try{await r.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(a,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(b?x:"").substring(0,500),b?1:0,v||null,E,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}function ja(e){const t=e.length;for(let r=0;r<t-1;r++){const a=e[r];if(a.role!=="user"||typeof a.content!="string")continue;const n=t-1-r,s=n<=2?12e3:n<=4?5e3:2e3;a.content.length>s&&(e[r]={...a,content:a.content.substring(0,s)+`
[...truncated in history to reduce context size]`})}}function ys(e){const t=[];let r=[],a="",n=!1,s=0;const i=e.length;for(;s<i;){const o=e[s];if(n){if(o==='"'){if(e[s+1]==='"'){a+='"',s+=2;continue}n=!1,s++;continue}a+=o,s++;continue}if(o==='"'){n=!0,s++;continue}if(o===","){r.push(a),a="",s++;continue}if(o==="\r"&&e[s+1]===`
`){r.push(a),t.push(r),r=[],a="",s+=2;continue}if(o===`
`||o==="\r"){r.push(a),t.push(r),r=[],a="",s++;continue}a+=o,s++}for((a||r.length)&&(r.push(a),t.push(r));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function vs(e,t,r,a,n,s,i,o,l,d,c,m,h){var y,b,v,x,E,O,C,j,G,F,P,q,z,R,W,L;const w=new Y(r);switch(e){case"create_schedule":{const u=new Date;let f;const p=d||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){f=new Date(u.getTime()+t.minutes_from_now*60*1e3);const D=f.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,$,I]=(D[0]||"").split("/");t.schedule_value=`${I}-${N}-${$} ${D[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);f=new Date(u.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"&&t.action_type==="reminder"){const T=`${t.name||""} ${t.action_description||""}`.toLowerCase();if(/\bevery\b|\bdaily\b|\beach\b|\bmorning\b|\bevening\b|\bnight\b|\bweekday\b|\bweekend\b|\brecurring\b|\brepeat\b/.test(T)){const[N,$]=t.schedule_value.split(":").map(Number),I=u.toLocaleString("en-US",{timeZone:p}),A=new Date(I),B=new Date(A);B.setHours(N,$,0,0),B<=A&&B.setDate(B.getDate()+1);const V=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),X=new Date(B.toLocaleString("en-US",{timeZone:p})),ee=V.getTime()-X.getTime();f=new Date(B.getTime()+ee)}else{const[N,$]=t.schedule_value.split(":").map(Number),I=u.toLocaleString("en-US",{timeZone:p}),A=new Date(I),B=new Date(A);B.setHours(N,$,0,0),B<=A&&B.setDate(B.getDate()+1);const V=pt=>String(pt).padStart(2,"0"),X=B.getFullYear(),ee=V(B.getMonth()+1),te=V(B.getDate());t.schedule_value=`${X}-${ee}-${te} ${V(N)}:${V($)}`,t.schedule_type="once";const ne=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),ce=new Date(B.toLocaleString("en-US",{timeZone:p})),Ce=ne.getTime()-ce.getTime();f=new Date(B.getTime()+Ce)}}else if(t.schedule_type==="daily"){const[T,D]=t.schedule_value.split(":").map(Number),N=u.toLocaleString("en-US",{timeZone:p}),$=new Date(N),I=new Date($);I.setHours(T,D,0,0),I<=$&&I.setDate(I.getDate()+1);const A=new Date(I.toLocaleString("en-US",{timeZone:"UTC"})),B=new Date(I.toLocaleString("en-US",{timeZone:p})),V=A.getTime()-B.getTime();f=new Date(I.getTime()+V)}else if(t.schedule_type==="weekly"){const[T,D]=t.schedule_value.split(" "),[N,$]=(D||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ce=>Ce.toLowerCase()===T.toLowerCase()),B=u.toLocaleString("en-US",{timeZone:p}),V=new Date(B),X=new Date(V);X.setHours(N,$,0,0);let ee=(A-X.getDay()+7)%7;ee===0&&X<=V&&(ee=7),X.setDate(X.getDate()+ee);const te=new Date(X.toLocaleString("en-US",{timeZone:"UTC"})),ne=new Date(X.toLocaleString("en-US",{timeZone:p})),ce=te.getTime()-ne.getTime();f=new Date(X.getTime()+ce)}else if(t.schedule_type==="once"){const[T,D]=t.schedule_value.split(" "),[N,$,I]=T.split("-").map(Number),[A,B]=(D||"00:00").split(":").map(Number),V=u.toLocaleString("en-US",{timeZone:p}),X=new Date(V),ee=new Date(X);ee.setFullYear(N,$-1,I),ee.setHours(A,B,0,0);const te=new Date(ee.toLocaleString("en-US",{timeZone:"UTC"})),ne=new Date(ee.toLocaleString("en-US",{timeZone:p})),ce=te.getTime()-ne.getTime();f=new Date(ee.getTime()+ce);const Ce=new Date(u.getTime()+120*1e3);if(f.getTime()<u.getTime()+60*1e3){const pt=f.toISOString();f=Ce;const ht=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${pt} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${f.toISOString()}.]`;t._pastTimeWarning=ht}}else f=new Date(u.getTime()+3600*1e3);if(t.action_type==="custom"&&t.schedule_type==="once"){const T=`${t.name||""} ${t.action_description||t.description||""}`.toLowerCase();/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i.test(T)||(t.action_type="reminder")}if(await r.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(a,t.name,t.schedule_type,t.schedule_value).first()){const T=f.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${T} (${p}). No duplicate created.`}await r.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(a,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),f.toISOString()).run();const _=t._pastTimeWarning||"",S=f.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${S} (${p}). [UTC: ${f.toISOString()}]${_}. IMPORTANT: Use the exact time "${S}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const f=(await r.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(a).all()).results||[];return f.length===0?"No scheduled tasks found.":f.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,f=u?"active":"paused";return await r.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,f,t.job_id,a).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],f=t.state;if(!u.includes(f))return`Invalid state "${f}". Valid states: ${u.join(", ")}`;const p=f==="completed"||f==="paused"?0:1;return await r.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(f,p,t.job_id,a).run(),`Schedule ${t.job_id} state updated to "${f}".`}case"update_schedule":{const u=t.job_id,f=d||"UTC",p=new Date,g=["updated_at = CURRENT_TIMESTAMP"],_=[];t.name&&(g.push("name = ?"),_.push(t.name)),t.description&&(g.push("description = ?"),_.push(t.description));let S=null,T=t.schedule_type,D=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){S=new Date(p.getTime()+t.minutes_from_now*60*1e3);const I=S.toLocaleString("en-US",{timeZone:f,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[A,B,V]=(I[0]||"").split("/");D=`${V}-${A}-${B} ${I[1]||"00:00"}`,T="once"}else if(T&&D){if(T==="interval")S=new Date(p.getTime()+parseInt(D,10)*60*1e3);else if(T==="daily"){const[$,I]=D.split(":").map(Number),A=new Date(p.toLocaleString("en-US",{timeZone:f})),B=new Date(A);B.setHours($,I,0,0),B<=A&&B.setDate(B.getDate()+1);const V=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(B.toLocaleString("en-US",{timeZone:f})).getTime();S=new Date(B.getTime()+V)}else if(T==="weekly"){const[$,I]=D.split(" "),[A,B]=(I||"00:00").split(":").map(Number),X=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ce=>Ce.toLowerCase()===$.toLowerCase()),ee=new Date(p.toLocaleString("en-US",{timeZone:f})),te=new Date(ee);te.setHours(A,B,0,0);let ne=(X-te.getDay()+7)%7;ne===0&&te<=ee&&(ne=7),te.setDate(te.getDate()+ne);const ce=new Date(te.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(te.toLocaleString("en-US",{timeZone:f})).getTime();S=new Date(te.getTime()+ce)}else if(T==="once"){const[$,I]=D.split(" "),[A,B,V]=$.split("-").map(Number),[X,ee]=(I||"00:00").split(":").map(Number),te=new Date(p.toLocaleString("en-US",{timeZone:f})),ne=new Date(te);ne.setFullYear(A,B-1,V),ne.setHours(X,ee,0,0);const ce=new Date(ne.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(ne.toLocaleString("en-US",{timeZone:f})).getTime();S=new Date(ne.getTime()+ce),S.getTime()<p.getTime()+60*1e3&&(S=new Date(p.getTime()+120*1e3))}}if(T&&(g.push("schedule_type = ?"),_.push(T)),D&&(g.push("schedule_value = ?"),_.push(D)),S&&(g.push("next_run = ?"),_.push(S.toISOString())),g.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";_.push(u,a),await r.prepare(`UPDATE cron_jobs SET ${g.join(", ")} WHERE id = ? AND user_id = ?`).bind(..._).run();const N=S?S.toLocaleString("en-US",{timeZone:f,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${N?` New fire time: ${N} (${f}).`:""} IMPORTANT: Use this exact time "${N}" when confirming to the user.`}case"delete_schedule":return await r.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,a).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,f=t.type==="task"?"preference":t.type,p=u>=7?"working":"long_term";return await w.store(a,f,t.title,t.content,u,p),`Stored in ${p==="working"?"working":"long-term"} memory: [${f}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await w.search(a,t.query);return u.length===0?"No matching memories found.":u.map(f=>`[id:${f.id}] [${f.tier||"long_term"}] [${f.type}] **${f.title}**: ${f.content}`).join(`
`)}case"delete_memory":return await w.remove(t.id,a),`Memory entry ${t.id} deleted.`;case"update_memory":return await w.update(t.id,a,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const u=await r.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(a).first(),f=await r.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(a).first(),p=await r.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(a).first(),g=await r.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(a).first(),_=await r.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(a).first();return`System Status:
...
- Unread errors: ${(_==null?void 0:_.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||""),f=t.spreadsheet_id;let p=t.range;const g=await u.sheets.getMetadata(f),_=g.sheets;p.includes("!")||(p=`${_[0]}!${p}`);let S;try{S=await u.sheets.readRange(f,p)}catch(D){if((y=D.message)!=null&&y.includes("Unable to parse range")||(b=D.message)!=null&&b.includes("400")){const N=p.includes("!")?p.split("!")[1]:p;p=`${_[0]}!${N}`,S=await u.sheets.readRange(f,p)}else throw D}let T=`[Spreadsheet: "${g.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${_.map(D=>`"${D}"`).join(", ")}]
`;return _.length>1&&(T+=`[To read a different tab, call read_sheet again with range like "${_[1]}!A1:Z500"]
`),S.length===0?T+"No data found in the specified range.":T+S.map(D=>D.join("	| ")).join(`
`)}catch(u){return await H(r,a,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const I=new Y(r),A=JSON.stringify(t.values);await I.store(a,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:A.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const p=t.values;let g=t.range;const T=Math.max(...p.map(I=>I.length))+4,D=p.map(I=>{const A=[...I];for(;A.length<T;)A.push("");return A}),N=g.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(N){const I=N[1]||"",A=N[2],B=N[3],V=N[5],ee=A.toUpperCase().charCodeAt(0)-64+T-1,te=ee<=26?String.fromCharCode(64+ee):"Z";g=`${I}${A}${B}:${te}${V}`}const $=await u.sheets.writeRange(t.spreadsheet_id,g,D);try{const I=new Y(r),A=await I.search(a,`Pending sheet write: ${t.spreadsheet_id}`);for(const B of A)B.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await I.remove(B.id,a)}catch{}return`Written ${$.updatedCells} cells to ${g}.`}catch(u){return await H(r,a,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new Y(r).store(a,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const p=await u.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const g=new Y(r),_=await g.search(a,`Pending sheet append: ${t.spreadsheet_id}`);for(const S of _)S.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await g.remove(S.id,a)}catch{}return`Appended ${p.updatedCells} cells to ${t.range}.`}catch(u){return await H(r,a,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected){if(t.title)try{await new Y(r).store(a,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`

The spreadsheet request has been saved to temporary memory. After reconnecting, tell me "create the pending spreadsheet" and I'll complete this automatically.`:"")}const p=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let g="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||"");g=`
Folder: "${(await Zt(_,p.spreadsheetId,t.folder_name)).folderName}"`}catch(_){g=`
(Note: spreadsheet saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new Y(r).store(a,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${g}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(u){return await H(r,a,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||""),f=t.calendar_id||"primary",p=t.days_ahead||7,g=new Date,_=new Date(g.getTime()+p*24*60*60*1e3),S=await u.calendar.listEvents(f,{timeMin:g.toISOString(),timeMax:_.toISOString(),query:t.query});return S.length===0?`No events found in the next ${p} days.`:S.map(T=>{var A;const D=T.start.dateTime||T.start.date||"TBD",N=T.end.dateTime||T.end.date||"",$=T.location?` 📍 ${T.location}`:"",I=((A=T.attendees)==null?void 0:A.map(B=>B.email).join(", "))||"";return`• ${T.summary} — ${D} to ${N}${$}${I?`
  Attendees: ${I}`:""}`}).join(`
`)}catch(u){return await H(r,a,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected){if(t.summary&&t.start_datetime&&t.end_datetime)try{await new Y(r).store(a,"context",`Pending calendar event: "${t.summary}"`,JSON.stringify({tool:"create_calendar_event",summary:t.summary,description:t.description??null,location:t.location??null,start_datetime:t.start_datetime,end_datetime:t.end_datetime,attendees:t.attendees??null,calendar_id:t.calendar_id??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.summary&&t.start_datetime?`

The calendar event has been saved to temporary memory. After reconnecting, tell me "create the pending event" and I'll add it to your calendar.`:"")}const p=t.calendar_id||"primary",g=await u.calendar.createEvent(p,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});try{const _=new Y(r),S=await _.search(a,`Pending calendar event: "${t.summary}"`);for(const T of S)T.title.startsWith(`Pending calendar event: "${t.summary}"`)&&await _.remove(T.id,a)}catch{}return`Event created: "${g.summary}"
ID: ${g.id}
Start: ${g.start.dateTime||g.start.date}`}catch(u){return await H(r,a,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected){if(t.title&&t.content){try{await new Y(r).store(a,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}try{await r.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
               VALUES (?, 'pending_google', ?, ?, 'high', 'agent', ?, ?)`).bind(a,`Pending doc: "${t.title}"`,'Google not connected — reconnect then say "save the pending document".',`pending_doc_${t.title}`,JSON.stringify({tool:"create_doc",title:t.title,folder_name:t.folder_name??null})).run()}catch{}}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" and I'll complete this automatically.`:"")}let p;try{p=await u.docs.createDocument(t.title)}catch(_){return await H(r,a,"google","create_doc",_.message),`Failed to create document: ${_.message}`}if(t.content)try{await u.docs.appendFormattedContent(p.documentId,t.content)}catch(_){return await H(r,a,"google","create_doc_append",_.message),`Document created but content could not be written (${_.message}).
ID: ${p.documentId}
URL: ${p.url}

Use append_to_doc with the document ID above to add content.`}let g="";if(t.folder_name)try{const{token:_}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||"");g=`
Folder: "${(await Zt(_,p.documentId,t.folder_name)).folderName}"`}catch(_){g=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${_.message})`}try{await new Y(r).store(a,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}try{const _=new Y(r),S=await _.search(a,`Pending Google Doc save: "${t.title}"`);for(const T of S)T.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await _.remove(T.id,a)}catch{}return`Document created: "${t.title}"${g}
ID: ${p.documentId}
URL: ${p.url}`}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const f=await new ue(r,a,n,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${f.title}"

${f.content}`}catch(u){return await H(r,a,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected){if(t.document_id&&t.content)try{await new Y(r).store(a,"context",`Pending append to doc: "${t.document_id}"`,JSON.stringify({tool:"append_to_doc",document_id:t.document_id,content:t.content}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.'+(t.document_id&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" to complete this.`:"")}await u.docs.appendFormattedContent(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}try{const g=new Y(r),_=await g.search(a,`Pending append to doc: "${t.document_id}"`);for(const S of _)S.title.startsWith(`Pending append to doc: "${t.document_id}"`)&&await g.remove(S.id,a)}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await H(r,a,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"rewrite_doc":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";await u.docs.rewriteDocument(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}return`Document "${p}" reformatted successfully.
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await H(r,a,"google","rewrite_doc",u.message),`Failed to rewrite document: ${u.message}`}}case"delete_sheet_row":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";const p=t.row_number;return p<2?"Row 1 is the header row and cannot be deleted. Specify row 2 or higher.":(await u.sheets.deleteRow(t.spreadsheet_id,t.sheet_name,p),`Row ${p} deleted from "${t.sheet_name}". All rows below have shifted up.`)}catch(u){return await H(r,a,"google","delete_sheet_row",u.message),`Failed to delete row: ${u.message}`}}case"delete_doc_content":{if(!n)return"Authentication context unavailable.";try{const u=new ue(r,a,n,s||"",i||"");if(!(await u.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";const p=await u.docs.deleteContent(t.document_id,t.text_to_remove);return p.occurrencesRemoved===0?"No matching text found in the document. The text must match exactly — check spacing, punctuation, and line breaks.":`Removed ${p.occurrencesRemoved} occurrence${p.occurrencesRemoved===1?"":"s"} from the document.`}catch(u){return await H(r,a,"google","delete_doc_content",u.message),`Failed to delete document content: ${u.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const f=await new be(r,a,n,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return f.length===0?"No messages found.":f.map((p,g)=>`${p.isUnread?"● ":"  "}${g+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await H(r,a,"gmail","list",u.message),(v=u.message)!=null&&v.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const u=new be(r,a,n,s||"",i||""),f=await u.getMessage(t.message_id);if(!f)return"Message not found.";const p=await u.getMessageBody(t.message_id);return`**${f.subject}**
From: ${f.from}
To: ${f.to}
Date: ${f.date}

${p}`}catch(u){return await H(r,a,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const f=await new be(r,a,n,s||"",i||"").search(t.query,t.max_results||10);return f.length===0?`No results for: ${t.query}`:f.map((p,g)=>`${p.isUnread?"● ":"  "}${g+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await H(r,a,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const u=new be(r,a,n,s||"",i||"");if(!(await new ue(r,a,n,s||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body){try{await new Y(r).store(a,"context",`Pending email: "${t.subject}"`,JSON.stringify({tool:"gmail_send",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}try{await r.prepare(`INSERT OR IGNORE INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload)
                 VALUES (?, 'pending_google', ?, ?, 'high', 'agent', ?, ?)`).bind(a,`Pending email: "${t.subject}"`,`To: ${t.to} — reconnect Google then say "send the pending email".`,`pending_email_${t.subject}`,JSON.stringify({tool:"gmail_send",to:t.to,subject:t.subject})).run()}catch{}}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const g=await u.send(t.to,t.subject,t.body,{cc:t.cc});try{const _=new Y(r),S=await _.search(a,`Pending email: "${t.subject}"`);for(const T of S)T.title.startsWith(`Pending email: "${t.subject}"`)&&await _.remove(T.id,a)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${g.id}]`}catch(u){return await H(r,a,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const u=new be(r,a,n,s||"",i||"");if(!(await new ue(r,a,n,s||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new Y(r).store(a,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const g=await u.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const S=new Y(r),T=await S.search(a,`Pending draft: "${t.subject}"`);for(const D of T)D.title.startsWith(`Pending draft: "${t.subject}"`)&&await S.remove(D.id,a)}catch{}const _=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${_}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${g.id}]`}catch(u){return await H(r,a,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new be(r,a,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await H(r,a,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const f=await new be(r,a,n,s||"",i||"").getUnreadCount();return`You have ${f} unread email${f!==1?"s":""} in Gmail.`}catch(u){return(x=u.message)!=null&&x.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||""),f=new URLSearchParams;f.set("pageSize",String(t.max_results||10)),f.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),f.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",f.set("q",p);const g=await fetch(`https://www.googleapis.com/drive/v3/files?${f}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const _=await g.json();return(E=_.files)!=null&&E.length?_.files.map((S,T)=>{var I,A;const D=((I=S.mimeType)==null?void 0:I.split(".").pop())||S.mimeType,N=S.size?`${(parseInt(S.size)/1024).toFixed(1)} KB`:"",$=((A=S.modifiedTime)==null?void 0:A.split("T")[0])||"";return`${T+1}. **${S.name}** (${D})
   ${N} · Modified: ${$}
   ${S.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await H(r,a,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||""),f=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",f),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const g=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const _=await g.json();return(O=_.files)!=null&&O.length?_.files.map((S,T)=>{var $,I;const D=(($=S.mimeType)==null?void 0:$.split(".").pop())||S.mimeType,N=((I=S.modifiedTime)==null?void 0:I.split("T")[0])||"";return`${T+1}. **${S.name}** (${D}) — Modified: ${N}
   ${S.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await H(r,a,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"drive_read_file":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||""),f=t.url_or_id.trim();let p=f;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const V of g){const X=f.match(V);if(X){p=X[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${u}`}});if(!_.ok)throw new Error(`Drive API error (${_.status}): could not fetch file metadata`);const S=await _.json(),{name:T,mimeType:D}=S,N=t.extract_focus,$=N?`Focus specifically on extracting: ${N}`:"Extract and return all readable text content. Preserve structure where relevant.",I={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(I[D]){const V=I[D],X=await fetch(`https://www.googleapis.com/drive/v3/files/${p}/export?mimeType=${encodeURIComponent(V)}`,{headers:{Authorization:`Bearer ${u}`}});if(!X.ok)throw new Error(`Drive export error (${X.status})`);const ee=await X.text();if(D==="application/vnd.google-apps.spreadsheet"){const te=ys(ee),ne=te.length,ce=((C=te[0])==null?void 0:C.length)??0;return`**${T}** (Google Sheet — ${ne} rows × ${ce} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(te)}`}return`**${T}**

${ee.substring(0,2e4)}`}if(D==="application/pdf"||T.toLowerCase().endsWith(".pdf")){const V=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!V.ok)throw new Error(`Drive download error (${V.status})`);const X=await V.arrayBuffer(),ee=Buffer.from(X).toString("base64");let te=null,ne="claude-haiku-4-5-20251001";for(const ht of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const mr=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,ht).first();if(mr&&n){const en=await J(mr.encrypted_value,n),It=JSON.parse(en);if(It.provider==="anthropic"){te=It.apiKey,It.model&&(ne=It.model);break}}}catch{}if(!te)return`"${T}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const ce=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":te,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:ne,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ee}},{type:"text",text:$}]}]})});if(!ce.ok){const ht=await ce.text();throw new Error(`Anthropic PDF extraction error: ${ht.substring(0,200)}`)}const pt=((G=(j=(await ce.json()).content)==null?void 0:j[0])==null?void 0:G.text)||"";return`**${T}** (PDF from Drive)

${pt}`}const A=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!A.ok)throw new Error(`Drive download error (${A.status})`);const B=await A.text();return`**${T}** (${D})

${B.substring(0,2e4)}`}catch(u){return await H(r,a,"google","drive_read_file",u.message),`Drive read error: ${u.message}`}}case"drive_delete_file":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||""),f=t.url_or_id.trim();let p=f;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const D of g){const N=f.match(D);if(N){p=N[1];break}}const _=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=name`,{headers:{Authorization:`Bearer ${u}`}});if(!_.ok)throw new Error(`Drive API error (${_.status})`);const S=await _.json(),T=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${u}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!T.ok)throw new Error(`Drive API error (${T.status})`);return`"${S.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(u){return await H(r,a,"google","drive_delete_file",u.message),`Drive delete error: ${u.message}`}}case"drive_organise":{if(!n)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:u}=await(await Promise.resolve().then(()=>He)).getGoogleAuth(r,a,n,s||"",i||""),f=t.url_or_id.trim();let p=f;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const S of g){const T=f.match(S);if(T){p=T[1];break}}const _=[];if(t.new_name){const S=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${u}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!S.ok)throw new Error(`Drive rename error (${S.status})`);_.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:S}=await Zt(u,p,t.folder_name);_.push(`Moved to folder "${S}"`)}return _.join(". ")+"."}catch(u){return await H(r,a,"google","drive_organise",u.message),`Drive organise error: ${u.message}`}}case"web_search":try{const u=await Ft(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((f,p)=>`${p+1}. [${f.title}](${f.link})
   ${f.snippet}`).join(`

`)}catch(u){return await H(r,a,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const f=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>cs),g=await p(u,f);return g.error?`Failed to read page: ${g.error}`:!g.text||g.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${g.text.length} chars):

${g.text}`}catch(u){return await H(r,a,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!c)return"Research tool requires an LLM provider but none is available.";try{let u;try{const T=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"perplexity_api_key").first();T&&n&&(u=await J(T.encrypted_value,n))}catch{}const f=2e4,p=ka(t.query,c,{depth:t.depth||"quick",site:t.site,perplexityApiKey:u}),g=new Promise(T=>setTimeout(()=>T(null),f)),_=await Promise.race([p,g]);if(_===null){const{webSearch:T}=await Promise.resolve().then(()=>rs),D=await T(t.query,{num:5});if(D.error||D.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let N=`Research took too long, but here are the top search results:

`;return N+=D.results.map(($,I)=>`${I+1}. [${$.title}](${$.link})
   ${$.snippet}`).join(`

`),N}if(_.error)return`Research failed: ${_.error}`;let S=_.report;_.sources.length>0&&(S+=`

---
**Sources** (`+_.pagesRead+` pages read):
`,S+=_.sources.map((T,D)=>`[${D+1}] [${T.title}](${T.url})`).join(`
`));try{const T=new Y(r),D=_.report.substring(0,600);await T.store(a,"context",`Research: ${t.query.substring(0,80)}`,D,6,"long_term")}catch{}return S}catch(u){return await H(r,a,"research","research",u.message),`Research error: ${u.message}`}}case"browser_task":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const f=(await J(u.encrypted_value,n)).trim();let p,g=t.task,_,S;if(t.site_name)try{const I=await r.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(a,t.site_name).first();if(I){const A=JSON.parse(await J(I.encrypted_blob,n));p={username:A.username,password:A.password},S=A.sessionId,_=I.id,g=`${g}

When prompted to log in, use username {username} and password {password}.`}}catch{}const T=await Ra(g,f,{secrets:p,sessionId:S}),D=async I=>{if(_)try{const A=await r.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(_,a).first();if(!A)return;const B=JSON.parse(await J(A.encrypted_blob,n));B.sessionId=I;const V=await ut(JSON.stringify(B),n);await r.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(V,_,a).run()}catch{}},N=async()=>{if(!(!_||!S))try{const I=await r.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(_,a).first();if(!I)return;const A=JSON.parse(await J(I.encrypted_blob,n));delete A.sessionId;const B=await ut(JSON.stringify(A),n);await r.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(B,_,a).run()}catch{}};if(T.status==="completed")return T.sessionId&&await D(T.sessionId),T.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again.";if(T.status==="timeout"){T.sessionId&&await D(T.sessionId);try{await new Y(r).store(a,"context",`Browser task in progress: ${T.taskId}`,JSON.stringify({task_id:T.taskId,task:t.task}),9,"working")}catch{}return`[BROWSER_TIMEOUT:${T.taskId}] Browser task did not finish within the time limit. Tell the user it is still running and ask them to follow up in 2–3 minutes.`}await N();const $=[T.error,T.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${T.taskId}\`): ${$||"No details returned. Check your Browser Use dashboard at cloud.browser-use.com."}`}catch(u){return await H(r,a,"browser","browser_task",u.message),`Browser task error: ${u.message}`}}case"browser_task_status":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured.";const f=await J(u.encrypted_value,n),p=await ms(t.task_id,f);if(p.done){try{const g=new Y(r),_=await g.search(a,`Browser task in progress: ${t.task_id}`);for(const S of _)await g.remove(S.id,a)}catch{}return p.status==="finished"||p.status==="completed"?p.output?p.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${p.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${p.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working. Ask me 'what happened with the browser task?' in 2–3 minutes."`}catch(u){return await H(r,a,"browser","browser_task_status",u.message),`Browser status check error: ${u.message}`}}case"vault_lookup":try{const u=(t.site_name||"").trim();if(!u)return"No site name provided.";const p=((await r.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(a,`%${u}%`).all()).results||[]).map(g=>g.name);return p.length===0?`No vault entries found matching "${u}".`:`Vault entries matching "${u}": ${p.join(", ")}. Use site_name="${p[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const f=await J(u.encrypted_value,n),p=await ya(f,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((g,_)=>{const S=g.rating?` ★${g.rating} (${g.userRatingsTotal||0} reviews)`:"",T=g.openNow!==void 0?g.openNow?" · Open now":" · Closed":"",D=g.googleMapsUri?`
   ${g.googleMapsUri}`:"";return`${_+1}. **${g.name}**${S}${T}
   ${g.address}${D}
   [place_id: ${g.placeId}]`}).join(`

`)}catch(u){return await H(r,a,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const f=await J(u.encrypted_value,n),p=await va(f,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const g=p.details;let _=`**${g.name}**
📍 ${g.address}`;if(g.phone&&(_+=`
📞 ${g.phone}`),g.website&&(_+=`
🌐 ${g.website}`),g.rating&&(_+=`
★ ${g.rating}`),g.googleMapsUri&&(_+=`
📌 ${g.googleMapsUri}`),g.openingHours&&(_+=`

Opening Hours:
${g.openingHours.join(`
`)}`),g.reviews&&g.reviews.length>0){_+=`

Recent Reviews:`;for(const S of g.reviews)_+=`
— ${S.author} (★${S.rating}, ${S.time}): "${S.text}"`}return _}catch(u){return await H(r,a,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const f=await J(u.encrypted_value,n),p=await wa(f,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const g=p.route;let _=`**${g.startAddress}** → **${g.endAddress}**
`;return _+=`📏 ${g.distance} · ⏱️ ${g.duration}`,g.durationInTraffic&&(_+=` (with traffic: ${g.durationInTraffic})`),_+=`
via ${g.summary}`,_+=`

Steps:`,g.steps.forEach((S,T)=>{_+=`
${T+1}. ${S.instruction} (${S.distance}, ${S.duration})`}),_}catch(u){return await H(r,a,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const f=await J(u.encrypted_value,n),p=await Ta(f,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let g=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(g+=` (with traffic: ${p.durationInTraffic})`),g}catch(u){return await H(r,a,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const f=await J(u.encrypted_value,n),p=await ba(f,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await H(r,a,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const f=await J(u.encrypted_value,n),p=await Ea(f,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((g,_)=>{var S;return`${_+1}. **${g.title}**
   ${g.channelTitle} · ${((S=g.publishedAt)==null?void 0:S.split("T")[0])||""}
   ${g.description}
   ${g.url}`}).join(`

`)}catch(u){return await H(r,a,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const u=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!u)return"Google API Key not configured.";const f=await J(u.encrypted_value,n),p=await _a(f,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((g,_)=>`${_+1}. ${g.address}
   Coordinates: ${g.lat}, ${g.lng}`).join(`
`)}catch(u){return await H(r,a,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}case"parse_document":{const u=t.file_id,f=t.extract_focus;if(!u)return"file_id is required to parse a document.";const p=await r.prepare("SELECT file_name, file_type, file_data, file_size, extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(u,a).first();if(!p)return"File not found. The file may have expired or the file_id is incorrect.";if(p.extracted_text)return`Document: ${p.file_name}

${p.extracted_text}`;const{file_name:g,file_type:_}=p;let{file_data:S}=p;if(S==="r2"){if(!m)return`File "${g}" is stored in R2 but no storage bucket is configured.`;const T=await m.get(u);if(!T)return`File "${g}" not found in storage. It may have been deleted.`;const D=await T.arrayBuffer();S=Buffer.from(D).toString("base64")}if(_.startsWith("text/"))try{const T=Buffer.from(S,"base64").toString("utf-8");return`Document: ${g}

${T.substring(0,2e4)}`}catch{return`Could not decode text file: ${g}`}if(_==="application/pdf"||_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||g.toLowerCase().endsWith(".pdf")||g.toLowerCase().endsWith(".docx")){if(_==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||g.toLowerCase().endsWith(".docx")){try{const N=await Oa(Buffer.from(S,"base64"));if(N.length>50)return`Document: ${g}

${N.substring(0,2e4)}`}catch{}return`Could not extract text from "${g}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let T=null,D="claude-haiku-4-5-20251001";for(const N of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const $=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,N).first();if($&&n){const I=await J($.encrypted_value,n),A=JSON.parse(I);if(A.provider==="anthropic"){T=A.apiKey,A.model&&(D=A.model);break}}}catch{}if(T)try{const N=f?`Focus specifically on extracting: ${f}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",$=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":T,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:S}},{type:"text",text:N}]}]})});if($.ok){const A=((P=(F=(await $.json()).content)==null?void 0:F[0])==null?void 0:P.text)||"";return`Document: ${g}

${A}`}else{const I=await $.text();return`Could not parse ${g} via Anthropic API: ${I.substring(0,200)}`}}catch(N){return`Document parsing error for ${g}: ${N.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}try{const T=Buffer.from(S,"base64").toString("utf-8").substring(0,2e3);return`Document: ${g} (${_})

Content preview:
${T}`}catch{return`Cannot read file: ${g} (${_})`}}case"search_library":{const u=t.query,f=Math.min(typeof t.limit=="number"?t.limit:10,20);if(!u)return"query is required for search_library.";if(h!=null&&h.ai&&(h!=null&&h.vectorize))try{const{semanticDocumentSearch:T}=await Promise.resolve().then(()=>Et),D=await T({DB:r,AI:h.ai,VECTORIZE:h.vectorize},a,u,f);if(D.length>0){const N=D.map($=>`[id:${$.document_id}] "${$.filename}" (relevance: ${($.relevance_score*100).toFixed(1)}%)
...
Use read_library_file with the id to get the full document text.`}}catch{}const p=await r.prepare(`
        ...
        LIMIT ?
      `).bind(a,`%${u}%`,`%${u}%`,`%${u}%`,f).all(),g=await r.prepare(`
        ...
        ORDER BY dl.created_at DESC
        LIMIT ?
      `).bind(a,a,`%${u}%`,a,`%${u}%`,`%${u}%`,`%${u}%`,f).all(),_=[...p.results||[],...g.results||[]].slice(0,f);if(_.length===0)return`No documents found matching "${u}" in your library.`;const S=_.map(T=>{const D=(T.summary||T.dl_extracted||"").substring(0,200);return`[id:${T.id}] "${T.name}" (source: ${T.source}, status: ${T.status})
  Preview: ${D||"(no preview yet — summarize or ask Karna to read it)"}`}).join(`

`);return`Found ${_.length} document(s) matching "${u}":
...
Use read_library_file with the id to get full text.`}case"read_library_file":{const u=String(t.id_or_name||"").trim();if(!u)return"id_or_name is required for read_library_file.";const f=parseInt(u,10);let p=null;if(isNaN(f)||(p=await r.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           FROM document_library dl WHERE dl.id = ? AND dl.user_id = ?`).bind(f,a).first()),p||(p=await r.prepare(`SELECT dl.id, dl.name, dl.extracted_text, dl.summary, dl.file_id
           FROM document_library dl WHERE dl.user_id = ? AND dl.name LIKE ? LIMIT 1`).bind(a,`%${u}%`).first()),!p)return`Document "${u}" not found. Use search_library to find available documents.`;let g=p.extracted_text||null;if(!g&&p.file_id){const _=await r.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(p.file_id,a).first();g=(_==null?void 0:_.extracted_text)||null}return g||(g=p.summary||null),g?`Document: ${p.name}

${g.substring(0,2e4)}`:`Document "${p.name}" has no extracted text yet. Ask Karna to parse it with parse_document(file_id="${p.file_id}") to extract the text first.`}case"create_skill":{const u=(q=t.name)==null?void 0:q.trim(),f=(z=t.description)==null?void 0:z.trim(),p=(R=t.instructions)==null?void 0:R.trim();if(!u||!f||!p)return"create_skill requires name, description, and instructions.";let g=u.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");g||(g=`skill_${Date.now()}`);const _=await r.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(a,`${g}%`).all();(W=_.results)!=null&&W.some(N=>N.slug===g)&&(g=`${g}_${(((L=_.results)==null?void 0:L.length)||0)+1}`);const S=JSON.stringify(t.parameters||{}),T=JSON.stringify(t.required_tools||[]),D=JSON.stringify(t.examples||[]);return await r.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(a,u,g,f,p,S,T,D).run(),`Skill created: **${u}** (invoke as: "${g}")

You can now ask me to run "${u}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${u} skill" to execute it.`}case"list_skills":{const f=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",g=(await r.prepare(f).bind(a).all()).results||[];if(g.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const _=g.map(S=>`• **${S.name}** (${S.slug}): ${S.description} [used ${S.usage_count} times${S.enabled?"":" — disabled"}]`).join(`
`);return`Your custom skills (${g.length}):

${_}`}default:{const u=e,f=await r.prepare("SELECT id, name, description, instructions, required_tools FROM user_skills WHERE user_id = ? AND slug = ? AND enabled = 1").bind(a,u).first();if(f){await r.prepare("UPDATE user_skills SET usage_count = usage_count + 1, last_used_at = CURRENT_TIMESTAMP WHERE id = ?").bind(f.id).run();const p=(()=>{try{return JSON.parse(f.required_tools).join(", ")}catch{return""}})(),g=Object.keys(t).length>0?`
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function Pa(e,t,r,a,n){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(r,a,"assistant",s,"{}",n),t.push({id:-1,user_id:r,channel:a,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function Ua(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const r=typeof e[t].content=="string"?e[t].content:"";r.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(r.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function kr(e,t,r,a,n,s,i){var z,R,W,L,u;const o=new Y(t),l=(z=e.metadata)==null?void 0:z.thread_id,d=Date.now(),[c,m]=await Promise.all([o.buildContext(a.id),cr(t,a.id)]),h=await o.getRecentConversations(a.id,30,l);await Pa(o,h,a.id,e.channel,l);const w=$a(a,c,e.channel,m),y=Ma([{role:"system",content:w},...h.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}]);Ua(y);const b=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],v=(c.match(/^- /gm)||[]).length;if(b.some(f=>f.test(e.text))||v<3)try{const f=await o.searchLongTerm(a.id,e.text,5);if(f.length>0){const p=f.map(g=>`- [${g.type}] ${g.title}: ${g.content}`).join(`
...
`)){const h=m.trim().split("|");if(h.length<4)continue;const[w,y,b,v]=h,x=["fact","preference","context","decision","summary","task"].find(O=>O===w.trim().toLowerCase());if(!x||!(y!=null&&y.trim())||!(b!=null&&b.trim()))continue;const E=Math.min(10,Math.max(1,parseInt(v)||5));await a.store(r.id,x,y.trim(),b.trim(),E,"long_term")}}const Dr={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function bs(e){for(const[t,r]of Object.entries(Dr))if(e.toLowerCase().includes(t.toLowerCase()))return r;return Dr.default}function _s(e,t,r,a){const n=bs(a),s=Math.floor(n*.75),i=[];let o=0,l=!1;const d=Vt(e);i.push({role:"system",content:e}),o+=d;const c=Vt(r);o+=c;const m=s-o,h=[];let w=0;for(let y=t.length-1;y>=0;y--){const b=t[y],v=Vt(b.content);if(w+v<=m)h.unshift({role:b.role,content:b.content}),w+=v;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:r}),o+=w,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*Es(e,t,r,a,n,s){var j,G;const i=new Y(t),o=(j=e.metadata)==null?void 0:j.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:r.name}};const[d,c]=await Promise.all([i.buildContext(a.id),cr(t,a.id)]),m=await i.getRecentConversations(a.id,30,o);await Pa(i,m,a.id,e.channel,o);const h=$a(a,d,e.channel,c),w=_s(h,m,e.text,r.name);await i.storeMessage(a.id,e.channel,"user",e.text,"{}",o);const y=await dr(t,a.id),b=10;let v="",x=0;const E=[...w.messages],O=[];Ua(E);for(let F=0;F<b;F++)try{F>0&&(yield{type:"thinking",data:{threadId:o}},ja(E));const P=await r.chat(E,{tools:y});if(P.usage&&(x+=P.usage.promptTokens+P.usage.completionTokens),P.toolCalls&&P.toolCalls.length>0){P.content&&(yield{type:"chunk",data:{text:P.content,threadId:o}});const R=P.content||`[calling: ${P.toolCalls.map(L=>{const u=L.arguments||{},f=Object.entries(u).filter(([p])=>!["content","values","body"].includes(p)).map(([p,g])=>`${p}="${String(g).substring(0,100)}"`).join(", ");return`${L.name}(${f})`}).join(", ")}]`;E.push({role:"assistant",content:R});const W=[];for(const L of P.toolCalls){yield{type:"tool_start",data:{tool:L.name,toolArgs:L.arguments,threadId:o}},O.push(L.name);try{const u=(_,S)=>_t(_,S,t,a.id,{agentType:"full",providerName:r.name,channel:e.channel},a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r,s==null?void 0:s.DOCUMENTS_BUCKET,{ai:s==null?void 0:s.AI,vectorize:s==null?void 0:s.VECTORIZE});let f;if(L.name==="browser_task"||L.name==="browser_task_status"){const S=u(L.name,L.arguments);e:for(;;){const T=await Promise.race([S.then(D=>({done:!0,r:D})),new Promise(D=>setTimeout(()=>D({done:!1}),15e3))]);if(T.done){f=T.r;break e}yield{type:"thinking",data:{threadId:o}}}if(L.name==="browser_task"){const T=f.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(T){yield{type:"thinking",data:{threadId:o}};const D=u("browser_task_status",{task_id:T[1]});e:for(;;){const N=await Promise.race([D.then($=>({done:!0,r:$})),new Promise($=>setTimeout(()=>$({done:!1}),15e3))]);if(N.done){f=N.r;break e}yield{type:"thinking",data:{threadId:o}}}}}}else f=await u(L.name,L.arguments);yield{type:"tool_end",data:{tool:L.name,toolResult:f.substring(0,500)+(f.length>500?"...":""),threadId:o}};const p=["parse_document","drive_read_file","read_library_file"].includes(L.name)?2e4:8e3,g=f.length>p?f.substring(0,p)+`
[...result truncated to prevent token limit — full content was extracted]`:f;W.push(`[Tool Result for ${L.name}]: ${g}`)}catch(u){await H(t,a.id,"tool",L.name,u.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:L.name,toolResult:`Error: ${u.message||"Execution failed"}`,threadId:o}},W.push(`[Tool Error for ${L.name}]: ${u.message||"Execution failed"}`)}}E.push({role:"user",content:W.join(`

`)});continue}v=P.content;const q=Bt(v);await i.storeMessage(a.id,e.channel,"assistant",q,"{}",o);const z=50;for(let R=0;R<q.length;R+=z)yield{type:"chunk",data:{text:q.substring(R,R+z),threadId:o}},R+z<q.length&&await new Promise(L=>setTimeout(L,10));break}catch(P){if(n){const R=P.message||"",W=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),L=R.includes("429"),u=W?1440:L?10:5;await n.recordError(r.name,R,u)}await H(t,a.id,"llm","provider_error",P.message||"Unknown LLM error",{provider:r.name,turn:F});const q=P.message||"An error occurred",z=q.includes("429")||q.toLowerCase().includes("rate limit")||q.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":q;try{await i.storeMessage(a.id,e.channel,"assistant",`⚠️ ${z}`,"{}",o)}catch{}yield{type:"error",data:{error:z,threadId:o}};return}if(v=(v==null?void 0:v.trim())??"",!v)try{E.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),v=(await r.chat(E,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const P=Bt(v);await i.storeMessage(a.id,e.channel,"assistant",P,"{}",o);const q=50;for(let z=0;z<P.length;z+=q)yield{type:"chunk",data:{text:P.substring(z,z+q),threadId:o}},z+q<P.length&&await new Promise(R=>setTimeout(R,10))}catch{v="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(a.id,e.channel,"assistant",v,"{}",o).catch(()=>{}),yield{type:"chunk",data:{text:v,threadId:o}}}if(n&&x>0)try{await n.recordUsage(r.name,x)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(a.id,r.name,"full",x,Date.now()-l,1,e.channel).run()}catch{}const C=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc)\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a Google Document but create_doc was never called. You MUST call create_doc NOW.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const F of C){const P=F.claimPattern.test(v),q=F.requiredTools.some(z=>O.includes(z));if(P&&!q){try{await H(t,a.id,"llm",F.logType,"LLM claimed action without tool call (streaming)",{response:v.substring(0,200)}),E.push({role:"assistant",content:v}),E.push({role:"user",content:F.enforcementMsg});const z=await r.chat(E,{tools:y.filter(R=>F.requiredTools.includes(R.name)),temperature:0});if((G=z.toolCalls)!=null&&G.length){for(const W of z.toolCalls){const L=await _t(W.name,W.arguments,t,a.id,{agentType:"full",providerName:r.name,channel:e.channel},a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r,s==null?void 0:s.DOCUMENTS_BUCKET,{ai:s==null?void 0:s.AI,vectorize:s==null?void 0:s.VECTORIZE});O.push(W.name),E.push({role:"assistant",content:"",toolCalls:z.toolCalls}),E.push({role:"user",content:L})}const R=await r.chat(E,{tools:[]});R.content&&(v=R.content)}else v="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}yield{type:"done",data:{threadId:o,provider:r.name,tokenCount:x}}}async function Rr(e,t,r,a,n,s,i,o){await s.storeMessage(n.id,t.channel,"user",t.text,"{}",o);const l=await _t(e.tool,e.args,r,n.id,{agentType:"direct",channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,a,i==null?void 0:i.DOCUMENTS_BUCKET,{ai:i==null?void 0:i.AI,vectorize:i==null?void 0:i.VECTORIZE}),d=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await s.storeMessage(n.id,t.channel,"assistant",d,"{}",o),l}async function ur(e,t,r,a,n,s){var y;const i=new Y(t),o=(y=e.metadata)==null?void 0:y.thread_id,l=await i.buildContext(a.id),d=lr(e.text,l);if(d.agent==="conversation")return Ha(e,t,r,a,l,n,o);const c=Ca(e.text);if(c)return Rr(c,e,t,r,a,i,s,o);const m=(await i.getRecentConversations(a.id,10,o)).map(b=>b.content).join(`
`),h=Na(e.text,m);if(h)return Rr(h,e,t,r,a,i,s,o);const w=d.confidence>=.85;if(e.channel==="telegram"){const b=await dr(t,a.id);return kr(e,t,r,a,n,s,{maxTurns:10,tools:b,forceToolUseOnFirstTurn:w})}return kr(e,t,r,a,n,s,{forceToolUseOnFirstTurn:w})}async function Ha(e,t,r,a,n,s,i){const o=new Y(t),l=Date.now(),d=Ba(a.timezone),c=await cr(t,a.id),m=c?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${c}

${n}`:n,h=Aa("conversation",a,m,a.timezone,d,e.channel),w=(await o.getRecentConversations(a.id,30,i)).filter(E=>!E.content.startsWith("[Autonomous Scheduled Task]")&&!E.content.startsWith("[Scheduled Reminder]")),y=Ma([{role:"system",content:h},...w.map(E=>({role:E.role,content:E.content})),{role:"user",content:e.text}]);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);let b=0,v="";try{const E=await r.chat(y,{temperature:.8});E.usage&&(b=E.usage.promptTokens+E.usage.completionTokens),v=E.content}catch(E){if(s){const O=E.message||"",C=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),j=O.includes("429"),G=C?1440:j?10:5;await s.recordError(r.name,O,G)}throw await H(t,a.id,"llm","conversation_error",E.message,{provider:r.name}),E}if(s&&b>0)try{await s.recordUsage(r.name,b)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(a.id,r.name,"conversation",b,Date.now()-l,1,e.channel).run()}catch{}const x=Bt(v);return await o.storeMessage(a.id,e.channel,"assistant",x,"{}",i),x}async function*Ts(e,t,r,a,n,s){var c;const i=new Y(t),o=(c=e.metadata)==null?void 0:c.thread_id,l=await i.buildContext(a.id),d=lr(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:r.name}},d.agent!=="conversation"){yield*Es(e,t,r,a,n,s);return}try{const m=await Ha(e,t,r,a,l,n,o),h=50;for(let w=0;w<m.length;w+=h)yield{type:"chunk",data:{text:m.substring(w,w+h),threadId:o}},w+h<m.length&&await new Promise(y=>setTimeout(y,10))}catch(m){yield{type:"error",data:{error:m.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:r.name,tokenCount:0}}}const ae=new ge;async function xs(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}ae.use("/*",xs);ae.get("/threads",async e=>{const t=e.get("user"),r=e.req.query("archived")==="1",a=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
     ...
     LIMIT ?`).bind(t.id,r?1:0,a).all();return e.json({threads:n.results||[]})});ae.post("/threads",async e=>{const t=e.get("user"),{title:r}=await e.req.json(),a=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,r||"New conversation").first();return e.json({thread:a})});ae.put("/threads/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.req.json(),n=[],s=[];return a.title!==void 0&&(n.push("title = ?"),s.push(a.title)),a.is_archived!==void 0&&(n.push("is_archived = ?"),s.push(a.is_archived?1:0)),n.push("updated_at = CURRENT_TIMESTAMP"),s.push(r,t.id),n.length<=1?e.json({error:"Nothing to update"},400):(await e.env.DB.prepare(`UPDATE threads SET ${n.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});ae.delete("/threads/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM conversations WHERE thread_id = ? AND user_id = ?").bind(r,t.id).run(),await e.env.DB.prepare("DELETE FROM threads WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0})});ae.post("/upload",async e=>{const t=e.get("user"),r=!!e.env.DOCUMENTS_BUCKET,a=r?100*1024*1024:700*1024;let n,s,i,o=null,l=null;try{if((e.req.header("Content-Type")||"").includes("multipart/form-data")){const v=(await e.req.formData()).get("file");if(!v)return e.json({error:"No file provided."},400);if(n=v.name,s=v.type||"application/octet-stream",i=v.size,i>a)return e.json({error:`File too large (max ${r?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);o=await v.arrayBuffer()}else{const b=await e.req.json();if(!b.file_name||!b.file_data)return e.json({error:"file_name and file_data are required."},400);if(n=b.file_name,s=b.file_type||"application/octet-stream",l=b.file_data,i=b.file_size||Math.round(l.length*.75),i>a)return e.json({error:`File too large (max ${r?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);if(r){const v=atob(l);o=new ArrayBuffer(v.length);const x=new Uint8Array(o);for(let E=0;E<v.length;E++)x[E]=v.charCodeAt(E)}}const c=crypto.randomUUID();let m;r&&o?(await e.env.DOCUMENTS_BUCKET.put(c,o,{httpMetadata:{contentType:s},customMetadata:{fileName:n,userId:String(t.id)}}),m="r2"):m=l||(o?Buffer.from(o).toString("base64"):""),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(c,t.id,n,s,m,i).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,c,"upload",n,s,i,"uploaded").run();const h=s==="application/pdf"||n.toLowerCase().endsWith(".pdf"),w=s==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||n.toLowerCase().endsWith(".docx");if(w)try{const{extractDocxTextFromBuffer:b}=await Promise.resolve().then(()=>Ia),v=l?Buffer.from(l,"base64"):o?Buffer.from(o):null;if(v){const x=await b(v);if(x.length>50){await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(x,c).run();const E=x.substring(0,600);await e.env.DB.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(E,x.substring(0,5e4),c,t.id).run()}}}catch{}if(h&&t.pin_hash){const b=l||(o?Buffer.from(o).toString("base64"):null),v=t.pin_hash,x=t.id,E=e.env.DB,O=e.env.DOCUMENTS_BUCKET,C=(async()=>{var j,G;try{let F=null,P="claude-haiku-4-5-20251001";const{decrypt:q}=await Promise.resolve().then(()=>Ht);for(const u of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const f=await E.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x,u).first();if(f){const p=await q(f.encrypted_value,v),g=JSON.parse(p);if(g.provider==="anthropic"){F=g.apiKey,g.model&&(P=g.model);break}}}catch{}if(!F)return;let z;if(m==="r2"&&O){const u=await O.get(c);if(!u)return;z=Buffer.from(await u.arrayBuffer()).toString("base64")}else if(b)z=b;else return;const R=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":F,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:P,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:z}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!R.ok)return;const L=((G=(j=(await R.json()).content)==null?void 0:j[0])==null?void 0:G.text)||"";if(L){await E.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(L,c).run();const u=L.substring(0,600);await E.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(u,L.substring(0,5e4),c,x).run()}}catch{}})();try{e.executionCtx.waitUntil(C)}catch{}}let y="";if(s.startsWith("text/"))try{const b=l||(o?Buffer.from(o).toString("base64"):"");y=Buffer.from(b,"base64").toString("utf-8").substring(0,500)}catch{}return e.json({file_id:c,name:n,type:s,size:i,text_preview:y,storage:r?"r2":"d1",extracting:h&&!w})}catch(d){console.error("File upload error:",d);try{const{logError:c}=await Promise.resolve().then(()=>at);await c(e.env.DB,t.id,"upload","upload_error",d.message||"Unknown upload error")}catch{}return e.json({error:`Upload failed: ${d.message||"Unknown error"}`},500)}});ae.post("/send",async e=>{const t=e.get("user"),{message:r,channel:a="web",thread_id:n,files:s}=await e.req.json();if(!r||typeof r!="string"||r.trim().length===0)return e.json({error:"Message is required"},400);let i="";if(s&&Array.isArray(s)&&s.length>0){i=`
...
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=n;if(!o){const d=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,r.trim().substring(0,60)+(r.trim().length>60?"...":"")).first();o=d==null?void 0:d.id}const l={userId:t.id,username:t.username,channel:a,text:r.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:d,rotation:c}=await Ve(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(h){const w=new TextEncoder;try{const y=Ts(l,e.env.DB,d,t,c,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID,DOCUMENTS_BUCKET:e.env.DOCUMENTS_BUCKET});for await(const b of y)b.data.threadId||(b.data.threadId=o),h.enqueue(w.encode(Or(b)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),h.close()}catch(y){const b={type:"error",data:{error:y.message||"An error occurred",threadId:o}};h.enqueue(w.encode(Or(b))),h.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(d){console.error("Stream setup error:",d);const c=d.message||"";return c.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):c.includes("429")||c.includes("limit reached")||c.includes("rate limit")||c.includes("Too Many Requests")?e.json({error:"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.",type:"rate_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:c,thread_id:o},500)}});ae.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),r=parseInt(e.req.param("id")),a=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     ...
     AND (cj.last_run IS NULL OR cj.last_run < datetime('now', '-90 seconds'))`).bind(n).all(),i=[];for(const o of s.results||[])try{await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ? WHERE id = ? AND (last_run IS NULL OR last_run < datetime('now', '-90 seconds'))").bind(n,o.id).run();const l=o.user_timezone||"UTC";let d,c=!1,m=o.state||"active";if(o.schedule_type==="interval"){const y=parseInt(o.schedule_value,10);d=new Date(a.getTime()+y*60*1e3)}else if(o.schedule_type==="daily"){const[y,b]=o.schedule_value.split(":").map(Number),v=Ir(l),x=new Date(v);x.setHours(y,b,0,0),x<=v&&x.setDate(x.getDate()+1);const E=new Date(x.toLocaleString("en-US",{timeZone:"UTC"})),O=new Date(x.toLocaleString("en-US",{timeZone:l})),C=E.getTime()-O.getTime();d=new Date(x.getTime()+C)}else if(o.schedule_type==="weekly"){const[y,b]=o.schedule_value.split(" "),[v,x]=(b||"00:00").split(":").map(Number),O=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(z=>z.toLowerCase()===y.toLowerCase()),C=Ir(l),j=new Date(C);j.setHours(v,x,0,0);let G=(O-j.getDay()+7)%7;G===0&&j<=C&&(G=7),j.setDate(j.getDate()+G);const F=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),P=new Date(j.toLocaleString("en-US",{timeZone:l})),q=F.getTime()-P.getTime();d=new Date(j.getTime()+q)}else o.schedule_type==="once"?(c=!0,m="completed",d=new Date(a.getTime()+365*24*60*60*1e3)):d=new Date(a.getTime()+3600*1e3);await e.env.DB.prepare("UPDATE cron_jobs SET last_run = ?, next_run = ?, enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,d.toISOString(),c?0:o.enabled,m,o.id).run();const w=(JSON.parse(o.action_config||"{}").description||o.description)&&(o.action_type==="check_mail"||o.action_type==="check_calendar"||o.action_type==="check_sheet"||o.action_type==="custom");i.push({job_id:o.id,name:o.name,status:"dispatched",needs_agent:w,next_run:d.toISOString()})}catch(l){i.push({job_id:o.id,name:o.name,status:"error",error:l.message})}try{const{MemoryService:o}=await Promise.resolve().then(()=>Yn),l=await e.env.DB.prepare("SELECT id FROM users").all();for(const d of l.results||[])await new o(e.env.DB).cleanupDoneTasks(d.id)}catch{}return e.json({executed:i.length,results:i,timestamp:n})});Ie.post("/cron/run-task/:jobId",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);const a=parseInt(e.req.param("jobId"),10);if(!a)return e.json({error:"Invalid job ID"},400);const n=await e.env.DB.prepare(`SELECT cj.*, u.id as uid, u.name as user_name, u.username, u.pin_hash,
            u.role as user_role, u.personality_prompt, u.telegram_chat_id,
            u.timezone as user_timezone, u.assistant_name
     FROM cron_jobs cj JOIN users u ON cj.user_id = u.id
     WHERE cj.id = ?`).bind(a).first();if(!n)return e.json({error:"Job not found"},404);const i=JSON.parse(n.action_config||"{}").description||n.description||"",o="⏰ "+(n.name||"Scheduled Task"),l=new Date().toISOString();let d="";const c=n.action_type==="reminder",m=/\b(check|search|look\s*up|read|fetch|find|verify|track|scan|review|query|pull|get)\b/i;if(!c&&n.action_type==="custom"&&m.test(i),c)d=i||n.name||"Time for your scheduled task.";else try{const b={id:n.user_id,username:n.username||"user",name:n.user_name||"User",pin_hash:n.pin_hash||"",role:n.user_role||"",personality_prompt:n.personality_prompt||"",telegram_chat_id:n.telegram_chat_id||"",timezone:n.user_timezone||"UTC",assistant_name:n.assistant_name||"Karna",created_at:"",updated_at:""},v={userId:n.user_id,username:b.username,channel:"cron",text:Ds(n.name,i,n.action_type),sessionId:"cron-"+n.id,timestamp:l},{provider:x,rotation:E}=await Ve(e.env.DB,n.user_id,n.pin_hash);d=await ur(v,e.env.DB,x,b,E,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID})}catch(b){const v=b.message||"unknown error",x=v.includes("rate_limit")||v.includes("429")||v.includes("quota"),E=v.includes("timeout")||v.includes("Timeout");x?d="Couldn’t complete this task right now — API rate limit reached. Will run at next scheduled time.":E?d="Task timed out. Will retry at next scheduled time.":d="Task encountered an error. Will retry at next scheduled time.",await H(e.env.DB,n.user_id,"cron_agent","execution_error",v,{job_id:n.id})}if(["check_mail","check_calendar","check_sheet","custom"].includes(n.action_type))try{const b=await e.env.DB.prepare(`SELECT COUNT(*) as cnt FROM tool_execution_log 
         WHERE user_id = ? AND created_at > datetime('now', '-60 seconds')
         AND tool_name != '__enforcement_trigger'`).bind(n.user_id).first();(!b||b.cnt===0)&&await H(e.env.DB,n.user_id,"cron_verification","no_tools_called",`Cron job "${n.name}" (${n.action_type}) completed without any tool calls`,{job_id:n.id,action_type:n.action_type,response_preview:d.substring(0,200)})}catch{}let w=d||i||"Time for your scheduled task.";w=w.replace(/^\[TOOLS_USED:[^\]]*\]\s*/i,"");const y=o+`
`+w;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(n.user_id,"reminder",o,w,"cron:"+n.id).run(),c&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(n.user_id,"system","assistant",y,JSON.stringify({type:"cron",job_id:n.id})).run(),n.telegram_chat_id&&await ks(e.env.DB,n.user_id,n.telegram_chat_id,y),e.json({job_id:a,status:"completed",response_length:d.length})});async function Fa(e){var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return null;const r=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(r==null?void 0:r.user_id)||null}Ie.get("/health/tools",async e=>{var r;const t=await Fa(e);if(!t)return e.json({error:"Not authenticated"},401);try{const a=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
       ...
       ORDER BY calls DESC`).bind(t).all();return e.json({period:"last_24h",tool_stats:a.results,enforcement:{triggers:n.results,retry_results:((r=s.results)==null?void 0:r[0])||{total_retries:0,successful_retries:0}},cron:{executions:i.results,warnings:o.results},providers:l.results})}catch(a){return e.json({error:a.message||"Failed to fetch metrics"},500)}});Ie.get("/health/tools/recent",async e=>{const t=await Fa(e);if(!t)return e.json({error:"Not authenticated"},401);try{const r=await e.env.DB.prepare(`SELECT id, agent_type, provider_name, tool_name, tool_args, tool_result,
              success, error_message, latency_ms, was_enforcement_retry, channel, created_at
       FROM tool_execution_log
       WHERE user_id = ?
       ORDER BY id DESC LIMIT 50`).bind(t).all();return e.json({logs:r.results})}catch(r){return e.json({error:r.message},500)}});const yt=`
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function Ds(e,t,r){return r==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:r==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check Gmail for new/important emails."}
You MUST call gmail_list or gmail_search immediately.${yt}`:r==="check_calendar"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check calendar for upcoming events."}
You MUST call list_calendar_events immediately.${yt}`:r==="check_sheet"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
You MUST call read_sheet immediately with the relevant spreadsheet.${yt}`:r==="custom"&&t?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${yt}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${yt}`}function Rs(e,t,r,a){return{userId:e,username:t,channel:"telegram",text:r,sessionId:`telegram-${a}`,timestamp:new Date().toISOString()}}function Os(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const Ot=new ge,Is=4e3;async function re(e,t,r,a="Markdown",n,s){var d,c;const i=Ns(r,Is),o=[];let l=!0;for(let m=0;m<i.length;m++){const h=i[m];let w=!1,y="";for(let b=0;b<3;b++)try{const v=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h,parse_mode:a,disable_web_page_preview:!1})});if(v.ok){w=!0;break}const x=await v.json().catch(()=>null);if(y=`HTTP ${v.status}: ${(x==null?void 0:x.description)||"Unknown error"}`,(d=x==null?void 0:x.description)!=null&&d.includes("parse")||(c=x==null?void 0:x.description)!=null&&c.includes("entities")){if((await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h})})).ok){w=!0;break}y+=" (plain-text retry also failed)"}if(v.status===429||v.status>=500){const E=Math.pow(2,b)*1e3;await new Promise(O=>setTimeout(O,E));continue}break}catch(v){if(y=`Network error: ${v.message}`,b<2){const x=Math.pow(2,b)*1e3;await new Promise(E=>setTimeout(E,x));continue}}w||(l=!1,o.push(`Chunk ${m+1}/${i.length}: ${y}`))}if(!l&&n&&s&&o.length>0)try{const{logError:m}=await Promise.resolve().then(()=>at);await m(n,s,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function Cs(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Ns(e,t){if(e.length<=t)return[e];const r=[];let a=e;for(;a.length>0;){if(a.length<=t){r.push(a);break}let n=a.lastIndexOf(`
`,t);n<t*.3&&(n=a.lastIndexOf(" ",t)),n<t*.3&&(n=t),r.push(a.substring(0,n)),a=a.substring(n).trimStart()}return r}async function As(e,t,r,a,n){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(a==null?void 0:a.name)||"there",o=(a==null?void 0:a.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`),d=await re(r,t,l,"Markdown",n,a==null?void 0:a.id);return!d.success&&d.errors.length>0&&console.warn(`[/start] Failed to send message: ${d.errors.join(" | ")}`),!0}case"/help":{const o=`🛠 *${(a==null?void 0:a.assistant_name)||"Karna"} — Commands*
...
Status: ✅ Online`,m=await re(r,t,c,"Markdown",n,a.id);m.success||console.warn(`[/status] Failed to send message: ${m.errors.join(" | ")}`)}catch{const o=await re(r,t,"✅ Online — but had trouble fetching stats.","Markdown",n,a==null?void 0:a.id);o.success||console.warn(`[/status error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/new":{if(!a){const o=await re(r,t,"⚠️ Account not linked.","Markdown",n);return o.success||console.warn(`[/new] Failed to send message: ${o.errors.join(" | ")}`),!0}await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(a.id).run();const i=await re(r,t,"🆕 Starting fresh conversation. Your next message begins a new thread.","Markdown",n,a.id);return i.success||console.warn(`[/new] Failed to send message: ${i.errors.join(" | ")}`),!0}case"/tasks":case"/task":{if(!a){const i=await re(r,t,"⚠️ Account not linked.","Markdown",n);return i.success||console.warn(`[/tasks] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await n.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(a.id).all()).results||[];if(o.length===0){const y=await re(r,t,"✅ No open tasks. You're all clear.","Markdown",n,a.id);return y.success||console.warn(`[/tasks] Failed to send message: ${y.errors.join(" | ")}`),!0}const l=new Date,d=l.toISOString().slice(0,10),c=new Date(l);c.setDate(c.getDate()+1);const m=c.toISOString().slice(0,10),h=[`📋 *Open Tasks (${o.length})*
`];for(const y of o){let b="";if(y.due_date){const v=y.due_date.slice(0,10);v<d?b=" ⚠️ _overdue_":v===d?b=" 🔴 _due today_":v===m?b=" 🟡 _due tomorrow_":b=` _${new Date(y.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}h.push(`☐ ${y.title}${b}`)}h.push(`
_Say "mark [task] as done" to close a task._`);const w=await re(r,t,h.join(`
`),"Markdown",n,a.id);w.success||console.warn(`[/tasks] Failed to send message: ${w.errors.join(" | ")}`)}catch(i){const o=await re(r,t,"❌ Could not fetch tasks: "+i.message,"Markdown",n,a==null?void 0:a.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}Ot.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const r=e.env.DB,a={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},n=async()=>{var s,i,o,l,d;try{if(t.callback_query){await Ls(r,t.callback_query);return}const c=t.message;if(!c)return;const m=!!c.text,h=!!c.voice,w=!!c.document,y=!!c.photo,b=!!c.caption;if(!m&&!h&&!w&&!y)return;const v=String(c.chat.id);let x=c.text||"";const E=await r.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let O=null;if(E){const R=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(E.id,"telegram_bot_token").first();R&&(O=await J(R.encrypted_value,E.pin_hash))}if(!O){const R=await r.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();R&&(O=await J(R.encrypted_value,R.pin_hash))}if(!O||x.startsWith("/")&&await As(x,v,O,E,r))return;if(!E){const R=await re(O,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",r);R.success||console.warn(`Failed to send unlinked account message: ${R.errors.join(" | ")}`);return}if(c.voice&&O&&E)try{const R=await re(O,v,"🎤 Processing voice note...","Markdown",r,E.id);R.success||console.warn(`[voice start] Failed to send message: ${R.errors.join(" | ")}`);const L=await(await fetch(`https://api.telegram.org/bot${O}/getFile?file_id=${c.voice.file_id}`)).json();if(L.ok&&((s=L.result)!=null&&s.file_path)){const f=await(await fetch(`https://api.telegram.org/file/bot${O}/${L.result.file_path}`)).blob();let p="",g="",_="whisper-1";const S=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(E.id).all();for(const I of S.results){const A=await J(I.encrypted_value,E.pin_hash);if(I.service==="openai"){p="https://api.openai.com/v1/audio/transcriptions",g=A;break}else if(I.service.startsWith("llm_slot_"))try{const B=JSON.parse(A);if(B.provider==="openai"){p="https://api.openai.com/v1/audio/transcriptions",g=B.apiKey;break}else if(B.provider==="groq"){p="https://api.groq.com/openai/v1/audio/transcriptions",g=B.apiKey,_="whisper-large-v3";break}}catch{}}if(!p){const I=await re(O,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).","Markdown",r,E.id);I.success||console.warn(`[voice no stt] Failed to send message: ${I.errors.join(" | ")}`);return}const T=new FormData;T.append("file",f,"voice.ogg"),T.append("model",_),T.append("language","en");const D=await fetch(p,{method:"POST",headers:{Authorization:`Bearer ${g}`},body:T});if(!D.ok){const I=await D.text(),A=await re(O,v,`⚠️ Transcription failed: ${D.status} ${I}`,"Markdown",r,E.id);A.success||console.warn(`[voice transcription error] Failed to send message: ${A.errors.join(" | ")}`);return}x=(await D.json()).text;const $=await re(O,v,`🗣️ *You said:* ${x}`,"Markdown",r,E.id);$.success||console.warn(`[voice transcript echo] Failed to send message: ${$.errors.join(" | ")}`)}}catch(R){const W=await re(O,v,`⚠️ Failed to process voice note: ${R.message}`,"Markdown",r,E==null?void 0:E.id);W.success||console.warn(`[voice processing error] Failed to send message: ${W.errors.join(" | ")}`);return}if((w||y)&&O&&E)try{let R,W="unknown",L="unknown",u=0;if(w)R=c.document.file_id,W=c.document.file_name||"document",L=c.document.mime_type||"unknown",u=c.document.file_size||0;else if(y){const f=c.photo[c.photo.length-1];R=f.file_id,W="photo.jpg",L="image/jpeg",u=f.file_size||0}if(R){const p=await(await fetch(`https://api.telegram.org/bot${O}/getFile?file_id=${R}`)).json();let g="";if(p.ok&&((i=p.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(W)||/^text\/|application\/json|application\/xml|application\/csv/i.test(L))&&u<5e4)try{g=await(await fetch(`https://api.telegram.org/file/bot${O}/${p.result.file_path}`)).text()}catch{}const _=c.caption||"",S=`[Telegram file received: "${W}" (${L}, ${Math.round(u/1024)}KB)]`;g?x=`${_?_+`
...
`:""}${S}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(R){if(b&&c.caption)x=c.caption;else{const W=await re(O,v,`⚠️ Received your file but couldn't process it: ${R.message}`,"Markdown",r,E==null?void 0:E.id);W.success||console.warn(`[file processing error] Failed to send message: ${W.errors.join(" | ")}`);return}}if(!x)return;Cs(O,v).catch(()=>{});let C=await r.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(E.id).first();C?await r.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(C.id).run():C={id:(await r.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(E.id).run()).meta.last_row_id};const j=Rs(E.id,E.username,x,v);j.metadata={thread_id:C.id};let G,F;try{const R=await Ve(r,E.id,E.pin_hash);G=R.provider,F=R.rotation}catch(R){console.error("Telegram provider setup error:",R);const W=(o=R.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=R.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${R.message||"Unknown error"}`,L=await re(O,v,W,"Markdown",r,E.id);L.success||console.warn(`[provider error] Failed to send message: ${L.errors.join(" | ")}`);return}const{classifyIntentFast:P}=await Promise.resolve().then(()=>hs);if(P(x).agent==="multi"){const R=await re(O,v,"🔍 On it…","Markdown",r,E.id);R.success||console.warn(`[ack] Failed to send: ${R.errors.join(" | ")}`)}const q=9e4;let z=!1;try{const R=await Promise.race([ur(j,r,G,E,F,a),new Promise((u,f)=>setTimeout(()=>f(new Error("TELEGRAM_TIMEOUT")),q))]),W=Os(R,"telegram"),L=await re(O,v,W||"(empty response)","Markdown",r,E.id);if(await r.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(C.id).run().catch(()=>{}),z=L.success,!L.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${E.id}:`,L.errors);try{const{logError:u}=await Promise.resolve().then(()=>at);await u(r,E.id,"telegram","response_send_failed",`Failed to deliver response: ${L.errors.join(" | ")}`)}catch{}}}catch(R){console.error("Telegram agent error:",R);const W=R.message==="TELEGRAM_TIMEOUT",L=W?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(d=R.message)!=null&&d.includes("API error")?`⚠️ AI provider returned an error. The provider (${G.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(R.message||"Unknown").substring(0,200)}`,u=await re(O,v,L,"Markdown",r,E.id);z=u.success,u.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${E.id}:`,u.errors);try{const{logError:f}=await Promise.resolve().then(()=>at);await f(r,E.id,"telegram",W?"timeout":"agent_error",R.message||"Agent error",{provider:G.name})}catch{}}}catch(c){console.error("Telegram webhook error:",c);try{const{logError:m}=await Promise.resolve().then(()=>at);await m(r,null,"telegram","webhook_error",c.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(n()),e.json({ok:!0})});Ot.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const{webhook_url:a}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await J(n.encrypted_value,r.pin_hash);if(!a){const c=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(c)}const o=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:a,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});Ot.get("/webhook-status",async e=>{var s,i,o,l,d,c;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({configured:!1,error:"Bot token not set"});const n=await J(a.encrypted_value,r.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((d=h.result)==null?void 0:d.last_error_message)||"",last_error_date:((c=h.result)==null?void 0:c.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Ot.post("/detect-chat-id",async e=>{var s,i;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({error:"Bot token not configured"},400);const n=await J(a.encrypted_value,r.pin_hash);try{const d=((i=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(v=>setTimeout(v,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const h=m.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const w=[],y=new Set;for(let v=h.length-1;v>=0;v--){const x=h[v].message;if(x&&x.chat){const E=String(x.chat.id);y.has(E)||(y.add(E),w.push({chat_id:E,name:[x.chat.first_name,x.chat.last_name].filter(Boolean).join(" ")||x.chat.title||"Unknown",username:x.chat.username||"",date:new Date((x.date||0)*1e3).toISOString()}))}}if(w.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const b=w[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(b,r.user_id).run(),e.json({found:!0,chat_id:b,name:w[0].name,all_chats:w,message:`Chat ID ${b} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function Ls(e,t){var b;const{id:r,data:a,message:n,from:s}=t;if(!a||!n)return;const i=a.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const d=String(n.chat.id),c=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!c)return;const m=await e.prepare(`
  ...
  `).bind(h,h,m.id).run();const w=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(c.id).first();if(!w)return;const y=await J(w.encrypted_value,w.pin_hash);try{const v=await fetch(`https://api.telegram.org/bot${y}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:r,text:h?"✅ Checked!":"☐ Unchecked"})});v.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${v.status}`)}catch(v){console.warn(`[callback answer] Error answering callback: ${v.message}`)}if((b=n.reply_markup)!=null&&b.inline_keyboard){const v=n.reply_markup.inline_keyboard.map(x=>x.map(E=>{var O;if((O=E.callback_data)!=null&&O.includes(o)){const C=h?"✅":"☐",j=E.text.replace(/^[☐✅]\s*/,"");return{...E,text:`${C} ${j}`}}return E}));try{await fetch(`https://api.telegram.org/bot${y}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:v}})})}catch{}}}function Ms(e){const t=new Date,r=new Date(t.toLocaleString("en-US",{timeZone:e})),a=new Date(r);a.setDate(a.getDate()+1),a.setHours(0,0,0,0);const n=new Date(a);n.setHours(23,59,59,999);const s=a.toISOString().split("T")[0];return{start:a.toISOString(),end:n.toISOString(),dateStr:s}}async function $s(e,t,r,a,n,s){try{return(await new or(e,t,r,a,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(c=>c.displayName||c.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Bs(e,t,r,a,n){try{const s=new be(e,t,r,a,n),i=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of i){const h=m.from.split("<")[0].trim()||m.from;l[h]=(l[h]||0)+1}const d=Object.entries(l).sort(([,m],[,h])=>h-m).slice(0,5).map(([m])=>m),c=i.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:d,hasUrgent:c}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function js(e,t){try{const r=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),a=new Date,n=new Date(a);n.setDate(n.getDate()+1),n.setHours(23,59,59,999);const s=r.results||[],i=s.map(l=>{if(l.due_date){const d=new Date(l.due_date),c=d<=a?"overdue":d<=n?"due today":d.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${l.title} [${c}]`}return l.title}),o=s.filter(l=>l.due_date?new Date(l.due_date)<=n:!1).length;return{pending:s.length,dueToday:o,items:i}}catch(r){return console.error("Tasks fetch error:",r.message),{pending:0,dueToday:0,items:[]}}}async function Ps(e,t){try{const r=Math.floor((Date.now()-1728e5)/1e3),a=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${r},points>10`,n=await fetch(a,{headers:{"User-Agent":"Karna/1.0"}});return n.ok?((await n.json()).hits||[]).filter(i=>i.url&&!t.has(i.url)).slice(0,2).map(i=>({title:i.title,summary:`${i.points} pts · ${i.num_comments} comments on HN`,url:i.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const Cr=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function Us(e,t,r){const a=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],n=new Set;if(t&&r)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(r).all()).results||[]).forEach(d=>n.add(d.url))}catch{}const s=[];if(a.some(l=>Cr.some(d=>l.toLowerCase().includes(d.toLowerCase())))){const l=a.find(c=>Cr.some(m=>c.toLowerCase().includes(m.toLowerCase())))||"AI agents",d=await Ps(l,n);for(const c of d)s.push(c),n.add(c.url)}for(const l of a){if(s.length>=8)break;const d=`latest ${l} news today`;try{const c=await Ft(d,{num:5});if(c.results)for(const m of c.results){if(s.length>=8)break;n.has(m.link)||(s.push({title:m.title,summary:m.snippet,url:m.link,source:m.displayLink}),n.add(m.link))}}catch(c){console.error(`News search error for "${d}":`,c.message)}}const o=s.slice(0,7);if(t&&r&&o.length>0)for(const l of o)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(r,l.url,l.title).run()}catch{}return o}function Hs(e,t){const r=[];let a="20:00";{const[i,o]=t.split(":"),l=parseInt(i,10),d=o||"00",c=l>=12?"PM":"AM";a=`${l===0?12:l>12?l-12:l}:${d} ${c}`}r.push(`🗓 Your ${a} Brief — ${e.targetDate}`),r.push("");const n=e.calendar.totalCount;if(n>0){r.push(`📅 Tomorrow: ${n} event${n===1?"":"s"}`);for(const i of e.calendar.google.slice(0,5)){const o=i.startTime?new Date(i.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";r.push(`   • ${o} ${i.title}`)}}else r.push("📅 Tomorrow: Nothing scheduled");r.push("");const s=e.emails.gmail.unreadCount;if(s>0?(r.push(`📧 Gmail: ${s} unread`),e.emails.gmail.importantCount>0&&r.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&r.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&r.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):r.push("📧 Gmail: Inbox clear"),r.push(""),e.tasks.pending>0){r.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const i of e.tasks.items)r.push(`   ☐ ${i}`)}else r.push("✅ Tasks: All clear");if(r.push(""),e.news.items.length>0){r.push("📡 Today's Signal:");for(const i of e.news.items){const o=i.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${i.source}`;r.push(`   • ${i.title.substring(0,90)}${i.title.length>90?"…":""}`),r.push(`     ${o} — ${i.summary.substring(0,80)}${i.summary.length>80?"…":""}`)}}return r.join(`
`)}function Fs(e){const t=[];let r=0;for(const a of e.calendar.google)t.push({type:"calendar",key:a.id,text:`${a.title} - ${new Date(a.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:a},sortOrder:r++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:r++});for(const a of e.tasks.items)t.push({type:"task",key:`task-${a}`,text:a,metadata:{},sortOrder:r++});for(const a of e.news.items)t.push({type:"news",key:`news-${a.url}`,text:`📰 ${a.title}`,metadata:{url:a.url,source:a.source},sortOrder:r++});return t}async function Gs(e,t){const r=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!r)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let a;try{const s=JSON.parse(r.components);a={google_calendar:s.google_calendar!==!1,gmail:s.gmail!==!1,tasks:s.tasks!==!1,news:s.news!==!1}}catch{a={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=r.news_topics?r.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:a,newsTopics:n}}async function Ga(e,t,r){var E,O;const a=t.timezone||"Asia/Kolkata",n=Ms(a),{components:s,newsTopics:i}=await Gs(e,t.id),o=[],l=[];s.google_calendar&&(o.push($s(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(o.push(Bs(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(o.push(js(e,t.id)),l.push("tasks")),s.news&&(o.push(Us(i,e,t.id)),l.push("news"));const d=await Promise.all(o),c={};l.forEach((C,j)=>{c[C]=d[j]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},w={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:c.googleEvents||[],totalCount:((E=c.googleEvents)==null?void 0:E.length)||0},emails:{gmail:c.gmailSummary||m},tasks:c.tasks||h,news:{items:c.news||[],fetchedAt:new Date().toISOString()},summary:""},y=((O=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:O.briefing_time)||"20:00";w.summary=Hs(w,y);const b=Fs(w),v=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(w)).first(),x=(v==null?void 0:v.id)||0;for(const C of b)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(x,C.type,C.key,C.text,JSON.stringify(C.metadata),C.sortOrder).run();return{briefingId:x,content:w,items:b}}async function Ws(e,t,r){const a=await e.prepare(`
  ...
  `).bind(r).all();return{briefing:{...a,content:JSON.parse(a.content_json||"{}")},items:n.results||[]}}async function qs(e,t,r,a){if(!await e.prepare(`
  ...
  `).bind(a,r).first();if(!s)return null;const i=s.checked?0:1;return await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ? AND briefing_id = ?
  `).bind(i,i,a,r).run(),{checked:i===1}}async function zs(e,t,r=10){return((await e.prepare(`
    SELECT b.*, 
    ...
    LIMIT ?
  `).bind(t,r).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function Wa(e,t,r=new Date){const a=new Date(r.toLocaleString("en-US",{timeZone:t})),n=a.getHours(),s=a.getMinutes(),[i,o]=e.split(":").map(Number),l=n*60+s,d=i*60+o;return l===d}function qa(e,t){const r=e.summary,a=[];for(const n of t.slice(0,10))a.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:r,inlineKeyboard:a}}const le=new ge;async function Ks(e,t){var n;if(e.req.path.includes("/cron/"))return t();const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}le.use("/*",Ks);le.get("/briefings",async e=>{const t=e.get("user"),r=parseInt(e.req.query("limit")||"10");try{const a=await zs(e.env.DB,t.id,r);return e.json({briefings:a})}catch(a){return e.json({error:a.message},500)}});le.get("/briefings/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));try{const a=await Ws(e.env.DB,t.id,r);return a?e.json(a):e.json({error:"Briefing not found"},404)}catch(a){return e.json({error:a.message},500)}});le.post("/briefings/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=parseInt(e.req.param("itemId"));try{const n=await qs(e.env.DB,t.id,r,a);return n?e.json(n):e.json({error:"Item not found"},404)}catch(n){return e.json({error:n.message},500)}});le.post("/briefings/generate",async e=>{const t=e.get("user");try{const r=await Ga(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(r)}catch(r){return e.json({error:r.message},500)}});le.get("/morning-briefing",async e=>{const t=e.get("user");try{const r=await Ya(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(r)}catch(r){return e.json({error:r.message},500)}});le.get("/briefing-preferences",async e=>{const t=e.get("user");try{const r=await e.env.DB.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t.id).first();if(!r){const n={briefingTime:"20:00",briefingEnabled:!0,components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0,weather:!1},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"],notificationChannels:{telegram:!0,web:!0},proactiveLevel:"moderate"};return e.json({preferences:n})}const a={briefingTime:r.briefing_time,briefingEnabled:r.briefing_enabled!==0,components:JSON.parse(r.components),newsTopics:r.news_topics.split(",").map(n=>n.trim()).filter(Boolean),notificationChannels:JSON.parse(r.notification_channels),proactiveLevel:r.proactive_level};return e.json({preferences:a})}catch(r){return e.json({error:r.message},500)}});le.post("/briefing-preferences",async e=>{const t=e.get("user"),r=await e.req.json(),a=[];if(r.briefingTime&&(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.test(r.briefingTime)||a.push("Invalid time format. Use HH:MM (e.g., 20:00)")),r.newsTopics&&(r.newsTopics.length>5&&a.push("Maximum 5 news topics allowed"),r.newsTopics.some(n=>n.length>50)&&a.push("Each news topic must be 50 characters or less")),r.proactiveLevel&&!["conservative","moderate","aggressive"].includes(r.proactiveLevel)&&a.push("Invalid proactive level. Use conservative, moderate, or aggressive"),a.length>0)return e.json({error:a.join("; ")},400);try{const n=await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first(),s=r.components?JSON.stringify(r.components):null,i=r.notificationChannels?JSON.stringify(r.notificationChannels):null,o=r.newsTopics?r.newsTopics.join(", "):null;if(n){const l=[],d=[];r.briefingTime!==void 0&&(l.push("briefing_time = ?"),d.push(r.briefingTime)),r.briefingEnabled!==void 0&&(l.push("briefing_enabled = ?"),d.push(r.briefingEnabled?1:0)),s!==null&&(l.push("components = ?"),d.push(s)),o!==null&&(l.push("news_topics = ?"),d.push(o)),i!==null&&(l.push("notification_channels = ?"),d.push(i)),r.proactiveLevel!==void 0&&(l.push("proactive_level = ?"),d.push(r.proactiveLevel)),l.length>0&&(l.push("updated_at = CURRENT_TIMESTAMP"),d.push(t.id),await e.env.DB.prepare(`UPDATE briefing_preferences SET ${l.join(", ")} WHERE user_id = ?`).bind(...d).run())}else await e.env.DB.prepare(`
        INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(t.id,r.briefingTime||"20:00",s||'{"google_calendar":true,"gmail":true,"tasks":true,"news":true}',o||"AI, LLM, Tools, Agentic Workflows, AI Features",i||'{"telegram":true,"web":true}',r.proactiveLevel||"moderate").run();return e.json({success:!0})}catch(n){return e.json({error:n.message},500)}});le.post("/briefing-preferences/init-defaults",async e=>{const t=e.get("user");try{return await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first()?e.json({success:!0,message:"Preferences already exist"}):(await e.env.DB.prepare(`
      INSERT INTO briefing_preferences (user_id, briefing_time, components, news_topics, notification_channels, proactive_level)
    ...
    `).all(),n=[],s=new Date;for(const i of a.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(Wa(l,o,s))try{const d=await Ga(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(i.telegram_chat_id){const{text:c,inlineKeyboard:m}=qa(d.content,d.items);await za(e.env.DB,i,c,m,d.briefingId)}n.push({user_id:i.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:o})}catch(d){n.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});le.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,i=new Date(s.getTime()+600*1e3).toISOString(),o=new Date(s.getTime()+900*1e3).toISOString();for(const l of a.results||[])try{const d=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!d)continue;const c=await J(d.encrypted_value,l.pin_hash),h=JSON.parse(c).access_token;if(!h)continue;const w=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${h}`}});if(!w.ok)continue;const b=((await w.json()).items||[]).filter(E=>{var C;const O=(C=E.start)==null?void 0:C.dateTime;return O?O>=s.toISOString()&&O<=i:!1});if(b.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const v=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!v)continue;const x=await J(v.encrypted_value,l.pin_hash);for(const E of b){const O=new Date(E.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),C=E.location?`
📍 ${E.location}`:"",j=`⏰ Meeting in 10 minutes!

*${E.summary||"Untitled Event"}*
🕐 ${O}${C}`;await fetch(`https://api.telegram.org/bot${x}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:j,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:b.length})}catch(d){n.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});le.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),n=[],s=new Date;for(const i of a.results||[]){if(!i.morning_briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.morning_briefing_time||"08:00";if(Wa(l,o,s))try{const d=await Ya(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});let c={telegram:!0,web:!0};try{c=JSON.parse(i.notification_channels||"{}")}catch{}if(c.telegram!==!1&&i.telegram_chat_id&&d.briefingId){const m=Vs(d.content);await Ka(e.env.DB,i,m),await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(d.briefingId).run()}n.push({user_id:i.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:o})}catch(d){n.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});le.post("/cron/email-digest",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare(`
      SELECT u.*, bp.components
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),n=[];for(const s of a.results||[]){let i={};try{i=JSON.parse(s.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Ja(e.env.DB,s,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,d=JSON.stringify(o,null,2),c=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'email_digest', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(s.id,l,d,`email_digest_${Date.now()}`,null,null,null).first();n.push({user_id:s.id,status:"success",action_item_id:c==null?void 0:c.id,digest:o})}catch(o){n.push({user_id:s.id,status:"error",error:o.message})}}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});le.post("/cron/weekly-review",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare(`
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),n=[],s=new Date;for(const i of a.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(Ys(l,o,s))try{const d=await Js(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),c=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,m=JSON.stringify(d,null,2),h=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,c,m,`weekly_review_${Date.now()}`,null,null,null).first();let w={telegram:!0,web:!0};try{w=JSON.parse(i.notification_channels||"{}")}catch{}if(w.telegram!==!1&&i.telegram_chat_id){const y=Zs(d);await Ka(e.env.DB,i,y)}n.push({user_id:i.id,status:"success",action_item_id:h==null?void 0:h.id})}catch(d){n.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});async function za(e,t,r,a,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const i=await J(s.encrypted_value,s.pin_hash);if(!(await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:r,parse_mode:"Markdown",reply_markup:{inline_keyboard:a.map(d=>d.map(c=>({...c,callback_data:`${c.callback_data}:${n}`})))}})})).json()).ok){const c=await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:r.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:a.map(m=>m.map(h=>({...h,callback_data:`${h.callback_data}:${n}`})))}})})).json();if(!c.ok){console.error("Telegram briefing send failed:",c.description,"chat_id:",t.telegram_chat_id);return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}async function Ka(e,t,r){try{const a=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!a)return;const n=await J(a.encrypted_value,a.pin_hash);(await fetch(`https://api.telegram.org/bot${n}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:r.substring(0,4e3),parse_mode:"Markdown"})})).ok||await fetch(`https://api.telegram.org/bot${n}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:r.substring(0,4e3).replace(/[_*[`\]]/g,"")})})}catch(a){console.error("Telegram plain text error:",a.message)}}async function Ya(e,t,r){const a=new Date;a.setHours(0,0,0,0);const n=new Date;n.setHours(23,59,59,999);const s=await e.prepare(`
    SELECT * FROM cron_jobs 
    WHERE user_id = ? AND enabled = 1 
    AND next_run >= ? AND next_run <= ?
    ORDER BY next_run ASC
  `).bind(t.id,a.toISOString(),n.toISOString()).all(),i=await e.prepare(`
    SELECT * FROM action_items 
    WHERE user_id = ? AND status = 'pending'
    ORDER BY priority DESC, created_at DESC
    LIMIT 10
  `).bind(t.id).all(),o=await Ja(e,t,r);let l=[];try{const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first();if(h){const w=await J(h.encrypted_value,t.pin_hash),b=JSON.parse(w).access_token;if(b){const v=a.toISOString(),x=n.toISOString(),E=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(v)}&timeMax=${encodeURIComponent(x)}&maxResults=20`,{headers:{Authorization:`Bearer ${b}`}});E.ok&&(l=((await E.json()).items||[]).map(C=>{var j,G,F,P;return{title:C.summary||"Untitled",startTime:((j=C.start)==null?void 0:j.dateTime)||((G=C.start)==null?void 0:G.date),endTime:((F=C.end)==null?void 0:F.dateTime)||((P=C.end)==null?void 0:P.date)}}))}}}catch{}const d={generatedAt:new Date().toISOString(),type:"morning",todayReminders:(s.results||[]).map(h=>({name:h.name,description:h.description,next_run:h.next_run})),pendingActions:(i.results||[]).map(h=>({title:h.title,priority:h.priority})),emailDigest:o,calendarEvents:l},c=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'morning', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(d)).first();return{briefingId:(c==null?void 0:c.id)||0,content:d}}async function Ja(e,t,r){const a={unreadCount:0,recent:[]},n={message:"",recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const i=new be(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET),o=await i.getUnreadCount(),l=await i.listMessages({maxResults:10,labelIds:["INBOX"]});a.unreadCount=o,a.recent=l.map(d=>({id:d.id,subject:d.subject,from:d.from,snippet:d.snippet,isUnread:d.isUnread}))}}catch(s){a.error=s.message}try{const s=await e.prepare("SELECT name, encrypted_blob FROM site_credentials WHERE user_id = ? AND (name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE) LIMIT 1").bind(t.id,"%Outlook%","%Microsoft%","%Office 365%").first();if(!s)n.message="No Outlook credentials saved in Secret Vault. Add them in Settings → Secret Vault.";else{const i=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t.id,"browser_use_api_key").first();if(!i)n.message="Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key.";else{const o=(await J(i.encrypted_value,t.pin_hash)).trim(),l=JSON.parse(await J(s.encrypted_blob,t.pin_hash)),d=await Ra("Go to https://outlook.live.com or https://outlook.office.com. Log in with username {username} and password {password} if prompted. Navigate to the inbox and extract the 10 most recent emails with sender, subject, date, and snippet. Return the results as structured text.",o,{secrets:{username:l.username,password:l.password},timeoutMs:88e3});d.status==="completed"&&d.output?n.recent=d.output:d.status==="timeout"?n.message="Outlook browser task timed out.":n.message="Outlook returned no content."}}}catch(s){n.message=`Outlook error: ${s.message}`}return{gmail:a,outlook:n}}function Ys(e,t,r=new Date){const a=new Date(r.toLocaleString("en-US",{timeZone:t})),n=a.toLocaleDateString("en-US",{weekday:"long"}),s=a.getHours(),i=a.getMinutes(),o=e.trim().split(" "),l=o[o.length-1],d=o.slice(0,o.length-1).join(" "),[c,m]=l.split(":").map(Number),h=s*60+i,w=c*60+m;return n===d&&h===w}async function Js(e,t,r){const a=new Date,n=new Date(a.getTime()-10080*60*1e3),s=new Date(a.getTime()+10080*60*1e3),i=await e.prepare(`
    SELECT * FROM cron_jobs 
    WHERE user_id = ? AND state = 'completed' AND last_run >= ?
    ORDER BY last_run DESC
  `).bind(t.id,n.toISOString()).all(),o=await e.prepare(`
    SELECT * FROM cron_jobs 
  ...
  `).bind(t.id).all(),d=await e.prepare(`
    ...
    LIMIT 10
  `).bind(t.id,n.toISOString()).all(),c=await e.prepare(`
    SELECT * FROM cron_jobs 
    WHERE user_id = ? AND enabled = 1 AND next_run >= ? AND next_run <= ?
    ORDER BY next_run ASC
  `).bind(t.id,a.toISOString(),s.toISOString()).all();let m={unreadCount:0,recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const w=new be(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET),y=await w.getUnreadCount(),b=await w.listMessages({maxResults:10,labelIds:["INBOX"]});m={unreadCount:y,recent:b.map(v=>({subject:v.subject,from:v.from,snippet:v.snippet}))}}}catch{}return{generatedAt:a.toISOString(),period:{start:n.toISOString(),end:a.toISOString()},completedTasks:(i.results||[]).map(h=>({name:h.name,last_run:h.last_run})),missedTasks:(o.results||[]).map(h=>({name:h.name,next_run:h.next_run})),openActions:(l.results||[]).map(h=>({title:h.title,priority:h.priority,status:h.status})),recentDocuments:(d.results||[]).map(h=>({name:h.name,status:h.status,created_at:h.created_at})),upcomingTasks:(c.results||[]).map(h=>({name:h.name,next_run:h.next_run})),gmailSummary:m}}function Vs(e){const t=[];t.push("☀️ Morning Briefing"),t.push("");const r=e.todayReminders||[];if(r.length>0){t.push(`📋 Today (${r.length}):`);for(const l of r){const d=l.next_run?new Date(l.next_run).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${d} ${l.name}`)}}else t.push("📋 Today: No scheduled reminders");t.push("");const a=e.pendingActions||[];if(a.length>0){t.push(`🔔 Pending Actions (${a.length}):`);for(const l of a.slice(0,5))t.push(`   • ${l.title} (${l.priority})`)}else t.push("🔔 Pending Actions: None");t.push("");const n=e.emailDigest||{},s=n.gmail||{};s.unreadCount>0?t.push(`📧 Gmail: ${s.unreadCount} unread`):t.push("📧 Gmail: Inbox clear");const i=n.outlook||{};typeof i.recent=="string"&&i.recent.length>0?t.push("📧 Outlook: see digest"):i.message&&t.push(`📧 Outlook: ${i.message}`),t.push("");const o=e.calendarEvents||[];if(o.length>0){t.push(`📅 Calendar (${o.length}):`);for(const l of o.slice(0,5)){const d=l.startTime?new Date(l.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${d} ${l.title}`)}}return t.join(`
`)}function Zs(e){const t=[];t.push("📊 Weekly Review"),t.push("");const r=e.completedTasks||[];t.push(`✅ Completed: ${r.length}`);const a=e.missedTasks||[];t.push(`❌ Missed/Overdue: ${a.length}`);const n=e.openActions||[];t.push(`🔔 Open Actions: ${n.length}`),t.push("");const s=e.recentDocuments||[];s.length>0&&t.push(`📄 Documents: ${s.length} this week`);const i=e.upcomingTasks||[];i.length>0&&t.push(`📅 Upcoming: ${i.length} in next 7 days`);const o=e.gmailSummary||{};return o.unreadCount>0&&t.push(`📧 Gmail Unread: ${o.unreadCount}`),t.join(`
`)}le.post("/briefings/:id/resend",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));try{const a=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!a)return e.json({error:"Briefing not found"},404);const n=JSON.parse(a.content||"{}"),s=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(r).all(),{text:i,inlineKeyboard:o}=qa(n,s.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(r).run(),await za(e.env.DB,t,i,o,r);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(r).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(a){return e.json({error:a.message},500)}});le.delete("/briefings/:id",async e=>{const t=e.get("user"),r=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0})});const Ze=new ge;async function Xs(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}Ze.use("/*",Xs);function Va(e){return e.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"")}Ze.get("/",async e=>{const t=e.get("user"),r=await e.env.DB.prepare(`SELECT id, name, slug, description, instructions, parameters, required_tools, examples, enabled, usage_count, last_used_at, created_at, updated_at
     FROM user_skills WHERE user_id = ? ORDER BY created_at DESC`).bind(t.id).all();return e.json({skills:r.results||[]})});Ze.post("/",async e=>{var d,c,m;const t=e.get("user"),r=await e.req.json();if(!((d=r.name)!=null&&d.trim()))return e.json({error:"name is required"},400);if(!((c=r.description)!=null&&c.trim()))return e.json({error:"description is required"},400);if(!((m=r.instructions)!=null&&m.trim()))return e.json({error:"instructions is required"},400);let a=Va(r.name);a||(a=`skill_${Date.now()}`);const n=await e.env.DB.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(t.id,`${a}%`).all();n.results&&n.results.length>0&&n.results.map(w=>w.slug).includes(a)&&(a=`${a}_${n.results.length+1}`);const s=JSON.stringify(r.parameters||{}),i=JSON.stringify(r.required_tools||[]),o=JSON.stringify(r.examples||[]),l=await e.env.DB.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).bind(t.id,r.name.trim(),a,r.description.trim(),r.instructions.trim(),s,i,o).first();return e.json({skill:l,created:!0})});Ze.get("/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));if(isNaN(r))return e.json({error:"Invalid skill ID"},400);const a=await e.env.DB.prepare("SELECT * FROM user_skills WHERE id = ? AND user_id = ?").bind(r,t.id).first();return a?e.json({skill:a}):e.json({error:"Skill not found"},404)});Ze.put("/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));if(isNaN(r))return e.json({error:"Invalid skill ID"},400);const a=await e.req.json(),n=[],s=[];return a.name!==void 0&&(n.push("name = ?","slug = ?"),s.push(a.name.trim(),Va(a.name))),a.description!==void 0&&(n.push("description = ?"),s.push(a.description.trim())),a.instructions!==void 0&&(n.push("instructions = ?"),s.push(a.instructions.trim())),a.parameters!==void 0&&(n.push("parameters = ?"),s.push(JSON.stringify(a.parameters))),a.required_tools!==void 0&&(n.push("required_tools = ?"),s.push(JSON.stringify(a.required_tools))),a.examples!==void 0&&(n.push("examples = ?"),s.push(JSON.stringify(a.examples))),a.enabled!==void 0&&(n.push("enabled = ?"),s.push(a.enabled?1:0)),n.length===0?e.json({error:"Nothing to update"},400):(n.push("updated_at = CURRENT_TIMESTAMP"),s.push(r,t.id),await e.env.DB.prepare(`UPDATE user_skills SET ${n.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});Ze.delete("/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return isNaN(r)?e.json({error:"Invalid skill ID"},400):(await e.env.DB.prepare("DELETE FROM user_skills WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0}))});const Pe=new ge;async function Qs(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}Pe.use("/*",Qs);function ei(e){const t=new Date().toLocaleString("en-US",{timeZone:e});return new Date(t)}function Za(e){const t=ei(e),r=new Date(t);r.setDate(r.getDate()+1),r.setHours(9,0,0,0);const a=new Date(r.toLocaleString("en-US",{timeZone:"UTC"})),n=new Date(r.toLocaleString("en-US",{timeZone:e})),s=a.getTime()-n.getTime();return new Date(r.getTime()+s)}function Gt(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}Pe.put("/:id/done",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!a)return e.json({error:"Notification not found"},404);const n=Gt(a.source);return n&&await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(n,t.id).run(),await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0,cron_completed:n!==null})});Pe.post("/:id/snooze",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.req.json(),n=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!n)return e.json({error:"Notification not found"},404);let s;if(typeof a.minutes=="number")s=new Date(Date.now()+a.minutes*60*1e3);else if(a.until==="tomorrow_morning")s=Za(t.timezone||"UTC");else if(a.new_time)s=new Date(a.new_time);else return e.json({error:"Invalid snooze parameters"},400);if(isNaN(s.getTime()))return e.json({error:"Invalid time"},400);const i=s.toISOString(),o=Gt(n.source);o&&await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(o,t.id).run();const l=await e.env.DB.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,n.title,n.body,"once",i,"reminder",JSON.stringify({description:n.body||""}),i,1,"active").first();return await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0,job_id:l==null?void 0:l.id})});Pe.post("/:id/reschedule",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),{new_time:a}=await e.req.json();if(!a)return e.json({error:"new_time is required"},400);const n=new Date(a);if(isNaN(n.getTime()))return e.json({error:"Invalid time"},400);const s=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!s)return e.json({error:"Notification not found"},404);const i=n.toISOString(),o=Gt(s.source);if(o)return await e.env.DB.prepare("UPDATE cron_jobs SET next_run = ?, schedule_value = ?, state = 'active', enabled = 1, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(i,i,o,t.id).run(),e.json({success:!0,job_id:o});const l=await e.env.DB.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,s.title,s.body,"once",i,"reminder",JSON.stringify({description:s.body||""}),i,1,"active").first();return e.json({success:!0,job_id:l==null?void 0:l.id})});Pe.delete("/:id/cancel",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!a)return e.json({error:"Notification not found"},404);const n=Gt(a.source);return n&&await e.env.DB.prepare("UPDATE cron_jobs SET enabled = 0, state = 'completed', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(n,t.id).run(),await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0})});Pe.post("/reminders/:id/snooze",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.req.json();if(!await e.env.DB.prepare("SELECT * FROM cron_jobs WHERE id = ? AND user_id = ?").bind(r,t.id).first())return e.json({error:"Reminder not found"},404);let s;if(typeof a.minutes=="number")s=new Date(Date.now()+a.minutes*60*1e3);else if(a.until_tomorrow_9am)s=Za(t.timezone||"UTC");else if(a.new_time)s=new Date(a.new_time);else return e.json({error:"Invalid snooze parameters"},400);if(isNaN(s.getTime()))return e.json({error:"Invalid time"},400);const i=s.toISOString();return await e.env.DB.prepare("UPDATE cron_jobs SET next_run = ?, schedule_value = ?, state = 'active', enabled = 1, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(i,i,r,t.id).run(),e.json({success:!0})});Pe.post("/reminders/:id/done",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await e.env.DB.prepare("SELECT * FROM cron_jobs WHERE id = ? AND user_id = ?").bind(r,t.id).first()?(await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t.id).run(),await e.env.DB.prepare("UPDATE notifications SET is_read = 1 WHERE source = ? AND user_id = ?").bind(`cron:${r}`,t.id).run(),e.json({success:!0})):e.json({error:"Reminder not found"},404)});const _e=new ge;async function ti(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}_e.use("/*",ti);_e.get("/",async e=>{const t=e.get("user"),r=e.req.query("status"),a=e.req.query("search"),n=["user_id = ?"],s=[t.id];r&&(n.push("status = ?"),s.push(r)),a&&(n.push("(name LIKE ? OR summary LIKE ?)"),s.push(`%${a}%`,`%${a}%`));const i=`SELECT * FROM document_library WHERE ${n.join(" AND ")} ORDER BY created_at DESC`,o=await e.env.DB.prepare(i).bind(...s).all();return e.json({documents:o.results||[]})});_e.get("/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(r,t.id).first();return a?e.json({document:a}):e.json({error:"Document not found"},404)});_e.post("/upload",async e=>{const t=e.get("user"),r=!!e.env.DOCUMENTS_BUCKET,a=r?100*1024*1024:700*1024;try{const s=(await e.req.formData()).get("file");if(!s)return e.json({error:"No file provided."},400);const i=s.name,o=s.type||"application/octet-stream",l=s.size;if(l>a)return e.json({error:`File too large (max ${r?"100 MB":"700 KB"}). Try sharing a Google Drive link instead.`},400);const d=await s.arrayBuffer(),c=crypto.randomUUID();let m;r?(await e.env.DOCUMENTS_BUCKET.put(c,d,{httpMetadata:{contentType:o},customMetadata:{fileName:i,userId:String(t.id)}}),m="r2"):m=Buffer.from(d).toString("base64"),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(c,t.id,i,o,m,l).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,c,"upload",i,o,l,"uploaded").run();const h=o==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||i.toLowerCase().endsWith(".docx");if(h)try{const{extractDocxTextFromBuffer:y}=await Promise.resolve().then(()=>Ia),b=await y(Buffer.from(d));if(b.length>50){await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(b,c).run();const v=b.substring(0,600);await e.env.DB.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(v,b.substring(0,5e4),c,t.id).run();const x=e.env,E=t.id,O=b,C=c,j=(async()=>{try{const G=await x.DB.prepare("SELECT id FROM document_library WHERE file_id = ? AND user_id = ?").bind(C,E).first();if(G){const{indexDocumentChunks:F}=await Promise.resolve().then(()=>Et);await F({DB:x.DB,AI:x.AI,VECTORIZE:x.VECTORIZE},E,G.id,O)}}catch{}})();try{e.executionCtx.waitUntil(j)}catch{}}}catch{}const w=o==="application/pdf"||i.toLowerCase().endsWith(".pdf");if(w&&t.pin_hash){const y=Buffer.from(d).toString("base64"),b=t.pin_hash,v=t.id,x=e.env.DB,E=e.env.DOCUMENTS_BUCKET,O=e.env,C=(async()=>{var j,G;try{let F=null,P="claude-haiku-4-5-20251001";const{decrypt:q}=await Promise.resolve().then(()=>Ht);for(const u of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const f=await x.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(v,u).first();if(f){const p=await q(f.encrypted_value,b),g=JSON.parse(p);if(g.provider==="anthropic"){F=g.apiKey,g.model&&(P=g.model);break}}}catch{}if(!F)return;let z=y;if(m==="r2"&&E){const u=await E.get(c);if(!u)return;z=Buffer.from(await u.arrayBuffer()).toString("base64")}const R=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":F,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:P,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:z}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!R.ok)return;const L=((G=(j=(await R.json()).content)==null?void 0:j[0])==null?void 0:G.text)||"";if(L){await x.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(L,c).run();const u=L.substring(0,600);await x.prepare("UPDATE document_library SET summary = ?, extracted_text = ?, status = 'parsed', updated_at = CURRENT_TIMESTAMP WHERE file_id = ? AND user_id = ?").bind(u,L.substring(0,5e4),c,v).run();try{const f=await x.prepare("SELECT id FROM document_library WHERE file_id = ? AND user_id = ?").bind(c,v).first();if(f){const{indexDocumentChunks:p}=await Promise.resolve().then(()=>Et);await p({DB:x,AI:O.AI,VECTORIZE:O.VECTORIZE},v,f.id,L)}}catch{}}}catch{}})();try{e.executionCtx.waitUntil(C)}catch{}}return e.json({file_id:c,name:i,type:o,size:l,storage:r?"r2":"d1",extracting:w&&!h})}catch(n){return console.error("Document upload error:",n),e.json({error:`Upload failed: ${n.message||"Unknown error"}`},500)}});_e.post("/search",async e=>{const t=e.get("user"),r=await e.req.json();if(!r.query)return e.json({error:"query is required"},400);const{semanticDocumentSearch:a}=await Promise.resolve().then(()=>Et),n=await a({DB:e.env.DB,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE},t.id,r.query,Math.min(r.limit||5,20));return e.json({results:n})});_e.post("/chat",async e=>{var o;const t=e.get("user"),r=await e.req.json(),a=(r.question||r.query||"").trim();if(!a)return e.json({error:"question is required"},400);const{semanticDocumentSearch:n}=await Promise.resolve().then(()=>Et),s=await n({DB:e.env.DB,AI:e.env.AI,VECTORIZE:e.env.VECTORIZE},t.id,a,6);let i;if(s.length===0)i="No relevant document content found for your question. Make sure your documents have been uploaded and processed first.";else{const l=s.map(d=>`[From: ${d.filename}]
${d.chunk}`).join(`

---

`);try{const{provider:d}=await Ve(e.env.DB,t.id,t.pin_hash);i=((o=(await d.chat([{role:"system",content:"Answer the question using only the provided document excerpts. Be specific and cite which document each part of your answer comes from."},{role:"user",content:`Document excerpts:

${l}

Question: ${a}`}],{maxTokens:1024})).content)==null?void 0:o.trim())||"Could not generate an answer."}catch{i="Unable to generate an answer at this time. Please try again."}}return e.json({answer:i,session_id:r.session_id||crypto.randomUUID(),sources:s.map(l=>({filename:l.filename,relevance_score:l.relevance_score}))})});_e.post("/",async e=>{const t=e.get("user"),r=await e.req.json();if(!r.name||typeof r.name!="string")return e.json({error:"name is required"},400);const a=r.source||"upload",n=r.mime_type||"application/octet-stream",s=typeof r.size=="number"?r.size:0,i=await e.env.DB.prepare(`INSERT INTO document_library (user_id, name, source, file_id, drive_file_id, mime_type, size, status)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).bind(t.id,r.name,a,r.file_id||null,r.drive_file_id||null,n,s,"uploaded").first();return e.json({success:!0,document:i})});_e.post("/:id/summarize",async e=>{var d;const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(r,t.id).first();if(!a)return e.json({error:"Document not found"},404);let n=null;if(a.file_id){const c=await e.env.DB.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(a.file_id,t.id).first();n=(c==null?void 0:c.extracted_text)||null}let s=null;if(n)try{const{provider:c}=await Ve(e.env.DB,t.id,t.pin_hash);s=((d=(await c.chat([{role:"system",content:"You are a helpful assistant that summarizes documents concisely."},{role:"user",content:`Summarize the following document in a few paragraphs:

${n.substring(0,8e3)}`}],{maxTokens:1024})).content)==null?void 0:d.trim())||null}catch{s=null}const i=s||"Summary not yet generated. Ask Karna in chat to summarize this document.";await e.env.DB.prepare("UPDATE document_library SET status = ?, summary = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("summarized",i,r,t.id).run();const l=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(r,t.id).first();return e.json({success:!0,document:l})});_e.delete("/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM document_library WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0})});_e.post("/:id/parse",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));await e.env.DB.prepare("UPDATE document_library SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("parsed",r,t.id).run();const a=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(r,t.id).first();return e.json({success:!0,document:a})});const fe=new ge;async function ri(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}fe.use("/*",ri);fe.get("/review",async e=>{const t=e.get("user"),r=e.req.query("tier"),a=e.req.query("type"),n=e.req.query("search"),s=parseInt(e.req.query("limit")||"50");let i="SELECT * FROM memory WHERE user_id = ?";const o=[t.id];r&&(i+=" AND tier = ?",o.push(r)),a&&(i+=" AND type = ?",o.push(a)),n&&(i+=" AND (title LIKE ? OR content LIKE ?)",o.push(`%${n}%`,`%${n}%`)),i+=" ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?",o.push(s);const l=await e.env.DB.prepare(i).bind(...o).all(),d=await e.env.DB.prepare("SELECT tier, COUNT(*) as cnt FROM memory WHERE user_id = ? GROUP BY tier").bind(t.id).all(),c={working:0,long_term:0};for(const m of d.results||[])c[m.tier]=m.cnt;return e.json({memories:l.results||[],tier_counts:c})});fe.put("/review/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.req.json(),n=[],s=[];return a.title!==void 0&&(n.push("title = ?"),s.push(a.title)),a.content!==void 0&&(n.push("content = ?"),s.push(a.content)),a.importance!==void 0&&(n.push("importance = ?"),s.push(a.importance)),a.tier!==void 0&&(n.push("tier = ?"),s.push(a.tier)),n.length===0?e.json({error:"Nothing to update"},400):(n.push("updated_at = CURRENT_TIMESTAMP"),s.push(r,t.id),await e.env.DB.prepare(`UPDATE memory SET ${n.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});fe.post("/review/:id/promote",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await new Y(e.env.DB).promote(r,t.id),e.json({success:!0})});fe.post("/review/:id/demote",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await new Y(e.env.DB).demote(r,t.id),e.json({success:!0})});fe.delete("/review/:id",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await new Y(e.env.DB).remove(r,t.id),e.json({success:!0})});fe.get("/suggestions",async e=>{const t=e.get("user"),r=e.req.query("status")||"pending",a=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare("SELECT * FROM memory_suggestions WHERE user_id = ? AND status = ? ORDER BY created_at DESC LIMIT ?").bind(t.id,r,a).all();return e.json({suggestions:n.results||[]})});fe.post("/suggestions/:id/accept",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id")),a=await e.env.DB.prepare("SELECT * FROM memory_suggestions WHERE id = ? AND user_id = ? AND status = 'pending'").bind(r,t.id).first();return a?(await new Y(e.env.DB).store(t.id,a.type,a.title,a.content,a.importance,"long_term"),await e.env.DB.prepare("UPDATE memory_suggestions SET status = 'accepted', decided_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r).run(),e.json({success:!0})):e.json({error:"Suggestion not found or already decided"},404)});fe.post("/suggestions/:id/reject",async e=>{const t=e.get("user"),r=parseInt(e.req.param("id"));return await e.env.DB.prepare("SELECT id FROM memory_suggestions WHERE id = ? AND user_id = ? AND status = 'pending'").bind(r,t.id).first()?(await e.env.DB.prepare("UPDATE memory_suggestions SET status = 'rejected', decided_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r).run(),e.json({success:!0})):e.json({error:"Suggestion not found or already decided"},404)});fe.post("/suggestions",async e=>{const t=e.get("user"),{type:r,title:a,content:n,importance:s,source_message_id:i}=await e.req.json();if(!r||!a||!n)return e.json({error:"type, title, and content are required"},400);const o=await e.env.DB.prepare("INSERT INTO memory_suggestions (user_id, type, title, content, importance, status, source_message_id) VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING id").bind(t.id,r,a,n,s??5,"pending",i||null).first();return e.json({success:!0,id:o==null?void 0:o.id})});fe.post("/migrate-documents-out",async e=>{const t=e.get("user"),a=(await e.env.DB.prepare(`
    ...
    LIMIT 50
  `).bind(t.id).all()).results||[];if(a.length===0)return e.json({migrated:0,skipped:0,samples:[],message:"No oversized memory entries found."});let n=0,s=0;const i=[];for(const o of a){const l=o.content.length>1500,d=/\b(essay|article|draft|report|chapter)\b/i.test(o.content)&&o.content.length>500;if(!l&&!d){s++;continue}try{const c=o.content.substring(0,500),m=o.content.substring(0,5e4);await e.env.DB.prepare(`
        INSERT INTO document_library (user_id, source, name, summary, extracted_text, status)
        VALUES (?, 'memory_migration', ?, ?, ?, 'parsed')
      `).bind(t.id,o.title,c,m).run();const h=`[Migrated to Document Library] ${o.title} — content moved to Document Library. Search for it with search_library("${o.title.substring(0,40)}").`;await e.env.DB.prepare("UPDATE memory SET content = ?, importance = 4, tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(h,o.id,t.id).run(),n++,i.length<5&&i.push({id:o.id,title:o.title,action:"migrated to document_library, memory demoted to pointer"})}catch{s++}}return e.json({migrated:n,skipped:s,samples:i,message:`Moved ${n} bulky memory entries to Document Library. ${s} entries were skipped (too short or migration error).`})});const pe=new ge;pe.use("/api/*",jn());pe.route("/api/auth",je);pe.route("/api/chat",ae);pe.route("/api/settings",Q);pe.route("/api/system",Ie);pe.route("/api/telegram",Ot);pe.route("/api/proactive",le);pe.route("/api/skills",Ze);pe.route("/api/notifications",Pe);pe.route("/api/documents",_e);pe.route("/api/memory",fe);pe.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),r=t.searchParams.get("code"),a=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Qe(!1,`Google denied access: ${n}`));if(!r||!a)return e.html(Qe(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(a)).sessionId;if(!i)return e.html(Qe(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(Qe(!1,"Session expired. Please log in again and retry."));const l=o.user_id,d=o.pin_hash,c=`${t.protocol}//${t.host}/auth/google/callback`,m=await pa(e.env.DB,l,d,r,c,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Qe(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Qe(!1,`OAuth failed: ${s.message}`))}});pe.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ea())));pe.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(ea())));function Qe(e,t,r){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function ai(e,t,r){const a="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const o=await(await fetch(`${a}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(o.results&&o.results.length>0){const d=o.results.filter(m=>m.needs_agent&&m.status==="dispatched");if(d.length>0){const m=d.map(h=>fetch(`${a}/api/system/cron/run-task/${h.job_id}`,{method:"POST",headers:s}).then(w=>w.json()).catch(w=>({job_id:h.job_id,error:w.message})));r.waitUntil(Promise.allSettled(m).then(h=>{console.log(`Cron: ${o.executed} dispatched, ${d.length} agent tasks`,JSON.stringify(h.map(w=>w.status==="fulfilled"?w.value:w.reason)))}))}const c=o.results.filter(m=>!m.needs_agent&&m.status==="dispatched");if(c.length>0){const m=c.map(h=>fetch(`${a}/api/system/cron/run-task/${h.job_id}`,{method:"POST",headers:s}).catch(()=>{}));r.waitUntil(Promise.allSettled(m))}}r.waitUntil(fetch(`${a}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{d.executed>0&&console.log("Evening briefing result:",JSON.stringify(d))}).catch(d=>{console.error("Evening briefing error:",d.message)})),new Date().getMinutes()%5<2&&r.waitUntil(fetch(`${a}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{var c;(c=d.results)!=null&&c.some(m=>m.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(d))}).catch(()=>{}))}catch(i){console.error("Scheduled cron error:",i.message||i)}}const ni={fetch:pe.fetch,scheduled:ai},Nr=new ge,si=Object.assign({"/src/index.tsx":ni});let Xa=!1;for(const[,e]of Object.entries(si))e&&(Nr.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Nr.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Xa=!0);if(!Xa)throw new Error("Can't import modules from ['/src/index.tsx']");function Qa(e){if(e.length<100)return e.trim()?[e.trim()]:[];const n=[];let s=0;for(;s<e.length;){let i=Math.min(s+1800,e.length);if(i<e.length){const l=e.lastIndexOf(`

`,i);if(l>s+1800/2)i=l+2;else{const d=e.lastIndexOf(". ",i);d>s+1800/2&&(i=d+2)}}const o=e.slice(s,i).trim();o.length>=100&&n.push(o),s=i-200,s<=0&&(s=i)}return n}async function ii(e,t,r,a){if(!e.AI||!e.VECTORIZE)return;const n=Qa(a);if(n.length===0)return;const s=await e.DB.prepare("SELECT vector_id FROM document_chunks WHERE document_id = ?").bind(r).all();s.results.length>0&&(await e.VECTORIZE.deleteByIds(s.results.map(c=>c.vector_id)),await e.DB.prepare("DELETE FROM document_chunks WHERE document_id = ?").bind(r).run());const o=(await e.AI.run("@cf/baai/bge-large-en-v1.5",{text:n})).data,l=n.map((c,m)=>`doc_${r}_${m}`);await e.VECTORIZE.insert(n.map((c,m)=>({id:l[m],values:o[m],metadata:{userId:String(t),documentId:String(r)}})));const d=e.DB.prepare("INSERT INTO document_chunks (user_id, document_id, chunk_index, text, vector_id) VALUES (?, ?, ?, ?, ?)");await e.DB.batch(n.map((c,m)=>d.bind(t,r,m,c,l[m])))}async function oi(e,t,r,a=5){if(!e.AI||!e.VECTORIZE)return[];const s=(await e.AI.run("@cf/baai/bge-large-en-v1.5",{text:[r]})).data[0],i=await e.VECTORIZE.query(s,{topK:a*3,filter:{userId:String(t)}});if(!i.matches||i.matches.length===0)return[];const o=i.matches.map(m=>m.id),l=new Map(i.matches.map(m=>[m.id,m.score])),d=o.map(()=>"?").join(",");return((await e.DB.prepare(`SELECT dc.text, dc.vector_id, dc.document_id, dl.name
     FROM document_chunks dc
     JOIN document_library dl ON dc.document_id = dl.id
     WHERE dc.vector_id IN (${d}) AND dc.user_id = ?`).bind(...o,t).all()).results||[]).map(m=>({filename:m.name,relevance_score:l.get(m.vector_id)??0,chunk:m.text,document_id:m.document_id})).sort((m,h)=>h.relevance_score-m.relevance_score).slice(0,a)}const Et=Object.freeze(Object.defineProperty({__proto__:null,chunkText:Qa,indexDocumentChunks:ii,semanticDocumentSearch:oi},Symbol.toStringTag,{value:"Module"}));export{Nr as default};
