var Ya=Object.defineProperty;var Mt=e=>{throw TypeError(e)};var Va=(e,t,a)=>t in e?Ya(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var k=(e,t,a)=>Va(e,typeof t!="symbol"?t+"":t,a),yt=(e,t,a)=>t.has(e)||Mt("Cannot "+a);var b=(e,t,a)=>(yt(e,t,"read from private field"),a?a.call(e):t.get(e)),C=(e,t,a)=>t.has(e)?Mt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(yt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(yt(e,t,"access private method"),a);var Bt=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return b(e,t,r)}});var jt=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,c=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(h){if(h instanceof Error&&t)r.error=h,l=await t(h,r),c=!0;else throw h}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},Xa=Symbol(),Za=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof oa?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Qa(e,{all:a,dot:r}):{}};async function Qa(e,t){const a=await e.formData();return a?er(a,t):{}}function er(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?tr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(ar(a,r,n),delete a[r])}),a}var tr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ar=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},ta=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},rr=e=>{const{groups:t,path:a}=nr(e),r=ta(a);return sr(r,t)},nr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},sr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},at={},or=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return at[r]||(a[2]?at[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:at[r]=[e,a[1],!0]),at[r]}return null},Ct=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},ir=e=>Ct(e,decodeURI),aa=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return ir(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},lr=e=>{const t=aa(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ce=(e,t,...a)=>(a.length&&(t=Ce(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ra=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},vt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ct(e,sa):e):e,na=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return vt(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=vt(l)),s=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=vt(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},cr=na,dr=(e,t)=>na(e,t,!0),sa=decodeURIComponent,Pt=e=>Ct(e,sa),Le,q,le,ia,la,Et,ce,Yt,oa=(Yt=class{constructor(e,t="/",a=[[]]){C(this,le);k(this,"raw");C(this,Le);C(this,q);k(this,"routeIndex",0);k(this,"path");k(this,"bodyCache",{});C(this,ce,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,q,a),D(this,Le,{})}param(e){return e?L(this,le,ia).call(this,e):L(this,le,la).call(this)}query(e){return cr(this.url,e)}queries(e){return dr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Za(this,e))}json(){return b(this,ce).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,ce).call(this,"text")}arrayBuffer(){return b(this,ce).call(this,"arrayBuffer")}blob(){return b(this,ce).call(this,"blob")}formData(){return b(this,ce).call(this,"formData")}addValidatedData(e,t){b(this,Le)[e]=t}valid(e){return b(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Xa](){return b(this,q)}get matchedRoutes(){return b(this,q)[0].map(([[,e]])=>e)}get routePath(){return b(this,q)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,q=new WeakMap,le=new WeakSet,ia=function(e){const t=b(this,q)[0][this.routeIndex][1][e],a=L(this,le,Et).call(this,t);return a&&/\%/.test(a)?Pt(a):a},la=function(){const e={},t=Object.keys(b(this,q)[0][this.routeIndex][1]);for(const a of t){const r=L(this,le,Et).call(this,b(this,q)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Pt(r):r)}return e},Et=function(e){return b(this,q)[1]?b(this,q)[1][e]:e},ce=new WeakMap,Yt),ur={Stringify:1},ca=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>ca(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},pr="text/plain; charset=UTF-8",bt=(e,t)=>({"Content-Type":e,...t}),Je,Ye,ne,Ne,se,W,Ve,$e,Me,be,Xe,Ze,de,Re,Vt,mr=(Vt=class{constructor(e,t){C(this,de);C(this,Je);C(this,Ye);k(this,"env",{});C(this,ne);k(this,"finalized",!1);k(this,"error");C(this,Ne);C(this,se);C(this,W);C(this,Ve);C(this,$e);C(this,Me);C(this,be);C(this,Xe);C(this,Ze);k(this,"render",(...e)=>(b(this,$e)??D(this,$e,t=>this.html(t)),b(this,$e).call(this,...e)));k(this,"setLayout",e=>D(this,Ve,e));k(this,"getLayout",()=>b(this,Ve));k(this,"setRenderer",e=>{D(this,$e,e)});k(this,"header",(e,t,a)=>{this.finalized&&D(this,W,new Response(b(this,W).body,b(this,W)));const r=b(this,W)?b(this,W).headers:b(this,be)??D(this,be,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});k(this,"status",e=>{D(this,Ne,e)});k(this,"set",(e,t)=>{b(this,ne)??D(this,ne,new Map),b(this,ne).set(e,t)});k(this,"get",e=>b(this,ne)?b(this,ne).get(e):void 0);k(this,"newResponse",(...e)=>L(this,de,Re).call(this,...e));k(this,"body",(e,t,a)=>L(this,de,Re).call(this,e,t,a));k(this,"text",(e,t,a)=>!b(this,be)&&!b(this,Ne)&&!t&&!a&&!this.finalized?new Response(e):L(this,de,Re).call(this,e,t,bt(pr,a)));k(this,"json",(e,t,a)=>L(this,de,Re).call(this,JSON.stringify(e),t,bt("application/json",a)));k(this,"html",(e,t,a)=>{const r=n=>L(this,de,Re).call(this,n,t,bt("text/html; charset=UTF-8",a));return typeof e=="object"?ca(e,ur.Stringify,!1,{}).then(r):r(e)});k(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});k(this,"notFound",()=>(b(this,Me)??D(this,Me,()=>new Response),b(this,Me).call(this,this)));D(this,Je,e),t&&(D(this,se,t.executionCtx),this.env=t.env,D(this,Me,t.notFoundHandler),D(this,Ze,t.path),D(this,Xe,t.matchResult))}get req(){return b(this,Ye)??D(this,Ye,new oa(b(this,Je),b(this,Ze),b(this,Xe))),b(this,Ye)}get event(){if(b(this,se)&&"respondWith"in b(this,se))return b(this,se);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,se))return b(this,se);throw Error("This context has no ExecutionContext")}get res(){return b(this,W)||D(this,W,new Response(null,{headers:b(this,be)??D(this,be,new Headers)}))}set res(e){if(b(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,W,e),this.finalized=!0}get var(){return b(this,ne)?Object.fromEntries(b(this,ne)):{}}},Je=new WeakMap,Ye=new WeakMap,ne=new WeakMap,Ne=new WeakMap,se=new WeakMap,W=new WeakMap,Ve=new WeakMap,$e=new WeakMap,Me=new WeakMap,be=new WeakMap,Xe=new WeakMap,Ze=new WeakMap,de=new WeakSet,Re=function(e,t,a){const r=b(this,W)?new Headers(b(this,W).headers):b(this,be)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Ne);return new Response(e,{status:n,headers:r})},Vt),P="ALL",hr="all",gr=["get","post","put","delete","options","patch"],da="Can not add a route since the matcher is already built.",ua=class extends Error{},fr="__COMPOSED_HANDLER",yr=e=>e.text("404 Not Found",404),Ut=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Y,U,pa,V,ye,st,ot,Be,vr=(Be=class{constructor(t={}){C(this,U);k(this,"get");k(this,"post");k(this,"put");k(this,"delete");k(this,"options");k(this,"patch");k(this,"all");k(this,"on");k(this,"use");k(this,"router");k(this,"getPath");k(this,"_basePath","/");C(this,Y,"/");k(this,"routes",[]);C(this,V,yr);k(this,"errorHandler",Ut);k(this,"onError",t=>(this.errorHandler=t,this));k(this,"notFound",t=>(D(this,V,t),this));k(this,"fetch",(t,...a)=>L(this,U,ot).call(this,t,a[1],a[0],t.method));k(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ce("/",t)}`,a),r,n)));k(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,U,ot).call(this,t.request,t,void 0,t.request.method))})});[...gr,hr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?D(this,Y,o):L(this,U,ye).call(this,s,b(this,Y),o),i.forEach(l=>{L(this,U,ye).call(this,s,b(this,Y),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){D(this,Y,l);for(const c of[s].flat())i.map(u=>{L(this,U,ye).call(this,c.toUpperCase(),b(this,Y),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?D(this,Y,s):(D(this,Y,"*"),o.unshift(s)),o.forEach(i=>{L(this,U,ye).call(this,P,b(this,Y),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??aa:lr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Ut?s=n.handler:(s=async(i,l)=>(await jt([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[fr]=n.handler),L(o=r,U,ye).call(o,n.method,n.path,s)}),this}basePath(t){const a=L(this,U,pa).call(this);return a._basePath=Ce(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ce(this._basePath,t),c=l==="/"?0:l.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(c)||"/",new Request(h,u)}})());const i=async(l,c)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await c()};return L(this,U,ye).call(this,P,Ce(t,"*"),i),this}},Y=new WeakMap,U=new WeakSet,pa=function(){const t=new Be({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,V,b(this,V)),t.routes=this.routes,t},V=new WeakMap,ye=function(t,a,r){t=t.toUpperCase(),a=Ce(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},st=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},ot=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await L(this,U,ot).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new mr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,V)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await b(this,V).call(this,i)})}catch(u){return L(this,U,st).call(this,u,i)}return c instanceof Promise?c.then(u=>u||(i.finalized?i.res:b(this,V).call(this,i))).catch(u=>L(this,U,st).call(this,u,i)):c??b(this,V).call(this,i)}const l=jt(o[0],this.errorHandler,b(this,V));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return L(this,U,st).call(this,c,i)}})()},Be),ma=[];function br(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[P],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],ma];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var lt="[^/]+",We=".*",qe="(?:|/.*)",Ae=Symbol(),wr=new Set(".\\+*[^]$()");function _r(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===lt?1:t===lt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var we,_e,X,Te,xr=(Te=class{constructor(){C(this,we);C(this,_e);C(this,X,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,we)!==void 0)throw Ae;if(s)return;D(this,we,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",We]:["","",lt]:o==="/*"?["","",qe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let h=l[2]||lt;if(u&&l[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw Ae;if(c=b(this,X)[h],!c){if(Object.keys(b(this,X)).some(y=>y!==We&&y!==qe))throw Ae;if(s)return;c=b(this,X)[h]=new Te,u!==""&&D(c,_e,n.varIndex++)}!s&&u!==""&&r.push([u,b(c,_e)])}else if(c=b(this,X)[o],!c){if(Object.keys(b(this,X)).some(u=>u.length>1&&u!==We&&u!==qe))throw Ae;if(s)return;c=b(this,X)[o]=new Te}c.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,X)).sort(_r).map(r=>{const n=b(this,X)[r];return(typeof b(n,_e)=="number"?`(${r})@${b(n,_e)}`:wr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,we)=="number"&&a.unshift(`#${b(this,we)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},we=new WeakMap,_e=new WeakMap,X=new WeakMap,Te),dt,Qe,Xt,Er=(Xt=class{constructor(){C(this,dt,{varIndex:0});C(this,Qe,new xr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return n[o]=[c,l],o++,i=!0,c}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return b(this,Qe).insert(s,t,r,b(this,dt),a),r}buildRegExp(){let e=b(this,Qe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},dt=new WeakMap,Qe=new WeakMap,Xt),Tr=[/^$/,[],Object.create(null)],it=Object.create(null);function ha(e){return it[e]??(it[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function kr(){it=Object.create(null)}function Sr(e){var c;const t=new Er,a=[];if(e.length===0)return Tr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[y,v])=>u?1:y?-1:h.length-v.length),n=Object.create(null);for(let u=0,h=-1,y=r.length;u<y;u++){const[v,f,x]=r[u];v?n[f]=[x.map(([E])=>[E,Object.create(null)]),ma]:h++;let _;try{_=t.insert(f,h,v)}catch(E){throw E===Ae?new ua(f):E}v||(a[h]=x.map(([E,d])=>{const g=Object.create(null);for(d-=1;d>=0;d--){const[m,p]=_[d];g[m]=p}return[E,g]}))}const[s,o,i]=t.buildRegExp();for(let u=0,h=a.length;u<h;u++)for(let y=0,v=a[u].length;y<v;y++){const f=(c=a[u][y])==null?void 0:c[1];if(!f)continue;const x=Object.keys(f);for(let _=0,E=x.length;_<E;_++)f[x[_]]=i[f[x[_]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ha(a).test(t))return[...e[a]]}}var ue,pe,ut,ga,Zt,Ir=(Zt=class{constructor(){C(this,ut);k(this,"name","RegExpRouter");C(this,ue);C(this,pe);k(this,"match",br);D(this,ue,{[P]:Object.create(null)}),D(this,pe,{[P]:Object.create(null)})}add(e,t,a){var i;const r=b(this,ue),n=b(this,pe);if(!r||!n)throw new Error(da);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(c=>{l[e][c]=[...l[P][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ha(t);e===P?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=De(r[c],t)||De(r[P],t)||[])}):(i=r[e])[t]||(i[t]=De(r[e],t)||De(r[P],t)||[]),Object.keys(r).forEach(c=>{(e===P||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,s])})}),Object.keys(n).forEach(c=>{(e===P||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,s]))});return}const o=ra(t)||[t];for(let l=0,c=o.length;l<c;l++){const u=o[l];Object.keys(n).forEach(h=>{var y;(e===P||e===h)&&((y=n[h])[u]||(y[u]=[...De(r[h],u)||De(r[P],u)||[]]),n[h][u].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,pe)).concat(Object.keys(b(this,ue))).forEach(t=>{e[t]||(e[t]=L(this,ut,ga).call(this,t))}),D(this,ue,D(this,pe,void 0)),kr(),e}},ue=new WeakMap,pe=new WeakMap,ut=new WeakSet,ga=function(e){const t=[];let a=e===P;return[b(this,ue),b(this,pe)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?Sr(t):null},Zt),me,oe,Qt,Dr=(Qt=class{constructor(e){k(this,"name","SmartRouter");C(this,me,[]);C(this,oe,[]);D(this,me,e.routers)}add(e,t,a){if(!b(this,oe))throw new Error(da);b(this,oe).push([e,t,a])}match(e,t){if(!b(this,oe))throw new Error("Fatal error");const a=b(this,me),r=b(this,oe),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof ua)continue;throw l}this.match=i.match.bind(i),D(this,me,[i]),D(this,oe,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,oe)||b(this,me).length!==1)throw new Error("No active router has been determined yet.");return b(this,me)[0]}},me=new WeakMap,oe=new WeakMap,Qt),He=Object.create(null),he,F,xe,je,H,ie,ve,Pe,Or=(Pe=class{constructor(t,a,r){C(this,ie);C(this,he);C(this,F);C(this,xe);C(this,je,0);C(this,H,He);if(D(this,F,r||Object.create(null)),D(this,he,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,he,[n])}D(this,xe,[])}insert(t,a,r){D(this,je,++Bt(this,je)._);let n=this;const s=rr(a),o=[];for(let i=0,l=s.length;i<l;i++){const c=s[i],u=s[i+1],h=or(c,u),y=Array.isArray(h)?h[0]:c;if(y in b(n,F)){n=b(n,F)[y],h&&o.push(h[1]);continue}b(n,F)[y]=new Pe,h&&(b(n,xe).push(h),o.push(h[1])),n=b(n,F)[y]}return b(n,he).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:b(this,je)}}),n}search(t,a){var l;const r=[];D(this,H,He);let s=[this];const o=ta(a),i=[];for(let c=0,u=o.length;c<u;c++){const h=o[c],y=c===u-1,v=[];for(let f=0,x=s.length;f<x;f++){const _=s[f],E=b(_,F)[h];E&&(D(E,H,b(_,H)),y?(b(E,F)["*"]&&r.push(...L(this,ie,ve).call(this,b(E,F)["*"],t,b(_,H))),r.push(...L(this,ie,ve).call(this,E,t,b(_,H)))):v.push(E));for(let d=0,g=b(_,xe).length;d<g;d++){const m=b(_,xe)[d],p=b(_,H)===He?{}:{...b(_,H)};if(m==="*"){const R=b(_,F)["*"];R&&(r.push(...L(this,ie,ve).call(this,R,t,b(_,H))),D(R,H,p),v.push(R));continue}const[w,T,S]=m;if(!h&&!(S instanceof RegExp))continue;const I=b(_,F)[w],A=o.slice(c).join("/");if(S instanceof RegExp){const R=S.exec(A);if(R){if(p[T]=R[0],r.push(...L(this,ie,ve).call(this,I,t,b(_,H),p)),Object.keys(b(I,F)).length){D(I,H,p);const N=((l=R[0].match(/\//))==null?void 0:l.length)??0;(i[N]||(i[N]=[])).push(I)}continue}}(S===!0||S.test(h))&&(p[T]=h,y?(r.push(...L(this,ie,ve).call(this,I,t,p,b(_,H))),b(I,F)["*"]&&r.push(...L(this,ie,ve).call(this,b(I,F)["*"],t,p,b(_,H)))):(D(I,H,p),v.push(I)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},he=new WeakMap,F=new WeakMap,xe=new WeakMap,je=new WeakMap,H=new WeakMap,ie=new WeakSet,ve=function(t,a,r,n){const s=[];for(let o=0,i=b(t,he).length;o<i;o++){const l=b(t,he)[o],c=l[a]||l[P],u={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==He||n&&n!==He))for(let h=0,y=c.possibleKeys.length;h<y;h++){const v=c.possibleKeys[h],f=u[c.score];c.params[v]=n!=null&&n[v]&&!f?n[v]:r[v]??(n==null?void 0:n[v]),u[c.score]=!0}}return s},Pe),Ee,ea,Cr=(ea=class{constructor(){k(this,"name","TrieRouter");C(this,Ee);D(this,Ee,new Or)}add(e,t,a){const r=ra(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ee).insert(e,r[n],a);return}b(this,Ee).insert(e,t,a)}match(e,t){return b(this,Ee).search(e,t)}},Ee=new WeakMap,ea),ge=class extends vr{constructor(e={}){super(e),this.router=e.router??new Dr({routers:[new Ir,new Cr]})}},Rr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(h,y){o.res.headers.set(h,y)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const h=await n(o.req.header("origin")||"",o);h.length&&l("Access-Control-Allow-Methods",h.join(","));let y=a.allowHeaders;if(!(y!=null&&y.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(y=v.split(/\s*,\s*/))}return y!=null&&y.length&&(l("Access-Control-Allow-Headers",y.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function fa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`))}catch{}}}})}}function kt(e,t,a,r){const n=Ke[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new ba(t,s,n.apiBase,a):new wa(t,s,n.apiBase,a)}class _a{constructor(){k(this,"errorLog",new Map);k(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const $r=["llm_slot_1","llm_slot_2","llm_slot_3"],Mr=["anthropic","openai"];async function et(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Lr),n=new _a,s=[];for(const h of $r){const y=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(y)try{const v=await r(y.encrypted_value,a),f=JSON.parse(v);if(f.provider&&f.apiKey&&Ke[f.provider]){const _=f.provider,E=kt(f.provider,f.apiKey,_,f.model);s.push({name:_,provider:E})}}catch(v){console.error(`Failed to load ${h}:`,v)}}const o=new Set(s.map(h=>h.name));for(const h of Mr){if(o.has(h))continue;const y=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(y)try{const v=await r(y.encrypted_value,a);if(Ke[h]){const x=kt(h,v,h);s.push({name:h,provider:x})}}catch{console.error(`Failed to decrypt legacy ${h} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(h=>h.name),l=await n.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const c=s.find(h=>h.name===l);return{provider:Br(c.provider,s,n),rotation:n}}function Br(e,t,a){return t.length<=1?e:{name:e.name,async chat(r,n){try{return await e.chat(r,n)}catch(s){const o=s.message||"";if(!(o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")))throw s;console.warn(`Provider ${e.name} auth/billing error, trying fallback...`),await a.recordError(e.name,o,1440);const l=t.filter(c=>c.name!==e.name);for(const c of l)try{const u=await c.provider.chat(r,n);return this.name=c.name,u}catch(u){const h=u.message||"";if(h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance")||h.includes("properties field not found")){await a.recordError(c.name,h,1440);continue}throw u}throw new Error(`All LLM providers failed. Primary (${e.name}): ${o.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(r,n){return await e.streamChat(r,n)}}}const St=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ba,OpenAICompatibleProvider:wa,ProviderRotation:_a,createProviderFromConfig:kt,createRotatingProvider:et,logError:O},Symbol.toStringTag,{value:"Module"})),wt=20,jr=2e3,Pr=2e3,xa=4;function Ur(e){return Math.ceil(e.length/xa)}function Gt(e,t){const a=t*xa;return e.length<=a?e:e.slice(0,a)+`
...
`),t.trim()}async function Ga(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await mt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async y=>{const v=await Ua(y.link);return{title:y.title,url:y.link,displayLink:y.displayLink,snippet:y.snippet,content:v.text,error:v.error}}),c=(await Promise.all(i)).filter(y=>y.content.length>50);if(c.length===0){const y=s.results.map((f,x)=>`[${x+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await Ht(e,y,t,"snippets"),sources:s.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const u=c.map((y,v)=>`--- SOURCE ${v+1}: ${y.title} (${y.displayLink}) ---
${y.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await Ht(e,u,t,"full"),sources:c.map(y=>({title:y.title,url:y.url})),pagesRead:c.length}}async function Ht(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Ft(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function gt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function ft(e,t,a,r,n,s,o,i,l,c,u){var y,v,f,x,_,E;const h=new K(a);switch(e){case"create_schedule":{const d=new Date;let g;const m=c||"UTC";if(t.schedule_type==="interval"){const p=parseInt(t.schedule_value,10);g=new Date(d.getTime()+p*60*1e3)}else if(t.schedule_type==="daily"){const[p,w]=t.schedule_value.split(":").map(Number),T=d.toLocaleString("en-US",{timeZone:m}),S=new Date(T),I=new Date(S);I.setHours(p,w,0,0),I<=S&&I.setDate(I.getDate()+1);const A=new Date(I.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(I.toLocaleString("en-US",{timeZone:m})),N=A.getTime()-R.getTime();g=new Date(I.getTime()+N)}else if(t.schedule_type==="weekly"){const[p,w]=t.schedule_value.split(" "),[T,S]=(w||"00:00").split(":").map(Number),A=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ie=>Ie.toLowerCase()===p.toLowerCase()),R=d.toLocaleString("en-US",{timeZone:m}),N=new Date(R),$=new Date(N);$.setHours(T,S,0,0);let G=(A-$.getDay()+7)%7;G===0&&$<=N&&(G=7),$.setDate($.getDate()+G);const ke=new Date($.toLocaleString("en-US",{timeZone:"UTC"})),te=new Date($.toLocaleString("en-US",{timeZone:m})),Se=ke.getTime()-te.getTime();g=new Date($.getTime()+Se)}else if(t.schedule_type==="once"){const[p,w]=t.schedule_value.split(" "),[T,S,I]=p.split("-").map(Number),[A,R]=(w||"00:00").split(":").map(Number),N=d.toLocaleString("en-US",{timeZone:m}),$=new Date(N),G=new Date($);G.setFullYear(T,S-1,I),G.setHours(A,R,0,0);const ke=new Date(G.toLocaleString("en-US",{timeZone:"UTC"})),te=new Date(G.toLocaleString("en-US",{timeZone:m})),Se=ke.getTime()-te.getTime();g=new Date(G.getTime()+Se)}else g=new Date(d.getTime()+3600*1e3);return await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new Q(a,r,n,s||"",o||""),g=t.spreadsheet_id;let m=t.range;const p=await d.sheets.getMetadata(g),w=p.sheets;m.includes("!")||(m=`${w[0]}!${m}`);let T;try{T=await d.sheets.readRange(g,m)}catch(I){if((y=I.message)!=null&&y.includes("Unable to parse range")||(v=I.message)!=null&&v.includes("400")){const A=m.includes("!")?m.split("!")[1]:m;m=`${w[0]}!${A}`,T=await d.sheets.readRange(g,m)}else throw I}let S=`[Spreadsheet: "${p.title}" | Reading tab: "${m.split("!")[0]}" | All tabs in this spreadsheet: ${w.map(I=>`"${I}"`).join(", ")}]
...
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(d){return await O(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new Q(a,r,n,s||"",o||""),g=t.calendar_id||"primary",m=t.days_ahead||7,p=new Date,w=new Date(p.getTime()+m*24*60*60*1e3),T=await d.calendar.listEvents(g,{timeMin:p.toISOString(),timeMax:w.toISOString(),query:t.query});return T.length===0?`No events found in the next ${m} days.`:T.map(S=>{var $;const I=S.start.dateTime||S.start.date||"TBD",A=S.end.dateTime||S.end.date||"",R=S.location?` 📍 ${S.location}`:"",N=(($=S.attendees)==null?void 0:$.map(G=>G.email).join(", "))||"";return`• ${S.summary} — ${I} to ${A}${R}${N?`
  Attendees: ${N}`:""}`}).join(`
`)}catch(d){return await O(a,r,"google","list_calendar",d.message),`Failed to list events: ${d.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const d=new Q(a,r,n,s||"",o||""),g=t.calendar_id||"primary",m=await d.calendar.createEvent(g,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${m.summary}"
ID: ${m.id}
Start: ${m.start.dateTime||m.start.date}`}catch(d){return await O(a,r,"google","create_event",d.message),`Failed to create event: ${d.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const d=new Q(a,r,n,s||"",o||"");if(!(await d.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await d.docs.createDocument(t.title);t.content&&await d.docs.appendText(m.documentId,t.content);let p="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>nt)).getGoogleAuth(a,r,n,s||"",o||"");p=`
Folder: "${(await Ft(w,m.documentId,t.folder_name)).folderName}"`}catch(w){p=`
...
— ${T.author} (★${T.rating}, ${T.time}): "${T.text}"`}return w}catch(d){return await O(a,r,"google_api","place_details",d.message),`Place details error: ${d.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),m=await Na(g,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const p=m.route;let w=`**${p.startAddress}** → **${p.endAddress}**
`;return w+=`📏 ${p.distance} · ⏱️ ${p.duration}`,p.durationInTraffic&&(w+=` (with traffic: ${p.durationInTraffic})`),w+=`
via ${p.summary}`,w+=`

Steps:`,p.steps.forEach((T,S)=>{w+=`
${S+1}. ${T.instruction} (${T.distance}, ${T.duration})`}),w}catch(d){return await O(a,r,"google_api","directions",d.message),`Directions error: ${d.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),m=await ja(g,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let p=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(p+=` (with traffic: ${m.durationInTraffic})`),p}catch(d){return await O(a,r,"google_api","travel_time",d.message),`Travel time error: ${d.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),m=await $a(g,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(d){return await O(a,r,"google_api","translate",d.message),`Translation error: ${d.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),m=await Ba(g,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((p,w)=>{var T;return`${w+1}. **${p.title}**
   ${p.channelTitle} · ${((T=p.publishedAt)==null?void 0:T.split("T")[0])||""}
   ${p.description}
   ${p.url}`}).join(`

`)}catch(d){return await O(a,r,"google_api","youtube_search",d.message),`YouTube search error: ${d.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const d=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!d)return"Google API Key not configured.";const g=await M(d.encrypted_value,n),m=await Ma(g,t.address);return m.error?`Geocoding failed: ${m.error}`:m.results.length===0?`Location not found: "${t.address}"`:m.results.map((p,w)=>`${w+1}. ${p.address}
   Coordinates: ${p.lat}, ${p.lng}`).join(`
`)}catch(d){return await O(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Dt(e,t,a,r,n,s){var x;const o=new K(t),i=(x=e.metadata)==null?void 0:x.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),h=[{role:"system",content:Wa(r,l)},...c.map(_=>({role:_.role,content:_.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const y=10;let v="",f=0;for(let _=0;_<y;_++)try{const E=await a.chat(h,{tools:ht});if(E.usage&&(f+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){E.content&&h.push({role:"assistant",content:E.content});for(const d of E.toolCalls)try{const g=await ft(d.name,d.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);h.push({role:"user",content:`[Tool Result for ${d.name}]: ${g}`})}catch(g){await O(t,r.id,"tool",d.name,g.message||"Tool execution failed"),h.push({role:"user",content:`[Tool Error for ${d.name}]: ${g.message||"Execution failed"}`})}continue}v=E.content;break}catch(E){if(n){const d=E.message||"",g=d.includes("401")||d.includes("403")||d.includes("authentication")||d.includes("credit balance"),m=d.includes("429"),p=g?1440:m?10:5;await n.recordError(a.name,d,p)}throw await O(t,r.id,"llm","provider_error",E.message||"Unknown LLM error",{provider:a.name,turn:_}),E}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}return await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),v}const Wt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function rn(e){for(const[t,a]of Object.entries(Wt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Wt.default}function nn(e,t,a,r){const n=rn(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const c=xt(e);o.push({role:"system",content:e}),i+=c;const u=xt(a);i+=u;const h=s-i,y=[];let v=0;for(let f=t.length-1;f>=0;f--){const x=t[f],_=xt(x.content);if(v+_<=h)y.unshift({role:x.role,content:x.content}),v+=_;else{l=!0;break}}return o.push(...y),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*sn(e,t,a,r,n,s){var _;const o=new K(t),i=(_=e.metadata)==null?void 0:_.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),u=Wa(r,l),h=nn(u,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const y=10;let v="",f=0;const x=[...h.messages];for(let E=0;E<y;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:ht});if(d.usage&&(f+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const m of d.toolCalls){yield{type:"tool_start",data:{tool:m.name,toolArgs:m.arguments,threadId:i}};try{const p=await ft(m.name,m.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:m.name,toolResult:p.substring(0,500)+(p.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${m.name}]: ${p}`})}catch(p){await O(t,r.id,"tool",m.name,p.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:m.name,toolResult:`Error: ${p.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${m.name}]: ${p.message||"Execution failed"}`})}}continue}v=d.content;const g=50;for(let m=0;m<v.length;m+=g)yield{type:"chunk",data:{text:v.substring(m,m+g),threadId:i}},m+g<v.length&&await new Promise(w=>setTimeout(w,10));break}catch(d){if(n){const g=d.message||"",m=g.includes("401")||g.includes("403")||g.includes("authentication")||g.includes("credit balance"),p=g.includes("429"),w=m?1440:p?10:5;await n.recordError(a.name,g,w)}await O(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function $t(e,t,a,r,n,s){var u;const o=new K(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=Ha(e.text,l);if(c.agent==="conversation")return ln(e,t,a,r,l,n,i);if(c.agent==="multi"||c.confidence<.5)return Dt(e,t,a,r,n,s);try{return await on(c.agent,e,t,a,r,l,n,s,i)}catch(h){return await O(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${h.message}`,{route:c}),Dt(e,t,a,r,n,s)}}async function on(e,t,a,r,n,s,o,i,l){const c=new K(a),u=gt(n.timezone),h=ct(e,n,s,n.timezone,u),y=za(e,ht),v=await c.getRecentConversations(n.id,25,l),f=[{role:"system",content:h},...v.map(g=>({role:g.role,content:g.content})),{role:"user",content:t.text}];await c.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const x=10;let _="",E=0,d="";for(let g=0;g<x;g++)try{const m=await r.chat(f,{tools:y.length>0?y:void 0});if(m.usage&&(E+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){m.content&&(d=m.content,f.push({role:"assistant",content:m.content}));for(const p of m.toolCalls)try{const w=await ft(p.name,p.arguments,a,n.id,n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${p.name}]: ${w}`})}catch(w){await O(a,n.id,"tool",p.name,w.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${p.name}]: ${w.message||"Execution failed"}`})}continue}_=m.content,!_&&d&&(_=d);break}catch(m){if(o){const p=m.message||"",w=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),T=p.includes("429"),S=w?1440:T?10:5;await o.recordError(r.name,p,S)}throw await O(a,n.id,"llm","subagent_error",m.message||"Unknown error",{agent:e,provider:r.name,turn:g}),m}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}return await c.storeMessage(n.id,t.channel,"assistant",_,"{}",l),await c.compactHistory(n.id,30),_}async function ln(e,t,a,r,n,s,o){const i=new K(t),l=gt(r.timezone),c=ct("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),h=[{role:"system",content:c},...u.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let y=0,v="";try{const f=await a.chat(h,{temperature:.8});f.usage&&(y=f.usage.promptTokens+f.usage.completionTokens),v=f.content}catch(f){if(s){const x=f.message||"",_=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),E=x.includes("429"),d=_?1440:E?10:5;await s.recordError(a.name,x,d)}throw await O(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(s&&y>0)try{await s.recordUsage(a.name,y)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*cn(e,t,a,r,n,s){var d;const o=new K(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=Ha(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*sn(e,t,a,r,n,s);return}const u=gt(r.timezone),h=c.agent==="conversation"?ct("conversation",r,l,r.timezone,u):ct(c.agent,r,l,r.timezone,u),y=za(c.agent,ht),v=await o.getRecentConversations(r.id,25,i),f=[{role:"system",content:h},...v.map(g=>({role:g.role,content:g.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let _="",E=0;for(let g=0;g<x;g++)try{g>0&&(yield{type:"thinking",data:{threadId:i}});const m=await a.chat(f,{tools:y.length>0?y:void 0});if(m.usage&&(E+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){m.content&&(yield{type:"chunk",data:{text:m.content,threadId:i}},f.push({role:"assistant",content:m.content}));for(const w of m.toolCalls){yield{type:"tool_start",data:{tool:w.name,toolArgs:w.arguments,threadId:i}};try{const T=await ft(w.name,w.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:w.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},f.push({role:"user",content:`[Tool Result for ${w.name}]: ${T}`})}catch(T){await O(t,r.id,"tool",w.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:w.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},f.push({role:"user",content:`[Tool Error for ${w.name}]: ${T.message||"Execution failed"}`})}}continue}_=m.content;const p=50;for(let w=0;w<_.length;w+=p)yield{type:"chunk",data:{text:_.substring(w,w+p),threadId:i}},w+p<_.length&&await new Promise(S=>setTimeout(S,10));break}catch(m){if(n){const p=m.message||"",w=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),T=p.includes("429"),S=w?1440:T?10:5;await n.recordError(a.name,p,S)}await O(t,r.id,"llm","subagent_stream_error",m.message||"Unknown error",{agent:c.agent,provider:a.name,turn:g}),yield{type:"error",data:{error:m.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",_,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const B=new ge;async function dn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
...
`;for(const c of s)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:u}=await et(e.env.DB,t.id,t.pin_hash),h=new ReadableStream({async start(y){const v=new TextEncoder;try{const f=cn(l,e.env.DB,c,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of f)x.data.threadId||(x.data.threadId=i),y.enqueue(v.encode(qt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),y.close()}catch(f){const x={type:"error",data:{error:f.message||"An error occurred",threadId:i}};y.enqueue(v.encode(qt(x))),y.close()}}});return new Response(h,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const u=c.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});B.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.) and present the results as a concise plain-text summary.`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}. Respond with a short, clean plain-text summary.`}function hn(e,t,a,r){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${r}`,timestamp:new Date().toISOString()}}function gn(e,t){return e.replace(/\*\*(.*?)\*\*/g,"*$1*").replace(/#{1,3}\s/g,"*").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const tt=new ge,fn=4e3;async function z(e,t,a,r="Markdown"){var s,o;const n=vn(a,fn);for(const i of n)try{const l=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i,parse_mode:r,disable_web_page_preview:!1})});if(!l.ok){const c=await l.json().catch(()=>null);((s=c==null?void 0:c.description)!=null&&s.includes("parse")||(o=c==null?void 0:c.description)!=null&&o.includes("entities"))&&await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:i})})}}catch{}}async function yn(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function vn(e,t){if(e.length<=t)return[e];const a=[];let r=e;for(;r.length>0;){if(r.length<=t){a.push(r);break}let n=r.lastIndexOf(`
`,t);n<t*.3&&(n=r.lastIndexOf(" ",t)),n<t*.3&&(n=t),a.push(r.substring(0,n)),r=r.substring(n).trimStart()}return a}async function bn(e,t,a,r,n){switch(e.split("@")[0].toLowerCase()){case"/start":{const o=(r==null?void 0:r.name)||"there",i=(r==null?void 0:r.assistant_name)||"Karna",l=`👋 *Hello, ${o}!*
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(p){if(y&&i.caption)f=i.caption;else return await z(_,v,`⚠️ Received your file but couldn't process it: ${p.message}`),e.json({ok:!0})}if(!f)return e.json({ok:!0});await yn(_,v);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=hn(x.id,x.username,f,v);d.metadata={thread_id:E.id};let g,m;try{const p=await et(e.env.DB,x.id,x.pin_hash);g=p.provider,m=p.rotation}catch(p){console.error("Telegram provider setup error:",p);const w=(r=p.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(n=p.message)!=null&&n.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${p.message||"Unknown error"}`;return await z(_,v,w),e.json({ok:!0})}try{const p=await $t(d,e.env.DB,g,x,m,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),w=gn(p,"telegram");await z(_,v,w||"(empty response)")}catch(p){console.error("Telegram agent error:",p);const w=(s=p.message)!=null&&s.includes("API error")?`⚠️ AI provider returned an error. The provider (${g.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(p.message||"Unknown").substring(0,200)}`;await z(_,v,w);try{const{logError:T}=await Promise.resolve().then(()=>St);await T(e.env.DB,x.id,"telegram","agent_error",p.message||"Agent error",{provider:g.name})}catch{}}return e.json({ok:!0})}catch(o){console.error("Telegram webhook error:",o);try{const{logError:i}=await Promise.resolve().then(()=>St);await i(e.env.DB,null,"telegram","webhook_error",o.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:o.message})}});tt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
...
`)}function In(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function Dn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function qa(e,t,a){var E;const r=t.timezone||"Asia/Kolkata",n=_n(r),{components:s,newsTopics:o}=await Dn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(xn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(En(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(Tn(e,t.id)),l.push("tasks")),s.news&&(i.push(kn(o)),l.push("news"));const c=await Promise.all(i),u={};l.forEach((d,g)=>{u[d]=c[g]});const h={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},y={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((E=u.googleEvents)==null?void 0:E.length)||0},emails:{gmail:u.gmailSummary||h},tasks:u.tasks||y,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};v.summary=Sn(v);const f=In(v),x=await e.prepare(`
  ...
  `).bind(t.id,JSON.stringify(v)).first(),_=(x==null?void 0:x.id)||0;for(const d of f)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(_,d.type,d.key,d.text,JSON.stringify(d.metadata),d.sortOrder).run();return{briefingId:_,content:v,items:f}}async function On(e,t,a){const r=await e.prepare(`
...
${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}J.delete("/briefings/:id",Ka,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const Z=new ge;Z.use("/api/*",Rr());Z.route("/api/auth",fe);Z.route("/api/chat",B);Z.route("/api/settings",j);Z.route("/api/system",Ge);Z.route("/api/telegram",tt);Z.route("/api/proactive",J);Z.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Oe(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Oe(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Oe(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Oe(!1,"Session expired. Please log in again and retry."));const l=i.user_id,c=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,h=await Da(e.env.DB,l,c,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Oe(!0,`Connected as ${h.email}`,h.email))}catch(s){return e.html(Oe(!1,`OAuth failed: ${s.message}`))}});Z.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(fa())));Z.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(fa())));function Oe(e,t,a){return`<!DOCTYPE html>
