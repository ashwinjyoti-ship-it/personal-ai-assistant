var nr=Object.defineProperty;var Pt=e=>{throw TypeError(e)};var sr=(e,t,a)=>t in e?nr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var k=(e,t,a)=>sr(e,typeof t!="symbol"?t+"":t,a),wt=(e,t,a)=>t.has(e)||Pt("Cannot "+a);var b=(e,t,a)=>(wt(e,t,"read from private field"),a?a.call(e):t.get(e)),N=(e,t,a)=>t.has(e)?Pt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),C=(e,t,a,r)=>(wt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),$=(e,t,a)=>(wt(e,t,"access private method"),a);var Ut=(e,t,a,r)=>({set _(n){C(e,t,n,a)},get _(){return b(e,t,r)}});var Ht=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,c=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(h){if(h instanceof Error&&t)r.error=h,l=await t(h,r),c=!0;else throw h}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},or=Symbol(),ir=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ua?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?lr(e,{all:a,dot:r}):{}};async function lr(e,t){const a=await e.formData();return a?cr(a,t):{}}function cr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?dr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(ur(a,r,n),delete a[r])}),a}var dr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ur=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},oa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},pr=e=>{const{groups:t,path:a}=mr(e),r=oa(a);return hr(r,t)},mr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},hr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},nt={},gr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return nt[r]||(a[2]?nt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:nt[r]=[e,a[1],!0]),nt[r]}return null},Nt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},fr=e=>Nt(e,decodeURI),ia=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return fr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},yr=e=>{const t=ia(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Re=(e,t,...a)=>(a.length&&(t=Re(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),la=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},_t=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Nt(e,da):e):e,ca=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return _t(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=_t(l)),s=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=_t(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},vr=ca,br=(e,t)=>ca(e,t,!0),da=decodeURIComponent,Gt=e=>Nt(e,da),$e,V,ue,pa,ma,It,me,ea,ua=(ea=class{constructor(e,t="/",a=[[]]){N(this,ue);k(this,"raw");N(this,$e);N(this,V);k(this,"routeIndex",0);k(this,"path");k(this,"bodyCache",{});N(this,me,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,C(this,V,a),C(this,$e,{})}param(e){return e?$(this,ue,pa).call(this,e):$(this,ue,ma).call(this)}query(e){return vr(this.url,e)}queries(e){return br(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ir(this,e))}json(){return b(this,me).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,me).call(this,"text")}arrayBuffer(){return b(this,me).call(this,"arrayBuffer")}blob(){return b(this,me).call(this,"blob")}formData(){return b(this,me).call(this,"formData")}addValidatedData(e,t){b(this,$e)[e]=t}valid(e){return b(this,$e)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[or](){return b(this,V)}get matchedRoutes(){return b(this,V)[0].map(([[,e]])=>e)}get routePath(){return b(this,V)[0].map(([[,e]])=>e)[this.routeIndex].path}},$e=new WeakMap,V=new WeakMap,ue=new WeakSet,pa=function(e){const t=b(this,V)[0][this.routeIndex][1][e],a=$(this,ue,It).call(this,t);return a&&/\%/.test(a)?Gt(a):a},ma=function(){const e={},t=Object.keys(b(this,V)[0][this.routeIndex][1]);for(const a of t){const r=$(this,ue,It).call(this,b(this,V)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Gt(r):r)}return e},It=function(e){return b(this,V)[1]?b(this,V)[1][e]:e},me=new WeakMap,ea),wr={Stringify:1},ha=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>ha(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},_r="text/plain; charset=UTF-8",xt=(e,t)=>({"Content-Type":e,...t}),Ve,Xe,ie,Me,le,K,Ze,Be,je,Ee,Qe,et,he,Ae,ta,xr=(ta=class{constructor(e,t){N(this,he);N(this,Ve);N(this,Xe);k(this,"env",{});N(this,ie);k(this,"finalized",!1);k(this,"error");N(this,Me);N(this,le);N(this,K);N(this,Ze);N(this,Be);N(this,je);N(this,Ee);N(this,Qe);N(this,et);k(this,"render",(...e)=>(b(this,Be)??C(this,Be,t=>this.html(t)),b(this,Be).call(this,...e)));k(this,"setLayout",e=>C(this,Ze,e));k(this,"getLayout",()=>b(this,Ze));k(this,"setRenderer",e=>{C(this,Be,e)});k(this,"header",(e,t,a)=>{this.finalized&&C(this,K,new Response(b(this,K).body,b(this,K)));const r=b(this,K)?b(this,K).headers:b(this,Ee)??C(this,Ee,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});k(this,"status",e=>{C(this,Me,e)});k(this,"set",(e,t)=>{b(this,ie)??C(this,ie,new Map),b(this,ie).set(e,t)});k(this,"get",e=>b(this,ie)?b(this,ie).get(e):void 0);k(this,"newResponse",(...e)=>$(this,he,Ae).call(this,...e));k(this,"body",(e,t,a)=>$(this,he,Ae).call(this,e,t,a));k(this,"text",(e,t,a)=>!b(this,Ee)&&!b(this,Me)&&!t&&!a&&!this.finalized?new Response(e):$(this,he,Ae).call(this,e,t,xt(_r,a)));k(this,"json",(e,t,a)=>$(this,he,Ae).call(this,JSON.stringify(e),t,xt("application/json",a)));k(this,"html",(e,t,a)=>{const r=n=>$(this,he,Ae).call(this,n,t,xt("text/html; charset=UTF-8",a));return typeof e=="object"?ha(e,wr.Stringify,!1,{}).then(r):r(e)});k(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});k(this,"notFound",()=>(b(this,je)??C(this,je,()=>new Response),b(this,je).call(this,this)));C(this,Ve,e),t&&(C(this,le,t.executionCtx),this.env=t.env,C(this,je,t.notFoundHandler),C(this,et,t.path),C(this,Qe,t.matchResult))}get req(){return b(this,Xe)??C(this,Xe,new ua(b(this,Ve),b(this,et),b(this,Qe))),b(this,Xe)}get event(){if(b(this,le)&&"respondWith"in b(this,le))return b(this,le);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,le))return b(this,le);throw Error("This context has no ExecutionContext")}get res(){return b(this,K)||C(this,K,new Response(null,{headers:b(this,Ee)??C(this,Ee,new Headers)}))}set res(e){if(b(this,K)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,K).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,K).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}C(this,K,e),this.finalized=!0}get var(){return b(this,ie)?Object.fromEntries(b(this,ie)):{}}},Ve=new WeakMap,Xe=new WeakMap,ie=new WeakMap,Me=new WeakMap,le=new WeakMap,K=new WeakMap,Ze=new WeakMap,Be=new WeakMap,je=new WeakMap,Ee=new WeakMap,Qe=new WeakMap,et=new WeakMap,he=new WeakSet,Ae=function(e,t,a){const r=b(this,K)?new Headers(b(this,K).headers):b(this,Ee)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Me);return new Response(e,{status:n,headers:r})},ta),H="ALL",Er="all",Tr=["get","post","put","delete","options","patch"],ga="Can not add a route since the matcher is already built.",fa=class extends Error{},kr="__COMPOSED_HANDLER",Sr=e=>e.text("404 Not Found",404),zt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,G,ya,ee,_e,it,lt,Pe,Ir=(Pe=class{constructor(t={}){N(this,G);k(this,"get");k(this,"post");k(this,"put");k(this,"delete");k(this,"options");k(this,"patch");k(this,"all");k(this,"on");k(this,"use");k(this,"router");k(this,"getPath");k(this,"_basePath","/");N(this,Q,"/");k(this,"routes",[]);N(this,ee,Sr);k(this,"errorHandler",zt);k(this,"onError",t=>(this.errorHandler=t,this));k(this,"notFound",t=>(C(this,ee,t),this));k(this,"fetch",(t,...a)=>$(this,G,lt).call(this,t,a[1],a[0],t.method));k(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Re("/",t)}`,a),r,n)));k(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith($(this,G,lt).call(this,t.request,t,void 0,t.request.method))})});[...Tr,Er].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?C(this,Q,o):$(this,G,_e).call(this,s,b(this,Q),o),i.forEach(l=>{$(this,G,_e).call(this,s,b(this,Q),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){C(this,Q,l);for(const c of[s].flat())i.map(u=>{$(this,G,_e).call(this,c.toUpperCase(),b(this,Q),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?C(this,Q,s):(C(this,Q,"*"),o.unshift(s)),o.forEach(i=>{$(this,G,_e).call(this,H,b(this,Q),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ia:yr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===zt?s=n.handler:(s=async(i,l)=>(await Ht([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[kr]=n.handler),$(o=r,G,_e).call(o,n.method,n.path,s)}),this}basePath(t){const a=$(this,G,ya).call(this);return a._basePath=Re(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Re(this._basePath,t),c=l==="/"?0:l.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(c)||"/",new Request(h,u)}})());const i=async(l,c)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await c()};return $(this,G,_e).call(this,H,Re(t,"*"),i),this}},Q=new WeakMap,G=new WeakSet,ya=function(){const t=new Pe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,C(t,ee,b(this,ee)),t.routes=this.routes,t},ee=new WeakMap,_e=function(t,a,r){t=t.toUpperCase(),a=Re(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},it=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},lt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await $(this,G,lt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new xr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:b(this,ee)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await b(this,ee).call(this,i)})}catch(u){return $(this,G,it).call(this,u,i)}return c instanceof Promise?c.then(u=>u||(i.finalized?i.res:b(this,ee).call(this,i))).catch(u=>$(this,G,it).call(this,u,i)):c??b(this,ee).call(this,i)}const l=Ht(o[0],this.errorHandler,b(this,ee));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return $(this,G,it).call(this,c,i)}})()},Pe),va=[];function Or(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[H],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],va];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var dt="[^/]+",Ke=".*",Ye="(?:|/.*)",Ne=Symbol(),Dr=new Set(".\\+*[^]$()");function Cr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ke||e===Ye?1:t===Ke||t===Ye?-1:e===dt?1:t===dt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Te,ke,te,Oe,Rr=(Oe=class{constructor(){N(this,Te);N(this,ke);N(this,te,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Te)!==void 0)throw Ne;if(s)return;C(this,Te,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Ke]:["","",dt]:o==="/*"?["","",Ye]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let h=l[2]||dt;if(u&&l[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw Ne;if(c=b(this,te)[h],!c){if(Object.keys(b(this,te)).some(f=>f!==Ke&&f!==Ye))throw Ne;if(s)return;c=b(this,te)[h]=new Oe,u!==""&&C(c,ke,n.varIndex++)}!s&&u!==""&&r.push([u,b(c,ke)])}else if(c=b(this,te)[o],!c){if(Object.keys(b(this,te)).some(u=>u.length>1&&u!==Ke&&u!==Ye))throw Ne;if(s)return;c=b(this,te)[o]=new Oe}c.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,te)).sort(Cr).map(r=>{const n=b(this,te)[r];return(typeof b(n,ke)=="number"?`(${r})@${b(n,ke)}`:Dr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Te)=="number"&&a.unshift(`#${b(this,Te)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Te=new WeakMap,ke=new WeakMap,te=new WeakMap,Oe),pt,tt,aa,Ar=(aa=class{constructor(){N(this,pt,{varIndex:0});N(this,tt,new Rr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return n[o]=[c,l],o++,i=!0,c}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return b(this,tt).insert(s,t,r,b(this,pt),a),r}buildRegExp(){let e=b(this,tt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},pt=new WeakMap,tt=new WeakMap,aa),Nr=[/^$/,[],Object.create(null)],ct=Object.create(null);function ba(e){return ct[e]??(ct[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Lr(){ct=Object.create(null)}function $r(e){var c;const t=new Ar,a=[];if(e.length===0)return Nr;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[f,v])=>u?1:f?-1:h.length-v.length),n=Object.create(null);for(let u=0,h=-1,f=r.length;u<f;u++){const[v,g,x]=r[u];v?n[g]=[x.map(([E])=>[E,Object.create(null)]),va]:h++;let w;try{w=t.insert(g,h,v)}catch(E){throw E===Ne?new fa(g):E}v||(a[h]=x.map(([E,d])=>{const y=Object.create(null);for(d-=1;d>=0;d--){const[p,m]=w[d];y[p]=m}return[E,y]}))}const[s,o,i]=t.buildRegExp();for(let u=0,h=a.length;u<h;u++)for(let f=0,v=a[u].length;f<v;f++){const g=(c=a[u][f])==null?void 0:c[1];if(!g)continue;const x=Object.keys(g);for(let w=0,E=x.length;w<E;w++)g[x[w]]=i[g[x[w]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ba(a).test(t))return[...e[a]]}}var ge,fe,mt,wa,ra,Mr=(ra=class{constructor(){N(this,mt);k(this,"name","RegExpRouter");N(this,ge);N(this,fe);k(this,"match",Or);C(this,ge,{[H]:Object.create(null)}),C(this,fe,{[H]:Object.create(null)})}add(e,t,a){var i;const r=b(this,ge),n=b(this,fe);if(!r||!n)throw new Error(ga);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[H]).forEach(c=>{l[e][c]=[...l[H][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ba(t);e===H?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=De(r[c],t)||De(r[H],t)||[])}):(i=r[e])[t]||(i[t]=De(r[e],t)||De(r[H],t)||[]),Object.keys(r).forEach(c=>{(e===H||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,s])})}),Object.keys(n).forEach(c=>{(e===H||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,s]))});return}const o=la(t)||[t];for(let l=0,c=o.length;l<c;l++){const u=o[l];Object.keys(n).forEach(h=>{var f;(e===H||e===h)&&((f=n[h])[u]||(f[u]=[...De(r[h],u)||De(r[H],u)||[]]),n[h][u].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,fe)).concat(Object.keys(b(this,ge))).forEach(t=>{e[t]||(e[t]=$(this,mt,wa).call(this,t))}),C(this,ge,C(this,fe,void 0)),Lr(),e}},ge=new WeakMap,fe=new WeakMap,mt=new WeakSet,wa=function(e){const t=[];let a=e===H;return[b(this,ge),b(this,fe)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==H&&t.push(...Object.keys(r[H]).map(s=>[s,r[H][s]]))}),a?$r(t):null},ra),ye,ce,na,Br=(na=class{constructor(e){k(this,"name","SmartRouter");N(this,ye,[]);N(this,ce,[]);C(this,ye,e.routers)}add(e,t,a){if(!b(this,ce))throw new Error(ga);b(this,ce).push([e,t,a])}match(e,t){if(!b(this,ce))throw new Error("Fatal error");const a=b(this,ye),r=b(this,ce),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof fa)continue;throw l}this.match=i.match.bind(i),C(this,ye,[i]),C(this,ce,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ce)||b(this,ye).length!==1)throw new Error("No active router has been determined yet.");return b(this,ye)[0]}},ye=new WeakMap,ce=new WeakMap,na),ze=Object.create(null),ve,q,Se,Ue,F,de,xe,He,jr=(He=class{constructor(t,a,r){N(this,de);N(this,ve);N(this,q);N(this,Se);N(this,Ue,0);N(this,F,ze);if(C(this,q,r||Object.create(null)),C(this,ve,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},C(this,ve,[n])}C(this,Se,[])}insert(t,a,r){C(this,Ue,++Ut(this,Ue)._);let n=this;const s=pr(a),o=[];for(let i=0,l=s.length;i<l;i++){const c=s[i],u=s[i+1],h=gr(c,u),f=Array.isArray(h)?h[0]:c;if(f in b(n,q)){n=b(n,q)[f],h&&o.push(h[1]);continue}b(n,q)[f]=new He,h&&(b(n,Se).push(h),o.push(h[1])),n=b(n,q)[f]}return b(n,ve).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:b(this,Ue)}}),n}search(t,a){var l;const r=[];C(this,F,ze);let s=[this];const o=oa(a),i=[];for(let c=0,u=o.length;c<u;c++){const h=o[c],f=c===u-1,v=[];for(let g=0,x=s.length;g<x;g++){const w=s[g],E=b(w,q)[h];E&&(C(E,F,b(w,F)),f?(b(E,q)["*"]&&r.push(...$(this,de,xe).call(this,b(E,q)["*"],t,b(w,F))),r.push(...$(this,de,xe).call(this,E,t,b(w,F)))):v.push(E));for(let d=0,y=b(w,Se).length;d<y;d++){const p=b(w,Se)[d],m=b(w,F)===ze?{}:{...b(w,F)};if(p==="*"){const I=b(w,q)["*"];I&&(r.push(...$(this,de,xe).call(this,I,t,b(w,F))),C(I,F,m),v.push(I));continue}const[_,T,S]=p;if(!h&&!(S instanceof RegExp))continue;const O=b(w,q)[_],L=o.slice(c).join("/");if(S instanceof RegExp){const I=S.exec(L);if(I){if(m[T]=I[0],r.push(...$(this,de,xe).call(this,O,t,b(w,F),m)),Object.keys(b(O,q)).length){C(O,F,m);const D=((l=I[0].match(/\//))==null?void 0:l.length)??0;(i[D]||(i[D]=[])).push(O)}continue}}(S===!0||S.test(h))&&(m[T]=h,f?(r.push(...$(this,de,xe).call(this,O,t,m,b(w,F))),b(O,q)["*"]&&r.push(...$(this,de,xe).call(this,b(O,q)["*"],t,m,b(w,F)))):(C(O,F,m),v.push(O)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},ve=new WeakMap,q=new WeakMap,Se=new WeakMap,Ue=new WeakMap,F=new WeakMap,de=new WeakSet,xe=function(t,a,r,n){const s=[];for(let o=0,i=b(t,ve).length;o<i;o++){const l=b(t,ve)[o],c=l[a]||l[H],u={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==ze||n&&n!==ze))for(let h=0,f=c.possibleKeys.length;h<f;h++){const v=c.possibleKeys[h],g=u[c.score];c.params[v]=n!=null&&n[v]&&!g?n[v]:r[v]??(n==null?void 0:n[v]),u[c.score]=!0}}return s},He),Ie,sa,Pr=(sa=class{constructor(){k(this,"name","TrieRouter");N(this,Ie);C(this,Ie,new jr)}add(e,t,a){const r=la(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ie).insert(e,r[n],a);return}b(this,Ie).insert(e,t,a)}match(e,t){return b(this,Ie).search(e,t)}},Ie=new WeakMap,sa),be=class extends Ir{constructor(e={}){super(e),this.router=e.router??new Br({routers:[new Mr,new Pr]})}},Ur=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(h,f){o.res.headers.set(h,f)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const h=await n(o.req.header("origin")||"",o);h.length&&l("Access-Control-Allow-Methods",h.join(","));let f=a.allowHeaders;if(!(f!=null&&f.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(f=v.split(/\s*,\s*/))}return f!=null&&f.length&&(l("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function _a(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <\/script>
     ...
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();return a?e.json({user:{id:a.uid,username:a.username,name:a.name,role:a.role,timezone:a.timezone}}):e.json({error:"Invalid or expired session"},401)});const Je={anthropic:{id:"anthropic",label:"Anthropic Claude",apiBase:"https://api.anthropic.com",apiFormat:"anthropic",defaultModel:"claude-sonnet-4-20250514",keyPlaceholder:"sk-ant-api03-...",modelHint:"claude-sonnet-4-20250514, claude-haiku-4-20250514",validatePath:"/v1/messages"},openai:{id:"openai",label:"OpenAI GPT",apiBase:"https://api.openai.com",apiFormat:"openai-compatible",defaultModel:"gpt-4o",keyPlaceholder:"sk-...",modelHint:"gpt-4o, gpt-4o-mini, o3-mini",validatePath:"/v1/models"},grok:{id:"grok",label:"xAI Grok",apiBase:"https://api.x.ai",apiFormat:"openai-compatible",defaultModel:"grok-3-mini",keyPlaceholder:"xai-...",modelHint:"grok-3-mini, grok-3",validatePath:"/v1/models"},deepseek:{id:"deepseek",label:"DeepSeek",apiBase:"https://api.deepseek.com",apiFormat:"openai-compatible",defaultModel:"deepseek-chat",keyPlaceholder:"sk-...",modelHint:"deepseek-chat, deepseek-reasoner",validatePath:"/v1/models"},gemini:{id:"gemini",label:"Google Gemini",apiBase:"https://generativelanguage.googleapis.com/v1beta/openai",apiFormat:"openai-compatible",defaultModel:"gemini-2.0-flash",keyPlaceholder:"AIzaSy...",modelHint:"gemini-2.0-flash, gemini-2.5-pro-preview",validatePath:"/models"},openrouter:{id:"openrouter",label:"OpenRouter",apiBase:"https://openrouter.ai/api",apiFormat:"openai-compatible",defaultModel:"anthropic/claude-sonnet-4",keyPlaceholder:"sk-or-...",modelHint:"e.g. deepseek/deepseek-chat, meta-llama/llama-3.1-70b",validatePath:"/v1/models"},abacus:{id:"abacus",label:"Abacus AI (RouteLLM)",apiBase:"https://routellm.abacus.ai",apiFormat:"openai-compatible",defaultModel:"route-llm",keyPlaceholder:"Your Abacus API key",modelHint:"route-llm (auto), grok-4, deepseek-v3.2, claude-4-5-sonnet, gemini-3-flash",validatePath:"/v1/models"}};async function A(e,t,a,r,n,s={}){try{await e.prepare("INSERT INTO error_log (user_id, source, error_type, message, details) VALUES (?, ?, ?, ?, ?)").bind(t,a,r,n,JSON.stringify(s)).run()}catch(o){console.error("Failed to log error:",o)}}async function Et(e,t,a,r,n,s){try{const o=`provider_alert:${r}:${a}`;if(await e.prepare(`SELECT id FROM error_log WHERE user_id = ? AND source = 'provider_alert'
       AND error_type = ? AND created_at > datetime('now', '-1 hour') LIMIT 1`).bind(t,o).first())return;await A(e,t,"provider_alert",o,`${r} failed: ${s.substring(0,200)}`,{alertType:a,failedProvider:r,fallbackProvider:n});let l;a==="all_providers_down"?l=`🚨 All LLM providers failed
...
`))}catch{}}}})}}function Dt(e,t,a,r){const n=Je[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=r||n.defaultModel;return n.apiFormat==="anthropic"?new ka(t,s,n.apiBase,a):new Sa(t,s,n.apiBase,a)}class Ia{constructor(){k(this,"errorLog",new Map);k(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),r=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=a:!0});return r.length>0?r[0]:null}async recordUsage(t,a){const r=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:r.tokens+a,requests:r.requests+1})}async recordError(t,a,r=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+r*60*1e3})}}const zr=["llm_slot_1","llm_slot_2","llm_slot_3"],Fr=["anthropic","openai"];async function at(e,t,a){const{decrypt:r}=await Promise.resolve().then(()=>Ta),n=new Ia,s=[];for(const h of zr){const f=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(f)try{const v=await r(f.encrypted_value,a),g=JSON.parse(v);if(g.provider&&g.apiKey&&Je[g.provider]){const w=g.provider,E=Dt(g.provider,g.apiKey,w,g.model);s.push({name:w,provider:E})}}catch(v){console.error(`Failed to load ${h}:`,v)}}const o=new Set(s.map(h=>h.name));for(const h of Fr){if(o.has(h))continue;const f=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,h).first();if(f)try{const v=await r(f.encrypted_value,a);if(Je[h]){const x=Dt(h,v,h);s.push({name:h,provider:x})}}catch{console.error(`Failed to decrypt legacy ${h} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(h=>h.name),l=await n.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const c=s.find(h=>h.name===l);return{provider:Wr(c.provider,s,n,e,t),rotation:n}}function Wr(e,t,a,r,n){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED");return t.length<=1?{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(l){const c=l.message||"";throw s(c)&&!c.includes("TOOLS_UNSUPPORTED")&&Et(r,n,"all_providers_down",e.name,null,c),l}},async streamChat(o,i){return await e.streamChat(o,i)}}:{name:e.name,async chat(o,i){try{return await e.chat(o,i)}catch(l){const c=l.message||"";if(!s(c))throw l;const u=c.includes("TOOLS_UNSUPPORTED");console.warn(`Provider ${e.name} ${u?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,u?1:1440);const h=t.filter(f=>f.name!==e.name);for(const f of h)try{const v=await f.provider.chat(o,i);return this.name=f.name,u||Et(r,n,"provider_switched",e.name,f.name,c),v}catch(v){const g=v.message||"";if(s(g)){await a.recordError(f.name,g,1440);continue}throw v}throw Et(r,n,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,i){return await e.streamChat(o,i)}}}const Ct=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ka,OpenAICompatibleProvider:Sa,ProviderRotation:Ia,createProviderFromConfig:Dt,createRotatingProvider:at,logError:A},Symbol.toStringTag,{value:"Module"})),Tt=20,qr=2e3,Kr=2e3,Oa=4;function Yr(e){return Math.ceil(e.length/Oa)}function Wt(e,t){const a=t*Oa;return e.length<=a?e:e.slice(0,a)+`
...
`),t.trim()}async function Ka(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await gt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,r).map(async f=>{const v=await qa(f.link);return{title:f.title,url:f.link,displayLink:f.displayLink,snippet:f.snippet,content:v.text,error:v.error}}),c=(await Promise.all(i)).filter(f=>f.content.length>50);if(c.length===0){const f=s.results.map((g,x)=>`[${x+1}] ${g.title}
${g.snippet}
Source: ${g.link}`).join(`

`);return{report:await qt(e,f,t,"snippets"),sources:s.results.map(g=>({title:g.title,url:g.link})),pagesRead:0}}const u=c.map((f,v)=>`--- SOURCE ${v+1}: ${f.title} (${f.displayLink}) ---
${f.content}
--- END SOURCE ${v+1} ---`).join(`

`);return{report:await qt(e,u,t,"full"),sources:c.map(f=>({title:f.title,url:f.url})),pagesRead:c.length}}async function qt(e,t,a,r){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Yt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function yt(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}function pn(e){const t=e.replace(/(\d+)\s*[.,;!]+\s*(minutes?|mins?|hours?|hrs?|h|days?|seconds?|secs?)/gi,"$1 $2"),a=t.toLowerCase().trim(),r=a.match(/\bin\s+(\d+)\s*(minutes?|mins?|hours?|hrs?|h|days?)\b/i);if(r){let o=parseInt(r[1],10);const i=r[2].toLowerCase();i.startsWith("h")&&(o*=60),i.startsWith("d")&&(o*=1440);const l=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let c;l?c=l[1].trim():c=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/in\s+\d+\s*\.?\s*(minutes?|mins?|hours?|hrs?|h|days?)\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const u=c.length>50?c.substring(0,47)+"...":c;return{args:{name:u.charAt(0).toUpperCase()+u.slice(1),description:c,schedule_type:"once",minutes_from_now:o,action_type:"reminder",action_description:c,schedule_value:""}}}const n=a.match(/(?:at|by)\s+(\d{1,2})[:.]?(\d{2})?\s*(am|pm|a\.m\.|p\.m\.)?/i);if(n){let o=parseInt(n[1],10);const i=n[2]?parseInt(n[2],10):0,l=(n[3]||"").replace(/\./g,"").toLowerCase();l==="pm"&&o<12&&(o+=12),l==="am"&&o===12&&(o=0);const c=t.match(/(?:to|about|that)\s+(.+?)\.?$/i);let u;c?u=c[1].trim():u=t.replace(/^(remind|alert|notify|tell|ping|nudge|buzz)\s*(me)?\s*/i,"").replace(/(?:at|by)\s+\d{1,2}[:.]?\d{0,2}\s*(am|pm|a\.m\.|p\.m\.)?\s*/i,"").replace(/^[,.\s]+|[,.\s]+$/g,"").trim()||"Reminder";const h=u.length>50?u.substring(0,47)+"...":u,f=new Date,v=f.getFullYear(),g=String(f.getMonth()+1).padStart(2,"0"),x=String(f.getDate()).padStart(2,"0"),w=`${v}-${g}-${x} ${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}`;return{args:{name:h.charAt(0).toUpperCase()+h.slice(1),description:u,schedule_type:"once",schedule_value:w,action_type:"reminder",action_description:u}}}const s=a.match(/^(remind|alert|notify)\s+me\s+(?:to|about|that)\s+(.+?)\.?$/i);if(s){const o=s[2].trim(),i=o.length>50?o.substring(0,47)+"...":o;return{args:{name:i.charAt(0).toUpperCase()+i.slice(1),description:o,schedule_type:"once",minutes_from_now:5,action_type:"reminder",action_description:o,schedule_value:""}}}return null}async function Le(e,t,a,r,n,s,o,i,l,c,u,h){const f=Date.now();let v=!0,g="",x="";try{return x=await mn(e,t,a,r,s,o,i,l,c,u,h),x}catch(w){throw v=!1,g=w.message||"Unknown error",w}finally{const w=Date.now()-f;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?x:"").substring(0,500),v?1:0,g||null,w,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function mn(e,t,a,r,n,s,o,i,l,c,u){var f,v,g,x,w,E;const h=new X(a);switch(e){case"create_schedule":{const d=new Date;let y;const p=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(d.getTime()+t.minutes_from_now*60*1e3);const S=y.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[O,L,I]=(S[0]||"").split("/");t.schedule_value=`${I}-${O}-${L} ${S[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);y=new Date(d.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"){const[T,S]=t.schedule_value.split(":").map(Number),O=d.toLocaleString("en-US",{timeZone:p}),L=new Date(O),I=new Date(L);I.setHours(T,S,0,0),I<=L&&I.setDate(I.getDate()+1);const D=new Date(I.toLocaleString("en-US",{timeZone:"UTC"})),R=new Date(I.toLocaleString("en-US",{timeZone:p})),M=D.getTime()-R.getTime();y=new Date(I.getTime()+M)}else if(t.schedule_type==="weekly"){const[T,S]=t.schedule_value.split(" "),[O,L]=(S||"00:00").split(":").map(Number),D=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(bt=>bt.toLowerCase()===T.toLowerCase()),R=d.toLocaleString("en-US",{timeZone:p}),M=new Date(R),z=new Date(M);z.setHours(O,L,0,0);let B=(D-z.getDay()+7)%7;B===0&&z<=M&&(B=7),z.setDate(z.getDate()+B);const Y=new Date(z.toLocaleString("en-US",{timeZone:"UTC"})),J=new Date(z.toLocaleString("en-US",{timeZone:p})),vt=Y.getTime()-J.getTime();y=new Date(z.getTime()+vt)}else if(t.schedule_type==="once"){const[T,S]=t.schedule_value.split(" "),[O,L,I]=T.split("-").map(Number),[D,R]=(S||"00:00").split(":").map(Number),M=d.toLocaleString("en-US",{timeZone:p}),z=new Date(M),B=new Date(z);B.setFullYear(O,L-1,I),B.setHours(D,R,0,0);const Y=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),J=new Date(B.toLocaleString("en-US",{timeZone:p})),vt=Y.getTime()-J.getTime();y=new Date(B.getTime()+vt);const bt=new Date(d.getTime()+120*1e3);if(y.getTime()<d.getTime()+60*1e3){const ar=y.toISOString();y=bt;const rr=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${ar} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=rr}}else y=new Date(d.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(d){return await A(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new re(a,r,n,s||"",o||""),y=t.calendar_id||"primary",p=t.days_ahead||7,m=new Date,_=new Date(m.getTime()+p*24*60*60*1e3),T=await d.calendar.listEvents(y,{timeMin:m.toISOString(),timeMax:_.toISOString(),query:t.query});return T.length===0?`No events found in the next ${p} days.`:T.map(S=>{var R;const O=S.start.dateTime||S.start.date||"TBD",L=S.end.dateTime||S.end.date||"",I=S.location?` 📍 ${S.location}`:"",D=((R=S.attendees)==null?void 0:R.map(M=>M.email).join(", "))||"";return`• ${S.summary} — ${O} to ${L}${I}${D?`
  Attendees: ${D}`:""}`}).join(`
...
`)}catch(d){return await A(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Jt(e,t,a,r,n,s){var d;const o=new X(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),h=[{role:"system",content:Xa(r,l)},...c.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",g=0;const x=[];for(let y=0;y<f;y++)try{const p=await a.chat(h,{tools:ft});if(p.usage&&(g+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&h.push({role:"assistant",content:p.content});for(const m of p.toolCalls){x.push(m.name);try{const _=await Le(m.name,m.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);h.push({role:"user",content:`[Tool Result for ${m.name}]: ${_}`})}catch(_){await A(t,r.id,"tool",m.name,_.message||"Tool execution failed"),h.push({role:"user",content:`[Tool Error for ${m.name}]: ${_.message||"Execution failed"}`})}}continue}v=p.content;break}catch(p){if(n){const m=p.message||"",_=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),T=m.includes("429"),S=_?1440:T?10:5;await n.recordError(a.name,m,S)}throw await A(t,r.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:a.name,turn:y}),p}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}const w=v.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),E=x.length>0?`[TOOLS_USED: ${[...new Set(x)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",E+w,"{}",i),await o.compactHistory(r.id,30),v}const Vt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function hn(e){for(const[t,a]of Object.entries(Vt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Vt.default}function gn(e,t,a,r){const n=hn(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const c=St(e);o.push({role:"system",content:e}),i+=c;const u=St(a);i+=u;const h=s-i,f=[];let v=0;for(let g=t.length-1;g>=0;g--){const x=t[g],w=St(x.content);if(v+w<=h)f.unshift({role:x.role,content:x.content}),v+=w;else{l=!0;break}}return o.push(...f),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*fn(e,t,a,r,n,s){var w;const o=new X(t),i=(w=e.metadata)==null?void 0:w.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),u=Xa(r,l),h=gn(u,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const f=10;let v="",g=0;const x=[...h.messages];for(let E=0;E<f;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:ft});if(d.usage&&(g+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const p of d.toolCalls){yield{type:"tool_start",data:{tool:p.name,toolArgs:p.arguments,threadId:i}};try{const m=await Le(p.name,p.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:p.name,toolResult:m.substring(0,500)+(m.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${p.name}]: ${m}`})}catch(m){await A(t,r.id,"tool",p.name,m.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:p.name,toolResult:`Error: ${m.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${p.name}]: ${m.message||"Execution failed"}`})}}continue}v=d.content;const y=50;for(let p=0;p<v.length;p+=y)yield{type:"chunk",data:{text:v.substring(p,p+y),threadId:i}},p+y<v.length&&await new Promise(_=>setTimeout(_,10));break}catch(d){if(n){const y=d.message||"",p=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),m=y.includes("429"),_=p?1440:m?10:5;await n.recordError(a.name,y,_)}await A(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&g>0)try{await n.recordUsage(a.name,g)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:g}}}async function jt(e,t,a,r,n,s){var u;const o=new X(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=Ya(e.text,l);if(c.agent==="conversation")return vn(e,t,a,r,l,n,i);if(c.agent==="multi"||c.confidence<.5)return Jt(e,t,a,r,n,s);try{return await yn(c.agent,e,t,a,r,l,n,s,i)}catch(h){return await A(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${h.message}`,{route:c}),Jt(e,t,a,r,n,s)}}async function yn(e,t,a,r,n,s,o,i,l){const c=new X(a),u=yt(n.timezone),h=ut(e,n,s,n.timezone,u),f=Ja(e,ft),v=(await c.getRecentConversations(n.id,25,l)).map(I=>({...I,content:I.content.replace(/^\[TOOLS_USED: [^\]]+\]\s*/i,"")})),g=[{role:"system",content:h},...v.map(I=>({role:I.role,content:I.content})),{role:"user",content:t.text}];await c.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const x=10;let w="",E=0,d="",y=!1;const p=[];for(let I=0;I<x;I++)try{const D=await r.chat(g,{tools:f.length>0?f:void 0});if(D.usage&&(E+=D.usage.promptTokens+D.usage.completionTokens),D.toolCalls&&D.toolCalls.length>0){y=!0,D.content&&(d=D.content,g.push({role:"assistant",content:D.content}));for(const R of D.toolCalls){p.push(R.name);try{const M=await Le(R.name,R.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g.push({role:"user",content:`[Tool Result for ${R.name}]: ${M}`})}catch(M){await A(a,n.id,"tool",R.name,M.message||"Tool execution failed"),g.push({role:"user",content:`[Tool Error for ${R.name}]: ${M.message||"Execution failed"}`})}}continue}w=D.content,!w&&d&&(w=d);break}catch(D){if(o){const R=D.message||"",M=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),z=R.includes("429"),B=M?1440:z?10:5;await o.recordError(r.name,R,B)}throw await A(a,n.id,"llm","subagent_error",D.message||"Unknown error",{agent:e,provider:r.name,turn:I}),D}const m=["scheduler","workspace","research"],_=e==="scheduler"&&!p.includes("create_schedule")&&!p.includes("list_schedules")&&!p.includes("toggle_schedule")&&!p.includes("update_schedule_state")&&!p.includes("delete_schedule")&&/\b(remind|in\s+\d+|at\s+\d{1,2}[:.]\d{0,2}|timer|alarm|schedule|tell\s+me\s+in|notify|alert|ping)\b/i.test(t.text),T=e==="workspace"&&p.includes("read_sheet")&&!p.includes("write_sheet")&&!p.includes("append_sheet")&&/\b(fix|correct|update|change|delete|remove|clean|clear|repair|replace|overwrite|set\s+to|should\s+be|wrong|broken|gap|missing)\b/i.test(t.text);if(!y&&m.includes(e)&&f.length>0||_||T){try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n.id,e,r.name,"__enforcement_trigger",JSON.stringify({userMessage:t.text.substring(0,200)}),w.substring(0,200),0,"LLM narrated without calling tools",0,0,t.channel||"web").run()}catch{}try{g.push({role:"assistant",content:w});let I;e==="scheduler"&&_?I=`[SYSTEM OVERRIDE] You called ${p.join(", ")||"no tools"} but did NOT call create_schedule. The user wants a reminder or schedule created. Call create_schedule NOW with the correct parameters. Do NOT respond with text saying a reminder is set — actually create it.`:e==="workspace"&&T?I="[SYSTEM OVERRIDE] You called read_sheet but did NOT call write_sheet. The user asked you to FIX or UPDATE the sheet data. You MUST call write_sheet NOW to make the actual changes. Reading data and then describing what you would fix is NOT the same as fixing it. Call write_sheet with the corrected values, then call read_sheet again to verify the fix landed correctly. Do NOT claim data is fixed without actually writing to the sheet.":I=`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${f.slice(0,3).map(R=>R.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`,g.push({role:"user",content:I});const D=await r.chat(g,{tools:f});if(D.usage&&(E+=D.usage.promptTokens+D.usage.completionTokens),D.toolCalls&&D.toolCalls.length>0){y=!0;let R=D.toolCalls,M=D.content;for(let z=0;z<5;z++){M&&g.push({role:"assistant",content:M});for(const Y of R){p.push(Y.name);try{const J=await Le(Y.name,Y.arguments,a,n.id,{agentType:e,providerName:r.name,channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);g.push({role:"user",content:`[Tool Result for ${Y.name}]: ${J}`})}catch(J){g.push({role:"user",content:`[Tool Error for ${Y.name}]: ${J.message||"Execution failed"}`})}}const B=await r.chat(g,{tools:f});if(B.usage&&(E+=B.usage.promptTokens+B.usage.completionTokens),B.toolCalls&&B.toolCalls.length>0){R=B.toolCalls,M=B.content;continue}B.content&&(w=B.content);break}}if(!p.includes("create_schedule")&&e==="scheduler")try{const R=pn(t.text);if(R){const M=await Le("create_schedule",R.args,a,n.id,{agentType:"scheduler",providerName:"programmatic_fallback",channel:t.channel,isEnforcementRetry:!0},n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);y=!0,p.push("create_schedule"),w=M}}catch(R){await A(a,n.id,"tool_enforcement","scheduler_fallback",`Programmatic scheduler fallback failed: ${R.message||"Unknown"}`)}}catch(I){await A(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${I.message||"Unknown"}`,{originalResponse:w.substring(0,200)})}}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}const O=w.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),L=p.length>0?`[TOOLS_USED: ${[...new Set(p)].join(", ")}] `:"";return await c.storeMessage(n.id,t.channel,"assistant",L+O,"{}",l),await c.compactHistory(n.id,30),w}async function vn(e,t,a,r,n,s,o){const i=new X(t),l=yt(r.timezone),c=ut("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),h=[{role:"system",content:c},...u.map(g=>({role:g.role,content:g.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let f=0,v="";try{const g=await a.chat(h,{temperature:.8});g.usage&&(f=g.usage.promptTokens+g.usage.completionTokens),v=g.content}catch(g){if(s){const x=g.message||"",w=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),E=x.includes("429"),d=w?1440:E?10:5;await s.recordError(a.name,x,d)}throw await A(t,r.id,"llm","conversation_error",g.message,{provider:a.name}),g}if(s&&f>0)try{await s.recordUsage(a.name,f)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*bn(e,t,a,r,n,s){var d;const o=new X(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=Ya(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*fn(e,t,a,r,n,s);return}const u=yt(r.timezone),h=c.agent==="conversation"?ut("conversation",r,l,r.timezone,u):ut(c.agent,r,l,r.timezone,u),f=Ja(c.agent,ft),v=await o.getRecentConversations(r.id,25,i),g=[{role:"system",content:h},...v.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let w="",E=0;for(let y=0;y<x;y++)try{y>0&&(yield{type:"thinking",data:{threadId:i}});const p=await a.chat(g,{tools:f.length>0?f:void 0});if(p.usage&&(E+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},g.push({role:"assistant",content:p.content}));for(const _ of p.toolCalls){yield{type:"tool_start",data:{tool:_.name,toolArgs:_.arguments,threadId:i}};try{const T=await Le(_.name,_.arguments,t,r.id,{agentType:c.agent,providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:_.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},g.push({role:"user",content:`[Tool Result for ${_.name}]: ${T}`})}catch(T){await A(t,r.id,"tool",_.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:_.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},g.push({role:"user",content:`[Tool Error for ${_.name}]: ${T.message||"Execution failed"}`})}}continue}w=p.content;const m=50;for(let _=0;_<w.length;_+=m)yield{type:"chunk",data:{text:w.substring(_,_+m),threadId:i}},_+m<w.length&&await new Promise(S=>setTimeout(S,10));break}catch(p){if(n){const m=p.message||"",_=m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance"),T=m.includes("429"),S=_?1440:T?10:5;await n.recordError(a.name,m,S)}await A(t,r.id,"llm","subagent_stream_error",p.message||"Unknown error",{agent:c.agent,provider:a.name,turn:y}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",w,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const P=new be;async function wn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
...
`;for(const c of s)o+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(o+=`
  Preview: ${c.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();i=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:c,rotation:u}=await at(e.env.DB,t.id,t.pin_hash),h=new ReadableStream({async start(f){const v=new TextEncoder;try{const g=bn(l,e.env.DB,c,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const x of g)x.data.threadId||(x.data.threadId=i),f.enqueue(v.encode(Xt(x)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),f.close()}catch(g){const x={type:"error",data:{error:g.message||"An error occurred",threadId:i}};f.enqueue(v.encode(Xt(x))),f.close()}}});return new Response(h,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(c){console.error("Stream setup error:",c);const u=c.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});P.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
     WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?`).bind(t.id,a,r).all();return e.json({messages:(n.results||[]).reverse(),total:((s=n.results)==null?void 0:s.length)||0})});P.get("/history",async e=>{var l;const t=e.get("user"),a=parseInt(e.req.query("limit")||"50"),r=parseInt(e.req.query("offset")||"0"),n=e.req.query("thread_id");let s,o;n?(s=`SELECT id, role, content, channel, thread_id, created_at FROM conversations 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await W(a,t,l),!0}case"/help":{const i=`🛠 *${(r==null?void 0:r.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`;return await W(a,t,i),!0}case"/status":{if(!r)return await W(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app."),!0;try{const[o,i,l,c]=await Promise.all([n.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(r.id).first(),n.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(r.id).first()]),u=`📊 *System Status*
...
Status: ✅ Online`;await W(a,t,u)}catch{await W(a,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return r?(await n.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(r.id).run(),await W(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await W(a,t,"⚠️ Account not linked."),!0);default:return!1}}rt.post("/webhook",async e=>{var t,a,r,n,s;try{const o=await e.req.json();if(o.callback_query)return await Cn(e.env.DB,o.callback_query),e.json({ok:!0});const i=o.message;if(!i)return e.json({ok:!0});const l=!!i.text,c=!!i.voice,u=!!i.document,h=!!i.photo,f=!!i.caption;if(!l&&!c&&!u&&!h)return e.json({ok:!0});const v=String(i.chat.id);let g=i.text||"";const x=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let w=null;if(x){const m=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(x.id,"telegram_bot_token").first();m&&(w=await j(m.encrypted_value,x.pin_hash))}if(!w){const m=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();m&&(w=await j(m.encrypted_value,m.pin_hash))}if(!w)return e.json({ok:!0,message:"Bot token not configured"});if(g.startsWith("/")&&await Dn(g,v,w,x,e.env.DB))return e.json({ok:!0});if(!x)return await W(w,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(i.voice&&w&&x)try{await W(w,v,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${i.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const S=await(await fetch(`https://api.telegram.org/file/bot${w}/${_.result.file_path}`)).blob();let O="",L="",I="whisper-1";const D=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(x.id).all();for(const B of D.results){const Y=await j(B.encrypted_value,x.pin_hash);if(B.service==="openai"){O="https://api.openai.com/v1/audio/transcriptions",L=Y;break}else if(B.service.startsWith("llm_slot_"))try{const J=JSON.parse(Y);if(J.provider==="openai"){O="https://api.openai.com/v1/audio/transcriptions",L=J.apiKey;break}else if(J.provider==="groq"){O="https://api.groq.com/openai/v1/audio/transcriptions",L=J.apiKey,I="whisper-large-v3";break}}catch{}}if(!O)return await W(w,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const R=new FormData;R.append("file",S,"voice.ogg"),R.append("model",I),R.append("language","en");const M=await fetch(O,{method:"POST",headers:{Authorization:`Bearer ${L}`},body:R});if(!M.ok){const B=await M.text();return await W(w,v,`⚠️ Transcription failed: ${M.status} ${B}`),e.json({ok:!0})}g=(await M.json()).text,await W(w,v,`🗣️ *You said:* ${g}`)}}catch(m){return await W(w,v,`⚠️ Failed to process voice note: ${m.message}`),e.json({ok:!0})}if((u||h)&&w&&x)try{let m,_="unknown",T="unknown",S=0;if(u)m=i.document.file_id,_=i.document.file_name||"document",T=i.document.mime_type||"unknown",S=i.document.file_size||0;else if(h){const O=i.photo[i.photo.length-1];m=O.file_id,_="photo.jpg",T="image/jpeg",S=O.file_size||0}if(m){const L=await(await fetch(`https://api.telegram.org/bot${w}/getFile?file_id=${m}`)).json();let I="";if(L.ok&&((a=L.result)!=null&&a.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(_)||/^text\/|application\/json|application\/xml|application\/csv/i.test(T))&&S<5e4)try{I=await(await fetch(`https://api.telegram.org/file/bot${w}/${L.result.file_path}`)).text()}catch{}const D=i.caption||"",R=`[Telegram file received: "${_}" (${T}, ${Math.round(S/1024)}KB)]`;I?g=`${D?D+`

`:""}${R}
File contents:
${I.substring(0,8e3)}${I.length>8e3?`
[...truncated]`:""}`:g=`${D?D+`
...
`)}function Bn(e){const t=[];let a=0;for(const r of e.calendar.google)t.push({type:"calendar",key:r.id,text:`${r.title} - ${new Date(r.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:r},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const r of e.tasks.items)t.push({type:"task",key:`task-${r}`,text:r,metadata:{},sortOrder:a++});for(const r of e.news.items)t.push({type:"news",key:`news-${r.url}`,text:`📰 ${r.title}`,metadata:{url:r.url,source:r.source},sortOrder:a++});return t}async function jn(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let r;try{r=JSON.parse(a.components)}catch{r={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:r,newsTopics:n}}async function Qa(e,t,a){var E;const r=t.timezone||"Asia/Kolkata",n=Rn(r),{components:s,newsTopics:o}=await jn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(An(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(Nn(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(Ln(e,t.id)),l.push("tasks")),s.news&&(i.push($n(o)),l.push("news"));const c=await Promise.all(i),u={};l.forEach((d,y)=>{u[d]=c[y]});const h={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},f={pending:0,dueToday:0,items:[]},v={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((E=u.googleEvents)==null?void 0:E.length)||0},emails:{gmail:u.gmailSummary||h},tasks:u.tasks||f,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};v.summary=Mn(v);const g=Bn(v),x=await e.prepare(`
  ...
  `).bind(t,a).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function Gn(e,t,a=new Date){const r=new Date(a.toLocaleString("en-US",{timeZone:t})),n=r.getHours(),s=r.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,c=o*60+i;return l===c}function zn(e,t){const a=e.summary,r=[];for(const n of t.slice(0,10))r.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:a,inlineKeyboard:r}}const Z=new be;async function er(e,t){var n;if(e.req.path.includes("/cron/"))return t();const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of r.results||[]){if(!o.briefing_enabled)continue;const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(Gn(l,i,s))try{const c=await Qa(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:h}=zn(c.content,c.items);await Fn(e.env.DB,o,u,h,c.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:c.briefingId,briefing_time:l,timezone:i})}catch(c){n.push({user_id:o.id,status:"error",error:c.message})}}return e.json({executed:n.length,results:n})}catch(r){return e.json({error:r.message},500)}});Z.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const r=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of r.results||[])try{const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!c)continue;const u=await j(c.encrypted_value,l.pin_hash),f=JSON.parse(u).access_token;if(!f)continue;const v=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${f}`}});if(!v.ok)continue;const x=((await v.json()).items||[]).filter(d=>{var p;const y=(p=d.start)==null?void 0:p.dateTime;return y?y>=s.toISOString()&&y<=o:!1});if(x.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const w=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!w)continue;const E=await j(w.encrypted_value,l.pin_hash);for(const d of x){const y=new Date(d.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),p=d.location?`
...
${a}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:r.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}Z.delete("/briefings/:id",er,async e=>{const t=e.get("user").id,a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t).run(),e.json({success:!0})});const ae=new be;ae.use("/api/*",Ur());ae.route("/api/auth",we);ae.route("/api/chat",P);ae.route("/api/settings",U);ae.route("/api/system",pe);ae.route("/api/telegram",rt);ae.route("/api/proactive",Z);ae.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),r=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ce(!1,`Google denied access: ${n}`));if(!a||!r)return e.html(Ce(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(r)).sessionId;if(!o)return e.html(Ce(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Ce(!1,"Session expired. Please log in again and retry."));const l=i.user_id,c=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,h=await La(e.env.DB,l,c,a,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Ce(!0,`Connected as ${h.email}`,h.email))}catch(s){return e.html(Ce(!1,`OAuth failed: ${s.message}`))}});ae.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(_a())));ae.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(_a())));function Ce(e,t,a){return`<!DOCTYPE html>
