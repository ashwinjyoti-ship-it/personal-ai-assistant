var Qn=Object.defineProperty;var ma=e=>{throw TypeError(e)};var er=(e,t,a)=>t in e?Qn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var A=(e,t,a)=>er(e,typeof t!="symbol"?t+"":t,a),Ht=(e,t,a)=>t.has(e)||ma("Cannot "+a);var k=(e,t,a)=>(Ht(e,t,"read from private field"),a?a.call(e):t.get(e)),G=(e,t,a)=>t.has(e)?ma("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),j=(e,t,a,n)=>(Ht(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a),V=(e,t,a)=>(Ht(e,t,"access private method"),a);var pa=(e,t,a,n)=>({set _(r){j(e,t,r,a)},get _(){return k(e,t,n)}});var ha=(e,t,a)=>(n,r)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,d=!1,c;if(e[o]?(c=e[o][0][0],n.req.routeIndex=o):c=o===e.length&&r||void 0,c)try{l=await c(n,()=>i(o+1))}catch(m){if(m instanceof Error&&t)n.error=m,l=await t(m,n),d=!0;else throw m}else n.finalized===!1&&a&&(l=await a(n));return l&&(n.finalized===!1||d)&&(n.res=l),n}},tr=Symbol(),ar=async(e,t=Object.create(null))=>{const{all:a=!1,dot:n=!1}=t,s=(e instanceof Ga?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?nr(e,{all:a,dot:n}):{}};async function nr(e,t){const a=await e.formData();return a?rr(a,t):{}}function rr(e,t){const a=Object.create(null);return e.forEach((n,r)=>{t.all||r.endsWith("[]")?sr(a,r,n):a[r]=n}),t.dot&&Object.entries(a).forEach(([n,r])=>{n.includes(".")&&(ir(a,n,r),delete a[n])}),a}var sr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},ir=(e,t,a)=>{let n=e;const r=t.split(".");r.forEach((s,i)=>{i===r.length-1?n[s]=a:((!n[s]||typeof n[s]!="object"||Array.isArray(n[s])||n[s]instanceof File)&&(n[s]=Object.create(null)),n=n[s])})},ja=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},or=e=>{const{groups:t,path:a}=lr(e),n=ja(a);return dr(n,t)},lr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,n)=>{const r=`@${n}`;return t.push([r,a]),r}),{groups:t,path:e}},dr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[n]=t[a];for(let r=e.length-1;r>=0;r--)if(e[r].includes(n)){e[r]=e[r].replace(n,t[a][1]);break}}return e},Ot={},cr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const n=`${e}#${t}`;return Ot[n]||(a[2]?Ot[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:Ot[n]=[e,a[1],!0]),Ot[n]}return null},ta=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},ur=e=>ta(e,decodeURI),Pa=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let n=a;for(;n<t.length;n++){const r=t.charCodeAt(n);if(r===37){const s=t.indexOf("?",n),i=t.indexOf("#",n),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return ur(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(r===63||r===35)break}return t.slice(a,n)},mr=e=>{const t=Pa(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Qe=(e,t,...a)=>(a.length&&(t=Qe(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ua=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let n="";return t.forEach(r=>{if(r!==""&&!/\:/.test(r))n+="/"+r;else if(/\:/.test(r))if(/\?/.test(r)){a.length===0&&n===""?a.push("/"):a.push(n);const s=r.replace("?","");n+="/"+s,a.push(n)}else n+="/"+r}),a.filter((r,s,i)=>i.indexOf(r)===s)},Ft=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ta(e,Fa):e):e,Ha=(e,t,a)=>{let n;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,d=e.indexOf("&",l);return Ft(e.slice(l,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(n=/[%+]/.test(e),!n)return}const r={};n??(n=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(n&&(l=Ft(l)),s=i,l==="")continue;let d;o===-1?d="":(d=e.slice(o+1,i===-1?void 0:i),n&&(d=Ft(d))),a?(r[l]&&Array.isArray(r[l])||(r[l]=[]),r[l].push(d)):r[l]??(r[l]=d)}return t?r[t]:r},pr=Ha,hr=(e,t)=>Ha(e,t,!0),Fa=decodeURIComponent,ga=e=>ta(e,Fa),nt,he,Re,Wa,qa,Jt,Ce,Ia,Ga=(Ia=class{constructor(e,t="/",a=[[]]){G(this,Re);A(this,"raw");G(this,nt);G(this,he);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});G(this,Ce,e=>{const{bodyCache:t,raw:a}=this,n=t[e];if(n)return n;const r=Object.keys(t)[0];return r?t[r].then(s=>(r==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,j(this,he,a),j(this,nt,{})}param(e){return e?V(this,Re,Wa).call(this,e):V(this,Re,qa).call(this)}query(e){return pr(this.url,e)}queries(e){return hr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,n)=>{t[n]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ar(this,e))}json(){return k(this,Ce).call(this,"text").then(e=>JSON.parse(e))}text(){return k(this,Ce).call(this,"text")}arrayBuffer(){return k(this,Ce).call(this,"arrayBuffer")}blob(){return k(this,Ce).call(this,"blob")}formData(){return k(this,Ce).call(this,"formData")}addValidatedData(e,t){k(this,nt)[e]=t}valid(e){return k(this,nt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[tr](){return k(this,he)}get matchedRoutes(){return k(this,he)[0].map(([[,e]])=>e)}get routePath(){return k(this,he)[0].map(([[,e]])=>e)[this.routeIndex].path}},nt=new WeakMap,he=new WeakMap,Re=new WeakSet,Wa=function(e){const t=k(this,he)[0][this.routeIndex][1][e],a=V(this,Re,Jt).call(this,t);return a&&/\%/.test(a)?ga(a):a},qa=function(){const e={},t=Object.keys(k(this,he)[0][this.routeIndex][1]);for(const a of t){const n=V(this,Re,Jt).call(this,k(this,he)[0][this.routeIndex][1][a]);n!==void 0&&(e[a]=/\%/.test(n)?ga(n):n)}return e},Jt=function(e){return k(this,he)[1]?k(this,he)[1][e]:e},Ce=new WeakMap,Ia),gr={Stringify:1},za=async(e,t,a,n,r)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(r?r[0]+=e:r=[e],Promise.all(s.map(o=>o({phase:t,buffer:r,context:n}))).then(o=>Promise.all(o.filter(Boolean).map(l=>za(l,t,!1,n,r))).then(()=>r[0]))):Promise.resolve(e)},fr="text/plain; charset=UTF-8",Gt=(e,t)=>({"Content-Type":e,...t}),_t,Et,Se,rt,xe,ue,Tt,st,it,Ge,St,xt,Ne,et,Aa,yr=(Aa=class{constructor(e,t){G(this,Ne);G(this,_t);G(this,Et);A(this,"env",{});G(this,Se);A(this,"finalized",!1);A(this,"error");G(this,rt);G(this,xe);G(this,ue);G(this,Tt);G(this,st);G(this,it);G(this,Ge);G(this,St);G(this,xt);A(this,"render",(...e)=>(k(this,st)??j(this,st,t=>this.html(t)),k(this,st).call(this,...e)));A(this,"setLayout",e=>j(this,Tt,e));A(this,"getLayout",()=>k(this,Tt));A(this,"setRenderer",e=>{j(this,st,e)});A(this,"header",(e,t,a)=>{this.finalized&&j(this,ue,new Response(k(this,ue).body,k(this,ue)));const n=k(this,ue)?k(this,ue).headers:k(this,Ge)??j(this,Ge,new Headers);t===void 0?n.delete(e):a!=null&&a.append?n.append(e,t):n.set(e,t)});A(this,"status",e=>{j(this,rt,e)});A(this,"set",(e,t)=>{k(this,Se)??j(this,Se,new Map),k(this,Se).set(e,t)});A(this,"get",e=>k(this,Se)?k(this,Se).get(e):void 0);A(this,"newResponse",(...e)=>V(this,Ne,et).call(this,...e));A(this,"body",(e,t,a)=>V(this,Ne,et).call(this,e,t,a));A(this,"text",(e,t,a)=>!k(this,Ge)&&!k(this,rt)&&!t&&!a&&!this.finalized?new Response(e):V(this,Ne,et).call(this,e,t,Gt(fr,a)));A(this,"json",(e,t,a)=>V(this,Ne,et).call(this,JSON.stringify(e),t,Gt("application/json",a)));A(this,"html",(e,t,a)=>{const n=r=>V(this,Ne,et).call(this,r,t,Gt("text/html; charset=UTF-8",a));return typeof e=="object"?za(e,gr.Stringify,!1,{}).then(n):n(e)});A(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});A(this,"notFound",()=>(k(this,it)??j(this,it,()=>new Response),k(this,it).call(this,this)));j(this,_t,e),t&&(j(this,xe,t.executionCtx),this.env=t.env,j(this,it,t.notFoundHandler),j(this,xt,t.path),j(this,St,t.matchResult))}get req(){return k(this,Et)??j(this,Et,new Ga(k(this,_t),k(this,xt),k(this,St))),k(this,Et)}get event(){if(k(this,xe)&&"respondWith"in k(this,xe))return k(this,xe);throw Error("This context has no FetchEvent")}get executionCtx(){if(k(this,xe))return k(this,xe);throw Error("This context has no ExecutionContext")}get res(){return k(this,ue)||j(this,ue,new Response(null,{headers:k(this,Ge)??j(this,Ge,new Headers)}))}set res(e){if(k(this,ue)&&e){e=new Response(e.body,e);for(const[t,a]of k(this,ue).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=k(this,ue).headers.getSetCookie();e.headers.delete("set-cookie");for(const r of n)e.headers.append("set-cookie",r)}else e.headers.set(t,a)}j(this,ue,e),this.finalized=!0}get var(){return k(this,Se)?Object.fromEntries(k(this,Se)):{}}},_t=new WeakMap,Et=new WeakMap,Se=new WeakMap,rt=new WeakMap,xe=new WeakMap,ue=new WeakMap,Tt=new WeakMap,st=new WeakMap,it=new WeakMap,Ge=new WeakMap,St=new WeakMap,xt=new WeakMap,Ne=new WeakSet,et=function(e,t,a){const n=k(this,ue)?new Headers(k(this,ue).headers):k(this,Ge)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?n.append(i,o):n.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")n.set(s,i);else{n.delete(s);for(const o of i)n.append(s,o)}const r=typeof t=="number"?t:(t==null?void 0:t.status)??k(this,rt);return new Response(e,{status:r,headers:n})},Aa),ne="ALL",vr="all",wr=["get","post","put","delete","options","patch"],Ka="Can not add a route since the matcher is already built.",Ya=class extends Error{},br="__COMPOSED_HANDLER",_r=e=>e.text("404 Not Found",404),fa=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},ge,re,Ja,fe,He,Ct,Nt,ot,Er=(ot=class{constructor(t={}){G(this,re);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");G(this,ge,"/");A(this,"routes",[]);G(this,fe,_r);A(this,"errorHandler",fa);A(this,"onError",t=>(this.errorHandler=t,this));A(this,"notFound",t=>(j(this,fe,t),this));A(this,"fetch",(t,...a)=>V(this,re,Nt).call(this,t,a[1],a[0],t.method));A(this,"request",(t,a,n,r)=>t instanceof Request?this.fetch(a?new Request(t,a):t,n,r):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Qe("/",t)}`,a),n,r)));A(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(V(this,re,Nt).call(this,t.request,t,void 0,t.request.method))})});[...wr,vr].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?j(this,ge,i):V(this,re,He).call(this,s,k(this,ge),i),o.forEach(l=>{V(this,re,He).call(this,s,k(this,ge),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){j(this,ge,l);for(const d of[s].flat())o.map(c=>{V(this,re,He).call(this,d.toUpperCase(),k(this,ge),c)})}return this},this.use=(s,...i)=>(typeof s=="string"?j(this,ge,s):(j(this,ge,"*"),i.unshift(s)),i.forEach(o=>{V(this,re,He).call(this,ne,k(this,ge),o)}),this);const{strict:n,...r}=t;Object.assign(this,r),this.getPath=n??!0?t.getPath??Pa:mr}route(t,a){const n=this.basePath(t);return a.routes.map(r=>{var i;let s;a.errorHandler===fa?s=r.handler:(s=async(o,l)=>(await ha([],a.errorHandler)(o,()=>r.handler(o,l))).res,s[br]=r.handler),V(i=n,re,He).call(i,r.method,r.path,s)}),this}basePath(t){const a=V(this,re,Ja).call(this);return a._basePath=Qe(this._basePath,t),a}mount(t,a,n){let r,s;n&&(typeof n=="function"?s=n:(s=n.optionHandler,n.replaceRequest===!1?r=l=>l:r=n.replaceRequest));const i=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};r||(r=(()=>{const l=Qe(this._basePath,t),d=l==="/"?0:l.length;return c=>{const m=new URL(c.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,c)}})());const o=async(l,d)=>{const c=await a(r(l.req.raw),...i(l));if(c)return c;await d()};return V(this,re,He).call(this,ne,Qe(t,"*"),o),this}},ge=new WeakMap,re=new WeakSet,Ja=function(){const t=new ot({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,j(t,fe,k(this,fe)),t.routes=this.routes,t},fe=new WeakMap,He=function(t,a,n){t=t.toUpperCase(),a=Qe(this._basePath,a);const r={basePath:this._basePath,path:a,method:t,handler:n};this.router.add(t,a,[n,r]),this.routes.push(r)},Ct=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},Nt=function(t,a,n,r){if(r==="HEAD")return(async()=>new Response(null,await V(this,re,Nt).call(this,t,a,n,"GET")))();const s=this.getPath(t,{env:n}),i=this.router.match(r,s),o=new yr(t,{path:s,matchResult:i,env:n,executionCtx:a,notFoundHandler:k(this,fe)});if(i[0].length===1){let d;try{d=i[0][0][0][0](o,async()=>{o.res=await k(this,fe).call(this,o)})}catch(c){return V(this,re,Ct).call(this,c,o)}return d instanceof Promise?d.then(c=>c||(o.finalized?o.res:k(this,fe).call(this,o))).catch(c=>V(this,re,Ct).call(this,c,o)):d??k(this,fe).call(this,o)}const l=ha(i[0],this.errorHandler,k(this,fe));return(async()=>{try{const d=await l(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return V(this,re,Ct).call(this,d,o)}})()},ot),Va=[];function Tr(e,t){const a=this.buildAllMatchers(),n=((r,s)=>{const i=a[r]||a[ne],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],Va];const d=l.indexOf("",1);return[i[1][d],l]});return this.match=n,n(e,t)}var At="[^/]+",yt=".*",vt="(?:|/.*)",tt=Symbol(),Sr=new Set(".\\+*[^]$()");function xr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===yt||e===vt?1:t===yt||t===vt?-1:e===At?1:t===At?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var We,qe,ye,Ye,kr=(Ye=class{constructor(){G(this,We);G(this,qe);G(this,ye,Object.create(null))}insert(t,a,n,r,s){if(t.length===0){if(k(this,We)!==void 0)throw tt;if(s)return;j(this,We,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",yt]:["","",At]:i==="/*"?["","",vt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const c=l[1];let m=l[2]||At;if(c&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw tt;if(d=k(this,ye)[m],!d){if(Object.keys(k(this,ye)).some(h=>h!==yt&&h!==vt))throw tt;if(s)return;d=k(this,ye)[m]=new Ye,c!==""&&j(d,qe,r.varIndex++)}!s&&c!==""&&n.push([c,k(d,qe)])}else if(d=k(this,ye)[i],!d){if(Object.keys(k(this,ye)).some(c=>c.length>1&&c!==yt&&c!==vt))throw tt;if(s)return;d=k(this,ye)[i]=new Ye}d.insert(o,a,n,r,s)}buildRegExpStr(){const a=Object.keys(k(this,ye)).sort(xr).map(n=>{const r=k(this,ye)[n];return(typeof k(r,qe)=="number"?`(${n})@${k(r,qe)}`:Sr.has(n)?`\\${n}`:n)+r.buildRegExpStr()});return typeof k(this,We)=="number"&&a.unshift(`#${k(this,We)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},We=new WeakMap,qe=new WeakMap,ye=new WeakMap,Ye),$t,kt,La,Dr=(La=class{constructor(){G(this,$t,{varIndex:0});G(this,kt,new kr)}insert(e,t,a){const n=[],r=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${i}`;return r[i]=[d,l],i++,o=!0,d}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=r.length-1;i>=0;i--){const[o]=r[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,r[i][1]);break}}return k(this,kt).insert(s,t,n,k(this,$t),a),n}buildRegExp(){let e=k(this,kt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(r,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(n[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,n]}},$t=new WeakMap,kt=new WeakMap,La),Rr=[/^$/,[],Object.create(null)],It=Object.create(null);function Za(e){return It[e]??(It[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Or(){It=Object.create(null)}function Cr(e){var d;const t=new Dr,a=[];if(e.length===0)return Rr;const n=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,m],[h,w])=>c?1:h?-1:m.length-w.length),r=Object.create(null);for(let c=0,m=-1,h=n.length;c<h;c++){const[w,f,_]=n[c];w?r[f]=[_.map(([S])=>[S,Object.create(null)]),Va]:m++;let v;try{v=t.insert(f,m,w)}catch(S){throw S===tt?new Ya(f):S}w||(a[m]=_.map(([S,E])=>{const O=Object.create(null);for(E-=1;E>=0;E--){const[I,M]=v[E];O[I]=M}return[S,O]}))}const[s,i,o]=t.buildRegExp();for(let c=0,m=a.length;c<m;c++)for(let h=0,w=a[c].length;h<w;h++){const f=(d=a[c][h])==null?void 0:d[1];if(!f)continue;const _=Object.keys(f);for(let v=0,S=_.length;v<S;v++)f[_[v]]=o[f[_[v]]]}const l=[];for(const c in i)l[c]=a[i[c]];return[s,l,r]}function Ze(e,t){if(e){for(const a of Object.keys(e).sort((n,r)=>r.length-n.length))if(Za(a).test(t))return[...e[a]]}}var Ie,Ae,Bt,Xa,Ma,Nr=(Ma=class{constructor(){G(this,Bt);A(this,"name","RegExpRouter");G(this,Ie);G(this,Ae);A(this,"match",Tr);j(this,Ie,{[ne]:Object.create(null)}),j(this,Ae,{[ne]:Object.create(null)})}add(e,t,a){var o;const n=k(this,Ie),r=k(this,Ae);if(!n||!r)throw new Error(Ka);n[e]||[n,r].forEach(l=>{l[e]=Object.create(null),Object.keys(l[ne]).forEach(d=>{l[e][d]=[...l[ne][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=Za(t);e===ne?Object.keys(n).forEach(d=>{var c;(c=n[d])[t]||(c[t]=Ze(n[d],t)||Ze(n[ne],t)||[])}):(o=n[e])[t]||(o[t]=Ze(n[e],t)||Ze(n[ne],t)||[]),Object.keys(n).forEach(d=>{(e===ne||e===d)&&Object.keys(n[d]).forEach(c=>{l.test(c)&&n[d][c].push([a,s])})}),Object.keys(r).forEach(d=>{(e===ne||e===d)&&Object.keys(r[d]).forEach(c=>l.test(c)&&r[d][c].push([a,s]))});return}const i=Ua(t)||[t];for(let l=0,d=i.length;l<d;l++){const c=i[l];Object.keys(r).forEach(m=>{var h;(e===ne||e===m)&&((h=r[m])[c]||(h[c]=[...Ze(n[m],c)||Ze(n[ne],c)||[]]),r[m][c].push([a,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(k(this,Ae)).concat(Object.keys(k(this,Ie))).forEach(t=>{e[t]||(e[t]=V(this,Bt,Xa).call(this,t))}),j(this,Ie,j(this,Ae,void 0)),Or(),e}},Ie=new WeakMap,Ae=new WeakMap,Bt=new WeakSet,Xa=function(e){const t=[];let a=e===ne;return[k(this,Ie),k(this,Ae)].forEach(n=>{const r=n[e]?Object.keys(n[e]).map(s=>[s,n[e][s]]):[];r.length!==0?(a||(a=!0),t.push(...r)):e!==ne&&t.push(...Object.keys(n[ne]).map(s=>[s,n[ne][s]]))}),a?Cr(t):null},Ma),Le,ke,$a,Ir=($a=class{constructor(e){A(this,"name","SmartRouter");G(this,Le,[]);G(this,ke,[]);j(this,Le,e.routers)}add(e,t,a){if(!k(this,ke))throw new Error(Ka);k(this,ke).push([e,t,a])}match(e,t){if(!k(this,ke))throw new Error("Fatal error");const a=k(this,Le),n=k(this,ke),r=a.length;let s=0,i;for(;s<r;s++){const o=a[s];try{for(let l=0,d=n.length;l<d;l++)o.add(...n[l]);i=o.match(e,t)}catch(l){if(l instanceof Ya)continue;throw l}this.match=o.match.bind(o),j(this,Le,[o]),j(this,ke,void 0);break}if(s===r)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(k(this,ke)||k(this,Le).length!==1)throw new Error("No active router has been determined yet.");return k(this,Le)[0]}},Le=new WeakMap,ke=new WeakMap,$a),ht=Object.create(null),Me,le,ze,lt,ie,De,Fe,dt,Ar=(dt=class{constructor(t,a,n){G(this,De);G(this,Me);G(this,le);G(this,ze);G(this,lt,0);G(this,ie,ht);if(j(this,le,n||Object.create(null)),j(this,Me,[]),t&&a){const r=Object.create(null);r[t]={handler:a,possibleKeys:[],score:0},j(this,Me,[r])}j(this,ze,[])}insert(t,a,n){j(this,lt,++pa(this,lt)._);let r=this;const s=or(a),i=[];for(let o=0,l=s.length;o<l;o++){const d=s[o],c=s[o+1],m=cr(d,c),h=Array.isArray(m)?m[0]:d;if(h in k(r,le)){r=k(r,le)[h],m&&i.push(m[1]);continue}k(r,le)[h]=new dt,m&&(k(r,ze).push(m),i.push(m[1])),r=k(r,le)[h]}return k(r,Me).push({[t]:{handler:n,possibleKeys:i.filter((o,l,d)=>d.indexOf(o)===l),score:k(this,lt)}}),r}search(t,a){var l;const n=[];j(this,ie,ht);let s=[this];const i=ja(a),o=[];for(let d=0,c=i.length;d<c;d++){const m=i[d],h=d===c-1,w=[];for(let f=0,_=s.length;f<_;f++){const v=s[f],S=k(v,le)[m];S&&(j(S,ie,k(v,ie)),h?(k(S,le)["*"]&&n.push(...V(this,De,Fe).call(this,k(S,le)["*"],t,k(v,ie))),n.push(...V(this,De,Fe).call(this,S,t,k(v,ie)))):w.push(S));for(let E=0,O=k(v,ze).length;E<O;E++){const I=k(v,ze)[E],M=k(v,ie)===ht?{}:{...k(v,ie)};if(I==="*"){const R=k(v,le)["*"];R&&(n.push(...V(this,De,Fe).call(this,R,t,k(v,ie))),j(R,ie,M),w.push(R));continue}const[q,H,$]=I;if(!m&&!($ instanceof RegExp))continue;const W=k(v,le)[q],z=i.slice(d).join("/");if($ instanceof RegExp){const R=$.exec(z);if(R){if(M[H]=R[0],n.push(...V(this,De,Fe).call(this,W,t,k(v,ie),M)),Object.keys(k(W,le)).length){j(W,ie,M);const U=((l=R[0].match(/\//))==null?void 0:l.length)??0;(o[U]||(o[U]=[])).push(W)}continue}}($===!0||$.test(m))&&(M[H]=m,h?(n.push(...V(this,De,Fe).call(this,W,t,M,k(v,ie))),k(W,le)["*"]&&n.push(...V(this,De,Fe).call(this,k(W,le)["*"],t,M,k(v,ie)))):(j(W,ie,M),w.push(W)))}}s=w.concat(o.shift()??[])}return n.length>1&&n.sort((d,c)=>d.score-c.score),[n.map(({handler:d,params:c})=>[d,c])]}},Me=new WeakMap,le=new WeakMap,ze=new WeakMap,lt=new WeakMap,ie=new WeakMap,De=new WeakSet,Fe=function(t,a,n,r){const s=[];for(let i=0,o=k(t,Me).length;i<o;i++){const l=k(t,Me)[i],d=l[a]||l[ne],c={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),n!==ht||r&&r!==ht))for(let m=0,h=d.possibleKeys.length;m<h;m++){const w=d.possibleKeys[m],f=c[d.score];d.params[w]=r!=null&&r[w]&&!f?r[w]:n[w]??(r==null?void 0:r[w]),c[d.score]=!0}}return s},dt),Ke,Ba,Lr=(Ba=class{constructor(){A(this,"name","TrieRouter");G(this,Ke);j(this,Ke,new Ar)}add(e,t,a){const n=Ua(t);if(n){for(let r=0,s=n.length;r<s;r++)k(this,Ke).insert(e,n[r],a);return}k(this,Ke).insert(e,t,a)}match(e,t){return k(this,Ke).search(e,t)}},Ke=new WeakMap,Ba),pe=class extends Er{constructor(e={}){super(e),this.router=e.router??new Ir({routers:[new Nr,new Lr]})}},Mr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),r=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var c;function l(m,h){i.res.headers.set(m,h)}const d=await n(i.req.header("origin")||"",i);if(d&&l("Access-Control-Allow-Origin",d),a.credentials&&l("Access-Control-Allow-Credentials","true"),(c=a.exposeHeaders)!=null&&c.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await r(i.req.header("origin")||"",i);m.length&&l("Access-Control-Allow-Methods",m.join(","));let h=a.allowHeaders;if(!(h!=null&&h.length)){const w=i.req.header("Access-Control-Request-Headers");w&&(h=w.split(/\s*,\s*/))}return h!=null&&h.length&&(l("Access-Control-Allow-Headers",h.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Qa(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}const aa="AES-GCM",$r=256;async function en(e){const t=new TextEncoder,a=await crypto.subtle.importKey("raw",t.encode(e.padEnd(32,"0").slice(0,32)),{name:"PBKDF2"},!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode("karna-salt-v1"),iterations:1e5,hash:"SHA-256"},a,{name:aa,length:$r},!1,["encrypt","decrypt"])}async function ct(e,t){const a=await en(t),n=crypto.getRandomValues(new Uint8Array(12)),r=new TextEncoder,s=await crypto.subtle.encrypt({name:aa,iv:n},a,r.encode(e)),i=new Uint8Array(n.length+new Uint8Array(s).length);return i.set(n),i.set(new Uint8Array(s),n.length),btoa(String.fromCharCode(...i))}async function Y(e,t){const a=await en(t),n=new Uint8Array(atob(e).split("").map(o=>o.charCodeAt(0))),r=n.slice(0,12),s=n.slice(12),i=await crypto.subtle.decrypt({name:aa,iv:r},a,s);return new TextDecoder().decode(i)}async function jt(e){const a=new TextEncoder().encode(e+"karna-pin-salt"),n=await crypto.subtle.digest("SHA-256",a);return btoa(String.fromCharCode(...new Uint8Array(n)))}async function tn(e,t){return await jt(e)===t}const na=Object.freeze(Object.defineProperty({__proto__:null,decrypt:Y,encrypt:ct,hashPin:jt,verifyPin:tn},Symbol.toStringTag,{value:"Module"})),$e=new pe;$e.get("/check",async e=>{const t=await e.env.DB.prepare("SELECT COUNT(*) as cnt FROM users").first();return e.json({hasUsers:((t==null?void 0:t.cnt)||0)>0})});$e.post("/setup",async e=>{const{username:t,name:a,pin:n,personality_prompt:r,timezone:s}=await e.req.json();if(!t||!a||!n)return e.json({error:"Username, name, and PIN are required"},400);if(n.length<4)return e.json({error:"PIN must be at least 4 characters"},400);if(await e.env.DB.prepare("SELECT id FROM users WHERE username = ?").bind(t).first())return e.json({error:"Username already taken"},409);const o=await jt(n);await e.env.DB.prepare("INSERT INTO users (username, name, pin_hash, personality_prompt, timezone) VALUES (?, ?, ?, ?, ?)").bind(t,a,o,r||"",s||"Asia/Kolkata").run();const l=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first(),d=crypto.randomUUID(),c=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(d,l.id,"web",c).run(),e.json({success:!0,sessionId:d,user:{id:l.id,username:l.username,name:l.name}})});$e.post("/login",async e=>{const{username:t,pin:a}=await e.req.json();if(!t||!a)return e.json({error:"Username and PIN required"},400);const n=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first();if(!n)return e.json({error:"User not found"},404);if(!await tn(a,n.pin_hash))return e.json({error:"Invalid PIN"},401);const s=crypto.randomUUID(),i=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(s,n.id,"web",i).run(),e.json({success:!0,sessionId:s,user:{id:n.id,username:n.username,name:n.name}})});$e.post("/logout",async e=>{var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");return t&&await e.env.DB.prepare("DELETE FROM sessions WHERE id = ?").bind(t).run(),e.json({success:!0})});$e.get("/users/hints",async e=>{const a=((await e.env.DB.prepare("SELECT username, name, created_at FROM users ORDER BY created_at ASC").all()).results||[]).map(n=>{var r;return{username:n.username,name_hint:n.name.split(" ")[0],created:((r=n.created_at)==null?void 0:r.split(" ")[0])||""}});return e.json({users:a,count:a.length})});$e.post("/reset-pin",async e=>{var o;const{username:t,name:a,new_pin:n}=await e.req.json();if(!t||!a||!n)return e.json({error:"Username, display name, and new PIN are required"},400);if(n.length<4)return e.json({error:"PIN must be at least 4 characters"},400);const r=await e.env.DB.prepare("SELECT id, username, name FROM users WHERE username = ?").bind(t).first();if(!r)return e.json({error:"User not found"},404);if(r.name.toLowerCase().trim()!==a.toLowerCase().trim())return e.json({error:"Display name does not match. This is required for identity verification."},403);const s=await jt(n);await e.env.DB.prepare("UPDATE users SET pin_hash = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,r.id).run();const i=await e.env.DB.prepare("DELETE FROM credentials WHERE user_id = ?").bind(r.id).run();return await e.env.DB.prepare("DELETE FROM sessions WHERE user_id = ?").bind(r.id).run(),e.json({success:!0,message:"PIN reset successfully. All API keys and credentials have been cleared (they were encrypted with your old PIN). Please log in with your new PIN and re-enter your API keys in Settings.",credentials_cleared:((o=i.meta)==null?void 0:o.changes)||0})});$e.get("/me",async e=>{var n;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return e.json({error:"No session"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.id as uid, u.username, u.name, u.role, u.timezone 
     FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();return a?e.json({user:{id:a.uid,username:a.username,name:a.name,role:a.role,timezone:a.timezone}}):e.json({error:"Invalid or expired session"},401)});const wt={anthropic:{id:"anthropic",label:"Anthropic Claude",apiBase:"https://api.anthropic.com",apiFormat:"anthropic",defaultModel:"claude-sonnet-4-20250514",keyPlaceholder:"sk-ant-api03-...",modelHint:"claude-sonnet-4-20250514, claude-haiku-4-20250514",validatePath:"/v1/messages"},openai:{id:"openai",label:"OpenAI GPT",apiBase:"https://api.openai.com",apiFormat:"openai-compatible",defaultModel:"gpt-4o",keyPlaceholder:"sk-...",modelHint:"gpt-4o, gpt-4o-mini, o3-mini",validatePath:"/v1/models"},grok:{id:"grok",label:"xAI Grok",apiBase:"https://api.x.ai",apiFormat:"openai-compatible",defaultModel:"grok-3-mini",keyPlaceholder:"xai-...",modelHint:"grok-3-mini, grok-3",validatePath:"/v1/models"},deepseek:{id:"deepseek",label:"DeepSeek",apiBase:"https://api.deepseek.com",apiFormat:"openai-compatible",defaultModel:"deepseek-chat",keyPlaceholder:"sk-...",modelHint:"deepseek-chat, deepseek-reasoner",validatePath:"/v1/models"},gemini:{id:"gemini",label:"Google Gemini",apiBase:"https://generativelanguage.googleapis.com/v1beta/openai",apiFormat:"openai-compatible",defaultModel:"gemini-2.0-flash",keyPlaceholder:"AIzaSy...",modelHint:"gemini-2.0-flash, gemini-2.5-pro-preview",validatePath:"/models"},openrouter:{id:"openrouter",label:"OpenRouter",apiBase:"https://openrouter.ai/api",apiFormat:"openai-compatible",defaultModel:"anthropic/claude-sonnet-4",keyPlaceholder:"sk-or-...",modelHint:"e.g. deepseek/deepseek-chat, meta-llama/llama-3.1-70b",validatePath:"/v1/models"},abacus:{id:"abacus",label:"Abacus AI (RouteLLM)",apiBase:"https://routellm.abacus.ai",apiFormat:"openai-compatible",defaultModel:"route-llm",keyPlaceholder:"Your Abacus API key",modelHint:"route-llm (auto), grok-4, deepseek-v3.2, claude-4-5-sonnet, gemini-3-flash",validatePath:"/v1/models"}},Br=55e3;function an(e,t){return Promise.race([e,new Promise((a,n)=>setTimeout(()=>n(new Error(`LLM timeout: ${t} did not respond within 25 seconds. Try again or switch providers in Settings → Keys.`)),Br))])}async function P(e,t,a,n,r,s={}){try{await e.prepare("INSERT INTO error_log (user_id, source, error_type, message, details) VALUES (?, ?, ?, ?, ?)").bind(t,a,n,r,JSON.stringify(s)).run()}catch(i){console.error("Failed to log error:",i)}}async function Wt(e,t,a,n,r,s){try{const i=`provider_alert:${n}:${a}`;if(await e.prepare(`SELECT id FROM error_log WHERE user_id = ? AND source = 'provider_alert'
       AND error_type = ? AND created_at > datetime('now', '-1 hour') LIMIT 1`).bind(t,i).first())return;await P(e,t,"provider_alert",i,`${n} failed: ${s.substring(0,200)}`,{alertType:a,failedProvider:n,fallbackProvider:r});let l;a==="all_providers_down"?l=`🚨 All LLM providers failed

Last error from ${n}: ${ya(s)}
...
Check your ${n} API credit balance or key.`;const{decrypt:d}=await Promise.resolve().then(()=>na),c=await e.prepare("SELECT telegram_chat_id, pin_hash FROM users WHERE id = ?").bind(t).first();if(!(c!=null&&c.telegram_chat_id))return;const m=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(t).first();if(!m)return;const h=await d(m.encrypted_value,c.pin_hash);await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:c.telegram_chat_id,text:l})})}catch(i){console.error("Failed to send provider alert:",i)}}function ya(e){return e.includes("credit balance")||e.includes("insufficient")||e.includes("402")?"Credits exhausted or balance too low":e.includes("429")||e.includes("rate_limit")||e.includes("quota")?"Rate limit / quota exceeded":e.includes("401")||e.includes("authentication")||e.includes("invalid")&&e.includes("key")?"API key invalid or expired":e.includes("403")?"Access denied (key may lack permissions)":e.includes("TOOLS_UNSUPPORTED")?"Provider does not support tool calls":e.includes("properties field not found")?"Schema compatibility issue":"API error"}class nn{constructor(t,a="claude-sonnet-4-20250514",n="https://api.anthropic.com",r="anthropic"){A(this,"name");A(this,"apiKey");A(this,"model");A(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=n,this.name=r}async chat(t,a){var c,m,h,w;const n=t.find(f=>f.role==="system"),r=t.filter(f=>f.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:r.map(f=>({role:f.role,content:f.content}))};n&&(s.system=n.content),a!=null&&a.tools&&a.tools.length>0&&(s.tools=a.tools.map(f=>({name:f.name,description:f.description,input_schema:f.parameters})),a.toolChoice==="required"&&(s.tool_choice={type:"any"}));const i=await an(fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)}),this.name);if(!i.ok){const f=await i.text();throw new Error(this.name+" API error "+i.status+": "+f)}const o=await i.json(),l=((c=o.content)==null?void 0:c.filter(f=>f.type==="text"))||[],d=((m=o.content)==null?void 0:m.filter(f=>f.type==="tool_use"))||[];return{content:l.map(f=>f.text).join(`
`),toolCalls:d.map(f=>({id:f.id,name:f.name,arguments:f.input})),usage:{promptTokens:((h=o.usage)==null?void 0:h.input_tokens)||0,completionTokens:((w=o.usage)==null?void 0:w.output_tokens)||0}}}async streamChat(t,a){const n=t.find(d=>d.role==="system"),r=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:r.map(d=>({role:d.role,content:d.content}))};n&&(s.system=n.content);const i=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!i.ok){const d=await i.text();throw new Error(this.name+" stream error "+i.status+": "+d)}const o=i.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var f;const{done:c,value:m}=await o.read();if(c){d.close();return}const w=l.decode(m,{stream:!0}).split(`
`);for(const _ of w)if(_.startsWith("data: ")){const v=_.slice(6);if(v==="[DONE]")continue;try{const S=JSON.parse(v);S.type==="content_block_delta"&&((f=S.delta)!=null&&f.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:S.delta.text})+`

`))}catch{}}}})}}function jr(e){const t={},a=e||{};if(t.type=a.type||"object",t.type==="object"){const n=a.properties;if(n&&typeof n=="object"&&Object.keys(n).length>0){const r={};for(const[s,i]of Object.entries(n))i&&typeof i=="object"?r[s]=Vt(i):r[s]=i;t.properties=r}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(a.required)?t.required=a.required:t.required=[]}return a.description&&(t.description=a.description),t}function Vt(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const a=t.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const n={};for(const[r,s]of Object.entries(a))s&&typeof s=="object"?n[r]=Vt(s):n[r]=s;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=Vt(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class rn{constructor(t,a,n,r){A(this,"name");A(this,"apiKey");A(this,"model");A(this,"apiBase");this.apiKey=t,this.model=a,this.apiBase=n.replace(/\/+$/,""),this.name=r}async chat(t,a){var l,d,c,m,h,w;const n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,messages:t.map(f=>({role:f.role,content:f.content}))},r=this.apiBase.includes("routellm.abacus.ai");if(a!=null&&a.tools&&a.tools.length>0&&r)throw new Error("TOOLS_UNSUPPORTED: Provider "+this.name+" does not support tool calling. Needs fallback to tool-capable provider.");a!=null&&a.tools&&a.tools.length>0&&(n.tools=a.tools.map(f=>({type:"function",function:{name:f.name,description:f.description,parameters:jr(f.parameters||{})}})),a.toolChoice==="required"&&(n.tool_choice="required"));const s=await an(fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(n)}),this.name);if(!s.ok){const f=await s.text();throw new Error(this.name+" API error "+s.status+": "+f)}const i=await s.json(),o=(l=i.choices)==null?void 0:l[0];return{content:((d=o==null?void 0:o.message)==null?void 0:d.content)||"",toolCalls:(m=(c=o==null?void 0:o.message)==null?void 0:c.tool_calls)==null?void 0:m.map(f=>({id:f.id,name:f.function.name,arguments:(()=>{try{return typeof f.function.arguments=="string"?JSON.parse(f.function.arguments||"{}"):f.function.arguments||{}}catch{return{}}})()})),usage:{promptTokens:((h=i.usage)==null?void 0:h.prompt_tokens)||0,completionTokens:((w=i.usage)==null?void 0:w.completion_tokens)||0}}}async streamChat(t,a){const n={model:this.model,max_tokens:(a==null?void 0:a.maxTokens)||4096,temperature:(a==null?void 0:a.temperature)??.7,stream:!0,messages:t.map(o=>({role:o.role,content:o.content}))},r=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(n)});if(!r.ok){const o=await r.text();throw new Error(this.name+" stream error "+r.status+": "+o)}const s=r.body.getReader(),i=new TextDecoder;return new ReadableStream({async pull(o){var h,w,f;const{done:l,value:d}=await s.read();if(l){o.close();return}const m=i.decode(d,{stream:!0}).split(`
`);for(const _ of m)if(_.startsWith("data: ")){const v=_.slice(6);if(v==="[DONE]")continue;try{const E=(f=(w=(h=JSON.parse(v).choices)==null?void 0:h[0])==null?void 0:w.delta)==null?void 0:f.content;E&&o.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:E})+`

`))}catch{}}}})}}function Zt(e,t,a,n){const r=wt[e];if(!r)throw new Error(`Unknown LLM provider: ${e}`);const s=n||r.defaultModel;return r.apiFormat==="anthropic"?new nn(t,s,r.apiBase,a):new rn(t,s,r.apiBase,a)}class sn{constructor(){A(this,"errorLog",new Map);A(this,"usageLog",new Map)}async pickProvider(t){const a=Date.now(),n=t.filter(r=>{const s=this.errorLog.get(r);return s?s.cooldownUntil<=a:!0});return n.length>0?n[0]:null}async recordUsage(t,a){const n=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:n.tokens+a,requests:n.requests+1})}async recordError(t,a,n=5){this.errorLog.set(t,{error:a,cooldownUntil:Date.now()+n*60*1e3})}}const Pr=["llm_slot_1","llm_slot_2","llm_slot_3"],Ur=["anthropic","openai"];async function ut(e,t,a){const{decrypt:n}=await Promise.resolve().then(()=>na),r=new sn,s=[];for(const m of Pr){const h=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const w=await n(h.encrypted_value,a),f=JSON.parse(w);if(f.provider&&f.apiKey&&wt[f.provider]){const v=f.provider,S=Zt(f.provider,f.apiKey,v,f.model);s.push({name:v,provider:S})}}catch(w){console.error(`Failed to load ${m}:`,w)}}const i=new Set(s.map(m=>m.name));for(const m of Ur){if(i.has(m))continue;const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(h)try{const w=await n(h.encrypted_value,a);if(wt[m]){const _=Zt(m,w,m);s.push({name:m,provider:_})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const o=s.map(m=>m.name),l=await r.pickProvider(o);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:r};const d=s.find(m=>m.name===l);return{provider:Hr(d.provider,s,r,e,t),rotation:r}}function Hr(e,t,a,n,r){const s=o=>o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")||o.includes("TOOLS_UNSUPPORTED"),i=o=>o.includes("429")||o.toLowerCase().includes("rate limit")||o.toLowerCase().includes("too many requests");return t.length<=1?{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"";throw s(c)&&!c.includes("TOOLS_UNSUPPORTED")&&Wt(n,r,"all_providers_down",e.name,null,c),d}},async streamChat(o,l){return await e.streamChat(o,l)}}:{name:e.name,async chat(o,l){try{return await e.chat(o,l)}catch(d){const c=d.message||"",m=i(c);if(!s(c)&&!m)throw d;const h=c.includes("TOOLS_UNSUPPORTED"),w=h?1:m?10:1440;console.warn(`Provider ${e.name} ${m?"rate limited":h?"tools unsupported":"auth/billing error"}, trying fallback...`),await a.recordError(e.name,c,w);const f=t.filter(_=>_.name!==e.name);for(const _ of f)try{const v=await _.provider.chat(o,l);return this.name=_.name,!h&&!m&&Wt(n,r,"provider_switched",e.name,_.name,c),v}catch(v){const S=v.message||"";if(s(S)||i(S)){await a.recordError(_.name,S,i(S)?10:1440);continue}throw v}throw Wt(n,r,"all_providers_down",e.name,null,c),new Error(`All LLM providers failed. Primary (${e.name}): ${c.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(o,l){return await e.streamChat(o,l)}}}const at=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:nn,OpenAICompatibleProvider:rn,ProviderRotation:sn,createProviderFromConfig:Zt,createRotatingProvider:ut,logError:P},Symbol.toStringTag,{value:"Module"})),qt=20,Fr=2e3,Gr=2e3,on=4;function Wr(e){return Math.ceil(e.length/on)}function va(e,t){const a=t*on;return e.length<=a?e:e.slice(0,a)+`
[...truncated to fit token budget]`}class K{constructor(t){this.db=t}async store(t,a,n,r,s=5,i="working"){const o=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,a,n).first();o?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(r,s,i,o.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,n,r,s,i).run(),i==="working"&&await this.enforceWorkingMemoryCap(t)}async cleanupDoneTasks(t){await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
       WHERE user_id = ? AND type = 'task' AND status = 'done' AND tier = 'working'
       AND updated_at < datetime('now', '-7 days')`).bind(t).run()}async enforceWorkingMemoryCap(t){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((a==null?void 0:a.cnt)||0)>qt){const n=((a==null?void 0:a.cnt)||0)-qt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP
         ...
         )`).bind(t,t,n).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,qt).all()).results||[]}async getAll(t,a,n=50){return a?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a,n).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,n).all()).results||[]}async search(t,a,n=10){const s=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${a}%`,`%${a}%`,n).all()).results||[];if(s.length>0)return await this.touchMemories(t,s.map(c=>c.id)),s;const i=a.split(/\s+/).filter(c=>c.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const c of i){const m=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${c}%`,`%${c}%`,n*2).all();for(const h of m.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const d=[...l.values()].sort((c,m)=>(o.get(m.id)||0)-(o.get(c.id)||0)).slice(0,n);return d.length>0&&await this.touchMemories(t,d.map(c=>c.id)),d}async searchLongTerm(t,a,n=5){const s=(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${a}%`,`%${a}%`,n).all()).results||[];if(s.length>0)return await this.touchMemories(t,s.map(c=>c.id)),s;const i=a.split(/\s+/).filter(c=>c.length>2);if(i.length===0)return[];const o=new Map,l=new Map;for(const c of i){const m=await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'long_term' AND (title LIKE ? OR content LIKE ?) LIMIT ?").bind(t,`%${c}%`,`%${c}%`,n*2).all();for(const h of m.results||[])o.set(h.id,(o.get(h.id)||0)+1),l.set(h.id,h)}const d=[...l.values()].sort((c,m)=>(o.get(m.id)||0)-(o.get(c.id)||0)).slice(0,n);return d.length>0&&await this.touchMemories(t,d.map(c=>c.id)),d}async touchMemories(t,a){for(const n of a)await this.db.prepare("UPDATE memory SET updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(n,t).run()}async update(t,a,n){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(n,t,a).run()}async promote(t,a){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run(),await this.enforceWorkingMemoryCap(a)}async demote(t,a){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,a).run()}async remove(t,a){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,a).run()}async buildContext(t){const a=await this.getWorkingMemory(t);if(a.length===0)return"";const n={};for(const s of a)n[s.type]||(n[s.type]=[]),n[s.type].push(s);let r=`
## Working Memory (Active Context)
`;for(const[s,i]of Object.entries(n)){r+=`
### ${s.charAt(0).toUpperCase()+s.slice(1)}s
`;for(const o of i)r+=`- **${o.title}**: ${o.content}
`}return va(r,Fr)}static truncatePersonality(t){return va(t,Gr)}async getRecentConversations(t,a=20,n){return n?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,n,a).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a).all()).results||[]).reverse()}async storeMessage(t,a,n,r,s="{}",i){const o=Wr(r);i?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,a,n,r,s,o,i).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,a,n,r,s,o).run()}async compactHistory(t,a=30){const n=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((n==null?void 0:n.cnt)||0)<=a*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,a).run()}}const qr=Object.freeze(Object.defineProperty({__proto__:null,MemoryService:K},Symbol.toStringTag,{value:"Module"})),zr="https://accounts.google.com/o/oauth2/v2/auth",ln="https://oauth2.googleapis.com/token",Kr="https://www.googleapis.com/oauth2/v2/userinfo",Yr=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let be=null;async function Xt(e,t,a){const n=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!n)return null;try{const r=await Y(n.encrypted_value,a);return JSON.parse(r)}catch{return null}}async function Jr(e,t,a,n){const r=await ct(JSON.stringify(n),a);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,r).run()}function dn(e,t,a){const n=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Yr,access_type:"offline",prompt:"consent",state:a,include_granted_scopes:"true"});return`${zr}?${n}`}async function cn(e,t,a,n){const r=await fetch(ln,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:a,redirect_uri:n,grant_type:"authorization_code"})}),s=await r.text();if(!r.ok)throw new Error(`Token exchange failed (${r.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function Vr(e,t,a){const n=await fetch(ln,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:a,grant_type:"refresh_token"})}),r=await n.text();if(!n.ok)throw n.status===400||n.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${n.status}): ${r.substring(0,300)}`);return JSON.parse(r)}async function un(e){const t=await fetch(Kr,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function mt(e,t,a,n,r){if(!n||!r)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(be&&be.userId===t&&be.expiresAt>Date.now()/1e3+60){const o=await Xt(e,t,a);return{token:be.token,email:(o==null?void 0:o.email)||"unknown"}}const s=await Xt(e,t,a);if(!s)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const i=await Vr(s.refresh_token,n,r);return be={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{token:i.access_token,email:s.email}}async function ra(e,t,a){try{const n=await Xt(e,t,a);return n?{connected:!0,email:n.email,connectedAt:n.connected_at}:{connected:!1}}catch{return{connected:!1}}}function mn(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function pn(e,t,a,n,r,s,i){const o=await cn(n,s,i,r);if(!o.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await un(o.access_token),d={refresh_token:o.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Jr(e,t,a,d),be={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{email:l.email,name:l.name}}async function hn(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(be==null?void 0:be.userId)===t&&(be=null)}const Pe="https://sheets.googleapis.com/v4/spreadsheets";class gn{constructor(t,a,n,r,s){this.db=t,this.userId=a,this.pinHash=n,this.clientId=r,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,a){const n=await this.authHeaders(),r=encodeURIComponent(a),s=await fetch(`${Pe}/${t}/values/${r}`,{headers:n});if(!s.ok){const o=await s.text();throw new Error(`Sheets read failed (${s.status}): ${o}`)}return(await s.json()).values||[]}async writeRange(t,a,n){const r=await this.authHeaders(),s=encodeURIComponent(a),i=await fetch(`${Pe}/${t}/values/${s}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:r,body:JSON.stringify({range:a,majorDimension:"ROWS",values:n})});if(!i.ok){const l=await i.text();throw new Error(`Sheets write failed (${i.status}): ${l}`)}return{updatedCells:(await i.json()).updatedCells||0}}async appendRows(t,a,n){var l;const r=await this.authHeaders(),s=encodeURIComponent(a),i=await fetch(`${Pe}/${t}/values/${s}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:r,body:JSON.stringify({range:a,majorDimension:"ROWS",values:n})});if(!i.ok){const d=await i.text();throw new Error(`Sheets append failed (${i.status}): ${d}`)}return{updatedCells:((l=(await i.json()).updates)==null?void 0:l.updatedCells)||n.length}}async deleteRow(t,a,n){const r=await this.authHeaders(),s=await fetch(`${Pe}/${t}?fields=sheets.properties`,{headers:r});if(!s.ok){const m=await s.text();throw new Error(`Failed to get sheet metadata (${s.status}): ${m}`)}const i=await s.json(),o=i.sheets.find(m=>m.properties.title===a);if(!o){const m=i.sheets.map(h=>h.properties.title).join(", ");throw new Error(`Tab "${a}" not found. Available tabs: ${m}`)}const l=o.properties.sheetId,d=n-1,c=await fetch(`${Pe}/${t}:batchUpdate`,{method:"POST",headers:r,body:JSON.stringify({requests:[{deleteDimension:{range:{sheetId:l,dimension:"ROWS",startIndex:d,endIndex:d+1}}}]})});if(!c.ok){const m=await c.text();throw new Error(`Row delete failed (${c.status}): ${m}`)}}async createSpreadsheet(t,a){const n=await this.authHeaders(),r={properties:{title:t},sheets:a&&a.length>0?a.map(o=>({properties:{title:o}})):[{properties:{title:"Sheet1"}}]},s=await fetch(Pe,{method:"POST",headers:n,body:JSON.stringify(r)});if(!s.ok){const o=await s.text();throw new Error(`Sheets create failed (${s.status}): ${o}`)}const i=await s.json();return{spreadsheetId:i.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${i.spreadsheetId}/edit`}}async getMetadata(t){const a=await this.authHeaders(),n=await fetch(`${Pe}/${t}?fields=properties.title,sheets.properties.title`,{headers:a});if(!n.ok){const s=await n.text();throw new Error(`Sheets metadata failed (${n.status}): ${s}`)}const r=await n.json();return{title:r.properties.title,sheets:r.sheets.map(s=>s.properties.title)}}}const gt="https://www.googleapis.com/calendar/v3";class sa{constructor(t,a,n,r,s){this.db=t,this.userId=a,this.pinHash=n,this.clientId=r,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",a={}){const n=await this.authHeaders(),r=new URLSearchParams;a.timeMin&&r.set("timeMin",a.timeMin),a.timeMax&&r.set("timeMax",a.timeMax),r.set("maxResults",String(a.maxResults||20)),r.set("singleEvents","true"),r.set("orderBy","startTime"),a.query&&r.set("q",a.query);const s=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events?${r}`,{headers:n});if(!s.ok){const o=await s.text();throw new Error(`Calendar list failed (${s.status}): ${o}`)}return(await s.json()).items||[]}async createEvent(t="primary",a){var o;const n=await this.authHeaders(),r=a.timeZone||"Asia/Kolkata",s={summary:a.summary,description:a.description||"",location:a.location||"",start:{dateTime:a.startDateTime,timeZone:r},end:{dateTime:a.endDateTime,timeZone:r}};(o=a.attendees)!=null&&o.length&&(s.attendees=a.attendees.map(l=>({email:l})));const i=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:n,body:JSON.stringify(s)});if(!i.ok){const l=await i.text();throw new Error(`Calendar create failed (${i.status}): ${l}`)}return await i.json()}async updateEvent(t="primary",a,n){const r=await this.authHeaders(),s=n.timeZone||"Asia/Kolkata",i={};n.summary&&(i.summary=n.summary),n.description&&(i.description=n.description),n.location&&(i.location=n.location),n.startDateTime&&(i.start={dateTime:n.startDateTime,timeZone:s}),n.endDateTime&&(i.end={dateTime:n.endDateTime,timeZone:s});const o=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"PATCH",headers:r,body:JSON.stringify(i)});if(!o.ok){const l=await o.text();throw new Error(`Calendar update failed (${o.status}): ${l}`)}return await o.json()}async deleteEvent(t="primary",a){const n=await this.authHeaders(),r=await fetch(`${gt}/calendars/${encodeURIComponent(t)}/events/${a}`,{method:"DELETE",headers:n});if(!r.ok&&r.status!==410){const s=await r.text();throw new Error(`Calendar delete failed (${r.status}): ${s}`)}}async listCalendars(){const t=await this.authHeaders(),a=await fetch(`${gt}/users/me/calendarList`,{headers:t});if(!a.ok){const r=await a.text();throw new Error(`Calendar list calendars failed (${a.status}): ${r}`)}return((await a.json()).items||[]).map(r=>({id:r.id,summary:r.summary,primary:r.primary||!1}))}}const Ee="https://docs.googleapis.com/v1/documents",Zr="https://www.googleapis.com/drive/v3/files";function wa(e){const t=[];for(const a of e.split(`
`)){const n=a.trim();if(n===""||/^---+$/.test(n))continue;let r="NORMAL_TEXT",s=a;const i=n.match(/^###\s+(.+)/),o=!i&&n.match(/^##\s+(.+)/),l=!i&&!o&&n.match(/^#\s+(.+)/);i?(r="HEADING_3",s=i[1]):o?(r="HEADING_2",s=o[1]):l?(r="HEADING_1",s=l[1]):/^\s*[-*]\s/.test(a)&&(s="• "+a.replace(/^\s*[-*]\s+/,""));const{text:d,spans:c}=Xr(s);t.push({text:d,namedStyle:r,spans:c})}return t}function Xr(e){const t=[];let a="",n=0;for(;n<e.length;)if(e[n]==="*"&&e[n+1]==="*"){const r=e.indexOf("**",n+2);if(r!==-1){const s=a.length;a+=e.substring(n+2,r),t.push({start:s,end:a.length,bold:!0}),n=r+2}else a+=e[n++]}else if(e[n]==="_"&&e[n+1]==="_"){const r=e.indexOf("__",n+2);if(r!==-1){const s=a.length;a+=e.substring(n+2,r),t.push({start:s,end:a.length,bold:!0}),n=r+2}else a+=e[n++]}else if(e[n]==="*"&&e[n+1]!=="*"){const r=e.indexOf("*",n+1);if(r!==-1){const s=a.length;a+=e.substring(n+1,r),t.push({start:s,end:a.length,italic:!0}),n=r+1}else a+=e[n++]}else if(e[n]==="_"){const r=e.indexOf("_",n+1);if(r!==-1){const s=a.length;a+=e.substring(n+1,r),t.push({start:s,end:a.length,italic:!0}),n=r+1}else a+=e[n++]}else a+=e[n++];return{text:a,spans:t}}class fn{constructor(t,a,n,r,s){this.db=t,this.userId=a,this.pinHash=n,this.clientId=r,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const a=await this.authHeaders(),n=await fetch(Ee,{method:"POST",headers:a,body:JSON.stringify({title:t})});if(!n.ok){const s=await n.text();throw new Error(`Docs create failed (${n.status}): ${s}`)}const r=await n.json();return{documentId:r.documentId,url:`https://docs.google.com/document/d/${r.documentId}/edit`}}async readDocument(t){var i,o;const a=await this.authHeaders(),n=await fetch(`${Ee}/${t}`,{headers:a});if(!n.ok){const l=await n.text();throw new Error(`Docs read failed (${n.status}): ${l}`)}const r=await n.json();let s="";for(const l of((i=r.body)==null?void 0:i.content)||[])if(l.paragraph)for(const d of l.paragraph.elements)(o=d.textRun)!=null&&o.content&&(s+=d.textRun.content);return{title:r.title,content:s.trim()}}async rewriteDocument(t,a){var f;const n=await this.authHeaders(),r=await fetch(`${Ee}/${t}`,{headers:n});if(!r.ok){const _=await r.text();throw new Error(`Docs fetch failed (${r.status}): ${_.substring(0,200)}`)}const i=((f=(await r.json()).body)==null?void 0:f.content)||[],o=i[i.length-1],l=(o==null?void 0:o.endIndex)??2,d=wa(a),c=[];if(l>2&&c.push({deleteContentRange:{range:{startIndex:1,endIndex:l-1}}}),d.length===0){c.length>0&&await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:n,body:JSON.stringify({requests:c})});return}let m="";const h=[];for(const _ of d){const v=m.length;m+=_.text+`
`,h.push({start:v,end:m.length,namedStyle:_.namedStyle,spans:_.spans})}c.push({insertText:{location:{index:1},text:m}});for(const _ of h){_.namedStyle!=="NORMAL_TEXT"&&c.push({updateParagraphStyle:{range:{startIndex:1+_.start,endIndex:1+_.end},paragraphStyle:{namedStyleType:_.namedStyle},fields:"namedStyleType"}});for(const v of _.spans){const S={},E=[];v.bold&&(S.bold=!0,E.push("bold")),v.italic&&(S.italic=!0,E.push("italic")),E.length>0&&c.push({updateTextStyle:{range:{startIndex:1+_.start+v.start,endIndex:1+_.start+v.end},textStyle:S,fields:E.join(",")}})}}const w=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:n,body:JSON.stringify({requests:c})});if(!w.ok){const _=await w.text();throw new Error(`Docs rewrite failed (${w.status}): ${_.substring(0,200)}`)}}async appendFormattedContent(t,a){var f;const n=await this.authHeaders(),r=wa(a);if(r.length===0)return;const s=await fetch(`${Ee}/${t}`,{headers:n});if(!s.ok){const _=await s.text();throw new Error(`Docs fetch failed (${s.status}): ${_.substring(0,200)}`)}const o=((f=(await s.json()).body)==null?void 0:f.content)||[],l=o[o.length-1],d=Math.max(1,((l==null?void 0:l.endIndex)??2)-1);let c="";const m=[];for(const _ of r){const v=c.length;c+=_.text+`
`,m.push({start:v,end:c.length,namedStyle:_.namedStyle,spans:_.spans})}const h=[{insertText:{location:{index:d},text:c}}];for(const _ of m){_.namedStyle!=="NORMAL_TEXT"&&h.push({updateParagraphStyle:{range:{startIndex:d+_.start,endIndex:d+_.end},paragraphStyle:{namedStyleType:_.namedStyle},fields:"namedStyleType"}});for(const v of _.spans){const S={},E=[];v.bold&&(S.bold=!0,E.push("bold")),v.italic&&(S.italic=!0,E.push("italic")),E.length>0&&h.push({updateTextStyle:{range:{startIndex:d+_.start+v.start,endIndex:d+_.start+v.end},textStyle:S,fields:E.join(",")}})}}const w=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:n,body:JSON.stringify({requests:h})});if(!w.ok){const _=await w.text();throw new Error(`Docs append failed (${w.status}): ${_.substring(0,200)}`)}}async appendText(t,a){const n=await this.authHeaders(),r=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:n,body:JSON.stringify({requests:[{insertText:{endOfSegmentLocation:{},text:a}}]})});if(!r.ok){const s=await r.text();throw new Error(`Docs append failed (${r.status}): ${s}`)}}async deleteContent(t,a){var i,o,l;const n=await this.authHeaders(),r=await fetch(`${Ee}/${t}:batchUpdate`,{method:"POST",headers:n,body:JSON.stringify({requests:[{replaceAllText:{containsText:{text:a,matchCase:!0},replaceText:""}}]})});if(!r.ok){const d=await r.text();throw new Error(`Docs delete content failed (${r.status}): ${d.substring(0,200)}`)}return{occurrencesRemoved:((l=(o=(i=(await r.json()).replies)==null?void 0:i[0])==null?void 0:o.replaceAllText)==null?void 0:l.occurrencesChanged)??0}}async shareDocument(t,a,n="writer"){const r=await this.authHeaders(),s=await fetch(`${Zr}/${t}/permissions`,{method:"POST",headers:r,body:JSON.stringify({type:"user",role:n,emailAddress:a})});if(!s.ok){const i=await s.text();throw new Error(`Share failed (${s.status}): ${i}`)}}}class ce{constructor(t,a,n,r,s){A(this,"sheets");A(this,"calendar");A(this,"docs");A(this,"db");A(this,"userId");A(this,"pinHash");this.db=t,this.userId=a,this.pinHash=n,this.sheets=new gn(t,a,n,r,s),this.calendar=new sa(t,a,n,r,s),this.docs=new fn(t,a,n,r,s)}async isConnected(){return ra(this.db,this.userId,this.pinHash)}}const Ue=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:sa,GoogleDocs:fn,GoogleServices:ce,GoogleSheets:gn,completeOAuthFlow:pn,disconnectGoogle:hn,exchangeCodeForTokens:cn,fetchUserInfo:un,generateAuthUrl:dn,getGoogleAuth:mt,isGoogleConnected:ra,isOAuthClientConfigured:mn},Symbol.toStringTag,{value:"Module"}));async function yn(e,t,a={}){const n={textQuery:t,languageCode:"en",pageSize:8};if(a.type&&(n.includedType=a.type),a.location){const l=a.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(n.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:a.radius||5e3}})}const r=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),s=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":r},body:JSON.stringify(n)});if(!s.ok){const l=await s.text();return{results:[],error:`Places API error (${s.status}): ${l.substring(0,200)}`}}const i=await s.json();return!i.places||i.places.length===0?{results:[]}:{results:i.places.map(l=>{var d,c,m;return{name:((d=l.displayName)==null?void 0:d.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(c=l.currentOpeningHours)==null?void 0:c.openNow,types:(m=l.types)==null?void 0:m.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function vn(e,t){var s,i,o;const a=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),n=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":a}});if(!n.ok){const l=await n.text();return{error:`Place Details API error (${n.status}): ${l.substring(0,200)}`}}const r=await n.json();return{details:{name:((s=r.displayName)==null?void 0:s.text)||"",address:r.formattedAddress||"",phone:r.internationalPhoneNumber,website:r.websiteUri,rating:r.rating,reviews:(i=r.reviews)==null?void 0:i.slice(0,3).map(l=>{var d,c,m;return{author:((d=l.authorAttribution)==null?void 0:d.displayName)||"Anonymous",rating:l.rating||0,text:((m=(c=l.text)==null?void 0:c.text)==null?void 0:m.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(o=r.currentOpeningHours)==null?void 0:o.weekdayDescriptions,location:r.location?{lat:r.location.latitude,lng:r.location.longitude}:void 0,googleMapsUri:r.googleMapsUri}}}async function wn(e,t,a,n={}){var d;const r=new URLSearchParams({origin:t,destination:a,key:e,mode:n.mode||"driving"});(n.mode==="driving"||!n.mode)&&r.set("departure_time","now");const s=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${r}`);if(!s.ok)return{error:`Directions API error: ${s.status}`};const i=await s.json();if(i.status!=="OK")return{error:`Directions: ${i.status} — ${i.error_message||""}`};const o=i.routes[0],l=o.legs[0];return{route:{summary:o.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(d=l.duration_in_traffic)==null?void 0:d.text,steps:l.steps.slice(0,10).map(c=>{var m,h,w;return{instruction:((m=c.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((h=c.distance)==null?void 0:h.text)||"",duration:((w=c.duration)==null?void 0:w.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function bn(e,t,a,n){var l,d;const r={q:t,target:a,key:e,format:"text"};n&&(r.source=n);const s=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!s.ok){const c=await s.text();return{translatedText:"",error:`Translate API error (${s.status}): ${c.substring(0,200)}`}}const o=(d=(l=(await s.json()).data)==null?void 0:l.translations)==null?void 0:d[0];return o?{translatedText:o.translatedText,detectedSourceLang:o.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function _n(e,t){const a=new URLSearchParams({address:t,key:e}),n=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${a}`);if(!n.ok)return{results:[],error:`Geocoding API error: ${n.status}`};const r=await n.json();return r.status!=="OK"&&r.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${r.status} — ${r.error_message||""}`}:{results:(r.results||[]).slice(0,5).map(s=>{var i;return{address:s.formatted_address,lat:s.geometry.location.lat,lng:s.geometry.location.lng,placeId:s.place_id,types:(i=s.types)==null?void 0:i.slice(0,3)}})}}async function En(e,t,a={}){const n=new URLSearchParams({part:"snippet",q:t,key:e,type:a.type||"video",maxResults:String(a.maxResults||5),order:a.order||"relevance"}),r=await fetch(`https://www.googleapis.com/youtube/v3/search?${n}`);if(!r.ok){const i=await r.text();return{results:[],error:`YouTube API error (${r.status}): ${i.substring(0,200)}`}}return{results:((await r.json()).items||[]).map(i=>{var o,l,d,c,m,h,w,f;return{title:i.snippet.title,channelTitle:i.snippet.channelTitle,description:(o=i.snippet.description)==null?void 0:o.substring(0,200),videoId:((l=i.id)==null?void 0:l.videoId)||((d=i.id)==null?void 0:d.channelId)||((c=i.id)==null?void 0:c.playlistId)||"",publishedAt:i.snippet.publishedAt,url:(m=i.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${i.id.videoId}`:(h=i.id)!=null&&h.channelId?`https://www.youtube.com/channel/${i.id.channelId}`:"",thumbnailUrl:(f=(w=i.snippet.thumbnails)==null?void 0:w.medium)==null?void 0:f.url}})}}async function Pt(e,t={}){const a=Math.min(t.num||5,10),n=t.site?`site:${t.site} ${e}`:e;try{const r=new URLSearchParams({q:n}),s=await fetch(`https://html.duckduckgo.com/html/?${r}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!s.ok)return{results:[],error:`Search request failed (${s.status})`};const i=await s.text(),o=[],l=i.split(/class="result results_links/g).slice(1);for(const d of l){if(o.length>=a)break;const c=d.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=d.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(c){let h=c[1];const w=h.match(/uddg=([^&]+)/);w?h=decodeURIComponent(w[1]):h.startsWith("//")&&(h="https:"+h);const f=S=>S.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),_=f(c[2]),v=m?f(m[1]):"";if(_&&h.startsWith("http")){const S=h.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];o.push({title:_,link:h,snippet:v,displayLink:S})}}}return o.length===0?{results:[],error:void 0}:{results:o}}catch(r){return{results:[],error:`Web search error: ${r.message}`}}}async function Tn(e,t,a,n="driving"){var l,d,c,m;const r=new URLSearchParams({origins:t,destinations:a,key:e,mode:n,departure_time:"now"}),s=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${r}`);if(!s.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${s.status}`};const i=await s.json(),o=(c=(d=(l=i.rows)==null?void 0:l[0])==null?void 0:d.elements)==null?void 0:c[0];return!o||o.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(o==null?void 0:o.status)||i.status}`}:{distance:o.distance.text,duration:o.duration.text,durationInTraffic:(m=o.duration_in_traffic)==null?void 0:m.text}}const Qr=Object.freeze(Object.defineProperty({__proto__:null,geocode:_n,getDirections:wn,getDistanceMatrix:Tn,getPlaceDetails:vn,searchPlaces:yn,searchYouTube:En,translateText:bn,webSearch:Pt},Symbol.toStringTag,{value:"Module"})),Te="https://gmail.googleapis.com/gmail/v1/users/me";class ve{constructor(t,a,n,r,s){this.db=t,this.userId=a,this.pinHash=n,this.clientId=r,this.clientSecret=s}async authHeaders(){const{token:t}=await mt(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var o;const a=await this.authHeaders(),n=new URLSearchParams;if(n.set("maxResults",String(t.maxResults||10)),t.query&&n.set("q",t.query),(o=t.labelIds)!=null&&o.length)for(const l of t.labelIds)n.append("labelIds",l);const r=await fetch(`${Te}/messages?${n}`,{headers:a});if(!r.ok){const l=await r.text();throw new Error(`Gmail list failed (${r.status}): ${l.substring(0,200)}`)}const s=await r.json();if(!s.messages||s.messages.length===0)return[];const i=[];for(const l of s.messages.slice(0,t.maxResults||10))try{const d=await this.getMessage(l.id,a);d&&i.push(d)}catch{}return i}async getMessage(t,a){const n=a||await this.authHeaders(),r=await fetch(`${Te}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:n});if(!r.ok)return null;const s=await r.json(),i=o=>{var l,d,c;return((c=(d=(l=s.payload)==null?void 0:l.headers)==null?void 0:d.find(m=>m.name.toLowerCase()===o.toLowerCase()))==null?void 0:c.value)||""};return{id:s.id,threadId:s.threadId,snippet:s.snippet||"",subject:i("Subject")||"(no subject)",from:i("From"),to:i("To"),date:i("Date")||new Date(parseInt(s.internalDate)).toISOString(),isUnread:(s.labelIds||[]).includes("UNREAD"),labels:s.labelIds||[]}}async getMessageBody(t){const a=await this.authHeaders(),n=await fetch(`${Te}/messages/${t}?format=full`,{headers:a});if(!n.ok){const s=await n.text();throw new Error(`Gmail message body failed (${n.status}): ${s.substring(0,200)}`)}const r=await n.json();return Sn(r.payload)}async search(t,a=10){return this.listMessages({query:t,maxResults:a})}async send(t,a,n,r={}){const s=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];r.cc&&i.push(`Cc: ${r.cc}`),r.bcc&&i.push(`Bcc: ${r.bcc}`),r.replyToMessageId&&(i.push(`In-Reply-To: ${r.replyToMessageId}`),i.push(`References: ${r.replyToMessageId}`)),i.push("",n);const o=i.join(`\r
`),d={raw:ba(o)};r.threadId&&(d.threadId=r.threadId);const c=await fetch(`${Te}/messages/send`,{method:"POST",headers:s,body:JSON.stringify(d)});if(!c.ok){const m=await c.text();throw new Error(`Gmail send failed (${c.status}): ${m.substring(0,200)}`)}return await c.json()}async createDraft(t,a,n,r={}){const s=await this.authHeaders(),i=[`To: ${t}`,`Subject: ${a}`,"MIME-Version: 1.0","Content-Type: text/html; charset=UTF-8"];r.cc&&i.push(`Cc: ${r.cc}`),i.push("",es(n));const o=i.join(`\r
`),l=ba(o),d=await fetch(`${Te}/drafts`,{method:"POST",headers:s,body:JSON.stringify({message:{raw:l}})});if(!d.ok){const c=await d.text();throw new Error(`Gmail draft failed (${d.status}): ${c.substring(0,200)}`)}return await d.json()}async markAsRead(t){const a=await this.authHeaders();await fetch(`${Te}/messages/${t}/modify`,{method:"POST",headers:a,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,a){const n=await this.authHeaders();let r={};switch(a){case"archive":r={removeLabelIds:["INBOX"]};break;case"trash":r={addLabelIds:["TRASH"]};break;case"read":r={removeLabelIds:["UNREAD"]};break;case"unread":r={addLabelIds:["UNREAD"]};break;case"star":r={addLabelIds:["STARRED"]};break;case"unstar":r={removeLabelIds:["STARRED"]};break}const s=await fetch(`${Te}/messages/${t}/modify`,{method:"POST",headers:{...n,"Content-Type":"application/json"},body:JSON.stringify(r)});if(!s.ok){const i=await s.text();throw new Error(`Failed to modify message: ${i}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),a=await fetch(`${Te}/labels/INBOX`,{headers:t});return a.ok&&(await a.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),a=await fetch(`${Te}/profile`,{headers:t});if(!a.ok)throw new Error("Failed to get Gmail profile");return await a.json()}}function Sn(e){var t,a,n;if(!e)return"";if((t=e.body)!=null&&t.data)return zt(e.body.data);if(e.parts){for(const r of e.parts)if(r.mimeType==="text/plain"&&((a=r.body)!=null&&a.data))return zt(r.body.data);for(const r of e.parts)if(r.mimeType==="text/html"&&((n=r.body)!=null&&n.data)){const s=zt(r.body.data);return ts(s)}for(const r of e.parts)if(r.parts){const s=Sn(r);if(s)return s}}return e.snippet||""}function es(e){let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");return t=t.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>"),t=t.replace(new RegExp("(?<!\\*)\\*(?!\\*)(.+?)(?<!\\*)\\*(?!\\*)","g"),"<em>$1</em>"),`<html><body style="font-family:Arial,sans-serif;font-size:14px;line-height:1.6;color:#000000;">${t.split(/\n\n+/).map(r=>{const s=r.split(`
`);return s.every(i=>/^\s*[-*]\s/.test(i)||i.trim()==="")?`<ul>${s.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*[-*]\s+/,"")}</li>`).join("")}</ul>`:s.every(i=>/^\s*\d+\.\s/.test(i)||i.trim()==="")?`<ol>${s.filter(o=>o.trim()).map(o=>`<li>${o.replace(/^\s*\d+\.\s+/,"")}</li>`).join("")}</ol>`:`<p>${s.join("<br>")}</p>`}).join("")}</body></html>`}function ba(e){const t=new TextEncoder().encode(e);let a="";for(let n=0;n<t.length;n++)a+=String.fromCharCode(t[n]);return btoa(a).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function zt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function ts(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const as=1e4,ns=1e4;async function xn(e,t){try{const a=new AbortController,n=setTimeout(()=>a.abort(),ns),r=await fetch(e,{signal:a.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(!r.ok)return{text:"",error:`HTTP ${r.status}`};const s=r.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const i=await r.text();clearTimeout(n);const o=i.length>2e5?i.substring(0,2e5):i,l=rs(o);return l.length<50?{text:"",error:"Page has too little readable content"}:{text:l.substring(0,t||as)}}catch(a){return{text:"",error:a.name==="AbortError"?"Timeout":a.message}}}function rs(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
• `),t=t.replace(/<[^>]+>/g,""),t=t.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&#x27;/g,"'").replace(/&nbsp;/g," ").replace(/&#(\d+);/g,(a,n)=>String.fromCharCode(parseInt(n))),t=t.replace(/[ \t]+/g," "),t=t.replace(/\n\s*\n/g,`

`),t=t.split(`
`).map(a=>a.trim()).filter(a=>a.length>0).join(`
`),t.trim()}const ss=1e4;async function is(e,t){var r,s,i;const a=new AbortController,n=setTimeout(()=>a.abort(),ss);try{const o=await fetch("https://api.perplexity.ai/chat/completions",{method:"POST",signal:a.signal,headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"},body:JSON.stringify({model:"sonar-pro",messages:[{role:"user",content:e}],max_tokens:2e3})});if(clearTimeout(n),!o.ok)return{report:"",sources:[],pagesRead:0,error:`Perplexity error ${o.status}`};const l=await o.json(),d=((i=(s=(r=l==null?void 0:l.choices)==null?void 0:r[0])==null?void 0:s.message)==null?void 0:i.content)||"",m=((l==null?void 0:l.citations)||[]).map(h=>({title:h,url:h,snippet:""}));return{report:d,sources:m,pagesRead:m.length}}catch(o){return clearTimeout(n),{report:"",sources:[],pagesRead:0,error:`Perplexity request failed: ${o.message}`}}}async function kn(e,t,a={}){if(a.perplexityApiKey){const h=await is(e,a.perplexityApiKey);if(!h.error)return h}const n=a.maxPages||(a.depth==="thorough"?5:3),r=a.maxResults||(a.depth==="thorough"?8:5),s=await Pt(e,{num:r,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,n).map(async h=>{const w=await xn(h.link);return{title:h.title,url:h.link,displayLink:h.displayLink,snippet:h.snippet,content:w.text,error:w.error}}),d=(await Promise.all(o)).filter(h=>h.content.length>50);if(d.length===0){const h=s.results.map((f,_)=>`[${_+1}] ${f.title}
${f.snippet}
Source: ${f.link}`).join(`

`);return{report:await _a(e,h,t,"snippets"),sources:s.results.map(f=>({title:f.title,url:f.link})),pagesRead:0}}const c=d.map((h,w)=>`--- SOURCE ${w+1}: ${h.title} (${h.displayLink}) ---
${h.content}
--- END SOURCE ${w+1} ---`).join(`

`);return{report:await _a(e,c,t,"full"),sources:d.map(h=>({title:h.title,url:h.url})),pagesRead:d.length}}async function _a(e,t,a,n){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
${n}
`:"",o=Ta(t,hs);return`You are ${r} — a personal AI assistant. Your name is ${r} — always refer to yourself by this name if asked.
...
- **Long content intent check**: When asked to write long-form content (essay, article, report — likely over 200 words) WITHOUT a save destination specified, do NOT start writing. Ask first: "Should I save this as a Google Doc and send you the link, or write it here in chat?" Wait for the response. If Drive/Doc, call \`create_doc\` with full content and return only the link. **Exception: if you have already executed one or more tools in this chain (e.g. research, web_search), skip this check and continue directly to the next step.**`:""}`}async function Yt(e,t,a){var d;const r=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=r.files)==null?void 0:d.length)>0?s=r.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function Mt(e){return e.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"").replace(/<function_calls>[\s\S]*?<\/function_calls>/gi,"").replace(/<function_result>[\s\S]*?<\/function_result>/gi,"").trim()}function $n(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function bt(e,t,a,n,r,s,i,o,l,d,c,m,h){const w=Date.now();let f=!0,_="",v="";try{return v=await fs(e,t,a,n,s,i,o,l,d,c,m,h),v}catch(S){throw f=!1,_=S.message||"Unknown error",S}finally{const S=Date.now()-w;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(n,r.agentType||null,r.providerName||null,e,JSON.stringify(t).substring(0,2e3),(f?v:"").substring(0,500),f?1:0,_||null,S,r.isEnforcementRetry?1:0,r.channel||"web").run()}catch{}}}function Bn(e){const t=e.length;for(let a=0;a<t-1;a++){const n=e[a];if(n.role!=="user"||typeof n.content!="string")continue;const r=t-1-a,s=r<=2?12e3:r<=4?5e3:2e3;n.content.length>s&&(e[a]={...n,content:n.content.substring(0,s)+`
[...truncated in history to reduce context size]`})}}function gs(e){const t=[];let a=[],n="",r=!1,s=0;const i=e.length;for(;s<i;){const o=e[s];if(r){if(o==='"'){if(e[s+1]==='"'){n+='"',s+=2;continue}r=!1,s++;continue}n+=o,s++;continue}if(o==='"'){r=!0,s++;continue}if(o===","){a.push(n),n="",s++;continue}if(o==="\r"&&e[s+1]===`
`){a.push(n),t.push(a),a=[],n="",s+=2;continue}if(o===`
`||o==="\r"){a.push(n),t.push(a),a=[],n="",s++;continue}n+=o,s++}for((n||a.length)&&(a.push(n),t.push(a));t.length&&t[t.length-1].every(o=>o==="");)t.pop();return t}async function fs(e,t,a,n,r,s,i,o,l,d,c,m){var w,f,_,v,S,E,O,I,M,q,H,$,W,z,R,U;const h=new K(a);switch(e){case"create_schedule":{const u=new Date;let y;const p=d||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){y=new Date(u.getTime()+t.minutes_from_now*60*1e3);const D=y.toLocaleString("en-US",{timeZone:p,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,B,C]=(D[0]||"").split("/");t.schedule_value=`${C}-${N}-${B} ${D[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const T=parseInt(t.schedule_value,10);y=new Date(u.getTime()+T*60*1e3)}else if(t.schedule_type==="daily"){const[T,D]=t.schedule_value.split(":").map(Number),N=u.toLocaleString("en-US",{timeZone:p}),B=new Date(N),C=new Date(B);C.setHours(T,D,0,0),C<=B&&C.setDate(C.getDate()+1);const L=new Date(C.toLocaleString("en-US",{timeZone:"UTC"})),F=new Date(C.toLocaleString("en-US",{timeZone:p})),J=L.getTime()-F.getTime();y=new Date(C.getTime()+J)}else if(t.schedule_type==="weekly"){const[T,D]=t.schedule_value.split(" "),[N,B]=(D||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ve=>Ve.toLowerCase()===T.toLowerCase()),F=u.toLocaleString("en-US",{timeZone:p}),J=new Date(F),X=new Date(J);X.setHours(N,B,0,0);let ee=(L-X.getDay()+7)%7;ee===0&&X<=J&&(ee=7),X.setDate(X.getDate()+ee);const Q=new Date(X.toLocaleString("en-US",{timeZone:"UTC"})),se=new Date(X.toLocaleString("en-US",{timeZone:p})),me=Q.getTime()-se.getTime();y=new Date(X.getTime()+me)}else if(t.schedule_type==="once"){const[T,D]=t.schedule_value.split(" "),[N,B,C]=T.split("-").map(Number),[L,F]=(D||"00:00").split(":").map(Number),J=u.toLocaleString("en-US",{timeZone:p}),X=new Date(J),ee=new Date(X);ee.setFullYear(N,B-1,C),ee.setHours(L,F,0,0);const Q=new Date(ee.toLocaleString("en-US",{timeZone:"UTC"})),se=new Date(ee.toLocaleString("en-US",{timeZone:p})),me=Q.getTime()-se.getTime();y=new Date(ee.getTime()+me);const Ve=new Date(u.getTime()+120*1e3);if(y.getTime()<u.getTime()+60*1e3){const Ut=y.toISOString();y=Ve;const pt=` [Note: The requested time ${t.schedule_value} in ${p} resolved to ${Ut} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${y.toISOString()}.]`;t._pastTimeWarning=pt}}else y=new Date(u.getTime()+3600*1e3);if(await a.prepare("SELECT id FROM cron_jobs WHERE user_id = ? AND name = ? AND schedule_type = ? AND schedule_value = ? AND state != 'completed' LIMIT 1").bind(n,t.name,t.schedule_type,t.schedule_value).first()){const T=y.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule already exists: "${t.name}" is already set for ${T} (${p}). No duplicate created.`}await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(n,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),y.toISOString()).run();const b=t._pastTimeWarning||"",x=y.toLocaleString("en-US",{timeZone:p,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${x} (${p}). [UTC: ${y.toISOString()}]${b}. IMPORTANT: Use the exact time "${x}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const y=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(n).all()).results||[];return y.length===0?"No scheduled tasks found.":y.map(p=>`[ID:${p.id}] ${p.enabled?"▶":"⏸"} "${p.name}" — [${p.schedule_type}] ${p.schedule_value} — ${p.action_type} — state: ${p.state||"active"} — next: ${p.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,y=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,y,t.job_id,n).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],y=t.state;if(!u.includes(y))return`Invalid state "${y}". Valid states: ${u.join(", ")}`;const p=y==="completed"||y==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(y,p,t.job_id,n).run(),`Schedule ${t.job_id} state updated to "${y}".`}case"update_schedule":{const u=t.job_id,y=d||"UTC",p=new Date,g=["updated_at = CURRENT_TIMESTAMP"],b=[];t.name&&(g.push("name = ?"),b.push(t.name)),t.description&&(g.push("description = ?"),b.push(t.description));let x=null,T=t.schedule_type,D=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){x=new Date(p.getTime()+t.minutes_from_now*60*1e3);const C=x.toLocaleString("en-US",{timeZone:y,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[L,F,J]=(C[0]||"").split("/");D=`${J}-${L}-${F} ${C[1]||"00:00"}`,T="once"}else if(T&&D){if(T==="interval")x=new Date(p.getTime()+parseInt(D,10)*60*1e3);else if(T==="daily"){const[B,C]=D.split(":").map(Number),L=new Date(p.toLocaleString("en-US",{timeZone:y})),F=new Date(L);F.setHours(B,C,0,0),F<=L&&F.setDate(F.getDate()+1);const J=new Date(F.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(F.toLocaleString("en-US",{timeZone:y})).getTime();x=new Date(F.getTime()+J)}else if(T==="weekly"){const[B,C]=D.split(" "),[L,F]=(C||"00:00").split(":").map(Number),X=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Ve=>Ve.toLowerCase()===B.toLowerCase()),ee=new Date(p.toLocaleString("en-US",{timeZone:y})),Q=new Date(ee);Q.setHours(L,F,0,0);let se=(X-Q.getDay()+7)%7;se===0&&Q<=ee&&(se=7),Q.setDate(Q.getDate()+se);const me=new Date(Q.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(Q.toLocaleString("en-US",{timeZone:y})).getTime();x=new Date(Q.getTime()+me)}else if(T==="once"){const[B,C]=D.split(" "),[L,F,J]=B.split("-").map(Number),[X,ee]=(C||"00:00").split(":").map(Number),Q=new Date(p.toLocaleString("en-US",{timeZone:y})),se=new Date(Q);se.setFullYear(L,F-1,J),se.setHours(X,ee,0,0);const me=new Date(se.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(se.toLocaleString("en-US",{timeZone:y})).getTime();x=new Date(se.getTime()+me),x.getTime()<p.getTime()+60*1e3&&(x=new Date(p.getTime()+120*1e3))}}if(T&&(g.push("schedule_type = ?"),b.push(T)),D&&(g.push("schedule_value = ?"),b.push(D)),x&&(g.push("next_run = ?"),b.push(x.toISOString())),g.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";b.push(u,n),await a.prepare(`UPDATE cron_jobs SET ${g.join(", ")} WHERE id = ? AND user_id = ?`).bind(...b).run();const N=x?x.toLocaleString("en-US",{timeZone:y,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${N?` New fire time: ${N} (${y}).`:""} IMPORTANT: Use this exact time "${N}" when confirming to the user.`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,n).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,y=t.type==="task"?"preference":t.type,p=u>=7?"working":"long_term";return await h.store(n,y,t.title,t.content,u,p),`Stored in ${p==="working"?"working":"long-term"} memory: [${y}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await h.search(n,t.query);return u.length===0?"No matching memories found.":u.map(y=>`[id:${y.id}] [${y.tier||"long_term"}] [${y.type}] **${y.title}**: ${y.content}`).join(`
`)}case"delete_memory":return await h.remove(t.id,n),`Memory entry ${t.id} deleted.`;case"update_memory":return await h.update(t.id,n,t.content),`Memory entry ${t.id} updated.`;case"get_system_status":{const u=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(n).first(),y=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(n).first(),p=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(n).first(),g=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(n).first(),b=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(n).first();return`System Status:
...
- Unread errors: ${(b==null?void 0:b.cnt)||0}`}case"read_sheet":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||""),y=t.spreadsheet_id;let p=t.range;const g=await u.sheets.getMetadata(y),b=g.sheets;p.includes("!")||(p=`${b[0]}!${p}`);let x;try{x=await u.sheets.readRange(y,p)}catch(D){if((w=D.message)!=null&&w.includes("Unable to parse range")||(f=D.message)!=null&&f.includes("400")){const N=p.includes("!")?p.split("!")[1]:p;p=`${b[0]}!${N}`,x=await u.sheets.readRange(y,p)}else throw D}let T=`[Spreadsheet: "${g.title}" | Reading tab: "${p.split("!")[0]}" | All tabs in this spreadsheet: ${b.map(D=>`"${D}"`).join(", ")}]
...
`)}catch(u){return await P(a,n,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{const C=new K(a),L=JSON.stringify(t.values);await C.store(n,"context",`Pending sheet write: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"write_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:L.length>15e3?"[[truncated — re-provide values on retry]]":t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The sheet write has been saved to temporary memory. After reconnecting, tell me "write the pending sheet data" to complete this.`:"")}const p=t.values;let g=t.range;const T=Math.max(...p.map(C=>C.length))+4,D=p.map(C=>{const L=[...C];for(;L.length<T;)L.push("");return L}),N=g.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(N){const C=N[1]||"",L=N[2],F=N[3],J=N[5],ee=L.toUpperCase().charCodeAt(0)-64+T-1,Q=ee<=26?String.fromCharCode(64+ee):"Z";g=`${C}${L}${F}:${Q}${J}`}const B=await u.sheets.writeRange(t.spreadsheet_id,g,D);try{const C=new K(a),L=await C.search(n,`Pending sheet write: ${t.spreadsheet_id}`);for(const F of L)F.title.startsWith(`Pending sheet write: ${t.spreadsheet_id}`)&&await C.remove(F.id,n)}catch{}return`Written ${B.updatedCells} cells to ${g}.`}catch(u){return await P(a,n,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected){if(t.spreadsheet_id&&t.range&&t.values)try{await new K(a).store(n,"context",`Pending sheet append: ${t.spreadsheet_id} — ${t.range}`,JSON.stringify({tool:"append_sheet",spreadsheet_id:t.spreadsheet_id,range:t.range,values:t.values}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.spreadsheet_id&&t.range?`

The append data has been saved to temporary memory. After reconnecting, tell me "append the pending sheet data" to complete this.`:"")}const p=await u.sheets.appendRows(t.spreadsheet_id,t.range,t.values);try{const g=new K(a),b=await g.search(n,`Pending sheet append: ${t.spreadsheet_id}`);for(const x of b)x.title.startsWith(`Pending sheet append: ${t.spreadsheet_id}`)&&await g.remove(x.id,n)}catch{}return`Appended ${p.updatedCells} cells to ${t.range}.`}catch(u){return await P(a,n,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected){if(t.title)try{await new K(a).store(n,"context",`Pending spreadsheet create: "${t.title}"`,JSON.stringify({tool:"create_sheet",title:t.title,sheet_names:t.sheet_names??null,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title?`

The spreadsheet request has been saved to temporary memory. After reconnecting, tell me "create the pending spreadsheet" and I'll complete this automatically.`:"")}const p=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let g="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||"");g=`
Folder: "${(await Yt(b,p.spreadsheetId,t.folder_name)).folderName}"`}catch(b){g=`
(Note: spreadsheet saved to Drive root — could not place in folder "${t.folder_name}": ${b.message})`}try{await new K(a).store(n,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${g}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(u){return await P(a,n,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||""),y=t.calendar_id||"primary",p=t.days_ahead||7,g=new Date,b=new Date(g.getTime()+p*24*60*60*1e3),x=await u.calendar.listEvents(y,{timeMin:g.toISOString(),timeMax:b.toISOString(),query:t.query});return x.length===0?`No events found in the next ${p} days.`:x.map(T=>{var L;const D=T.start.dateTime||T.start.date||"TBD",N=T.end.dateTime||T.end.date||"",B=T.location?` 📍 ${T.location}`:"",C=((L=T.attendees)==null?void 0:L.map(F=>F.email).join(", "))||"";return`• ${T.summary} — ${D} to ${N}${B}${C?`
  Attendees: ${C}`:""}`}).join(`
`)}catch(u){return await P(a,n,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected){if(t.summary&&t.start_datetime&&t.end_datetime)try{await new K(a).store(n,"context",`Pending calendar event: "${t.summary}"`,JSON.stringify({tool:"create_calendar_event",summary:t.summary,description:t.description??null,location:t.location??null,start_datetime:t.start_datetime,end_datetime:t.end_datetime,attendees:t.attendees??null,calendar_id:t.calendar_id??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.summary&&t.start_datetime?`

The calendar event has been saved to temporary memory. After reconnecting, tell me "create the pending event" and I'll add it to your calendar.`:"")}const p=t.calendar_id||"primary",g=await u.calendar.createEvent(p,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});try{const b=new K(a),x=await b.search(n,`Pending calendar event: "${t.summary}"`);for(const T of x)T.title.startsWith(`Pending calendar event: "${t.summary}"`)&&await b.remove(T.id,n)}catch{}return`Event created: "${g.summary}"
ID: ${g.id}
Start: ${g.start.dateTime||g.start.date}`}catch(u){return await P(a,n,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!r)return"Authentication context unavailable.";const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected){if(t.title&&t.content)try{await new K(a).store(n,"context",`Pending Google Doc save: "${t.title}"`,JSON.stringify({tool:"create_doc",title:t.title,content:t.content,folder_name:t.folder_name??null}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.'+(t.title&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" and I'll complete this automatically.`:"")}let p;try{p=await u.docs.createDocument(t.title)}catch(b){return await P(a,n,"google","create_doc",b.message),`Failed to create document: ${b.message}`}if(t.content)try{await u.docs.appendFormattedContent(p.documentId,t.content)}catch(b){return await P(a,n,"google","create_doc_append",b.message),`Document created but content could not be written (${b.message}).
ID: ${p.documentId}
URL: ${p.url}

Use append_to_doc with the document ID above to add content.`}let g="";if(t.folder_name)try{const{token:b}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||"");g=`
Folder: "${(await Yt(b,p.documentId,t.folder_name)).folderName}"`}catch(b){g=`
(Note: document saved to Drive root — could not place in folder "${t.folder_name}": ${b.message})`}try{await new K(a).store(n,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}try{const b=new K(a),x=await b.search(n,`Pending Google Doc save: "${t.title}"`);for(const T of x)T.title.startsWith(`Pending Google Doc save: "${t.title}"`)&&await b.remove(T.id,n)}catch{}return`Document created: "${t.title}"${g}
ID: ${p.documentId}
URL: ${p.url}`}case"read_doc":{if(!r)return"Authentication context unavailable.";try{const y=await new ce(a,n,r,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${y.title}"

${y.content}`}catch(u){return await P(a,n,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected){if(t.document_id&&t.content)try{await new K(a).store(n,"context",`Pending append to doc: "${t.document_id}"`,JSON.stringify({tool:"append_to_doc",document_id:t.document_id,content:t.content}),9,"working")}catch{}return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.'+(t.document_id&&t.content?`

Your content has been saved to temporary memory. After reconnecting, tell me "save the pending document" to complete this.`:"")}await u.docs.appendFormattedContent(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}try{const g=new K(a),b=await g.search(n,`Pending append to doc: "${t.document_id}"`);for(const x of b)x.title.startsWith(`Pending append to doc: "${t.document_id}"`)&&await g.remove(x.id,n)}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await P(a,n,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"rewrite_doc":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";await u.docs.rewriteDocument(t.document_id,t.content);let p=t.document_id;try{p=(await u.docs.readDocument(t.document_id)).title}catch{}return`Document "${p}" reformatted successfully.
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await P(a,n,"google","rewrite_doc",u.message),`Failed to rewrite document: ${u.message}`}}case"delete_sheet_row":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";const p=t.row_number;return p<2?"Row 1 is the header row and cannot be deleted. Specify row 2 or higher.":(await u.sheets.deleteRow(t.spreadsheet_id,t.sheet_name,p),`Row ${p} deleted from "${t.sheet_name}". All rows below have shifted up.`)}catch(u){return await P(a,n,"google","delete_sheet_row",u.message),`Failed to delete row: ${u.message}`}}case"delete_doc_content":{if(!r)return"Authentication context unavailable.";try{const u=new ce(a,n,r,s||"",i||"");if(!(await u.isConnected()).connected)return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account.";const p=await u.docs.deleteContent(t.document_id,t.text_to_remove);return p.occurrencesRemoved===0?"No matching text found in the document. The text must match exactly — check spacing, punctuation, and line breaks.":`Removed ${p.occurrencesRemoved} occurrence${p.occurrencesRemoved===1?"":"s"} from the document.`}catch(u){return await P(a,n,"google","delete_doc_content",u.message),`Failed to delete document content: ${u.message}`}}case"gmail_list":{if(!r)return"Authentication context unavailable.";try{const y=await new ve(a,n,r,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return y.length===0?"No messages found.":y.map((p,g)=>`${p.isUnread?"● ":"  "}${g+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await P(a,n,"gmail","list",u.message),(_=u.message)!=null&&_.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!r)return"Authentication context unavailable.";try{const u=new ve(a,n,r,s||"",i||""),y=await u.getMessage(t.message_id);if(!y)return"Message not found.";const p=await u.getMessageBody(t.message_id);return`**${y.subject}**
From: ${y.from}
To: ${y.to}
Date: ${y.date}

${p}`}catch(u){return await P(a,n,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!r)return"Authentication context unavailable.";try{const y=await new ve(a,n,r,s||"",i||"").search(t.query,t.max_results||10);return y.length===0?`No results for: ${t.query}`:y.map((p,g)=>`${p.isUnread?"● ":"  "}${g+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(u){return await P(a,n,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!r)return"Authentication context unavailable.";try{const u=new ve(a,n,r,s||"",i||"");if(!(await new ce(a,n,r,s||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new K(a).store(n,"context",`Pending email: "${t.subject}"`,JSON.stringify({tool:"gmail_send",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your email has been saved to temporary memory. After reconnecting, tell me "send the pending email" and I'll send it automatically.`:"")}const g=await u.send(t.to,t.subject,t.body,{cc:t.cc});try{const b=new K(a),x=await b.search(n,`Pending email: "${t.subject}"`);for(const T of x)T.title.startsWith(`Pending email: "${t.subject}"`)&&await b.remove(T.id,n)}catch{}return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${g.id}]`}catch(u){return await P(a,n,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!r)return"Authentication context unavailable.";try{const u=new ve(a,n,r,s||"",i||"");if(!(await new ce(a,n,r,s||"",i||"").isConnected()).connected){if(t.to&&t.subject&&t.body)try{await new K(a).store(n,"context",`Pending draft: "${t.subject}"`,JSON.stringify({tool:"gmail_draft",to:t.to,subject:t.subject,body:t.body,cc:t.cc??null}),9,"working")}catch{}return"Google account not connected. Please go to Settings → Keys → Google Workspace and connect your account."+(t.to&&t.subject&&t.body?`

Your draft has been saved to temporary memory. After reconnecting, tell me "create the pending draft" and I'll save it to Gmail.`:"")}const g=await u.createDraft(t.to,t.subject,t.body,{cc:t.cc});try{const x=new K(a),T=await x.search(n,`Pending draft: "${t.subject}"`);for(const D of T)D.title.startsWith(`Pending draft: "${t.subject}"`)&&await x.remove(D.id,n)}catch{}const b=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${b}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${g.id}]`}catch(u){return await P(a,n,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!r)return"Authentication context unavailable.";try{return await new ve(a,n,r,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await P(a,n,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!r)return"Authentication context unavailable.";try{const y=await new ve(a,n,r,s||"",i||"").getUnreadCount();return`You have ${y} unread email${y!==1?"s":""} in Gmail.`}catch(u){return(v=u.message)!=null&&v.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!r)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||""),y=new URLSearchParams;y.set("pageSize",String(t.max_results||10)),y.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),y.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",y.set("q",p);const g=await fetch(`https://www.googleapis.com/drive/v3/files?${y}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const b=await g.json();return(S=b.files)!=null&&S.length?b.files.map((x,T)=>{var C,L;const D=((C=x.mimeType)==null?void 0:C.split(".").pop())||x.mimeType,N=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",B=((L=x.modifiedTime)==null?void 0:L.split("T")[0])||"";return`${T+1}. **${x.name}** (${D})
   ${N} · Modified: ${B}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await P(a,n,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!r)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||""),y=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",y),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const g=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${u}`}});if(!g.ok)throw new Error(`Drive API error (${g.status})`);const b=await g.json();return(E=b.files)!=null&&E.length?b.files.map((x,T)=>{var B,C;const D=((B=x.mimeType)==null?void 0:B.split(".").pop())||x.mimeType,N=((C=x.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${T+1}. **${x.name}** (${D}) — Modified: ${N}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await P(a,n,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"drive_read_file":{if(!r)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||""),y=t.url_or_id.trim();let p=y;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/\/presentation\/d\/([a-zA-Z0-9_-]+)/,/\/forms\/d\/([a-zA-Z0-9_-]+)/,/[?&]id=([a-zA-Z0-9_-]+)/,/\/d\/([a-zA-Z0-9_-]+)/];for(const J of g){const X=y.match(J);if(X){p=X[1];break}}const b=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=id,name,mimeType,size`,{headers:{Authorization:`Bearer ${u}`}});if(!b.ok)throw new Error(`Drive API error (${b.status}): could not fetch file metadata`);const x=await b.json(),{name:T,mimeType:D}=x,N=t.extract_focus,B=N?`Focus specifically on extracting: ${N}`:"Extract and return all readable text content. Preserve structure where relevant.",C={"application/vnd.google-apps.document":"text/plain","application/vnd.google-apps.spreadsheet":"text/csv","application/vnd.google-apps.presentation":"text/plain"};if(C[D]){const J=C[D],X=await fetch(`https://www.googleapis.com/drive/v3/files/${p}/export?mimeType=${encodeURIComponent(J)}`,{headers:{Authorization:`Bearer ${u}`}});if(!X.ok)throw new Error(`Drive export error (${X.status})`);const ee=await X.text();if(D==="application/vnd.google-apps.spreadsheet"){const Q=gs(ee),se=Q.length,me=((O=Q[0])==null?void 0:O.length)??0;return`**${T}** (Google Sheet — ${se} rows × ${me} columns)

Parsed rows (JSON, ready for write_sheet/append_sheet):
${JSON.stringify(Q)}`}return`**${T}**

${ee.substring(0,2e4)}`}if(D==="application/pdf"||T.toLowerCase().endsWith(".pdf")){const J=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?alt=media`,{headers:{Authorization:`Bearer ${u}`}});if(!J.ok)throw new Error(`Drive download error (${J.status})`);const X=await J.arrayBuffer(),ee=Buffer.from(X).toString("base64");let Q=null,se="claude-haiku-4-5-20251001";for(const pt of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const ua=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,pt).first();if(ua&&r){const Xn=await Y(ua.encrypted_value,r),Rt=JSON.parse(Xn);if(Rt.provider==="anthropic"){Q=Rt.apiKey,Rt.model&&(se=Rt.model);break}}}catch{}if(!Q)return`"${T}" is a PDF. An Anthropic API key is required to extract PDF content. Please configure one in Settings → Keys.`;const me=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":Q,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:se,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:ee}},{type:"text",text:B}]}]})});if(!me.ok){const pt=await me.text();throw new Error(`Anthropic PDF extraction error: ${pt.substring(0,200)}`)}const Ut=((M=(I=(await me.json()).content)==null?void 0:I[0])==null?void 0:M.text)||"";return`**${T}** (PDF from Drive)
...
${F.substring(0,2e4)}`}catch(u){return await P(a,n,"google","drive_read_file",u.message),`Drive read error: ${u.message}`}}case"drive_delete_file":{if(!r)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||""),y=t.url_or_id.trim();let p=y;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const D of g){const N=y.match(D);if(N){p=N[1];break}}const b=await fetch(`https://www.googleapis.com/drive/v3/files/${p}?fields=name`,{headers:{Authorization:`Bearer ${u}`}});if(!b.ok)throw new Error(`Drive API error (${b.status})`);const x=await b.json(),T=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${u}`,"Content-Type":"application/json"},body:JSON.stringify({trashed:!0})});if(!T.ok)throw new Error(`Drive API error (${T.status})`);return`"${x.name}" moved to trash. You can restore it from Drive trash within 30 days.`}catch(u){return await P(a,n,"google","drive_delete_file",u.message),`Drive delete error: ${u.message}`}}case"drive_organise":{if(!r)return"Authentication context unavailable.";if(!t.folder_name&&!t.new_name)return"Please provide at least a folder_name to move to or a new_name to rename.";try{const{token:u}=await(await Promise.resolve().then(()=>Ue)).getGoogleAuth(a,n,r,s||"",i||""),y=t.url_or_id.trim();let p=y;const g=[/\/file\/d\/([a-zA-Z0-9_-]+)/,/\/document\/d\/([a-zA-Z0-9_-]+)/,/\/spreadsheets\/d\/([a-zA-Z0-9_-]+)/,/id=([a-zA-Z0-9_-]+)/];for(const x of g){const T=y.match(x);if(T){p=T[1];break}}const b=[];if(t.new_name){const x=await fetch(`https://www.googleapis.com/drive/v3/files/${p}`,{method:"PATCH",headers:{Authorization:`Bearer ${u}`,"Content-Type":"application/json"},body:JSON.stringify({name:t.new_name})});if(!x.ok)throw new Error(`Drive rename error (${x.status})`);b.push(`Renamed to "${t.new_name}"`)}if(t.folder_name){const{folderName:x}=await Yt(u,p,t.folder_name);b.push(`Moved to folder "${x}"`)}return b.join(". ")+"."}catch(u){return await P(a,n,"google","drive_organise",u.message),`Drive organise error: ${u.message}`}}case"web_search":try{const u=await Pt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((y,p)=>`${p+1}. [${y.title}](${y.link})
   ${y.snippet}`).join(`

`)}catch(u){return await P(a,n,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const y=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>os),g=await p(u,y);return g.error?`Failed to read page: ${g.error}`:!g.text||g.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${g.text.length} chars):

${g.text}`}catch(u){return await P(a,n,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!c)return"Research tool requires an LLM provider but none is available.";try{let u;try{const T=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"perplexity_api_key").first();T&&r&&(u=await Y(T.encrypted_value,r))}catch{}const y=2e4,p=kn(t.query,c,{depth:t.depth||"quick",site:t.site,perplexityApiKey:u}),g=new Promise(T=>setTimeout(()=>T(null),y)),b=await Promise.race([p,g]);if(b===null){const{webSearch:T}=await Promise.resolve().then(()=>Qr),D=await T(t.query,{num:5});if(D.error||D.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let N=`Research took too long, but here are the top search results:

`;return N+=D.results.map((B,C)=>`${C+1}. [${B.title}](${B.link})
   ${B.snippet}`).join(`
...
`));try{const T=new K(a),D=b.report.substring(0,600);await T.store(n,"context",`Research: ${t.query.substring(0,80)}`,D,6,"long_term")}catch{}return x}catch(u){return await P(a,n,"research","research",u.message),`Research error: ${u.message}`}}case"browser_task":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key (get one at cloud.browser-use.com).";const y=(await Y(u.encrypted_value,r)).trim();let p,g=t.task,b,x;if(t.site_name)try{const C=await a.prepare("SELECT id, encrypted_blob FROM site_credentials WHERE user_id = ? AND name = ? COLLATE NOCASE").bind(n,t.site_name).first();if(C){const L=JSON.parse(await Y(C.encrypted_blob,r));p={username:L.username,password:L.password},x=L.sessionId,b=C.id,g=`${g}

When prompted to log in, use username {username} and password {password}.`}}catch{}const T=await Rn(g,y,{secrets:p,sessionId:x}),D=async C=>{if(b)try{const L=await a.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(b,n).first();if(!L)return;const F=JSON.parse(await Y(L.encrypted_blob,r));F.sessionId=C;const J=await ct(JSON.stringify(F),r);await a.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(J,b,n).run()}catch{}},N=async()=>{if(!(!b||!x))try{const C=await a.prepare("SELECT encrypted_blob FROM site_credentials WHERE id = ? AND user_id = ?").bind(b,n).first();if(!C)return;const L=JSON.parse(await Y(C.encrypted_blob,r));delete L.sessionId;const F=await ct(JSON.stringify(L),r);await a.prepare("UPDATE site_credentials SET encrypted_blob = ? WHERE id = ? AND user_id = ?").bind(F,b,n).run()}catch{}};if(T.status==="completed")return T.sessionId&&await D(T.sessionId),T.output??"[NO-OUTPUT] Browser task completed but returned no content — do NOT invent or summarise what the site may have contained. Tell the user the browser returned nothing and suggest they try again.";if(T.status==="timeout"){T.sessionId&&await D(T.sessionId);try{await new K(a).store(n,"context",`Browser task in progress: ${T.taskId}`,JSON.stringify({task_id:T.taskId,task:t.task}),9,"working")}catch{}return`[BROWSER_TIMEOUT:${T.taskId}] Browser task did not finish within the time limit. Tell the user it is still running and ask them to follow up in 2–3 minutes.`}await N();const B=[T.error,T.output].filter(Boolean).join(" — ");return`Browser task failed (ID: \`${T.taskId}\`): ${B||"No details returned. Check your Browser Use dashboard at cloud.browser-use.com."}`}catch(u){return await P(a,n,"browser","browser_task",u.message),`Browser task error: ${u.message}`}}case"browser_task_status":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"browser_use_api_key").first();if(!u)return"Browser Use API key not configured.";const y=await Y(u.encrypted_value,r),p=await ds(t.task_id,y);if(p.done){try{const g=new K(a),b=await g.search(n,`Browser task in progress: ${t.task_id}`);for(const x of b)await g.remove(x.id,n)}catch{}return p.status==="finished"||p.status==="completed"?p.output?p.output:'[NO-OUTPUT] Browser task finished but returned no content. Do NOT invent or infer what emails or page data might have said. Tell the user: "The browser finished but returned no content — the site may have blocked automation or the login failed. Would you like to try again?"':`Browser task ended with status "${p.status}" and no output. Do NOT retry — report this to the user.`}return`[still-running] Browser task has not finished yet (status: ${p.status}). STOP — do not call browser_task_status again. Tell the user: "The browser is still working. Ask me 'what happened with the browser task?' in 2–3 minutes."`}catch(u){return await P(a,n,"browser","browser_task_status",u.message),`Browser status check error: ${u.message}`}}case"vault_lookup":try{const u=(t.site_name||"").trim();if(!u)return"No site name provided.";const p=((await a.prepare("SELECT name FROM site_credentials WHERE user_id = ? AND name LIKE ? COLLATE NOCASE").bind(n,`%${u}%`).all()).results||[]).map(g=>g.name);return p.length===0?`No vault entries found matching "${u}".`:`Vault entries matching "${u}": ${p.join(", ")}. Use site_name="${p[0]}" in browser_task to inject credentials automatically.`}catch{return"vault_lookup: could not query Secret Vault (table may not exist — run migrations)."}case"search_places":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const y=await Y(u.encrypted_value,r),p=await yn(y,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((g,b)=>{const x=g.rating?` ★${g.rating} (${g.userRatingsTotal||0} reviews)`:"",T=g.openNow!==void 0?g.openNow?" · Open now":" · Closed":"",D=g.googleMapsUri?`
   ${g.googleMapsUri}`:"";return`${b+1}. **${g.name}**${x}${T}
   ${g.address}${D}
   [place_id: ${g.placeId}]`}).join(`

`)}catch(u){return await P(a,n,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Y(u.encrypted_value,r),p=await vn(y,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const g=p.details;let b=`**${g.name}**
...
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return b}catch(u){return await P(a,n,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Y(u.encrypted_value,r),p=await wn(y,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const g=p.route;let b=`**${g.startAddress}** → **${g.endAddress}**
`;return b+=`📏 ${g.distance} · ⏱️ ${g.duration}`,g.durationInTraffic&&(b+=` (with traffic: ${g.durationInTraffic})`),b+=`
via ${g.summary}`,b+=`

Steps:`,g.steps.forEach((x,T)=>{b+=`
${T+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),b}catch(u){return await P(a,n,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Y(u.encrypted_value,r),p=await Tn(y,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let g=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(g+=` (with traffic: ${p.durationInTraffic})`),g}catch(u){return await P(a,n,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Y(u.encrypted_value,r),p=await bn(y,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(u){return await P(a,n,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Y(u.encrypted_value,r),p=await En(y,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((g,b)=>{var x;return`${b+1}. **${g.title}**
   ${g.channelTitle} · ${((x=g.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${g.description}
   ${g.url}`}).join(`

`)}catch(u){return await P(a,n,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!r)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,"google_api_key").first();if(!u)return"Google API Key not configured.";const y=await Y(u.encrypted_value,r),p=await _n(y,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((g,b)=>`${b+1}. ${g.address}
   Coordinates: ${g.lat}, ${g.lng}`).join(`
`)}catch(u){return await P(a,n,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}case"parse_document":{const u=t.file_id,y=t.extract_focus;if(!u)return"file_id is required to parse a document.";const p=await a.prepare("SELECT file_name, file_type, file_data, file_size, extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(u,n).first();if(!p)return"File not found. The file may have expired or the file_id is incorrect.";if(p.extracted_text)return`Document: ${p.file_name}
...
${T.substring(0,2e4)}`}catch{return`Could not decode text file: ${g}`}if(b==="application/pdf"||b==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||g.toLowerCase().endsWith(".pdf")||g.toLowerCase().endsWith(".docx")){if(b==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||g.toLowerCase().endsWith(".docx")){try{const N=await On(Buffer.from(x,"base64"));if(N.length>50)return`Document: ${g}

${N.substring(0,2e4)}`}catch{}return`Could not extract text from "${g}". Try uploading to Google Drive and sharing the link — Drive can open and export Word documents directly.`}let T=null,D="claude-haiku-4-5-20251001";for(const N of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const B=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(n,N).first();if(B&&r){const C=await Y(B.encrypted_value,r),L=JSON.parse(C);if(L.provider==="anthropic"){T=L.apiKey,L.model&&(D=L.model);break}}}catch{}if(T)try{const N=y?`Focus specifically on extracting: ${y}`:"Extract and return all readable text content from this document. Preserve structure where relevant.",B=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":T,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:D,max_tokens:4096,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:x}},{type:"text",text:N}]}]})});if(B.ok){const L=((H=(q=(await B.json()).content)==null?void 0:q[0])==null?void 0:H.text)||"";return`Document: ${g}

${L}`}else{const C=await B.text();return`Could not parse ${g} via Anthropic API: ${C.substring(0,200)}`}}catch(N){return`Document parsing error for ${g}: ${N.message}`}return"To parse PDF documents, please configure an Anthropic API key in Settings → Keys. No Anthropic key is currently set."}try{const T=Buffer.from(x,"base64").toString("utf-8").substring(0,2e3);return`Document: ${g} (${b})

Content preview:
${T}`}catch{return`Cannot read file: ${g} (${b})`}}case"create_skill":{const u=($=t.name)==null?void 0:$.trim(),y=(W=t.description)==null?void 0:W.trim(),p=(z=t.instructions)==null?void 0:z.trim();if(!u||!y||!p)return"create_skill requires name, description, and instructions.";let g=u.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"");g||(g=`skill_${Date.now()}`);const b=await a.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(n,`${g}%`).all();(R=b.results)!=null&&R.some(N=>N.slug===g)&&(g=`${g}_${(((U=b.results)==null?void 0:U.length)||0)+1}`);const x=JSON.stringify(t.parameters||{}),T=JSON.stringify(t.required_tools||[]),D=JSON.stringify(t.examples||[]);return await a.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`).bind(n,u,g,y,p,x,T,D).run(),`Skill created: **${u}** (invoke as: "${g}")

You can now ask me to run "${u}" at any time. The skill will appear in Settings → Skills. You can also say "run my ${u} skill" to execute it.`}case"list_skills":{const y=t.include_disabled===!0?"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? ORDER BY created_at DESC":"SELECT id, name, slug, description, enabled, usage_count, last_used_at FROM user_skills WHERE user_id = ? AND enabled = 1 ORDER BY created_at DESC",g=(await a.prepare(y).bind(n).all()).results||[];if(g.length===0)return`You haven't created any custom skills yet. Ask me to create one: "Create a skill that..."`;const b=g.map(x=>`• **${x.name}** (${x.slug}): ${x.description} [used ${x.usage_count} times${x.enabled?"":" — disabled"}]`).join(`
`);return`Your custom skills (${g.length}):

${b}`}default:{const u=e,y=await a.prepare("SELECT id, name, description, instructions, required_tools FROM user_skills WHERE user_id = ? AND slug = ? AND enabled = 1").bind(n,u).first();if(y){await a.prepare("UPDATE user_skills SET usage_count = usage_count + 1, last_used_at = CURRENT_TIMESTAMP WHERE id = ?").bind(y.id).run();const p=(()=>{try{return JSON.parse(y.required_tools).join(", ")}catch{return""}})(),g=Object.keys(t).length>0?`
...
Execute the steps above using your available tools. When complete, provide a clear summary of what was done and any results.`}return`Unknown tool: ${e}`}}}async function jn(e,t,a,n,r){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(a,n,"assistant",s,"{}",r),t.push({id:-1,user_id:a,channel:n,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function Pn(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function xa(e,t,a,n,r,s,i){var z,R,U,u,y;const o=new K(t),l=(z=e.metadata)==null?void 0:z.thread_id,d=Date.now(),[c,m]=await Promise.all([o.buildContext(n.id),la(t,n.id)]),h=await o.getRecentConversations(n.id,30,l);await jn(o,h,n.id,e.channel,l);const w=Mn(n,c,e.channel,m),f=Ln([{role:"system",content:w},...h.map(p=>({role:p.role,content:p.content})),{role:"user",content:e.text}]);Pn(f);const _=[/\bmy (address|phone|email|budget|preferences?|settings?|rules?|sheet|doc|folder|password|login|account)\b/i,/\b(do you remember|last time|what did i|you said|i told you|my usual|like before|same as last|remind me what|what was the|previously)\b/i],v=(c.match(/^- /gm)||[]).length;if(_.some(p=>p.test(e.text))||v<3)try{const p=await o.searchLongTerm(n.id,e.text,5);if(p.length>0){const g=p.map(b=>`- [${b.type}] ${b.title}: ${b.content}`).join(`
...
`)){const h=m.trim().split("|");if(h.length<4)continue;const[w,f,_,v]=h,S=["fact","preference","context","decision","summary","task"].find(O=>O===w.trim().toLowerCase());if(!S||!(f!=null&&f.trim())||!(_!=null&&_.trim()))continue;const E=Math.min(10,Math.max(1,parseInt(v)||5));await n.store(a.id,S,f.trim(),_.trim(),E,"long_term")}}const ka={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function vs(e){for(const[t,a]of Object.entries(ka))if(e.toLowerCase().includes(t.toLowerCase()))return a;return ka.default}function ws(e,t,a,n){const r=vs(n),s=Math.floor(r*.75),i=[];let o=0,l=!1;const d=Kt(e);i.push({role:"system",content:e}),o+=d;const c=Kt(a);o+=c;const m=s-o,h=[];let w=0;for(let f=t.length-1;f>=0;f--){const _=t[f],v=Kt(_.content);if(w+v<=m)h.unshift({role:_.role,content:_.content}),w+=v;else{l=!0;break}}return i.push(...h),i.push({role:"user",content:a}),o+=w,{maxTokens:r,usedTokens:o,messages:i,wasTruncated:l}}async function*bs(e,t,a,n,r,s){var M,q;const i=new K(t),o=(M=e.metadata)==null?void 0:M.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:a.name}};const[d,c]=await Promise.all([i.buildContext(n.id),la(t,n.id)]),m=await i.getRecentConversations(n.id,30,o);await jn(i,m,n.id,e.channel,o);const h=Mn(n,d,e.channel,c),w=ws(h,m,e.text,a.name);await i.storeMessage(n.id,e.channel,"user",e.text,"{}",o);const f=await oa(t,n.id),_=10;let v="",S=0;const E=[...w.messages],O=[];Pn(E);for(let H=0;H<_;H++)try{H>0&&(yield{type:"thinking",data:{threadId:o}},Bn(E));const $=await a.chat(E,{tools:f});if($.usage&&(S+=$.usage.promptTokens+$.usage.completionTokens),$.toolCalls&&$.toolCalls.length>0){$.content&&(yield{type:"chunk",data:{text:$.content,threadId:o}});const R=$.content||`[calling: ${$.toolCalls.map(u=>{const y=u.arguments||{},p=Object.entries(y).filter(([g])=>!["content","values","body"].includes(g)).map(([g,b])=>`${g}="${String(b).substring(0,100)}"`).join(", ");return`${u.name}(${p})`}).join(", ")}]`;E.push({role:"assistant",content:R});const U=[];for(const u of $.toolCalls){yield{type:"tool_start",data:{tool:u.name,toolArgs:u.arguments,threadId:o}},O.push(u.name);try{const y=(x,T)=>bt(x,T,t,n.id,{agentType:"full",providerName:a.name,channel:e.channel},n.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,n.timezone,a,s==null?void 0:s.DOCUMENTS_BUCKET);let p;if(u.name==="browser_task"||u.name==="browser_task_status"){const T=y(u.name,u.arguments);e:for(;;){const D=await Promise.race([T.then(N=>({done:!0,r:N})),new Promise(N=>setTimeout(()=>N({done:!1}),15e3))]);if(D.done){p=D.r;break e}yield{type:"thinking",data:{threadId:o}}}if(u.name==="browser_task"){const D=p.match(/^\[BROWSER_TIMEOUT:([^\]]+)\]/);if(D){yield{type:"thinking",data:{threadId:o}};const N=y("browser_task_status",{task_id:D[1]});e:for(;;){const B=await Promise.race([N.then(C=>({done:!0,r:C})),new Promise(C=>setTimeout(()=>C({done:!1}),15e3))]);if(B.done){p=B.r;break e}yield{type:"thinking",data:{threadId:o}}}}}}else p=await y(u.name,u.arguments);yield{type:"tool_end",data:{tool:u.name,toolResult:p.substring(0,500)+(p.length>500?"...":""),threadId:o}};const g=["parse_document","drive_read_file"].includes(u.name)?2e4:8e3,b=p.length>g?p.substring(0,g)+`
[...result truncated to prevent token limit — full content was extracted]`:p;U.push(`[Tool Result for ${u.name}]: ${b}`)}catch(y){await P(t,n.id,"tool",u.name,y.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:u.name,toolResult:`Error: ${y.message||"Execution failed"}`,threadId:o}},U.push(`[Tool Error for ${u.name}]: ${y.message||"Execution failed"}`)}}E.push({role:"user",content:U.join(`

`)});continue}v=$.content;const W=Mt(v);await i.storeMessage(n.id,e.channel,"assistant",W,"{}",o);const z=50;for(let R=0;R<W.length;R+=z)yield{type:"chunk",data:{text:W.substring(R,R+z),threadId:o}},R+z<W.length&&await new Promise(u=>setTimeout(u,10));break}catch($){if(r){const R=$.message||"",U=R.includes("401")||R.includes("403")||R.includes("authentication")||R.includes("credit balance"),u=R.includes("429"),y=U?1440:u?10:5;await r.recordError(a.name,R,y)}await P(t,n.id,"llm","provider_error",$.message||"Unknown LLM error",{provider:a.name,turn:H});const W=$.message||"An error occurred",z=W.includes("429")||W.toLowerCase().includes("rate limit")||W.toLowerCase().includes("too many requests")?"Rate limit reached across all configured providers. Add a second AI provider in Settings → API Keys (Gemini and DeepSeek offer free tiers) to enable automatic failover and avoid this.":W;try{await i.storeMessage(n.id,e.channel,"assistant",`⚠️ ${z}`,"{}",o)}catch{}yield{type:"error",data:{error:z,threadId:o}};return}if(v=(v==null?void 0:v.trim())??"",!v)try{E.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),v=(await a.chat(E,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const $=Mt(v);await i.storeMessage(n.id,e.channel,"assistant",$,"{}",o);const W=50;for(let z=0;z<$.length;z+=W)yield{type:"chunk",data:{text:$.substring(z,z+W),threadId:o}},z+W<$.length&&await new Promise(R=>setTimeout(R,10))}catch{v="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",await i.storeMessage(n.id,e.channel,"assistant",v,"{}",o).catch(()=>{}),yield{type:"chunk",data:{text:v,threadId:o}}}if(r&&S>0)try{await r.recordUsage(a.name,S)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(n.id,a.name,"full",S,Date.now()-l,1,e.channel).run()}catch{}const I=[{claimPattern:/\b(reminder set|set a reminder|i.ve set|i've set|scheduled for|reminder.*\d{1,2}:\d{2}|reminder.*(am|pm)\b|updated.*reminder|reminder.*updated|now set for|reminder now|set for.*\d{1,2}:\d{2}|set for.*(am|pm)\b)\b/i,requiredTools:["create_schedule","update_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a reminder was created or updated but neither create_schedule nor update_schedule was called. You MUST call the appropriate tool NOW. Do not respond with text only.",logType:"schedule_hallucination"},{claimPattern:/\b(email\s+(sent|delivered)|sent\s+(the\s+)?(email|message)|i.ve\s+(sent|emailed|mailed)|message\s+sent)\b/i,requiredTools:["gmail_send"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed an email was sent but gmail_send was never called. You MUST call gmail_send NOW or clarify that only a draft was prepared.",logType:"email_hallucination"},{claimPattern:/\b(i.ve\s+(remembered|stored|saved|noted)|stored\s+(that|this|it)|saved\s+(that|this|it)\s+to\s+memory|i.ll\s+remember\s+that|noted\s+(that|this|it))\b/i,requiredTools:["store_memory"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have stored something in memory but store_memory was never called. You MUST call store_memory NOW with the relevant content.",logType:"memory_hallucination"},{claimPattern:/\b(added\s+(row|entry|item|data)|appended\s+(to|into)\s+(the\s+)?(sheet|spreadsheet)|updated\s+(the\s+)?(sheet|row|cell|entry)|added\s+(to|in)\s+(your\s+|the\s+)(sheet|spreadsheet)|saved\s+(your\s+|the\s+)?(data|entry|note|info)\s+(to|in)\s+(the\s+)?(sheet|spreadsheet)|data\s+(is\s+)?(now\s+)?(in|on)\s+(your\s+|the\s+)?(sheet|spreadsheet)|(entry|note|data|row)\s+(has\s+been\s+|is\s+)(added|saved|recorded|entered|written))\b/i,requiredTools:["append_sheet","write_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have written to a sheet but append_sheet/write_sheet was never called. You MUST call the appropriate tool NOW.",logType:"sheet_hallucination"},{claimPattern:/\b(created\s+(the\s+)?(event|meeting|appointment)|added\s+(to\s+)?(your\s+)?calendar|(calendar\s+)?event\s+(created|added|scheduled))\b/i,requiredTools:["create_calendar_event"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a calendar event but create_calendar_event was never called. You MUST call create_calendar_event NOW.",logType:"calendar_hallucination"},{claimPattern:/\b(moved?\s+to\s+trash|(file|document|doc|spreadsheet)\s+(has\s+been\s+)?(deleted|trashed|moved\s+to\s+trash)|(deleted|trashed)\s+(the|your|that)\s+(file|document|doc|spreadsheet)|i.ve\s+(deleted|trashed)\s+(the|your|that)\s+(file|document|doc))\b/i,requiredTools:["drive_delete_file"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed a Drive file was deleted or moved to trash but drive_delete_file was never called. You MUST call drive_delete_file NOW with the file URL or ID.",logType:"drive_delete_hallucination"},{claimPattern:/\b(moved?\s+(the\s+)?(file|document|doc|spreadsheet)\s+to\b|renamed\s+(the\s+)?(file|document|doc)|(file|document|doc)\s+(has\s+been\s+)?(moved|renamed)|i.ve\s+(moved|renamed)\s+(the\s+)?(file|document|doc))\b/i,requiredTools:["drive_organise"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have moved or renamed a Drive file but drive_organise was never called. You MUST call drive_organise NOW.",logType:"drive_organise_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?doc(ument)?|doc(ument)?\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?doc)\b/i,requiredTools:["create_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a Google Document but create_doc was never called. You MUST call create_doc NOW.",logType:"create_doc_hallucination"},{claimPattern:/\b(appended\s+(to|into)\s+(the\s+|your\s+)?(document|google\s+doc|doc|notes?)|(added|saved)\s+(the\s+)?(content|text|data|note|entry)\s+(to|in)\s+(the\s+|your\s+)?(document|doc|notes?)|(added|saved)\s+(to|in)\s+(your\s+|the\s+)?(quick\s+)?notes?|i.ve\s+(appended|added)\s+(to\s+)?(the\s+|your\s+)?(document|doc|notes?))\b/i,requiredTools:["append_to_doc"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have appended content to a Google Document but append_to_doc was never called. You MUST call append_to_doc NOW.",logType:"append_doc_hallucination"},{claimPattern:/\b(created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet)|spreadsheet\s+(has\s+been\s+|is\s+)(created|ready|live)|i.ve\s+created\s+(a\s+)?(new\s+)?(google\s+)?(spreadsheet|sheet))\b/i,requiredTools:["create_sheet"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have created a spreadsheet but create_sheet was never called. You MUST call create_sheet NOW.",logType:"create_sheet_hallucination"},{claimPattern:/\b(drafted\s+(an?\s+)?(email|message)|created\s+(a\s+)?draft(\s+email|\s+message)?|draft\s+(is\s+)?(ready|saved|created)|i.ve\s+drafted\s+(the\s+|an?\s+)?(email|message))\b/i,requiredTools:["gmail_draft"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have drafted an email but gmail_draft was never called. You MUST call gmail_draft NOW.",logType:"draft_hallucination"},{claimPattern:/\b(archived\s+(the\s+|that\s+)?(email|message|thread)|marked\s+(it\s*|the\s+email\s*|that\s+email\s*)?(as\s+)?(read|unread|starred|important)|i.ve\s+archived\s+(the\s+|that\s+)?(email|message))\b/i,requiredTools:["gmail_modify"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have archived or marked an email but gmail_modify was never called. You MUST call gmail_modify NOW.",logType:"gmail_modify_hallucination"},{claimPattern:/\b(deleted\s+(the\s+)?(reminder|schedule|task)|removed\s+(the\s+)?(reminder|schedule|task)|(reminder|schedule|task)\s+(has\s+been\s+)?(deleted|removed|cancelled)|i.ve\s+(deleted|removed)\s+(the\s+)?(reminder|task))\b/i,requiredTools:["delete_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a reminder or schedule but delete_schedule was never called. You MUST call delete_schedule NOW.",logType:"delete_schedule_hallucination"},{claimPattern:/\b(disabled\s+(the\s+)?(reminder|schedule|task)|paused\s+(the\s+)?(reminder|task)|turned\s+off\s+(the\s+)?(reminder|schedule|task)|re-?enabled\s+(the\s+)?(reminder|task))\b/i,requiredTools:["toggle_schedule"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have enabled or disabled a reminder but toggle_schedule was never called. You MUST call toggle_schedule NOW with the job ID and enabled state.",logType:"toggle_schedule_hallucination"},{claimPattern:/\b(deleted?\s+(row|entry|line)\s+\d+|(row|entry)\s+\d+\s+(deleted?|removed?)|(duplicate\s+)?(row|entry)\s+(deleted?|removed?)|i.ve\s+(deleted?|removed?)\s+(the\s+)?(duplicate\s+)?(row|entry))\b/i,requiredTools:["delete_sheet_row"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted a sheet row but delete_sheet_row was never called. You MUST call delete_sheet_row NOW with the correct row number.",logType:"delete_sheet_row_hallucination"},{claimPattern:/\b(removed?\s+(the\s+)?(duplicate\s+)?(text|entry|line|content)\s+from\s+(the\s+)?(document|doc)|deleted?\s+(the\s+)?(duplicate\s+)?(text|entry|line)\s+from\s+(the\s+)?(document|doc)|i.ve\s+(removed?|deleted?)\s+(the\s+)?(duplicate|text|entry)\s+from\s+(the\s+)?doc)\b/i,requiredTools:["delete_doc_content"],enforcementMsg:"[SYSTEM ENFORCEMENT] You claimed to have deleted content from a Google Document but delete_doc_content was never called. You MUST call delete_doc_content NOW.",logType:"delete_doc_content_hallucination"}];for(const H of I){const $=H.claimPattern.test(v),W=H.requiredTools.some(z=>O.includes(z));if($&&!W){try{await P(t,n.id,"llm",H.logType,"LLM claimed action without tool call (streaming)",{response:v.substring(0,200)}),E.push({role:"assistant",content:v}),E.push({role:"user",content:H.enforcementMsg});const z=await a.chat(E,{tools:f.filter(R=>H.requiredTools.includes(R.name)),temperature:0});if((q=z.toolCalls)!=null&&q.length){for(const U of z.toolCalls){const u=await bt(U.name,U.arguments,t,n.id,{agentType:"full",providerName:a.name,channel:e.channel},n.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,n.timezone,a,s==null?void 0:s.DOCUMENTS_BUCKET);O.push(U.name),E.push({role:"assistant",content:"",toolCalls:z.toolCalls}),E.push({role:"user",content:u})}const R=await a.chat(E,{tools:[]});R.content&&(v=R.content)}else v="I need to complete that action — could you confirm the details so I can actually do it?"}catch{}break}}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:S}}}async function Da(e,t,a,n,r,s,i,o){await s.storeMessage(r.id,t.channel,"user",t.text,"{}",o);const l=await bt(e.tool,e.args,a,r.id,{agentType:"direct",channel:t.channel},r.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,r.timezone,n,i==null?void 0:i.DOCUMENTS_BUCKET),d=`[TOOLS_USED: ${e.tool}] ${l}`.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await s.storeMessage(r.id,t.channel,"assistant",d,"{}",o),l}async function da(e,t,a,n,r,s){var f;const i=new K(t),o=(f=e.metadata)==null?void 0:f.thread_id,l=await i.buildContext(n.id),d=ia(e.text,l);if(d.agent==="conversation")return Un(e,t,a,n,l,r,o);const c=Cn(e.text);if(c)return Da(c,e,t,a,n,i,s,o);const m=(await i.getRecentConversations(n.id,10,o)).map(_=>_.content).join(`
`),h=Nn(e.text,m);if(h)return Da(h,e,t,a,n,i,s,o);const w=d.confidence>=.85;if(e.channel==="telegram"){const _=await oa(t,n.id);return xa(e,t,a,n,r,s,{maxTurns:10,tools:_,forceToolUseOnFirstTurn:w})}return xa(e,t,a,n,r,s,{forceToolUseOnFirstTurn:w})}async function Un(e,t,a,n,r,s,i){const o=new K(t),l=Date.now(),d=$n(n.timezone),c=await la(t,n.id),m=c?`## Your Standing Instructions (User-Set — Do Not Duplicate in Memory)
These rules were explicitly configured by the user in Settings. Do not store copies in memory or contradict them.
${c}

${r}`:r,h=In("conversation",n,m,n.timezone,d,e.channel),w=(await o.getRecentConversations(n.id,30,i)).filter(E=>!E.content.startsWith("[Autonomous Scheduled Task]")&&!E.content.startsWith("[Scheduled Reminder]")),f=Ln([{role:"system",content:h},...w.map(E=>({role:E.role,content:E.content})),{role:"user",content:e.text}]);await o.storeMessage(n.id,e.channel,"user",e.text,"{}",i);let _=0,v="";try{const E=await a.chat(f,{temperature:.8});E.usage&&(_=E.usage.promptTokens+E.usage.completionTokens),v=E.content}catch(E){if(s){const O=E.message||"",I=O.includes("401")||O.includes("403")||O.includes("authentication")||O.includes("credit balance"),M=O.includes("429"),q=I?1440:M?10:5;await s.recordError(a.name,O,q)}throw await P(t,n.id,"llm","conversation_error",E.message,{provider:a.name}),E}if(s&&_>0)try{await s.recordUsage(a.name,_)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(n.id,a.name,"conversation",_,Date.now()-l,1,e.channel).run()}catch{}const S=Mt(v);return await o.storeMessage(n.id,e.channel,"assistant",S,"{}",i),S}async function*_s(e,t,a,n,r,s){var c;const i=new K(t),o=(c=e.metadata)==null?void 0:c.thread_id,l=await i.buildContext(n.id),d=ia(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:a.name}},d.agent!=="conversation"){yield*bs(e,t,a,n,r,s);return}try{const m=await Un(e,t,a,n,l,r,o),h=50;for(let w=0;w<m.length;w+=h)yield{type:"chunk",data:{text:m.substring(w,w+h),threadId:o}},w+h<m.length&&await new Promise(f=>setTimeout(f,10))}catch(m){yield{type:"error",data:{error:m.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:0}}}const ae=new pe;async function Es(e,t){var r;const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}ae.use("/*",Es);ae.get("/threads",async e=>{const t=e.get("user"),a=e.req.query("archived")==="1",n=parseInt(e.req.query("limit")||"30"),r=await e.env.DB.prepare(`SELECT t.*, 
     ...
     LIMIT ?`).bind(t.id,a?1:0,n).all();return e.json({threads:r.results||[]})});ae.post("/threads",async e=>{const t=e.get("user"),{title:a}=await e.req.json(),n=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a||"New conversation").first();return e.json({thread:n})});ae.put("/threads/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.req.json(),r=[],s=[];return n.title!==void 0&&(r.push("title = ?"),s.push(n.title)),n.is_archived!==void 0&&(r.push("is_archived = ?"),s.push(n.is_archived?1:0)),r.push("updated_at = CURRENT_TIMESTAMP"),s.push(a,t.id),r.length<=1?e.json({error:"Nothing to update"},400):(await e.env.DB.prepare(`UPDATE threads SET ${r.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});ae.delete("/threads/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM conversations WHERE thread_id = ? AND user_id = ?").bind(a,t.id).run(),await e.env.DB.prepare("DELETE FROM threads WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});ae.post("/upload",async e=>{const t=e.get("user"),a=!!e.env.DOCUMENTS_BUCKET,n=a?100*1024*1024:700*1024;let r,s,i,o=null,l=null;try{if((e.req.header("Content-Type")||"").includes("multipart/form-data")){const v=(await e.req.formData()).get("file");if(!v)return e.json({error:"No file provided."},400);if(r=v.name,s=v.type||"application/octet-stream",i=v.size,i>n)return e.json({error:`File too large (max ${a?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);o=await v.arrayBuffer()}else{const _=await e.req.json();if(!_.file_name||!_.file_data)return e.json({error:"file_name and file_data are required."},400);if(r=_.file_name,s=_.file_type||"application/octet-stream",l=_.file_data,i=_.file_size||Math.round(l.length*.75),i>n)return e.json({error:`File too large (max ${a?"100 MB":"700 KB"}). Try sharing a Google Drive link instead — paste the link into the chat and Karna can read it directly.`},400);if(a){const v=atob(l);o=new ArrayBuffer(v.length);const S=new Uint8Array(o);for(let E=0;E<v.length;E++)S[E]=v.charCodeAt(E)}}const c=crypto.randomUUID();let m;a&&o?(await e.env.DOCUMENTS_BUCKET.put(c,o,{httpMetadata:{contentType:s},customMetadata:{fileName:r,userId:String(t.id)}}),m="r2"):m=l||(o?Buffer.from(o).toString("base64"):""),await e.env.DB.prepare("INSERT INTO uploaded_files (id, user_id, file_name, file_type, file_data, file_size) VALUES (?, ?, ?, ?, ?, ?)").bind(c,t.id,r,s,m,i).run(),await e.env.DB.prepare("INSERT INTO document_library (user_id, file_id, source, name, mime_type, size, status) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t.id,c,"upload",r,s,i,"uploaded").run();const h=s==="application/pdf"||r.toLowerCase().endsWith(".pdf"),w=s==="application/vnd.openxmlformats-officedocument.wordprocessingml.document"||r.toLowerCase().endsWith(".docx");if(w)try{const{extractDocxTextFromBuffer:_}=await Promise.resolve().then(()=>cs),v=l?Buffer.from(l,"base64"):o?Buffer.from(o):null;if(v){const S=await _(v);S.length>50&&await e.env.DB.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(S,c).run()}}catch{}if(h&&t.pin_hash){const _=l||(o?Buffer.from(o).toString("base64"):null),v=t.pin_hash,S=t.id,E=e.env.DB,O=e.env.DOCUMENTS_BUCKET,I=(async()=>{var M,q;try{let H=null,$="claude-haiku-4-5-20251001";const{decrypt:W}=await Promise.resolve().then(()=>na);for(const y of["llm_slot_1","llm_slot_2","llm_slot_3"])try{const p=await E.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(S,y).first();if(p){const g=await W(p.encrypted_value,v),b=JSON.parse(g);if(b.provider==="anthropic"){H=b.apiKey,b.model&&($=b.model);break}}}catch{}if(!H)return;let z;if(m==="r2"&&O){const y=await O.get(c);if(!y)return;z=Buffer.from(await y.arrayBuffer()).toString("base64")}else if(_)z=_;else return;const R=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":H,"anthropic-version":"2023-06-01","anthropic-beta":"pdfs-2024-09-25","content-type":"application/json"},body:JSON.stringify({model:$,max_tokens:8192,messages:[{role:"user",content:[{type:"document",source:{type:"base64",media_type:"application/pdf",data:z}},{type:"text",text:"Extract all readable text from this document. Preserve tables, lists, and structure."}]}]})});if(!R.ok)return;const u=((q=(M=(await R.json()).content)==null?void 0:M[0])==null?void 0:q.text)||"";u&&await E.prepare("UPDATE uploaded_files SET extracted_text = ? WHERE id = ?").bind(u,c).run()}catch{}})();try{e.executionCtx.waitUntil(I)}catch{}}let f="";if(s.startsWith("text/"))try{const _=l||(o?Buffer.from(o).toString("base64"):"");f=Buffer.from(_,"base64").toString("utf-8").substring(0,500)}catch{}return e.json({file_id:c,name:r,type:s,size:i,text_preview:f,storage:a?"r2":"d1",extracting:h&&!w})}catch(d){console.error("File upload error:",d);try{const{logError:c}=await Promise.resolve().then(()=>at);await c(e.env.DB,t.id,"upload","upload_error",d.message||"Unknown upload error")}catch{}return e.json({error:`Upload failed: ${d.message||"Unknown error"}`},500)}});ae.post("/send",async e=>{const t=e.get("user"),{message:a,channel:n="web",thread_id:r,files:s}=await e.req.json();if(!a||typeof a!="string"||a.trim().length===0)return e.json({error:"Message is required"},400);let i="";if(s&&Array.isArray(s)&&s.length>0){i=`
...
`+w;return await e.env.DB.prepare("INSERT INTO notifications (user_id, type, title, body, source, is_read) VALUES (?, ?, ?, ?, ?, 0)").bind(r.user_id,"reminder",o,w,"cron:"+r.id).run(),c&&await e.env.DB.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata) VALUES (?, ?, ?, ?, ?)").bind(r.user_id,"system","assistant",f,JSON.stringify({type:"cron",job_id:r.id})).run(),r.telegram_chat_id&&await Ss(e.env.DB,r.user_id,r.telegram_chat_id,f),e.json({job_id:n,status:"completed",response_length:d.length})});async function Hn(e){var n;const t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!t)return null;const a=await e.env.DB.prepare("SELECT user_id FROM sessions WHERE id = ? AND expires_at > datetime('now')").bind(t).first();return(a==null?void 0:a.user_id)||null}Oe.get("/health/tools",async e=>{var a;const t=await Hn(e);if(!t)return e.json({error:"Not authenticated"},401);try{const n=await e.env.DB.prepare(`SELECT tool_name,
              COUNT(*) as total,
       ...
       ORDER BY calls DESC`).bind(t).all();return e.json({period:"last_24h",tool_stats:n.results,enforcement:{triggers:r.results,retry_results:((a=s.results)==null?void 0:a[0])||{total_retries:0,successful_retries:0}},cron:{executions:i.results,warnings:o.results},providers:l.results})}catch(n){return e.json({error:n.message||"Failed to fetch metrics"},500)}});Oe.get("/health/tools/recent",async e=>{const t=await Hn(e);if(!t)return e.json({error:"Not authenticated"},401);try{const a=await e.env.DB.prepare(`SELECT id, agent_type, provider_name, tool_name, tool_args, tool_result,
              success, error_message, latency_ms, was_enforcement_retry, channel, created_at
       FROM tool_execution_log
       WHERE user_id = ?
       ORDER BY id DESC LIMIT 50`).bind(t).all();return e.json({logs:a.results})}catch(a){return e.json({error:a.message},500)}});const ft=`
...
- Example: "Couldn't retrieve Amazon order status — requires login."`;function xs(e,t,a){return a==="reminder"?`[Scheduled Reminder] "${e}": ${t||"Time for your reminder."}`:a==="check_mail"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check Gmail for new/important emails."}
You MUST call gmail_list or gmail_search immediately.${ft}`:a==="check_calendar"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t||"Check calendar for upcoming events."}
You MUST call list_calendar_events immediately.${ft}`:a==="check_sheet"?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
You MUST call read_sheet immediately with the relevant spreadsheet.${ft}`:a==="custom"&&t?`[Autonomous Scheduled Task] Execute this task NOW using tools — do NOT just describe what you'd do.
Task: "${e}"
Instructions: ${t}
Execute the instructions above by calling the appropriate tools (web_search, gmail_search, read_sheet, etc.).${ft}`:`[Scheduled task "${e}"]: ${t||"Execute this scheduled task."}${ft}`}function ks(e,t,a,n){return{userId:e,username:t,channel:"telegram",text:a,sessionId:`telegram-${n}`,timestamp:new Date().toISOString()}}function Ds(e,t){return e.replace(/\*\*(.*?)\*\*/gs,"*$1*").replace(/^#{1,3}\s+(.+)$/gm,"*$1*").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/```(\w*)\n([\s\S]*?)```/g,"```$2```")}const Dt=new pe,Rs=4e3;async function te(e,t,a,n="Markdown",r,s){var d,c;const i=Cs(a,Rs),o=[];let l=!0;for(let m=0;m<i.length;m++){const h=i[m];let w=!1,f="";for(let _=0;_<3;_++)try{const v=await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h,parse_mode:n,disable_web_page_preview:!1})});if(v.ok){w=!0;break}const S=await v.json().catch(()=>null);if(f=`HTTP ${v.status}: ${(S==null?void 0:S.description)||"Unknown error"}`,(d=S==null?void 0:S.description)!=null&&d.includes("parse")||(c=S==null?void 0:S.description)!=null&&c.includes("entities")){if((await fetch(`https://api.telegram.org/bot${e}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,text:h})})).ok){w=!0;break}f+=" (plain-text retry also failed)"}if(v.status===429||v.status>=500){const E=Math.pow(2,_)*1e3;await new Promise(O=>setTimeout(O,E));continue}break}catch(v){if(f=`Network error: ${v.message}`,_<2){const S=Math.pow(2,_)*1e3;await new Promise(E=>setTimeout(E,S));continue}}w||(l=!1,o.push(`Chunk ${m+1}/${i.length}: ${f}`))}if(!l&&r&&s&&o.length>0)try{const{logError:m}=await Promise.resolve().then(()=>at);await m(r,s,"telegram","send_failed",o.join(" | "))}catch{}return{success:l,errors:o}}async function Os(e,t){try{await fetch(`https://api.telegram.org/bot${e}/sendChatAction`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t,action:"typing"})})}catch{}}function Cs(e,t){if(e.length<=t)return[e];const a=[];let n=e;for(;n.length>0;){if(n.length<=t){a.push(n);break}let r=n.lastIndexOf(`
`,t);r<t*.3&&(r=n.lastIndexOf(" ",t)),r<t*.3&&(r=t),a.push(n.substring(0,r)),n=n.substring(r).trimStart()}return a}async function Ns(e,t,a,n,r){switch(e.split("@")[0].toLowerCase()){case"/start":{const i=(n==null?void 0:n.name)||"there",o=(n==null?void 0:n.assistant_name)||"Karna",l=`👋 *Hello, ${i}!*
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`),d=await te(a,t,l,"Markdown",r,n==null?void 0:n.id);return!d.success&&d.errors.length>0&&console.warn(`[/start] Failed to send message: ${d.errors.join(" | ")}`),!0}case"/help":{const o=`🛠 *${(n==null?void 0:n.assistant_name)||"Karna"} — Commands*
...
Just type naturally — I'll figure out the rest.`,l=await te(a,t,o,"Markdown",r,n==null?void 0:n.id);return!l.success&&l.errors.length>0&&console.warn(`[/help] Failed to send message: ${l.errors.join(" | ")}`),!0}case"/status":{if(!n){const i=await te(a,t,"⚠️ Account not linked. Set your Telegram Chat ID in Settings on the web app.","Markdown",r);return i.success||console.warn(`[/status] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const[i,o,l,d]=await Promise.all([r.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(n.id).first(),r.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(n.id).first(),r.prepare("SELECT COUNT(DISTINCT date(created_at)) as cnt FROM conversations WHERE user_id = ?").bind(n.id).first(),r.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE user_id = ? AND acknowledged = 0").bind(n.id).first()]),c=`📊 *System Status*
...
Status: ✅ Online`,m=await te(a,t,c,"Markdown",r,n.id);m.success||console.warn(`[/status] Failed to send message: ${m.errors.join(" | ")}`)}catch{const o=await te(a,t,"✅ Online — but had trouble fetching stats.","Markdown",r,n==null?void 0:n.id);o.success||console.warn(`[/status error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}case"/new":{if(!n){const o=await te(a,t,"⚠️ Account not linked.","Markdown",r);return o.success||console.warn(`[/new] Failed to send message: ${o.errors.join(" | ")}`),!0}await r.prepare("UPDATE threads SET is_archived = 1 WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0").bind(n.id).run();const i=await te(a,t,"🆕 Starting fresh conversation. Your next message begins a new thread.","Markdown",r,n.id);return i.success||console.warn(`[/new] Failed to send message: ${i.errors.join(" | ")}`),!0}case"/tasks":case"/task":{if(!n){const i=await te(a,t,"⚠️ Account not linked.","Markdown",r);return i.success||console.warn(`[/tasks] Failed to send message: ${i.errors.join(" | ")}`),!0}try{const o=(await r.prepare(`
          ...
          ORDER BY
            ...
            importance DESC
          LIMIT 20
        `).bind(n.id).all()).results||[];if(o.length===0){const f=await te(a,t,"✅ No open tasks. You're all clear.","Markdown",r,n.id);return f.success||console.warn(`[/tasks] Failed to send message: ${f.errors.join(" | ")}`),!0}const l=new Date,d=l.toISOString().slice(0,10),c=new Date(l);c.setDate(c.getDate()+1);const m=c.toISOString().slice(0,10),h=[`📋 *Open Tasks (${o.length})*
...
_Say "mark [task] as done" to close a task._`);const w=await te(a,t,h.join(`
`),"Markdown",r,n.id);w.success||console.warn(`[/tasks] Failed to send message: ${w.errors.join(" | ")}`)}catch(i){const o=await te(a,t,"❌ Could not fetch tasks: "+i.message,"Markdown",r,n==null?void 0:n.id);o.success||console.warn(`[/tasks error] Failed to send message: ${o.errors.join(" | ")}`)}return!0}default:return!1}}Dt.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,n={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},r=async()=>{var s,i,o,l,d;try{if(t.callback_query){await Is(a,t.callback_query);return}const c=t.message;if(!c)return;const m=!!c.text,h=!!c.voice,w=!!c.document,f=!!c.photo,_=!!c.caption;if(!m&&!h&&!w&&!f)return;const v=String(c.chat.id);let S=c.text||"";const E=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(v).first();let O=null;if(E){const R=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(E.id,"telegram_bot_token").first();R&&(O=await Y(R.encrypted_value,E.pin_hash))}if(!O){const R=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();R&&(O=await Y(R.encrypted_value,R.pin_hash))}if(!O||S.startsWith("/")&&await Ns(S,v,O,E,a))return;if(!E){const R=await te(O,v,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${v}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`,"Markdown",a);R.success||console.warn(`Failed to send unlinked account message: ${R.errors.join(" | ")}`);return}if(c.voice&&O&&E)try{const R=await te(O,v,"🎤 Processing voice note...","Markdown",a,E.id);R.success||console.warn(`[voice start] Failed to send message: ${R.errors.join(" | ")}`);const u=await(await fetch(`https://api.telegram.org/bot${O}/getFile?file_id=${c.voice.file_id}`)).json();if(u.ok&&((s=u.result)!=null&&s.file_path)){const p=await(await fetch(`https://api.telegram.org/file/bot${O}/${u.result.file_path}`)).blob();let g="",b="",x="whisper-1";const T=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(E.id).all();for(const L of T.results){const F=await Y(L.encrypted_value,E.pin_hash);if(L.service==="openai"){g="https://api.openai.com/v1/audio/transcriptions",b=F;break}else if(L.service.startsWith("llm_slot_"))try{const J=JSON.parse(F);if(J.provider==="openai"){g="https://api.openai.com/v1/audio/transcriptions",b=J.apiKey;break}else if(J.provider==="groq"){g="https://api.groq.com/openai/v1/audio/transcriptions",b=J.apiKey,x="whisper-large-v3";break}}catch{}}if(!g){const L=await te(O,v,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).","Markdown",a,E.id);L.success||console.warn(`[voice no stt] Failed to send message: ${L.errors.join(" | ")}`);return}const D=new FormData;D.append("file",p,"voice.ogg"),D.append("model",x),D.append("language","en");const N=await fetch(g,{method:"POST",headers:{Authorization:`Bearer ${b}`},body:D});if(!N.ok){const L=await N.text(),F=await te(O,v,`⚠️ Transcription failed: ${N.status} ${L}`,"Markdown",a,E.id);F.success||console.warn(`[voice transcription error] Failed to send message: ${F.errors.join(" | ")}`);return}S=(await N.json()).text;const C=await te(O,v,`🗣️ *You said:* ${S}`,"Markdown",a,E.id);C.success||console.warn(`[voice transcript echo] Failed to send message: ${C.errors.join(" | ")}`)}}catch(R){const U=await te(O,v,`⚠️ Failed to process voice note: ${R.message}`,"Markdown",a,E==null?void 0:E.id);U.success||console.warn(`[voice processing error] Failed to send message: ${U.errors.join(" | ")}`);return}if((w||f)&&O&&E)try{let R,U="unknown",u="unknown",y=0;if(w)R=c.document.file_id,U=c.document.file_name||"document",u=c.document.mime_type||"unknown",y=c.document.file_size||0;else if(f){const p=c.photo[c.photo.length-1];R=p.file_id,U="photo.jpg",u="image/jpeg",y=p.file_size||0}if(R){const g=await(await fetch(`https://api.telegram.org/bot${O}/getFile?file_id=${R}`)).json();let b="";if(g.ok&&((i=g.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(U)||/^text\/|application\/json|application\/xml|application\/csv/i.test(u))&&y<5e4)try{b=await(await fetch(`https://api.telegram.org/file/bot${O}/${g.result.file_path}`)).text()}catch{}const x=c.caption||"",T=`[Telegram file received: "${U}" (${u}, ${Math.round(y/1024)}KB)]`;b?S=`${x?x+`
...
`:""}${T}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(R){if(_&&c.caption)S=c.caption;else{const U=await te(O,v,`⚠️ Received your file but couldn't process it: ${R.message}`,"Markdown",a,E==null?void 0:E.id);U.success||console.warn(`[file processing error] Failed to send message: ${U.errors.join(" | ")}`);return}}if(!S)return;Os(O,v).catch(()=>{});let I=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(E.id).first();I?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(I.id).run():I={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(E.id).run()).meta.last_row_id};const M=ks(E.id,E.username,S,v);M.metadata={thread_id:I.id};let q,H;try{const R=await ut(a,E.id,E.pin_hash);q=R.provider,H=R.rotation}catch(R){console.error("Telegram provider setup error:",R);const U=(o=R.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=R.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${R.message||"Unknown error"}`,u=await te(O,v,U,"Markdown",a,E.id);u.success||console.warn(`[provider error] Failed to send message: ${u.errors.join(" | ")}`);return}const{classifyIntentFast:$}=await Promise.resolve().then(()=>ms);if($(S).agent==="multi"){const R=await te(O,v,"🔍 On it…","Markdown",a,E.id);R.success||console.warn(`[ack] Failed to send: ${R.errors.join(" | ")}`)}const W=9e4;let z=!1;try{const R=await Promise.race([da(M,a,q,E,H,n),new Promise((y,p)=>setTimeout(()=>p(new Error("TELEGRAM_TIMEOUT")),W))]),U=Ds(R,"telegram"),u=await te(O,v,U||"(empty response)","Markdown",a,E.id);if(await a.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(I.id).run().catch(()=>{}),z=u.success,!u.success){console.error(`[CRITICAL] Agent response failed to send to Telegram for user ${E.id}:`,u.errors);try{const{logError:y}=await Promise.resolve().then(()=>at);await y(a,E.id,"telegram","response_send_failed",`Failed to deliver response: ${u.errors.join(" | ")}`)}catch{}}}catch(R){console.error("Telegram agent error:",R);const U=R.message==="TELEGRAM_TIMEOUT",u=U?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(d=R.message)!=null&&d.includes("API error")?`⚠️ AI provider returned an error. The provider (${q.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(R.message||"Unknown").substring(0,200)}`,y=await te(O,v,u,"Markdown",a,E.id);z=y.success,y.success||console.error(`[CRITICAL] Error message failed to send to Telegram for user ${E.id}:`,y.errors);try{const{logError:p}=await Promise.resolve().then(()=>at);await p(a,E.id,"telegram",U?"timeout":"agent_error",R.message||"Agent error",{provider:q.name})}catch{}}}catch(c){console.error("Telegram webhook error:",c);try{const{logError:m}=await Promise.resolve().then(()=>at);await m(a,null,"telegram","webhook_error",c.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(r()),e.json({ok:!0})});Dt.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const{webhook_url:n}=await e.req.json(),r=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!r)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await Y(r.encrypted_value,a.pin_hash);if(!n){const c=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(c)}const o=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:n,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(o)});Dt.get("/webhook-status",async e=>{var s,i,o,l,d,c;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({configured:!1,error:"Bot token not set"});const r=await Y(n.encrypted_value,a.pin_hash);try{const h=await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((i=h.result)==null?void 0:i.url)||"",has_webhook:!!((o=h.result)!=null&&o.url),pending_updates:((l=h.result)==null?void 0:l.pending_update_count)||0,last_error:((d=h.result)==null?void 0:d.last_error_message)||"",last_error_date:((c=h.result)==null?void 0:c.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Dt.post("/detect-chat-id",async e=>{var s,i;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!a)return e.json({error:"Invalid session"},401);const n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Bot token not configured"},400);const r=await Y(n.encrypted_value,a.pin_hash);try{const d=((i=(await(await fetch(`https://api.telegram.org/bot${r}/getWebhookInfo`)).json()).result)==null?void 0:i.url)||"";await fetch(`https://api.telegram.org/bot${r}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(v=>setTimeout(v,500));const m=await(await fetch(`https://api.telegram.org/bot${r}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${r}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const h=m.result||[];if(h.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const w=[],f=new Set;for(let v=h.length-1;v>=0;v--){const S=h[v].message;if(S&&S.chat){const E=String(S.chat.id);f.has(E)||(f.add(E),w.push({chat_id:E,name:[S.chat.first_name,S.chat.last_name].filter(Boolean).join(" ")||S.chat.title||"Unknown",username:S.chat.username||"",date:new Date((S.date||0)*1e3).toISOString()}))}}if(w.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=w[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,a.user_id).run(),e.json({found:!0,chat_id:_,name:w[0].name,all_chats:w,message:`Chat ID ${_} detected and saved to your profile.`})}catch(o){return e.json({error:`Detection failed: ${o.message}`},500)}});async function Is(e,t){var _;const{id:a,data:n,message:r,from:s}=t;if(!n||!r)return;const i=n.split(":");if(i[0]!=="briefing_toggle"||i.length<3)return;const o=i[1],l=parseInt(i[2]);if(!l||!o)return;const d=String(r.chat.id),c=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!c)return;const m=await e.prepare(`
  ...
  `).bind(h,h,m.id).run();const w=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(c.id).first();if(!w)return;const f=await Y(w.encrypted_value,w.pin_hash);try{const v=await fetch(`https://api.telegram.org/bot${f}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:a,text:h?"✅ Checked!":"☐ Unchecked"})});v.ok||console.warn(`[callback answer] Failed to answer callback: HTTP ${v.status}`)}catch(v){console.warn(`[callback answer] Error answering callback: ${v.message}`)}if((_=r.reply_markup)!=null&&_.inline_keyboard){const v=r.reply_markup.inline_keyboard.map(S=>S.map(E=>{var O;if((O=E.callback_data)!=null&&O.includes(o)){const I=h?"✅":"☐",M=E.text.replace(/^[☐✅]\s*/,"");return{...E,text:`${I} ${M}`}}return E}));try{await fetch(`https://api.telegram.org/bot${f}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:r.message_id,reply_markup:{inline_keyboard:v}})})}catch{}}}function As(e){const t=new Date,a=new Date(t.toLocaleString("en-US",{timeZone:e})),n=new Date(a);n.setDate(n.getDate()+1),n.setHours(0,0,0,0);const r=new Date(n);r.setHours(23,59,59,999);const s=n.toISOString().split("T")[0];return{start:n.toISOString(),end:r.toISOString(),dateStr:s}}async function Ls(e,t,a,n,r,s){try{return(await new sa(e,t,a,n,r).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(c=>c.displayName||c.email),source:"google"}})}catch(i){return console.error("Google Calendar fetch error:",i.message),[]}}async function Ms(e,t,a,n,r){try{const s=new ve(e,t,a,n,r),i=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),o=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of i){const h=m.from.split("<")[0].trim()||m.from;l[h]=(l[h]||0)+1}const d=Object.entries(l).sort(([,m],[,h])=>h-m).slice(0,5).map(([m])=>m),c=i.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:i.length,importantCount:o.length,topSenders:d,hasUrgent:c}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function $s(e,t){try{const a=await e.prepare(`
      ...
      ORDER BY
        ...
        importance DESC
      LIMIT 10
    `).bind(t).all(),n=new Date,r=new Date(n);r.setDate(r.getDate()+1),r.setHours(23,59,59,999);const s=a.results||[],i=s.map(l=>{if(l.due_date){const d=new Date(l.due_date),c=d<=n?"overdue":d<=r?"due today":d.toLocaleDateString("en-GB",{day:"numeric",month:"short"});return`${l.title} [${c}]`}return l.title}),o=s.filter(l=>l.due_date?new Date(l.due_date)<=r:!1).length;return{pending:s.length,dueToday:o,items:i}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function Bs(e,t){try{const a=Math.floor((Date.now()-1728e5)/1e3),n=`https://hn.algolia.com/api/v1/search?query=${encodeURIComponent(e)}&tags=story&hitsPerPage=5&numericFilters=created_at_i>${a},points>10`,r=await fetch(n,{headers:{"User-Agent":"Karna/1.0"}});return r.ok?((await r.json()).hits||[]).filter(i=>i.url&&!t.has(i.url)).slice(0,2).map(i=>({title:i.title,summary:`${i.points} pts · ${i.num_comments} comments on HN`,url:i.url,source:"news.ycombinator.com"})):[]}catch{return[]}}const Ca=["AI","LLM","Agentic","artificial intelligence","machine learning","Claude","GPT","Gemini"];async function js(e,t,a){const n=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],r=new Set;if(t&&a)try{((await t.prepare("SELECT url FROM briefing_seen_news WHERE user_id = ? AND seen_at > datetime('now', '-7 days')").bind(a).all()).results||[]).forEach(d=>r.add(d.url))}catch{}const s=[];if(n.some(l=>Ca.some(d=>l.toLowerCase().includes(d.toLowerCase())))){const l=n.find(c=>Ca.some(m=>c.toLowerCase().includes(m.toLowerCase())))||"AI agents",d=await Bs(l,r);for(const c of d)s.push(c),r.add(c.url)}for(const l of n){if(s.length>=8)break;const d=`latest ${l} news today`;try{const c=await Pt(d,{num:5});if(c.results)for(const m of c.results){if(s.length>=8)break;r.has(m.link)||(s.push({title:m.title,summary:m.snippet,url:m.link,source:m.displayLink}),r.add(m.link))}}catch(c){console.error(`News search error for "${d}":`,c.message)}}const o=s.slice(0,7);if(t&&a&&o.length>0)for(const l of o)try{await t.prepare("INSERT OR IGNORE INTO briefing_seen_news (user_id, url, title) VALUES (?, ?, ?)").bind(a,l.url,l.title).run()}catch{}return o}function Ps(e,t){const a=[];let n="20:00";{const[i,o]=t.split(":"),l=parseInt(i,10),d=o||"00",c=l>=12?"PM":"AM";n=`${l===0?12:l>12?l-12:l}:${d} ${c}`}a.push(`🗓 Your ${n} Brief — ${e.targetDate}`),a.push("");const r=e.calendar.totalCount;if(r>0){a.push(`📅 Tomorrow: ${r} event${r===1?"":"s"}`);for(const i of e.calendar.google.slice(0,5)){const o=i.startTime?new Date(i.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";a.push(`   • ${o} ${i.title}`)}}else a.push("📅 Tomorrow: Nothing scheduled");a.push("");const s=e.emails.gmail.unreadCount;if(s>0?(a.push(`📧 Gmail: ${s} unread`),e.emails.gmail.importantCount>0&&a.push(`   ★ ${e.emails.gmail.importantCount} marked important`),e.emails.gmail.hasUrgent&&a.push("   ⚠️ Urgent messages present"),e.emails.gmail.topSenders.length>0&&a.push(`   From: ${e.emails.gmail.topSenders.slice(0,3).join(", ")}`)):a.push("📧 Gmail: Inbox clear"),a.push(""),e.tasks.pending>0){a.push(`✅ Open Tasks (${e.tasks.pending}):`);for(const i of e.tasks.items)a.push(`   ☐ ${i}`)}else a.push("✅ Tasks: All clear");if(a.push(""),e.news.items.length>0){a.push("📡 Today's Signal:");for(const i of e.news.items){const o=i.source==="news.ycombinator.com"?"🟠 HN":`🔗 ${i.source}`;a.push(`   • ${i.title.substring(0,90)}${i.title.length>90?"…":""}`),a.push(`     ${o} — ${i.summary.substring(0,80)}${i.summary.length>80?"…":""}`)}}return a.join(`
`)}function Us(e){const t=[];let a=0;for(const n of e.calendar.google)t.push({type:"calendar",key:n.id,text:`${n.title} - ${new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:n},sortOrder:a++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:a++});for(const n of e.tasks.items)t.push({type:"task",key:`task-${n}`,text:n,metadata:{},sortOrder:a++});for(const n of e.news.items)t.push({type:"news",key:`news-${n.url}`,text:`📰 ${n.title}`,metadata:{url:n.url,source:n.source},sortOrder:a++});return t}async function Hs(e,t){const a=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!a)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let n;try{const s=JSON.parse(a.components);n={google_calendar:s.google_calendar!==!1,gmail:s.gmail!==!1,tasks:s.tasks!==!1,news:s.news!==!1}}catch{n={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const r=a.news_topics?a.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:n,newsTopics:r}}async function Fn(e,t,a){var E,O;const n=t.timezone||"Asia/Kolkata",r=As(n),{components:s,newsTopics:i}=await Hs(e,t.id),o=[],l=[];s.google_calendar&&(o.push(Ls(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET,r)),l.push("googleEvents")),s.gmail&&(o.push(Ms(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(o.push($s(e,t.id)),l.push("tasks")),s.news&&(o.push(js(i,e,t.id)),l.push("news"));const d=await Promise.all(o),c={};l.forEach((I,M)=>{c[I]=d[M]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},h={pending:0,dueToday:0,items:[]},w={generatedAt:new Date().toISOString(),targetDate:r.dateStr,calendar:{google:c.googleEvents||[],totalCount:((E=c.googleEvents)==null?void 0:E.length)||0},emails:{gmail:c.gmailSummary||m},tasks:c.tasks||h,news:{items:c.news||[],fetchedAt:new Date().toISOString()},summary:""},f=((O=await e.prepare("SELECT briefing_time FROM briefing_preferences WHERE user_id = ?").bind(t.id).first())==null?void 0:O.briefing_time)||"20:00";w.summary=Ps(w,f);const _=Us(w),v=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(w)).first(),S=(v==null?void 0:v.id)||0;for(const I of _)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(S,I.type,I.key,I.text,JSON.stringify(I.metadata),I.sortOrder).run();return{briefingId:S,content:w,items:_}}async function Fs(e,t,a){const n=await e.prepare(`
    SELECT * FROM briefings WHERE id = ? AND user_id = ?
  `).bind(a,t).first();if(!n)return null;const r=await e.prepare(`
    SELECT * FROM briefing_items WHERE briefing_id = ? ORDER BY sort_order ASC
  `).bind(a).all();return{briefing:{...n,content:JSON.parse(n.content_json||"{}")},items:r.results||[]}}async function Gs(e,t,a,n){if(!await e.prepare(`
  ...
  `).bind(n,a).first();if(!s)return null;const i=s.checked?0:1;return await e.prepare(`
    UPDATE briefing_items 
    SET checked = ?, checked_at = CASE WHEN ? = 1 THEN CURRENT_TIMESTAMP ELSE NULL END
    WHERE id = ? AND briefing_id = ?
  `).bind(i,i,n,a).run(),{checked:i===1}}async function Ws(e,t,a=10){return((await e.prepare(`
    SELECT b.*, 
    ...
    LIMIT ?
  `).bind(t,a).all()).results||[]).map(r=>({...r,content:JSON.parse(r.content_json||"{}")}))}function Gn(e,t,a=new Date){const n=new Date(a.toLocaleString("en-US",{timeZone:t})),r=n.getHours(),s=n.getMinutes(),[i,o]=e.split(":").map(Number),l=r*60+s,d=i*60+o;return l===d}function Wn(e,t){const a=e.summary,n=[];for(const r of t.slice(0,10))n.push([{text:`☐ ${r.text.substring(0,40)}${r.text.length>40?"...":""}`,callback_data:`briefing_toggle:${r.key}`}]);return{text:a,inlineKeyboard:n}}const oe=new pe;async function qs(e,t){var r;if(e.req.path.includes("/cron/"))return t();const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}oe.use("/*",qs);oe.get("/briefings",async e=>{const t=e.get("user"),a=parseInt(e.req.query("limit")||"10");try{const n=await Ws(e.env.DB,t.id,a);return e.json({briefings:n})}catch(n){return e.json({error:n.message},500)}});oe.get("/briefings/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const n=await Fs(e.env.DB,t.id,a);return n?e.json(n):e.json({error:"Briefing not found"},404)}catch(n){return e.json({error:n.message},500)}});oe.post("/briefings/:id/items/:itemId/toggle",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=parseInt(e.req.param("itemId"));try{const r=await Gs(e.env.DB,t.id,a,n);return r?e.json(r):e.json({error:"Item not found"},404)}catch(r){return e.json({error:r.message},500)}});oe.post("/briefings/generate",async e=>{const t=e.get("user");try{const a=await Fn(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(a)}catch(a){return e.json({error:a.message},500)}});oe.get("/morning-briefing",async e=>{const t=e.get("user");try{const a=await Kn(e.env.DB,t,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});return e.json(a)}catch(a){return e.json({error:a.message},500)}});oe.get("/briefing-preferences",async e=>{const t=e.get("user");try{const a=await e.env.DB.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t.id).first();if(!a){const r={briefingTime:"20:00",briefingEnabled:!0,components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0,weather:!1},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"],notificationChannels:{telegram:!0,web:!0},proactiveLevel:"moderate"};return e.json({preferences:r})}const n={briefingTime:a.briefing_time,briefingEnabled:a.briefing_enabled!==0,components:JSON.parse(a.components),newsTopics:a.news_topics.split(",").map(r=>r.trim()).filter(Boolean),notificationChannels:JSON.parse(a.notification_channels),proactiveLevel:a.proactive_level};return e.json({preferences:n})}catch(a){return e.json({error:a.message},500)}});oe.post("/briefing-preferences",async e=>{const t=e.get("user"),a=await e.req.json(),n=[];if(a.briefingTime&&(/^([01]?[0-9]|2[0-3]):[0-5][0-9]$/.test(a.briefingTime)||n.push("Invalid time format. Use HH:MM (e.g., 20:00)")),a.newsTopics&&(a.newsTopics.length>5&&n.push("Maximum 5 news topics allowed"),a.newsTopics.some(r=>r.length>50)&&n.push("Each news topic must be 50 characters or less")),a.proactiveLevel&&!["conservative","moderate","aggressive"].includes(a.proactiveLevel)&&n.push("Invalid proactive level. Use conservative, moderate, or aggressive"),n.length>0)return e.json({error:n.join("; ")},400);try{const r=await e.env.DB.prepare("SELECT id FROM briefing_preferences WHERE user_id = ?").bind(t.id).first(),s=a.components?JSON.stringify(a.components):null,i=a.notificationChannels?JSON.stringify(a.notificationChannels):null,o=a.newsTopics?a.newsTopics.join(", "):null;if(r){const l=[],d=[];a.briefingTime!==void 0&&(l.push("briefing_time = ?"),d.push(a.briefingTime)),a.briefingEnabled!==void 0&&(l.push("briefing_enabled = ?"),d.push(a.briefingEnabled?1:0)),s!==null&&(l.push("components = ?"),d.push(s)),o!==null&&(l.push("news_topics = ?"),d.push(o)),i!==null&&(l.push("notification_channels = ?"),d.push(i)),a.proactiveLevel!==void 0&&(l.push("proactive_level = ?"),d.push(a.proactiveLevel)),l.length>0&&(l.push("updated_at = CURRENT_TIMESTAMP"),d.push(t.id),await e.env.DB.prepare(`UPDATE briefing_preferences SET ${l.join(", ")} WHERE user_id = ?`).bind(...d).run())}else await e.env.DB.prepare(`
    ...
    `).bind(t.id).run(),e.json({success:!0,message:"Default preferences created"}))}catch(a){return e.json({error:a.message},500)}});oe.post("/cron/evening-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const n=await e.env.DB.prepare(`
    ...
    `).all(),r=[],s=new Date;for(const i of n.results||[]){if(!i.briefing_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.briefing_time||"20:00";if(Gn(l,o,s))try{const d=await Fn(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(i.telegram_chat_id){const{text:c,inlineKeyboard:m}=Wn(d.content,d.items);await qn(e.env.DB,i,c,m,d.briefingId)}r.push({user_id:i.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:o})}catch(d){r.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:r.length,results:r})}catch(n){return e.json({error:n.message},500)}});oe.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const n=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),r=[],s=new Date,i=new Date(s.getTime()+600*1e3).toISOString(),o=new Date(s.getTime()+900*1e3).toISOString();for(const l of n.results||[])try{const d=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!d)continue;const c=await Y(d.encrypted_value,l.pin_hash),h=JSON.parse(c).access_token;if(!h)continue;const w=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(o)}&maxResults=10`,{headers:{Authorization:`Bearer ${h}`}});if(!w.ok)continue;const _=((await w.json()).items||[]).filter(E=>{var I;const O=(I=E.start)==null?void 0:I.dateTime;return O?O>=s.toISOString()&&O<=i:!1});if(_.length===0){r.push({user_id:l.id,reminders_sent:0});continue}const v=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!v)continue;const S=await Y(v.encrypted_value,l.pin_hash);for(const E of _){const O=new Date(E.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),I=E.location?`
📍 ${E.location}`:"",M=`⏰ Meeting in 10 minutes!

*${E.summary||"Untitled Event"}*
🕐 ${O}${I}`;await fetch(`https://api.telegram.org/bot${S}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:M,parse_mode:"Markdown"})})}r.push({user_id:l.id,reminders_sent:_.length})}catch(d){r.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:r.length,results:r})}catch(n){return e.json({error:n.message},500)}});oe.post("/cron/morning-briefing",async e=>{const t=e.req.header("X-Cron-Secret")||"",a=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==a)return e.json({error:"Unauthorized"},401);try{const n=await e.env.DB.prepare(`
    ...
    `).all(),r=[];for(const s of n.results||[]){let i={};try{i=JSON.parse(s.components||"{}")}catch{}if(i.email_digest!==!1)try{const o=await Yn(e.env.DB,s,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),l=`Email Digest — ${new Date().toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})}`,d=JSON.stringify(o,null,2),c=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
      ...
      FROM users u
      LEFT JOIN briefing_preferences bp ON u.id = bp.user_id
    `).all(),r=[],s=new Date;for(const i of n.results||[]){if(!i.weekly_review_enabled)continue;const o=i.timezone||"Asia/Kolkata",l=i.weekly_review_day_time||"Sunday 20:00";if(zs(l,o,s))try{const d=await Ks(e.env.DB,i,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET}),c=`Weekly Review — Week of ${new Date().toLocaleDateString("en-US",{month:"short",day:"numeric"})}`,m=JSON.stringify(d,null,2),h=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
           VALUES (?, 'weekly_review', ?, ?, 'normal', 'proactive', ?, ?, ?) RETURNING id`).bind(i.id,c,m,`weekly_review_${Date.now()}`,null,null,null).first();let w={telegram:!0,web:!0};try{w=JSON.parse(i.notification_channels||"{}")}catch{}if(w.telegram!==!1&&i.telegram_chat_id){const f=Js(d);await zn(e.env.DB,i,f)}r.push({user_id:i.id,status:"success",action_item_id:h==null?void 0:h.id})}catch(d){r.push({user_id:i.id,status:"error",error:d.message})}}return e.json({executed:r.length,results:r})}catch(n){return e.json({error:n.message},500)}});async function qn(e,t,a,n,r){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const i=await Y(s.encrypted_value,s.pin_hash);if(!(await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a,parse_mode:"Markdown",reply_markup:{inline_keyboard:n.map(d=>d.map(c=>({...c,callback_data:`${c.callback_data}:${r}`})))}})})).json()).ok){const c=await(await fetch(`https://api.telegram.org/bot${i}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a.replace(/[_*[`\]]/g,""),reply_markup:{inline_keyboard:n.map(m=>m.map(h=>({...h,callback_data:`${h.callback_data}:${r}`})))}})})).json();if(!c.ok){console.error("Telegram briefing send failed:",c.description,"chat_id:",t.telegram_chat_id);return}}await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(r).run()}catch(s){console.error("Telegram briefing error:",s.message)}}async function zn(e,t,a){try{const n=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!n)return;const r=await Y(n.encrypted_value,n.pin_hash);(await fetch(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a.substring(0,4e3),parse_mode:"Markdown"})})).ok||await fetch(`https://api.telegram.org/bot${r}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:a.substring(0,4e3).replace(/[_*[`\]]/g,"")})})}catch(n){console.error("Telegram plain text error:",n.message)}}async function Kn(e,t,a){const n=new Date;n.setHours(0,0,0,0);const r=new Date;r.setHours(23,59,59,999);const s=await e.prepare(`
    SELECT * FROM cron_jobs 
    WHERE user_id = ? AND enabled = 1 
    AND next_run >= ? AND next_run <= ?
    ORDER BY next_run ASC
  `).bind(t.id,n.toISOString(),r.toISOString()).all(),i=await e.prepare(`
    SELECT * FROM action_items 
    WHERE user_id = ? AND status = 'pending'
    ORDER BY priority DESC, created_at DESC
    LIMIT 10
  `).bind(t.id).all(),o=await Yn(e,t,a);let l=[];try{const h=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first();if(h){const w=await Y(h.encrypted_value,t.pin_hash),_=JSON.parse(w).access_token;if(_){const v=n.toISOString(),S=r.toISOString(),E=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(v)}&timeMax=${encodeURIComponent(S)}&maxResults=20`,{headers:{Authorization:`Bearer ${_}`}});E.ok&&(l=((await E.json()).items||[]).map(I=>{var M,q,H,$;return{title:I.summary||"Untitled",startTime:((M=I.start)==null?void 0:M.dateTime)||((q=I.start)==null?void 0:q.date),endTime:((H=I.end)==null?void 0:H.dateTime)||(($=I.end)==null?void 0:$.date)}}))}}}catch{}const d={generatedAt:new Date().toISOString(),type:"morning",todayReminders:(s.results||[]).map(h=>({name:h.name,description:h.description,next_run:h.next_run})),pendingActions:(i.results||[]).map(h=>({title:h.title,priority:h.priority})),emailDigest:o,calendarEvents:l},c=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'morning', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(d)).first();return{briefingId:(c==null?void 0:c.id)||0,content:d}}async function Yn(e,t,a){const n={unreadCount:0,recent:[]},r={message:"",recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const i=new ve(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET),o=await i.getUnreadCount(),l=await i.listMessages({maxResults:10,labelIds:["INBOX"]});n.unreadCount=o,n.recent=l.map(d=>({id:d.id,subject:d.subject,from:d.from,snippet:d.snippet,isUnread:d.isUnread}))}}catch(s){n.error=s.message}try{const s=await e.prepare("SELECT name, encrypted_blob FROM site_credentials WHERE user_id = ? AND (name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE OR name LIKE ? COLLATE NOCASE) LIMIT 1").bind(t.id,"%Outlook%","%Microsoft%","%Office 365%").first();if(!s)r.message="No Outlook credentials saved in Secret Vault. Add them in Settings → Secret Vault.";else{const i=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t.id,"browser_use_api_key").first();if(!i)r.message="Browser Use API key not configured. Add it in Settings → API Keys → Browser Use API Key.";else{const o=(await Y(i.encrypted_value,t.pin_hash)).trim(),l=JSON.parse(await Y(s.encrypted_blob,t.pin_hash)),d=await Rn("Go to https://outlook.live.com or https://outlook.office.com. Log in with username {username} and password {password} if prompted. Navigate to the inbox and extract the 10 most recent emails with sender, subject, date, and snippet. Return the results as structured text.",o,{secrets:{username:l.username,password:l.password},timeoutMs:88e3});d.status==="completed"&&d.output?r.recent=d.output:d.status==="timeout"?r.message="Outlook browser task timed out.":r.message="Outlook returned no content."}}}catch(s){r.message=`Outlook error: ${s.message}`}return{gmail:n,outlook:r}}function zs(e,t,a=new Date){const n=new Date(a.toLocaleString("en-US",{timeZone:t})),r=n.toLocaleDateString("en-US",{weekday:"long"}),s=n.getHours(),i=n.getMinutes(),o=e.trim().split(" "),l=o[o.length-1],d=o.slice(0,o.length-1).join(" "),[c,m]=l.split(":").map(Number),h=s*60+i,w=c*60+m;return r===d&&h===w}async function Ks(e,t,a){const n=new Date,r=new Date(n.getTime()-10080*60*1e3),s=new Date(n.getTime()+10080*60*1e3),i=await e.prepare(`
    SELECT * FROM cron_jobs 
  ...
  `).bind(t.id,r.toISOString()).all(),c=await e.prepare(`
    ...
    ORDER BY next_run ASC
  `).bind(t.id,n.toISOString(),s.toISOString()).all();let m={unreadCount:0,recent:[]};try{if(await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t.id).first()){const w=new ve(e,t.id,t.pin_hash,a.GOOGLE_CLIENT_ID,a.GOOGLE_CLIENT_SECRET),f=await w.getUnreadCount(),_=await w.listMessages({maxResults:10,labelIds:["INBOX"]});m={unreadCount:f,recent:_.map(v=>({subject:v.subject,from:v.from,snippet:v.snippet}))}}}catch{}return{generatedAt:n.toISOString(),period:{start:r.toISOString(),end:n.toISOString()},completedTasks:(i.results||[]).map(h=>({name:h.name,last_run:h.last_run})),missedTasks:(o.results||[]).map(h=>({name:h.name,next_run:h.next_run})),openActions:(l.results||[]).map(h=>({title:h.title,priority:h.priority,status:h.status})),recentDocuments:(d.results||[]).map(h=>({name:h.name,status:h.status,created_at:h.created_at})),upcomingTasks:(c.results||[]).map(h=>({name:h.name,next_run:h.next_run})),gmailSummary:m}}function Ys(e){const t=[];t.push("☀️ Morning Briefing"),t.push("");const a=e.todayReminders||[];if(a.length>0){t.push(`📋 Today (${a.length}):`);for(const l of a){const d=l.next_run?new Date(l.next_run).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${d} ${l.name}`)}}else t.push("📋 Today: No scheduled reminders");t.push("");const n=e.pendingActions||[];if(n.length>0){t.push(`🔔 Pending Actions (${n.length}):`);for(const l of n.slice(0,5))t.push(`   • ${l.title} (${l.priority})`)}else t.push("🔔 Pending Actions: None");t.push("");const r=e.emailDigest||{},s=r.gmail||{};s.unreadCount>0?t.push(`📧 Gmail: ${s.unreadCount} unread`):t.push("📧 Gmail: Inbox clear");const i=r.outlook||{};typeof i.recent=="string"&&i.recent.length>0?t.push("📧 Outlook: see digest"):i.message&&t.push(`📧 Outlook: ${i.message}`),t.push("");const o=e.calendarEvents||[];if(o.length>0){t.push(`📅 Calendar (${o.length}):`);for(const l of o.slice(0,5)){const d=l.startTime?new Date(l.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${d} ${l.title}`)}}return t.join(`
`)}function Js(e){const t=[];t.push("📊 Weekly Review"),t.push("");const a=e.completedTasks||[];t.push(`✅ Completed: ${a.length}`);const n=e.missedTasks||[];t.push(`❌ Missed/Overdue: ${n.length}`);const r=e.openActions||[];t.push(`🔔 Open Actions: ${r.length}`),t.push("");const s=e.recentDocuments||[];s.length>0&&t.push(`📄 Documents: ${s.length} this week`);const i=e.upcomingTasks||[];i.length>0&&t.push(`📅 Upcoming: ${i.length} in next 7 days`);const o=e.gmailSummary||{};return o.unreadCount>0&&t.push(`📧 Gmail Unread: ${o.unreadCount}`),t.join(`
`)}oe.post("/briefings/:id/resend",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));try{const n=await e.env.DB.prepare("SELECT * FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!n)return e.json({error:"Briefing not found"},404);const r=JSON.parse(n.content||"{}"),s=await e.env.DB.prepare("SELECT * FROM briefing_items WHERE briefing_id = ?").bind(a).all(),{text:i,inlineKeyboard:o}=Wn(r,s.results||[]);await e.env.DB.prepare("UPDATE briefings SET delivered_telegram = 0 WHERE id = ?").bind(a).run(),await qn(e.env.DB,t,i,o,a);const l=await e.env.DB.prepare("SELECT delivered_telegram FROM briefings WHERE id = ?").bind(a).first();return l!=null&&l.delivered_telegram?e.json({success:!0,message:"Briefing sent to Telegram"}):e.json({error:"Telegram send failed — check bot token and chat ID in Settings"},500)}catch(n){return e.json({error:n.message},500)}});oe.delete("/briefings/:id",async e=>{const t=e.get("user"),a=e.req.param("id");return await e.env.DB.prepare("DELETE FROM briefings WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});const Je=new pe;async function Vs(e,t){var r;const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}Je.use("/*",Vs);function Jn(e){return e.toLowerCase().replace(/[^a-z0-9\s_-]/g,"").replace(/\s+/g,"_").replace(/_+/g,"_").substring(0,50).replace(/^_|_$/g,"")}Je.get("/",async e=>{const t=e.get("user"),a=await e.env.DB.prepare(`SELECT id, name, slug, description, instructions, parameters, required_tools, examples, enabled, usage_count, last_used_at, created_at, updated_at
     FROM user_skills WHERE user_id = ? ORDER BY created_at DESC`).bind(t.id).all();return e.json({skills:a.results||[]})});Je.post("/",async e=>{var d,c,m;const t=e.get("user"),a=await e.req.json();if(!((d=a.name)!=null&&d.trim()))return e.json({error:"name is required"},400);if(!((c=a.description)!=null&&c.trim()))return e.json({error:"description is required"},400);if(!((m=a.instructions)!=null&&m.trim()))return e.json({error:"instructions is required"},400);let n=Jn(a.name);n||(n=`skill_${Date.now()}`);const r=await e.env.DB.prepare("SELECT slug FROM user_skills WHERE user_id = ? AND slug LIKE ?").bind(t.id,`${n}%`).all();r.results&&r.results.length>0&&r.results.map(w=>w.slug).includes(n)&&(n=`${n}_${r.results.length+1}`);const s=JSON.stringify(a.parameters||{}),i=JSON.stringify(a.required_tools||[]),o=JSON.stringify(a.examples||[]),l=await e.env.DB.prepare(`INSERT INTO user_skills (user_id, name, slug, description, instructions, parameters, required_tools, examples)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).bind(t.id,a.name.trim(),n,a.description.trim(),a.instructions.trim(),s,i,o).first();return e.json({skill:l,created:!0})});Je.get("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));if(isNaN(a))return e.json({error:"Invalid skill ID"},400);const n=await e.env.DB.prepare("SELECT * FROM user_skills WHERE id = ? AND user_id = ?").bind(a,t.id).first();return n?e.json({skill:n}):e.json({error:"Skill not found"},404)});Je.put("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));if(isNaN(a))return e.json({error:"Invalid skill ID"},400);const n=await e.req.json(),r=[],s=[];return n.name!==void 0&&(r.push("name = ?","slug = ?"),s.push(n.name.trim(),Jn(n.name))),n.description!==void 0&&(r.push("description = ?"),s.push(n.description.trim())),n.instructions!==void 0&&(r.push("instructions = ?"),s.push(n.instructions.trim())),n.parameters!==void 0&&(r.push("parameters = ?"),s.push(JSON.stringify(n.parameters))),n.required_tools!==void 0&&(r.push("required_tools = ?"),s.push(JSON.stringify(n.required_tools))),n.examples!==void 0&&(r.push("examples = ?"),s.push(JSON.stringify(n.examples))),n.enabled!==void 0&&(r.push("enabled = ?"),s.push(n.enabled?1:0)),r.length===0?e.json({error:"Nothing to update"},400):(r.push("updated_at = CURRENT_TIMESTAMP"),s.push(a,t.id),await e.env.DB.prepare(`UPDATE user_skills SET ${r.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});Je.delete("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return isNaN(a)?e.json({error:"Invalid skill ID"},400):(await e.env.DB.prepare("DELETE FROM user_skills WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0}))});const Be=new pe;async function Zs(e,t){var r;const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}Be.use("/*",Zs);function Xs(e){const t=new Date().toLocaleString("en-US",{timeZone:e});return new Date(t)}function Vn(e){const t=Xs(e),a=new Date(t);a.setDate(a.getDate()+1),a.setHours(9,0,0,0);const n=new Date(a.toLocaleString("en-US",{timeZone:"UTC"})),r=new Date(a.toLocaleString("en-US",{timeZone:e})),s=n.getTime()-r.getTime();return new Date(a.getTime()+s)}function ca(e){if(!e)return null;if(e.startsWith("cron:")){const t=parseInt(e.replace("cron:",""),10);return isNaN(t)?null:t}return null}Be.put("/notifications/:id/done",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!n)return e.json({error:"Notification not found"},404);await e.env.DB.prepare("UPDATE notifications SET is_read = 1 WHERE id = ? AND user_id = ?").bind(a,t.id).run();const r=ca(n.source);return r&&await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t.id).run(),e.json({success:!0})});Be.post("/notifications/:id/snooze",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.req.json(),r=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!r)return e.json({error:"Notification not found"},404);let s;if(typeof n.minutes=="number")s=new Date(Date.now()+n.minutes*60*1e3);else if(n.until==="tomorrow_morning")s=Vn(t.timezone||"UTC");else if(n.new_time)s=new Date(n.new_time);else return e.json({error:"Invalid snooze parameters"},400);if(isNaN(s.getTime()))return e.json({error:"Invalid time"},400);const i=s.toISOString(),o=await e.env.DB.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,r.title,r.body,"once",i,"reminder",JSON.stringify({description:r.body||""}),i,1,"active").first();return await e.env.DB.prepare("UPDATE notifications SET is_read = 1 WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0,job_id:o==null?void 0:o.id})});Be.post("/notifications/:id/reschedule",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),{new_time:n}=await e.req.json();if(!n)return e.json({error:"new_time is required"},400);const r=new Date(n);if(isNaN(r.getTime()))return e.json({error:"Invalid time"},400);const s=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!s)return e.json({error:"Notification not found"},404);const i=r.toISOString(),o=ca(s.source);if(o)return await e.env.DB.prepare("UPDATE cron_jobs SET next_run = ?, schedule_value = ?, state = 'active', enabled = 1, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(i,i,o,t.id).run(),e.json({success:!0,job_id:o});const l=await e.env.DB.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, enabled, state)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,s.title,s.body,"once",i,"reminder",JSON.stringify({description:s.body||""}),i,1,"active").first();return e.json({success:!0,job_id:l==null?void 0:l.id})});Be.delete("/notifications/:id/cancel",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.env.DB.prepare("SELECT * FROM notifications WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!n)return e.json({error:"Notification not found"},404);const r=ca(n.source);return r&&await e.env.DB.prepare("UPDATE cron_jobs SET enabled = 0, state = 'completed', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(r,t.id).run(),await e.env.DB.prepare("DELETE FROM notifications WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});Be.post("/reminders/:id/snooze",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.req.json();if(!await e.env.DB.prepare("SELECT * FROM cron_jobs WHERE id = ? AND user_id = ?").bind(a,t.id).first())return e.json({error:"Reminder not found"},404);let s;if(typeof n.minutes=="number")s=new Date(Date.now()+n.minutes*60*1e3);else if(n.until_tomorrow_9am)s=Vn(t.timezone||"UTC");else if(n.new_time)s=new Date(n.new_time);else return e.json({error:"Invalid snooze parameters"},400);if(isNaN(s.getTime()))return e.json({error:"Invalid time"},400);const i=s.toISOString();return await e.env.DB.prepare("UPDATE cron_jobs SET next_run = ?, schedule_value = ?, state = 'active', enabled = 1, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(i,i,a,t.id).run(),e.json({success:!0})});Be.post("/reminders/:id/done",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("SELECT * FROM cron_jobs WHERE id = ? AND user_id = ?").bind(a,t.id).first()?(await e.env.DB.prepare("UPDATE cron_jobs SET state = 'completed', enabled = 0, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t.id).run(),await e.env.DB.prepare("UPDATE notifications SET is_read = 1 WHERE source = ? AND user_id = ?").bind(`cron:${a}`,t.id).run(),e.json({success:!0})):e.json({error:"Reminder not found"},404)});const _e=new pe;async function Qs(e,t){var r;const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}_e.use("/*",Qs);_e.get("/",async e=>{const t=e.get("user"),[a,n,r,s,i,o,l,d,c,m,h]=await Promise.all([e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'pending'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'running'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'failed'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'completed'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ? AND status = 'needs_approval'").bind(t.id).first(),e.env.DB.prepare("SELECT COUNT(*) as cnt FROM action_items WHERE user_id = ?").bind(t.id).first(),e.env.DB.prepare("SELECT type, COUNT(*) as cnt FROM action_items WHERE user_id = ? GROUP BY type").bind(t.id).all(),e.env.DB.prepare(`SELECT * FROM action_items WHERE user_id = ? AND (status IN ('pending', 'running', 'needs_approval') OR date(due_at) = date('now'))
       ...
       ORDER BY updated_at DESC LIMIT 20`).bind(t.id).all()]),w={};for(const f of l.results||[])w[f.type]=f.cnt;return e.json({counts:{pending:(a==null?void 0:a.cnt)||0,running:(n==null?void 0:n.cnt)||0,failed:(r==null?void 0:r.cnt)||0,completed:(s==null?void 0:s.cnt)||0,needs_approval:(i==null?void 0:i.cnt)||0,total:(o==null?void 0:o.cnt)||0},by_type:w,today:d.results||[],pending:c.results||[],needs_approval:m.results||[],recent_activity:h.results||[]})});_e.get("/pending",async e=>{const t=e.get("user"),a=e.req.query("type"),n=parseInt(e.req.query("limit")||"50");let r="SELECT * FROM action_items WHERE user_id = ? AND status IN ('pending', 'needs_approval')";const s=[t.id];a&&(r+=" AND type = ?",s.push(a)),r+=" ORDER BY CASE priority WHEN 'urgent' THEN 1 WHEN 'high' THEN 2 WHEN 'normal' THEN 3 ELSE 4 END, due_at ASC LIMIT ?",s.push(n);const i=await e.env.DB.prepare(r).bind(...s).all();return e.json({items:i.results||[]})});_e.post("/:id/complete",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare(`UPDATE action_items SET status = 'completed', completed_at = CURRENT_TIMESTAMP, updated_at = CURRENT_TIMESTAMP
     WHERE id = ? AND user_id = ?`).bind(a,t.id).run(),e.json({success:!0})});_e.post("/:id/cancel",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare(`UPDATE action_items SET status = 'cancelled', updated_at = CURRENT_TIMESTAMP
     WHERE id = ? AND user_id = ?`).bind(a,t.id).run(),e.json({success:!0})});_e.post("/:id/retry",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare(`UPDATE action_items SET status = 'pending', updated_at = CURRENT_TIMESTAMP
     WHERE id = ? AND user_id = ? AND status = 'failed'`).bind(a,t.id).run(),e.json({success:!0})});_e.post("/:id/approve",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare(`UPDATE action_items SET status = 'pending', updated_at = CURRENT_TIMESTAMP
     WHERE id = ? AND user_id = ? AND status = 'needs_approval'`).bind(a,t.id).run(),e.json({success:!0})});_e.post("/",async e=>{const t=e.get("user"),a=await e.req.json();if(!a.title||typeof a.title!="string")return e.json({error:"Title is required"},400);const n=await e.env.DB.prepare(`INSERT INTO action_items (user_id, type, title, body, priority, source, source_id, action_payload, due_at)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id`).bind(t.id,a.type||"manual",a.title,a.body||null,a.priority||"normal",a.source||null,a.source_id||null,a.action_payload||null,a.due_at||null).first();return e.json({success:!0,id:n==null?void 0:n.id})});_e.delete("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM action_items WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});const je=new pe;async function ei(e,t){var r;const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}je.use("/*",ei);je.get("/",async e=>{const t=e.get("user"),a=e.req.query("status"),n=e.req.query("search"),r=["user_id = ?"],s=[t.id];a&&(r.push("status = ?"),s.push(a)),n&&(r.push("(name LIKE ? OR summary LIKE ?)"),s.push(`%${n}%`,`%${n}%`));const i=`SELECT * FROM document_library WHERE ${r.join(" AND ")} ORDER BY created_at DESC`,o=await e.env.DB.prepare(i).bind(...s).all();return e.json({documents:o.results||[]})});je.get("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(a,t.id).first();return n?e.json({document:n}):e.json({error:"Document not found"},404)});je.post("/",async e=>{const t=e.get("user"),a=await e.req.json();if(!a.name||typeof a.name!="string")return e.json({error:"name is required"},400);const n=a.source||"upload",r=a.mime_type||"application/octet-stream",s=typeof a.size=="number"?a.size:0,i=await e.env.DB.prepare(`INSERT INTO document_library (user_id, name, source, file_id, drive_file_id, mime_type, size, status)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).bind(t.id,a.name,n,a.file_id||null,a.drive_file_id||null,r,s,"uploaded").first();return e.json({success:!0,document:i})});je.post("/:id/summarize",async e=>{var d;const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(a,t.id).first();if(!n)return e.json({error:"Document not found"},404);let r=null;if(n.file_id){const c=await e.env.DB.prepare("SELECT extracted_text FROM uploaded_files WHERE id = ? AND user_id = ?").bind(n.file_id,t.id).first();r=(c==null?void 0:c.extracted_text)||null}let s=null;if(r)try{const{provider:c}=await ut(e.env.DB,t.id,t.pin_hash);s=((d=(await c.chat([{role:"system",content:"You are a helpful assistant that summarizes documents concisely."},{role:"user",content:`Summarize the following document in a few paragraphs:

${r.substring(0,8e3)}`}],{maxTokens:1024})).content)==null?void 0:d.trim())||null}catch{s=null}const i=s||"Summary not yet generated. Ask Karna in chat to summarize this document.";await e.env.DB.prepare("UPDATE document_library SET status = ?, summary = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("summarized",i,a,t.id).run();const l=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(a,t.id).first();return e.json({success:!0,document:l})});je.delete("/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("DELETE FROM document_library WHERE id = ? AND user_id = ?").bind(a,t.id).run(),e.json({success:!0})});je.post("/:id/parse",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));await e.env.DB.prepare("UPDATE document_library SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind("parsed",a,t.id).run();const n=await e.env.DB.prepare("SELECT * FROM document_library WHERE id = ? AND user_id = ?").bind(a,t.id).first();return e.json({success:!0,document:n})});const we=new pe;async function ti(e,t){var r;const a=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const n=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(a).first();if(!n)return e.json({error:"Invalid session"},401);e.set("user",{id:n.user_id,username:n.username,name:n.name,pin_hash:n.pin_hash,role:n.role,personality_prompt:n.personality_prompt,telegram_chat_id:n.telegram_chat_id,timezone:n.timezone,assistant_name:n.assistant_name||"Karna",created_at:n.created_at,updated_at:n.updated_at}),e.set("sessionId",a),await t()}we.use("/*",ti);we.get("/api/memory/review",async e=>{const t=e.get("user"),a=e.req.query("tier"),n=e.req.query("type"),r=e.req.query("search"),s=parseInt(e.req.query("limit")||"50");let i="SELECT * FROM memory WHERE user_id = ?";const o=[t.id];a&&(i+=" AND tier = ?",o.push(a)),n&&(i+=" AND type = ?",o.push(n)),r&&(i+=" AND (title LIKE ? OR content LIKE ?)",o.push(`%${r}%`,`%${r}%`)),i+=" ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?",o.push(s);const l=await e.env.DB.prepare(i).bind(...o).all(),d=await e.env.DB.prepare("SELECT tier, COUNT(*) as cnt FROM memory WHERE user_id = ? GROUP BY tier").bind(t.id).all(),c={working:0,long_term:0};for(const m of d.results||[])c[m.tier]=m.cnt;return e.json({memories:l.results||[],tier_counts:c})});we.put("/api/memory/review/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.req.json(),r=[],s=[];return n.title!==void 0&&(r.push("title = ?"),s.push(n.title)),n.content!==void 0&&(r.push("content = ?"),s.push(n.content)),n.importance!==void 0&&(r.push("importance = ?"),s.push(n.importance)),n.tier!==void 0&&(r.push("tier = ?"),s.push(n.tier)),r.length===0?e.json({error:"Nothing to update"},400):(r.push("updated_at = CURRENT_TIMESTAMP"),s.push(a,t.id),await e.env.DB.prepare(`UPDATE memory SET ${r.join(", ")} WHERE id = ? AND user_id = ?`).bind(...s).run(),e.json({success:!0}))});we.post("/api/memory/review/:id/promote",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await new K(e.env.DB).promote(a,t.id),e.json({success:!0})});we.post("/api/memory/review/:id/demote",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await new K(e.env.DB).demote(a,t.id),e.json({success:!0})});we.delete("/api/memory/review/:id",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await new K(e.env.DB).remove(a,t.id),e.json({success:!0})});we.get("/api/memory-suggestions",async e=>{const t=e.get("user"),a=e.req.query("status")||"pending",n=parseInt(e.req.query("limit")||"50"),r=await e.env.DB.prepare("SELECT * FROM memory_suggestions WHERE user_id = ? AND status = ? ORDER BY created_at DESC LIMIT ?").bind(t.id,a,n).all();return e.json({suggestions:r.results||[]})});we.post("/api/memory-suggestions/:id/accept",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id")),n=await e.env.DB.prepare("SELECT * FROM memory_suggestions WHERE id = ? AND user_id = ? AND status = 'pending'").bind(a,t.id).first();return n?(await new K(e.env.DB).store(t.id,n.type,n.title,n.content,n.importance,"long_term"),await e.env.DB.prepare("UPDATE memory_suggestions SET status = 'accepted', decided_at = CURRENT_TIMESTAMP WHERE id = ?").bind(a).run(),e.json({success:!0})):e.json({error:"Suggestion not found or already decided"},404)});we.post("/api/memory-suggestions/:id/reject",async e=>{const t=e.get("user"),a=parseInt(e.req.param("id"));return await e.env.DB.prepare("SELECT id FROM memory_suggestions WHERE id = ? AND user_id = ? AND status = 'pending'").bind(a,t.id).first()?(await e.env.DB.prepare("UPDATE memory_suggestions SET status = 'rejected', decided_at = CURRENT_TIMESTAMP WHERE id = ?").bind(a).run(),e.json({success:!0})):e.json({error:"Suggestion not found or already decided"},404)});we.post("/api/memory-suggestions",async e=>{const t=e.get("user"),{type:a,title:n,content:r,importance:s,source_message_id:i}=await e.req.json();if(!a||!n||!r)return e.json({error:"type, title, and content are required"},400);const o=await e.env.DB.prepare("INSERT INTO memory_suggestions (user_id, type, title, content, importance, status, source_message_id) VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING id").bind(t.id,a,n,r,s??5,"pending",i||null).first();return e.json({success:!0,id:o==null?void 0:o.id})});const de=new pe;de.use("/api/*",Mr());de.route("/api/auth",$e);de.route("/api/chat",ae);de.route("/api/settings",Z);de.route("/api/system",Oe);de.route("/api/telegram",Dt);de.route("/api/proactive",oe);de.route("/api/skills",Je);de.route("/api/notifications",Be);de.route("/api/action-center",_e);de.route("/api/documents",je);de.route("/api/memory",we);de.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),a=t.searchParams.get("code"),n=t.searchParams.get("state"),r=t.searchParams.get("error");if(r)return e.html(Xe(!1,`Google denied access: ${r}`));if(!a||!n)return e.html(Xe(!1,"Missing authorization code or state parameter."));try{const i=JSON.parse(atob(n)).sessionId;if(!i)return e.html(Xe(!1,"Invalid state parameter — missing session."));const o=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(i).first();if(!o)return e.html(Xe(!1,"Session expired. Please log in again and retry."));const l=o.user_id,d=o.pin_hash,c=`${t.protocol}//${t.host}/auth/google/callback`,m=await pn(e.env.DB,l,d,a,c,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Xe(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Xe(!1,`OAuth failed: ${s.message}`))}});de.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Qa())));de.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(Qa())));function Xe(e,t,a){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function ai(e,t,a){const n="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const o=await(await fetch(`${n}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(o.results&&o.results.length>0){const d=o.results.filter(m=>m.needs_agent&&m.status==="dispatched");if(d.length>0){const m=d.map(h=>fetch(`${n}/api/system/cron/run-task/${h.job_id}`,{method:"POST",headers:s}).then(w=>w.json()).catch(w=>({job_id:h.job_id,error:w.message})));a.waitUntil(Promise.allSettled(m).then(h=>{console.log(`Cron: ${o.executed} dispatched, ${d.length} agent tasks`,JSON.stringify(h.map(w=>w.status==="fulfilled"?w.value:w.reason)))}))}const c=o.results.filter(m=>!m.needs_agent&&m.status==="dispatched");if(c.length>0){const m=c.map(h=>fetch(`${n}/api/system/cron/run-task/${h.job_id}`,{method:"POST",headers:s}).catch(()=>{}));a.waitUntil(Promise.allSettled(m))}}a.waitUntil(fetch(`${n}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{d.executed>0&&console.log("Evening briefing result:",JSON.stringify(d))}).catch(d=>{console.error("Evening briefing error:",d.message)})),new Date().getMinutes()%5<2&&a.waitUntil(fetch(`${n}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{var c;(c=d.results)!=null&&c.some(m=>m.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(d))}).catch(()=>{}))}catch(i){console.error("Scheduled cron error:",i.message||i)}}const ni={fetch:de.fetch,scheduled:ai},Na=new pe,ri=Object.assign({"/src/index.tsx":ni});let Zn=!1;for(const[,e]of Object.entries(ri))e&&(Na.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Na.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Zn=!0);if(!Zn)throw new Error("Can't import modules from ['/src/index.tsx']");export{Na as default};
