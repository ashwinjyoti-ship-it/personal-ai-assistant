var ur=Object.defineProperty;var Ut=e=>{throw TypeError(e)};var pr=(e,t,a)=>t in e?ur(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var D=(e,t,a)=>pr(e,typeof t!="symbol"?t+"":t,a),bt=(e,t,a)=>t.has(e)||Ut("Cannot "+a);var b=(e,t,a)=>(bt(e,t,"read from private field"),a?a.call(e):t.get(e)),A=(e,t,a)=>t.has(e)?Ut("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),C=(e,t,a,r)=>(bt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),M=(e,t,a)=>(bt(e,t,"access private method"),a);var Ht=(e,t,a,r)=>({set _(n){C(e,t,n,a)},get _(){return b(e,t,r)}});var Gt=(e,t,a)=>(r,n)=>{let s=-1;return i(0);async function i(o){if(o<=s)throw new Error("next() called multiple times");s=o;let l,c=!1,d;if(e[o]?(d=e[o][0][0],r.req.routeIndex=o):d=o===e.length&&n||void 0,d)try{l=await d(r,()=>i(o+1))}catch(p){if(p instanceof Error&&t)r.error=p,l=await t(p,r),c=!0;else throw p}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},mr=Symbol(),hr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ma?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?gr(e,{all:a,dot:r}):{}};async function gr(e,t){const a=await e.formData();return a?fr(a,t):{}}function fr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?yr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(vr(a,r,n),delete a[r])}),a}var yr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},vr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,i)=>{i===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},la=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},br=e=>{const{groups:t,path:a}=wr(e),r=la(a);return _r(r,t)},wr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},_r=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},lt={},Er=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return lt[r]||(a[2]?lt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:lt[r]=[e,a[1],!0]),lt[r]}return null},At=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},Tr=e=>At(e,decodeURI),ca=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),i=t.indexOf("#",r),o=s===-1?i===-1?void 0:i:i===-1?s:Math.min(s,i),l=t.slice(a,o);return Tr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},xr=e=>{const t=ca(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ne=(e,t,...a)=>(a.length&&(t=Ne(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),da=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,i)=>i.indexOf(n)===s)},wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?At(e,pa):e):e,ua=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const o=e.charCodeAt(i+t.length+1);if(o===61){const l=i+t.length+2,c=e.indexOf("&",l);return wt(e.slice(l,c===-1?void 0:c))}else if(o==38||isNaN(o))return"";i=e.indexOf(`&${t}`,i+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const i=e.indexOf("&",s+1);let o=e.indexOf("=",s);o>i&&i!==-1&&(o=-1);let l=e.slice(s+1,o===-1?i===-1?void 0:i:o);if(r&&(l=wt(l)),s=i,l==="")continue;let c;o===-1?c="":(c=e.slice(o+1,i===-1?void 0:i),r&&(c=wt(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},Sr=ua,kr=(e,t)=>ua(e,t,!0),pa=decodeURIComponent,Ft=e=>At(e,pa),je,X,he,ha,ga,kt,fe,aa,ma=(aa=class{constructor(e,t="/",a=[[]]){A(this,he);D(this,"raw");A(this,je);A(this,X);D(this,"routeIndex",0);D(this,"path");D(this,"bodyCache",{});A(this,fe,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,C(this,X,a),C(this,je,{})}param(e){return e?M(this,he,ha).call(this,e):M(this,he,ga).call(this)}query(e){return Sr(this.url,e)}queries(e){return kr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await hr(this,e))}json(){return b(this,fe).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,fe).call(this,"text")}arrayBuffer(){return b(this,fe).call(this,"arrayBuffer")}blob(){return b(this,fe).call(this,"blob")}formData(){return b(this,fe).call(this,"formData")}addValidatedData(e,t){b(this,je)[e]=t}valid(e){return b(this,je)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[mr](){return b(this,X)}get matchedRoutes(){return b(this,X)[0].map(([[,e]])=>e)}get routePath(){return b(this,X)[0].map(([[,e]])=>e)[this.routeIndex].path}},je=new WeakMap,X=new WeakMap,he=new WeakSet,ha=function(e){const t=b(this,X)[0][this.routeIndex][1][e],a=M(this,he,kt).call(this,t);return a&&/\%/.test(a)?Ft(a):a},ga=function(){const e={},t=Object.keys(b(this,X)[0][this.routeIndex][1]);for(const a of t){const r=M(this,he,kt).call(this,b(this,X)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ft(r):r)}return e},kt=function(e){return b(this,X)[1]?b(this,X)[1][e]:e},fe=new WeakMap,aa),Ir={Stringify:1},fa=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(o=>o({phase:t,buffer:n,context:r}))).then(o=>Promise.all(o.filter(Boolean).map(l=>fa(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},Dr="text/plain; charset=UTF-8",_t=(e,t)=>({"Content-Type":e,...t}),Xe,Qe,de,Be,ue,V,et,Pe,Ue,ke,tt,at,ye,$e,ra,Or=(ra=class{constructor(e,t){A(this,ye);A(this,Xe);A(this,Qe);D(this,"env",{});A(this,de);D(this,"finalized",!1);D(this,"error");A(this,Be);A(this,ue);A(this,V);A(this,et);A(this,Pe);A(this,Ue);A(this,ke);A(this,tt);A(this,at);D(this,"render",(...e)=>(b(this,Pe)??C(this,Pe,t=>this.html(t)),b(this,Pe).call(this,...e)));D(this,"setLayout",e=>C(this,et,e));D(this,"getLayout",()=>b(this,et));D(this,"setRenderer",e=>{C(this,Pe,e)});D(this,"header",(e,t,a)=>{this.finalized&&C(this,V,new Response(b(this,V).body,b(this,V)));const r=b(this,V)?b(this,V).headers:b(this,ke)??C(this,ke,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});D(this,"status",e=>{C(this,Be,e)});D(this,"set",(e,t)=>{b(this,de)??C(this,de,new Map),b(this,de).set(e,t)});D(this,"get",e=>b(this,de)?b(this,de).get(e):void 0);D(this,"newResponse",(...e)=>M(this,ye,$e).call(this,...e));D(this,"body",(e,t,a)=>M(this,ye,$e).call(this,e,t,a));D(this,"text",(e,t,a)=>!b(this,ke)&&!b(this,Be)&&!t&&!a&&!this.finalized?new Response(e):M(this,ye,$e).call(this,e,t,_t(Dr,a)));D(this,"json",(e,t,a)=>M(this,ye,$e).call(this,JSON.stringify(e),t,_t("application/json",a)));D(this,"html",(e,t,a)=>{const r=n=>M(this,ye,$e).call(this,n,t,_t("text/html; charset=UTF-8",a));return typeof e=="object"?fa(e,Ir.Stringify,!1,{}).then(r):r(e)});D(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});D(this,"notFound",()=>(b(this,Ue)??C(this,Ue,()=>new Response),b(this,Ue).call(this,this)));C(this,Xe,e),t&&(C(this,ue,t.executionCtx),this.env=t.env,C(this,Ue,t.notFoundHandler),C(this,at,t.path),C(this,tt,t.matchResult))}get req(){return b(this,Qe)??C(this,Qe,new ma(b(this,Xe),b(this,at),b(this,tt))),b(this,Qe)}get event(){if(b(this,ue)&&"respondWith"in b(this,ue))return b(this,ue);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,ue))return b(this,ue);throw Error("This context has no ExecutionContext")}get res(){return b(this,V)||C(this,V,new Response(null,{headers:b(this,ke)??C(this,ke,new Headers)}))}set res(e){if(b(this,V)&&e){e=new Response(e.body,e);for(const[t,a]of b(this,V).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=b(this,V).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}C(this,V,e),this.finalized=!0}get var(){return b(this,de)?Object.fromEntries(b(this,de)):{}}},Xe=new WeakMap,Qe=new WeakMap,de=new WeakMap,Be=new WeakMap,ue=new WeakMap,V=new WeakMap,et=new WeakMap,Pe=new WeakMap,Ue=new WeakMap,ke=new WeakMap,tt=new WeakMap,at=new WeakMap,ye=new WeakSet,$e=function(e,t,a){const r=b(this,V)?new Headers(b(this,V).headers):b(this,ke)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,o]of s)i.toLowerCase()==="set-cookie"?r.append(i,o):r.set(i,o)}if(a)for(const[s,i]of Object.entries(a))if(typeof i=="string")r.set(s,i);else{r.delete(s);for(const o of i)r.append(s,o)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,Be);return new Response(e,{status:n,headers:r})},ra),z="ALL",Cr="all",Rr=["get","post","put","delete","options","patch"],ya="Can not add a route since the matcher is already built.",va=class extends Error{},Ar="__COMPOSED_HANDLER",Lr=e=>e.text("404 Not Found",404),Wt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},Q,q,ba,ee,xe,ut,pt,He,Nr=(He=class{constructor(t={}){A(this,q);D(this,"get");D(this,"post");D(this,"put");D(this,"delete");D(this,"options");D(this,"patch");D(this,"all");D(this,"on");D(this,"use");D(this,"router");D(this,"getPath");D(this,"_basePath","/");A(this,Q,"/");D(this,"routes",[]);A(this,ee,Lr);D(this,"errorHandler",Wt);D(this,"onError",t=>(this.errorHandler=t,this));D(this,"notFound",t=>(C(this,ee,t),this));D(this,"fetch",(t,...a)=>M(this,q,pt).call(this,t,a[1],a[0],t.method));D(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ne("/",t)}`,a),r,n)));D(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(M(this,q,pt).call(this,t.request,t,void 0,t.request.method))})});[...Rr,Cr].forEach(s=>{this[s]=(i,...o)=>(typeof i=="string"?C(this,Q,i):M(this,q,xe).call(this,s,b(this,Q),i),o.forEach(l=>{M(this,q,xe).call(this,s,b(this,Q),l)}),this)}),this.on=(s,i,...o)=>{for(const l of[i].flat()){C(this,Q,l);for(const c of[s].flat())o.map(d=>{M(this,q,xe).call(this,c.toUpperCase(),b(this,Q),d)})}return this},this.use=(s,...i)=>(typeof s=="string"?C(this,Q,s):(C(this,Q,"*"),i.unshift(s)),i.forEach(o=>{M(this,q,xe).call(this,z,b(this,Q),o)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ca:xr}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var i;let s;a.errorHandler===Wt?s=n.handler:(s=async(o,l)=>(await Gt([],a.errorHandler)(o,()=>n.handler(o,l))).res,s[Ar]=n.handler),M(i=r,q,xe).call(i,n.method,n.path,s)}),this}basePath(t){const a=M(this,q,ba).call(this);return a._basePath=Ne(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const i=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ne(this._basePath,t),c=l==="/"?0:l.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const o=async(l,c)=>{const d=await a(n(l.req.raw),...i(l));if(d)return d;await c()};return M(this,q,xe).call(this,z,Ne(t,"*"),o),this}},Q=new WeakMap,q=new WeakSet,ba=function(){const t=new He({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,C(t,ee,b(this,ee)),t.routes=this.routes,t},ee=new WeakMap,xe=function(t,a,r){t=t.toUpperCase(),a=Ne(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},ut=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},pt=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await M(this,q,pt).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),i=this.router.match(n,s),o=new Or(t,{path:s,matchResult:i,env:r,executionCtx:a,notFoundHandler:b(this,ee)});if(i[0].length===1){let c;try{c=i[0][0][0][0](o,async()=>{o.res=await b(this,ee).call(this,o)})}catch(d){return M(this,q,ut).call(this,d,o)}return c instanceof Promise?c.then(d=>d||(o.finalized?o.res:b(this,ee).call(this,o))).catch(d=>M(this,q,ut).call(this,d,o)):c??b(this,ee).call(this,o)}const l=Gt(i[0],this.errorHandler,b(this,ee));return(async()=>{try{const c=await l(o);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return M(this,q,ut).call(this,c,o)}})()},He),wa=[];function $r(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const i=a[n]||a[z],o=i[2][s];if(o)return o;const l=s.match(i[0]);if(!l)return[[],wa];const c=l.indexOf("",1);return[i[1][c],l]});return this.match=r,r(e,t)}var ht="[^/]+",Ye=".*",Ve="(?:|/.*)",Me=Symbol(),Mr=new Set(".\\+*[^]$()");function jr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ye||e===Ve?1:t===Ye||t===Ve?-1:e===ht?1:t===ht?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ie,De,te,Re,Br=(Re=class{constructor(){A(this,Ie);A(this,De);A(this,te,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(b(this,Ie)!==void 0)throw Me;if(s)return;C(this,Ie,a);return}const[i,...o]=t,l=i==="*"?o.length===0?["","",Ye]:["","",ht]:i==="/*"?["","",Ve]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const d=l[1];let p=l[2]||ht;if(d&&l[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Me;if(c=b(this,te)[p],!c){if(Object.keys(b(this,te)).some(g=>g!==Ye&&g!==Ve))throw Me;if(s)return;c=b(this,te)[p]=new Re,d!==""&&C(c,De,n.varIndex++)}!s&&d!==""&&r.push([d,b(c,De)])}else if(c=b(this,te)[i],!c){if(Object.keys(b(this,te)).some(d=>d.length>1&&d!==Ye&&d!==Ve))throw Me;if(s)return;c=b(this,te)[i]=new Re}c.insert(o,a,r,n,s)}buildRegExpStr(){const a=Object.keys(b(this,te)).sort(jr).map(r=>{const n=b(this,te)[r];return(typeof b(n,De)=="number"?`(${r})@${b(n,De)}`:Mr.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof b(this,Ie)=="number"&&a.unshift(`#${b(this,Ie)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},Ie=new WeakMap,De=new WeakMap,te=new WeakMap,Re),gt,rt,na,Pr=(na=class{constructor(){A(this,gt,{varIndex:0});A(this,rt,new Br)}insert(e,t,a){const r=[],n=[];for(let i=0;;){let o=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${i}`;return n[i]=[c,l],i++,o=!0,c}),!o)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[o]=n[i];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(o)!==-1){s[l]=s[l].replace(o,n[i][1]);break}}return b(this,rt).insert(s,t,r,b(this,gt),a),r}buildRegExp(){let e=b(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,i)=>s!==void 0?(a[++t]=Number(s),"$()"):(i!==void 0&&(r[Number(i)]=++t),"")),[new RegExp(`^${e}`),a,r]}},gt=new WeakMap,rt=new WeakMap,na),Ur=[/^$/,[],Object.create(null)],mt=Object.create(null);function _a(e){return mt[e]??(mt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Hr(){mt=Object.create(null)}function Gr(e){var c;const t=new Pr,a=[];if(e.length===0)return Ur;const r=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[g,v])=>d?1:g?-1:p.length-v.length),n=Object.create(null);for(let d=0,p=-1,g=r.length;d<g;d++){const[v,y,T]=r[d];v?n[y]=[T.map(([x])=>[x,Object.create(null)]),wa]:p++;let _;try{_=t.insert(y,p,v)}catch(x){throw x===Me?new va(y):x}v||(a[p]=T.map(([x,u])=>{const h=Object.create(null);for(u-=1;u>=0;u--){const[m,f]=_[u];h[m]=f}return[x,h]}))}const[s,i,o]=t.buildRegExp();for(let d=0,p=a.length;d<p;d++)for(let g=0,v=a[d].length;g<v;g++){const y=(c=a[d][g])==null?void 0:c[1];if(!y)continue;const T=Object.keys(y);for(let _=0,x=T.length;_<x;_++)y[T[_]]=o[y[T[_]]]}const l=[];for(const d in i)l[d]=a[i[d]];return[s,l,n]}function Ae(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(_a(a).test(t))return[...e[a]]}}var ve,be,ft,Ea,sa,Fr=(sa=class{constructor(){A(this,ft);D(this,"name","RegExpRouter");A(this,ve);A(this,be);D(this,"match",$r);C(this,ve,{[z]:Object.create(null)}),C(this,be,{[z]:Object.create(null)})}add(e,t,a){var o;const r=b(this,ve),n=b(this,be);if(!r||!n)throw new Error(ya);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[z]).forEach(c=>{l[e][c]=[...l[z][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=_a(t);e===z?Object.keys(r).forEach(c=>{var d;(d=r[c])[t]||(d[t]=Ae(r[c],t)||Ae(r[z],t)||[])}):(o=r[e])[t]||(o[t]=Ae(r[e],t)||Ae(r[z],t)||[]),Object.keys(r).forEach(c=>{(e===z||e===c)&&Object.keys(r[c]).forEach(d=>{l.test(d)&&r[c][d].push([a,s])})}),Object.keys(n).forEach(c=>{(e===z||e===c)&&Object.keys(n[c]).forEach(d=>l.test(d)&&n[c][d].push([a,s]))});return}const i=da(t)||[t];for(let l=0,c=i.length;l<c;l++){const d=i[l];Object.keys(n).forEach(p=>{var g;(e===z||e===p)&&((g=n[p])[d]||(g[d]=[...Ae(r[p],d)||Ae(r[z],d)||[]]),n[p][d].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,be)).concat(Object.keys(b(this,ve))).forEach(t=>{e[t]||(e[t]=M(this,ft,Ea).call(this,t))}),C(this,ve,C(this,be,void 0)),Hr(),e}},ve=new WeakMap,be=new WeakMap,ft=new WeakSet,Ea=function(e){const t=[];let a=e===z;return[b(this,ve),b(this,be)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==z&&t.push(...Object.keys(r[z]).map(s=>[s,r[z][s]]))}),a?Gr(t):null},sa),we,pe,ia,Wr=(ia=class{constructor(e){D(this,"name","SmartRouter");A(this,we,[]);A(this,pe,[]);C(this,we,e.routers)}add(e,t,a){if(!b(this,pe))throw new Error(ya);b(this,pe).push([e,t,a])}match(e,t){if(!b(this,pe))throw new Error("Fatal error");const a=b(this,we),r=b(this,pe),n=a.length;let s=0,i;for(;s<n;s++){const o=a[s];try{for(let l=0,c=r.length;l<c;l++)o.add(...r[l]);i=o.match(e,t)}catch(l){if(l instanceof va)continue;throw l}this.match=o.match.bind(o),C(this,we,[o]),C(this,pe,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(b(this,pe)||b(this,we).length!==1)throw new Error("No active router has been determined yet.");return b(this,we)[0]}},we=new WeakMap,pe=new WeakMap,ia),ze=Object.create(null),_e,Y,Oe,Ge,J,me,Se,Fe,zr=(Fe=class{constructor(t,a,r){A(this,me);A(this,_e);A(this,Y);A(this,Oe);A(this,Ge,0);A(this,J,ze);if(C(this,Y,r||Object.create(null)),C(this,_e,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},C(this,_e,[n])}C(this,Oe,[])}insert(t,a,r){C(this,Ge,++Ht(this,Ge)._);let n=this;const s=br(a),i=[];for(let o=0,l=s.length;o<l;o++){const c=s[o],d=s[o+1],p=Er(c,d),g=Array.isArray(p)?p[0]:c;if(g in b(n,Y)){n=b(n,Y)[g],p&&i.push(p[1]);continue}b(n,Y)[g]=new Fe,p&&(b(n,Oe).push(p),i.push(p[1])),n=b(n,Y)[g]}return b(n,_e).push({[t]:{handler:r,possibleKeys:i.filter((o,l,c)=>c.indexOf(o)===l),score:b(this,Ge)}}),n}search(t,a){var l;const r=[];C(this,J,ze);let s=[this];const i=la(a),o=[];for(let c=0,d=i.length;c<d;c++){const p=i[c],g=c===d-1,v=[];for(let y=0,T=s.length;y<T;y++){const _=s[y],x=b(_,Y)[p];x&&(C(x,J,b(_,J)),g?(b(x,Y)["*"]&&r.push(...M(this,me,Se).call(this,b(x,Y)["*"],t,b(_,J))),r.push(...M(this,me,Se).call(this,x,t,b(_,J)))):v.push(x));for(let u=0,h=b(_,Oe).length;u<h;u++){const m=b(_,Oe)[u],f=b(_,J)===ze?{}:{...b(_,J)};if(m==="*"){const O=b(_,Y)["*"];O&&(r.push(...M(this,me,Se).call(this,O,t,b(_,J))),C(O,J,f),v.push(O));continue}const[w,E,S]=m;if(!p&&!(S instanceof RegExp))continue;const k=b(_,Y)[w],I=i.slice(c).join("/");if(S instanceof RegExp){const O=S.exec(I);if(O){if(f[E]=O[0],r.push(...M(this,me,Se).call(this,k,t,b(_,J),f)),Object.keys(b(k,Y)).length){C(k,J,f);const R=((l=O[0].match(/\//))==null?void 0:l.length)??0;(o[R]||(o[R]=[])).push(k)}continue}}(S===!0||S.test(p))&&(f[E]=p,g?(r.push(...M(this,me,Se).call(this,k,t,f,b(_,J))),b(k,Y)["*"]&&r.push(...M(this,me,Se).call(this,b(k,Y)["*"],t,f,b(_,J)))):(C(k,J,f),v.push(k)))}}s=v.concat(o.shift()??[])}return r.length>1&&r.sort((c,d)=>c.score-d.score),[r.map(({handler:c,params:d})=>[c,d])]}},_e=new WeakMap,Y=new WeakMap,Oe=new WeakMap,Ge=new WeakMap,J=new WeakMap,me=new WeakSet,Se=function(t,a,r,n){const s=[];for(let i=0,o=b(t,_e).length;i<o;i++){const l=b(t,_e)[i],c=l[a]||l[z],d={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==ze||n&&n!==ze))for(let p=0,g=c.possibleKeys.length;p<g;p++){const v=c.possibleKeys[p],y=d[c.score];c.params[v]=n!=null&&n[v]&&!y?n[v]:r[v]??(n==null?void 0:n[v]),d[c.score]=!0}}return s},Fe),Ce,oa,qr=(oa=class{constructor(){D(this,"name","TrieRouter");A(this,Ce);C(this,Ce,new zr)}add(e,t,a){const r=da(t);if(r){for(let n=0,s=r.length;n<s;n++)b(this,Ce).insert(e,r[n],a);return}b(this,Ce).insert(e,t,a)}match(e,t){return b(this,Ce).search(e,t)}},Ce=new WeakMap,oa),Ee=class extends Nr{constructor(e={}){super(e),this.router=e.router??new Wr({routers:[new Fr,new qr]})}},Kr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:i=>s===i?i:null:typeof s=="function"?s:i=>s.includes(i)?i:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(i,o){var d;function l(p,g){i.res.headers.set(p,g)}const c=await r(i.req.header("origin")||"",i);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(d=a.exposeHeaders)!=null&&d.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),i.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const p=await n(i.req.header("origin")||"",i);p.length&&l("Access-Control-Allow-Methods",p.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=i.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await o(),a.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Ta(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`),t.trim()}async function Va(e,t,a={}){const r=a.maxPages||(a.depth==="thorough"?5:3),n=a.maxResults||(a.depth==="thorough"?8:5),s=await vt(e,{num:n,site:a.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const o=s.results.slice(0,r).map(async g=>{const v=await Ya(g.link);return{title:g.title,url:g.link,displayLink:g.displayLink,snippet:g.snippet,content:v.text,error:v.error}}),c=(await Promise.all(o)).filter(g=>g.content.length>50);if(c.length===0){const g=s.results.map((y,T)=>`[${T+1}] ${y.title}
${y.snippet}
Source: ${y.link}`).join(`
...
${r}
`:"",o=Yt(t,bn);return`You are ${n} — a personal AI assistant. You are intelligent, direct, and genuinely helpful. You speak with clarity and warmth, never robotic. Your name is ${n} — always refer to yourself by this name if asked.
...
- **No narration**: Every action must be an actual tool call. Never say "Now let me..." or "I'll now..." — just call the tool.`:""}`}async function Vt(e,t,a){var c;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${a.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((c=n.files)==null?void 0:c.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:a,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:a}}function tr(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function ar(e,t,a,r,n,s,i,o,l,c,d,p){const g=Date.now();let v=!0,y="",T="";try{return T=await wn(e,t,a,r,s,i,o,l,c,d,p),T}catch(_){throw v=!1,y=_.message||"Unknown error",_}finally{const _=Date.now()-g;try{await a.prepare(`INSERT INTO tool_execution_log (user_id, agent_type, provider_name, tool_name, tool_args, tool_result, success, error_message, latency_ms, was_enforcement_retry, channel)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).bind(r,n.agentType||null,n.providerName||null,e,JSON.stringify(t).substring(0,2e3),(v?T:"").substring(0,500),v?1:0,y||null,_,n.isEnforcementRetry?1:0,n.channel||"web").run()}catch{}}}async function wn(e,t,a,r,n,s,i,o,l,c,d){var g,v,y,T,_,x;const p=new ae(a);switch(e){case"create_schedule":{const u=new Date;let h;const m=c||"UTC";if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){h=new Date(u.getTime()+t.minutes_from_now*60*1e3);const S=h.toLocaleString("en-US",{timeZone:m,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[k,I,O]=(S[0]||"").split("/");t.schedule_value=`${O}-${k}-${I} ${S[1]||"00:00"}`,t.schedule_type="once"}else if(t.schedule_type==="interval"){const E=parseInt(t.schedule_value,10);h=new Date(u.getTime()+E*60*1e3)}else if(t.schedule_type==="daily"){const[E,S]=t.schedule_value.split(":").map(Number),k=u.toLocaleString("en-US",{timeZone:m}),I=new Date(k),O=new Date(I);O.setHours(E,S,0,0),O<=I&&O.setDate(O.getDate()+1);const R=new Date(O.toLocaleString("en-US",{timeZone:"UTC"})),N=new Date(O.toLocaleString("en-US",{timeZone:m})),$=R.getTime()-N.getTime();h=new Date(O.getTime()+$)}else if(t.schedule_type==="weekly"){const[E,S]=t.schedule_value.split(" "),[k,I]=(S||"00:00").split(":").map(Number),R=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(ne=>ne.toLowerCase()===E.toLowerCase()),N=u.toLocaleString("en-US",{timeZone:m}),$=new Date(N),j=new Date($);j.setHours(k,I,0,0);let B=(R-j.getDay()+7)%7;B===0&&j<=$&&(B=7),j.setDate(j.getDate()+B);const K=new Date(j.toLocaleString("en-US",{timeZone:"UTC"})),U=new Date(j.toLocaleString("en-US",{timeZone:m})),W=K.getTime()-U.getTime();h=new Date(j.getTime()+W)}else if(t.schedule_type==="once"){const[E,S]=t.schedule_value.split(" "),[k,I,O]=E.split("-").map(Number),[R,N]=(S||"00:00").split(":").map(Number),$=u.toLocaleString("en-US",{timeZone:m}),j=new Date($),B=new Date(j);B.setFullYear(k,I-1,O),B.setHours(R,N,0,0);const K=new Date(B.toLocaleString("en-US",{timeZone:"UTC"})),U=new Date(B.toLocaleString("en-US",{timeZone:m})),W=K.getTime()-U.getTime();h=new Date(B.getTime()+W);const ne=new Date(u.getTime()+120*1e3);if(h.getTime()<u.getTime()+60*1e3){const oe=h.toISOString();h=ne;const it=` [Note: The requested time ${t.schedule_value} in ${m} resolved to ${oe} UTC which is in the past. Auto-adjusted to fire in ~2 minutes at ${h.toISOString()}.]`;t._pastTimeWarning=it}}else h=new Date(u.getTime()+3600*1e3);await a.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')`).bind(r,t.name,t.description||t.action_description||"",t.schedule_type,t.schedule_value,t.action_type,JSON.stringify({description:t.action_description||t.description||""}),h.toISOString()).run();const f=t._pastTimeWarning||"",w=h.toLocaleString("en-US",{timeZone:m,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});return`Schedule created: "${t.name}" — ${t.schedule_type}. Will fire at ${w} (${m}). [UTC: ${h.toISOString()}]${f}. IMPORTANT: Use the exact time "${w}" when confirming to the user — do NOT calculate or guess the time yourself.`}case"list_schedules":{const h=(await a.prepare("SELECT * FROM cron_jobs WHERE user_id = ? ORDER BY enabled DESC, next_run ASC").bind(r).all()).results||[];return h.length===0?"No scheduled tasks found.":h.map(m=>`[ID:${m.id}] ${m.enabled?"▶":"⏸"} "${m.name}" — [${m.schedule_type}] ${m.schedule_value} — ${m.action_type} — state: ${m.state||"active"} — next: ${m.next_run||"N/A"}`).join(`
`)}case"toggle_schedule":{const u=t.enabled?1:0,h=u?"active":"paused";return await a.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(u,h,t.job_id,r).run(),`Schedule ${t.job_id} ${u?"enabled (active)":"paused"}.`}case"update_schedule_state":{const u=["created","active","reminding","paused","completed"],h=t.state;if(!u.includes(h))return`Invalid state "${h}". Valid states: ${u.join(", ")}`;const m=h==="completed"||h==="paused"?0:1;return await a.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(h,m,t.job_id,r).run(),`Schedule ${t.job_id} state updated to "${h}".`}case"update_schedule":{const u=t.job_id,h=c||"UTC",m=new Date,f=["updated_at = CURRENT_TIMESTAMP"],w=[];t.name&&(f.push("name = ?"),w.push(t.name)),t.description&&(f.push("description = ?"),w.push(t.description));let E=null,S=t.schedule_type,k=t.schedule_value;if(t.minutes_from_now&&typeof t.minutes_from_now=="number"&&t.minutes_from_now>0){E=new Date(m.getTime()+t.minutes_from_now*60*1e3);const R=E.toLocaleString("en-US",{timeZone:h,hour12:!1,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"}).split(", "),[N,$,j]=(R[0]||"").split("/");k=`${j}-${N}-${$} ${R[1]||"00:00"}`,S="once"}else if(S&&k){if(S==="interval")E=new Date(m.getTime()+parseInt(k,10)*60*1e3);else if(S==="daily"){const[O,R]=k.split(":").map(Number),N=new Date(m.toLocaleString("en-US",{timeZone:h})),$=new Date(N);$.setHours(O,R,0,0),$<=N&&$.setDate($.getDate()+1);const j=new Date($.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date($.toLocaleString("en-US",{timeZone:h})).getTime();E=new Date($.getTime()+j)}else if(S==="weekly"){const[O,R]=k.split(" "),[N,$]=(R||"00:00").split(":").map(Number),B=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(oe=>oe.toLowerCase()===O.toLowerCase()),K=new Date(m.toLocaleString("en-US",{timeZone:h})),U=new Date(K);U.setHours(N,$,0,0);let W=(B-U.getDay()+7)%7;W===0&&U<=K&&(W=7),U.setDate(U.getDate()+W);const ne=new Date(U.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(U.toLocaleString("en-US",{timeZone:h})).getTime();E=new Date(U.getTime()+ne)}else if(S==="once"){const[O,R]=k.split(" "),[N,$,j]=O.split("-").map(Number),[B,K]=(R||"00:00").split(":").map(Number),U=new Date(m.toLocaleString("en-US",{timeZone:h})),W=new Date(U);W.setFullYear(N,$-1,j),W.setHours(B,K,0,0);const ne=new Date(W.toLocaleString("en-US",{timeZone:"UTC"})).getTime()-new Date(W.toLocaleString("en-US",{timeZone:h})).getTime();E=new Date(W.getTime()+ne),E.getTime()<m.getTime()+60*1e3&&(E=new Date(m.getTime()+120*1e3))}}if(S&&(f.push("schedule_type = ?"),w.push(S)),k&&(f.push("schedule_value = ?"),w.push(k)),E&&(f.push("next_run = ?"),w.push(E.toISOString())),f.length===1)return"No changes provided. Specify name, description, or schedule fields to update.";w.push(u,r),await a.prepare(`UPDATE cron_jobs SET ${f.join(", ")} WHERE id = ? AND user_id = ?`).bind(...w).run();const I=E?E.toLocaleString("en-US",{timeZone:h,weekday:"short",year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0}):null;return`Schedule ${u} updated.${I?` New fire time: ${I} (${h}).`:""} IMPORTANT: Use this exact time "${I}" when confirming to the user.`}case"delete_schedule":return await a.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,r).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const u=t.importance||5,h=t.type==="task"?"preference":t.type,m=u>=7?"working":"long_term";return await p.store(r,h,t.title,t.content,u,m),`Stored in ${m==="working"?"working":"long-term"} memory: [${h}] ${t.title} (importance: ${u})`}case"search_memory":{const u=await p.search(r,t.query);return u.length===0?"No matching memories found.":u.map(h=>`[${h.tier||"long_term"}] [${h.type}] **${h.title}**: ${h.content}`).join(`
`)}case"get_system_status":{const u=await a.prepare("SELECT COUNT(*) as cnt FROM cron_jobs WHERE user_id = ? AND enabled = 1").bind(r).first(),h=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ?").bind(r).first(),m=await a.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(r).first(),f=await a.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(r).first(),w=await a.prepare("SELECT COUNT(*) as cnt FROM error_log WHERE (user_id = ? OR user_id IS NULL) AND acknowledged = 0").bind(r).first();return`System Status:
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.spreadsheet_id;let m=t.range;const f=await u.sheets.getMetadata(h),w=f.sheets;m.includes("!")||(m=`${w[0]}!${m}`);let E;try{E=await u.sheets.readRange(h,m)}catch(k){if((g=k.message)!=null&&g.includes("Unable to parse range")||(v=k.message)!=null&&v.includes("400")){const I=m.includes("!")?m.split("!")[1]:m;m=`${w[0]}!${I}`,E=await u.sheets.readRange(h,m)}else throw k}let S=`[Spreadsheet: "${f.title}" | Reading tab: "${m.split("!")[0]}" | All tabs in this spreadsheet: ${w.map(k=>`"${k}"`).join(", ")}]
`;return w.length>1&&(S+=`[To read a different tab, call read_sheet again with range like "${w[1]}!A1:Z500"]
`),E.length===0?S+"No data found in the specified range.":S+E.map(k=>k.join("	| ")).join(`
`)}catch(u){return await L(a,r,"google","read_sheet",u.message),`Failed to read sheet: ${u.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.values;let m=t.range;const E=Math.max(...h.map(O=>O.length))+4,S=h.map(O=>{const R=[...O];for(;R.length<E;)R.push("");return R}),k=m.match(/^(.+!)?([A-Z]+)(\d+):([A-Z]+)(\d+)$/i);if(k){const O=k[1]||"",R=k[2],N=k[3],$=k[5],B=R.toUpperCase().charCodeAt(0)-64+E-1,K=B<=26?String.fromCharCode(64+B):"Z";m=`${O}${R}${N}:${K}${$}`}return`Written ${(await u.sheets.writeRange(t.spreadsheet_id,m,S)).updatedCells} cells to ${m}.`}catch(u){return await L(a,r,"google","write_sheet",u.message),`Failed to write sheet: ${u.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new se(a,r,n,s||"",i||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(u){return await L(a,r,"google","append_sheet",u.message),`Failed to append to sheet: ${u.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.sheets.createSpreadsheet(t.title,t.sheet_names);let f="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||"");f=`
Folder: "${(await Vt(w,m.spreadsheetId,t.folder_name)).folderName}"`}catch(w){f=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ae(a).store(r,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${m.spreadsheetId} | URL: ${m.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${f}
ID: ${m.spreadsheetId}
URL: ${m.url}`}catch(u){return await L(a,r,"google","create_sheet",u.message),`Failed to create spreadsheet: ${u.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.calendar_id||"primary",m=t.days_ahead||7,f=new Date,w=new Date(f.getTime()+m*24*60*60*1e3),E=await u.calendar.listEvents(h,{timeMin:f.toISOString(),timeMax:w.toISOString(),query:t.query});return E.length===0?`No events found in the next ${m} days.`:E.map(S=>{var N;const k=S.start.dateTime||S.start.date||"TBD",I=S.end.dateTime||S.end.date||"",O=S.location?` 📍 ${S.location}`:"",R=((N=S.attendees)==null?void 0:N.map($=>$.email).join(", "))||"";return`• ${S.summary} — ${k} to ${I}${O}${R?`
  Attendees: ${R}`:""}`}).join(`
`)}catch(u){return await L(a,r,"google","list_calendar",u.message),`Failed to list events: ${u.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||""),h=t.calendar_id||"primary",m=await u.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${m.summary}"
ID: ${m.id}
Start: ${m.start.dateTime||m.start.date}`}catch(u){return await L(a,r,"google","create_event",u.message),`Failed to create event: ${u.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const m=await u.docs.createDocument(t.title);t.content&&await u.docs.appendText(m.documentId,t.content);let f="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||"");f=`
Folder: "${(await Vt(w,m.documentId,t.folder_name)).folderName}"`}catch(w){f=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ae(a).store(r,"context",`Document: ${t.title}`,`Document ID: ${m.documentId} | URL: ${m.url}`,6,"working")}catch{}return`Document created: "${t.title}"${f}
ID: ${m.documentId}
URL: ${m.url}`}catch(u){return await L(a,r,"google","create_doc",u.message),`Failed to create document: ${u.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const h=await new se(a,r,n,s||"",i||"").docs.readDocument(t.document_id);return`Document: "${h.title}"

${h.content}`}catch(u){return await L(a,r,"google","read_doc",u.message),`Failed to read document: ${u.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const u=new se(a,r,n,s||"",i||"");if(!(await u.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await u.docs.appendText(t.document_id,t.content);let m=t.document_id;try{m=(await u.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${m}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(u){return await L(a,r,"google","append_to_doc",u.message),`Failed to append to document: ${u.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((m,f)=>`${m.isUnread?"● ":"  "}${f+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await L(a,r,"gmail","list",u.message),(y=u.message)!=null&&y.includes("not connected")?u.message:`Gmail list error: ${u.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const u=new ce(a,r,n,s||"",i||""),h=await u.getMessage(t.message_id);if(!h)return"Message not found.";const m=await u.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${m}`}catch(u){return await L(a,r,"gmail","read",u.message),`Gmail read error: ${u.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((m,f)=>`${m.isUnread?"● ":"  "}${f+1}. **${m.subject}**
   From: ${m.from}
   Date: ${m.date}
   ${m.snippet}
   [id: ${m.id}]`).join(`

`)}catch(u){return await L(a,r,"gmail","search",u.message),`Gmail search error: ${u.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(u){return await L(a,r,"gmail","send",u.message),`Gmail send error: ${u.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").createDraft(t.to,t.subject,t.body,{cc:t.cc}),m=t.cc?`, CC: ${t.cc}`:"";return`Draft created. To: ${t.to}${m}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(u){return await L(a,r,"gmail","draft",u.message),`Gmail draft error: ${u.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new ce(a,r,n,s||"",i||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(u){return await L(a,r,"gmail","modify",u.message),`Gmail modify error: ${u.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new ce(a,r,n,s||"",i||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(u){return(T=u.message)!=null&&T.includes("not connected")?u.message:`Gmail error: ${u.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let m="";t.folder_id?m=`'${t.folder_id}' in parents and trashed = false`:t.query?m=`${t.query} and trashed = false`:m="trashed = false",h.set("q",m);const f=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const w=await f.json();return(_=w.files)!=null&&_.length?w.files.map((E,S)=>{var R,N;const k=((R=E.mimeType)==null?void 0:R.split(".").pop())||E.mimeType,I=E.size?`${(parseInt(E.size)/1024).toFixed(1)} KB`:"",O=((N=E.modifiedTime)==null?void 0:N.split("T")[0])||"";return`${S+1}. **${E.name}** (${k})
   ${I} · Modified: ${O}
   ${E.webViewLink||""}`}).join(`

`):"No files found."}catch(u){return await L(a,r,"google","drive_list",u.message),`Drive list error: ${u.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:u}=await(await Promise.resolve().then(()=>dt)).getGoogleAuth(a,r,n,s||"",i||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,m=new URLSearchParams;m.set("q",h),m.set("pageSize",String(t.max_results||10)),m.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),m.set("orderBy","modifiedTime desc");const f=await fetch(`https://www.googleapis.com/drive/v3/files?${m}`,{headers:{Authorization:`Bearer ${u}`}});if(!f.ok)throw new Error(`Drive API error (${f.status})`);const w=await f.json();return(x=w.files)!=null&&x.length?w.files.map((E,S)=>{var O,R;const k=((O=E.mimeType)==null?void 0:O.split(".").pop())||E.mimeType,I=((R=E.modifiedTime)==null?void 0:R.split("T")[0])||"";return`${S+1}. **${E.name}** (${k}) — Modified: ${I}
   ${E.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(u){return await L(a,r,"google","drive_search",u.message),`Drive search error: ${u.message}`}}case"web_search":try{const u=await vt(t.query,{num:t.num_results||5,site:t.site});return u.error?`Web search failed: ${u.error}. Answer this question directly from your training knowledge and clearly state you are doing so.`:u.results.length===0?`Web search returned no results for "${t.query}". Answer this question directly from your training knowledge and clearly state you are doing so instead of searching.`:u.results.map((h,m)=>`${m+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(u){return await L(a,r,"search","web_search",u.message),`Web search error: ${u.message}`}case"read_url":try{const u=t.url;if(!u||!u.startsWith("http://")&&!u.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:m}=await Promise.resolve().then(()=>gn),f=await m(u,h);return f.error?`Failed to read page: ${f.error}`:!f.text||f.text.length<20?`Page at ${u} returned no readable content.`:`Content from ${u} (${f.text.length} chars):

${f.text}`}catch(u){return await L(a,r,"search","read_url",u.message),`Read URL error: ${u.message}`}case"research":{if(!d)return"Research tool requires an LLM provider but none is available.";try{const h=Va(t.query,d,{depth:t.depth||"quick",site:t.site}),m=new Promise(E=>setTimeout(()=>E(null),45e3)),f=await Promise.race([h,m]);if(f===null){const{webSearch:E}=await Promise.resolve().then(()=>dn),S=await E(t.query,{num:5});if(S.error||S.results.length===0)return"Research timed out and fallback search returned no results. Try rephrasing or asking a more specific question.";let k=`Research took too long, but here are the top search results:

`;return k+=S.results.map((I,O)=>`${O+1}. **${I.title}**
   ${I.snippet}
   ${I.link}`).join(`

`),k}if(f.error)return`Research failed: ${f.error}`;let w=f.report;return f.sources.length>0&&(w+=`

---
**Sources** (`+f.pagesRead+` pages read):
`,w+=f.sources.map((E,S)=>`[${S+1}] ${E.title}
    ${E.url}`).join(`
`)),w}catch(u){return await L(a,r,"research","research",u.message),`Research error: ${u.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await F(u.encrypted_value,n),m=await Ha(h,t.query,{type:t.type});return m.error?`Places search failed: ${m.error}`:m.results.length===0?`No places found for "${t.query}".`:m.results.map((f,w)=>{const E=f.rating?` ★${f.rating} (${f.userRatingsTotal||0} reviews)`:"",S=f.openNow!==void 0?f.openNow?" · Open now":" · Closed":"",k=f.googleMapsUri?`
   ${f.googleMapsUri}`:"";return`${w+1}. **${f.name}**${E}${S}
   ${f.address}${k}
   [place_id: ${f.placeId}]`}).join(`

`)}catch(u){return await L(a,r,"google_api","search_places",u.message),`Places search error: ${u.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Ga(h,t.place_id);if(m.error)return`Details lookup failed: ${m.error}`;if(!m.details)return"No details found.";const f=m.details;let w=`**${f.name}**
...
Recent Reviews:`;for(const E of f.reviews)w+=`
— ${E.author} (★${E.rating}, ${E.time}): "${E.text}"`}return w}catch(u){return await L(a,r,"google_api","place_details",u.message),`Place details error: ${u.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Fa(h,t.origin,t.destination,{mode:t.mode||"driving"});if(m.error)return`Directions failed: ${m.error}`;if(!m.route)return"No route found.";const f=m.route;let w=`**${f.startAddress}** → **${f.endAddress}**
`;return w+=`📏 ${f.distance} · ⏱️ ${f.duration}`,f.durationInTraffic&&(w+=` (with traffic: ${f.durationInTraffic})`),w+=`
via ${f.summary}`,w+=`

Steps:`,f.steps.forEach((E,S)=>{w+=`
${S+1}. ${E.instruction} (${E.distance}, ${E.duration})`}),w}catch(u){return await L(a,r,"google_api","directions",u.message),`Directions error: ${u.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Ka(h,t.origin,t.destination,t.mode||"driving");if(m.error)return`Travel time lookup failed: ${m.error}`;let f=`${t.origin} → ${t.destination}: ${m.distance}, ${m.duration}`;return m.durationInTraffic&&(f+=` (with traffic: ${m.durationInTraffic})`),f}catch(u){return await L(a,r,"google_api","travel_time",u.message),`Travel time error: ${u.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await Wa(h,t.text,t.target_language,t.source_language);return m.error?`Translation failed: ${m.error}`:`[${m.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${m.translatedText}`}catch(u){return await L(a,r,"google_api","translate",u.message),`Translation error: ${u.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await qa(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return m.error?`YouTube search failed: ${m.error}`:m.results.length===0?`No YouTube results for "${t.query}".`:m.results.map((f,w)=>{var E;return`${w+1}. **${f.title}**
   ${f.channelTitle} · ${((E=f.publishedAt)==null?void 0:E.split("T")[0])||""}
   ${f.description}
   ${f.url}`}).join(`

`)}catch(u){return await L(a,r,"google_api","youtube_search",u.message),`YouTube search error: ${u.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const u=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r,"google_api_key").first();if(!u)return"Google API Key not configured.";const h=await F(u.encrypted_value,n),m=await za(h,t.address);return m.error?`Geocoding failed: ${m.error}`:m.results.length===0?`Location not found: "${t.address}"`:m.results.map((f,w)=>`${w+1}. ${f.address}
   Coordinates: ${f.lat}, ${f.lng}`).join(`
`)}catch(u){return await L(a,r,"google_api","geocode",u.message),`Geocoding error: ${u.message}`}}default:return`Unknown tool: ${e}`}}async function rr(e,t,a,r,n){if(t.length>0&&t[t.length-1].role==="user"){const s="(Previous request did not complete. Please try again.)";await e.storeMessage(a,r,"assistant",s,"{}",n),t.push({id:-1,user_id:a,channel:r,role:"assistant",content:s,metadata:"{}",token_estimate:s.length,created_at:new Date().toISOString()})}}function nr(e){for(let t=e.length-1;t>=0;t--)if(e[t].role==="assistant"){const a=typeof e[t].content=="string"?e[t].content:"";a.length<300&&/^(now let me|let me |i'll |i will |i'm going to|let's |to do this)/i.test(a.trim())&&(e[t]={...e[t],content:"(My previous response was cut off before completing. Starting fresh.)"});break}}async function _n(e,t,a,r,n,s,i){var w;const o=new ae(t),l=(w=e.metadata)==null?void 0:w.thread_id,c=Date.now(),[d,p]=await Promise.all([o.buildContext(r.id),Bt(t,r.id)]),g=await o.getRecentConversations(r.id,25,l);await rr(o,g,r.id,e.channel,l);const v=er(r,d,e.channel,p),y=Qa([{role:"system",content:v},...g.map(E=>({role:E.role,content:E.content})),{role:"user",content:e.text}]);nr(y),await o.storeMessage(r.id,e.channel,"user",e.text,"{}",l);const T=(i==null?void 0:i.maxTurns)??10,_=(i==null?void 0:i.tools)??jt;let x="",u=0;const h=[];for(let E=0;E<T;E++)try{const S=await a.chat(y,{tools:_});if(S.usage&&(u+=S.usage.promptTokens+S.usage.completionTokens),S.toolCalls&&S.toolCalls.length>0){S.content&&y.push({role:"assistant",content:S.content});for(const k of S.toolCalls){h.push(k.name);try{const I=await ar(k.name,k.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);y.push({role:"user",content:`[Tool Result for ${k.name}]: ${I}`})}catch(I){await L(t,r.id,"tool",k.name,I.message||"Tool execution failed"),y.push({role:"user",content:`[Tool Error for ${k.name}]: ${I.message||"Execution failed"}`})}}continue}x=S.content;break}catch(S){if(n){const k=S.message||"",I=k.includes("401")||k.includes("403")||k.includes("authentication")||k.includes("credit balance"),O=k.includes("429"),R=I?1440:O?10:5;await n.recordError(a.name,k,R)}throw await L(t,r.id,"llm","provider_error",S.message||"Unknown LLM error",{provider:a.name,turn:E}),S}if(!x)try{y.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),x=(await a.chat(y,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me directly and I will answer from my knowledge."}catch{x="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge."}if(n&&u>0)try{await n.recordUsage(a.name,u)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",u,Date.now()-c,1,e.channel).run()}catch{}const m=x.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),f=h.length>0?`[TOOLS_USED: ${[...new Set(h)].join(", ")}] `:"";return await o.storeMessage(r.id,e.channel,"assistant",f+m,"{}",l),await o.compactHistory(r.id,30),m}const Zt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function En(e){for(const[t,a]of Object.entries(Zt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return Zt.default}function Tn(e,t,a,r){const n=En(r),s=Math.floor(n*.75),i=[];let o=0,l=!1;const c=St(e);i.push({role:"system",content:e}),o+=c;const d=St(a);o+=d;const p=s-o,g=[];let v=0;for(let y=t.length-1;y>=0;y--){const T=t[y],_=St(T.content);if(v+_<=p)g.unshift({role:T.role,content:T.content}),v+=_;else{l=!0;break}}return i.push(...g),i.push({role:"user",content:a}),o+=v,{maxTokens:n,usedTokens:o,messages:i,wasTruncated:l}}async function*xn(e,t,a,r,n,s){var u;const i=new ae(t),o=(u=e.metadata)==null?void 0:u.thread_id,l=Date.now();yield{type:"thinking",data:{threadId:o,provider:a.name}};const[c,d]=await Promise.all([i.buildContext(r.id),Bt(t,r.id)]),p=await i.getRecentConversations(r.id,20,o);await rr(i,p,r.id,e.channel,o);const g=er(r,c,e.channel,d),v=Tn(g,p,e.text,a.name);await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);const y=10;let T="",_=0;const x=[...v.messages];nr(x);for(let h=0;h<y;h++)try{h>0&&(yield{type:"thinking",data:{threadId:o}});const m=await a.chat(x,{tools:jt});if(m.usage&&(_+=m.usage.promptTokens+m.usage.completionTokens),m.toolCalls&&m.toolCalls.length>0){m.content&&(yield{type:"chunk",data:{text:m.content,threadId:o}},x.push({role:"assistant",content:m.content}));for(const w of m.toolCalls){yield{type:"tool_start",data:{tool:w.name,toolArgs:w.arguments,threadId:o}};try{const E=await ar(w.name,w.arguments,t,r.id,{agentType:"full",providerName:a.name,channel:e.channel},r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:w.name,toolResult:E.substring(0,500)+(E.length>500?"...":""),threadId:o}},x.push({role:"user",content:`[Tool Result for ${w.name}]: ${E}`})}catch(E){await L(t,r.id,"tool",w.name,E.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:w.name,toolResult:`Error: ${E.message||"Execution failed"}`,threadId:o}},x.push({role:"user",content:`[Tool Error for ${w.name}]: ${E.message||"Execution failed"}`})}}continue}T=m.content;const f=50;for(let w=0;w<T.length;w+=f)yield{type:"chunk",data:{text:T.substring(w,w+f),threadId:o}},w+f<T.length&&await new Promise(S=>setTimeout(S,10));break}catch(m){if(n){const w=m.message||"",E=w.includes("401")||w.includes("403")||w.includes("authentication")||w.includes("credit balance"),S=w.includes("429"),k=E?1440:S?10:5;await n.recordError(a.name,w,k)}await L(t,r.id,"llm","provider_error",m.message||"Unknown LLM error",{provider:a.name,turn:h});const f=m.message||"An error occurred";try{await i.storeMessage(r.id,e.channel,"assistant",`⚠️ ${f}`,"{}",o)}catch{}yield{type:"error",data:{error:f,threadId:o}};return}if(!T)try{x.push({role:"user",content:"You have used all available research steps. Please now give a final answer based on the information gathered above and your own training knowledge. Be clear about what you found vs. what comes from your general knowledge."}),T=(await a.chat(x,{tools:[]})).content||"I reached the maximum number of research steps without a conclusive result. Please try rephrasing your question or ask me to answer directly from my knowledge.";const m=50;for(let f=0;f<T.length;f+=m)yield{type:"chunk",data:{text:T.substring(f,f+m),threadId:o}},f+m<T.length&&await new Promise(w=>setTimeout(w,10))}catch{T="I reached the maximum number of research steps. Please try rephrasing your question or ask me to answer directly from my knowledge.",yield{type:"chunk",data:{text:T,threadId:o}}}if(n&&_>0)try{await n.recordUsage(a.name,_)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"full",_,Date.now()-l,1,e.channel).run()}catch{}await i.storeMessage(r.id,e.channel,"assistant",T.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,""),"{}",o),await i.compactHistory(r.id,30),yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:_}}}async function Pt(e,t,a,r,n,s){var p;const i=new ae(t),o=(p=e.metadata)==null?void 0:p.thread_id,l=await i.buildContext(r.id);if(Za(e.text,l).agent==="conversation")return sr(e,t,a,r,l,n,o);const d=e.channel==="telegram"?{maxTurns:4,tools:jt.filter(g=>g.name!=="research")}:void 0;return _n(e,t,a,r,n,s,d)}async function sr(e,t,a,r,n,s,i){const o=new ae(t),l=Date.now(),c=tr(r.timezone),d=await Bt(t,r.id),p=d?`## Your Standing Instructions
These are explicit preferences the user has set. Follow them in every response.
${d}

${n}`:n,g=yn("conversation",r,p,r.timezone,c,e.channel),v=(await o.getRecentConversations(r.id,25,i)).filter(u=>!u.content.startsWith("[Autonomous Scheduled Task]")&&!u.content.startsWith("[Scheduled Reminder]")),y=Qa([{role:"system",content:g},...v.map(u=>({role:u.role,content:u.content})),{role:"user",content:e.text}]);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);let T=0,_="";try{const u=await a.chat(y,{temperature:.8});u.usage&&(T=u.usage.promptTokens+u.usage.completionTokens),_=u.content}catch(u){if(s){const h=u.message||"",m=h.includes("401")||h.includes("403")||h.includes("authentication")||h.includes("credit balance"),f=h.includes("429"),w=m?1440:f?10:5;await s.recordError(a.name,h,w)}throw await L(t,r.id,"llm","conversation_error",u.message,{provider:a.name}),u}if(s&&T>0)try{await s.recordUsage(a.name,T)}catch{}try{await t.prepare("INSERT INTO llm_calls (user_id, provider_name, agent_type, tokens_used, latency_ms, success, channel) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(r.id,a.name,"conversation",T,Date.now()-l,1,e.channel).run()}catch{}const x=_.replace(/^\[TOOLS_USED: [^\]]*\]\s*/i,"");return await o.storeMessage(r.id,e.channel,"assistant",x,"{}",i),await o.compactHistory(r.id,30),x}async function*Sn(e,t,a,r,n,s){var d;const i=new ae(t),o=(d=e.metadata)==null?void 0:d.thread_id,l=await i.buildContext(r.id),c=Za(e.text,l);if(yield{type:"thinking",data:{threadId:o,provider:a.name}},c.agent!=="conversation"){yield*xn(e,t,a,r,n,s);return}try{const p=await sr(e,t,a,r,l,n,o),g=50;for(let v=0;v<p.length;v+=g)yield{type:"chunk",data:{text:p.substring(v,v+g),threadId:o}},v+g<p.length&&await new Promise(y=>setTimeout(y,10))}catch(p){yield{type:"error",data:{error:p.message||"An error occurred",threadId:o}};return}yield{type:"done",data:{threadId:o,provider:a.name,tokenCount:0}}}const G=new Ee;async function kn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
...
`;for(const c of s)i+=`- ${c.name} (${c.type}, ${Math.round(c.size/1024)}KB, file_id: ${c.file_id})`,c.text_preview&&(i+=`
  Preview: ${c.text_preview.substring(0,300)}...`),i+=`
`;i+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let o=n;if(!o){const c=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,a.trim().substring(0,60)+(a.trim().length>60?"...":"")).first();o=c==null?void 0:c.id}const l={userId:t.id,username:t.username,channel:r,text:a.trim()+i,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:o}};try{const{provider:c,rotation:d}=await nt(e.env.DB,t.id,t.pin_hash),p=new ReadableStream({async start(g){const v=new TextEncoder;try{const y=Sn(l,e.env.DB,c,t,d,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const T of y)T.data.threadId||(T.data.threadId=o),g.enqueue(v.encode(Xt(T)));o&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(o).run(),g.close()}catch(y){const T={type:"error",data:{error:y.message||"An error occurred",threadId:o}};g.enqueue(v.encode(Xt(T))),g.close()}}});return new Response(p,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(o||"")}})}catch(c){console.error("Stream setup error:",c);const d=c.message||"";return d.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:o},400):d.includes("limit reached")?e.json({error:d,type:"cost_limit",thread_id:o},429):e.json({error:"Something went wrong setting up the stream.",details:d,thread_id:o},500)}});G.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),a=parseInt(e.req.param("id")),r=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
`];for(const v of o){let y="";if(v.due_date){const T=v.due_date.slice(0,10);T<c?y=" ⚠️ _overdue_":T===c?y=" 🔴 _due today_":T===p?y=" 🟡 _due tomorrow_":y=` _${new Date(v.due_date).toLocaleDateString("en-GB",{day:"numeric",month:"short"})}_`}g.push(`☐ ${v.title}${y}`)}g.push(`
_Say "mark [task] as done" to close a task._`),await H(a,t,g.join(`
`))}catch(i){await H(a,t,"❌ Could not fetch tasks: "+i.message)}return!0}default:return!1}}st.post("/webhook",async e=>{let t;try{t=await e.req.json()}catch{return e.json({ok:!0})}const a=e.env.DB,r={GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID},n=async()=>{var s,i,o,l,c;try{if(t.callback_query){await Mn(a,t.callback_query);return}const d=t.message;if(!d)return;const p=!!d.text,g=!!d.voice,v=!!d.document,y=!!d.photo,T=!!d.caption;if(!p&&!g&&!v&&!y)return;const _=String(d.chat.id);let x=d.text||"";const u=await a.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(_).first();let h=null;if(u){const I=await a.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(u.id,"telegram_bot_token").first();I&&(h=await F(I.encrypted_value,u.pin_hash))}if(!h){const I=await a.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c
         JOIN users u ON c.user_id = u.id
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();I&&(h=await F(I.encrypted_value,I.pin_hash))}if(!h||x.startsWith("/")&&await $n(x,_,h,u,a))return;if(!u){await H(h,_,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${_}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`);return}if(d.voice&&h&&u)try{await H(h,_,"🎤 Processing voice note...");const O=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${d.voice.file_id}`)).json();if(O.ok&&((s=O.result)!=null&&s.file_path)){const N=await(await fetch(`https://api.telegram.org/file/bot${h}/${O.result.file_path}`)).blob();let $="",j="",B="whisper-1";const K=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(u.id).all();for(const oe of K.results){const it=await F(oe.encrypted_value,u.pin_hash);if(oe.service==="openai"){$="https://api.openai.com/v1/audio/transcriptions",j=it;break}else if(oe.service.startsWith("llm_slot_"))try{const ot=JSON.parse(it);if(ot.provider==="openai"){$="https://api.openai.com/v1/audio/transcriptions",j=ot.apiKey;break}else if(ot.provider==="groq"){$="https://api.groq.com/openai/v1/audio/transcriptions",j=ot.apiKey,B="whisper-large-v3";break}}catch{}}if(!$){await H(h,_,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys).");return}const U=new FormData;U.append("file",N,"voice.ogg"),U.append("model",B),U.append("language","en");const W=await fetch($,{method:"POST",headers:{Authorization:`Bearer ${j}`},body:U});if(!W.ok){const oe=await W.text();await H(h,_,`⚠️ Transcription failed: ${W.status} ${oe}`);return}x=(await W.json()).text,await H(h,_,`🗣️ *You said:* ${x}`)}}catch(I){await H(h,_,`⚠️ Failed to process voice note: ${I.message}`);return}if((v||y)&&h&&u)try{let I,O="unknown",R="unknown",N=0;if(v)I=d.document.file_id,O=d.document.file_name||"document",R=d.document.mime_type||"unknown",N=d.document.file_size||0;else if(y){const $=d.photo[d.photo.length-1];I=$.file_id,O="photo.jpg",R="image/jpeg",N=$.file_size||0}if(I){const j=await(await fetch(`https://api.telegram.org/bot${h}/getFile?file_id=${I}`)).json();let B="";if(j.ok&&((i=j.result)!=null&&i.file_path)&&(/\.(txt|csv|json|md|xml|html|log|yaml|yml|tsv|ini|cfg|conf|py|js|ts|sh|sql)$/i.test(O)||/^text\/|application\/json|application\/xml|application\/csv/i.test(R))&&N<5e4)try{B=await(await fetch(`https://api.telegram.org/file/bot${h}/${j.result.file_path}`)).text()}catch{}const K=d.caption||"",U=`[Telegram file received: "${O}" (${R}, ${Math.round(N/1024)}KB)]`;B?x=`${K?K+`
...
`:""}${U}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(I){if(T&&d.caption)x=d.caption;else{await H(h,_,`⚠️ Received your file but couldn't process it: ${I.message}`);return}}if(!x)return;Ln(h,_).catch(()=>{});let m=await a.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(u.id).first();m?await a.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(m.id).run():m={id:(await a.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(u.id).run()).meta.last_row_id};const f=Cn(u.id,u.username,x,_);f.metadata={thread_id:m.id};let w,E;try{const I=await nt(a,u.id,u.pin_hash);w=I.provider,E=I.rotation}catch(I){console.error("Telegram provider setup error:",I);const O=(o=I.message)!=null&&o.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(l=I.message)!=null&&l.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${I.message||"Unknown error"}`;await H(h,_,O);return}/\b(write\s+(an?\s+)?(essay|article|report|document|doc|blog|post|summary|draft)|draft\s+(an?\s+)?(essay|article|report|document)|research\s+.{0,60}(save|store|drive|doc))\b/i.test(x)&&await H(h,_,"📝 Working on it— searching and saving to Drive takes about 20 seconds...");const k=25e3;try{const I=await Promise.race([Pt(f,a,w,u,E,r),new Promise((R,N)=>setTimeout(()=>N(new Error("TELEGRAM_TIMEOUT")),k))]),O=Rn(I,"telegram");await H(h,_,O||"(empty response)")}catch(I){console.error("Telegram agent error:",I);const O=I.message==="TELEGRAM_TIMEOUT",R=O?`⏱️ This took longer than Telegram allows (25s limit).

For long essays, please use the web app — it handles long generation without time limits.`:(c=I.message)!=null&&c.includes("API error")?`⚠️ AI provider returned an error. The provider (${w.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(I.message||"Unknown").substring(0,200)}`;await H(h,_,R);try{const{logError:N}=await Promise.resolve().then(()=>Ot);await N(a,u.id,"telegram",O?"timeout":"agent_error",I.message||"Agent error",{provider:w.name})}catch{}}}catch(d){console.error("Telegram webhook error:",d);try{const{logError:p}=await Promise.resolve().then(()=>Ot);await p(a,null,"telegram","webhook_error",d.message||"Unknown telegram error")}catch{}}};return e.executionCtx.waitUntil(n()),e.json({ok:!0})});st.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const a=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
