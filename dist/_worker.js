var Za=Object.defineProperty;var Bt=e=>{throw TypeError(e)};var Qa=(e,t,a)=>t in e?Za(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var S=(e,t,a)=>Qa(e,typeof t!="symbol"?t+"":t,a),vt=(e,t,a)=>t.has(e)||Bt("Cannot "+a);var w=(e,t,a)=>(vt(e,t,"read from private field"),a?a.call(e):t.get(e)),C=(e,t,a)=>t.has(e)?Bt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),D=(e,t,a,r)=>(vt(e,t,"write to private field"),r?r.call(e,a):t.set(e,a),a),L=(e,t,a)=>(vt(e,t,"access private method"),a);var jt=(e,t,a,r)=>({set _(n){D(e,t,n,a)},get _(){return w(e,t,r)}});var Pt=(e,t,a)=>(r,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,c=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(r,()=>o(i+1))}catch(m){if(m instanceof Error&&t)r.error=m,l=await t(m,r),c=!0;else throw m}else r.finalized===!1&&a&&(l=await a(r));return l&&(r.finalized===!1||c)&&(r.res=l),r}},er=Symbol(),tr=async(e,t=Object.create(null))=>{const{all:a=!1,dot:r=!1}=t,s=(e instanceof ia?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?ar(e,{all:a,dot:r}):{}};async function ar(e,t){const a=await e.formData();return a?rr(a,t):{}}function rr(e,t){const a=Object.create(null);return e.forEach((r,n)=>{t.all||n.endsWith("[]")?nr(a,n,r):a[n]=r}),t.dot&&Object.entries(a).forEach(([r,n])=>{r.includes(".")&&(sr(a,r,n),delete a[r])}),a}var nr=(e,t,a)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(a):e[t]=[e[t],a]:t.endsWith("[]")?e[t]=[a]:e[t]=a},sr=(e,t,a)=>{let r=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?r[s]=a:((!r[s]||typeof r[s]!="object"||Array.isArray(r[s])||r[s]instanceof File)&&(r[s]=Object.create(null)),r=r[s])})},aa=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},or=e=>{const{groups:t,path:a}=ir(e),r=aa(a);return lr(r,t)},ir=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(a,r)=>{const n=`@${r}`;return t.push([n,a]),n}),{groups:t,path:e}},lr=(e,t)=>{for(let a=t.length-1;a>=0;a--){const[r]=t[a];for(let n=e.length-1;n>=0;n--)if(e[n].includes(r)){e[n]=e[n].replace(r,t[a][1]);break}}return e},rt={},cr=(e,t)=>{if(e==="*")return"*";const a=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(a){const r=`${e}#${t}`;return rt[r]||(a[2]?rt[r]=t&&t[0]!==":"&&t[0]!=="*"?[r,a[1],new RegExp(`^${a[2]}(?=/${t})`)]:[e,a[1],new RegExp(`^${a[2]}$`)]:rt[r]=[e,a[1],!0]),rt[r]}return null},Rt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,a=>{try{return t(a)}catch{return a}})}},dr=e=>Rt(e,decodeURI),ra=e=>{const t=e.url,a=t.indexOf("/",t.indexOf(":")+4);let r=a;for(;r<t.length;r++){const n=t.charCodeAt(r);if(n===37){const s=t.indexOf("?",r),o=t.indexOf("#",r),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(a,i);return dr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(a,r)},ur=e=>{const t=ra(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ce=(e,t,...a)=>(a.length&&(t=Ce(t,...a)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),na=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),a=[];let r="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))r+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){a.length===0&&r===""?a.push("/"):a.push(r);const s=n.replace("?","");r+="/"+s,a.push(r)}else r+="/"+n}),a.filter((n,s,o)=>o.indexOf(n)===s)},bt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Rt(e,oa):e):e,sa=(e,t,a)=>{let r;if(!a&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,c=e.indexOf("&",l);return bt(e.slice(l,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(r=/[%+]/.test(e),!r)return}const n={};r??(r=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(r&&(l=bt(l)),s=o,l==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),r&&(c=bt(c))),a?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(c)):n[l]??(n[l]=c)}return t?n[t]:n},pr=sa,mr=(e,t)=>sa(e,t,!0),oa=decodeURIComponent,Ut=e=>Rt(e,oa),Le,K,ce,la,ca,Tt,ue,Vt,ia=(Vt=class{constructor(e,t="/",a=[[]]){C(this,ce);S(this,"raw");C(this,Le);C(this,K);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});C(this,ue,e=>{const{bodyCache:t,raw:a}=this,r=t[e];if(r)return r;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=a[e]()});this.raw=e,this.path=t,D(this,K,a),D(this,Le,{})}param(e){return e?L(this,ce,la).call(this,e):L(this,ce,ca).call(this)}query(e){return pr(this.url,e)}queries(e){return mr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((a,r)=>{t[r]=a}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await tr(this,e))}json(){return w(this,ue).call(this,"text").then(e=>JSON.parse(e))}text(){return w(this,ue).call(this,"text")}arrayBuffer(){return w(this,ue).call(this,"arrayBuffer")}blob(){return w(this,ue).call(this,"blob")}formData(){return w(this,ue).call(this,"formData")}addValidatedData(e,t){w(this,Le)[e]=t}valid(e){return w(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[er](){return w(this,K)}get matchedRoutes(){return w(this,K)[0].map(([[,e]])=>e)}get routePath(){return w(this,K)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,K=new WeakMap,ce=new WeakSet,la=function(e){const t=w(this,K)[0][this.routeIndex][1][e],a=L(this,ce,Tt).call(this,t);return a&&/\%/.test(a)?Ut(a):a},ca=function(){const e={},t=Object.keys(w(this,K)[0][this.routeIndex][1]);for(const a of t){const r=L(this,ce,Tt).call(this,w(this,K)[0][this.routeIndex][1][a]);r!==void 0&&(e[a]=/\%/.test(r)?Ut(r):r)}return e},Tt=function(e){return w(this,K)[1]?w(this,K)[1][e]:e},ue=new WeakMap,Vt),hr={Stringify:1},da=async(e,t,a,r,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>da(l,t,!1,r,n))).then(()=>n[0]))):Promise.resolve(e)},gr="text/plain; charset=UTF-8",wt=(e,t)=>({"Content-Type":e,...t}),Ye,Ve,se,Ne,oe,W,Xe,$e,Me,_e,Ze,Qe,pe,Re,Xt,fr=(Xt=class{constructor(e,t){C(this,pe);C(this,Ye);C(this,Ve);S(this,"env",{});C(this,se);S(this,"finalized",!1);S(this,"error");C(this,Ne);C(this,oe);C(this,W);C(this,Xe);C(this,$e);C(this,Me);C(this,_e);C(this,Ze);C(this,Qe);S(this,"render",(...e)=>(w(this,$e)??D(this,$e,t=>this.html(t)),w(this,$e).call(this,...e)));S(this,"setLayout",e=>D(this,Xe,e));S(this,"getLayout",()=>w(this,Xe));S(this,"setRenderer",e=>{D(this,$e,e)});S(this,"header",(e,t,a)=>{this.finalized&&D(this,W,new Response(w(this,W).body,w(this,W)));const r=w(this,W)?w(this,W).headers:w(this,_e)??D(this,_e,new Headers);t===void 0?r.delete(e):a!=null&&a.append?r.append(e,t):r.set(e,t)});S(this,"status",e=>{D(this,Ne,e)});S(this,"set",(e,t)=>{w(this,se)??D(this,se,new Map),w(this,se).set(e,t)});S(this,"get",e=>w(this,se)?w(this,se).get(e):void 0);S(this,"newResponse",(...e)=>L(this,pe,Re).call(this,...e));S(this,"body",(e,t,a)=>L(this,pe,Re).call(this,e,t,a));S(this,"text",(e,t,a)=>!w(this,_e)&&!w(this,Ne)&&!t&&!a&&!this.finalized?new Response(e):L(this,pe,Re).call(this,e,t,wt(gr,a)));S(this,"json",(e,t,a)=>L(this,pe,Re).call(this,JSON.stringify(e),t,wt("application/json",a)));S(this,"html",(e,t,a)=>{const r=n=>L(this,pe,Re).call(this,n,t,wt("text/html; charset=UTF-8",a));return typeof e=="object"?da(e,hr.Stringify,!1,{}).then(r):r(e)});S(this,"redirect",(e,t)=>{const a=String(e);return this.header("Location",/[^\x00-\xFF]/.test(a)?encodeURI(a):a),this.newResponse(null,t??302)});S(this,"notFound",()=>(w(this,Me)??D(this,Me,()=>new Response),w(this,Me).call(this,this)));D(this,Ye,e),t&&(D(this,oe,t.executionCtx),this.env=t.env,D(this,Me,t.notFoundHandler),D(this,Qe,t.path),D(this,Ze,t.matchResult))}get req(){return w(this,Ve)??D(this,Ve,new ia(w(this,Ye),w(this,Qe),w(this,Ze))),w(this,Ve)}get event(){if(w(this,oe)&&"respondWith"in w(this,oe))return w(this,oe);throw Error("This context has no FetchEvent")}get executionCtx(){if(w(this,oe))return w(this,oe);throw Error("This context has no ExecutionContext")}get res(){return w(this,W)||D(this,W,new Response(null,{headers:w(this,_e)??D(this,_e,new Headers)}))}set res(e){if(w(this,W)&&e){e=new Response(e.body,e);for(const[t,a]of w(this,W).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const r=w(this,W).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of r)e.headers.append("set-cookie",n)}else e.headers.set(t,a)}D(this,W,e),this.finalized=!0}get var(){return w(this,se)?Object.fromEntries(w(this,se)):{}}},Ye=new WeakMap,Ve=new WeakMap,se=new WeakMap,Ne=new WeakMap,oe=new WeakMap,W=new WeakMap,Xe=new WeakMap,$e=new WeakMap,Me=new WeakMap,_e=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,pe=new WeakSet,Re=function(e,t,a){const r=w(this,W)?new Headers(w(this,W).headers):w(this,_e)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(a)for(const[s,o]of Object.entries(a))if(typeof o=="string")r.set(s,o);else{r.delete(s);for(const i of o)r.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??w(this,Ne);return new Response(e,{status:n,headers:r})},Xt),P="ALL",yr="all",vr=["get","post","put","delete","options","patch"],ua="Can not add a route since the matcher is already built.",pa=class extends Error{},br="__COMPOSED_HANDLER",wr=e=>e.text("404 Not Found",404),Gt=(e,t)=>{if("getResponse"in e){const a=e.getResponse();return t.newResponse(a.body,a)}return console.error(e),t.text("Internal Server Error",500)},V,U,ma,X,be,ot,it,Be,_r=(Be=class{constructor(t={}){C(this,U);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");C(this,V,"/");S(this,"routes",[]);C(this,X,wr);S(this,"errorHandler",Gt);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(D(this,X,t),this));S(this,"fetch",(t,...a)=>L(this,U,it).call(this,t,a[1],a[0],t.method));S(this,"request",(t,a,r,n)=>t instanceof Request?this.fetch(a?new Request(t,a):t,r,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ce("/",t)}`,a),r,n)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(L(this,U,it).call(this,t.request,t,void 0,t.request.method))})});[...vr,yr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?D(this,V,o):L(this,U,be).call(this,s,w(this,V),o),i.forEach(l=>{L(this,U,be).call(this,s,w(this,V),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){D(this,V,l);for(const c of[s].flat())i.map(u=>{L(this,U,be).call(this,c.toUpperCase(),w(this,V),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?D(this,V,s):(D(this,V,"*"),o.unshift(s)),o.forEach(i=>{L(this,U,be).call(this,P,w(this,V),i)}),this);const{strict:r,...n}=t;Object.assign(this,n),this.getPath=r??!0?t.getPath??ra:ur}route(t,a){const r=this.basePath(t);return a.routes.map(n=>{var o;let s;a.errorHandler===Gt?s=n.handler:(s=async(i,l)=>(await Pt([],a.errorHandler)(i,()=>n.handler(i,l))).res,s[br]=n.handler),L(o=r,U,be).call(o,n.method,n.path,s)}),this}basePath(t){const a=L(this,U,ma).call(this);return a._basePath=Ce(this._basePath,t),a}mount(t,a,r){let n,s;r&&(typeof r=="function"?s=r:(s=r.optionHandler,r.replaceRequest===!1?n=l=>l:n=r.replaceRequest));const o=s?l=>{const c=s(l);return Array.isArray(c)?c:[c]}:l=>{let c;try{c=l.executionCtx}catch{}return[l.env,c]};n||(n=(()=>{const l=Ce(this._basePath,t),c=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,u)}})());const i=async(l,c)=>{const u=await a(n(l.req.raw),...o(l));if(u)return u;await c()};return L(this,U,be).call(this,P,Ce(t,"*"),i),this}},V=new WeakMap,U=new WeakSet,ma=function(){const t=new Be({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,X,w(this,X)),t.routes=this.routes,t},X=new WeakMap,be=function(t,a,r){t=t.toUpperCase(),a=Ce(this._basePath,a);const n={basePath:this._basePath,path:a,method:t,handler:r};this.router.add(t,a,[r,n]),this.routes.push(n)},ot=function(t,a){if(t instanceof Error)return this.errorHandler(t,a);throw t},it=function(t,a,r,n){if(n==="HEAD")return(async()=>new Response(null,await L(this,U,it).call(this,t,a,r,"GET")))();const s=this.getPath(t,{env:r}),o=this.router.match(n,s),i=new fr(t,{path:s,matchResult:o,env:r,executionCtx:a,notFoundHandler:w(this,X)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await w(this,X).call(this,i)})}catch(u){return L(this,U,ot).call(this,u,i)}return c instanceof Promise?c.then(u=>u||(i.finalized?i.res:w(this,X).call(this,i))).catch(u=>L(this,U,ot).call(this,u,i)):c??w(this,X).call(this,i)}const l=Pt(o[0],this.errorHandler,w(this,X));return(async()=>{try{const c=await l(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return L(this,U,ot).call(this,c,i)}})()},Be),ha=[];function xr(e,t){const a=this.buildAllMatchers(),r=((n,s)=>{const o=a[n]||a[P],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],ha];const c=l.indexOf("",1);return[o[1][c],l]});return this.match=r,r(e,t)}var ct="[^/]+",We=".*",qe="(?:|/.*)",Ae=Symbol(),Er=new Set(".\\+*[^]$()");function Tr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===We||e===qe?1:t===We||t===qe?-1:e===ct?1:t===ct?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var xe,Ee,Z,Se,kr=(Se=class{constructor(){C(this,xe);C(this,Ee);C(this,Z,Object.create(null))}insert(t,a,r,n,s){if(t.length===0){if(w(this,xe)!==void 0)throw Ae;if(s)return;D(this,xe,a);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",We]:["","",ct]:o==="/*"?["","",qe]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(l){const u=l[1];let m=l[2]||ct;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Ae;if(c=w(this,Z)[m],!c){if(Object.keys(w(this,Z)).some(g=>g!==We&&g!==qe))throw Ae;if(s)return;c=w(this,Z)[m]=new Se,u!==""&&D(c,Ee,n.varIndex++)}!s&&u!==""&&r.push([u,w(c,Ee)])}else if(c=w(this,Z)[o],!c){if(Object.keys(w(this,Z)).some(u=>u.length>1&&u!==We&&u!==qe))throw Ae;if(s)return;c=w(this,Z)[o]=new Se}c.insert(i,a,r,n,s)}buildRegExpStr(){const a=Object.keys(w(this,Z)).sort(Tr).map(r=>{const n=w(this,Z)[r];return(typeof w(n,Ee)=="number"?`(${r})@${w(n,Ee)}`:Er.has(r)?`\\${r}`:r)+n.buildRegExpStr()});return typeof w(this,xe)=="number"&&a.unshift(`#${w(this,xe)}`),a.length===0?"":a.length===1?a[0]:"(?:"+a.join("|")+")"}},xe=new WeakMap,Ee=new WeakMap,Z=new WeakMap,Se),ut,et,Zt,Sr=(Zt=class{constructor(){C(this,ut,{varIndex:0});C(this,et,new kr)}insert(e,t,a){const r=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const c=`@\\${o}`;return n[o]=[c,l],o++,i=!0,c}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return w(this,et).insert(s,t,r,w(this,ut),a),r}buildRegExp(){let e=w(this,et).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const a=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(a[++t]=Number(s),"$()"):(o!==void 0&&(r[Number(o)]=++t),"")),[new RegExp(`^${e}`),a,r]}},ut=new WeakMap,et=new WeakMap,Zt),Ir=[/^$/,[],Object.create(null)],lt=Object.create(null);function ga(e){return lt[e]??(lt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,a)=>a?`\\${a}`:"(?:|/.*)")}$`))}function Dr(){lt=Object.create(null)}function Or(e){var c;const t=new Sr,a=[];if(e.length===0)return Ir;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[g,v])=>u?1:g?-1:m.length-v.length),n=Object.create(null);for(let u=0,m=-1,g=r.length;u<g;u++){const[v,f,x]=r[u];v?n[f]=[x.map(([E])=>[E,Object.create(null)]),ha]:m++;let _;try{_=t.insert(f,m,v)}catch(E){throw E===Ae?new pa(f):E}v||(a[m]=x.map(([E,d])=>{const y=Object.create(null);for(d-=1;d>=0;d--){const[h,p]=_[d];y[h]=p}return[E,y]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=a.length;u<m;u++)for(let g=0,v=a[u].length;g<v;g++){const f=(c=a[u][g])==null?void 0:c[1];if(!f)continue;const x=Object.keys(f);for(let _=0,E=x.length;_<E;_++)f[x[_]]=i[f[x[_]]]}const l=[];for(const u in o)l[u]=a[o[u]];return[s,l,n]}function De(e,t){if(e){for(const a of Object.keys(e).sort((r,n)=>n.length-r.length))if(ga(a).test(t))return[...e[a]]}}var me,he,pt,fa,Qt,Cr=(Qt=class{constructor(){C(this,pt);S(this,"name","RegExpRouter");C(this,me);C(this,he);S(this,"match",xr);D(this,me,{[P]:Object.create(null)}),D(this,he,{[P]:Object.create(null)})}add(e,t,a){var i;const r=w(this,me),n=w(this,he);if(!r||!n)throw new Error(ua);r[e]||[r,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[P]).forEach(c=>{l[e][c]=[...l[P][c]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=ga(t);e===P?Object.keys(r).forEach(c=>{var u;(u=r[c])[t]||(u[t]=De(r[c],t)||De(r[P],t)||[])}):(i=r[e])[t]||(i[t]=De(r[e],t)||De(r[P],t)||[]),Object.keys(r).forEach(c=>{(e===P||e===c)&&Object.keys(r[c]).forEach(u=>{l.test(u)&&r[c][u].push([a,s])})}),Object.keys(n).forEach(c=>{(e===P||e===c)&&Object.keys(n[c]).forEach(u=>l.test(u)&&n[c][u].push([a,s]))});return}const o=na(t)||[t];for(let l=0,c=o.length;l<c;l++){const u=o[l];Object.keys(n).forEach(m=>{var g;(e===P||e===m)&&((g=n[m])[u]||(g[u]=[...De(r[m],u)||De(r[P],u)||[]]),n[m][u].push([a,s-c+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(w(this,he)).concat(Object.keys(w(this,me))).forEach(t=>{e[t]||(e[t]=L(this,pt,fa).call(this,t))}),D(this,me,D(this,he,void 0)),Dr(),e}},me=new WeakMap,he=new WeakMap,pt=new WeakSet,fa=function(e){const t=[];let a=e===P;return[w(this,me),w(this,he)].forEach(r=>{const n=r[e]?Object.keys(r[e]).map(s=>[s,r[e][s]]):[];n.length!==0?(a||(a=!0),t.push(...n)):e!==P&&t.push(...Object.keys(r[P]).map(s=>[s,r[P][s]]))}),a?Or(t):null},Qt),ge,ie,ea,Rr=(ea=class{constructor(e){S(this,"name","SmartRouter");C(this,ge,[]);C(this,ie,[]);D(this,ge,e.routers)}add(e,t,a){if(!w(this,ie))throw new Error(ua);w(this,ie).push([e,t,a])}match(e,t){if(!w(this,ie))throw new Error("Fatal error");const a=w(this,ge),r=w(this,ie),n=a.length;let s=0,o;for(;s<n;s++){const i=a[s];try{for(let l=0,c=r.length;l<c;l++)i.add(...r[l]);o=i.match(e,t)}catch(l){if(l instanceof pa)continue;throw l}this.match=i.match.bind(i),D(this,ge,[i]),D(this,ie,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(w(this,ie)||w(this,ge).length!==1)throw new Error("No active router has been determined yet.");return w(this,ge)[0]}},ge=new WeakMap,ie=new WeakMap,ea),He=Object.create(null),fe,F,Te,je,H,le,we,Pe,Ar=(Pe=class{constructor(t,a,r){C(this,le);C(this,fe);C(this,F);C(this,Te);C(this,je,0);C(this,H,He);if(D(this,F,r||Object.create(null)),D(this,fe,[]),t&&a){const n=Object.create(null);n[t]={handler:a,possibleKeys:[],score:0},D(this,fe,[n])}D(this,Te,[])}insert(t,a,r){D(this,je,++jt(this,je)._);let n=this;const s=or(a),o=[];for(let i=0,l=s.length;i<l;i++){const c=s[i],u=s[i+1],m=cr(c,u),g=Array.isArray(m)?m[0]:c;if(g in w(n,F)){n=w(n,F)[g],m&&o.push(m[1]);continue}w(n,F)[g]=new Pe,m&&(w(n,Te).push(m),o.push(m[1])),n=w(n,F)[g]}return w(n,fe).push({[t]:{handler:r,possibleKeys:o.filter((i,l,c)=>c.indexOf(i)===l),score:w(this,je)}}),n}search(t,a){var l;const r=[];D(this,H,He);let s=[this];const o=aa(a),i=[];for(let c=0,u=o.length;c<u;c++){const m=o[c],g=c===u-1,v=[];for(let f=0,x=s.length;f<x;f++){const _=s[f],E=w(_,F)[m];E&&(D(E,H,w(_,H)),g?(w(E,F)["*"]&&r.push(...L(this,le,we).call(this,w(E,F)["*"],t,w(_,H))),r.push(...L(this,le,we).call(this,E,t,w(_,H)))):v.push(E));for(let d=0,y=w(_,Te).length;d<y;d++){const h=w(_,Te)[d],p=w(_,H)===He?{}:{...w(_,H)};if(h==="*"){const A=w(_,F)["*"];A&&(r.push(...L(this,le,we).call(this,A,t,w(_,H))),D(A,H,p),v.push(A));continue}const[b,T,k]=h;if(!m&&!(k instanceof RegExp))continue;const I=w(_,F)[b],R=o.slice(c).join("/");if(k instanceof RegExp){const A=k.exec(R);if(A){if(p[T]=A[0],r.push(...L(this,le,we).call(this,I,t,w(_,H),p)),Object.keys(w(I,F)).length){D(I,H,p);const N=((l=A[0].match(/\//))==null?void 0:l.length)??0;(i[N]||(i[N]=[])).push(I)}continue}}(k===!0||k.test(m))&&(p[T]=m,g?(r.push(...L(this,le,we).call(this,I,t,p,w(_,H))),w(I,F)["*"]&&r.push(...L(this,le,we).call(this,w(I,F)["*"],t,p,w(_,H)))):(D(I,H,p),v.push(I)))}}s=v.concat(i.shift()??[])}return r.length>1&&r.sort((c,u)=>c.score-u.score),[r.map(({handler:c,params:u})=>[c,u])]}},fe=new WeakMap,F=new WeakMap,Te=new WeakMap,je=new WeakMap,H=new WeakMap,le=new WeakSet,we=function(t,a,r,n){const s=[];for(let o=0,i=w(t,fe).length;o<i;o++){const l=w(t,fe)[o],c=l[a]||l[P],u={};if(c!==void 0&&(c.params=Object.create(null),s.push(c),r!==He||n&&n!==He))for(let m=0,g=c.possibleKeys.length;m<g;m++){const v=c.possibleKeys[m],f=u[c.score];c.params[v]=n!=null&&n[v]&&!f?n[v]:r[v]??(n==null?void 0:n[v]),u[c.score]=!0}}return s},Pe),ke,ta,Lr=(ta=class{constructor(){S(this,"name","TrieRouter");C(this,ke);D(this,ke,new Ar)}add(e,t,a){const r=na(t);if(r){for(let n=0,s=r.length;n<s;n++)w(this,ke).insert(e,r[n],a);return}w(this,ke).insert(e,t,a)}match(e,t){return w(this,ke).search(e,t)}},ke=new WeakMap,ta),ye=class extends _r{constructor(e={}){super(e),this.router=e.router??new Rr({routers:[new Cr,new Lr]})}},Nr=e=>{const a={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(a.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(a.allowMethods);return async function(o,i){var u;function l(m,g){o.res.headers.set(m,g)}const c=await r(o.req.header("origin")||"",o);if(c&&l("Access-Control-Allow-Origin",c),a.credentials&&l("Access-Control-Allow-Credentials","true"),(u=a.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",a.exposeHeaders.join(",")),o.req.method==="OPTIONS"){a.origin!=="*"&&l("Vary","Origin"),a.maxAge!=null&&l("Access-Control-Max-Age",a.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let g=a.allowHeaders;if(!(g!=null&&g.length)){const v=o.req.header("Access-Control-Request-Headers");v&&(g=v.split(/\s*,\s*/))}return g!=null&&g.length&&(l("Access-Control-Allow-Headers",g.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),a.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function ya(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
- Unread errors: ${(b==null?void 0:b.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),y=t.spreadsheet_id;let h=t.range;const p=await d.sheets.getMetadata(y),b=p.sheets;h.includes("!")||(h=`${b[0]}!${h}`);let T;try{T=await d.sheets.readRange(y,h)}catch(I){if((g=I.message)!=null&&g.includes("Unable to parse range")||(v=I.message)!=null&&v.includes("400")){const R=h.includes("!")?h.split("!")[1]:h;h=`${b[0]}!${R}`,T=await d.sheets.readRange(y,h)}else throw I}let k=`[Spreadsheet: "${p.title}" | Reading tab: "${h.split("!")[0]}" | All tabs in this spreadsheet: ${b.map(I=>`"${I}"`).join(", ")}]
`;return b.length>1&&(k+=`[To read a different tab, call read_sheet again with range like "${b[1]}!A1:Z500"]
`),T.length===0?k+"No data found in the specified range.":k+T.map(I=>I.join("	| ")).join(`
...
ID: ${h.spreadsheetId}
URL: ${h.url}`}catch(d){return await O(a,r,"google","create_sheet",d.message),`Failed to create spreadsheet: ${d.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const d=new ee(a,r,n,s||"",o||""),y=t.calendar_id||"primary",h=t.days_ahead||7,p=new Date,b=new Date(p.getTime()+h*24*60*60*1e3),T=await d.calendar.listEvents(y,{timeMin:p.toISOString(),timeMax:b.toISOString(),query:t.query});return T.length===0?`No events found in the next ${h} days.`:T.map(k=>{var $;const I=k.start.dateTime||k.start.date||"TBD",R=k.end.dateTime||k.end.date||"",A=k.location?` 📍 ${k.location}`:"",N=(($=k.attendees)==null?void 0:$.map(G=>G.email).join(", "))||"";return`• ${k.summary} — ${I} to ${R}${A}${N?`
  Attendees: ${N}`:""}`}).join(`
...
`)}catch(d){return await O(a,r,"google_api","geocode",d.message),`Geocoding error: ${d.message}`}}default:return`Unknown tool: ${e}`}}async function Ot(e,t,a,r,n,s){var x;const o=new J(t),i=(x=e.metadata)==null?void 0:x.thread_id,l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,25,i),m=[{role:"system",content:qa(r,l)},...c.map(_=>({role:_.role,content:_.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;for(let _=0;_<g;_++)try{const E=await a.chat(m,{tools:gt});if(E.usage&&(f+=E.usage.promptTokens+E.usage.completionTokens),E.toolCalls&&E.toolCalls.length>0){E.content&&m.push({role:"assistant",content:E.content});for(const d of E.toolCalls)try{const y=await Je(d.name,d.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);m.push({role:"user",content:`[Tool Result for ${d.name}]: ${y}`})}catch(y){await O(t,r.id,"tool",d.name,y.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${d.name}]: ${y.message||"Execution failed"}`})}continue}v=E.content;break}catch(E){if(n){const d=E.message||"",y=d.includes("401")||d.includes("403")||d.includes("authentication")||d.includes("credit balance"),h=d.includes("429"),p=y?1440:h?10:5;await n.recordError(a.name,d,p)}throw await O(t,r.id,"llm","provider_error",E.message||"Unknown LLM error",{provider:a.name,turn:_}),E}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}return await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),v}const qt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function on(e){for(const[t,a]of Object.entries(qt))if(e.toLowerCase().includes(t.toLowerCase()))return a;return qt.default}function ln(e,t,a,r){const n=on(r),s=Math.floor(n*.75),o=[];let i=0,l=!1;const c=Et(e);o.push({role:"system",content:e}),i+=c;const u=Et(a);i+=u;const m=s-i,g=[];let v=0;for(let f=t.length-1;f>=0;f--){const x=t[f],_=Et(x.content);if(v+_<=m)g.unshift({role:x.role,content:x.content}),v+=_;else{l=!0;break}}return o.push(...g),o.push({role:"user",content:a}),i+=v,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*cn(e,t,a,r,n,s){var _;const o=new J(t),i=(_=e.metadata)==null?void 0:_.thread_id;yield{type:"thinking",data:{threadId:i,provider:a.name}};const l=await o.buildContext(r.id),c=await o.getRecentConversations(r.id,20,i),u=qa(r,l),m=ln(u,c,e.text,a.name);await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const g=10;let v="",f=0;const x=[...m.messages];for(let E=0;E<g;E++)try{E>0&&(yield{type:"thinking",data:{threadId:i}});const d=await a.chat(x,{tools:gt});if(d.usage&&(f+=d.usage.promptTokens+d.usage.completionTokens),d.toolCalls&&d.toolCalls.length>0){d.content&&(yield{type:"chunk",data:{text:d.content,threadId:i}},x.push({role:"assistant",content:d.content}));for(const h of d.toolCalls){yield{type:"tool_start",data:{tool:h.name,toolArgs:h.arguments,threadId:i}};try{const p=await Je(h.name,h.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:h.name,toolResult:p.substring(0,500)+(p.length>500?"...":""),threadId:i}},x.push({role:"user",content:`[Tool Result for ${h.name}]: ${p}`})}catch(p){await O(t,r.id,"tool",h.name,p.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:h.name,toolResult:`Error: ${p.message||"Execution failed"}`,threadId:i}},x.push({role:"user",content:`[Tool Error for ${h.name}]: ${p.message||"Execution failed"}`})}}continue}v=d.content;const y=50;for(let h=0;h<v.length;h+=y)yield{type:"chunk",data:{text:v.substring(h,h+y),threadId:i}},h+y<v.length&&await new Promise(b=>setTimeout(b,10));break}catch(d){if(n){const y=d.message||"",h=y.includes("401")||y.includes("403")||y.includes("authentication")||y.includes("credit balance"),p=y.includes("429"),b=h?1440:p?10:5;await n.recordError(a.name,y,b)}await O(t,r.id,"llm","provider_error",d.message||"Unknown LLM error",{provider:a.name,turn:E}),yield{type:"error",data:{error:d.message||"An error occurred",threadId:i}};return}if(n&&f>0)try{await n.recordUsage(a.name,f)}catch{}await o.storeMessage(r.id,e.channel,"assistant",v,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:f}}}async function Mt(e,t,a,r,n,s){var u;const o=new J(t),i=(u=e.metadata)==null?void 0:u.thread_id,l=await o.buildContext(r.id),c=za(e.text,l);if(c.agent==="conversation")return un(e,t,a,r,l,n,i);if(c.agent==="multi"||c.confidence<.5)return Ot(e,t,a,r,n,s);try{return await dn(c.agent,e,t,a,r,l,n,s,i)}catch(m){return await O(t,r.id,"router","subagent_fallback",`${c.agent} failed: ${m.message}`,{route:c}),Ot(e,t,a,r,n,s)}}async function dn(e,t,a,r,n,s,o,i,l){const c=new J(a),u=ft(n.timezone),m=dt(e,n,s,n.timezone,u),g=Fa(e,gt),v=await c.getRecentConversations(n.id,25,l),f=[{role:"system",content:m},...v.map(p=>({role:p.role,content:p.content})),{role:"user",content:t.text}];await c.storeMessage(n.id,t.channel,"user",t.text,"{}",l);const x=10;let _="",E=0,d="",y=!1;for(let p=0;p<x;p++)try{const b=await r.chat(f,{tools:g.length>0?g:void 0});if(b.usage&&(E+=b.usage.promptTokens+b.usage.completionTokens),b.toolCalls&&b.toolCalls.length>0){y=!0,b.content&&(d=b.content,f.push({role:"assistant",content:b.content}));for(const T of b.toolCalls)try{const k=await Je(T.name,T.arguments,a,n.id,n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${T.name}]: ${k}`})}catch(k){await O(a,n.id,"tool",T.name,k.message||"Tool execution failed"),f.push({role:"user",content:`[Tool Error for ${T.name}]: ${k.message||"Execution failed"}`})}continue}_=b.content,!_&&d&&(_=d);break}catch(b){if(o){const T=b.message||"",k=T.includes("401")||T.includes("403")||T.includes("authentication")||T.includes("credit balance"),I=T.includes("429"),R=k?1440:I?10:5;await o.recordError(r.name,T,R)}throw await O(a,n.id,"llm","subagent_error",b.message||"Unknown error",{agent:e,provider:r.name,turn:p}),b}if(!y&&["scheduler","workspace","research"].includes(e)&&g.length>0)try{f.push({role:"assistant",content:_}),f.push({role:"user",content:`[SYSTEM OVERRIDE] You responded with text but did NOT call any tool. This is a ${e} request — you MUST use your tools. Do NOT repeat your text response. Call the appropriate tool NOW (e.g., ${g.slice(0,3).map(b=>b.name).join(", ")}). The user is waiting for an actual action, not a description of what you would do.`});const p=await r.chat(f,{tools:g});if(p.usage&&(E+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){y=!0;for(const T of p.toolCalls)try{const k=await Je(T.name,T.arguments,a,n.id,n.pin_hash,i==null?void 0:i.GOOGLE_CLIENT_ID,i==null?void 0:i.GOOGLE_CLIENT_SECRET,i==null?void 0:i.GOOGLE_API_KEY,i==null?void 0:i.GOOGLE_CSE_ID,n.timezone,r);f.push({role:"user",content:`[Tool Result for ${T.name}]: ${k}`})}catch(k){f.push({role:"user",content:`[Tool Error for ${T.name}]: ${k.message||"Execution failed"}`})}const b=await r.chat(f,{tools:g});b.content&&(_=b.content),b.usage&&(E+=b.usage.promptTokens+b.usage.completionTokens)}}catch(p){await O(a,n.id,"tool_enforcement",e,`Tool enforcement retry failed: ${p.message||"Unknown"}`,{originalResponse:_.substring(0,200)})}if(o&&E>0)try{await o.recordUsage(r.name,E)}catch{}return await c.storeMessage(n.id,t.channel,"assistant",_,"{}",l),await c.compactHistory(n.id,30),_}async function un(e,t,a,r,n,s,o){const i=new J(t),l=ft(r.timezone),c=dt("conversation",r,n,r.timezone,l),u=await i.getRecentConversations(r.id,25,o),m=[{role:"system",content:c},...u.map(f=>({role:f.role,content:f.content})),{role:"user",content:e.text}];await i.storeMessage(r.id,e.channel,"user",e.text,"{}",o);let g=0,v="";try{const f=await a.chat(m,{temperature:.8});f.usage&&(g=f.usage.promptTokens+f.usage.completionTokens),v=f.content}catch(f){if(s){const x=f.message||"",_=x.includes("401")||x.includes("403")||x.includes("authentication")||x.includes("credit balance"),E=x.includes("429"),d=_?1440:E?10:5;await s.recordError(a.name,x,d)}throw await O(t,r.id,"llm","conversation_error",f.message,{provider:a.name}),f}if(s&&g>0)try{await s.recordUsage(a.name,g)}catch{}return await i.storeMessage(r.id,e.channel,"assistant",v,"{}",o),await i.compactHistory(r.id,30),v}async function*pn(e,t,a,r,n,s){var d;const o=new J(t),i=(d=e.metadata)==null?void 0:d.thread_id,l=await o.buildContext(r.id),c=za(e.text,l);if(yield{type:"thinking",data:{threadId:i,provider:a.name}},c.agent==="multi"||c.confidence<.5){yield*cn(e,t,a,r,n,s);return}const u=ft(r.timezone),m=c.agent==="conversation"?dt("conversation",r,l,r.timezone,u):dt(c.agent,r,l,r.timezone,u),g=Fa(c.agent,gt),v=await o.getRecentConversations(r.id,25,i),f=[{role:"system",content:m},...v.map(y=>({role:y.role,content:y.content})),{role:"user",content:e.text}];await o.storeMessage(r.id,e.channel,"user",e.text,"{}",i);const x=10;let _="",E=0;for(let y=0;y<x;y++)try{y>0&&(yield{type:"thinking",data:{threadId:i}});const h=await a.chat(f,{tools:g.length>0?g:void 0});if(h.usage&&(E+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){h.content&&(yield{type:"chunk",data:{text:h.content,threadId:i}},f.push({role:"assistant",content:h.content}));for(const b of h.toolCalls){yield{type:"tool_start",data:{tool:b.name,toolArgs:b.arguments,threadId:i}};try{const T=await Je(b.name,b.arguments,t,r.id,r.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,r.timezone,a);yield{type:"tool_end",data:{tool:b.name,toolResult:T.substring(0,500)+(T.length>500?"...":""),threadId:i}},f.push({role:"user",content:`[Tool Result for ${b.name}]: ${T}`})}catch(T){await O(t,r.id,"tool",b.name,T.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:b.name,toolResult:`Error: ${T.message||"Execution failed"}`,threadId:i}},f.push({role:"user",content:`[Tool Error for ${b.name}]: ${T.message||"Execution failed"}`})}}continue}_=h.content;const p=50;for(let b=0;b<_.length;b+=p)yield{type:"chunk",data:{text:_.substring(b,b+p),threadId:i}},b+p<_.length&&await new Promise(k=>setTimeout(k,10));break}catch(h){if(n){const p=h.message||"",b=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),T=p.includes("429"),k=b?1440:T?10:5;await n.recordError(a.name,p,k)}await O(t,r.id,"llm","subagent_stream_error",h.message||"Unknown error",{agent:c.agent,provider:a.name,turn:y}),yield{type:"error",data:{error:h.message||"An error occurred",threadId:i}};return}if(n&&E>0)try{await n.recordUsage(a.name,E)}catch{}await o.storeMessage(r.id,e.channel,"assistant",_,"{}",i),await o.compactHistory(r.id,30),yield{type:"done",data:{threadId:i,provider:a.name,tokenCount:E}}}const B=new ye;async function mn(e,t){var n;const a=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!a)return e.json({error:"Authentication required"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
...
`:""}${$}
Note: This file type cannot be read directly. I can see it was sent but cannot extract the content. For PDFs, images, or Office docs — suggest uploading to Google Drive via the web app where I can process them.`}}catch(p){if(g&&i.caption)f=i.caption;else return await z(_,v,`⚠️ Received your file but couldn't process it: ${p.message}`),e.json({ok:!0})}if(!f)return e.json({ok:!0});await wn(_,v);let E=await e.env.DB.prepare("SELECT id FROM threads WHERE user_id = ? AND channel = 'telegram' AND is_archived = 0 ORDER BY updated_at DESC LIMIT 1").bind(x.id).first();E?await e.env.DB.prepare("UPDATE threads SET updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(E.id).run():E={id:(await e.env.DB.prepare("INSERT INTO threads (user_id, title, channel) VALUES (?, 'Telegram', 'telegram')").bind(x.id).run()).meta.last_row_id};const d=yn(x.id,x.username,f,v);d.metadata={thread_id:E.id};let y,h;try{const p=await tt(e.env.DB,x.id,x.pin_hash);y=p.provider,h=p.rotation}catch(p){console.error("Telegram provider setup error:",p);const b=(r=p.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.
