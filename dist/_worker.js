var Nr=Object.defineProperty;var Dt=e=>{throw TypeError(e)};var $r=(e,t,r)=>t in e?Nr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var E=(e,t,r)=>$r(e,typeof t!="symbol"?t+"":t,r),dt=(e,t,r)=>t.has(e)||Dt("Cannot "+r);var y=(e,t,r)=>(dt(e,t,"read from private field"),r?r.call(e):t.get(e)),k=(e,t,r)=>t.has(e)?Dt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),T=(e,t,r,a)=>(dt(e,t,"write to private field"),a?a.call(e,r):t.set(e,r),r),O=(e,t,r)=>(dt(e,t,"access private method"),r);var Ct=(e,t,r,a)=>({set _(n){T(e,t,n,r)},get _(){return y(e,t,a)}});var Ot=(e,t,r)=>(a,n)=>{let s=-1;return o(0);async function o(i){if(i<=s)throw new Error("next() called multiple times");s=i;let l,d=!1,u;if(e[i]?(u=e[i][0][0],a.req.routeIndex=i):u=i===e.length&&n||void 0,u)try{l=await u(a,()=>o(i+1))}catch(m){if(m instanceof Error&&t)a.error=m,l=await t(m,a),d=!0;else throw m}else a.finalized===!1&&r&&(l=await r(a));return l&&(a.finalized===!1||d)&&(a.res=l),a}},Mr=Symbol(),jr=async(e,t=Object.create(null))=>{const{all:r=!1,dot:a=!1}=t,s=(e instanceof Zt?e.raw.headers:e.headers).get("Content-Type");return s!=null&&s.startsWith("multipart/form-data")||s!=null&&s.startsWith("application/x-www-form-urlencoded")?Br(e,{all:r,dot:a}):{}};async function Br(e,t){const r=await e.formData();return r?Pr(r,t):{}}function Pr(e,t){const r=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Hr(r,n,a):r[n]=a}),t.dot&&Object.entries(r).forEach(([a,n])=>{a.includes(".")&&(Ur(r,a,n),delete r[a])}),r}var Hr=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Ur=(e,t,r)=>{let a=e;const n=t.split(".");n.forEach((s,o)=>{o===n.length-1?a[s]=r:((!a[s]||typeof a[s]!="object"||Array.isArray(a[s])||a[s]instanceof File)&&(a[s]=Object.create(null)),a=a[s])})},Kt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Gr=e=>{const{groups:t,path:r}=zr(e),a=Kt(r);return Fr(a,t)},zr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,a)=>{const n=`@${a}`;return t.push([n,r]),n}),{groups:t,path:e}},Fr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[a]=t[r];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[r][1]);break}}return e},Xe={},Wr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const a=`${e}#${t}`;return Xe[a]||(r[2]?Xe[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Xe[a]=[e,r[1],!0]),Xe[a]}return null},xt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},qr=e=>xt(e,decodeURI),Jt=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let a=r;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const s=t.indexOf("?",a),o=t.indexOf("#",a),i=s===-1?o===-1?void 0:o:o===-1?s:Math.min(s,o),l=t.slice(r,i);return qr(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(n===63||n===35)break}return t.slice(r,a)},Kr=e=>{const t=Jt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Te=(e,t,...r)=>(r.length&&(t=Te(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Yt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){r.length===0&&a===""?r.push("/"):r.push(a);const s=n.replace("?","");a+="/"+s,r.push(a)}else a+="/"+n}),r.filter((n,s,o)=>o.indexOf(n)===s)},ct=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?xt(e,Xt):e):e,Vt=(e,t,r)=>{let a;if(!r&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const i=e.charCodeAt(o+t.length+1);if(i===61){const l=o+t.length+2,d=e.indexOf("&",l);return ct(e.slice(l,d===-1?void 0:d))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let s=e.indexOf("?",8);for(;s!==-1;){const o=e.indexOf("&",s+1);let i=e.indexOf("=",s);i>o&&o!==-1&&(i=-1);let l=e.slice(s+1,i===-1?o===-1?void 0:o:i);if(a&&(l=ct(l)),s=o,l==="")continue;let d;i===-1?d="":(d=e.slice(i+1,o===-1?void 0:o),a&&(d=ct(d))),r?(n[l]&&Array.isArray(n[l])||(n[l]=[]),n[l].push(d)):n[l]??(n[l]=d)}return t?n[t]:n},Jr=Vt,Yr=(e,t)=>Vt(e,t,!0),Xt=decodeURIComponent,Rt=e=>xt(e,Xt),Ie,F,ne,Qt,er,gt,se,Ut,Zt=(Ut=class{constructor(e,t="/",r=[[]]){k(this,ne);E(this,"raw");k(this,Ie);k(this,F);E(this,"routeIndex",0);E(this,"path");E(this,"bodyCache",{});k(this,se,e=>{const{bodyCache:t,raw:r}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(s=>(n==="json"&&(s=JSON.stringify(s)),new Response(s)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,T(this,F,r),T(this,Ie,{})}param(e){return e?O(this,ne,Qt).call(this,e):O(this,ne,er).call(this)}query(e){return Jr(this.url,e)}queries(e){return Yr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,a)=>{t[a]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await jr(this,e))}json(){return y(this,se).call(this,"text").then(e=>JSON.parse(e))}text(){return y(this,se).call(this,"text")}arrayBuffer(){return y(this,se).call(this,"arrayBuffer")}blob(){return y(this,se).call(this,"blob")}formData(){return y(this,se).call(this,"formData")}addValidatedData(e,t){y(this,Ie)[e]=t}valid(e){return y(this,Ie)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Mr](){return y(this,F)}get matchedRoutes(){return y(this,F)[0].map(([[,e]])=>e)}get routePath(){return y(this,F)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ie=new WeakMap,F=new WeakMap,ne=new WeakSet,Qt=function(e){const t=y(this,F)[0][this.routeIndex][1][e],r=O(this,ne,gt).call(this,t);return r&&/\%/.test(r)?Rt(r):r},er=function(){const e={},t=Object.keys(y(this,F)[0][this.routeIndex][1]);for(const r of t){const a=O(this,ne,gt).call(this,y(this,F)[0][this.routeIndex][1][r]);a!==void 0&&(e[r]=/\%/.test(a)?Rt(a):a)}return e},gt=function(e){return y(this,F)[1]?y(this,F)[1][e]:e},se=new WeakMap,Ut),Vr={Stringify:1},tr=async(e,t,r,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const s=e.callbacks;return s!=null&&s.length?(n?n[0]+=e:n=[e],Promise.all(s.map(i=>i({phase:t,buffer:n,context:a}))).then(i=>Promise.all(i.filter(Boolean).map(l=>tr(l,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Xr="text/plain; charset=UTF-8",ut=(e,t)=>({"Content-Type":e,...t}),Ge,ze,ee,De,te,z,Fe,Ce,Oe,fe,We,qe,oe,ke,Gt,Zr=(Gt=class{constructor(e,t){k(this,oe);k(this,Ge);k(this,ze);E(this,"env",{});k(this,ee);E(this,"finalized",!1);E(this,"error");k(this,De);k(this,te);k(this,z);k(this,Fe);k(this,Ce);k(this,Oe);k(this,fe);k(this,We);k(this,qe);E(this,"render",(...e)=>(y(this,Ce)??T(this,Ce,t=>this.html(t)),y(this,Ce).call(this,...e)));E(this,"setLayout",e=>T(this,Fe,e));E(this,"getLayout",()=>y(this,Fe));E(this,"setRenderer",e=>{T(this,Ce,e)});E(this,"header",(e,t,r)=>{this.finalized&&T(this,z,new Response(y(this,z).body,y(this,z)));const a=y(this,z)?y(this,z).headers:y(this,fe)??T(this,fe,new Headers);t===void 0?a.delete(e):r!=null&&r.append?a.append(e,t):a.set(e,t)});E(this,"status",e=>{T(this,De,e)});E(this,"set",(e,t)=>{y(this,ee)??T(this,ee,new Map),y(this,ee).set(e,t)});E(this,"get",e=>y(this,ee)?y(this,ee).get(e):void 0);E(this,"newResponse",(...e)=>O(this,oe,ke).call(this,...e));E(this,"body",(e,t,r)=>O(this,oe,ke).call(this,e,t,r));E(this,"text",(e,t,r)=>!y(this,fe)&&!y(this,De)&&!t&&!r&&!this.finalized?new Response(e):O(this,oe,ke).call(this,e,t,ut(Xr,r)));E(this,"json",(e,t,r)=>O(this,oe,ke).call(this,JSON.stringify(e),t,ut("application/json",r)));E(this,"html",(e,t,r)=>{const a=n=>O(this,oe,ke).call(this,n,t,ut("text/html; charset=UTF-8",r));return typeof e=="object"?tr(e,Vr.Stringify,!1,{}).then(a):a(e)});E(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});E(this,"notFound",()=>(y(this,Oe)??T(this,Oe,()=>new Response),y(this,Oe).call(this,this)));T(this,Ge,e),t&&(T(this,te,t.executionCtx),this.env=t.env,T(this,Oe,t.notFoundHandler),T(this,qe,t.path),T(this,We,t.matchResult))}get req(){return y(this,ze)??T(this,ze,new Zt(y(this,Ge),y(this,qe),y(this,We))),y(this,ze)}get event(){if(y(this,te)&&"respondWith"in y(this,te))return y(this,te);throw Error("This context has no FetchEvent")}get executionCtx(){if(y(this,te))return y(this,te);throw Error("This context has no ExecutionContext")}get res(){return y(this,z)||T(this,z,new Response(null,{headers:y(this,fe)??T(this,fe,new Headers)}))}set res(e){if(y(this,z)&&e){e=new Response(e.body,e);for(const[t,r]of y(this,z).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=y(this,z).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,r)}T(this,z,e),this.finalized=!0}get var(){return y(this,ee)?Object.fromEntries(y(this,ee)):{}}},Ge=new WeakMap,ze=new WeakMap,ee=new WeakMap,De=new WeakMap,te=new WeakMap,z=new WeakMap,Fe=new WeakMap,Ce=new WeakMap,Oe=new WeakMap,fe=new WeakMap,We=new WeakMap,qe=new WeakMap,oe=new WeakSet,ke=function(e,t,r){const a=y(this,z)?new Headers(y(this,z).headers):y(this,fe)??new Headers;if(typeof t=="object"&&"headers"in t){const s=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,i]of s)o.toLowerCase()==="set-cookie"?a.append(o,i):a.set(o,i)}if(r)for(const[s,o]of Object.entries(r))if(typeof o=="string")a.set(s,o);else{a.delete(s);for(const i of o)a.append(s,i)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??y(this,De);return new Response(e,{status:n,headers:a})},Gt),j="ALL",Qr="all",ea=["get","post","put","delete","options","patch"],rr="Can not add a route since the matcher is already built.",ar=class extends Error{},ta="__COMPOSED_HANDLER",ra=e=>e.text("404 Not Found",404),At=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},W,B,nr,q,he,et,tt,Re,aa=(Re=class{constructor(t={}){k(this,B);E(this,"get");E(this,"post");E(this,"put");E(this,"delete");E(this,"options");E(this,"patch");E(this,"all");E(this,"on");E(this,"use");E(this,"router");E(this,"getPath");E(this,"_basePath","/");k(this,W,"/");E(this,"routes",[]);k(this,q,ra);E(this,"errorHandler",At);E(this,"onError",t=>(this.errorHandler=t,this));E(this,"notFound",t=>(T(this,q,t),this));E(this,"fetch",(t,...r)=>O(this,B,tt).call(this,t,r[1],r[0],t.method));E(this,"request",(t,r,a,n)=>t instanceof Request?this.fetch(r?new Request(t,r):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Te("/",t)}`,r),a,n)));E(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(O(this,B,tt).call(this,t.request,t,void 0,t.request.method))})});[...ea,Qr].forEach(s=>{this[s]=(o,...i)=>(typeof o=="string"?T(this,W,o):O(this,B,he).call(this,s,y(this,W),o),i.forEach(l=>{O(this,B,he).call(this,s,y(this,W),l)}),this)}),this.on=(s,o,...i)=>{for(const l of[o].flat()){T(this,W,l);for(const d of[s].flat())i.map(u=>{O(this,B,he).call(this,d.toUpperCase(),y(this,W),u)})}return this},this.use=(s,...o)=>(typeof s=="string"?T(this,W,s):(T(this,W,"*"),o.unshift(s)),o.forEach(i=>{O(this,B,he).call(this,j,y(this,W),i)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??Jt:Kr}route(t,r){const a=this.basePath(t);return r.routes.map(n=>{var o;let s;r.errorHandler===At?s=n.handler:(s=async(i,l)=>(await Ot([],r.errorHandler)(i,()=>n.handler(i,l))).res,s[ta]=n.handler),O(o=a,B,he).call(o,n.method,n.path,s)}),this}basePath(t){const r=O(this,B,nr).call(this);return r._basePath=Te(this._basePath,t),r}mount(t,r,a){let n,s;a&&(typeof a=="function"?s=a:(s=a.optionHandler,a.replaceRequest===!1?n=l=>l:n=a.replaceRequest));const o=s?l=>{const d=s(l);return Array.isArray(d)?d:[d]}:l=>{let d;try{d=l.executionCtx}catch{}return[l.env,d]};n||(n=(()=>{const l=Te(this._basePath,t),d=l==="/"?0:l.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,u)}})());const i=async(l,d)=>{const u=await r(n(l.req.raw),...o(l));if(u)return u;await d()};return O(this,B,he).call(this,j,Te(t,"*"),i),this}},W=new WeakMap,B=new WeakSet,nr=function(){const t=new Re({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,T(t,q,y(this,q)),t.routes=this.routes,t},q=new WeakMap,he=function(t,r,a){t=t.toUpperCase(),r=Te(this._basePath,r);const n={basePath:this._basePath,path:r,method:t,handler:a};this.router.add(t,r,[a,n]),this.routes.push(n)},et=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},tt=function(t,r,a,n){if(n==="HEAD")return(async()=>new Response(null,await O(this,B,tt).call(this,t,r,a,"GET")))();const s=this.getPath(t,{env:a}),o=this.router.match(n,s),i=new Zr(t,{path:s,matchResult:o,env:a,executionCtx:r,notFoundHandler:y(this,q)});if(o[0].length===1){let d;try{d=o[0][0][0][0](i,async()=>{i.res=await y(this,q).call(this,i)})}catch(u){return O(this,B,et).call(this,u,i)}return d instanceof Promise?d.then(u=>u||(i.finalized?i.res:y(this,q).call(this,i))).catch(u=>O(this,B,et).call(this,u,i)):d??y(this,q).call(this,i)}const l=Ot(o[0],this.errorHandler,y(this,q));return(async()=>{try{const d=await l(i);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return O(this,B,et).call(this,d,i)}})()},Re),sr=[];function na(e,t){const r=this.buildAllMatchers(),a=((n,s)=>{const o=r[n]||r[j],i=o[2][s];if(i)return i;const l=s.match(o[0]);if(!l)return[[],sr];const d=l.indexOf("",1);return[o[1][d],l]});return this.match=a,a(e,t)}var at="[^/]+",Pe=".*",He="(?:|/.*)",Se=Symbol(),sa=new Set(".\\+*[^]$()");function oa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Pe||e===He?1:t===Pe||t===He?-1:e===at?1:t===at?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var ve,ye,K,xe,ia=(xe=class{constructor(){k(this,ve);k(this,ye);k(this,K,Object.create(null))}insert(t,r,a,n,s){if(t.length===0){if(y(this,ve)!==void 0)throw Se;if(s)return;T(this,ve,r);return}const[o,...i]=t,l=o==="*"?i.length===0?["","",Pe]:["","",at]:o==="/*"?["","",He]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(l){const u=l[1];let m=l[2]||at;if(u&&l[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Se;if(d=y(this,K)[m],!d){if(Object.keys(y(this,K)).some(f=>f!==Pe&&f!==He))throw Se;if(s)return;d=y(this,K)[m]=new xe,u!==""&&T(d,ye,n.varIndex++)}!s&&u!==""&&a.push([u,y(d,ye)])}else if(d=y(this,K)[o],!d){if(Object.keys(y(this,K)).some(u=>u.length>1&&u!==Pe&&u!==He))throw Se;if(s)return;d=y(this,K)[o]=new xe}d.insert(i,r,a,n,s)}buildRegExpStr(){const r=Object.keys(y(this,K)).sort(oa).map(a=>{const n=y(this,K)[a];return(typeof y(n,ye)=="number"?`(${a})@${y(n,ye)}`:sa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof y(this,ve)=="number"&&r.unshift(`#${y(this,ve)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},ve=new WeakMap,ye=new WeakMap,K=new WeakMap,xe),nt,Ke,zt,la=(zt=class{constructor(){k(this,nt,{varIndex:0});k(this,Ke,new ia)}insert(e,t,r){const a=[],n=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,l=>{const d=`@\\${o}`;return n[o]=[d,l],o++,i=!0,d}),!i)break}const s=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[i]=n[o];for(let l=s.length-1;l>=0;l--)if(s[l].indexOf(i)!==-1){s[l]=s[l].replace(i,n[o][1]);break}}return y(this,Ke).insert(s,t,a,y(this,nt),r),a}buildRegExp(){let e=y(this,Ke).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,s,o)=>s!==void 0?(r[++t]=Number(s),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),r,a]}},nt=new WeakMap,Ke=new WeakMap,zt),da=[/^$/,[],Object.create(null)],rt=Object.create(null);function or(e){return rt[e]??(rt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ca(){rt=Object.create(null)}function ua(e){var d;const t=new la,r=[];if(e.length===0)return da;const a=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[f,b])=>u?1:f?-1:m.length-b.length),n=Object.create(null);for(let u=0,m=-1,f=a.length;u<f;u++){const[b,g,_]=a[u];b?n[g]=[_.map(([h])=>[h,Object.create(null)]),sr]:m++;let c;try{c=t.insert(g,m,b)}catch(h){throw h===Se?new ar(g):h}b||(r[m]=_.map(([h,p])=>{const v=Object.create(null);for(p-=1;p>=0;p--){const[w,x]=c[p];v[w]=x}return[h,v]}))}const[s,o,i]=t.buildRegExp();for(let u=0,m=r.length;u<m;u++)for(let f=0,b=r[u].length;f<b;f++){const g=(d=r[u][f])==null?void 0:d[1];if(!g)continue;const _=Object.keys(g);for(let c=0,h=_.length;c<h;c++)g[_[c]]=i[g[_[c]]]}const l=[];for(const u in o)l[u]=r[o[u]];return[s,l,n]}function _e(e,t){if(e){for(const r of Object.keys(e).sort((a,n)=>n.length-a.length))if(or(r).test(t))return[...e[r]]}}var ie,le,st,ir,Ft,pa=(Ft=class{constructor(){k(this,st);E(this,"name","RegExpRouter");k(this,ie);k(this,le);E(this,"match",na);T(this,ie,{[j]:Object.create(null)}),T(this,le,{[j]:Object.create(null)})}add(e,t,r){var i;const a=y(this,ie),n=y(this,le);if(!a||!n)throw new Error(rr);a[e]||[a,n].forEach(l=>{l[e]=Object.create(null),Object.keys(l[j]).forEach(d=>{l[e][d]=[...l[j][d]]})}),t==="/*"&&(t="*");const s=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const l=or(t);e===j?Object.keys(a).forEach(d=>{var u;(u=a[d])[t]||(u[t]=_e(a[d],t)||_e(a[j],t)||[])}):(i=a[e])[t]||(i[t]=_e(a[e],t)||_e(a[j],t)||[]),Object.keys(a).forEach(d=>{(e===j||e===d)&&Object.keys(a[d]).forEach(u=>{l.test(u)&&a[d][u].push([r,s])})}),Object.keys(n).forEach(d=>{(e===j||e===d)&&Object.keys(n[d]).forEach(u=>l.test(u)&&n[d][u].push([r,s]))});return}const o=Yt(t)||[t];for(let l=0,d=o.length;l<d;l++){const u=o[l];Object.keys(n).forEach(m=>{var f;(e===j||e===m)&&((f=n[m])[u]||(f[u]=[..._e(a[m],u)||_e(a[j],u)||[]]),n[m][u].push([r,s-d+l+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(y(this,le)).concat(Object.keys(y(this,ie))).forEach(t=>{e[t]||(e[t]=O(this,st,ir).call(this,t))}),T(this,ie,T(this,le,void 0)),ca(),e}},ie=new WeakMap,le=new WeakMap,st=new WeakSet,ir=function(e){const t=[];let r=e===j;return[y(this,ie),y(this,le)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(s=>[s,a[e][s]]):[];n.length!==0?(r||(r=!0),t.push(...n)):e!==j&&t.push(...Object.keys(a[j]).map(s=>[s,a[j][s]]))}),r?ua(t):null},Ft),de,re,Wt,ma=(Wt=class{constructor(e){E(this,"name","SmartRouter");k(this,de,[]);k(this,re,[]);T(this,de,e.routers)}add(e,t,r){if(!y(this,re))throw new Error(rr);y(this,re).push([e,t,r])}match(e,t){if(!y(this,re))throw new Error("Fatal error");const r=y(this,de),a=y(this,re),n=r.length;let s=0,o;for(;s<n;s++){const i=r[s];try{for(let l=0,d=a.length;l<d;l++)i.add(...a[l]);o=i.match(e,t)}catch(l){if(l instanceof ar)continue;throw l}this.match=i.match.bind(i),T(this,de,[i]),T(this,re,void 0);break}if(s===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(y(this,re)||y(this,de).length!==1)throw new Error("No active router has been determined yet.");return y(this,de)[0]}},de=new WeakMap,re=new WeakMap,Wt),Me=Object.create(null),ce,H,be,Ae,P,ae,ge,Le,ha=(Le=class{constructor(t,r,a){k(this,ae);k(this,ce);k(this,H);k(this,be);k(this,Ae,0);k(this,P,Me);if(T(this,H,a||Object.create(null)),T(this,ce,[]),t&&r){const n=Object.create(null);n[t]={handler:r,possibleKeys:[],score:0},T(this,ce,[n])}T(this,be,[])}insert(t,r,a){T(this,Ae,++Ct(this,Ae)._);let n=this;const s=Gr(r),o=[];for(let i=0,l=s.length;i<l;i++){const d=s[i],u=s[i+1],m=Wr(d,u),f=Array.isArray(m)?m[0]:d;if(f in y(n,H)){n=y(n,H)[f],m&&o.push(m[1]);continue}y(n,H)[f]=new Le,m&&(y(n,be).push(m),o.push(m[1])),n=y(n,H)[f]}return y(n,ce).push({[t]:{handler:a,possibleKeys:o.filter((i,l,d)=>d.indexOf(i)===l),score:y(this,Ae)}}),n}search(t,r){var l;const a=[];T(this,P,Me);let s=[this];const o=Kt(r),i=[];for(let d=0,u=o.length;d<u;d++){const m=o[d],f=d===u-1,b=[];for(let g=0,_=s.length;g<_;g++){const c=s[g],h=y(c,H)[m];h&&(T(h,P,y(c,P)),f?(y(h,H)["*"]&&a.push(...O(this,ae,ge).call(this,y(h,H)["*"],t,y(c,P))),a.push(...O(this,ae,ge).call(this,h,t,y(c,P)))):b.push(h));for(let p=0,v=y(c,be).length;p<v;p++){const w=y(c,be)[p],x=y(c,P)===Me?{}:{...y(c,P)};if(w==="*"){const C=y(c,H)["*"];C&&(a.push(...O(this,ae,ge).call(this,C,t,y(c,P))),T(C,P,x),b.push(C));continue}const[S,R,L]=w;if(!m&&!(L instanceof RegExp))continue;const D=y(c,H)[S],A=o.slice(d).join("/");if(L instanceof RegExp){const C=L.exec(A);if(C){if(x[R]=C[0],a.push(...O(this,ae,ge).call(this,D,t,y(c,P),x)),Object.keys(y(D,H)).length){T(D,P,x);const G=((l=C[0].match(/\//))==null?void 0:l.length)??0;(i[G]||(i[G]=[])).push(D)}continue}}(L===!0||L.test(m))&&(x[R]=m,f?(a.push(...O(this,ae,ge).call(this,D,t,x,y(c,P))),y(D,H)["*"]&&a.push(...O(this,ae,ge).call(this,y(D,H)["*"],t,x,y(c,P)))):(T(D,P,x),b.push(D)))}}s=b.concat(i.shift()??[])}return a.length>1&&a.sort((d,u)=>d.score-u.score),[a.map(({handler:d,params:u})=>[d,u])]}},ce=new WeakMap,H=new WeakMap,be=new WeakMap,Ae=new WeakMap,P=new WeakMap,ae=new WeakSet,ge=function(t,r,a,n){const s=[];for(let o=0,i=y(t,ce).length;o<i;o++){const l=y(t,ce)[o],d=l[r]||l[j],u={};if(d!==void 0&&(d.params=Object.create(null),s.push(d),a!==Me||n&&n!==Me))for(let m=0,f=d.possibleKeys.length;m<f;m++){const b=d.possibleKeys[m],g=u[d.score];d.params[b]=n!=null&&n[b]&&!g?n[b]:a[b]??(n==null?void 0:n[b]),u[d.score]=!0}}return s},Le),we,qt,ga=(qt=class{constructor(){E(this,"name","TrieRouter");k(this,we);T(this,we,new ha)}add(e,t,r){const a=Yt(t);if(a){for(let n=0,s=a.length;n<s;n++)y(this,we).insert(e,a[n],r);return}y(this,we).insert(e,t,r)}match(e,t){return y(this,we).search(e,t)}},we=new WeakMap,qt),pe=class extends aa{constructor(e={}){super(e),this.router=e.router??new ma({routers:[new pa,new ga]})}},fa=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(s=>typeof s=="string"?s==="*"?()=>s:o=>s===o?o:null:typeof s=="function"?s:o=>s.includes(o)?o:null)(r.origin),n=(s=>typeof s=="function"?s:Array.isArray(s)?()=>s:()=>[])(r.allowMethods);return async function(o,i){var u;function l(m,f){o.res.headers.set(m,f)}const d=await a(o.req.header("origin")||"",o);if(d&&l("Access-Control-Allow-Origin",d),r.credentials&&l("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&l("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&l("Vary","Origin"),r.maxAge!=null&&l("Access-Control-Max-Age",r.maxAge.toString());const m=await n(o.req.header("origin")||"",o);m.length&&l("Access-Control-Allow-Methods",m.join(","));let f=r.allowHeaders;if(!(f!=null&&f.length)){const b=o.req.header("Access-Control-Request-Headers");b&&(f=b.split(/\s*,\s*/))}return f!=null&&f.length&&(l("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function lr(){return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`}const _t="AES-GCM",va=256;async function dr(e){const t=new TextEncoder,r=await crypto.subtle.importKey("raw",t.encode(e.padEnd(32,"0").slice(0,32)),{name:"PBKDF2"},!1,["deriveKey"]);return crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode("karna-salt-v1"),iterations:1e5,hash:"SHA-256"},r,{name:_t,length:va},!1,["encrypt","decrypt"])}async function Et(e,t){const r=await dr(t),a=crypto.getRandomValues(new Uint8Array(12)),n=new TextEncoder,s=await crypto.subtle.encrypt({name:_t,iv:a},r,n.encode(e)),o=new Uint8Array(a.length+new Uint8Array(s).length);return o.set(a),o.set(new Uint8Array(s),a.length),btoa(String.fromCharCode(...o))}async function N(e,t){const r=await dr(t),a=new Uint8Array(atob(e).split("").map(i=>i.charCodeAt(0))),n=a.slice(0,12),s=a.slice(12),o=await crypto.subtle.decrypt({name:_t,iv:n},r,s);return new TextDecoder().decode(o)}async function ot(e){const r=new TextEncoder().encode(e+"karna-pin-salt"),a=await crypto.subtle.digest("SHA-256",r);return btoa(String.fromCharCode(...new Uint8Array(a)))}async function cr(e,t){return await ot(e)===t}const ya=Object.freeze(Object.defineProperty({__proto__:null,decrypt:N,encrypt:Et,hashPin:ot,verifyPin:cr},Symbol.toStringTag,{value:"Module"})),me=new pe;me.get("/check",async e=>{const t=await e.env.DB.prepare("SELECT COUNT(*) as cnt FROM users").first();return e.json({hasUsers:((t==null?void 0:t.cnt)||0)>0})});me.post("/setup",async e=>{const{username:t,name:r,pin:a,personality_prompt:n,timezone:s}=await e.req.json();if(!t||!r||!a)return e.json({error:"Username, name, and PIN are required"},400);if(a.length<4)return e.json({error:"PIN must be at least 4 characters"},400);if(await e.env.DB.prepare("SELECT id FROM users WHERE username = ?").bind(t).first())return e.json({error:"Username already taken"},409);const i=await ot(a);await e.env.DB.prepare("INSERT INTO users (username, name, pin_hash, personality_prompt, timezone) VALUES (?, ?, ?, ?, ?)").bind(t,r,i,n||"",s||"Asia/Kolkata").run();const l=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first(),d=crypto.randomUUID(),u=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(d,l.id,"web",u).run(),e.json({success:!0,sessionId:d,user:{id:l.id,username:l.username,name:l.name}})});me.post("/login",async e=>{const{username:t,pin:r}=await e.req.json();if(!t||!r)return e.json({error:"Username and PIN required"},400);const a=await e.env.DB.prepare("SELECT * FROM users WHERE username = ?").bind(t).first();if(!a)return e.json({error:"User not found"},404);if(!await cr(r,a.pin_hash))return e.json({error:"Invalid PIN"},401);const s=crypto.randomUUID(),o=new Date(Date.now()+10080*60*1e3).toISOString();return await e.env.DB.prepare("INSERT INTO sessions (id, user_id, channel, expires_at) VALUES (?, ?, ?, ?)").bind(s,a.id,"web",o).run(),e.json({success:!0,sessionId:s,user:{id:a.id,username:a.username,name:a.name}})});me.post("/logout",async e=>{var r;const t=(r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ","");return t&&await e.env.DB.prepare("DELETE FROM sessions WHERE id = ?").bind(t).run(),e.json({success:!0})});me.get("/users/hints",async e=>{const r=((await e.env.DB.prepare("SELECT username, name, created_at FROM users ORDER BY created_at ASC").all()).results||[]).map(a=>{var n;return{username:a.username,name_hint:a.name.split(" ")[0],created:((n=a.created_at)==null?void 0:n.split(" ")[0])||""}});return e.json({users:r,count:r.length})});me.post("/reset-pin",async e=>{var i;const{username:t,name:r,new_pin:a}=await e.req.json();if(!t||!r||!a)return e.json({error:"Username, display name, and new PIN are required"},400);if(a.length<4)return e.json({error:"PIN must be at least 4 characters"},400);const n=await e.env.DB.prepare("SELECT id, username, name FROM users WHERE username = ?").bind(t).first();if(!n)return e.json({error:"User not found"},404);if(n.name.toLowerCase().trim()!==r.toLowerCase().trim())return e.json({error:"Display name does not match. This is required for identity verification."},403);const s=await ot(a);await e.env.DB.prepare("UPDATE users SET pin_hash = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(s,n.id).run();const o=await e.env.DB.prepare("DELETE FROM credentials WHERE user_id = ?").bind(n.id).run();return await e.env.DB.prepare("DELETE FROM sessions WHERE user_id = ?").bind(n.id).run(),e.json({success:!0,message:"PIN reset successfully. All API keys and credentials have been cleared (they were encrypted with your old PIN). Please log in with your new PIN and re-enter your API keys in Settings.",credentials_cleared:((i=o.meta)==null?void 0:i.changes)||0})});me.get("/me",async e=>{var a;const t=(a=e.req.header("Authorization"))==null?void 0:a.replace("Bearer ","");if(!t)return e.json({error:"No session"},401);const r=await e.env.DB.prepare(`SELECT s.*, u.id as uid, u.username, u.name, u.role, u.timezone 
     FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();return r?e.json({user:{id:r.uid,username:r.username,name:r.name,role:r.role,timezone:r.timezone}}):e.json({error:"Invalid or expired session"},401)});const Ue={anthropic:{id:"anthropic",label:"Anthropic Claude",apiBase:"https://api.anthropic.com",apiFormat:"anthropic",defaultModel:"claude-sonnet-4-20250514",keyPlaceholder:"sk-ant-api03-...",modelHint:"claude-sonnet-4-20250514, claude-haiku-4-20250514",validatePath:"/v1/messages"},openai:{id:"openai",label:"OpenAI GPT",apiBase:"https://api.openai.com",apiFormat:"openai-compatible",defaultModel:"gpt-4o",keyPlaceholder:"sk-...",modelHint:"gpt-4o, gpt-4o-mini, o3-mini",validatePath:"/v1/models"},grok:{id:"grok",label:"xAI Grok",apiBase:"https://api.x.ai",apiFormat:"openai-compatible",defaultModel:"grok-3-mini",keyPlaceholder:"xai-...",modelHint:"grok-3-mini, grok-3",validatePath:"/v1/models"},deepseek:{id:"deepseek",label:"DeepSeek",apiBase:"https://api.deepseek.com",apiFormat:"openai-compatible",defaultModel:"deepseek-chat",keyPlaceholder:"sk-...",modelHint:"deepseek-chat, deepseek-reasoner",validatePath:"/v1/models"},gemini:{id:"gemini",label:"Google Gemini",apiBase:"https://generativelanguage.googleapis.com/v1beta/openai",apiFormat:"openai-compatible",defaultModel:"gemini-2.0-flash",keyPlaceholder:"AIzaSy...",modelHint:"gemini-2.0-flash, gemini-2.5-pro-preview",validatePath:"/models"},openrouter:{id:"openrouter",label:"OpenRouter",apiBase:"https://openrouter.ai/api",apiFormat:"openai-compatible",defaultModel:"anthropic/claude-sonnet-4",keyPlaceholder:"sk-or-...",modelHint:"e.g. deepseek/deepseek-chat, meta-llama/llama-3.1-70b",validatePath:"/v1/models"},abacus:{id:"abacus",label:"Abacus AI (RouteLLM)",apiBase:"https://routellm.abacus.ai",apiFormat:"openai-compatible",defaultModel:"route-llm",keyPlaceholder:"Your Abacus API key",modelHint:"route-llm (auto), grok-4, deepseek-v3.2, claude-4-5-sonnet, gemini-3-flash",validatePath:"/v1/models"}};async function I(e,t,r,a,n,s={}){try{await e.prepare("INSERT INTO error_log (user_id, source, error_type, message, details) VALUES (?, ?, ?, ?, ?)").bind(t,r,a,n,JSON.stringify(s)).run()}catch(o){console.error("Failed to log error:",o)}}class ur{constructor(t,r="claude-sonnet-4-20250514",a="https://api.anthropic.com",n="anthropic"){E(this,"name");E(this,"apiKey");E(this,"model");E(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=a,this.name=n}async chat(t,r){var u,m,f,b;const a=t.find(g=>g.role==="system"),n=t.filter(g=>g.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:n.map(g=>({role:g.role,content:g.content}))};a&&(s.system=a.content),r!=null&&r.tools&&r.tools.length>0&&(s.tools=r.tools.map(g=>({name:g.name,description:g.description,input_schema:g.parameters})));const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const g=await o.text();throw new Error(this.name+" API error "+o.status+": "+g)}const i=await o.json(),l=((u=i.content)==null?void 0:u.filter(g=>g.type==="text"))||[],d=((m=i.content)==null?void 0:m.filter(g=>g.type==="tool_use"))||[];return{content:l.map(g=>g.text).join(`
`),toolCalls:d.map(g=>({id:g.id,name:g.name,arguments:g.input})),usage:{promptTokens:((f=i.usage)==null?void 0:f.input_tokens)||0,completionTokens:((b=i.usage)==null?void 0:b.output_tokens)||0}}}async streamChat(t,r){const a=t.find(d=>d.role==="system"),n=t.filter(d=>d.role!=="system"),s={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:n.map(d=>({role:d.role,content:d.content}))};a&&(s.system=a.content);const o=await fetch(this.apiBase+"/v1/messages",{method:"POST",headers:{"Content-Type":"application/json","x-api-key":this.apiKey,"anthropic-version":"2023-06-01"},body:JSON.stringify(s)});if(!o.ok){const d=await o.text();throw new Error(this.name+" stream error "+o.status+": "+d)}const i=o.body.getReader(),l=new TextDecoder;return new ReadableStream({async pull(d){var g;const{done:u,value:m}=await i.read();if(u){d.close();return}const b=l.decode(m,{stream:!0}).split(`
`);for(const _ of b)if(_.startsWith("data: ")){const c=_.slice(6);if(c==="[DONE]")continue;try{const h=JSON.parse(c);h.type==="content_block_delta"&&((g=h.delta)!=null&&g.text)&&d.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:h.delta.text})+`

`))}catch{}}}})}}function ba(e){const t={},r=e||{};if(t.type=r.type||"object",t.type==="object"){const a=r.properties;if(a&&typeof a=="object"&&Object.keys(a).length>0){const n={};for(const[s,o]of Object.entries(a))o&&typeof o=="object"?n[s]=ft(o):n[s]=o;t.properties=n}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(r.required)?t.required=r.required:t.required=[]}return r.description&&(t.description=r.description),t}function ft(e){const t={...e};if(t.type||(t.type="string"),t.type==="object"){const r=t.properties;if(r&&typeof r=="object"&&Object.keys(r).length>0){const a={};for(const[n,s]of Object.entries(r))s&&typeof s=="object"?a[n]=ft(s):a[n]=s;t.properties=a}else t.properties={_unused:{type:"string",description:"No parameters needed"}};Array.isArray(t.required)||(t.required=[])}return t.type==="array"&&t.items?typeof t.items=="object"&&(t.items=ft(t.items)):t.type==="array"&&!t.items&&(t.items={type:"string"}),t}class pr{constructor(t,r,a,n){E(this,"name");E(this,"apiKey");E(this,"model");E(this,"apiBase");this.apiKey=t,this.model=r,this.apiBase=a.replace(/\/+$/,""),this.name=n}async chat(t,r){var l,d,u,m,f,b;const a={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,messages:t.map(g=>({role:g.role,content:g.content}))},n=this.apiBase.includes("routellm.abacus.ai");r!=null&&r.tools&&r.tools.length>0&&!n&&(a.tools=r.tools.map(g=>({type:"function",function:{name:g.name,description:g.description,parameters:ba(g.parameters||{})}})));const s=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)});if(!s.ok){const g=await s.text();throw new Error(this.name+" API error "+s.status+": "+g)}const o=await s.json(),i=(l=o.choices)==null?void 0:l[0];return{content:((d=i==null?void 0:i.message)==null?void 0:d.content)||"",toolCalls:(m=(u=i==null?void 0:i.message)==null?void 0:u.tool_calls)==null?void 0:m.map(g=>({id:g.id,name:g.function.name,arguments:typeof g.function.arguments=="string"?JSON.parse(g.function.arguments||"{}"):g.function.arguments||{}})),usage:{promptTokens:((f=o.usage)==null?void 0:f.prompt_tokens)||0,completionTokens:((b=o.usage)==null?void 0:b.completion_tokens)||0}}}async streamChat(t,r){const a={model:this.model,max_tokens:(r==null?void 0:r.maxTokens)||4096,temperature:(r==null?void 0:r.temperature)??.7,stream:!0,messages:t.map(i=>({role:i.role,content:i.content}))},n=await fetch(this.apiBase+"/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:"Bearer "+this.apiKey},body:JSON.stringify(a)});if(!n.ok){const i=await n.text();throw new Error(this.name+" stream error "+n.status+": "+i)}const s=n.body.getReader(),o=new TextDecoder;return new ReadableStream({async pull(i){var f,b,g;const{done:l,value:d}=await s.read();if(l){i.close();return}const m=o.decode(d,{stream:!0}).split(`
`);for(const _ of m)if(_.startsWith("data: ")){const c=_.slice(6);if(c==="[DONE]")continue;try{const p=(g=(b=(f=JSON.parse(c).choices)==null?void 0:f[0])==null?void 0:b.delta)==null?void 0:g.content;p&&i.enqueue(new TextEncoder().encode("data: "+JSON.stringify({text:p})+`

`))}catch{}}}})}}function vt(e,t,r,a){const n=Ue[e];if(!n)throw new Error(`Unknown LLM provider: ${e}`);const s=a||n.defaultModel;return n.apiFormat==="anthropic"?new ur(t,s,n.apiBase,r):new pr(t,s,n.apiBase,r)}class mr{constructor(){E(this,"errorLog",new Map);E(this,"usageLog",new Map)}async pickProvider(t){const r=Date.now(),a=t.filter(n=>{const s=this.errorLog.get(n);return s?s.cooldownUntil<=r:!0});return a.length>0?a[0]:null}async recordUsage(t,r){const a=this.usageLog.get(t)||{tokens:0,requests:0};this.usageLog.set(t,{tokens:a.tokens+r,requests:a.requests+1})}async recordError(t,r,a=5){this.errorLog.set(t,{error:r,cooldownUntil:Date.now()+a*60*1e3})}}const wa=["llm_slot_1","llm_slot_2","llm_slot_3"],xa=["anthropic","openai"];async function Je(e,t,r){const{decrypt:a}=await Promise.resolve().then(()=>ya),n=new mr,s=[];for(const m of wa){const f=await e.prepare("SELECT encrypted_value, label FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(f)try{const b=await a(f.encrypted_value,r),g=JSON.parse(b);if(g.provider&&g.apiKey&&Ue[g.provider]){const c=g.provider,h=vt(g.provider,g.apiKey,c,g.model);s.push({name:c,provider:h})}}catch(b){console.error(`Failed to load ${m}:`,b)}}const o=new Set(s.map(m=>m.name));for(const m of xa){if(o.has(m))continue;const f=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,m).first();if(f)try{const b=await a(f.encrypted_value,r);if(Ue[m]){const _=vt(m,b,m);s.push({name:m,provider:_})}}catch{console.error(`Failed to decrypt legacy ${m} key`)}}if(s.length===0)throw new Error("No LLM provider configured. Please add at least one API key in Settings → Keys.");const i=s.map(m=>m.name),l=await n.pickProvider(i);if(!l)return console.warn("All providers in cooldown, using first available"),{provider:s[0].provider,rotation:n};const d=s.find(m=>m.name===l);return{provider:_a(d.provider,s,n),rotation:n}}function _a(e,t,r){return t.length<=1?e:{name:e.name,async chat(a,n){try{return await e.chat(a,n)}catch(s){const o=s.message||"";if(!(o.includes("401")||o.includes("403")||o.includes("authentication")||o.includes("credit balance")||o.includes("invalid")&&o.includes("key")||o.includes("properties field not found")))throw s;console.warn(`Provider ${e.name} auth/billing error, trying fallback...`),await r.recordError(e.name,o,1440);const l=t.filter(d=>d.name!==e.name);for(const d of l)try{const u=await d.provider.chat(a,n);return this.name=d.name,u}catch(u){const m=u.message||"";if(m.includes("401")||m.includes("403")||m.includes("authentication")||m.includes("credit balance")||m.includes("properties field not found")){await r.recordError(d.name,m,1440);continue}throw u}throw new Error(`All LLM providers failed. Primary (${e.name}): ${o.substring(0,150)}. Check your API keys in Settings → Keys.`)}},async streamChat(a,n){return await e.streamChat(a,n)}}}const yt=Object.freeze(Object.defineProperty({__proto__:null,ClaudeProvider:ur,OpenAICompatibleProvider:pr,ProviderRotation:mr,createProviderFromConfig:vt,createRotatingProvider:Je,logError:I},Symbol.toStringTag,{value:"Module"})),pt=20,Ea=2e3,Ta=2e3,hr=4;function ka(e){return Math.ceil(e.length/hr)}function Lt(e,t){const r=t*hr;return e.length<=r?e:e.slice(0,r)+`
[...truncated to fit token budget]`}class ue{constructor(t){this.db=t}async store(t,r,a,n,s=5,o="working"){const i=await this.db.prepare("SELECT id FROM memory WHERE user_id = ? AND type = ? AND title = ?").bind(t,r,a).first();i?await this.db.prepare("UPDATE memory SET content = ?, importance = ?, tier = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,s,o,i.id).run():await this.db.prepare("INSERT INTO memory (user_id, type, title, content, importance, tier) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,o).run(),o==="working"&&await this.enforceWorkingMemoryCap(t)}async enforceWorkingMemoryCap(t){const r=await this.db.prepare("SELECT COUNT(*) as cnt FROM memory WHERE user_id = ? AND tier = 'working'").bind(t).first();if(((r==null?void 0:r.cnt)||0)>pt){const a=((r==null?void 0:r.cnt)||0)-pt;await this.db.prepare(`UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP 
         ...
         )`).bind(t,t,a).run()}}async getWorkingMemory(t){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND tier = 'working' ORDER BY importance DESC, updated_at DESC LIMIT ?").bind(t,pt).all()).results||[]}async getAll(t,r,a=50){return r?(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND type = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,r,a).all()).results||[]:(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? ORDER BY tier ASC, importance DESC, updated_at DESC LIMIT ?").bind(t,a).all()).results||[]}async search(t,r,a=10){return(await this.db.prepare("SELECT * FROM memory WHERE user_id = ? AND (title LIKE ? OR content LIKE ?) ORDER BY importance DESC LIMIT ?").bind(t,`%${r}%`,`%${r}%`,a).all()).results||[]}async update(t,r,a){await this.db.prepare("UPDATE memory SET content = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(a,t,r).run()}async promote(t,r){await this.db.prepare("UPDATE memory SET tier = 'working', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,r).run(),await this.enforceWorkingMemoryCap(r)}async demote(t,r){await this.db.prepare("UPDATE memory SET tier = 'long_term', updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(t,r).run()}async remove(t,r){await this.db.prepare("DELETE FROM memory WHERE id = ? AND user_id = ?").bind(t,r).run()}async buildContext(t){const r=await this.getWorkingMemory(t);if(r.length===0)return"";const a={};for(const s of r)a[s.type]||(a[s.type]=[]),a[s.type].push(s);let n=`
## Working Memory (Active Context)
`;for(const[s,o]of Object.entries(a)){n+=`
### ${s.charAt(0).toUpperCase()+s.slice(1)}s
`;for(const i of o)n+=`- **${i.title}**: ${i.content}
`}return Lt(n,Ea)}static truncatePersonality(t){return Lt(t,Ta)}async getRecentConversations(t,r=20,a){return a?((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? AND thread_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,a,r).all()).results||[]).reverse():((await this.db.prepare("SELECT * FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?").bind(t,r).all()).results||[]).reverse()}async storeMessage(t,r,a,n,s="{}",o){const i=ka(n);o?await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate, thread_id) VALUES (?, ?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,i,o).run():await this.db.prepare("INSERT INTO conversations (user_id, channel, role, content, metadata, token_estimate) VALUES (?, ?, ?, ?, ?, ?)").bind(t,r,a,n,s,i).run()}async compactHistory(t,r=30){const a=await this.db.prepare("SELECT COUNT(*) as cnt FROM conversations WHERE user_id = ?").bind(t).first();((a==null?void 0:a.cnt)||0)<=r*2||await this.db.prepare(`DELETE FROM conversations WHERE user_id = ? AND id NOT IN (
        SELECT id FROM conversations WHERE user_id = ? ORDER BY created_at DESC LIMIT ?
      )`).bind(t,t,r).run()}}const Sa="https://accounts.google.com/o/oauth2/v2/auth",gr="https://oauth2.googleapis.com/token",Ia="https://www.googleapis.com/oauth2/v2/userinfo",Da=["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/calendar","https://www.googleapis.com/auth/documents","https://www.googleapis.com/auth/drive","https://www.googleapis.com/auth/gmail.readonly","https://www.googleapis.com/auth/gmail.send","https://www.googleapis.com/auth/gmail.compose","https://www.googleapis.com/auth/gmail.modify","https://www.googleapis.com/auth/userinfo.email","https://www.googleapis.com/auth/userinfo.profile"].join(" ");let X=null;async function bt(e,t,r){const a=await e.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(t,"google_oauth_tokens").first();if(!a)return null;try{const n=await N(a.encrypted_value,r);return JSON.parse(n)}catch{return null}}async function Ca(e,t,r,a){const n=await Et(JSON.stringify(a),r);await e.prepare(`INSERT INTO credentials (user_id, service, label, encrypted_value) 
     VALUES (?, 'google_oauth_tokens', 'Google Account', ?)
     ON CONFLICT(user_id, service) DO UPDATE SET 
       encrypted_value = excluded.encrypted_value,
       label = 'Google Account',
       updated_at = CURRENT_TIMESTAMP`).bind(t,n).run()}function fr(e,t,r){const a=new URLSearchParams({client_id:e,redirect_uri:t,response_type:"code",scope:Da,access_type:"offline",prompt:"consent",state:r,include_granted_scopes:"true"});return`${Sa}?${a}`}async function vr(e,t,r,a){const n=await fetch(gr,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({code:e,client_id:t,client_secret:r,redirect_uri:a,grant_type:"authorization_code"})}),s=await n.text();if(!n.ok)throw new Error(`Token exchange failed (${n.status}): ${s.substring(0,300)}`);return JSON.parse(s)}async function Oa(e,t,r){const a=await fetch(gr,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({refresh_token:e,client_id:t,client_secret:r,grant_type:"refresh_token"})}),n=await a.text();if(!a.ok)throw a.status===400||a.status===401?new Error("Google connection expired. Please reconnect your Google account in Settings → Keys."):new Error(`Token refresh failed (${a.status}): ${n.substring(0,300)}`);return JSON.parse(n)}async function yr(e){const t=await fetch(Ia,{headers:{Authorization:`Bearer ${e}`}});if(!t.ok)throw new Error(`Failed to fetch user info: ${t.status}`);return await t.json()}async function Ne(e,t,r,a,n){if(!a||!n)throw new Error("Google OAuth not configured. The deployer needs to set GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET as environment secrets.");if(X&&X.userId===t&&X.expiresAt>Date.now()/1e3+60){const i=await bt(e,t,r);return{token:X.token,email:(i==null?void 0:i.email)||"unknown"}}const s=await bt(e,t,r);if(!s)throw new Error('Google account not connected. Go to Settings → Keys → Google Workspace and click "Connect Google Account".');const o=await Oa(s.refresh_token,a,n);return X={userId:t,token:o.access_token,expiresAt:Math.floor(Date.now()/1e3)+o.expires_in},{token:o.access_token,email:s.email}}async function Tt(e,t,r){try{const a=await bt(e,t,r);return a?{connected:!0,email:a.email,connectedAt:a.connected_at}:{connected:!1}}catch{return{connected:!1}}}function br(e,t){return!!(e&&t&&e.includes(".apps.googleusercontent.com"))}async function wr(e,t,r,a,n,s,o){const i=await vr(a,s,o,n);if(!i.refresh_token)throw new Error("No refresh token received. Try disconnecting and reconnecting.");const l=await yr(i.access_token),d={refresh_token:i.refresh_token,email:l.email,name:l.name,connected_at:new Date().toISOString()};return await Ca(e,t,r,d),X={userId:t,token:i.access_token,expiresAt:Math.floor(Date.now()/1e3)+i.expires_in},{email:l.email,name:l.name}}async function xr(e,t){await e.prepare("DELETE FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(t).run(),(X==null?void 0:X.userId)===t&&(X=null)}const je="https://sheets.googleapis.com/v4/spreadsheets";class _r{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ne(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async readRange(t,r){const a=await this.authHeaders(),n=encodeURIComponent(r),s=await fetch(`${je}/${t}/values/${n}`,{headers:a});if(!s.ok){const i=await s.text();throw new Error(`Sheets read failed (${s.status}): ${i}`)}return(await s.json()).values||[]}async writeRange(t,r,a){const n=await this.authHeaders(),s=encodeURIComponent(r),o=await fetch(`${je}/${t}/values/${s}?valueInputOption=USER_ENTERED`,{method:"PUT",headers:n,body:JSON.stringify({range:r,majorDimension:"ROWS",values:a})});if(!o.ok){const l=await o.text();throw new Error(`Sheets write failed (${o.status}): ${l}`)}return{updatedCells:(await o.json()).updatedCells||0}}async appendRows(t,r,a){var l;const n=await this.authHeaders(),s=encodeURIComponent(r),o=await fetch(`${je}/${t}/values/${s}:append?valueInputOption=USER_ENTERED&insertDataOption=INSERT_ROWS`,{method:"POST",headers:n,body:JSON.stringify({range:r,majorDimension:"ROWS",values:a})});if(!o.ok){const d=await o.text();throw new Error(`Sheets append failed (${o.status}): ${d}`)}return{updatedCells:((l=(await o.json()).updates)==null?void 0:l.updatedCells)||a.length}}async createSpreadsheet(t,r){const a=await this.authHeaders(),n={properties:{title:t},sheets:r&&r.length>0?r.map(i=>({properties:{title:i}})):[{properties:{title:"Sheet1"}}]},s=await fetch(je,{method:"POST",headers:a,body:JSON.stringify(n)});if(!s.ok){const i=await s.text();throw new Error(`Sheets create failed (${s.status}): ${i}`)}const o=await s.json();return{spreadsheetId:o.spreadsheetId,url:`https://docs.google.com/spreadsheets/d/${o.spreadsheetId}/edit`}}async getMetadata(t){const r=await this.authHeaders(),a=await fetch(`${je}/${t}?fields=properties.title,sheets.properties.title`,{headers:r});if(!a.ok){const s=await a.text();throw new Error(`Sheets metadata failed (${a.status}): ${s}`)}const n=await a.json();return{title:n.properties.title,sheets:n.sheets.map(s=>s.properties.title)}}}const Be="https://www.googleapis.com/calendar/v3";class kt{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ne(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listEvents(t="primary",r={}){const a=await this.authHeaders(),n=new URLSearchParams;r.timeMin&&n.set("timeMin",r.timeMin),r.timeMax&&n.set("timeMax",r.timeMax),n.set("maxResults",String(r.maxResults||20)),n.set("singleEvents","true"),n.set("orderBy","startTime"),r.query&&n.set("q",r.query);const s=await fetch(`${Be}/calendars/${encodeURIComponent(t)}/events?${n}`,{headers:a});if(!s.ok){const i=await s.text();throw new Error(`Calendar list failed (${s.status}): ${i}`)}return(await s.json()).items||[]}async createEvent(t="primary",r){var i;const a=await this.authHeaders(),n=r.timeZone||"Asia/Kolkata",s={summary:r.summary,description:r.description||"",location:r.location||"",start:{dateTime:r.startDateTime,timeZone:n},end:{dateTime:r.endDateTime,timeZone:n}};(i=r.attendees)!=null&&i.length&&(s.attendees=r.attendees.map(l=>({email:l})));const o=await fetch(`${Be}/calendars/${encodeURIComponent(t)}/events`,{method:"POST",headers:a,body:JSON.stringify(s)});if(!o.ok){const l=await o.text();throw new Error(`Calendar create failed (${o.status}): ${l}`)}return await o.json()}async updateEvent(t="primary",r,a){const n=await this.authHeaders(),s=a.timeZone||"Asia/Kolkata",o={};a.summary&&(o.summary=a.summary),a.description&&(o.description=a.description),a.location&&(o.location=a.location),a.startDateTime&&(o.start={dateTime:a.startDateTime,timeZone:s}),a.endDateTime&&(o.end={dateTime:a.endDateTime,timeZone:s});const i=await fetch(`${Be}/calendars/${encodeURIComponent(t)}/events/${r}`,{method:"PATCH",headers:n,body:JSON.stringify(o)});if(!i.ok){const l=await i.text();throw new Error(`Calendar update failed (${i.status}): ${l}`)}return await i.json()}async deleteEvent(t="primary",r){const a=await this.authHeaders(),n=await fetch(`${Be}/calendars/${encodeURIComponent(t)}/events/${r}`,{method:"DELETE",headers:a});if(!n.ok&&n.status!==410){const s=await n.text();throw new Error(`Calendar delete failed (${n.status}): ${s}`)}}async listCalendars(){const t=await this.authHeaders(),r=await fetch(`${Be}/users/me/calendarList`,{headers:t});if(!r.ok){const n=await r.text();throw new Error(`Calendar list calendars failed (${r.status}): ${n}`)}return((await r.json()).items||[]).map(n=>({id:n.id,summary:n.summary,primary:n.primary||!1}))}}const Ze="https://docs.googleapis.com/v1/documents",Ra="https://www.googleapis.com/drive/v3/files";class Er{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ne(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async createDocument(t){const r=await this.authHeaders(),a=await fetch(Ze,{method:"POST",headers:r,body:JSON.stringify({title:t})});if(!a.ok){const s=await a.text();throw new Error(`Docs create failed (${a.status}): ${s}`)}const n=await a.json();return{documentId:n.documentId,url:`https://docs.google.com/document/d/${n.documentId}/edit`}}async readDocument(t){var o,i;const r=await this.authHeaders(),a=await fetch(`${Ze}/${t}`,{headers:r});if(!a.ok){const l=await a.text();throw new Error(`Docs read failed (${a.status}): ${l}`)}const n=await a.json();let s="";for(const l of((o=n.body)==null?void 0:o.content)||[])if(l.paragraph)for(const d of l.paragraph.elements)(i=d.textRun)!=null&&i.content&&(s+=d.textRun.content);return{title:n.title,content:s.trim()}}async appendText(t,r){const a=await this.authHeaders(),n=await fetch(`${Ze}/${t}`,{headers:a});if(!n.ok){const l=await n.text();throw new Error(`Docs read for append failed (${n.status}): ${l}`)}const s=await n.json(),o=s.body.content[s.body.content.length-1].endIndex-1,i=await fetch(`${Ze}/${t}:batchUpdate`,{method:"POST",headers:a,body:JSON.stringify({requests:[{insertText:{location:{index:o},text:r}}]})});if(!i.ok){const l=await i.text();throw new Error(`Docs append failed (${i.status}): ${l}`)}}async shareDocument(t,r,a="writer"){const n=await this.authHeaders(),s=await fetch(`${Ra}/${t}/permissions`,{method:"POST",headers:n,body:JSON.stringify({type:"user",role:a,emailAddress:r})});if(!s.ok){const o=await s.text();throw new Error(`Share failed (${s.status}): ${o}`)}}}class V{constructor(t,r,a,n,s){E(this,"sheets");E(this,"calendar");E(this,"docs");E(this,"db");E(this,"userId");E(this,"pinHash");this.db=t,this.userId=r,this.pinHash=a,this.sheets=new _r(t,r,a,n,s),this.calendar=new kt(t,r,a,n,s),this.docs=new Er(t,r,a,n,s)}async isConnected(){return Tt(this.db,this.userId,this.pinHash)}}const Qe=Object.freeze(Object.defineProperty({__proto__:null,GoogleCalendar:kt,GoogleDocs:Er,GoogleServices:V,GoogleSheets:_r,completeOAuthFlow:wr,disconnectGoogle:xr,exchangeCodeForTokens:vr,fetchUserInfo:yr,generateAuthUrl:fr,getGoogleAuth:Ne,isGoogleConnected:Tt,isOAuthClientConfigured:br},Symbol.toStringTag,{value:"Module"}));async function Aa(e,t,r={}){const a={textQuery:t,languageCode:"en",pageSize:8};if(r.type&&(a.includedType=r.type),r.location){const l=r.location.split(",").map(Number);l.length===2&&!isNaN(l[0])&&!isNaN(l[1])&&(a.locationBias={circle:{center:{latitude:l[0],longitude:l[1]},radius:r.radius||5e3}})}const n=["places.displayName","places.formattedAddress","places.rating","places.userRatingCount","places.priceLevel","places.currentOpeningHours","places.types","places.id","places.location","places.googleMapsUri"].join(","),s=await fetch("https://places.googleapis.com/v1/places:searchText",{method:"POST",headers:{"Content-Type":"application/json","X-Goog-Api-Key":e,"X-Goog-FieldMask":n},body:JSON.stringify(a)});if(!s.ok){const l=await s.text();return{results:[],error:`Places API error (${s.status}): ${l.substring(0,200)}`}}const o=await s.json();return!o.places||o.places.length===0?{results:[]}:{results:o.places.map(l=>{var d,u,m;return{name:((d=l.displayName)==null?void 0:d.text)||"",address:l.formattedAddress||"",rating:l.rating,userRatingsTotal:l.userRatingCount,priceLevel:l.priceLevel,openNow:(u=l.currentOpeningHours)==null?void 0:u.openNow,types:(m=l.types)==null?void 0:m.slice(0,5),placeId:l.id||"",location:l.location?{lat:l.location.latitude,lng:l.location.longitude}:void 0,googleMapsUri:l.googleMapsUri}})}}async function La(e,t){var s,o,i;const r=["displayName","formattedAddress","internationalPhoneNumber","websiteUri","rating","reviews","currentOpeningHours","location","googleMapsUri"].join(","),a=await fetch(`https://places.googleapis.com/v1/places/${t}`,{method:"GET",headers:{"X-Goog-Api-Key":e,"X-Goog-FieldMask":r}});if(!a.ok){const l=await a.text();return{error:`Place Details API error (${a.status}): ${l.substring(0,200)}`}}const n=await a.json();return{details:{name:((s=n.displayName)==null?void 0:s.text)||"",address:n.formattedAddress||"",phone:n.internationalPhoneNumber,website:n.websiteUri,rating:n.rating,reviews:(o=n.reviews)==null?void 0:o.slice(0,3).map(l=>{var d,u,m;return{author:((d=l.authorAttribution)==null?void 0:d.displayName)||"Anonymous",rating:l.rating||0,text:((m=(u=l.text)==null?void 0:u.text)==null?void 0:m.substring(0,200))||"",time:l.relativePublishTimeDescription||""}}),openingHours:(i=n.currentOpeningHours)==null?void 0:i.weekdayDescriptions,location:n.location?{lat:n.location.latitude,lng:n.location.longitude}:void 0,googleMapsUri:n.googleMapsUri}}}async function Na(e,t,r,a={}){var d;const n=new URLSearchParams({origin:t,destination:r,key:e,mode:a.mode||"driving"});(a.mode==="driving"||!a.mode)&&n.set("departure_time","now");const s=await fetch(`https://maps.googleapis.com/maps/api/directions/json?${n}`);if(!s.ok)return{error:`Directions API error: ${s.status}`};const o=await s.json();if(o.status!=="OK")return{error:`Directions: ${o.status} — ${o.error_message||""}`};const i=o.routes[0],l=i.legs[0];return{route:{summary:i.summary,distance:l.distance.text,duration:l.duration.text,durationInTraffic:(d=l.duration_in_traffic)==null?void 0:d.text,steps:l.steps.slice(0,10).map(u=>{var m,f,b;return{instruction:((m=u.html_instructions)==null?void 0:m.replace(/<[^>]*>/g,""))||"",distance:((f=u.distance)==null?void 0:f.text)||"",duration:((b=u.duration)==null?void 0:b.text)||""}}),startAddress:l.start_address,endAddress:l.end_address}}}async function $a(e,t,r,a){var l,d;const n={q:t,target:r,key:e,format:"text"};a&&(n.source=a);const s=await fetch("https://translation.googleapis.com/language/translate/v2",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const u=await s.text();return{translatedText:"",error:`Translate API error (${s.status}): ${u.substring(0,200)}`}}const i=(d=(l=(await s.json()).data)==null?void 0:l.translations)==null?void 0:d[0];return i?{translatedText:i.translatedText,detectedSourceLang:i.detectedSourceLanguage}:{translatedText:"",error:"No translation returned."}}async function Ma(e,t){const r=new URLSearchParams({address:t,key:e}),a=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?${r}`);if(!a.ok)return{results:[],error:`Geocoding API error: ${a.status}`};const n=await a.json();return n.status!=="OK"&&n.status!=="ZERO_RESULTS"?{results:[],error:`Geocoding: ${n.status} — ${n.error_message||""}`}:{results:(n.results||[]).slice(0,5).map(s=>{var o;return{address:s.formatted_address,lat:s.geometry.location.lat,lng:s.geometry.location.lng,placeId:s.place_id,types:(o=s.types)==null?void 0:o.slice(0,3)}})}}async function ja(e,t,r={}){const a=new URLSearchParams({part:"snippet",q:t,key:e,type:r.type||"video",maxResults:String(r.maxResults||5),order:r.order||"relevance"}),n=await fetch(`https://www.googleapis.com/youtube/v3/search?${a}`);if(!n.ok){const o=await n.text();return{results:[],error:`YouTube API error (${n.status}): ${o.substring(0,200)}`}}return{results:((await n.json()).items||[]).map(o=>{var i,l,d,u,m,f,b,g;return{title:o.snippet.title,channelTitle:o.snippet.channelTitle,description:(i=o.snippet.description)==null?void 0:i.substring(0,200),videoId:((l=o.id)==null?void 0:l.videoId)||((d=o.id)==null?void 0:d.channelId)||((u=o.id)==null?void 0:u.playlistId)||"",publishedAt:o.snippet.publishedAt,url:(m=o.id)!=null&&m.videoId?`https://www.youtube.com/watch?v=${o.id.videoId}`:(f=o.id)!=null&&f.channelId?`https://www.youtube.com/channel/${o.id.channelId}`:"",thumbnailUrl:(g=(b=o.snippet.thumbnails)==null?void 0:b.medium)==null?void 0:g.url}})}}async function St(e,t={}){const r=Math.min(t.num||5,10),a=t.site?`site:${t.site} ${e}`:e;try{const n=new URLSearchParams({q:a}),s=await fetch(`https://html.duckduckgo.com/html/?${n}`,{method:"GET",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36"}});if(!s.ok)return{results:[],error:`Search request failed (${s.status})`};const o=await s.text(),i=[],l=o.split(/class="result results_links/g).slice(1);for(const d of l){if(i.length>=r)break;const u=d.match(/class="result__a"[^>]*href="([^"]*)"[^>]*>([\s\S]*?)<\/a>/),m=d.match(/class="result__snippet"[^>]*>([\s\S]*?)<\/a>/);if(u){let f=u[1];const b=f.match(/uddg=([^&]+)/);b?f=decodeURIComponent(b[1]):f.startsWith("//")&&(f="https:"+f);const g=h=>h.replace(/<[^>]*>/g,"").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#x27;/g,"'").replace(/&quot;/g,'"').replace(/&#39;/g,"'").trim(),_=g(u[2]),c=m?g(m[1]):"";if(_&&f.startsWith("http")){const h=f.replace(/^https?:\/\/(www\.)?/,"").split("/")[0];i.push({title:_,link:f,snippet:c,displayLink:h})}}}return i.length===0?{results:[],error:void 0}:{results:i}}catch(n){return{results:[],error:`Web search error: ${n.message}`}}}async function Ba(e,t,r,a="driving"){var l,d,u,m;const n=new URLSearchParams({origins:t,destinations:r,key:e,mode:a,departure_time:"now"}),s=await fetch(`https://maps.googleapis.com/maps/api/distancematrix/json?${n}`);if(!s.ok)return{distance:"",duration:"",error:`Distance Matrix error: ${s.status}`};const o=await s.json(),i=(u=(d=(l=o.rows)==null?void 0:l[0])==null?void 0:d.elements)==null?void 0:u[0];return!i||i.status!=="OK"?{distance:"",duration:"",error:`No route found: ${(i==null?void 0:i.status)||o.status}`}:{distance:i.distance.text,duration:i.duration.text,durationInTraffic:(m=i.duration_in_traffic)==null?void 0:m.text}}const Z="https://gmail.googleapis.com/gmail/v1/users/me";class Q{constructor(t,r,a,n,s){this.db=t,this.userId=r,this.pinHash=a,this.clientId=n,this.clientSecret=s}async authHeaders(){const{token:t}=await Ne(this.db,this.userId,this.pinHash,this.clientId,this.clientSecret);return{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}async listMessages(t={}){var i;const r=await this.authHeaders(),a=new URLSearchParams;if(a.set("maxResults",String(t.maxResults||10)),t.query&&a.set("q",t.query),(i=t.labelIds)!=null&&i.length)for(const l of t.labelIds)a.append("labelIds",l);const n=await fetch(`${Z}/messages?${a}`,{headers:r});if(!n.ok){const l=await n.text();throw new Error(`Gmail list failed (${n.status}): ${l.substring(0,200)}`)}const s=await n.json();if(!s.messages||s.messages.length===0)return[];const o=[];for(const l of s.messages.slice(0,t.maxResults||10))try{const d=await this.getMessage(l.id,r);d&&o.push(d)}catch{}return o}async getMessage(t,r){const a=r||await this.authHeaders(),n=await fetch(`${Z}/messages/${t}?format=metadata&metadataHeaders=Subject&metadataHeaders=From&metadataHeaders=To&metadataHeaders=Date`,{headers:a});if(!n.ok)return null;const s=await n.json(),o=i=>{var l,d,u;return((u=(d=(l=s.payload)==null?void 0:l.headers)==null?void 0:d.find(m=>m.name.toLowerCase()===i.toLowerCase()))==null?void 0:u.value)||""};return{id:s.id,threadId:s.threadId,snippet:s.snippet||"",subject:o("Subject")||"(no subject)",from:o("From"),to:o("To"),date:o("Date")||new Date(parseInt(s.internalDate)).toISOString(),isUnread:(s.labelIds||[]).includes("UNREAD"),labels:s.labelIds||[]}}async getMessageBody(t){const r=await this.authHeaders(),a=await fetch(`${Z}/messages/${t}?format=full`,{headers:r});if(!a.ok){const s=await a.text();throw new Error(`Gmail message body failed (${a.status}): ${s.substring(0,200)}`)}const n=await a.json();return Tr(n.payload)}async search(t,r=10){return this.listMessages({query:t,maxResults:r})}async send(t,r,a,n={}){const s=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${r}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8"];n.cc&&o.push(`Cc: ${n.cc}`),n.bcc&&o.push(`Bcc: ${n.bcc}`),n.replyToMessageId&&(o.push(`In-Reply-To: ${n.replyToMessageId}`),o.push(`References: ${n.replyToMessageId}`)),o.push("",a);const i=o.join(`\r
`),d={raw:btoa(unescape(encodeURIComponent(i))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")};n.threadId&&(d.threadId=n.threadId);const u=await fetch(`${Z}/messages/send`,{method:"POST",headers:s,body:JSON.stringify(d)});if(!u.ok){const m=await u.text();throw new Error(`Gmail send failed (${u.status}): ${m.substring(0,200)}`)}return await u.json()}async createDraft(t,r,a){const n=await this.authHeaders(),o=[`To: ${t}`,`Subject: ${r}`,"MIME-Version: 1.0","Content-Type: text/plain; charset=UTF-8","",a].join(`\r
`),i=btoa(unescape(encodeURIComponent(o))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,""),l=await fetch(`${Z}/drafts`,{method:"POST",headers:n,body:JSON.stringify({message:{raw:i}})});if(!l.ok){const d=await l.text();throw new Error(`Gmail draft failed (${l.status}): ${d.substring(0,200)}`)}return await l.json()}async markAsRead(t){const r=await this.authHeaders();await fetch(`${Z}/messages/${t}/modify`,{method:"POST",headers:r,body:JSON.stringify({removeLabelIds:["UNREAD"]})})}async modifyMessage(t,r){const a=await this.authHeaders();let n={};switch(r){case"archive":n={removeLabelIds:["INBOX"]};break;case"trash":n={addLabelIds:["TRASH"]};break;case"read":n={removeLabelIds:["UNREAD"]};break;case"unread":n={addLabelIds:["UNREAD"]};break;case"star":n={addLabelIds:["STARRED"]};break;case"unstar":n={removeLabelIds:["STARRED"]};break}const s=await fetch(`${Z}/messages/${t}/modify`,{method:"POST",headers:{...a,"Content-Type":"application/json"},body:JSON.stringify(n)});if(!s.ok){const o=await s.text();throw new Error(`Failed to modify message: ${o}`)}return!0}async getUnreadCount(){const t=await this.authHeaders(),r=await fetch(`${Z}/labels/INBOX`,{headers:t});return r.ok&&(await r.json()).messagesUnread||0}async getProfile(){const t=await this.authHeaders(),r=await fetch(`${Z}/profile`,{headers:t});if(!r.ok)throw new Error("Failed to get Gmail profile");return await r.json()}}function Tr(e){var t,r,a;if(!e)return"";if((t=e.body)!=null&&t.data)return mt(e.body.data);if(e.parts){for(const n of e.parts)if(n.mimeType==="text/plain"&&((r=n.body)!=null&&r.data))return mt(n.body.data);for(const n of e.parts)if(n.mimeType==="text/html"&&((a=n.body)!=null&&a.data)){const s=mt(n.body.data);return Pa(s)}for(const n of e.parts)if(n.parts){const s=Tr(n);if(s)return s}}return e.snippet||""}function mt(e){const t=e.replace(/-/g,"+").replace(/_/g,"/");try{return decodeURIComponent(escape(atob(t)))}catch{return atob(t)}}function Pa(e){return e.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,"").replace(/<script[^>]*>[\s\S]*?<\/script>/gi,"").replace(/<br\s*\/?>/gi,`
`).replace(/<\/p>/gi,`
`).replace(/<\/div>/gi,`
`).replace(/<[^>]+>/g,"").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/\n{3,}/g,`

`).trim()}const Ha=8e3,Ua=8e3;async function kr(e,t){try{const r=new AbortController,a=setTimeout(()=>r.abort(),Ua),n=await fetch(e,{signal:r.signal,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36",Accept:"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"},redirect:"follow"});if(clearTimeout(a),!n.ok)return{text:"",error:`HTTP ${n.status}`};const s=n.headers.get("content-type")||"";if(!s.includes("text/html")&&!s.includes("text/plain")&&!s.includes("application/xhtml"))return{text:"",error:`Non-HTML content: ${s.split(";")[0]}`};const o=await n.text(),i=Ga(o);return i.length<50?{text:"",error:"Page has too little readable content"}:{text:i.substring(0,t||Ha)}}catch(r){return{text:"",error:r.name==="AbortError"?"Timeout":r.message}}}function Ga(e){let t=e;return t=t.replace(/<script[\s\S]*?<\/script>/gi,""),t=t.replace(/<style[\s\S]*?<\/style>/gi,""),t=t.replace(/<nav[\s\S]*?<\/nav>/gi,""),t=t.replace(/<footer[\s\S]*?<\/footer>/gi,""),t=t.replace(/<header[\s\S]*?<\/header>/gi,""),t=t.replace(/<aside[\s\S]*?<\/aside>/gi,""),t=t.replace(/<noscript[\s\S]*?<\/noscript>/gi,""),t=t.replace(/<!--[\s\S]*?-->/g,""),t=t.replace(/<\/?(p|div|br|h[1-6]|li|tr|blockquote|section|article)[^>]*>/gi,`
`),t=t.replace(/<li[^>]*>/gi,`
...
`),t.trim()}async function Sr(e,t,r={}){const a=r.maxPages||(r.depth==="thorough"?5:3),n=r.maxResults||(r.depth==="thorough"?8:5),s=await St(e,{num:n,site:r.site});if(s.error)return{report:"",sources:[],pagesRead:0,error:`Search failed: ${s.error}`};if(s.results.length===0)return{report:`No web results found for "${e}".`,sources:[],pagesRead:0};const i=s.results.slice(0,a).map(async f=>{const b=await kr(f.link);return{title:f.title,url:f.link,displayLink:f.displayLink,snippet:f.snippet,content:b.text,error:b.error}}),d=(await Promise.all(i)).filter(f=>f.content.length>50);if(d.length===0){const f=s.results.map((g,_)=>`[${_+1}] ${g.title}
${g.snippet}
Source: ${g.link}`).join(`

`);return{report:await Nt(e,f,t,"snippets"),sources:s.results.map(g=>({title:g.title,url:g.link})),pagesRead:0}}const u=d.map((f,b)=>`--- SOURCE ${b+1}: ${f.title} (${f.displayLink}) ---
${f.content}
--- END SOURCE ${b+1} ---`).join(`

`);return{report:await Nt(e,u,t,"full"),sources:d.map(f=>({title:f.title,url:f.url})),pagesRead:d.length}}async function Nt(e,t,r,a){const s=`You are a research analyst. Your job is to synthesize web research into clear, actionable reports.
...
Note: Always use this date/time as the current time. Do NOT guess or use UTC.`}async function Mt(e,t,r){var d;const n=await(await fetch(`https://www.googleapis.com/drive/v3/files?q=${encodeURIComponent(`name='${r.replace(/'/g,"\\'")}' and mimeType='application/vnd.google-apps.folder' and trashed=false`)}&fields=files(id,name)`,{headers:{Authorization:`Bearer ${e}`}})).json();let s;((d=n.files)==null?void 0:d.length)>0?s=n.files[0].id:s=(await(await fetch("https://www.googleapis.com/drive/v3/files",{method:"POST",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({name:r,mimeType:"application/vnd.google-apps.folder"})})).json()).id;const l=((await(await fetch(`https://www.googleapis.com/drive/v3/files/${t}?fields=parents`,{headers:{Authorization:`Bearer ${e}`}})).json()).parents||[]).join(",");return await fetch(`https://www.googleapis.com/drive/v3/files/${t}?addParents=${s}&removeParents=${l}`,{method:"PATCH",headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/json"},body:JSON.stringify({})}),{folderId:s,folderName:r}}function qa(e){try{const t=new Date;return new Intl.DateTimeFormat("en-US",{timeZone:e,weekday:"long",year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0}).format(t)}catch{return new Date().toISOString()}}async function Or(e,t,r,a,n,s,o,i,l,d,u){var f,b,g,_;const m=new ue(r);switch(e){case"create_schedule":{const c=new Date;let h;const p=d||"UTC";if(t.schedule_type==="interval"){const v=parseInt(t.schedule_value,10);h=new Date(c.getTime()+v*60*1e3)}else if(t.schedule_type==="daily"){const[v,w]=t.schedule_value.split(":").map(Number),x=c.toLocaleString("en-US",{timeZone:p}),S=new Date(x),R=new Date(S);R.setHours(v,w,0,0),R<=S&&R.setDate(R.getDate()+1);const L=new Date(R.toLocaleString("en-US",{timeZone:"UTC"})),D=new Date(R.toLocaleString("en-US",{timeZone:p})),A=L.getTime()-D.getTime();h=new Date(R.getTime()+A)}else if(t.schedule_type==="weekly"){const[v,w]=t.schedule_value.split(" "),[x,S]=(w||"00:00").split(":").map(Number),L=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].findIndex(Lr=>Lr.toLowerCase()===v.toLowerCase()),D=c.toLocaleString("en-US",{timeZone:p}),A=new Date(D),C=new Date(A);C.setHours(x,S,0,0);let G=(L-C.getDay()+7)%7;G===0&&C<=A&&(G=7),C.setDate(C.getDate()+G);const Ve=new Date(C.toLocaleString("en-US",{timeZone:"UTC"})),it=new Date(C.toLocaleString("en-US",{timeZone:p})),lt=Ve.getTime()-it.getTime();h=new Date(C.getTime()+lt)}else if(t.schedule_type==="once"){const[v,w]=t.schedule_value.split(" "),[x,S,R]=v.split("-").map(Number),[L,D]=(w||"00:00").split(":").map(Number),A=c.toLocaleString("en-US",{timeZone:p}),C=new Date(A),G=new Date(C);G.setFullYear(x,S-1,R),G.setHours(L,D,0,0);const Ve=new Date(G.toLocaleString("en-US",{timeZone:"UTC"})),it=new Date(G.toLocaleString("en-US",{timeZone:p})),lt=Ve.getTime()-it.getTime();h=new Date(G.getTime()+lt)}else h=new Date(c.getTime()+3600*1e3);return await r.prepare(`INSERT INTO cron_jobs (user_id, name, description, schedule_type, schedule_value, action_type, action_config, next_run, state)
...
`)}case"toggle_schedule":{const c=t.enabled?1:0,h=c?"active":"paused";return await r.prepare("UPDATE cron_jobs SET enabled = ?, state = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(c,h,t.job_id,a).run(),`Schedule ${t.job_id} ${c?"enabled (active)":"paused"}.`}case"update_schedule_state":{const c=["created","active","reminding","paused","completed"],h=t.state;if(!c.includes(h))return`Invalid state "${h}". Valid states: ${c.join(", ")}`;const p=h==="completed"||h==="paused"?0:1;return await r.prepare("UPDATE cron_jobs SET state = ?, enabled = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND user_id = ?").bind(h,p,t.job_id,a).run(),`Schedule ${t.job_id} state updated to "${h}".`}case"delete_schedule":return await r.prepare("DELETE FROM cron_jobs WHERE id = ? AND user_id = ?").bind(t.job_id,a).run(),`Schedule ${t.job_id} deleted.`;case"store_memory":{const c=t.importance||5,h=c>=7?"working":"long_term";return await m.store(a,t.type,t.title,t.content,c,h),`Stored in ${h==="working"?"working":"long-term"} memory: [${t.type}] ${t.title} (importance: ${c})`}case"search_memory":{const c=await m.search(a,t.query);return c.length===0?"No matching memories found.":c.map(h=>`[${h.tier||"long_term"}] [${h.type}] **${h.title}**: ${h.content}`).join(`
...
- Unread errors: ${(w==null?void 0:w.cnt)||0}`}case"read_sheet":{if(!n)return"Authentication context unavailable.";try{const h=await new V(r,a,n,s||"",o||"").sheets.readRange(t.spreadsheet_id,t.range);return h.length===0?"No data found in the specified range.":h.map(p=>p.join("	| ")).join(`
`)}catch(c){return await I(r,a,"google","read_sheet",c.message),`Failed to read sheet: ${c.message}`}}case"write_sheet":{if(!n)return"Authentication context unavailable.";try{return`Written ${(await new V(r,a,n,s||"",o||"").sheets.writeRange(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await I(r,a,"google","write_sheet",c.message),`Failed to write sheet: ${c.message}`}}case"append_sheet":{if(!n)return"Authentication context unavailable.";try{return`Appended ${(await new V(r,a,n,s||"",o||"").sheets.appendRows(t.spreadsheet_id,t.range,t.values)).updatedCells} cells to ${t.range}.`}catch(c){return await I(r,a,"google","append_sheet",c.message),`Failed to append to sheet: ${c.message}`}}case"create_sheet":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.sheets.createSpreadsheet(t.title,t.sheet_names);let v="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||"");v=`
Folder: "${(await Mt(w,p.spreadsheetId,t.folder_name)).folderName}"`}catch(w){v=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ue(r).store(a,"context",`Spreadsheet: ${t.title}`,`Spreadsheet ID: ${p.spreadsheetId} | URL: ${p.url} | Sheets: ${(t.sheet_names||["Sheet1"]).join(", ")}`,7,"working")}catch{}return`Spreadsheet created: "${t.title}"${v}
ID: ${p.spreadsheetId}
URL: ${p.url}`}catch(c){return await I(r,a,"google","create_sheet",c.message),`Failed to create spreadsheet: ${c.message}`}}case"list_calendar_events":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||""),h=t.calendar_id||"primary",p=t.days_ahead||7,v=new Date,w=new Date(v.getTime()+p*24*60*60*1e3),x=await c.calendar.listEvents(h,{timeMin:v.toISOString(),timeMax:w.toISOString(),query:t.query});return x.length===0?`No events found in the next ${p} days.`:x.map(S=>{var C;const R=S.start.dateTime||S.start.date||"TBD",L=S.end.dateTime||S.end.date||"",D=S.location?` 📍 ${S.location}`:"",A=((C=S.attendees)==null?void 0:C.map(G=>G.email).join(", "))||"";return`• ${S.summary} — ${R} to ${L}${D}${A?`
  Attendees: ${A}`:""}`}).join(`
`)}catch(c){return await I(r,a,"google","list_calendar",c.message),`Failed to list events: ${c.message}`}}case"create_calendar_event":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||""),h=t.calendar_id||"primary",p=await c.calendar.createEvent(h,{summary:t.summary,description:t.description,location:t.location,startDateTime:t.start_datetime,endDateTime:t.end_datetime,attendees:t.attendees});return`Event created: "${p.summary}"
ID: ${p.id}
Start: ${p.start.dateTime||p.start.date}`}catch(c){return await I(r,a,"google","create_event",c.message),`Failed to create event: ${c.message}`}}case"create_doc":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" to sign in with your Google account first.';const p=await c.docs.createDocument(t.title);t.content&&await c.docs.appendText(p.documentId,t.content);let v="";if(t.folder_name)try{const{token:w}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||"");v=`
Folder: "${(await Mt(w,p.documentId,t.folder_name)).folderName}"`}catch(w){v=`
(Could not move to folder "${t.folder_name}": ${w.message})`}try{await new ue(r).store(a,"context",`Document: ${t.title}`,`Document ID: ${p.documentId} | URL: ${p.url}`,6,"working")}catch{}return`Document created: "${t.title}"${v}
ID: ${p.documentId}
URL: ${p.url}`}catch(c){return await I(r,a,"google","create_doc",c.message),`Failed to create document: ${c.message}`}}case"read_doc":{if(!n)return"Authentication context unavailable.";try{const h=await new V(r,a,n,s||"",o||"").docs.readDocument(t.document_id);return`Document: "${h.title}"

${h.content}`}catch(c){return await I(r,a,"google","read_doc",c.message),`Failed to read document: ${c.message}`}}case"append_to_doc":{if(!n)return"Authentication context unavailable.";try{const c=new V(r,a,n,s||"",o||"");if(!(await c.isConnected()).connected)return'Google account not connected. Please go to Settings → Keys → Google Workspace and click "Connect Google Account" first.';await c.docs.appendText(t.document_id,t.content);let p=t.document_id;try{p=(await c.docs.readDocument(t.document_id)).title}catch{}return`Content appended to "${p}".
URL: https://docs.google.com/document/d/${t.document_id}/edit`}catch(c){return await I(r,a,"google","append_to_doc",c.message),`Failed to append to document: ${c.message}`}}case"gmail_list":{if(!n)return"Authentication context unavailable.";try{const h=await new Q(r,a,n,s||"",o||"").listMessages({maxResults:t.max_results||10,query:t.query});return h.length===0?"No messages found.":h.map((p,v)=>`${p.isUnread?"● ":"  "}${v+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await I(r,a,"gmail","list",c.message),(f=c.message)!=null&&f.includes("not connected")?c.message:`Gmail list error: ${c.message}`}}case"gmail_read":{if(!n)return"Authentication context unavailable.";try{const c=new Q(r,a,n,s||"",o||""),h=await c.getMessage(t.message_id);if(!h)return"Message not found.";const p=await c.getMessageBody(t.message_id);return`**${h.subject}**
From: ${h.from}
To: ${h.to}
Date: ${h.date}

${p}`}catch(c){return await I(r,a,"gmail","read",c.message),`Gmail read error: ${c.message}`}}case"gmail_search":{if(!n)return"Authentication context unavailable.";try{const h=await new Q(r,a,n,s||"",o||"").search(t.query,t.max_results||10);return h.length===0?`No results for: ${t.query}`:h.map((p,v)=>`${p.isUnread?"● ":"  "}${v+1}. **${p.subject}**
   From: ${p.from}
   Date: ${p.date}
   ${p.snippet}
   [id: ${p.id}]`).join(`

`)}catch(c){return await I(r,a,"gmail","search",c.message),`Gmail search error: ${c.message}`}}case"gmail_send":{if(!n)return"Authentication context unavailable.";try{const h=await new Q(r,a,n,s||"",o||"").send(t.to,t.subject,t.body,{cc:t.cc});return`Email sent successfully to ${t.to}. Subject: "${t.subject}" [Message ID: ${h.id}]`}catch(c){return await I(r,a,"gmail","send",c.message),`Gmail send error: ${c.message}`}}case"gmail_draft":{if(!n)return"Authentication context unavailable.";try{const h=await new Q(r,a,n,s||"",o||"").createDraft(t.to,t.subject,t.body);return`Draft created. To: ${t.to}, Subject: "${t.subject}" — Review and send from Gmail. [Draft ID: ${h.id}]`}catch(c){return await I(r,a,"gmail","draft",c.message),`Gmail draft error: ${c.message}`}}case"gmail_modify":{if(!n)return"Authentication context unavailable.";try{return await new Q(r,a,n,s||"",o||"").modifyMessage(t.message_id,t.action),`Message ${t.message_id} successfully ${t.action}ed.`}catch(c){return await I(r,a,"gmail","modify",c.message),`Gmail modify error: ${c.message}`}}case"gmail_unread_count":{if(!n)return"Authentication context unavailable.";try{const h=await new Q(r,a,n,s||"",o||"").getUnreadCount();return`You have ${h} unread email${h!==1?"s":""} in Gmail.`}catch(c){return(b=c.message)!=null&&b.includes("not connected")?c.message:`Gmail error: ${c.message}`}}case"drive_list":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||""),h=new URLSearchParams;h.set("pageSize",String(t.max_results||10)),h.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),h.set("orderBy","modifiedTime desc");let p="";t.folder_id?p=`'${t.folder_id}' in parents and trashed = false`:t.query?p=`${t.query} and trashed = false`:p="trashed = false",h.set("q",p);const v=await fetch(`https://www.googleapis.com/drive/v3/files?${h}`,{headers:{Authorization:`Bearer ${c}`}});if(!v.ok)throw new Error(`Drive API error (${v.status})`);const w=await v.json();return(g=w.files)!=null&&g.length?w.files.map((x,S)=>{var A,C;const R=((A=x.mimeType)==null?void 0:A.split(".").pop())||x.mimeType,L=x.size?`${(parseInt(x.size)/1024).toFixed(1)} KB`:"",D=((C=x.modifiedTime)==null?void 0:C.split("T")[0])||"";return`${S+1}. **${x.name}** (${R})
   ${L} · Modified: ${D}
   ${x.webViewLink||""}`}).join(`

`):"No files found."}catch(c){return await I(r,a,"google","drive_list",c.message),`Drive list error: ${c.message}`}}case"drive_search":{if(!n)return"Authentication context unavailable.";try{const{token:c}=await(await Promise.resolve().then(()=>Qe)).getGoogleAuth(r,a,n,s||"",o||""),h=`fullText contains '${t.query.replace(/'/g,"\\'")}' and trashed = false`,p=new URLSearchParams;p.set("q",h),p.set("pageSize",String(t.max_results||10)),p.set("fields","files(id,name,mimeType,modifiedTime,size,webViewLink)"),p.set("orderBy","modifiedTime desc");const v=await fetch(`https://www.googleapis.com/drive/v3/files?${p}`,{headers:{Authorization:`Bearer ${c}`}});if(!v.ok)throw new Error(`Drive API error (${v.status})`);const w=await v.json();return(_=w.files)!=null&&_.length?w.files.map((x,S)=>{var D,A;const R=((D=x.mimeType)==null?void 0:D.split(".").pop())||x.mimeType,L=((A=x.modifiedTime)==null?void 0:A.split("T")[0])||"";return`${S+1}. **${x.name}** (${R}) — Modified: ${L}
   ${x.webViewLink||""}`}).join(`

`):`No files found for: "${t.query}"`}catch(c){return await I(r,a,"google","drive_search",c.message),`Drive search error: ${c.message}`}}case"web_search":try{const c=await St(t.query,{num:t.num_results||5,site:t.site});return c.error?`Web search failed: ${c.error}`:c.results.length===0?`No results found for "${t.query}".`:c.results.map((h,p)=>`${p+1}. **${h.title}**
   ${h.link}
   ${h.snippet}`).join(`

`)}catch(c){return await I(r,a,"search","web_search",c.message),`Web search error: ${c.message}`}case"read_url":try{const c=t.url;if(!c||!c.startsWith("http://")&&!c.startsWith("https://"))return"Invalid URL. Please provide a full URL starting with http:// or https://";const h=Math.min(t.max_length||8e3,15e3),{fetchPageContent:p}=await Promise.resolve().then(()=>za),v=await p(c,h);return v.error?`Failed to read page: ${v.error}`:!v.text||v.text.length<20?`Page at ${c} returned no readable content.`:`Content from ${c} (${v.text.length} chars):

${v.text}`}catch(c){return await I(r,a,"search","read_url",c.message),`Read URL error: ${c.message}`}case"research":{if(!u)return"Research tool requires an LLM provider but none is available.";try{const c=await Sr(t.query,u,{depth:t.depth||"quick",site:t.site});if(c.error)return`Research failed: ${c.error}`;let h=c.report;return c.sources.length>0&&(h+=`

---
**Sources** (`+c.pagesRead+` pages read):
`,h+=c.sources.map((p,v)=>`[${v+1}] ${p.title}
    ${p.url}`).join(`
`)),h}catch(c){return await I(r,a,"research","research",c.message),`Research error: ${c.message}`}}case"search_places":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured. Add it in Settings → Keys → Google API Key.";const h=await N(c.encrypted_value,n),p=await Aa(h,t.query,{type:t.type});return p.error?`Places search failed: ${p.error}`:p.results.length===0?`No places found for "${t.query}".`:p.results.map((v,w)=>{const x=v.rating?` ★${v.rating} (${v.userRatingsTotal||0} reviews)`:"",S=v.openNow!==void 0?v.openNow?" · Open now":" · Closed":"",R=v.googleMapsUri?`
   ${v.googleMapsUri}`:"";return`${w+1}. **${v.name}**${x}${S}
   ${v.address}${R}
   [place_id: ${v.placeId}]`}).join(`

`)}catch(c){return await I(r,a,"google_api","search_places",c.message),`Places search error: ${c.message}`}}case"get_place_details":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await N(c.encrypted_value,n),p=await La(h,t.place_id);if(p.error)return`Details lookup failed: ${p.error}`;if(!p.details)return"No details found.";const v=p.details;let w=`**${v.name}**
...
Recent Reviews:`;for(const x of v.reviews)w+=`
— ${x.author} (★${x.rating}, ${x.time}): "${x.text}"`}return w}catch(c){return await I(r,a,"google_api","place_details",c.message),`Place details error: ${c.message}`}}case"get_directions":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await N(c.encrypted_value,n),p=await Na(h,t.origin,t.destination,{mode:t.mode||"driving"});if(p.error)return`Directions failed: ${p.error}`;if(!p.route)return"No route found.";const v=p.route;let w=`**${v.startAddress}** → **${v.endAddress}**
`;return w+=`📏 ${v.distance} · ⏱️ ${v.duration}`,v.durationInTraffic&&(w+=` (with traffic: ${v.durationInTraffic})`),w+=`
via ${v.summary}`,w+=`

Steps:`,v.steps.forEach((x,S)=>{w+=`
${S+1}. ${x.instruction} (${x.distance}, ${x.duration})`}),w}catch(c){return await I(r,a,"google_api","directions",c.message),`Directions error: ${c.message}`}}case"get_travel_time":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await N(c.encrypted_value,n),p=await Ba(h,t.origin,t.destination,t.mode||"driving");if(p.error)return`Travel time lookup failed: ${p.error}`;let v=`${t.origin} → ${t.destination}: ${p.distance}, ${p.duration}`;return p.durationInTraffic&&(v+=` (with traffic: ${p.durationInTraffic})`),v}catch(c){return await I(r,a,"google_api","travel_time",c.message),`Travel time error: ${c.message}`}}case"translate_text":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await N(c.encrypted_value,n),p=await $a(h,t.text,t.target_language,t.source_language);return p.error?`Translation failed: ${p.error}`:`[${p.detectedSourceLang||t.source_language||"auto"} → ${t.target_language}]

${p.translatedText}`}catch(c){return await I(r,a,"google_api","translate",c.message),`Translation error: ${c.message}`}}case"search_youtube":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await N(c.encrypted_value,n),p=await ja(h,t.query,{maxResults:t.max_results||5,order:t.order||"relevance"});return p.error?`YouTube search failed: ${p.error}`:p.results.length===0?`No YouTube results for "${t.query}".`:p.results.map((v,w)=>{var x;return`${w+1}. **${v.title}**
   ${v.channelTitle} · ${((x=v.publishedAt)==null?void 0:x.split("T")[0])||""}
   ${v.description}
   ${v.url}`}).join(`

`)}catch(c){return await I(r,a,"google_api","youtube_search",c.message),`YouTube search error: ${c.message}`}}case"geocode_address":{if(!n)return"Authentication context unavailable.";try{const c=await r.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(a,"google_api_key").first();if(!c)return"Google API Key not configured.";const h=await N(c.encrypted_value,n),p=await Ma(h,t.address);return p.error?`Geocoding failed: ${p.error}`:p.results.length===0?`Location not found: "${t.address}"`:p.results.map((v,w)=>`${w+1}. ${v.address}
   Coordinates: ${v.lat}, ${v.lng}`).join(`
`)}catch(c){return await I(r,a,"google_api","geocode",c.message),`Geocoding error: ${c.message}`}}default:return`Unknown tool: ${e}`}}async function It(e,t,r,a,n,s){var _;const o=new ue(t),i=(_=e.metadata)==null?void 0:_.thread_id,l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,15,i),m=[{role:"system",content:Cr(a,l)},...d.map(c=>({role:c.role,content:c.content})),{role:"user",content:e.text}];await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const f=10;let b="",g=0;for(let c=0;c<f;c++)try{const h=await r.chat(m,{tools:Dr});if(h.usage&&(g+=h.usage.promptTokens+h.usage.completionTokens),h.toolCalls&&h.toolCalls.length>0){h.content&&m.push({role:"assistant",content:h.content});for(const p of h.toolCalls)try{const v=await Or(p.name,p.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);m.push({role:"user",content:`[Tool Result for ${p.name}]: ${v}`})}catch(v){await I(t,a.id,"tool",p.name,v.message||"Tool execution failed"),m.push({role:"user",content:`[Tool Error for ${p.name}]: ${v.message||"Execution failed"}`})}continue}b=h.content;break}catch(h){if(n){const p=h.message||"",v=p.includes("401")||p.includes("403")||p.includes("authentication")||p.includes("credit balance"),w=p.includes("429"),x=v?1440:w?10:5;await n.recordError(r.name,p,x)}throw await I(t,a.id,"llm","provider_error",h.message||"Unknown LLM error",{provider:r.name,turn:c}),h}if(n&&g>0)try{await n.recordUsage(r.name,g)}catch{}return await o.storeMessage(a.id,e.channel,"assistant",b,"{}",i),await o.compactHistory(a.id,30),b}const jt={"claude-sonnet-4-20250514":2e5,"claude-haiku-4-20250514":2e5,"gpt-4o":128e3,"gpt-4o-mini":128e3,"grok-3-mini":131072,"grok-3":131072,"deepseek-chat":64e3,"gemini-2.0-flash":1e6,default:32e3};function Ka(e){for(const[t,r]of Object.entries(jt))if(e.toLowerCase().includes(t.toLowerCase()))return r;return jt.default}function Ja(e,t,r,a){const n=Ka(a),s=Math.floor(n*.75),o=[];let i=0,l=!1;const d=ht(e);o.push({role:"system",content:e}),i+=d;const u=ht(r);i+=u;const m=s-i,f=[];let b=0;for(let g=t.length-1;g>=0;g--){const _=t[g],c=ht(_.content);if(b+c<=m)f.unshift({role:_.role,content:_.content}),b+=c;else{l=!0;break}}return o.push(...f),o.push({role:"user",content:r}),i+=b,{maxTokens:n,usedTokens:i,messages:o,wasTruncated:l}}async function*Ya(e,t,r,a,n,s){var c;const o=new ue(t),i=(c=e.metadata)==null?void 0:c.thread_id;yield{type:"thinking",data:{threadId:i,provider:r.name}};const l=await o.buildContext(a.id),d=await o.getRecentConversations(a.id,20,i),u=Cr(a,l),m=Ja(u,d,e.text,r.name);await o.storeMessage(a.id,e.channel,"user",e.text,"{}",i);const f=10;let b="",g=0;const _=[...m.messages];for(let h=0;h<f;h++)try{h>0&&(yield{type:"thinking",data:{threadId:i}});const p=await r.chat(_,{tools:Dr});if(p.usage&&(g+=p.usage.promptTokens+p.usage.completionTokens),p.toolCalls&&p.toolCalls.length>0){p.content&&(yield{type:"chunk",data:{text:p.content,threadId:i}},_.push({role:"assistant",content:p.content}));for(const w of p.toolCalls){yield{type:"tool_start",data:{tool:w.name,toolArgs:w.arguments,threadId:i}};try{const x=await Or(w.name,w.arguments,t,a.id,a.pin_hash,s==null?void 0:s.GOOGLE_CLIENT_ID,s==null?void 0:s.GOOGLE_CLIENT_SECRET,s==null?void 0:s.GOOGLE_API_KEY,s==null?void 0:s.GOOGLE_CSE_ID,a.timezone,r);yield{type:"tool_end",data:{tool:w.name,toolResult:x.substring(0,500)+(x.length>500?"...":""),threadId:i}},_.push({role:"user",content:`[Tool Result for ${w.name}]: ${x}`})}catch(x){await I(t,a.id,"tool",w.name,x.message||"Tool execution failed"),yield{type:"tool_end",data:{tool:w.name,toolResult:`Error: ${x.message||"Execution failed"}`,threadId:i}},_.push({role:"user",content:`[Tool Error for ${w.name}]: ${x.message||"Execution failed"}`})}}continue}b=p.content;const v=50;for(let w=0;w<b.length;w+=v)yield{type:"chunk",data:{text:b.substring(w,w+v),threadId:i}},w+v<b.length&&await new Promise(S=>setTimeout(S,10));break}catch(p){if(n){const v=p.message||"",w=v.includes("401")||v.includes("403")||v.includes("authentication")||v.includes("credit balance"),x=v.includes("429"),S=w?1440:x?10:5;await n.recordError(r.name,v,S)}await I(t,a.id,"llm","provider_error",p.message||"Unknown LLM error",{provider:r.name,turn:h}),yield{type:"error",data:{error:p.message||"An error occurred",threadId:i}};return}if(n&&g>0)try{await n.recordUsage(r.name,g)}catch{}await o.storeMessage(a.id,e.channel,"assistant",b,"{}",i),await o.compactHistory(a.id,30),yield{type:"done",data:{threadId:i,provider:r.name,tokenCount:g}}}const $=new pe;async function Va(e,t){var n;const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(r).first();if(!a)return e.json({error:"Invalid session"},401);e.set("user",{id:a.user_id,username:a.username,name:a.name,pin_hash:a.pin_hash,role:a.role,personality_prompt:a.personality_prompt,telegram_chat_id:a.telegram_chat_id,timezone:a.timezone,assistant_name:a.assistant_name||"Karna",created_at:a.created_at,updated_at:a.updated_at}),e.set("sessionId",r),await t()}$.use("/*",Va);$.get("/threads",async e=>{const t=e.get("user"),r=e.req.query("archived")==="1",a=parseInt(e.req.query("limit")||"30"),n=await e.env.DB.prepare(`SELECT t.*, 
...
`;for(const d of s)o+=`- ${d.name} (${d.type}, ${Math.round(d.size/1024)}KB, file_id: ${d.file_id})`,d.text_preview&&(o+=`
  Preview: ${d.text_preview.substring(0,300)}...`),o+=`
`;o+="Use parse_document tool to read full file contents. Use drive_upload to upload to Google Drive.]"}let i=n;if(!i){const d=await e.env.DB.prepare("INSERT INTO threads (user_id, title) VALUES (?, ?) RETURNING *").bind(t.id,r.trim().substring(0,60)+(r.trim().length>60?"...":"")).first();i=d==null?void 0:d.id}const l={userId:t.id,username:t.username,channel:a,text:r.trim()+o,sessionId:e.get("sessionId"),timestamp:new Date().toISOString(),metadata:{thread_id:i}};try{const{provider:d,rotation:u}=await Je(e.env.DB,t.id,t.pin_hash),m=new ReadableStream({async start(f){const b=new TextEncoder;try{const g=Ya(l,e.env.DB,d,t,u,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID});for await(const _ of g)_.data.threadId||(_.data.threadId=i),f.enqueue(b.encode(Bt(_)));i&&await e.env.DB.prepare("UPDATE threads SET message_count = message_count + 2, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(i).run(),f.close()}catch(g){const _={type:"error",data:{error:g.message||"An error occurred",threadId:i}};f.enqueue(b.encode(Bt(_))),f.close()}}});return new Response(m,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Thread-Id":String(i||"")}})}catch(d){console.error("Stream setup error:",d);const u=d.message||"";return u.includes("No LLM provider configured")?e.json({error:"No AI provider configured. Please add at least one API key in Settings → Keys.",type:"no_provider",thread_id:i},400):u.includes("limit reached")?e.json({error:u,type:"cost_limit",thread_id:i},429):e.json({error:"Something went wrong setting up the stream.",details:u,thread_id:i},500)}});$.get("/threads/:id/messages",async e=>{var s;const t=e.get("user"),r=parseInt(e.req.param("id")),a=parseInt(e.req.query("limit")||"50"),n=await e.env.DB.prepare(`SELECT id, role, content, channel, created_at FROM conversations 
...
⚠️ Your Telegram chat ID is *${t}*. Set this in Settings → Profile → Telegram Chat ID to link your account.`);return await U(r,t,l),!0}case"/help":{const i=`🛠 *${(a==null?void 0:a.assistant_name)||"Karna"} — Commands*
...
Status: ✅ Online`;await U(r,t,u)}catch{await U(r,t,"✅ Online — but had trouble fetching stats.")}return!0}case"/new":return a?(await U(r,t,"🆕 Starting fresh conversation. Your next message begins a new thread."),!0):(await U(r,t,"⚠️ Account not linked."),!0);default:return!1}}Ye.post("/webhook",async e=>{var t,r,a,n;try{const s=await e.req.json();if(s.callback_query)return await sn(e.env.DB,s.callback_query),e.json({ok:!0});const o=s.message;if(!(o!=null&&o.text)&&!(o!=null&&o.voice))return e.json({ok:!0});const i=String(o.chat.id);let l=o.text||"";const d=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(i).first();let u=null;if(d){const g=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(d.id,"telegram_bot_token").first();g&&(u=await N(g.encrypted_value,d.pin_hash))}if(!u){const g=await e.env.DB.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
         JOIN users u ON c.user_id = u.id 
         WHERE c.service = 'telegram_bot_token' LIMIT 1`).first();g&&(u=await N(g.encrypted_value,g.pin_hash))}if(!u)return e.json({ok:!0,message:"Bot token not configured"});if(l.startsWith("/")&&await nn(l,i,u,d,e.env.DB))return e.json({ok:!0});if(!d)return await U(u,i,`⚠️ Your account isn't linked yet.

Your Telegram Chat ID is: \`${i}\`

Go to the web app → Settings → Profile → set your Telegram Chat ID to this value.`),e.json({ok:!0});if(o.voice&&u&&d)try{await U(u,i,"🎤 Processing voice note...");const _=await(await fetch(`https://api.telegram.org/bot${u}/getFile?file_id=${o.voice.file_id}`)).json();if(_.ok&&((t=_.result)!=null&&t.file_path)){const h=await(await fetch(`https://api.telegram.org/file/bot${u}/${_.result.file_path}`)).blob();let p="",v="",w="whisper-1";const x=await e.env.DB.prepare("SELECT service, encrypted_value FROM credentials WHERE user_id = ? AND (service IN ('llm_slot_1', 'llm_slot_2', 'llm_slot_3', 'openai'))").bind(d.id).all();for(const D of x.results){const A=await N(D.encrypted_value,d.pin_hash);if(D.service==="openai"){p="https://api.openai.com/v1/audio/transcriptions",v=A;break}else if(D.service.startsWith("llm_slot_"))try{const C=JSON.parse(A);if(C.provider==="openai"){p="https://api.openai.com/v1/audio/transcriptions",v=C.apiKey;break}else if(C.provider==="groq"){p="https://api.groq.com/openai/v1/audio/transcriptions",v=C.apiKey,w="whisper-large-v3";break}}catch{}}if(!p)return await U(u,i,"⚠️ To use voice notes, configure an OpenAI API key in your LLM slots (Settings → Keys)."),e.json({ok:!0});const S=new FormData;S.append("file",h,"voice.ogg"),S.append("model",w);const R=await fetch(p,{method:"POST",headers:{Authorization:`Bearer ${v}`},body:S});if(!R.ok){const D=await R.text();return await U(u,i,`⚠️ Transcription failed: ${R.status} ${D}`),e.json({ok:!0})}l=(await R.json()).text,await U(u,i,`🗣️ *You said:* ${l}`)}}catch(g){return await U(u,i,`⚠️ Failed to process voice note: ${g.message}`),e.json({ok:!0})}if(!l)return e.json({ok:!0});await rn(u,i);const m=Qa(d.id,d.username,l,i);let f,b;try{const g=await Je(e.env.DB,d.id,d.pin_hash);f=g.provider,b=g.rotation}catch(g){console.error("Telegram provider setup error:",g);const _=(r=g.message)!=null&&r.includes("No LLM provider")?`⚠️ No AI provider configured yet.

Go to the web app → Settings → Keys → add at least one API key (DeepSeek, Grok, Abacus AI, etc.).`:(a=g.message)!=null&&a.includes("Daily usage limit")?"⚠️ Daily usage limit reached. Your limit resets at midnight.":`⚠️ AI provider error: ${g.message||"Unknown error"}`;return await U(u,i,_),e.json({ok:!0})}try{const g=await It(m,e.env.DB,f,d,b,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET,GOOGLE_API_KEY:e.env.GOOGLE_API_KEY,GOOGLE_CSE_ID:e.env.GOOGLE_CSE_ID}),_=en(g,"telegram");await U(u,i,_||"(empty response)")}catch(g){console.error("Telegram agent error:",g);const _=(n=g.message)!=null&&n.includes("API error")?`⚠️ AI provider returned an error. The provider (${f.name}) may be temporarily unavailable. Your message was saved — try again shortly.`:`⚠️ Something went wrong processing your message. Error: ${(g.message||"Unknown").substring(0,200)}`;await U(u,i,_);try{const{logError:c}=await Promise.resolve().then(()=>yt);await c(e.env.DB,d.id,"telegram","agent_error",g.message||"Agent error",{provider:f.name})}catch{}}return e.json({ok:!0})}catch(s){console.error("Telegram webhook error:",s);try{const{logError:o}=await Promise.resolve().then(()=>yt);await o(e.env.DB,null,"telegram","webhook_error",s.message||"Unknown telegram error")}catch{}return e.json({ok:!0,error:s.message})}});Ye.post("/setup-webhook",async e=>{var l;const t=(l=e.req.header("Authorization"))==null?void 0:l.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const{webhook_url:a}=await e.req.json(),n=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!n)return e.json({error:"Telegram bot token not configured in Settings"},400);const s=await N(n.encrypted_value,r.pin_hash);if(!a){const u=await(await fetch(`https://api.telegram.org/bot${s}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})})).json();return e.json(u)}const i=await(await fetch(`https://api.telegram.org/bot${s}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:a,allowed_updates:["message"],drop_pending_updates:!1})})).json();return e.json(i)});Ye.get("/webhook-status",async e=>{var s,o,i,l,d,u;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({configured:!1,error:"Bot token not set"});const n=await N(a.encrypted_value,r.pin_hash);try{const f=await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json();return e.json({configured:!0,webhook_url:((o=f.result)==null?void 0:o.url)||"",has_webhook:!!((i=f.result)!=null&&i.url),pending_updates:((l=f.result)==null?void 0:l.pending_update_count)||0,last_error:((d=f.result)==null?void 0:d.last_error_message)||"",last_error_date:((u=f.result)==null?void 0:u.last_error_date)||null})}catch(m){return e.json({configured:!0,error:m.message})}});Ye.post("/detect-chat-id",async e=>{var s,o;const t=(s=e.req.header("Authorization"))==null?void 0:s.replace("Bearer ","");if(!t)return e.json({error:"Auth required"},401);const r=await e.env.DB.prepare(`SELECT s.user_id, u.pin_hash FROM sessions s JOIN users u ON s.user_id = u.id
     WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(t).first();if(!r)return e.json({error:"Invalid session"},401);const a=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = ?").bind(r.user_id,"telegram_bot_token").first();if(!a)return e.json({error:"Bot token not configured"},400);const n=await N(a.encrypted_value,r.pin_hash);try{const d=((o=(await(await fetch(`https://api.telegram.org/bot${n}/getWebhookInfo`)).json()).result)==null?void 0:o.url)||"";await fetch(`https://api.telegram.org/bot${n}/deleteWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({drop_pending_updates:!1})}),await new Promise(c=>setTimeout(c,500));const m=await(await fetch(`https://api.telegram.org/bot${n}/getUpdates?limit=10&timeout=0`)).json();d&&await fetch(`https://api.telegram.org/bot${n}/setWebhook`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:d,allowed_updates:["message"]})});const f=m.result||[];if(f.length===0)return e.json({found:!1,message:"No messages found. Send any message to your bot on Telegram first, then try again within 30 seconds."});const b=[],g=new Set;for(let c=f.length-1;c>=0;c--){const h=f[c].message;if(h&&h.chat){const p=String(h.chat.id);g.has(p)||(g.add(p),b.push({chat_id:p,name:[h.chat.first_name,h.chat.last_name].filter(Boolean).join(" ")||h.chat.title||"Unknown",username:h.chat.username||"",date:new Date((h.date||0)*1e3).toISOString()}))}}if(b.length===0)return e.json({found:!1,message:"No chat messages found in updates. Try sending a message to the bot and click detect again."});const _=b[0].chat_id;return await e.env.DB.prepare("UPDATE users SET telegram_chat_id = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(_,r.user_id).run(),e.json({found:!0,chat_id:_,name:b[0].name,all_chats:b,message:`Chat ID ${_} detected and saved to your profile.`})}catch(i){return e.json({error:`Detection failed: ${i.message}`},500)}});async function sn(e,t){var _;const{id:r,data:a,message:n,from:s}=t;if(!a||!n)return;const o=a.split(":");if(o[0]!=="briefing_toggle"||o.length<3)return;const i=o[1],l=parseInt(o[2]);if(!l||!i)return;const d=String(n.chat.id),u=await e.prepare("SELECT * FROM users WHERE telegram_chat_id = ?").bind(d).first();if(!u)return;const m=await e.prepare(`
  ...
  `).bind(u.id,l,i).first();if(!m)return;const f=m.checked?0:1;await e.prepare(`
    ...
    WHERE id = ?
  `).bind(f,f,m.id).run();const b=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
     JOIN users u ON c.user_id = u.id 
     WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(u.id).first();if(!b)return;const g=await N(b.encrypted_value,b.pin_hash);if(await fetch(`https://api.telegram.org/bot${g}/answerCallbackQuery`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({callback_query_id:r,text:f?"✅ Checked!":"☐ Unchecked"})}),(_=n.reply_markup)!=null&&_.inline_keyboard){const c=n.reply_markup.inline_keyboard.map(h=>h.map(p=>{var v;if((v=p.callback_data)!=null&&v.includes(i)){const w=f?"✅":"☐",x=p.text.replace(/^[☐✅]\s*/,"");return{...p,text:`${w} ${x}`}}return p}));try{await fetch(`https://api.telegram.org/bot${g}/editMessageReplyMarkup`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:d,message_id:n.message_id,reply_markup:{inline_keyboard:c}})})}catch{}}}function on(e){const t=new Date,r=new Date(t.toLocaleString("en-US",{timeZone:e})),a=new Date(r);a.setDate(a.getDate()+1),a.setHours(0,0,0,0);const n=new Date(a);n.setHours(23,59,59,999);const s=a.toISOString().split("T")[0];return{start:a.toISOString(),end:n.toISOString(),dateStr:s}}async function ln(e,t,r,a,n,s){try{return(await new kt(e,t,r,a,n).listEvents("primary",{timeMin:s.start,timeMax:s.end,maxResults:50})).map(l=>{var d;return{id:l.id||`google-${Date.now()}`,title:l.summary||"Untitled Event",startTime:l.start.dateTime||l.start.date||"",endTime:l.end.dateTime||l.end.date||"",location:l.location,attendees:(d=l.attendees)==null?void 0:d.map(u=>u.displayName||u.email),source:"google"}})}catch(o){return console.error("Google Calendar fetch error:",o.message),[]}}async function dn(e,t,r,a,n){try{const s=new Q(e,t,r,a,n),o=await s.listMessages({query:"is:unread",maxResults:50,labelIds:["INBOX"]}),i=await s.listMessages({query:"is:important is:unread",maxResults:10}),l={};for(const m of o){const f=m.from.split("<")[0].trim()||m.from;l[f]=(l[f]||0)+1}const d=Object.entries(l).sort(([,m],[,f])=>f-m).slice(0,5).map(([m])=>m),u=o.some(m=>m.subject.toLowerCase().includes("urgent")||m.subject.toLowerCase().includes("asap")||m.subject.toLowerCase().includes("immediately"));return{unreadCount:o.length,importantCount:i.length,topSenders:d,hasUrgent:u}}catch(s){return console.error("Gmail fetch error:",s.message),{unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1}}}async function cn(e,t){var r;try{const a=await e.prepare(`
      SELECT name, description, next_run 
      FROM cron_jobs 
      WHERE user_id = ? AND enabled = 1 AND state != 'completed'
      ORDER BY next_run ASC
      LIMIT 10
    `).bind(t).all(),n=new Date,s=new Date(n);s.setDate(s.getDate()+1);const o=(a.results||[]).map(l=>l.name),i=(a.results||[]).filter(l=>new Date(l.next_run)<=s).length;return{pending:((r=a.results)==null?void 0:r.length)||0,dueToday:i,items:o}}catch(a){return console.error("Tasks fetch error:",a.message),{pending:0,dueToday:0,items:[]}}}async function un(e){const t=e.length>0?e.slice(0,5):["AI","LLM","Tools","Agentic Workflows","AI Features"],r=[];for(const a of t){const n=`latest ${a} news today`;try{const s=await St(n,{num:3});if(s.results){for(const o of s.results.slice(0,2))if(!r.some(i=>i.url===o.link)&&(r.push({title:o.title,summary:o.snippet,url:o.link,source:o.displayLink}),r.length>=5))break}}catch(s){console.error(`News search error for "${n}":`,s.message)}if(r.length>=5)break}return r.slice(0,5)}function pn(e){const t=[];t.push(`📋 Evening Briefing for ${e.targetDate}`),t.push("");const r=e.calendar.totalCount;if(r>0){t.push(`📅 Tomorrow: ${r} event${r===1?"":"s"}`);for(const n of e.calendar.google.slice(0,5)){const s=n.startTime?new Date(n.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}):"";t.push(`   • ${s} ${n.title}`)}}else t.push("📅 Tomorrow: No events scheduled");t.push("");const a=e.emails.gmail.unreadCount;if(a>0?(t.push(`📧 Gmail: ${a} unread`),e.emails.gmail.hasUrgent&&t.push("   ⚠️ Contains urgent messages")):t.push("📧 Gmail: Inbox clear"),t.push(""),e.tasks.pending>0?t.push(`✅ Tasks: ${e.tasks.pending} pending (${e.tasks.dueToday} due soon)`):t.push("✅ Tasks: All caught up"),t.push(""),e.news.items.length>0){t.push("🤖 AI News Today:");for(const n of e.news.items)t.push(`   • ${n.title.substring(0,80)}${n.title.length>80?"...":""}`)}return t.join(`
`)}function mn(e){const t=[];let r=0;for(const a of e.calendar.google)t.push({type:"calendar",key:a.id,text:`${a.title} - ${new Date(a.startTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"})}`,metadata:{event:a},sortOrder:r++});e.emails.gmail.unreadCount>0&&t.push({type:"email",key:"gmail-unread",text:`Review ${e.emails.gmail.unreadCount} unread Gmail messages`,metadata:{source:"gmail",count:e.emails.gmail.unreadCount},sortOrder:r++});for(const a of e.tasks.items)t.push({type:"task",key:`task-${a}`,text:a,metadata:{},sortOrder:r++});for(const a of e.news.items)t.push({type:"news",key:`news-${a.url}`,text:`📰 ${a.title}`,metadata:{url:a.url,source:a.source},sortOrder:r++});return t}async function hn(e,t){const r=await e.prepare("SELECT * FROM briefing_preferences WHERE user_id = ?").bind(t).first();if(!r)return{components:{google_calendar:!0,gmail:!0,tasks:!0,news:!0},newsTopics:["AI","LLM","Tools","Agentic Workflows","AI Features"]};let a;try{a=JSON.parse(r.components)}catch{a={google_calendar:!0,gmail:!0,tasks:!0,news:!0}}const n=r.news_topics?r.news_topics.split(",").map(s=>s.trim()).filter(Boolean):["AI","LLM","Tools","Agentic Workflows","AI Features"];return{components:a,newsTopics:n}}async function Rr(e,t,r){var h;const a=t.timezone||"Asia/Kolkata",n=on(a),{components:s,newsTopics:o}=await hn(e,t.id),i=[],l=[];s.google_calendar&&(i.push(ln(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET,n)),l.push("googleEvents")),s.gmail&&(i.push(dn(e,t.id,t.pin_hash,r.GOOGLE_CLIENT_ID,r.GOOGLE_CLIENT_SECRET)),l.push("gmailSummary")),s.tasks&&(i.push(cn(e,t.id)),l.push("tasks")),s.news&&(i.push(un(o)),l.push("news"));const d=await Promise.all(i),u={};l.forEach((p,v)=>{u[p]=d[v]});const m={unreadCount:0,importantCount:0,topSenders:[],hasUrgent:!1},f={pending:0,dueToday:0,items:[]},b={generatedAt:new Date().toISOString(),targetDate:n.dateStr,calendar:{google:u.googleEvents||[],totalCount:((h=u.googleEvents)==null?void 0:h.length)||0},emails:{gmail:u.gmailSummary||m},tasks:u.tasks||f,news:{items:u.news||[],fetchedAt:new Date().toISOString()},summary:""};b.summary=pn(b);const g=mn(b),_=await e.prepare(`
    INSERT INTO briefings (user_id, briefing_type, content_json, channel)
    VALUES (?, 'evening', ?, 'all')
    RETURNING id
  `).bind(t.id,JSON.stringify(b)).first(),c=(_==null?void 0:_.id)||0;for(const p of g)await e.prepare(`
      INSERT INTO briefing_items (briefing_id, item_type, item_key, item_text, item_metadata, sort_order)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(c,p.type,p.key,p.text,JSON.stringify(p.metadata),p.sortOrder).run();return{briefingId:c,content:b,items:g}}async function gn(e,t,r){const a=await e.prepare(`
  ...
  `).bind(r).all();return{briefing:{...a,content:JSON.parse(a.content_json||"{}")},items:n.results||[]}}async function fn(e,t,r,a){if(!await e.prepare(`
  ...
  `).bind(o,o,a,r).run(),{checked:o===1}}async function vn(e,t,r=10){return((await e.prepare(`
    SELECT b.*, 
  ...
  `).bind(t,r).all()).results||[]).map(n=>({...n,content:JSON.parse(n.content_json||"{}")}))}function yn(e,t,r=new Date){const a=new Date(r.toLocaleString("en-US",{timeZone:t})),n=a.getHours(),s=a.getMinutes(),[o,i]=e.split(":").map(Number),l=n*60+s,d=o*60+i;return l>=d&&l<d+5}function bn(e,t){const r=e.summary,a=[];for(const n of t.slice(0,10))a.push([{text:`☐ ${n.text.substring(0,40)}${n.text.length>40?"...":""}`,callback_data:`briefing_toggle:${n.key}`}]);return{text:r,inlineKeyboard:a}}const J=new pe;async function wn(e,t){var n;if(e.req.path.includes("/cron/"))return t();const r=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","");if(!r)return e.json({error:"Authentication required"},401);const a=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
    ...
    `).all(),n=[],s=new Date;for(const o of a.results||[]){const i=o.timezone||"Asia/Kolkata",l=o.briefing_time||"20:00";if(yn(l,i,s))try{const d=await Rr(e.env.DB,o,{GOOGLE_CLIENT_ID:e.env.GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET:e.env.GOOGLE_CLIENT_SECRET});if(o.telegram_chat_id){const{text:u,inlineKeyboard:m}=bn(d.content,d.items);await xn(e.env.DB,o,u,m,d.briefingId)}n.push({user_id:o.id,status:"success",briefing_id:d.briefingId,briefing_time:l,timezone:i})}catch(d){n.push({user_id:o.id,status:"error",error:d.message})}}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});J.post("/cron/meeting-reminders",async e=>{const t=e.req.header("X-Cron-Secret")||"",r=e.env.CRON_SECRET||"karna-cron-default-v1";if(t!==r)return e.json({error:"Unauthorized"},401);try{const a=await e.env.DB.prepare("SELECT * FROM users WHERE telegram_chat_id IS NOT NULL").all(),n=[],s=new Date,o=new Date(s.getTime()+600*1e3).toISOString(),i=new Date(s.getTime()+900*1e3).toISOString();for(const l of a.results||[])try{const d=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'google_oauth_tokens'").bind(l.id).first();if(!d)continue;const u=await N(d.encrypted_value,l.pin_hash),f=JSON.parse(u).access_token;if(!f)continue;const b=await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?singleEvents=true&orderBy=startTime&timeMin=${encodeURIComponent(s.toISOString())}&timeMax=${encodeURIComponent(i)}&maxResults=10`,{headers:{Authorization:`Bearer ${f}`}});if(!b.ok)continue;const _=((await b.json()).items||[]).filter(p=>{var w;const v=(w=p.start)==null?void 0:w.dateTime;return v?v>=s.toISOString()&&v<=o:!1});if(_.length===0){n.push({user_id:l.id,reminders_sent:0});continue}const c=await e.env.DB.prepare("SELECT encrypted_value FROM credentials WHERE user_id = ? AND service = 'telegram_bot_token'").bind(l.id).first();if(!c)continue;const h=await N(c.encrypted_value,l.pin_hash);for(const p of _){const v=new Date(p.start.dateTime).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit"}),w=p.location?`
📍 ${p.location}`:"",x=`⏰ Meeting in 10 minutes!

*${p.summary||"Untitled Event"}*
🕐 ${v}${w}`;await fetch(`https://api.telegram.org/bot${h}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:l.telegram_chat_id,text:x,parse_mode:"Markdown"})})}n.push({user_id:l.id,reminders_sent:_.length})}catch(d){n.push({user_id:l.id,status:"error",error:d.message})}return e.json({executed:n.length,results:n})}catch(a){return e.json({error:a.message},500)}});async function xn(e,t,r,a,n){try{const s=await e.prepare(`SELECT c.encrypted_value, u.pin_hash FROM credentials c 
       JOIN users u ON c.user_id = u.id 
       WHERE c.user_id = ? AND c.service = 'telegram_bot_token'`).bind(t.id).first();if(!s)return;const o=await N(s.encrypted_value,s.pin_hash);await fetch(`https://api.telegram.org/bot${o}/sendMessage`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:t.telegram_chat_id,text:`🌙 *Evening Briefing*

${r}`,parse_mode:"Markdown",reply_markup:{inline_keyboard:a.map(i=>i.map(l=>({...l,callback_data:`${l.callback_data}:${n}`})))}})}),await e.prepare("UPDATE briefings SET delivered_telegram = 1 WHERE id = ?").bind(n).run()}catch(s){console.error("Telegram briefing error:",s.message)}}const Y=new pe;Y.use("/api/*",fa());Y.route("/api/auth",me);Y.route("/api/chat",$);Y.route("/api/settings",M);Y.route("/api/system",$e);Y.route("/api/telegram",Ye);Y.route("/api/proactive",J);Y.get("/auth/google/callback",async e=>{const t=new URL(e.req.url),r=t.searchParams.get("code"),a=t.searchParams.get("state"),n=t.searchParams.get("error");if(n)return e.html(Ee(!1,`Google denied access: ${n}`));if(!r||!a)return e.html(Ee(!1,"Missing authorization code or state parameter."));try{const o=JSON.parse(atob(a)).sessionId;if(!o)return e.html(Ee(!1,"Invalid state parameter — missing session."));const i=await e.env.DB.prepare(`SELECT s.*, u.* FROM sessions s JOIN users u ON s.user_id = u.id 
       WHERE s.id = ? AND s.expires_at > datetime('now')`).bind(o).first();if(!i)return e.html(Ee(!1,"Session expired. Please log in again and retry."));const l=i.user_id,d=i.pin_hash,u=`${t.protocol}//${t.host}/auth/google/callback`,m=await wr(e.env.DB,l,d,r,u,e.env.GOOGLE_CLIENT_ID,e.env.GOOGLE_CLIENT_SECRET);return e.html(Ee(!0,`Connected as ${m.email}`,m.email))}catch(s){return e.html(Ee(!1,`OAuth failed: ${s.message}`))}});Y.get("/",e=>(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(lr())));Y.get("*",e=>e.req.path.startsWith("/api/")?e.json({error:"Not found"},404):(e.header("Cache-Control","no-cache, no-store, must-revalidate"),e.header("Pragma","no-cache"),e.header("Expires","0"),e.html(lr())));function Ee(e,t,r){return`<!DOCTYPE html>
...
<\/script>
</body></html>`}async function _n(e,t,r){const a="https://karna-5xs.pages.dev",s={"Content-Type":"application/json","X-Cron-Secret":t.CRON_SECRET||"karna-cron-default-v1"};try{const i=await(await fetch(`${a}/api/system/cron/execute`,{method:"POST",headers:s})).json();if(i.results&&i.results.length>0){const d=i.results.filter(m=>m.needs_agent&&m.status==="dispatched");if(d.length>0){const m=d.map(f=>fetch(`${a}/api/system/cron/run-task/${f.job_id}`,{method:"POST",headers:s}).then(b=>b.json()).catch(b=>({job_id:f.job_id,error:b.message})));r.waitUntil(Promise.allSettled(m).then(f=>{console.log(`Cron: ${i.executed} dispatched, ${d.length} agent tasks`,JSON.stringify(f.map(b=>b.status==="fulfilled"?b.value:b.reason)))}))}const u=i.results.filter(m=>!m.needs_agent&&m.status==="dispatched");if(u.length>0){const m=u.map(f=>fetch(`${a}/api/system/cron/run-task/${f.job_id}`,{method:"POST",headers:s}).catch(()=>{}));r.waitUntil(Promise.allSettled(m))}}r.waitUntil(fetch(`${a}/api/proactive/cron/evening-briefing`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{d.executed>0&&console.log("Evening briefing result:",JSON.stringify(d))}).catch(d=>{console.error("Evening briefing error:",d.message)})),new Date().getMinutes()%5<2&&r.waitUntil(fetch(`${a}/api/proactive/cron/meeting-reminders`,{method:"POST",headers:s}).then(d=>d.json()).then(d=>{var u;(u=d.results)!=null&&u.some(m=>m.reminders_sent>0)&&console.log("Meeting reminders:",JSON.stringify(d))}).catch(()=>{}))}catch(o){console.error("Scheduled cron error:",o.message||o)}}const En={fetch:Y.fetch,scheduled:_n},Ht=new pe,Tn=Object.assign({"/src/index.tsx":En});let Ar=!1;for(const[,e]of Object.entries(Tn))e&&(Ht.all("*",t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Ht.notFound(t=>{let r;try{r=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,r)}),Ar=!0);if(!Ar)throw new Error("Can't import modules from ['/src/index.tsx']");export{Ht as default};
